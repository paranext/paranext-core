...
import { Slot as Gt, Dialog as Y, Separator as _e, Popover as wt, Tooltip as lt, DropdownMenu as E, Label as Te, RadioGroup as _t, ToggleGroup as te } from "radix-ui";
import { IconX as Ce, IconCheck as jt, IconSearch as Le, IconChevronRight as Ae } from "@tabler/icons-react";
import { Canon as L } from "@sillsdev/scripture";
import { cva as ot } from "class-variance-authority";
import C, { createContext as ee, useContext as ae, useState as M, useRef as pt, useCallback as V, useEffect as Tt, useMemo as at, Fragment as ze, forwardRef as oe } from "react";
import { ChevronsUpDown as re, Check as ne, Star as Ge, Group as je, ArrowRight as Re, Loader2 as Oe, ChevronDown as Pe, Search as De, X as Be, AlertTriangle as Me, LoaderCircle as He } from "lucide-react";
import { Section as rt, MODIFIER_KEYS as Ue, normalizeProjectId as D, PROJECT_SELECTOR_CUSTOM_DATA_KEYS as dt, getLocalizeKeyForScrollGroupId as $e, getSectionForBook as Fe } from "platform-bible-utils";
...
function We(t, e) {
  ...
  const a = Ct(t);
  if (a[0] !== "tw") return t;
  const o = a.slice(1, -1), r = a[a.length - 1], s = Ct(e), i = s.some((u) => u.startsWith("-tw-")), l = s.some((u) => u.startsWith("!tw-"));
  if (i && r.startsWith("-")) {
    const u = r.slice(1);
    return [...o, `-tw-${u}`].join(":");
  }
...
const se = 600, ie = 650, Co = 400, qe = 450, Ye = 500, Lo = 510, Ao = 520, Qe = 675, zo = 690, Go = 700, jo = 800, le = ot(
...
function J({
  ...
  return /* @__PURE__ */ n(
    s,
    {
      ...
      "data-variant": e,
      "data-size": a,
      className: d(le({ variant: e, size: a, className: t })),
      ...r
    }
  );
}
const ce = "layoutDirection";
function de() {
...
function U() {
  var t;
  try {
    const e = (t = de()) == null ? void 0 : t.getItem(ce);
    if (e === "rtl")
      return e;
  } catch {
  }
...
function we({
  ...
  return (
    ...
    /* @__PURE__ */ n("div", { "data-slot": "command-input-wrapper", className: "tw:p-1 tw:pb-0", dir: r, children: /* @__PURE__ */ p(oa, { className: "tw:h-8! tw:rounded-lg! tw:border-input/30 tw:bg-input/30 tw:shadow-none! tw:*:data-[slot=input-group-addon]:ps-2!", children: [
      ...
      /* @__PURE__ */ n(na, { children: /* @__PURE__ */ n(Le, { className: "tw:size-4 tw:shrink-0 tw:opacity-50" }) })
    ] }) })
  );
}
...
const he = "data-quiet-focus";
function rr(t) {
  t && (typeof window < "u" && typeof window.matchMedia == "function" && window.matchMedia("(forced-colors: active)").matches || (t.setAttribute(he, ""), t.style.outline = "none"));
}
function nr(t) {
  t && (t.removeAttribute(he), t.style.removeProperty("outline"));
}
const sr = "tw:data-quiet-focus:focus-visible:border-transparent tw:data-quiet-focus:focus-visible:ring-0 tw:data-quiet-focus:focus-visible:outline-none";
function pa({
  className: t,
...
const dr = "data-platform-content-zoom-root", ur = "data-platform-content-zoom-popup", fa = "--platform-content-zoom-", ha = "--platform-content-zoom-default", ga = "main", ba = "--platform-content-zoom-popup-factor", ge = ee(void 0);
function wr({ area: t, children: e }) {
...
function Ne({
  ...
  const s = U(), i = C.useContext(ve), l = Dt();
  return (
...
function Ht({
  ...
  return /* @__PURE__ */ n(
    lt.Trigger,
    {
      ...
      className: e ? d(le({ variant: e }), t) : t,
      ...a
    }
  );
}
...
const Ca = ["input", "select", "textarea", "button"], La = ["button", "textbox"], Gr = ({
  options: t,
  onFocusChange: e,
  onOptionSelect: a,
  onCharacterPress: o
}) => {
  const r = pt(null), [s, i] = M(void 0), [l, u] = M(void 0), m = V(
    (w) => {
      i(w);
    ...
    (w) => {
      ...
      if (!!(h && g && h.contains(g) && g !== h) && S(g)) {
        ...
        if (w.key === "ArrowDown" || w.key === "ArrowUp") {
          ...
          const H = x.findIndex((Z) => Z === g);
          if (H === -1) return;
          let X;
          w.key === "ArrowDown" ? X = Math.min(H + 1, x.length - 1) : X = Math.max(H - 1, 0), X !== H && (w.preventDefault(), w.stopPropagation(), (j = x[X]) == null || j.focus());
          return;
        }
        return;
      }
...
function xt({ className: t, variant: e = "default", asChild: a = !1, ...o }) {
...
function $r({
  ...
  const [K, Q] = M(!1), A = pt(null), tt = V(
    (I) => {
      var R;
      const W = (R = t.find((q) => q.label === I)) == null ? void 0 : R.value;
      W && a(
        e.includes(W) ? e.filter((q) => q !== W) : [...e, W]
      );
    },
    [t, e, a]
  ), j = () => m || o, x = f ?? K, H = S ?? Q, [X, Z] = M(x), [it, et] = M(e);
  X !== x && (Z(x), x && et(e));
  const ht = at(() => {
    if (!w) return t;
    const I = t.filter((R) => R.starred).sort((R, q) => R.label.localeCompare(q.label)), W = t.filter((R) => !R.starred).sort((R, q) => {
      const bt = it.includes(R.value), c = it.includes(q.value);
      return bt && !c ? -1 : !bt && c ? 1 : R.label.localeCompare(q.label);
    });
    return [...I, ...W];
  }, [t, it, w]), gt = () => {
  ...
  return /* @__PURE__ */ n("div", { id: F, className: h, children: /* @__PURE__ */ p(be, { open: x, onOpenChange: H, children: [
    ...
    /* @__PURE__ */ n(Ne, { align: "start", className: "tw:w-full tw:p-0", children: /* @__PURE__ */ p(ue, { children: [
      /* @__PURE__ */ n(
        we,
        {
          placeholder: r ?? o,
      ...
      /* @__PURE__ */ n(Oa, { isEnabled: g, scrollerRef: A, children: /* @__PURE__ */ p(pe, { ref: A, children: [
        /* @__PURE__ */ n(me, { children: u }),
        /* @__PURE__ */ n(fe, { children: ht.map((I) => /* @__PURE__ */ p(
          Ot,
          {
            value: I.label,
            onSelect: tt,
...
function Fr(t, e, a) {
  ...
  if (Da(t) || Ue.has(t.key) || t.key === "Dead")
    return "passed";
...
function Ka(t, e) {
  if (e.id === "openTabs") return $a(t);
  if (e.id === "selection") return Fa(t, e);
  if (!e.getGroupKey) return zt(t);
...
function Ja(t) {
  ...
  return [
    ke(e.openTabsLabel),
    {
      ...
      getGroupKey: (a) => {
        var o;
        return typeof ((o = a.customData) == null ? void 0 : o[dt.lastUsedAt]) == "number" ? vt : Va;
      },
...
function ft(t) {
  return da[$e(t)] ?? String(t);
}
const Qt = "platform.footerAction", qa = {
...
function Ya({ scrollGroupId: t, isBoundButClosed: e }) {
  const a = ft(t);
  return e ? /* @__PURE__ */ n(
    xt,
    {
  ...
  ) : /* @__PURE__ */ n(xt, { variant: "secondary", children: a });
}
function Qa({
  row: t,
  mode: e,
  ...
  const {
    ...
    onPointerEnter: f,
    onPointerLeave: S
  } = Na(), [k, w] = M(!1), g = !!t.scrollGroupScrRefLabel || t.isBoundButClosed || !!(i != null && i.label) || t.isDisabled && !!t.disabledReason, v = m || k, h = V(() => {
    if (g) {
      w(!0);
      return;
    }
    ...
    w(!1), S();
  }, [S]), F = /* @__PURE__ */ n(ne, { className: d("tw:h-4 tw:w-4", t.isSelected ? "tw:opacity-100" : "tw:opacity-0") });
  let K;
  e === "project" ? t.openGroups.length > 0 && (K = /* @__PURE__ */ n("span", { className: "tw:ms-auto tw:flex tw:shrink-0 tw:gap-1", children: t.openGroups.map((j) => /* @__PURE__ */ n(xt, { variant: "secondary", children: ft(j) }, j)) })) : t.scrollGroupId !== void 0 && (K = /* @__PURE__ */ p("span", { className: "tw:ms-auto tw:flex tw:shrink-0 tw:items-center tw:gap-2", children: [
    /* @__PURE__ */ n(
      Ya,
      {
  ...
  ), A = t.scrollGroupId !== void 0 ? ft(t.scrollGroupId) : void 0, tt = t.isBoundButClosed && A ? a.boundButClosedTooltip.replace("{group}", A) : void 0;
  return /* @__PURE__ */ p(Mt, { open: v, delayDuration: 400, children: [
    /* @__PURE__ */ n(Ht, { asChild: !0, children: Q }),
    /* @__PURE__ */ p(
      Ut,
      {
        side: "top",
...
function to({
  ...
  return /* @__PURE__ */ p(xa, { children: [
    /* @__PURE__ */ p(Mt, { children: [
      /* @__PURE__ */ n(Ht, { asChild: !0, children: /* @__PURE__ */ n(ya, { asChild: !0, children: /* @__PURE__ */ n(
        J,
        {
          variant: "ghost",
          size: "sm",
    ...
    /* @__PURE__ */ p(
      Ia,
      {
        ...
        style: { zIndex: ie },
        children: [
          /* @__PURE__ */ n(Ea, { children: o.groupSectionLabel }),
          /* @__PURE__ */ p(ka, { value: e, onValueChange: a, children: [
            /* @__PURE__ */ n(Wt, { value: ct, children: o.groupByNone }),
            /* @__PURE__ */ n(_a, {}),
...
function tn(t) {
  const [e, a] = M(!1), [o, r] = M(""), s = at(() => Wa(t.localizedStrings), [t.localizedStrings]), i = at(() => {
    if (t.availableGroupings !== void 0) return t.availableGroupings;
    const c = [];
    return t.openTabs.length > 0 && c.push(ke(s.autoOpenTabsGroupingLabel)), t.mode === "project-multi" && c.push(
      Xa({
    ...
    () => eo(i, t.defaultGrouping),
    [i, t.defaultGrouping]
  ), f = l ?? m, S = pt(null), [k, w] = M(void 0), g = V((c) => {
    a(c), c || (r(""), w(void 0));
  }, []);
  Tt(() => {
    if (!e) return;
  ...
  const v = at(() => t.mode === "project" ? Et({
    ...
    [$]
  ), { renderProjectIndicator: K } = t, Q = V(
    (c) => K ? K(c.project) : void 0,
    [K]
  ), A = !!K, tt = !!t.footerAction && h.length === 0, j = at(() => {
    if (f === ct) return zt(h);
    const c = i.find((b) => b.id === f);
    return c ? Ka(h, c) : zt(h);
  }, [h, f, i]), x = (c) => {
    ...
    switch (t.mode) {
      ...
      case "project-multi": {
        const b = t.selection.pairs, O = D(c.projectId), B = (G) => D(G.projectId) === O && G.scrollGroupId === c.scrollGroupId, z = b.some(B) ? b.filter((G) => !B(G)) : [
          ...b.filter((G) => !B(G)),
  ...
  }, Z = t.mode === "project" ? t.renderTriggerLabel : void 0, it = t.mode === "project" ? t.triggerLabelFormat : void 0, et = at(() => {
    switch (t.mode) {
      case "project": {
        const c = F(t.selection.projectId);
        if (Z) return { node: Z(c), title: "" };
        let b = c ? c.shortName : s.buttonPlaceholder;
        return c && it === "shortNameAndFullName" && c.fullName && c.fullName !== c.shortName && (b = `${c.shortName} - ${c.fullName}`), { node: b, title: b };
      }
      case "project-multi": {
        ...
        const O = b.map(
          ({ project: z, scrollGroupId: G }) => G === void 0 ? z.shortName : `${z.shortName} (${ft(G)})`
        ).join(", "), B = b.length.toString();
        return {
          node: /* @__PURE__ */ p(Ee, { children: [
            /* @__PURE__ */ n(xt, { variant: "muted", className: "tw:shrink-0", children: B }),
            /* @__PURE__ */ n("span", { className: "tw:min-w-0 tw:truncate", children: O })
          ] }),
          title: `${B} ${O}`
        };
      }
      case "projectScrollGroup": {
        ...
        const O = `${c.shortName} · ${ft(b)}`;
        return { node: O, title: O };
      }
      default:
        return { node: "", title: "" };
    }
  ...
  Tt(() => {
    ...
    return O.observe(c, { box: "border-box" }), () => O.disconnect();
  }, []);
  let I;
  t.isLoading ? I = /* @__PURE__ */ n(Oe, { className: "tw:ms-2 tw:h-4 tw:w-4 tw:shrink-0 tw:animate-spin tw:opacity-50" }) : gt ? I = void 0 : t.mode === "project-multi" ? I = /* @__PURE__ */ n(re, { className: "tw:ms-2 tw:h-4 tw:w-4 tw:shrink-0 tw:opacity-50" }) : I = /* @__PURE__ */ n(Pe, { className: "tw:ms-2 tw:h-4 tw:w-4 tw:shrink-0 tw:opacity-50" });
  const W = t.mode === "projectScrollGroup" || t.mode === "project-multi" && t.onOpenProjectInGroup ? x : void 0, R = /* @__PURE__ */ p(
    J,
    {
      ref: ht,
  ...
  ), q = et.title ? /* @__PURE__ */ n(Zt, { delayDuration: 400, children: /* @__PURE__ */ p(Mt, { children: [
    /* @__PURE__ */ n(Ht, { asChild: !0, children: /* @__PURE__ */ n(At, { asChild: !0, children: R }) }),
    /* @__PURE__ */ n(Ut, { children: et.title })
  ] }) }) : /* @__PURE__ */ n(At, { asChild: !0, children: R }), bt = i.length > 1;
          ...
          ue,
          {
            ...
            children: [
              ...
              /* @__PURE__ */ p(pe, { children: [
                /* @__PURE__ */ n(me, { children: s.commandEmptyMessage }),
                j.map((c, b) => (
                  ...
                  /* @__PURE__ */ p(
                    ...
                    {
                      children: [
                        /* @__PURE__ */ n(fe, { heading: ao(c, s), children: c.rows.map((O) => /* @__PURE__ */ n(
                          Qa,
                          {
                            row: O,
                            mode: t.mode,
                        ...
                        b < j.length - 1 && /* @__PURE__ */ n(Vt, { alwaysRender: !0 })
                      ]
                    },
...
const an = (t, e, a) => no(t, e).every((o) => a.includes(o));
function so(t, e) {
  return [
...
function on(t, e, a, o) {
  ...
  const i = so(t, o);
  if (i.length !== 0)
    return i.length <= ro ? i.join(", ") : `${i[0]} - ${i[i.length - 1]}`;
}
...
function sn({
  ...
  return /* @__PURE__ */ p(io, { className: d(s), role: r, children: [
    /* @__PURE__ */ p(lo, { children: [
      /* @__PURE__ */ n(uo, { variant: "icon", children: o ?? /* @__PURE__ */ n(Me, {}) }),
      /* @__PURE__ */ n(wo, { children: t })
    ] }),
    a && /* @__PURE__ */ n(po, { children: /* @__PURE__ */ n(J, { onClick: () => a(), children: e }) })
  ] });
}
const mo = oe(({ className: t, ...e }, a) => /* @__PURE__ */ n(He, { size: 35, className: d("tw:animate-spin", t), ...e, ref: a }));
...
//# sourceMappingURL=resizable-hGhW28Y7.js.map
