...
import { Slot as It, Dialog as X, Separator as Ne, Popover as dt, Tooltip as at, DropdownMenu as E, Label as ve, RadioGroup as vt, ToggleGroup as Vt } from "radix-ui";
import { IconX as xe, IconCheck as Et, IconSearch as ye, IconChevronRight as Se } from "@tabler/icons-react";
import { Canon as T } from "@sillsdev/scripture";
import { cva as Z } from "class-variance-authority";
import _, { useState as J, useRef as mt, useCallback as F, createContext as ke, useContext as Ie, useMemo as Y, useEffect as Dt, Fragment as Ee, forwardRef as Jt } from "react";
import { ChevronsUpDown as Xt, Check as qt, Star as _e, Group as Te, ArrowRight as Ce, Loader2 as Ge, ChevronDown as je, Search as ze, X as Le, AlertTriangle as Ae, LoaderCircle as Re } from "lucide-react";
import { Section as Q, MODIFIER_KEYS as De, normalizeProjectId as P, PROJECT_SELECTOR_CUSTOM_DATA_KEYS as it, getLocalizeKeyForScrollGroupId as Oe, getSectionForBook as Pe } from "platform-bible-utils";
...
const Wt = 600, Zt = 650, fr = 400, Fe = 450, Ve = 500, hr = 510, gr = 520, Je = 675, br = 690, Nr = 700, vr = 800, Yt = Z(
...
function ae({
  ...
  return (
    ...
    /* @__PURE__ */ o("div", { "data-slot": "command-input-wrapper", className: "tw:p-1 tw:pb-0", dir: n, children: /* @__PURE__ */ p(Ze, { className: "tw:h-8! tw:rounded-lg! tw:border-input/30 tw:bg-input/30 tw:shadow-none! tw:*:data-[slot=input-group-addon]:ps-2!", children: [
      ...
      /* @__PURE__ */ o(Qe, { children: /* @__PURE__ */ o(ye, { className: "tw:size-4 tw:shrink-0 tw:opacity-50" }) })
    ] }) })
  );
}
...
const Br = Object.fromEntries(
  aa.map((t) => [t, T.bookIdToEnglishName(t)])
);
function Mr(t, e, a) {
...
const Hr = "tw:data-selected:ring-2 tw:data-selected:ring-ring/50 tw:data-selected:ring-inset tw:forced-colors:data-selected:outline-2 tw:forced-colors:data-selected:outline-[color:Highlight] tw:forced-colors:data-selected:-outline-offset-2";
...
const Vr = "tw:data-quiet-focus:focus-visible:border-transparent tw:data-quiet-focus:focus-visible:ring-0 tw:data-quiet-focus:focus-visible:outline-none";
function ia({
  className: t,
...
function ca({ variant: t = "default", ...e }) {
  ...
  return /* @__PURE__ */ o(ce.Provider, { value: r, children: /* @__PURE__ */ o(E.Root, { "data-slot": "dropdown-menu", dir: a, ...e }) });
}
function eo({
  ...t
}) {
...
function io({
  ...
  return /* @__PURE__ */ p(
    E.SubTrigger,
    {
      ...
      children: [
        a,
        /* @__PURE__ */ o(Se, { className: "tw:ms-auto" })
      ]
    }
  );
}
...
const ga = ["input", "select", "textarea", "button"], ba = ["button", "textbox"], go = ({
  options: t,
  onFocusChange: e,
  onOptionSelect: a,
  onCharacterPress: r
...
function _o({
  ...
  return /* @__PURE__ */ o("div", { id: h, className: g, children: /* @__PURE__ */ p(ie, { open: y, onOpenChange: f ?? U, children: [
    ...
    /* @__PURE__ */ o(de, { align: "start", className: "tw:w-full tw:p-0", children: /* @__PURE__ */ p(ee, { children: [
      ...
      /* @__PURE__ */ p(re, { children: [
        ...
        /* @__PURE__ */ o(ne, { children: z.map((S) => /* @__PURE__ */ p(
          Tt,
          {
            value: S.label,
            onSelect: $,
            ...
            children: [
              ...
              S.starred && /* @__PURE__ */ o(_e, { className: "tw:h-4 tw:w-4" }),
...
function To(t, e, a) {
  ...
  if (ka(t) || De.has(t.key) || t.key === "Dead")
    return "passed";
  ...
  return t.key === "*" ? r === "selection" && e.filter === "" ? (O(t), a.dismiss(), "ended") : (O(t), a.commitTypedCloser(e.filter), a.dismiss(), "ended") : t.key === "\\" && r === "backslash" ? e.filter === "" ? (a.dismiss(), "ended") : (O(t), a.commitTypedAndReopen(e.filter), "ended") : t.key === "Backspace" && e.filter === "" ? (O(t), a.dismiss(), "ended") : t.key === "Backspace" || we[r].test(t.key) ? (O(t), e.filter = t.key === "Backspace" ? e.filter.slice(0, -1) : e.filter + t.key, a.update({ filterText: e.filter }), "continue") : (r === "selection" && O(t), a.dismiss(), "ended");
}
function Co(t, e) {
  var a;
...
function La(t) {
  ...
  return [
    pe(e.openTabsLabel),
    {
      ...
      getGroupKey: (a) => {
        var r;
        return typeof ((r = a.customData) == null ? void 0 : r[it.lastUsedAt]) == "number" ? wt : za;
      },
...
const Ft = "platform.footerAction", Pa = {
...
function Ma({
  ...
  const {
    ...
    onPointerEnter: f,
    onPointerLeave: k
  } = da(), [I, w] = J(!1), g = !!t.scrollGroupScrRefLabel || t.isBoundButClosed || !!(i != null && i.label) || t.isDisabled && !!t.disabledReason, v = m || I, h = F(() => {
    if (g) {
      w(!0);
      return;
    }
  ...
  e === "project" ? t.openGroups.length > 0 && ($ = /* @__PURE__ */ o("span", { className: "tw:ms-auto tw:flex tw:shrink-0 tw:gap-1", children: t.openGroups.map((L) => /* @__PURE__ */ o(ft, { variant: "secondary", children: ut(L) }, L)) })) : t.scrollGroupId !== void 0 && ($ = /* @__PURE__ */ p("span", { className: "tw:ms-auto tw:flex tw:shrink-0 tw:items-center tw:gap-2", children: [
    ...
    t.isBoundButClosed && n && /* @__PURE__ */ p(
      V,
      {
        ...
        children: [
          /* @__PURE__ */ o(Ce, { className: "tw:h-3 tw:w-3" }),
          a.openButtonLabel
        ]
      }
    )
...
function Ha({
  ...
  return /* @__PURE__ */ p(ca, { children: [
    /* @__PURE__ */ p(Gt, { children: [
      /* @__PURE__ */ o(jt, { asChild: !0, children: /* @__PURE__ */ o(ua, { asChild: !0, children: /* @__PURE__ */ o(
        V,
        {
          variant: "ghost",
          size: "sm",
...
function Po(t) {
  const [e, a] = J(!1), [r, n] = J(""), s = Oa(t.localizedStrings), i = Y(() => {
  ...
  let st;
  t.isLoading ? st = /* @__PURE__ */ o(Ge, { className: "tw:ms-2 tw:h-4 tw:w-4 tw:shrink-0 tw:animate-spin tw:opacity-50" }) : nt ? st = void 0 : t.mode === "project-multi" ? st = /* @__PURE__ */ o(Xt, { className: "tw:ms-2 tw:h-4 tw:w-4 tw:shrink-0 tw:opacity-50" }) : st = /* @__PURE__ */ o(je, { className: "tw:ms-2 tw:h-4 tw:w-4 tw:shrink-0 tw:opacity-50" });
  const fe = t.mode === "projectScrollGroup" || t.mode === "project-multi" && t.onOpenProjectInGroup ? y : void 0, Rt = /* @__PURE__ */ p(
    V,
    {
      ref: ot,
  ...
  ), he = R.title ? /* @__PURE__ */ o(Ht, { delayDuration: 400, children: /* @__PURE__ */ p(Gt, { children: [
    /* @__PURE__ */ o(jt, { asChild: !0, children: /* @__PURE__ */ o(St, { asChild: !0, children: Rt }) }),
    /* @__PURE__ */ o(zt, { children: R.title })
  ] }) }) : /* @__PURE__ */ o(St, { asChild: !0, children: Rt }), ge = i.length > 1;
              ...
              /* @__PURE__ */ p(re, { children: [
                ...
                L.map((c, b) => (
                  ...
                  /* @__PURE__ */ p(
                    ...
                    {
                      children: [
                        /* @__PURE__ */ o(ne, { heading: $a(c, s), children: c.rows.map((D) => /* @__PURE__ */ o(
                          Ma,
                          {
                            row: D,
                            mode: t.mode,
...
const Mo = (t, e, a) => Va(t, e).every((r) => a.includes(r));
function Ja(t, e) {
  return [
    ...new Set(t.map((r) => r.toUpperCase()))
  ].filter((r) => T.bookIdToNumber(r) > 0).sort((r, n) => T.bookIdToNumber(r) - T.bookIdToNumber(n)).map((r) => na(r, e));
}
function Ho(t, e, a, r) {
...
function Uo({ message: t, id: e, className: a }) {
  return /* @__PURE__ */ o(
    "p",
    {
      role: "status",
...
function Ko({
  ...
  return /* @__PURE__ */ p(Xa, { className: d(s), role: n, children: [
    /* @__PURE__ */ p(qa, { children: [
      /* @__PURE__ */ o(Za, { variant: "icon", children: r ?? /* @__PURE__ */ o(Ae, {}) }),
      /* @__PURE__ */ o(Ya, { children: t })
    ] }),
    a && /* @__PURE__ */ o(Qa, { children: /* @__PURE__ */ o(V, { onClick: () => a(), children: e }) })
  ] });
}
const tr = Jt(({ className: t, ...e }, a) => /* @__PURE__ */ o(Re, { size: 35, className: d("tw:animate-spin", t), ...e, ref: a }));
...
//# sourceMappingURL=resizable-C6Bc10mY.js.map
