...
import z, { useState as X, useRef as xt, useCallback as K, createContext as me, useContext as fe, useMemo as Q, useEffect as pe, Fragment as he, forwardRef as Pt } from "react";
...
import { Section as Z, MODIFIER_KEYS as Ce, normalizeProjectId as _, getLocalizeKeyForScrollGroupId as Ee, getSectionForBook as Te } from "platform-bible-utils";
...
const Oe = 600, _t = 650, cr = 400, Be = 450, Pe = 500, Me = 550, ur = 650, wr = 700, Ut = W(
  ...
  return /* @__PURE__ */ m(je, { children: [
    ...
    /* @__PURE__ */ m(
      J.Content,
      {
        ...
        children: [
          e,
          a && /* @__PURE__ */ o(J.Close, { "data-slot": "dialog-close", asChild: !0, children: /* @__PURE__ */ m(U, { variant: "ghost", className: "tw:absolute tw:top-2 tw:end-2", size: "icon-sm", children: [
            /* @__PURE__ */ o(ce, {}),
...
function wn({
  ...
  const [A, H] = X(!1), Y = K(
    (C) => {
      var O;
      const R = (O = t.find((F) => F.label === C)) == null ? void 0 : O.value;
      R && a(
    ...
    if (!S) return t;
    const C = t.filter((O) => O.starred).sort((O, F) => O.label.localeCompare(F.label)), R = t.filter((O) => !O.starred).sort((O, F) => {
      const lt = e.includes(O.value), q = e.includes(F.value);
      return lt && !q ? -1 : !lt && q ? 1 : O.label.localeCompare(F.label);
    });
    return [...C, ...R];
  }, [t, e, S]), M = () => {
    a(t.map((C) => C.value));
  ...
  return /* @__PURE__ */ o("div", { id: N, className: b, children: /* @__PURE__ */ m(Xt, { open: x, onOpenChange: h ?? H, children: [
...
function Na(t) {
  ...
  return t.forEach((a) => {
    const r = _(a.projectId), n = e.get(r), s = {
...
function pt(t) {
  ...
  if (t.mode === "project") {
    const n = t.selection.projectId === void 0 ? void 0 : _(t.selection.projectId);
    return t.projects.map((s) => {
      const i = e.get(_(s.id)) ?? [];
      return {
        rowKey: s.id,
        projectId: s.id,
...
function Ca(t, e, a, r) {
  ...
  t.forEach((v) => {
    const S = i(_(v.projectId));
    S < 0 ? c.push(v) : l[S].push(v);
  });
  const f = (v, S) => {
    const { compare: u } = S;
    return u ? [...v].sort((b, g) => {
      const N = a.get(_(b.projectId)), A = a.get(_(g.projectId));
      if (!N || !A) return D(b, g);
      const H = u(N, A);
      return H !== 0 ? H : D(b, g);
    }) : [...v].sort(D);
...
function La({
  ...
  return /* @__PURE__ */ m(Zt, { open: N, delayDuration: 400, children: [
    /* @__PURE__ */ o(Yt, { asChild: !0, children: P }),
    /* @__PURE__ */ m(
      Qt,
      {
        side: "top",
...
function bn(t) {
  const [e, a] = X(!1), [r, n] = X(""), s = t.availableGroupings ?? Ga, i = Ra(
    s,
    t.defaultGrouping,
  ...
  const u = Ta(t.localizedStrings), b = Q(() => t.mode === "project" ? pt({
    ...
    () => new Map(t.projects.map((w) => [_(w.id), w])),
    [t.projects]
  ), { renderProjectIndicator: A } = t, H = K(
    (w) => {
      if (!A) return;
      const p = N.get(_(w.projectId));
      return p ? A(p) : void 0;
    },
    [A, N]
  ), { lastUsedRecentSectionHeading: Y } = u, { lastUsedOtherSectionHeading: B } = u, { languageUnknownSectionHeading: P } = u, { versificationUnknownSectionHeading: M } = u, { typeUnknownSectionHeading: V } = u, { customUnmatchedSectionHeading: x } = u, j = Q(() => {
    switch (l) {
      case "openTabs":
        return Rt(g, !0);
      case "lastUsed":
          ...
          /* @__PURE__ */ m(Ft, { children: [
            ...
            j.map((w, p) => (
              ...
              /* @__PURE__ */ m(he, { children: [
                /* @__PURE__ */ o(Jt, { heading: Ma(w, u), children: w.rows.map((y) => /* @__PURE__ */ o(
                  La,
                  {
                    row: y,
                    mode: t.mode,
...
const vn = (t, e, a) => Ua(t, e).every((r) => a.includes(r));
function $a(t, e) {
  return [
...
function In({
  ...
  return /* @__PURE__ */ m(Ha, { className: d(s), role: n, children: [
    /* @__PURE__ */ m(Va, { children: [
      /* @__PURE__ */ o(Ka, { variant: "icon", children: r ?? /* @__PURE__ */ o(Ie, {}) }),
      /* @__PURE__ */ o(Ja, { children: t })
    ] }),
    a && /* @__PURE__ */ o(Xa, { children: /* @__PURE__ */ o(U, { onClick: () => a(), children: e }) })
  ] });
}
const Wa = Pt(({ className: t, ...e }, a) => /* @__PURE__ */ o(Se, { size: 35, className: d("tw:animate-spin", t), ...e, ref: a }));
...
//# sourceMappingURL=resizable-C9lY8U--.js.map
