 ...
 * @experimental This export is unstable and may change shape or disappear without notice
 */
export const MAIN_CONTENT_ZOOM_AREA_ID = 'main';
...
/**
 * Inline style a zoomed pop-up carries; see {@link getContentZoomPopupStyle}. Library-internal — not
 ...
 * size caps to divide by. Takes the value {@link useContentZoomArea} returned. Library-internal —
