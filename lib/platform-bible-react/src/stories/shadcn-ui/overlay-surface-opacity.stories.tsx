...
/**
 * Asserts each surface, and everything it is painted inside, is fully opaque in every Storybook
 * theme.
 *
...
async function expectSurfacesOpaqueInEveryTheme(slots: readonly string[]) {
  ...
  // `opacity` does not vary by theme, but an entry animation can hold it below 1 briefly.
