...
- Combobox component - where search, grouping and more details are helpful
  - [Single Select Combobox](https://github.com/paranext/paranext-core/blob/main/lib/platform-bible-react/src/stories/shadcn-ui/combo-box.stories.tsx): use a [Chevron Down](https://lucide.dev/icons/chevron-down) icon on the trigger, close on selection
  - [Multi Select Combobox](https://github.com/paranext/paranext-core/blob/main/lib/platform-bible-react/src/stories/advanced/multi-select-combo-box.stories.tsx): use the default [Chevrons Up-Down](https://lucide.dev/icons/chevrons-up-down) icon on the trigger, do not close on selection
