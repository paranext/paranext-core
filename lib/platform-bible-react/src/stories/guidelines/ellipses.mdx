...
Conventionally and most simply, an ellipsis means an action will be interrupted by a choice and not done immediately.

| Label end with       | No Ellipsis                                                                                               | Ellipsis                                                                                                                                           |
| -------------------- | --------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------- |
| Means                | Do immediately.                                                                                           | Do after a choice. You'll have a chance to back out.                                                                                           |
| Example              | New tab                                                                                                   | Open…                                                                                                                                              |
| Clicking the example | Immediately opens a new tab. There will be choices to make, but the tab will already exist at that point. | Opens a dialog to choose a file. **Cancel** will result in no action. Choosing a file clicking **Open** will result in opening a file immediately. |
...
The ellipsis after Settings is so pervasive that in an audit of 20 macOS applications, every app used "Settings…" with an ellipsis. This would be a good reason to make an exception, and we may choose to do so in the future.