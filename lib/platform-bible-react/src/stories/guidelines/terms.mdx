...
- `Window`: An operating system window that contains some interface. In Power mode, Platform.Bible supports having more than one open at a time. Actions you start — opening settings, a dialog, a notification — happen in the window you are working in.
