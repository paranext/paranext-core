...
- `Pane`: A region of a tab content with its own layout. Most tabs are a single pane; the Scripture Editor tab has a text pane and a footnote pane, separated by a divider. Content zoom ("Zoom" in Settings) scales the text in panes; "Zoom factor" scales the whole application.
