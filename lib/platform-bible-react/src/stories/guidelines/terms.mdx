...
- `Window`: An operating system window that contains some interface. Platform.Bible (and therefore Paratext 10) can have several of these open at once. They are equal siblings — none of them is a main or parent window, and each has its own dock layout.
