...
- `Window`: An operating system window that contains some interface. Platform.Bible supports multiple windows. The focused window receives commands by default.
