...
<input
  ...
  className="tw-full tw-file:border-0 tw-col-span-2 tw-flex tw-h-8 tw-rounded-md tw-border
    ...
    tw-ring-offset-white file:tw-bg-transparent file:tw-text-sm file:tw-font-medium
    placeholder:tw-text-slate-400 focus-visible:tw-outline-none focus-visible:tw-ring-2
    focus-visible:tw-ring-slate-400 focus-visible:tw-ring-offset-2
