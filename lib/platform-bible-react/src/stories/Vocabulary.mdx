...
### ghost
Use ghost for control styles that such low emphasis that they usually lack visually indications of their bounds, such as background color or border—unless they're hovered or focused. Ghost styles often used in toolbars, dropdowns, or secondary actions.
