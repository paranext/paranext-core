        ...
        "tasks": [
          ...
          },
          {
            ...
            "descriptions": {
              ...
              "zh-Hans": "第一个翻译任务是利用不同的圣经版本和注释书来仔细研读并理解经文。这就称之为“经文解释”。每个翻译小组最少要有一位善于解释的人。",
          ...
          },
          {
            ...
            "descriptions": {
              ...
              "zh-Hans": "以译入语（或受体语言）为母语的译者拟定翻译的初稿，并输入到《圣经辅助工具》中。",
        ...
        "tasks": [
          {
            ...
            "descriptions": {
              ...
              "zh-Hans": "这项检查由翻译小组进行（用一个或两个本国语言的译本与初稿作一比较，讨论翻译中对经文解释方面的选择，识别翻译中可能有错的经文解释；识别是否有漏译的经节或句子。）",
          ...
          },
          {
            ...
            "descriptions": {
              ...
              "zh-Hans": "这项检查由翻译小组进行（阅读初稿，检查语篇是否流畅，检查它的逻辑、年代顺序、经文中出现的所指对象（participant reference）、句子长度和节奏、语言风格和语言方式等。）",
          ...
          },
          {
            ...
            "descriptions": {
              ...
              "zh-Hans": "这项检查由翻译小组进行（在经文段落中识别主要圣经专门用词，把译法输入到“圣经专门用词”工具中，检查经文段落中使用的主要圣经专门用词与“圣经专门用词”工具中所记录的专门用词是否一致，讨论和记录重要的差异和／或需要与翻译顾问讨论的替代选项，用一个或两个本国语言的译本与初稿做一比较，讨论翻译中对经文解释方面的选择，识别翻译中可能有错的经文解释；识别是否有漏译的经节或句子。）",
          ...
          },
          {
            ...
            "descriptions": {
              ...
              "zh-Hans": "在“检查”菜单下有“给当前书卷运行‘拼写检查’”的选项，单击这个选项，然后接受或纠正所有出现字词的拼写。至于需要更多讨论的字词，请打开“词表”工具，然后添加一个拼写讨论附注。",
          ...
          },
          {
            ...
            "descriptions": {
              ...
              "zh-Hans": "彼此讨论译文中使用的格式，检查这格式与商定的范本译本（若有）是否一致。需要检查的格式包括（但不限于）以下各项：散文（或叙述文）格式，诗歌的缩排格式，译文与简介的不同格式。若是使用另一个译本作为范本，可以通过以下途径运行这项检查：“工具 ＞ 检查表工具（checklists） ＞ 比较分段标题”。",
          ...
          },
          {
            ...
            "descriptions": {
              ...
              "zh-Hans": "阅读文本，确定段落符都在想要放置的地方。若是使用另一个译本作为根据，可以通过以下途径运行这项检查：“工具 ＞ 检查表工具（checklists） ＞ 比较格式码”，然后寻找新的段落格式码，如：\\p，和 \\m。",
          ...
          },
          {
            ...
            "descriptions": {
              ...
              "zh-Hans": "确定其他版式问题，如诗歌。要特别注意诗歌的缩排。若是使用另一个译本作为根据，可以通过以下途径运行这项检查：“工具 ＞ 检查表工具（checklists） ＞ 比较格式码”，然后寻找新的段落格式码，如：\\q， \\q1 和 \\q2。",
          ...
          },
          {
            ...
            "descriptions": {
              ...
              "zh-Hans": "见特殊格式问题列表，如：家谱、十字架上的字词、信件等。确定文本是使用正确的“标准格式格式码”（USFM）来标记。有关使用 USFM 的最新指南，见 http://paratext.org/about/usfm。",
          ...
          },
          {
            ...
            "descriptions": {
              ...
              "zh-Hans": "打开“工作分配和进度”窗口，然后改正所有在窗口中显示的错误／问题。改正所有错误和解决所有未解决的附注之后，打印一些书卷或章，交给该语言群体中的公众审阅者审阅。要从《圣经辅助工具》打印文本，两种最简单的方法可见于“文件”菜单，就是“打印草稿”和“另存为 RTF 文件”。较高级的格式还可以使用其他的方法，如“导出至 Pathway 软件”。请使用项目管理员或翻译顾问所指定的方法。",
        ...
        "tasks": [
          {
            ...
            "descriptions": {
              ...
              "zh-Hans": "这项理解译文的测试是与语言群体中没有参与准备文本初稿的人一起去做。（重新阅读译稿；为理解译文测试拟定一般性的复述问题；识别可能出现的误解；拟定一些具体问题，例如与关乎经文中的主要事件、经文中出现的所指对象（participant reference）、主要圣经用词、外来的观念、比喻、修辞性疑问句、推理信息、正面或负面的关联等。）",
          ...
          },
          {
            ...
            "descriptions": {
              ...
              "zh-Hans": "在这计划中，任何前一阶段未完成的检查都应适当地加以处理。注意：如果前一个完成阶段的检查中出现错误，这情况会在当前的工作阶段中显示出来。\n\n初稿部分特别提到一些辅助性的帮助材料，这里假设所有其他关乎补充材料的检查也会完成，并且是最后文本的一部分。",
          ...
          },
          {
            ...
            "descriptions": {
              ...
              "zh-Hans": "这项检查与一个 UNS 小组一起去做（阅读经文的第一个修订文本；发问一般性的复述问题；发问后续的问题；记录需要在翻译中处理的理解问题；关乎拼写的问题要在“词表”工具用拼写附注来记录，关乎字词译法的问题要在“圣经专门用词”工具用译法附注来记录。同时注意任何与改进初稿自然度相关的更改。）",
        ...
        "tasks": [
          {
            ...
            "descriptions": {
              ...
              "zh-Hans": "打开“圣经专门用词”工具，筛选出一些篇章以便翻译顾问进行检查。确定所有“圣经专门用词”已经有核准的译法。更新缺失的译法，或由于进一步理解希腊语或希伯来语的意思而更改的译法。当中有些极可能已经过期，因为译文理解测试后已有修订。",
          ...
          },
          {
            ...
            "descriptions": {
              ...
              "zh-Hans": "准备或修订一份相关语法和语段分析的详细描写，然后发送给翻译顾问。列出所有连接字词的列表会对翻译顾问特别有用。",
          ...
          },
          {
            ...
            "descriptions": {
              ...
              "zh-Hans": "回译就是翻译成该地区的主要国家或贸易语言。这步骤应该由译者以外的另一个说该语言的人来完成。这将显示翻译是否能准确有效地沟通，也可用作翻译顾问检查的根据。",
          ...
          },
          {
            ...
            "descriptions": {
              ...
              "zh-Hans": "翻译小组应确定回译是完整的，没有遗漏字词或片语，以便于顾问使用。这项检查的目的不是让翻译小组去改变回译者对文本意思的理解。",
          ...
          },
          {
            ...
            "descriptions": {
              ...
              "zh-Hans": "翻译顾问评价文本，并把附注连同他在文本（或回译）中的观察所得写在附注中。评价的焦点应放在文本的准确、清晰、自然和翻译的可接受性，包括所有补充材料和所使用的例证。",
          ...
          },
          {
            ...
            "descriptions": {
              ...
              "zh-Hans": "顾问与翻译小组进行交流，讨论他对译本和补充材料的观察，并按要求提供协助和建议。项目管理员应在“工作分配和进度”窗口，把编辑权限授予一名组员（可以是他自己），去处理“翻译顾问的访问”任务。",
          ...
          },
          {
            ...
            "descriptions": {
              ...
              "zh-Hans": "根据翻译顾问的意见修订文本和补充材料。这任务是在顾问离开后进行的编辑工作。有些顾问称这类编辑为“行动项”、“待办事项”、“作业”或其他。",
        ...
        "tasks": [
          ...
          },
          {
            ...
            "descriptions": {
              ...
              "zh-Hans": "翻译小组撰写一份报告，交待他们针对主要圣经用词所做的更改，以及为何作出那些更改，然后发送给翻译顾问。小组应打开“圣经专门用词”工具，查阅报告中主要圣经用词的附注和历史记录部分。把针对更改所进行的讨论和决定输入到“圣经专门用词”工具中，是一个很好的习惯。",
          ...
          },
          {
            ...
            "descriptions": {
              ...
              "zh-Hans": "初步决定使用哪些插图。如果插图标题包含非直接引用经文的文本，就必须要求翻译顾问检查文本。这应该与出版部门一起完成。示例插图可在以下位置找到：\n\nhttps://www.dropbox.com/sh/cs0qspb52iwa2rj/AACr9xi7s2LVoheonn0OnjPla?dl=0",
          ...
          },
          {
            ...
            "descriptions": {
              ...
              "zh-Hans": "与一个 UNS 小组合作，测试任何尚未测试的补充材料。当中极可能会包括但不限于：词汇表条目，图表标题和书卷简介。",
        ...
        "tasks": [
          {
            ...
            "descriptions": {
              ...
              "zh-Hans": "最后决定使用哪些插图。如果插图标题包含非直接引用经文的文本，就必须要求顾问检查文本。这应该与出版部门一起完成。示例插图可在以下位置找到：\n\nhttps://www.dropbox.com/sh/cs0qspb52iwa2rj/AACr9xi7s2LVoheonn0OnjPla?dl=0",
          ...
          },
          {
            ...
            "descriptions": {
              ...
              "zh-Hans": "最后决定使用哪些地图。这应该与出版部门一起完成。示例地图可在以下位置找到：\n\nhttps://www.dropbox.com/sh/0bi5dg8v7vj7y74/AAANSWfsC6uSL_mRSYKBx6T9a?dl=0",
          ...
          },
          {
            ...
            "descriptions": {
              ...
              "zh-Hans": "转到“工具-->平行经文”菜单，使用“平行经文”工具作指引，使平行经文之间有相应的译法。",
          ...
          },
          {
            ...
            "descriptions": {
              ...
              "zh-Hans": "在“圣经专门用词”工具中选择“数”的列表作为“圣经专门用词”列表，以查找新约中所有的数目。",
          ...
          },
          {
            ...
            "descriptions": {
              ...
              "zh-Hans": "确定所有诸如金钱、钱币、银子、金子、得拿利和舍客勒等字词都有充分的区分和一致的译法。",
          ...
          },
          {
            ...
            "descriptions": {
              ...
              "zh-Hans": "确定所有诸如他连得、弥拿、舍客勒、pim 、比加、季拉等字词都有充分的区分和一致的译法。",
          ...
          },
          {
            ...
            "descriptions": {
              ...
              "zh-Hans": "确定所有诸如肘、虎口、一掌、 orgyia 、斯他迪、百万、 cor 、半賀梅珥、伊法、细亚、賀梅珥、 cab 、罢特、欣、 log 等字词都有充分的区分和一致的译法。",
          ...
          },
          {
            ...
            "descriptions": {
              ...
              "zh-Hans": "在脚注、经文相互参照、书卷简介等，查阅所有经文参照，确定当中列出的经节都谈论相应的主题。（这并不是《圣经辅助工具》的自动检查，不是要确定经文参照格式是正确和存在于经目表的。）",
          ...
          },
          {
            ...
            "descriptions": {
              ...
              "zh-Hans": "若是使用另一个译本为根据，可以进行这项检查如下：“工具 ＞ 检查表工具（Checklists） ＞ 比较分段标题”。",
          ...
          },
          {
            ...
            "descriptions": {
              ...
              "zh-Hans": "若是使用另一个译本为根据，可以进行这项检查如下：“工具 ＞ 检查表工具（Checklists） ＞ 比较格式码”，然后寻找新的段落格式码，如　\\p 和 \\m。",
          ...
          },
          {
            ...
            "descriptions": {
              ...
              "zh-Hans": "确定其他版式问题，如诗歌的版式。要特别注意诗歌的缩排。若是使用另一个译本为根据，可以进行这项检查如下：“工具 ＞ 检查表工具（Checklists） ＞ 比较格式码”，然后寻找新的段落格式码，如　\\q，\\q1 和 \\q2。",
        ...
        "tasks": [
          ...
          },
          {
            ...
            "descriptions": {
              ...
              "zh-Hans": "以译入语（或受体语言）为母语的译者首先在 LWC 【？】研读经文，然后用白话向翻译小组的其他成员复述经文。小组可以把这段复述录下来，留待下一步的草拟初稿时使用。",
          ...
          },
          {
            ...
            "descriptions": {
              ...
              "zh-Hans": "以译入语（或受体语言）为母语的译者向翻译小组朗读初稿，其他以译入语为母语的组员查看译文是否自然和清晰。然后根据小组的意见调整译文。",
        ...
        "tasks": [
          ...
          },
          {
            ...
            "descriptions": {
              ...
              "zh-Hans": "翻译小组讨论第一次译文理解测试所得出的意见，并适当地修订文本。（解决所有用项目附注以及拼写和译法附注记录的问题。）",
        ...
        "tasks": [
          ...
          },
          {
            ...
            "descriptions": {
              ...
              "zh-Hans": "翻译小组撰写一份报告，交待第四次修订所做的更改，以及为何作出那些更改，然后发送给翻译顾问。",
          ...
          },
          {
            ...
            "descriptions": {
              ...
              "zh-Hans": "翻译小组讨论公众审阅对主要圣经用词所给予的意见，然后使用一些他们认为有效的更改。",
        ...
        "tasks": [
          ...
          },
          {
            ...
            "descriptions": {
              ...
              "zh-Hans": "打开“平行经文”工具并确认所有平行经文。（这项检查并非只是确定所有平行经文都有勾选标记，而是要细阅所有经节，看看每段经文是否都有相应的绿色和黄色标记字词。）",
          ...
          },
          {
            ...
            "descriptions": {
              ...
              "zh-Hans": "细阅所有脚注和经文参照，查看所使用的格式是否不一致。检查的目标是使所有脚注都有一致的外观和感觉，并非只是检查脚注的格式码错误。",
    ...
    "stages": [
      {
        ...
        "descriptions": {
          ...
          "zh-Hans": "请打开附带的SIL_Compact_Plan.html文件以查看此计划。\n\n 这阶段主要是翻译初稿。",
          "zh-Hant": "透過開啟隨附的 SIL_Compact_Plan.html 文件查看此計劃。\n\n\n\n\n\n此階段涉及創建翻譯的初稿。",
          "pt-BR": "Visualize este plano abrindo o documento SIL_Compact_Plan.html que o acompanha.\n\n\n\nEsta etapa envolve a criação do primeiro rascunho da tradução."
        },
        "tasks": [
          {
            "id": "9f99673c-cb6a-4c05-a9cd-4629eb7f6b20",
        ...
        "tasks": [
          ...
          },
          {
            ...
            "descriptions": {
              ...
              "zh-Hans": "团队一起朗读初稿。阅读译文时，检查语篇的总体流畅性、逻辑、时序、参与者指称、句子长度和节奏、语言风格等。根据需要调整文本，解决发现的所有问题。",
              "zh-Hant": "與團隊一起大聲朗讀草稿。閱讀文本時，檢查話語的整體流程、邏輯、時間順序、參與者參考、句子長度和節奏、語言風格和語體等。",
              "pt-BR": "Leia o rascunho em voz alta com a equipe. Durante a leitura do texto, verifique o fluxo geral do discurso, sua lógica, cronologia, referência dos participantes, comprimento e ritmo das frases, estilo e registro linguístico etc. Ajuste o texto conforme necessário para resolver qualquer problema encontrado."
            },
            "markComplete": "by-chapter",
            "taskStart": "after-previous-task-on-same-book",
            "requiresEditing": "scripture-text",
          ...
          },
          {
            ...
            "descriptions": {
              ...
              "zh-Hans": "这些材料可能包括：\n\n●分段标题 \n\n● 脚注\n\n● 经文参照\n\n●插图（包括说明）\n\n● 地图 \n\n● 词汇表条目\n\n● 书卷简介",
              "zh-Hant": "這些材料可能包括：\n\n● 章節標題\n\n● 註腳\n\n● 交叉引用\n\n● 插圖（包括說明文字）\n\n● 地圖\n\n● 詞彙表條目\n\n● 書籍簡介。",
              "pt-BR": "Esses materiais podem incluir:\n\n● títulos de seção\n\n● notas de rodapé\n\n● referências cruzadas\n\n● ilustrações (incluindo legendas)\n\n● mapas\n\n● verbetes do glossário\n\n● introduções de livros."
            },
            "markComplete": "by-chapter",
            "taskStart": "after-previous-task-on-same-book",
            "requiresEditing": "scripture-text",
          ...
          },
          {
            ...
            "descriptions": {
              ...
              "zh-Hans": "进行理解测试，记录反馈/回复，以供后续分析/审读。在测试时提供补充材料。所有材料都应由译入语言社群几个不同的成员进行测试。",
              "zh-Hant": "執行理解測試，記錄回饋/答案以供以後分析/審查。在測試中包括補充材料。這些材料都應該由語言社群的幾個不同成員進行測試。",
              "pt-BR": "Realize testes de compreensão, documentando feedback/respostas para análise/revisão posterior. Inclua materiais adicionais nos testes. Todos os materiais devem ser testados com vários membros diferentes da comunidade linguística."
            },
            "markComplete": "by-chapter",
            "taskStart": "after-previous-task-on-same-book",
            "requiresEditing": "scripture-text",
          ...
          },
          {
            ...
            "descriptions": {
              ...
              "zh-Hans": "小组审阅理解测试的结果，并对文本进行相应的修改。如有需要，对修改后的段落再次进行理解测试。",
              "zh-Hant": "團隊審查理解測試的結果，並在適當的情況下對文本進行更改。必要時對修改後的段落重複理解測試。",
              "pt-BR": "A equipe analisa os resultados dos testes de compreensão e incorpora alterações no texto quando apropriado. Repita o teste de compreensão para passagens revisadas conforme necessário."
            },
            "markComplete": "by-chapter",
            "taskStart": "after-previous-task-on-same-book",
            "requiresEditing": "scripture-text",
        ...
        "tasks": [
          {
            ...
            "descriptions": {
              ...
              "zh-Hans": "回译须由没有参与翻译的人来起草。目的是展示读者如何理解译文。回译工作不应参考任何其他译本、版本或资源。回译文本应该输入到回译项目中。",
              "zh-Hant": "反向翻譯是由未參與翻譯的人員創建的。目的是向讀者展示如何理解文本。必須在不查看任何其他翻譯、版本或資源的情況下準備它。文字被輸入到反向翻譯項目。",
              "pt-BR": "A retrotradução é criada por alguém que não esteve envolvido na tradução. O objetivo é mostrar como o leitor compreenderá o texto. Deve ser preparada sem consultar qualquer outra tradução, versão ou recurso. O texto é inserido no projeto de retrotradução."
            },
            "markComplete": "by-chapter",
            "taskStart": "after-previous-task-on-same-book",
            "requiresEditing": "scripture-text",
          ...
          },
          {
            ...
            "descriptions": {
              ...
              "zh-Hans": "小组应确保回译完整，并在《圣经辅助工具》中标记所有经节已完成。检查文本时，请不要改动文字，拼写方面的小问题则可以修改。回译的作用只是辅助翻译顾问的工作，在大多数情况下都不会出版。通常，在回译到国家语言中语法最不好的那些部分，最需要由顾问来检查。不过，如果拼写错误严重到妨碍顾问正常理解回译，那就要予以纠正。",
              "zh-Hant": "團隊應驗證反向翻譯是否完成，並在副文本中將所有經文標記為完成。檢查文字時不要更改所使用的字詞。允許出現小拼字問題。回譯只是對顧問的幫助，大多數情況下不會發布。通常，對顧問來說最有幫助的是本國語言中語法看起來很差的部分。但是，如果拼字錯誤嚴重到妨礙顧問理解反向翻譯，則應予以糾正。",
              "pt-BR": "A equipe deve verificar se a retrotradução está completa e marcar todos os versículos como finalizados no Paratext. Não altere as palavras usadas ao verificar o texto. Pequenos problemas ortográficos são permitidos. A retrotradução é apenas uma ajuda para o consultor e não será publicada na maioria dos casos. Muitas vezes são as partes que parecem ser de gramática ruim na língua nacional que são mais úteis para o consultor observar. No entanto, erros ortográficos que sejam graves o suficiente para impedir que o consultor compreenda a retrotradução devem ser corrigidos."
            },
            "markComplete": "by-chapter",
            "taskStart": "after-previous-task-on-same-book",
            "requiresEditing": "scripture-text",
      ...
      },
      {
        ...
        "descriptions": {
          ...
          "zh-Hans": "顾问与小组远程互动，为检查会议做准备。然后计划一个时间，与小组一起审阅文本。在检查会议的最后，小组根据顾问的建议，还要完成一些工作。当顾问对改进感到满意时，会向小组提交一份报告或声明，表明该文本已获核准。",
          "zh-Hant": "顧問與團隊遠端互動，為檢查會議做準備，然後規劃他們可以一起審查文本的時間。檢查結束後，團隊需要做一些工作來遵守顧問的建議。當顧問對改進感到滿意時，就會向團隊提交一份報告或聲明，表明文本已獲得批准。",
          "pt-BR": "O consultor interage remotamente com a equipe para se preparar para a sessão de verificação e, em seguida, planeja um horário em que possam se reunir para revisar o texto juntos. Ao final da sessão de verificação, a equipe terá algum trabalho a fazer para atender às sugestões do consultor. Quando o consultor estiver satisfeito com as correções feitas, um relatório ou comunicado é enviado à equipe demonstrando que o texto foi aprovado."
        },
        "tasks": [
          {
            "id": "fd6c2f9b-c34f-4762-bcd0-845ff03c1785",
          ...
          },
          {
            ...
            "descriptions": {
              ...
              "zh-Hans": "顾问通过面对面或视频会议，与翻译小组进行互动。顾问对文本和补充材料提出意见，并根据需要提供帮助和建议。\n\n\n\n这项任务涉及编辑，因此应指派一个成员在会议期间进行修改。",
              "zh-Hant": "顧問透過實體或虛擬會議與翻譯團隊互動。他或她對文本和補充材料提出意見，並根據要求提供幫助和建議。\n\n\n\n\n\n此任務涉及編輯，應指派一名成員在會議期間進行更改。",
              "pt-BR": "O consultor interage com a equipe de tradução em sessão física ou virtual. Ele ou ela faz observações sobre o texto e materiais adicionais e dá assistência e conselhos conforme solicitado.\n\n\n\nEsta tarefa envolve edição e um membro deve ser designado para fazer alterações durante a sessão."
            },
            "markComplete": "by-chapter",
            "taskStart": "after-previous-task-on-same-book",
            "requiresEditing": "scripture-text",
          ...
          },
          {
            ...
            "descriptions": {
              ...
              "zh-Hans": "执行更改后，通过顾问报告或适当的方式获得顾问的核准。如果没有获得核准，请按照其余的建议来达到顾问的要求。",
              "zh-Hant": "實施變更後，透過顧問報告或適當的方式獲得顧問的批准。如果未獲得批准，請遵循剩餘的建議以滿足顧問的要求。",
              "pt-BR": "Após implementar as alterações, obtenha a aprovação do consultor através do relatório do consultor ou dos meios apropriados. Se a aprovação não for concedida, siga as recomendações restantes para satisfazer o consultor."
            },
            "markComplete": "by-chapter",
            "taskStart": "after-previous-task-on-same-book",
            "requiresEditing": "no",
        ...
        "tasks": [
          {
            ...
            "descriptions": {
              ...
              "zh-Hans": "社群领袖、教会领袖和其他社群成员讨论如何翻译圣经专门用词。小组讨论在社群审阅中针对圣经专门用词提出的意见和建议，并应用那些他们认为合宜的修改。\n\n\n\n考虑在安卓平板电脑上使用《圣经辅助工具》（精简版），以在理解测试会议中收集信息；当语言社群位于几个不同的国家时，也可使用  Scripture Forge《经文锻造》(即基于网络翻译和编辑应用程序）。",
              "zh-Hant": "社區領袖、教會領袖和其他社區成員討論如何呈現關鍵術語。團隊討論了社群審核中對關鍵術語的評論，並使用了他們認為有效的變更。\n\n\n\n\n\n考慮在 Android 平板電腦上使用 Paratext lite 在理解測試會議上收集信息，並在語言社區位於多個不同國家/地區的情況下使用 Bible Forge。",
              "pt-BR": "Os líderes da comunidade, os líderes da igreja e outros membros da comunidade discutem como os termos-chave são traduzidos. A equipe discute comentários sobre termos-chave feitos na revisão da comunidade e utiliza as alterações que considera válidas.\n\n\n\nConsidere usar o Paratext Lite em um tablet Android para coletar informações em reuniões de teste de compreensão e o Scripture Forge para situações em que a comunidade linguística está em vários países diferentes."
            },
            "markComplete": "by-chapter",
            "taskStart": "after-previous-stage-on-same-book",
            "requiresEditing": "scripture-text",
          ...
          },
          {
            ...
            "descriptions": {
              ...
              "zh-Hans": "小组向顾问报告在社群审阅中发现的任何文本或关键术语的更改。报告应包含作出更改的理由。小组应打开圣经专门用词工具，查阅注释，以及所改术语的历史记录。最好的做法是，在讨论和决定更改时，就把这些信息输入到工具中。",
              "zh-Hant": "團隊向顧問報告社區審核後所做的任何文字或關鍵術語變更。應包括變更的理由。團隊應該打開聖經術語工具並查閱註釋和所報告術語的歷史部分。最佳實踐是在討論和決定變更時在工具中輸入此資訊。",
              "pt-BR": "A equipe informa ao consultor sobre qualquer alteração textual ou de termos-chave feita como resultado da revisão da comunidade. A justificativa para as mudanças deve ser incluída. A equipe deve abrir a ferramenta de termos bíblicos e consultar as notas e seções de histórico dos termos relatados. É uma boa prática inserir essas informações na ferramenta à medida que as mudanças são discutidas e decididas."
            },
            "markComplete": "by-chapter",
            "taskStart": "after-previous-task-on-same-book",
            "requiresEditing": "no",
      ...
      },
      {
        ...
        "descriptions": {
          ...
          "zh-Hans": "文本定稿，准备出版并上传到“数字圣经书库”（DBL）。如果计划排版印刷，则由排版人员提出排版要求。",
          "zh-Hant": "該文本已最終確定已出版並上傳至 DBL。如果是排版出版物，則排版要求將由排版人員提供。",
          "pt-BR": "O texto é finalizado para publicação e carregado na DBL. Se uma publicação impressa estiver em vista, os requisitos de impressão serão fornecidos pelo impressor."
        },
        "tasks": [
          {
            ...
            "descriptions": {
              ...
              "zh-Hans": "为方便用户找到词汇表条目，您必须为印刷出版提供字词标记，或为电子出版提供字词的超链接。请使用《圣经辅助工具》中的工具添加必要的标记，这将创建超链接条目，或在印刷品中突出显示，以识别词汇表中的字词。",
              "zh-Hant": "為了讓使用者發現您的術語表條目，必須為印刷出版物標記單詞，或為數位出版物標記超連結。使用 Paratext 中的工具添加必要的標記，這將在列印中建立超連結條目或其他突出顯示以識別詞彙表單字。",
              "pt-BR": "Para que os usuários descubram os verbetes do seu glossário, as palavras devem ser marcadas para uma publicação impressa ou com o link para publicação digital. Use as ferramentas do Paratext para adicionar a marcação necessária, que criará verbetes com links ou outro destaque na impressão para identificar palavras do glossário."
            },
            "markComplete": "by-chapter",
            "taskStart": "after-previous-stage-on-same-book",
            "requiresEditing": "scripture-text",
          ...
          },
          {
            ...
            "descriptions": {
              ...
              "zh-Hans": "在您的项目中打开项目属性。点击管理“项目注册资料”。该操作将带您跳转到该项目在网络上的条目。转到注册网页上的“发布”选项卡，并填写横线上的信息。",
              "zh-Hant": "打開您的項目的項目屬性。點選管理項目註冊。這將帶您進入該項目在網路上的入口。前往註冊網站上的「發布」標籤並填寫水平線上方的資訊。",
              "pt-BR": "Abra Propriedades do Projeto para o seu projeto. Clique em Gerenciar registro do Projeto. Isso o levará à página deste projeto na web. Acesse a guia Publicação no site de registro e preencha as informações acima da linha horizontal."
            },
            "markComplete": "by-project",
            "taskStart": "after-previous-task-on-same-book",
            "requiresEditing": "no",
          ...
          },
          {
            ...
            "descriptions": {
              ...
              "zh-Hans": "将文本提交到“数字圣经书库”（DBL）。对于威克里夫全球联盟的伙伴，可在 bit.ly/DBL-Submit  <a href=\"https://bit.ly/DBL-Submit\">bit.ly/DBL-Submit</a>   获取相关说明。\n\n\n\n\n\n该页面说明如何准备文本，并提供一个表单链接以填写要提交的信息。",
              "zh-Hant": "將文字提交給 DBL。對於威克利夫全球聯盟合作夥伴，請在 bit.ly/DBL-Submit 上找到相關說明\n\n\n\n\n\n<a href=\"https://bit.ly/DBL-Submit\">bit.ly/DBL-Submit</a>\n\n\n\n\n\n此頁面介紹如何準備文本，並提供了用於填寫提交的表格的連結。",
              "pt-BR": "Envie o texto para a DBL. Para parceiros da Wycliffe Global Alliance, as instruções podem ser encontradas em bit.ly/DBL-Submit  <a href=\"https://bit.ly/DBL-Submit\">bit.ly/DBL-Submit</a>\n\n\n\nEsta página explica como preparar o texto e tem um link para um formulário a ser preenchido para o envio."
            },
            "markComplete": "by-chapter",
            "taskStart": "after-previous-task-on-same-book",
            "requiresEditing": "no",
        ...
        "tasks": [
          ...
          },
          {
            ...
            "descriptions": {
              ...
              "zh-Hans": "在《圣经辅助工具》更新改动，并（如需要）透过“注解”功能针对有关问题与成员沟通。",
              "es": "Ingresar los cambios y enviar notas al co-traductor.",
              "zh-Hant": "在《聖經輔助工具》更新改動，並（如需要）透過「註解」功能針對有關問題與成員溝通。",
          ...
          },
          {
            ...
            "descriptions": {
              "zh-Hans": "也就是说，如果初译者在总结其他成员对初稿意见的过程中，透过“注解”功能回复了个别成员或作进一步咨询，该成员必须解决“注解”，或把该“注解”转发给其他成员。",
              "zh-Hant": "也就是說，如果初譯者在總結其他成員對初稿意見的過程中，透過「註解」功能回復了個別成員或作進一步咨詢，該成員必須解決「註解」，或把該「註解」轉發給其他成員。"
            },
            "markComplete": "by-chapter",
            "taskStart": "after-previous-task-on-same-book",
            "requiresEditing": "no",
        ...
        "tasks": [
          {
            ...
            "descriptions": {
              "zh-Hans": "除了翻译顾问，有些语言群体可能有资深的学者或老师或牧长对《圣经》有很深入的研究和认识，但未能成为翻译小组成员，却愿意参与审阅工作。",
              "zh-Hant": "除了翻譯顧問，有些語言群體可能有資深的學者或老師或牧長對《聖經》有很深入的研究和認識，但未能成為翻譯小組成員，卻願意參與審閱工作。"
            },
            "markComplete": "by-chapter",
            "taskStart": "after-previous-task-on-same-book",
            "requiresEditing": "no",
          ...
          },
          {
            ...
            "descriptions": {
              "zh-Hans": "在《圣经辅助工具》更新改动，并（如需要）透过“注解”功能针对有关问题与翻译顾问或特别评审者沟通。这是假设他们也使用《圣经辅助工具》。",
              "zh-Hant": "在《聖經輔助工具》更新改動，並（如需要）透過「註解」功能針對有關問題與翻譯顧問或特別評審者溝通。這是假設他們也使用《聖經輔助工具》。"
            },
            "markComplete": "by-chapter",
            "taskStart": "after-previous-task-on-same-book",
            "requiresEditing": "no",
          ...
          },
          {
            ...
            "descriptions": {
              "zh-Hans": "也就是说，如果初译者在总结翻译顾问或特别评审者对初稿意见的过程中，透过“注解”功能回复了他们或作进一步咨询，翻译顾问或特别评审者必须解决“注解”，或把该“注解”转发给其他成员。这是假设他们也使用《圣经辅助工具》。",
              "zh-Hant": "也就是說，如果初譯者在總結翻譯顧問或特別評審者對初稿意見的過程中，透過「註解」功能回復了他們或作進一步咨詢，翻譯顧問或特別評審者必須解決「註解」，或把該「註解」轉發給其他成員。這是假設他們也使用《聖經輔助工具》。"
            },
            "markComplete": "by-chapter",
            "taskStart": "after-previous-task-on-same-book",
            "requiresEditing": "no",
          ...
          },
          {
            ...
            "descriptions": {
              "zh-Hans": "在一般情况下，公眾审阅者大概不会使用《圣经辅助工具》；按此，翻译小组只能打印出来分发。",
              "zh-Hant": "在一般情況下，公眾審閱者大概不會使用《聖經輔助工具》；按此，翻譯小組只能打印出來分發。"
            },
            "markComplete": "by-chapter",
            "taskStart": "after-previous-task-on-same-book",
            "requiresEditing": "no",
        ...
        "tasks": [
          {
            ...
            "descriptions": {
              "zh-Hans": "这只适用于某些语言群体：当中有特别的文体审阅者或编辑，该审阅者或编辑未能成为翻译小组成员，但愿意参与审阅工作。",
              "zh-Hant": "這只適用於某些語言群體：當中有特別的文體審閱者或編輯，該審閱者或編輯未能成為翻譯小組成員，但願意參與審閱工作。"
            },
            "markComplete": "by-chapter",
            "taskStart": "after-previous-task-on-same-book",
            "requiresEditing": "no",
          ...
          },
          {
            ...
            "descriptions": {
              "zh-Hans": "在《圣经辅助工具》更新改动，并（如需要）透过“注解”功能针对有关问题与文体审阅者或编辑沟通。",
              "zh-Hant": "在《聖經輔助工具》更新改動，並（如需要）透過「註解」功能針對有關問題與文體審閱者或編輯溝通。"
            },
            "markComplete": "by-chapter",
            "taskStart": "after-previous-task-on-same-book",
            "requiresEditing": "no",
