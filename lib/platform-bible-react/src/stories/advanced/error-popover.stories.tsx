...
const meta: Meta<typeof ErrorPopover> = {
  ...
  argTypes: {
    ...
    localizedStrings: {
      control: 'object',
      description: 'List of localized strings to use in the ErrorPopover component.',
    },
    className: {
      control: 'text',
...
export const WithCustomLocalizedStrings: Story = {
  args: {
    ...
    localizedStrings: {
      '%webView_error_dump_header%': "Détails de l'erreur",
      '%webView_error_dump_info_message%':
        "Une erreur s'est produite. Veuillez copier les détails ci-dessous et signaler ce problème.",
      '%webView_error_dump_copied_message%': "Détails de l'erreur copiés dans le presse-papiers!",
    },
  },
  render: (args) => (
    <ErrorPopover {...args}>
