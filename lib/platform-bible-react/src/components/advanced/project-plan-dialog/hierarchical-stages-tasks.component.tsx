      ...
      {stages.length === 0 ? (
        ...
        <ul className="tw:flex tw:flex-col tw:gap-1">
          {stages.map((stage, stageIndex) => {
            ...
            return (
              <li key={stage.id} className="tw:rounded tw:border">
                <RowHeader
                  isStage
                  open={stageOpen}
                ...
                <ul className="tw:flex tw:flex-col tw:gap-1 tw:p-2 tw:ps-8">
                  {stage.tasks.map((task, taskIndex) => {
                    ...
                    return (
                      <li key={task.id} className="tw:rounded tw:border">
                        <RowHeader
                          open={taskOpen}
  ...
  return (
    ...
    >
      <button
        ...
        title="Drag to reorder (not yet wired)"
...
function EffortPopover({
  ...
  return (
    <Popover>
      ...
      <PopoverContent align="end" className="tw:z-600 tw:w-80">
