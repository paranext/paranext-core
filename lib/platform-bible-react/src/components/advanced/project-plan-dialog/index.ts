...
export {
  ...
  type ProjectPlanDialogStageTabsProps,
} from '@/components/advanced/project-plan-dialog/project-plan-dialog-stage-tabs.component';
export type {
...
export { CHECK_GROUPS } from '@/components/advanced/project-plan-dialog/checks-tab.component';
