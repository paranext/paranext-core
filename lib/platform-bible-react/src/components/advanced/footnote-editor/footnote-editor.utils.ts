    ...
    markerMenuItems.push(
      ...markers.map((marker) => {
        return {
          ...
          action: () => {
            // TODO: Remove this cast once `insertMarker` ships in the platform-editor API
            // Tech debt: `insertMarker` is a planned but not yet released method; tracked for removal
