    ...
    <ContextMenuPrimitive.Portal>
      <ContextMenuPrimitive.Content
        ...
        className={cn(
          ...
          // CUSTOM: Removed tw:bg-popover/70 and the tw:before:* backdrop-blur layer (tw:before:-z-1,
          // tw:before:pointer-events-none, tw:before:absolute, tw:before:inset-0,
          // tw:before:rounded-[inherit], tw:before:backdrop-blur-2xl, tw:before:backdrop-saturate-150)
          // that shadcn's translucent menu color adds, so the base tw:bg-popover paints this surface
          // opaque. At 70% the text behind a menu shows through it, scrollbar gutter included, and in
          // a scrolling menu the absolutely positioned blur layer scrolls away with the items.
