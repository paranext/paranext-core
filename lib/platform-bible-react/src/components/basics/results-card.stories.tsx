  ...
  render: () => {
    const checkCards: CardConfig[] = [
      ...
      },
      {
        ...
        description:
          'Invalid or unknown unknownunknownunknownunknownunknownunknownunknownunknownunknownunknownunknownunknownunknownunknownunknownunknownunknown unknown character: (',
        isDenied: true,
      },
    ];
