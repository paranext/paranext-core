...
function fn({ commandHandler: e, className: r, columns: n }) {
  return S.jsx(Q.Grid, {
    ...
    columns: n.length,
    children: n.map((t) =>
      S.jsx(Dn, { commandHandler: e, name: t.name, className: r, items: t.items }),
    ),
  });
}
...
function Zn({ scrRef: e, handleSubmit: r }) {
  const n = (i) => {
    ...
    t = (i, l) => {
      const f = { bookNum: he.bookIdToNumber(l.bookId), chapterNum: 1, verseNum: 1 };
      n(f);
    },
    o = (i) => {
    ...
    s = ie.useMemo(() => sr()[e.bookNum - 1], [e.bookNum]);
  return S.jsxs(S.Fragment, {
    children: [
      ...
      S.jsx(Se, { onClick: () => n(Pr(e, -1)), isDisabled: e.bookNum <= xn, children: '<' }),
      S.jsx(Se, {
        onClick: () => n(Pr(e, 1)),
...
function tt({
  ...
  const le = ie.useMemo(() => {
    ...
    return f ? [{ ...Rr.SelectColumn, minWidth: h }, ...se] : se;
  }, [f, e]);
  return S.jsx(Rr, {
    columns: le,
    defaultColumnOptions: { width: o, minWidth: a, maxWidth: s, sortable: i, resizable: l },
    sortColumns: r,
    onSortColumnsChange: n,
    onColumnResize: t,
    rows: c,
    ...
    (ir = o()
      ...
      : function (a, s) {
          for (var i, l = t(a), c, f = 1; f < arguments.length; f++) {
            ...
            for (var h in i) r.call(i, h) && (l[h] = i[h]);
            if (e) {
              c = e(i);
              for (var u = 0; u < c.length; u++) n.call(i, c[u]) && (l[c[u]] = i[c[u]]);
            }
          }
          return l;
        }),
...
function Ot(e) {
  ...
  function f(u) {
    return s.indexOf(u) + 1 < s.length ? c(u, s[s.indexOf(u) + 1]) : i(u);
  }
  function h(u) {
    const y = s.indexOf(u);
    return y === 0
  ...
  return A({ keys: s, values: a, up: i, down: l, between: c, only: f, not: h, unit: n }, o);
}
...
function be(e, r, n) {
  ...
  if (Array.isArray(r)) {
    ...
    return r.reduce((s, i, l) => ((s[a.up(a.keys[l])] = n(r[l])), s), {});
  }
  if (typeof r == 'object') {
    const a = t.breakpoints || Yr;
...
const Ft = F({ prop: 'border', themeKey: 'borders', transform: de }),
  Ht = F({ prop: 'borderTop', themeKey: 'borders', transform: de }),
  Ut = F({ prop: 'borderRight', themeKey: 'borders', transform: de }),
  Gt = F({ prop: 'borderBottom', themeKey: 'borders', transform: de }),
  Jt = F({ prop: 'borderLeft', themeKey: 'borders', transform: de }),
  qt = F({ prop: 'borderColor', themeKey: 'palette' }),
  Kt = F({ prop: 'borderTopColor', themeKey: 'palette' }),
  Wt = F({ prop: 'borderRightColor', themeKey: 'palette' }),
  Xt = F({ prop: 'borderBottomColor', themeKey: 'palette' }),
  Yt = F({ prop: 'borderLeftColor', themeKey: 'palette' }),
  rr = (e) => {
...
const Zt = F({ prop: 'gridColumn' }),
  Qt = F({ prop: 'gridRow' }),
  eo = F({ prop: 'gridAutoFlow' }),
  ro = F({ prop: 'gridAutoColumns' }),
  no = F({ prop: 'gridAutoRows' }),
  to = F({ prop: 'gridTemplateColumns' }),
  oo = F({ prop: 'gridTemplateRows' }),
  ao = F({ prop: 'gridTemplateAreas' }),
  so = F({ prop: 'gridArea' });
...
const io = F({ prop: 'color', themeKey: 'palette', transform: Me }),
  ...
  lo = F({ prop: 'backgroundColor', themeKey: 'palette', transform: Me });
er(io, co, lo);
function re(e) {
  return e <= 1 && e !== 0 ? `${e * 100}%` : e;
}
const uo = F({ prop: 'width', transform: re }),
  Nr = (e) => {
...
const fo = F({ prop: 'minWidth', transform: re }),
  po = F({ prop: 'height', transform: re }),
  ho = F({ prop: 'maxHeight', transform: re }),
  mo = F({ prop: 'minHeight', transform: re });
...
function xo() {
  function e(n, t, o, a) {
    const s = { [n]: t, theme: o },
      i = a[n];
    if (!i) return { [n]: t };
    const { cssProperty: l = n, themeKey: c, transform: f, style: h } = i;
          ...
          if (v != null)
            if (typeof v == 'object')
              if (s[y]) u = Le(u, e(y, v, a, s));
                ...
                yo(p, v) ? (u[y] = r({ sx: v, theme: a })) : (u = Le(u, p));
              }
...
function Tr(e = {}, ...r) {
  ...
  return (
    ...
    (c.unstable_sxConfig = A({}, Er, s == null ? void 0 : s.unstable_sxConfig)),
      ...
      i &&
        i.forEach((l) => {
          ...
          Object.keys(l.props).forEach((f) => {
            a[f] !== l.props[f] && e[f] !== l.props[f] && (c = !1);
          }),
            c && s.push(r[Pn(l.props)]);
        }),
      s
    );
  };
...
function Io(e = {}) {
  ...
  return (
    ...
    (s, i = {}) => {
      ...
      const { name: l, slot: c, skipVariantsResolver: f, skipSx: h, overridesResolver: u } = i,
        y = ye(i, Co),
        v = f !== void 0 ? f : (c && c !== 'Root') || !1,
        p = h || !1;
      let d;
      process.env.NODE_ENV !== 'production' && l && (d = `${l}-${Mo(c || 'Root')}`);
      let E = Ke;
      c === 'Root' ? (E = t) : c ? (E = o) : _o(s) && (E = void 0);
      const W = hr(s, A({ shouldForwardProp: E, label: d }, y)),
        H = ($, ...m) => {
          const X = m
            ? m.map((j) =>
...
function zo(e) {
  ...
  return e.type === 'hsla' && ((i += 'a'), l.push(r[3])), Cr({ type: i, values: l });
}
function en(e) {
  e = je(e);
...
function aa(e) {
  const { mode: r = 'light', contrastThreshold: n = 3, tonalOffset: t = 0.2 } = e,
    ...
    f = e.warning || oa(r);
  function h(p) {
    const d = rn(p, pr.text.primary) >= n ? pr.text.primary : nn.text.primary;
    if (process.env.NODE_ENV !== 'production') {
      const E = rn(p, d);
      E < 3 &&
        console.error(
  ...
  return A(
    {
      ...
      create: (o = ['all'], a = {}) => {
        const { duration: s = n.standard, easing: i = r.easeInOut, delay: l = 0 } = a,
          c = ye(a, ha);
        if (process.env.NODE_ENV !== 'production') {
          ...
          !f(o) &&
            ...
            !h(l) && !f(l) && console.error('MUI: Argument "delay" must be a number or a string.'),
            typeof a != 'object' &&
              console.error(
                [
...
`),
        ...
        return (Array.isArray(o) ? o : [o])
          .map(
            (f) =>
              `${f} ${typeof s == 'string' ? s : sn(s)} ${i} ${typeof l == 'string' ? l : sn(l)}`,
          )
          .join(',');
      },
    },
    ...
    return {
      ...
      fontSize: {
        ...
        small:
          ...
          '1.25rem',
        medium:
          ((i = e.typography) == null || (l = i.pxToRem) == null ? void 0 : l.call(i, 24)) ||
          '1.5rem',
        large:
...
const Pa = Aa(S.jsx('path', { d: 'M3 18h18v-2H3v2zm0-5h18v-2H3v2zm0-7v2h18V6H3z' }), 'Menu');
function Ma({ menu: e, dataHandler: r, commandHandler: n, className: t, children: o }) {
