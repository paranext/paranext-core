...
const bn = 1,
  ...
  Ir = (e, r) => ({ ...e, verseNum: Math.max(vn, e.verseNum + r) });
function We({
  variant: e = 'outlined',
  isDisabled: r = !1,
  hasError: n = !1,
...
function Qn({ scrRef: e, handleSubmit: r }) {
  ...
  return S.jsxs(S.Fragment, {
    children: [
      ...
      S.jsx(ke, { onClick: () => r(Ir(e, -1)), isDisabled: e.verseNum <= vn, children: '<' }),
...
K.filterProps = Qe;
process.env.NODE_ENV !== 'production' && Ft.reduce((e, r) => ((e[r] = ve), e), {});
function qt(e = 8) {
  if (e.mui) return e;
...
const Gt = F({ prop: 'border', themeKey: 'borders', transform: de }),
  ...
  Kt = F({ prop: 'borderRight', themeKey: 'borders', transform: de }),
  Wt = F({ prop: 'borderBottom', themeKey: 'borders', transform: de }),
  Xt = F({ prop: 'borderLeft', themeKey: 'borders', transform: de }),
...
const fo = F({ prop: 'color', themeKey: 'palette', transform: Ie }),
  po = F({ prop: 'bgcolor', cssProperty: 'backgroundColor', themeKey: 'palette', transform: Ie }),
  ho = F({ prop: 'backgroundColor', themeKey: 'palette', transform: Ie });
er(fo, po, ho);
function re(e) {
...
const ko = {
    ...
    color: { themeKey: 'palette', transform: Ie },
    bgcolor: { themeKey: 'palette', cssProperty: 'backgroundColor', transform: Ie },
    backgroundColor: { themeKey: 'palette', transform: Ie },
    p: { style: K },
    pt: { style: K },
    pr: { style: K },
    pb: { style: K },
          ...
          if (v != null)
            if (typeof v == 'object')
              if (s[y]) u = Le(u, e(y, v, a, s));
                ...
                So(h, v) ? (u[y] = r({ sx: v, theme: a })) : (u = Le(u, h));
              }
  ...
  return (
    ...
    (s, c = {}) => {
      ...
      const { name: i, slot: l, skipVariantsResolver: d, skipSx: p, overridesResolver: u } = c,
        ...
        h = p || !1;
      let f;
      process.env.NODE_ENV !== 'production' && i && (f = `${i}-${Do(l || 'Root')}`);
      let E = Ke;
      l === 'Root' ? (E = t) : l ? (E = o) : Po(s) && (E = void 0);
      const W = _t(s, A({ shouldForwardProp: E, label: f }, y)),
        U = ($, ...m) => {
          const X = m
            ? m.map((j) =>
...
function _a({ props: e, name: r }) {
  return Lo({ props: e, name: r, defaultTheme: In, themeId: Mn });
}
const Oa = (e) => Ke(e) && e !== 'classes',
  Ra = zo({ themeId: Mn, defaultTheme: In, rootShouldForwardProp: Oa }),
  $a = Ra;
function Aa(e) {
      ...
      children: S.jsxs(Q.Toolbar, {
        ...
        children: [
          e.menu
            ...
            : null,
          e.children
            ? S.jsx('div', { style: { padding: 10, paddingTop: 10 }, children: e.children })
            : null,
          e.menu
            ? S.jsx(Q.Drawer, {
                ...
                PaperProps: {
                  style: { top: '24px', height: 'auto', position: 'absolute', width: 'auto' },
                },
                children: S.jsx(Sn, {
