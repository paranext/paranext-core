...
function zn({ commandHandler: e, name: r, className: n, items: t }) {
...
function dn({ commandHandler: e, className: r, columns: n }) {
  return S.jsx(Q.Grid, {
    ...
    columns: n.length,
    children: n.map((t) =>
      S.jsx(zn, { commandHandler: e, name: t.name, className: r, items: t.items }),
    ),
  });
}
var Vn = Object.defineProperty,
  Ln = (e, r, n) =>
    r in e ? Vn(e, r, { enumerable: !0, configurable: !0, writable: !0, value: n }) : (e[r] = n),
  $ = (e, r, n) => (Ln(e, typeof r != 'symbol' ? r + '' : r, n), n);
const we = [
    'GEN',
    'EXO',
    'LEV',
...
let oe = Ne;
$(oe, 'Original', new Ne(ve.Original)),
  $(oe, 'Septuagint', new Ne(ve.Septuagint)),
  $(oe, 'Vulgate', new Ne(ve.Vulgate)),
  $(oe, 'English', new Ne(ve.English)),
  $(oe, 'RussianProtestant', new Ne(ve.RussianProtestant)),
  $(oe, 'RussianOrthodox', new Ne(ve.RussianOrthodox));
function Or(e, r) {
  const n = r[0];
...
let he = O;
$(he, 'defaultVersification', oe.English),
  $(he, 'verseRangeSeparator', '-'),
  $(he, 'verseSequenceIndicator', ','),
  $(he, 'verseRangeSeparators', [O.verseRangeSeparator]),
  $(he, 'verseSequenceIndicators', [O.verseSequenceIndicator]),
  $(he, 'chapterDigitShifter', 1e3),
  $(he, 'bookDigitShifter', O.chapterDigitShifter * O.chapterDigitShifter),
  $(he, 'bcvMaxValue', O.chapterDigitShifter - 1),
  $(he, 'ValidStatusType', bn);
...
function et({ scrRef: e, handleSubmit: r }) {
  const [n, t] = ie.useState(Rr(e.bookNum)),
    o = (i) => {
      t(Rr(i.bookNum)), r(i);
    },
    a = (i, c) => {
  ...
  return S.jsxs(S.Fragment, {
    children: [
      S.jsx(ln, {
        ...
        isClearable: !1,
        width: 200,
        checkIsOptionEqualToValue: Qn,
      }),
      S.jsx(Se, { onClick: () => o(Ar(e, -1)), isDisabled: e.bookNum <= vn, children: '<' }),
      S.jsx(Se, {
        onClick: () => o(Ar(e, 1)),
...
const ot = ({ onChange: e, disabled: r, checked: n, ...t }) => {
  function o(a) {
...
function at({
  ...
  const ue = ie.useMemo(() => {
    ...
    return f ? [{ ...Cr.SelectColumn, minWidth: h }, ...se] : se;
  }, [f, e]);
  return S.jsx(Cr, {
    columns: ue,
...
function be(e, r, n) {
  ...
  if (typeof r == 'object') {
    ...
    return Object.keys(r).reduce((s, l) => {
      if (Object.keys(a.values || vr).indexOf(l) !== -1) {
        const i = a.up(l);
        s[i] = n(r[l], l);
      } else {
        const i = l;
          ...
          if (v != null)
            if (typeof v == 'object')
              if (s[y]) u = Le(u, e(y, v, a, s));
                ...
                So(p, v) ? (u[y] = r({ sx: v, theme: a })) : (u = Le(u, p));
              }
...
function Nr(e = {}, ...r) {
  ...
  return (
    ...
    (c.unstable_sxConfig = A({}, kr, s == null ? void 0 : s.unstable_sxConfig)),
    (c.unstable_sx = function (h) {
      return Sr({ sx: h, theme: this });
    }),
    c
  );
}
  ...
  return (
    ...
    (s, l = {}) => {
      ...
      const { name: i, slot: c, skipVariantsResolver: f, skipSx: h, overridesResolver: u } = l,
        ...
        p = h || !1;
      let d;
      process.env.NODE_ENV !== 'production' && i && (d = `${i}-${Do(c || 'Root')}`);
      let E = Ke;
      c === 'Root' ? (E = t) : c ? (E = o) : Po(s) && (E = void 0);
      const W = _t(s, A({ shouldForwardProp: E, label: d }, y)),
        U = (R, ...m) => {
          const X = m
            ? m.map((j) =>
          ...
          i &&
              ...
              if (ue) {
                ...
                return (
                  Object.entries(ue).forEach(([G, de]) => {
                    se[G] = typeof de == 'function' ? de(A({}, j, { theme: Y })) : de;
                  }),
                  u(j, se)
                );
              }
            ...
            i &&
              ...
              X.push((j) => {
                const Y = ze(A({}, j, { defaultTheme: n, themeId: r }));
                return jo(j, Io(i, Y), Y, i);
              }),
            p || X.push(a);
          const le = X.length - m.length;
          if (Array.isArray(R) && le > 0) {
            const j = new Array(le).fill('');
            (ne = [...R, ...j]), (ne.raw = [...R.raw, ...j]);
          } else
            typeof R == 'function' &&
              R.__emotion_real !== R &&
              (ne = (j) => R(A({}, j, { theme: ze(A({}, j, { defaultTheme: n, themeId: r })) })));
          const ae = W(ne, ...X);
          if (process.env.NODE_ENV !== 'production') {
            let j;
            i && (j = `${i}${c || ''}`),
...
function Uo(e) {
  ...
  return e.type === 'hsla' && ((l += 'a'), i.push(r[3])), Er({ type: l, values: i });
}
function Qr(e) {
  e = je(e);
  let r = e.type === 'hsl' || e.type === 'hsla' ? je(Uo(e)).values : e.values;
  return (
    (r = r.map(
      (n) => (
...
const theme2 = createTheme({ palette: {
  primary: { main: green[500] },
      ...
      return (
        nn(p, 'light', W, t), nn(p, 'dark', U, t), p.contrastText || (p.contrastText = h(p.main)), p
      );
    },
    y = { dark: dr, light: rn };
  return (
...
const Oa = (e) => Ke(e) && e !== 'classes',
  $a = zo({ themeId: In, defaultTheme: Mn, rootShouldForwardProp: Oa }),
  Ra = $a;
function Aa(e) {
...
function Da({ menu: e, dataHandler: r, commandHandler: n, className: t, children: o }) {
