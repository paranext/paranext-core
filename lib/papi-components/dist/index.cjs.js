...
function Zn({ scrRef: e, handleSubmit: r }) {
  const [n, t] = Pe.useState($r(e.bookNum)),
    o = (i) => {
      t($r(i.bookNum)), r(i);
    },
    a = (i, l) => {
  ...
  return S.jsxs(S.Fragment, {
    children: [
      ...
      S.jsx(ke, { onClick: () => o(Ar(e, -1)), isDisabled: e.bookNum <= bn, children: '<' }),
      S.jsx(ke, {
        onClick: () => o(Ar(e, 1)),
      ...
      S.jsx(ke, { onClick: () => r(Pr(e, -1)), isDisabled: e.chapterNum <= yn, children: '<' }),
      S.jsx(ke, {
        onClick: () => r(Pr(e, 1)),
      ...
      S.jsx(ke, { onClick: () => r(Mr(e, -1)), isDisabled: e.verseNum <= vn, children: '<' }),
      S.jsx(ke, { onClick: () => r(Mr(e, 1)), children: '>' }),
    ],
  });
}
function Qn({
...
function et({ isChecked: e, isDisabled: r = !1, hasError: n = !1, className: t, onChange: o }) {
  ...
  const le = Pe.useMemo(() => {
    const se = e.map((J) =>
      typeof J.editable == 'function'
        ? { ...J, editable: (ee) => !!J.editable(ee), renderEditCell: J.renderEditCell || Ir }
...
function ot({ commandHandler: e, name: r, className: n, items: t }) {
  return S.jsxs(Q.Grid, {
    ...
    children: [
      ...
      t.map((o, a) =>
        S.jsx(kn, { className: `papi-menu-item ${o.className}`, onClick: () => e(o), ...o }, a),
      ),
    ],
  });
}
function Sn({ commandHandler: e, className: r, columns: n }) {
  return S.jsx(Q.Grid, {
    ...
    columns: n.length,
    children: n.map((t) =>
      S.jsx(ot, { commandHandler: e, name: t.name, className: r, items: t.items }),
    ),
  });
}
function A() {
...
function En() {
  return (
    Dr ||
      ((Dr = 1), process.env.NODE_ENV === 'production' ? (qe.exports = st()) : (qe.exports = it())),
    qe.exports
  );
}
/*
  ...
  return (
    (lr = function (c, i) {
      ...
      function ne(g) {
        ...
        function x(_, T, N, P, w) {
          for (var C = _[T], M = 0; M < g.length; M++) if (v(C, g[M])) return null;
      ...
      function le(g) {
        function x(_, T, N, P, w) {
          ...
          for (var B in g) {
            var I = g[B];
            if (typeof I != 'function') return Y(N, P, w, B, fe(I));
      ...
      function se(g) {
        function x(_, T, N, P, w) {
          ...
          for (var I in B) {
            var Z = g[I];
            if (t(g, I) && typeof Z != 'function') return Y(N, P, w, I, fe(Z));
            if (!Z)
              return new h(
                'Invalid ' +
                  P +
          ...
          case 'object':
            ...
            if (x) {
              var _ = x.call(g),
                T;
              if (x !== g.entries) {
                for (; !(T = _.next()).done; ) if (!J(T.value)) return !1;
              } else
                for (; !(T = _.next()).done; ) {
                  var N = T.value;
                  if (N && !J(N[1])) return !1;
...
process.env.NODE_ENV === 'production' ? (pr.exports = mt()) : (pr.exports = gt());
var qr = pr.exports;
...
const Dt = { m: 'margin', p: 'padding' },
  zt = { t: 'Top', r: 'Right', b: 'Bottom', l: 'Left', x: ['Left', 'Right'], y: ['Top', 'Bottom'] },
...
K.filterProps = Qe;
process.env.NODE_ENV !== 'production' && Lt.reduce((e, r) => ((e[r] = ve), e), {});
function Ht(e = 8) {
  if (e.mui) return e;
...
const Gt = F({ prop: 'border', themeKey: 'borders', transform: de }),
  Jt = F({ prop: 'borderTop', themeKey: 'borders', transform: de }),
  qt = F({ prop: 'borderRight', themeKey: 'borders', transform: de }),
  Kt = F({ prop: 'borderBottom', themeKey: 'borders', transform: de }),
  Wt = F({ prop: 'borderLeft', themeKey: 'borders', transform: de }),
  Xt = F({ prop: 'borderColor', themeKey: 'palette' }),
  Yt = F({ prop: 'borderTopColor', themeKey: 'palette' }),
  Zt = F({ prop: 'borderRightColor', themeKey: 'palette' }),
  Qt = F({ prop: 'borderBottomColor', themeKey: 'palette' }),
  eo = F({ prop: 'borderLeftColor', themeKey: 'palette' }),
  rr = (e) => {
...
er(Gt, Jt, qt, Kt, Wt, Xt, Yt, Zt, Qt, eo, rr);
const nr = (e) => {
...
const ro = F({ prop: 'gridColumn' }),
  no = F({ prop: 'gridRow' }),
  to = F({ prop: 'gridAutoFlow' }),
  oo = F({ prop: 'gridAutoColumns' }),
  ao = F({ prop: 'gridAutoRows' }),
  so = F({ prop: 'gridTemplateColumns' }),
  io = F({ prop: 'gridTemplateRows' }),
  co = F({ prop: 'gridTemplateAreas' }),
  lo = F({ prop: 'gridArea' });
er(nr, tr, or, ro, no, to, oo, ao, so, io, co, lo);
function Me(e, r) {
  return r === 'grey' ? r : e;
}
const uo = F({ prop: 'color', themeKey: 'palette', transform: Me }),
  fo = F({ prop: 'bgcolor', cssProperty: 'backgroundColor', themeKey: 'palette', transform: Me }),
  po = F({ prop: 'backgroundColor', themeKey: 'palette', transform: Me });
er(uo, fo, po);
function re(e) {
  return e <= 1 && e !== 0 ? `${e * 100}%` : e;
}
const ho = F({ prop: 'width', transform: re }),
  xr = (e) => {
...
const mo = F({ prop: 'minWidth', transform: re }),
  go = F({ prop: 'height', transform: re }),
  bo = F({ prop: 'maxHeight', transform: re }),
  yo = F({ prop: 'minHeight', transform: re });
F({ prop: 'size', cssProperty: 'width', transform: re });
F({ prop: 'size', cssProperty: 'height', transform: re });
const vo = F({ prop: 'boxSizing' });
er(ho, xr, mo, go, bo, yo, vo);
const xo = {
          ...
          if (v != null)
            if (typeof v == 'object')
              if (s[y]) u = Le(u, e(y, v, a, s));
                ...
                ko(h, v) ? (u[y] = r({ sx: v, theme: a })) : (u = Le(u, h));
              }
...
$n.filterProps = ['sx'];
const Sr = $n,
  Eo = ['breakpoints', 'palette', 'spacing', 'shape'];
function Nr(e = {}, ...r) {
...
const Ro = ['name', 'slot', 'skipVariantsResolver', 'skipSx', 'overridesResolver'];
function $o(e) {
  return Object.keys(e).length === 0;
}
function Ao(e) {
...
const jo = Nr(),
  Bo = (e) => e.charAt(0).toLowerCase() + e.slice(1);
...
function Do(e = {}) {
  ...
  return (
    (a.__mui_systemSx = !0),
    (s, c = {}) => {
      _t(s, ($) => $.filter((m) => !(m != null && m.__mui_systemSx)));
      const { name: i, slot: l, skipVariantsResolver: d, skipSx: p, overridesResolver: u } = c,
        y = be(c, Ro),
        v = d !== void 0 ? d : (l && l !== 'Root') || !1,
        h = p || !1;
      let f;
      process.env.NODE_ENV !== 'production' && i && (f = `${i}-${Bo(l || 'Root')}`);
      let E = Ke;
      l === 'Root' ? (E = t) : l ? (E = o) : Ao(s) && (E = void 0);
      const W = Ct(s, A({ shouldForwardProp: E, label: f }, y)),
        U = ($, ...m) => {
          const X = m
            ? m.map((j) =>
          ...
          i &&
            ...
            X.push((j) => {
              ...
              if (le) {
                const se = {};
                return (
                  Object.entries(le).forEach(([J, ue]) => {
                    se[J] = typeof ue == 'function' ? ue(A({}, j, { theme: Y })) : ue;
                  }),
                  u(j, se)
                );
              }
...
function Vo({ props: e, name: r, defaultTheme: n, themeId: t }) {
  let o = _o(n);
  return t && (o = o[t] || o), zo({ theme: o, name: r, props: e });
}
...
function Qr(e) {
  e = je(e);
  let r = e.type === 'hsl' || e.type === 'hsla' ? je(Fo(e)).values : e.values;
  return (
    (r = r.map(
      (n) => (
...
const Jo = { black: '#000', white: '#fff' },
  ...
  $e = ea,
  ra = ['mode', 'contrastThreshold', 'tonalOffset'],
  rn = {
    text: {
...
function G(...e) {
  return [
    `${e[0]}px ${e[1]}px ${e[2]}px ${e[3]}px rgba(0,0,0,${fa})`,
    `${e[4]}px ${e[5]}px ${e[6]}px ${e[7]}px rgba(0,0,0,${pa})`,
    `${e[8]}px ${e[9]}px ${e[10]}px ${e[11]}px rgba(0,0,0,${ha})`,
  ].join(',');
}
const ma = [
    'none',
...
const Ta = wa(),
  Mn = Ta,
  In = '$$material';
function Ca({ props: e, name: r }) {
  return Vo({ props: e, name: r, defaultTheme: Mn, themeId: In });
}
const _a = (e) => Ke(e) && e !== 'classes',
  Oa = Do({ themeId: In, defaultTheme: Mn, rootShouldForwardProp: _a }),
  Ra = Oa;
function $a(e) {
...
const Aa = [
  ...
  wr = Fe.forwardRef(function (r, n) {
    const t = Ca({ props: r, name: 'MuiSvgIcon' }),
      {
        children: o,
        className: a,
        color: s = 'inherit',
...
const ja = Ia(S.jsx('path', { d: 'M3 18h18v-2H3v2zm0-5h18v-2H3v2zm0-7v2h18V6H3z' }), 'Menu');
function Ba(e) {
  var a;
