          ...
          function ne() {
            {
              if ((F--, F === 0)) {
                ...
                Object.defineProperties(console, {
                  ...
                  error: A({}, T, { value: G }),
                  group: A({}, T, { value: $ }),
                  groupCollapsed: A({}, T, { value: j }),
                  groupEnd: A({}, T, { value: X }),
                });
              }
              F < 0 &&
      ...
      function A($) {
        switch (typeof $) {
          ...
          case 'boolean':
            return !$;
          case 'object':
            if (Array.isArray($)) return $.every(A);
            if ($ === null || l($)) return !0;
            var j = p($);
            if (j) {
              var X = j.call($),
                H;
              if (j !== $.entries) {
                for (; !(H = X.next()).done; ) if (!A(H.value)) return !1;
              } else
                for (; !(H = X.next()).done; ) {
                  var U = H.value;
                  if (U && !A(U[1])) return !1;
...
function wl(e) {
  ...
  return M(Rl, { styles: typeof t == 'function' ? (i) => t(Op(i) ? o : i) : t });
}
process.env.NODE_ENV !== 'production' &&
          ...
          l &&
            ...
            f.push((L) => {
              ...
              if (_) {
                const Y = {};
                return (
                  Object.entries(_).forEach(([B, A]) => {
                    Y[B] = typeof A == 'function' ? A(v({}, L, { theme: D })) : A;
                  }),
                  p(L, Y)
                );
              }
...
function Go(e) {
  ...
  return (
    ...
    M(E.Fragment, { children: E.cloneElement(t, g) })
  );
}
process.env.NODE_ENV !== 'production' &&
  (Go.propTypes = {
...
`),
            ...
            if (!z.contains(O.activeElement)) {
              ...
              if (
                ...
                const Y = !!(
                  ...
                  B = _[0],
                  A = _[_.length - 1];
                typeof B != 'string' && typeof A != 'string' && (Y ? A.focus() : B.focus());
              } else z.focus();
            }
          }
        },
  ...
  return Je(E.Fragment, {
    children: [
      M('div', { tabIndex: l ? 0 : -1, onFocus: C, ref: u, 'data-testid': 'sentinelStart' }),
      E.cloneElement(t, { ref: h, onFocus: S }),
      M('div', { tabIndex: l ? 0 : -1, onFocus: C, ref: d, 'data-testid': 'sentinelEnd' }),
    ],
  });
}
process.env.NODE_ENV !== 'production' &&
...
const Zo = E.forwardRef(function (t, o) {
  ...
  if (
    ...
    return M(E.Fragment, { children: r });
  }
  return M(E.Fragment, { children: s && Qs.createPortal(r, s) });
});
process.env.NODE_ENV !== 'production' &&
  (Zo.propTypes = {
    children: n.node,
...
`),
    ...
    return M(F, v({}, V, { children: typeof a == 'function' ? a(B) : a }));
  }),
...
const ob = new Jh(),
  Gl = E.forwardRef(function (t, o) {
    ...
    const {
      ...
      G = () => lt(A.current),
      $ = () => ((B.current.modalRef = F.current), (B.current.mountNode = A.current), B.current),
      j = () => {
      ...
      U = Et((ve) => {
        (A.current = ve), !(!ve || !F.current) && (f && H() ? j() : ho(F.current, se));
      }),
      ne = E.useCallback(() => {
        S.remove($(), se);
      }, [S, se]);
...
function db(e) {
  ...
  const ie = (Z) => (me) => {
      ...
      if (
        ...
        const ye = V.indexOf(A[be]);
        ee = ee < A[be] ? V[ye - 1] : V[ye + 1];
      }
      if (B) {
        i && (ee = ao(ee, A[be - 1] || -1 / 0, A[be + 1] || 1 / 0));
        const ye = ee;
        ee = gs({ values: A, newValue: ee, index: be });
        let Ee = be;
  ...
  const re = ({ finger: Z, move: me = !1 }) => {
      ...
      let Ne = 0;
      if (B) {
        me ? (Ne = le.current) : (Ne = vs(A, Ee)),
          i && (Ee = ao(Ee, A[Ne - 1] || -1 / 0, A[Ne + 1] || 1 / 0));
        const it = Ee;
        (Ee = gs({ values: A, newValue: Ee, index: Ne })),
...
` && (z.value += ' ');
      ...
      let A = Y;
      a && (A = Math.max(Number(a) * B, A)),
        i && (A = Math.min(Number(i) * B, A)),
        (A = Math.max(A, B));
      const F = A + (L === 'border-box' ? D + _ : 0),
        V = Math.abs(A - Y) <= 1;
  ...
  Bi = E.forwardRef(function (t, o) {
    ...
    return Je(
      ...
      v(
        ...
        h,
        g,
        { ownerState: y, children: [i, p ? M('title', { children: p }) : null] },
      ),
    );
  });
process.env.NODE_ENV !== 'production' &&
...
function Jn(e, t) {
  function o(r, i) {
    return M(Os, v({ 'data-testid': `${t}Icon`, ref: i }, r, { children: e }));
  }
  return (
...
`),
      ...
      M(Fb, v({ as: a, ownerState: d, className: Oe(p.root, i), ref: o }, u))
    );
  });
process.env.NODE_ENV !== 'production' &&
  (tc.propTypes = {
...
function nc(e) {
  ...
  return (
    ...
    M('span', { className: b, style: g, children: M('span', { className: y }) })
  );
}
process.env.NODE_ENV !== 'production' &&
  (nc.propTypes = {
    ...
    const m = E.useCallback(
      ...
      S = E.useCallback(
        (x = {}, f = {}, R = () => {}) => {
          ...
          if (z) (A = Math.sqrt((2 * _.width ** 2 + _.height ** 2) / 3)), A % 2 === 0 && (A += 1);
          else {
          ...
          x != null && x.touches
            ? y.current === null &&
              ((y.current = () => {
                m({ pulsate: w, rippleX: Y, rippleY: B, rippleSize: A, cb: R });
              }),
...
`),
    ...
    return Je(
      ...
      v(
        ...
        me,
        V,
        { children: [s, ie ? M(Yb, v({ ref: G, center: a }, B)) : null] },
      ),
    );
  });
process.env.NODE_ENV !== 'production' &&
...
const uv = ['className', 'color', 'component', 'disableGutters', 'disableSticky', 'inset'],
  ...
  qi = E.forwardRef(function (t, o) {
    const r = Xe({ props: t, name: 'MuiListSubheader' }),
      ...
      b = dv(p);
    return M(pv, v({ as: s, className: Oe(b.root, i), ref: o, ownerState: p }, d));
  });
  ...
  y &&
    (V =
      u && E.isValidElement(u)
        ? E.cloneElement(u, { className: Oe(u.props.className, A.deleteIcon), onClick: z })
        : M(mv, { className: Oe(A.deleteIcon), onClick: z }));
  let ae = null;
  i &&
    E.isValidElement(i) &&
    (ae = E.cloneElement(i, { className: Oe(A.avatar, i.props.className) }));
  let se = null;
  return (
    p &&
      E.isValidElement(p) &&
      (se = E.cloneElement(p, { className: Oe(A.icon, p.props.className) })),
    process.env.NODE_ENV !== 'production' &&
      ae &&
      se &&
      console.error(
    ...
    Je(
      ...
      v(
        ...
        F,
        f,
        { children: [ae || se, M(Ev, { className: Oe(A.label), ownerState: B, children: b }), V] },
      ),
    )
  );
});
...
function dc(e) {
  return M(wl, v({}, e, { defaultTheme: Or }));
}
process.env.NODE_ENV !== 'production' &&
  (dc.propTypes = {
    styles: n.oneOfType([
...
const _v = v({}, $t, De('MuiFilledInput', ['root', 'underline', 'input'])),
  Pt = _v,
  fc = Jn(M('path', { d: 'M7 10l5 5 5-5z' }), 'ArrowDropDown');
function Mv(e) {
...
const Dv = [
  ...
  mc = E.forwardRef(function (t, o) {
    ...
    const l = Xe({ props: t, name: 'MuiAutocomplete' }),
      {
        ...
        ChipProps: b,
        className: g,
        clearIcon: y = Is || (Is = M(av, { fontSize: 'small' })),
    ...
    if (ne && ue.length > 0) {
      ...
      Pe
        ? (mt = Pe(ue, Ie, et))
        : (mt = ue.map((ct, _t) => M(xv, v({ label: V(ct), size: Ze }, Ie({ index: _t }), b))));
    }
    if ($ > -1 && Array.isArray(mt)) {
      ...
      !it &&
        Ie > 0 &&
        ((mt = mt.splice(0, $)),
        mt.push(M('span', { className: nt.tag, children: F(Ie) }, mt.length)));
    }
    const qt =
        Te ||
        ((Ie) =>
          Je(
            'li',
            {
              children: [
                ...
                M(Kv, { className: nt.groupUl, ownerState: et, children: Ie.children }),
              ],
            },
            Ie.key,
          )),
      zt = W || ((Ie, ct) => M('li', v({}, Ie, { children: V(ct) }))),
      nn = (Ie, ct) => {
                ...
                Yt,
                {
                  ...
                  children: Je(
                    ...
                    v({ ownerState: et, as: le }, rn, {
                      ...
                      children: [
                        H && ht.length === 0
                          ? M(Wv, { className: nt.loading, ownerState: et, children: U })
                          : null,
                        ht.length === 0 && !B && !H
                          ? M(Hv, {
  ...
  hc = E.forwardRef(function (t, o) {
    const r = Xn(),
      ...
      z = R((A, F) => {
        ...
        (A.style.webkitTransition = r.transitions.create('opacity', V)),
          (A.style.transition = r.transitions.create('opacity', V)),
          d && d(A, F);
      }),
      L = R(p),
      D = R(h),
...
const ag = vc,
  ...
  yc = E.forwardRef(function (t, o) {
    const r = E.useContext(ag),
      ...
      R = lg(f),
      w = S && M(ug, { className: R.startIcon, ownerState: f, children: S }),
      z = g && M(dg, { className: R.endIcon, ownerState: f, children: g });
    return Je(
      cg,
      v(
        {
    ...
    const r = Xe({ props: t, name: 'MuiFormControl' }),
        ...
        return (
          i &&
            E.Children.forEach(i, (A) => {
              if (!Lr(A, ['Input', 'Select'])) return;
              const F = Lr(A, ['Select']) ? A.props.input : A;
              F && Ov(F.props) && (B = !0);
            }),
          B
        );
      ...
      [R, w] = E.useState(() => {
        ...
        return (
          i &&
            E.Children.forEach(i, (A) => {
              Lr(A, ['Input', 'Select']) && Ki(A.props, !0) && (B = !0);
            }),
          B
        );
      }),
  ...
  Rc = E.forwardRef(function (t, o) {
    ...
    return M(
      ...
      v({ as: s, ownerState: d, className: Oe(p.root, a), ref: o }, l, {
        children:
          i === ' ' ? As || (As = M('span', { className: 'notranslate', children: '​' })) : i,
      }),
    );
  });
process.env.NODE_ENV !== 'production' &&
...
const Fy = De('MuiNativeSelect', [
  ...
  zc = E.forwardRef(function (t, o) {
    ...
    return Je(E.Fragment, {
      children: [
        M(Vy, v({ ownerState: u, className: Oe(d.select, r), disabled: i, ref: s || o }, c)),
        t.multiple ? null : M(By, { as: a, ownerState: u, className: d.icon }),
      ],
    });
  });
process.env.NODE_ENV !== 'production' &&
...
`),
    ...
    const be = _.id || (C ? `mui-component-select-${C}` : void 0),
      fe = v({}, t, { variant: A, value: V, open: ve }),
      ue = i0(fe);
    return Je(E.Fragment, {
      children: [
        M(
        ...
        M(n0, { as: g, className: ue.icon, ownerState: fe }),
        M(
          Dy,
          v(
            {
    ...
    return M(E.Fragment, {
      children: E.cloneElement(
        ...
        v(
          ...
          { ref: ae, className: Oe(A.props.className, l) },
          !b && { variant: B },
          L,
        ),
      ),
  ...
  Qc = E.forwardRef(function (t, o) {
    ...
    return Je(
      ...
      v({ role: l, square: !0, elevation: 6, className: Oe(d.root, a), ownerState: u, ref: o }, c, {
        children: [
          M(R0, { className: d.message, ownerState: u, children: s }),
          i ? M(w0, { className: d.action, ownerState: u, children: i }) : null,
        ],
      }),
    );
  });
              ...
              v({}, B, {
                children: M(
                  ...
                  v(
                    ...
                    f,
                    { children: d || M($0, v({ message: h, action: s }, g)) },
                  ),
                ),
              }),
            ),
...
const A0 = De('MuiSwitch', [
  ...
  tu = E.forwardRef(function (t, o) {
    const r = Xe({ props: t, name: 'MuiSwitch' }),
      ...
      p = L0(d),
      b = M(V0, { className: p.thumb, ownerState: d });
    return Je(F0, {
      ...
      children: [
        ...
        M(z0, { className: p.track, ownerState: d }),
      ],
    });
  });
process.env.NODE_ENV !== 'production' &&
  ...
  nu = E.forwardRef(function (t, o) {
    ...
    return Je(
      ...
      v(
        ...
        {
          children: [
            x != null && x !== '' && M(dy, v({ htmlFor: U, id: oe }, m, { children: x })),
            F
              ? M(
                  p0,
...
function ru({
  ...
  if (t) {
    const p = o === Tn.Before || o === Tn.Above,
      ...
      y = g ? b : M('div', { children: b }),
      h = g ? u : M('div', { children: u });
    d = Je($c, {
...
function iu({
  ...
  return M(Gv, {
    ...
    onBlur: p,
    renderInput: (b) =>
      M(ou, { ...b, error: r, fullWidth: i, disabled: t, label: e, style: { width: a } }),
  });
}
const Qn = [
...
function X0({ scrRef: e, handleSubmit: t }) {
  ...
  return Je(pu, {
    children: [
      ...
      M(On, { onClick: () => i(Gs(e, -1)), isDisabled: e.book <= oa, children: '<' }),
      M(On, { onClick: () => i(Gs(e, 1)), isDisabled: e.book >= Ks().length, children: '>' }),
      M(or, {
      ...
      M(On, { onClick: () => t(Xs(e, -1)), isDisabled: e.chapter <= su, children: '<' }),
      M(On, { onClick: () => t(Xs(e, 1)), isDisabled: e.chapter >= G0(e.book), children: '>' }),
      M(or, {
        className: 'papi-ref-selector chapter-verse',
        label: 'Verse',
        value: e.verse,
      ...
      M(On, { onClick: () => t(Js(e, -1)), isDisabled: e.verse <= lu, children: '<' }),
      M(On, { onClick: () => t(Js(e, 1)), children: '>' }),
    ],
  });
}
function J0({
...
function eE({ onRowChange: e, row: t, column: o }) {
  ...
  return M(or, { defaultValue: t[o.key], onChange: r });
}
const tE = ({ onChange: e, disabled: t, checked: o, ...r }) => {
  function i(a) {
    e(a.target.checked, a.nativeEvent.shiftKey);
  }
  return M(ru, { ...r, isChecked: o, isDisabled: t, onChange: i });
};
function nE({
  columns: e,
  sortColumns: t,
  ...
  const Y = Ce.useMemo(() => (d ? [{ ...ia.SelectColumn, minWidth: p }, ...e] : e), [d, e]);
  return M(ia, {
    columns: Y,
