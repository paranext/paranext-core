...
const _ = class {
  ...
  set book(r) {
    this.bookNum = le.bookIdToNumber(r);
  }
  get chapter() {
  ...
  get internalValid() {
    return this.versification == null
      ? 1
      : this._bookNum <= 0 || this._bookNum > le.lastBook
      ? 2
      : 0;
  }
  ...
  updateInternal(r, n, t) {
    (this.bookNum = le.bookIdToNumber(r)), (this.chapter = n), (this.verse = t);
  }
};
let he = _;
...
function $r() {
  return le.allBookIds.map((e) => ({ bookId: e, label: le.bookIdToEnglishName(e) }));
}
function Ar(e) {
  return { bookId: le.bookNumberToId(e), label: le.bookNumberToEnglishName(e) };
}
const xn = 1,
  Yn = vn.length - 1,
  kn = 1,
...
function Qn({ scrRef: e, handleSubmit: r, id: n }) {
  const [t, o] = ce.useState(Ar(e.bookNum)),
    a = (i) => {
      o(Ar(i.bookNum)), r(i);
    },
    a = (i, c) => {
      const p = { bookNum: ce.bookIdToNumber(c.bookId), chapterNum: 1, verseNum: 1 };
      o(p);
    },
    c = (i) => {
...
function _t(e) {
  ...
  return A({ keys: s, values: a, up: l, down: i, between: c, only: f, not: p, unit: n }, o);
}
...
const Ht = H({ prop: 'border', themeKey: 'borders', transform: pe }),
  Ut = H({ prop: 'borderTop', themeKey: 'borders', transform: pe }),
  Gt = H({ prop: 'borderRight', themeKey: 'borders', transform: pe }),
  Jt = H({ prop: 'borderBottom', themeKey: 'borders', transform: pe }),
  qt = H({ prop: 'borderLeft', themeKey: 'borders', transform: pe }),
...
const fo = H({ prop: 'width', transform: ne }),
  kr = (e) => {
...
const po = H({ prop: 'minWidth', transform: ne }),
  ho = H({ prop: 'height', transform: ne }),
  mo = H({ prop: 'maxHeight', transform: ne }),
  go = H({ prop: 'minHeight', transform: ne });
...
const yo = {
    border: { themeKey: 'borders', transform: pe },
          ...
          if (b != null)
            if (typeof b == 'object')
              if (s[v]) l = Le(l, e(v, b, a, s));
                ...
                vo(h, v) ? (u[y] = r({ sx: v, theme: a })) : (u = Le(u, h));
              }
          ...
          u &&
            ...
            X.push((B) => {
              ...
              if (de) {
                const fe = {};
                return (
                  Object.entries(de).forEach(([ee, K]) => {
                    fe[ee] = typeof K == 'function' ? K(A({}, B, { theme: Y })) : K;
                  }),
                  l(B, fe)
                );
              }
...
function Na(e = {}, ...r) {
  ...
  if (
    ((c = me(c, s)), (c = r.reduce((f, p) => me(f, p), c)), process.env.NODE_ENV !== 'production')
  ) {
    const f = [
        'active',
        'checked',
          ...
          children: [
            ...
            h
              ? S.jsx(Q.Drawer, {
                  ...
                  children: S.jsx(fn, { commandHandler: v, columns: h.columns }),
                })
              : null,
          ],
        }),
