...
function q({
  ...
  if (n) {
    const k = r === C.Before || r === C.Above,
      ...
      T = E ? v : c.jsx('div', { children: v }),
      A = E ? u : c.jsx('div', { children: u });
    b = c.jsxs(m.FormLabel, {
...
var Ne = Object.defineProperty,
  ...
  s = (e, n, r) => (ke(e, typeof n != 'symbol' ? n + '' : n, r), r);
const S = [
    'GEN',
    'EXO',
    'LEV',
  ...
  D = Te();
function B(e, n = !0) {
  return n && (e = e.toUpperCase()), e in D ? D[e] : 0;
}
function I(e) {
  return B(e) > 0;
}
...
function W(e) {
  const n = typeof e == 'number' ? R(e) : e;
  return I(n) && !V.includes(n);
}
function Be(e) {
  const n = typeof e == 'number' ? R(e) : e;
  return I(n) && V.includes(n);
...
const N = {
  ...
  extraBooks: Se,
  bookNumberToId: R,
  bookNumberToEnglishName: Z,
  bookIdToEnglishName: Ee,
  isCanonical: W,
  isExtraMaterial: Be,
  isObsolete: _e,
};
...
const Ae = (e) => {
  ...
  oe = (e) => {
    var n;
    return ((n = Y[e]) == null ? void 0 : n.chapters) ?? -1;
  },
  P = (e, n) => ({
    bookNum: Math.max(ee, Math.min(e.bookNum + n, Oe)),
    chapterNum: 1,
    verseNum: 1,
  }),
  X = (e, n) => ({
    ...e,
    chapterNum: Math.min(Math.max(ne, e.chapterNum + n), oe(e.bookNum)),
    verseNum: 1,
  }),
  j = (e, n) => ({ ...e, verseNum: Math.max(re, e.verseNum + n) });
function M({
  variant: e = 'outlined',
  isDisabled: n = !1,
  hasError: r = !1,
...
function Ve({ scrRef: e, handleSubmit: n }) {
  const r = (i) => {
      n(i);
    },
    o = (i, h) => {
      const u = { bookNum: N.bookIdToNumber(h.bookId), chapterNum: 1, verseNum: 1 };
      r(u);
    },
    t = (i) => {
  ...
  return c.jsxs(c.Fragment, {
    children: [
      c.jsx(F, {
        ...
        value: G.useMemo(() => O()[e.bookNum - 1], [e.bookNum]),
        options: O(),
        onChange: o,
        isClearable: !1,
        width: 200,
      }),
      c.jsx(y, { onClick: () => r(P(e, -1)), isDisabled: e.bookNum <= ee, children: '<' }),
      c.jsx(y, { onClick: () => r(P(e, 1)), isDisabled: e.bookNum >= O().length, children: '>' }),
      c.jsx(M, {
      ...
      c.jsx(y, { onClick: () => n(X(e, -1)), isDisabled: e.chapterNum <= ne, children: '<' }),
      c.jsx(y, {
        onClick: () => n(X(e, 1)),
        isDisabled: e.chapterNum >= oe(e.bookNum),
        children: '>',
      }),
      c.jsx(M, {
        className: 'papi-ref-selector chapter-verse',
      ...
      c.jsx(y, { onClick: () => n(j(e, -1)), isDisabled: e.verseNum <= re, children: '<' }),
      c.jsx(y, { onClick: () => n(j(e, 1)), children: '>' }),
    ],
  });
}
function Ie({
...
function Re({ isChecked: e, isDisabled: n = !1, hasError: r = !1, className: o, onChange: t }) {
  return c.jsx(m.Switch, {
    checked: e,
    disabled: n,
...
function L({ onRowChange: e, row: n, column: r }) {
  const o = (t) => {
    e({ ...n, [r.key]: t.target.value });
  };
  return c.jsx(M, { defaultValue: n[r.key], onChange: o });
}
const De = ({ onChange: e, disabled: n, checked: r, ...o }) => {
  function t(l) {
    e(l.target.checked, l.nativeEvent.shiftKey);
  }
  return c.jsx(q, { ...o, isChecked: r, isDisabled: n, onChange: t });
};
function He({
  columns: e,
  sortColumns: n,
  ...
  const me = G.useMemo(() => {
    const J = e.map((g) =>
      typeof g.editable == 'function'
        ? { ...g, editable: (fe) => !!g.editable(fe), renderEditCell: g.renderEditCell || L }
    ...
    return b ? [{ ...z.SelectColumn, minWidth: k }, ...J] : J;
  }, [b, e]);
  return c.jsx(z, {
    columns: me,
    defaultColumnOptions: { width: t, minWidth: l, maxWidth: i, sortable: h, resizable: d },
    sortColumns: n,
    onSortColumnsChange: r,
    onColumnResize: o,
    rows: u,
    ...
    onPaste: be,
    onScroll: pe,
    renderers: { renderCheckbox: De },
    className: `${ge ?? 'rdg-light'}`,
  });
}
exports.Button = y;
exports.Checkbox = q;
