...
` + de[Re].replace(' at new ', ' at ');
          ...
          var un = function (O, q, ce, P, N, Y, ee) {
            var de = { $$typeof: t, type: O, key: q, ref: ce, props: ee, _owner: Y };
            return (
              (de._store = {}),
...
process.env.NODE_ENV === 'production' ? (Hr.exports = ou()) : (Hr.exports = ru());
var ci = Hr.exports;
...
process.env.NODE_ENV === 'production' ? (Yr.exports = $u()) : (Yr.exports = Pu());
var ba = Yr.exports;
...
function to(e, t) {
  return sd(ir('', null, null, '', null, null, 0), e, { length: -e.length }, t);
}
function dd() {
  return ct;
}
      ...
      case 0:
        switch (S) {
          ...
          case 59 + d:
            g > 0 &&
              Gt(w) - f &&
              ko(g > 32 ? Ca(w + ';', r, o, f - 1) : Ca(qe(w, ' ', '') + ';', r, o, f - 2), c);
            break;
          case 59:
            w += ';';
          default:
...
function gd(e, t, o) {
  return ir(e, t, o, mi, or(dd()), bo(e, 2, -2), 0);
}
function Ca(e, t, o, r) {
...
process.env.NODE_ENV === 'production' ? (Zr.exports = Ad()) : (Zr.exports = Dd());
var Ld = Zr.exports,
  vl = Ld,
...
st.propTypes =
  process.env.NODE_ENV !== 'production' ? pr.reduce((e, t) => ((e[t] = bn), e), {}) : {};
st.filterProps = pr;
...
fr.propTypes = process.env.NODE_ENV !== 'production' ? { borderRadius: bn } : {};
fr.filterProps = ['borderRadius'];
ur($p, Pp, Np, kp, Ip, _p, Mp, Ap, Dp, Lp, fr);
const mr = (e) => {
...
mr.propTypes = process.env.NODE_ENV !== 'production' ? { gap: bn } : {};
mr.filterProps = ['gap'];
const hr = (e) => {
...
hr.propTypes = process.env.NODE_ENV !== 'production' ? { columnGap: bn } : {};
...
br.propTypes = process.env.NODE_ENV !== 'production' ? { rowGap: bn } : {};
...
const Fp = Ke({ prop: 'gridColumn' }),
  ...
  Hp = Ke({ prop: 'gridTemplateAreas' }),
  qp = Ke({ prop: 'gridArea' });
ur(mr, hr, br, Fp, jp, Vp, zp, Bp, Up, Wp, Hp, qp);
function zn(e, t) {
  return t === 'grey' ? t : e;
}
...
function ot(...e) {
  return [
    `${e[0]}px ${e[1]}px ${e[2]}px ${e[3]}px rgba(0,0,0,${Hf})`,
...
function Xe({ props: e, name: t }) {
  return Nf({ props: e, name: t, defaultTheme: gr });
}
const tn = (e) => co(e) && e !== 'classes',
  Ii = co,
  am = $f({ defaultTheme: gr, rootShouldForwardProp: tn }),
  he = am,
  sm = (e) => {
    let t;
...
function Po(e) {
  for (var t = Ft(e), o = ns(e); o && Mm(o) && Ht(o).position === 'static'; ) o = ns(o);
...
function is(e, t, o) {
  return t === Ml ? oi(Gm(e, o)) : Pn(t) ? Jm(t, o) : oi(Xm(vn(e)));
}
function Zm(e) {
  var t = po(xr(e)),
        ...
        switch (o) {
          ...
          case 'phase':
            ti.indexOf(t.phase) < 0 &&
              console.error(
                pn(yn, t.name, '"phase"', 'either ' + ti.join(', '), '"' + String(t.phase) + '"'),
              );
            break;
          case 'fn':
      ...
      g = {
        ...
        setOptions: function (C) {
          ...
          if (
            ...
            if ((Oh(E), Ut(d.options.placement) === yr)) {
...
var wh = [qm, uh, Wm, _m, lh, oh, fh, Vm, ih],
...
`),
  ...
  Wl = x.forwardRef(function (t, o) {
    ...
    if (a) w = a;
      ...
      const A = Jo(r);
      w = A && Er(A) ? ft(A).body : ft(null).body;
    }
...
function ob(e) {
  ...
  const oe = ({ finger: Z, move: fe = !1 }) => {
    ...
    k = Nt((Z) => {
      ...
      Mo({ sliderRef: H, activeIndex: be, setActive: E }),
        _(ge),
        !w && L.current > Jh && V(!0),
        K && ge !== A && K(Z, ge, be);
    }),
    ...
    I = Nt((Z) => {
      ...
      if (ge !== !1) {
        ...
        Mo({ sliderRef: H, activeIndex: ue, setActive: E }), _(pe), K && K(Z, pe, ue);
      }
      L.current = 0;
  ...
  const Pe = (Z) => (fe) => {
      ...
      if (be !== !1) {
        ...
        Mo({ sliderRef: H, activeIndex: Q, setActive: E }), _(ue), K && K(fe, ue, Q);
      }
      L.current = 0;
...
`),
  ...
  return (
    ...
    {
      getRootProps: (P = {}) =>
        v({ 'aria-owns': Q ? `${H}-listbox` : null }, P, {
          onKeyDown: qt(P),
          onMouseDown: lt,
          onClick: _t,
        }),
...
process.env.NODE_ENV === 'production' ? (ri.exports = hb()) : (ri.exports = bb());
var Vi = ri.exports;
function ii(e, t) {
  return (
    ...
    return (
      ...
      (o.componentDidUpdate = function (i) {
        ...
        if (i !== this.props) {
          ...
          this.props.in ? s !== En && s !== jn && (a = En) : (s === En || s === jn) && (a = ai);
        }
...
const Vb = Ye('MuiButtonBase', ['root', 'disabled', 'focusVisible']),
  ...
  ec = x.forwardRef(function (t, o) {
    const r = Xe({ props: t, name: 'MuiButtonBase' }),
      ...
      ie = x.useRef(null),
      G = mt(ie, M),
      { isFocusVisibleRef: $, onFocus: F, onBlur: X, ref: H } = il(),
      [U, te] = x.useState(!1);
    u && U && te(!1),
...
const wv = [
  ...
  Mv = he(Or, { name: 'MuiAutocomplete', slot: 'Paper', overridesResolver: (e, t) => t.paper })(
...
const Cg = yc,
  ...
  $g = he(wr, { name: 'MuiFilledInput', slot: 'Input', overridesResolver: Sr })(
    ({ theme: e, ownerState: t }) =>
      v(
...
const Kg = Ki,
  ...
  Zg = he(wr, { name: 'MuiInput', slot: 'Input', overridesResolver: Sr })({}),
...
const Nc = x.forwardRef(function (t, o) {
  ...
  const h = (T) => {
      ...
      if (p === 'ArrowDown') T.preventDefault(), io(E, R, u, c, Wr);
      else if (p === 'ArrowUp') T.preventDefault(), io(E, R, u, c, _s);
      else if (p === 'Home') T.preventDefault(), io(E, null, u, c, Wr);
        ...
        w.previousKeyMatched && (A || io(E, R, !1, c, Wr, w))
          ? T.preventDefault()
...
const hy = (e) => {
  ...
  vy = he(Or, { name: 'MuiPopover', slot: 'Paper', overridesResolver: (e, t) => t.paper })({
    position: 'absolute',
    overflowY: 'auto',
    overflowX: 'hidden',
    minWidth: 16,
...
const xy = ['onEntering'],
  ...
  Ry = he(Or, { name: 'MuiMenu', slot: 'Paper', overridesResolver: (e, t) => t.paper })({
...
const jy = [
  ...
  Uy = he(wr, { name: 'MuiOutlinedInput', slot: 'Input', overridesResolver: Sr })(
    ({ theme: e, ownerState: t }) =>
      v(
        { padding: '16.5px 14px' },
        !e.vars && {
...
const d0 = (e) => {
  ...
  Yc = x.forwardRef(function (t, o) {
    ...
    const ut = d0(Se),
      ...
      dt = (g = (y = W == null ? void 0 : W.mark) != null ? y : ie.Mark) != null ? g : Hc,
...
const Jn = [
  ...
  P0 = (e) => Jn[e].chapters,
  Hs = (e, t) => ({ book: Math.max(ea, Math.min(e.book + t, Qc)), chapter: 1, verse: 1 }),
  qs = (e, t) => ({
    ...e,
...
function N0({ scrRef: e, handleSubmit: t }) {
  ...
  return et(iu, {
    children: [
      ...
      D(On, { onClick: () => i(Hs(e, -1)), isDisabled: e.book <= ea, children: '<' }),
      D(On, { onClick: () => i(Hs(e, 1)), isDisabled: e.book >= Ws().length, children: '>' }),
      D(tr, {
      ...
      D(On, { onClick: () => t(qs(e, -1)), isDisabled: e.chapter <= eu, children: '<' }),
      D(On, { onClick: () => t(qs(e, 1)), isDisabled: e.chapter >= P0(e.book), children: '>' }),
      D(tr, {
        className: 'papi-ref-selector chapter-verse',
        label: 'Verse',
        value: e.verse,
...
function _0({ onRowChange: e, row: t, column: o }) {
  const r = (i) => {
    e({ ...t, [o.key]: i.target.value });
  };
  return D(tr, { defaultValue: t[o.key], onChange: r });
}
const M0 = ({ onChange: e, disabled: t, checked: o, ...r }) => {
  function i(a) {
    e(a.target.checked, a.nativeEvent.shiftKey);
  }
  return D(Jc, { ...r, isChecked: o, isDisabled: t, onChange: i });
};
function A0({
  columns: e,
  sortColumns: t,
  ...
  const K = Ce.useMemo(() => (d ? [{ ...na.SelectColumn, minWidth: f }, ...e] : e), [d, e]);
  return D(na, {
    columns: K,
