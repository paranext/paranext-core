          ...
          function E(T, V, ce) {
            {
              ...
              var G = ce.map(function (oe) {
                return String(oe);
              });
              G.unshift('Warning: ' + V), Function.prototype.apply.call(console[T], console, G);
            }
          }
          var x = !1,
            f = !1,
...
` +
          ...
          function M(T, V) {
            ...
            var G;
            (G = ie.current), (ie.current = null), Y();
            try {
              if (V) {
                var oe = function () {
                  throw Error();
...
` + fe[ge].replace(' at new ', ' at ');
              ...
              (ue = !1), (ie.current = G), X(), (Error.prepareStackTrace = P);
            }
          ...
          var lt = function (T, V, ce, k, P, G, oe) {
            var fe = { $$typeof: t, type: T, key: V, ref: ce, props: oe, _owner: G };
            return (
              (fe._store = {}),
          ...
          function Et(T, V, ce, k, P) {
            {
              ...
              ce !== void 0 && (xe(ce), (fe = '' + ce)),
                ...
                H(V) && ((ve = V.ref), Re(V, P));
              for (G in V) Ce.call(V, G) && !Ee.hasOwnProperty(G) && (oe[G] = V[G]);
              if (T && T.defaultProps) {
                var ge = T.defaultProps;
                for (G in ge) oe[G] === void 0 && (oe[G] = ge[G]);
              }
              if (fe || ve) {
          ...
          function Ct(T, V) {
            {
              ...
              if (Fe(T))
                ...
                if (typeof P == 'function' && P !== T.entries)
                  for (var G = P.call(T), oe; !(oe = G.next()).done; )
...
function Gd(e) {
  return $l(Ko('', null, null, null, [''], (e = wl(e)), 0, [0], e));
}
function Ko(e, t, o, r, i, a, s, l, c) {
  for (
    var d = 0,
      u = 0,
      p = s,
      ...
      default:
        ...
        switch (((R += hr(C)), C * h)) {
          ...
          case 44:
            ...
            break;
          case 64:
            tn() === 45 && (R += Go(kt())), (m = tn()), (u = p = Qt((E = R += Yd(Yo())))), C++;
            break;
          case 45:
            g === 45 && Qt(R) == 2 && (h = 0);
        }
...
const uf = Ke({ prop: 'border', themeKey: 'borders', transform: en }),
  df = Ke({ prop: 'borderTop', themeKey: 'borders', transform: en }),
  pf = Ke({ prop: 'borderRight', themeKey: 'borders', transform: en }),
  ff = Ke({ prop: 'borderBottom', themeKey: 'borders', transform: en }),
  mf = Ke({ prop: 'borderLeft', themeKey: 'borders', transform: en }),
  hf = Ke({ prop: 'borderColor', themeKey: 'palette' }),
  bf = Ke({ prop: 'borderTopColor', themeKey: 'palette' }),
  vf = Ke({ prop: 'borderRightColor', themeKey: 'palette' }),
  gf = Ke({ prop: 'borderBottomColor', themeKey: 'palette' }),
  yf = Ke({ prop: 'borderLeftColor', themeKey: 'palette' }),
  Sr = (e) => {
...
const xf = Ke({ prop: 'gridColumn' }),
  Ef = Ke({ prop: 'gridRow' }),
  Of = Ke({ prop: 'gridAutoFlow' }),
  Tf = Ke({ prop: 'gridAutoColumns' }),
  Cf = Ke({ prop: 'gridAutoRows' }),
  Rf = Ke({ prop: 'gridTemplateColumns' }),
  Sf = Ke({ prop: 'gridTemplateRows' }),
  wf = Ke({ prop: 'gridTemplateAreas' }),
  $f = Ke({ prop: 'gridArea' });
Rr(wr, $r, kr, xf, Ef, Of, Tf, Cf, Rf, Sf, wf, $f);
function Vn(e, t) {
  return t === 'grey' ? t : e;
}
const kf = Ke({ prop: 'color', themeKey: 'palette', transform: Vn }),
  Nf = Ke({ prop: 'bgcolor', cssProperty: 'backgroundColor', themeKey: 'palette', transform: Vn }),
  Pf = Ke({ prop: 'backgroundColor', themeKey: 'palette', transform: Vn });
Rr(kf, Nf, Pf);
function $t(e) {
  return e <= 1 && e !== 0 ? `${e * 100}%` : e;
}
const If = Ke({ prop: 'width', transform: $t }),
  zi = (e) => {
...
const Mf = Ke({ prop: 'minWidth', transform: $t }),
  _f = Ke({ prop: 'height', transform: $t }),
  Af = Ke({ prop: 'maxHeight', transform: $t }),
  Df = Ke({ prop: 'minHeight', transform: $t });
Ke({ prop: 'size', cssProperty: 'width', transform: $t });
Ke({ prop: 'size', cssProperty: 'height', transform: $t });
const jf = Ke({ prop: 'boxSizing' });
            ...
            if (!A.contains(E.activeElement)) {
              ...
              if (
                ...
                const K = !!(
                  ...
                  B = I[0],
                  _ = I[I.length - 1];
                typeof B != 'string' && typeof _ != 'string' && (K ? _.focus() : B.focus());
              } else A.focus();
            }
          }
        },
...
var vt = 'top',
  ...
  Kl = [].concat(_o, [Ar]).reduce(function (e, t) {
...
function Ji(e) {
  return Gn(bn(e)).left + Xi(e).scrollLeft;
}
function vh(e, t) {
  var o = Pt(e),
    r = bn(e),
...
function gs(e, t, o) {
  return t === Gl ? yi(vh(e, o)) : kn(t) ? yh(t, o) : yi(gh(bn(e)));
}
function xh(e) {
  var t = yo(Dr(e)),
...
function Fh(e, t, o) {
  ...
  return (
    (r || (!r && !o)) &&
      ...
      Nt(t) ? ((c = Gn(t, !0)), (c.x += t.clientLeft), (c.y += t.clientTop)) : a && (c.x = Ji(a))),
    {
      ...
      y = {
        ...
        forceUpdate: function () {
          if (!m) {
            ...
            (u.rects = { reference: Fh(C, Ao(E), u.options.strategy === 'fixed'), popper: Gi(E) }),
              (u.reset = !1),
...
var Kh = [mh, Ih, ph, th, Nh, Rh, Ah, lh, wh],
  Xh = Gh({ defaultModifiers: Kh });
function Jh(e) {
...
`),
    ...
    return N(_, { ...D, children: typeof a == 'function' ? a(K) : a });
  }),
...
function Ob(e) {
  ...
  const ae = (te) => (ne) => {
      ...
      I(se), Z(he), K && !zo(se, w) && K(ne, se, he), p && p(ne, se);
    },
    ue = b.useRef();
  let de = m;
...
function kb(e) {
  ...
  Y = (k) => {
    ...
    if (typeof P != 'string') {
      if (process.env.NODE_ENV !== 'production') {
        const G = P === void 0 ? 'undefined' : `${typeof P} (${P})`;
        console.error(
          `MUI: The \`getOptionLabel\` method of ${d} returned ${G} instead of a string for ${JSON.stringify(
            k,
          )}.`,
        );
      }
  ...
  if (process.env.NODE_ENV !== 'production' && q !== null && !C && F.length > 0) {
    const k = (I ? q : [q]).filter((P) => !F.some((G) => w(G, P)));
    k.length > 0 &&
      console.warn(
        [
...
`),
  ...
  function H(k, P) {
    ...
    let G = k;
    for (;;) {
      if ((P === 'next' && G === Ee.length) || (P === 'previous' && G === -1)) return -1;
      const oe = ae.current.querySelector(`[data-option-index="${G}"]`),
        fe = g ? !1 : !oe || oe.disabled || oe.getAttribute('aria-disabled') === 'true';
      if ((oe && !oe.hasAttribute('tabindex')) || fe) G += P === 'next' ? 1 : -1;
      else return G;
    }
  }
  const ye = ft(({ event: k, index: P, reason: G = 'auto' }) => {
      if (
        ((Q.current = P),
        P === -1
          ? ee.current.removeAttribute('aria-activedescendant')
          : ee.current.setAttribute('aria-activedescendant', `${U}-option-${P}`),
        _ && _(k, P === -1 ? null : Ee[P], G),
        !ae.current)
      )
        return;
      ...
      if (
        ...
        G === 'keyboard' && ve.classList.add(`${o}-focusVisible`),
        fe.scrollHeight > fe.clientHeight && G !== 'mouse')
      ) {
        const ge = ve,
    ...
    Re = ft(({ event: k, diff: P, direction: G = 'next', reason: oe = 'auto' }) => {
      if (!he) return;
      const ve = H(
        (() => {
    ...
    mt = () => {
      ...
      if (
        ...
        (I
          ? q.length === _e.value.length && _e.value.every((P, G) => Y(q[G]) === Y(P))
          : k(_e.value, q))
      ) {
    ...
    bt = b.useCallback(() => {
      ...
      if (ae.current) {
        if (k != null) {
          ...
          const G = ti(Ee, (oe) => w(oe, k));
          G === -1 ? Re({ diff: 'reset' }) : ye({ index: G });
          return;
        }
...
`),
  ...
  const Et = (k) => {
    ...
    ct = b.useRef(!1),
    dt = (k, P, G = 'selectOption', oe = 'options') => {
      let fe = G,
        ve = P;
      if (I) {
...
`),
  ...
  function Yt(k, P) {
    ...
    let G = k;
    for (;;) {
      if ((P === 'next' && G === q.length) || (P === 'previous' && G === -1)) return -1;
      const oe = ue.querySelector(`[data-tag-index="${G}"]`);
      if (
        !oe ||
  ...
  const Gt = (k, P) => {
      ...
      let G = me;
      me === -1
        ? pe === '' && P === 'previous' && (G = q.length - 1)
        : ((G += P === 'next' ? 1 : -1), G < 0 && (G = 0), G === q.length && (G = -1)),
        (G = Yt(G, P)),
        M(G),
        $e(G);
    },
    ...
    Tt = (k) => (P) => {
      if (
        ...
        switch (P.key) {
          ...
          case 'Backspace':
            if (I && !$ && pe === '' && q.length > 0) {
              const G = me === -1 ? q.length - 1 : me,
                oe = q.slice();
              oe.splice(G, 1), et(P, oe, 'removeOption', { option: q[G] });
            }
            break;
          case 'Delete':
    ...
    Bt = (k) => (P) => {
      const G = q.slice();
      G.splice(k, 1), et(P, G, 'removeOption', { option: q[k] });
    },
    Jt = (k) => {
  ...
  if (f) {
    const k = new Map();
    let P = !1;
    ce = Ee.reduce((G, oe, fe) => {
      const ve = f(oe);
      return (
        G.length > 0 && G[G.length - 1].group === ve
          ? G[G.length - 1].options.push(oe)
          : (process.env.NODE_ENV !== 'production' &&
              (k.get(ve) &&
                !P &&
                (console.warn(
                ...
                (P = !0)),
              k.set(ve, !0)),
            G.push({ key: fe, index: fe, group: ve, options: [oe] })),
        G
      );
    }, []);
  }
  return (
    y && Le && Xt(),
    {
      ...
      getOptionProps: ({ index: k, option: P }) => {
        const G = (I ? q : [q]).some((fe) => fe != null && w(P, fe)),
          oe = E ? E(P) : !1;
        return {
          key: Y(P),
          tabIndex: -1,
      ...
      O = b.useCallback(
        (x = {}, f = {}, S = () => {}) => {
          ...
          if (
            ...
            (K = Math.round(I.width / 2)), (B = Math.round(I.height / 2));
          else {
            const { clientX: D, clientY: W } = x.touches && x.touches.length > 0 ? x.touches[0] : x;
            (K = Math.round(D - I.left)), (B = Math.round(W - I.top));
          }
          if (A) (_ = Math.sqrt((2 * I.width ** 2 + I.height ** 2) / 3)), _ % 2 === 0 && (_ += 1);
          else {
            const D = Math.max(Math.abs((w ? w.clientWidth : 0) - K), K) * 2 + 2,
          ...
          x != null && x.touches
            ? g.current === null &&
              ((g.current = () => {
                v({ pulsate: R, rippleX: K, rippleY: B, rippleSize: _, cb: S });
              }),
...
`),
    ...
    const Ze = (H) => {
      ...
      Fe = (H, ...ye) => {
        ...
        x.onChange && x.onChange(H, ...ye), K && K(H, ...ye);
      };
    b.useEffect(() => {
      Le(de.current);
    }, []);
...
const Fv = (e) => {
  ...
  Tc = b.forwardRef(function (t, o) {
    ...
    const k =
      ...
      G = he || ((Oe, Be) => N('li', { ...Oe, children: L(Be) })),
      oe = (Oe, Be) => {
        const sn = ct({ option: Oe, index: Be });
        return G({ ...sn, className: T.option }, Oe, {
...
const Lc = b.forwardRef(function (t, o) {
  ...
  const K = N(C, { in: h, direction: jc[R], timeout: E, appear: S.current, ...O, children: I });
  return x === 'persistent'
    ? N(Us, { className: be(w.root, w.docked, d), ownerState: j, ref: o, ...f, children: K })
    : N(_g, {
        ...
        return (
          i &&
            b.Children.forEach(i, (_) => {
              if (!Kr(_, ['Input', 'Select'])) return;
              const D = Kr(_, ['Select']) ? _.props.input : _;
              D && Sv(D.props) && (B = !0);
            }),
          B
        );
  ...
  Vc = b.forwardRef(function (t, o) {
    ...
    return Ge(ey, {
      ...
      children: [
        i,
        h.required &&
          Ge(ty, { ownerState: v, 'aria-hidden': !0, className: O.asterisk, children: [' ', '*'] }),
      ],
    });
  });
process.env.NODE_ENV !== 'production' &&
...
const Qc = b.forwardRef(function (t, o) {
  ...
  const h = (E) => {
      ...
      else if (f === 'ArrowUp') E.preventDefault(), uo(x, S, d, c, Ks);
      else if (f === 'Home') E.preventDefault(), uo(x, null, d, c, ri);
      else if (f === 'End') E.preventDefault(), uo(x, null, d, c, Ks);
      else if (f.length === 1) {
        const R = g.current,
          A = f.toLowerCase(),
          j = performance.now();
...
const Uy = we('MuiMenuItem', [
  ...
  qy = le(Jn, {
    ...
    [`& .${Gs.root}`]: { marginTop: 0, marginBottom: 0 },
    [`& .${Gs.inset}`]: { paddingLeft: 36 },
    [`& .${Ys.root}`]: { minWidth: 36 },
...
`),
    ...
    const _e = K.id || (E ? `mui-component-select-${E}` : void 0),
    ...
    return Ge(b.Fragment, {
      children: [
        N(l0, {
          ...
          ...K,
          ownerState: se,
          className: be(K.className, $e.select, c),
          id: _e,
          children: d0(Xe)
...
const f0 = lu,
  ...
  ma = b.forwardRef(function (t, o) {
    const r = Me({ name: 'MuiSelect', props: t }),
      ...
      w = C ? Qy : f0,
      I = Mn(),
      K = eo({ props: r, muiFormControl: I, states: ['variant', 'error'] }),
      B = K.variant || A,
...
const C0 = (e) => {
  ...
  vu = b.forwardRef(function (t, o) {
    ...
    const et = C0(ne),
      ...
      Gt = (d = (u = Ne == null ? void 0 : Ne.thumb) != null ? u : L.Thumb) != null ? d : fu,
      rn =
      ...
      G = It({ elementType: Tt, externalSlotProps: Jt, ownerState: ne, className: et.mark }),
      oe = It({ elementType: Kt, externalSlotProps: gn, ownerState: ne, className: et.markLabel }),
                ...
                b.Fragment,
                {
                  children: [
                    N(Tt, {
                      ...
                      ...(!fn(Tt) && { markActive: Be }),
                      style: { ...Oe, ...G.style },
                      className: be(G.className, Be && et.markActive),
                    }),
                    ve.label != null
                      ? N(Kt, {
                          'aria-hidden': !0,
...
const K0 = { standard: Gc, filled: Fc, outlined: su },
  X0 = (e) => {
    const { classes: t } = e;
    return Ie({ root: ['root'] }, G0, t);
  },
...
function ax({ commandHandler: e, name: t, className: o, items: r }) {
  return Ge(qc, {
    item: !0,
    xs: 1,
    className: `papi-menu-column ${o ?? ''}`,
    children: [
      N('h3', { className: `papi-menu ${o ?? ''}`, children: t }),
      r.map((i, a) =>
        N(ku, { className: `papi-menu-item ${i.className}`, onClick: () => e(i), ...i }, a),
      ),
    ],
  });
}
function Nu({ commandHandler: e, className: t, columns: o }) {
  return N(qc, {
    container: !0,
    spacing: 0,
    ...
    columns: o.length,
    children: o.map((r) =>
      N(ax, { commandHandler: e, name: r.name, className: t, items: r.items }),
    ),
  });
}
