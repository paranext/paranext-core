...
const S = require('react/jsx-runtime'),
  ...
  ie = require('react'),
  _r = require('react-data-grid'),
  pr = require('@mui/styled-engine');
function jn(e) {
...
function cn({
  ...
  if (r) {
    const h = n === Ee.Before || n === Ee.Above,
      ...
      v = y ? l : S.jsx('div', { children: l }),
      p = y ? i : S.jsx('div', { children: i });
...
function Bn({ commandHandler: e, name: r, className: n, items: t }) {
...
function dn({ commandHandler: e, className: r, columns: n }) {
  return S.jsx(Q.Grid, {
    container: !0,
    spacing: 0,
    ...
    columns: n.length,
    children: n.map((t) =>
      S.jsx(Bn, { commandHandler: e, name: t.name, className: r, items: t.items }),
    ),
  });
}
var Dn = Object.defineProperty,
  zn = (e, r, n) =>
    r in e ? Dn(e, r, { enumerable: !0, configurable: !0, writable: !0, value: n }) : (e[r] = n),
  R = (e, r, n) => (zn(e, typeof r != 'symbol' ? r + '' : r, n), n);
const we = [
    'GEN',
    'EXO',
    'LEV',
  ...
  Rr = Wn();
function Be(e, r = !0) {
  return r && (e = e.toUpperCase()), e in Rr ? Rr[e] : 0;
}
function br(e) {
  return Be(e) > 0;
}
...
function Xn() {
  return he.allBookIds.map((e) => ({ bookId: e, label: he.bookIdToEnglishName(e) }));
}
const Yn = (e) => {
    let r = null;
    return () => (r === null && (r = e()), r);
  ...
  Ar = (e, r) => ({
    bookNum: Math.max(vn, Math.min(e.bookNum + r, Zn)),
    chapterNum: 1,
    verseNum: 1,
  }),
  Pr = (e, r) => ({
  ...
  Mr = (e, r) => ({ ...e, verseNum: Math.max(kn, e.verseNum + r) });
function We({
  variant: e = 'outlined',
  isDisabled: r = !1,
  hasError: n = !1,
...
function Qn({ scrRef: e, handleSubmit: r }) {
  const n = (s) => {
    ...
    t = (s, c) => {
      const i = { bookNum: he.bookIdToNumber(c.bookId), chapterNum: 1, verseNum: 1 };
      n(i);
    },
    o = (s) => {
  ...
  return S.jsxs(S.Fragment, {
    children: [
      S.jsx(ln, {
        ...
        value: ie.useMemo(() => ar()[e.bookNum - 1], [e.bookNum]),
        options: ar(),
        onChange: t,
        isClearable: !1,
        width: 200,
      }),
      S.jsx(Se, { onClick: () => n(Ar(e, -1)), isDisabled: e.bookNum <= vn, children: '<' }),
      S.jsx(Se, {
        onClick: () => n(Ar(e, 1)),
      ...
      S.jsx(Se, { onClick: () => r(Pr(e, -1)), isDisabled: e.chapterNum <= xn, children: '<' }),
      S.jsx(Se, {
        onClick: () => r(Pr(e, 1)),
      ...
      S.jsx(Se, { onClick: () => r(Mr(e, -1)), isDisabled: e.verseNum <= kn, children: '<' }),
...
function ot({
  ...
  const le = ie.useMemo(() => {
    ...
    return f ? [{ ..._r.SelectColumn, minWidth: h }, ...se] : se;
  }, [f, e]);
  return S.jsx(_r, {
    columns: le,
...
var cr, Lr;
function wn() {
  return Lr || ((Lr = 1), (cr = Function.call.bind(Object.prototype.hasOwnProperty))), cr;
}
var lr, Fr;
function lt() {
  if (Fr) return lr;
...
process.env.NODE_ENV === 'production' ? (mr.exports = mt()) : (mr.exports = gt());
var qr = mr.exports;
...
function On(e) {
  ...
  if (typeof e == 'string' || typeof e == 'number') t += e;
    ...
    if (Array.isArray(e))
      for (r = 0; r < e.length; r++) e[r] && (n = On(e[r])) && (t && (t += ' '), (t += n));
...
function _t(e) {
  ...
  return A({ keys: s, values: a, up: c, down: u, between: i, only: f, not: h, unit: n }, o);
}
...
const kr = { xs: 0, sm: 600, md: 900, lg: 1200, xl: 1536 },
  Xr = { keys: ['xs', 'sm', 'md', 'lg', 'xl'], up: (e) => `@media (min-width:${kr[e]}px)` };
function be(e, r, n) {
  const t = e.theme || {};
  if (Array.isArray(r)) {
...
const Ht = F({ prop: 'border', themeKey: 'borders', transform: de }),
  Ut = F({ prop: 'borderTop', themeKey: 'borders', transform: de }),
  Gt = F({ prop: 'borderRight', themeKey: 'borders', transform: de }),
  Jt = F({ prop: 'borderBottom', themeKey: 'borders', transform: de }),
  qt = F({ prop: 'borderLeft', themeKey: 'borders', transform: de }),
          ...
          if (v != null)
            if (typeof v == 'object')
              if (s[y]) l = Le(l, e(y, v, a, s));
                ...
                vo(p, v) ? (l[y] = r({ sx: v, theme: a })) : (l = Le(l, p));
              }
...
function Eo(e = null) {
  const r = Fe.useContext(pr.ThemeContext);
  return !r || No(r) ? e : r;
}
const wo = wr();
function To(e = wo) {
...
function jo(e = {}) {
  const {
    ...
    a = (s) => Er(A({}, s, { theme: ze(A({}, s, { defaultTheme: n, themeId: r })) }));
  return (
    (a.__mui_systemSx = !0),
    (s, c = {}) => {
      pr.internal_processStyles(s, ($) => $.filter((m) => !(m != null && m.__mui_systemSx)));
      ...
      let E = Ke;
      i === 'Root' ? (E = t) : i ? (E = o) : Ro(s) && (E = void 0);
      const W = pr(s, A({ shouldForwardProp: E, label: d }, y)),
        H = ($, ...m) => {
          const X = m
            ? m.map((j) =>
...
function Vo(e) {
  ...
  return e.type === 'hsla' && ((c += 'a'), u.push(r[3])), Tr({ type: c, values: u });
}
function Qr(e) {
  e = je(e);
...
function sa(e) {
  const { mode: r = 'light', contrastThreshold: n = 3, tonalOffset: t = 0.2 } = e,
    ...
    f = e.warning || aa(r);
  function h(p) {
    const d = en(p, fr.text.primary) >= n ? fr.text.primary : rn.text.primary;
    if (process.env.NODE_ENV !== 'production') {
      const E = en(p, d);
      E < 3 &&
        console.error(
...
function Na(e = {}, ...r) {
  ...
  if (
    ((i = me(i, s)), (i = r.reduce((f, h) => me(f, h), i)), process.env.NODE_ENV !== 'production')
  ) {
    const f = [
        'active',
        'checked',
...
function wa({ props: e, name: r }) {
  return Do({ props: e, name: r, defaultTheme: Mn, themeId: In });
}
const Ta = (e) => Ke(e) && e !== 'classes',
  Ca = jo({ themeId: In, defaultTheme: Mn, rootShouldForwardProp: Ta }),
  Oa = Ca;
function _a(e) {
...
function Ia({ menu: e, dataHandler: r, commandHandler: n, className: t, children: o }) {
  ...
  const v = ie.useCallback((d) => (i(), n(d)), [n, i]);
  let p = e;
  return (
    !p && r && (p = r(c)),
    S.jsx('div', {
          ...
          children: [
            ...
            p
              ? S.jsx(Q.Drawer, {
                  ...
                  children: S.jsx(dn, { commandHandler: v, columns: p.columns }),
                })
              : null,
          ],
        }),
