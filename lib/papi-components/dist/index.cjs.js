...
function Ha(e) {
  e = wn(e);
  let t = e.type === 'hsl' || e.type === 'hsla' ? wn(Nf(e)).values : e.values;
  return (
    (t = t.map(
      (o) => (
...
function rs(e, t, o) {
  return t === _l ? ni(Ym(e, o)) : $n(t) ? Gm(t, o) : ni(Km(vn(e)));
}
function Xm(e) {
  var t = po(yr(e)),
...
function xo(e, t) {
  ...
  var o = t,
    ...
    T = e.rects.popper,
    O = e.elements[x ? S : b],
    p = Jm($n(O) ? O : O.contextElement || vn(e.elements.popper), c, d, s),
    ...
    return (
      ...
      (o.componentDidUpdate = function (i) {
        ...
        if (i !== this.props) {
          ...
          this.props.in ? s !== En && s !== Fn && (a = En) : (s === En || s === Fn) && (a = ii);
        }
