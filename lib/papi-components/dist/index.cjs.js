...
function ax({ doCommand: e, name: t, index: o, items: r }) {
  return Ge(qc, {
    item: !0,
    xs: o,
    children: [
      N('h3', { className: 'menu', children: t }),
      r.map((i, a) =>
        N(ku, { className: `menu-item ${i.className}`, onClick: () => e(i), ...i }, a),
      ),
    ],
  });
}
function Nu({ doCommand: e, columns: t }) {
  return N(qc, {
    container: !0,
    spacing: 0,
    className: 'multi-colum-menu',
    columns: t.length,
    children: t.map((o, r) => N(ax, { doCommand: e, name: o.name, index: r, items: o.items })),
  });
}
