...
function F({
  ...
  if (n) {
    const f = r === S.Before || r === S.Above,
      ...
      x = r === S.Before || r === S.After,
      T = x ? v : i.jsx('div', { children: v }),
      O = x ? d : i.jsx('div', { children: d });
    b = i.jsxs(k.FormLabel, {
...
function* Ce() {
  for (let e = 1; e <= E.length; e++) yield e;
}
const Se = 1,
  Z = E.length;
function Ee() {
...
function Q(e) {
  const n = typeof e == 'number' ? A(e) : e;
  return V(n) && !I.includes(n);
}
function _e(e) {
  const n = typeof e == 'number' ? A(e) : e;
  return V(n) && I.includes(n);
...
function Me() {
  const e = {};
  for (let n = 0; n < E.length; n++) e[E[n]] = n + 1;
  return e;
}
const m = {
  allBookIds: E,
...
let p = C;
s(p, 'Original', new C(y.Original)),
  s(p, 'Septuagint', new C(y.Septuagint)),
  s(p, 'Vulgate', new C(y.Vulgate)),
  s(p, 'English', new C(y.English)),
  s(p, 'RussianProtestant', new C(y.RussianProtestant)),
  s(p, 'RussianOrthodox', new C(y.RussianOrthodox));
function D(e, n) {
  const r = n[0];
  ...
  return i.jsxs(i.Fragment, {
    children: [
      i.jsx(U, {
        ...
        isClearable: !1,
        width: 200,
        checkIsOptionEqualToValue: Ie,
      }),
      i.jsx(w, { onClick: () => t(X(e, -1)), isDisabled: e.bookNum <= ne, children: '<' }),
      i.jsx(w, { onClick: () => t(X(e, 1)), isDisabled: e.bookNum >= H().length, children: '>' }),
      i.jsx(M, {
      ...
      i.jsx(w, { onClick: () => n(j(e, -1)), isDisabled: e.chapterNum <= re, children: '<' }),
      i.jsx(w, {
        onClick: () => n(j(e, 1)),
      ...
      i.jsx(w, { onClick: () => n(L(e, -1)), isDisabled: e.verseNum <= oe, children: '<' }),
      i.jsx(w, { onClick: () => n(L(e, 1)), children: '>' }),
    ],
  });
}
function Ae({
...
const De = ({ onChange: e, disabled: n, checked: r, ...o }) => {
  ...
  return i.jsx(F, { ...o, isChecked: r, isDisabled: n, onChange: t });
};
function He({
  columns: e,
  sortColumns: n,
  ...
  return i.jsx(J, {
    columns: fe,
    defaultColumnOptions: { width: t, minWidth: l, maxWidth: c, sortable: u, resizable: h },
    sortColumns: n,
    onSortColumnsChange: r,
    onColumnResize: o,
    rows: d,
