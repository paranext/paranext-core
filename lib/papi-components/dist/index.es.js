...
import { Button as Bn, FormLabel as Dn, Checkbox as jn, Autocomplete as zn, TextField as ln, MenuItem as Vn, Grid as un, Slider as Ln, Snackbar as Fn, Switch as Hn, AppBar as Un, Toolbar as Jn, IconButton as Gn, Drawer as Kn } from "@mui/material";
...
function rt({
  ...
  let p;
  if (n) {
    const u = t === $e.Before || t === $e.Above, y = /* @__PURE__ */ C("span", { className: `papi-checkbox-label ${l ? "error" : ""} ${i ?? ""}`, children: n }), v = t === $e.Before || t === $e.After, h = v ? y : /* @__PURE__ */ C("div", { children: y }), d = v ? f : /* @__PURE__ */ C("div", { children: f });
    p = /* @__PURE__ */ Fe(
      Dn,
      {
...
const vt = ({ onChange: e, disabled: r, checked: n, ...t }) => /* @__PURE__ */ C(
  rt,
  {
    ...t,
    isChecked: n,
...
function kt() {
  ...
  return z.AsyncMode = i, z.ConcurrentMode = c, z.ContextConsumer = l, z.ContextProvider = s, z.Element = r, z.ForwardRef = f, z.Fragment = t, z.Lazy = v, z.Memo = y, z.Portal = n, z.Profiler = a, z.StrictMode = o, z.Suspense = p, z.isAsyncMode = function(m) {
    ...
    return typeof m == "string" || typeof m == "function" || m === t || m === c || m === a || m === o || m === p || m === u || typeof m == "object" && m !== null && (m.$$typeof === v || m.$$typeof === y || m.$$typeof === s || m.$$typeof === l || m.$$typeof === f || m.$$typeof === d || m.$$typeof === S || m.$$typeof === W || m.$$typeof === h);
  }, z.typeOf = B, z;
}
var V = {};
/** @license React v16.13.1
...
function St() {
  return Dr || (Dr = 1, process.env.NODE_ENV !== "production" && function() {
    ...
    function B(b) {
      ...
      b === t || b === c || b === a || b === o || b === p || b === u || typeof b == "object" && b !== null && (b.$$typeof === v || b.$$typeof === y || b.$$typeof === s || b.$$typeof === l || b.$$typeof === f || b.$$typeof === d || b.$$typeof === S || b.$$typeof === W || b.$$typeof === h);
    }
    function R(b) {
    ...
    var m = i, X = c, ne = l, ie = s, ae = r, D = f, Y = t, ce = v, le = y, Q = n, q = a, ee = o, se = p, ve = !1;
    function Se(b) {
...
var jr;
function En() {
  return jr || (jr = 1, process.env.NODE_ENV === "production" ? Ge.exports = kt() : Ge.exports = St()), Ge.exports;
}
/*
object-assign
(c) Sindre Sorhus
...
function Rt() {
  return Gr || (Gr = 1, process.env.NODE_ENV !== "production" && function() {
    var e = Symbol.for("react.element"), r = Symbol.for("react.portal"), n = Symbol.for("react.fragment"), t = Symbol.for("react.strict_mode"), o = Symbol.for("react.profiler"), a = Symbol.for("react.provider"), s = Symbol.for("react.context"), l = Symbol.for("react.server_context"), i = Symbol.for("react.forward_ref"), c = Symbol.for("react.suspense"), f = Symbol.for("react.suspense_list"), p = Symbol.for("react.memo"), u = Symbol.for("react.lazy"), y = Symbol.for("react.offscreen"), v = !1, h = !1, d = !1, S = !1, W = !1, B;
    B = Symbol.for("react.module.reference");
    function R(k) {
      return !!(typeof k == "string" || typeof k == "function" || k === n || k === o || W || k === t || k === c || k === f || S || k === y || v || h || d || typeof k == "object" && k !== null && (k.$$typeof === u || k.$$typeof === p || k.$$typeof === a || k.$$typeof === s || k.$$typeof === i || // This needs to include all possible module reference object
    ...
    var X = s, ne = a, ie = e, ae = i, D = n, Y = u, ce = p, le = r, Q = o, q = t, ee = c, se = f, ve = !1, Se = !1;
    function g(k) {
...
function Yo(e = {}) {
  ...
  return a.__mui_systemSx = !0, (s, l = {}) => {
    ...
    const {
      ...
      overridesResolver: u = Xo(Qr(c))
    } = l, y = ge(l, Ho), v = f !== void 0 ? f : (
    ...
    let S = Ke;
    c === "Root" || c === "root" ? S = t : c ? S = o : Jo(s) && (S = void 0);
    const W = Zn(s, A({
      shouldForwardProp: S,
      label: d
    }, y)), B = (R, ...m) => {
      ...
      if (process.env.NODE_ENV !== "production") {
        let D;
        i && (D = `${i}${de(c || "")}`), D === void 0 && (D = `Styled(${Mt(s)})`), ae.displayName = D;
      }
...
function ka(e) {
  const {
    ...
    tonalOffset: t = 0.2
  } = e, o = ge(e, ha), a = e.primary || ma(r), s = e.secondary || ga(r), l = e.error || ba(r), i = e.info || ya(r), c = e.success || va(r), f = e.warning || xa(r);
  function p(h) {
...
const La = (e) => Ke(e) && e !== "classes", Fa = Yo({
  themeId: In,
  defaultTheme: Mn,
...
const Ja = ["children", "className", "color", "component", "fontSize", "htmlColor", "inheritViewBox", "titleAccess", "viewBox"], Ga = (e) => {
  ...
  const t = Va({
    ...
    titleAccess: p,
    viewBox: u = "0 0 24 24"
  } = t, y = ge(t, Ja), v = /* @__PURE__ */ Ve.isValidElement(o) && o.type === "svg", h = A({}, t, {
    color: s,
    component: l,
    fontSize: i,
...
function cs({
  ...
  let d = e;
  return !d && r && (d = r(i)), /* @__PURE__ */ C("div", { ref: u, style: { position: "relative" }, children: /* @__PURE__ */ C(Un, { position: "static", id: o, children: /* @__PURE__ */ Fe(Jn, { className: `papi-toolbar ${t ?? ""}`, variant: "dense", children: [
    d ? /* @__PURE__ */ C(
      Gn,
      {
        edge: "start",
    ...
    d ? /* @__PURE__ */ C(
      Kn,
      {
        ...
        children: /* @__PURE__ */ C(at, { commandHandler: h, columns: d.columns })
      }
    ) : null
  ] }) }) });
}
