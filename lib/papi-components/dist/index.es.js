...
function lx({ doCommand: e, name: t, index: o, items: r }) {
  return /* @__PURE__ */ Ke(Yc, {
    item: !0,
    xs: o,
    children: [
      /* @__PURE__ */ N('h3', { className: 'menu', children: t }),
      r.map((i, a) =>
        /* @__PURE__ */ N(
          ax,
          {
            className: `menu-item ${i.className}`,
            onClick: () => e(i),
            ...i,
          },
          a,
...
function cx({ doCommand: e, columns: t }) {
  return /* @__PURE__ */ N(Yc, {
    ...
    columns: t.length,
    children: t.map((o, r) =>
      /* @__PURE__ */ N(lx, { doCommand: e, name: o.name, index: r, items: o.items }),
    ),
  });
}
const ux = kn(
