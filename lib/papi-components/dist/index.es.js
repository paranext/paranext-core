...
function hl() {
  return (
    Ta ||
      ((Ta = 1), process.env.NODE_ENV === 'production' ? (Do.exports = Ku()) : (Do.exports = Gu())),
    Do.exports
  );
}
/*
...
const gl = _t(n.element, vl);
gl.isRequired = _t(n.element.isRequired, vl);
const $n = gl;
function rd(e) {
  const { prototype: t = {} } = e;
  return !!t.isReactComponent;
...
function hd(e) {
  ...
  return (
    b.useEffect(() => {
      t == null && ((_a += 1), o(`mui-${_a}`));
    }, [t]),
    r
  );
}
const Aa = b['useId'.toString()];
function xl(e) {
  if (Aa !== void 0) {
    const t = Aa();
    return e ?? t;
...
Cl.isRequired = Tl;
ui.isRequired = ui;
const mr = process.env.NODE_ENV === 'production' ? ui : Cl;
function Ii(e, t) {
  const o = {
    ...t,
  };
...
function $t() {
  return (it = gt < $l ? ct(Zn, gt++) : 0), Wn++, it === 10 && ((Wn = 1), vr++), it;
}
function tn() {
  return ct(Zn, gt);
}
...
function kl(e) {
  return (vr = Wn = 1), ($l = Qt((Zn = e))), (gt = 0), [];
}
function Nl(e) {
  return (Zn = ''), e;
}
function Xo(e) {
  return wl(No(gt - 1, pi(e === 91 ? e + 2 : e === 40 ? e + 1 : e)));
}
function Kd(e) {
  for (; (it = tn()) && it < 33; ) $t();
...
function Zd(e) {
  return Nl(Jo('', null, null, null, [''], (e = kl(e)), 0, [0], e));
}
        ...
        switch (C) {
          ...
          case 59 + u:
            O == -1 && (R = je(R, /\f/g, '')),
              y > 0 &&
                Qt(R) - p &&
                jo(y > 32 ? Fa(R + ';', r, o, p - 1) : Fa(je(R, ' ', '') + ';', r, o, p - 2), c);
            break;
          case 59:
            R += ';';
          default:
            if ((jo((S = La(R, t, o, d, u, i, l, E, (x = []), (f = []), p)), a), C === 123))
                ...
                switch (m === 99 && ct(R, 3) === 110 ? 100 : m) {
                  ...
                  case 115:
                    Jo(
                      ...
                      S,
                      S,
                      r && jo(La(e, S, S, 0, 0, i, l, E, i, (x = []), p), f),
                      i,
                      f,
                      p,
                      l,
...
var op = function (t, o, r) {
  ...
  ap = function (t) {
    if (
      ...
      if (!(t.props.length === 1 && o.charCodeAt(0) !== 58 && !za.get(r)) && !i) {
        za.set(t, !0);
  ...
  dp = function (t, o) {
    for (var r = t - 1; r >= 0; r--) if (!Pl(o[r])) return !0;
    return !1;
  },
  Ba = function (t) {
    ...
    case 4765:
      if (Qt(e) - 1 - t > 6)
        switch (ct(e, t + 1)) {
          ...
          case 115:
            return ~di(e, 'stretch') ? Il(je(e, 'stretch', 'fill-available'), t) + e : e;
        }
      break;
    case 4949:
...
https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Template_literals#ES2018_revision_of_illegal_escape_sequences`,
  ...
  or = function (t, o) {
    switch (t) {
      ...
      case 'animationName':
        if (typeof o == 'string')
          return o.replace(Al, function (r, i, a) {
            return (
              (Bt = {
                name: i,
                styles: a,
    ...
    for (var a in o) {
      ...
      if (typeof s != 'object')
        ...
        if (Array.isArray(s) && typeof s[0] == 'string' && (t == null || t[s[0]] === void 0))
          for (var l = 0; l < s.length; l++) Ha(s[l]) && (r += Zr(a) + ':' + or(a, s[l]) + ';');
        else {
          var c = So(e, t, s);
          switch (a) {
            case 'animation':
...
var Bt,
  Hn = function (t, o, r) {
    ...
    var c;
    process.env.NODE_ENV !== 'production' &&
      (a = a.replace(jl, function (m) {
        return (c = m), '';
      })),
      (Ya.lastIndex = 0);
    for (var d = '', u; (u = Ya.exec(a)) !== null; )
      d +=
  ...
  Ll = b['useInsertionEffect'] ? b['useInsertionEffect'] : !1,
  Fi = Ll || Ip,
  Ka = Ll || b.useLayoutEffect,
  Mp = {}.hasOwnProperty,
...
zi.Provider;
var Er = function (t) {
    return /* @__PURE__ */ ku(function (o, r) {
      var i = Nu(zi);
      return t(o, i, r);
    });
  },
...
var Ga = '__EMOTION_TYPE_PLEASE_DO_NOT_USE__',
  Xa = '__EMOTION_LABEL_PLEASE_DO_NOT_USE__',
  _p = function (t) {
    var o = t.cache,
      r = t.serialized,
      i = t.isStringTag;
  ...
  Ap = /* @__PURE__ */ Er(function (e, t, o) {
    ...
    for (var u in e)
      Mp.call(e, u) &&
        u !== 'css' &&
        u !== Ga &&
        (process.env.NODE_ENV === 'production' || u !== Xa) &&
        (d[u] = e[u]);
    return (
      (d.ref = o),
      (d.className = s),
...
process.env.NODE_ENV !== 'production' && (Fl.displayName = 'EmotionGlobal');
function jp() {
...
if (process.env.NODE_ENV !== 'production') {
  ...
  if (Za && !Vp) {
    var Qa =
      ...
      es = '__EMOTION_REACT_' + Dp.version.split('.')[0] + '__';
    Qa[es] &&
      console.warn(
...
You may have forgotten to import it.`);
    ...
    return function () {
      ...
      if ((a !== void 0 && p.push('label:' + a + ';'), u[0] == null || u[0].raw === void 0))
        ...
        process.env.NODE_ENV !== 'production' && u[0][0] === void 0 && console.error(os),
          p.push(u[0][0]);
        for (var m = u.length, y = 1; y < m; y++)
          process.env.NODE_ENV !== 'production' && u[0][y] === void 0 && console.error(os),
            p.push(u[y], u[0][y]);
      }
...
function Hl({ styles: e, themeId: t, defaultTheme: o = {} }) {
  const r = qi(o),
...
function bm(e) {
  const { mode: t = 'light', contrastThreshold: o = 3, tonalOffset: r = 0.2, ...i } = e,
    ...
    u = e.warning || hm(t);
  function p(h) {
    const v = ss(h, Qr.text.primary) >= o ? Qr.text.primary : ls.text.primary;
    if (process.env.NODE_ENV !== 'production') {
      const O = ss(h, v);
      O < 3 &&
        console.error(
...
const theme2 = createTheme({ palette: {
  primary: { main: green[500] },
      ...
      return (
        cs(h, 'light', C, r), cs(h, 'dark', E, r), h.contrastText || (h.contrastText = p(h.main)), h
      );
    },
    y = {
      dark: Qr,
...
function gm(e, t) {
  ...
  const m = r / 14,
    ...
    h = {
      ...
      button: g(s, 14, 1.75, 0.4, us),
      caption: g(a, 12, 1.66, 0.4),
      overline: g(a, 12, 2.66, 1, us),
      inherit: {
        fontFamily: 'inherit',
        fontWeight: 'inherit',
        fontSize: 'inherit',
  ...
  return {
    ...
    create: (i = ['all'], a = {}) => {
      ...
      return (Array.isArray(i) ? i : [i])
        .map(
          (u) =>
            `${u} ${typeof s == 'string' ? s : ps(s)} ${l} ${typeof c == 'string' ? c : ps(c)}`,
        )
        .join(',');
    },
    ...e,
...
var bt = 'top',
  ...
  so = 'popper',
  Ym = 'reference',
  bs = /* @__PURE__ */ Mo.reduce(function (e, t) {
    return e.concat([t + '-' + qn, t + '-' + wo]);
  }, []),
  Jl = /* @__PURE__ */ [].concat(Mo, [Dr]).reduce(function (e, t) {
...
function _o(e) {
  for (var t = Nt(e), o = vs(e); o && ah(o) && qt(o).position === 'static'; ) o = vs(o);
...
function xs(e, t, o) {
  return t === Xl ? xi(Eh(e, o)) : wn(t) ? Th(t, o) : xi(Oh(bn(e)));
}
function Ch(e) {
  var t = go(jr(e)),
...
function $o(e, t) {
  ...
  var o = t,
    ...
    h = o.padding,
    v = h === void 0 ? 0 : h,
    O = tc(typeof v != 'number' ? v : nc(v, Mo)),
    C = m === so ? Ym : so,
    E = e.rects.popper,
    x = e.elements[g ? C : m],
...
function Zh(e) {
  ...
  return function (l, c, d) {
    ...
    if (!Ss(l, c)) return process.env.NODE_ENV !== 'production' && console.error(Cs), y;
...
const lr = /* @__PURE__ */ b.forwardRef(function (t, o) {
  ...
  return /* @__PURE__ */ N(b.Fragment, {
    children: s && /* @__PURE__ */ fl.createPortal(r, s),
  });
});
process.env.NODE_ENV !== 'production' &&
  (lr.propTypes = {
  ...
  if (!t.disableScrollLock) {
    if (cb(r)) {
      ...
      o.push({
        ...
        (r.style.paddingRight = `${ws(r) + s}px`);
      ...
      [].forEach.call(l, (c) => {
        o.push({
          ...
          (c.style.paddingRight = `${ws(c) + s}px`);
      });
    }
    let a;
  ...
  remove(t, o = !0) {
    ...
    if ((a.modals.splice(a.modals.indexOf(t), 1), this.modals.splice(r, 1), a.modals.length === 0))
      a.restore && a.restore(),
        ...
        $s(a.container, t.mount, t.modalRef, a.hiddenSiblings, !1),
...
const gb = new fb(),
  sc = /* @__PURE__ */ b.forwardRef(function (t, o) {
    ...
    a.props.tabIndex === void 0 && (M.tabIndex = '-1'),
      re && ((M.onEnter = Ma(ae, a.props.onEnter)), (M.onExited = Ma(ue, a.props.onExited)));
...
function Ns({ values: e, newValue: t, index: o }) {
  const r = e.slice();
  return (r[o] = t), r.sort(lc);
}
...
function Sb(e) {
  ...
  const D =
      s === !0 && h !== null
        ...
        : s || [],
    W = D.map((te) => te.value),
    { isFocusVisibleRef: re, onBlur: L, onFocus: F, ref: $ } = El(),
    [B, Z] = b.useState(-1),
    U = b.useRef(),
    Y = rt($, U),
    X = rt(y, Y),
...
const cc = /* @__PURE__ */ b.forwardRef(function (t, o) {
  ...
  Kb = le('div', {
    ...
    return {
      ...
      ...(t.variant === 'elevation' && {
        ...
        ...(!e.vars &&
          e.palette.mode === 'dark' && {
            backgroundImage: `linear-gradient(${Ye('#fff', fs(t.elevation))}, ${Ye(
              '#fff',
              fs(t.elevation),
            )})`,
          }),
...
const rv = we('MuiButtonBase', ['root', 'disabled', 'focusVisible']),
  ...
  hc = /* @__PURE__ */ b.forwardRef(function (t, o) {
    const r = Me({
      ...
      F = b.useRef(null),
      $ = rt(F, D),
      { isFocusVisibleRef: B, onFocus: Z, onBlur: U, ref: Y } = El(),
      [X, ie] = b.useState(!1);
    d && X && ie(!1),
      b.useImperativeHandle(
        i,
...
const xc = /* @__PURE__ */ b.forwardRef(function (t, o) {
  const r = Me({
      props: t,
      name: 'MuiChip',
    }),
    ...
    j = (F) => {
      F.currentTarget === F.target && zs(F) && F.preventDefault(), h && h(F);
    },
    w = (F) => {
      F.currentTarget === F.target &&
        (g && zs(F) ? g(F) : F.key === 'Escape' && S.current && S.current.blur()),
        v && v(F);
    },
    I = s !== !1 && y ? !0 : s,
    G = I || g ? Jn : c || 'div',
...
const Ec = /* @__PURE__ */ b.createContext(void 0);
process.env.NODE_ENV !== 'production' && (Ec.displayName = 'FormControlContext');
const la = Ec;
function Pn() {
...
function pr(e, t = !1) {
  return (
    e && ((Bs(e.value) && e.value !== '') || (t && Bs(e.defaultValue) && e.defaultValue !== ''))
  );
}
function Nv(e) {
  ...
  Rc = /* @__PURE__ */ b.forwardRef(function (t, o) {
    ...
    const l = Me({
      ...
      }),
      {
        ...
        PopperComponent: Fe = yc,
        popupIcon: Ze = Us || (Us = /* @__PURE__ */ N(Cc, {})),
        readOnly: te = !1,
        renderGroup: ne,
        renderInput: xe,
        renderOption: he,
...
const ig = (e) => {
  ...
  wc = /* @__PURE__ */ b.forwardRef(function (t, o) {
    var r, i, a;
    const s = Me({
        props: t,
        name: 'MuiBackdrop',
...
const cg = we('MuiButton', [
  ...
  Ho = cg,
  $c = /* @__PURE__ */ b.createContext({});
process.env.NODE_ENV !== 'production' && ($c.displayName = 'ButtonGroupContext');
const ug = $c,
  dg = (e) => {
...
const jc = /* @__PURE__ */ b.forwardRef(function (t, o) {
  const r = cn(),
    i = {
...
function Bg(e, t) {
  return e.direction === 'rtl' && zg(t) ? Fc[t] : t;
}
const zc = /* @__PURE__ */ b.forwardRef(function (t, o) {
  const r = Me({
      props: t,
      name: 'MuiDrawer',
    }),
...
const Hc = Wc,
  qc = /* @__PURE__ */ b.createContext();
process.env.NODE_ENV !== 'production' && (qc.displayName = 'GridContext');
const Ks = qc;
function ay(e) {
  return ke('MuiGrid', e);
}
...
function Yc({ breakpoints: e, values: t }) {
  let o = '';
  Object.keys(t).forEach((i) => {
    o === '' && t[i] !== 0 && (o = i);
  });
...
function uo(e, t, o, r, i, a) {
  ...
  for (; l; ) {
    ...
    if (!l.hasAttribute('tabindex') || !eu(l, a) || c) l = i(e, l, o);
    else return l.focus(), !0;
  }
  return !1;
}
const tu = /* @__PURE__ */ b.forwardRef(function (t, o) {
  const {
      // private
      // eslint-disable-next-line react/prop-types
      actions: r,
  ...
  const h = (E) => {
      ...
      else if (f === 'ArrowUp') E.preventDefault(), uo(x, S, d, c, Js);
      else if (f === 'Home') E.preventDefault(), uo(x, null, d, c, ii);
      else if (f === 'End') E.preventDefault(), uo(x, null, d, c, Js);
      else if (f.length === 1) {
        const R = g.current,
          A = f.toLowerCase(),
          j = performance.now();
...
`),
        ...
        return {
          top: Z.top + Zs(Z, s.vertical),
          left: Z.left + Qs(Z, s.horizontal),
        };
      }, [a, s.horizontal, s.vertical, l, c]),
      I = b.useCallback(
        ($) => ({
          vertical: Zs($, v.vertical),
          horizontal: Qs($, v.horizontal),
        }),
...
`),
      ...
      if (C) {
        ...
        (ye = L.some((Re) => ol(Re, H.props.value))), ye && te && Ze.push(H.props.children);
      } else (ye = ol(L, H.props.value)), ye && te && (Fe = H.props.children);
      return (
        ye && (ne = !0),
...
const $0 = (e) => {
  ...
  yu = /* @__PURE__ */ b.forwardRef(function (t, o) {
    ...
    const Qe = $0(ne),
      lt = (r = (i = Ne == null ? void 0 : Ne.root) != null ? i : L.Root) != null ? r : pu,
      ut = (a = (s = Ne == null ? void 0 : Ne.rail) != null ? s : L.Rail) != null ? a : fu,
      Yt = (l = (c = Ne == null ? void 0 : Ne.track) != null ? c : L.Track) != null ? l : mu,
      Kt = (d = (u = Ne == null ? void 0 : Ne.thumb) != null ? u : L.Thumb) != null ? d : hu,
      rn =
        (p = (m = Ne == null ? void 0 : Ne.valueLabel) != null ? m : L.ValueLabel) != null ? p : bu,
      Ot = (y = (g = Ne == null ? void 0 : Ne.mark) != null ? g : L.Mark) != null ? y : vu,
      Gt =
        (h = (v = Ne == null ? void 0 : Ne.markLabel) != null ? v : L.MarkLabel) != null ? h : gu,
...
const to = [
  ...
  al = (e) => to[e < va || e > Su ? 0 : e].fullNames[0],
  sl = () => {
    const e = [];
    return (
  ...
  ix = (e) => to[e].chapters,
  ll = (e, t) => ({
    book: Math.max(va, Math.min(e.book + t, Su)),
    chapter: 1,
    verse: 1,
  }),
  cl = (e, t) => ({
...
function mx({ scrRef: e, handleSubmit: t }) {
  ...
  return /* @__PURE__ */ Ke(Lu, {
    children: [
      ...
      /* @__PURE__ */ N(Ln, {
        onClick: () => t(ul(e, -1)),
        isDisabled: e.verse <= $u,
        children: '<',
      }),
      /* @__PURE__ */ N(Ln, { onClick: () => t(ul(e, 1)), children: '>' }),
    ],
  });
}
function hx({
    ...
    const z = e.map((_) =>
      typeof _.editable == 'function'
        ? {
            ...
            renderEditCell: _.renderEditCell || dl,
          }
...
function lx({ commandHandler: e, name: t, className: o, items: r }) {
  return /* @__PURE__ */ Ke(Kc, {
    item: !0,
    xs: 1,
    className: `papi-menu-column ${o ?? ''}`,
    children: [
      /* @__PURE__ */ N('h3', { className: `papi-menu ${o ?? ''}`, children: t }),
      r.map((i, a) =>
        /* @__PURE__ */ N(
          ax,
          {
...
function cx({ commandHandler: e, className: t, columns: o }) {
