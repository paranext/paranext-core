import { jsx as C, jsxs as Fe, Fragment as Bn } from 'react/jsx-runtime';
import {
  Button as Dn,
  FormLabel as jn,
  Checkbox as zn,
...
import { useState as dn, useMemo as Wn, useRef as Tr } from 'react';
...
function et({
  ...
  if (r) {
    const p = n === $e.Before || n === $e.Above,
      ...
      h = y ? l : /* @__PURE__ */ C('div', { children: l });
    d = /* @__PURE__ */ Fe(jn, {
...
const vn = 1,
  ...
  Rr = (e, r) => ({
    bookNum: Math.max(vn, Math.min(e.bookNum + r, ht)),
    chapterNum: 1,
    verseNum: 1,
  }),
  Ar = (e, r) => ({
...
function Ir({ onRowChange: e, row: r, column: n }) {
  ...
  return /* @__PURE__ */ C(ur, { defaultValue: r[n.key], onChange: t });
}
...
function En() {
  return (
    Dr ||
      ((Dr = 1), process.env.NODE_ENV === 'production' ? (Ge.exports = xt()) : (Ge.exports = Nt())),
    Ge.exports
  );
}
/*
  ...
  return (
    (ir = function (c, i) {
      ...
      function re(g) {
        ...
        function k(_, w, N, P, E) {
          for (var T = _[w], I = 0; I < g.length; I++) if (v(T, g[I])) return null;
...
if (process.env.NODE_ENV !== 'production') {
  var Ct = En(),
    _t = !0;
  dr.exports = wt()(Ct.isElement, _t);
} else dr.exports = Tt()();
var Ot = dr.exports;
const H = /* @__PURE__ */ kt(Ot);
function Pe(e) {
...
process.env.NODE_ENV === 'production' ? (fr.exports = $t()) : (fr.exports = Rt());
var Gr = fr.exports;
...
Ze(er, rr, nr, bo, yo, vo, ko, xo, No, So, Eo, wo);
function Ae(e, r) {
  return r === 'grey' ? r : e;
}
const To = F({
...
function Qo(e = {}) {
  ...
  return (
    (a.__mui_systemSx = !0),
    (s, c = {}) => {
      Ut(s, (R) => R.filter((m) => !(m != null && m.__mui_systemSx)));
      const { name: i, slot: l, skipVariantsResolver: d, skipSx: p, overridesResolver: u } = c,
        y = ge(c, Jo),
        v = d !== void 0 ? d : (l && l !== 'Root') || !1,
        h = p || !1;
      let f;
      process.env.NODE_ENV !== 'production' && i && (f = `${i}-${Zo(l || 'Root')}`);
      let S = qe;
      l === 'Root' ? (S = t) : l ? (S = o) : qo(s) && (S = void 0);
      const W = Ft(
          s,
          A(
            {
...
function Zr(e) {
  e = Ie(e);
  let r = e.type === 'hsl' || e.type === 'hsla' ? Ie(ta(e)).values : e.values;
  return (
    (r = r.map(
      (n) => (
...
function oa(e, r) {
  if (((e = Ie(e)), (r = Pn(r)), e.type.indexOf('hsl') !== -1)) e.values[2] *= 1 - r;
  else if (e.type.indexOf('rgb') !== -1 || e.type.indexOf('color') !== -1)
    for (let n = 0; n < 3; n += 1) e.values[n] *= 1 - r;
  return Sr(e);
}
function aa(e, r) {
  if (((e = Ie(e)), (r = Pn(r)), e.type.indexOf('hsl') !== -1))
      ...
      children: /* @__PURE__ */ Fe(Gn, {
        ...
        children: [
          e.menu
            ...
            : null,
          e.children
            ? /* @__PURE__ */ C('div', { style: { padding: 10 }, children: e.children })
            : null,
          e.menu
            ? /* @__PURE__ */ C(Kn, {
