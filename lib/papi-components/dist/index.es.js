...
function q0({ scrRef: e, handleSubmit: t }) {
...
function G0({ onRowChange: e, row: t, column: o }) {
  const r = (i) => {
    e({ ...t, [o.key]: i.target.value });
  };
  return /* @__PURE__ */ D(pi, { defaultValue: t[o.key], onChange: r });
}
const B0 = ({ onChange: e, disabled: t, checked: o, ...r }) => {
  function i(a) {
    e(a.target.checked, a.nativeEvent.shiftKey);
  }
  return /* @__PURE__ */ D(F0, { ...r, isChecked: o, isDisabled: t, onChange: i });
};
function X0({
  columns: e,
  sortColumns: t,
  ...
  const K = cu(() => (d ? [{ ...du, minWidth: f }, ...e] : e), [d, e]);
