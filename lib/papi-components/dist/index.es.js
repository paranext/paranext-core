...
function ls({ isChecked: e, isDisabled: r = !1, hasError: n = !1, className: t, onChange: o }) {
  ...
  return (
    ...
    (s, l = {}) => {
      ...
      const { name: i, slot: c, skipVariantsResolver: f, skipSx: h, overridesResolver: u } = l,
        ...
        p = h || !1;
      let d;
      process.env.NODE_ENV !== 'production' && i && (d = `${i}-${Zo(c || 'Root')}`);
      let N = qe;
      c === 'Root' ? (N = t) : c ? (N = o) : Ko(s) && (N = void 0);
      const W = Ft(
          s,
          A(
            {
...
function ds({ menu: e, dataHandler: r, commandHandler: n, className: t, children: o }) {
  const [a, s] = Ke(!1),
    [l, i] = Ke(!1),
    c = or(() => {
      a && s(!1), i(!1);
