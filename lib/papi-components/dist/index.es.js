...
import { Button as Vn, Autocomplete as Ln, TextField as fn, FormControlLabel as Ar, FormLabel as Fn, Checkbox as Hn, MenuItem as Un, Grid as pn, IconButton as hn, Paper as Jn, InputBase as Gn, Slider as Kn, Snackbar as Wn, Switch as qn, AppBar as Xn, Toolbar as Yn, Drawer as Zn } from "@mui/material";
import * as Le from "react";
import { useMemo as yr, useState as Ke, useCallback as or, useRef as Qn, useEffect as et } from "react";
import rt, { SelectColumn as nt } from "react-data-grid";
import tt, { ThemeContext as ot, internal_processStyles as at } from "@mui/styled-engine";
function Ee({
  id: e,
  isDisabled: r = !1,
  className: n,
...
function ct({ commandHandler: e, name: r, className: n, items: t, id: o }) {
...
function lt({ commandHandler: e, className: r, columns: n, id: t }) {
  return /* @__PURE__ */ S(
    pn,
    {
      container: !0,
...
var ut = Object.defineProperty, dt = (e, r, n) => r in e ? ut(e, r, { enumerable: !0, configurable: !0, writable: !0, value: n }) : e[r] = n, $ = (e, r, n) => (dt(e, typeof r != "symbol" ? r + "" : r, n), n);
const ke = [
  "GEN",
  "EXO",
  "LEV",
...
function vn(e) {
  const r = typeof e == "number" ? kr(e) : e;
  return xr(r) && !vr.includes(r);
}
function vt(e) {
  const r = typeof e == "number" ? kr(e) : e;
  return xr(r) && vr.includes(r);
...
var xn = /* @__PURE__ */ ((e) => (e[e.Valid = 0] = "Valid", e[e.UnknownVersification = 1] = "UnknownVersification", e[e.OutOfRange = 2] = "OutOfRange", e[e.VerseOutOfOrder = 3] = "VerseOutOfOrder", e[e.VerseRepeated = 4] = "VerseRepeated", e))(xn || {});
const O = class {
  constructor(r, n, t, o) {
...
}))), ar), Sn = 1, St = kn.length - 1, Nn = 1, En = 1, wn = (e) => {
  var r;
  return ((r = kn[e]) == null ? void 0 : r.chapters) ?? -1;
}, Ir = (e, r) => ({
  bookNum: Math.max(Sn, Math.min(e.bookNum + r, St)),
  chapterNum: 1,
  verseNum: 1
}), Br = (e, r) => ({
  ...e,
...
function us({ onSearch: e, placeholder: r, isFullWidth: n }) {
  const [t, o] = Ke(""), a = (s) => {
    o(s), e(s);
  };
...
function jr({ onRowChange: e, row: r, column: n }) {
  ...
  return /* @__PURE__ */ S(mr, { defaultValue: r[n.key], onChange: t });
}
const Nt = ({ onChange: e, disabled: r, checked: n, ...t }) => /* @__PURE__ */ S(
  st,
  {
    ...t,
    isChecked: n,
...
function hs({
  ...
  const le = yr(() => {
    const Q = e.map((W) => typeof W.editable == "function" ? {
      ...
      renderEditCell: W.renderEditCell || jr
    } : W.editable && !W.renderEditCell ? { ...W, renderEditCell: jr } : W.renderEditCell && !W.editable ? { ...W, editable: !1 } : W);
...
function wt() {
  ...
  return z.AsyncMode = c, z.ConcurrentMode = i, z.ContextConsumer = u, z.ContextProvider = s, z.Element = r, z.ForwardRef = l, z.Fragment = t, z.Lazy = b, z.Memo = v, z.Portal = n, z.Profiler = a, z.StrictMode = o, z.Suspense = p, z.isAsyncMode = function(m) {
    ...
    return typeof m == "string" || typeof m == "function" || m === t || m === i || m === a || m === o || m === p || m === d || typeof m == "object" && m !== null && (m.$$typeof === b || m.$$typeof === v || m.$$typeof === s || m.$$typeof === u || m.$$typeof === l || m.$$typeof === f || m.$$typeof === N || m.$$typeof === q || m.$$typeof === h);
  }, z.typeOf = B, z;
}
var V = {};
/** @license React v16.13.1
...
function Tt() {
  return Vr || (Vr = 1, process.env.NODE_ENV !== "production" && function() {
    ...
    function B(y) {
      ...
      y === t || y === i || y === a || y === o || y === p || y === d || typeof y == "object" && y !== null && (y.$$typeof === b || y.$$typeof === v || y.$$typeof === s || y.$$typeof === u || y.$$typeof === l || y.$$typeof === f || y.$$typeof === N || y.$$typeof === q || y.$$typeof === h);
    }
    function R(y) {
    ...
    var m = c, X = i, ne = u, ie = s, ae = r, D = l, Y = t, ce = b, le = v, Q = n, W = a, ee = o, se = p, ve = !1;
    function Se(y) {
    ...
    V.AsyncMode = m, V.ConcurrentMode = X, V.ContextConsumer = ne, V.ContextProvider = ie, V.Element = ae, V.ForwardRef = D, V.Fragment = Y, V.Lazy = ce, V.Memo = le, V.Portal = Q, V.Profiler = W, V.StrictMode = ee, V.Suspense = se, V.isAsyncMode = Se, V.isConcurrentMode = g, V.isContextConsumer = x, V.isContextProvider = _, V.isElement = T, V.isForwardRef = E, V.isFragment = P, V.isLazy = w, V.isMemo = C, V.isPortal = M, V.isProfiler = j, V.isStrictMode = I, V.isSuspense = Z, V.isValidElementType = B, V.typeOf = R;
  }()), V;
}
var Lr;
function Cn() {
  return Lr || (Lr = 1, process.env.NODE_ENV === "production" ? Ge.exports = wt() : Ge.exports = Tt()), Ge.exports;
}
/*
object-assign
(c) Sindre Sorhus
...
var lr, Ur;
function _n() {
  return Ur || (Ur = 1, lr = Function.call.bind(Object.prototype.hasOwnProperty)), lr;
}
var ur, Jr;
function _t() {
  if (Jr)
...
function Ot() {
  if (Gr)
    return dr;
  Gr = 1;
  var e = Cn(), r = Ct(), n = Sr(), t = _n(), o = _t(), a = function() {
  };
  ...
  return dr = function(u, c) {
    ...
    function D() {
      function g(x, _, T, E, P) {
        return Q(x[_]) ? null : new h("Invalid " + E + " `" + P + "` supplied to " + ("`" + T + "`, expected a ReactNode."));
      }
      return f(g);
    }
    function Y(g, x, _, T, E) {
      return new h(
        (g || "React class") + ": " + x + " type `" + _ + "." + T + "` is invalid; it must be a function, usually from the `prop-types` package, but received `" + E + "`."
      );
    }
    function ce(g) {
      function x(_, T, E, P, w) {
...
if (process.env.NODE_ENV !== "production") {
  var Rt = Cn(), At = !0;
  gr.exports = Ot()(Rt.isElement, At);
} else
  gr.exports = $t()();
var Pt = gr.exports;
const U = /* @__PURE__ */ Et(Pt);
function Pe(e) {
...
function It() {
  return qr || (qr = 1, process.env.NODE_ENV !== "production" && function() {
    var e = Symbol.for("react.element"), r = Symbol.for("react.portal"), n = Symbol.for("react.fragment"), t = Symbol.for("react.strict_mode"), o = Symbol.for("react.profiler"), a = Symbol.for("react.provider"), s = Symbol.for("react.context"), u = Symbol.for("react.server_context"), c = Symbol.for("react.forward_ref"), i = Symbol.for("react.suspense"), l = Symbol.for("react.suspense_list"), p = Symbol.for("react.memo"), d = Symbol.for("react.lazy"), v = Symbol.for("react.offscreen"), b = !1, h = !1, f = !1, N = !1, q = !1, B;
    B = Symbol.for("react.module.reference");
    function R(k) {
      return !!(typeof k == "string" || typeof k == "function" || k === n || k === o || q || k === t || k === i || k === l || N || k === v || b || h || f || typeof k == "object" && k !== null && (k.$$typeof === d || k.$$typeof === p || k.$$typeof === a || k.$$typeof === s || k.$$typeof === c || // This needs to include all possible module reference object
    ...
    var X = s, ne = a, ie = e, ae = c, D = n, Y = d, ce = p, le = r, Q = o, W = t, ee = i, se = l, ve = !1, Se = !1;
    function g(k) {
    ...
    F.ContextConsumer = X, F.ContextProvider = ne, F.Element = ie, F.ForwardRef = ae, F.Fragment = D, F.Lazy = Y, F.Memo = ce, F.Portal = le, F.Profiler = Q, F.StrictMode = W, F.Suspense = ee, F.SuspenseList = se, F.isAsyncMode = g, F.isConcurrentMode = x, F.isContextConsumer = _, F.isContextProvider = T, F.isElement = E, F.isForwardRef = P, F.isFragment = w, F.isLazy = C, F.isMemo = M, F.isPortal = j, F.isProfiler = I, F.isStrictMode = Z, F.isSuspense = y, F.isSuspenseList = te, F.isValidElementType = R, F.typeOf = m;
  }()), F;
}
process.env.NODE_ENV === "production" ? br.exports = Mt() : br.exports = It();
var Xr = br.exports;
...
function On(e, r = "") {
  return e.displayName || e.name || Dt(e) || r;
}
function Yr(e, r, n) {
  const t = On(r);
...
const Gt = ["values", "unit", "step"], Kt = (e) => {
...
function Wt(e) {
  const {
    ...
    unit: n = "px",
    step: t = 5
  } = e, o = ge(e, Gt), a = Kt(r), s = Object.keys(a);
  function u(d) {
...
const qt = {
  borderRadius: 4
}, Xt = qt, Yt = process.env.NODE_ENV !== "production" ? U.oneOfType([U.number, U.string, U.object, U.array]) : {}, ye = Yt;
function Ve(e, r) {
  return r ? he(e, r, {
    clone: !1
...
function H(e) {
  const {
    ...
    if (s[r] == null)
      return null;
    const u = s[r], c = s.theme, i = Xe(c, t) || {};
    return me(s, u, (p) => {
      let d = qe(i, o, p);
      return p === d && typeof p == "string" && (d = qe(i, o, `${r}${p === "default" ? "" : de(p)}`, p)), n === !1 ? d : {
        [n]: d
      };
    });
  };
...
function so(e, r, n, t) {
  if (r.indexOf(n) === -1)
    return null;
  const o = to(n), a = ao(o, t), s = e[n];
  return me(e, s, a);
}
function Pn(e, r) {
  const n = An(e.theme);
  return Object.keys(e).map((t) => so(e, r, t, n)).reduce(Ve, {});
}
function G(e) {
  return Pn(e, Ye);
}
...
Qe(co, lo, uo, fo, po, ho, mo, go, bo, yo, er);
const rr = (e) => {
...
Qe(rr, nr, tr, vo, xo, ko, So, No, Eo, wo, To, Co);
function Ae(e, r) {
  return r === "grey" ? r : e;
}
const _o = H({
...
function Vo() {
  function e(n, t, o, a) {
    ...
    return p ? p(s) : me(s, t, (b) => {
      let h = qe(d, l, b);
      return b === h && typeof b == "string" && (h = qe(d, l, `${n}${b === "default" ? "" : de(b)}`, b)), c === !1 ? h : {
        [c]: h
      };
    });
  }
  function r(n) {
    ...
    function u(c) {
      ...
      if (!i)
        return null;
      const l = Zt(a.breakpoints), p = Object.keys(l);
      let d = l;
...
const Mn = Vo();
Mn.filterProps = ["sx"];
const Cr = Mn, Lo = ["breakpoints", "palette", "spacing", "shape"];
function _r(e = {}, ...r) {
  const {
    breakpoints: n = {},
    palette: t = {},
...
const Ko = ["name", "slot", "skipVariantsResolver", "skipSx", "overridesResolver"];
function Wo(e) {
  return Object.keys(e).length === 0;
}
function qo(e) {
...
const Xo = (e, r) => r.components && r.components[e] && r.components[e].styleOverrides ? r.components[e].styleOverrides : null, Yo = (e, r) => {
  let n = [];
...
const Qo = _r(), nn = (e) => e && e.charAt(0).toLowerCase() + e.slice(1);
function je({
  defaultTheme: e,
  theme: r,
  themeId: n
...
function ra(e = {}) {
  ...
  return a.__mui_systemSx = !0, (s, u = {}) => {
    at(s, (R) => R.filter((m) => !(m != null && m.__mui_systemSx)));
    const {
      name: c,
      slot: i,
      ...
      overridesResolver: d = ea(nn(i))
    } = u, v = ge(u, Ko), b = l !== void 0 ? l : (
    ...
    const q = tt(s, A({
      ...
      if (process.env.NODE_ENV !== "production") {
        let D;
        c && (D = `${c}${de(i || "")}`), D === void 0 && (D = `Styled(${jt(s)})`), ae.displayName = D;
      }
...
function tn(e) {
  e = Me(e);
  let r = e.type === "hsl" || e.type === "hsla" ? Me(aa(e)).values : e.values;
...
const la = {
  ...
  A400: "#00e676",
  A700: "#00c853"
}, Oe = ba, ya = ["mode", "contrastThreshold", "tonalOffset"], an = {
...
function sn(e, r, n, t) {
  ...
  e[r] || (e.hasOwnProperty(n) ? e[r] = e[n] : r === "light" ? e.light = ia(e.main, o) : r === "dark" && (e.dark = sa(e.main, a)));
}
function va(e = "light") {
  return e === "dark" ? {
    main: Ce[200],
...
function wa(e) {
  const {
    ...
    tonalOffset: t = 0.2
  } = e, o = ge(e, ya), a = e.primary || va(r), s = e.secondary || xa(r), u = e.error || ka(r), c = e.info || Sa(r), i = e.success || Na(r), l = e.warning || Ea(r);
  function p(h) {
    const f = on(h, pr.text.primary) >= n ? pr.text.primary : an.text.primary;
    if (process.env.NODE_ENV !== "production") {
      const N = on(h, f);
...
const theme2 = createTheme({ palette: {
  primary: { main: green[500] },
    ...
    return sn(h, "light", q, t), sn(h, "dark", B, t), h.contrastText || (h.contrastText = p(h.main)), h;
  }, v = {
    dark: pr,
    light: an
  };
...
const Ta = ["fontFamily", "fontSize", "fontWeightLight", "fontWeightRegular", "fontWeightMedium", "fontWeightBold", "htmlFontSize", "allVariants", "pxToRem"];
function Ca(e) {
...
function _a(e, r) {
  ...
  const v = o / 14, b = p || ((N) => `${N / i * v}rem`), h = (N, q, B, R, m) => A({
    fontFamily: t,
    fontWeight: N,
    fontSize: b(q),
...
const Oa = 0.2, $a = 0.14, Ra = 0.12;
function J(...e) {
  return [`${e[0]}px ${e[1]}px ${e[2]}px ${e[3]}px rgba(0,0,0,${Oa})`, `${e[4]}px ${e[5]}px ${e[6]}px ${e[7]}px rgba(0,0,0,${$a})`, `${e[8]}px ${e[9]}px ${e[10]}px ${e[11]}px rgba(0,0,0,${Ra})`].join(",");
}
const Aa = ["none", J(0, 2, 1, -1, 0, 1, 1, 0, 0, 1, 3, 0), J(0, 3, 1, -2, 0, 2, 2, 0, 0, 1, 5, 0), J(0, 3, 3, -2, 0, 3, 4, 0, 0, 1, 8, 0), J(0, 2, 4, -1, 0, 4, 5, 0, 0, 1, 10, 0), J(0, 3, 5, -1, 0, 5, 8, 0, 0, 1, 14, 0), J(0, 3, 5, -1, 0, 6, 10, 0, 0, 1, 18, 0), J(0, 4, 5, -2, 0, 7, 10, 1, 0, 2, 16, 1), J(0, 5, 5, -3, 0, 8, 10, 1, 0, 3, 14, 2), J(0, 5, 6, -3, 0, 9, 12, 1, 0, 3, 16, 2), J(0, 6, 6, -3, 0, 10, 14, 1, 0, 4, 18, 3), J(0, 6, 7, -4, 0, 11, 15, 1, 0, 4, 20, 3), J(0, 7, 8, -4, 0, 12, 17, 2, 0, 5, 22, 4), J(0, 7, 8, -4, 0, 13, 19, 2, 0, 5, 24, 4), J(0, 7, 9, -4, 0, 14, 21, 2, 0, 5, 26, 4), J(0, 8, 9, -5, 0, 15, 22, 2, 0, 6, 28, 5), J(0, 8, 10, -5, 0, 16, 24, 2, 0, 6, 30, 5), J(0, 8, 11, -5, 0, 17, 26, 2, 0, 6, 32, 5), J(0, 9, 11, -5, 0, 18, 28, 2, 0, 7, 34, 6), J(0, 9, 12, -6, 0, 19, 29, 2, 0, 7, 36, 6), J(0, 10, 13, -6, 0, 20, 31, 3, 0, 8, 38, 7), J(0, 10, 13, -6, 0, 21, 33, 3, 0, 8, 40, 7), J(0, 10, 14, -6, 0, 22, 35, 3, 0, 8, 42, 7), J(0, 11, 14, -7, 0, 23, 36, 3, 0, 9, 44, 8), J(0, 11, 15, -7, 0, 24, 38, 3, 0, 9, 46, 8)], Pa = Aa, Ma = ["duration", "easing", "delay"], Ia = {
...
function ja(e) {
  const r = A({}, Ia, e.easing), n = A({}, Ba, e.duration);
  return A({
...
const za = {
  ...
  snackbar: 1400,
  tooltip: 1500
}, Va = za, La = ["breakpoints", "mixins", "spacing", "palette", "transitions", "typography", "shape"];
function Fa(e = {}, ...r) {
  const {
    mixins: n = {},
    palette: t = {},
...
const Ja = (e) => We(e) && e !== "classes", Ga = ra({
  themeId: jn,
  defaultTheme: Dn,
...
const qa = ["children", "className", "color", "component", "fontSize", "htmlColor", "inheritViewBox", "titleAccess", "viewBox"], Xa = (e) => {
  const {
    color: r,
    fontSize: n,
    classes: t
  ...
  l || (f.viewBox = d);
  const N = Xa(h);
  return /* @__PURE__ */ Ie(Ya, A({
    as: u,
    className: Jt(N.root, a),
    focusable: "false",
    color: i,
...
function ms({
  ...
  const [s, u] = Ke(!1), [c, i] = Ke(!1), l = or(() => {
    s && u(!1), i(!1);
  }, [s]), p = or((N) => {
    N.stopPropagation(), u((q) => {
      const B = !q;
  ...
  let f = e;
  return !f && r && (f = r(c)), /* @__PURE__ */ S("div", { ref: d, style: { position: "relative" }, children: /* @__PURE__ */ S(Xn, { position: "static", id: o, children: /* @__PURE__ */ Ie(Yn, { className: `papi-toolbar ${t ?? ""}`, variant: "dense", children: [
    f ? /* @__PURE__ */ S(
      hn,
      {
        edge: "start",
    ...
    f ? /* @__PURE__ */ S(
      Zn,
      {
        ...
        children: /* @__PURE__ */ S(lt, { commandHandler: h, columns: f.columns })
      }
    ) : null
  ] }) }) });
}
