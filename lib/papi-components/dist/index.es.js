...
function et({
  ...
  if (n) {
    const l = t === $e.Before || t === $e.Above,
      ...
      h = b ? v : /* @__PURE__ */ w('div', { children: v }),
      d = b ? f : /* @__PURE__ */ w('div', { children: f });
    p = /* @__PURE__ */ Fe(In, {
          ...
          children: [
            ...
            d
              ? /* @__PURE__ */ w(Jn, {
                  ...
                  children: /* @__PURE__ */ w(ot, { commandHandler: h, columns: d.columns }),
                })
              : null,
          ],
        }),
