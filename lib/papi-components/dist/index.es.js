...
function et({
  ...
  if (n) {
    const l = t === $e.Before || t === $e.Above,
      ...
      b = t === $e.Before || t === $e.After,
      h = b ? v : /* @__PURE__ */ C('div', { children: v }),
      d = b ? f : /* @__PURE__ */ C('div', { children: f });
    p = /* @__PURE__ */ Fe(In, {
...
function ts({ scrRef: e, handleSubmit: r, id: n }) {
  const [t, o] = Ke(Rr(e.bookNum)),
    ...
    s = (i, f) => {
      const l = { bookNum: ie.bookIdToNumber(f.bookId), chapterNum: 1, verseNum: 1 };
      a(l);
    },
    c = (i) => {
  ...
  return /* @__PURE__ */ Fe('span', {
    ...
    children: [
      ...
      /* @__PURE__ */ C(Ne, { onClick: () => r(Mr(e, 1)), children: '>' }),
    ],
  });
}
function os({
  ...
  return (
    (lr = function (c, u) {
      ...
      function ne(g) {
        ...
        function k(O, w, E, P, N) {
          for (var T = O[w], M = 0; M < g.length; M++) if (b(T, g[M])) return null;
      ...
      function ae(g) {
        ...
        function w(E, P, N, T, M) {
          ...
          return new h('Invalid ' + T + ' `' + M + '` supplied to ' + ('`' + N + '`' + te + '.'));
        }
        return d(w);
      }
      function D() {
      ...
      function le(g) {
        function k(O, w, E, P, N) {
          ...
          for (var j in g) {
            var I = g[j];
            if (typeof I != 'function') return Y(E, P, N, j, se(I));
            var Z = I(T, j, E, P, N + '.' + j, n);
            if (Z) return Z;
          }
          return null;
        }
      ...
      function ue(g) {
        function k(O, w, E, P, N) {
          ...
          for (var I in j) {
            var Z = g[I];
            if (t(g, I) && typeof Z != 'function') return Y(E, P, N, I, se(Z));
            if (!Z)
              return new h(
                'Invalid ' +
                  P +
          ...
          case 'object':
            ...
            if (k) {
              var O = k.call(g),
                w;
              if (k !== g.entries) {
                for (; !(w = O.next()).done; ) if (!Q(w.value)) return !1;
              } else
                for (; !(w = O.next()).done; ) {
                  var E = w.value;
                  if (E && !Q(E[1])) return !1;
...
Qe(rr, nr, tr, mo, go, bo, yo, vo, ko, xo, So, Eo);
function Ae(e, r) {
  return r === 'grey' ? r : e;
}
const No = H({
...
function ja(e = {}, ...r) {
  ...
  if (
    ((i = pe(i, s)), (i = r.reduce((f, p) => pe(f, p), i)), process.env.NODE_ENV !== 'production')
  ) {
    const f = [
        'active',
        'checked',
...
const Ja = [
  ...
  Tr = /* @__PURE__ */ Ve.forwardRef(function (r, n) {
    const t = Va({
      ...
      v = ge(t, Ja),
      b = /* @__PURE__ */ Ve.isValidElement(o) && o.type === 'svg',
      h = A({}, t, {
        color: s,
        component: c,
        fontSize: u,
