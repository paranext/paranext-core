...
import { Button as Dn, FormLabel as jn, Checkbox as zn, Autocomplete as Vn, TextField as ln, MenuItem as Ln, Grid as un, IconButton as dn, Slider as Fn, Snackbar as Hn, Switch as Un, AppBar as Jn, Toolbar as Gn, Drawer as Kn } from "@mui/material";
import * as Ve from "react";
import { useMemo as fn, useState as tr, useCallback as or, useRef as qn, useEffect as Wn } from "react";
...
function rt({
  ...
  let p;
  if (n) {
    const u = t === $e.Before || t === $e.Above, y = /* @__PURE__ */ w("span", { className: `papi-checkbox-label ${l ? "error" : ""} ${i ?? ""}`, children: n }), v = t === $e.Before || t === $e.After, h = v ? y : /* @__PURE__ */ w("div", { children: y }), f = v ? d : /* @__PURE__ */ w("div", { children: d });
    p = /* @__PURE__ */ Fe(
      jn,
      {
...
function ns({
  ...
  isFocusRippleDisabled: a = !1,
  adjustMarginToAlignToEdge: s = !1,
  size: l = "medium",
  className: i,
  onClick: c,
  children: d
...
var yn = /* @__PURE__ */ ((e) => (e[e.Valid = 0] = "Valid", e[e.UnknownVersification = 1] = "UnknownVersification", e[e.OutOfRange = 2] = "OutOfRange", e[e.VerseOutOfOrder = 3] = "VerseOutOfOrder", e[e.VerseRepeated = 4] = "VerseRepeated", e))(yn || {});
const O = class {
  constructor(r, n, t, o) {
...
}))), ar), xn = 1, yt = vn.length - 1, kn = 1, Sn = 1, Nn = (e) => {
  var r;
  return ((r = vn[e]) == null ? void 0 : r.chapters) ?? -1;
}, Ar = (e, r) => ({
  bookNum: Math.max(xn, Math.min(e.bookNum + r, yt)),
  chapterNum: 1,
  verseNum: 1
}), Pr = (e, r) => ({
  ...e,
  chapterNum: Math.min(
    Math.max(kn, e.chapterNum + r),
    Nn(e.bookNum)
  ),
  verseNum: 1
}), Mr = (e, r) => ({
  ...e,
  verseNum: Math.max(Sn, e.verseNum + r)
});
function hr({
  variant: e = "outlined",
  id: r,
...
function os({ scrRef: e, handleSubmit: r, id: n }) {
  const t = (i) => {
    r(i);
  }, o = (i, c) => {
...
function Ir({ onRowChange: e, row: r, column: n }) {
  ...
  return /* @__PURE__ */ w(hr, { defaultValue: r[n.key], onChange: t });
}
const vt = ({ onChange: e, disabled: r, checked: n, ...t }) => /* @__PURE__ */ w(
  rt,
  {
    ...t,
    isChecked: n,
...
function he(e, r, n = {
  ...
  return Re(e) && Re(r) && Object.keys(r).forEach((o) => {
    o !== "__proto__" && (Re(r[o]) && o in e && Re(e[o]) ? t[o] = he(e[o], r[o], n) : n.clone ? t[o] = Re(r[o]) ? En(r[o]) : r[o] : t[o] = r[o]);
  }), t;
}
function xt(e) {
...
function St() {
  return Dr || (Dr = 1, process.env.NODE_ENV !== "production" && function() {
    ...
    V.AsyncMode = m, V.ConcurrentMode = X, V.ContextConsumer = ne, V.ContextProvider = ie, V.Element = ae, V.ForwardRef = D, V.Fragment = Y, V.Lazy = ce, V.Memo = le, V.Portal = Q, V.Profiler = q, V.StrictMode = ee, V.Suspense = se, V.isAsyncMode = Se, V.isConcurrentMode = g, V.isContextConsumer = x, V.isContextProvider = _, V.isElement = T, V.isForwardRef = N, V.isFragment = P, V.isLazy = E, V.isMemo = C, V.isPortal = M, V.isProfiler = j, V.isStrictMode = I, V.isSuspense = Z, V.isValidElementType = B, V.typeOf = R;
  }()), V;
}
var jr;
function wn() {
...
function wt() {
  if (Hr)
    return dr;
  Hr = 1;
  var e = wn(), r = Nt(), n = xr(), t = Tn(), o = Et(), a = function() {
  };
  ...
  return dr = function(l, i) {
    ...
    function f(g) {
      ...
      function T(P, E, C, M, j, I, Z) {
        ...
        return E[C] == null ? P ? E[C] === null ? new h("The " + j + " `" + I + "` is marked as required " + ("in `" + M + "`, but its value is `null`.")) : new h("The " + j + " `" + I + "` is marked as required in " + ("`" + M + "`, but its value is `undefined`.")) : null : g(E, C, M, j, I);
      }
      var N = T.bind(null, !1);
      return N.isRequired = T.bind(null, !0), N;
    }
    function S(g) {
      function x(_, T, N, P, E, C) {
        var M = _[T], j = ee(M);
        if (j !== g) {
          var I = se(M);
          return new h(
    ...
    function X(g) {
      function x(_, T, N, P, E) {
        if (!(_[T] instanceof g)) {
          ...
          return new h("Invalid " + P + " `" + E + "` of type " + ("`" + M + "` supplied to `" + N + "`, expected ") + ("instance of `" + C + "`."));
        }
        return null;
      }
      return f(x);
    ...
    function ne(g) {
      ...
      function x(_, T, N, P, E) {
        ...
        return new h("Invalid " + P + " `" + E + "` of value `" + String(C) + "` " + ("supplied to `" + N + "`, expected one of " + j + "."));
      }
      return f(x);
    }
    function ie(g) {
...
function Rt() {
  return Gr || (Gr = 1, process.env.NODE_ENV !== "production" && function() {
    ...
    F.ContextConsumer = X, F.ContextProvider = ne, F.Element = ie, F.ForwardRef = ae, F.Fragment = D, F.Lazy = Y, F.Memo = ce, F.Portal = le, F.Profiler = Q, F.StrictMode = q, F.Suspense = ee, F.SuspenseList = se, F.isAsyncMode = g, F.isConcurrentMode = x, F.isContextConsumer = _, F.isContextProvider = T, F.isElement = N, F.isForwardRef = P, F.isFragment = E, F.isLazy = C, F.isMemo = M, F.isPortal = j, F.isProfiler = I, F.isStrictMode = Z, F.isSuspense = b, F.isSuspenseList = te, F.isValidElementType = R, F.typeOf = m;
  }()), F;
}
...
function Bo() {
  ...
  function r(n) {
    ...
    function l(i) {
      ...
      if (!c)
        return null;
      const d = qt(a.breakpoints), p = Object.keys(d);
      let u = d;
...
const An = Bo();
An.filterProps = ["sx"];
const wr = An, Do = ["breakpoints", "palette", "spacing", "shape"];
function Tr(e = {}, ...r) {
  const {
    breakpoints: n = {},
    palette: t = {},
  ...
  return c = r.reduce((d, p) => he(d, p), c), c.unstable_sxConfig = A({}, Er, s == null ? void 0 : s.unstable_sxConfig), c.unstable_sx = function(p) {
    return wr({
      sx: p,
      theme: this
    });
...
function Yo(e = {}) {
  ...
  return a.__mui_systemSx = !0, (s, l = {}) => {
    ...
    } = l, y = ge(l, Ho), v = d !== void 0 ? d : (
      // TODO v6: remove `Root` in the next major release
      // For more details: https://github.com/mui/material-ui/pull/37908
      c && c !== "Root" && c !== "root" || !1
    ), h = p || !1;
    let f;
    process.env.NODE_ENV !== "production" && i && (f = `${i}-${Qr(c || "Root")}`);
    let S = Ke;
...
function na(e, r) {
  if (e = Me(e), r = Mn(r), e.type.indexOf("hsl") !== -1)
    e.values[2] *= 1 - r;
...
function ka(e) {
  const {
    ...
    tonalOffset: t = 0.2
  } = e, o = ge(e, ha), a = e.primary || ma(r), s = e.secondary || ga(r), l = e.error || ba(r), i = e.info || ya(r), c = e.success || va(r), d = e.warning || xa(r);
  function p(h) {
    const f = rn(h, pr.text.primary) >= n ? pr.text.primary : nn.text.primary;
    if (process.env.NODE_ENV !== "production") {
      const S = rn(h, f);
...
`)), Object.keys(c).length !== 0 && console.error(`MUI: Unrecognized argument(s) [${Object.keys(c).join(",")}].`);
      ...
      return (Array.isArray(o) ? o : [o]).map((d) => `${d} ${typeof s == "string" ? s : sn(s)} ${l} ${typeof i == "string" ? i : sn(i)}`).join(",");
    }
  }, e, {
    easing: r,
    duration: n
...
const Ja = ["children", "className", "color", "component", "fontSize", "htmlColor", "inheritViewBox", "titleAccess", "viewBox"], Ga = (e) => {
  ...
  return /* @__PURE__ */ Fe(Ka, A({
    ...
    ownerState: h,
    children: [v ? o.props.children : o, p ? /* @__PURE__ */ w("title", {
      children: p
    }) : null]
  }));
});
...
function ls({
  ...
  let f = e;
  return !f && r && (f = r(i)), /* @__PURE__ */ w("div", { ref: u, style: { position: "relative" }, children: /* @__PURE__ */ w(Jn, { position: "static", id: o, children: /* @__PURE__ */ Fe(Gn, { className: `papi-toolbar ${t ?? ""}`, variant: "dense", children: [
    f ? /* @__PURE__ */ w(
      dn,
      {
        edge: "start",
    ...
    a ? /* @__PURE__ */ w("div", { className: "papi-menu-children", children: a }) : null,
    f ? /* @__PURE__ */ w(
      Kn,
      {
