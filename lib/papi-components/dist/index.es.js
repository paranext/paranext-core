...
` + de[Se].replace(' at new ', ' at ');
            ...
            var Nn = E ? E.displayName || E.name : '',
              ia = Nn ? re(Nn) : '';
            return typeof E == 'function' && me.set(E, ia), ia;
          }
          function Ee(E, q, ce) {
            return k(E, !1);
          }
          ...
          function Yt(E, q, ce, $, N, Y) {
            {
              ...
              if (ee) {
                ...
                if (ht !== void 0)
                  if ($)
                    if (Je(ht)) {
                      for (var Nn = 0; Nn < ht.length; Nn++) nn(ht[Nn], E);
...
function tl() {
  return (
    ua ||
      ((ua = 1), process.env.NODE_ENV === 'production' ? (Io.exports = Ou()) : (Io.exports = Tu())),
    Io.exports
  );
}
/*
...
const zu = typeof window < 'u' ? y.useLayoutEffect : y.useEffect,
  ln = zu;
let Oa = 0;
function Bu(e) {
...
function no(e, t) {
  return md(lr('', null, null, '', null, null, 0), e, { length: -e.length }, t);
}
function gd() {
  return lt;
}
  ...
  for (
    ...
    switch (((x = S), (S = Nt()))) {
      ...
      case 0:
        switch (S) {
          ...
          case 59 + d:
            g > 0 &&
              Gt(P) - f &&
              _o(g > 32 ? wa(P + ';', r, o, f - 1) : wa(He(P, ' ', '') + ';', r, o, f - 2), c);
            break;
          case 59:
            P += ';';
          default:
            if ((_o((R = Ra(P, t, o, u, d, i, l, T, (O = []), (p = []), f)), a), S === 123))
                ...
                switch (b === 99 && bt(P, 3) === 110 ? 100 : b) {
                  ...
                  case 115:
                    Ho(
                      ...
                      R,
                      R,
                      r && _o(Ra(e, R, R, 0, 0, i, l, T, i, (O = []), f), p),
                      i,
                      p,
                      f,
                      l,
      ...
      default:
        if (h < 1) {
          if (S == 123) --h;
          else if (S == 125 && h++ == 0 && yd() == 125) continue;
        }
        switch (((P += ar(S)), S * h)) {
          case 38:
            C = d > 0 ? 1 : ((P += '\f'), -1);
          ...
          case 44:
            ...
            break;
          case 64:
            Jt() === 45 && (P += Wo(Nt())), (b = Jt()), (d = f = Gt((T = P += Td(Uo())))), S++;
            break;
          case 45:
            x === 45 && Gt(P) == 2 && (h = 0);
        }
...
function Ra(e, t, o, r, i, a, s, l, c, u, d) {
  for (var f = i - 1, b = i === 0 ? a : [''], g = Oi(b), x = 0, h = 0, m = 0; x < r; ++x)
    for (var C = 0, S = bo(e, f + 1, (f = fd((h = s[x])))), T = e; C < g; ++C)
      (T = hl(h > 0 ? b[C] + ' ' + S : He(S, /&\f/g, b[C]))) && (c[m++] = T);
  return lr(e, t, o, i === 0 ? xi : l, c, u, d);
}
function Sd(e, t, o) {
  return lr(e, t, o, yi, ar(gd()), bo(e, 2, -2), 0);
}
function wa(e, t, o, r) {
...
var Pd = function (t, o, r) {
  ...
  Nd = function (t, o) {
    ...
    do
      switch (vo(i)) {
        case 0:
          i === 38 && Jt() === 12 && (o[r] = 1), (t[r] += Pd(Ct - 1, o, r));
          break;
        case 2:
          t[r] += Wo(i);
          break;
...
https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Template_literals#ES2018_revision_of_illegal_escape_sequences`,
  ...
  jr = /* @__PURE__ */ fl(function (e) {
    return Ci(e) ? e : e.replace(Jd, '-$&').toLowerCase();
  }),
  Xo = function (t, o) {
    switch (t) {
      case 'animation':
    ...
    return Gd[t] !== 1 && !Ci(t) && typeof o == 'number' && o !== 0 ? o + 'px' : o;
  };
if (process.env.NODE_ENV !== 'production') {
  var Zd =
    ...
    return function () {
      ...
      var x = dr(function (h, m, C) {
        ...
        typeof h.className == 'string'
          ? (T = Ti(m.registered, O, h.className))
...
at.filterProps = hr;
process.env.NODE_ENV !== 'production' && Ip.reduce((e, t) => ((e[t] = vn), e), {});
function Xt(e) {
...
fr(Ap, Dp, Lp, Fp, jp, Vp, zp, Bp, Up, Wp, br);
const vr = (e) => {
...
fr(vr, gr, yr, Hp, qp, Yp, Kp, Gp, Xp, Jp, Zp, Qp);
function Bn(e, t) {
  return t === 'grey' ? t : e;
}
const ef = Ye({
...
function Af(e = {}) {
  const { defaultTheme: t = _f, rootShouldForwardProp: o = co, slotShouldForwardProp: r = co } = e,
    i = (a) => {
  ...
  return (
    (i.__mui_systemSx = !0),
    (a, s = {}) => {
      Cp(a, (T) => T.filter((O) => !(O != null && O.__mui_systemSx)));
...
function Ga(e) {
  e = wn(e);
  let t = e.type === 'hsl' || e.type === 'hsla' ? wn(jf(e)).values : e.values;
  return (
    (t = t.map(
      (o) => (
...
function nt(...e) {
  return [
    `${e[0]}px ${e[1]}px ${e[2]}px ${e[3]}px rgba(0,0,0,${Zf})`,
...
const lm = {
  ...
  cm = lm,
  um = ['breakpoints', 'mixins', 'spacing', 'palette', 'transitions', 'typography', 'shape'];
function dm(e = {}, ...t) {
...
const bm = {
  ...
  vm = /* @__PURE__ */ y.createContext(bm);
function Ll(e) {
  const { disableDefaultClasses: t } = y.useContext(vm);
  return (o) => (t ? '' : e(o));
}
function gm(e, t = []) {
  if (e === void 0) return {};
...
function Sm(e) {
  const t = [],
    o = [];
  return (
    Array.from(e.querySelectorAll(Em)).forEach((r, i) => {
      const a = Om(r);
      a === -1 ||
        !Cm(r) ||
        (a === 0
...
function No(e) {
  for (var t = Lt(e), o = is(e); o && zm(o) && Ht(o).position === 'static'; ) o = is(o);
...
function ls(e, t, o) {
  return t === Fl ? ai(nh(e, o)) : $n(t) ? rh(t, o) : ai(oh(gn(e)));
}
function ih(e) {
  var t = po(Tr(e)),
...
function ah(e, t, o, r) {
  var i = t === 'clippingParents' ? ih(e) : [].concat(t),
    a = [].concat(i, [o]),
    s = a[0],
...
function xo(e, t) {
  ...
  var o = t,
    ...
    T = e.rects.popper,
    O = e.elements[x ? S : b],
    p = ah($n(O) ? O : O.contextElement || gn(e.elements.popper), c, d, s),
  ...
  if (R) {
    ...
    if (l) {
      var ve,
        ...
        pe = g && Z ? Um(ge, Ce, be) : uo(g ? ge : Je, Ce, g ? be : ot);
      (R[p] = pe), (K[p] = pe - Ce);
    }
    t.modifiersData[r] = K;
  }
...
var xn = 'Popper: modifier "%s" provided an invalid %s property, expected %s but got %s',
  $h = 'Popper: modifier "%s" requires "%s", but "%s" modifier is not available',
      ...
      .forEach(function (o) {
        ...
        t.requires &&
          t.requires.forEach(function (r) {
            e.find(function (i) {
              return i.name === r;
            }) == null && console.error(pn($h, String(t.name), r, r));
          });
      });
  });
}
    ...
    var d = {
      ...
      g = {
        ...
        setOptions: function (C) {
          ...
          var T = Rh(kh([].concat(r, d.options.modifiers)));
          if (
            ...
            var O = Nh([].concat(T, d.options.modifiers), function (_) {
              var K = _.name;
              return K;
            });
            if ((Ph(O), Ut(d.options.placement) === Or)) {
        ...
        forceUpdate: function () {
          if (!b) {
            ...
            (d.rects = {
              reference: Ch(S, No(T), d.options.strategy === 'fixed'),
              popper: Fi(T),
            }),
              (d.reset = !1),
...
var Mh = [Qm, vh, Jm, Vm, hh, uh, xh, Ym, ph],
  Ah = /* @__PURE__ */ _h({
    defaultModifiers: Mh,
  });
function Dh(e) {
...
const Bh = () =>
  ...
  Uh = {},
  Wh = /* @__PURE__ */ y.forwardRef(function (t, o) {
    var r;
    const {
        anchorEl: i,
        children: a,
...
function ub(e) {
  ...
  const oe = ({ finger: Z, move: fe = !1 }) => {
      ...
      let xe;
      if (((xe = ib(ye, c, l)), h)) xe = sb(xe, h, c);
      else {
        const rt = vs(z, xe);
        xe = z[rt];
      }
...
function vb(e) {
  const {
      ...
      unstable_isActiveElementInListbox: t = bb,
      // eslint-disable-next-line @typescript-eslint/naming-convention
...
const yb = [
  ...
  Ui = /* @__PURE__ */ y.forwardRef(function (t, o) {
    const r = Ge({
        props: t,
        name: 'MuiSvgIcon',
      }),
...
process.env.NODE_ENV === 'production' ? (si.exports = Ob()) : (si.exports = Tb());
var Wi = si.exports;
function li(e, t) {
  return (
    ...
    return (
      ...
      (o.render = function () {
        var i = this.props,
          ...
          u = Nb(this.state.children).map(s);
        return (
          delete l.appear,
          delete l.enter,
          delete l.exit,
...
const Mb = ['className', 'component', 'elevation', 'square', 'variant'],
  Ab = (e) => {
...
const Yb = qe('MuiButtonBase', ['root', 'disabled', 'focusVisible']),
  Kb = Yb,
  Gb = [
    'action',
    'centerRipple',
...
const Qb = qe('MuiIconButton', [
  ...
  ev = Qb,
  tv = ['edge', 'children', 'className', 'color', 'disabled', 'disableFocusRipple', 'size'],
  nv = (e) => {
...
const ac = ic,
  ...
  iv = ['components', 'componentsProps', 'slots', 'slotProps'],
  av = he(Hh, {
    name: 'MuiPopper',
    slot: 'Root',
    overridesResolver: (e, t) => t.root,
...
const lv = ['className', 'color', 'component', 'disableGutters', 'disableSticky', 'inset'],
  cv = (e) => {
  ...
  Yi = /* @__PURE__ */ y.forwardRef(function (t, o) {
    const r = Ge({
        props: t,
        name: 'MuiListSubheader',
      }),
  ...
  const r = Ge({
    ...
    A = (G) => {
      G.currentTarget === G.target &&
        (x && Ns(G) ? x(G) : G.key === 'Escape' && R.current && R.current.blur()),
        m && m(G);
    },
    _ = s !== !1 && g ? !0 : s,
    K = _ || x ? Eo : c || 'div',
...
const wv = v({}, Rt, qe('MuiInput', ['root', 'underline', 'input'])),
  fn = wv;
function $v(e) {
  return De('MuiOutlinedInput', e);
}
const Pv = v({}, Rt, qe('MuiOutlinedInput', ['root', 'notchedOutline', 'input'])),
  Kt = Pv;
function Nv(e) {
  return De('MuiFilledInput', e);
}
const kv = v({}, Rt, qe('MuiFilledInput', ['root', 'underline', 'input'])),
  wt = kv,
  fc = Xn(
    /* @__PURE__ */ D('path', {
      d: 'M7 10l5 5 5-5z',
  ...
  mc = /* @__PURE__ */ y.forwardRef(function (t, o) {
    ...
    const l = Ge({
      ...
      }),
      {
        ...
        popupIcon: oe = _s || (_s = /* @__PURE__ */ D(fc, {})),
        readOnly: k = !1,
        renderGroup: Ee,
        renderInput: I,
        renderOption: W,
...
const wg = Oc,
  ...
  Tc = /* @__PURE__ */ y.forwardRef(function (t, o) {
    ...
    const u = Ge({
      ...
      G = (r = (i = K == null ? void 0 : K.root) != null ? i : C.Root) != null ? r : Pg,
...
const kg = Tc,
  ...
  Ji = /* @__PURE__ */ y.forwardRef(function (t, o) {
    var r, i, a, s;
    const l = Ge({
        props: t,
        name: 'MuiFilledInput',
      ...
      O = g ?? u ? Mt(g ?? u, T) : T,
      p = (r = (i = x.root) != null ? i : c.Root) != null ? r : Mg,
      R = (a = (s = x.input) != null ? s : c.Input) != null ? a : Ag;
    return /* @__PURE__ */ D(
      Xi,
      v(
        {
...
const ty = Zi,
  ...
  Qi = /* @__PURE__ */ y.forwardRef(function (t, o) {
    ...
    const l = Ge({
      ...
      p = x ?? d ? Mt(x ?? d, O) : O,
      R = (r = (i = h.root) != null ? i : u.Root) != null ? r : ry,
      P = (a = (s = h.input) != null ? s : u.Input) != null ? a : iy;
    return /* @__PURE__ */ D(
      Xi,
      v(
        {
...
const fy = ['children', 'className', 'component', 'dense', 'disablePadding', 'subheader'],
  my = (e) => {
...
const Mc = /* @__PURE__ */ y.forwardRef(function (t, o) {
  ...
  const h = (T) => {
      ...
      else if (p === 'ArrowUp') T.preventDefault(), ao(O, R, u, c, Ds);
      else if (p === 'Home') T.preventDefault(), ao(O, null, u, c, Yr);
      else if (p === 'End') T.preventDefault(), ao(O, null, u, c, Ds);
      else if (p.length === 1) {
        const P = x.current,
          V = p.toLowerCase(),
          L = performance.now();
  ...
  Ac = /* @__PURE__ */ y.forwardRef(function (t, o) {
    const r = Ge({
      ...
      }),
      {
        ...
        TransitionComponent: C = ty,
        transitionDuration: S = 'auto',
        TransitionProps: { onEntering: T } = {},
      } = r,
      O = Te(r.TransitionProps, xy),
      p = Te(r, Ey),
      R = y.useRef(),
      P = ft(R, h.ref),
      V = v({}, r, {
...
`),
      ...
      _ = y.useCallback(
        (w) => ({
          vertical: Ls(w, m.vertical),
          horizontal: Fs(w, m.horizontal),
        }),
...
const Ly = qe('MuiNativeSelect', [
  ...
  ea = Ly,
  Fy = ['className', 'disabled', 'IconComponent', 'inputRef', 'variant'],
  jy = (e) => {
...
const By = jc;
var Vs;
const Uy = ['children', 'classes', 'className', 'label', 'notched'],
  Wy = he('fieldset')({
    textAlign: 'left',
    position: 'absolute',
    bottom: 0,
  ...
  Hy = he('legend')(({ ownerState: e, theme: t }) =>
    v(
      {
        float: 'unset',
...
const qy = [
  ...
  ta = /* @__PURE__ */ y.forwardRef(function (t, o) {
    ...
    const c = Ge({
      ...
      R = (r = (i = h.root) != null ? i : u.Root) != null ? r : Ky,
      P = (a = (s = h.input) != null ? s : u.Input) != null ? a : Xy;
    return /* @__PURE__ */ D(
      Xi,
      v(
        {
  ...
  oa = /* @__PURE__ */ y.forwardRef(function (t, o) {
    const r = Ge({
      ...
      M =
        b ||
        {
          standard: Us || (Us = /* @__PURE__ */ D(l0, {})),
          outlined: /* @__PURE__ */ D(c0, {
            label: x,
          }),
          filled: Ws || (Ws = /* @__PURE__ */ D(u0, {})),
        }[B],
      j = v({}, r, {
        variant: B,
        classes: s,
...
const O0 = qe('MuiSwitch', [
  ...
  yt = O0,
  T0 = ['className', 'color', 'edge', 'size', 'sx'],
  C0 = (e) => {
...
const Zn = [
  ...
  nu = 1,
  ou = 1,
  D0 = (e) => Zn.findIndex((t) => t.fullNames.includes(e)),
...
function z0({ scrRef: e, handleSubmit: t }) {
  const [o, r] = lu(qs(e.book)),
    i = (c) => {
      r(qs(c.book)), t(c);
    },
    a = (c, u) => {
      const f = { book: D0(u), chapter: 1, verse: 1 };
      i(f);
    },
    s = (c) => {
  ...
  return /* @__PURE__ */ Qe(pu, {
    children: [
      ...
      /* @__PURE__ */ D(Ln, {
        onClick: () => t(Gs(e, 1)),
        isDisabled: e.chapter >= L0(e.book),
        children: '>',
      }),
      /* @__PURE__ */ D(Js, {
        className: 'papi-ref-selector chapter-verse',
      ...
      /* @__PURE__ */ D(Ln, { onClick: () => t(Xs(e, 1)), children: '>' }),
    ],
  });
}
function B0({
...
function U0({ isChecked: e, isDisabled: t = !1, hasError: o = !1, className: r, onChange: i }) {
  return /* @__PURE__ */ D(P0, {
    checked: e,
    disabled: t,
