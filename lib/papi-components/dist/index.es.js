...
import { Button as Bn, FormLabel as Dn, Checkbox as jn, Autocomplete as zn, TextField as ln, MenuItem as Vn, Grid as un, Paper as Ln, InputBase as Fn, Slider as Hn, Snackbar as Un, Switch as Jn, AppBar as Gn, Toolbar as Kn, IconButton as Wn, Drawer as qn } from "@mui/material";
import * as Ve from "react";
import { useMemo as dn, useState as Ke, useCallback as or, useRef as Xn, useEffect as Yn } from "react";
import Zn, { SelectColumn as Qn } from "react-data-grid";
import et, { ThemeContext as rt, internal_processStyles as nt } from "@mui/styled-engine";
function Ee({
  id: e,
  isDisabled: r = !1,
  className: n,
...
function tt({
  ...
  let p;
  if (n) {
    const u = t === $e.Before || t === $e.Above, y = /* @__PURE__ */ E("span", { className: `papi-checkbox-label ${l ? "error" : ""} ${i ?? ""}`, children: n }), v = t === $e.Before || t === $e.After, h = v ? y : /* @__PURE__ */ E("div", { children: y }), d = v ? f : /* @__PURE__ */ E("div", { children: f });
    p = /* @__PURE__ */ Fe(
      Dn,
      {
...
function st({ commandHandler: e, name: r, className: n, items: t, id: o }) {
  return /* @__PURE__ */ Fe(un, { id: o, item: !0, xs: "auto", className: `papi-menu-column ${n ?? ""}`, children: [
...
}))), ar), vn = 1, xt = yn.length - 1, xn = 1, kn = 1, Sn = (e) => {
  var r;
  return ((r = yn[e]) == null ? void 0 : r.chapters) ?? -1;
}, Ar = (e, r) => ({
  bookNum: Math.max(vn, Math.min(e.bookNum + r, xt)),
  chapterNum: 1,
  verseNum: 1
}), Pr = (e, r) => ({
  ...e,
...
function as({ scrRef: e, handleSubmit: r, id: n }) {
  const t = (i) => {
    r(i);
  }, o = (i, c) => {
  ...
  return /* @__PURE__ */ Fe("span", { id: n, children: [
    ...
    /* @__PURE__ */ E(Ee, { onClick: () => r(Mr(e, 1)), children: ">" })
  ] });
}
function ss({ onSearch: e, placeholder: r, isFullWidth: n }) {
  const [t, o] = Ke(""), a = (s) => {
    o(s), e(s);
  };
  return /* @__PURE__ */ E(Ln, { component: "form", className: "search-bar-paper", children: /* @__PURE__ */ E(
    Fn,
    {
      fullWidth: n,
...
function Ir({ onRowChange: e, row: r, column: n }) {
  ...
  return /* @__PURE__ */ E(hr, { defaultValue: r[n.key], onChange: t });
}
...
function us({
  ...
  const le = dn(() => {
    const Q = e.map((W) => typeof W.editable == "function" ? {
      ...W,
      editable: (se) => !!W.editable(se),
      renderEditCell: W.renderEditCell || Ir
    } : W.editable && !W.renderEditCell ? { ...W, renderEditCell: Ir } : W.renderEditCell && !W.editable ? { ...W, editable: !1 } : W);
    return f ? [{ ...Qn, minWidth: p }, ...Q] : Q;
  }, [e, f, p]);
  return /* @__PURE__ */ E(
    Zn,
    {
...
function he(e, r, n = {
  ...
  return Re(e) && Re(r) && Object.keys(r).forEach((o) => {
    o !== "__proto__" && (Re(r[o]) && o in e && Re(e[o]) ? t[o] = he(e[o], r[o], n) : n.clone ? t[o] = Re(r[o]) ? Nn(r[o]) : r[o] : t[o] = r[o]);
  }), t;
}
function St(e) {
...
function Nt() {
  ...
  return z.AsyncMode = i, z.ConcurrentMode = c, z.ContextConsumer = l, z.ContextProvider = s, z.Element = r, z.ForwardRef = f, z.Fragment = t, z.Lazy = v, z.Memo = y, z.Portal = n, z.Profiler = a, z.StrictMode = o, z.Suspense = p, z.isAsyncMode = function(m) {
    return R(m) || B(m) === i;
    ...
    return typeof m == "string" || typeof m == "function" || m === t || m === c || m === a || m === o || m === p || m === u || typeof m == "object" && m !== null && (m.$$typeof === v || m.$$typeof === y || m.$$typeof === s || m.$$typeof === l || m.$$typeof === f || m.$$typeof === d || m.$$typeof === S || m.$$typeof === q || m.$$typeof === h);
  }, z.typeOf = B, z;
}
var V = {};
/** @license React v16.13.1
...
function Et() {
  return Dr || (Dr = 1, process.env.NODE_ENV !== "production" && function() {
    ...
    function B(b) {
      ...
      b === t || b === c || b === a || b === o || b === p || b === u || typeof b == "object" && b !== null && (b.$$typeof === v || b.$$typeof === y || b.$$typeof === s || b.$$typeof === l || b.$$typeof === f || b.$$typeof === d || b.$$typeof === S || b.$$typeof === q || b.$$typeof === h);
    }
    function R(b) {
    ...
    var m = i, X = c, ne = l, ie = s, ae = r, D = f, Y = t, ce = v, le = y, Q = n, W = a, ee = o, se = p, ve = !1;
    function Se(b) {
    ...
    V.AsyncMode = m, V.ConcurrentMode = X, V.ContextConsumer = ne, V.ContextProvider = ie, V.Element = ae, V.ForwardRef = D, V.Fragment = Y, V.Lazy = ce, V.Memo = le, V.Portal = Q, V.Profiler = W, V.StrictMode = ee, V.Suspense = se, V.isAsyncMode = Se, V.isConcurrentMode = g, V.isContextConsumer = x, V.isContextProvider = _, V.isElement = T, V.isForwardRef = N, V.isFragment = P, V.isLazy = w, V.isMemo = C, V.isPortal = M, V.isProfiler = j, V.isStrictMode = I, V.isSuspense = Z, V.isValidElementType = B, V.typeOf = R;
  }()), V;
}
var jr;
function En() {
  return jr || (jr = 1, process.env.NODE_ENV === "production" ? Ge.exports = Nt() : Ge.exports = Et()), Ge.exports;
}
/*
object-assign
(c) Sindre Sorhus
        ...
        if (t(a, f)) {
          ...
          try {
            if (typeof a[f] != "function") {
              var u = Error(
                (i || "React class") + ": " + l + " type `" + f + "` is invalid; it must be a function, usually from the `prop-types` package, but received `" + typeof a[f] + "`.This often happens because of typos such as `PropTypes.function` instead of `PropTypes.func`."
              );
          ...
          if (p && !(p instanceof Error) && e(
            (i || "React class") + ": type specification of " + l + " `" + f + "` is invalid; the type checker function must return `null` or an `Error` but returned a " + typeof p + ". You may have forgotten to pass an argument to the type checker creator (arrayOf, instanceOf, objectOf, oneOf, oneOfType, and shape all require an argument)."
...
function Ct() {
  if (Hr)
    return dr;
  Hr = 1;
  var e = En(), r = wt(), n = xr(), t = wn(), o = Tt(), a = function() {
  };
  ...
  return dr = function(l, i) {
    ...
    function D() {
      function g(x, _, T, N, P) {
        return Q(x[_]) ? null : new h("Invalid " + N + " `" + P + "` supplied to " + ("`" + T + "`, expected a ReactNode."));
      }
      return d(g);
    }
    function Y(g, x, _, T, N) {
      return new h(
        (g || "React class") + ": " + x + " type `" + _ + "." + T + "` is invalid; it must be a function, usually from the `prop-types` package, but received `" + N + "`."
      );
    }
    function ce(g) {
      function x(_, T, N, P, w) {
...
Valid keys: ` + JSON.stringify(Object.keys(g), null, "  ")
    ...
    function ee(g) {
      var x = typeof g;
      return Array.isArray(g) ? "array" : g instanceof RegExp ? "object" : W(x, g) ? "symbol" : x;
    }
    function se(g) {
...
function At() {
  ...
  return L.ContextConsumer = s, L.ContextProvider = a, L.Element = e, L.ForwardRef = i, L.Fragment = n, L.Lazy = u, L.Memo = p, L.Portal = r, L.Profiler = o, L.StrictMode = t, L.Suspense = c, L.SuspenseList = f, L.isAsyncMode = function() {
    return !1;
    ...
    return typeof d == "string" || typeof d == "function" || d === n || d === o || d === t || d === c || d === f || d === y || typeof d == "object" && d !== null && (d.$$typeof === u || d.$$typeof === p || d.$$typeof === a || d.$$typeof === s || d.$$typeof === i || d.$$typeof === v || d.getModuleId !== void 0);
  }, L.typeOf = h, L;
}
var F = {};
/**
...
function Pt() {
  return Gr || (Gr = 1, process.env.NODE_ENV !== "production" && function() {
    var e = Symbol.for("react.element"), r = Symbol.for("react.portal"), n = Symbol.for("react.fragment"), t = Symbol.for("react.strict_mode"), o = Symbol.for("react.profiler"), a = Symbol.for("react.provider"), s = Symbol.for("react.context"), l = Symbol.for("react.server_context"), i = Symbol.for("react.forward_ref"), c = Symbol.for("react.suspense"), f = Symbol.for("react.suspense_list"), p = Symbol.for("react.memo"), u = Symbol.for("react.lazy"), y = Symbol.for("react.offscreen"), v = !1, h = !1, d = !1, S = !1, q = !1, B;
    B = Symbol.for("react.module.reference");
    function R(k) {
      return !!(typeof k == "string" || typeof k == "function" || k === n || k === o || q || k === t || k === c || k === f || S || k === y || v || h || d || typeof k == "object" && k !== null && (k.$$typeof === u || k.$$typeof === p || k.$$typeof === a || k.$$typeof === s || k.$$typeof === i || // This needs to include all possible module reference object
    ...
    var X = s, ne = a, ie = e, ae = i, D = n, Y = u, ce = p, le = r, Q = o, W = t, ee = c, se = f, ve = !1, Se = !1;
    function g(k) {
    ...
    F.ContextConsumer = X, F.ContextProvider = ne, F.Element = ie, F.ForwardRef = ae, F.Fragment = D, F.Lazy = Y, F.Memo = ce, F.Portal = le, F.Profiler = Q, F.StrictMode = W, F.Suspense = ee, F.SuspenseList = se, F.isAsyncMode = g, F.isConcurrentMode = x, F.isContextConsumer = _, F.isContextProvider = T, F.isElement = N, F.isForwardRef = P, F.isFragment = w, F.isLazy = C, F.isMemo = M, F.isPortal = j, F.isProfiler = I, F.isStrictMode = Z, F.isSuspense = b, F.isSuspenseList = te, F.isValidElementType = R, F.typeOf = m;
  }()), F;
}
process.env.NODE_ENV === "production" ? gr.exports = At() : gr.exports = Pt();
var Kr = gr.exports;
...
const Kt = {
  borderRadius: 4
}, Wt = Kt, qt = process.env.NODE_ENV !== "production" ? U.oneOfType([U.number, U.string, U.object, U.array]) : {}, ye = qt;
function ze(e, r) {
  return r ? he(e, r, {
    clone: !1
...
function qe(e, r, n, t = n) {
  let o;
  return typeof e == "function" ? o = e(n) : Array.isArray(e) ? o = e[n] || t : o = Xe(e, n) || t, r && (o = r(o, t, e)), o;
}
function H(e) {
  const {
    prop: r,
    ...
    if (s[r] == null)
      return null;
    const l = s[r], i = s.theme, c = Xe(i, t) || {};
    return me(s, l, (p) => {
      let u = qe(c, o, p);
...
function $n(e, r) {
  const n = On(e.theme);
  return Object.keys(e).map((t) => oo(e, r, t, n)).reduce(ze, {});
}
function G(e) {
  return $n(e, Ye);
}
G.propTypes = process.env.NODE_ENV !== "production" ? Ye.reduce((e, r) => (e[r] = ye, e), {}) : {};
G.filterProps = Ye;
function K(e) {
  return $n(e, Ze);
}
K.propTypes = process.env.NODE_ENV !== "production" ? Ze.reduce((e, r) => (e[r] = ye, e), {}) : {};
K.filterProps = Ze;
...
Qe(rr, nr, tr, bo, yo, vo, xo, ko, So, No, Eo, wo);
function Ae(e, r) {
  return r === "grey" ? r : e;
}
const To = H({
...
function jo() {
  function e(n, t, o, a) {
    ...
    return p ? p(s) : me(s, t, (v) => {
      let h = qe(u, f, v);
      return v === h && typeof v == "string" && (h = qe(u, f, `${n}${v === "default" ? "" : de(v)}`, v)), i === !1 ? h : {
        [i]: h
      };
    });
  }
  function r(n) {
    ...
    function l(i) {
      ...
      if (!c)
        return null;
      const f = Xt(a.breakpoints), p = Object.keys(f);
      let u = f;
...
const Rn = jo();
Rn.filterProps = ["sx"];
const wr = Rn, zo = ["breakpoints", "palette", "spacing", "shape"];
function Tr(e = {}, ...r) {
  const {
    breakpoints: n = {},
    palette: t = {},
  ...
  return c = r.reduce((f, p) => he(f, p), c), c.unstable_sxConfig = A({}, Er, s == null ? void 0 : s.unstable_sxConfig), c.unstable_sx = function(p) {
    return wr({
      sx: p,
      theme: this
    });
...
const Wo = (e, r) => r.components && r.components[e] && r.components[e].styleOverrides ? r.components[e].styleOverrides : null, qo = (e, r) => {
  let n = [];
  ...
  return l && l.forEach((i) => {
    ...
    }), c && s.push(r[An(i.props)]);
  }), s;
};
function We(e) {
  return e !== "ownerState" && e !== "theme" && e !== "sx" && e !== "as";
}
const Yo = Tr(), Qr = (e) => e && e.charAt(0).toLowerCase() + e.slice(1);
function De({
  defaultTheme: e,
  theme: r,
  themeId: n
...
function Qo(e = {}) {
  ...
  return a.__mui_systemSx = !0, (s, l = {}) => {
    nt(s, (R) => R.filter((m) => !(m != null && m.__mui_systemSx)));
    const {
      name: i,
      slot: c,
      ...
      overridesResolver: u = Zo(Qr(c))
    } = l, y = ge(l, Jo), v = f !== void 0 ? f : (
      // TODO v6: remove `Root` in the next major release
      // For more details: https://github.com/mui/material-ui/pull/37908
      c && c !== "Root" && c !== "root" || !1
    ), h = p || !1;
    let d;
    process.env.NODE_ENV !== "production" && i && (d = `${i}-${Qr(c || "Root")}`);
    let S = We;
    ...
    const q = et(s, A({
      ...
      i && u && X.push((D) => {
        ...
        if (ce) {
          const le = {};
          return Object.entries(ce).forEach(([Q, W]) => {
            le[Q] = typeof W == "function" ? W(A({}, D, {
              theme: Y
            })) : W;
          }), u(D, le);
        }
...
function ta(e) {
  ...
  const {
    values: r
  } = e, n = r[0], t = r[1] / 100, o = r[2] / 100, a = t * Math.min(o, 1 - o), s = (c, f = (c + n / 30) % 12) => o - a * Math.max(Math.min(f - 3, 9 - f, 1), -1);
  let l = "rgb";
  const i = [Math.round(s(0) * 255), Math.round(s(8) * 255), Math.round(s(4) * 255)];
  return e.type === "hsla" && (l += "a", i.push(r[3])), Cr({
    type: l,
    values: i
  });
}
...
function oa(e, r) {
  if (e = Me(e), r = Pn(r), e.type.indexOf("hsl") !== -1)
    e.values[2] *= 1 - r;
...
const ia = {
  ...
  A400: "#00e676",
  A700: "#00c853"
}, Oe = ma, ga = ["mode", "contrastThreshold", "tonalOffset"], nn = {
...
function Na(e) {
  const {
    ...
    tonalOffset: t = 0.2
  } = e, o = ge(e, ga), a = e.primary || ba(r), s = e.secondary || ya(r), l = e.error || va(r), i = e.info || xa(r), c = e.success || ka(r), f = e.warning || Sa(r);
  function p(h) {
...
const theme2 = createTheme({ palette: {
  primary: { main: green[500] },
    ...
    return tn(h, "light", q, t), tn(h, "dark", B, t), h.contrastText || (h.contrastText = p(h.main)), h;
  }, y = {
    dark: pr,
    light: nn
  };
...
function Ta(e, r) {
  ...
  const y = o / 14, v = p || ((S) => `${S / c * y}rem`), h = (S, q, B, R, m) => A({
    fontFamily: t,
    fontWeight: S,
    fontSize: v(q),
...
const Ca = 0.2, _a = 0.14, Oa = 0.12;
function J(...e) {
  return [`${e[0]}px ${e[1]}px ${e[2]}px ${e[3]}px rgba(0,0,0,${Ca})`, `${e[4]}px ${e[5]}px ${e[6]}px ${e[7]}px rgba(0,0,0,${_a})`, `${e[8]}px ${e[9]}px ${e[10]}px ${e[11]}px rgba(0,0,0,${Oa})`].join(",");
}
  ...
  return A({
    ...
    create: (o = ["all"], a = {}) => {
      ...
      if (process.env.NODE_ENV !== "production") {
        ...
        !f(o) && !Array.isArray(o) && console.error('MUI: Argument "props" must be a string or Array.'), !p(s) && !f(s) && console.error(`MUI: Argument "duration" must be a number or a string but found ${s}.`), f(l) || console.error('MUI: Argument "easing" must be a string.'), !p(i) && !f(i) && console.error('MUI: Argument "delay" must be a number or a string.'), typeof a != "object" && console.error(["MUI: Secong argument of transition.create must be an object.", "Arguments should be either `create('prop1', options)` or `create(['prop1', 'prop2'], options)`"].join(`
`)), Object.keys(c).length !== 0 && console.error(`MUI: Unrecognized argument(s) [${Object.keys(c).join(",")}].`);
      }
      return (Array.isArray(o) ? o : [o]).map((f) => `${f} ${typeof s == "string" ? s : sn(s)} ${l} ${typeof i == "string" ? i : sn(i)}`).join(",");
    }
  }, e, {
    easing: r,
    duration: n
...
function Va(e = {}, ...r) {
  ...
  if (c = he(c, s), c = r.reduce((f, p) => he(f, p), c), process.env.NODE_ENV !== "production") {
...
`));
  ...
  return c.unstable_sxConfig = A({}, Er, s == null ? void 0 : s.unstable_sxConfig), c.unstable_sx = function(p) {
    return wr({
      sx: p,
      theme: this
    });
...
const Ha = (e) => We(e) && e !== "classes", Ua = Qo({
  themeId: In,
  defaultTheme: Mn,
...
const Ka = ["children", "className", "color", "component", "fontSize", "htmlColor", "inheritViewBox", "titleAccess", "viewBox"], Wa = (e) => {
  const {
    color: r,
    fontSize: n,
    classes: t
  ...
  const t = Fa({
    ...
    titleAccess: p,
    viewBox: u = "0 0 24 24"
  } = t, y = ge(t, Ka), v = /* @__PURE__ */ Ve.isValidElement(o) && o.type === "svg", h = A({}, t, {
    color: s,
    component: l,
    fontSize: i,
...
function ds({
  ...
  const [s, l] = Ke(!1), [i, c] = Ke(!1), f = or(() => {
    s && l(!1), c(!1);
  }, [s]), p = or((S) => {
    S.stopPropagation(), l((q) => {
      const B = !q;
  ...
  let d = e;
  return !d && r && (d = r(i)), /* @__PURE__ */ E("div", { ref: u, style: { position: "relative" }, children: /* @__PURE__ */ E(Gn, { position: "static", id: o, children: /* @__PURE__ */ Fe(Kn, { className: `papi-toolbar ${t ?? ""}`, variant: "dense", children: [
    d ? /* @__PURE__ */ E(
      Wn,
      {
        edge: "start",
    ...
    d ? /* @__PURE__ */ E(
      qn,
      {
        ...
        children: /* @__PURE__ */ E(it, { commandHandler: h, columns: d.columns })
      }
    ) : null
  ] }) }) });
}
