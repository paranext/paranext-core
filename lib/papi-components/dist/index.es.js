...
import { useState as Se, useMemo as Ee } from 'react';
import Be, { SelectColumn as _e } from 'react-data-grid';
...
function Te({
  ...
  let b;
  if (n) {
    const f = r === S.Before || r === S.Above,
      N = /* @__PURE__ */ i('span', {
        className: `papi-checkbox-label ${c ? 'error' : ''} ${u ?? ''}`,
        children: n,
      }),
      v = r === S.Before || r === S.After,
      _ = v ? N : /* @__PURE__ */ i('div', { children: N }),
      T = v ? d : /* @__PURE__ */ i('div', { children: d });
    b = /* @__PURE__ */ L(ke, {
...
var Oe = Object.defineProperty,
  Ie = (e, n, r) =>
    n in e ? Oe(e, n, { enumerable: !0, configurable: !0, writable: !0, value: r }) : (e[n] = r),
  s = (e, n, r) => (Ie(e, typeof n != 'symbol' ? n + '' : n, r), r);
const w = [
    'GEN',
    'EXO',
    'LEV',
  ...
  R = Ge();
function E(e, n = !0) {
  return n && (e = e.toUpperCase()), e in R ? R[e] : 0;
}
function I(e) {
  return E(e) > 0;
}
...
function* Je() {
  for (let e = 1; e <= w.length; e++) yield e;
}
const ze = 1,
  F = w.length;
function De() {
...
function V(e, n = '***') {
  const r = e - 1;
  return r < 0 || r >= w.length ? n : w[r];
}
function K(e) {
  return e <= 0 || e > F ? '******' : q[e - 1];
}
function He(e) {
  return K(E(e));
}
function j(e) {
  const n = typeof e == 'number' ? V(e) : e;
  return I(n) && !O.includes(n);
}
function Xe(e) {
  const n = typeof e == 'number' ? V(e) : e;
  return I(n) && O.includes(n);
...
function Pe(e) {
  return q[e - 1].includes('*obsolete*');
}
function Ge() {
  const e = {};
  for (let n = 0; n < w.length; n++) e[w[n]] = n + 1;
  return e;
}
const m = {
  allBookIds: w,
...
let p = x;
s(p, 'Original', new x(y.Original)),
  s(p, 'Septuagint', new x(y.Septuagint)),
  s(p, 'Vulgate', new x(y.Vulgate)),
  s(p, 'English', new x(y.English)),
  s(p, 'RussianProtestant', new x(y.RussianProtestant)),
  s(p, 'RussianOrthodox', new x(y.RussianOrthodox));
function J(e, n) {
  const r = n[0];
...
let k = a;
s(k, 'defaultVersification', p.English),
  s(k, 'verseRangeSeparator', '-'),
  s(k, 'verseSequenceIndicator', ','),
  s(k, 'verseRangeSeparators', [a.verseRangeSeparator]),
  s(k, 'verseSequenceIndicators', [a.verseSequenceIndicator]),
  s(k, 'chapterDigitShifter', 1e3),
  s(k, 'bookDigitShifter', a.chapterDigitShifter * a.chapterDigitShifter),
  s(k, 'bcvMaxValue', a.chapterDigitShifter - 1)
  /**
   * The valid status of the VerseRef.
   */,
  s(k, 'ValidStatusType', Z);
...
function z() {
  return m.allBookIds.map((e) => ({
    bookId: e,
    label: m.bookIdToEnglishName(e),
  }));
}
function D(e) {
  return {
    bookId: m.bookNumberToId(e),
    label: m.bookNumberToEnglishName(e),
  };
}
const Q = 1,
  Le = W.length - 1,
...
function $e(e, n) {
  return e.bookId === n.bookId && e.label === n.label;
}
function Qe({ scrRef: e, handleSubmit: n }) {
  const [r, o] = Se(D(e.bookNum)),
    t = (h) => {
      o(D(h.bookNum)), n(h);
    },
    l = (h, d) => {
  ...
  return /* @__PURE__ */ L(me, {
    children: [
      ...
      /* @__PURE__ */ i(C, { onClick: () => n(P(e, 1)), children: '>' }),
    ],
  });
}
function Ye({
...
function en({ isChecked: e, isDisabled: n = !1, hasError: r = !1, className: o, onChange: t }) {
...
function G({ onRowChange: e, row: n, column: r }) {
  ...
  return /* @__PURE__ */ i(M, { defaultValue: n[r.key], onChange: o });
}
const qe = ({ onChange: e, disabled: n, checked: r, ...o }) => {
  function t(l) {
    ...
    const A = e.map((g) =>
      typeof g.editable == 'function'
        ? {
            ...
            renderEditCell: g.renderEditCell || G,
          }
