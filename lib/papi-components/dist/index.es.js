...
import { Button as In, FormLabel as Bn, Checkbox as Dn, Autocomplete as jn, TextField as cn, MenuItem as zn, Grid as ln, Slider as Vn, Snackbar as Ln, Switch as Fn, AppBar as Hn, Toolbar as Un, IconButton as Jn, Drawer as Gn } from "@mui/material";
import * as Ve from "react";
import { useMemo as un, useState as tr, useCallback as or, useRef as Kn, useEffect as qn } from "react";
...
function et({
  ...
  let p;
  if (n) {
    const u = t === $e.Before || t === $e.Above, y = /* @__PURE__ */ C("span", { className: `papi-checkbox-label ${c ? "error" : ""} ${i ?? ""}`, children: n }), v = t === $e.Before || t === $e.After, h = v ? y : /* @__PURE__ */ C("div", { children: y }), d = v ? f : /* @__PURE__ */ C("div", { children: f });
    p = /* @__PURE__ */ Fe(
      Bn,
      {
...
function tt({ commandHandler: e, name: r, className: n, items: t, id: o }) {
  return /* @__PURE__ */ Fe(ln, { id: o, item: !0, xs: "auto", className: `papi-menu-column ${n ?? ""}`, children: [
    /* @__PURE__ */ C("h3", { className: `papi-menu ${n ?? ""}`, children: r }),
    t.map((a, s) => /* @__PURE__ */ C(
      nt,
      {
...
var at = Object.defineProperty, st = (e, r, n) => r in e ? at(e, r, { enumerable: !0, configurable: !0, writable: !0, value: n }) : e[r] = n, $ = (e, r, n) => (st(e, typeof r != "symbol" ? r + "" : r, n), n);
const ke = [
  "GEN",
  "EXO",
  "LEV",
...
var gn = /* @__PURE__ */ ((e) => (e[e.Valid = 0] = "Valid", e[e.UnknownVersification = 1] = "UnknownVersification", e[e.OutOfRange = 2] = "OutOfRange", e[e.VerseOutOfOrder = 3] = "VerseOutOfOrder", e[e.VerseRepeated = 4] = "VerseRepeated", e))(gn || {});
const O = class {
  constructor(r, n, t, o) {
  ...
  parse(r) {
    ...
    if (t.length !== 2 || fe.bookIdToNumber(n[0]) === 0 || !Number.isInteger(o) || o < 0 || !O.isVerseParseable(t[1]))
      throw new Be("Invalid reference : " + r);
   ...
   */
  get internalValid() {
    return this.versification == null ? 1 : this._bookNum <= 0 || this._bookNum > fe.lastBook ? 2 : 0;
  }
...
let de = O;
$(de, "defaultVersification", oe.English), $(de, "verseRangeSeparator", "-"), $(de, "verseSequenceIndicator", ","), $(de, "verseRangeSeparators", [O.verseRangeSeparator]), $(de, "verseSequenceIndicators", [O.verseSequenceIndicator]), $(de, "chapterDigitShifter", 1e3), $(de, "bookDigitShifter", O.chapterDigitShifter * O.chapterDigitShifter), $(de, "bcvMaxValue", O.chapterDigitShifter - 1), /**
...
let ar;
const sr = () => (ar || (ar = fe.allBookIds.map((e) => ({
  bookId: e,
  label: fe.bookIdToEnglishName(e)
}))), ar), yn = 1, bt = bn.length - 1, vn = 1, xn = 1, kn = (e) => {
  var r;
...
const yt = ({ onChange: e, disabled: r, checked: n, ...t }) => /* @__PURE__ */ C(
  et,
  {
    ...t,
    isChecked: n,
...
function pe(e, r, n = {
  ...
  return Re(e) && Re(r) && Object.keys(r).forEach((o) => {
    o !== "__proto__" && (Re(r[o]) && o in e && Re(e[o]) ? t[o] = pe(e[o], r[o], n) : n.clone ? t[o] = Re(r[o]) ? Sn(r[o]) : r[o] : t[o] = r[o]);
  }), t;
}
function vt(e) {
  return e && e.__esModule && Object.prototype.hasOwnProperty.call(e, "default") ? e.default : e;
}
var mr = { exports: {} }, Ge = { exports: {} }, z = {};
...
function xt() {
  ...
  return z.AsyncMode = i, z.ConcurrentMode = l, z.ContextConsumer = c, z.ContextProvider = s, z.Element = r, z.ForwardRef = f, z.Fragment = t, z.Lazy = v, z.Memo = y, z.Portal = n, z.Profiler = a, z.StrictMode = o, z.Suspense = p, z.isAsyncMode = function(m) {
    return R(m) || B(m) === i;
    ...
    return typeof m == "string" || typeof m == "function" || m === t || m === l || m === a || m === o || m === p || m === u || typeof m == "object" && m !== null && (m.$$typeof === v || m.$$typeof === y || m.$$typeof === s || m.$$typeof === c || m.$$typeof === f || m.$$typeof === d || m.$$typeof === S || m.$$typeof === W || m.$$typeof === h);
  }, z.typeOf = B, z;
}
var V = {};
/** @license React v16.13.1
...
function kt() {
  return Dr || (Dr = 1, process.env.NODE_ENV !== "production" && function() {
    ...
    function B(b) {
      ...
      b === t || b === l || b === a || b === o || b === p || b === u || typeof b == "object" && b !== null && (b.$$typeof === v || b.$$typeof === y || b.$$typeof === s || b.$$typeof === c || b.$$typeof === f || b.$$typeof === d || b.$$typeof === S || b.$$typeof === W || b.$$typeof === h);
    }
    function R(b) {
    ...
    var m = i, X = l, ne = c, ie = s, ae = r, D = f, Y = t, ce = v, le = y, Q = n, q = a, ee = o, se = p, ve = !1;
    function Se(b) {
    ...
    V.AsyncMode = m, V.ConcurrentMode = X, V.ContextConsumer = ne, V.ContextProvider = ie, V.Element = ae, V.ForwardRef = D, V.Fragment = Y, V.Lazy = ce, V.Memo = le, V.Portal = Q, V.Profiler = q, V.StrictMode = ee, V.Suspense = se, V.isAsyncMode = Se, V.isConcurrentMode = g, V.isContextConsumer = x, V.isContextProvider = _, V.isElement = w, V.isForwardRef = N, V.isFragment = P, V.isLazy = E, V.isMemo = T, V.isPortal = M, V.isProfiler = j, V.isStrictMode = I, V.isSuspense = Z, V.isValidElementType = B, V.typeOf = R;
  }()), V;
}
var jr;
function Nn() {
  return jr || (jr = 1, process.env.NODE_ENV === "production" ? Ge.exports = xt() : Ge.exports = kt()), Ge.exports;
}
/*
object-assign
(c) Sindre Sorhus
        ...
        if (t(a, f)) {
          ...
          try {
            if (typeof a[f] != "function") {
              var u = Error(
                (i || "React class") + ": " + c + " type `" + f + "` is invalid; it must be a function, usually from the `prop-types` package, but received `" + typeof a[f] + "`.This often happens because of typos such as `PropTypes.function` instead of `PropTypes.func`."
              );
          ...
          if (p && !(p instanceof Error) && e(
            (i || "React class") + ": type specification of " + c + " `" + f + "` is invalid; the type checker function must return `null` or an `Error` but returned a " + typeof p + ". You may have forgotten to pass an argument to the type checker creator (arrayOf, instanceOf, objectOf, oneOf, oneOfType, and shape all require an argument)."
...
function Et() {
  if (Hr)
    return dr;
  Hr = 1;
  var e = Nn(), r = St(), n = xr(), t = En(), o = Nt(), a = function() {
  };
  ...
  return dr = function(c, i) {
    ...
    function ne(g) {
      ...
      function x(_, w, N, P, E) {
        for (var T = _[w], M = 0; M < g.length; M++)
          if (v(T, g[M]))
            return null;
    ...
    function ae(g) {
      ...
      for (var x = 0; x < g.length; x++) {
        ...
        if (typeof _ != "function")
          return a(
            "Invalid argument supplied to oneOfType. Expected an array of check functions, but received " + ve(_) + " at index " + x + "."
          ), s;
      }
      function w(N, P, E, T, M) {
        for (var j = [], I = 0; I < g.length; I++) {
          var Z = g[I], b = Z(N, P, E, T, M, n);
          if (b == null)
            return null;
    ...
    function D() {
      function g(x, _, w, N, P) {
        return Q(x[_]) ? null : new h("Invalid " + N + " `" + P + "` supplied to " + ("`" + w + "`, expected a ReactNode."));
      }
      return d(g);
    }
    function Y(g, x, _, w, N) {
      return new h(
        (g || "React class") + ": " + x + " type `" + _ + "." + w + "` is invalid; it must be a function, usually from the `prop-types` package, but received `" + N + "`."
      );
    }
    function ce(g) {
      function x(_, w, N, P, E) {
...
function Ot() {
  ...
  return L.ContextConsumer = s, L.ContextProvider = a, L.Element = e, L.ForwardRef = i, L.Fragment = n, L.Lazy = u, L.Memo = p, L.Portal = r, L.Profiler = o, L.StrictMode = t, L.Suspense = l, L.SuspenseList = f, L.isAsyncMode = function() {
    return !1;
    ...
    return typeof d == "string" || typeof d == "function" || d === n || d === o || d === t || d === l || d === f || d === y || typeof d == "object" && d !== null && (d.$$typeof === u || d.$$typeof === p || d.$$typeof === a || d.$$typeof === s || d.$$typeof === i || d.$$typeof === v || d.getModuleId !== void 0);
  }, L.typeOf = h, L;
}
var F = {};
/**
...
function $t() {
  return Gr || (Gr = 1, process.env.NODE_ENV !== "production" && function() {
    var e = Symbol.for("react.element"), r = Symbol.for("react.portal"), n = Symbol.for("react.fragment"), t = Symbol.for("react.strict_mode"), o = Symbol.for("react.profiler"), a = Symbol.for("react.provider"), s = Symbol.for("react.context"), c = Symbol.for("react.server_context"), i = Symbol.for("react.forward_ref"), l = Symbol.for("react.suspense"), f = Symbol.for("react.suspense_list"), p = Symbol.for("react.memo"), u = Symbol.for("react.lazy"), y = Symbol.for("react.offscreen"), v = !1, h = !1, d = !1, S = !1, W = !1, B;
    B = Symbol.for("react.module.reference");
    function R(k) {
      return !!(typeof k == "string" || typeof k == "function" || k === n || k === o || W || k === t || k === l || k === f || S || k === y || v || h || d || typeof k == "object" && k !== null && (k.$$typeof === u || k.$$typeof === p || k.$$typeof === a || k.$$typeof === s || k.$$typeof === i || // This needs to include all possible module reference object
    ...
    var X = s, ne = a, ie = e, ae = i, D = n, Y = u, ce = p, le = r, Q = o, q = t, ee = l, se = f, ve = !1, Se = !1;
    function g(k) {
    ...
    F.ContextConsumer = X, F.ContextProvider = ne, F.Element = ie, F.ForwardRef = ae, F.Fragment = D, F.Lazy = Y, F.Memo = ce, F.Portal = le, F.Profiler = Q, F.StrictMode = q, F.Suspense = ee, F.SuspenseList = se, F.isAsyncMode = g, F.isConcurrentMode = x, F.isContextConsumer = _, F.isContextProvider = w, F.isElement = N, F.isForwardRef = P, F.isFragment = E, F.isLazy = T, F.isMemo = M, F.isPortal = j, F.isProfiler = I, F.isStrictMode = Z, F.isSuspense = b, F.isSuspenseList = te, F.isValidElementType = R, F.typeOf = m;
  }()), F;
}
...
const Lt = ["values", "unit", "step"], Ft = (e) => {
...
function Ht(e) {
  const {
    ...
    unit: n = "px",
    step: t = 5
  } = e, o = ge(e, Lt), a = Ft(r), s = Object.keys(a);
  function c(u) {
  ...
  function p(u) {
    const y = s.indexOf(u);
    return y === 0 ? c(s[1]) : y === s.length - 1 ? i(s[y]) : l(u, s[s.indexOf(u) + 1]).replace("@media", "@media not all and");
  }
  return A({
    keys: s,
    values: a,
...
const Ut = {
  borderRadius: 4
}, Jt = Ut, Gt = process.env.NODE_ENV !== "production" ? U.oneOfType([U.number, U.string, U.object, U.array]) : {}, ye = Gt;
function ze(e, r) {
  return r ? pe(e, r, {
    clone: !1
...
function H(e) {
  const {
    ...
    if (s[r] == null)
      return null;
    const c = s[r], i = s.theme, l = We(i, t) || {};
    return me(s, c, (p) => {
      let u = qe(l, o, p);
      return p === u && typeof p == "string" && (u = qe(l, o, `${r}${p === "default" ? "" : he(p)}`, p)), n === !1 ? u : {
        [n]: u
      };
    });
  };
...
function ro(e, r, n, t) {
  if (r.indexOf(n) === -1)
    return null;
  const o = Zt(n), a = eo(o, t), s = e[n];
  return me(e, s, a);
}
function On(e, r) {
  const n = _n(e.theme);
  return Object.keys(e).map((t) => ro(e, r, t, n)).reduce(ze, {});
}
function G(e) {
  return On(e, Xe);
}
...
function Io() {
  function e(n, t, o, a) {
    ...
    return p ? p(s) : me(s, t, (v) => {
      let h = qe(u, f, v);
      return v === h && typeof v == "string" && (h = qe(u, f, `${n}${v === "default" ? "" : he(v)}`, v)), i === !1 ? h : {
        [i]: h
      };
    });
  }
  function r(n) {
    ...
    function c(i) {
      ...
      if (!l)
        return null;
      const f = Kt(a.breakpoints), p = Object.keys(f);
      let u = f;
...
const $n = Io();
$n.filterProps = ["sx"];
const wr = $n, Bo = ["breakpoints", "palette", "spacing", "shape"];
function Tr(e = {}, ...r) {
  const {
    breakpoints: n = {},
    palette: t = {},
  ...
  return l = r.reduce((f, p) => pe(f, p), l), l.unstable_sxConfig = A({}, Er, s == null ? void 0 : s.unstable_sxConfig), l.unstable_sx = function(p) {
    return wr({
      sx: p,
      theme: this
    });
...
function Rn(e) {
  ...
  return Object.keys(n).sort().forEach((o) => {
    o === "color" ? t += Zr(t) ? e[o] : he(e[o]) : t += `${Zr(t) ? o : he(o)}${he(e[o].toString())}`;
  }), t;
}
...
const Jo = (e, r) => r.components && r.components[e] && r.components[e].styleOverrides ? r.components[e].styleOverrides : null, Go = (e, r) => {
  let n = [];
  ...
  const {
    ownerState: a = {}
  } = e, s = [], c = n == null || (o = n.components) == null || (o = o[t]) == null ? void 0 : o.variants;
  return c && c.forEach((i) => {
    let l = !0;
...
const qo = Tr(), Wo = (e) => e.charAt(0).toLowerCase() + e.slice(1);
function De({
  defaultTheme: e,
  theme: r,
  themeId: n
...
function Xo(e = {}) {
  ...
  return a.__mui_systemSx = !0, (s, c = {}) => {
    ...
    const {
      ...
      skipSx: p,
      overridesResolver: u
    } = c, y = ge(c, Fo), v = f !== void 0 ? f : l && l !== "Root" || !1, h = p || !1;
    let d;
    ...
    const W = Yn(s, A({
      ...
      if (process.env.NODE_ENV !== "production") {
        let D;
        i && (D = `${i}${l || ""}`), D === void 0 && (D = `Styled(${Pt(s)})`), ae.displayName = D;
      }
...
function Yo(e) {
  ...
  return !r || !r.components || !r.components[n] || !r.components[n].defaultProps ? t : Tn(r.components[n].defaultProps, t);
}
function Zo({
  props: e,
  name: r,
...
function ea(e) {
  ...
  const {
    values: r
  } = e, n = r[0], t = r[1] / 100, o = r[2] / 100, a = t * Math.min(o, 1 - o), s = (l, f = (l + n / 30) % 12) => o - a * Math.max(Math.min(f - 3, 9 - f, 1), -1);
  let c = "rgb";
  const i = [Math.round(s(0) * 255), Math.round(s(8) * 255), Math.round(s(4) * 255)];
  return e.type === "hsla" && (c += "a", i.push(r[3])), Cr({
    type: c,
    values: i
  });
}
...
const oa = {
  ...
  A400: "#00e676",
  A700: "#00c853"
}, Oe = fa, pa = ["mode", "contrastThreshold", "tonalOffset"], rn = {
...
function nn(e, r, n, t) {
  ...
  e[r] || (e.hasOwnProperty(n) ? e[r] = e[n] : r === "light" ? e.light = na(e.main, o) : r === "dark" && (e.dark = ra(e.main, a)));
}
function ha(e = "light") {
  return e === "dark" ? {
    main: Ce[200],
...
function xa(e) {
  const {
    ...
    tonalOffset: t = 0.2
  } = e, o = ge(e, pa), a = e.primary || ha(r), s = e.secondary || ma(r), c = e.error || ga(r), i = e.info || ba(r), l = e.success || ya(r), f = e.warning || va(r);
  function p(h) {
...
The color object needs to have a \`main\` property or a \`${S}\` property.` : Pe(11, d ? ` (${d})` : "", S));
...
const theme2 = createTheme({ palette: {
  primary: { main: green[500] },
    ...
    return nn(h, "light", W, t), nn(h, "dark", B, t), h.contrastText || (h.contrastText = p(h.main)), h;
  }, y = {
    dark: pr,
    light: rn
  };
  return process.env.NODE_ENV !== "production" && (y[r] || console.error(`MUI: The palette mode \`${r}\` is not supported.`)), pe(A({
...
function Na(e, r) {
  ...
  const y = o / 14, v = p || ((S) => `${S / l * y}rem`), h = (S, W, B, R, m) => A({
    fontFamily: t,
    fontWeight: S,
    fontSize: v(W),
...
const Ea = 0.2, wa = 0.14, Ta = 0.12;
function J(...e) {
  return [`${e[0]}px ${e[1]}px ${e[2]}px ${e[3]}px rgba(0,0,0,${Ea})`, `${e[4]}px ${e[5]}px ${e[6]}px ${e[7]}px rgba(0,0,0,${wa})`, `${e[8]}px ${e[9]}px ${e[10]}px ${e[11]}px rgba(0,0,0,${Ta})`].join(",");
}
const Ca = ["none", J(0, 2, 1, -1, 0, 1, 1, 0, 0, 1, 3, 0), J(0, 3, 1, -2, 0, 2, 2, 0, 0, 1, 5, 0), J(0, 3, 3, -2, 0, 3, 4, 0, 0, 1, 8, 0), J(0, 2, 4, -1, 0, 4, 5, 0, 0, 1, 10, 0), J(0, 3, 5, -1, 0, 5, 8, 0, 0, 1, 14, 0), J(0, 3, 5, -1, 0, 6, 10, 0, 0, 1, 18, 0), J(0, 4, 5, -2, 0, 7, 10, 1, 0, 2, 16, 1), J(0, 5, 5, -3, 0, 8, 10, 1, 0, 3, 14, 2), J(0, 5, 6, -3, 0, 9, 12, 1, 0, 3, 16, 2), J(0, 6, 6, -3, 0, 10, 14, 1, 0, 4, 18, 3), J(0, 6, 7, -4, 0, 11, 15, 1, 0, 4, 20, 3), J(0, 7, 8, -4, 0, 12, 17, 2, 0, 5, 22, 4), J(0, 7, 8, -4, 0, 13, 19, 2, 0, 5, 24, 4), J(0, 7, 9, -4, 0, 14, 21, 2, 0, 5, 26, 4), J(0, 8, 9, -5, 0, 15, 22, 2, 0, 6, 28, 5), J(0, 8, 10, -5, 0, 16, 24, 2, 0, 6, 30, 5), J(0, 8, 11, -5, 0, 17, 26, 2, 0, 6, 32, 5), J(0, 9, 11, -5, 0, 18, 28, 2, 0, 7, 34, 6), J(0, 9, 12, -6, 0, 19, 29, 2, 0, 7, 36, 6), J(0, 10, 13, -6, 0, 20, 31, 3, 0, 8, 38, 7), J(0, 10, 13, -6, 0, 21, 33, 3, 0, 8, 40, 7), J(0, 10, 14, -6, 0, 22, 35, 3, 0, 8, 42, 7), J(0, 11, 14, -7, 0, 23, 36, 3, 0, 9, 44, 8), J(0, 11, 15, -7, 0, 24, 38, 3, 0, 9, 46, 8)], _a = Ca, Oa = ["duration", "easing", "delay"], $a = {
...
function Pa(e) {
  const r = A({}, $a, e.easing), n = A({}, Ra, e.duration);
  return A({
...
`)), Object.keys(l).length !== 0 && console.error(`MUI: Unrecognized argument(s) [${Object.keys(l).join(",")}].`);
      ...
      return (Array.isArray(o) ? o : [o]).map((f) => `${f} ${typeof s == "string" ? s : an(s)} ${c} ${typeof i == "string" ? i : an(i)}`).join(",");
    }
  }, e, {
    easing: r,
    duration: n
...
const Ma = {
  ...
  snackbar: 1400,
  tooltip: 1500
}, Ia = Ma, Ba = ["breakpoints", "mixins", "spacing", "palette", "transitions", "typography", "shape"];
function Da(e = {}, ...r) {
  const {
    mixins: n = {},
    palette: t = {},
  ...
  if (l = pe(l, s), l = r.reduce((f, p) => pe(f, p), l), process.env.NODE_ENV !== "production") {
    const f = ["active", "checked", "completed", "disabled", "error", "expanded", "focused", "focusVisible", "required", "selected"], p = (u, y) => {
      let v;
      for (v in u) {
        const h = u[v];
        if (f.indexOf(v) !== -1 && Object.keys(h).length > 0) {
          if (process.env.NODE_ENV !== "production") {
            const d = kr("", v);
            console.error([`MUI: The \`${y}\` component increases the CSS specificity of the \`${v}\` internal state.`, "You can not override it like this: ", JSON.stringify(u, null, 2), "", `Instead, you need to use the '&.${d}' syntax:`, JSON.stringify({
              root: {
                [`&.${d}`]: h
              }
...
`));
  ...
  return l.unstable_sxConfig = A({}, Er, s == null ? void 0 : s.unstable_sxConfig), l.unstable_sx = function(p) {
    return wr({
      sx: p,
      theme: this
    });
...
const Va = (e) => Ke(e) && e !== "classes", La = Xo({
  themeId: Mn,
  defaultTheme: Pn,
...
const Ua = ["children", "className", "color", "component", "fontSize", "htmlColor", "inheritViewBox", "titleAccess", "viewBox"], Ja = (e) => {
  const {
    color: r,
    fontSize: n,
    classes: t
  ...
  overridesResolver: (e, r) => {
    ...
    return [r.root, n.color !== "inherit" && r[`color${he(n.color)}`], r[`fontSize${he(n.fontSize)}`]];
  }
})(({
  theme: e,
  ownerState: r
  ...
  return {
    ...
    fontSize: {
      ...
      medium: ((c = e.typography) == null || (i = c.pxToRem) == null ? void 0 : i.call(c, 24)) || "1.5rem",
  ...
  const t = za({
    ...
    titleAccess: p,
    viewBox: u = "0 0 24 24"
  } = t, y = ge(t, Ua), v = /* @__PURE__ */ Ve.isValidElement(o) && o.type === "svg", h = A({}, t, {
    color: s,
    component: c,
    fontSize: i,
  ...
  return /* @__PURE__ */ Fe(Ga, A({
    ...
    ownerState: h,
    children: [v ? o.props.children : o, p ? /* @__PURE__ */ C("title", {
      children: p
    }) : null]
  }));
});
...
function Ka(e, r) {
  ...
  return process.env.NODE_ENV !== "production" && (n.displayName = `${r}Icon`), n.muiName = sn.muiName, /* @__PURE__ */ Ve.memo(/* @__PURE__ */ Ve.forwardRef(n));
}
const qa = Ka(/* @__PURE__ */ C("path", {
...
function is({
  ...
  let d = e;
  return !d && r && (d = r(i)), /* @__PURE__ */ C("div", { ref: u, style: { position: "relative" }, children: /* @__PURE__ */ C(Hn, { position: "static", id: o, children: /* @__PURE__ */ Fe(Un, { className: `papi-toolbar ${t ?? ""}`, variant: "dense", children: [
    d ? /* @__PURE__ */ C(
      Jn,
      {
        edge: "start",
