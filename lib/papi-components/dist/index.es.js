...
const sr = () => (
  ...
  Ar = (e, r) => ({
    bookNum: Math.max(yn, Math.min(e.bookNum + r, yt)),
    chapterNum: 1,
    verseNum: 1,
  }),
  Pr = (e, r) => ({
...
function ts({ scrRef: e, handleSubmit: r }) {
  const n = (i) => {
      r(i);
    },
    t = (i, l) => {
      const f = { bookNum: fe.bookIdToNumber(l.bookId), chapterNum: 1, verseNum: 1 };
      n(f);
    },
    o = (i) => {
...
function Nn() {
  return (
    jr ||
      ((jr = 1), process.env.NODE_ENV === 'production' ? (Ge.exports = kt()) : (Ge.exports = St())),
    Ge.exports
  );
}
/*
            ...
            return !!(
              ...
              (typeof k == 'object' &&
                ...
                (k.$$typeof === u ||
                  ...
                  k.$$typeof === a ||
                  k.$$typeof === s ||
                  k.$$typeof === l || // This needs to include all possible module reference object
  ...
  return (
    ...
    (s, i = {}) => {
      ...
      const { name: l, slot: c, skipVariantsResolver: f, skipSx: h, overridesResolver: u } = i,
        ...
        p = h || !1;
      let d;
      process.env.NODE_ENV !== 'production' && l && (d = `${l}-${Xo(c || 'Root')}`);
      let N = Ke;
      c === 'Root' ? (N = t) : c ? (N = o) : Jo(s) && (N = void 0);
      const q = Zn(
          s,
          A(
            {
...
function ka(e) {
  const { mode: r = 'light', contrastThreshold: n = 3, tonalOffset: t = 0.2 } = e,
    ...
    f = e.warning || xa(r);
  function h(p) {
    const d = en(p, pr.text.primary) >= n ? pr.text.primary : rn.text.primary;
    if (process.env.NODE_ENV !== 'production') {
      const N = en(p, d);
      N < 3 &&
        console.error(
...
const theme2 = createTheme({ palette: {
  primary: { main: green[500] },
      ...
      return (
        nn(p, 'light', q, t), nn(p, 'dark', H, t), p.contrastText || (p.contrastText = h(p.main)), p
      );
    },
    y = {
      dark: pr,
...
`),
        ...
        return (Array.isArray(o) ? o : [o])
          .map(
            (f) =>
              `${f} ${typeof s == 'string' ? s : an(s)} ${i} ${typeof l == 'string' ? l : an(l)}`,
          )
          .join(',');
      },
    },
...
function cs({ menu: e, dataHandler: r, commandHandler: n, className: t, children: o }) {
  const [a, s] = tr(!1),
    [i, l] = tr(!1),
    c = or(() => {
      a && s(!1), l(!1);
