...
import { Button as zn, Autocomplete as Vn, TextField as fn, FormControlLabel as Ar, FormLabel as Ln, Checkbox as Fn, MenuItem as Hn, Grid as pn, Slider as Un, Snackbar as Jn, Switch as Gn, AppBar as Kn, Toolbar as qn, IconButton as Wn, Drawer as Xn } from "@mui/material";
import * as Le from "react";
import { useMemo as yr, useState as tr, useCallback as or, useRef as Yn, useEffect as Zn } from "react";
...
function ot({
  ...
  let p;
  if (n) {
    const u = t === $e.Before || t === $e.Above, y = /* @__PURE__ */ E("span", { className: `papi-checkbox-label ${c ? "error" : ""} ${i ?? ""}`, children: n }), v = t === $e.Before || t === $e.After, h = v ? y : /* @__PURE__ */ E("div", { children: y }), d = v ? f : /* @__PURE__ */ E("div", { children: f });
    p = /* @__PURE__ */ Ie(
      Ln,
      {
...
function ss({ scrRef: e, handleSubmit: r, id: n }) {
  const t = (i) => {
    ...
    const p = { bookNum: pe.bookIdToNumber(l.bookId), chapterNum: 1, verseNum: 1 };
    t(p);
  }, a = (i) => {
    r({ ...e, chapterNum: +i.target.value });
  }, s = (i) => {
    r({ ...e, verseNum: +i.target.value });
  }, c = yr(() => sr()[e.bookNum - 1], [e.bookNum]);
  return /* @__PURE__ */ Ie("span", { id: n, children: [
    ...
    /* @__PURE__ */ E(Ee, { onClick: () => r(Dr(e, 1)), children: ">" })
  ] });
}
function is({
  id: e,
...
function Et() {
  return Vr || (Vr = 1, process.env.NODE_ENV !== "production" && function() {
    ...
    V.AsyncMode = m, V.ConcurrentMode = X, V.ContextConsumer = ne, V.ContextProvider = ie, V.Element = ae, V.ForwardRef = D, V.Fragment = Y, V.Lazy = ce, V.Memo = le, V.Portal = Q, V.Profiler = q, V.StrictMode = ee, V.Suspense = se, V.isAsyncMode = Se, V.isConcurrentMode = g, V.isContextConsumer = x, V.isContextProvider = _, V.isElement = T, V.isForwardRef = N, V.isFragment = P, V.isLazy = w, V.isMemo = C, V.isPortal = M, V.isProfiler = j, V.isStrictMode = I, V.isSuspense = Z, V.isValidElementType = B, V.typeOf = R;
  }()), V;
}
var Lr;
function Tn() {
  return Lr || (Lr = 1, process.env.NODE_ENV === "production" ? Ge.exports = Nt() : Ge.exports = Et()), Ge.exports;
}
/*
object-assign
(c) Sindre Sorhus
...
function Ct() {
  if (Gr)
    return dr;
  Gr = 1;
  var e = Tn(), r = wt(), n = Sr(), t = Cn(), o = Tt(), a = function() {
  };
...
function Pt() {
  return Wr || (Wr = 1, process.env.NODE_ENV !== "production" && function() {
    ...
    F.ContextConsumer = X, F.ContextProvider = ne, F.Element = ie, F.ForwardRef = ae, F.Fragment = D, F.Lazy = Y, F.Memo = ce, F.Portal = le, F.Profiler = Q, F.StrictMode = q, F.Suspense = ee, F.SuspenseList = se, F.isAsyncMode = g, F.isConcurrentMode = x, F.isContextConsumer = _, F.isContextProvider = T, F.isElement = N, F.isForwardRef = P, F.isFragment = w, F.isLazy = C, F.isMemo = M, F.isPortal = j, F.isProfiler = I, F.isStrictMode = Z, F.isSuspense = b, F.isSuspenseList = te, F.isValidElementType = R, F.typeOf = m;
  }()), F;
}
...
function me(e, r, n) {
  ...
  if (typeof r == "object") {
    ...
    return Object.keys(r).reduce((s, c) => {
      if (Object.keys(a.values || Er).indexOf(c) !== -1) {
        const i = a.up(c);
        s[i] = n(r[c], c);
      } else {
        const i = c;
...
function H(e) {
  const {
    ...
    return me(s, c, (p) => {
      let u = qe(l, o, p);
      return p === u && typeof p == "string" && (u = qe(l, o, `${r}${p === "default" ? "" : de(p)}`, p)), n === !1 ? u : {
        [n]: u
      };
    });
  };
...
const Pn = jo();
Pn.filterProps = ["sx"];
const Cr = Pn, zo = ["breakpoints", "palette", "spacing", "shape"];
function _r(e = {}, ...r) {
  const {
    breakpoints: n = {},
    palette: t = {},
  ...
  return l = r.reduce((f, p) => he(f, p), l), l.unstable_sxConfig = A({}, Tr, s == null ? void 0 : s.unstable_sxConfig), l.unstable_sx = function(p) {
    return Cr({
      sx: p,
      theme: this
    });
...
const qo = (e, r) => r.components && r.components[e] && r.components[e].styleOverrides ? r.components[e].styleOverrides : null, Wo = (e, r) => {
  ...
  return c && c.forEach((i) => {
    ...
    }), l && s.push(r[Mn(i.props)]);
  }), s;
};
function Ke(e) {
  return e !== "ownerState" && e !== "theme" && e !== "sx" && e !== "as";
}
const Yo = _r(), nn = (e) => e && e.charAt(0).toLowerCase() + e.slice(1);
function je({
  defaultTheme: e,
  theme: r,
  themeId: n
...
function Qo(e = {}) {
  ...
  return a.__mui_systemSx = !0, (s, c = {}) => {
    ...
    const {
      ...
      overridesResolver: u = Zo(nn(l))
    } = c, y = ge(c, Jo), v = f !== void 0 ? f : (
      // TODO v6: remove `Root` in the next major release
      // For more details: https://github.com/mui/material-ui/pull/37908
      l && l !== "Root" && l !== "root" || !1
    ), h = p || !1;
    let d;
    process.env.NODE_ENV !== "production" && i && (d = `${i}-${nn(l || "Root")}`);
    let S = Ke;
    l === "Root" || l === "root" ? S = t : l ? S = o : Ko(s) && (S = void 0);
    const W = rt(s, A({
      shouldForwardProp: S,
      label: d
    }, y)), B = (R, ...m) => {
      ...
      if (process.env.NODE_ENV !== "production") {
        let D;
        i && (D = `${i}${de(l || "")}`), D === void 0 && (D = `Styled(${Bt(s)})`), ae.displayName = D;
      }
...
function ea(e) {
  ...
  return !r || !r.components || !r.components[n] || !r.components[n].defaultProps ? t : On(r.components[n].defaultProps, t);
}
function ra({
  props: e,
  name: r,
...
function ta(e) {
  ...
  return e.type === "hsla" && (c += "a", i.push(r[3])), Or({
    type: c,
    values: i
  });
}
...
const ia = {
  ...
  A400: "#00e676",
  A700: "#00c853"
}, Oe = ma, ga = ["mode", "contrastThreshold", "tonalOffset"], an = {
...
function Na(e) {
  const {
    ...
    tonalOffset: t = 0.2
  } = e, o = ge(e, ga), a = e.primary || ba(r), s = e.secondary || ya(r), c = e.error || va(r), i = e.info || xa(r), l = e.success || ka(r), f = e.warning || Sa(r);
  function p(h) {
    const d = on(h, pr.text.primary) >= n ? pr.text.primary : an.text.primary;
    if (process.env.NODE_ENV !== "production") {
      const S = on(h, d);
...
`)), Object.keys(l).length !== 0 && console.error(`MUI: Unrecognized argument(s) [${Object.keys(l).join(",")}].`);
      ...
      return (Array.isArray(o) ? o : [o]).map((f) => `${f} ${typeof s == "string" ? s : un(s)} ${c} ${typeof i == "string" ? i : un(i)}`).join(",");
    }
  }, e, {
    easing: r,
    duration: n
...
function Va(e = {}, ...r) {
  ...
  if (l = he(l, s), l = r.reduce((f, p) => he(f, p), l), process.env.NODE_ENV !== "production") {
...
`));
  ...
  return l.unstable_sxConfig = A({}, Tr, s == null ? void 0 : s.unstable_sxConfig), l.unstable_sx = function(p) {
    return Cr({
      sx: p,
      theme: this
    });
...
function ds({
  ...
  let d = e;
  return !d && r && (d = r(i)), /* @__PURE__ */ E("div", { ref: u, style: { position: "relative" }, children: /* @__PURE__ */ E(Kn, { position: "static", id: o, children: /* @__PURE__ */ Ie(qn, { className: `papi-toolbar ${t ?? ""}`, variant: "dense", children: [
    d ? /* @__PURE__ */ E(
      Wn,
      {
        edge: "start",
