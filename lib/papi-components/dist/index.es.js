import { jsx as N, jsxs as Ie, Fragment as zn } from "react/jsx-runtime";
import { Button as Vn, Autocomplete as Ln, TextField as fn, FormControlLabel as Ar, FormLabel as Fn, Checkbox as Hn, MenuItem as Un, Grid as pn, IconButton as hn, Slider as Jn, Snackbar as Gn, Switch as Kn, AppBar as qn, Toolbar as Wn, Drawer as Xn } from "@mui/material";
...
function ot({
  ...
  let p;
  if (n) {
    const u = t === $e.Before || t === $e.Above, y = /* @__PURE__ */ N("span", { className: `papi-checkbox-label ${c ? "error" : ""} ${i ?? ""}`, children: n }), v = t === $e.Before || t === $e.After, h = v ? y : /* @__PURE__ */ N("div", { children: y }), d = v ? f : /* @__PURE__ */ N("div", { children: f });
    p = /* @__PURE__ */ Ie(
      Fn,
      {
...
function st({ commandHandler: e, name: r, className: n, items: t, id: o }) {
  return /* @__PURE__ */ Ie(pn, { id: o, item: !0, xs: "auto", className: `papi-menu-column ${n ?? ""}`, children: [
    /* @__PURE__ */ N("h3", { className: `papi-menu ${n ?? ""}`, children: r }),
    t.map((a, s) => /* @__PURE__ */ N(
      at,
      {
...
}))), ar), Sn = 1, kt = xn.length - 1, Nn = 1, En = 1, wn = (e) => {
  var r;
  return ((r = xn[e]) == null ? void 0 : r.chapters) ?? -1;
}, Ir = (e, r) => ({
  bookNum: Math.max(Sn, Math.min(e.bookNum + r, kt)),
  chapterNum: 1,
  verseNum: 1
}), Br = (e, r) => ({
  ...e,
...
function is({ scrRef: e, handleSubmit: r, id: n }) {
  const t = (i) => {
    r(i);
  }, o = (i, l) => {
  ...
  return /* @__PURE__ */ Ie("span", { id: n, children: [
    ...
    /* @__PURE__ */ N(Ee, { onClick: () => r(Dr(e, 1)), children: ">" })
  ] });
}
function cs({
  id: e,
...
function jr({ onRowChange: e, row: r, column: n }) {
  ...
  return /* @__PURE__ */ N(mr, { defaultValue: r[n.key], onChange: t });
}
const xt = ({ onChange: e, disabled: r, checked: n, ...t }) => /* @__PURE__ */ N(
  ot,
  {
    ...t,
    isChecked: n,
...
function Ct() {
  if (Gr)
    return dr;
  Gr = 1;
  var e = Cn(), r = wt(), n = Sr(), t = _n(), o = Tt(), a = function() {
  };
...
function Pt() {
  return Wr || (Wr = 1, process.env.NODE_ENV !== "production" && function() {
    ...
    function R(x) {
      return !!(typeof x == "string" || typeof x == "function" || x === n || x === o || W || x === t || x === l || x === f || S || x === y || v || h || d || typeof x == "object" && x !== null && (x.$$typeof === u || x.$$typeof === p || x.$$typeof === a || x.$$typeof === s || x.$$typeof === i || // This needs to include all possible module reference object
    ...
    F.ContextConsumer = X, F.ContextProvider = ne, F.Element = ie, F.ForwardRef = ae, F.Fragment = D, F.Lazy = Y, F.Memo = ce, F.Portal = le, F.Profiler = Q, F.StrictMode = q, F.Suspense = ee, F.SuspenseList = se, F.isAsyncMode = g, F.isConcurrentMode = k, F.isContextConsumer = _, F.isContextProvider = T, F.isElement = E, F.isForwardRef = P, F.isFragment = w, F.isLazy = C, F.isMemo = M, F.isPortal = j, F.isProfiler = I, F.isStrictMode = Z, F.isSuspense = b, F.isSuspenseList = te, F.isValidElementType = R, F.typeOf = m;
  }()), F;
}
...
Ze(er, rr, nr, bo, yo, vo, ko, xo, So, No, Eo, wo);
function Ae(e, r) {
  return r === "grey" ? r : e;
}
const To = H({
...
const Mn = jo();
Mn.filterProps = ["sx"];
const Cr = Mn, zo = ["breakpoints", "palette", "spacing", "shape"];
function _r(e = {}, ...r) {
  const {
    breakpoints: n = {},
    palette: t = {},
...
function Na(e) {
  const {
    ...
    tonalOffset: t = 0.2
  } = e, o = ge(e, ga), a = e.primary || ba(r), s = e.secondary || ya(r), c = e.error || va(r), i = e.info || ka(r), l = e.success || xa(r), f = e.warning || Sa(r);
  function p(h) {
...
const Ka = ["children", "className", "color", "component", "fontSize", "htmlColor", "inheritViewBox", "titleAccess", "viewBox"], qa = (e) => {
  ...
  return /* @__PURE__ */ Ie(Wa, A({
    ...
    ownerState: h,
    children: [v ? o.props.children : o, p ? /* @__PURE__ */ N("title", {
      children: p
    }) : null]
  }));
});
...
function fs({
  ...
  let d = e;
  return !d && r && (d = r(i)), /* @__PURE__ */ N("div", { ref: u, style: { position: "relative" }, children: /* @__PURE__ */ N(qn, { position: "static", id: o, children: /* @__PURE__ */ Ie(Wn, { className: `papi-toolbar ${t ?? ""}`, variant: "dense", children: [
    d ? /* @__PURE__ */ N(
      hn,
      {
        edge: "start",
    ...
    a ? /* @__PURE__ */ N("div", { className: "papi-menu-children", children: a }) : null,
    d ? /* @__PURE__ */ N(
      Xn,
      {
        ...
        children: /* @__PURE__ */ N(it, { commandHandler: h, columns: d.columns })
      }
    ) : null
  ] }) }) });
}
