            ...
            return !!(
              ...
              (typeof k == 'object' &&
                ...
                (k.$$typeof === u ||
                  ...
                  k.$$typeof === a ||
                  k.$$typeof === s ||
                  k.$$typeof === c || // This needs to include all possible module reference object
  ...
  return (
    ...
    (s, i = {}) => {
      ...
      const { name: c, slot: l, skipVariantsResolver: f, skipSx: p, overridesResolver: u } = i,
        ...
        h = p || !1;
      let d;
      process.env.NODE_ENV !== 'production' && c && (d = `${c}-${Wo(l || 'Root')}`);
      let S = Ke;
