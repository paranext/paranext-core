...
function ts({ scrRef: e, handleSubmit: r, id: n }) {
  const [t, o] = Ke(Rr(e.bookNum)),
    ...
    s = (i, f) => {
      const l = { bookNum: se.bookIdToNumber(f.bookId), chapterNum: 1, verseNum: 1 };
      a(l);
    },
    c = (i) => {
    ...
    (lr = function (c, u) {
      ...
      function ce(g) {
        function k(O, w, N, P, E) {
          ...
          for (var j in g) {
            var I = g[j];
            if (typeof I != 'function') return Y(N, P, E, j, de(I));
      ...
      function ae(g) {
        function k(O, w, N, P, E) {
          ...
          for (var I in j) {
            var Z = g[I];
            if (t(g, I) && typeof Z != 'function') return Y(N, P, E, I, de(Z));
            if (!Z)
              return new h(
                'Invalid ' +
                  P +
