...
import Ce, { SelectColumn as Se } from 'react-data-grid';
...
function Ee({
  ...
  if (n) {
    const N = r === S.Before || r === S.Above,
      ...
      _ = w ? k : /* @__PURE__ */ i('div', { children: k }),
      T = w ? d : /* @__PURE__ */ i('div', { children: d });
    u = /* @__PURE__ */ P(fe, {
...
var _e = Object.defineProperty,
  Te = (e, n, r) =>
    n in e ? _e(e, n, { enumerable: !0, configurable: !0, writable: !0, value: r }) : (e[n] = r),
  s = (e, n, r) => (Te(e, typeof n != 'symbol' ? n + '' : n, r), r);
const x = [
    'GEN',
    'EXO',
    'LEV',
...
const f = {
  ...
  extraBooks: Re,
  bookNumberToId: O,
  bookNumberToEnglishName: F,
  bookIdToEnglishName: Je,
  isCanonical: K,
  isExtraMaterial: ze,
  isObsolete: De,
};
  ...
  allVerses(e = !1, n = a.verseRangeSeparators, r = a.verseSequenceIndicators) {
    ...
    for (const l of t.map((c) => J(c, n))) {
      ...
      if ((o.push(c), l.length > 1)) {
        const b = this.clone();
        if (((b.verse = l[1]), !e))
          for (let d = h + 1; d < b.verseNum; d++) {
            const u = new a(this._bookNum, this._chapterNum, d, this.versification);
            this.isExcluded || o.push(u);
          }
        o.push(b);
      }
    }
...
const W = 1,
  ...
  ee = (e) => {
    var n;
    return ((n = Z[e]) == null ? void 0 : n.chapters) ?? -1;
  },
  z = (e, n) => ({
    bookNum: Math.max(W, Math.min(e.bookNum + n, Pe)),
    chapterNum: 1,
    verseNum: 1,
  }),
  D = (e, n) => ({
    ...e,
    chapterNum: Math.min(Math.max(Q, e.chapterNum + n), ee(e.bookNum)),
    verseNum: 1,
  }),
  H = (e, n) => ({
    ...e,
    verseNum: Math.max(Y, e.verseNum + n),
  });
function M({
  variant: e = 'outlined',
  isDisabled: n = !1,
...
function je({ scrRef: e, handleSubmit: n }) {
  const r = L(() => Xe(), []),
    o = (h) => {
      n(h);
    },
    t = (h, b) => {
      const u = { bookNum: f.bookIdToNumber(b.bookId), chapterNum: 1, verseNum: 1 };
      o(u);
    },
    l = (h) => {
  ...
  return /* @__PURE__ */ P(ge, {
    children: [
      ...
      /* @__PURE__ */ i(C, {
        onClick: () => n(D(e, -1)),
        isDisabled: e.chapterNum <= Q,
        children: '<',
      }),
      /* @__PURE__ */ i(C, {
        onClick: () => n(D(e, 1)),
        isDisabled: e.chapterNum >= ee(e.bookNum),
        children: '>',
      }),
      /* @__PURE__ */ i(M, {
        className: 'papi-ref-selector chapter-verse',
      ...
      /* @__PURE__ */ i(C, {
        onClick: () => n(H(e, -1)),
        isDisabled: e.verseNum <= Y,
        children: '<',
      }),
      /* @__PURE__ */ i(C, { onClick: () => n(H(e, 1)), children: '>' }),
    ],
  });
}
function Ze({
...
function We({ isChecked: e, isDisabled: n = !1, hasError: r = !1, className: o, onChange: t }) {
...
function X({ onRowChange: e, row: n, column: r }) {
  const o = (t) => {
    e({ ...n, [r.key]: t.target.value });
  };
  return /* @__PURE__ */ i(M, { defaultValue: n[r.key], onChange: o });
}
const Ge = ({ onChange: e, disabled: n, checked: r, ...o }) => {
  function t(l) {
...
function en({
  ...
  const be = L(() => {
    const I = e.map((g) =>
      typeof g.editable == 'function'
        ? {
            ...g,
            editable: (pe) => !!g.editable(pe),
            renderEditCell: g.renderEditCell || X,
          }
  ...
  return /* @__PURE__ */ i(Ce, {
    ...
    onCellKeyDown: se,
    direction: le,
    enableVirtualization: ie,
    onCopy: ce,
    onPaste: he,
    onScroll: de,
    renderers: { renderCheckbox: Ge },
    className: `${ue ?? 'rdg-light'}`,
  });
}
function Le(e, n = 'top') {
