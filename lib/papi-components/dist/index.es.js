...
function ot({
  ...
  let p;
  if (n) {
    const d = t === $e.Before || t === $e.Above, v = /* @__PURE__ */ N("span", { className: `papi-checkbox-label ${u ? "error" : ""} ${c ?? ""}`, children: n }), b = t === $e.Before || t === $e.After, h = b ? v : /* @__PURE__ */ N("div", { children: v }), f = b ? l : /* @__PURE__ */ N("div", { children: l });
    p = /* @__PURE__ */ Ie(
      Fn,
      {
...
function Nt() {
  ...
  return z.AsyncMode = c, z.ConcurrentMode = i, z.ContextConsumer = u, z.ContextProvider = s, z.Element = r, z.ForwardRef = l, z.Fragment = t, z.Lazy = b, z.Memo = v, z.Portal = n, z.Profiler = a, z.StrictMode = o, z.Suspense = p, z.isAsyncMode = function(m) {
    ...
    return typeof m == "string" || typeof m == "function" || m === t || m === i || m === a || m === o || m === p || m === d || typeof m == "object" && m !== null && (m.$$typeof === b || m.$$typeof === v || m.$$typeof === s || m.$$typeof === u || m.$$typeof === l || m.$$typeof === f || m.$$typeof === S || m.$$typeof === W || m.$$typeof === h);
  }, z.typeOf = B, z;
}
var V = {};
/** @license React v16.13.1
...
function Et() {
  return Vr || (Vr = 1, process.env.NODE_ENV !== "production" && function() {
    ...
    function B(y) {
      ...
      y === t || y === i || y === a || y === o || y === p || y === d || typeof y == "object" && y !== null && (y.$$typeof === b || y.$$typeof === v || y.$$typeof === s || y.$$typeof === u || y.$$typeof === l || y.$$typeof === f || y.$$typeof === S || y.$$typeof === W || y.$$typeof === h);
    }
    function R(y) {
...
function Pt() {
  return Wr || (Wr = 1, process.env.NODE_ENV !== "production" && function() {
    var e = Symbol.for("react.element"), r = Symbol.for("react.portal"), n = Symbol.for("react.fragment"), t = Symbol.for("react.strict_mode"), o = Symbol.for("react.profiler"), a = Symbol.for("react.provider"), s = Symbol.for("react.context"), u = Symbol.for("react.server_context"), c = Symbol.for("react.forward_ref"), i = Symbol.for("react.suspense"), l = Symbol.for("react.suspense_list"), p = Symbol.for("react.memo"), d = Symbol.for("react.lazy"), v = Symbol.for("react.offscreen"), b = !1, h = !1, f = !1, S = !1, W = !1, B;
    B = Symbol.for("react.module.reference");
    function R(x) {
      return !!(typeof x == "string" || typeof x == "function" || x === n || x === o || W || x === t || x === i || x === l || S || x === v || b || h || f || typeof x == "object" && x !== null && (x.$$typeof === d || x.$$typeof === p || x.$$typeof === a || x.$$typeof === s || x.$$typeof === c || // This needs to include all possible module reference object
...
function H(e) {
  const {
    ...
    if (s[r] == null)
      return null;
    const u = s[r], c = s.theme, i = We(c, t) || {};
    return me(s, u, (p) => {
      let d = qe(i, o, p);
...
function jo() {
  ...
  function r(n) {
    ...
    function u(c) {
      ...
      if (!i)
        return null;
      const l = Xt(a.breakpoints), p = Object.keys(l);
      let d = l;
...
function Qo(e = {}) {
  ...
  return a.__mui_systemSx = !0, (s, u = {}) => {
    ...
    const {
      ...
      overridesResolver: d = Zo(nn(i))
    } = u, v = ge(u, Jo), b = l !== void 0 ? l : (
    ...
    let S = Ke;
    i === "Root" || i === "root" ? S = t : i ? S = o : Ko(s) && (S = void 0);
    const W = rt(s, A({
      shouldForwardProp: S,
      label: f
    }, v)), B = (R, ...m) => {
      ...
      if (process.env.NODE_ENV !== "production") {
        let D;
        c && (D = `${c}${de(i || "")}`), D === void 0 && (D = `Styled(${Bt(s)})`), ae.displayName = D;
      }
...
function Na(e) {
  const {
    ...
    tonalOffset: t = 0.2
  } = e, o = ge(e, ga), a = e.primary || ba(r), s = e.secondary || ya(r), u = e.error || va(r), c = e.info || ka(r), i = e.success || xa(r), l = e.warning || Sa(r);
  function p(h) {
...
function Ta(e, r) {
  ...
  const v = o / 14, b = p || ((S) => `${S / i * v}rem`), h = (S, W, B, R, m) => A({
    fontFamily: t,
    fontWeight: S,
    fontSize: b(W),
...
const Ka = ["children", "className", "color", "component", "fontSize", "htmlColor", "inheritViewBox", "titleAccess", "viewBox"], qa = (e) => {
  ...
  const t = Fa({
    ...
    titleAccess: p,
    viewBox: d = "0 0 24 24"
  } = t, v = ge(t, Ka), b = /* @__PURE__ */ Le.isValidElement(o) && o.type === "svg", h = A({}, t, {
    color: s,
    component: u,
    fontSize: c,
  ...
  return /* @__PURE__ */ Ie(Wa, A({
    ...
    ownerState: h,
    children: [b ? o.props.children : o, p ? /* @__PURE__ */ N("title", {
      children: p
    }) : null]
  }));
});
...
function fs({
  ...
  let f = e;
  return !f && r && (f = r(c)), /* @__PURE__ */ N("div", { ref: d, style: { position: "relative" }, children: /* @__PURE__ */ N(qn, { position: "static", id: o, children: /* @__PURE__ */ Ie(Wn, { className: `papi-toolbar ${t ?? ""}`, variant: "dense", children: [
    f ? /* @__PURE__ */ N(
      hn,
      {
        edge: "start",
    ...
    f ? /* @__PURE__ */ N(
      Xn,
      {
        ...
        children: /* @__PURE__ */ N(it, { commandHandler: h, columns: f.columns })
      }
    ) : null
  ] }) }) });
}
