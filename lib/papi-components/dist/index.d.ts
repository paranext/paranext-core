...
import { AutocompleteChangeDetails, AutocompleteChangeReason, SnackbarCloseReason, SnackbarOrigin } from '@mui/material';
import { ChangeEvent, ChangeEventHandler, FocusEventHandler, MouseEventHandler, PropsWithChildren, ReactElement, ReactNode, SyntheticEvent } from 'react';
 ...
 */
export declare function Button({ isDisabled, className, onClick, onContextMenu, children }: ButtonProps): JSX.Element;
 ...
 */
export declare function Checkbox({ isChecked, labelText, labelPosition, isIndeterminate, isDefaultChecked, isDisabled, hasError, className, onChange, }: CheckboxProps): JSX.Element;
...
export type ComboBoxProps = {
	 ...
	 */
	onChange?: (event: SyntheticEvent<Element, Event>, value: unknown, reason?: ComboBoxChangeReason, details?: ComboBoxChangeDetails<unknown> | undefined) => void;
	/**
 ...
 * https://mui.com/material-ui/getting-started/overview/
 */
export declare function ComboBox({ title, isDisabled, isClearable, hasError, isFullWidth, width, options, className, value, onChange, onFocus, onBlur, }: ComboBoxProps): JSX.Element;
 ...
 * https://mui.com/material-ui/getting-started/overview/
 */
export declare function Slider({ isDisabled, orientation, min, max, step, showMarks, defaultValue, valueLabelDisplay, className, onChange, onChangeCommitted, }: SliderProps): JSX.Element;
 ...
 * https://mui.com/material-ui/getting-started/overview/
 */
export declare function Switch({ isChecked: checked, isDisabled, hasError, className, onChange, }: SwitchProps): JSX.Element;
 ...
 * https://mui.com/material-ui/getting-started/overview/
 */
export declare function TextField({ variant, isDisabled, hasError, isFullWidth, helperText, label, placeholder, isRequired, className, defaultValue, value, onChange, onFocus, onBlur, }: TextFieldProps): JSX.Element;
...
export type SnackbarContentProps = {
	 ...
	 */
	action?: ReactNode | ReactElement<typeof Button>;
	/**
 ...
 * https://mui.com/material-ui/getting-started/overview/
 */
export declare function Snackbar({ autoHideDuration, isOpen, className, onClose, anchorOrigin, ContentProps, children, }: SnackbarProps): JSX.Element;
