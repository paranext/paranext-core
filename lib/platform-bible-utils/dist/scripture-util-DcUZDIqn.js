...
var y = (e, t, r) => ee(e, typeof t != "symbol" ? t + "" : t, r);
...
const re = "Debounced function invocation was canceled";
function _e(e, t = 300) {
  let r, s, a, n, o;
  ...
  return c.cancel = () => {
    clearTimeout(r), o = void 0, s && (n(new Error(re)), s = void 0);
  }, c.flush = () => {
    if (o === void 0) return;
    clearTimeout(r);
    const u = o;
...
), he = "", le = "", W = new Uint8Array(12448), G = new Uint8Array(1440), z = new Uint8Array(2816);
let H, q;
{
  let e = (a, n, o, i, h) => {
  ...
  ne(ie, he, (a, n, o) => {
    e(W, 0, a, n, o), e(G, 42592, a, n, o), e(z, 126976, a, n, o), n >= 65040 && !(a >= 126976 && n <= 129791) && (t[s] = a, r[s++] = n << 5 | o);
  }), H = t.slice(0, s), q = r.slice(0, s);
}
function O(e) {
  return e < 12448 ? W[e] : e < 42592 ? e === 12951 || e === 12953 ? 4 : 0 : e < 44032 ? G[e - 42592] : e < 55204 ? (e - 44032) % 28 ? 8 : 7 : e >= 126976 && e < 129792 ? z[e - 126976] : e >>> 4 === 4064 ? 3 : ue(e);
}
function ue(e) {
  return e < 57344 ? e <= 55238 ? e >= 55216 ? 13 : 0 : e >= 55243 && e <= 55291 ? 12 : 0 : e < 65024 ? e === 64286 ? 3 : 0 : e >= 917504 ? e > 921599 ? 0 : e >= 917536 && e < 917632 || e >= 917760 && e < 918e3 ? 3 : 2 : oe(e, H, q);
}
const ce = Uint8Array.from(le);
function fe(e) {
...
function me(e, t) {
  return t === 8204 ? e & 21 : e & 8 || fe(t) ? e & 21 | 40 : e & 21 | 32;
}
function w(e, t, r) {
  return t === 3 ? e & 32 ? me(e, r) : e & 21 : t === 4 ? 17 : t === 10 ? e & 2 ^ 3 : t === 14 ? (e & 16) >> 2 | e & 41 : t === 15 ? 33 : 1;
}
function* k(e) {
  let t = e.length;
  if (t === 0) return;
...
class m {
  ...
  *[Symbol.iterator]() {
   ...
   */
  formatReplacement(t) {
    return this.formatReplacementToArray(t).map(pe).join("");
  }
  /**
  ...
  split(t, r) {
    const s = r === void 0 ? Ne : X(r);
    return s === 0 ? [] : t === void 0 ? [this] : ge(t) ? this.splitOnRegExp(t, s) : this.splitOnString(S(t), s);
  }
  /**
...
const B = ["chapter", "book", "para", "row", "sidebar", te], Ae = "​", M = " ", V = [
...
], Se = 1, Ce = V.length - 1, ye = 1, Be = 1, xt = {
  book: "GEN",
  chapterNum: 1,
  verseNum: 1
}, Oe = (e) => {
  var t;
  return ((t = V[e]) == null ? void 0 : t.chapters) ?? -1;
...
const yt = (e, t) => ({
  ...
  ...e,
  chapterNum: Math.min(
    Math.max(ye, e.chapterNum + t),
    Oe(N.bookIdToNumber(e.book))
  ),
  verseNum: 1
}), Ot = (e, t) => ({
  ...e,
  verseNum: Math.max(Be, e.verseNum + t)
});
...
function ke(e, t) {
  const r = Z(e, t == null ? void 0 : t.optionOrLocalizedBookName), s = (t == null ? void 0 : t.bookChapterSeparator) ?? " ", a = (t == null ? void 0 : t.chapterVerseSeparator) ?? ":";
...
function R(e, t) {
  const r = Z(e, t == null ? void 0 : t.optionOrLocalizedBookName), s = Te(
    e,
...
var ve = /* @__PURE__ */ ((e) => (e.OT = "OT", e.NT = "NT", e.DC = "DC", e.Extra = "Extra", e))(ve || {});
const Pt = (e) => {
...
function Le(e) {
  ...
  for (let a = 0; a < e.length; a += 1) {
    const n = e[a];
    n.charCodeAt(0) < 32 ? (r || (t += " "), r = !0) : !r && n === Ae && a + 1 < e.length && L(e[a + 1]) || (L(n) ? (r || (t += n), r = !0) : Re(n) && s === n || (t += n, r = !1)), s = n;
  }
  return t;
}
function F(e) {
...
function j(e) {
  return e.split(M).map(Le).join(M);
}
function Y(e, t, r, s) {
  if (!e && !r) return !0;
  if (!e || !r) return !1;
...
function Lt(e) {
  const t = [], r = /* @__PURE__ */ new Set(), s = (a) => {
    a && a.forEach((n) => {
      if (p(n)) return;
      const { marker: o } = n;
      o && !o.startsWith("z") && !r.has(o) && (r.add(o), t.push(o)), s(n.content);
    });
  };
...
//# sourceMappingURL=scripture-util-DcUZDIqn.js.map
