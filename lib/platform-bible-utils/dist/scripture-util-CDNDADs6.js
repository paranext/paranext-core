...
var O = (t, e, s) => V(t, typeof e != "symbol" ? e + "" : e, s);
import { Canon as N, VerseRef as $ } from "@sillsdev/scripture";
import { USJ_TYPE as j } from "@eten-tech-foundation/scripture-utilities";
...
const y = ["chapter", "book", "para", "row", "sidebar", j], ae = "​", G = [
...
], ne = 1, oe = G.length - 1, he = 1, le = 1, tt = {
  book: "GEN",
  chapterNum: 1,
  verseNum: 1
}, ce = (t) => {
...
function k(t, e) {
  const s = F(t, e == null ? void 0 : e.optionOrLocalizedBookName), r = fe(
    t,
...
//# sourceMappingURL=scripture-util-CDNDADs6.js.map
