...
import { indexOf as V, limit as D, length as K, substring as j, toArray as X, substr as Z } from "stringz";
function ke() {
...
function P(e, t, a) {
  ...
  if (t > r || a && (t > a && !(t >= 0 && t < r && a < 0 && a > -r) || a < -r))
    return "";
  const s = y(r, t), o = a ? y(r, a) : void 0;
  return d(e, s, o);
}
function I(e, t, a) {
  const r = [];
...
const O = ["chapter", "book", "para", "row", "sidebar", H], ue = "​", M = " ", F = [
...
], ce = 1, he = F.length - 1, me = 1, fe = 1, je = {
  book: "GEN",
  chapterNum: 1,
  verseNum: 1
}, Ne = (e) => {
...
function v(e, t) {
  const a = z(e, t == null ? void 0 : t.optionOrLocalizedBookName), r = Ee(
    e,
...
function nt(e, t, a) {
  ...
  const s = e.book === t.book && !(a != null && a.repeatBookName) ? "" : (a == null ? void 0 : a.endRefOptionOrLocalizedBookName) ?? (a == null ? void 0 : a.optionOrLocalizedBookName), o = v(t, {
    ...a,
...
function Ae(e) {
  ...
  for (let s = 0; s < e.length; s += 1) {
    const o = e[s];
    o.charCodeAt(0) < 32 ? (a || (t += " "), a = !0) : !a && o === ue && s + 1 < e.length && x(e[s + 1]) || (x(o) ? (a || (t += o), a = !0) : be(o) && r === o || (t += o, a = !1)), r = o;
  }
  return t;
}
function L(e) {
...
function W(e, t, a, r) {
  ...
  if (s && o) {
    const n = J(e), l = J(a);
    if (n !== l) {
      if (!g(B(n, -1) ?? "") && !g(B(l, -1) ?? "") || !R(e, t) || !R(a, r)) return !1;
      let h = n;
      for (; g(B(h, -1) ?? ""); ) h = P(h, 0, -1);
      let f = l;
      for (; g(B(f, -1) ?? ""); ) f = P(f, 0, -1);
      if (h !== f) return !1;
    }
  } else if (!s && !o) {
    ...
    const f = L(n.content), i = L(l.content);
    if (f !== i) return !1;
    if (!f && !i) {
      ...
      if (O.includes(l.type) && E(k) && g(k) && (p = p.slice(0, -1)), c.length !== p.length) return !1;
...
function ct(e) {
  const t = [], a = /* @__PURE__ */ new Set(), r = (s) => {
    s && s.forEach((o) => {
      if (E(o)) return;
      const { marker: n } = o;
      n && !n.startsWith("z") && !a.has(n) && (a.add(n), t.push(n)), r(o.content);
    });
  };
...
//# sourceMappingURL=scripture-util-CUueoNBU.js.map
