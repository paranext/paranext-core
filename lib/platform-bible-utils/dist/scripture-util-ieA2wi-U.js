...
const T = ["chapter", "book", "para", "row", "sidebar", H], le = "​", G = [
...
function z(e, t, a, r) {
  ...
  if (s && o) {
    const l = R(e), n = R(a);
    if (l !== n) {
      if (!g(A(l, -1) ?? "") && !g(A(n, -1) ?? "") || !J(e, t) || !J(a, r)) return !1;
      let c = l;
    ...
    const f = v(l.content), d = v(n.content);
    if (f !== d) return !1;
    if (!f && !d) {
...
//# sourceMappingURL=scripture-util-ieA2wi-U.js.map
