...
import { indexOf as F, limit as D, length as W, substring as K, toArray as X, substr as j } from "stringz";
function Be() {
...
], le = 1, ue = G.length - 1, ce = 1, he = 1, Ve = {
  book: "GEN",
  chapterNum: 1,
  verseNum: 1
}, me = (e) => {
...
function R(e) {
  ...
  for (let s = 0; s < e.length; s += 1) {
    const o = e[s];
    o.charCodeAt(0) < 32 ? (a || (t += " "), a = !0) : !a && o === ne && s + 1 < e.length && L(e[s + 1]) || (L(o) ? (a || (t += o), a = !0) : Ce(o) && r === o || (t += o, a = !1)), r = o;
  }
  return t;
}
function J(e) {
...
function H(e, t, a, r) {
  ...
  if (s && o) {
    const l = R(e), n = R(a);
    if (l !== n) {
      if (!g(A(l, -1) ?? "") && !g(A(n, -1) ?? "") || !v(e, t) || !v(a, r)) return !1;
      let c = l;
    ...
    const f = J(l.content), C = J(n.content);
    if (f !== C) return !1;
    if (!f && !C) {
      let h = l.content, E = n.content;
      const y = h[h.length - 1];
      T.includes(l.type) && i(y) && g(y) && (h = h.slice(0, -1));
      const k = E[E.length - 1];
      if (T.includes(n.type) && i(k) && g(k) && (E = E.slice(0, -1)), h.length !== E.length) return !1;
...
//# sourceMappingURL=scripture-util-A_1QUftH.js.map
