...
class i {
  ...
  *[Symbol.iterator]() {
   ...
   */
  formatReplacement(t) {
    return this.formatReplacementToArray(t).map((s) => `${s}`).join("");
  }
  /**
  ...
  padStart(t, s) {
    ...
    return r.length === 0 ? this : new i(r.join("") + this.str);
  }
  /**
  ...
  padEnd(t, s) {
    const r = this.buildPadding(t, s);
    return r.length === 0 ? this : new i(this.str + r.join(""));
  }
  /**
   ...
   */
  indexOf(t, s) {
    const r = b(t), a = S(s ?? 0, this.graphemes.length);
   ...
   */
  lastIndexOf(t, s) {
    const r = b(t), { length: a } = this.graphemes, n = s === void 0 ? NaN : Number(s), o = Number.isNaN(n) ? a : S(n, a);
  ...
  split(t, s) {
    ...
    return r === 0 ? [] : t === void 0 ? [this] : se(t) ? this.splitOnRegExp(t, r) : this.splitOnString(b(t), r);
  }
  /**
...
function ze(e, t, s) {
  return new i(e).padEnd(t, s).toString();
}
function He(e, t, s) {
  return new i(e).padStart(t, s).toString();
}
function Ve(e, t, s) {
...
const y = ["chapter", "book", "para", "row", "sidebar", Z], oe = "​", k = " ", z = [
...
], he = 1, ce = z.length - 1, le = 1, ue = 1, at = {
  book: "GEN",
  chapterNum: 1,
  verseNum: 1
}, ie = (e) => {
...
function P(e, t) {
  const s = H(e, t == null ? void 0 : t.optionOrLocalizedBookName), r = Ne(
    e,
...
function Se(e) {
  ...
  for (let a = 0; a < e.length; a += 1) {
    const n = e[a];
    n.charCodeAt(0) < 32 ? (s || (t += " "), s = !0) : !s && n === oe && a + 1 < e.length && R(e[a + 1]) || (R(n) ? (s || (t += n), s = !0) : Ae(n) && r === n || (t += n, s = !1)), r = n;
  }
  return t;
}
function L(e) {
...
function D(e) {
  return e.split(k).map(Se).join(k);
}
function V(e, t, s, r) {
  if (!e && !s) return !0;
  if (!e || !s) return !1;
...
//# sourceMappingURL=scripture-util-DcoZhajY.js.map
