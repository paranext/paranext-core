...
import { indexOf as V, limit as _, length as K, substring as j, toArray as X, substr as Z } from "stringz";
function Ie() {
...
function Je(e) {
  ...
  return E(e) ? e.includes(t) : D(e).includes(t);
}
function $e(e) {
  const t = "401 Unauthorized error while getting shared projects.", a = "User registration is not valid. Cannot retrieve resources from DBL.", r = E(e) ? e : D(e);
...
function Fe(e, t, a = " ") {
  return t <= m(e) ? e : _(e, t, a, "right");
}
function ze(e, t, a = " ") {
  return t <= m(e) ? e : _(e, t, a, "left");
}
function y(e, t) {
...
const O = ["chapter", "book", "para", "row", "sidebar", H], he = "​", M = " ", F = [
...
], me = 1, fe = F.length - 1, ie = 1, Ne = 1, qe = {
  book: "GEN",
  chapterNum: 1,
  verseNum: 1
}, pe = (e) => {
...
}, Ye = "", Qe = i.allBookIds.filter(
  (e) => !i.isObsolete(i.bookIdToNumber(e))
);
function et(e) {
...
const tt = (e, t) => ({
  book: i.bookNumberToId(
    Math.max(
      me,
      Math.min(i.bookIdToNumber(e.book) + t, fe)
    )
  ),
  chapterNum: 1,
  verseNum: 1
  ...
  ...e,
  chapterNum: Math.min(
    Math.max(ie, e.chapterNum + t),
    pe(i.bookIdToNumber(e.book))
  ),
  verseNum: 1
}), rt = (e, t) => ({
  ...e,
...
function Be(e) {
  ...
  for (let s = 0; s < e.length; s += 1) {
    const o = e[s];
    o.charCodeAt(0) < 32 ? (a || (t += " "), a = !0) : !a && o === he && s + 1 < e.length && R(e[s + 1]) || (R(o) ? (a || (t += o), a = !0) : Te(o) && r === o || (t += o, a = !1)), r = o;
  }
  return t;
}
function v(e) {
...
function W(e, t, a, r) {
  ...
  if (s && o) {
    const n = J(e), l = J(a);
    if (n !== l) {
      if (!S(T(n, -1) ?? "") && !S(T(l, -1) ?? "") || !x(e, t) || !x(a, r)) return !1;
      let h = n;
      for (; S(T(h, -1) ?? ""); ) h = I(h, 0, -1);
      let f = l;
      for (; S(T(f, -1) ?? ""); ) f = I(f, 0, -1);
      if (h !== f) return !1;
    }
  } else if (!s && !o) {
    ...
    const f = v(n.content), N = v(l.content);
    if (f !== N) return !1;
    if (!f && !N) {
      ...
      if (O.includes(l.type) && E(k) && S(k) && (p = p.slice(0, -1)), c.length !== p.length) return !1;
...
//# sourceMappingURL=scripture-util-0bza5jjZ.js.map
