...
function ae(e, t) {
  ...
  let r = 0, s = 0;
  function o(l, c, m) {
    const N = E(e, s, c), h = a.length > 0 && p(a[a.length - 1]) ? `${a.pop()}${N}` : N;
...
function w(e, t, a) {
  ...
  for (let l = 0; l < (a ? a - 1 : o.length); l++) {
    ...
    if (r.push(E(e, n, c)), n = c + m, a !== void 0 && r.length === a)
      break;
  }
  return r.push(E(e, n)), r;
}
function O(e, t, a = 0) {
  return C(e, t, a) === a;
}
function B(e, t = 0, a = f(e) - t) {
  return Z(e, t, a);
}
function E(e, t, a = f(e)) {
  return X(e, t, a);
}
function oe(e) {
  return j(e);
...
function H(e, t, a, r) {
  ...
  if (s && o) {
    const n = R(e), l = R(a);
    if (n !== l) {
      if (!g(A(n, -1) ?? "") && !g(A(l, -1) ?? "") || !J(e, t) || !J(a, r)) return !1;
      let c = n;
      for (; g(A(c, -1) ?? ""); ) c = P(c, 0, -1);
      let m = l;
      for (; g(A(m, -1) ?? ""); ) m = P(m, 0, -1);
      if (c !== m) return !1;
    }
  } else if (!s && !o) {
    ...
    const m = v(n.content), N = v(l.content);
    if (m !== N) return !1;
    if (!m && !N) {
      let h = n.content, d = l.content;
      const y = h[h.length - 1];
      T.includes(n.type) && p(y) && g(y) && (h = h.slice(0, -1));
      const k = d[d.length - 1];
      if (T.includes(l.type) && p(k) && g(k) && (d = d.slice(0, -1)), h.length !== d.length) return !1;
...
function nt(e) {
  const t = [], a = /* @__PURE__ */ new Set(), r = (s) => {
    s && s.forEach((o) => {
      if (p(o)) return;
      const { marker: n } = o;
      n && !O(n, "z") && !a.has(n) && (a.add(n), t.push(n)), r(o.content);
    });
  };
...
//# sourceMappingURL=scripture-util-BhmEFqSa.js.map
