  ...
  buildPadding(t, s) {
    ...
    if (r > T)
      throw new RangeError(
        `Invalid string length: padding to ${r} graphemes exceeds the limit of ${T}`
      );
...
const y = ["chapter", "book", "para", "row", "sidebar", K], he = "​", M = " ", F = [
...
], ce = 1, ie = F.length - 1, le = 1, ue = 1, ct = {
  book: "GEN",
  chapterNum: 1,
  verseNum: 1
}, me = (e) => {
...
function be(e) {
  ...
  for (let a = 0; a < e.length; a += 1) {
    const n = e[a];
    n.charCodeAt(0) < 32 ? (s || (t += " "), s = !0) : !s && n === he && a + 1 < e.length && P(e[a + 1]) || (P(n) ? (s || (t += n), s = !0) : Se(n) && r === n || (t += n, s = !1)), r = n;
  }
  return t;
}
function R(e) {
...
//# sourceMappingURL=scripture-util-DArajUVn.js.map
