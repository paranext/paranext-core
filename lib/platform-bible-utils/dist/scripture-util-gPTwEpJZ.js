...
import { indexOf as K, limit as D, length as j, substring as X, toArray as Z, substr as q } from "stringz";
function Ie() {
...
function Je(e) {
  ...
  return E(e) ? e.includes(t) : U(e).includes(t);
}
function $e(e) {
  const t = "401 Unauthorized error while getting shared projects.", a = "User registration is not valid. Cannot retrieve resources from DBL.", r = E(e) ? e : U(e);
...
function ae(e, t, a) {
  if (t < 0) return -1;
  if (a) {
    if (g(e, t) === "}" && g(e, t - 1) === "\\") return t;
    const o = C(e, "\\}", t);
    return o >= 0 ? o + 1 : o;
  }
  let r = t;
  const s = m(e);
  for (; r < s && (r = C(e, "}", r), !(r === -1 || g(e, r - 1) !== "\\")); )
    r += 1;
  return r >= s ? -1 : r;
}
function re(e, t) {
...
function Fe(e, t, a = " ") {
  return t <= m(e) ? e : D(e, t, a, "right");
}
function ze(e, t, a = " ") {
  return t <= m(e) ? e : D(e, t, a, "left");
}
function I(e, t) {
...
function P(e, t, a) {
  ...
  if (t > r || a && (t > a && !(t >= 0 && t < r && a < 0 && a > -r) || a < -r))
    return "";
  const s = I(r, t), o = a ? I(r, a) : void 0;
  return d(e, s, o);
}
function M(e, t, a) {
  const r = [];
...
const O = ["chapter", "book", "para", "row", "sidebar", W], he = "​", L = " ", z = [
...
], me = 1, fe = z.length - 1, Ne = 1, ie = 1, qe = {
  book: "GEN",
  chapterNum: 1,
  verseNum: 1
}, pe = (e) => {
...
const tt = (e, t) => ({
  book: N.bookNumberToId(
    Math.max(
      me,
      Math.min(N.bookIdToNumber(e.book) + t, fe)
    )
  ),
  chapterNum: 1,
  verseNum: 1
  ...
  ...e,
  chapterNum: Math.min(
    Math.max(Ne, e.chapterNum + t),
    pe(N.bookIdToNumber(e.book))
  ),
  verseNum: 1
}), rt = (e, t) => ({
  ...e,
...
function R(e, t) {
  const a = H(e, t == null ? void 0 : t.optionOrLocalizedBookName), r = Se(
    e,
...
function ct(e, t, a) {
  const r = R(e, a);
  if (Ee(e, t) === 0) return r;
  const s = e.book === t.book && !(a != null && a.repeatBookName) ? "" : (a == null ? void 0 : a.endRefOptionOrLocalizedBookName) ?? (a == null ? void 0 : a.optionOrLocalizedBookName), o = R(t, {
    ...a,
...
function Be(e) {
  ...
  for (let s = 0; s < e.length; s += 1) {
    const o = e[s];
    o.charCodeAt(0) < 32 ? (a || (t += " "), a = !0) : !a && o === he && s + 1 < e.length && v(e[s + 1]) || (v(o) ? (a || (t += o), a = !0) : Te(o) && r === o || (t += o, a = !1)), r = o;
  }
  return t;
}
function x(e) {
...
function $(e) {
  return e.split(L).map(Be).join(L);
}
function V(e, t, a, r) {
  if (!e && !a) return !0;
  if (!e || !a) return !1;
  ...
  if (s && o) {
    const n = $(e), l = $(a);
    if (n !== l) {
      if (!S(T(n, -1) ?? "") && !S(T(l, -1) ?? "") || !J(e, t) || !J(a, r)) return !1;
      let h = n;
      for (; S(T(h, -1) ?? ""); ) h = P(h, 0, -1);
      let f = l;
      for (; S(T(f, -1) ?? ""); ) f = P(f, 0, -1);
      if (h !== f) return !1;
    }
  } else if (!s && !o) {
    ...
    const f = x(n.content), i = x(l.content);
    if (f !== i) return !1;
    if (!f && !i) {
      let c = n.content, p = l.content;
      const b = c[c.length - 1];
      O.includes(n.type) && E(b) && S(b) && (c = c.slice(0, -1));
      const y = p[p.length - 1];
      if (O.includes(l.type) && E(y) && S(y) && (p = p.slice(0, -1)), c.length !== p.length) return !1;
...
//# sourceMappingURL=scripture-util-gPTwEpJZ.js.map
