...
var X = (e, t, s) => t in e ? H(e, t, { enumerable: !0, configurable: !0, writable: !0, value: s }) : e[t] = s;
...
import { splitGraphemes as B } from "unicode-segmenter/grapheme";
function xe() {
...
const V = "Debounced function invocation was canceled";
function Be(e, t = 300) {
  let s, r, a, n, o;
  const h = () => (r || (r = new Promise((f, l) => {
    a = f, n = l;
  })), r), c = async (f) => {
    const l = a, p = n;
    r = void 0;
  ...
  return m.cancel = () => {
    clearTimeout(s), o = void 0, r && (n(new Error(V)), r = void 0);
  }, m.flush = () => {
    if (o === void 0) return;
    clearTimeout(s);
    const f = o;
...
function ve(e) {
  ...
  return g(e) ? e.includes(t) : U(e).includes(t);
}
function Pe(e) {
  const t = "401 Unauthorized error while getting shared projects.", s = "User registration is not valid. Cannot retrieve resources from DBL.", r = g(e) ? e : U(e);
...
class u {
  ...
  constructor(t) {
     ...
     */
    x(this, "graphemes");
    this.str = t, this.graphemes = t === "" ? [] : Array.from(B(t));
  }
  /**
  ...
  *[Symbol.iterator]() {
  ...
  splitOnRegExp(t, s) {
    ...
    for (; c < this.str.length; ) {
      ...
      if (!m) break;
      const f = m.index + m[0].length, l = this.graphemeIndexAtOffset(m.index), p = c + 1;
      if (l < 0 || !this.isBoundary(f))
  ...
  buildPadding(t, s) {
    ...
    const a = s === void 0 ? " " : `${s}`, n = Array.from(B(a));
...
function re(e, t) {
  ...
  let r = 0, a = 0;
  function n(h, c, m) {
    const f = e.slice(a, c).toString(), l = s.length > 0 && g(s[s.length - 1]) ? `${s.pop()}${f}` : f;
    g(h) ? s.push(`${l}${h}`) : (l && s.push(l), s.push(h)), a = c + m;
  }
  const o = e.length;
  for (; r < o; ) {
...
const y = ["chapter", "book", "para", "row", "sidebar", K], ne = "​", M = " ", F = [
...
], oe = 1, he = F.length - 1, ce = 1, le = 1, nt = {
  book: "GEN",
  chapterNum: 1,
  verseNum: 1
}, ie = (e) => {
...
const lt = (e, t) => ({
  ...
  ...e,
  verseNum: Math.max(le, e.verseNum + t)
});
...
function v(e, t) {
  const s = j(e, t == null ? void 0 : t.optionOrLocalizedBookName), r = fe(
    e,
...
var Ne = /* @__PURE__ */ ((e) => (e.OT = "OT", e.NT = "NT", e.DC = "DC", e.Extra = "Extra", e))(Ne || {});
const Et = (e) => {
...
function Ae(e) {
  ...
  for (let a = 0; a < e.length; a += 1) {
    const n = e[a];
    n.charCodeAt(0) < 32 ? (s || (t += " "), s = !0) : !s && n === ne && a + 1 < e.length && P(e[a + 1]) || (P(n) ? (s || (t += n), s = !0) : Ee(n) && r === n || (t += n, s = !1)), r = n;
  }
  return t;
}
function R(e) {
...
function $(e) {
  return e.split(M).map(Ae).join(M);
}
function z(e, t, s, r) {
  if (!e && !s) return !0;
  if (!e || !s) return !1;
...
//# sourceMappingURL=scripture-util-CdNYRoko.js.map
