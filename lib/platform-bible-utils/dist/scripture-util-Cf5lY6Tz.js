...
function I(e, t) {
  ...
  let r = 0, a = 0;
  function n(h, l, c) {
    const N = e.slice(a, l).toString(), f = s.length > 0 && p(s[s.length - 1]) ? `${s.pop()}${N}` : N;
    ...
    switch (e.charAt(r)) {
      case "{":
        if (h !== "\\") {
          const l = te(e, r, !1);
          if (l >= 0) {
            const c = e.slice(r + 1, l).toString(), N = c in t ? (
...
function H(e, t, s, r) {
  ...
  if (a && n) {
    ...
    if (!c && !N) {
      ...
      if (w.includes(h.type) && p(C) && A(C) && (g = g.slice(0, -1)), f.length !== g.length) return !1;
...
//# sourceMappingURL=scripture-util-Cf5lY6Tz.js.map
