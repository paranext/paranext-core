...
var re = (e, t, r) => t in e ? te(e, t, { enumerable: !0, configurable: !0, writable: !0, value: r }) : e[t] = r;
...
const ae = "Debounced function invocation was canceled";
function Ge(e, t = 300) {
  let r, s, a, n, o;
  const i = () => (s || (s = new Promise((u, h) => {
    a = u, n = h;
  })), s), l = async (u) => {
    const h = a, b = n;
    s = void 0;
  ...
  return c.cancel = () => {
    clearTimeout(r), o = void 0, s && (n(new Error(ae)), s = void 0);
  }, c.flush = () => {
    if (o === void 0) return;
    clearTimeout(r);
    const u = o;
...
function We(e, t, r) {
  ...
  return e.forEach((a, n) => {
    const o = t(a, n), i = s.get(o), l = r ? r(a, o, n) : a;
    i ? i.push(l) : s.set(o, [l]);
  }), s;
}
function ne(e) {
...
function Ke(e) {
  const t = "401 Unauthorized error while getting shared projects.", r = "User registration is not valid. Cannot retrieve resources from DBL.", s = p(e) ? e : $(e);
  return s.includes(t) || s.includes(r);
}
function ie(e, t, r) {
  let s = e.length, a = 0, n = 0, o = -1, i = () => {
    let l = 0, c = 0, u;
    do
      u = parseInt(e[a++], 36), l += (u & 15) << c, c += 4;
    while (u & 16);
    return l;
  };
  for (; a < s; ) {
    let l = o + 1 + i();
    r(l, o = l + i(), parseInt(t[n++], 36));
  }
}
function le(e, t, r) {
...
), ue = "", ce = "", W = new Uint8Array(12448), z = new Uint8Array(1440), H = new Uint8Array(2816);
let q, V;
{
  let e = (a, n, o, i, l) => {
    let c = i - n + 1, u = a.length;
    c > 0 && o - n < u && a.fill(l, o > n ? o - n : 0, c > u ? u : c);
  }, t = new Uint32Array(320), r = new Uint32Array(320), s = 0;
  ie(he, ue, (a, n, o) => {
    e(W, 0, a, n, o), e(z, 42592, a, n, o), e(H, 126976, a, n, o), n >= 65040 && !(a >= 126976 && n <= 129791) && (t[s] = a, r[s++] = n << 5 | o);
  }), q = t.slice(0, s), V = r.slice(0, s);
}
function O(e) {
  return e < 12448 ? W[e] : e < 42592 ? e === 12951 || e === 12953 ? 4 : 0 : e < 44032 ? z[e - 42592] : e < 55204 ? (e - 44032) % 28 ? 8 : 7 : e >= 126976 && e < 129792 ? H[e - 126976] : e >>> 4 === 4064 ? 3 : fe(e);
}
function fe(e) {
  return e < 57344 ? e <= 55238 ? e >= 55216 ? 13 : 0 : e >= 55243 && e <= 55291 ? 12 : 0 : e < 65024 ? e === 64286 ? 3 : 0 : e >= 917504 ? e > 921599 ? 0 : e >= 917536 && e < 917632 || e >= 917760 && e < 918e3 ? 3 : 2 : le(e, q, V);
}
const me = Uint8Array.from(ce);
function Ne(e) {
...
function be(e, t) {
  return t === 8204 ? e & 21 : e & 8 || Ne(t) ? e & 21 | 40 : e & 21 | 32;
}
function w(e, t, r) {
  return t === 3 ? e & 32 ? be(e, r) : e & 21 : t === 4 ? 17 : t === 10 ? e & 2 ^ 3 : t === 14 ? (e & 16) >> 2 | e & 41 : t === 15 ? 33 : 1;
}
function* k(e) {
  let t = e.length;
  if (t === 0) return;
  ...
  for (; s < t; ) {
    r = /** @type {number} */
    e.codePointAt(s);
    let i = O(r), l = !(n & me[a << 4 | i]);
    n = w(n, i, r), l && (yield e.slice(o, s), o = s), s += r > 65535 ? 2 : 1, a = i;
  }
  yield e.slice(o);
}
const pe = 2 ** 32 - 1, T = 2 ** 20;
function A(e) {
  const t = Number(e);
...
function v(e, t) {
  const r = A(e);
  return r === -1 / 0 ? 0 : r < 0 ? Math.max(t + r, 0) : Math.min(r, t);
}
function x(e, t) {
  const r = A(e);
...
class m {
  ...
  *[Symbol.iterator]() {
   ...
   */
  formatReplacement(t) {
    return this.formatReplacementToArray(t).map(de).join("");
  }
  /**
  ...
  split(t, r) {
    const s = r === void 0 ? pe : X(r);
    return s === 0 ? [] : t === void 0 ? [this] : Ee(t) ? this.splitOnRegExp(t, s) : this.splitOnString(C(t), s);
  }
  /**
  ...
  splitOnString(t, r) {
    ...
    if (t === "")
      return this.graphemes.slice(0, Math.min(r, s)).map((i) => m.fromSegmented(i, [i]));
    if (s === 0) return [this];
    const a = [];
    let n = 0, o = 0;
    for (; o < s; ) {
      const i = this.indexOf(t, o);
      if (i < 0) break;
      if (a.push(this.derive(n, i)), a.length === r) return a;
      n = i + this.graphemeSpan(i, t), o = n;
    }
  ...
  splitOnRegExp(t, r) {
    ...
    for (; l < this.str.length; ) {
      ...
      if (!c) break;
      const u = c.index + c[0].length, h = this.graphemeIndexAtOffset(c.index), b = l + 1;
      if (h < 0 || !this.isBoundary(u))
        l = Math.max(c.index + 1, b);
      else {
        const g = u >= this.str.length ? s : this.graphemeIndexAtOffset(u);
        if (g === i) {
          if (h + 1 >= s) break;
          l = Math.max(this.offsets()[h + 1], b);
        } else {
          if (o.push(this.derive(i, h)), o.length === r) return o;
    ...
    return o.push(this.derive(i, s)), o;
  }
  /**
  ...
  buildPadding(t, r) {
    ...
    const o = s - this.graphemes.length, i = new Array(o);
    for (let l = 0; l < o; l++) i[l] = n[l % n.length];
    return i;
  }
  /** UTF-16 offset where grapheme `index` starts, or the end of the string for `index === length`. */
  offsetAt(t) {
    const r = this.offsets();
    return t < r.length ? r[t] : this.str.length;
  }
  /**
...
function Ae(e, t) {
  ...
  let s = 0, a = 0;
  function n(i, l, c) {
    const u = e.slice(a, l).toString(), h = r.length > 0 && p(r[r.length - 1]) ? `${r.pop()}${u}` : u;
    p(i) ? r.push(`${h}${i}`) : (h && r.push(h), r.push(i)), a = l + c;
  }
  const o = e.length;
  for (; s < o; ) {
    const i = e.charAt(s - 1);
    switch (e.charAt(s)) {
      case "{":
        if (i !== "\\") {
          const l = xe(e, s, !1);
          if (l >= 0) {
            const c = e.slice(s + 1, l).toString(), u = Object.hasOwn(t, c) ? (
  ...
  if (a < o) {
    const i = e.slice(a).toString();
    r.push(
      r.length > 0 && p(r[r.length - 1]) ? `${r.pop()}${i}` : i
    );
  }
  return r;
}
    ...
    if (s === s.toUpperCase() && s !== s.toLowerCase()) {
      if (r > 0) {
        ...
        if (!(n === n.toUpperCase() && n !== n.toLowerCase()))
          ...
          const i = e[r + 1];
          i === i.toLowerCase() && i !== i.toUpperCase() && (t += "-");
        }
      }
      t += s.toLowerCase();
    } else
...
const B = ["chapter", "book", "para", "row", "sidebar", se], Se = "​", P = " ", Y = [
...
], ye = 1, Be = Y.length - 1, Oe = 1, we = 1, xt = {
  book: "GEN",
  chapterNum: 1,
  verseNum: 1
}, ke = (e) => {
  var t;
  return ((t = Y[e]) == null ? void 0 : t.chapters) ?? -1;
...
const yt = (e, t) => ({
  book: N.bookNumberToId(
    Math.max(
      ye,
      Math.min(N.bookIdToNumber(e.book) + t, Be)
    )
  ),
  chapterNum: 1,
  verseNum: 1
  ...
  chapterNum: Math.min(
    ...
    ke(N.bookIdToNumber(e.book))
  ),
  verseNum: 1
}), Ot = (e, t) => ({
  ...e,
  verseNum: Math.max(we, e.verseNum + t)
});
async function wt(e, t, r) {
  const s = N.bookNumberToId(e);
  if (!Z(Intl.getCanonicalLocales(t)[0], "zh"))
    return r({
...
function ve(e, t) {
  const r = Q(e, t == null ? void 0 : t.optionOrLocalizedBookName), s = (t == null ? void 0 : t.bookChapterSeparator) ?? " ", a = (t == null ? void 0 : t.chapterVerseSeparator) ?? ":";
...
function L(e, t) {
  const r = Q(e, t == null ? void 0 : t.optionOrLocalizedBookName), s = Ie(
    e,
...
function Mt(e, t, r) {
  const s = L(e, r);
  if (Te(e, t) === 0) return s;
  const a = e.book === t.book && !(r != null && r.repeatBookName) ? "" : (r == null ? void 0 : r.endRefOptionOrLocalizedBookName) ?? (r == null ? void 0 : r.optionOrLocalizedBookName), n = L(t, {
    ...r,
    optionOrLocalizedBookName: a
  });
  return `${s}${(r == null ? void 0 : r.rangeSeparator) ?? " - "}${n}`;
}
var Me = /* @__PURE__ */ ((e) => (e.OT = "OT", e.NT = "NT", e.DC = "DC", e.Extra = "Extra", e))(Me || {});
const Pt = (e) => {
...
function De(e) {
  ...
  for (let a = 0; a < e.length; a += 1) {
    const n = e[a];
    n.charCodeAt(0) < 32 ? (r || (t += " "), r = !0) : !r && n === Se && a + 1 < e.length && F(e[a + 1]) || (F(n) ? (r || (t += n), r = !0) : Fe(n) && s === n || (t += n, r = !1)), s = n;
  }
  return t;
}
function D(e) {
...
function J(e) {
  return e.split(P).map(De).join(P);
}
function ee(e, t, r, s) {
  if (!e && !r) return !0;
  if (!e || !r) return !1;
  ...
  if (a && n) {
    ...
    if (o !== i) {
      const l = new m(o);
      let c;
      const u = () => (c ?? (c = new m(i)), c);
      if (!S(l.at(-1) ?? "") && !S(u().at(-1) ?? "") || !j(e, t) || !j(r, s) || U(l) !== U(u())) return !1;
    }
  } else if (!a && !n) {
    const o = e, i = r, l = Object.keys(o).filter(
      (h) => h !== "content"
    );
    if (l.length !== Object.keys(i).filter((h) => h !== "content").length || l.some((h) => !(h in i) || o[h] !== i[h])) return !1;
    const c = D(o.content), u = D(i.content);
    if (c !== u) return !1;
    if (!c && !u) {
      let h = o.content, b = i.content;
      const g = h[h.length - 1];
      B.includes(o.type) && p(g) && S(g) && (h = h.slice(0, -1));
      const E = b[b.length - 1];
      if (B.includes(i.type) && p(E) && S(E) && (b = b.slice(0, -1)), h.length !== b.length) return !1;
...
function Lt(e) {
  const t = [], r = /* @__PURE__ */ new Set(), s = (a) => {
    a && a.forEach((n) => {
      if (p(n)) return;
      const { marker: o } = n;
      o && !Z(o, "z") && !r.has(o) && (r.add(o), t.push(o)), s(n.content);
    });
  };
...
//# sourceMappingURL=scripture-util-C0x1tXaM.js.map
