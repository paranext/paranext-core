...
function Oe(e, t = 300) {
  let a, r, s, o;
  return (...u) => (clearTimeout(a), r || (r = new Promise((n, c) => {
    s = n, o = c;
  })), a = setTimeout(async () => {
    try {
      s(await e(...u));
...
const T = ["chapter", "book", "para", "row", "sidebar", H], ne = "​", G = [
...
], ue = 1, le = G.length - 1, ce = 1, he = 1, He = {
  book: "GEN",
  chapterNum: 1,
  verseNum: 1
}, me = (e) => {
...
function tt(e, t, a) {
  ...
  const s = e.book === t.book && !(a != null && a.repeatBookName) ? "" : (a == null ? void 0 : a.endRefOptionOrLocalizedBookName) ?? (a == null ? void 0 : a.optionOrLocalizedBookName), o = L(t, {
    ...a,
...
function R(e) {
  ...
  for (let s = 0; s < e.length; s += 1) {
    const o = e[s];
    o.charCodeAt(0) < 32 ? (a || (t += " "), a = !0) : !a && o === ne && s + 1 < e.length && x(e[s + 1]) || (x(o) ? (a || (t += o), a = !0) : Ce(o) && r === o || (t += o, a = !1)), r = o;
  }
  return t;
}
function J(e) {
...
function z(e, t, a, r) {
  ...
  if (s && o) {
    const u = R(e), n = R(a);
    if (u !== n) {
      if (!g(A(u, -1) ?? "") && !g(A(n, -1) ?? "") || !v(e, t) || !v(a, r)) return !1;
      let c = u;
      for (; g(A(c, -1) ?? ""); ) c = M(c, 0, -1);
      let f = n;
      for (; g(A(f, -1) ?? ""); ) f = M(f, 0, -1);
      if (c !== f) return !1;
    }
  } else if (!s && !o) {
    ...
    const f = J(u.content), C = J(n.content);
    if (f !== C) return !1;
    if (!f && !C) {
      let h = u.content, E = n.content;
      const k = h[h.length - 1];
      T.includes(u.type) && i(k) && g(k) && (h = h.slice(0, -1));
...
function st(e) {
  const t = [], a = /* @__PURE__ */ new Set(), r = (s) => {
    s && s.forEach((o) => {
      if (i(o)) return;
      const { marker: u } = o;
      u && !O(u, "z") && !a.has(u) && (a.add(u), t.push(u)), r(o.content);
    });
  };
...
//# sourceMappingURL=scripture-util-D7GPhJTY.js.map
