...
function ke(e, t = 300) {
  let a, r, s, o;
  const l = (...n) => (clearTimeout(a), r || (r = new Promise((c, N) => {
    s = c, o = N;
  })), a = setTimeout(async () => {
    try {
      s(await e(...n));
  ...
  return l.cancel = () => {
    clearTimeout(a), r && (o(new Error(q)), r = void 0);
  }, l;
}
function ye(e, t, a) {
...
function xe(e) {
  ...
  return i(e) ? e.includes(t) : U(e).includes(t);
}
function Le(e) {
...
function ae(e, t) {
  ...
  let r = 0, s = 0;
  function o(n, c, N) {
    const g = p(e, s, c), h = a.length > 0 && i(a[a.length - 1]) ? `${a.pop()}${g}` : g;
...
const T = ["chapter", "book", "para", "row", "sidebar", V], le = "​", F = [
...
const Ze = (e, t) => ({
  book: f.bookNumberToId(
    Math.max(
      ue,
      Math.min(f.bookIdToNumber(e.book) + t, ce)
    )
  ),
  chapterNum: 1,
  verseNum: 1
...
function R(e) {
  ...
  for (let s = 0; s < e.length; s += 1) {
    const o = e[s];
    o.charCodeAt(0) < 32 ? (a || (t += " "), a = !0) : !a && o === le && s + 1 < e.length && L(e[s + 1]) || (L(o) ? (a || (t += o), a = !0) : Ce(o) && r === o || (t += o, a = !1)), r = o;
  }
  return t;
}
function v(e) {
...
function H(e, t, a, r) {
  ...
  if (s && o) {
    const l = R(e), n = R(a);
    if (l !== n) {
      if (!d(A(l, -1) ?? "") && !d(A(n, -1) ?? "") || !J(e, t) || !J(a, r)) return !1;
      let c = l;
      for (; d(A(c, -1) ?? ""); ) c = P(c, 0, -1);
      let N = n;
      for (; d(A(N, -1) ?? ""); ) N = P(N, 0, -1);
      if (c !== N) return !1;
    }
  } else if (!s && !o) {
    ...
    const N = v(l.content), g = v(n.content);
    if (N !== g) return !1;
    if (!N && !g) {
      let h = l.content, E = n.content;
      const k = h[h.length - 1];
      T.includes(l.type) && i(k) && d(k) && (h = h.slice(0, -1));
...
//# sourceMappingURL=scripture-util-CNXyds_O.js.map
