import { x as h } from "./scripture-util-DArajUVn.js";
import { ae as T, af as V, ag as y, ah as L } from "./scripture-util-DArajUVn.js";
...
function I(o, e, r) {
  ...
  if (e === void 0 || e.includes(t)) {
    ...
    return s === void 0 || u < s ? { book: t, chapterNum: n, verseNum: u + 1 } : n < m(t, r) ? { book: t, chapterNum: n + 1, verseNum: 1 } : a(o, e ?? [], r);
  }
  const i = c(t, e, "next");
  if (i)
