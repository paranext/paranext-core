import { x as h } from "./scripture-util-Df5kpddK.js";
import { ab as V, ac as y, ad as A } from "./scripture-util-Df5kpddK.js";
import { Canon as N } from "@sillsdev/scripture";
function f(o, e) {
  return (e == null ? void 0 : e.getEndChapter(o)) ?? h(N.bookIdToNumber(o));
}
function c(o, e, r) {
...
function B(o, e, r) {
  ...
  if (e === void 0 || e.includes(t)) {
    ...
    return s === void 0 || u < s ? { book: t, chapterNum: n, verseNum: u + 1 } : n < f(t, r) ? { book: t, chapterNum: n + 1, verseNum: 1 } : k(o, e ?? [], r);
  }
  const i = c(t, e, "next");
  if (i)
...
export {
  ...
  C as NAVIGABLE_PROJECT_IDS_WEB_VIEW_STATE_KEY,
  c as findAdjacentPresentBook,
  A as getBookIdsFromBooksPresent,
  E as getNextBookRef,
  k as getNextChapterRef,
  B as getNextVerseRef,
  g as getPreviousBookRef,
  x as getPreviousChapterRef,
  P as getPreviousVerseRef,
  _ as isNavigableProjectIds,
  I as resolveReferenceHistoryDirection
};
