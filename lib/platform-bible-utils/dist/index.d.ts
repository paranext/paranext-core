...
export type MenuColumnWithHeader = OrderedExtensibleContainer & {
	 ...
	 * for assistive technology; a section left on its own, including one left alone by
	 * interface-mode filtering, gets neither a heading nor a name. Give it a real label regardless.
	 * The application menubar ignores this, because there the header is what opens the column.
	 */
