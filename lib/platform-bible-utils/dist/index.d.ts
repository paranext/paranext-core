...
import { indexOf as stringzIndexOf, length as stringzLength, substring as stringzSubstring, toArray as stringzToArray } from 'stringz';
...
export declare const indexOf: typeof stringzIndexOf;
export declare const substring: typeof stringzSubstring;
declare const length$1: typeof stringzLength;
export declare const toArray: typeof stringzToArray;
export declare const padStart: (string: string, targetLength: number, padString?: string) => void;
export declare const padEnd: (string: string, targetLength: number, padString?: string) => void;
export declare const normalize: (string: string, form?: "NFC" | "NFD" | "none") => string;
/**
