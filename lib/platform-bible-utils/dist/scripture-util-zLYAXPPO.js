...
function Be(e, t = 300) {
  ...
  return f.cancel = () => {
    clearTimeout(s), o = void 0, r && (n(new Error(Z)), r = void 0);
  }, f.flush = () => {
    if (o === void 0) return;
    clearTimeout(s);
    const m = o;
...
class i {
  ...
  *[Symbol.iterator]() {
   ...
   */
  substring(t, s) {
    const { length: r } = this.graphemes, a = t === void 0 ? 0 : C(t, r), n = s === void 0 ? r : C(s, r);
   ...
   */
  indexOf(t, s) {
    const r = b(t), a = C(s ?? 0, this.graphemes.length);
   ...
   */
  lastIndexOf(t, s) {
    const r = b(t), { length: a } = this.graphemes, n = s === void 0 ? NaN : Number(s), o = Number.isNaN(n) ? a : C(n, a);
  ...
  startsWith(t, s) {
    const r = b(t);
    if (r === "") return !0;
    const a = this.offsetAt(C(s ?? 0, this.graphemes.length));
  ...
  endsWith(t, s) {
    const r = b(t);
    if (r === "") return !0;
    const { length: a } = this.graphemes, n = this.offsetAt(s === void 0 ? a : C(s, a));
    return this.str.endsWith(r, n) ? this.isBoundary(n - r.length) : !1;
  }
  split(t, s) {
    const r = s === void 0 ? Q : W(s);
    return r === 0 ? [] : t === void 0 ? [this] : te(t) ? this.splitOnRegExp(t, r) : this.splitOnString(b(t), r);
  }
  /**
...
const y = ["chapter", "book", "para", "row", "sidebar", K], ne = "​", M = " ", j = [
...
], oe = 1, he = j.length - 1, ce = 1, le = 1, rt = {
  book: "GEN",
  chapterNum: 1,
  verseNum: 1
}, ue = (e) => {
  var t;
  return ((t = j[e]) == null ? void 0 : t.chapters) ?? -1;
}, at = "", nt = N.allBookIds.filter(
...
function fe(e, t) {
  const s = z(e, t == null ? void 0 : t.optionOrLocalizedBookName), r = (t == null ? void 0 : t.bookChapterSeparator) ?? " ", a = (t == null ? void 0 : t.chapterVerseSeparator) ?? ":";
...
function v(e, t) {
  const s = z(e, t == null ? void 0 : t.optionOrLocalizedBookName), r = me(
    e,
...
function H(e, t, s, r) {
  ...
  if (a && n) {
    ...
    if (o !== h) {
      ...
      if (!O(c.at(-1) ?? "") && !O(m().at(-1) ?? "") || !J(e, t) || !J(s, r) || L(c) !== L(m())) return !1;
    }
  } else if (!a && !n) {
...
//# sourceMappingURL=scripture-util-zLYAXPPO.js.map
