...
var K = (e, t, s) => t in e ? H(e, t, { enumerable: !0, configurable: !0, writable: !0, value: s }) : e[t] = s;
...
import { splitGraphemes as y } from "unicode-segmenter/grapheme";
function Be() {
...
function Ie(e, t = 300) {
  ...
  return m.cancel = () => {
    clearTimeout(s), o = void 0, r && (n(new Error(X)), r = void 0);
  }, m.flush = () => {
    if (o === void 0) return;
    clearTimeout(s);
    const f = o;
...
function Le(e) {
  const t = "Bug in Paratext caused attempted access to Internet. Request has been blocked.", s = "(INTERNET_SERVICES_BLOCKED)", r = U(e);
  return r.includes(t) || r.includes(s);
}
function Je(e) {
  const t = "401 Unauthorized error while getting shared projects.", s = "User registration is not valid. Cannot retrieve resources from DBL.", r = U(e);
  return r.includes(t) || r.includes(s);
}
...
class u {
  ...
  constructor(t) {
     ...
     */
    x(this, "graphemes");
    this.str = t, this.graphemes = t === "" ? [] : Array.from(y(t));
  }
  /**
  ...
  *[Symbol.iterator]() {
   ...
   */
  formatReplacement(t) {
    return this.formatReplacementToArray(t).map(te).join("");
  }
  /**
   ...
   */
  slice(t, s) {
    const { length: r } = this.graphemes, a = t === void 0 ? 0 : w(t, r), n = s === void 0 ? r : w(s, r);
  ...
  split(t, s) {
    const r = s === void 0 ? Q : W(s);
    return r === 0 ? [] : t === void 0 ? [this] : se(t) ? this.splitOnRegExp(t, r) : this.splitOnString(C(t), r);
  }
  /**
  ...
  buildPadding(t, s) {
    ...
    const a = s === void 0 ? " " : `${s}`, n = Array.from(y(a));
...
const T = ["chapter", "book", "para", "row", "sidebar", V], ce = "​", M = " ", F = [
...
], ie = 1, le = F.length - 1, ue = 1, me = 1, it = {
  book: "GEN",
  chapterNum: 1,
  verseNum: 1
}, fe = (e) => {
...
function v(e, t) {
  const s = j(e, t == null ? void 0 : t.optionOrLocalizedBookName), r = ge(
    e,
...
function Ce(e) {
  ...
  for (let a = 0; a < e.length; a += 1) {
    const n = e[a];
    n.charCodeAt(0) < 32 ? (s || (t += " "), s = !0) : !s && n === ce && a + 1 < e.length && P(e[a + 1]) || (P(n) ? (s || (t += n), s = !0) : be(n) && r === n || (t += n, s = !1)), r = n;
  }
  return t;
}
function R(e) {
...
function $(e) {
  return e.split(M).map(Ce).join(M);
}
function z(e, t, s, r) {
  if (!e && !s) return !0;
  if (!e || !s) return !1;
  ...
  if (a && n) {
    ...
    if (o !== h) {
      ...
      if (!O(c.at(-1) ?? "") && !O(f().at(-1) ?? "") || !J(e, t) || !J(s, r) || L(c) !== L(f())) return !1;
    }
  } else if (!a && !n) {
    ...
    const m = R(o.content), f = R(h.content);
    if (m !== f) return !1;
    if (!m && !f) {
      let i = o.content, p = h.content;
      const d = i[i.length - 1];
      T.includes(o.type) && g(d) && O(d) && (i = i.slice(0, -1));
      const A = p[p.length - 1];
      if (T.includes(h.type) && g(A) && O(A) && (p = p.slice(0, -1)), i.length !== p.length) return !1;
...
//# sourceMappingURL=scripture-util-BBnvrJsO.js.map
