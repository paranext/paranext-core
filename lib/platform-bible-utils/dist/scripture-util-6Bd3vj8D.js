...
function Re(e) {
  ...
  return i(e) ? e.includes(t) : _(e).includes(t);
}
function ve(e) {
  const t = "401 Unauthorized error while getting shared projects.", a = "User registration is not valid. Cannot retrieve resources from DBL.", r = i(e) ? e : _(e);
...
function te(e, t, a) {
  if (t < 0) return -1;
  if (a) {
    if (d(e, t) === "}" && d(e, t - 1) === "\\") return t;
    const o = C(e, "\\}", t);
    return o >= 0 ? o + 1 : o;
  }
  let r = t;
  const s = m(e);
  for (; r < s && (r = C(e, "}", r), !(r === -1 || d(e, r - 1) !== "\\")); )
    r += 1;
  return r >= s ? -1 : r;
}
function ae(e, t) {
...
const B = ["chapter", "book", "para", "row", "sidebar", V], ce = "​", F = [
...
], he = 1, me = F.length - 1, fe = 1, Ne = 1, je = {
  book: "GEN",
  chapterNum: 1,
  verseNum: 1
}, ie = (e) => {
...
const Ye = (e, t) => ({
  book: N.bookNumberToId(
    Math.max(
      he,
      Math.min(N.bookIdToNumber(e.book) + t, me)
    )
  ),
  chapterNum: 1,
  verseNum: 1
...
function L(e, t) {
  const a = z(e, t == null ? void 0 : t.optionOrLocalizedBookName), r = Se(
    e,
...
function R(e) {
  ...
  for (let s = 0; s < e.length; s += 1) {
    const o = e[s];
    o.charCodeAt(0) < 32 ? (a || (t += " "), a = !0) : !a && o === ce && s + 1 < e.length && x(e[s + 1]) || (x(o) ? (a || (t += o), a = !0) : Ae(o) && r === o || (t += o, a = !1)), r = o;
  }
  return t;
}
function v(e) {
...
function H(e, t, a, r) {
  ...
  if (s && o) {
    const l = R(e), n = R(a);
    if (l !== n) {
      if (!S(A(l, -1) ?? "") && !S(A(n, -1) ?? "") || !J(e, t) || !J(a, r)) return !1;
      let c = l;
      for (; S(A(c, -1) ?? ""); ) c = M(c, 0, -1);
      let f = n;
      for (; S(A(f, -1) ?? ""); ) f = M(f, 0, -1);
      if (c !== f) return !1;
    }
  } else if (!s && !o) {
    ...
    const f = v(l.content), g = v(n.content);
    if (f !== g) return !1;
    if (!f && !g) {
      let h = l.content, E = n.content;
      const y = h[h.length - 1];
      B.includes(l.type) && i(y) && S(y) && (h = h.slice(0, -1));
      const k = E[E.length - 1];
      if (B.includes(n.type) && i(k) && S(k) && (E = E.slice(0, -1)), h.length !== E.length) return !1;
...
//# sourceMappingURL=scripture-util-6Bd3vj8D.js.map
