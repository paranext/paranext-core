  ...
  function qe(r, u, s, c) {
    ...
    switch (r.nodeType) {
      case z:
        ...
        var kt = !me;
        if (kt && (S || r.namespaceURI === f.HTML) && (kt = h(de)), kt)
          u.push("/>");
        else {
          if (u.push(">"), S && a(de))
            for (; me; )
  ...
  function Lt(r, u, s) {
    ...
    switch (u.childNodes && (c.childNodes = new T()), c.ownerDocument = r, c.nodeType) {
      case z:
        ...
        for (var Ce = 0; Ce < de; Ce++)
          c.setAttributeNode(Lt(r, J.item(Ce), !0));
        break;
      case K:
        s = !0;
    }
    if (s)
      for (var Ee = u.firstChild; Ee; )
        c.appendChild(Lt(r, Ee, s)), Ee = Ee.nextSibling;
    return c;
  }
  function Jt(r, u, s) {
    r[u] = s;
...
function bn() {
  if (ar) return rt;
  ar = 1;
  var t = Dt(), e = Fr(), n = _t(), i = vn(), o = An(), a = e.DOMImplementation, h = t.hasDefaultHTMLNamespace, p = t.isHTMLMimeType, f = t.isValidMimeType, m = t.MIME_TYPE, g = t.NAMESPACE, l = n.ParseError, v = o.XMLReader;
  function O(E) {
    return E.replace(/\r[\n\u0085]/g, `
`).replace(/[\r\u0085\u2028\u2029]/g, `
`);
...
const Ut = ["chapter", "book", "para", "row", "sidebar", $t], Bn = "​", Ur = [
...
], Rn = 1, _n = Ur.length - 1, Pn = 1, Ln = 1, di = {
  book: "GEN",
  chapterNum: 1,
  verseNum: 1
}, kn = (t) => {
  ...
  book: Ne.bookNumberToId(
    Math.max(
      Rn,
      Math.min(Ne.bookIdToNumber(t.book) + e, _n)
    )
  ),
  chapterNum: 1,
  verseNum: 1
...
function gr(t) {
  ...
  for (let o = 0; o < t.length; o += 1) {
    const a = t[o];
    a.charCodeAt(0) < 32 ? (n || (e += " "), n = !0) : !n && a === Bn && o + 1 < t.length && mr(t[o + 1]) || (mr(a) ? (n || (e += a), n = !0) : Un(a) && i === a || (e += a, n = !1)), i = a;
  }
  return e;
}
function Er(t) {
...
function jr(t, e, n, i) {
  ...
  if (o && a) {
    ...
    if (!m && !g) {
      ...
      Ut.includes(h.type) && Me(O) && mt(O) && (l = l.slice(0, -1));
      const N = v[v.length - 1];
      if (Ut.includes(p.type) && Me(N) && mt(N) && (v = v.slice(0, -1)), l.length !== v.length) return !1;
...
var Hn = "__v", Xn = "__o", Jn = "_owner", br = Object.getOwnPropertyDescriptor, Nr = Object.keys;
function Yn(t, e, n) {
  var i = t.length;
  if (e.length !== i)
    return !1;
...
function Du(t) {
  ...
  return function(N, y, U) {
    ...
    if (F === Set)
      return g(N, y, U);
    var j = Eu(N);
    return j === au ? n(N, y, U) : j === pu ? m(N, y, U) : j === cu ? a(N, y, U) : j === hu ? g(N, y, U) : j === fu ? typeof N.then != "function" && typeof y.then != "function" && p(N, y, U) : j === mu ? v(N, y, U) : j === su ? i(N, y, U) : j === iu ? p(N, y, U) : j === ou || j === lu || j === du ? f(N, y, U) : !1;
  };
}
function vu(t) {
...
function Ge(t) {
  ...
  return bu({ circular: n, comparator: f, createState: o, equals: m, strict: h });
}
function yu(t, e) {
  return Nu(t, e);
}
function Cu(t, e) {
  ...
  return Object.keys(n).forEach((a) => {
    o && (Object.hasOwn(i, a) && Cu(i[a], n[a]) || (o = !1));
  }), o;
}
function Sr(t, e, n) {
...
export {
  ...
  Fn as getLocalizeKeyForScrollGroupId,
