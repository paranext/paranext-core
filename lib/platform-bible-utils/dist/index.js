...
import { D as Ht, F as Jt, a as Kt, b as Gt, G as Yt, L as Xt, M as Wt, S as Zt, c as Qt, e as er, f as tr, g as rr, h as nr, j as ir, k as sr, l as ar, m as or, n as cr, o as dr, p as pr, q as lr, r as ur, s as hr, t as fr, u as mr, v as gr, w as yr, x as kr, y as br, z as vr, A as Mr, B as xr, C as _r, E as Er, H as Ir, I as wr, J as Sr, K as Pr, N as Tr, O as Cr, P as Ar, Q as qr, R as $r, T as jr, U as Nr, V as Ur, W as Or, X as Fr, Y as Rr, Z as Dr, _ as Lr, $ as Br, a0 as Vr, a1 as zr, a2 as Hr, a3 as Jr, a4 as Kr, a5 as Gr, a6 as Yr, a7 as Xr, a8 as Wr, a9 as Zr, aa as Qr, ab as en, ac as tn, ad as rn } from "./scripture-util-DArajUVn.js";
...
const Qe = "ABORTED", et = "ALREADY_EXISTS", tt = "CANCELLED", rt = "DATA_LOSS", nt = "DEADLINE_EXCEEDED", it = "FAILED_PRECONDITION", st = "INTERNAL", at = "INVALID_ARGUMENT", ot = "NOT_FOUND", ct = "OUT_OF_RANGE", dt = "PERMISSION_DENIED", pt = "RESOURCE_EXHAUSTED", lt = "UNAUTHENTICATED", ut = "UNAVAILABLE", ht = "UNIMPLEMENTED", ft = "UNKNOWN", q = 1;
function mt(n, e) {
  if (!n)
    return {
      message: "",
...
const yt = (n) => (...e) => n.map((r) => r(...e)).every((r) => r), kt = (n) => async (...e) => {
...
const It = (n) => n.replace(/&/g, "&amp;").replace(/</g, "&lt;").replace(/>/g, "&gt;").replace(/"/g, "&quot;").replace(/'/g, "&#x27;").replace(/\//g, "&#x2F;");
function wt() {
...
function Ee(n) {
  return !!n.fullName && n.fullName !== n.shortName;
}
const Ie = " - ";
function Tt(n) {
...
function Ct(n, e) {
  return n.shortName.localeCompare(e.shortName, void 0, { sensitivity: "base" });
}
function At(n) {
  return typeof n == "string" && n.length > 0 ? n : void 0;
}
const we = 1e3, Q = 60, ee = Q * 60, Se = ee * 24;
function qt(n, e, t = /* @__PURE__ */ new Date()) {
  const r = Math.floor((e.getTime() - t.getTime()) / we), s = Math.round(r / Se);
...
function Lt(n, e, t) {
  ...
  return s.id = `${$e}${t ? `-${t}` : ""}`, s.dataset.themeId = n.id, s.textContent = Ne(n), this.document.head.appendChild(s), s;
}
function ne(n) {
...
USJ: ${JSON.stringify(
  ...
  getInfoForMarker(e, t = "usfm") {
    ...
    if (t === "usfm" && d === "cell" && b.colspan) {
      const u = parseInt(b.colspan, 10), h = Oe.exec(r);
      if (h != null && h[1]) {
  ...
  textContentToUsfm(e) {
    return {
      usfm: this.shouldAllowInvisibleCharacters ? e : e.replace(Ue, "~"),
    ...
    e.map((d) => {
      ...
      if (typeof d.fragment == "object" && "type" in d.fragment) {
        ...
        if (h.type === be && h.code)
          ...
          const f = (m = Fe.exec(h.number)) == null ? void 0 : m[1];
          if (!f)
            console.warn(
...
export {
  ...
  St as formatBytes,
  Tt as formatProjectName,
  $t as formatRelativeDate,
  ...
  jr as newGuid,
  mt as newPlatformError,
  Nr as normalize,
  At as normalizeFullName,
  Pt as normalizeProjectId,
  Ur as normalizeScriptureSpaces,
  Or as offsetBook,
  Fr as offsetChapter,
  Rr as offsetVerse,
  ...
  Ft as recencyMapFromOrderedIds,
  Vr as retryUntil,
  Mt as sanitizeHtml,
