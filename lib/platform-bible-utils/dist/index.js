...
import { D as Jt, F as Kt, a as Gt, b as Yt, G as Xt, L as Wt, M as Zt, S as Qt, c as er, e as tr, f as rr, g as nr, h as ir, j as sr, k as ar, l as or, m as cr, n as dr, o as pr, p as lr, q as ur, r as hr, s as fr, t as mr, u as gr, v as yr, w as kr, x as br, y as vr, z as Mr, A as xr, B as _r, C as Er, E as Ir, H as wr, I as Sr, J as Pr, K as Tr, N as Cr, O as Ar, P as qr, Q as $r, R as jr, T as Nr, U as Ur, V as Or, W as Fr, X as Rr, Y as Dr, Z as Lr, _ as Br, $ as Vr, a0 as zr, a1 as Hr, a2 as Jr, a3 as Kr, a4 as Gr, a5 as Yr, a6 as Xr, a7 as Wr, a8 as Zr, a9 as Qr, aa as en, ab as tn, ac as rn, ad as nn } from "./scripture-util-DArajUVn.js";
...
class he {
  ...
  constructor(e, t) {
    ...
    k(this, "latestOutput");
    k(this, "options");
    k(this, "onDidRebuildEmitter", new ue());
...
class Xe {
  ...
  get(e) {
    ...
    return t || (t = new me(), this.mutexesByID.set(e, t), t);
  }
  /**
...
class Ze {
  ...
  cleanupPromiseChain(e) {
    ...
    if (!t) return;
    const r = { promise: ye }, s = t.catch((i) => this.logger.warn(`Error in promise for ${e}: ${i.message}`)).finally(() => {
...
const Y = 1e4, U = Y / 1e3, X = 3, z = /* @__PURE__ */ new Map(), ke = {
  unsubscribed: {
    ...
    suppressed: (n, e) => `UnsubscriberAsyncList ${n}: ${e} more unsubscribers arrived after the list was run in the last ${U}s and were unsubscribed immediately; per-occurrence warnings suppressed.`
  },
  failed: {
    log: (n) => console.error(n),
    first: (n) => `UnsubscriberAsyncList ${n}: Unsubscriber added after the list was run failed!`,
    suppressed: (n, e) => `UnsubscriberAsyncList ${n}: ${e} more unsubscribers added after the list was run failed in the last ${U}s; per-occurrence errors suppressed.`
  },
  threw: {
    log: (n) => console.error(n),
    ...
    suppressed: (n, e, t) => `UnsubscriberAsyncList ${n}: ${e} more unsubscribers added after the list was run threw in the last ${U}s; per-occurrence errors suppressed. Distinct errors sampled (up to ${X}): ${t.join(" | ")}`
  }
};
function H(n, e, t) {
  const { log: r, first: s, suppressed: i } = ke[e], c = `${n}\0${e}`, p = Date.now(), d = z.get(c);
  if (!d || p >= d.closesAt) {
    r(s(n, t)), z.set(c, {
      closesAt: p + Y,
      suppressedCount: 0,
...
const tt = "ABORTED", rt = "ALREADY_EXISTS", nt = "CANCELLED", it = "DATA_LOSS", st = "DEADLINE_EXCEEDED", at = "FAILED_PRECONDITION", ot = "INTERNAL", ct = "INVALID_ARGUMENT", dt = "NOT_FOUND", pt = "OUT_OF_RANGE", lt = "PERMISSION_DENIED", ut = "RESOURCE_EXHAUSTED", ht = "UNAUTHENTICATED", ft = "UNAVAILABLE", mt = "UNIMPLEMENTED", gt = "UNKNOWN", q = 1;
function yt(n, e) {
  if (!n)
    return {
      message: "",
...
const bt = (n) => (...e) => n.map((r) => r(...e)).every((r) => r), vt = (n) => async (...e) => {
  const t = n.map(async (r) => r(...e));
  return (await Promise.all(t)).every((r) => r);
}, be = "book", J = "chapter", w = "verse", S = "***";
...
function Mt(n) {
  var e;
  return ((e = W[n]) == null ? void 0 : e.type) === a.Paragraph || n === "v";
}
function xt(n) {
  const e = W[n];
...
function xe(n, e) {
  ...
  return Object.keys(t).forEach((i) => {
    s && (Object.hasOwn(r, i) && xe(r[i], t[i]) || (s = !1));
  }), s;
}
function K(n, e, t) {
...
const St = (n) => n.replace(/&/g, "&amp;").replace(/</g, "&lt;").replace(/>/g, "&gt;").replace(/"/g, "&quot;").replace(/'/g, "&#x27;").replace(/\//g, "&#x2F;");
function Pt() {
...
function Ee(n) {
  return !!Se(n.fullName) && n.fullName !== n.shortName;
}
const Ie = " - ";
function At(n) {
  return Ee(n) ? `${n.shortName}${Ie}${n.fullName}` : n.shortName;
}
function we(n, e) {
  return n.localeCompare(e, void 0, { sensitivity: "base" });
}
function qt(n, e) {
  return we(n.shortName, e.shortName);
}
function Se(n) {
  return typeof n == "string" && n.trim().length > 0 ? n : void 0;
}
const Pe = 1e3, Q = 60, ee = Q * 60, Te = ee * 24;
function $t(n, e, t = /* @__PURE__ */ new Date()) {
  const r = Math.floor((e.getTime() - t.getTime()) / Pe), s = Math.round(r / Te);
  if (Math.abs(s) >= 1) return n.format(s, "day");
  const i = Math.round(r / ee);
...
function Bt(n, e, t) {
  ...
  return s.id = `${Ne}${t ? `-${t}` : ""}`, s.dataset.themeId = n.id, s.textContent = Oe(n), this.document.head.appendChild(s), s;
}
function ne(n) {
  return Object.freeze(n), n == null || Object.getOwnPropertyNames(n).forEach(function(t) {
    ...
    n[t] !== null && (typeof n[t] == "object" || typeof n[t] == "function") && !Object.isFrozen(n[t]) && ne(n[t]);
  }), n;
}
const F = ne({
  version: "3.0.7",
...
USJ: ${JSON.stringify(
  ...
  findAllNotes() {
    var e;
    return Me((e = this.usj) == null ? void 0 : e.content);
  }
  /**
  ...
  search(e, t) {
    ...
    for (; f; ) {
      if (f[0].length > 0) {
        ...
        }, N = u ? b.substring(y, M) : f[0];
        i.push({ text: N, start: v, end: I });
      }
      if (!e.global) break;
      f = e.exec(h);
    }
...
`);
    ...
    return s.push({ fragment: e, indexInUsfm: r.length }), r += p === "optbreak" ? "//" : `\\${b}`, p !== "optbreak" && (s.push({
      ...
      s.push({
        ...
        if ("isClosingMarker" in v.fragment) {
          const { isClosingMarker: x, ...I } = v.fragment, N = {
            ...I,
            forMarker: e,
  ...
  closingMarkerToUsfm(e, t) {
    const {
      ...
      var y, M;
      return !(f === "type" || f === "marker" || f === "content" || f === "closed" || (y = p.skipOutputAttributeToUsfm) != null && y.includes(f) || (M = i.leadingAttributes) != null && M.includes(f) || i.textContentAttribute === f || d.some(
...
`) && (i.length === 0 ? (p = p.map((u) => ({
 ...
 `);
  ...
  static areUsjDocumentLocationsEqual(e, t, r = !1) {
    ...
    return !r && !O(P.toPathArray(s), P.toPathArray(c)) ? !1 : O(i, p);
  }
   ...
   *   do.
   */
  static transferFragmentsInfoArrayToMaps(e, t, r, s, i, c) {
    e.map((d) => {
      var m, b, u;
      if (typeof d.fragment == "object" && "type" in d.fragment) {
        ...
        if (h.type === be && h.code)
        ...
        else if (h.type === J && h.number) {
          const f = parseInt(h.number, 10);
          if (Number.isNaN(f))
            console.warn(
              `Found ${J} type marker with number ${h.number}, but could not parse chapter number from it. Continuing using previous chapter number ${r.chapterNum}`
            );
          else {
          ...
          const f = (m = De.exec(h.number)) == null ? void 0 : m[1];
          if (!f)
            console.warn(
...
export {
  ...
  Jt as DEBOUNCE_CANCELED_ERROR_MESSAGE,
  pe as DateTimeFormat,
  he as DocumentCombiner,
  Ye as EventRollingTimeCounter,
  at as FAILED_PRECONDITION,
  Kt as FIRST_SCR_BOOK_NUM,
  Gt as FIRST_SCR_CHAPTER_NUM,
  Yt as FIRST_SCR_VERSE_NUM,
  Xt as GraphemeString,
  ot as INTERNAL,
  ct as INVALID_ARGUMENT,
  Wt as LAST_SCR_BOOK_NUM,
  Zt as MAX_PADDING_LENGTH,
  Nt as MODIFIER_KEYS,
  a as MarkerType,
  me as Mutex,
  Xe as MutexMap,
  ...
  Ie as PROJECT_NAME_SEPARATOR,
  $ as PROJECT_SELECTOR_CUSTOM_DATA_KEYS,
  ue as PlatformEventEmitter,
  Ze as PromiseChainingMap,
  ut as RESOURCE_EXHAUSTED,
  Qt as SELECTABLE_INVISIBLE_CHAR_OR_WHITESPACE_CLASS,
  er as Section,
  V as SortedNumberMap,
  Qe as SortedSet,
  Ne as THEME_STYLE_ELEMENT_ID,
  ht as UNAUTHENTICATED,
  ft as UNAVAILABLE,
  mt as UNIMPLEMENTED,
  gt as UNKNOWN,
  F as USFM_MARKERS_MAP_3_0,
  Vt as USFM_MARKERS_MAP_PARATEXT_3_0,
  et as UnsubscriberAsyncList,
  g as UsjReaderWriter,
  w as VERSE_TYPE,
  vt as aggregateUnsubscriberAsyncs,
  bt as aggregateUnsubscribers,
  Bt as applyThemeStylesheet,
  tr as areUsjContentsEqualExceptWhitespace,
  rr as at,
  nr as charAt,
  ir as codePointAt,
  sr as collapseMiddleWords,
  ar as collectUsjMarkers,
  we as compareProjectShortNames,
  qt as compareProjectsByName,
  or as compareScrRefs,
  Ot as computeEffectiveStructureProtection,
  cr as createSyncProxyForAsyncObject,
  dr as debounce,
  C as deepClone,
  O as deepEqual,
  pr as defaultScrRef,
  _e as deserialize,
  Dt as doesCatalogRowCoverProject,
  lr as endsWith,
  ur as ensureArray,
  hr as escapeStringRegexp,
  Lt as expandThemeContribution,
  Tt as formatBytes,
  At as formatProjectName,
  jt as formatRelativeDate,
  fr as formatReplacementString,
  mr as formatReplacementStringToArray,
  gr as formatScrRef,
  yr as formatScrRefRange,
  $t as formatTimeSpan,
  kr as getAllObjectFunctionNames,
  br as getChaptersForBook,
  ...
  Mr as getLocalizeKeyForScrollGroupId,
  xr as getLocalizeKeysForScrollGroupIds,
  _r as getLocalizedIdFromBookNumber,
  ve as getNthCaller,
  It as getPaneSizeLimits,
  Er as getSectionForBook,
  Oe as getStylesheetForTheme,
  Ir as groupBy,
  Ee as hasDistinctFullName,
  St as htmlEncode,
  wr as includes,
  Sr as indexOf,
  Mt as isBlockMarker,
  xt as isCharacterMarker,
  Pr as isErrorMessageAboutParatextBlockingInternetAccess,
  Tr as isErrorMessageAboutRegistryAuthFailure,
  Cr as isLocalizeKey,
  kt as isPlatformError,
  Ar as isSelectableInvisibleCharOrWhiteSpace,
  wt as isSerializable,
  _ as isString,
  xe as isSubset,
  qr as isWhiteSpace,
  $r as isolateBidi,
  jr as lastIndexOf,
  qe as localizedStringsDocumentSchema,
  Ft as makeProjectSelectorCustomData,
  $e as menuDocumentSchema,
  Nr as newGuid,
  yt as newPlatformError,
  Ur as normalize,
  Se as normalizeFullName,
  Ct as normalizeProjectId,
  Or as normalizeScriptureSpaces,
  Fr as offsetBook,
  Rr as offsetChapter,
  Dr as offsetVerse,
  Lr as ordinalCompare,
  Br as padEnd,
  Vr as padStart,
  Ce as projectSettingsDocumentSchema,
  Rt as recencyMapFromOrderedIds,
  zr as retryUntil,
  _t as sanitizeHtml,
  Hr as scrRefToBBBCCC,
  Jr as scrRefToBBBCCCVVV,
  K as serialize,
  Ae as settingsDocumentSchema,
  Kr as slice,
  Gr as split,
  Yr as startsWith,
  Xr as stringLength,
  Wr as substring,
  je as themeDocumentSchema,
  Zr as toArray,
  Qr as toKebabCase,
  en as transformAndEnsureRegExpArray,
  tn as transformAndEnsureRegExpRegExpArray,
  W as usfmMarkers,
  rn as wait,
