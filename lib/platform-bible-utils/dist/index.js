...
var Jr = (t, e, n) => e in t ? Xr(t, e, { enumerable: !0, configurable: !0, writable: !0, value: n }) : t[e] = n;
...
var an = Object.defineProperty, sn = (t, e, n) => e in t ? an(t, e, { enumerable: !0, configurable: !0, writable: !0, value: n }) : t[e] = n, G = (t, e, n) => sn(t, typeof e != "symbol" ? e + "" : e, n);
const it = [
  "GEN",
  "EXO",
  "LEV",
...
const De = class Y {
  ...
  static fromJSON(e) {
    ...
    let f;
    return p && (f = new nt(p)), n ? new Y(n, i.toString(), h, f) : new Y();
  }
  /**
...
function Dt() {
  ...
  tr = 1;
  function t(B, k, j) {
    if (j === void 0 && (j = Array.prototype), B && typeof j.find == "function")
      return j.find.call(B, k);
    for (var ne = 0; ne < B.length; ne++)
      if (n(B, ne)) {
        var le = B[ne];
        if (k.call(void 0, le, ne, B))
          return le;
      }
  }
  function e(B, k) {
    return k === void 0 && (k = Object), k && typeof k.getOwnPropertyDescriptors == "function" && (B = k.create(null, k.getOwnPropertyDescriptors(B))), k && typeof k.freeze == "function" ? k.freeze(B) : B;
  }
  function n(B, k) {
  ...
  function v(B) {
    return l(B) || B === O.XML_XHTML_APPLICATION;
  }
  var O = e({
    /**
  ...
  }), b = Object.keys(O).map(function(B) {
    return O[B];
  });
  function C(B) {
...
function _t() {
  ...
  for (var h = {
    ...
    DATA_CLONE_ERR: 25
  }, f = Object.entries(h), m = 0; m < f.length; m++) {
    var E = f[m][0];
    p[E] = f[m][1];
  }
  function l(v, O) {
...
function Fr() {
  ...
  function i(ue, pe) {
    ...
    if (ue.source.indexOf(pe) === -1)
      throw new Error('"' + pe + '" is not is /' + ue.source + "/");
    if (pe === "-" && ue.source.indexOf(pe) !== 1)
      throw new Error('"' + pe + '" is not at the first postion of /' + ue.source + "/");
    return new RegExp(ue.source.replace(pe, ""), e ? "u" : "");
  }
  function o(ue) {
    var pe = this;
    return new RegExp(
  ...
  var O = n(v), b = o("[", O, n(/[-.0-9\xB7]/), n(/[\u0300-\u036F\u203F-\u2040]/), "]"), C = o(v, b, "*"), $ = o(b, "+"), B = o("&", C, ";"), k = a(/&#[0-9]+;|&#x[0-9a-fA-F]+;/), j = a(B, "|", k), ne = o("%", C, ";"), le = a(
    o('"', a(/[^%&"]/, "|", ne, "|", j), "*", '"'),
    "|",
    o("'", a(/[^%&']/, "|", ne, "|", j), "*", "'")
  ), g = a('"', a(/[^<&"]/, "|", j), "*", '"', "|", "'", a(/[^<&']/, "|", j), "*", "'"), x = i(v, ":"), F = i(b, ":"), z = o(x, F, "*"), K = o(z, a(":", z), "?"), ee = o("^", K, "$"), Ie = o("(", K, ")"), te = a(/"[^"]*"|'[^']*'/), Re = o(/^<\?/, "(", C, ")", a(E, "(", h, "*?)"), "?", /\?>/), d = /[\x20\x0D\x0Aa-zA-Z0-9-'()+,./:=?;!*#@$_%]/, N = a('"', d, '*"', "|", "'", i(d, "'"), "*'"), w = "<!--", y = "-->", M = o(w, a(i(h, "-"), "|", o("-", i(h, "-"))), "*", y), A = "#PCDATA", R = a(
    o(/\(/, l, A, a(l, /\|/, l, K), "*", l, /\)\*/),
    "|",
    o(/\(/, l, A, l, /\)/)
  ), X = /[?*+]?/, _ = o(
  ...
  ), T = a("EMPTY", "|", "ANY", "|", R, "|", _), I = "<!ELEMENT", L = o(I, E, a(K, "|", ne), E, a(T, "|", ne), l, ">"), V = o("NOTATION", E, /\(/, l, C, a(l, /\|/, l, C), "*", l, /\)/), fe = o(/\(/, l, $, a(l, /\|/, l, $), "*", l, /\)/), we = a(V, "|", fe), ve = a(/CDATA|ID|IDREF|IDREFS|ENTITY|ENTITIES|NMTOKEN|NMTOKENS/, "|", we), ie = a(/#REQUIRED|#IMPLIED/, "|", a(a("#FIXED", E), "?", g)), P = a(E, C, E, ve, E, ie), je = "<!ATTLIST", Be = o(je, E, C, P, "*", l, ">"), he = "about:legacy-compat", Ve = a('"' + he + '"', "|", "'" + he + "'"), _e = "SYSTEM", Se = "PUBLIC", Fe = a(a(_e, E, te), "|", a(Se, E, N, E, te)), He = o(
    "^",
    a(
  ...
  ), Xe = a(E, "NDATA", E, C), Ce = a(le, "|", a(Fe, Xe, "?")), Q = "<!ENTITY", ze = o(Q, E, C, E, Ce, l, ">"), oe = a(le, "|", Fe), Je = o(Q, E, "%", E, C, E, oe, l, ">"), vt = a(ze, "|", Je), Ye = o(Se, E, N), We = o("<!NOTATION", E, C, E, a(Fe, "|", Ye), l, ">"), q = o(l, "=", l), Z = /1[.]\d+/, Ae = o(E, "version", q, a("'", Z, "'", "|", '"', Z, '"')), Ne = /[A-Za-z][-A-Za-z0-9._]*/, Ke = a(E, "encoding", q, a('"', Ne, '"', "|", "'", Ne, "'")), st = a(E, "standalone", q, a("'", a("yes", "|", "no"), "'", "|", '"', a("yes", "|", "no"), '"')), ct = o(/^<\?xml/, Ae, Ke, "?", st, "?", l, /\?>/), lt = "<!DOCTYPE", At = "<![CDATA[", Nt = "]]>", ft = /<!\[CDATA\[/, Qe = /\]\]>/, ht = o(h, "*?", Qe), Ot = o(ft, ht);
  return U.chars = n, U.chars_without = i, U.detectUnicodeSupport = t, U.reg = o, U.regg = a, U.ABOUT_LEGACY_COMPAT = he, U.ABOUT_LEGACY_COMPAT_SystemLiteral = Ve, U.AttlistDecl = Be, U.CDATA_START = At, U.CDATA_END = Nt, U.CDSect = Ot, U.Char = h, U.Comment = M, U.COMMENT_START = w, U.COMMENT_END = y, U.DOCTYPE_DECL_START = lt, U.elementdecl = L, U.EntityDecl = vt, U.EntityValue = le, U.ExternalID = Fe, U.ExternalID_match = He, U.Name = C, U.NotationDecl = We, U.Reference = j, U.PEReference = ne, U.PI = Re, U.PUBLIC = Se, U.PubidLiteral = N, U.QName = K, U.QName_exact = ee, U.QName_group = Ie, U.S = E, U.SChar_s = m, U.S_OPT = l, U.SYSTEM = _e, U.SystemLiteral = te, U.UNICODE_REPLACEMENT_CHARACTER = p, U.UNICODE_SUPPORT = e, U.XMLDecl = ct, U;
}
var ur;
function kr() {
  if (ur) return re;
  ur = 1;
  var t = Dt(), e = t.find, n = t.hasDefaultHTMLNamespace, i = t.hasOwn, o = t.isHTMLMimeType, a = t.isHTMLRawTextElement, p = t.isHTMLVoidElement, h = t.MIME_TYPE, f = t.NAMESPACE, m = Symbol(), E = _t(), l = E.DOMException, v = E.DOMExceptionName, O = Fr();
  function b(r) {
    if (r !== m)
  ...
  var F = {}, z = F.ELEMENT_NODE = 1, K = F.ATTRIBUTE_NODE = 2, ee = F.TEXT_NODE = 3, Ie = F.CDATA_SECTION_NODE = 4, te = F.ENTITY_REFERENCE_NODE = 5, Re = F.ENTITY_NODE = 6, d = F.PROCESSING_INSTRUCTION_NODE = 7, N = F.COMMENT_NODE = 8, w = F.DOCUMENT_NODE = 9, y = F.DOCUMENT_TYPE_NODE = 10, M = F.DOCUMENT_FRAGMENT_NODE = 11, A = F.NOTATION_NODE = 12, R = t.freeze({
  ...
  function X(r, u) {
    if (u.length < r.length) return X(u, r);
    var s = null;
    for (var c in r) {
      if (r[c] !== u[c]) return s;
      s = r[c];
  ...
  function L(r) {
    ...
    if (r._inc !== u) {
      ...
      if (Jt(r, "length", s.length), !r.$$length || s.length < r.$$length)
  ...
  ie.prototype = {
    ...
    createHTMLDocument: function(r) {
      var u = new he(m, { contentType: h.HTML });
  ...
  P.prototype = {
    ...
    compareDocumentPosition: function(r) {
      ...
      if (u instanceof Ae && (c = u, u = c.ownerElement), s instanceof Ae && (D = s, s = D.ownerElement, c && u && s === u))
        for (var S = 0, J; J = s.attributes[S]; S++) {
          if (J === c)
      ...
      if (!u || !s || s.ownerDocument !== u.ownerDocument)
        return R.DOCUMENT_POSITION_DISCONNECTED + R.DOCUMENT_POSITION_IMPLEMENTATION_SPECIFIC + (_(s.ownerDocument) > _(u.ownerDocument) ? R.DOCUMENT_POSITION_FOLLOWING : R.DOCUMENT_POSITION_PRECEDING);
      if (D && u === s)
      ...
      for (var Ue in Ze.childNodes) {
        ...
        if (Oe === u) return R.DOCUMENT_POSITION_PRECEDING;
        if (ye.indexOf(Oe) >= 0) return R.DOCUMENT_POSITION_FOLLOWING;
  ...
  g(F, P), g(F, P.prototype), g(R, P), g(R, P.prototype);
  function Be(r, u) {
    if (u(r))
      return !0;
    if (r = r.firstChild)
  ...
  function vt(r, u, s) {
    ...
    if (
      ...
      !Xe(u) || // 5. If either `node` is a Text node and `parent` is a document,
  ...
  function q(r, u, s, c) {
    ...
    S.previousSibling = ae, J.nextSibling = s, ae ? ae.nextSibling = S : r.firstChild = S, s == null ? r.lastChild = J : s.previousSibling = J;
    do
      S.parentNode = r;
    while (S !== J && (S = S.nextSibling));
  ...
  he.prototype = {
    ...
    getElementById: function(r) {
      var u = null;
      return Be(this.documentElement, function(s) {
  ...
  Z.prototype = {
    ...
    getElementsByClassName: function(r) {
      ...
      return new I(this, function(s) {
        var c = [];
        return u.length > 0 && Be(s, function(D) {
          if (D !== s && D.nodeType === z) {
    ...
    getElementsByTagName: function(r) {
      ...
      return new I(this, function(c) {
        var D = [];
        return Be(c, function(S) {
          if (!(S === c || S.nodeType !== z))
            if (r === "*")
              D.push(S);
            else {
              var J = S.getQualifiedName(), ae = u && S.namespaceURI === f.HTML ? s : r;
              J === ae && D.push(S);
            }
        }), D;
      });
    ...
    getElementsByTagNameNS: function(r, u) {
      return new I(this, function(s) {
        var c = [];
        return Be(s, function(D) {
          D !== s && D.nodeType === z && (r === "*" || D.namespaceURI === r) && (u === "*" || D.localName == u) && c.push(D);
        }), c;
      });
    }
  }, he.prototype.getElementsByClassName = Z.prototype.getElementsByClassName, he.prototype.getElementsByTagName = Z.prototype.getElementsByTagName, he.prototype.getElementsByTagNameNS = Z.prototype.getElementsByTagNameNS, x(Z, P);
  function Ae(r) {
  ...
  Nt.prototype.nodeType = Re, x(Nt, P);
  function ft(r) {
    b(r);
  }
  ...
  ht.prototype.nodeType = d, x(ht, Ne);
  function Ot() {
  }
  ...
  function qe(r, u, s, c) {
    ...
    switch (r.nodeType) {
      case z:
        var J = r.attributes, ae = J.length, me = r.firstChild, de = r.tagName, ye = de;
        if (!S && !r.prefix && r.namespaceURI) {
          for (var ge, Ze = 0; Ze < J.length; Ze++)
            if (J.item(Ze).name === "xmlns") {
              ge = J.item(Ze).value;
              break;
            }
          if (!ge)
        ...
        var Ft = !me;
        if (Ft && (S || r.namespaceURI === f.HTML) && (Ft = p(de)), Ft)
          u.push("/>");
        else {
          if (u.push(">"), S && a(de))
            for (; me; )
      ...
      case ee:
        return u.push(r.data.replace(/[<&>]/g, je));
      case Ie:
  ...
  function Xt(r, u, s) {
    ...
    if (c || (c = u.cloneNode(!1)), c.ownerDocument = r, c.parentNode = null, s)
      for (var D = u.firstChild; D; )
        c.appendChild(Xt(r, D, s)), D = D.nextSibling;
    return c;
  }
  function Lt(r, u, s) {
    ...
    switch (u.childNodes && (c.childNodes = new T()), c.ownerDocument = r, c.nodeType) {
      case z:
        var J = u.attributes, ae = c.attributes = new V(), de = J.length;
        ae._ownerElement = c;
        for (var ye = 0; ye < de; ye++)
          c.setAttributeNode(Lt(r, J.item(ye), !0));
        break;
      case K:
        s = !0;
    }
  ...
  return re._updateLiveList = L, re.Attr = Ae, re.CDATASection = ct, re.CharacterData = Ne, re.Comment = st, re.Document = he, re.DocumentFragment = Qe, re.DocumentType = lt, re.DOMImplementation = ie, re.Element = Z, re.Entity = Nt, re.EntityReference = ft, re.LiveNodeList = I, re.NamedNodeMap = V, re.Node = P, re.NodeList = T, re.Notation = At, re.Text = Ke, re.ProcessingInstruction = ht, re.XMLSerializer = Ot, re;
}
var rt = {}, kt = {}, ir;
function vn() {
...
function An() {
  if (or) return yt;
  or = 1;
  var t = Dt(), e = Fr(), n = _t(), i = t.isHTMLEscapableRawTextElement, o = t.isHTMLMimeType, a = t.isHTMLRawTextElement, p = t.hasOwn, h = t.NAMESPACE, f = n.ParseError, m = n.DOMException, E = 0, l = 1, v = 2, O = 3, b = 4, C = 5, $ = 6, B = 7;
  function k() {
  }
  k.prototype = {
    parse: function(d, N, w) {
      var y = this.domBuilder;
      y.startDocument(), z(N, N = /* @__PURE__ */ Object.create(null)), ne(d, N, w, y, this.errorHandler), y.endDocument();
    }
  };
  var j = /&#?\w+;?/g;
  function ne(d, N, w, y, M) {
    ...
    function X(q) {
      ...
      var Ne = Z.slice(1, -1);
      return p(w, Ne) ? w[Ne] : Ne.charAt(0) === "#" ? R(parseInt(Ne.substring(1).replace("x", "0x"))) : (M.error("entity not found:" + q), q);
    }
    function _(q) {
      if (q > ie) {
        var Z = d.substring(ie, q).replace(j, X);
      ...
      try {
        ...
        if (P < 0) {
          ...
          if (!d.substring(ie).match(/^\s*$/)) {
            var je = y.doc, Be = je.createTextNode(d.substring(ie));
            if (je.documentElement)
              return M.error("Extra content at the end of the document");
            je.appendChild(Be), y.currentElement = Be;
          }
          return;
        }
        if (P > ie) {
          var he = d.substring(ie, P);
          !A && ve.length === 0 && (he = he.replace(new RegExp(e.S_OPT.source, "g"), ""), he && M.error("Unexpected content outside root element: '" + he + "'")), _(P);
        }
        switch (d.charAt(P + 1)) {
          case "/":
            ...
            if (y.endElement(He.uri, He.localName, Se), Xe)
              for (var Ce in Xe)
                p(Xe, Ce) && y.endPrefixMapping(Ce);
            oe++;
            break;
          // end element
          case "?":
          ...
          default:
            V && fe(P);
            var Q = new Re(), ze = we[we.length - 1].currentNSMap, oe = g(d, P, Q, ze, X, M, A), Je = Q.length;
            if (Q.closed || (A && t.isHTMLVoidElement(Q.tagName) ? Q.closed = !0 : ve.push(Q.tagName)), V && Je) {
              for (var vt = le(V, {}), Ye = 0; Ye < Je; Ye++) {
                var We = Q[Ye];
                fe(We.offset), We.locator = le(V, {});
              }
              y.locator = vt, x(Q, y, ze) && we.push(Q), y.locator = V;
            } else
              x(Q, y, ze) && we.push(Q);
            A && !Q.closed ? oe = F(d, oe, Q.tagName, X, y) : oe++;
        }
      } catch (q) {
        if (q instanceof f)
          throw q;
  ...
  function g(d, N, w, y, M, A, R) {
    function X(fe, we, ve) {
      if (p(w.attributeNames, fe))
      ...
      switch (V) {
        ...
        case '"':
          if (L === O || L === l)
            if (L === l && (A.warning('attribute value must after "="'), _ = d.slice(N, I)), N = I + 1, I = d.indexOf(V, N), I > 0)
              T = d.slice(N, I), X(_, T, N - 1), L = C;
            else
              throw new Error("attribute value no end '" + V + "' match");
          else if (L == b)
            T = d.slice(N, I), X(_, T, N), A.warning('attribute "' + _ + '" missed start quot(' + V + ")!!"), N = I + 1, L = C;
          else
        ...
        case ">":
          switch (L) {
            ...
            case v:
              L === v && (T = _), L == b ? (A.warning('attribute "' + T + '" missed quot(")!'), X(_, T, N)) : (R || A.warning('attribute "' + T + '" missed value!! "' + T + '" instead!!'), X(T, T, N));
              break;
            case O:
              if (!R)
        ...
        default:
          if (V <= " ")
            switch (L) {
              ...
              case b:
                var T = d.slice(N, I);
                A.warning('attribute "' + T + '" missed quot(")!!'), X(_, T, N);
              case C:
                L = $;
                break;
            }
  ...
  function x(d, N, w) {
    for (var y = d.tagName, M = null, L = d.length; L--; ) {
      var A = d[L], R = A.qName, X = A.value, V = R.indexOf(":");
      if (V > 0)
        var _ = A.prefix = R.slice(0, V), T = R.slice(V + 1), I = _ === "xmlns" && T;
      else
        T = R, _ = null, I = R === "xmlns" && "";
      A.localName = T, I !== !1 && (M == null && (M = /* @__PURE__ */ Object.create(null), z(w, w = /* @__PURE__ */ Object.create(null))), w[I] = M[I] = X, A.uri = h.XMLNS, N.startPrefixMapping(I, X));
    }
    for (var L = d.length; L--; )
      A = d[L], A.prefix && (A.prefix === "xml" && (A.uri = h.XML), A.prefix !== "xmlns" && (A.uri = w[A.prefix]));
    var V = y.indexOf(":");
  ...
  function F(d, N, w, y, M) {
    var A = i(w);
    if (A || a(w)) {
      var R = d.indexOf("</" + w + ">", N), X = d.substring(N + 1, R);
      return A && (X = X.replace(j, y)), M.characters(X, 0, X.length), R;
    }
    return N + 1;
  }
  function z(d, N) {
...
` && L !== "	" && L !== "\r")
  ...
  function ee(d, N) {
    function w(X, _) {
      var T = e.PI.exec(X.substringFromIndex());
      ...
      ) : (X.skip(T[0].length), T[0]) : _.fatalError("processing instruction is not well-formed at position " + X.getIndex());
    }
    var y = d.getSource();
    if (d.char() === "[") {
      d.skip(1);
      for (var M = d.getIndex(); d.getIndex() < y.length; ) {
        ...
        if (d.char() === "<" && d.char(1) === "!")
          switch (d.char(2)) {
            case "E":
              d.char(3) === "L" ? R = d.getMatch(e.elementdecl) : d.char(3) === "N" && (R = d.getMatch(e.EntityDecl));
              break;
            case "A":
              R = d.getMatch(e.AttlistDecl);
              break;
            case "N":
              R = d.getMatch(e.NotationDecl);
              break;
            case "-":
              R = d.getMatch(e.Comment);
              break;
          }
        else if (d.char() === "<" && d.char(1) === "?")
          R = w(d, N);
        else if (d.char() === "%")
          R = d.getMatch(e.PEReference);
        else
  ...
  function Ie(d, N, w, y, M) {
    ...
    switch (M ? A.char(2).toUpperCase() : A.char(2)) {
      case "-":
        ...
        return R ? (w.comment(R, e.COMMENT_START.length, R.length - e.COMMENT_START.length - e.COMMENT_END.length), A.getIndex()) : y.fatalError("comment is not well-formed at position " + A.getIndex());
      case "[":
        var X = A.getMatch(e.CDSect);
        return X ? !M && !w.currentElement ? y.fatalError("CDATA outside of element") : (w.startCDATA(), w.characters(X, e.CDATA_START.length, X.length - e.CDATA_START.length - e.CDATA_END.length), w.endCDATA(), A.getIndex()) : y.fatalError("Invalid CDATA starting at position " + N);
      case "D": {
...
function Nn() {
  if (ar) return rt;
  ar = 1;
  var t = Dt(), e = kr(), n = _t(), i = vn(), o = An(), a = e.DOMImplementation, p = t.hasDefaultHTMLNamespace, h = t.isHTMLMimeType, f = t.isValidMimeType, m = t.MIME_TYPE, E = t.NAMESPACE, l = n.ParseError, v = o.XMLReader;
  function O(g) {
    return g.replace(/\r[\n\u0085]/g, `
`).replace(/[\r\u0085\u2028\u2029]/g, `
`);
  ...
  b.prototype.parseFromString = function(g, x) {
    ...
    var F = this.assign(/* @__PURE__ */ Object.create(null), this.xmlns), z = i.XML_ENTITIES, K = F[""] || null;
    p(x) ? (z = i.HTML_ENTITIES, K = E.HTML) : x === m.XML_SVG_IMAGE && (K = E.SVG), F[""] = K, F.xml = F.xml || E.XML;
    ...
    var Re = !t.isHTMLMimeType(x);
    return Re && typeof g != "string" && te.errorHandler.fatalError("source is not a string"), te.parse(this.normalizeLineEndings(String(g)), F, z), ee.doc.documentElement || te.errorHandler.fatalError("missing root element"), ee.doc;
  };
  function C(g) {
    var x = g || {};
  ...
  C.prototype = {
    ...
    startElement: function(g, x, F, z) {
      var K = this.doc, ee = K.createElementNS(g, F || x), Ie = z.length;
      j(this, ee), this.currentElement = ee, this.locator && $(this.locator, ee);
      for (var te = 0; te < Ie; te++) {
        var g = z.getURI(te), Re = z.getValue(te), F = z.getQName(te), d = K.createAttributeNS(g, F);
        this.locator && $(z.getLocator(te), d), d.value = d.nodeValue = Re, ee.setAttributeNode(d);
      }
    },
    ...
    processingInstruction: function(g, x) {
      ...
      this.locator && $(this.locator, F), j(this, F);
    },
    ...
    characters: function(g, x, F) {
      if (g = k.apply(this, arguments), g) {
        if (this.cdata)
          var z = this.doc.createCDATASection(g);
        else
          var z = this.doc.createTextNode(g);
        this.currentElement ? this.currentElement.appendChild(z) : /^\s*$/.test(g) && this.doc.appendChild(z), this.locator && $(this.locator, z);
      }
    },
    ...
    comment: function(g, x, F) {
      ...
      var z = this.doc.createComment(g);
      this.locator && $(this.locator, z), j(this, z);
    },
    startCDATA: function() {
      this.cdata = !0;
    },
    ...
    startDTD: function(g, x, F, z) {
      var K = this.doc.implementation;
      if (K && K.createDocumentType) {
        var ee = K.createDocumentType(g, x, F, z);
        this.locator && $(this.locator, ee), j(this, ee), this.doc.doctype = ee;
      }
    },
...
function Cn() {
  return cr || (cr = 1, qt = () => {
    const t = "\\ud800-\\udfff", p = "\\u0300-\\u036f" + "\\ufe20-\\ufe2f" + "\\u20d0-\\u20ff" + "\\u1ab0-\\u1aff" + "\\u1dc0-\\u1dff", h = "\\ufe0e\\ufe0f", f = "\\uD83D\\uDC69\\uD83C\\uDFFB\\u200D\\uD83C\\uDF93", m = `[${t}]`, E = `[${p}]`, l = "\\ud83c[\\udffb-\\udfff]", v = `(?:${E}|${l})`, O = `[^${t}]`, b = "(?:\\uD83C[\\uDDE6-\\uDDFF]){2}", C = "[\\ud800-\\udbff][\\udc00-\\udfff]", $ = "\\u200d", B = "(?:\\ud83c\\udff4\\udb40\\udc67\\udb40\\udc62\\udb40(?:\\udc65|\\udc73|\\udc77)\\udb40(?:\\udc6e|\\udc63|\\udc6c)\\udb40(?:\\udc67|\\udc74|\\udc73)\\udb40\\udc7f)", k = `[${f}]`, j = `${v}?`, ne = `[${h}]?`, le = `(?:${$}(?:${[O, b, C].join("|")})${ne + j})*`, g = ne + j + le, F = `(?:${[`${O}${E}?`, E, b, C, m, k].join("|")})`;
    return new RegExp(`${B}|${l}(?=${l})|${F + g}`, "g");
  }), qt;
}
var lr;
function yn() {
...
function Sn(t, e) {
  ...
  function a(h, f, m) {
    ...
    Me(h) ? n.push(`${l}${h}`) : (l && n.push(l), n.push(h)), o = f + m;
  }
  const p = ce(t);
  for (; i < p; ) {
    switch (Et(t, i)) {
      case "{":
        if (Et(t, i - 1) !== "\\") {
          const h = wn(t, i, !1);
          if (h >= 0) {
            const f = ut(t, i + 1, h), m = f in e ? (
              // Just checked that the key is in the object
              // eslint-disable-next-line no-type-assertion/no-type-assertion
              e[f]
            ) : f;
            a(m, i, h + 1 - i), i = h, o = h + 1;
          }
        } else
          a("{", i - 1, 2);
        break;
...
function pr(t, e, n) {
  ...
  for (let h = 0; h < (n ? n - 1 : a.length); h++) {
    const f = St(t, a[h], p), m = ce(a[h]);
    if (i.push(ut(t, p, f)), p = f + m, n !== void 0 && i.length === n)
      break;
  }
...
const $t = ["chapter", "book", "para", "row", "sidebar", Ut], Rn = "​", $r = [
...
], Bn = 1, _n = $r.length - 1, Pn = 1, Ln = 1, hi = {
  book: "GEN",
  chapterNum: 1,
  verseNum: 1
}, Fn = (t) => {
...
function Er(t) {
  ...
  for (let o = 0; o < t.length; o += 1) {
    const a = t[o];
    a.charCodeAt(0) < 32 ? (n || (e += " "), n = !0) : !n && a === Rn && o + 1 < t.length && mr(t[o + 1]) || (mr(a) ? (n || (e += a), n = !0) : $n(a) && i === a || (e += a, n = !1)), i = a;
  }
  return e;
}
function gr(t) {
...
function jr(t, e, n, i) {
  ...
  if (o && a) {
    ...
    const m = gr(p.content), E = gr(h.content);
    if (m !== E) return !1;
    if (!m && !E) {
      let l = p.content, v = h.content;
      const O = l[l.length - 1];
      $t.includes(p.type) && Me(O) && mt(O) && (l = l.slice(0, -1));
      const b = v[v.length - 1];
      if ($t.includes(h.type) && Me(b) && mt(b) && (v = v.slice(0, -1)), l.length !== v.length) return !1;
...
const bi = (t) => (...e) => t.map((i) => i(...e)).every((i) => i), Ci = (t) => async (...e) => {
  const n = t.map(async (i) => i(...e));
  return (await Promise.all(n)).every((i) => i);
}, Mt = "chapter", Rt = "verse";
var jn = Object.getOwnPropertyNames, Vn = Object.getOwnPropertySymbols, zn = Object.prototype.hasOwnProperty;
function vr(t, e) {
...
var Hn = "__v", Xn = "__o", Jn = "_owner", Nr = Object.getOwnPropertyDescriptor, br = Object.keys;
function Yn(t, e, n) {
  var i = t.length;
  if (e.length !== i)
    return !1;
...
function Cr(t, e, n) {
  ...
  for (var o = new Array(i), a = t.entries(), p, h, f = 0; (p = a.next()) && !p.done; ) {
    for (var m = e.entries(), E = !1, l = 0; (h = m.next()) && !h.done; ) {
      if (o[l]) {
        l++;
        continue;
      }
...
function Tt(t, e, n) {
  ...
  if (Ar(e).length !== o)
    return !1;
  for (var a, p, h; o-- > 0; )
    if (a = i[o], !Vr(t, e, n, a) || (p = Nr(t, a), h = Nr(e, a), (p || h) && (!p || !h || p.configurable !== h.configurable || p.enumerable !== h.enumerable || p.writable !== h.writable)))
      return !1;
  return !0;
}
function tu(t, e) {
...
function yr(t, e, n) {
  ...
  for (var o = new Array(i), a = t.values(), p, h; (p = a.next()) && !p.done; ) {
    for (var f = e.values(), m = !1, E = 0; (h = f.next()) && !h.done; ) {
...
function Vr(t, e, n, i) {
  return (i === Jn || i === Xn || i === Hn) && (t.$$typeof || e.$$typeof) ? !0 : Gn(e, i) && n.equals(t[i], e[i], i, i, t, e, n);
}
var iu = "[object Arguments]", ou = "[object Boolean]", au = "[object Date]", su = "[object Error]", cu = "[object Map]", lu = "[object Number]", fu = "[object Object]", hu = "[object RegExp]", pu = "[object Set]", du = "[object String]", mu = "[object URL]", Eu = Array.isArray, Tr = typeof ArrayBuffer == "function" && ArrayBuffer.isView ? ArrayBuffer.isView : null, wr = Object.assign, gu = Object.prototype.toString.call.bind(Object.prototype.toString);
function Du(t) {
  var e = t.areArraysEqual, n = t.areDatesEqual, i = t.areErrorsEqual, o = t.areFunctionsEqual, a = t.areMapsEqual, p = t.areNumbersEqual, h = t.areObjectsEqual, f = t.arePrimitiveWrappersEqual, m = t.areRegExpsEqual, E = t.areSetsEqual, l = t.areTypedArraysEqual, v = t.areUrlsEqual;
  return function(b, C, $) {
    if (b === C)
      return !0;
    if (b == null || C == null)
    ...
    if (B !== typeof C)
      return !1;
    if (B !== "object")
      return B === "number" ? p(b, C, $) : B === "function" ? o(b, C, $) : !1;
    var k = b.constructor;
    if (k !== C.constructor)
      return !1;
    if (k === Object)
    ...
    if (k === Set)
      return E(b, C, $);
    var j = gu(b);
    return j === au ? n(b, C, $) : j === hu ? m(b, C, $) : j === cu ? a(b, C, $) : j === pu ? E(b, C, $) : j === fu ? typeof b.then != "function" && typeof C.then != "function" && h(b, C, $) : j === mu ? v(b, C, $) : j === su ? i(b, C, $) : j === iu ? h(b, C, $) : j === ou || j === lu || j === du ? f(b, C, $) : !1;
  };
}
function vu(t) {
  ...
  if (n && (o = wr({}, o, n(o))), e) {
    var a = Bt(o.areArraysEqual), p = Bt(o.areMapsEqual), h = Bt(o.areObjectsEqual), f = Bt(o.areSetsEqual);
    o = wr({}, o, {
      areArraysEqual: a,
      areMapsEqual: p,
      areObjectsEqual: h,
...
function Ge(t) {
  t === void 0 && (t = {});
  var e = t.circular, n = e === void 0 ? !1 : e, i = t.createInternalComparator, o = t.createState, a = t.strict, p = a === void 0 ? !1 : a, h = vu(t), f = Du(h), m = i ? i(f) : Au(f);
  return Nu({ circular: n, comparator: f, createState: o, equals: m, strict: p });
}
function Cu(t, e) {
  return bu(t, e);
}
...
const Ti = (t) => t.replace(/&/g, "&amp;").replace(/</g, "&lt;").replace(/>/g, "&gt;").replace(/"/g, "&quot;").replace(/'/g, "&#x27;").replace(/\//g, "&#x2F;");
function wi() {
...
const wu = 1e3, zr = 60, Gr = zr * 60, Su = Gr * 24;
function Oi(t, e, n = /* @__PURE__ */ new Date()) {
...
Object.freeze(Mu);
const Ii = "-light", xi = "-dark", Ru = "theme-styles";
function Bu(t) {
  return `
.${t.id} {
...
function Mi(t, e, n) {
  ...
  return o.id = `${Ru}${n ? `-${n}` : ""}`, o.dataset.themeId = t.id, o.textContent = Bu(t), this.document.head.appendChild(o), o;
}
const $e = ["figure", "note", "sidebar", "table"];
Object.freeze($e);
class Ee {
  constructor(e) {
    W(this, "usj");
  ...
  findVerseRefForNode(e, n, i = {
    ...
    const p = n.content[a], h = Ee.findRightMostDescendantMarkerObject(
      p,
      n,
      $e
    );
  ...
  nodeToVerseRefAndOffset(e, n, i) {
    ...
    return a.startingContentNode !== void 0 && this.findNextMatchingNode(a.startingContentNode, [], (f, m) => {
      var E, l;
      return f === n ? !0 : m.find((v) => $e.includes(v.parent.type)) ? !1 : typeof f == "string" ? (h += f.length, !1) : f.type === Mt && f.number !== ((E = a.chapterNum) == null ? void 0 : E.toString()) || f.type === Rt && f.number !== ((l = a.verseNum) == null ? void 0 : l.toString()) ? (h = 0, !0) : !1;
    }), { verseRef: p, offset: h };
  }
  // #endregion
  ...
  verseRefToUsjContentLocation(e, n = 0) {
    ...
    const h = e.verse ?? e.verseNum.toString(), f = this.findNextMatchingNode(
      o,
      $e,
      (v, O) => v === o ? e.verseNum === 0 ? (p = Ee.convertWorkingStackToJsonPath(O), !0) : !1 : typeof v != "object" ? !1 : v.type === Mt ? (a = !0, !0) : v.type === Rt && v.number !== void 0 && v.number === h ? (p = Ee.convertWorkingStackToJsonPath(O), !0) : !1
    );
    ...
    return this.findNextMatchingNode(
      ...
      (v, O) => {
        ...
        if (typeof v == "string") {
          if (m += v.length, m > n)
            return p = Ee.convertWorkingStackToJsonPath(O), E = n - m + v.length, l = v, !0;
        } else if (v.type === Mt || v.type === Rt) return !0;
        return !1;
      }
  ...
  findNextLocationOfMatchingText(e, n, i = 1e3) {
    ...
    const E = Ee.findNextMatchingNodeUsingWorkingStack(
      ...
      this.convertJsonPathToWorkingStack(e.jsonPath),
      $e,
      (l, v) => typeof l != "string" || (a += l.length, a < h + 1) ? !1 : (f = h - a + l.length, m = v, !0)
    );
  ...
  extractTextBetweenPoints(e, n, i = 100) {
    ...
    return Ee.findNextMatchingNodeUsingWorkingStack(
      ...
      this.convertJsonPathToWorkingStack(e.jsonPath),
      $e,
      (a, p) => a === n.node && (typeof a == "object" || n.jsonPath === Ee.convertWorkingStackToJsonPath(p)) ? !0 : typeof a != "string" ? !1 : (o = `${o}${a}`, o.length > i && (o = o.substring(0, i)), o.length >= i)
    ), o;
  }
  // #endregion
...
export {
  ...
  nn as Mutex,
  Ju as MutexMap,
  Yu as NonValidatingDocumentCombiner,
  un as NumberFormat,
  It as PLATFORM_ERROR_VERSION,
  Kr as PlatformEventEmitter,
  Wu as PromiseChainingMap,
  Ru as THEME_STYLE_ELEMENT_ID,
  xi as THEME_SUFFIX_DARK,
  Ii as THEME_SUFFIX_LIGHT,
  Ku as UnsubscriberAsyncList,
  Ee as UsjReaderWriter,
  Rt as VERSE_TYPE,
  Ci as aggregateUnsubscriberAsyncs,
  bi as aggregateUnsubscribers,
  Mi as applyThemeStylesheet,
  Ni as areUsjContentsEqualExceptWhitespace,
  xt as at,
  Et as charAt,
  ti as codePointAt,
  Di as compareScrRefs,
  ...
  Tn as endsWith,
  qr as ensureArray,
  si as escapeStringRegexp,
  Si as formatBytes,
  ri as formatReplacementString,
  Sn as formatReplacementStringToArray,
  Ai as formatScrRef,
  Oi as formatTimeSpan,
  Vu as getAllObjectFunctionNames,
  Fn as getChaptersForBook,
  wi as getCurrentLocale,
  Or as getErrorMessage,
  kn as getLocalizeKeyForScrollGroupId,
  vi as getLocalizeKeysForScrollGroupIds,
  Ei as getLocalizedIdFromBookNumber,
  Bu as getStylesheetForTheme,
  $u as groupBy,
  Ti as htmlEncode,
  On as includes,
  St as indexOf,
  Gu as isErrorMessageAboutParatextBlockingInternetAccess,
  Hu as isErrorMessageAboutRegistryAuthFailure,
  ai as isLocalizeKey,
  Zu as isPlatformError,
  yi as isSerializable,
  Me as isString,
  yu as isSubset,
  mt as isWhiteSpace,
  In as lastIndexOf,
  ...
  li as transformAndEnsureRegExpArray,
  ci as transformAndEnsureRegExpRegExpArray,
  en as wait,
  ju as waitForDuration
};
