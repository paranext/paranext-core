...
var m = (t, e, r) => (re(t, typeof e != "symbol" ? e + "" : e, r), r);
...
], he = 1, me = F.length - 1, pe = 1, de = 1, be = (t) => {
  var e;
  return ((e = F[t]) == null ? void 0 : e.chapters) ?? -1;
}, gt = (t, e) => ({
  bookNum: Math.max(he, Math.min(t.bookNum + e, me)),
  chapterNum: 1,
  verseNum: 1
}), vt = (t, e) => ({
  ...t,
...
var T = typeof globalThis < "u" ? globalThis : typeof window < "u" ? window : typeof global < "u" ? global : typeof self < "u" ? self : {}, g = {}, Ne = () => {
...
}, ge = T && T.__importDefault || function(t) {
...
function $t(t, e) {
  return e < 0 || e > p(t) - 1 ? "" : q(t, e, 1);
}
function At(t, e) {
  if (!(e < 0 || e > p(t) - 1))
    return q(t, e, 1).codePointAt(0);
}
function qt(t, e, r = p(t)) {
  const s = Me(t, e);
  return !(s === -1 || s + p(e) !== r);
}
function je(t, e, r = 0) {
...
function Me(t, e, r) {
  let s = r === void 0 ? p(t) : r;
  s < 0 ? s = 0 : s >= p(t) && (s = p(t) - 1);
  for (let n = s; n >= 0; n--)
    if (q(t, n, p(e)) === e)
      return n;
  return -1;
...
function Mt(t, e, r = " ") {
  return e <= p(t) ? t : W(t, e, r, "right");
}
function Ct(t, e, r = " ") {
  return e <= p(t) ? t : W(t, e, r, "left");
}
function R(t, e) {
...
export {
  ...
  me as LAST_SCR_BOOK_NUM,
  fe as Mutex,
  Nt as MutexMap,
  pt as NonValidatingDocumentCombiner,
  ...
  $t as charAt,
  At as codePointAt,
  mt as createSyncProxyForAsyncObject,
  ut as debounce,
  O as deepClone,
  Tt as deepEqual,
  tt as deserialize,
