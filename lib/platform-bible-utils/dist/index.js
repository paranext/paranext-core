...
import { D as Lt, F as Bt, a as Vt, b as zt, G as Ht, L as Jt, M as Kt, S as Gt, c as Yt, e as Xt, f as Wt, g as Zt, h as Qt, j as er, k as tr, l as rr, m as nr, n as ir, o as sr, p as ar, q as or, r as cr, s as dr, t as pr, u as lr, v as ur, w as hr, x as fr, y as mr, z as gr, A as yr, B as kr, C as br, E as vr, H as Mr, I as xr, J as _r, K as Er, N as Ir, O as wr, P as Sr, Q as Pr, R as Tr, T as Cr, U as Ar, V as qr, W as $r, X as jr, Y as Nr, Z as Ur, _ as Or, $ as Fr, a0 as Rr, a1 as Dr, a2 as Lr, a3 as Br, a4 as Vr, a5 as zr, a6 as Hr, a7 as Jr, a8 as Kr, a9 as Gr, aa as Yr, ab as Xr, ac as Wr, ad as Zr } from "./scripture-util-DArajUVn.js";
...
function H(i, e, t) {
  const { log: r, first: s, suppressed: n } = ke[e], c = `${i}\0${e}`, p = Date.now(), d = z.get(c);
  if (!d || p >= d.closesAt) {
    r(s(i, t)), z.set(c, {
      closesAt: p + Y,
      suppressedCount: 0,
...
const Et = (i) => i.replace(/&/g, "&amp;").replace(/</g, "&lt;").replace(/>/g, "&gt;").replace(/"/g, "&quot;").replace(/'/g, "&#x27;").replace(/\//g, "&#x2F;");
function It() {
...
const Ee = 1e3, Q = 60, ee = Q * 60, Ie = ee * 24;
function Pt(i, e, t = /* @__PURE__ */ new Date()) {
    ...
    e.map((d) => {
      ...
      if (typeof d.fragment == "object" && "type" in d.fragment) {
        ...
        if (h.type === be && h.code)
          ...
          const f = (m = Ue.exec(h.number)) == null ? void 0 : m[1];
          if (!f)
            console.warn(
...
export {
  ...
  Ft as USFM_MARKERS_MAP_PARATEXT_3_0,
  ...
  qt as computeEffectiveStructureProtection,
  bt as createCachedInitializer,
  ...
  $t as makeProjectSelectorCustomData,
  Te as menuDocumentSchema,
  Cr as newGuid,
  ht as newPlatformError,
  Ar as normalize,
  St as normalizeProjectId,
  qr as normalizeScriptureSpaces,
  $r as offsetBook,
  jr as offsetChapter,
  Nr as offsetVerse,
  Ur as ordinalCompare,
  Or as padEnd,
  Fr as padStart,
