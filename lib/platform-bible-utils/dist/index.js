...
function kr() {
  if (ir) return ne;
  ir = 1;
  var t = Dt(), e = t.find, n = t.hasDefaultHTMLNamespace, i = t.hasOwn, o = t.isHTMLMimeType, a = t.isHTMLRawTextElement, h = t.isHTMLVoidElement, f = t.MIME_TYPE, p = t.NAMESPACE, m = Symbol(), E = Mt(), l = E.DOMException, v = E.DOMExceptionName, w = Fr();
  function b(r) {
    if (r !== m)
...
function An() {
  if (ar) return yt;
  ar = 1;
  var t = Dt(), e = Fr(), n = Mt(), i = t.isHTMLEscapableRawTextElement, o = t.isHTMLMimeType, a = t.isHTMLRawTextElement, h = t.hasOwn, f = t.NAMESPACE, p = n.ParseError, m = n.DOMException, E = 0, l = 1, v = 2, w = 3, b = 4, C = 5, k = 6, x = 7;
  function F() {
  }
  F.prototype = {
...
function Nn() {
  if (sr) return et;
  sr = 1;
  var t = Dt(), e = kr(), n = Mt(), i = vn(), o = An(), a = e.DOMImplementation, h = t.hasDefaultHTMLNamespace, f = t.isHTMLMimeType, p = t.isValidMimeType, m = t.MIME_TYPE, E = t.NAMESPACE, l = n.ParseError, v = o.XMLReader;
  function w(D) {
    return D.replace(/\r[\n\u0085]/g, `
`).replace(/[\r\u0085\u2028]/g, `
`);
...
function Sn(t, e) {
  ...
  let i = 0, o = 0;
  function a(f, p, m) {
    const E = tt(t, o, p), l = n.length > 0 && Pe(n[n.length - 1]) ? `${n.pop()}${E}` : E;
    Pe(f) ? n.push(`${l}${f}`) : (l && n.push(l), n.push(f)), o = p + m;
  }
  const h = pe(t);
  for (; i < h; ) {
    switch (Et(t, i)) {
  ...
  if (o < h) {
    const f = tt(t, o);
    n.push(
      n.length > 0 && Pe(n[n.length - 1]) ? `${n.pop()}${f}` : f
    );
  }
  return n;
}
...
const jt = ["chapter", "book", "para", "row", "sidebar", qt], Mn = "​", $r = [
...
], Bn = 1, _n = $r.length - 1, Pn = 1, Ln = 1, oi = {
  bookNum: 1,
  chapterNum: 1,
  verseNum: 1
}, Fn = (t) => {
...
function Ur(t, e, n, i) {
  ...
  if (o && a) {
    ...
    if (!m && !E) {
      ...
      jt.includes(h.type) && Pe(w) && mt(w) && (l = l.slice(0, -1));
      const b = v[v.length - 1];
      if (jt.includes(f.type) && Pe(b) && mt(b) && (v = v.slice(0, -1)), l.length !== v.length) return !1;
...
const mi = (t) => (...e) => t.map((i) => i(...e)).every((i) => i), Ei = (t) => async (...e) => {
...
function Tt(t, e, n) {
  ...
  if (Nr(e).length !== o)
    return !1;
  for (var a, h, f; o-- > 0; )
    if (a = i[o], !Vr(t, e, n, a) || (h = br(t, a), f = br(e, a), (h || f) && (!h || !f || h.configurable !== f.configurable || h.enumerable !== f.enumerable || h.writable !== f.writable)))
      return !1;
  return !0;
}
function tu(t, e) {
...
const Di = (t) => t.replace(/&/g, "&amp;").replace(/</g, "&lt;").replace(/>/g, "&gt;").replace(/"/g, "&quot;").replace(/'/g, "&#x27;").replace(/\//g, "&#x2F;");
function vi() {
...
const wu = 1e3, Hr = 60, Gr = Hr * 60, Su = Gr * 24;
function Ni(t, e, n = /* @__PURE__ */ new Date()) {
...
class Ee {
  ...
  nodeToVerseRefAndOffset(e, n, i) {
    ...
    return a.startingContentNode !== void 0 && this.findNextMatchingNode(a.startingContentNode, [], (p, m) => {
      var E, l;
      return p === n ? !0 : m.find((v) => qe.includes(v.parent.type)) ? !1 : typeof p == "string" ? (f += p.length, !1) : p.type === It && p.number !== ((E = a.chapterNum) == null ? void 0 : E.toString()) || p.type === Rt && p.number !== ((l = a.verseNum) == null ? void 0 : l.toString()) ? (f = 0, !0) : !1;
    }), { verseRef: h, offset: f };
  }
  // #endregion
...
export {
  ...
  tt as substring,
  Rn as toArray,
  ii as transformAndEnsureRegExpArray,
  ui as transformAndEnsureRegExpRegExpArray,
  en as wait,
