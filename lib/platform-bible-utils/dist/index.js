...
var Y = (t, e, n) => Yr(t, typeof e != "symbol" ? e + "" : e, n);
...
function Hu(t) {
  ...
  return xe(t) ? t.includes(e) : xr(t).includes(e);
}
function zu(t) {
  const e = "401 Unauthorized error while getting shared projects.", n = "User registration is not valid. Cannot retrieve resources from DBL.", i = xe(t) ? t : xr(t);
...
class rn {
  ...
  constructor(e, n) {
    ...
    Y(this, "latestOutput");
    Y(this, "options");
    Y(this, "onDidRebuildEmitter", new Qr());
...
const ve = class X {
   ...
   */
  get book() {
    return _e.bookNumberToId(this.bookNum, "");
  }
  set book(e) {
    this.bookNum = _e.bookIdToNumber(e);
  }
  /**
  ...
  parse(e) {
    ...
    if (i.length !== 2 || _e.bookIdToNumber(n[0]) === 0 || !Number.isInteger(a) || a < 0 || !X.isVerseParseable(i[1]))
      throw new Ct("Invalid reference : " + e);
   ...
   */
  get internalValid() {
    return this.versification == null ? 1 : this._bookNum <= 0 || this._bookNum > _e.lastBook ? 2 : (_e.isCanonical(this._bookNum), 0);
  }
  setEmpty(e = X.defaultVersification) {
    this._bookNum = 0, this._chapterNum = -1, this._verse = void 0, this.versification = e;
  }
  updateInternal(e, n, i) {
    this.bookNum = _e.bookIdToNumber(e), this.chapter = n, this.verse = i;
  }
};
...
function Dt() {
  ...
  nr = 1;
  function t(R, F, q) {
    if (q === void 0 && (q = Array.prototype), R && typeof q.find == "function")
      return q.find.call(R, F);
    for (var ue = 0; ue < R.length; ue++)
      if (n(R, ue)) {
        var he = R[ue];
        if (F.call(void 0, he, ue, R))
          return he;
      }
  }
  function e(R, F) {
  ...
  function v(R) {
    return f(R) || R === w.XML_XHTML_APPLICATION;
  }
  var w = e({
    /**
  ...
  }), b = Object.keys(w).map(function(R) {
    return w[R];
  });
  function C(R) {
...
function kr() {
  ...
  var w = n(v), b = a("[", w, n(/[-.0-9\xB7]/), n(/[\u0300-\u036F\u203F-\u2040]/), "]"), C = a(v, b, "*"), k = a(b, "+"), R = a("&", C, ";"), F = o(/&#[0-9]+;|&#x[0-9a-fA-F]+;/), q = o(R, "|", F), ue = a("%", C, ";"), he = o(
    a('"', o(/[^%&"]/, "|", ue, "|", q), "*", '"'),
    "|",
    a("'", o(/[^%&']/, "|", ue, "|", q), "*", "'")
  ), D = o('"', o(/[^<&"]/, "|", q), "*", '"', "|", "'", o(/[^<&']/, "|", q), "*", "'"), x = i(v, ":"), L = i(b, ":"), V = a(x, L, "*"), K = a(V, o(":", V), "?"), ee = a("^", K, "$"), we = a("(", K, ")"), te = o(/"[^"]*"|'[^']*'/), Re = a(/^<\?/, "(", C, ")", o(E, "(", l, "*?)"), "?", /\?>/), d = /[\x20\x0D\x0Aa-zA-Z0-9-'()+,./:=?;!*#@$_%]/, A = o('"', d, '*"', "|", "'", i(d, "'"), "*'"), S = "<!--", O = "-->", B = a(S, o(i(l, "-"), "|", a("-", i(l, "-"))), "*", O), N = "#PCDATA", M = o(
    a(/\(/, f, N, o(f, /\|/, f, K), "*", f, /\)\*/),
    "|",
    a(/\(/, f, N, f, /\)/)
  ), z = /[?*+]?/, _ = a(
  ...
  ), y = o("EMPTY", "|", "ANY", "|", M, "|", _), I = "<!ELEMENT", P = a(I, E, o(K, "|", ue), E, o(y, "|", ue), f, ">"), re = a("NOTATION", E, /\(/, f, C, o(f, /\|/, f, C), "*", f, /\)/), W = a(/\(/, f, k, o(f, /\|/, f, k), "*", f, /\)/), Ce = o(re, "|", W), ye = o(/CDATA|ID|IDREF|IDREFS|ENTITY|ENTITIES|NMTOKEN|NMTOKENS/, "|", Ce), se = o(/#REQUIRED|#IMPLIED/, "|", o(o("#FIXED", E), "?", D)), oe = o(E, C, E, ye, E, se), j = "<!ATTLIST", Ge = a(j, E, C, oe, "*", f, ">"), Ae = "SYSTEM", ce = "PUBLIC", Me = o(o(Ae, E, te), "|", o(ce, E, A, E, te)), Le = a(
    "^",
    o(
  ...
  ), it = o(E, "NDATA", E, C), je = o(he, "|", o(Me, it, "?")), $e = "<!ENTITY", ot = a($e, E, C, E, je, f, ">"), Q = o(he, "|", Me), ge = a($e, E, "%", E, C, E, Q, f, ">"), le = o(ot, "|", ge), Je = a(ce, E, A), at = a("<!NOTATION", E, C, E, o(Me, "|", Je), f, ">"), Fe = a(f, "=", f), Xe = /1[.]\d+/, U = a(E, "version", Fe, o("'", Xe, "'", "|", '"', Xe, '"')), ie = /[A-Za-z][-A-Za-z0-9._]*/, De = o(E, "encoding", Fe, o('"', ie, '"', "|", "'", ie, "'")), Ne = o(E, "standalone", Fe, o("'", o("yes", "|", "no"), "'", "|", '"', o("yes", "|", "no"), '"')), Ue = a(/^<\?xml/, U, De, "?", Ne, "?", f, /\?>/), Ye = "<!DOCTYPE", st = "<![CDATA[", ct = "]]>", lt = /<!\[CDATA\[/, vt = /\]\]>/, At = a(l, "*?", vt), ft = a(lt, At);
  return $.chars = n, $.chars_without = i, $.detectUnicodeSupport = t, $.reg = a, $.regg = o, $.AttlistDecl = Ge, $.CDATA_START = st, $.CDATA_END = ct, $.CDSect = ft, $.Char = l, $.Comment = B, $.COMMENT_START = S, $.COMMENT_END = O, $.DOCTYPE_DECL_START = Ye, $.elementdecl = P, $.EntityDecl = le, $.EntityValue = he, $.ExternalID = Me, $.ExternalID_match = Le, $.Name = C, $.NotationDecl = at, $.Reference = q, $.PEReference = ue, $.PI = Re, $.PUBLIC = ce, $.PubidLiteral = A, $.QName = K, $.QName_exact = ee, $.QName_group = we, $.S = E, $.SChar_s = m, $.S_OPT = f, $.SYSTEM = Ae, $.SystemLiteral = te, $.UNICODE_REPLACEMENT_CHARACTER = h, $.UNICODE_SUPPORT = e, $.XMLDecl = Ue, $;
}
var or;
function qr() {
  if (or) return ne;
  or = 1;
  var t = Dt(), e = t.find, n = t.hasDefaultHTMLNamespace, i = t.hasOwn, a = t.isHTMLMimeType, o = t.isHTMLRawTextElement, h = t.isHTMLVoidElement, l = t.MIME_TYPE, p = t.NAMESPACE, m = Symbol(), E = Bt(), f = E.DOMException, v = E.DOMExceptionName, w = kr();
  function b(r) {
    if (r !== m)
  ...
  var L = {}, V = L.ELEMENT_NODE = 1, K = L.ATTRIBUTE_NODE = 2, ee = L.TEXT_NODE = 3, we = L.CDATA_SECTION_NODE = 4, te = L.ENTITY_REFERENCE_NODE = 5, Re = L.ENTITY_NODE = 6, d = L.PROCESSING_INSTRUCTION_NODE = 7, A = L.COMMENT_NODE = 8, S = L.DOCUMENT_NODE = 9, O = L.DOCUMENT_TYPE_NODE = 10, B = L.DOCUMENT_FRAGMENT_NODE = 11, N = L.NOTATION_NODE = 12, M = t.freeze({
  ...
  ce.prototype = {
    ...
    createElementNS: function(r, u) {
      var s = he(r, u), c = new De(m), g = c.attributes = new W();
  ...
  }, ce.prototype.getElementsByClassName = De.prototype.getElementsByClassName, ce.prototype.getElementsByTagName = De.prototype.getElementsByTagName, ce.prototype.getElementsByTagNameNS = De.prototype.getElementsByTagNameNS, x(De, j);
  function Ne(r) {
    b(r), this.namespaceURI = null, this.prefix = null, this.ownerElement = null;
  }
  Ne.prototype.nodeType = K, x(Ne, j);
  function Ue(r) {
    b(r);
  }
  Ue.prototype = {
  ...
  lt.prototype.nodeType = O, x(lt, j);
  function vt(r) {
    b(r);
  }
  vt.prototype.nodeType = N, x(vt, j);
  function At(r) {
    b(r);
  }
  At.prototype.nodeType = Re, x(At, j);
  function ft(r) {
    b(r);
  }
  ft.prototype.nodeType = te, x(ft, j);
  function Z(r) {
    b(r);
  }
  Z.prototype.nodeName = "#document-fragment", Z.prototype.nodeType = B, x(Z, j);
  function ae(r) {
    b(r);
  }
  ae.prototype.nodeType = d, x(ae, Ue);
  function Ve() {
  }
    ...
    switch (r.nodeType) {
      case V:
        ...
        if (!T && !r.prefix && r.namespaceURI) {
          for (var Oe, ke = 0; ke < J.length; ke++)
        ...
        for (var Qe = 0; Qe < de; Qe++) {
          var Be = J.item(Qe);
          Be.prefix == "xmlns" ? c.push({
            prefix: Be.localName,
            namespace: Be.value
          }) : Be.nodeName == "xmlns" && c.push({ prefix: "", namespace: Be.value });
        }
        for (var Qe = 0; Qe < de; Qe++) {
          var Be = J.item(Qe);
          if (Xt(Be, T, c)) {
            var Ze = Be.prefix || "", bt = Be.namespaceURI;
            Pt(u, Ze ? "xmlns:" + Ze : "xmlns", bt), c.push({ prefix: Ze, namespace: bt });
          }
          pt(Be, u, s, c);
        }
        if (be === Se && Xt(r, T, c)) {
        ...
        var Ft = !me;
        if (Ft && (T || r.namespaceURI === p.HTML) && (Ft = h(be)), Ft)
          u.push("/>");
        else {
          if (u.push(">"), T && o(be))
            for (; me; )
      ...
      case B:
        ...
        return;
      case K:
        return Pt(u, r.name, r.value);
      case ee:
        return u.push(r.data.replace(/[<&>]/g, Ge));
      case we:
  ...
  function Lt(r, u, s) {
    ...
    switch (u.childNodes && (c.childNodes = new I()), c.ownerDocument = r, c.nodeType) {
      case V:
        var J = u.attributes, de = c.attributes = new W(), be = J.length;
        de._ownerElement = c;
        for (var Se = 0; Se < be; Se++)
          c.setAttributeNode(Lt(r, J.item(Se), !0));
        break;
      case K:
        s = !0;
    }
    if (s)
      for (var Oe = u.firstChild; Oe; )
        c.appendChild(Lt(r, Oe, s)), Oe = Oe.nextSibling;
    return c;
  }
  function Kt(r, u, s) {
    r[u] = s;
...
function Nn() {
  if (sr) return yt;
  sr = 1;
  var t = Dt(), e = kr(), n = Bt(), i = t.isHTMLEscapableRawTextElement, a = t.isHTMLMimeType, o = t.isHTMLRawTextElement, h = t.hasOwn, l = t.NAMESPACE, p = n.ParseError, m = n.DOMException, E = 0, f = 1, v = 2, w = 3, b = 4, C = 5, k = 6, R = 7;
  function F() {
  }
  F.prototype = {
  ...
  function ue(d, A, S, O, B) {
    ...
    function _(U) {
      if (U > se) {
        var ie = d.substring(se, U).replace(q, z);
        W && y(se), O.characters(ie, 0, U - se), se = U;
      }
    }
    function y(U, ie) {
      for (; U >= P && (ie = re.exec(d)); )
        I = ie.index, P = I + ie[0].length, W.lineNumber++;
      W.columnNumber = U - I + 1;
    }
    for (var I = 0, P = 0, re = /.*(?:\r\n?|\n)|.*$/g, W = O.locator, Ce = [{ currentNSMap: A }], ye = [], se = 0; ; ) {
      try {
        var oe = d.indexOf("<", se);
        if (oe < 0) {
          if (!N && ye.length > 0)
          ...
          if (!d.substring(se).match(/^\s*$/)) {
            var j = O.doc, Ge = j.createTextNode(d.substr(se));
            if (j.documentElement)
              return B.error("Extra content at the end of the document");
            j.appendChild(Ge), O.currentElement = Ge;
          }
          return;
        }
        if (oe > se) {
        ...
        switch (d.charAt(oe + 1)) {
          case "/":
            ...
            var Me = le > 0 && e.reg("^", e.QName_group, e.S_OPT, "$").exec(ce);
            if (!Me)
              return B.fatalError('end tag name contains invalid characters: "' + ce + '"');
            if (!O.currentElement && !O.doc.documentElement)
              return;
            var Le = ye[ye.length - 1] || O.currentElement.tagName || O.doc.documentElement.tagName || "";
            if (Le !== Me[1]) {
              var it = Me[1].toLowerCase();
          ...
          // end element
          case "?":
            W && y(oe), le = te(d, oe, O, B);
            break;
          case "!":
            W && y(oe), le = we(d, oe, O, B, N);
            break;
          default:
            W && y(oe);
            var Q = new Re(), ge = Ce[Ce.length - 1].currentNSMap, le = D(d, oe, Q, ge, z, B, N), Je = Q.length;
            if (Q.closed || (N && t.isHTMLVoidElement(Q.tagName) ? Q.closed = !0 : ye.push(Q.tagName)), W && Je) {
              for (var at = he(W, {}), Fe = 0; Fe < Je; Fe++) {
                var Xe = Q[Fe];
                y(Xe.offset), Xe.locator = he(W, {});
              }
              O.locator = at, x(Q, O, ge) && Ce.push(Q), O.locator = W;
            } else
              x(Q, O, ge) && Ce.push(Q);
            N && !Q.closed ? le = L(d, le, Q.tagName, z, O) : le++;
        }
      } catch (U) {
        if (U instanceof p)
          throw U;
  ...
  function D(d, A, S, O, B, N, M) {
    function z(W, Ce, ye) {
      if (h(S.attributeNames, W))
        return N.fatalError("Attribute " + W + " redefined");
      if (!M && Ce.indexOf("<") >= 0)
      ...
      switch (re) {
        ...
        case '"':
          if (P === w || P === f)
            if (P === f && (N.warning('attribute value must after "="'), _ = d.slice(A, I)), A = I + 1, I = d.indexOf(re, A), I > 0)
              y = d.slice(A, I), z(_, y, A - 1), P = C;
            else
              throw new Error("attribute value no end '" + re + "' match");
          else if (P == b)
            y = d.slice(A, I), z(_, y, A), N.warning('attribute "' + _ + '" missed start quot(' + re + ")!!"), A = I + 1, P = C;
          else
        ...
        case ">":
          switch (P) {
            ...
            case v:
              P === v && (y = _), P == b ? (N.warning('attribute "' + y + '" missed quot(")!'), z(_, y, A)) : (M || N.warning('attribute "' + y + '" missed value!! "' + y + '" instead!!'), z(y, y, A));
              break;
            case w:
              if (!M)
        ...
        default:
          if (re <= " ")
            switch (P) {
              ...
              case b:
                var y = d.slice(A, I);
                N.warning('attribute "' + y + '" missed quot(")!!'), z(_, y, A);
              case C:
                P = k;
                break;
            }
            ...
            switch (P) {
              ...
              case v:
                M || N.warning('attribute "' + _ + '" missed value!! "' + _ + '" instead2!!'), z(_, _, A), A = I, P = f;
                break;
              case C:
  ...
  function x(d, A, S) {
    for (var O = d.tagName, B = null, P = d.length; P--; ) {
      var N = d[P], M = N.qName, z = N.value, re = M.indexOf(":");
      if (re > 0)
        var _ = N.prefix = M.slice(0, re), y = M.slice(re + 1), I = _ === "xmlns" && y;
      else
        y = M, _ = null, I = M === "xmlns" && "";
      N.localName = y, I !== !1 && (B == null && (B = /* @__PURE__ */ Object.create(null), V(S, S = /* @__PURE__ */ Object.create(null))), S[I] = B[I] = z, N.uri = l.XMLNS, A.startPrefixMapping(I, z));
    }
    ...
    var W = d.uri = S[_ || ""];
    if (A.startElement(W, y, O, d), d.closed) {
      if (A.endElement(W, y, O), B)
        for (_ in B)
  ...
  function L(d, A, S, O, B) {
    var N = i(S);
    if (N || o(S)) {
      var M = d.indexOf("</" + S + ">", A), z = d.substring(A + 1, M);
      return N && (z = z.replace(q, O)), B.characters(z, 0, z.length), M;
    }
    return A + 1;
  }
  function V(d, A) {
...
` && I !== "	" && I !== "\r")
    ...
    return {
      ...
      substringStartsWith: z
    };
  }
  function ee(d, A) {
    function S(z, _) {
      var y = e.PI.exec(z.substringFromIndex());
      return y ? y[1].toLowerCase() === "xml" ? _.fatalError(
        "xml declaration is only allowed at the start of the document, but found at position " + z.getIndex()
      ) : (z.skip(y[0].length), y[0]) : _.fatalError("processing instruction is not well-formed at position " + z.getIndex());
    }
    var O = d.getSource();
    if (d.char() === "[") {
      d.skip(1);
  ...
  function we(d, A, S, O, B) {
    ...
    switch (N.char(2)) {
      ...
      case "[":
        var z = N.getMatch(e.CDSect);
        return z ? !B && !S.currentElement ? O.fatalError("CDATA outside of element") : (S.startCDATA(), S.characters(z, e.CDATA_START.length, z.length - e.CDATA_START.length - e.CDATA_END.length), S.endCDATA(), N.getIndex()) : O.fatalError("Invalid CDATA starting at position " + A);
      case "D": {
  ...
  return Re.prototype = {
    ...
    //	getType:function(i){},
  }, yt.XMLReader = F, yt.parseUtils = K, yt.parseDoctypeCommentOrCData = we, yt;
}
var cr;
function bn() {
  if (cr) return et;
  cr = 1;
  var t = Dt(), e = qr(), n = Bt(), i = An(), a = Nn(), o = e.DOMImplementation, h = t.hasDefaultHTMLNamespace, l = t.isHTMLMimeType, p = t.isValidMimeType, m = t.MIME_TYPE, E = t.NAMESPACE, f = n.ParseError, v = a.XMLReader;
  function w(D) {
    return D.replace(/\r[\n\u0085]/g, `
`).replace(/[\r\u0085\u2028]/g, `
`);
  ...
  b.prototype.parseFromString = function(D, x) {
    if (!p(x))
      throw new TypeError('DOMParser.parseFromString: the provided mimeType "' + x + '" is not valid.');
    var L = this.assign(/* @__PURE__ */ Object.create(null), this.xmlns), V = i.XML_ENTITIES, K = L[""] || null;
    h(x) ? (V = i.HTML_ENTITIES, K = E.HTML) : x === m.XML_SVG_IMAGE && (K = E.SVG), L[""] = K, L.xml = L.xml || E.XML;
  ...
  function k(D, x) {
    x.lineNumber = D.lineNumber, x.columnNumber = D.columnNumber;
  }
  C.prototype = {
    /**
    ...
    startElement: function(D, x, L, V) {
      var K = this.doc, ee = K.createElementNS(D, L || x), we = V.length;
      q(this, ee), this.currentElement = ee, this.locator && k(this.locator, ee);
      for (var te = 0; te < we; te++) {
        var D = V.getURI(te), Re = V.getValue(te), L = V.getQName(te), d = K.createAttributeNS(D, L);
        this.locator && k(V.getLocator(te), d), d.value = d.nodeValue = Re, ee.setAttributeNode(d);
      }
    },
    endElement: function(D, x, L) {
      this.currentElement = this.currentElement.parentNode;
    },
    startPrefixMapping: function(D, x) {
    },
    endPrefixMapping: function(D) {
    },
    processingInstruction: function(D, x) {
      var L = this.doc.createProcessingInstruction(D, x);
      this.locator && k(this.locator, L), q(this, L);
    },
    ignorableWhitespace: function(D, x, L) {
    },
    characters: function(D, x, L) {
    ...
    startDTD: function(D, x, L, V) {
      var K = this.doc.implementation;
      if (K && K.createDocumentType) {
        var ee = K.createDocumentType(D, x, L, V);
        this.locator && k(this.locator, ee), q(this, ee), this.doc.doctype = ee;
      }
    },
    reportError: function(D, x) {
      if (typeof this.onError == "function")
        try {
          this.onError(D, x, this);
        } catch (L) {
          throw new f("Reporting " + D + ' "' + x + '" caused ' + L, this.locator);
        }
      else
        console.error("[xmldom " + D + "]	" + x, R(this.locator));
    },
    /**
...
@#[line:` + D.lineNumber + ",col:" + D.columnNumber + "]";
  ...
  function F(D, x, L) {
    return typeof D == "string" ? D.substr(x, L) : D.length >= x + L || x ? new java.lang.String(D, x, L) + "" : D;
  }
  ...
  function q(D, x) {
    D.currentElement ? D.currentElement.appendChild(x) : D.doc.appendChild(x);
  }
  function ue(D) {
...
function Cn() {
  ...
  lr = 1;
  var t = Dt();
  G.assign = t.assign, G.hasDefaultHTMLNamespace = t.hasDefaultHTMLNamespace, G.isHTMLMimeType = t.isHTMLMimeType, G.isValidMimeType = t.isValidMimeType, G.MIME_TYPE = t.MIME_TYPE, G.NAMESPACE = t.NAMESPACE;
  var e = Bt();
  G.DOMException = e.DOMException, G.DOMExceptionName = e.DOMExceptionName, G.ExceptionCode = e.ExceptionCode, G.ParseError = e.ParseError;
  var n = qr();
  G.Attr = n.Attr, G.CDATASection = n.CDATASection, G.CharacterData = n.CharacterData, G.Comment = n.Comment, G.Document = n.Document, G.DocumentFragment = n.DocumentFragment, G.DocumentType = n.DocumentType, G.DOMImplementation = n.DOMImplementation, G.Element = n.Element, G.Entity = n.Entity, G.EntityReference = n.EntityReference, G.LiveNodeList = n.LiveNodeList, G.NamedNodeMap = n.NamedNodeMap, G.Node = n.Node, G.NodeList = n.NodeList, G.Notation = n.Notation, G.ProcessingInstruction = n.ProcessingInstruction, G.Text = n.Text, G.XMLSerializer = n.XMLSerializer;
  var i = bn();
  return G.DOMParser = i.DOMParser, G.onErrorStopParsing = i.onErrorStopParsing, G.onWarningStopParsing = i.onWarningStopParsing, G;
}
Cn();
const jt = "USJ";
var Ie = {}, qt, fr;
function yn() {
  return fr || (fr = 1, qt = () => {
    const t = "\\ud800-\\udfff", h = "\\u0300-\\u036f" + "\\ufe20-\\ufe2f" + "\\u20d0-\\u20ff" + "\\u1ab0-\\u1aff" + "\\u1dc0-\\u1dff", l = "\\ufe0e\\ufe0f", p = "\\uD83D\\uDC69\\uD83C\\uDFFB\\u200D\\uD83C\\uDF93", m = `[${t}]`, E = `[${h}]`, f = "\\ud83c[\\udffb-\\udfff]", v = `(?:${E}|${f})`, w = `[^${t}]`, b = "(?:\\uD83C[\\uDDE6-\\uDDFF]){2}", C = "[\\ud800-\\udbff][\\udc00-\\udfff]", k = "\\u200d", R = "(?:\\ud83c\\udff4\\udb40\\udc67\\udb40\\udc62\\udb40(?:\\udc65|\\udc73|\\udc77)\\udb40(?:\\udc6e|\\udc63|\\udc6c)\\udb40(?:\\udc67|\\udc74|\\udc73)\\udb40\\udc7f)", F = `[${p}]`, q = `${v}?`, ue = `[${l}]?`, he = `(?:${k}(?:${[w, b, C].join("|")})${ue + q})*`, D = ue + q + he, L = `(?:${[`${w}${E}?`, E, b, C, m, F].join("|")})`;
    return new RegExp(`${R}|${f}(?=${f})|${L + D}`, "g");
  }), qt;
}
var pr;
function Tn() {
...
function Et(t, e) {
  return e < 0 || e > pe(t) - 1 ? "" : _t(t, e, 1);
}
function ei(t, e) {
  if (!(e < 0 || e > pe(t) - 1))
    return _t(t, e, 1).codePointAt(0);
}
...
const $t = ["chapter", "book", "para", "row", "sidebar", jt], Bn = "​", Ur = [
...
], _n = 1, Pn = Ur.length - 1, Ln = 1, Fn = 1, fi = {
  bookNum: 1,
  chapterNum: 1,
  verseNum: 1
}, kn = (t) => {
  ...
  bookNum: Math.max(_n, Math.min(t.bookNum + e, Pn)),
  chapterNum: 1,
  verseNum: 1
}), hi = (t, e) => ({
  ...t,
...
function Er(t) {
  return new zt(t.bookNum, t.chapterNum, t.verseNum).BBBCCCVVV;
}
function Ei(t, e) {
  return Er(t) - Er(e);
}
...
function Di(t, e, n, i) {
  ...
  switch (e ?? "id") {
    case "English":
      a = _e.bookNumberToEnglishName(t.bookNum);
      break;
    case "id":
      a = _e.bookNumberToId(t.bookNum);
      break;
    default:
      a = e ?? "";
      break;
...
function Vr(t, e, n, i) {
  ...
  if (a && o) {
    ...
    if (!m && !E) {
      ...
      $t.includes(h.type) && xe(w) && mt(w) && (f = f.slice(0, -1));
      const b = v[v.length - 1];
      if ($t.includes(l.type) && xe(b) && mt(b) && (v = v.slice(0, -1)), f.length !== v.length) return !1;
...
var Vn = Object.getOwnPropertyNames, Hn = Object.getOwnPropertySymbols, zn = Object.prototype.hasOwnProperty;
function Nr(t, e) {
...
function Hr(t, e, n, i) {
  return (i === Yn || i === Xn || i === Jn) && (t.$$typeof || e.$$typeof) ? !0 : Gn(e, i) && n.equals(t[i], e[i], i, i, t, e, n);
}
...
function vu(t) {
  ...
  return function(b, C, k) {
    ...
    if (R !== typeof C)
      return !1;
    if (R !== "object")
      return R === "number" ? h(b, C, k) : R === "function" ? a(b, C, k) : !1;
    var F = b.constructor;
    if (F !== C.constructor)
      return !1;
    if (F === Object)
...
class Ee {
  ...
  nodeToVerseRefAndOffset(e, n, i) {
    ...
    return o.startingContentNode !== void 0 && this.findNextMatchingNode(o.startingContentNode, [], (p, m) => {
      var E, f;
      return p === n ? !0 : m.find((v) => qe.includes(v.parent.type)) ? !1 : typeof p == "string" ? (l += p.length, !1) : p.type === xt && p.number !== ((E = o.chapterNum) == null ? void 0 : E.toString()) || p.type === Rt && p.number !== ((f = o.verseNum) == null ? void 0 : f.toString()) ? (l = 0, !0) : !1;
    }), { verseRef: h, offset: l };
  }
  // #endregion
  ...
  verseRefToUsjContentLocation(e, n = 0) {
    ...
    const l = e.verse, p = this.findNextMatchingNode(
      a,
      qe,
      (v, w) => v === a ? e.verseNum === 0 ? (h = Ee.convertWorkingStackToJsonPath(w), !0) : !1 : typeof v != "object" ? !1 : v.type === xt ? (o = !0, !0) : v.type === Rt && v.number !== void 0 && v.number === l ? (h = Ee.convertWorkingStackToJsonPath(w), !0) : !1
    );
    ...
    return this.findNextMatchingNode(
      ...
      (v, w) => {
        ...
        } else if (v.type === xt || v.type === Rt) return !0;
        return !1;
      }
...
export {
  ...
  un as Mutex,
  Ju as MutexMap,
  Xu as NonValidatingDocumentCombiner,
  on as NumberFormat,
  Ot as PLATFORM_ERROR_VERSION,
  Qr as PlatformEventEmitter,
  Yu as PromiseChainingMap,
  ...
  wn as endsWith,
  jr as ensureArray,
  ai as escapeStringRegexp,
  Ti as formatBytes,
  ti as formatReplacementString,
  ...
  mi as getLocalizedIdFromBookNumber,
  ju as groupBy,
  Ci as htmlEncode,
  In as includes,
  St as indexOf,
  ...
  Rn as toArray,
  li as toKebabCase,
  ci as transformAndEnsureRegExpArray,
  si as transformAndEnsureRegExpRegExpArray,
  tn as wait,
