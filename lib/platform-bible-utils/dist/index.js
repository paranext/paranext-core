...
var Ge = Object.defineProperty, _e = (t, e, r) => e in t ? Ge(t, e, { enumerable: !0, configurable: !0, writable: !0, value: r }) : t[e] = r, l = (t, e, r) => _e(t, typeof e != "symbol" ? e + "" : e, r);
const j = [
  "GEN",
  "EXO",
  "LEV",
...
function Fe(t) {
  const e = typeof t == "string" ? P(t) : t;
  return e >= 40 && e <= 66;
}
function Xe(t) {
  return (typeof t == "string" ? P(t) : t) <= 39;
}
function pe(t) {
  return t <= 66;
}
...
const N = class {
  ...
  constructor(e) {
    ...
    typeof e == "string" ? (this.name = e, this._type = E[e]) : (this._type = e, this.name = E[e]);
  }
  get type() {
    return this._type;
  }
...
const y = class f {
  ...
  parse(e) {
    ...
    if (s.length !== 2 || O.bookIdToNumber(r[0]) === 0 || !Number.isInteger(n) || n < 0 || !f.isVerseParseable(s[1]))
      throw new D("Invalid reference : " + e);
  ...
  updateInternal(e, r, s) {
    this.bookNum = O.bookIdToNumber(e), this.chapter = r, this.verse = s;
  }
};
...
var Y = typeof globalThis < "u" ? globalThis : typeof window < "u" ? window : typeof global < "u" ? global : typeof self < "u" ? self : {}, I = {}, et = () => {
  const t = "\\ud800-\\udfff", e = "\\u0300-\\u036f", r = "\\ufe20-\\ufe2f", s = "\\u20d0-\\u20ff", n = "\\u1ab0-\\u1aff", i = "\\u1dc0-\\u1dff", o = e + r + s + n + i, a = "\\ufe0e\\ufe0f", h = "\\uD83D\\uDC69\\uD83C\\uDFFB\\u200D\\uD83C\\uDF93", p = `[${t}]`, u = `[${o}]`, c = "\\ud83c[\\udffb-\\udfff]", m = `(?:${u}|${c})`, v = `[^${t}]`, b = "(?:\\uD83C[\\uDDE6-\\uDDFF]){2}", A = "[\\ud800-\\udbff][\\udc00-\\udfff]", V = "\\u200d", $e = "(?:\\ud83c\\udff4\\udb40\\udc67\\udb40\\udc62\\udb40(?:\\udc65|\\udc73|\\udc77)\\udb40(?:\\udc6e|\\udc63|\\udc6c)\\udb40(?:\\udc67|\\udc74|\\udc73)\\udb40\\udc7f)", je = `[${h}]`, H = `${m}?`, L = `[${a}]?`, Ie = `(?:${V}(?:${[v, b, A].join("|")})${L + H})*`, Ce = L + H + Ie, Pe = `(?:${[`${v}${u}?`, u, b, A, p, je].join("|")})`;
...
function te(t, e, r) {
  ...
  if (r !== void 0 && r <= 0)
    return [t];
  if (e === "")
    return dt(t).slice(0, r);
  let n = e;
  (typeof e == "string" || e instanceof RegExp && !ht(e.flags, "g")) && (n = new RegExp(e, "g"));
  const i = t.match(n);
  let o = 0;
  if (!i)
    return [t];
...
], mt = 1, gt = we.length - 1, bt = 1, yt = 1, vt = (t) => {
  var e;
  return ((e = we[t]) == null ? void 0 : e.chapters) ?? -1;
}, $r = (t, e) => ({
  bookNum: Math.max(mt, Math.min(t.bookNum + e, gt)),
  chapterNum: 1,
  verseNum: 1
}), jr = (t, e) => ({
  ...t,
  chapterNum: Math.min(
    Math.max(bt, t.chapterNum + e),
    vt(t.bookNum)
  ),
  verseNum: 1
}), Ir = (t, e) => ({
...
const Pr = (t) => (...e) => t.map((s) => s(...e)).every((s) => s), Tr = (t) => async (...e) => {
  const r = t.map(async (s) => s(...e));
  return (await Promise.all(r)).every((s) => s);
};
var Nt = Object.getOwnPropertyNames, wt = Object.getOwnPropertySymbols, Et = Object.prototype.hasOwnProperty;
function re(t, e) {
...
function oe(t, e, r) {
  ...
  for (var s = {}, n = t.entries(), i = 0, o, a; (o = n.next()) && !o.done; ) {
    for (var h = e.entries(), p = !1, u = 0; (a = h.next()) && !a.done; ) {
      var c = o.value, m = c[0], v = c[1], b = a.value, A = b[0], V = b[1];
      !p && !s[u] && (p = r.equals(m, A, i, u, t, e, r) && r.equals(v, V, m, A, t, e, r)) && (s[u] = !0), u++;
    }
    if (!p)
      return !1;
    i++;
...
function zt(t) {
  ...
  return function(u, c, m) {
    ...
    if (v === Set)
      return a(u, c, m);
    var b = Vt(u);
    return b === At ? r(u, c, m) : b === Bt ? o(u, c, m) : b === Dt ? s(u, c, m) : b === xt ? a(u, c, m) : b === Rt ? typeof u.then != "function" && typeof c.then != "function" && n(u, c, m) : b === Pt ? n(u, c, m) : b === Tt || b === Mt || b === kt ? i(u, c, m) : !1;
  };
}
function Jt(t) {
  var e = t.circular, r = t.createCustomConfig, s = t.strict, n = {
    areArraysEqual: s ? M : Ot,
    areDatesEqual: St,
...
function S(t) {
  t === void 0 && (t = {});
  var e = t.circular, r = e === void 0 ? !1 : e, s = t.createInternalComparator, n = t.createState, i = t.strict, o = i === void 0 ? !1 : i, a = Jt(t), h = zt(a), p = s ? s(h) : Gt(h);
  return _t({ circular: r, comparator: h, createState: n, equals: p, strict: o });
}
function Xt(t, e) {
  return Ft(t, e);
}
function Kt(t, e) {
  ...
  return Object.keys(r).forEach((i) => {
    n && (Object.hasOwn(s, i) && Kt(s[i], r[i]) || (n = !1));
  }), n;
}
function ce(t, e, r) {
...
const Dr = (t) => t.replace(/&/g, "&amp;").replace(/</g, "&lt;").replace(/>/g, "&gt;").replace(/"/g, "&quot;").replace(/'/g, "&#x27;").replace(/\//g, "&#x2F;");
function Mr() {
...
export {
  ...
  Nr as padEnd,
  wr as padStart,
  Lt as projectSettingsDocumentSchema,
  ce as serialize,
