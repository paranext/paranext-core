...
class Gu {
  ...
  cleanupPromiseChain(e) {
    ...
    if (!n) return;
    const i = { promise: un }, a = n.catch((o) => this.logger.warn(`Error in promise for ${e}: ${o.message}`)).finally(() => {
...
const ve = class X {
  constructor(e, n, i, a) {
    if (H(this, "firstChapter"), H(this, "lastChapter"), H(this, "lastVerse"), H(this, "hasSegmentsDefined"), H(this, "text"), H(this, "BBBCCCVVVS"), H(this, "longHashCode"), H(this, "versification"), H(this, "rtlMark", "‏"), H(this, "_bookNum", 0), H(this, "_chapterNum", 0), H(this, "_verseNum", 0), H(this, "_verse"), i == null && a == null)
      if (e != null && typeof e == "string") {
        const o = e, h = n != null && n instanceof Ve ? n : void 0;
        this.setEmpty(h), this.parse(o);
      } else if (e != null && typeof e == "number") {
        const o = n != null && n instanceof Ve ? n : void 0;
        ...
        if (e != null && e instanceof X) {
          ...
          if (e == null) return;
          const o = e instanceof Ve ? e : X.defaultVersification;
          this.setEmpty(o);
        }
      else
  ...
  static fromJSON(e) {
    ...
    let p;
    return h && (p = new Ve(h)), n ? new X(n, i.toString(), l, p) : new X();
  }
  /**
  ...
  parse(e) {
    ...
    if (i.length !== 2 || Be.bookIdToNumber(n[0]) === 0 || !Number.isInteger(a) || a < 0 || !X.isVerseParseable(i[1]))
      throw new Ct("Invalid reference : " + e);
  ...
  allVerses(e = !1, n = X.verseRangeSeparators, i = X.verseSequenceIndicators) {
    if (this._verse == null || this.chapterNum <= 0)
      return [this.clone()];
    const a = [], o = tr(this._verse, i);
    for (const h of o.map((l) => tr(l, n))) {
      const l = this.clone();
      l.verse = h[0];
      const p = l.verseNum;
...
function Lr() {
  ...
  var w = n(v), b = a("[", w, n(/[-.0-9\xB7]/), n(/[\u0300-\u036F\u203F-\u2040]/), "]"), C = a(v, b, "*"), k = a(b, "+"), x = a("&", C, ";"), F = o(/&#[0-9]+;|&#x[0-9a-fA-F]+;/), q = o(x, "|", F), ue = a("%", C, ";"), he = o(
    ...
    "|",
    a("'", o(/[^%&']/, "|", ue, "|", q), "*", "'")
  ), D = o('"', o(/[^<&"]/, "|", q), "*", '"', "|", "'", o(/[^<&']/, "|", q), "*", "'"), R = i(v, ":"), L = i(b, ":"), V = a(R, L, "*"), Y = a(V, o(":", V), "?"), ee = a("^", Y, "$"), we = a("(", Y, ")"), te = o(/"[^"]*"|'[^']*'/), Re = a(/^<\?/, "(", C, ")", o(E, "(", l, "*?)"), "?", /\?>/), d = /[\x20\x0D\x0Aa-zA-Z0-9-'()+,./:=?;!*#@$_%]/, A = o('"', d, '*"', "|", "'", i(d, "'"), "*'"), S = "<!--", O = "-->", B = a(S, o(i(l, "-"), "|", a("-", i(l, "-"))), "*", O), N = "#PCDATA", M = o(
    a(/\(/, f, N, o(f, /\|/, f, Y), "*", f, /\)\*/),
    "|",
    a(/\(/, f, N, f, /\)/)
  ), G = /[?*+]?/, _ = a(
  ...
  ), it = o(E, "NDATA", E, C), qe = o(he, "|", o(xe, it, "?")), $e = "<!ENTITY", ot = a($e, E, C, E, qe, f, ">"), Q = o(he, "|", xe), ge = a($e, E, "%", E, C, E, Q, f, ">"), le = o(ot, "|", ge), Je = a(ce, E, A), at = a("<!NOTATION", E, C, E, o(xe, "|", Je), f, ">"), Le = a(f, "=", f), Xe = /1[.]\d+/, U = a(E, "version", Le, o("'", Xe, "'", "|", '"', Xe, '"')), ie = /[A-Za-z][-A-Za-z0-9._]*/, De = o(E, "encoding", Le, o('"', ie, '"', "|", "'", ie, "'")), Ne = o(E, "standalone", Le, o("'", o("yes", "|", "no"), "'", "|", '"', o("yes", "|", "no"), '"')), je = a(/^<\?xml/, U, De, "?", Ne, "?", f, /\?>/), Ye = "<!DOCTYPE", st = "<![CDATA[", ct = "]]>", lt = /<!\[CDATA\[/, vt = /\]\]>/, At = a(l, "*?", vt), ft = a(lt, At);
  return j.chars = n, j.chars_without = i, j.detectUnicodeSupport = t, j.reg = a, j.regg = o, j.AttlistDecl = ze, j.CDATA_START = st, j.CDATA_END = ct, j.CDSect = ft, j.Char = l, j.Comment = B, j.COMMENT_START = S, j.COMMENT_END = O, j.DOCTYPE_DECL_START = Ye, j.elementdecl = P, j.EntityDecl = le, j.EntityValue = he, j.ExternalID = xe, j.ExternalID_match = Pe, j.Name = C, j.NotationDecl = at, j.Reference = q, j.PEReference = ue, j.PI = Re, j.PUBLIC = ce, j.PubidLiteral = A, j.QName = Y, j.QName_exact = ee, j.QName_group = we, j.S = E, j.SChar_s = m, j.S_OPT = f, j.SYSTEM = Ae, j.SystemLiteral = te, j.UNICODE_REPLACEMENT_CHARACTER = h, j.UNICODE_SUPPORT = e, j.XMLDecl = je, j;
}
var ir;
function Fr() {
  if (ir) return ne;
  ir = 1;
  var t = Dt(), e = t.find, n = t.hasDefaultHTMLNamespace, i = t.hasOwn, a = t.isHTMLMimeType, o = t.isHTMLRawTextElement, h = t.isHTMLVoidElement, l = t.MIME_TYPE, p = t.NAMESPACE, m = Symbol(), E = Mt(), f = E.DOMException, v = E.DOMExceptionName, w = Lr();
  function b(r) {
    if (r !== m)
...
function vn() {
  if (ar) return yt;
  ar = 1;
  var t = Dt(), e = Lr(), n = Mt(), i = t.isHTMLEscapableRawTextElement, a = t.isHTMLMimeType, o = t.isHTMLRawTextElement, h = t.hasOwn, l = t.NAMESPACE, p = n.ParseError, m = n.DOMException, E = 0, f = 1, v = 2, w = 3, b = 4, C = 5, k = 6, x = 7;
  function F() {
  }
  F.prototype = {
...
function An() {
  if (sr) return et;
  sr = 1;
  var t = Dt(), e = Fr(), n = Mt(), i = Dn(), a = vn(), o = e.DOMImplementation, h = t.hasDefaultHTMLNamespace, l = t.isHTMLMimeType, p = t.isValidMimeType, m = t.MIME_TYPE, E = t.NAMESPACE, f = n.ParseError, v = a.XMLReader;
  function w(D) {
    return D.replace(/\r[\n\u0085]/g, `
`).replace(/[\r\u0085\u2028]/g, `
`);
...
function wn(t, e) {
  ...
  let i = 0, a = 0;
  function o(l, p, m) {
    const E = tt(t, a, p), f = n.length > 0 && He(n[n.length - 1]) ? `${n.pop()}${E}` : E;
    He(l) ? n.push(`${f}${l}`) : (f && n.push(f), n.push(l)), a = p + m;
  }
  const h = pe(t);
  for (; i < h; ) {
    switch (Et(t, i)) {
  ...
  if (a < h) {
    const l = tt(t, a);
    n.push(
      n.length > 0 && He(n[n.length - 1]) ? `${n.pop()}${l}` : l
    );
  }
  return n;
}
...
function hr(t, e, n) {
  ...
  if (e > i || n && (e > n && !(e >= 0 && e < i && n < 0 && n > -i) || n < -i))
    return "";
  const a = pr(i, e), o = n ? pr(i, n) : void 0;
  return tt(t, a, o);
}
function dr(t, e, n) {
  const i = [];
  ...
  let a = e;
  (typeof e == "string" || e instanceof RegExp && !Sn(e.flags, "g")) && (a = new RegExp(e, "g"));
  const o = t.match(a);
  let h = 0;
  if (!o) return [t];
...
const $t = ["chapter", "book", "para", "row", "sidebar", qt], xn = "​", $r = [
...
], Mn = 1, Bn = $r.length - 1, _n = 1, Pn = 1, ii = {
  bookNum: 1,
  chapterNum: 1,
  verseNum: 1
}, Ln = (t) => {
  ...
  bookNum: Math.max(Mn, Math.min(t.bookNum + e, Bn)),
  chapterNum: 1,
  verseNum: 1
}), ai = (t, e) => ({
  ...t,
...
function pi(t, e, n, i) {
  ...
  switch (e ?? "id") {
    case "English":
      a = Be.bookNumberToEnglishName(t.bookNum);
      break;
    case "id":
      a = Be.bookNumberToId(t.bookNum);
      break;
    default:
      a = e ?? "";
      break;
...
function gr(t) {
  ...
  for (let a = 0; a < t.length; a += 1) {
    const o = t[a];
    o.charCodeAt(0) < 32 ? (n || (e += " "), n = !0) : !n && o === xn && a + 1 < t.length && Er(t[a + 1]) || (Er(o) ? (n || (e += o), n = !0) : $n(o) && i === o || (e += o, n = !1)), i = o;
  }
  return e;
}
function Dr(t) {
...
function jr(t, e, n, i) {
  ...
  if (a && o) {
    const h = gr(t), l = gr(n);
    if (h !== l) {
      if (!mt(Ot(h, -1) ?? "") && !mt(Ot(l, -1) ?? "") || !vr(t, e) || !vr(n, i)) return !1;
      let p = h;
    ...
    const m = Dr(h.content), E = Dr(l.content);
    if (m !== E) return !1;
    if (!m && !E) {
      let f = h.content, v = l.content;
      const w = f[f.length - 1];
      $t.includes(h.type) && He(w) && mt(w) && (f = f.slice(0, -1));
      const b = v[v.length - 1];
      if ($t.includes(l.type) && He(b) && mt(b) && (v = v.slice(0, -1)), f.length !== v.length) return !1;
...
function Tt(t, e, n) {
  var i = Nr(t), a = i.length;
  if (Nr(e).length !== a)
    return !1;
  for (var o, h, l; a-- > 0; )
    if (o = i[a], !Ur(t, e, n, o) || (h = br(t, o), l = br(e, o), (h || l) && (!h || !l || h.configurable !== l.configurable || h.enumerable !== l.enumerable || h.writable !== l.writable)))
      return !1;
  return !0;
}
function eu(t, e) {
...
function gu(t) {
  ...
  return function(b, C, k) {
    ...
    if (F === Set)
      return E(b, C, k);
    var q = Eu(b);
    return q === ou ? n(b, C, k) : q === fu ? m(b, C, k) : q === su ? o(b, C, k) : q === pu ? E(b, C, k) : q === lu ? typeof b.then != "function" && typeof C.then != "function" && l(b, C, k) : q === du ? v(b, C, k) : q === au ? i(b, C, k) : q === uu ? l(b, C, k) : q === iu || q === cu || q === hu ? p(b, C, k) : !1;
  };
}
function Du(t) {
...
function Ge(t) {
  t === void 0 && (t = {});
  var e = t.circular, n = e === void 0 ? !1 : e, i = t.createInternalComparator, a = t.createState, o = t.strict, h = o === void 0 ? !1 : o, l = Du(t), p = gu(l), m = i ? i(p) : vu(p);
  return Au({ circular: n, comparator: p, createState: a, equals: m, strict: h });
}
function bu(t, e) {
  return Nu(t, e);
}
function Cu(t, e) {
  ...
  return Object.keys(n).forEach((o) => {
    a && (Object.hasOwn(i, o) && Cu(i[o], n[o]) || (a = !1));
  }), a;
}
function Or(t, e, n) {
...
function yu(t, e) {
  ...
  function i(h, l) {
    if (l && typeof l == "object" && "book" in l && typeof l.book == "string" && "chapterNum" in l && typeof l.chapterNum == "number" && "verseNum" in l && typeof l.verseNum == "number" && Object.keys(l).every(
      ...
      const p = l.chapterNum.toString(10), m = "verse" in l && typeof l.verse == "string" ? l.verse : l.verseNum.toString(10), E = "versificationStr" in l && typeof l.versificationStr == "string" ? new Ve(l.versificationStr) : void 0;
      return new Ht(l.book, p, m, E);
    }
    return l;
  }
  function a(h, l) {
...
function Ai(t, e, n = /* @__PURE__ */ new Date()) {
  const i = Math.floor((e.getTime() - n.getTime()) / Tu), a = Math.round(i / wu);
  if (Math.abs(a) >= 1) return t.format(a, "day");
  const o = Math.round(i / Hr);
...
class Ee {
  ...
  nodeToVerseRefAndOffset(e, n, i) {
    ...
    return o.startingContentNode !== void 0 && this.findNextMatchingNode(o.startingContentNode, [], (p, m) => {
      var E, f;
      return p === n ? !0 : m.find((v) => ke.includes(v.parent.type)) ? !1 : typeof p == "string" ? (l += p.length, !1) : p.type === It && p.number !== ((E = o.chapterNum) == null ? void 0 : E.toString()) || p.type === Rt && p.number !== ((f = o.verseNum) == null ? void 0 : f.toString()) ? (l = 0, !0) : !1;
    }), { verseRef: h, offset: l };
  }
  // #endregion
  ...
  verseRefToUsjContentLocation(e, n = 0) {
    ...
    const l = e.verse, p = this.findNextMatchingNode(
      a,
      ke,
      (v, w) => v === a ? e.verseNum === 0 ? (h = Ee.convertWorkingStackToJsonPath(w), !0) : !1 : typeof v != "object" ? !1 : v.type === It ? (o = !0, !0) : v.type === Rt && v.number !== void 0 && v.number === l ? (h = Ee.convertWorkingStackToJsonPath(w), !0) : !1
    );
