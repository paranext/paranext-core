...
import { D as rr, F as nr, a as ir, b as sr, G as ar, L as or, M as cr, S as dr, c as pr, e as lr, f as ur, g as hr, h as fr, j as mr, k as gr, l as yr, m as kr, n as br, o as vr, p as Mr, q as xr, r as _r, s as Er, t as Ir, u as wr, v as Sr, w as Pr, x as Tr, y as Cr, z as Ar, A as qr, B as $r, C as Nr, E as jr, H as Or, I as Ur, J as Fr, K as Rr, N as Dr, O as Lr, P as Br, Q as Vr, R as zr, T as Hr, U as Jr, V as Kr, W as Gr, X as Yr, Y as Xr, Z as Wr, _ as Zr, $ as Qr, a0 as en, a1 as tn, a2 as rn, a3 as nn, a4 as sn, a5 as an, a6 as on, a7 as cn, a8 as dn, a9 as pn, aa as ln, ab as un, ac as hn, ad as fn } from "./scripture-util-DArajUVn.js";
...
const Ut = (n) => n.replace(/&/g, "&amp;").replace(/</g, "&lt;").replace(/>/g, "&gt;").replace(/"/g, "&quot;").replace(/'/g, "&#x27;").replace(/\//g, "&#x2F;");
function Ft() {
...
const Ne = 1e3, ne = 60, ie = ne * 60, je = ie * 24;
function Vt(n, e, t = /* @__PURE__ */ new Date()) {
  const r = Math.floor((e.getTime() - t.getTime()) / Ne), s = Math.round(r / je);
  ...
  search(e, t) {
    ...
    for (; f; ) {
      if (f[0].length > 0) {
        ...
        }, j = u ? b.substring(y, v) : f[0];
        i.push({ text: j, start: M, end: I });
      }
      if (!e.global) break;
      f = e.exec(h);
    }
    ...
    return s.push({ fragment: e, indexInUsfm: r.length }), r += p === "optbreak" ? "//" : `\\${b}`, p !== "optbreak" && (s.push({
      ...
      s.push({
        ...
        if ("isClosingMarker" in M.fragment) {
          const { isClosingMarker: x, ...I } = M.fragment, j = {
            ...I,
            forMarker: e,
...
`) && (i.length === 0 ? (p = p.map((u) => ({
 ...
 `);
  ...
  static areUsjDocumentLocationsEqual(e, t, r = !1) {
    ...
    return !r && !U(P.toPathArray(s), P.toPathArray(c)) ? !1 : U(i, p);
  }
...
export {
  ...
  dt as CANCELLED,
  K as CHAPTER_TYPE,
  Tt as CONTENT_ZOOM_IN_SHORTCUT,
  Ct as CONTENT_ZOOM_OUT_SHORTCUT,
  At as CONTENT_ZOOM_RESET_SHORTCUT,
  o as CategoryType,
  et as Collator,
  pt as DATA_LOSS,
  lt as DEADLINE_EXCEEDED,
  rr as DEBOUNCE_CANCELED_ERROR_MESSAGE,
  fe as DateTimeFormat,
  ye as DocumentCombiner,
  tt as EventRollingTimeCounter,
  ut as FAILED_PRECONDITION,
  nr as FIRST_SCR_BOOK_NUM,
  ir as FIRST_SCR_CHAPTER_NUM,
  sr as FIRST_SCR_VERSE_NUM,
  ar as GraphemeString,
  ht as INTERNAL,
  ft as INVALID_ARGUMENT,
  or as LAST_SCR_BOOK_NUM,
  cr as MAX_PADDING_LENGTH,
  ...
  dr as SELECTABLE_INVISIBLE_CHAR_OR_WHITESPACE_CLASS,
  pr as Section,
  ...
  Qt as USFM_MARKERS_MAP_PARATEXT_3_0,
  at as UnsubscriberAsyncList,
  g as UsjReaderWriter,
  w as VERSE_TYPE,
  _e as ZOOM_STEP,
  qt as adjustZoomFactor,
  wt as aggregateUnsubscriberAsyncs,
  It as aggregateUnsubscribers,
  Zt as applyThemeStylesheet,
  lr as areUsjContentsEqualExceptWhitespace,
  ur as at,
  hr as charAt,
  Ee as clampZoom,
  fr as codePointAt,
  mr as collapseMiddleWords,
  gr as collectUsjMarkers,
  qe as compareProjectShortNames,
  Bt as compareProjectsByName,
  yr as compareScrRefs,
  Kt as computeEffectiveStructureProtection,
  kr as createSyncProxyForAsyncObject,
  br as debounce,
  C as deepClone,
  U as deepEqual,
  vr as defaultScrRef,
  Te as deserialize,
  Xt as doesCatalogRowCoverProject,
  Mr as endsWith,
  xr as ensureArray,
  _r as escapeStringRegexp,
  Wt as expandThemeContribution,
  Rt as formatBytes,
  Lt as formatProjectName,
  zt as formatRelativeDate,
  Er as formatReplacementString,
  Ir as formatReplacementStringToArray,
  wr as formatScrRef,
  Sr as formatScrRefRange,
  Vt as formatTimeSpan,
  Pr as getAllObjectFunctionNames,
  Tr as getChaptersForBook,
  Ft as getCurrentLocale,
  re as getDefaultCallerSequence,
  Cr as getErrorMessage,
  Nt as getFormatCallerFunction,
  Jt as getLocalizeKeyForPhysicalKey,
  Ar as getLocalizeKeyForScrollGroupId,
  qr as getLocalizeKeysForScrollGroupIds,
  $r as getLocalizedIdFromBookNumber,
  we as getNthCaller,
  jt as getPaneSizeLimits,
  Nr as getSectionForBook,
  ...
  Fr as isErrorMessageAboutParatextBlockingInternetAccess,
  Rr as isErrorMessageAboutRegistryAuthFailure,
  Dr as isLocalizeKey,
  Et as isPlatformError,
  Lr as isSelectableInvisibleCharOrWhiteSpace,
  Ot as isSerializable,
  _ as isString,
  Pe as isSubset,
  Br as isWhiteSpace,
  Vr as isolateBidi,
  zr as lastIndexOf,
  Fe as localizedStringsDocumentSchema,
  Gt as makeProjectSelectorCustomData,
  Re as menuDocumentSchema,
  Hr as newGuid,
  _t as newPlatformError,
  Jr as normalize,
  $e as normalizeFullName,
  Dt as normalizeProjectId,
  Kr as normalizeScriptureSpaces,
  Gr as offsetBook,
  Yr as offsetChapter,
  Xr as offsetVerse,
  ...
  Yt as recencyMapFromOrderedIds,
  en as retryUntil,
  Ie as roundZoom,
  $t as sanitizeHtml,
  tn as scrRefToBBBCCC,
  rn as scrRefToBBBCCCVVV,
  W as serialize,
  Ue as settingsDocumentSchema,
  nn as slice,
  sn as split,
  an as startsWith,
  on as stringLength,
  ...
  dn as toArray,
  pn as toKebabCase,
  ln as transformAndEnsureRegExpArray,
  un as transformAndEnsureRegExpRegExpArray,
  te as usfmMarkers,
  hn as wait,
  fn as waitForDuration
};
