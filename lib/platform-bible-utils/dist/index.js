...
import { length as Me, indexOf as Se, limit as ae, substring as Ae, toArray as Ee, substr as Te } from "stringz";
...
function ze(n, e, t) {
  if (e < 0) return -1;
  if (t) {
    if (T(n, e) === "}" && T(n, e - 1) === "\\") return e;
    const s = U(n, "\\}", e);
    return s >= 0 ? s + 1 : s;
  }
  let r = e;
  const i = N(n);
  for (; r < i && (r = U(n, "}", r), !(r === -1 || T(n, r - 1) !== "\\")); )
    r += 1;
  return r >= i ? -1 : r;
}
function qe(n, e) {
...
function Pr(n, e, t = /* @__PURE__ */ new Date()) {
    ...
    for (; c !== void 0; )
      c = m.findNextMatchingNodeUsingWorkingStack(
        ...
        (d, f) => (typeof d != "string" || t && f.some((h) => {
          ...
          if (!g) return !1;
          let v;
          return "style" in g && typeof g.style == "string" ? v = g.style : "marker" in g && typeof g.marker == "string" && (v = g.marker), v !== void 0 && !t.has(v);
        }) || (s.push(d), o.set(a, {
          node: d,
          documentLocation: {
            offset: 0,
...
`);
    ...
    return i.push({ fragment: e, indexInUsfm: r.length }), r += a === "optbreak" ? "//" : `\\${d}`, a !== "optbreak" && (i.push({
      ...
      i.push({
        ...
        if (m.isFragmentAMarker(k.fragment)) {
          i.push({
            ...k,
            fragment: {
  ...
  closingMarkerToUsfm(e, t) {
    ...
    if ((u.closed === "false" || s.isClosingMarkerOptional && !this.markersMap.shouldOptionalClosingMarkersBePresent && u.closed !== "true") && (d = !1), s.independentClosingMarkers && s.independentClosingMarkers.length > 0 && d) {
      ...
      let g = "";
      const v = [], { usfm: w, fragmentsInfo: k } = this.openingMarkerToUsfm(h, t), F = k.find((A) => m.isFragmentAMarker(A.fragment));
      if (!F)
        throw new Error(
...
`) && (s.length === 0 ? (a = a.map((f) => ({
 ...
 `);
  ...
  static areUsjDocumentLocationsEqual(e, t, r = !1) {
    ...
    return !r && !J(P.toPathArray(i), P.toPathArray(o)) ? !1 : J(s, a);
  }
...
export {
  ...
  kr as areUsjContentsEqualExceptWhitespace,
  D as at,
  T as charAt,
  Zt as codePointAt,
