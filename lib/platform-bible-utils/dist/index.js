...
var h = (t, e, r) => (oe(t, typeof e != "symbol" ? e + "" : e, r), r);
...
function dt(t, e, r) {
  ...
  return t.forEach((i) => {
    const n = e(i), a = s.get(n), o = r ? r(i, n) : i;
    a ? a.push(o) : s.set(n, [o]);
  }), s;
}
function ce(t) {
...
class he {
  ...
  updateBaseDocument(e) {
    return this.validateStartingDocument(e), this.baseDocument = this.options.copyDocuments ? E(e) : e, this.baseDocument = this.transformValidatedStartingDocument(this.baseDocument), this.rebuild();
  }
  /**
  ...
  addOrUpdateContribution(e, r) {
    ...
    i = this.transformValidatedContribution(e, i), this.contributions.set(e, i);
    try {
      return this.rebuild();
    } catch (n) {
  ...
  rebuild() {
    if (this.contributions.size === 0) {
      ...
      return r = this.transformFinalOutput(r), this.validateOutput(r), this.latestOutput = r, this.onDidRebuildEmitter.emit(void 0), this.latestOutput;
    }
    ...
    }), e = this.transformFinalOutput(e), this.validateOutput(e), this.latestOutput = e, this.onDidRebuildEmitter.emit(void 0), this.latestOutput;
  }
  /**
  ...
  transformValidatedStartingDocument(e) {
    return e;
  }
  /**
  ...
  // classes to override
  // eslint-disable-next-line class-methods-use-this
  transformValidatedContribution(e, r) {
    return r;
  }
}
function x(...t) {
...
var I = typeof globalThis < "u" ? globalThis : typeof window < "u" ? window : typeof global < "u" ? global : typeof self < "u" ? self : {}, y = {}, Ne = () => {
  const t = "\\ud800-\\udfff", e = "\\u0300-\\u036f", r = "\\ufe20-\\ufe2f", s = "\\u20d0-\\u20ff", i = "\\u1ab0-\\u1aff", n = "\\u1dc0-\\u1dff", a = e + r + s + i + n, o = "\\ufe0e\\ufe0f", c = "\\uD83D\\uDC69\\uD83C\\uDFFB\\u200D\\uD83C\\uDF93", p = `[${t}]`, u = `[${a}]`, l = "\\ud83c[\\udffb-\\udfff]", f = `(?:${u}|${l})`, g = `[^${t}]`, m = "(?:\\uD83C[\\uDDE6-\\uDDFF]){2}", N = "[\\ud800-\\udbff][\\udc00-\\udfff]", P = "\\u200d", ee = "(?:\\ud83c\\udff4\\udb40\\udc67\\udb40\\udc62\\udb40(?:\\udc65|\\udc73|\\udc77)\\udb40(?:\\udc6e|\\udc63|\\udc6c)\\udb40(?:\\udc67|\\udc74|\\udc73)\\udb40\\udc7f)", te = `[${c}]`, T = `${f}?`, M = `[${o}]?`, re = `(?:${P}(?:${[g, m, N].join("|")})${M + T})*`, se = M + T + re, ie = `(?:${[`${g}${u}?`, u, m, N, p, te].join("|")})`;
...
function Ae(t, e, r) {
  ...
  for (a = r; a < s.length; a += 1) {
    for (var o = 0; o < i.length && i[o] === s[a + o]; )
      o += 1;
    if (o === i.length && i[o - 1] === s[a + o - 1]) {
      n = !0;
      break;
    }
  }
...
function xt(t, e, r) {
  ...
  if (e > s || r && (e > r && !(e > 0 && e < s && r < 0 && r > -s) || r < -s || e < 0 && e > -s && r > 0))
    return "";
  const i = z(s, e), n = r ? z(s, r) : void 0;
  return O(t, i, n);
}
function Rt(t, e, r) {
  const s = [];
  ...
  if (!n)
    return [t];
  for (let o = 0; o < (r ? r - 1 : n.length); o++) {
    const c = q(t, n[o], a), p = d(n[o]);
...
function w(t) {
  return function(r, s, i) {
    if (!r || !s || typeof r != "object" || typeof s != "object")
      return t(r, s, i);
    var n = i.cache, a = n.get(r), o = n.get(s);
    if (a && o)
      return a === s && o === r;
    n.set(r, s), n.set(s, r);
    var c = t(r, s, i);
...
var Q = "_owner", _ = Object.getOwnPropertyDescriptor, J = Object.keys;
function Ie(t, e, r) {
  var s = t.length;
  if (e.length !== s)
    return !1;
...
function V(t, e, r) {
  if (t.size !== e.size)
    return !1;
  for (var s = {}, i = t.entries(), n = 0, a, o; (a = i.next()) && !a.done; ) {
    for (var c = e.entries(), p = !1, u = 0; (o = c.next()) && !o.done; ) {
      var l = a.value, f = l[0], g = l[1], m = o.value, N = m[0], P = m[1];
...
function $(t, e, r) {
  ...
  if (G(e).length !== i)
    return !1;
  for (var n, a, o; i-- > 0; )
    if (n = s[i], n === Q && (t.$$typeof || e.$$typeof) && t.$$typeof !== e.$$typeof || !X(e, n) || !r.equals(t[n], e[n], n, n, t, e, r) || (a = _(t, n), o = _(e, n), (a || o) && (!a || !o || a.configurable !== o.configurable || a.enumerable !== o.enumerable || a.writable !== o.writable)))
      return !1;
  return !0;
}
function Ge(t, e) {
...
function K(t, e, r) {
  if (t.size !== e.size)
    return !1;
  for (var s = {}, i = t.values(), n, a; (n = i.next()) && !n.done; ) {
    for (var o = e.values(), c = !1, p = 0; (a = o.next()) && !a.done; )
      !c && !s[p] && (c = r.equals(n.value, a.value, n.value, a.value, t, e, r)) && (s[p] = !0), p++;
    if (!c)
      return !1;
  }
  return !0;
...
function Ye(t) {
  var e = t.areArraysEqual, r = t.areDatesEqual, s = t.areMapsEqual, i = t.areObjectsEqual, n = t.arePrimitiveWrappersEqual, a = t.areRegExpsEqual, o = t.areSetsEqual, c = t.areTypedArraysEqual;
  return function(u, l, f) {
    ...
    if (g === Set)
      return o(u, l, f);
    var m = Qe(u);
    return m === Fe ? r(u, l, f) : m === We ? a(u, l, f) : m === Ue ? s(u, l, f) : m === Le ? o(u, l, f) : m === He ? typeof u.then != "function" && typeof l.then != "function" && i(u, l, f) : m === Ve ? i(u, l, f) : m === Ke || m === ke || m === Ze ? n(u, l, f) : !1;
  };
}
function et(t) {
  var e = t.circular, r = t.createCustomConfig, s = t.strict, i = {
    areArraysEqual: s ? $ : Ie,
    areDatesEqual: ze,
    areMapsEqual: s ? B(V, $) : V,
    areObjectsEqual: s ? $ : Be,
    arePrimitiveWrappersEqual: Ge,
    areRegExpsEqual: _e,
    areSetsEqual: s ? B(K, $) : K,
    areTypedArraysEqual: s ? $ : Je
  };
  if (r && (i = U({}, i, r(i))), e) {
    var n = w(i.areArraysEqual), a = w(i.areMapsEqual), o = w(i.areObjectsEqual), c = w(i.areSetsEqual);
    i = U({}, i, {
      areArraysEqual: n,
      areMapsEqual: a,
      areObjectsEqual: o,
...
function b(t) {
  t === void 0 && (t = {});
  var e = t.circular, r = e === void 0 ? !1 : e, s = t.createInternalComparator, i = t.createState, n = t.strict, a = n === void 0 ? !1 : n, o = et(t), c = Ye(o), p = s ? s(c) : tt(c);
...
const Gt = (t) => t.replace(/&/g, "&amp;").replace(/</g, "&lt;").replace(/>/g, "&gt;").replace(/"/g, "&quot;").replace(/'/g, "&#x27;").replace(/\//g, "&#x2F;"), nt = {
...
export {
  ...
  Tt as padEnd,
  Mt as padStart,
  ot as projectSettingsDocumentSchema,
  k as serialize,
