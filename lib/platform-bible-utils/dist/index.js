...
var ee = (o, e, t) => e in o ? Q(o, e, { enumerable: !0, configurable: !0, writable: !0, value: t }) : o[e] = t;
var k = (o, e, t) => ee(o, typeof e != "symbol" ? e + "" : e, t);
import { d as C, i as _ } from "./scripture-util-DArajUVn.js";
import { D as qt, F as At, a as $t, b as jt, G as Nt, L as Ft, M as Ot, S as Ut, c as Rt, e as Dt, f as Lt, g as Bt, h as Vt, j as zt, k as Ht, l as Jt, m as Kt, n as Gt, o as Yt, p as Xt, q as Wt, r as Zt, s as Qt, t as er, u as tr, v as rr, w as nr, x as ir, y as sr, z as ar, A as or, B as cr, C as dr, E as pr, H as lr, I as ur, J as hr, K as fr, N as mr, O as gr, P as yr, Q as kr, R as br, T as vr, U as Mr, V as xr, W as _r, X as Ir, Y as Er, Z as wr, _ as Sr, $ as Pr, a0 as Tr, a1 as Cr, a2 as qr, a3 as Ar, a4 as $r, a5 as jr, a6 as Nr, a7 as Fr, a8 as Or, a9 as Ur, aa as Rr, ab as Dr, ac as Lr, ad as Br } from "./scripture-util-DArajUVn.js";
import { Mutex as te } from "async-mutex";
import re from "dompurify";
import { deepEqual as ne } from "fast-equals";
import { USJ_TYPE as ie } from "@eten-tech-foundation/scripture-utilities";
...
function ae(o) {
  return typeof o == "object" && !!o && "then" in o && typeof o.then == "function" && "catch" in o && typeof o.catch == "function";
}
class oe {
  constructor() {
    /**
...
class ce {
  ...
  constructor(e, t) {
    ...
    k(this, "latestOutput");
    k(this, "options");
    k(this, "onDidRebuildEmitter", new oe());
...
class Re {
  ...
  get(e) {
    ...
    return t || (t = new pe(), this.mutexesByID.set(e, t), t);
  }
  /**
...
class Le {
  ...
  cleanupPromiseChain(e) {
    ...
    if (!t) return;
    const r = { promise: ue }, i = t.catch((n) => this.logger.warn(`Error in promise for ${e}: ${n.message}`)).finally(() => {
...
const ze = "ABORTED", He = "ALREADY_EXISTS", Je = "CANCELLED", Ke = "DATA_LOSS", Ge = "DEADLINE_EXCEEDED", Ye = "FAILED_PRECONDITION", Xe = "INTERNAL", We = "INVALID_ARGUMENT", Ze = "NOT_FOUND", Qe = "OUT_OF_RANGE", et = "PERMISSION_DENIED", tt = "RESOURCE_EXHAUSTED", rt = "UNAUTHENTICATED", nt = "UNAVAILABLE", it = "UNIMPLEMENTED", st = "UNKNOWN", A = 1;
function at(o, e) {
  if (!o)
    return {
      message: "",
  ...
  if (typeof o == "object" && "message" in o && typeof o.message == "string") {
    const t = {
      message: o.message,
      platformErrorVersion: A
    };
    return Object.defineProperties(t, Object.getOwnPropertyDescriptors(o)), Object.defineProperty(t, "message", { enumerable: !0 }), "stack" in o && _(o.stack) && Object.defineProperty(t, "stack", { value: o.stack, enumerable: !0 }), "cause" in t && Object.defineProperty(t, "cause", { enumerable: !0 }), e && (t.code = e), t;
  }
  return {
    cause: o,
    message: "",
...
function ot(o) {
  return !!o && typeof o == "object" && "platformErrorVersion" in o;
}
const ct = (o) => (...e) => o.map((r) => r(...e)).every((r) => r), dt = (o) => async (...e) => {
  const t = o.map(async (r) => r(...e));
  return (await Promise.all(t)).every((r) => r);
}, B = "book", V = "chapter", w = "verse", S = "***";
var a = /* @__PURE__ */ ((o) => (o.FileIdentification = "FileIdentification", o.Headers = "Headers", o.Remarks = "Remarks", o.Introduction = "Introduction", o.DivisionMarks = "DivisionMarks", o.Paragraphs = "Paragraphs", o.Poetry = "Poetry", o.TitlesHeadings = "TitlesHeadings", o.Tables = "Tables", o.CenterTables = "CenterTables", o.RightTables = "RightTables", o.Lists = "Lists", o.Footnotes = "Footnotes", o.CrossReferences = "CrossReferences", o.SpecialText = "SpecialText", o.CharacterStyling = "CharacterStyling", o.Breaks = "Breaks", o.SpecialFeatures = "SpecialFeatures", o.PeripheralReferences = "PeripheralReferences", o.PeripheralMaterials = "PeripheralMaterials", o.Uncategorized = "Uncategorized", o))(a || {}), s = /* @__PURE__ */ ((o) => (o.Paragraph = "Paragraph", o.Character = "Character", o.Note = "Note", o.Unknown = "Unknown", o))(s || {});
const J = {
  id: {
...
function pt(o) {
  var e;
  return ((e = J[o]) == null ? void 0 : e.type) === s.Paragraph || o === "v";
}
function lt(o) {
  const e = J[o];
  return (e == null ? void 0 : e.type) !== s.Character ? !1 : e.category !== a.DivisionMarks;
}
function ut(o) {
  return re.sanitize(o, {
    ALLOWED_TAGS: [
      "p",
      "br",
      "b",
...
function K() {
  return Array.from({ length: 26 }, (o, e) => String.fromCharCode(97 + e));
}
function he(o, e) {
  const t = e && e.length > 0 ? e : K();
  return t[o % t.length];
}
function ht(o, e) {
  const t = e && e.length > 0 ? e : K(), r = (() => {
    const i = /* @__PURE__ */ new Map();
    let n = 0;
    return o.forEach((c, d) => {
      c.caller === "+" && (i.set(d, he(n, t)), n += 1);
    }), i;
  })();
  return (i, n) => {
    if (i === "+") {
...
function ft(o, e = {}) {
  ...
  let l, p;
  return d < r + i ? (l = n, p = c) : (p = Math.min(
    Math.floor((d - i) / d * 100),
    c
  ), l = Math.min(
    Math.max(Math.ceil(r / d * 100), n),
    p
...
function me(o, e) {
  if (typeof o != typeof e) return !1;
  if (!o && !e) return !0;
  if (Array.isArray(o)) {
    const n = e, c = o;
    return n.length === 0 ? !0 : n.every((d) => c.includes(d));
  }
  if (typeof o != "object")
    return N(o, e);
  const t = e, r = o;
...
const gt = (o) => o.replace(/&/g, "&amp;").replace(/</g, "&lt;").replace(/>/g, "&gt;").replace(/"/g, "&quot;").replace(/'/g, "&#x27;").replace(/\//g, "&#x2F;");
function yt() {
...
function kt(o, e = 2) {
  ...
  const t = ["Bytes", "KB", "MB", "GB", "TB", "PB", "EB", "ZB", "YB"], r = Math.floor(Math.log(o) / Math.log(1024)), i = t[r];
  return `${new le("en", {
    style: "decimal",
...
const ye = 1e3, G = 60, Y = G * 60, ke = Y * 24;
function vt(o, e, t = /* @__PURE__ */ new Date()) {
  const r = Math.floor((e.getTime() - t.getTime()) / ye), i = Math.round(r / ke);
  if (Math.abs(i) >= 1) return o.format(i, "day");
  const n = Math.round(r / Y);
  if (Math.abs(n) >= 1) return o.format(n, "hour");
  const c = Math.round(r / G);
  return Math.abs(c) >= 1 ? o.format(c, "minute") : o.format(r, "second");
}
function Mt(o, e, t, r, i = {
  year: "numeric",
  month: "short",
  day: "numeric"
}) {
  ...
  const d = o.getDate() === n.getDate() && o.getMonth() === n.getMonth() && o.getFullYear() === n.getFullYear(), l = o.getDate() === c.getDate() && o.getMonth() === c.getMonth() && o.getFullYear() === c.getFullYear();
  return d ? e : l ? t : o.toLocaleString(r, i);
}
...
function _t(o) {
  return `%physicalKey_${o.charAt(0).toLowerCase()}${o.slice(1)}%`;
}
function It({
  interfaceMode: o,
  isAdminProtected: e,
...
Object.freeze(xe);
function Et(o, e) {
  return !o.installed && o.projectId === "" ? !1 : o.projectId !== "" && o.projectId === e ? !0 : o.dblEntryUid !== "" && e.toLowerCase().startsWith(o.dblEntryUid.toLowerCase());
}
const W = {
  themeCssVariables: {
          ...
          return [
            ...
            c ? {
              ...
              cssVariables: {
                ...
                ...(d = e == null ? void 0 : e[n]) == null ? void 0 : d.cssVariables,
                ...c.cssVariables
              }
            } : void 0
          ];
...
function we(o) {
  return `
.${o.id} {
${Object.entries(o.cssVariables).map(([e, t]) => `  --${e}: ${t};`).join(`
`)}
}
`;
}
function St(o, e, t) {
  ...
  r && this.document.body.classList.remove(r), this.document.body.classList.add(o.id), e && this.document.head.removeChild(e);
  const i = this.document.createElement("style");
  return i.id = `${Ie}${t ? `-${t}` : ""}`, i.dataset.themeId = o.id, i.textContent = we(o), this.document.head.appendChild(i), i;
}
function Z(o) {
  return Object.freeze(o), o == null || Object.getOwnPropertyNames(o).forEach(function(t) {
    // Need to make sure to avoid null, which is an object type
    // eslint-disable-next-line no-null/no-null
    o[t] !== null && (typeof o[t] == "object" || typeof o[t] == "function") && !Object.isFrozen(o[t]) && Z(o[t]);
  }), o;
}
const F = Z({
  version: "3.0.7",
...
class g {
  ...
  getBookIdForLogging() {
    ...
    const e = (t = this.usj.content) == null ? void 0 : t.find(
      (r) => typeof r != "string" && r.type === B && !!r.code
    );
  ...
  static isTopLevelUsjMarker(e, t) {
    return typeof e == "object" && e.type === ie && t.length === 0;
  }
  /**
    ...
    for (; n !== void 0; ) {
      ...
      if (
        ...
        !n.content.find((c, d) => {
          ...
          return t.unshift({ parent: n, index: d }), !0;
        })
      )
  ...
  convertJsonPathToWorkingStack(e) {
    ...
    return r.forEach((n, c) => {
      ...
      if (t.push({ parent: i, index: l }), c + 1 < r.length) {
  ...
  static findNextMatchingNodeOrClosingFragmentUsingWorkingStack(e, t, r, i) {
    ...
    if (!_(c)) {
      ...
      let l;
      t.some((p) => {
        const m = p.parent.content[p.index];
        return !_(m) && r.includes(m.type) ? (l = m, !0) : !1;
      }), l && (n = l);
    }
    for (; n !== void 0; ) {
      const l = typeof n == "object" && r.includes(n.type);
      if (!l && i(n, t)) return n;
      if (!l && typeof n == "object" && (((d = n.content) == null ? void 0 : d.length) ?? 0) > 0)
        t.push({ parent: n, index: 0 }), [n] = n.content;
      else {
        if (!l) {
          const p = typeof n == "object" ? { isClosingMarker: !0, forMarker: n } : void 0;
          if (p && i(p, t))
            return p;
        }
        for (n = void 0; t.length > 0; ) {
          ...
          if (p)
            if (p.index + 1 < p.parent.content.length) {
              p.index += 1, t.push(p), n = p.parent.content[p.index];
              break;
            } else {
              const m = {
                isClosingMarker: !0,
  ...
  static findNextMatchingNodeUsingWorkingStack(e, t, r, i) {
    return this.findNextMatchingNodeOrClosingFragmentUsingWorkingStack(
      ...
      t,
      r,
      (c, d) => typeof c == "object" && "isClosingMarker" in c ? !1 : i(c, d)
    );
  }
  findNextMatchingNode(e, t) {
    ...
    const n = g.findNextMatchingNodeUsingWorkingStack(
      ...
      (c, d) => (i = d, t({
        node: c,
        documentLocation: g.convertNodeToUsjDocumentLocation(c, d)
      }))
    );
    if (n !== void 0)
      return {
  ...
  getVerseRefForIndexInUsfm(e, t) {
    ...
    const d = this.getIndexInUsfmForVerseRef(n), l = this.fragmentsByIndexInUsfm.get(d);
    return l && g.isFragmentAMarker(l.fragment) && l.fragment.type === w && l.fragment.number && l.fragment.number !== `${n.verseNum}` && (n.verse = l.fragment.number), n;
  }
  ...
  findNextLocationOfMatchingText(e, t, r = 1e3) {
    ...
    if (g.findNextMatchingNodeUsingWorkingStack(
      ...
      (h, f) => {
        ...
        if (p && g.areStackItemsShallowEqual(v, p)) {
        ...
        n += y.length, i = `${i}${y}`;
        const I = i.indexOf(t);
        return I < 0 ? (c += i.length, i.length > t.length && (i = i.substring(i.length - t.length)), c -= i.length, n > r) : (d = c + I, !0);
      }
    ), d < 0) return;
    n = 0;
    let m = 0, b = [];
    const u = g.findNextMatchingNodeUsingWorkingStack(
      ...
      T,
      (h, f) => typeof h != "string" || (n += h.length, n < d + 1) ? !1 : (m = d - n + h.length, b = f, !0)
    );
  ...
  search(e, t) {
    ...
    for (; m !== void 0; )
      m = g.findNextMatchingNodeUsingWorkingStack(
        ...
        (y, v) => (typeof y != "string" || r && v.some((M) => {
          ...
          let E;
          return "style" in x && typeof x.style == "string" ? E = x.style : "marker" in x && typeof x.marker == "string" && (E = x.marker), E !== void 0 && !r.has(E);
        }) || (d.push(y), l.set(p, {
          node: y,
          documentLocation: {
            offset: 0,
    ...
    const b = d.join(""), u = i === "NFD" ? g.buildNFDToOriginalPositionMap(b) : void 0, h = u ? b.normalize("NFD") : b;
    let f = e.exec(h);
    for (; f; ) {
      if (f[0].length > 0) {
        ...
        const I = l.findClosestLessThanOrEqual(y);
        if (!I)
    ...
    return g.findNextMatchingNodeUsingWorkingStack(
      ...
      (c) => {
        ...
        if (i >= c.length)
          return i -= c.length, !1;
        let d = c;
        if (i > 0 && (d = d.substring(i), i = 0), n + d.length < t)
          return n += d.length, r = `${r}${d}`, !1;
        const l = t - n;
        return r = `${r}${d.substring(0, l - 1)}`, !0;
      }
    ), r;
  }
  ...
  getInfoForMarker(e, t = "usfm") {
    ...
    let d = r;
    if (n != null && n.markerUsfm && (d = n.markerUsfm, n = this.getMarkerInfo(d)), !n) {
      if (_(e))
        throw new Error(`Unknown marker ${r} and no marker type provided`);
      n = { type: e.type }, i = !0, this.reportProblemOnce(
        `Unknown marker ${r}. Creating MarkerInfo to use: ${JSON.stringify(n)}`,
        "debug"
      );
    }
    let l = n.type, p = this.markersMap.markerTypes[l];
    if (p != null && p.markerTypeUsfm && (l = p.markerTypeUsfm, p = this.markersMap.markerTypes[l]), !_(e) && e.type !== c && (!p || e.type !== p.markerTypeUsfm && e.type !== p.markerTypeUsx && e.type !== p.markerTypeUsj) && (this.reportProblemOnce(
    ...
    ), l = e.type, p = this.markersMap.markerTypes[l], i = !0), !p)
      throw new Error(
        `Unknown marker type ${l} on marker ${r}! Cannot proceed.`
      );
    i && l === "para" && (p = { ...p, hasNewlineBefore: !1 });
    const m = [];
    ...
    const b = e;
    if (t === "usfm" && l === "cell" && b.colspan) {
      const u = parseInt(b.colspan, 10), h = Pe.exec(r);
      if (h != null && h[1]) {
        const f = parseInt(h[1], 10);
        !Number.isNaN(f) && !Number.isNaN(u) && (d = `${r}-${f + u - 1}`, p = {
          ...p,
  ...
  textContentToUsfm(e) {
    return {
      usfm: this.shouldAllowInvisibleCharacters ? e : e.replace(Se, "~"),
  ...
  openingMarkerToUsfm(e, t) {
    let r = "";
    const i = [], { markerName: n, markerInfo: c, markerType: d, markerTypeInfo: l, attributeMarkerInfoEntries: p } = this.getInfoForMarker(e), m = e;
    l.hasNewlineBefore && (r += `
`);
    const b = t ? l.nestedPrefix ?? "" : "";
    return i.push({ fragment: e, indexInUsfm: r.length }), r += d === "optbreak" ? "//" : `\\${b}`, d !== "optbreak" && (i.push({
      fragment: { attributeValueForKey: "marker", forMarker: e },
      indexInUsfm: r.length
    }), r += `${n}${d === "unmatched" ? "" : " "}`), c.leadingAttributes && c.leadingAttributes.forEach((u) => {
      const h = m[u];
      h && (i.push({
      ...
      indexInUsfm: r.length
    }), r += `${m[c.textContentAttribute]} `), c.attributeMarkers && p.forEach(([u, h]) => {
      ...
      i.push({
        ...
        if ("isClosingMarker" in M.fragment) {
          const { isClosingMarker: x, ...E } = M.fragment, j = {
            ...E,
            forMarker: e,
  ...
  closingMarkerToUsfm(e, t) {
    ...
    } = this.getInfoForMarker(e), p = Object.keys(e).filter((f) => {
      var y, v;
      return !(f === "type" || f === "marker" || f === "content" || f === "closed" || (y = d.skipOutputAttributeToUsfm) != null && y.includes(f) || (v = n.leadingAttributes) != null && v.includes(f) || n.textContentAttribute === f || l.some(
        ([, I]) => I.attributeMarkerAttributeName === f
      ));
    }), m = e;
    if (d.isCloseable && n.independentClosingMarkers && n.independentClosingMarkers.length > 0)
      throw new Error(
    ...
    if ((m.closed === "false" || n.isClosingMarkerOptional && !this.markersMap.shouldOptionalClosingMarkersBePresent && m.closed !== "true") && (b = !1), n.independentClosingMarkers && n.independentClosingMarkers.length > 0 && b) {
      ...
      let y = "";
      const v = [], { usfm: I, fragmentsInfo: M } = this.openingMarkerToUsfm(f, t), x = M.find((E) => g.isFragmentAMarker(E.fragment));
      if (!x)
        throw new Error(
      ...
      }), y += I, r !== f.marker && (y = this.addMarkerUsfmToString(
        y,
        {
          isClosingMarker: !0,
          forMarker: f
    ...
    let u = "";
    const h = [];
    if (p.length > 0 && (u += "|", p.length === 1 && p[0] === n.defaultAttribute ? (h.push({
      fragment: { attributeValueForKey: n.defaultAttribute, forMarker: e },
      indexInUsfm: u.length
    }), u += m[n.defaultAttribute]) : p.forEach((f, y) => {
      ...
      const f = d.isClosingMarkerEmpty ? "" : i, y = t ? d.nestedPrefix ?? "" : "";
      h.push({
        fragment: { isClosingMarker: !0, forMarker: e },
        indexInUsfm: u.length
      }), u += `\\${y}${f}*`;
  ...
  addMarkerUsfmToString(e, t, r, i) {
    let n = e, c, d;
    const { markerNameOriginal: l, markerType: p, markerTypeInfo: m } = this.getInfoForMarker(
    ...
    if ("isClosingMarker" in t) {
      ...
      d = h, c = u, m.isCloseable && m.isClosingMarkerEmpty && // No contents
    ...
    if (c.startsWith(`
`) && (n.length === 0 ? (d = d.map((u) => ({
      ...u,
      indexInUsfm: u.indexInUsfm - 1
    })), c = c.substring(1)) : n = g.removeEndSpace(n)), this.markersMap.isSpaceAfterAttributeMarkersContent && l === "ca") {
 ...
 `);
  ...
  static areUsjDocumentLocationsEqual(e, t, r = !1) {
    const { jsonPath: i, ...n } = e, { jsonPath: c, ...d } = t;
    return !r && !N(P.toPathArray(i), P.toPathArray(c)) ? !1 : N(n, d);
  }
   ...
   *   do.
   */
  transferFragmentsInfoArrayToMaps(e, t, r, i, n, c) {
    e.map((l) => {
      var m, b, u;
      if (typeof l.fragment == "object" && "type" in l.fragment) {
        ...
        if (h.type === B && h.code)
        ...
        else if (h.type === V && h.number) {
          const f = parseInt(h.number, 10);
          if (Number.isNaN(f))
            this.reportProblemOnce(
              `Found ${V} type marker with number ${h.number}, but could not parse chapter number from it. Continuing using previous chapter number ${r.chapterNum}`
            );
          else {
          ...
          const f = (m = Te.exec(h.number)) == null ? void 0 : m[1];
          if (!f)
            this.reportProblemOnce(
      ...
      const p = l.nodeAndDocumentLocation.documentLocation.jsonPath, m = n.get(p);
      m ? m.push(l) : n.set(p, [l]), c[r.bookId] || (c[r.bookId] = {}), c[r.bookId][r.chapterNum] || (c[r.bookId][r.chapterNum] = {}), c[r.bookId][r.chapterNum][r.verseNum] === void 0 && (c[r.bookId][r.chapterNum][r.verseNum] = l.indexInUsfm);
    }), e.splice(0);
  }
  ...
  calculateUsfmProperties() {
    ...
    return g.findNextMatchingNodeOrClosingFragmentUsingWorkingStack(
      ...
      (m, b) => {
        ...
        let u;
        return b.length > 0 && (u = b[b.length - 1].parent), "isClosingMarker" in m ? p.length > 0 && p[p.length - 1] === m.forMarker ? (p.pop(), !1) : (e = this.addMarkerUsfmToString(
          e,
          m,
          u,
          n
        ), d(b), m.forMarker.type === "book" && l && (e = this.addMarkerUsfmToString(e, l, u, n), d(b), l = void 0), !1) : this.shouldSkipOutputMarkerToUsfm(m) ? (p.push(m), !1) : g.isTopLevelUsjMarker(m, b) && !l ? (m.version !== "3.0" && (l = m), !1) : (e = this.addMarkerUsfmToString(e, m, u, n), d(b), !1);
      }
...
export {
  ...
  Oe as Collator,
  Ke as DATA_LOSS,
  Ge as DEADLINE_EXCEEDED,
  qt as DEBOUNCE_CANCELED_ERROR_MESSAGE,
  se as DateTimeFormat,
  ce as DocumentCombiner,
  Ue as EventRollingTimeCounter,
  Ye as FAILED_PRECONDITION,
  At as FIRST_SCR_BOOK_NUM,
  $t as FIRST_SCR_CHAPTER_NUM,
  jt as FIRST_SCR_VERSE_NUM,
  Nt as GraphemeString,
  Xe as INTERNAL,
  We as INVALID_ARGUMENT,
  Ft as LAST_SCR_BOOK_NUM,
  Ot as MAX_PADDING_LENGTH,
  xt as MODIFIER_KEYS,
  s as MarkerType,
  pe as Mutex,
  Re as MutexMap,
  Ze as NOT_FOUND,
  De as NonValidatingDocumentCombiner,
  le as NumberFormat,
  Qe as OUT_OF_RANGE,
  et as PERMISSION_DENIED,
  A as PLATFORM_ERROR_VERSION,
  oe as PlatformEventEmitter,
  Le as PromiseChainingMap,
  tt as RESOURCE_EXHAUSTED,
  Ut as SELECTABLE_INVISIBLE_CHAR_OR_WHITESPACE_CLASS,
  Rt as Section,
  L as SortedNumberMap,
  Be as SortedSet,
  Ie as THEME_STYLE_ELEMENT_ID,
  rt as UNAUTHENTICATED,
  nt as UNAVAILABLE,
  it as UNIMPLEMENTED,
  st as UNKNOWN,
  F as USFM_MARKERS_MAP_3_0,
  Pt as USFM_MARKERS_MAP_PARATEXT_3_0,
  Ve as UnsubscriberAsyncList,
  g as UsjReaderWriter,
  w as VERSE_TYPE,
  dt as aggregateUnsubscriberAsyncs,
  ct as aggregateUnsubscribers,
  St as applyThemeStylesheet,
  Dt as areUsjContentsEqualExceptWhitespace,
  Lt as at,
  Bt as charAt,
  Vt as codePointAt,
  zt as collapseMiddleWords,
  Ht as collectUsjMarkers,
  Jt as compareScrRefs,
  It as computeEffectiveStructureProtection,
  Kt as createSyncProxyForAsyncObject,
  Gt as debounce,
  C as deepClone,
  N as deepEqual,
  Yt as defaultScrRef,
  ge as deserialize,
  Et as doesCatalogRowCoverProject,
  Xt as endsWith,
  Wt as ensureArray,
  Zt as escapeStringRegexp,
  wt as expandThemeContribution,
  kt as formatBytes,
  Mt as formatRelativeDate,
  Qt as formatReplacementString,
  er as formatReplacementStringToArray,
  tr as formatScrRef,
  rr as formatScrRefRange,
  vt as formatTimeSpan,
  nr as getAllObjectFunctionNames,
  ir as getChaptersForBook,
  yt as getCurrentLocale,
  K as getDefaultCallerSequence,
  sr as getErrorMessage,
  ht as getFormatCallerFunction,
  _t as getLocalizeKeyForPhysicalKey,
  ar as getLocalizeKeyForScrollGroupId,
  or as getLocalizeKeysForScrollGroupIds,
  cr as getLocalizedIdFromBookNumber,
  he as getNthCaller,
  ft as getPaneSizeLimits,
  dr as getSectionForBook,
  we as getStylesheetForTheme,
  pr as groupBy,
  gt as htmlEncode,
  lr as includes,
  ur as indexOf,
  ...
  hr as isErrorMessageAboutParatextBlockingInternetAccess,
  fr as isErrorMessageAboutRegistryAuthFailure,
  mr as isLocalizeKey,
  ot as isPlatformError,
  gr as isSelectableInvisibleCharOrWhiteSpace,
  ...
  kr as isolateBidi,
  br as lastIndexOf,
  Me as localizedStringsDocumentSchema,
  xe as menuDocumentSchema,
  vr as newGuid,
  at as newPlatformError,
  Mr as normalize,
  bt as normalizeProjectId,
  xr as normalizeScriptureSpaces,
  _r as offsetBook,
  Ir as offsetChapter,
  Er as offsetVerse,
  ...
  Sr as padEnd,
  Pr as padStart,
  be as projectSettingsDocumentSchema,
  Tr as retryUntil,
  ut as sanitizeHtml,
  Cr as scrRefToBBBCCC,
  qr as scrRefToBBBCCCVVV,
  z as serialize,
  ve as settingsDocumentSchema,
  Ar as slice,
  $r as split,
  jr as startsWith,
  Nr as stringLength,
  Fr as substring,
  _e as themeDocumentSchema,
  Or as toArray,
  Ur as toKebabCase,
  Rr as transformAndEnsureRegExpArray,
  Dr as transformAndEnsureRegExpRegExpArray,
  J as usfmMarkers,
  Lr as wait,
  Br as waitForDuration
};
