...
var Ie = (n, e, t) => e in n ? xe(n, e, { enumerable: !0, configurable: !0, writable: !0, value: t }) : n[e] = t;
var y = (n, e, t) => Ie(n, typeof e != "symbol" ? e + "" : e, t);
import { Mutex as we } from "async-mutex";
import { Canon as M, VerseRef as oe } from "@sillsdev/scripture";
import { USJ_TYPE as ae } from "@eten-tech-foundation/scripture-utilities";
import { indexOf as Me, limit as ce, length as Ee, substring as Ae, toArray as Se, substr as Te } from "stringz";
...
function Rt(n) {
  ...
  return b(n) ? n.includes(e) : le(n).includes(e);
}
function qt(n) {
  const e = "401 Unauthorized error while getting shared projects.", t = "User registration is not valid. Cannot retrieve resources from DBL.", r = b(n) ? n : le(n);
...
function Wt(n) {
  ...
  if (b(n)) return { message: n, platformErrorVersion: D };
...
function P(n, e) {
  return e < 0 || e > x(n) - 1 ? "" : F(n, e, 1);
}
function Qt(n, e) {
  if (!(e < 0 || e > x(n) - 1))
    return F(n, e, 1).codePointAt(0);
}
function ze(n, e, t = x(n)) {
  const r = Ge(n, e);
  return !(r === -1 || r + x(e) !== t);
}
function Re(n, e, t) {
...
function qe(n, e) {
  ...
  let r = 0, i = 0;
  function s(a, c, l) {
    const p = S(n, i, c), h = t.length > 0 && b(t[t.length - 1]) ? `${t.pop()}${p}` : p;
    b(a) ? t.push(`${h}${a}`) : (h && t.push(h), t.push(a)), i = c + l;
  }
  const o = x(n);
  for (; r < o; ) {
    switch (P(n, r)) {
...
function Ge(n, e, t) {
  let r = t === void 0 ? x(n) : t;
  r < 0 ? r = 0 : r >= x(n) && (r = x(n) - 1);
  for (let i = r; i >= 0; i--)
    if (F(n, i, x(e)) === e)
      return i;
  return -1;
...
function nr(n, e, t = " ") {
  return e <= x(n) ? n : ce(n, e, t, "right");
}
function sr(n, e, t = " ") {
  return e <= x(n) ? n : ce(n, e, t, "left");
}
function _(n, e) {
...
function Y(n, e, t) {
  ...
  if (e > r || t && (e > t && !(e >= 0 && e < r && t < 0 && t > -r) || t < -r))
    return "";
  const i = _(r, e), s = t ? _(r, t) : void 0;
  return S(n, i, s);
}
function W(n, e, t) {
  const r = [];
  ...
  for (let a = 0; a < (t ? t - 1 : s.length); a++) {
    const c = j(n, s[a], o), l = x(s[a]);
    if (r.push(S(n, o, c)), o = c + l, t !== void 0 && r.length === t)
      break;
  }
...
function F(n, e = 0, t = x(n) - e) {
  return Te(n, e, t);
}
function S(n, e, t = x(n)) {
  return Ae(n, e, t);
}
function He(n) {
  return Se(n);
...
function cr(n) {
  return n ? fe(n).map((r) => new RegExp(r)) : [];
}
const Xe = (
...
const J = ["chapter", "book", "para", "row", "sidebar", ae], _e = "​", de = [
...
], Ye = 1, We = de.length - 1, Ze = 1, Qe = 1, fr = {
  book: "GEN",
  chapterNum: 1,
  verseNum: 1
}, et = (n) => {
  var e;
  return ((e = de[n]) == null ? void 0 : e.chapters) ?? -1;
}, pr = (n, e) => ({
  book: M.bookNumberToId(
    Math.max(
      Ye,
      Math.min(M.bookIdToNumber(n.book) + e, We)
    )
  ),
  chapterNum: 1,
  verseNum: 1
...
async function mr(n, e, t) {
  const r = M.bookNumberToId(n);
  if (!pe(Intl.getCanonicalLocales(e)[0], "zh"))
    return t({
  ...
  return W(s[0], "ÿ08")[0].trim();
}
function gr(n) {
  return new oe(M.bookIdToNumber(n.book), n.chapterNum, n.verseNum).BBBCCC;
}
function Z(n) {
  return new oe(M.bookIdToNumber(n.book), n.chapterNum, n.verseNum).BBBCCCVVV;
}
function tt(n, e) {
  return Z(n) - Z(e);
}
...
function he(n, e) {
  switch (e) {
    case "English":
      return M.bookIdToEnglishName(n.book);
    case "id":
    case void 0:
      return n.book;
    default:
...
function vr(n, e, t) {
  ...
  const i = n.book === e.book && !(t != null && t.repeatBookName) ? "" : (t == null ? void 0 : t.endRefOptionOrLocalizedBookName) ?? (t == null ? void 0 : t.optionOrLocalizedBookName), s = Q(e, {
    ...t,
...
const kr = (n) => {
  if (M.isBookOT(n)) return "OT";
  if (M.isBookNT(n)) return "NT";
  if (M.isBookDC(n)) return "DC";
  if (M.isExtraMaterial(n)) return "Extra";
...
function te(n) {
  ...
  for (let i = 0; i < n.length; i += 1) {
    const s = n[i];
    s.charCodeAt(0) < 32 ? (t || (e += " "), t = !0) : !t && s === _e && i + 1 < n.length && ee(n[i + 1]) || (ee(s) ? (t || (e += s), t = !0) : lt(s) && r === s || (e += s, t = !1)), r = s;
  }
  return e;
}
function re(n) {
...
function ne(n, e) {
  if (!e || !J.includes(e.type)) return !1;
  if (!e.content)
    throw new Error(
...
function me(n, e, t, r) {
  ...
  if (i && s) {
    const o = te(n), a = te(t);
    if (o !== a) {
      if (!T(B(o, -1) ?? "") && !T(B(a, -1) ?? "") || !ne(n, e) || !ne(t, r)) return !1;
      let c = o;
      for (; T(B(c, -1) ?? ""); ) c = Y(c, 0, -1);
      let l = a;
      for (; T(B(l, -1) ?? ""); ) l = Y(l, 0, -1);
      if (c !== l) return !1;
    }
  } else if (!i && !s) {
    ...
    const l = re(o.content), p = re(a.content);
    if (l !== p) return !1;
    if (!l && !p) {
      let h = o.content, u = a.content;
      const f = h[h.length - 1];
      J.includes(o.type) && b(f) && T(f) && (h = h.slice(0, -1));
      const d = u[u.length - 1];
      if (J.includes(a.type) && b(d) && T(d) && (u = u.slice(0, -1)), h.length !== u.length) return !1;
...
function Nr(n, e) {
  return me(n, void 0, e, void 0);
}
const xr = (n) => (...e) => n.map((r) => r(...e)).every((r) => r), Ir = (n) => async (...e) => {
  const t = n.map(async (r) => r(...e));
  return (await Promise.all(t)).every((r) => r);
}, ut = "book", se = "chapter", E = "verse", A = "***";
function wr(n) {
...
function ft(n, e) {
  const t = e && e.length > 0 ? e : ge();
  return t[n % t.length];
}
function Mr(n, e) {
  const t = e && e.length > 0 ? e : ge(), r = (() => {
...
function dt(n, e) {
  ...
  return Object.keys(t).forEach((s) => {
    i && (Object.hasOwn(r, s) && dt(r[s], t[s]) || (i = !1));
  }), i;
}
function ie(n, e, t) {
...
const Sr = (n) => n.replace(/&/g, "&amp;").replace(/</g, "&lt;").replace(/>/g, "&gt;").replace(/"/g, "&quot;").replace(/'/g, "&#x27;").replace(/\//g, "&#x2F;");
function Tr() {
...
const mt = 1e3, ye = 60, be = ye * 60, gt = be * 24;
function $r(n, e, t = /* @__PURE__ */ new Date()) {
  ...
  const s = Math.round(r / be);
  if (Math.abs(s) >= 1) return n.format(s, "hour");
  const o = Math.round(r / ye);
...
function jr(n, e, t) {
  ...
  return i.id = `${xt}${t ? `-${t}` : ""}`, i.dataset.themeId = n.id, i.textContent = wt(n), this.document.head.appendChild(i), i;
}
function Ne(n) {
...
USJ: ${JSON.stringify(
    ...
    else if (g.areUsjVersionsCompatible(this.usj.version, R.version))
      this.markersMap = R;
    else
      throw new Error(
  ...
  static isTopLevelUsjMarker(e, t) {
    return typeof e == "object" && e.type === ae && t.length === 0;
  }
  /**
  ...
  static createParentMapInternal(e, t, r) {
    ...
    r.set(e, t), e.content && r.set(e.content, e), (i = e.content) == null || i.forEach((s) => {
      typeof s == "object" && g.createParentMapInternal(s, e, r);
    });
  }
  ...
  static findNextMatchingNodeOrClosingFragmentUsingWorkingStack(e, t, r, i) {
    ...
    if (!b(o)) {
      ...
      let c;
      t.some((l) => {
        const p = l.parent.content[l.index];
        return !b(p) && r.includes(p.type) ? (c = p, !0) : !1;
      }), c && (s = c);
    }
    for (; s !== void 0; ) {
  ...
  findNextMatchingNode(e, t) {
    ...
    let i = r;
    const s = g.findNextMatchingNodeUsingWorkingStack(
      e.node,
      r,
      [],
      (o, a) => (i = a, t({
  ...
  usjDocumentLocationToUsfmVerseRefVerseLocation(e, t) {
    ...
    return {
      ...
      offset: r.indexInUsfm - s + g.getOffsetInUsjDocumentLocation(e)
    };
  }
  ...
  getEffectiveBookId(e) {
    const t = Object.keys(this.indicesInUsfmByVerseRef), r = t.length === 0 || t.length === 1 && t[0] === A, i = r ? A : e;
  ...
  getVerseRefForIndexInUsfm(e, t) {
    ...
    return c && g.isFragmentAMarker(c.fragment) && c.fragment.type === E && c.fragment.number && c.fragment.number !== `${s.verseNum}` && (s.verse = c.fragment.number), s;
  }
  ...
  usfmVerseLocationToUsjNodeAndDocumentLocation(e) {
    const { verseRef: t, offset: r } = g.usfmVerseLocationToUsfmVerseRefVerseLocation(e), i = this.usfmVerseLocationToIndexInUsfm(e), { value: s } = this.fragmentsByIndexInUsfm.findClosestLessThanOrEqual(
      i
    ) ?? {
      value: void 0
    };
  ...
  findNextLocationOfMatchingText(e, t, r = 1e3) {
    ...
    if (g.findNextMatchingNodeUsingWorkingStack(
      ...
      (f, d) => {
        ...
        if (l && g.areStackItemsShallowEqual(k, l)) {
          ...
          m = f.substring(e.documentLocation.offset), o += e.documentLocation.offset;
        }
        s += m.length, i = `${i}${m}`;
        const I = i.indexOf(t);
        return I < 0 ? (o += i.length, i.length > t.length && (i = i.substring(i.length - t.length)), o -= i.length, s > r) : (a = o + I, !0);
      }
    ), a < 0) return;
    s = 0;
    let p = 0, h = [];
    const u = g.findNextMatchingNodeUsingWorkingStack(
      ...
      C,
      (f, d) => typeof f != "string" || (s += f.length, s < a + 1) ? !1 : (p = a - s + f.length, h = d, !0)
    );
  ...
  search(e, t) {
    const r = t instanceof Set ? t : t == null ? void 0 : t.markerStylesToInclude, i = t instanceof Set || t == null ? void 0 : t.normalizationForm, s = [];
    if (this.usj.content.length === 0) return s;
    const o = {
      node: this.usj,
      documentLocation: {
        jsonPath: "$"
    ...
    let l = 0, p = o.node;
    for (; p !== void 0; )
      p = g.findNextMatchingNodeUsingWorkingStack(
        o.node,
        this.convertJsonPathToWorkingStack(o.documentLocation.jsonPath),
        [],
        // We need to use variables from outside the function to keep track of our current position
        // eslint-disable-next-line no-loop-func
        (m, k) => (typeof m != "string" || r && k.some((v) => {
          const N = v.parent;
          if (!N || !("type" in N) || N.type === "char") return !1;
          let w;
          return "style" in N && typeof N.style == "string" ? w = N.style : "marker" in N && typeof N.marker == "string" && (w = N.marker), w !== void 0 && !r.has(w);
        }) || (a.push(m), c.set(l, {
          node: m,
          documentLocation: {
            offset: 0,
            jsonPath: g.convertWorkingStackToJsonPath(k)
          }
        }), l += m.length), !1)
      );
    const h = a.join(""), u = i === "NFD" ? g.buildNFDToOriginalPositionMap(h) : void 0, f = u ? h.normalize("NFD") : h;
    let d = e.exec(f);
    for (; d; ) {
      if (d[0].length > 0) {
        const m = u ? u[d.index] : d.index, k = u ? u[d.index + d[0].length] : d.index + d[0].length;
        if (m < 0 || m >= h.length)
          throw new Error(`Match index out of bounds: ${m}`);
        const I = c.findClosestLessThanOrEqual(m);
        if (!I)
          throw new Error(`Internal error: no starting node found for index ${m}`);
        const v = {
          node: I.value.node,
          documentLocation: {
        ...
        }, N = c.findClosestLessThanOrEqual(k - 1);
        if (!N)
          throw new Error(`Internal error: no ending node found for index ${m}`);
        const w = {
          node: N.value.node,
          documentLocation: {
        ...
        }, V = u ? h.substring(m, k) : d[0];
        s.push({ text: V, start: v, end: w });
      }
      if (!e.global) break;
      d = e.exec(f);
    }
  ...
  extractTextBetweenPoints(e, t, r = 100) {
    ...
    return g.findNextMatchingNodeUsingWorkingStack(
      ...
      this.convertJsonPathToWorkingStack(e.documentLocation.jsonPath),
      C,
      (s, o) => s === t.node && (typeof s == "object" || t.documentLocation.jsonPath === g.convertWorkingStackToJsonPath(o)) ? !0 : typeof s != "string" ? !1 : (i = `${i}${s}`, i.length > r && (i = i.substring(0, r)), i.length >= r)
    ), i;
  }
  ...
  getInfoForMarker(e, t = "usfm") {
    ...
    if (l != null && l.markerTypeUsfm && (c = l.markerTypeUsfm, l = this.markersMap.markerTypes[c]), !b(e) && e.type !== o && (!l || e.type !== l.markerTypeUsfm && e.type !== l.markerTypeUsx && e.type !== l.markerTypeUsj) && (console.warn(
    ...
    const p = [];
    s.attributeMarkers && s.attributeMarkers.forEach((u) => {
      const f = this.getMarkerInfo(u);
      f && "attributeMarkerAttributeName" in f && p.push([u, f]);
    });
    const h = e;
    if (t === "usfm" && c === "cell" && h.colspan) {
      const u = parseInt(h.colspan, 10), f = Et.exec(r);
      if (f != null && f[1]) {
        const d = parseInt(f[1], 10);
        !Number.isNaN(d) && !Number.isNaN(u) && (a = `${r}-${d + u - 1}`, l = {
          ...l,
  ...
  openingMarkerToUsfm(e, t) {
    let r = "";
    const i = [], { markerName: s, markerInfo: o, markerType: a, markerTypeInfo: c, attributeMarkerInfoEntries: l } = this.getInfoForMarker(e), p = e;
...
`);
    ...
    return i.push({ fragment: e, indexInUsfm: r.length }), r += a === "optbreak" ? "//" : `\\${h}`, a !== "optbreak" && (i.push({
    ...
    }), r += `${s}${a === "unmatched" ? "" : " "}`), o.leadingAttributes && o.leadingAttributes.forEach((u) => {
      const f = p[u];
      f && (i.push({
        fragment: { attributeValueForKey: u, forMarker: e },
        indexInUsfm: r.length
      }), r += `${f} `);
    }), o.textContentAttribute && p[o.textContentAttribute] && (i.push({
      fragment: { attributeValueForKey: o.textContentAttribute, forMarker: e },
      indexInUsfm: r.length
    }), r += `${p[o.textContentAttribute]} `), o.attributeMarkers && l.forEach(([u, f]) => {
      const d = p[f.attributeMarkerAttributeName];
      if (!d) return;
      const m = {
        type: f.type,
        marker: u,
      ...
      const { usfm: I } = this.textContentToUsfm(d);
      i.push({
        fragment: {
        ...
        if (b(v.fragment) || "attributeKey" in v.fragment)
          throw new Error(
        ...
        if ("isClosingMarker" in v.fragment) {
          const { isClosingMarker: N, ...w } = v.fragment, V = {
            ...w,
            forMarker: e,
      ...
      }), !this.markersMap.isSpaceAfterAttributeMarkersContent && f.hasStructuralSpaceAfterCloseAttributeMarker && (r += " ");
  ...
  closingMarkerToUsfm(e, t) {
    ...
    } = this.getInfoForMarker(e), l = Object.keys(e).filter((d) => {
      var m, k;
      return !(d === "type" || d === "marker" || d === "content" || d === "closed" || (m = a.skipOutputAttributeToUsfm) != null && m.includes(d) || (k = s.leadingAttributes) != null && k.includes(d) || s.textContentAttribute === d || c.some(
        ([, I]) => I.attributeMarkerAttributeName === d
      ));
    }), p = e;
    ...
    let h = !0;
    if ((p.closed === "false" || s.isClosingMarkerOptional && !this.markersMap.shouldOptionalClosingMarkersBePresent && p.closed !== "true") && (h = !1), s.independentClosingMarkers && s.independentClosingMarkers.length > 0 && h) {
      const d = {
        type: o,
      ...
      let m = "";
      const k = [], { usfm: I, fragmentsInfo: v } = this.openingMarkerToUsfm(d, t), N = v.find((w) => g.isFragmentAMarker(w.fragment));
      if (!N)
        throw new Error(
      ...
      return k.push({
      ...
      }), m += I, r !== d.marker && (m = this.addMarkerUsfmToString(
        m,
        {
          isClosingMarker: !0,
          forMarker: d
        ...
        t
      )), { usfm: m, fragmentsInfo: k };
    }
    let u = "";
    const f = [];
    if (l.length > 0 && (u += "|", l.length === 1 && l[0] === s.defaultAttribute ? (f.push({
      fragment: { attributeValueForKey: s.defaultAttribute, forMarker: e },
      indexInUsfm: u.length
    }), u += p[s.defaultAttribute]) : l.forEach((d, m) => {
      const k = o === "figure" && d === "file" ? "src" : d;
      m > 0 && (u += " "), f.push({
      ...
      const d = a.isClosingMarkerEmpty ? "" : i, m = t ? a.nestedPrefix ?? "" : "";
      f.push({
        fragment: { isClosingMarker: !0, forMarker: e },
        indexInUsfm: u.length
      }), u += `\\${m}${d}*`;
    }
    return { usfm: u, fragmentsInfo: f };
  }
  /**
  ...
  addMarkerUsfmToString(e, t, r, i) {
    let s = e, o, a;
    const { markerNameOriginal: c, markerType: l, markerTypeInfo: p } = this.getInfoForMarker(
    ...
    if ("isClosingMarker" in t) {
      const { usfm: u, fragmentsInfo: f } = this.closingMarkerToUsfm(
        t.forMarker,
        h
      );
      a = f, o = u, p.isCloseable && p.isClosingMarkerEmpty && // No contents
      (!t.forMarker.content || t.forMarker.content.length === 0) && // No closing marker attributes
      !o.startsWith("|") && (s = g.removeEndSpace(s));
    } else {
      const { usfm: u, fragmentsInfo: f } = this.openingMarkerToUsfm(
        t,
        h
      );
      a = f, o = u;
...
`) && (s.length === 0 ? (a = a.map((u) => ({
 ...
 `);
  ...
  static areUsjDocumentLocationsEqual(e, t, r = !1) {
    ...
    return !r && !z($.toPathArray(i), $.toPathArray(o)) ? !1 : z(s, a);
  }
  ...
  static transferFragmentsInfoArrayToMaps(e, t, r, i, s, o) {
    e.map((c) => {
      ...
      if (typeof c.fragment == "object" && "type" in c.fragment) {
        const f = c.fragment;
        if (f.type === ut && f.code)
          r.bookId = f.code, r.chapterNum = 0, r.verseNum = 0, o[A] && (o[r.bookId] = o[A], delete o[A]);
        else if (f.type === se && f.number) {
          const d = parseInt(f.number, 10);
          if (Number.isNaN(d))
            console.warn(
              `Found ${se} type marker with number ${f.number}, but could not parse chapter number from it. Continuing using previous chapter number ${r.chapterNum}`
            );
          else {
            r.chapterNum = d, r.verseNum = 0;
            const m = o[r.bookId];
            m != null && m[0] && (m[r.chapterNum] = m[0], delete m[0]);
          }
        } else if (f.type === E && f.number) {
          const d = (p = At.exec(f.number)) == null ? void 0 : p[1];
          if (!d)
            console.warn(
              `Found ${E} type marker with number ${f.number}, but could not find starting verse number in it. Continuing using previous verse number ${r.verseNum}`
            );
          else {
            const m = parseInt(d, 10);
            Number.isNaN(m) ? console.warn(
              `Found ${E} type marker with number ${f.number}, but could not parse starting verse number from ${d}. Continuing using previous verse number ${r.verseNum}`
            ) : (u = (h = o[r.bookId]) == null ? void 0 : h[r.chapterNum]) != null && u[m] ? console.warn(`Found ${E} marker with existing number ${m} after
                  current ${E} number ${r.verseNum}! Not updating verse start index. All positions in this duplicate verse will be based on the current ${E} marker, not the new duplicate marker.`) : (m < r.verseNum && console.debug(
              `Found ${E} marker with number ${m} lower than current ${E} number ${r.verseNum}. Verses are out of order. There may be some issues.`
            ), r.verseNum = m);
          }
        }
      }
      ...
      const l = c.nodeAndDocumentLocation.documentLocation.jsonPath, p = s.get(l);
      p ? p.push(c) : s.set(l, [c]), o[r.bookId] || (o[r.bookId] = {}), o[r.bookId][r.chapterNum] || (o[r.bookId][r.chapterNum] = {}), o[r.bookId][r.chapterNum][r.verseNum] === void 0 && (o[r.bookId][r.chapterNum][r.verseNum] = c.indexInUsfm);
    }), e.splice(0);
  }
  ...
  calculateUsfmProperties() {
    let e = "";
    const t = new X(), r = /* @__PURE__ */ new Map(), i = {}, s = [], o = {
      bookId: A,
      chapterNum: 0,
      verseNum: 0
    };
    ...
    return g.findNextMatchingNodeOrClosingFragmentUsingWorkingStack(
      ...
      (p, h) => {
        if (typeof p != "object") {
          const { usfm: f, fragmentsInfo: d } = this.textContentToUsfm(p);
        ...
        let u;
        return h.length > 0 && (u = h[h.length - 1].parent), "isClosingMarker" in p ? l.length > 0 && l[l.length - 1] === p.forMarker ? (l.pop(), !1) : (e = this.addMarkerUsfmToString(
          e,
          p,
          u,
          s
        ), a(h), p.forMarker.type === "book" && c && (e = this.addMarkerUsfmToString(e, c, u, s), a(h), c = void 0), !1) : this.shouldSkipOutputMarkerToUsfm(p) ? (l.push(p), !1) : g.isTopLevelUsjMarker(p, h) && !c ? (p.version !== "3.0" && (c = p), !1) : (e = this.addMarkerUsfmToString(e, p, u, s), a(h), !1);
      }
...
export {
  ...
  E as VERSE_TYPE,
  Ir as aggregateUnsubscriberAsyncs,
  ...
  zt as createSyncProxyForAsyncObject,
  Ft as debounce,
  O as deepClone,
  z as deepEqual,
  fr as defaultScrRef,
  ...
  ge as getDefaultCallerSequence,
  ...
  tr as normalize,
  te as normalizeScriptureSpaces,
  pr as offsetBook,
  dr as offsetChapter,
  hr as offsetVerse,
