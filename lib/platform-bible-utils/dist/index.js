...
var Ee = (n, e, t) => e in n ? _e(n, e, { enumerable: !0, configurable: !0, writable: !0, value: t }) : n[e] = t;
var k = (n, e, t) => Ee(n, typeof e != "symbol" ? e + "" : e, t);
import { d as U, i as w } from "./scripture-util-DArajUVn.js";
import { D as gr, F as yr, a as kr, b as br, G as vr, L as Mr, M as xr, S as _r, c as Er, e as Ir, f as wr, g as Sr, h as Pr, j as Tr, k as Cr, l as Ar, m as qr, n as $r, o as Nr, p as jr, q as Or, r as Ur, s as Fr, t as Rr, u as Lr, v as Dr, w as Br, x as Vr, y as zr, z as Hr, A as Jr, B as Kr, C as Gr, E as Yr, H as Xr, I as Wr, J as Zr, K as Qr, N as en, O as tn, P as rn, Q as nn, R as sn, T as an, U as on, V as cn, W as dn, X as pn, Y as ln, Z as un, _ as hn, $ as fn, a0 as mn, a1 as gn, a2 as yn, a3 as kn, a4 as bn, a5 as vn, a6 as Mn, a7 as xn, a8 as _n, a9 as En, aa as In, ab as wn, ac as Sn, ad as Pn } from "./scripture-util-DArajUVn.js";
import { Mutex as Ie } from "async-mutex";
import we from "dompurify";
import { deepEqual as Se } from "fast-equals";
import { USJ_TYPE as Pe } from "@eten-tech-foundation/scripture-utilities";
...
class qe {
  ...
  constructor(e, t) {
    ...
    k(this, "latestOutput");
    k(this, "options");
    k(this, "onDidRebuildEmitter", new Ae());
...
class yt {
  ...
  get(e) {
    ...
    return t || (t = new Ne(), this.mutexesByID.set(e, t), t);
  }
  /**
...
class bt {
  ...
  cleanupPromiseChain(e) {
    ...
    if (!t) return;
    const r = { promise: Oe }, s = t.catch((i) => this.logger.warn(`Error in promise for ${e}: ${i.message}`)).finally(() => {
...
const de = 1e4, H = de / 1e3, pe = 3, ne = /* @__PURE__ */ new Map(), Ue = {
  unsubscribed: {
...
function ie(n, e, t) {
  const { log: r, first: s, suppressed: i } = Ue[e], c = `${n}\0${e}`, p = Date.now(), d = ne.get(c);
  if (!d || p >= d.closesAt) {
    r(s(n, t)), ne.set(c, {
      closesAt: p + de,
      suppressedCount: 0,
...
const xt = "ABORTED", _t = "ALREADY_EXISTS", Et = "CANCELLED", It = "DATA_LOSS", wt = "DEADLINE_EXCEEDED", St = "FAILED_PRECONDITION", Pt = "INTERNAL", Tt = "INVALID_ARGUMENT", Ct = "NOT_FOUND", At = "OUT_OF_RANGE", qt = "PERMISSION_DENIED", $t = "RESOURCE_EXHAUSTED", Nt = "UNAUTHENTICATED", jt = "UNAVAILABLE", Ot = "UNIMPLEMENTED", Ut = "UNKNOWN", L = 1;
function Ft(n, e) {
  if (!n)
    return {
      message: "",
      ...e && { code: e },
      platformErrorVersion: L
    };
  if (w(n))
    return {
      message: n,
...
const Lt = (n) => (...e) => n.map((r) => r(...e)).every((r) => r), Dt = (n) => async (...e) => {
...
function Le(n, e) {
  ...
  return Object.keys(t).forEach((i) => {
    s && (Object.hasOwn(r, i) && Le(r[i], t[i]) || (s = !1));
  }), s;
}
function oe(n, e, t) {
...
const Gt = (n) => n.replace(/&/g, "&amp;").replace(/</g, "&lt;").replace(/>/g, "&gt;").replace(/"/g, "&quot;").replace(/'/g, "&#x27;").replace(/\//g, "&#x2F;");
function Yt() {
  return typeof navigator < "u" && navigator.languages ? navigator.languages[0].replace(/@posix$/i, "") : new Te().resolvedOptions().locale;
}
function Xt(n, e = 2) {
...
function Be(n) {
  return !!He(n.fullName) && n.fullName !== n.shortName;
}
const Ve = " - ";
function Zt(n) {
  return Be(n) ? `${n.shortName}${Ve}${n.fullName}` : n.shortName;
}
function ze(n, e) {
  return n.localeCompare(e, void 0, { sensitivity: "base" });
}
function Qt(n, e) {
  return ze(n.shortName, e.shortName);
}
function He(n) {
  return typeof n == "string" && n.trim().length > 0 ? n : void 0;
}
const Je = 1e3, he = 60, fe = he * 60, Ke = fe * 24;
function er(n, e, t = /* @__PURE__ */ new Date()) {
  const r = Math.floor((e.getTime() - t.getTime()) / Je), s = Math.round(r / Ke);
...
const Ge = 3 - 0.5, Ye = 0.1;
function sr(n = {}) {
  const e = n.zoomStep ?? Ye, t = n.maxSteps ?? Math.ceil(Ge / e), r = n.window ?? globalThis.window, s = 120, i = 100, c = (v) => {
  ...
  let Y = -1 / 0;
  const be = (v) => T.size > 0 || $.size > 0 && v - Y < S, X = (v) => {
  ...
  const ve = (v, E, P) => (
    ...
    v.ctrlKey && !be(P) && v.deltaMode === 0 && v.deltaX === 0 && (Math.abs(Math.exp(-v.deltaY / b) - 1) < u || // The running gesture belongs to the scope it is running in: a gesture that lands somewhere
    // else is a new one, and starts on its own evidence however close behind it arrives.
    E === M && P - x < h)
  ), z = (v) => v < 0 ? -Math.min(-v, t) : Math.min(v, t), Me = (v, E, P) => {
  ...
  return {
    read(v, E) {
      ...
      return ve(v, E, P) ? Me(v, E, P) : xe(v, E);
    },
    dispose() {
...
const Qe = /^%[^%]*%$/;
function ge(n) {
  return typeof n != "string" ? !1 : !Qe.test(n) && n.trim() !== "";
}
function ar(n, e) {
  const t = n == null ? void 0 : n[e];
  return typeof t == "string" && ge(t) ? t : void 0;
}
function or(n, e) {
  return ge(n) ? n : e;
}
...
function cr(n) {
  const e = {};
  return typeof n.language == "string" && n.language.length > 0 && (e[D.language] = n.language), typeof n.type == "string" && n.type.length > 0 && (e[D.type] = n.type), typeof n.typeName == "string" && n.typeName.length > 0 && (e[D.typeName] = n.typeName), typeof n.lastUsedAt == "number" && Number.isFinite(n.lastUsedAt) && (e[D.lastUsedAt] = n.lastUsedAt), e;
}
function dr(n) {
...
function ur(n, e, t) {
  ...
  return s.id = `${rt}${t ? `-${t}` : ""}`, s.dataset.themeId = n.id, s.textContent = it(n), this.document.head.appendChild(s), s;
}
function ke(n) {
  return Object.freeze(n), n == null || Object.getOwnPropertyNames(n).forEach(function(t) {
    ...
    n[t] !== null && (typeof n[t] == "object" || typeof n[t] == "function") && !Object.isFrozen(n[t]) && ke(n[t]);
  }), n;
}
const K = ke({
  version: "3.0.7",
...
class y {
  ...
  static isTopLevelUsjMarker(e, t) {
    return typeof e == "object" && e.type === Pe && t.length === 0;
  }
  /**
  ...
  findAllNotes() {
    var e;
    return Re((e = this.usj) == null ? void 0 : e.content);
  }
  /**
  ...
  getInfoForMarker(e, t = "usfm") {
    ...
    if (t === "usfm" && d === "cell" && b.colspan) {
      const u = parseInt(b.colspan, 10), h = at.exec(r);
      if (h != null && h[1]) {
  ...
  textContentToUsfm(e) {
    return {
      usfm: this.shouldAllowInvisibleCharacters ? e : e.replace(st, "~"),
    ...
    e.map((d) => {
      ...
      if (typeof d.fragment == "object" && "type" in d.fragment) {
        ...
        if (h.type === se && h.code)
          ...
          const f = (m = ot.exec(h.number)) == null ? void 0 : m[1];
          if (!f)
            this.reportProblemOnce(
...
export {
  ...
  mt as Collator,
  It as DATA_LOSS,
  wt as DEADLINE_EXCEEDED,
  gr as DEBOUNCE_CANCELED_ERROR_MESSAGE,
  Te as DateTimeFormat,
  qe as DocumentCombiner,
  gt as EventRollingTimeCounter,
  St as FAILED_PRECONDITION,
  yr as FIRST_SCR_BOOK_NUM,
  kr as FIRST_SCR_CHAPTER_NUM,
  br as FIRST_SCR_VERSE_NUM,
  vr as GraphemeString,
  Pt as INTERNAL,
  Tt as INVALID_ARGUMENT,
  Mr as LAST_SCR_BOOK_NUM,
  xr as MAX_PADDING_LENGTH,
  rr as MODIFIER_KEYS,
  a as MarkerType,
  Ne as Mutex,
  yt as MutexMap,
  ...
  je as NumberFormat,
  At as OUT_OF_RANGE,
  qt as PERMISSION_DENIED,
  L as PLATFORM_ERROR_VERSION,
  Ve as PROJECT_NAME_SEPARATOR,
  D as PROJECT_SELECTOR_CUSTOM_DATA_KEYS,
  Ae as PlatformEventEmitter,
  bt as PromiseChainingMap,
  $t as RESOURCE_EXHAUSTED,
  _r as SELECTABLE_INVISIBLE_CHAR_OR_WHITESPACE_CLASS,
  Er as Section,
  re as SortedNumberMap,
  vt as SortedSet,
  rt as THEME_STYLE_ELEMENT_ID,
  Nt as UNAUTHENTICATED,
  jt as UNAVAILABLE,
  Ot as UNIMPLEMENTED,
  Ut as UNKNOWN,
  K as USFM_MARKERS_MAP_3_0,
  hr as USFM_MARKERS_MAP_PARATEXT_3_0,
  Mt as UnsubscriberAsyncList,
  y as UsjReaderWriter,
  C as VERSE_TYPE,
  Dt as aggregateUnsubscriberAsyncs,
  Lt as aggregateUnsubscribers,
  ur as applyThemeStylesheet,
  Ir as areUsjContentsEqualExceptWhitespace,
  wr as at,
  Sr as charAt,
  Pr as codePointAt,
  Tr as collapseMiddleWords,
  Cr as collectUsjMarkers,
  ze as compareProjectShortNames,
  Qt as compareProjectsByName,
  Ar as compareScrRefs,
  ir as computeEffectiveStructureProtection,
  sr as createContentZoomWheelReader,
  qr as createSyncProxyForAsyncObject,
  $r as debounce,
  U as deepClone,
  J as deepEqual,
  Nr as defaultScrRef,
  De as deserialize,
  pr as doesCatalogRowCoverProject,
  jr as endsWith,
  Or as ensureArray,
  Ur as escapeStringRegexp,
  lr as expandThemeContribution,
  Xt as formatBytes,
  Zt as formatProjectName,
  tr as formatRelativeDate,
  Fr as formatReplacementString,
  Rr as formatReplacementStringToArray,
  Lr as formatScrRef,
  Dr as formatScrRefRange,
  er as formatTimeSpan,
  Br as getAllObjectFunctionNames,
  Vr as getChaptersForBook,
  Yt as getCurrentLocale,
  ue as getDefaultCallerSequence,
  zr as getErrorMessage,
  Ht as getFormatCallerFunction,
  nr as getLocalizeKeyForPhysicalKey,
  Hr as getLocalizeKeyForScrollGroupId,
  Jr as getLocalizeKeysForScrollGroupIds,
  Kr as getLocalizedIdFromBookNumber,
  Fe as getNthCaller,
  Jt as getPaneSizeLimits,
  Gr as getSectionForBook,
  it as getStylesheetForTheme,
  Yr as groupBy,
  Be as hasDistinctFullName,
  Gt as htmlEncode,
  Xr as includes,
  Wr as indexOf,
  Bt as isBlockMarker,
  Vt as isCharacterMarker,
  Zr as isErrorMessageAboutParatextBlockingInternetAccess,
  Qr as isErrorMessageAboutRegistryAuthFailure,
  en as isLocalizeKey,
  Rt as isPlatformError,
  ge as isResolvedLocalizedValue,
  tn as isSelectableInvisibleCharOrWhiteSpace,
  Kt as isSerializable,
  w as isString,
  Le as isSubset,
  rn as isWhiteSpace,
  nn as isolateBidi,
  sn as lastIndexOf,
  ar as localizedStringOrUndefined,
  Ze as localizedStringsDocumentSchema,
  cr as makeProjectSelectorCustomData,
  et as menuDocumentSchema,
  an as newGuid,
  Ft as newPlatformError,
  on as normalize,
  He as normalizeFullName,
  Wt as normalizeProjectId,
  cn as normalizeScriptureSpaces,
  dn as offsetBook,
  pn as offsetChapter,
  ln as offsetVerse,
  un as ordinalCompare,
  hn as padEnd,
  fn as padStart,
  Xe as projectSettingsDocumentSchema,
  dr as recencyMapFromOrderedIds,
  or as resolveLocalizedString,
  mn as retryUntil,
  zt as sanitizeHtml,
  gn as scrRefToBBBCCC,
  yn as scrRefToBBBCCCVVV,
  oe as serialize,
  ...
  Mn as stringLength,
  xn as substring,
  tt as themeDocumentSchema,
  _n as toArray,
  En as toKebabCase,
  In as transformAndEnsureRegExpArray,
  wn as transformAndEnsureRegExpRegExpArray,
  le as usfmMarkers,
  Sn as wait,
  Pn as waitForDuration
};
