...
function qe(n, e) {
  ...
  let r = 0, i = 0;
  function s(a, c, l) {
    const u = S(n, i, c), d = t.length > 0 && b(t[t.length - 1]) ? `${t.pop()}${u}` : u;
    b(a) ? t.push(`${d}${a}`) : (d && t.push(d), t.push(a)), i = c + l;
  }
  const o = N(n);
  for (; r < o; ) {
    switch (P(n, r)) {
...
function nt(n, e) {
  const t = de(n, e == null ? void 0 : e.optionOrLocalizedBookName), r = (e == null ? void 0 : e.bookChapterSeparator) ?? " ", i = (e == null ? void 0 : e.chapterVerseSeparator) ?? ":";
...
function br(n, e) {
  const t = e == null ? void 0 : e.get(n.book);
  return typeof t == "object" && t !== void 0 && "localizedId" in t ? t == null ? void 0 : t.localizedId : t;
}
function Z(n, e) {
  const t = de(n, e == null ? void 0 : e.optionOrLocalizedBookName), r = st(
    n,
...
function he(n, e, t, r) {
  ...
  if (i && s) {
    ...
    if (l !== u) return !1;
    if (!l && !u) {
      let d = o.content, f = a.content;
      const p = d[d.length - 1];
      V.includes(o.type) && b(p) && E(p) && (d = d.slice(0, -1));
      const h = f[f.length - 1];
      if (V.includes(a.type) && b(h) && E(h) && (f = f.slice(0, -1)), d.length !== f.length) return !1;
...
const Er = (n) => n.replace(/&/g, "&amp;").replace(/</g, "&lt;").replace(/>/g, "&gt;").replace(/"/g, "&quot;").replace(/'/g, "&#x27;").replace(/\//g, "&#x2F;");
function Pr() {
...
const ht = 1e3, ge = 60, ye = ge * 60, mt = ye * 24;
function $r(n, e, t = /* @__PURE__ */ new Date()) {
  const r = Math.floor((e.getTime() - t.getTime()) / ht), i = Math.round(r / mt);
...
USJ: ${JSON.stringify(
  ...
  findNextLocationOfMatchingText(e, t, r = 1e3) {
    ...
    const f = m.findNextMatchingNodeUsingWorkingStack(
      ...
      $,
      (p, h) => typeof p != "string" || (s += p.length, s < a + 1) ? !1 : (u = a - s + p.length, d = h, !0)
    );
  ...
  search(e, t) {
    ...
    for (; c !== void 0; )
      c = m.findNextMatchingNodeUsingWorkingStack(
        ...
        // eslint-disable-next-line no-loop-func
        (d, f) => (typeof d != "string" || t && f.some((h) => {
          const g = h.parent;
    ...
    for (; u; ) {
      if (u[0].length > 0) {
        ...
        const d = o.findClosestLessThanOrEqual(u.index);
        if (!d)
          throw new Error(`Internal error: no starting node found for index ${u.index}`);
        const f = {
          node: d.value.node,
          documentLocation: {
            jsonPath: d.value.documentLocation.jsonPath,
            offset: u.index - d.key
          }
  ...
  getInfoForMarker(e, t = "usfm") {
    ...
    if (t === "usfm" && c === "cell" && d.colspan) {
      const f = parseInt(d.colspan, 10), p = Mt.exec(r);
      if (p != null && p[1]) {
        const h = parseInt(p[1], 10);
        !Number.isNaN(h) && !Number.isNaN(f) && (a = `${r}-${h + f - 1}`, l = {
          ...l,
...
`);
    ...
    return i.push({ fragment: e, indexInUsfm: r.length }), r += a === "optbreak" ? "//" : `\\${d}`, a !== "optbreak" && (i.push({
      ...
      const h = u[p.attributeMarkerAttributeName];
      if (!h) return;
      const g = {
        type: p.type,
        marker: f,
      ...
      const { usfm: w } = this.textContentToUsfm(h);
      i.push({
        fragment: {
        ...
        if ("isClosingMarker" in v.fragment) {
          const { isClosingMarker: F, ...A } = v.fragment, Ne = {
            ...A,
            forMarker: e,
  ...
  closingMarkerToUsfm(e, t) {
    const {
      ...
      var g, k;
      return !(h === "type" || h === "marker" || h === "content" || h === "closed" || (g = a.skipOutputAttributeToUsfm) != null && g.includes(h) || (k = s.leadingAttributes) != null && k.includes(h) || s.textContentAttribute === h || c.some(
        ([, w]) => w.attributeMarkerAttributeName === h
      ));
    }), u = e;
    ...
    let d = !0;
    if ((u.closed === "false" || s.isClosingMarkerOptional && !this.markersMap.shouldOptionalClosingMarkersBePresent && u.closed !== "true") && (d = !1), s.independentClosingMarkers && s.independentClosingMarkers.length > 0 && d) {
      const h = {
        type: o,
      ...
      let g = "";
      const k = [], { usfm: w, fragmentsInfo: v } = this.openingMarkerToUsfm(h, t), F = v.find((A) => m.isFragmentAMarker(A.fragment));
      if (!F)
        throw new Error(
      ...
      }), g += w, r !== h.marker && (g = this.addMarkerUsfmToString(
        g,
        {
          isClosingMarker: !0,
          forMarker: h
    ...
    }), f += u[s.defaultAttribute]) : l.forEach((h, g) => {
      const k = o === "figure" && h === "file" ? "src" : h;
      g > 0 && (f += " "), p.push({
 ...
 `);
    ...
    e.map((c) => {
      ...
      if (typeof c.fragment == "object" && "type" in c.fragment) {
        ...
        if (p.type === lt && p.code)
          ...
          const h = (u = St.exec(p.number)) == null ? void 0 : u[1];
          if (!h)
            console.warn(
            ...
            Number.isNaN(g) ? console.warn(
              `Found ${I} type marker with number ${p.number}, but could not parse starting verse number from ${h}. Continuing using previous verse number ${r.verseNum}`
            ) : (f = (d = o[r.bookId]) == null ? void 0 : d[r.chapterNum]) != null && f[g] ? console.warn(`Found ${I} marker with existing number ${g} after
  ...
  calculateUsfmProperties() {
    ...
    return m.findNextMatchingNodeOrClosingFragmentUsingWorkingStack(
      ...
      (u, d) => {
        if (typeof u != "object") {
          const { usfm: p, fragmentsInfo: h } = this.textContentToUsfm(u);
        ...
        let f;
        return d.length > 0 && (f = d[d.length - 1].parent), "isClosingMarker" in u ? l.length > 0 && l[l.length - 1] === u.forMarker ? (l.pop(), !1) : (e = this.addMarkerUsfmToString(
          e,
          u,
          f,
          s
        ), a(d), u.forMarker.type === "book" && c && (e = this.addMarkerUsfmToString(e, c, f, s), a(d), c = void 0), !1) : this.shouldSkipOutputMarkerToUsfm(u) ? (l.push(u), !1) : m.isTopLevelUsjMarker(u, d) && !c ? (u.version !== "3.0" && (c = u), !1) : (e = this.addMarkerUsfmToString(e, u, f, s), a(d), !1);
      }
...
export {
  ...
  Z as formatScrRefWithOptionalParts,
  $r as formatTimeSpan,
  ...
  br as getLocalizedBookName,
  hr as getLocalizedIdFromBookNumber,
  ut as getNthCaller,
