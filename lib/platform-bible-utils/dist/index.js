...
var z = (t, e, r) => Yr(t, typeof e != "symbol" ? e + "" : e, r);
...
class rn {
  ...
  constructor(e, r) {
    ...
    z(this, "latestOutput");
    z(this, "options");
    z(this, "onDidRebuildEmitter", new Qr());
...
var cn = Object.defineProperty, ln = (t, e, r) => e in t ? cn(t, e, { enumerable: !0, configurable: !0, writable: !0, value: r }) : t[e] = r, H = (t, e, r) => ln(t, typeof e != "symbol" ? e + "" : e, r);
const it = [
  "GEN",
  "EXO",
  "LEV",
...
H(Te, "Original", new Te(Pe.Original)), H(Te, "Septuagint", new Te(Pe.Septuagint)), H(Te, "Vulgate", new Te(Pe.Vulgate)), H(Te, "English", new Te(Pe.English)), H(Te, "RussianProtestant", new Te(Pe.RussianProtestant)), H(Te, "RussianOrthodox", new Te(Pe.RussianOrthodox));
let nt = Te;
function er(t, e) {
  const r = e[0];
...
const ve = class K {
  ...
  parse(e) {
    if (e = e.replace(this.rtlMark, ""), e.includes("/")) {
      ...
      if (e = a[0], a.length > 1)
        try {
          const p = +a[1].trim();
          this.versification = new nt(Pe[p]);
        } catch {
    ...
    if (u.length !== 2 || ee.bookIdToNumber(r[0]) === 0 || !Number.isInteger(o) || o < 0 || !K.isVerseParseable(u[1]))
      throw new yt("Invalid reference : " + e);
   ...
   */
  get internalValid() {
    return this.versification == null ? 1 : this._bookNum <= 0 || this._bookNum > ee.lastBook ? 2 : (ee.isCanonical(this._bookNum), 0);
  }
  setEmpty(e = K.defaultVersification) {
    this._bookNum = 0, this._chapterNum = -1, this._verse = void 0, this.versification = e;
  }
  updateInternal(e, r, u) {
    this.bookNum = ee.bookIdToNumber(e), this.chapter = r, this.verse = u;
  }
};
...
*/
H(ve, "ValidStatusType", Lr);
let Pr = ve, yt = class extends Error {
};
var J = {}, le = {}, tr;
function Dt() {
  if (tr) return le;
  ...
  }), N = Object.keys(C).map(function(B) {
    return C[B];
  });
  function y(B) {
  ...
  return le.assign = u, le.find = t, le.freeze = e, le.HTML_BOOLEAN_ATTRIBUTES = o, le.HTML_RAW_TEXT_ELEMENTS = f, le.HTML_VOID_ELEMENTS = p, le.hasDefaultHTMLNamespace = v, le.hasOwn = r, le.isHTMLBooleanAttribute = a, le.isHTMLRawTextElement = d, le.isHTMLEscapableRawTextElement = m, le.isHTMLMimeType = l, le.isHTMLVoidElement = h, le.isValidMimeType = y, le.MIME_TYPE = C, le.NAMESPACE = q, le;
}
var dt = {}, rr;
function _t() {
  if (rr) return dt;
...
function kr() {
  ...
  var C = r(v), N = o("[", C, r(/[-.0-9\xB7]/), r(/[\u0300-\u036F\u203F-\u2040]/), "]"), y = o(v, N, "*"), q = o(N, "+"), B = o("&", y, ";"), F = a(/&#[0-9]+;|&#x[0-9a-fA-F]+;/), U = a(B, "|", F), ue = o("%", y, ";"), he = a(
    o('"', a(/[^%&"]/, "|", ue, "|", U), "*", '"'),
    "|",
    o("'", a(/[^%&']/, "|", ue, "|", U), "*", "'")
  ), g = a('"', a(/[^<&"]/, "|", U), "*", '"', "|", "'", a(/[^<&']/, "|", U), "*", "'"), x = u(v, ":"), k = u(N, ":"), G = o(x, k, "*"), W = o(G, a(":", G), "?"), te = o("^", W, "$"), Ie = o("(", W, ")"), re = a(/"[^"]*"|'[^']*'/), Be = o(/^<\?/, "(", y, ")", a(m, "(", h, "*?)"), "?", /\?>/), E = /[\x20\x0D\x0Aa-zA-Z0-9-'()+,./:=?;!*#@$_%]/, b = a('"', E, '*"', "|", "'", u(E, "'"), "*'"), S = "<!--", T = "-->", M = o(S, a(u(h, "-"), "|", o("-", u(h, "-"))), "*", T), A = "#PCDATA", R = a(
    o(/\(/, l, A, a(l, /\|/, l, W), "*", l, /\)\*/),
    "|",
    o(/\(/, l, A, l, /\)/)
  ), X = /[?*+]?/, _ = o(
  ...
  ), w = a("EMPTY", "|", "ANY", "|", R, "|", _), I = "<!ELEMENT", P = o(I, m, a(W, "|", ue), m, a(w, "|", ue), l, ">"), V = o("NOTATION", m, /\(/, l, y, a(l, /\|/, l, y), "*", l, /\)/), pe = o(/\(/, l, q, a(l, /\|/, l, q), "*", l, /\)/), we = a(V, "|", pe), Ae = a(/CDATA|ID|IDREF|IDREFS|ENTITY|ENTITIES|NMTOKEN|NMTOKENS/, "|", we), ae = a(/#REQUIRED|#IMPLIED/, "|", a(a("#FIXED", m), "?", g)), L = a(m, y, m, Ae, m, ae), Ue = "<!ATTLIST", Re = o(Ue, m, y, L, "*", l, ">"), de = "about:legacy-compat", Ve = a('"' + de + '"', "|", "'" + de + "'"), _e = "SYSTEM", Se = "PUBLIC", ke = a(a(_e, m, re), "|", a(Se, m, b, m, re)), ze = o(
    "^",
    a(
      a(_e, m, "(?<SystemLiteralOnly>", re, ")"),
      "|",
      a(Se, m, "(?<PubidLiteral>", b, ")", m, "(?<SystemLiteral>", re, ")")
    )
  ), Je = a(m, "NDATA", m, y), ye = a(he, "|", a(ke, Je, "?")), Q = "<!ENTITY", Ge = o(Q, m, y, m, ye, l, ">"), se = a(he, "|", ke), Xe = o(Q, m, "%", m, y, m, se, l, ">"), vt = a(Ge, "|", Xe), Ye = o(Se, m, b), Ke = o("<!NOTATION", m, y, m, a(ke, "|", Ye), l, ">"), $ = o(l, "=", l), Z = /1[.]\d+/, Ne = o(m, "version", $, a("'", Z, "'", "|", '"', Z, '"')), be = /[A-Za-z][-A-Za-z0-9._]*/, We = a(m, "encoding", $, a('"', be, '"', "|", "'", be, "'")), st = a(m, "standalone", $, a("'", a("yes", "|", "no"), "'", "|", '"', a("yes", "|", "no"), '"')), ct = o(/^<\?xml/, Ne, We, "?", st, "?", l, /\?>/), lt = "<!DOCTYPE", At = "<![CDATA[", Nt = "]]>", ft = /<!\[CDATA\[/, Qe = /\]\]>/, ht = o(h, "*?", Qe), Ot = o(ft, ht);
  return j.chars = r, j.chars_without = u, j.detectUnicodeSupport = t, j.reg = o, j.regg = a, j.ABOUT_LEGACY_COMPAT = de, j.ABOUT_LEGACY_COMPAT_SystemLiteral = Ve, j.AttlistDecl = Re, j.CDATA_START = At, j.CDATA_END = Nt, j.CDSect = Ot, j.Char = h, j.Comment = M, j.COMMENT_START = S, j.COMMENT_END = T, j.DOCTYPE_DECL_START = lt, j.elementdecl = P, j.EntityDecl = vt, j.EntityValue = he, j.ExternalID = ke, j.ExternalID_match = ze, j.Name = y, j.NotationDecl = Ke, j.Reference = U, j.PEReference = ue, j.PI = Be, j.PUBLIC = Se, j.PubidLiteral = b, j.QName = W, j.QName_exact = te, j.QName_group = Ie, j.S = m, j.SChar_s = d, j.S_OPT = l, j.SYSTEM = _e, j.SystemLiteral = re, j.UNICODE_REPLACEMENT_CHARACTER = p, j.UNICODE_SUPPORT = e, j.XMLDecl = ct, j;
}
var ur;
function Fr() {
  if (ur) return ne;
  ...
  function x(n, i) {
    ...
    if (!(s instanceof i)) {
      ...
      c.prototype = i.prototype, c = new c(), g(s, c), n.prototype = s = c;
    }
    s.constructor != n && (typeof n != "function" && console.error("unknown Class:" + n), s.constructor = n);
  }
  var k = {}, G = k.ELEMENT_NODE = 1, W = k.ATTRIBUTE_NODE = 2, te = k.TEXT_NODE = 3, Ie = k.CDATA_SECTION_NODE = 4, re = k.ENTITY_REFERENCE_NODE = 5, Be = k.ENTITY_NODE = 6, E = k.PROCESSING_INSTRUCTION_NODE = 7, b = k.COMMENT_NODE = 8, S = k.DOCUMENT_NODE = 9, T = k.DOCUMENT_TYPE_NODE = 10, M = k.DOCUMENT_FRAGMENT_NODE = 11, A = k.NOTATION_NODE = 12, R = t.freeze({
  ...
  function I(n, i) {
    this._node = n, this._refresh = i, P(this);
  }
  function P(n) {
  ...
  L.prototype = {
    ...
    normalize: function() {
      for (var n = this.firstChild; n; ) {
        var i = n.nextSibling;
        i && i.nodeType == te && n.nodeType == te ? (this.removeChild(i), n.appendData(i.data)) : (n.normalize(), n = i);
      }
    },
    /**
    ...
    compareDocumentPosition: function(n) {
      ...
      if (i instanceof Ne && (c = i, i = c.ownerElement), s instanceof Ne && (D = s, s = D.ownerElement, c && i && s === i))
      ...
      for (var $e in Ze.childNodes) {
        ...
        if (ce.indexOf(Oe) >= 0) return R.DOCUMENT_POSITION_PRECEDING;
      }
      return 0;
    }
  };
  ...
  g(k, L), g(k, L.prototype), g(R, L), g(R, L.prototype);
  function Re(n, i) {
    if (i(n))
      return !0;
    if (n = n.firstChild)
  ...
  function ze(n) {
    return n && (n.nodeType === L.DOCUMENT_NODE || n.nodeType === L.DOCUMENT_FRAGMENT_NODE || n.nodeType === L.ELEMENT_NODE);
  }
  function Je(n) {
    return n && (n.nodeType === L.CDATA_SECTION_NODE || n.nodeType === L.COMMENT_NODE || n.nodeType === L.DOCUMENT_FRAGMENT_NODE || n.nodeType === L.DOCUMENT_TYPE_NODE || n.nodeType === L.ELEMENT_NODE || n.nodeType === L.PROCESSING_INSTRUCTION_NODE || n.nodeType === L.TEXT_NODE);
  }
  function ye(n) {
    return n && n.nodeType === L.DOCUMENT_TYPE_NODE;
  }
  function Q(n) {
    return n && n.nodeType === L.ELEMENT_NODE;
  }
  function Ge(n) {
    return n && n.nodeType === L.TEXT_NODE;
  }
  function se(n, i) {
    var s = n.childNodes || [];
    if (e(s, Q) || ye(i))
  ...
  function vt(n, i, s) {
    ...
    if (
      ...
      ye(i) && n.nodeType !== L.DOCUMENT_NODE
    )
      throw new l(
  ...
  function Ye(n, i, s) {
    ...
    if (i.nodeType === L.DOCUMENT_FRAGMENT_NODE) {
      var O = D.filter(Q);
      if (O.length > 1 || e(D, Ge))
        throw new l(l.HIERARCHY_REQUEST_ERR, "More than one element or text in fragment");
      if (O.length === 1 && !se(n, s))
  ...
  function $(n, i, s, c) {
    vt(n, i, s), n.nodeType === L.DOCUMENT_NODE && (c || Ye)(n, i, s);
    var D = i.parentNode;
    if (D && D.removeChild(i), i.nodeType === M) {
      ...
      O = Y = i;
    var ce = s ? s.previousSibling : n.lastChild;
    O.previousSibling = ce, Y.nextSibling = s, ce ? ce.nextSibling = O : n.firstChild = O, s == null ? n.lastChild = Y : s.previousSibling = Y;
    do
      O.parentNode = n;
  ...
  function Z(n) {
    N(n), this._nsMap = /* @__PURE__ */ Object.create(null);
  }
  Z.prototype = {
    nodeType: G,
    /**
        ...
        return Re(c, function(O) {
          if (!(O === c || O.nodeType !== G))
            if (n === "*")
              ...
              var Y = O.getQualifiedName(), ce = i && O.namespaceURI === f.HTML ? s : n;
              Y === ce && D.push(O);
            }
        }), D;
      });
  ...
  }, de.prototype.getElementsByClassName = Z.prototype.getElementsByClassName, de.prototype.getElementsByTagName = Z.prototype.getElementsByTagName, de.prototype.getElementsByTagNameNS = Z.prototype.getElementsByTagNameNS, x(Z, L);
  function Ne(n) {
    N(n), this.namespaceURI = null, this.prefix = null, this.ownerElement = null;
  }
  Ne.prototype.nodeType = W, x(Ne, L);
  function be(n) {
    N(n);
  }
  be.prototype = {
  ...
  lt.prototype.nodeType = T, x(lt, L);
  function At(n) {
    N(n);
  }
  At.prototype.nodeType = A, x(At, L);
  function Nt(n) {
    N(n);
  }
  Nt.prototype.nodeType = Be, x(Nt, L);
  function ft(n) {
    N(n);
  }
  ft.prototype.nodeType = re, x(ft, L);
  function Qe(n) {
    N(n);
  }
  Qe.prototype.nodeName = "#document-fragment", Qe.prototype.nodeType = M, x(Qe, L);
  function ht(n) {
    N(n);
  }
  ht.prototype.nodeType = E, x(ht, be);
  function Ot() {
  }
  ...
  function qe(n, i, s, c) {
    ...
    switch (n.nodeType) {
      case G:
        var Y = n.attributes, ce = Y.length, ge = n.firstChild, Ee = n.tagName, Ce = Ee;
          ...
          if (De !== n.namespaceURI)
            for (var $e = c.length - 1; $e >= 0; $e--) {
              ...
              if (Oe.namespace === n.namespaceURI) {
                Oe.prefix && (Ce = Oe.prefix + ":" + Ee);
                break;
              }
            }
        }
        i.push("<", Ce);
        for (var et = 0; et < ce; et++) {
          var Le = Y.item(et);
        ...
        for (var et = 0; et < ce; et++) {
          var Le = Y.item(et);
          if (me(Le, O, c)) {
            var tt = Le.prefix || "", bt = Le.namespaceURI;
            Fe(i, tt ? "xmlns:" + tt : "xmlns", bt), c.push({ prefix: tt, namespace: bt });
          }
          qe(Le, i, s, c);
        }
        if (Ee === Ce && me(n, O, c)) {
          var tt = n.prefix || "", bt = n.namespaceURI;
          Fe(i, tt ? "xmlns:" + tt : "xmlns", bt), c.push({ prefix: tt, namespace: bt });
        }
        var Ft = !ge;
        if (Ft && (O || n.namespaceURI === f.HTML) && (Ft = p(Ee)), Ft)
          i.push("/>");
        else {
          if (i.push(">"), O && a(Ee))
            for (; ge; )
  ...
  function kt(n, i, s) {
    ...
    switch (i.childNodes && (c.childNodes = new w()), c.ownerDocument = n, c.nodeType) {
      case G:
        var Y = i.attributes, ce = c.attributes = new V(), Ee = Y.length;
        ce._ownerElement = c;
    ...
    if (s)
      for (var De = i.firstChild; De; )
        c.appendChild(kt(n, De, s)), De = De.nextSibling;
    return c;
  }
  function Xt(n, i, s) {
    n[i] = s;
  ...
  return ne._updateLiveList = P, ne.Attr = Ne, ne.CDATASection = ct, ne.CharacterData = be, ne.Comment = st, ne.Document = de, ne.DocumentFragment = Qe, ne.DocumentType = lt, ne.DOMImplementation = ae, ne.Element = Z, ne.Entity = Nt, ne.EntityReference = ft, ne.LiveNodeList = I, ne.NamedNodeMap = V, ne.Node = L, ne.NodeList = w, ne.Notation = At, ne.Text = We, ne.ProcessingInstruction = ht, ne.XMLSerializer = Ot, ne;
}
var rt = {}, qt = {}, ir;
function Nn() {
...
function bn() {
  if (or) return Ct;
  or = 1;
  var t = Dt(), e = kr(), r = _t(), u = t.isHTMLEscapableRawTextElement, o = t.isHTMLMimeType, a = t.isHTMLRawTextElement, p = t.hasOwn, h = t.NAMESPACE, f = r.ParseError, d = r.DOMException, m = 0, l = 1, v = 2, C = 3, N = 4, y = 5, q = 6, B = 7;
  function F() {
  }
  F.prototype = {
    parse: function(E, b, S) {
      var T = this.domBuilder;
      T.startDocument(), G(b, b = /* @__PURE__ */ Object.create(null)), ue(E, b, S, T, this.errorHandler), T.endDocument();
    }
  };
  var U = /&#?\w+;?/g;
  function ue(E, b, S, T, M) {
    var A = o(T.mimeType);
    E.indexOf(e.UNICODE_REPLACEMENT_CHARACTER) >= 0 && M.warning("Unicode replacement character detected, source encoding issues?");
    function R($) {
      if ($ > 65535) {
        $ -= 65536;
        var Z = 55296 + ($ >> 10), Ne = 56320 + ($ & 1023);
        return String.fromCharCode(Z, Ne);
      } else
    ...
    function X($) {
      ...
      var Ne = e.Reference.exec(Z);
      if (!Ne || Ne[0].length !== Z.length)
    ...
    function _($) {
      if ($ > ae) {
        var Z = E.substring(ae, $).replace(U, X);
        V && pe(ae), T.characters(Z, 0, $ - ae), ae = $;
      }
    }
    var w = 0, I = 0, P = /\r\n?|\n|$/g, V = T.locator;
    function pe($, Z) {
    ...
    for (var we = [{ currentNSMap: b }], Ae = [], ae = 0; ; ) {
      try {
        var L = E.indexOf("<", ae);
        if (L < 0) {
          if (!A && Ae.length > 0)
            return M.fatalError("unclosed xml tag(s): " + Ae.join(", "));
          if (!E.substring(ae).match(/^\s*$/)) {
            var Ue = T.doc, Re = Ue.createTextNode(E.substring(ae));
        ...
        if (L > ae) {
          var de = E.substring(ae, L);
          !A && Ae.length === 0 && (de = de.replace(new RegExp(e.S_OPT.source, "g"), ""), de && M.error("Unexpected content outside root element: '" + de + "'")), _(L);
        }
        switch (E.charAt(L + 1)) {
          case "/":
            var se = E.indexOf(">", L + 2), Ve = E.substring(L + 2, se > 0 ? se : void 0);
            if (!Ve)
              return M.fatalError("end tag name missing");
            var _e = se > 0 && e.reg("^", e.QName_group, e.S_OPT, "$").exec(Ve);
            if (!_e)
            ...
            var ze = we.pop();
            Ae.pop();
            var Je = ze.localNSMap;
            if (T.endElement(ze.uri, ze.localName, Se), Je)
              for (var ye in Je)
          ...
          // end element
          case "?":
            V && pe(L), se = re(E, L, T, M);
            break;
          case "!":
            V && pe(L), se = Ie(E, L, T, M, A);
            break;
          default:
            V && pe(L);
            var Q = new Be(), Ge = we[we.length - 1].currentNSMap, se = g(E, L, Q, Ge, X, M, A), Xe = Q.length;
            if (Q.closed || (A && t.isHTMLVoidElement(Q.tagName) ? Q.closed = !0 : Ae.push(Q.tagName)), V && Xe) {
              ...
              T.locator = vt, x(Q, T, Ge) && we.push(Q), T.locator = V;
            } else
              x(Q, T, Ge) && we.push(Q);
            A && !Q.closed ? se = k(E, se, Q.tagName, X, T) : se++;
        }
      } catch ($) {
        if ($ instanceof f)
          throw $;
        ...
        M.error("element parse error: " + $), se = -1;
      }
      se > ae ? ae = se : _(Math.max(L, ae) + 1);
    }
  }
  function he(E, b) {
    return b.lineNumber = E.lineNumber, b.columnNumber = E.columnNumber, b;
  }
  function g(E, b, S, T, M, A, R) {
    function X(pe, we, Ae) {
    ...
    for (var _, w, I = ++b, P = m; ; ) {
      ...
      switch (V) {
        ...
        case '"':
          if (P === C || P === l)
            if (P === l && (A.warning('attribute value must after "="'), _ = E.slice(b, I)), b = I + 1, I = E.indexOf(V, b), I > 0)
              w = E.slice(b, I), X(_, w, b - 1), P = y;
            else
              throw new Error("attribute value no end '" + V + "' match");
          else if (P == N)
            w = E.slice(b, I), X(_, w, b), A.warning('attribute "' + _ + '" missed start quot(' + V + ")!!"), b = I + 1, P = y;
          else
        ...
        case "/":
          ...
          break;
        case "":
          return A.error("unexpected end of input"), P == m && S.setTagName(E.slice(b, I)), I;
        case ">":
          switch (P) {
            case m:
              S.setTagName(E.slice(b, I));
            ...
            //Compatible state
            case l:
              w = E.slice(b, I), w.slice(-1) === "/" && (S.closed = !0, w = w.slice(0, -1));
            case v:
              P === v && (w = _), P == N ? (A.warning('attribute "' + w + '" missed quot(")!'), X(_, w, b)) : (R || A.warning('attribute "' + w + '" missed value!! "' + w + '" instead!!'), X(w, w, b));
              break;
            case C:
              if (!R)
        ...
        default:
          if (V <= " ")
            switch (P) {
              ...
              case N:
                var w = E.slice(b, I);
                A.warning('attribute "' + w + '" missed quot(")!!'), X(_, w, b);
              case y:
                P = q;
                break;
            }
            ...
            switch (P) {
              ...
              case v:
                R || A.warning('attribute "' + _ + '" missed value!! "' + _ + '" instead2!!'), X(_, _, b), b = I, P = l;
                break;
              case y:
  ...
  function x(E, b, S) {
    for (var T = E.tagName, M = null, P = E.length; P--; ) {
      var A = E[P], R = A.qName, X = A.value, V = R.indexOf(":");
      if (V > 0)
        var _ = A.prefix = R.slice(0, V), w = R.slice(V + 1), I = _ === "xmlns" && w;
      else
        w = R, _ = null, I = R === "xmlns" && "";
      A.localName = w, I !== !1 && (M == null && (M = /* @__PURE__ */ Object.create(null), G(S, S = /* @__PURE__ */ Object.create(null))), S[I] = M[I] = X, A.uri = h.XMLNS, b.startPrefixMapping(I, X));
    }
    for (var P = E.length; P--; )
      A = E[P], A.prefix && (A.prefix === "xml" && (A.uri = h.XML), A.prefix !== "xmlns" && (A.uri = S[A.prefix]));
    var V = T.indexOf(":");
    V > 0 ? (_ = E.prefix = T.slice(0, V), w = E.localName = T.slice(V + 1)) : (_ = null, w = E.localName = T);
    var pe = E.uri = S[_ || ""];
    if (b.startElement(pe, w, T, E), E.closed) {
      if (b.endElement(pe, w, T), M)
        for (_ in M)
          p(M, _) && b.endPrefixMapping(_);
    } else
      return E.currentNSMap = S, E.localNSMap = M, !0;
  }
  function k(E, b, S, T, M) {
    var A = u(S);
    if (A || a(S)) {
      var R = E.indexOf("</" + S + ">", b), X = E.substring(b + 1, R);
...
` && P !== "	" && P !== "\r")
    ...
    function X(I) {
      return E.substring(S, S + I.length) === I;
    }
    function _(I) {
      return E.substring(S, S + I.length).toUpperCase() === I.toUpperCase();
    }
    function w(I) {
      var P = e.reg("^", I), V = P.exec(R());
  ...
  function te(E, b) {
    ...
    if (E.char() === "[") {
      E.skip(1);
      for (var M = E.getIndex(); E.getIndex() < T.length; ) {
        if (E.skipBlanks(), E.char() === "]") {
          var A = T.substring(M, E.getIndex());
          return E.skip(1), A;
        }
        var R = null;
        if (E.char() === "<" && E.char(1) === "!")
        ...
        if (!R)
          return b.fatalError("Error in internal subset at position " + E.getIndex());
      }
      return b.fatalError("doctype internal subset is not well-formed, missing ]");
    }
  }
  function Ie(E, b, S, T, M) {
    var A = W(E, b);
    switch (M ? A.char(2).toUpperCase() : A.char(2)) {
      ...
      case "[":
        ...
        return X ? !M && !S.currentElement ? T.fatalError("CDATA outside of element") : (S.startCDATA(), S.characters(X, e.CDATA_START.length, X.length - e.CDATA_START.length - e.CDATA_END.length), S.endCDATA(), A.getIndex()) : T.fatalError("Invalid CDATA starting at position " + b);
      case "D": {
        ...
        return M && _.systemId && !e.ABOUT_LEGACY_COMPAT_SystemLiteral.test(_.systemId) && T.warning("Unexpected doctype.systemId in HTML document at position " + A.getIndex()), M || (A.skipBlanks(), _.internalSubset = te(A, T)), A.skipBlanks(), A.char() !== ">" ? T.fatalError("doctype not terminated with > at position " + A.getIndex()) : (A.skip(1), S.startDTD(_.name, _.publicId, _.systemId, _.internalSubset), S.endDTD(), A.getIndex());
      }
      default:
  ...
  function re(E, b, S, T) {
    var M = E.substring(b).match(e.PI);
    if (!M)
    ...
    if (M[1].toLowerCase() === "xml") {
      ...
      if (!e.XMLDecl.test(E.substring(b)))
        return T.fatalError("xml declaration is not well-formed");
    }
    return S.processingInstruction(M[1], M[2]), b + M[0].length;
  }
  function Be() {
  ...
  return Be.prototype = {
    ...
    addValue: function(E, b, S) {
      if (!e.QName_exact.test(E))
        throw new Error("invalid attribute:" + E);
      this.attributeNames[E] = this.length, this[this.length++] = { qName: E, value: b, offset: S };
    },
    length: 0,
...
function yn() {
  if (ar) return rt;
  ar = 1;
  var t = Dt(), e = Fr(), r = _t(), u = Nn(), o = bn(), a = e.DOMImplementation, p = t.hasDefaultHTMLNamespace, h = t.isHTMLMimeType, f = t.isValidMimeType, d = t.MIME_TYPE, m = t.NAMESPACE, l = r.ParseError, v = o.XMLReader;
  function C(g) {
    return g.replace(/\r[\n\u0085]/g, `
`).replace(/[\r\u0085\u2028\u2029]/g, `
`);
  ...
  function N(g) {
    if (g = g || {}, g.locator === void 0 && (g.locator = !0), this.assign = g.assign || t.assign, this.domHandler = g.domHandler || y, this.onError = g.onError || g.errorHandler, g.errorHandler && typeof g.errorHandler != "function")
      throw new TypeError("errorHandler object is no longer supported, switch to onError!");
    g.errorHandler && g.errorHandler("warning", "The `errorHandler` option has been deprecated, use `onError` instead!", this), this.normalizeLineEndings = g.normalizeLineEndings || C, this.locator = !!g.locator, this.xmlns = this.assign(/* @__PURE__ */ Object.create(null), g.xmlns);
  }
  N.prototype.parseFromString = function(g, x) {
    if (!f(x))
    ...
    this.locator && te.setDocumentLocator(Ie);
    var re = new v();
    re.errorHandler = te, re.domBuilder = te;
    var Be = !t.isHTMLMimeType(x);
    return Be && typeof g != "string" && re.errorHandler.fatalError("source is not a string"), re.parse(this.normalizeLineEndings(String(g)), k, G), te.doc.documentElement || re.errorHandler.fatalError("missing root element"), te.doc;
  };
  function y(g) {
    var x = g || {};
  ...
  y.prototype = {
    ...
    startDocument: function() {
      var g = new a();
      this.doc = h(this.mimeType) ? g.createHTMLDocument(!1) : g.createDocument(this.defaultNamespace, "");
    },
    startElement: function(g, x, k, G) {
      var W = this.doc, te = W.createElementNS(g, k || x), Ie = G.length;
      U(this, te), this.currentElement = te, this.locator && q(this.locator, te);
      for (var re = 0; re < Ie; re++) {
        var g = G.getURI(re), Be = G.getValue(re), k = G.getQName(re), E = W.createAttributeNS(g, k);
        this.locator && q(G.getLocator(re), E), E.value = E.nodeValue = Be, te.setAttributeNode(E);
      }
    },
    endElement: function(g, x, k) {
    ...
    processingInstruction: function(g, x) {
      var k = this.doc.createProcessingInstruction(g, x);
      this.locator && q(this.locator, k), U(this, k);
    },
    ignorableWhitespace: function(g, x, k) {
    },
    characters: function(g, x, k) {
      if (g = F.apply(this, arguments), g) {
        if (this.cdata)
          var G = this.doc.createCDATASection(g);
        else
          var G = this.doc.createTextNode(g);
        this.currentElement ? this.currentElement.appendChild(G) : /^\s*$/.test(g) && this.doc.appendChild(G), this.locator && q(this.locator, G);
      }
    },
    ...
    startDTD: function(g, x, k, G) {
      var W = this.doc.implementation;
      if (W && W.createDocumentType) {
        var te = W.createDocumentType(g, x, k, G);
        this.locator && q(this.locator, te), U(this, te), this.doc.doctype = te;
      }
    },
    reportError: function(g, x) {
      if (typeof this.onError == "function")
        try {
          ...
          throw new l("Reporting " + g + ' "' + x + '" caused ' + k, this.locator);
        }
      else
        console.error("[xmldom " + g + "]	" + x, B(this.locator));
    },
    /**
...
@#[line:` + g.lineNumber + ",col:" + g.columnNumber + "]";
  ...
  function F(g, x, k) {
    return typeof g == "string" ? g.substr(x, k) : g.length >= x + k || x ? new java.lang.String(g, x, k) + "" : g;
  }
  ...
  return rt.__DOMHandler = y, rt.DOMParser = N, rt.normalizeLineEndings = C, rt.onErrorStopParsing = ue, rt.onWarningStopParsing = he, rt;
}
var sr;
function Cn() {
  if (sr) return J;
...
function Tn() {
  return cr || (cr = 1, $t = () => {
    const t = "\\ud800-\\udfff", p = "\\u0300-\\u036f" + "\\ufe20-\\ufe2f" + "\\u20d0-\\u20ff" + "\\u1ab0-\\u1aff" + "\\u1dc0-\\u1dff", h = "\\ufe0e\\ufe0f", f = "\\uD83D\\uDC69\\uD83C\\uDFFB\\u200D\\uD83C\\uDF93", d = `[${t}]`, m = `[${p}]`, l = "\\ud83c[\\udffb-\\udfff]", v = `(?:${m}|${l})`, C = `[^${t}]`, N = "(?:\\uD83C[\\uDDE6-\\uDDFF]){2}", y = "[\\ud800-\\udbff][\\udc00-\\udfff]", q = "\\u200d", B = "(?:\\ud83c\\udff4\\udb40\\udc67\\udb40\\udc62\\udb40(?:\\udc65|\\udc73|\\udc77)\\udb40(?:\\udc6e|\\udc63|\\udc6c)\\udb40(?:\\udc67|\\udc74|\\udc73)\\udb40\\udc7f)", F = `[${f}]`, U = `${v}?`, ue = `[${h}]?`, he = `(?:${q}(?:${[C, N, y].join("|")})${ue + U})*`, g = ue + U + he, k = `(?:${[`${C}${m}?`, m, N, y, d, F].join("|")})`;
    return new RegExp(`${B}|${l}(?=${l})|${k + g}`, "g");
  }), $t;
}
var lr;
function wn() {
...
const Ut = ["chapter", "book", "para", "row", "sidebar", jt], _n = "​", jr = [
...
], Ln = 1, Pn = jr.length - 1, kn = 1, Fn = 1, Ai = {
  book: "GEN",
  chapterNum: 1,
  verseNum: 1
}, qn = (t) => {
  ...
  book: ee.bookNumberToId(
    Math.max(
      Ln,
      Math.min(ee.bookIdToNumber(t.book) + e, Pn)
    )
  ),
  chapterNum: 1,
  verseNum: 1
...
function Ti(t) {
  return new Pr(ee.bookIdToNumber(t.book), t.chapterNum, t.verseNum).BBBCCC;
}
function dr(t) {
  return new Pr(ee.bookIdToNumber(t.book), t.chapterNum, t.verseNum).BBBCCCVVV;
}
function wi(t, e) {
  return dr(t) - dr(e);
}
...
function Oi(t, e, r, u) {
  ...
  switch (e ?? "id") {
    case "English":
      o = ee.bookIdToEnglishName(t.book);
      break;
    case "id":
      o = t.book;
      break;
...
var jn = /* @__PURE__ */ ((t) => (t.OT = "OT", t.NT = "NT", t.DC = "DC", t.Extra = "Extra", t))(jn || {});
const Ii = (t) => {
  if (ee.isBookOT(t)) return "OT";
  if (ee.isBookNT(t)) return "NT";
  if (ee.isBookDC(t)) return "DC";
  if (ee.isExtraMaterial(t)) return "Extra";
  throw new Error(`Unknown section for book: ${t}`);
}, xi = (t) => ({
  otLong: t == null ? void 0 : t["%scripture_section_ot_long%"],
  ntLong: t == null ? void 0 : t["%scripture_section_nt_long%"],
  dcLong: t == null ? void 0 : t["%scripture_section_dc_long%"],
  extraLong: t == null ? void 0 : t["%scripture_section_extra_long%"],
  otShort: t == null ? void 0 : t["%scripture_section_ot_short%"],
  ntShort: t == null ? void 0 : t["%scripture_section_nt_short%"],
  dcShort: t == null ? void 0 : t["%scripture_section_dc_short%"],
  extraShort: t == null ? void 0 : t["%scripture_section_extra_short%"]
}), Mi = (t, e, r, u, o) => {
  switch (t) {
    case "OT":
...
function Ri(t, e, r) {
  ...
  if (!u) return !1;
  const o = ee.bookIdToEnglishName(t), a = r == null ? void 0 : r.get(t), p = o.toLowerCase().includes(u) || t.toLowerCase().includes(u), h = a ? a.localizedName.toLowerCase().includes(u) || a.localizedId.toLowerCase().includes(u) : !1;
  return p || h;
}
function _i(t, e) {
  var u;
  return ((u = e == null ? void 0 : e.get(t)) == null ? void 0 : u.localizedName) ?? ee.bookIdToEnglishName(t);
}
function Li(t, e) {
  var u;
  return ((u = e == null ? void 0 : e.get(t)) == null ? void 0 : u.localizedId) ?? t.toUpperCase();
}
const Un = ee.allBookIds.filter(
  (t) => !ee.isObsolete(ee.bookIdToNumber(t))
), Pi = Object.fromEntries(
  Un.map((t) => [t, ee.bookIdToEnglishName(t)])
), Vn = (
  // Using unicode control characters to be very explicit about which characters we are using.
  // The first 6 characters are the control characters \f\n\r\t\v.
  // eslint-disable-next-line no-control-regex
...
function Er(t) {
  ...
  for (let o = 0; o < t.length; o += 1) {
    const a = t[o];
    a.charCodeAt(0) < 32 ? (r || (e += " "), r = !0) : !r && a === _n && o + 1 < t.length && mr(t[o + 1]) || (mr(a) ? (r || (e += a), r = !0) : Hn(a) && u === a || (e += a, r = !1)), u = a;
  }
  return e;
}
function gr(t) {
...
function Ur(t, e, r, u) {
  ...
  if (o && a) {
    ...
    const d = gr(p.content), m = gr(h.content);
    if (d !== m) return !1;
    if (!d && !m) {
...
const Fi = (t) => (...e) => t.map((u) => u(...e)).every((u) => u), qi = (t) => async (...e) => {
  const r = t.map(async (u) => u(...e));
  return (await Promise.all(r)).every((u) => u);
}, Mt = "chapter", Bt = "verse";
var zn = Object.getOwnPropertyNames, Jn = Object.getOwnPropertySymbols, Xn = Object.prototype.hasOwnProperty;
function vr(t, e) {
...
function Ar(t) {
  return zn(t).concat(Jn(t));
}
var Yn = Object.hasOwn || function(t, e) {
  return Xn.call(t, e);
};
function at(t, e) {
  return t === e || !t && !e && t !== t && e !== e;
}
var Kn = "__v", Wn = "__o", Qn = "_owner", Nr = Object.getOwnPropertyDescriptor, br = Object.keys;
function Zn(t, e, r) {
  var u = t.length;
  if (e.length !== u)
    return !1;
...
function Tt(t, e, r) {
  ...
  if (Ar(e).length !== o)
    return !1;
  for (var a, p, h; o-- > 0; )
    if (a = u[o], !Vr(t, e, r, a) || (p = Nr(t, a), h = Nr(e, a), (p || h) && (!p || !h || p.configurable !== h.configurable || p.enumerable !== h.enumerable || p.writable !== h.writable)))
      return !1;
  return !0;
}
function iu(t, e) {
...
function Vr(t, e, r, u) {
  return (u === Qn || u === Wn || u === Kn) && (t.$$typeof || e.$$typeof) ? !0 : Yn(e, u) && r.equals(t[u], e[u], u, u, t, e, r);
}
var cu = "[object Arguments]", lu = "[object Boolean]", fu = "[object Date]", hu = "[object Error]", pu = "[object Map]", du = "[object Number]", mu = "[object Object]", Eu = "[object RegExp]", gu = "[object Set]", Du = "[object String]", vu = "[object URL]", Au = Array.isArray, Tr = typeof ArrayBuffer == "function" && ArrayBuffer.isView ? ArrayBuffer.isView : null, wr = Object.assign, Nu = Object.prototype.toString.call.bind(Object.prototype.toString);
function bu(t) {
  ...
  return function(N, y, q) {
    ...
    if (B !== typeof y)
      return !1;
    if (B !== "object")
      return B === "number" ? p(N, y, q) : B === "function" ? o(N, y, q) : !1;
    var F = N.constructor;
    if (F !== y.constructor)
      return !1;
    if (F === Object)
    ...
    if (F === Set)
      return m(N, y, q);
    var U = Nu(N);
    return U === fu ? r(N, y, q) : U === Eu ? d(N, y, q) : U === pu ? a(N, y, q) : U === gu ? m(N, y, q) : U === mu ? typeof N.then != "function" && typeof y.then != "function" && h(N, y, q) : U === vu ? v(N, y, q) : U === hu ? u(N, y, q) : U === cu ? h(N, y, q) : U === lu || U === du || U === Du ? f(N, y, q) : !1;
  };
}
function yu(t) {
  var e = t.circular, r = t.createCustomConfig, u = t.strict, o = {
    areArraysEqual: u ? Tt : Zn,
    areDatesEqual: eu,
    areErrorsEqual: tu,
    areFunctionsEqual: ru,
    areMapsEqual: u ? vr(yr, Tt) : yr,
    areNumbersEqual: nu,
    areObjectsEqual: u ? Tt : uu,
    arePrimitiveWrappersEqual: iu,
    areRegExpsEqual: ou,
    areSetsEqual: u ? vr(Cr, Tt) : Cr,
    areTypedArraysEqual: u ? Tt : au,
    areUrlsEqual: su
  };
  if (r && (o = wr({}, o, r(o))), e) {
...
function He(t) {
  t === void 0 && (t = {});
  var e = t.circular, r = e === void 0 ? !1 : e, u = t.createInternalComparator, o = t.createState, a = t.strict, p = a === void 0 ? !1 : a, h = yu(t), f = bu(h), d = u ? u(f) : Cu(f);
  return Tu({ circular: r, comparator: f, createState: o, equals: d, strict: p });
}
function Su(t, e) {
  return wu(t, e);
}
function Ou(t, e) {
  ...
  return Object.keys(r).forEach((a) => {
    o && (Object.hasOwn(u, a) && Ou(u[a], r[a]) || (o = !1));
  }), o;
}
function Sr(t, e, r) {
...
const ji = (t) => t.replace(/&/g, "&amp;").replace(/</g, "&lt;").replace(/>/g, "&gt;").replace(/"/g, "&quot;").replace(/'/g, "&#x27;").replace(/\//g, "&#x2F;");
function Ui() {
...
const xu = 1e3, Gr = 60, Hr = Gr * 60, Mu = Hr * 24;
function Gi(t, e, r = /* @__PURE__ */ new Date()) {
  const u = Math.floor((e.getTime() - r.getTime()) / xu), o = Math.round(u / Mu);
  if (Math.abs(o) >= 1) return t.format(o, "day");
  const a = Math.round(u / Hr);
  if (Math.abs(a) >= 1) return t.format(a, "hour");
  const p = Math.round(u / Gr);
...
function Ji(t, e, r) {
  ...
  return o.id = `${ku}${r ? `-${r}` : ""}`, o.dataset.themeId = t.id, o.textContent = qu(t), this.document.head.appendChild(o), o;
}
...
class oe {
  ...
  static createParentMapInternal(e, r, u) {
    ...
    u.set(e, r), e.content && u.set(e.content, e), (o = e.content) == null || o.forEach((a) => {
      typeof a == "object" && oe.createParentMapInternal(a, e, u);
    });
  }
  ...
  createUsjParentMap() {
    ...
    return this.usj.content && e.set(this.usj.content, this.usj), this.usj.content.forEach((r) => {
      typeof r == "object" && oe.createParentMapInternal(r, this.usj, e);
    }), e;
  }
  ...
  findNextMatchingNode(e, r, u) {
    ...
    return oe.findNextMatchingNodeUsingWorkingStack(
      e,
      o,
      r,
      u
  ...
  nodeToJsonPath(e) {
    return oe.convertWorkingStackToJsonPath(this.createWorkingStack(e));
  }
  // #endregion
  ...
  findVerseRefForNode(e, r, u = {
    ...
    const p = r.content[a], h = oe.findRightMostDescendantMarkerObject(
      p,
      r,
      je
    );
  ...
  verseRefToUsjContentLocation(e, r = 0) {
    ...
    const h = e.verse ?? e.verseNum.toString(), f = this.findNextMatchingNode(
      o,
      je,
      (v, C) => v === o ? e.verseNum === 0 ? (p = oe.convertWorkingStackToJsonPath(C), !0) : !1 : typeof v != "object" ? !1 : v.type === Mt ? (a = !0, !0) : v.type === Bt && v.number !== void 0 && v.number === h ? (p = oe.convertWorkingStackToJsonPath(C), !0) : !1
    );
    ...
    return this.findNextMatchingNode(
      ...
      (v, C) => {
        ...
        if (typeof v == "string") {
          if (d += v.length, d > r)
            return p = oe.convertWorkingStackToJsonPath(C), m = r - d + v.length, l = v, !0;
  ...
  findNextLocationOfMatchingText(e, r, u = 1e3) {
    ...
    if (oe.findNextMatchingNodeUsingWorkingStack(
      e.node,
      f,
      je,
      (C, N) => {
        ...
        oe.areStackItemsShallowEqual(q, d) && (y = C.substring(e.offset), p += e.offset), a += y.length, o = `${o}${y}`;
        const B = o.indexOf(r);
    ...
    a = 0;
    let m = 0, l = [];
    const v = oe.findNextMatchingNodeUsingWorkingStack(
      e.node,
      this.convertJsonPathToWorkingStack(e.jsonPath),
      je,
      (C, N) => typeof C != "string" || (a += C.length, a < h + 1) ? !1 : (m = h - a + C.length, l = N, !0)
    );
    if (!v) throw new Error("Internal error: inconsistent search results");
    return {
      node: v,
      offset: m,
      jsonPath: oe.convertWorkingStackToJsonPath(l)
    };
  }
  search(e) {
    const r = [];
    ...
    let p = 0, h = u.node;
    for (; h !== void 0; )
      h = oe.findNextMatchingNodeUsingWorkingStack(
        u.node,
  ...
  extractTextBetweenPoints(e, r, u = 100) {
    ...
    return oe.findNextMatchingNodeUsingWorkingStack(
      ...
      this.convertJsonPathToWorkingStack(e.jsonPath),
      je,
      (a, p) => a === r.node && (typeof a == "object" || r.jsonPath === oe.convertWorkingStackToJsonPath(p)) ? !0 : typeof a != "string" ? !1 : (o = `${o}${a}`, o.length > u && (o = o.substring(0, u)), o.length >= u)
    ), o;
  }
  // #endregion
  ...
  removeContentNodes(e) {
    const r = oe.removeContentNodesFromArray(this.usj.content, e);
...
export {
  ...
  un as Mutex,
  ei as MutexMap,
  ti as NonValidatingDocumentCombiner,
  on as NumberFormat,
  It as PLATFORM_ERROR_VERSION,
  Qr as PlatformEventEmitter,
  ri as PromiseChainingMap,
  jn as Section,
  sn as SortedNumberMap,
  ni as SortedSet,
  ku as THEME_STYLE_ELEMENT_ID,
  ui as UnsubscriberAsyncList,
  oe as UsjReaderWriter,
  Bt as VERSE_TYPE,
  qi as aggregateUnsubscriberAsyncs,
  Fi as aggregateUnsubscribers,
  Ji as applyThemeStylesheet,
  ki as areUsjContentsEqualExceptWhitespace,
  xt as at,
  Et as charAt,
  ci as codePointAt,
  wi as compareScrRefs,
  Ku as createSyncProxyForAsyncObject,
  zu as debounce,
  wt as deepClone,
  Su as deepEqual,
  Ai as defaultScrRef,
  Iu as deserialize,
  Ri as doesBookMatchQuery,
  Sn as endsWith,
  qr as ensureArray,
  Ei as escapeStringRegexp,
  zi as expandThemeContribution,
  Vi as formatBytes,
  li as formatReplacementString,
  In as formatReplacementStringToArray,
  Oi as formatScrRef,
  Gi as formatTimeSpan,
  Yu as getAllObjectFunctionNames,
  qn as getChaptersForBook,
  Ui as getCurrentLocale,
  Or as getErrorMessage,
  $n as getLocalizeKeyForScrollGroupId,
  Si as getLocalizeKeysForScrollGroupIds,
  Li as getLocalizedBookId,
  _i as getLocalizedBookName,
  Ci as getLocalizedIdFromBookNumber,
  xi as getLocalizedSectionNames,
  Ii as getSectionForBook,
  Mi as getSectionLongName,
  Bi as getSectionShortName,
  qu as getStylesheetForTheme,
  Ju as groupBy,
  ji as htmlEncode,
  xn as includes,
  St as indexOf,
  Wu as isErrorMessageAboutParatextBlockingInternetAccess,
  Qu as isErrorMessageAboutRegistryAuthFailure,
  mi as isLocalizeKey,
  oi as isPlatformError,
  $i as isSerializable,
  Me as isString,
  Ou as isSubset,
  mt as isWhiteSpace,
  Mn as lastIndexOf,
  _u as localizedStringsDocumentSchema,
  Lu as menuDocumentSchema,
  Hu as newGuid,
  ii as newPlatformError,
  fi as normalize,
  Er as normalizeScriptureSpaces,
  Ni as offsetBook,
  bi as offsetChapter,
  yi as offsetVerse,
  hi as ordinalCompare,
  pi as padEnd,
  di as padStart,
  Bu as projectSettingsDocumentSchema,
  Ti as scrRefToBBBCCC,
  ...
  Bn as toArray,
  vi as toKebabCase,
  Di as transformAndEnsureRegExpArray,
  gi as transformAndEnsureRegExpRegExpArray,
  tn as wait,
