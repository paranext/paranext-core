...
var pe = (s, e, t) => e in s ? de(s, e, { enumerable: !0, configurable: !0, writable: !0, value: t }) : s[e] = t;
var y = (s, e, t) => pe(s, typeof e != "symbol" ? e + "" : e, t);
import { d as N, i as E } from "./scripture-util-DArajUVn.js";
import { D as zt, F as Ht, a as Jt, b as Kt, G as Gt, L as Yt, M as Xt, S as Wt, c as Zt, e as Qt, f as er, g as tr, h as rr, j as nr, k as ir, l as sr, m as ar, n as or, o as cr, p as dr, q as pr, r as lr, s as ur, t as hr, u as fr, v as mr, w as gr, x as yr, y as kr, z as br, A as vr, B as Mr, C as xr, E as _r, H as Er, I as Ir, J as wr, K as Sr, N as Pr, O as Tr, P as Cr, Q as Ar, R as qr, T as $r, U as jr, V as Nr, W as Fr, X as Ur, Y as Rr, Z as Or, _ as Dr, $ as Lr, a0 as Br, a1 as Vr, a2 as zr, a3 as Hr, a4 as Jr, a5 as Kr, a6 as Gr, a7 as Yr, a8 as Xr, a9 as Wr, aa as Zr, ab as Qr, ac as en, ad as tn } from "./scripture-util-DArajUVn.js";
...
import { JSONPath as $ } from "jsonpath-plus";
const F = class F {
  /**
...
class ke {
  ...
  constructor(e, t) {
    ...
    y(this, "latestOutput");
    y(this, "options");
    y(this, "onDidRebuildEmitter", new ye());
  ...
  updateBaseDocument(e) {
    return this.validateBaseDocument(e), this.baseDocument = this.options.copyDocuments ? N(e) : e, this.baseDocument = this.transformBaseDocumentAfterValidation(this.baseDocument), this.rebuild();
  }
  /**
  ...
  addOrUpdateContribution(e, t) {
    ...
    let i = this.options.copyDocuments && t ? N(t) : t;
...
class et {
  ...
  cleanupPromiseChain(e) {
    ...
    if (!t) return;
    const r = { promise: xe }, i = t.catch((n) => this.logger.warn(`Error in promise for ${e}: ${n.message}`)).finally(() => {
...
const Q = 1e4, O = Q / 1e3, ee = 3, G = /* @__PURE__ */ new Map(), _e = {
  unsubscribed: {
    ...
    suppressed: (s, e) => `UnsubscriberAsyncList ${s}: ${e} more unsubscribers arrived after the list was run in the last ${O}s and were unsubscribed immediately; per-occurrence warnings suppressed.`
  },
  failed: {
    log: (s) => console.error(s),
    first: (s) => `UnsubscriberAsyncList ${s}: Unsubscriber added after the list was run failed!`,
    suppressed: (s, e) => `UnsubscriberAsyncList ${s}: ${e} more unsubscribers added after the list was run failed in the last ${O}s; per-occurrence errors suppressed.`
  },
  threw: {
    log: (s) => console.error(s),
    ...
    suppressed: (s, e, t) => `UnsubscriberAsyncList ${s}: ${e} more unsubscribers added after the list was run threw in the last ${O}s; per-occurrence errors suppressed. Distinct errors sampled (up to ${ee}): ${t.join(" | ")}`
  }
};
function Y(s, e, t) {
  const { log: r, first: i, suppressed: n } = _e[e], c = `${s}\0${e}`, p = Date.now(), d = G.get(c);
  if (!d || p >= d.closesAt) {
    r(i(s, t)), G.set(c, {
      closesAt: p + Q,
      suppressedCount: 0,
  ...
  d.suppressedCount += 1, t !== void 0 && d.suppressedErrorSamples.size < ee && d.suppressedErrorSamples.add(`${t}`), d.summaryTimeout || (d.summaryTimeout = setTimeout(() => {
    const { suppressedCount: l } = d, h = [...d.suppressedErrorSamples];
    d.suppressedCount = 0, d.suppressedErrorSamples.clear(), d.summaryTimeout = void 0, l > 0 && r(n(s, l, h));
...
const nt = "ABORTED", it = "ALREADY_EXISTS", st = "CANCELLED", at = "DATA_LOSS", ot = "DEADLINE_EXCEEDED", ct = "FAILED_PRECONDITION", dt = "INTERNAL", pt = "INVALID_ARGUMENT", lt = "NOT_FOUND", ut = "OUT_OF_RANGE", ht = "PERMISSION_DENIED", ft = "RESOURCE_EXHAUSTED", mt = "UNAUTHENTICATED", gt = "UNAVAILABLE", yt = "UNIMPLEMENTED", kt = "UNKNOWN", U = 1;
function bt(s, e) {
  if (!s)
    return {
      message: "",
  ...
  if (typeof s == "object" && "message" in s && typeof s.message == "string") {
    ...
    return Object.defineProperties(t, Object.getOwnPropertyDescriptors(s)), Object.defineProperty(t, "message", { enumerable: !0 }), "stack" in s && E(s.stack) && Object.defineProperty(t, "stack", { value: s.stack, enumerable: !0 }), "cause" in t && Object.defineProperty(t, "cause", { enumerable: !0 }), e && (t.code = e), t;
  }
  return {
    cause: s,
    message: "",
...
const Mt = (s) => (...e) => s.map((r) => r(...e)).every((r) => r), xt = (s) => async (...e) => {
  const t = s.map(async (r) => r(...e));
  return (await Promise.all(t)).every((r) => r);
}, Ee = "book", X = "chapter", P = "verse", T = "***", Ie = "ws";
...
function _t(s) {
  var e;
  return ((e = te[s]) == null ? void 0 : e.type) === a.Paragraph || s === "v";
}
function Et(s) {
  const e = te[s];
...
function Pe(s, e) {
  ...
  return Object.keys(t).forEach((n) => {
    i && (Object.hasOwn(r, n) && Pe(r[n], t[n]) || (i = !1));
  }), i;
}
function W(s, e, t) {
...
const Tt = (s) => s.replace(/&/g, "&amp;").replace(/</g, "&lt;").replace(/>/g, "&gt;").replace(/"/g, "&quot;").replace(/'/g, "&#x27;").replace(/\//g, "&#x2F;");
function Ct() {
...
const Ce = 1e3, ne = 60, ie = ne * 60, Ae = ie * 24;
function $t(s, e, t = /* @__PURE__ */ new Date()) {
  const r = Math.floor((e.getTime() - t.getTime()) / Ce), i = Math.round(r / Ae);
  if (Math.abs(i) >= 1) return s.format(i, "day");
  const n = Math.round(r / ie);
  if (Math.abs(n) >= 1) return s.format(n, "hour");
  const c = Math.round(r / ne);
  return Math.abs(c) >= 1 ? s.format(c, "minute") : s.format(r, "second");
}
function jt(s, e, t, r, i = {
  year: "numeric",
  month: "short",
  day: "numeric"
}) {
...
function Dt(s, e, t) {
  ...
  return i.id = `${Ue}${t ? `-${t}` : ""}`, i.dataset.themeId = s.id, i.textContent = Oe(s), this.document.head.appendChild(i), i;
}
function oe(s) {
  return Object.freeze(s), s == null || Object.getOwnPropertyNames(s).forEach(function(t) {
    ...
    s[t] !== null && (typeof s[t] == "object" || typeof s[t] == "function") && !Object.isFrozen(s[t]) && oe(s[t]);
  }), s;
}
const L = oe({
  version: "3.0.7",
...
}), j = ["figure", "note", "sidebar", "table"];
Object.freeze(j);
const ce = ["para", "table", "row", "cell", "sidebar"];
Object.freeze(ce);
const De = /\u00A0/g, Le = /\w+(\d+)/, Be = /(\d+)-?(\d+)?/;
class m {
  constructor(e, t) {
    y(this, "usj");
    y(this, "markersMap");
    ...
    if (r)
      this.markersMap = r, m.areUsjVersionsCompatible(this.usj.version, this.markersMap.version) || console.warn(
...
USJ: ${JSON.stringify(
    ...
    else if (m.areUsjVersionsCompatible(this.usj.version, L.version))
      this.markersMap = L;
    else
      throw new Error(
  ...
  findSingleValue(e) {
    const t = $({ path: e, json: this.usj, wrap: !0 });
    if (t === void 0 || t.length === 0) return;
    if (!Array.isArray(t[0])) return t[0];
    const r = $({ path: e, json: this.usj, wrap: !1 });
  ...
  static createParentMapInternal(e, t, r) {
    ...
    r.set(e, t), e.content && r.set(e.content, e), (i = e.content) == null || i.forEach((n) => {
      typeof n == "object" && m.createParentMapInternal(n, e, r);
    });
  }
  ...
  createUsjParentMap() {
    ...
    return this.usj.content && e.set(this.usj.content, this.usj), this.usj.content.forEach((t) => {
      typeof t == "object" && m.createParentMapInternal(t, this.usj, e);
    }), e;
  }
  ...
  static normalizeJsonPath(e) {
    const t = $.toPathArray(e);
    return m.jsonPathArrayToJsonPath(t);
  }
  /**
  ...
  static convertWorkingStackAndPropertyToJsonPath(e, t) {
    return `${m.convertWorkingStackToJsonPath(e)}['${t}']`;
  }
  ...
  static findNextMatchingNodeOrClosingFragmentUsingWorkingStack(e, t, r, i) {
    ...
    if (!E(c)) {
      ...
      let d;
      t.some((l) => {
        const h = l.parent.content[l.index];
        return !E(h) && r.includes(h.type) ? (d = h, !0) : !1;
      }), d && (n = d);
    }
    for (; n !== void 0; ) {
  ...
  findNextMatchingNode(e, t) {
    ...
    let i = r;
    const n = m.findNextMatchingNodeUsingWorkingStack(
      e.node,
      r,
      [],
      (c, p) => (i = p, t({
        node: c,
        documentLocation: m.convertNodeToUsjDocumentLocation(c, p)
      }))
    );
    if (n !== void 0)
      return {
        node: n,
        documentLocation: m.convertNodeToUsjDocumentLocation(
          n,
          i
        )
      };
  ...
  nodeToJsonPath(e) {
    return m.convertWorkingStackToJsonPath(this.createWorkingStack(e));
  }
  ...
  nodeToUsjNodeAndDocumentLocation(e, t) {
    ...
    const i = m.convertNodeToUsjDocumentLocation(e, r);
    return {
      node: e,
      documentLocation: i
    };
  ...
  usjDocumentLocationToUsfmVerseRefVerseLocation(e, t) {
    ...
    return {
      ...
      offset: r.indexInUsfm - n + m.getOffsetInUsjDocumentLocation(e)
    };
  }
  ...
  getEffectiveBookId(e) {
    const t = Object.keys(this.indicesInUsfmByVerseRef), r = t.length === 0 || t.length === 1 && t[0] === T, i = r ? T : e;
    if (!this.indicesInUsfmByVerseRef[i])
      throw new Error(
        `Book ID ${e} not found in USJ! ${r ? `There seems to be no USJ content because there is no content in ${T} either` : `Book IDs in USJ: ${JSON.stringify(t)}`}`
      );
    return i;
  }
  /**
  ...
  getVerseRefForIndexInUsfm(e, t) {
    ...
    return d && m.isFragmentAMarker(d.fragment) && d.fragment.type === P && d.fragment.number && d.fragment.number !== `${n.verseNum}` && (n.verse = d.fragment.number), n;
  }
  usfmVerseLocationToIndexInUsfm(e) {
    const { verseRef: t, offset: r } = m.usfmVerseLocationToUsfmVerseRefVerseLocation(e);
  ...
  usfmVerseLocationToUsjNodeAndDocumentLocation(e) {
    const { verseRef: t, offset: r } = m.usfmVerseLocationToUsfmVerseRefVerseLocation(e), i = this.usfmVerseLocationToIndexInUsfm(e), { value: n } = this.fragmentsByIndexInUsfm.findClosestLessThanOrEqual(
      i
    ) ?? {
      value: void 0
    };
    ...
    return {
      ...
      documentLocation: m.moveUsjDocumentLocationToNewOffset(
  ...
  static isUsjDocumentLocationForNode(e) {
    ...
    if ("node" in e) {
      if (E(e.node))
        return m.isUsjDocumentLocationForTextContent(e);
      t = e.documentLocation;
    }
  ...
  findNextLocationOfMatchingText(e, t, r = 1e3) {
    ...
    if (m.findNextMatchingNodeUsingWorkingStack(
      e.node,
      d,
      j,
      (u, g) => {
        ...
        if (l && m.areStackItemsShallowEqual(M, l)) {
          ...
          k = u.substring(e.documentLocation.offset), c += e.documentLocation.offset;
        }
        n += k.length, i = `${i}${k}`;
        const I = i.indexOf(t);
        return I < 0 ? (c += i.length, i.length > t.length && (i = i.substring(i.length - t.length)), c -= i.length, n > r) : (p = c + I, !0);
      }
    ), p < 0) return;
    n = 0;
    let h = 0, b = [];
    const f = m.findNextMatchingNodeUsingWorkingStack(
      e.node,
      this.convertJsonPathToWorkingStack(e.documentLocation.jsonPath),
      j,
      (u, g) => typeof u != "string" || (n += u.length, n < p + 1) ? !1 : (h = p - n + u.length, b = g, !0)
    );
    ...
    return {
      node: f,
      documentLocation: {
        jsonPath: m.convertWorkingStackToJsonPath(b),
        offset: h
      }
    };
  }
   ...
   */
  static findNearestBlockAncestor(e) {
    for (let t = e.length - 1; t >= 0; t--) {
      const { parent: r } = e[t];
      if (r && "type" in r && ce.includes(r.type)) return r;
    }
  }
  /**
   ...
   */
  static hasWhitespaceGapAwayFromBoundary(e, t, r) {
    var n;
    const i = (n = e.indices) == null ? void 0 : n.groups;
    return i ? Object.entries(i).some(([c, p]) => {
      if (!c.startsWith(Ie) || !p) return !1;
      const [d, l] = p;
      if (l > d) return !1;
      const h = r ? r[d] : d;
      return !t.has(h);
  ...
  search(e, t) {
    ...
    }, p = [], d = new K(), l = /* @__PURE__ */ new Set();
    let h, b = !1, f = 0, u = c.node;
    for (; u !== void 0; )
      u = m.findNextMatchingNodeUsingWorkingStack(
        c.node,
        ...
        // eslint-disable-next-line no-loop-func
        (x, S) => {
          if (typeof x != "string" || r && S.some((A) => {
            const w = A.parent;
            if (!w || !("type" in w) || w.type === "char") return !1;
            let q;
            return "style" in w && typeof w.style == "string" ? q = w.style : "marker" in w && typeof w.marker == "string" && (q = w.marker), q !== void 0 && !r.has(q);
          }))
            return !1;
          const C = m.findNearestBlockAncestor(S);
          return b && C !== h && l.add(f), h = C, b = !0, p.push(x), d.set(f, {
            node: x,
            documentLocation: {
              offset: 0,
              jsonPath: m.convertWorkingStackToJsonPath(S)
            }
          }), f += x.length, !1;
        }
      );
    const g = p.join(""), k = i === "NFD" ? m.buildNFDToOriginalPositionMap(g) : void 0, M = k ? g.normalize("NFD") : g, I = t instanceof Set ? !1 : !!(t != null && t.flexibleWhitespaceAtBlockBoundaries), v = I && !e.flags.includes("d") ? new RegExp(e.source, `${e.flags}d`) : e;
    let _ = v.exec(M);
    for (; _; )
      if (_[0].length === 0) {
        if (!v.global || v.lastIndex >= M.length) break;
        v.lastIndex += 1, _ = v.exec(M);
      } else if (I && m.hasWhitespaceGapAwayFromBoundary(
        _,
        l,
        k
      )) {
        if (!v.global) break;
        v.lastIndex = _.index + 1, _ = v.exec(M);
      } else {
        const x = k ? k[_.index] : _.index, S = k ? k[_.index + _[0].length] : _.index + _[0].length;
        if (x < 0 || x >= g.length)
          throw new Error(`Match index out of bounds: ${x}`);
        const C = d.findClosestLessThanOrEqual(x);
        if (!C)
          throw new Error(`Internal error: no starting node found for index ${x}`);
        const V = {
          node: C.value.node,
          documentLocation: {
            jsonPath: C.value.documentLocation.jsonPath,
            offset: x - C.key
          }
        }, A = d.findClosestLessThanOrEqual(S - 1);
        if (!A)
          throw new Error(`Internal error: no ending node found for index ${x}`);
        const w = {
          node: A.value.node,
          documentLocation: {
            jsonPath: A.value.documentLocation.jsonPath,
            offset: S - A.key
          }
        }, q = k ? g.substring(x, S) : _[0];
        if (n.push({ text: q, start: V, end: w }), !v.global) break;
        _ = v.exec(M);
      }
    return n;
  }
  ...
  extractText(e, t) {
    ...
    return m.findNextMatchingNodeUsingWorkingStack(
      e.node,
      this.convertJsonPathToWorkingStack(e.documentLocation.jsonPath),
      j,
      (c) => {
  ...
  extractTextBetweenPoints(e, t, r = 100) {
    ...
    return m.findNextMatchingNodeUsingWorkingStack(
      ...
      this.convertJsonPathToWorkingStack(e.documentLocation.jsonPath),
      j,
      (n, c) => n === t.node && (typeof n == "object" || t.documentLocation.jsonPath === m.convertWorkingStackToJsonPath(c)) ? !0 : typeof n != "string" ? !1 : (i = `${i}${n}`, i.length > r && (i = i.substring(0, r)), i.length >= r)
    ), i;
  }
  ...
  removeContentNodes(e) {
    const t = m.removeContentNodesFromArray(this.usj.content, e);
  ...
  getInfoForMarker(e, t = "usfm") {
    ...
    if (l != null && l.markerTypeUsfm && (d = l.markerTypeUsfm, l = this.markersMap.markerTypes[d]), !E(e) && e.type !== c && (!l || e.type !== l.markerTypeUsfm && e.type !== l.markerTypeUsx && e.type !== l.markerTypeUsj) && (console.warn(
    ...
    n.attributeMarkers && n.attributeMarkers.forEach((f) => {
      const u = this.getMarkerInfo(f);
      u && "attributeMarkerAttributeName" in u && h.push([f, u]);
    });
    const b = e;
    if (t === "usfm" && d === "cell" && b.colspan) {
      const f = parseInt(b.colspan, 10), u = Le.exec(r);
      if (u != null && u[1]) {
        const g = parseInt(u[1], 10);
        !Number.isNaN(g) && !Number.isNaN(f) && (p = `${r}-${g + f - 1}`, l = {
          ...l,
  ...
  textContentToUsfm(e) {
    return {
      usfm: this.shouldAllowInvisibleCharacters ? e : e.replace(De, "~"),
  ...
  openingMarkerToUsfm(e, t) {
    let r = "";
    const i = [], { markerName: n, markerInfo: c, markerType: p, markerTypeInfo: d, attributeMarkerInfoEntries: l } = this.getInfoForMarker(e), h = e;
...
`);
    ...
    return i.push({ fragment: e, indexInUsfm: r.length }), r += p === "optbreak" ? "//" : `\\${b}`, p !== "optbreak" && (i.push({
    ...
    }), c.textContentAttribute && h[c.textContentAttribute] && (i.push({
      fragment: { attributeValueForKey: c.textContentAttribute, forMarker: e },
      indexInUsfm: r.length
    }), r += `${h[c.textContentAttribute]} `), c.attributeMarkers && l.forEach(([f, u]) => {
      const g = h[u.attributeMarkerAttributeName];
      if (!g) return;
      const k = {
        type: u.type,
        marker: f,
      ...
      const { usfm: I } = this.textContentToUsfm(g);
      i.push({
        fragment: {
          attributeValueForKey: u.attributeMarkerAttributeName,
          forMarker: e
        },
        indexInUsfm: r.length
        ...
        if (E(v.fragment) || "attributeKey" in v.fragment)
          throw new Error(
        ...
        if (m.isFragmentAMarker(v.fragment)) {
          i.push({
            ...v,
            fragment: {
              attributeMarker: u.attributeMarkerAttributeName,
              forMarker: e
            }
          });
          return;
        ...
        if ("attributeValueForKey" in v.fragment) {
          ...
          i.push({
            ...v,
            fragment: {
              attributeKey: u.attributeMarkerAttributeName,
              forMarker: e
            }
          });
          return;
        ...
        if ("isClosingMarker" in v.fragment) {
          const { isClosingMarker: _, ...x } = v.fragment, S = {
            ...x,
            forMarker: e,
            attributeMarkerClosingMarker: u.attributeMarkerAttributeName
          };
          i.push({
            ...v,
            fragment: S
      ...
      }), !this.markersMap.isSpaceAfterAttributeMarkersContent && u.hasStructuralSpaceAfterCloseAttributeMarker && (r += " ");
  ...
  closingMarkerToUsfm(e, t) {
    ...
    } = this.getInfoForMarker(e), l = Object.keys(e).filter((g) => {
      var k, M;
      return !(g === "type" || g === "marker" || g === "content" || g === "closed" || (k = p.skipOutputAttributeToUsfm) != null && k.includes(g) || (M = n.leadingAttributes) != null && M.includes(g) || n.textContentAttribute === g || d.some(
        ([, I]) => I.attributeMarkerAttributeName === g
      ));
    }), h = e;
    ...
    let b = !0;
    if ((h.closed === "false" || n.isClosingMarkerOptional && !this.markersMap.shouldOptionalClosingMarkersBePresent && h.closed !== "true") && (b = !1), n.independentClosingMarkers && n.independentClosingMarkers.length > 0 && b) {
      const g = {
        type: c,
      ...
      let k = "";
      const M = [], { usfm: I, fragmentsInfo: v } = this.openingMarkerToUsfm(g, t), _ = v.find((x) => m.isFragmentAMarker(x.fragment));
      if (!_)
        throw new Error(
      ...
      }), k += I, r !== g.marker && (k = this.addMarkerUsfmToString(
        k,
        {
          isClosingMarker: !0,
          forMarker: g
    ...
    let f = "";
    const u = [];
    if (l.length > 0 && (f += "|", l.length === 1 && l[0] === n.defaultAttribute ? (u.push({
      fragment: { attributeValueForKey: n.defaultAttribute, forMarker: e },
      indexInUsfm: f.length
    }), f += h[n.defaultAttribute]) : l.forEach((g, k) => {
      ...
      const g = p.isClosingMarkerEmpty ? "" : i, k = t ? p.nestedPrefix ?? "" : "";
      u.push({
        fragment: { isClosingMarker: !0, forMarker: e },
        indexInUsfm: f.length
      }), f += `\\${k}${g}*`;
    }
    return { usfm: f, fragmentsInfo: u };
  }
  /**
  ...
  addMarkerUsfmToString(e, t, r, i) {
    let n = e, c, p;
    const { markerNameOriginal: d, markerType: l, markerTypeInfo: h } = this.getInfoForMarker(
    ...
    if ("isClosingMarker" in t) {
      const { usfm: f, fragmentsInfo: u } = this.closingMarkerToUsfm(
        t.forMarker,
        b
      );
      p = u, c = f, h.isCloseable && h.isClosingMarkerEmpty && // No contents
      (!t.forMarker.content || t.forMarker.content.length === 0) && // No closing marker attributes
      !c.startsWith("|") && (n = m.removeEndSpace(n));
    } else {
      const { usfm: f, fragmentsInfo: u } = this.openingMarkerToUsfm(
        t,
        b
      );
      p = u, c = f;
...
`) && (n.length === 0 ? (p = p.map((f) => ({
    ...
    })), c = c.substring(1)) : n = m.removeEndSpace(n)), this.markersMap.isSpaceAfterAttributeMarkersContent && d === "ca") {
      const f = n.lastIndexOf("\\");
      f >= 0 && n.substring(
        f + 1,
        f + 3
      ) === "c " && (n = m.removeEndSpace(n), n += `
 `);
    }
    return i && m.mergeFragmentsInfoIntoExistingArray(
      p,
      i,
      n.length
    ), n += c, n;
  ...
  static areUsjDocumentLocationsEqual(e, t, r = !1) {
    ...
    return !r && !D($.toPathArray(i), $.toPathArray(c)) ? !1 : D(n, p);
  }
  /** Find the fragment info corresponding to the specified USJ Document location. */
  findFragmentInfoAtUsjDocumentLocation(e) {
    const t = m.moveUsjDocumentLocationToNewOffset(e, 0);
    let r;
    const i = this.fragmentsByJsonPath.get(
      m.normalizeJsonPath(e.jsonPath)
    );
    if (i)
      return i.find((n) => m.areUsjDocumentLocationsEqual(
        n.nodeAndDocumentLocation.documentLocation,
        t,
  ...
  static convertNodeToUsjDocumentLocation(e, t, r = 0) {
    const i = m.convertWorkingStackToJsonPath(t);
    return E(e) ? { jsonPath: i, offset: r } : { jsonPath: i };
  }
  /**
  ...
  static convertFragmentToUsjNodeAndDocumentLocation(e, t, r = 0) {
    if (E(e) || m.isFragmentAMarker(e)) {
      const i = m.convertNodeToUsjDocumentLocation(
        e,
        t,
        r
      );
    ...
    if ("isClosingMarker" in e) {
      const n = {
        jsonPath: m.convertWorkingStackToJsonPath(t),
    ...
    if ("attributeValueForKey" in e) {
      const n = {
        jsonPath: m.convertWorkingStackAndPropertyToJsonPath(
          t,
  ...
  static transferFragmentsInfoArrayToMaps(e, t, r, i, n, c) {
    e.map((d) => {
      ...
      if (typeof d.fragment == "object" && "type" in d.fragment) {
        const u = d.fragment;
        if (u.type === Ee && u.code)
          r.bookId = u.code, r.chapterNum = 0, r.verseNum = 0, c[T] && (c[r.bookId] = c[T], delete c[T]);
        else if (u.type === X && u.number) {
          const g = parseInt(u.number, 10);
          if (Number.isNaN(g))
            console.warn(
              `Found ${X} type marker with number ${u.number}, but could not parse chapter number from it. Continuing using previous chapter number ${r.chapterNum}`
            );
          else {
            r.chapterNum = g, r.verseNum = 0;
            const k = c[r.bookId];
            k != null && k[0] && (k[r.chapterNum] = k[0], delete k[0]);
          }
        } else if (u.type === P && u.number) {
          const g = (h = Be.exec(u.number)) == null ? void 0 : h[1];
          if (!g)
            console.warn(
              `Found ${P} type marker with number ${u.number}, but could not find starting verse number in it. Continuing using previous verse number ${r.verseNum}`
            );
          else {
            const k = parseInt(g, 10);
            Number.isNaN(k) ? console.warn(
              `Found ${P} type marker with number ${u.number}, but could not parse starting verse number from ${g}. Continuing using previous verse number ${r.verseNum}`
            ) : (f = (b = c[r.bookId]) == null ? void 0 : b[r.chapterNum]) != null && f[k] ? console.warn(`Found ${P} marker with existing number ${k} after
                  current ${P} number ${r.verseNum}! Not updating verse start index. All positions in this duplicate verse will be based on the current ${P} marker, not the new duplicate marker.`) : (k < r.verseNum && console.debug(
              `Found ${P} marker with number ${k} lower than current ${P} number ${r.verseNum}. Verses are out of order. There may be some issues.`
            ), r.verseNum = k);
          }
        }
      }
      return {
        ...
        nodeAndDocumentLocation: m.convertFragmentToUsjNodeAndDocumentLocation(
          d.fragment,
          t
        )
      };
      ...
      const l = d.nodeAndDocumentLocation.documentLocation.jsonPath, h = n.get(l);
      h ? h.push(d) : n.set(l, [d]), c[r.bookId] || (c[r.bookId] = {}), c[r.bookId][r.chapterNum] || (c[r.bookId][r.chapterNum] = {}), c[r.bookId][r.chapterNum][r.verseNum] === void 0 && (c[r.bookId][r.chapterNum][r.verseNum] = d.indexInUsfm);
    }), e.splice(0);
  }
  ...
  calculateUsfmProperties() {
    let e = "";
    const t = new K(), r = /* @__PURE__ */ new Map(), i = {}, n = [], c = {
      bookId: T,
      chapterNum: 0,
      verseNum: 0
    };
    function p(h) {
      m.transferFragmentsInfoArrayToMaps(
        n,
        h,
        c,
        t,
    ...
    let d;
    const l = [];
    return m.findNextMatchingNodeOrClosingFragmentUsingWorkingStack(
      this.usj,
      ...
      (h, b) => {
        if (typeof h != "object") {
          const { usfm: u, fragmentsInfo: g } = this.textContentToUsfm(h);
          return m.mergeFragmentsInfoIntoExistingArray(
            g,
            n,
            e.length
          ), p(b), e += u, !1;
        ...
        let f;
        return b.length > 0 && (f = b[b.length - 1].parent), "isClosingMarker" in h ? l.length > 0 && l[l.length - 1] === h.forMarker ? (l.pop(), !1) : (e = this.addMarkerUsfmToString(
          e,
          h,
          f,
          n
        ), p(b), h.forMarker.type === "book" && d && (e = this.addMarkerUsfmToString(e, d, f, n), p(b), d = void 0), !1) : this.shouldSkipOutputMarkerToUsfm(h) ? (l.push(h), !1) : m.isTopLevelUsjMarker(h, b) && !d ? (h.version !== "3.0" && (d = h), !1) : (e = this.addMarkerUsfmToString(e, h, f, n), p(b), !1);
      }
    ), e = `${m.removeEndSpace(e)}
...
export {
  ...
  Xe as Collator,
  at as DATA_LOSS,
  ot as DEADLINE_EXCEEDED,
  zt as DEBOUNCE_CANCELED_ERROR_MESSAGE,
  me as DateTimeFormat,
  ke as DocumentCombiner,
  We as EventRollingTimeCounter,
  ct as FAILED_PRECONDITION,
  Ht as FIRST_SCR_BOOK_NUM,
  Jt as FIRST_SCR_CHAPTER_NUM,
  Kt as FIRST_SCR_VERSE_NUM,
  Gt as GraphemeString,
  dt as INTERNAL,
  pt as INVALID_ARGUMENT,
  Yt as LAST_SCR_BOOK_NUM,
  Xt as MAX_PADDING_LENGTH,
  Nt as MODIFIER_KEYS,
  a as MarkerType,
  ve as Mutex,
  Ze as MutexMap,
  lt as NOT_FOUND,
  Qe as NonValidatingDocumentCombiner,
  Me as NumberFormat,
  ut as OUT_OF_RANGE,
  ht as PERMISSION_DENIED,
  U as PLATFORM_ERROR_VERSION,
  ye as PlatformEventEmitter,
  et as PromiseChainingMap,
  ft as RESOURCE_EXHAUSTED,
  Ie as SEARCH_WHITESPACE_GROUP_PREFIX,
  Wt as SELECTABLE_INVISIBLE_CHAR_OR_WHITESPACE_CLASS,
  Zt as Section,
  K as SortedNumberMap,
  tt as SortedSet,
  Ue as THEME_STYLE_ELEMENT_ID,
  mt as UNAUTHENTICATED,
  gt as UNAVAILABLE,
  yt as UNIMPLEMENTED,
  kt as UNKNOWN,
  L as USFM_MARKERS_MAP_3_0,
  Lt as USFM_MARKERS_MAP_PARATEXT_3_0,
  rt as UnsubscriberAsyncList,
  m as UsjReaderWriter,
  P as VERSE_TYPE,
  xt as aggregateUnsubscriberAsyncs,
  Mt as aggregateUnsubscribers,
  Dt as applyThemeStylesheet,
  Qt as areUsjContentsEqualExceptWhitespace,
  er as at,
  tr as charAt,
  rr as codePointAt,
  nr as collapseMiddleWords,
  ir as collectUsjMarkers,
  sr as compareScrRefs,
  Ut as computeEffectiveStructureProtection,
  ...
  cr as defaultScrRef,
  Te as deserialize,
  Rt as doesCatalogRowCoverProject,
  dr as endsWith,
  pr as ensureArray,
  lr as escapeStringRegexp,
  Ot as expandThemeContribution,
  At as formatBytes,
  jt as formatRelativeDate,
  ur as formatReplacementString,
  hr as formatReplacementStringToArray,
  fr as formatScrRef,
  mr as formatScrRefRange,
  $t as formatTimeSpan,
  gr as getAllObjectFunctionNames,
  yr as getChaptersForBook,
  Ct as getCurrentLocale,
  re as getDefaultCallerSequence,
  kr as getErrorMessage,
  wt as getFormatCallerFunction,
  Ft as getLocalizeKeyForPhysicalKey,
  br as getLocalizeKeyForScrollGroupId,
  vr as getLocalizeKeysForScrollGroupIds,
  Mr as getLocalizedIdFromBookNumber,
  we as getNthCaller,
  St as getPaneSizeLimits,
  xr as getSectionForBook,
  Oe as getStylesheetForTheme,
  _r as groupBy,
  Tt as htmlEncode,
  Er as includes,
  Ir as indexOf,
  _t as isBlockMarker,
  Et as isCharacterMarker,
  wr as isErrorMessageAboutParatextBlockingInternetAccess,
  Sr as isErrorMessageAboutRegistryAuthFailure,
  Pr as isLocalizeKey,
  vt as isPlatformError,
  Tr as isSelectableInvisibleCharOrWhiteSpace,
  Pt as isSerializable,
  E as isString,
  Pe as isSubset,
  Cr as isWhiteSpace,
  Ar as isolateBidi,
  qr as lastIndexOf,
  je as localizedStringsDocumentSchema,
  Ne as menuDocumentSchema,
  $r as newGuid,
  bt as newPlatformError,
  jr as normalize,
  qt as normalizeProjectId,
  Nr as normalizeScriptureSpaces,
  Fr as offsetBook,
  Ur as offsetChapter,
  Rr as offsetVerse,
  Or as ordinalCompare,
  Dr as padEnd,
  Lr as padStart,
  qe as projectSettingsDocumentSchema,
  Br as retryUntil,
  It as sanitizeHtml,
  Vr as scrRefToBBBCCC,
  zr as scrRefToBBBCCCVVV,
  W as serialize,
  $e as settingsDocumentSchema,
  Hr as slice,
  Jr as split,
  Kr as startsWith,
  Gr as stringLength,
  Yr as substring,
  Fe as themeDocumentSchema,
  Xr as toArray,
  Wr as toKebabCase,
  Zr as transformAndEnsureRegExpArray,
  Qr as transformAndEnsureRegExpRegExpArray,
  te as usfmMarkers,
  en as wait,
  tn as waitForDuration
};
