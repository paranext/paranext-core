...
function St(i) {
  return _e(i) ? `${i.shortName} - ${i.fullName}` : i.shortName;
}
function Pt(i, e) {
  return i.shortName.localeCompare(e.shortName, void 0, { sensitivity: "base" });
}
const Ee = 1e3, Z = 60, Q = Z * 60, Ie = Q * 24;
