...
class $t {
  ...
  get(e) {
    ...
    return r || (r = new he(), this.mutexesByID.set(e, r), r);
  }
}
const W = [
...
var I = typeof globalThis < "u" ? globalThis : typeof window < "u" ? window : typeof global < "u" ? global : typeof self < "u" ? self : {}, y = {}, Ne = () => {
  const t = "\\ud800-\\udfff", e = "\\u0300-\\u036f", r = "\\ufe20-\\ufe2f", s = "\\u20d0-\\u20ff", i = "\\u1ab0-\\u1aff", n = "\\u1dc0-\\u1dff", a = e + r + s + i + n, o = "\\ufe0e\\ufe0f", c = "\\uD83D\\uDC69\\uD83C\\uDFFB\\u200D\\uD83C\\uDF93", p = `[${t}]`, u = `[${a}]`, l = "\\ud83c[\\udffb-\\udfff]", f = `(?:${u}|${l})`, g = `[^${t}]`, m = "(?:\\uD83C[\\uDDE6-\\uDDFF]){2}", N = "[\\ud800-\\udbff][\\udc00-\\udfff]", P = "\\u200d", ee = "(?:\\ud83c\\udff4\\udb40\\udc67\\udb40\\udc62\\udb40(?:\\udc65|\\udc73|\\udc77)\\udb40(?:\\udc6e|\\udc63|\\udc6c)\\udb40(?:\\udc67|\\udc74|\\udc73)\\udb40\\udc7f)", te = `[${c}]`, D = `${f}?`, M = `[${o}]?`, re = `(?:${P}(?:${[g, m, N].join("|")})${M + D})*`, se = M + D + re, ie = `(?:${[`${g}${u}?`, u, m, N, p, te].join("|")})`;
...
function $(t, e, r) {
  ...
  if (G(e).length !== i)
    return !1;
  for (var n, a, o; i-- > 0; )
    if (n = s[i], n === Q && (t.$$typeof || e.$$typeof) && t.$$typeof !== e.$$typeof || !X(e, n) || !r.equals(t[n], e[n], n, n, t, e, r) || (a = V(t, n), o = V(e, n), (a || o) && (!a || !o || a.configurable !== o.configurable || a.enumerable !== o.enumerable || a.writable !== o.writable)))
      return !1;
  return !0;
}
function Ge(t, e) {
...
function Ye(t) {
  ...
  return function(u, l, f) {
    ...
    if (g === Set)
      return o(u, l, f);
    var m = Qe(u);
    return m === Fe ? r(u, l, f) : m === We ? a(u, l, f) : m === Ue ? s(u, l, f) : m === Le ? o(u, l, f) : m === He ? typeof u.then != "function" && typeof l.then != "function" && i(u, l, f) : m === _e ? i(u, l, f) : m === Ke || m === ke || m === Ze ? n(u, l, f) : !1;
  };
}
function et(t) {
