...
function me(t) {
  ...
  return z(e) && !V.includes(e);
}
function Le(t) {
  return me(T(t));
}
function ge(t) {
  const e = typeof t == "number" ? G(t) : t;
  return J(e) && !z.includes(e);
}
function Ue(t) {
...
const y = class f {
  ...
  allVerses(e = !1, r = f.verseRangeSeparators, s = f.verseSequenceIndicators) {
    if (this._verse == null || this.chapterNum <= 0)
      return [this.clone()];
    const i = [], n = Q(this._verse, s);
    for (const o of n.map((a) => Q(a, r))) {
      const a = this.clone();
      a.verse = o[0];
      const h = a.verseNum;
...
var Y = typeof globalThis < "u" ? globalThis : typeof window < "u" ? window : typeof global < "u" ? global : typeof self < "u" ? self : {}, S = {}, Qe = () => {
  const t = "\\ud800-\\udfff", e = "\\u0300-\\u036f", r = "\\ufe20-\\ufe2f", s = "\\u20d0-\\u20ff", i = "\\u1ab0-\\u1aff", n = "\\u1dc0-\\u1dff", o = e + r + s + i + n, a = "\\ufe0e\\ufe0f", h = "\\uD83D\\uDC69\\uD83C\\uDFFB\\u200D\\uD83C\\uDF93", p = `[${t}]`, u = `[${o}]`, c = "\\ud83c[\\udffb-\\udfff]", m = `(?:${u}|${c})`, v = `[^${t}]`, b = "(?:\\uD83C[\\uDDE6-\\uDDFF]){2}", A = "[\\ud800-\\udbff][\\udc00-\\udfff]", x = "\\u200d", $e = "(?:\\ud83c\\udff4\\udb40\\udc67\\udb40\\udc62\\udb40(?:\\udc65|\\udc73|\\udc77)\\udb40(?:\\udc6e|\\udc63|\\udc6c)\\udb40(?:\\udc67|\\udc74|\\udc73)\\udb40\\udc7f)", Se = `[${h}]`, H = `${m}?`, L = `[${a}]?`, Ce = `(?:${x}(?:${[v, b, A].join("|")})${L + H})*`, Te = L + H + Ce, je = `(?:${[`${v}${u}?`, u, b, A, p, Se].join("|")})`;
  return new RegExp(`${$e}|${c}(?=${c})|${je + Te}`, "g");
}, Ye = Y && Y.__importDefault || function(t) {
...
function Nr(t, e, r) {
  ...
  if (e > s || r && (e > r && !(e >= 0 && e < s && r < 0 && r > -s) || r < -s))
    return "";
  const i = ee(s, e), n = r ? ee(s, r) : void 0;
  return R(t, i, n);
}
function q(t, e, r) {
  const s = [];
  ...
  let i = e;
  (typeof e == "string" || e instanceof RegExp && !lt(e.flags, "g")) && (i = new RegExp(e, "g"));
  const n = t.match(i);
  let o = 0;
  if (!n)
    return [t];
  for (let a = 0; a < (r ? r - 1 : n.length); a++) {
    const h = X(t, n[a], o), p = g(n[a]);
...
], ft = 1, ht = ye.length - 1, pt = 1, dt = 1, mt = (t) => {
  var e;
...
var we = "_owner", ie = Object.getOwnPropertyDescriptor, ne = Object.keys;
function Et(t, e, r) {
  var s = t.length;
  if (e.length !== s)
    return !1;
...
function oe(t, e, r) {
  ...
  for (var s = {}, i = t.entries(), n = 0, o, a; (o = i.next()) && !o.done; ) {
    for (var h = e.entries(), p = !1, u = 0; (a = h.next()) && !a.done; ) {
      var c = o.value, m = c[0], v = c[1], b = a.value, A = b[0], x = b[1];
      !p && !s[u] && (p = r.equals(m, A, n, u, t, e, r) && r.equals(v, x, m, A, t, e, r)) && (s[u] = !0), u++;
    }
    if (!p)
      return !1;
    n++;
...
function Ot(t, e, r) {
  var s = ne(t), i = s.length;
  if (ne(e).length !== i)
    return !1;
  for (var n; i-- > 0; )
    if (n = s[i], n === we && (t.$$typeof || e.$$typeof) && t.$$typeof !== e.$$typeof || !Ee(e, n) || !r.equals(t[n], e[n], n, n, t, e, r))
      return !1;
  return !0;
}
function M(t, e, r) {
  ...
  if (re(e).length !== i)
    return !1;
  for (var n, o, a; i-- > 0; )
    if (n = s[i], n === we && (t.$$typeof || e.$$typeof) && t.$$typeof !== e.$$typeof || !Ee(e, n) || !r.equals(t[n], e[n], n, n, t, e, r) || (o = ie(t, n), a = ie(e, n), (o || a) && (!o || !a || o.configurable !== a.configurable || o.enumerable !== a.enumerable || o.writable !== a.writable)))
      return !1;
  return !0;
}
function $t(t, e) {
...
var Tt = "[object Arguments]", jt = "[object Boolean]", At = "[object Date]", Pt = "[object Map]", Mt = "[object Number]", Dt = "[object Object]", Bt = "[object RegExp]", Rt = "[object Set]", It = "[object String]", kt = Array.isArray, ue = typeof ArrayBuffer == "function" && ArrayBuffer.isView ? ArrayBuffer.isView : null, le = Object.assign, xt = Object.prototype.toString.call.bind(Object.prototype.toString);
function Vt(t) {
  ...
  return function(u, c, m) {
    ...
    if (v === Set)
      return a(u, c, m);
    var b = xt(u);
    return b === At ? r(u, c, m) : b === Bt ? o(u, c, m) : b === Pt ? s(u, c, m) : b === Rt ? a(u, c, m) : b === Dt ? typeof u.then != "function" && typeof c.then != "function" && i(u, c, m) : b === Tt ? i(u, c, m) : b === jt || b === Mt || b === It ? n(u, c, m) : !1;
  };
}
function qt(t) {
  ...
  if (r && (i = le({}, i, r(i))), e) {
    var n = B(i.areArraysEqual), o = B(i.areMapsEqual), a = B(i.areObjectsEqual), h = B(i.areSetsEqual);
    i = le({}, i, {
      areArraysEqual: n,
      areMapsEqual: o,
      areObjectsEqual: a,
...
function O(t) {
  t === void 0 && (t = {});
  var e = t.circular, r = e === void 0 ? !1 : e, s = t.createInternalComparator, i = t.createState, n = t.strict, o = n === void 0 ? !1 : n, a = qt(t), h = Vt(a), p = s ? s(h) : zt(h);
  return Jt({ circular: r, comparator: h, createState: i, equals: p, strict: o });
}
function _t(t, e) {
  return Gt(t, e);
}
function Xt(t, e) {
  ...
  return Object.keys(r).forEach((n) => {
    i && (Object.hasOwn(s, n) && Xt(s[n], r[n]) || (i = !1));
  }), i;
}
function ce(t, e, r) {
...
function Ar() {
  return typeof navigator < "u" && navigator.languages ? navigator.languages[0] : Intl.DateTimeFormat().resolvedOptions().locale;
}
function Pr(t, e, r = "en") {
...
export {
  ...
  R as substring,
  ht as toArray,
  te as toCodePointArray,
  Mr as unicodeCodePointCompare,
  ke as wait,
