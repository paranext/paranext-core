...
import { D as qt, F as At, a as $t, b as jt, G as Nt, L as Ft, M as Ut, S as Ot, c as Rt, e as Dt, f as Lt, g as Bt, h as Vt, j as zt, k as Ht, l as Jt, m as Kt, n as Gt, o as Yt, p as Xt, q as Wt, r as Zt, s as Qt, t as er, u as tr, v as rr, w as nr, x as ir, y as sr, z as ar, A as or, B as cr, C as dr, E as pr, H as lr, I as ur, J as hr, K as fr, N as mr, O as gr, P as yr, Q as kr, R as br, T as vr, U as Mr, V as xr, W as _r, X as Ir, Y as Er, Z as wr, _ as Sr, $ as Pr, a0 as Tr, a1 as Cr, a2 as qr, a3 as Ar, a4 as $r, a5 as jr, a6 as Nr, a7 as Fr, a8 as Ur, a9 as Or, aa as Rr, ab as Dr, ac as Lr, ad as Br } from "./scripture-util-DArajUVn.js";
...
USJ: ${JSON.stringify(
   ...
   */
  warnOnce(e) {
    this.reportedProblems.has(e) || (this.reportedProblems.add(e), console.warn(e));
  }
  /**
  ...
  getInfoForMarker(e, t = "usfm") {
    ...
    if (n != null && n.markerUsfm && (d = n.markerUsfm, n = this.getMarkerInfo(d)), !n) {
      ...
      n = { type: e.type }, i = !0, this.warnOnce(
        `Unknown marker ${r}. Creating MarkerInfo to use: ${JSON.stringify(n)}`
      );
    }
    let l = n.type, p = this.markersMap.markerTypes[l];
    if (p != null && p.markerTypeUsfm && (l = p.markerTypeUsfm, p = this.markersMap.markerTypes[l]), !_(e) && e.type !== c && (!p || e.type !== p.markerTypeUsfm && e.type !== p.markerTypeUsx && e.type !== p.markerTypeUsj) && (this.warnOnce(
...
export {
  ...
  Ot as SELECTABLE_INVISIBLE_CHAR_OR_WHITESPACE_CLASS,
  Rt as Section,
