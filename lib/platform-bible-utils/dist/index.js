...
function $r() {
  ...
  ), w = a("EMPTY", "|", "ANY", "|", R, "|", _), I = "<!ELEMENT", P = o(I, m, a(W, "|", ne), m, a(w, "|", ne), l, ">"), V = o("NOTATION", m, /\(/, l, y, a(l, /\|/, l, y), "*", l, /\)/), pe = o(/\(/, l, q, a(l, /\|/, l, q), "*", l, /\)/), we = a(V, "|", pe), Ae = a(/CDATA|ID|IDREF|IDREFS|ENTITY|ENTITIES|NMTOKEN|NMTOKENS/, "|", we), ae = a(/#REQUIRED|#IMPLIED/, "|", a(a("#FIXED", m), "?", E)), L = a(m, y, m, Ae, m, ae), Ue = "<!ATTLIST", Re = o(Ue, m, y, L, "*", l, ">"), de = "about:legacy-compat", Ve = a('"' + de + '"', "|", "'" + de + "'"), _e = "SYSTEM", Se = "PUBLIC", ke = a(a(_e, m, te), "|", a(Se, m, N, m, te)), He = o(
    "^",
    a(
...
function jr() {
  ...
  ft.prototype.nodeType = te, x(ft, L);
  function Qe(n) {
    b(n);
  }
  ...
  return re._updateLiveList = P, re.Attr = be, re.CDATASection = ct, re.CharacterData = Ne, re.Comment = st, re.Document = de, re.DocumentFragment = Qe, re.DocumentType = lt, re.DOMImplementation = ae, re.Element = Z, re.Entity = bt, re.EntityReference = ft, re.LiveNodeList = I, re.NamedNodeMap = V, re.Node = L, re.NodeList = w, re.Notation = At, re.Text = We, re.ProcessingInstruction = ht, re.XMLSerializer = xt, re;
}
var rt = {}, jt = {}, sr;
function Cn() {
...
const zt = ["chapter", "book", "para", "row", "sidebar", Vt], Pn = "​", zr = [
...
], kn = 1, Fn = zr.length - 1, qn = 1, $n = 1, Ai = {
  book: "GEN",
  chapterNum: 1,
  verseNum: 1
}, jn = (t) => {
  ...
  book: oe.bookNumberToId(
    Math.max(
      kn,
      Math.min(oe.bookIdToNumber(t.book) + e, Fn)
    )
  ),
  chapterNum: 1,
  verseNum: 1
...
function Ti(t) {
  return new qr(oe.bookIdToNumber(t.book), t.chapterNum, t.verseNum).BBBCCC;
}
function Er(t) {
  return new qr(oe.bookIdToNumber(t.book), t.chapterNum, t.verseNum).BBBCCCVVV;
}
function wi(t, e) {
  return Er(t) - Er(e);
}
...
function xi(t, e, r) {
  ...
  if (!u) return !1;
  const o = oe.bookIdToEnglishName(t), a = r == null ? void 0 : r.get(t);
...
function vr(t) {
  ...
  for (let o = 0; o < t.length; o += 1) {
    const a = t[o];
    a.charCodeAt(0) < 32 ? (r || (e += " "), r = !0) : !r && a === Pn && o + 1 < t.length && Dr(t[o + 1]) || (Dr(a) ? (r || (e += a), r = !0) : Hn(a) && u === a || (e += a, r = !1)), u = a;
  }
  return e;
}
function Ar(t) {
...
const Bi = (t) => (...e) => t.map((u) => u(...e)).every((u) => u), Ri = (t) => async (...e) => {
  const r = t.map(async (u) => u(...e));
  return (await Promise.all(r)).every((u) => u);
}, Rt = "chapter", _t = "verse";
var Jn = Object.getOwnPropertyNames, Xn = Object.getOwnPropertySymbols, Yn = Object.prototype.hasOwnProperty;
function Nr(t, e) {
...
function yr(t) {
  return Jn(t).concat(Xn(t));
}
var Kn = Object.hasOwn || function(t, e) {
  return Yn.call(t, e);
};
function at(t, e) {
  return t === e || !t && !e && t !== t && e !== e;
}
var Wn = "__v", Qn = "__o", Zn = "_owner", Cr = Object.getOwnPropertyDescriptor, Tr = Object.keys;
function eu(t, e, r) {
  var u = t.length;
  if (e.length !== u)
    return !1;
...
function Hr(t, e, r, u) {
  return (u === Zn || u === Qn || u === Wn) && (t.$$typeof || e.$$typeof) ? !0 : Kn(e, u) && r.equals(t[u], e[u], u, u, t, e, r);
}
var lu = "[object Arguments]", fu = "[object Boolean]", hu = "[object Date]", pu = "[object Error]", du = "[object Map]", mu = "[object Number]", gu = "[object Object]", Eu = "[object RegExp]", Du = "[object Set]", vu = "[object String]", Au = "[object URL]", bu = Array.isArray, Or = typeof ArrayBuffer == "function" && ArrayBuffer.isView ? ArrayBuffer.isView : null, Ir = Object.assign, Nu = Object.prototype.toString.call.bind(Object.prototype.toString);
function yu(t) {
  ...
  return function(b, y, q) {
    ...
    if (F === Set)
      return m(b, y, q);
    var U = Nu(b);
    return U === hu ? r(b, y, q) : U === Eu ? d(b, y, q) : U === du ? a(b, y, q) : U === Du ? m(b, y, q) : U === gu ? typeof b.then != "function" && typeof y.then != "function" && h(b, y, q) : U === Au ? v(b, y, q) : U === pu ? u(b, y, q) : U === lu ? h(b, y, q) : U === fu || U === mu || U === vu ? f(b, y, q) : !1;
  };
}
function Cu(t) {
  var e = t.circular, r = t.createCustomConfig, u = t.strict, o = {
    areArraysEqual: u ? Tt : eu,
    areDatesEqual: tu,
    areErrorsEqual: ru,
    areFunctionsEqual: nu,
    areMapsEqual: u ? Nr(wr, Tt) : wr,
    areNumbersEqual: uu,
    areObjectsEqual: u ? Tt : iu,
    arePrimitiveWrappersEqual: ou,
    areRegExpsEqual: au,
    areSetsEqual: u ? Nr(Sr, Tt) : Sr,
    areTypedArraysEqual: u ? Tt : su,
    areUrlsEqual: cu
  };
  if (r && (o = Ir({}, o, r(o))), e) {
...
function Ge(t) {
  t === void 0 && (t = {});
  var e = t.circular, r = e === void 0 ? !1 : e, u = t.createInternalComparator, o = t.createState, a = t.strict, p = a === void 0 ? !1 : a, h = Cu(t), f = yu(h), d = u ? u(f) : Tu(f);
  return wu({ circular: r, comparator: f, createState: o, equals: d, strict: p });
}
function Ou(t, e) {
  return Su(t, e);
}
function Iu(t, e) {
  ...
  return Object.keys(r).forEach((a) => {
    o && (Object.hasOwn(u, a) && Iu(u[a], r[a]) || (o = !1));
  }), o;
}
function xr(t, e, r) {
...
const Li = (t) => t.replace(/&/g, "&amp;").replace(/</g, "&lt;").replace(/>/g, "&gt;").replace(/"/g, "&quot;").replace(/'/g, "&#x27;").replace(/\//g, "&#x2F;");
function Pi() {
...
const Mu = 1e3, Jr = 60, Xr = Jr * 60, Bu = Xr * 24;
function Fi(t, e, r = /* @__PURE__ */ new Date()) {
  const u = Math.floor((e.getTime() - r.getTime()) / Mu), o = Math.round(u / Bu);
...
function ji(t, e, r) {
  ...
  return o.id = `${Fu}${r ? `-${r}` : ""}`, o.dataset.themeId = t.id, o.textContent = $u(t), this.document.head.appendChild(o), o;
}
...
class ie {
  ...
  verseRefToUsjContentLocation(e, r = 0) {
    ...
    const h = e.verse ?? e.verseNum.toString(), f = this.findNextMatchingNode(
      o,
      je,
      (v, C) => v === o ? e.verseNum === 0 ? (p = ie.convertWorkingStackToJsonPath(C), !0) : !1 : typeof v != "object" ? !1 : v.type === Rt ? (a = !0, !0) : v.type === _t && v.number !== void 0 && v.number === h ? (p = ie.convertWorkingStackToJsonPath(C), !0) : !1
    );
...
export {
  ...
  ni as SortedSet,
  Fu as THEME_STYLE_ELEMENT_ID,
  ui as UnsubscriberAsyncList,
  ie as UsjReaderWriter,
  _t as VERSE_TYPE,
  Ri as aggregateUnsubscriberAsyncs,
  Bi as aggregateUnsubscribers,
  ji as applyThemeStylesheet,
  Mi as areUsjContentsEqualExceptWhitespace,
  Bt as at,
  gt as charAt,
  ci as codePointAt,
  ...
  _i as isSerializable,
  Me as isString,
  Iu as isSubset,
  mt as isWhiteSpace,
  Rn as lastIndexOf,
  Lu as localizedStringsDocumentSchema,
  Pu as menuDocumentSchema,
  Gu as newGuid,
  ...
  pi as padEnd,
  di as padStart,
  Ru as projectSettingsDocumentSchema,
  Ti as scrRefToBBBCCC,
  Er as scrRefToBBBCCCVVV,
  xr as serialize,
  _u as settingsDocumentSchema,
  mr as slice,
  gr as split,
  Vr as startsWith,
  fe as stringLength,
  ut as substring,
  ku as themeDocumentSchema,
  _n as toArray,
  vi as toKebabCase,
