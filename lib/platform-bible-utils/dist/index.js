...
import { D as zt, F as Ht, a as Jt, b as Kt, G as Gt, L as Yt, M as Xt, S as Wt, c as Zt, e as Qt, f as er, g as tr, h as rr, j as nr, k as ir, l as sr, m as ar, n as or, o as cr, p as dr, q as pr, r as lr, s as ur, t as hr, u as fr, v as mr, w as gr, x as yr, y as kr, z as br, A as vr, B as Mr, C as xr, E as _r, H as Er, I as Ir, J as wr, K as Sr, N as Pr, O as Tr, P as Cr, Q as Ar, R as qr, T as $r, U as jr, V as Nr, W as Ur, X as Or, Y as Fr, Z as Rr, _ as Dr, $ as Lr, a0 as Br, a1 as Vr, a2 as zr, a3 as Hr, a4 as Jr, a5 as Kr, a6 as Gr, a7 as Yr, a8 as Xr, a9 as Wr, aa as Zr, ab as Qr, ac as en, ad as tn } from "./scripture-util-DArajUVn.js";
...
const Y = 1e4, U = Y / 1e3, X = 3, z = /* @__PURE__ */ new Map(), be = {
  unsubscribed: {
    ...
    suppressed: (i, e) => `UnsubscriberAsyncList ${i}: ${e} more unsubscribers arrived after the list was run in the last ${U}s and were unsubscribed immediately; per-occurrence warnings suppressed.`
  },
  failed: {
    log: (i) => console.error(i),
    first: (i) => `UnsubscriberAsyncList ${i}: Unsubscriber added after the list was run failed!`,
    suppressed: (i, e) => `UnsubscriberAsyncList ${i}: ${e} more unsubscribers added after the list was run failed in the last ${U}s; per-occurrence errors suppressed.`
  },
  threw: {
    log: (i) => console.error(i),
    ...
    suppressed: (i, e, t) => `UnsubscriberAsyncList ${i}: ${e} more unsubscribers added after the list was run threw in the last ${U}s; per-occurrence errors suppressed. Distinct errors sampled (up to ${X}): ${t.join(" | ")}`
  }
};
function H(i, e, t) {
...
const yt = (i) => (...e) => i.map((r) => r(...e)).every((r) => r), kt = (i) => async (...e) => {
  const t = i.map(async (r) => r(...e));
  return (await Promise.all(t)).every((r) => r);
}, ve = "book", J = "chapter", w = "verse", S = "***";
...
function bt(i) {
  var e;
  return ((e = W[i]) == null ? void 0 : e.type) === a.Paragraph || i === "v";
}
function vt(i) {
  const e = W[i];
...
function _e(i, e) {
  ...
  return Object.keys(t).forEach((n) => {
    s && (Object.hasOwn(r, n) && _e(r[n], t[n]) || (s = !1));
  }), s;
}
function K(i, e, t) {
...
const It = (i) => i.replace(/&/g, "&amp;").replace(/</g, "&lt;").replace(/>/g, "&gt;").replace(/"/g, "&quot;").replace(/'/g, "&#x27;").replace(/\//g, "&#x2F;");
function wt() {
...
const Ie = 1e3, Q = 60, ee = Q * 60, we = ee * 24;
function Tt(i, e, t = /* @__PURE__ */ new Date()) {
  const r = Math.floor((e.getTime() - t.getTime()) / Ie), s = Math.round(r / we);
...
const Ce = /^%[^%]*%$/;
function re(i) {
  return i !== void 0 && !Ce.test(i) && i.trim() !== "";
}
function jt(i, e) {
  const t = i[e];
  return typeof t == "string" && re(t) ? t : void 0;
}
function Nt(i, e) {
  return re(i) ? i : e;
}
...
function Dt(i, e, t) {
  ...
  return s.id = `${$e}${t ? `-${t}` : ""}`, s.dataset.themeId = i.id, s.textContent = Ne(i), this.document.head.appendChild(s), s;
}
function ie(i) {
...
USJ: ${JSON.stringify(
  ...
  findAllNotes() {
    var e;
    return xe((e = this.usj) == null ? void 0 : e.content);
  }
  /**
...
`) && (n.length === 0 ? (p = p.map((u) => ({
 ...
 `);
  ...
  static areUsjDocumentLocationsEqual(e, t, r = !1) {
    ...
    return !r && !O(P.toPathArray(s), P.toPathArray(c)) ? !1 : O(n, p);
  }
...
export {
  ...
  $t as computeEffectiveStructureProtection,
  ...
  qt as getLocalizeKeyForPhysicalKey,
  ...
  re as isResolvedLocalizedValue,
  ...
  Ar as isolateBidi,
  qr as lastIndexOf,
  jt as localizedStringOrUndefined,
  Te as localizedStringsDocumentSchema,
  Ut as makeProjectSelectorCustomData,
  ...
  Dr as padEnd,
  Lr as padStart,
  Se as projectSettingsDocumentSchema,
  Ot as recencyMapFromOrderedIds,
  Nt as resolveLocalizedString,
  Br as retryUntil,
  Mt as sanitizeHtml,
  Vr as scrRefToBBBCCC,
  zr as scrRefToBBBCCCVVV,
  K as serialize,
  Pe as settingsDocumentSchema,
  Hr as slice,
  Jr as split,
  Kr as startsWith,
  Gr as stringLength,
