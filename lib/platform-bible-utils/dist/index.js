...
var k = (o, e, t) => Z(o, typeof e != "symbol" ? e + "" : e, t);
import { d as C, i as _ } from "./scripture-util-BiADhCws.js";
import { F as St, a as Pt, b as Tt, L as Ct, S as qt, c as At, e as jt, f as $t, g as Nt, h as Ft, j as Ot, k as Ut, l as Rt, m as Dt, n as Lt, o as Bt, p as Vt, q as zt, r as Ht, s as Jt, t as Kt, u as Gt, v as Yt, w as Xt, x as Wt, y as Zt, z as Qt, A as er, B as tr, C as rr, D as nr, E as ir, G as sr, H as ar, I as or, J as cr, K as dr, M as pr, N as lr, O as ur, P as hr, Q as fr, R as mr, T as gr, U as yr, V as kr, W as br, X as vr, Y as xr, Z as Mr, _ as _r, $ as Ir, a0 as Er, a1 as wr, a2 as Sr, a3 as Pr, a4 as Tr, a5 as Cr, a6 as qr, a7 as Ar, a8 as jr } from "./scripture-util-BiADhCws.js";
import { Mutex as Q } from "async-mutex";
import ee from "dompurify";
import { deepEqual as te } from "fast-equals";
...
class se {
  ...
  constructor(e, t) {
    ...
    k(this, "latestOutput");
    k(this, "options");
    k(this, "onDidRebuildEmitter", new ie());
...
class Ue {
  ...
  get(e) {
    ...
    return t || (t = new oe(), this.mutexesByID.set(e, t), t);
  }
  /**
...
class De {
  ...
  cleanupPromiseChain(e) {
    ...
    if (!t) return;
    const r = { promise: de }, i = t.catch((n) => this.logger.warn(`Error in promise for ${e}: ${n.message}`)).finally(() => {
...
function dt(o) {
  var e;
  return ((e = le[o]) == null ? void 0 : e.type) === s.Paragraph || o === "v";
}
function pt(o) {
  return ee.sanitize(o, {
    ALLOWED_TAGS: [
      "p",
      "br",
      "b",
...
function ue(o, e) {
  const t = e && e.length > 0 ? e : H();
  return t[o % t.length];
}
function lt(o, e) {
  const t = e && e.length > 0 ? e : H(), r = (() => {
...
const ft = (o) => o.replace(/&/g, "&amp;").replace(/</g, "&lt;").replace(/>/g, "&gt;").replace(/"/g, "&quot;").replace(/'/g, "&#x27;").replace(/\//g, "&#x2F;");
function mt() {
  return typeof navigator < "u" && navigator.languages ? navigator.languages[0].replace(/@posix$/i, "") : new ne().resolvedOptions().locale;
}
function gt(o, e = 2) {
  ...
  $defs: {
    ...
    menuItem: {
      ...
      properties: {
        ...
        isHiddenInSimple: {
          description: "Set to `true` to hide this menu item while the app is in Simple interface mode. Omit (or set to `false`) for items that should show in both modes.",
          type: "boolean"
        }
      },
...
function X(o) {
  return Object.freeze(o), o == null || Object.getOwnPropertyNames(o).forEach(function(t) {
    ...
    o[t] !== null && (typeof o[t] == "object" || typeof o[t] == "function") && !Object.isFrozen(o[t]) && X(o[t]);
  }), o;
}
const F = X({
  version: "3.0.7",
...
USJ: ${JSON.stringify(
  ...
  static isTopLevelUsjMarker(e, t) {
    return typeof e == "object" && e.type === re && t.length === 0;
  }
  /**
  ...
  findNextLocationOfMatchingText(e, t, r = 1e3) {
    ...
    if (g.findNextMatchingNodeUsingWorkingStack(
      ...
      (h, f) => {
        ...
        if (p && g.areStackItemsShallowEqual(x, p)) {
  ...
  search(e, t) {
    ...
    for (; m !== void 0; )
      m = g.findNextMatchingNodeUsingWorkingStack(
        ...
        // eslint-disable-next-line no-loop-func
        (y, x) => (typeof y != "string" || r && x.some((v) => {
          const M = v.parent;
          if (!M || !("type" in M) || M.type === "char") return !1;
          let E;
          return "style" in M && typeof M.style == "string" ? E = M.style : "marker" in M && typeof M.marker == "string" && (E = M.marker), E !== void 0 && !r.has(E);
        }) || (d.push(y), l.set(p, {
          node: y,
          documentLocation: {
            offset: 0,
            jsonPath: g.convertWorkingStackToJsonPath(x)
          }
        }), p += y.length), !1)
      );
    ...
    for (; f; ) {
      if (f[0].length > 0) {
        const y = u ? u[f.index] : f.index, x = u ? u[f.index + f[0].length] : f.index + f[0].length;
        if (y < 0 || y >= b.length)
        ...
        }, M = l.findClosestLessThanOrEqual(x - 1);
        if (!M)
...
`);
    ...
    return i.push({ fragment: e, indexInUsfm: r.length }), r += d === "optbreak" ? "//" : `\\${b}`, d !== "optbreak" && (i.push({
      ...
      i.push({
        ...
        if ("isClosingMarker" in v.fragment) {
          const { isClosingMarker: M, ...E } = v.fragment, $ = {
            ...E,
            forMarker: e,
  ...
  closingMarkerToUsfm(e, t) {
    const {
      ...
      var y, x;
      return !(f === "type" || f === "marker" || f === "content" || f === "closed" || (y = d.skipOutputAttributeToUsfm) != null && y.includes(f) || (x = n.leadingAttributes) != null && x.includes(f) || n.textContentAttribute === f || l.some(
    ...
    if ((m.closed === "false" || n.isClosingMarkerOptional && !this.markersMap.shouldOptionalClosingMarkersBePresent && m.closed !== "true") && (b = !1), n.independentClosingMarkers && n.independentClosingMarkers.length > 0 && b) {
      ...
      let y = "";
      const x = [], { usfm: I, fragmentsInfo: v } = this.openingMarkerToUsfm(f, t), M = v.find((E) => g.isFragmentAMarker(E.fragment));
      if (!M)
        throw new Error(
...
export {
  ...
  ne as DateTimeFormat,
  se as DocumentCombiner,
  Oe as EventRollingTimeCounter,
  Ge as FAILED_PRECONDITION,
  St as FIRST_SCR_BOOK_NUM,
  Pt as FIRST_SCR_CHAPTER_NUM,
  Tt as FIRST_SCR_VERSE_NUM,
  Ye as INTERNAL,
  Xe as INVALID_ARGUMENT,
  Ct as LAST_SCR_BOOK_NUM,
  vt as MODIFIER_KEYS,
  s as MarkerType,
  oe as Mutex,
  Ue as MutexMap,
  ...
  Vt as endsWith,
  zt as ensureArray,
  Ht as escapeStringRegexp,
  Mt as expandThemeContribution,
  gt as formatBytes,
  bt as formatRelativeDate,
  Jt as formatReplacementString,
  Kt as formatReplacementStringToArray,
  Gt as formatScrRef,
  Yt as formatScrRefRange,
  kt as formatTimeSpan,
  Xt as getAllObjectFunctionNames,
  Wt as getChaptersForBook,
  mt as getCurrentLocale,
  H as getDefaultCallerSequence,
  Zt as getErrorMessage,
  lt as getFormatCallerFunction,
  Qt as getLocalizeKeyForScrollGroupId,
  er as getLocalizeKeysForScrollGroupIds,
  tr as getLocalizedIdFromBookNumber,
  ue as getNthCaller,
  ut as getPaneSizeLimits,
  rr as getSectionForBook,
  ...
  sr as indexOf,
  dt as isBlockMarker,
  ar as isErrorMessageAboutParatextBlockingInternetAccess,
  or as isErrorMessageAboutRegistryAuthFailure,
  cr as isLocalizeKey,
  at as isPlatformError,
  dr as isSelectableInvisibleCharOrWhiteSpace,
