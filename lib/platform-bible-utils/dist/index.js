...
function Fu(t, e = 300) {
  if (He(t)) throw new Error("Tried to debounce a string! Could be XSS");
  let n;
  return (...i) => {
...
class Vu {
  ...
  get(e) {
    ...
    return n || (n = new rn(), this.mutexesByID.set(e, n), n);
  }
}
class Hu extends en {
...
class Gu {
  ...
  cleanupPromiseChain(e) {
    ...
    if (!n) return;
    const i = { promise: un }, o = n.catch((a) => this.logger.warn(`Error in promise for ${e}: ${a.message}`)).finally(() => {
...
var on = Object.defineProperty, an = (t, e, n) => e in t ? on(t, e, { enumerable: !0, configurable: !0, writable: !0, value: n }) : t[e] = n, H = (t, e, n) => an(t, typeof e != "symbol" ? e + "" : e, n);
const rt = [
  "GEN",
  "EXO",
  "LEV",
...
const ve = class X {
  constructor(e, n, i, o) {
    if (H(this, "firstChapter"), H(this, "lastChapter"), H(this, "lastVerse"), H(this, "hasSegmentsDefined"), H(this, "text"), H(this, "BBBCCCVVVS"), H(this, "longHashCode"), H(this, "versification"), H(this, "rtlMark", "‏"), H(this, "_bookNum", 0), H(this, "_chapterNum", 0), H(this, "_verseNum", 0), H(this, "_verse"), i == null && o == null)
      if (e != null && typeof e == "string") {
        const a = e, h = n != null && n instanceof Ve ? n : void 0;
        this.setEmpty(h), this.parse(a);
      } else if (e != null && typeof e == "number") {
        const a = n != null && n instanceof Ve ? n : void 0;
        ...
        if (e != null && e instanceof X) {
          ...
          if (e == null) return;
          const a = e instanceof Ve ? e : X.defaultVersification;
          this.setEmpty(a);
        }
      else
  ...
  static fromJSON(e) {
    ...
    let p;
    return h && (p = new Ve(h)), n ? new X(n, i.toString(), f, p) : new X();
  }
  /**
  ...
  set versificationStr(e) {
    this.versification = this.versification != null ? new Ve(e) : void 0;
  }
  /**
  ...
  parse(e) {
    if (e = e.replace(this.rtlMark, ""), e.includes("/")) {
      ...
      if (e = a[0], a.length > 1)
        try {
          const h = +a[1].trim();
          this.versification = new Ve(_e[h]);
        } catch {
...
H(ve, "defaultVersification", Ve.English), H(ve, "verseRangeSeparator", "-"), H(ve, "verseSequenceIndicator", ","), H(ve, "verseRangeSeparators", [ve.verseRangeSeparator]), H(ve, "verseSequenceIndicators", [ve.verseSequenceIndicator]), H(ve, "chapterDigitShifter", 1e3), H(ve, "bookDigitShifter", ve.chapterDigitShifter * ve.chapterDigitShifter), H(ve, "bcvMaxValue", ve.chapterDigitShifter - 1), /**
...
function Dt() {
  ...
  rr = 1;
  function t(M, F, q) {
    if (q === void 0 && (q = Array.prototype), M && typeof q.find == "function")
      return q.find.call(M, F);
    for (var ue = 0; ue < M.length; ue++)
      if (n(M, ue)) {
        var he = M[ue];
        if (F.call(void 0, he, ue, M))
          return he;
      }
  }
  function e(M, F) {
    return F === void 0 && (F = Object), F && typeof F.getOwnPropertyDescriptors == "function" && (M = F.create(null, F.getOwnPropertyDescriptors(M))), F && typeof F.freeze == "function" ? F.freeze(M) : M;
  }
  function n(M, F) {
  ...
  function v(M) {
    return l(M) || M === w.XML_XHTML_APPLICATION;
  }
  var w = e({
    /**
  ...
  }), b = Object.keys(w).map(function(M) {
    return w[M];
  });
  function C(M) {
...
function Lr() {
  ...
  function o(Z) {
    ...
    return new RegExp(
      Array.prototype.slice.call(arguments).map(function(Ue) {
        var Nt = typeof Ue == "string";
        if (Nt && ae === void 0 && Ue === "|")
          throw new Error("use regg instead of reg to wrap expressions with `|`!");
        return Nt ? Ue : Ue.source;
      }).join(""),
      e ? "mu" : "m"
    );
  }
  ...
  var w = n(v), b = o("[", w, n(/[-.0-9\xB7]/), n(/[\u0300-\u036F\u203F-\u2040]/), "]"), C = o(v, b, "*"), k = o(b, "+"), M = o("&", C, ";"), F = a(/&#[0-9]+;|&#x[0-9a-fA-F]+;/), q = a(M, "|", F), ue = o("%", C, ";"), he = a(
    o('"', a(/[^%&"]/, "|", ue, "|", q), "*", '"'),
    "|",
    o("'", a(/[^%&']/, "|", ue, "|", q), "*", "'")
  ), D = a('"', a(/[^<&"]/, "|", q), "*", '"', "|", "'", a(/[^<&']/, "|", q), "*", "'"), R = i(v, ":"), L = i(b, ":"), V = o(R, L, "*"), Y = o(V, a(":", V), "?"), ee = o("^", Y, "$"), we = o("(", Y, ")"), te = a(/"[^"]*"|'[^']*'/), Re = o(/^<\?/, "(", C, ")", a(E, "(", f, "*?)"), "?", /\?>/), d = /[\x20\x0D\x0Aa-zA-Z0-9-'()+,./:=?;!*#@$_%]/, A = a('"', d, '*"', "|", "'", i(d, "'"), "*'"), S = "<!--", O = "-->", B = o(S, a(i(f, "-"), "|", o("-", i(f, "-"))), "*", O), N = "#PCDATA", x = a(
    o(/\(/, l, N, a(l, /\|/, l, Y), "*", l, /\)\*/),
    "|",
    o(/\(/, l, N, l, /\)/)
  ), G = /[?*+]?/, _ = o(
  ...
  ), it = a(E, "NDATA", E, C), qe = a(he, "|", a(Me, it, "?")), $e = "<!ENTITY", ot = o($e, E, C, E, qe, l, ">"), Q = a(he, "|", Me), ge = o($e, E, "%", E, C, E, Q, l, ">"), le = a(ot, "|", ge), Je = o(ce, E, A), at = o("<!NOTATION", E, C, E, a(Me, "|", Je), l, ">"), Le = o(l, "=", l), Xe = /1[.]\d+/, U = o(E, "version", Le, a("'", Xe, "'", "|", '"', Xe, '"')), ie = /[A-Za-z][-A-Za-z0-9._]*/, De = a(E, "encoding", Le, a('"', ie, '"', "|", "'", ie, "'")), Ne = a(E, "standalone", Le, a("'", a("yes", "|", "no"), "'", "|", '"', a("yes", "|", "no"), '"')), je = o(/^<\?xml/, U, De, "?", Ne, "?", l, /\?>/), Ye = "<!DOCTYPE", st = "<![CDATA[", ct = "]]>", lt = /<!\[CDATA\[/, vt = /\]\]>/, At = o(f, "*?", vt), ft = o(lt, At);
  return j.chars = n, j.chars_without = i, j.detectUnicodeSupport = t, j.reg = o, j.regg = a, j.AttlistDecl = ze, j.CDATA_START = st, j.CDATA_END = ct, j.CDSect = ft, j.Char = f, j.Comment = B, j.COMMENT_START = S, j.COMMENT_END = O, j.DOCTYPE_DECL_START = Ye, j.elementdecl = P, j.EntityDecl = le, j.EntityValue = he, j.ExternalID = Me, j.ExternalID_match = Pe, j.Name = C, j.NotationDecl = at, j.Reference = q, j.PEReference = ue, j.PI = Re, j.PUBLIC = ce, j.PubidLiteral = A, j.QName = Y, j.QName_exact = ee, j.QName_group = we, j.S = E, j.SChar_s = m, j.S_OPT = l, j.SYSTEM = Ae, j.SystemLiteral = te, j.UNICODE_REPLACEMENT_CHARACTER = h, j.UNICODE_SUPPORT = e, j.XMLDecl = je, j;
}
var ir;
function Fr() {
  if (ir) return ne;
  ir = 1;
  var t = Dt(), e = t.find, n = t.hasDefaultHTMLNamespace, i = t.hasOwn, o = t.isHTMLMimeType, a = t.isHTMLRawTextElement, h = t.isHTMLVoidElement, f = t.MIME_TYPE, p = t.NAMESPACE, m = Symbol(), E = xt(), l = E.DOMException, v = E.DOMExceptionName, w = Lr();
  function b(r) {
    if (r !== m)
  ...
  var L = {}, V = L.ELEMENT_NODE = 1, Y = L.ATTRIBUTE_NODE = 2, ee = L.TEXT_NODE = 3, we = L.CDATA_SECTION_NODE = 4, te = L.ENTITY_REFERENCE_NODE = 5, Re = L.ENTITY_NODE = 6, d = L.PROCESSING_INSTRUCTION_NODE = 7, A = L.COMMENT_NODE = 8, S = L.DOCUMENT_NODE = 9, O = L.DOCUMENT_TYPE_NODE = 10, B = L.DOCUMENT_FRAGMENT_NODE = 11, N = L.NOTATION_NODE = 12, x = t.freeze({
    ...
    compareDocumentPosition: function(r) {
      ...
      if (u instanceof Ne && (c = u, u = c.ownerElement), s instanceof Ne && (g = s, s = g.ownerElement, c && u && s === u))
        for (var T = 0, J; J = s.attributes[T]; T++) {
          if (J === c)
            return x.DOCUMENT_POSITION_IMPLEMENTATION_SPECIFIC + x.DOCUMENT_POSITION_PRECEDING;
          if (J === g)
            return x.DOCUMENT_POSITION_IMPLEMENTATION_SPECIFIC + x.DOCUMENT_POSITION_FOLLOWING;
        }
      if (!u || !s || s.ownerDocument !== u.ownerDocument)
        return x.DOCUMENT_POSITION_DISCONNECTED + x.DOCUMENT_POSITION_IMPLEMENTATION_SPECIFIC + (y(s.ownerDocument) > y(u.ownerDocument) ? x.DOCUMENT_POSITION_FOLLOWING : x.DOCUMENT_POSITION_PRECEDING);
      var de = G(u), be = G(s);
      if (!c && be.indexOf(u) >= 0 || g && u === s)
        return x.DOCUMENT_POSITION_CONTAINS + x.DOCUMENT_POSITION_PRECEDING;
      if (!g && de.indexOf(s) >= 0 || c && u === s)
        return x.DOCUMENT_POSITION_CONTAINED_BY + x.DOCUMENT_POSITION_FOLLOWING;
      var Se = _(be, de);
      for (var Oe in Se.childNodes) {
        var Fe = Se.childNodes[Oe];
        if (Fe === s) return x.DOCUMENT_POSITION_FOLLOWING;
        if (Fe === u) return x.DOCUMENT_POSITION_PRECEDING;
        if (be.indexOf(Fe) >= 0) return x.DOCUMENT_POSITION_FOLLOWING;
        if (de.indexOf(Fe) >= 0) return x.DOCUMENT_POSITION_PRECEDING;
      }
      return 0;
    }
  };
  ...
  D(L, $), D(L, $.prototype), D(x, $), D(x, $.prototype);
  function Ae(r, u) {
    if (u(r))
      return !0;
    if (r = r.firstChild)
  ...
  ae.prototype.nodeType = d, R(ae, je);
  function Ue() {
  }
  Ue.prototype.serializeToString = function(r, u) {
    return Nt.call(r, u);
    ...
    switch (r.nodeType) {
      case V:
        ...
        for (var Qe = 0; Qe < de; Qe++) {
          var xe = J.item(Qe);
          xe.prefix == "xmlns" ? c.push({
            prefix: xe.localName,
            namespace: xe.value
          }) : xe.nodeName == "xmlns" && c.push({ prefix: "", namespace: xe.value });
        }
        for (var Qe = 0; Qe < de; Qe++) {
          var xe = J.item(Qe);
          if (Jt(xe, T, c)) {
            var Ze = xe.prefix || "", bt = xe.namespaceURI;
  ...
  return ne._updateLiveList = re, ne.Attr = Ne, ne.CDATASection = ct, ne.CharacterData = je, ne.Comment = st, ne.Document = ce, ne.DocumentFragment = Z, ne.DocumentType = lt, ne.DOMImplementation = oe, ne.Element = De, ne.Entity = At, ne.EntityReference = ft, ne.LiveNodeList = P, ne.NamedNodeMap = K, ne.Node = $, ne.NodeList = I, ne.Notation = vt, ne.Text = Ye, ne.ProcessingInstruction = ae, ne.XMLSerializer = Ue, ne;
}
var et = {}, Ft = {}, or;
function Dn() {
...
function vn() {
  if (ar) return yt;
  ar = 1;
  var t = Dt(), e = Lr(), n = xt(), i = t.isHTMLEscapableRawTextElement, o = t.isHTMLMimeType, a = t.isHTMLRawTextElement, h = t.hasOwn, f = t.NAMESPACE, p = n.ParseError, m = n.DOMException, E = 0, l = 1, v = 2, w = 3, b = 4, C = 5, k = 6, M = 7;
  function F() {
  }
  F.prototype = {
  ...
  function ue(d, A, S, O, B) {
    ...
    function G(U) {
      ...
      var Ne = ie.slice(1, -1);
      return h(S, Ne) ? S[Ne] : Ne.charAt(0) === "#" ? x(parseInt(Ne.substr(1).replace("x", "0x"))) : (B.error("entity not found:" + U), U);
    }
    function _(U) {
      if (U > se) {
      ...
      try {
        ...
        switch (d.charAt(oe + 1)) {
          case "/":
            ...
            ye.pop();
            var $e = qe.localNSMap;
            if (O.endElement(qe.uri, qe.localName, Pe), $e)
              for (var ot in $e)
      ...
      switch (re) {
        ...
        case ">":
          switch (P) {
            ...
            case v:
              P === v && (y = _), P == b ? (N.warning('attribute "' + y + '" missed quot(")!'), G(_, y, A)) : (x || N.warning('attribute "' + y + '" missed value!! "' + y + '" instead!!'), G(y, y, A));
              break;
            case w:
              if (!x)
        ...
        default:
          if (re <= " ")
            ...
            switch (P) {
              ...
              case v:
                x || N.warning('attribute "' + _ + '" missed value!! "' + _ + '" instead2!!'), G(_, _, A), A = I, P = l;
                break;
              case C:
  ...
  function R(d, A, S) {
    for (var O = d.tagName, B = null, P = d.length; P--; ) {
      var N = d[P], x = N.qName, G = N.value, re = x.indexOf(":");
      if (re > 0)
        var _ = N.prefix = x.slice(0, re), y = x.slice(re + 1), I = _ === "xmlns" && y;
      else
        y = x, _ = null, I = x === "xmlns" && "";
  ...
  function L(d, A, S, O, B) {
    var N = i(S);
    if (N || a(S)) {
      var x = d.indexOf("</" + S + ">", A), G = d.substring(A + 1, x);
      return N && (G = G.replace(q, O)), B.characters(G, 0, G.length), x;
    }
    return A + 1;
  }
  function V(d, A) {
...
` && I !== "	" && I !== "\r")
    ...
    if (d.char() === "[") {
      ...
      for (var B = d.getIndex(); d.getIndex() < O.length; ) {
        ...
        if (d.char() === "<" && d.char(1) === "!")
          switch (d.char(2)) {
            case "E":
              d.char(3) === "L" ? x = d.getMatch(e.elementdecl) : d.char(3) === "N" && (x = d.getMatch(e.EntityDecl));
              break;
            case "A":
              x = d.getMatch(e.AttlistDecl);
              break;
            case "N":
              x = d.getMatch(e.NotationDecl);
              break;
            case "-":
              x = d.getMatch(e.Comment);
              break;
          }
        else if (d.char() === "<" && d.char(1) === "?")
          x = S(d, A);
        else if (d.char() === "%")
          x = d.getMatch(e.PEReference);
        else
  ...
  function we(d, A, S, O, B) {
    ...
    switch (N.char(2)) {
      case "-":
        var x = N.getMatch(e.Comment);
        return x ? (S.comment(x, e.COMMENT_START.length, x.length - e.COMMENT_START.length - e.COMMENT_END.length), N.getIndex()) : O.fatalError("comment is not well-formed at position " + N.getIndex());
      case "[":
...
function An() {
  if (sr) return et;
  sr = 1;
  var t = Dt(), e = Fr(), n = xt(), i = Dn(), o = vn(), a = e.DOMImplementation, h = t.hasDefaultHTMLNamespace, f = t.isHTMLMimeType, p = t.isValidMimeType, m = t.MIME_TYPE, E = t.NAMESPACE, l = n.ParseError, v = o.XMLReader;
  function w(D) {
    return D.replace(/\r[\n\u0085]/g, `
`).replace(/[\r\u0085\u2028]/g, `
`);
  ...
  C.prototype = {
    ...
    reportError: function(D, R) {
      if (typeof this.onError == "function")
        ...
        console.error("[xmldom " + D + "]	" + R, M(this.locator));
    },
    /**
...
function bn() {
  return lr || (lr = 1, kt = () => {
    const t = "\\ud800-\\udfff", h = "\\u0300-\\u036f" + "\\ufe20-\\ufe2f" + "\\u20d0-\\u20ff" + "\\u1ab0-\\u1aff" + "\\u1dc0-\\u1dff", f = "\\ufe0e\\ufe0f", p = "\\uD83D\\uDC69\\uD83C\\uDFFB\\u200D\\uD83C\\uDF93", m = `[${t}]`, E = `[${h}]`, l = "\\ud83c[\\udffb-\\udfff]", v = `(?:${E}|${l})`, w = `[^${t}]`, b = "(?:\\uD83C[\\uDDE6-\\uDDFF]){2}", C = "[\\ud800-\\udbff][\\udc00-\\udfff]", k = "\\u200d", M = "(?:\\ud83c\\udff4\\udb40\\udc67\\udb40\\udc62\\udb40(?:\\udc65|\\udc73|\\udc77)\\udb40(?:\\udc6e|\\udc63|\\udc6c)\\udb40(?:\\udc67|\\udc74|\\udc73)\\udb40\\udc7f)", F = `[${p}]`, q = `${v}?`, ue = `[${f}]?`, he = `(?:${k}(?:${[w, b, C].join("|")})${ue + q})*`, D = ue + q + he, L = `(?:${[`${w}${E}?`, E, b, C, m, F].join("|")})`;
    return new RegExp(`${M}|${l}(?=${l})|${L + D}`, "g");
  }), kt;
}
var fr;
function Cn() {
...
function wn(t, e) {
  ...
  let i = 0, o = 0;
  function a(f, p, m) {
    const E = tt(t, o, p), l = n.length > 0 && He(n[n.length - 1]) ? `${n.pop()}${E}` : E;
    He(f) ? n.push(`${l}${f}`) : (l && n.push(l), n.push(f)), o = p + m;
  }
  const h = pe(t);
  for (; i < h; ) {
    switch (Et(t, i)) {
  ...
  if (o < h) {
    const f = tt(t, o);
    n.push(
      n.length > 0 && He(n[n.length - 1]) ? `${n.pop()}${f}` : f
    );
  }
  return n;
}
function Yu(t, e) {
  return wn(t, e).map((n) => `${n}`).join("");
}
function Sn(t, e, n = 0) {
  const i = tt(t, n);
  return St(i, e) !== -1;
...
function dr(t, e, n) {
  ...
  if (n !== void 0 && n <= 0)
    return [t];
  if (e === "") return In(t).slice(0, n);
  let o = e;
  (typeof e == "string" || e instanceof RegExp && !Sn(e.flags, "g")) && (o = new RegExp(e, "g"));
  const a = t.match(o);
  let h = 0;
  if (!a) return [t];
...
const $t = ["chapter", "book", "para", "row", "sidebar", qt], Mn = "​", $r = [
...
], xn = 1, Bn = $r.length - 1, _n = 1, Pn = 1, ui = {
  bookNum: 1,
  chapterNum: 1,
  verseNum: 1
}, Ln = (t) => {
  ...
  bookNum: Math.max(xn, Math.min(t.bookNum + e, Bn)),
  chapterNum: 1,
  verseNum: 1
}), oi = (t, e) => ({
  ...t,
  chapterNum: Math.min(
    Math.max(_n, t.chapterNum + e),
    Ln(t.bookNum)
  ),
  verseNum: 1
}), ai = (t, e) => ({
  ...t,
  verseNum: Math.max(Pn, t.verseNum + e)
});
...
function gr(t) {
  ...
  for (let o = 0; o < t.length; o += 1) {
    const a = t[o];
    a.charCodeAt(0) < 32 ? (n || (e += " "), n = !0) : !n && a === Mn && o + 1 < t.length && Er(t[o + 1]) || (Er(a) ? (n || (e += a), n = !0) : $n(a) && i === a || (e += a, n = !1)), i = a;
  }
  return e;
}
function Dr(t) {
...
function jr(t, e, n, i) {
  ...
  if (o && a) {
    ...
    if (!m && !E) {
      ...
      $t.includes(h.type) && He(w) && mt(w) && (l = l.slice(0, -1));
      const b = v[v.length - 1];
      if ($t.includes(f.type) && He(b) && mt(b) && (v = v.slice(0, -1)), l.length !== v.length) return !1;
...
const hi = (t) => (...e) => t.map((i) => i(...e)).every((i) => i), di = (t) => async (...e) => {
  const n = t.map(async (i) => i(...e));
  return (await Promise.all(n)).every((i) => i);
}, It = "chapter", Rt = "verse";
var jn = Object.getOwnPropertyNames, Un = Object.getOwnPropertySymbols, Vn = Object.prototype.hasOwnProperty;
function Ar(t, e) {
...
var Gn = "__v", zn = "__o", Jn = "_owner", br = Object.getOwnPropertyDescriptor, Cr = Object.keys;
function Xn(t, e, n) {
  var i = t.length;
  if (e.length !== i)
    return !1;
...
function Ur(t, e, n, i) {
  return (i === Jn || i === zn || i === Gn) && (t.$$typeof || e.$$typeof) ? !0 : Hn(e, i) && n.equals(t[i], e[i], i, i, t, e, n);
}
var uu = "[object Arguments]", iu = "[object Boolean]", ou = "[object Date]", au = "[object Error]", su = "[object Map]", cu = "[object Number]", lu = "[object Object]", fu = "[object RegExp]", pu = "[object Set]", hu = "[object String]", du = "[object URL]", mu = Array.isArray, wr = typeof ArrayBuffer == "function" && ArrayBuffer.isView ? ArrayBuffer.isView : null, Sr = Object.assign, Eu = Object.prototype.toString.call.bind(Object.prototype.toString);
function gu(t) {
  ...
  return function(b, C, k) {
    ...
    if (M !== typeof C)
      return !1;
    if (M !== "object")
      return M === "number" ? h(b, C, k) : M === "function" ? o(b, C, k) : !1;
    var F = b.constructor;
    if (F !== C.constructor)
      return !1;
    if (F === Object)
    ...
    if (F === Set)
      return E(b, C, k);
    var q = Eu(b);
    return q === ou ? n(b, C, k) : q === fu ? m(b, C, k) : q === su ? a(b, C, k) : q === pu ? E(b, C, k) : q === lu ? typeof b.then != "function" && typeof C.then != "function" && f(b, C, k) : q === du ? v(b, C, k) : q === au ? i(b, C, k) : q === uu ? f(b, C, k) : q === iu || q === cu || q === hu ? p(b, C, k) : !1;
  };
}
function Du(t) {
  var e = t.circular, n = t.createCustomConfig, i = t.strict, o = {
    areArraysEqual: i ? Tt : Xn,
    areDatesEqual: Yn,
    areErrorsEqual: Kn,
    areFunctionsEqual: Wn,
    areMapsEqual: i ? Ar(yr, Tt) : yr,
    areNumbersEqual: Qn,
    areObjectsEqual: i ? Tt : Zn,
    arePrimitiveWrappersEqual: eu,
    areRegExpsEqual: tu,
    areSetsEqual: i ? Ar(Tr, Tt) : Tr,
    areTypedArraysEqual: i ? Tt : ru,
    areUrlsEqual: nu
  };
  if (n && (o = Sr({}, o, n(o))), e) {
...
function Ge(t) {
  t === void 0 && (t = {});
  var e = t.circular, n = e === void 0 ? !1 : e, i = t.createInternalComparator, o = t.createState, a = t.strict, h = a === void 0 ? !1 : a, f = Du(t), p = gu(f), m = i ? i(p) : vu(p);
  return Au({ circular: n, comparator: p, createState: o, equals: m, strict: h });
}
function bu(t, e) {
  return Nu(t, e);
}
...
function yu(t, e) {
  ...
  function i(h, f) {
    if (f && typeof f == "object" && "book" in f && typeof f.book == "string" && "chapterNum" in f && typeof f.chapterNum == "number" && "verseNum" in f && typeof f.verseNum == "number" && Object.keys(f).every(
      ...
      const p = f.chapterNum.toString(10), m = "verse" in f && typeof f.verse == "string" ? f.verse : f.verseNum.toString(10), E = "versificationStr" in f && typeof f.versificationStr == "string" ? new Ve(f.versificationStr) : void 0;
...
const Ei = (t) => t.replace(/&/g, "&amp;").replace(/</g, "&lt;").replace(/>/g, "&gt;").replace(/"/g, "&quot;").replace(/'/g, "&#x27;").replace(/\//g, "&#x2F;");
function gi() {
...
const Tu = 1e3, Vr = 60, Hr = Vr * 60, wu = Hr * 24;
function vi(t, e, n = /* @__PURE__ */ new Date()) {
  const i = Math.floor((e.getTime() - n.getTime()) / Tu), o = Math.round(i / wu);
...
export {
  ...
  en as DocumentCombiner,
  xn as FIRST_SCR_BOOK_NUM,
  _n as FIRST_SCR_CHAPTER_NUM,
  Pn as FIRST_SCR_VERSE_NUM,
  Bn as LAST_SCR_BOOK_NUM,
  rn as Mutex,
  Vu as MutexMap,
  Hu as NonValidatingDocumentCombiner,
  nn as NumberFormat,
  Kr as PlatformEventEmitter,
  Gu as PromiseChainingMap,
  zu as UnsubscriberAsyncList,
  Ee as UsjReaderWriter,
  Rt as VERSE_TYPE,
  di as aggregateUnsubscriberAsyncs,
  hi as aggregateUnsubscribers,
  pi as areUsjContentsEqualExceptWhitespace,
  Ot as at,
  Et as charAt,
  Xu as codePointAt,
  ...
  yn as endsWith,
  kr as ensureArray,
  ti as escapeStringRegexp,
  Di as formatBytes,
  Yu as formatReplacementString,
  wn as formatReplacementStringToArray,
  fi as formatScrRef,
  vi as formatTimeSpan,
  ju as getAllObjectFunctionNames,
  Ln as getChaptersForBook,
  gi as getCurrentLocale,
  qu as getErrorMessage,
  Fn as getLocalizeKeyForScrollGroupId,
  li as getLocalizeKeysForScrollGroupIds,
  si as getLocalizedIdFromBookNumber,
  ku as groupBy,
  Ei as htmlEncode,
  Sn as includes,
  St as indexOf,
  ei as isLocalizeKey,
  mi as isSerializable,
  He as isString,
  Cu as isSubset,
  mt as isWhiteSpace,
  On as lastIndexOf,
  Iu as localizedStringsDocumentSchema,
  ...
  oi as offsetChapter,
  ai as offsetVerse,
  Wu as ordinalCompare,
  Qu as padEnd,
  Zu as padStart,
  Su as projectSettingsDocumentSchema,
  mr as scrRefToBBBCCCVVV,
  Or as serialize,
  Ou as settingsDocumentSchema,
  hr as slice,
  dr as split,
  qr as startsWith,
  pe as stringLength,
  tt as substring,
  In as toArray,
  ni as transformAndEnsureRegExpArray,
  ri as transformAndEnsureRegExpRegExpArray,
  Zr as wait,
