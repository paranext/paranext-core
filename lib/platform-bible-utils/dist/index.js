...
function qu(t, e = 300) {
  if (Re(t)) throw new Error("Tried to debounce a string! Could be XSS");
  let n;
  return (...i) => {
...
function Hu(t) {
  ...
  return Re(t) ? t.includes(e) : Rr(t).includes(e);
}
function Gu(t) {
  const e = "401 Unauthorized error while getting shared projects.", n = "User registration is not valid. Cannot retrieve resources from DBL.", i = Re(t) ? t : Rr(t);
...
const Ot = 1;
function Ku(t) {
  return t ? Re(t) ? { message: t, platformErrorVersion: Ot } : typeof t == "object" && "message" in t && typeof t.message == "string" ? { ...t, message: t.message, platformErrorVersion: Ot } : { cause: t, message: "", platformErrorVersion: Ot } : { message: "", platformErrorVersion: Ot };
}
function Wu(t) {
...
const ve = class X {
  ...
  parse(e) {
    ...
    if (i.length !== 2 || _e.bookIdToNumber(n[0]) === 0 || !Number.isInteger(o) || o < 0 || !X.isVerseParseable(i[1]))
      throw new yt("Invalid reference : " + e);
  ...
  allVerses(e = !1, n = X.verseRangeSeparators, i = X.verseSequenceIndicators) {
    if (this._verse == null || this.chapterNum <= 0)
      return [this.clone()];
    const o = [], a = rr(this._verse, i);
    for (const h of a.map((f) => rr(f, n))) {
      const f = this.clone();
      f.verse = h[0];
      const p = f.verseNum;
...
function Dt() {
  ...
  return fe.assign = i, fe.find = t, fe.freeze = e, fe.HTML_BOOLEAN_ATTRIBUTES = o, fe.HTML_RAW_TEXT_ELEMENTS = p, fe.HTML_VOID_ELEMENTS = h, fe.hasDefaultHTMLNamespace = v, fe.hasOwn = n, fe.isHTMLBooleanAttribute = a, fe.isHTMLRawTextElement = m, fe.isHTMLEscapableRawTextElement = E, fe.isHTMLMimeType = l, fe.isHTMLVoidElement = f, fe.isValidMimeType = y, fe.MIME_TYPE = w, fe.NAMESPACE = k, fe;
}
var dt = {}, ur;
function Bt() {
  if (ur) return dt;
...
function kr() {
  ...
  var w = n(v), b = o("[", w, n(/[-.0-9\xB7]/), n(/[\u0300-\u036F\u203F-\u2040]/), "]"), y = o(v, b, "*"), k = o(b, "+"), x = o("&", y, ";"), F = a(/&#[0-9]+;|&#x[0-9a-fA-F]+;/), q = a(x, "|", F), ue = o("%", y, ";"), he = a(
    o('"', a(/[^%&"]/, "|", ue, "|", q), "*", '"'),
    "|",
    o("'", a(/[^%&']/, "|", ue, "|", q), "*", "'")
  ), D = a('"', a(/[^<&"]/, "|", q), "*", '"', "|", "'", a(/[^<&']/, "|", q), "*", "'"), R = i(v, ":"), L = i(b, ":"), V = o(R, L, "*"), Y = o(V, a(":", V), "?"), ee = o("^", Y, "$"), we = o("(", Y, ")"), te = a(/"[^"]*"|'[^']*'/), xe = o(/^<\?/, "(", y, ")", a(E, "(", f, "*?)"), "?", /\?>/), d = /[\x20\x0D\x0Aa-zA-Z0-9-'()+,./:=?;!*#@$_%]/, A = a('"', d, '*"', "|", "'", i(d, "'"), "*'"), S = "<!--", O = "-->", B = o(S, a(i(f, "-"), "|", o("-", i(f, "-"))), "*", O), N = "#PCDATA", M = a(
    o(/\(/, l, N, a(l, /\|/, l, Y), "*", l, /\)\*/),
    "|",
    o(/\(/, l, N, l, /\)/)
  ), G = /[?*+]?/, _ = o(
  ...
  ), C = a("EMPTY", "|", "ANY", "|", M, "|", _), I = "<!ELEMENT", P = o(I, E, a(Y, "|", ue), E, a(C, "|", ue), l, ">"), re = o("NOTATION", E, /\(/, l, y, a(l, /\|/, l, y), "*", l, /\)/), K = o(/\(/, l, k, a(l, /\|/, l, k), "*", l, /\)/), ye = a(re, "|", K), Ce = a(/CDATA|ID|IDREF|IDREFS|ENTITY|ENTITIES|NMTOKEN|NMTOKENS/, "|", ye), se = a(/#REQUIRED|#IMPLIED/, "|", a(a("#FIXED", E), "?", D)), oe = a(E, y, E, Ce, E, se), j = "<!ATTLIST", ze = o(j, E, y, oe, "*", l, ">"), Ae = "SYSTEM", ce = "PUBLIC", Me = a(a(Ae, E, te), "|", a(ce, E, A, E, te)), Le = o(
    "^",
    a(
  ...
  ), it = a(E, "NDATA", E, y), je = a(he, "|", a(Me, it, "?")), $e = "<!ENTITY", ot = o($e, E, y, E, je, l, ">"), Q = a(he, "|", Me), ge = o($e, E, "%", E, y, E, Q, l, ">"), le = a(ot, "|", ge), Je = o(ce, E, A), at = o("<!NOTATION", E, y, E, a(Me, "|", Je), l, ">"), Fe = o(l, "=", l), Xe = /1[.]\d+/, U = o(E, "version", Fe, a("'", Xe, "'", "|", '"', Xe, '"')), ie = /[A-Za-z][-A-Za-z0-9._]*/, De = a(E, "encoding", Fe, a('"', ie, '"', "|", "'", ie, "'")), Ne = a(E, "standalone", Fe, a("'", a("yes", "|", "no"), "'", "|", '"', a("yes", "|", "no"), '"')), Ue = o(/^<\?xml/, U, De, "?", Ne, "?", l, /\?>/), Ye = "<!DOCTYPE", st = "<![CDATA[", ct = "]]>", lt = /<!\[CDATA\[/, vt = /\]\]>/, At = o(f, "*?", vt), ft = o(lt, At);
  return $.chars = n, $.chars_without = i, $.detectUnicodeSupport = t, $.reg = o, $.regg = a, $.AttlistDecl = ze, $.CDATA_START = st, $.CDATA_END = ct, $.CDSect = ft, $.Char = f, $.Comment = B, $.COMMENT_START = S, $.COMMENT_END = O, $.DOCTYPE_DECL_START = Ye, $.elementdecl = P, $.EntityDecl = le, $.EntityValue = he, $.ExternalID = Me, $.ExternalID_match = Le, $.Name = y, $.NotationDecl = at, $.Reference = q, $.PEReference = ue, $.PI = xe, $.PUBLIC = ce, $.PubidLiteral = A, $.QName = Y, $.QName_exact = ee, $.QName_group = we, $.S = E, $.SChar_s = m, $.S_OPT = l, $.SYSTEM = Ae, $.SystemLiteral = te, $.UNICODE_REPLACEMENT_CHARACTER = h, $.UNICODE_SUPPORT = e, $.XMLDecl = Ue, $;
}
var or;
function qr() {
  if (or) return ne;
  or = 1;
  var t = Dt(), e = t.find, n = t.hasDefaultHTMLNamespace, i = t.hasOwn, o = t.isHTMLMimeType, a = t.isHTMLRawTextElement, h = t.isHTMLVoidElement, f = t.MIME_TYPE, p = t.NAMESPACE, m = Symbol(), E = Bt(), l = E.DOMException, v = E.DOMExceptionName, w = kr();
  function b(r) {
    if (r !== m)
  ...
  var L = {}, V = L.ELEMENT_NODE = 1, Y = L.ATTRIBUTE_NODE = 2, ee = L.TEXT_NODE = 3, we = L.CDATA_SECTION_NODE = 4, te = L.ENTITY_REFERENCE_NODE = 5, xe = L.ENTITY_NODE = 6, d = L.PROCESSING_INSTRUCTION_NODE = 7, A = L.COMMENT_NODE = 8, S = L.DOCUMENT_NODE = 9, O = L.DOCUMENT_TYPE_NODE = 10, B = L.DOCUMENT_FRAGMENT_NODE = 11, N = L.NOTATION_NODE = 12, M = t.freeze({
  ...
  K.prototype = {
    ...
    setNamedItem: function(r) {
      ...
      return s === r ? r : (Ce(this._ownerElement, this, r, s), s);
    },
    /**
  ...
  j.prototype = {
    ...
    compareDocumentPosition: function(r) {
      ...
      if (!u || !s || s.ownerDocument !== u.ownerDocument)
        return M.DOCUMENT_POSITION_DISCONNECTED + M.DOCUMENT_POSITION_IMPLEMENTATION_SPECIFIC + (C(s.ownerDocument) > C(u.ownerDocument) ? M.DOCUMENT_POSITION_FOLLOWING : M.DOCUMENT_POSITION_PRECEDING);
      var de = G(u), be = G(s);
  ...
  At.prototype.nodeType = xe, R(At, j);
  function ft(r) {
    b(r);
  }
...
function Nn() {
  if (sr) return Ct;
  sr = 1;
  var t = Dt(), e = kr(), n = Bt(), i = t.isHTMLEscapableRawTextElement, o = t.isHTMLMimeType, a = t.isHTMLRawTextElement, h = t.hasOwn, f = t.NAMESPACE, p = n.ParseError, m = n.DOMException, E = 0, l = 1, v = 2, w = 3, b = 4, y = 5, k = 6, x = 7;
  function F() {
  }
  F.prototype = {
  ...
  function ue(d, A, S, O, B) {
    ...
    function _(U) {
      if (U > se) {
        ...
        K && C(se), O.characters(ie, 0, U - se), se = U;
      }
    }
    function C(U, ie) {
    ...
    for (var I = 0, P = 0, re = /.*(?:\r\n?|\n)|.*$/g, K = O.locator, ye = [{ currentNSMap: A }], Ce = [], se = 0; ; ) {
      try {
        var oe = d.indexOf("<", se);
        if (oe < 0) {
          if (!N && Ce.length > 0)
            return B.fatalError("unclosed xml tag(s): " + Ce.join(", "));
        ...
        if (oe > se) {
          ...
          !N && Ce.length === 0 && (Ae = Ae.replace(new RegExp(e.S_OPT.source, "g"), ""), Ae && B.error("Unexpected content outside root element: '" + Ae + "'")), _(oe);
        }
        switch (d.charAt(oe + 1)) {
          case "/":
            ...
            if (!O.currentElement && !O.doc.documentElement)
              return;
            var Le = Ce[Ce.length - 1] || O.currentElement.tagName || O.doc.documentElement.tagName || "";
            if (Le !== Me[1]) {
          ...
          // end element
          case "?":
            K && C(oe), le = te(d, oe, O, B);
            break;
          case "!":
            K && C(oe), le = we(d, oe, O, B, N);
            break;
          default:
            K && C(oe);
            var Q = new xe(), ge = ye[ye.length - 1].currentNSMap, le = D(d, oe, Q, ge, G, B, N), Je = Q.length;
            if (Q.closed || (N && t.isHTMLVoidElement(Q.tagName) ? Q.closed = !0 : Ce.push(Q.tagName)), K && Je) {
              for (var at = he(K, {}), Fe = 0; Fe < Je; Fe++) {
                var Xe = Q[Fe];
                C(Xe.offset), Xe.locator = he(K, {});
              }
      ...
      switch (re) {
        ...
        case '"':
          if (P === w || P === l)
            if (P === l && (N.warning('attribute value must after "="'), _ = d.slice(A, I)), A = I + 1, I = d.indexOf(re, A), I > 0)
              C = d.slice(A, I), G(_, C, A - 1), P = y;
            else
              throw new Error("attribute value no end '" + re + "' match");
          else if (P == b)
            C = d.slice(A, I), G(_, C, A), N.warning('attribute "' + _ + '" missed start quot(' + re + ")!!"), A = I + 1, P = y;
          else
        ...
        case ">":
          switch (P) {
            ...
            //Compatible state
            case l:
              C = d.slice(A, I), C.slice(-1) === "/" && (S.closed = !0, C = C.slice(0, -1));
            case v:
              P === v && (C = _), P == b ? (N.warning('attribute "' + C + '" missed quot(")!'), G(_, C, A)) : (M || N.warning('attribute "' + C + '" missed value!! "' + C + '" instead!!'), G(C, C, A));
              break;
            case w:
              if (!M)
        ...
        default:
          if (re <= " ")
            switch (P) {
              ...
              case b:
                var C = d.slice(A, I);
                N.warning('attribute "' + C + '" missed quot(")!!'), G(_, C, A);
              case y:
                P = k;
                break;
            }
  ...
  function R(d, A, S) {
    for (var O = d.tagName, B = null, P = d.length; P--; ) {
      ...
      if (re > 0)
        var _ = N.prefix = M.slice(0, re), C = M.slice(re + 1), I = _ === "xmlns" && C;
      else
        C = M, _ = null, I = M === "xmlns" && "";
      N.localName = C, I !== !1 && (B == null && (B = /* @__PURE__ */ Object.create(null), V(S, S = /* @__PURE__ */ Object.create(null))), S[I] = B[I] = G, N.uri = f.XMLNS, A.startPrefixMapping(I, G));
    }
    for (var P = d.length; P--; )
      N = d[P], N.prefix && (N.prefix === "xml" && (N.uri = f.XML), N.prefix !== "xmlns" && (N.uri = S[N.prefix]));
    var re = O.indexOf(":");
    re > 0 ? (_ = d.prefix = O.slice(0, re), C = d.localName = O.slice(re + 1)) : (_ = null, C = d.localName = O);
    var K = d.uri = S[_ || ""];
    if (A.startElement(K, C, O, d), d.closed) {
      if (A.endElement(K, C, O), B)
        for (_ in B)
  ...
  function Y(d, A) {
    var S = A;
    function O(C) {
      return C = C || 0, d.charAt(S + C);
    }
    function B(C) {
      C = C || 1, S += C;
    }
    function N() {
      for (var C = 0; S < d.length; ) {
        var I = O();
        if (I !== " " && I !== `
` && I !== "	" && I !== "\r")
          return C;
    ...
    function G(C) {
      return d.substring(S, S + C.length) === C;
    }
    function _(C) {
      var I = e.reg("^", C), P = I.exec(M());
  ...
  function ee(d, A) {
    function S(G, _) {
      var C = e.PI.exec(G.substringFromIndex());
      return C ? C[1].toLowerCase() === "xml" ? _.fatalError(
        "xml declaration is only allowed at the start of the document, but found at position " + G.getIndex()
      ) : (G.skip(C[0].length), C[0]) : _.fatalError("processing instruction is not well-formed at position " + G.getIndex());
    }
    var O = d.getSource();
    if (d.char() === "[") {
      d.skip(1);
    ...
    switch (N.char(2)) {
      ...
      case "D": {
        ...
        if (N.skipBlanks(), N.substringStartsWith(e.PUBLIC) || N.substringStartsWith(e.SYSTEM)) {
          var C = e.ExternalID_match.exec(N.substringFromIndex());
          if (!C)
            return O.fatalError("doctype external id is not well-formed at position " + N.getIndex());
          C.groups.SystemLiteralOnly !== void 0 ? _.systemId = C.groups.SystemLiteralOnly : (_.systemId = C.groups.SystemLiteral, _.publicId = C.groups.PubidLiteral), N.skip(C[0].length);
        }
  ...
  return xe.prototype = {
    ...
    //	getType:function(i){},
  }, Ct.XMLReader = F, Ct.parseUtils = Y, Ct.parseDoctypeCommentOrCData = we, Ct;
}
var cr;
function bn() {
  if (cr) return et;
  cr = 1;
  var t = Dt(), e = qr(), n = Bt(), i = An(), o = Nn(), a = e.DOMImplementation, h = t.hasDefaultHTMLNamespace, f = t.isHTMLMimeType, p = t.isValidMimeType, m = t.MIME_TYPE, E = t.NAMESPACE, l = n.ParseError, v = o.XMLReader;
  function w(D) {
    return D.replace(/\r[\n\u0085]/g, `
`).replace(/[\r\u0085\u2028]/g, `
`);
  ...
  function b(D) {
    if (D = D || { locator: !0 }, this.assign = D.assign || t.assign, this.domHandler = D.domHandler || y, this.onError = D.onError || D.errorHandler, D.errorHandler && typeof D.errorHandler != "function")
  ...
  b.prototype.parseFromString = function(D, R) {
    ...
    var xe = !t.isHTMLMimeType(R);
    return xe && typeof D != "string" && te.errorHandler.fatalError("source is not a string"), te.parse(this.normalizeLineEndings(String(D)), L, V), ee.doc.documentElement || te.errorHandler.fatalError("missing root element"), ee.doc;
  };
  function y(D) {
    var R = D || {};
  ...
  y.prototype = {
    ...
    startElement: function(D, R, L, V) {
      ...
      for (var te = 0; te < we; te++) {
        var D = V.getURI(te), xe = V.getValue(te), L = V.getQName(te), d = Y.createAttributeNS(D, L);
        this.locator && k(V.getLocator(te), d), d.value = d.nodeValue = xe, ee.setAttributeNode(d);
      }
    },
...
@#[line:` + D.lineNumber + ",col:" + D.columnNumber + "]";
  ...
  return et.__DOMHandler = y, et.DOMParser = b, et.normalizeLineEndings = w, et.onErrorStopParsing = ue, et.onWarningStopParsing = he, et;
}
var lr;
function yn() {
  if (lr) return z;
...
function Cn() {
  return fr || (fr = 1, qt = () => {
    const t = "\\ud800-\\udfff", h = "\\u0300-\\u036f" + "\\ufe20-\\ufe2f" + "\\u20d0-\\u20ff" + "\\u1ab0-\\u1aff" + "\\u1dc0-\\u1dff", f = "\\ufe0e\\ufe0f", p = "\\uD83D\\uDC69\\uD83C\\uDFFB\\u200D\\uD83C\\uDF93", m = `[${t}]`, E = `[${h}]`, l = "\\ud83c[\\udffb-\\udfff]", v = `(?:${E}|${l})`, w = `[^${t}]`, b = "(?:\\uD83C[\\uDDE6-\\uDDFF]){2}", y = "[\\ud800-\\udbff][\\udc00-\\udfff]", k = "\\u200d", x = "(?:\\ud83c\\udff4\\udb40\\udc67\\udb40\\udc62\\udb40(?:\\udc65|\\udc73|\\udc77)\\udb40(?:\\udc6e|\\udc63|\\udc6c)\\udb40(?:\\udc67|\\udc74|\\udc73)\\udb40\\udc7f)", F = `[${p}]`, q = `${v}?`, ue = `[${f}]?`, he = `(?:${k}(?:${[w, b, y].join("|")})${ue + q})*`, D = ue + q + he, L = `(?:${[`${w}${E}?`, E, b, y, m, F].join("|")})`;
...
function On(t, e) {
  ...
  let i = 0, o = 0;
  function a(f, p, m) {
    const E = tt(t, o, p), l = n.length > 0 && Re(n[n.length - 1]) ? `${n.pop()}${E}` : E;
    Re(f) ? n.push(`${l}${f}`) : (l && n.push(l), n.push(f)), o = p + m;
  }
  const h = pe(t);
  for (; i < h; ) {
    switch (Et(t, i)) {
  ...
  if (o < h) {
    const f = tt(t, o);
    n.push(
      n.length > 0 && Re(n[n.length - 1]) ? `${n.pop()}${f}` : f
    );
  }
  return n;
}
...
], _n = 1, Pn = Ur.length - 1, Ln = 1, Fn = 1, ci = {
  bookNum: 1,
  chapterNum: 1,
  verseNum: 1
}, kn = (t) => {
...
function Er(t) {
  return new Gt(t.bookNum, t.chapterNum, t.verseNum).BBBCCCVVV;
}
function di(t, e) {
  return Er(t) - Er(e);
}
...
function Ei(t, e, n, i) {
  ...
  switch (e ?? "id") {
    case "English":
      o = _e.bookNumberToEnglishName(t.bookNum);
      break;
    case "id":
      o = _e.bookNumberToId(t.bookNum);
      break;
    default:
      o = e ?? "";
      break;
...
function Dr(t) {
  ...
  for (let o = 0; o < t.length; o += 1) {
    const a = t[o];
    a.charCodeAt(0) < 32 ? (n || (e += " "), n = !0) : !n && a === Bn && o + 1 < t.length && gr(t[o + 1]) || (gr(a) ? (n || (e += a), n = !0) : Un(a) && i === a || (e += a, n = !1)), i = a;
  }
  return e;
}
function vr(t) {
...
function Vr(t, e, n, i) {
  ...
  if (o && a) {
    const h = Dr(t), f = Dr(n);
    if (h !== f) {
      if (!mt(It(h, -1) ?? "") && !mt(It(f, -1) ?? "") || !Ar(t, e) || !Ar(n, i)) return !1;
      let p = h;
    ...
    const m = vr(h.content), E = vr(f.content);
    if (m !== E) return !1;
    if (!m && !E) {
      let l = h.content, v = f.content;
      const w = l[l.length - 1];
      $t.includes(h.type) && Re(w) && mt(w) && (l = l.slice(0, -1));
      const b = v[v.length - 1];
      if ($t.includes(f.type) && Re(b) && mt(b) && (v = v.slice(0, -1)), l.length !== v.length) return !1;
...
const Di = (t) => (...e) => t.map((i) => i(...e)).every((i) => i), vi = (t) => async (...e) => {
...
var Jn = "__v", Xn = "__o", Yn = "_owner", yr = Object.getOwnPropertyDescriptor, Cr = Object.keys;
function Kn(t, e, n) {
  var i = t.length;
  if (e.length !== i)
    return !1;
...
function Tt(t, e, n) {
  ...
  if (br(e).length !== o)
    return !1;
  for (var a, h, f; o-- > 0; )
    if (a = i[o], !Hr(t, e, n, a) || (h = yr(t, a), f = yr(e, a), (h || f) && (!h || !f || h.configurable !== f.configurable || h.enumerable !== f.enumerable || h.writable !== f.writable)))
      return !1;
  return !0;
}
function ru(t, e) {
...
function vu(t) {
  ...
  return function(b, y, k) {
    ...
    if (x !== typeof y)
      return !1;
    if (x !== "object")
      return x === "number" ? h(b, y, k) : x === "function" ? o(b, y, k) : !1;
    var F = b.constructor;
    if (F !== y.constructor)
      return !1;
    if (F === Object)
    ...
    if (F === Set)
      return E(b, y, k);
    var q = Du(b);
    return q === su ? n(b, y, k) : q === hu ? m(b, y, k) : q === lu ? a(b, y, k) : q === du ? E(b, y, k) : q === pu ? typeof b.then != "function" && typeof y.then != "function" && f(b, y, k) : q === Eu ? v(b, y, k) : q === cu ? i(b, y, k) : q === ou ? f(b, y, k) : q === au || q === fu || q === mu ? p(b, y, k) : !1;
  };
}
function Au(t) {
  ...
  if (n && (o = Or({}, o, n(o))), e) {
    var a = Mt(o.areArraysEqual), h = Mt(o.areMapsEqual), f = Mt(o.areObjectsEqual), p = Mt(o.areSetsEqual);
    o = Or({}, o, {
      areArraysEqual: a,
      areMapsEqual: h,
      areObjectsEqual: f,
...
function Ge(t) {
  t === void 0 && (t = {});
  var e = t.circular, n = e === void 0 ? !1 : e, i = t.createInternalComparator, o = t.createState, a = t.strict, h = a === void 0 ? !1 : a, f = Au(t), p = vu(f), m = i ? i(p) : Nu(p);
  return bu({ circular: n, comparator: p, createState: o, equals: m, strict: h });
}
function Cu(t, e) {
  return yu(t, e);
}
...
const Ni = (t) => t.replace(/&/g, "&amp;").replace(/</g, "&lt;").replace(/>/g, "&gt;").replace(/"/g, "&quot;").replace(/'/g, "&#x27;").replace(/\//g, "&#x2F;");
function bi() {
...
function Ci(t, e, n = /* @__PURE__ */ new Date()) {
...
class Ee {
  ...
  nodeToVerseRefAndOffset(e, n, i) {
    ...
    return a.startingContentNode !== void 0 && this.findNextMatchingNode(a.startingContentNode, [], (p, m) => {
      var E, l;
      return p === n ? !0 : m.find((v) => qe.includes(v.parent.type)) ? !1 : typeof p == "string" ? (f += p.length, !1) : p.type === Rt && p.number !== ((E = a.chapterNum) == null ? void 0 : E.toString()) || p.type === xt && p.number !== ((l = a.verseNum) == null ? void 0 : l.toString()) ? (f = 0, !0) : !1;
    }), { verseRef: h, offset: f };
  }
  // #endregion
  ...
  verseRefToUsjContentLocation(e, n = 0) {
    ...
    const f = e.verse, p = this.findNextMatchingNode(
      o,
      qe,
      (v, w) => v === o ? e.verseNum === 0 ? (h = Ee.convertWorkingStackToJsonPath(w), !0) : !1 : typeof v != "object" ? !1 : v.type === Rt ? (a = !0, !0) : v.type === xt && v.number !== void 0 && v.number === f ? (h = Ee.convertWorkingStackToJsonPath(w), !0) : !1
    );
...
export {
  ...
  xt as VERSE_TYPE,
  vi as aggregateUnsubscriberAsyncs,
  Di as aggregateUnsubscribers,
  gi as areUsjContentsEqualExceptWhitespace,
  It as at,
  Et as charAt,
  Zu as codePointAt,
  ...
  mi as getLocalizeKeysForScrollGroupIds,
  hi as getLocalizedIdFromBookNumber,
  ju as groupBy,
  Ni as htmlEncode,
  In as includes,
  St as indexOf,
