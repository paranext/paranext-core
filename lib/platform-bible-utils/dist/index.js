...
var tt = (r, e, t) => e in r ? et(r, e, { enumerable: !0, configurable: !0, writable: !0, value: t }) : r[e] = t;
var y = (r, e, t) => tt(r, typeof e != "symbol" ? e + "" : e, t);
import { Mutex as rt } from "async-mutex";
import { USJ_TYPE as Pe } from "@eten-tech-foundation/scripture-utilities";
import { length as nt, indexOf as it, limit as Ce, substring as st, toArray as ot, substr as at } from "stringz";
...
function cn(r) {
  ...
  return N(r) ? r.includes(e) : $e(r).includes(e);
}
function ln(r) {
  const e = "401 Unauthorized error while getting shared projects.", t = "User registration is not valid. Cannot retrieve resources from DBL.", n = N(r) ? r : $e(r);
...
class dt {
  ...
  constructor(e, t) {
    ...
    y(this, "latestOutput");
    y(this, "options");
    y(this, "onDidRebuildEmitter", new ut());
...
class fn {
  ...
  get(e) {
    ...
    return t || (t = new gt(), this.mutexesByID.set(e, t), t);
  }
}
class pn extends dt {
...
class hn {
  ...
  cleanupPromiseChain(e) {
    ...
    if (!t) return;
    const n = { promise: bt }, i = t.catch((s) => this.logger.warn(`Error in promise for ${e}: ${s.message}`)).finally(() => {
...
var vt = Object.defineProperty, kt = (r, e, t) => e in r ? vt(r, e, { enumerable: !0, configurable: !0, writable: !0, value: t }) : r[e] = t, v = (r, e, t) => kt(r, typeof e != "symbol" ? e + "" : e, t);
const U = [
  "GEN",
  "EXO",
  "LEV",
...
var qe = /* @__PURE__ */ ((r) => (r[r.Valid = 0] = "Valid", r[r.UnknownVersification = 1] = "UnknownVersification", r[r.OutOfRange = 2] = "OutOfRange", r[r.VerseOutOfOrder = 3] = "VerseOutOfOrder", r[r.VerseRepeated = 4] = "VerseRepeated", r))(qe || {});
const A = class k {
  constructor(e, t, n, i) {
...
function de(r, e, t) {
  ...
  let i = e;
  (typeof e == "string" || e instanceof RegExp && !jt(e.flags, "g")) && (i = new RegExp(e, "g"));
  const s = r.match(i);
  let o = 0;
  if (!s) return [r];
...
const Q = ["chapter", "book", "para", "row", "sidebar", Pe], Rt = "​", ze = [
...
], Vt = 1, qt = ze.length - 1, Lt = 1, Ft = 1, Pn = {
  book: "GEN",
  chapterNum: 1,
  verseNum: 1
}, Jt = (r) => {
...
function Bn(r) {
  return new Le(I.bookIdToNumber(r.book), r.chapterNum, r.verseNum).BBBCCC;
}
function me(r) {
  return new Le(I.bookIdToNumber(r.book), r.chapterNum, r.verseNum).BBBCCCVVV;
}
function Dn(r, e) {
  return me(r) - me(e);
}
...
function ge(r, e, t, n) {
  ...
  const s = i ? n ?? " " : "", o = r.verseNum < 0 ? "" : `${t ?? ":"}${r.verseNum}`, a = r.chapterNum < 0 ? "" : `${s}${r.chapterNum}${o}`;
  return `${i}${a}`;
}
function Vn(r, e, t, n, i, s, o = " - ", a = !0) {
  const c = a && r.book === e.book ? "" : n ?? t, l = a && r.book === e.book ? "" : s;
  return `${ge(r, t, i, s)}${o}${ge(e, c, i, l)}`;
}
var Kt = /* @__PURE__ */ ((r) => (r.OT = "OT", r.NT = "NT", r.DC = "DC", r.Extra = "Extra", r))(Kt || {});
const qn = (r) => {
...
function be(r) {
  ...
  for (let i = 0; i < r.length; i += 1) {
    const s = r[i];
    s.charCodeAt(0) < 32 ? (t || (e += " "), t = !0) : !t && s === Rt && i + 1 < r.length && ye(r[i + 1]) || (ye(s) ? (t || (e += s), t = !0) : Xt(s) && n === s || (e += s, t = !1)), n = s;
  }
  return e;
}
function ve(r) {
...
function Ke(r, e, t, n) {
  ...
  if (i && s) {
    const o = be(r), a = be(t);
    if (o !== a) {
      if (!R(H(o, -1) ?? "") && !R(H(a, -1) ?? "") || !ke(r, e) || !ke(t, n)) return !1;
      let c = o;
...
const Fn = (r) => (...e) => r.map((n) => n(...e)).every((n) => n), Jn = (r) => async (...e) => {
  const t = r.map(async (n) => n(...e));
  return (await Promise.all(t)).every((n) => n);
}, Ht = "book", we = "chapter", O = "verse", P = "***";
function zn(r) {
...
function _n(r, e) {
  const t = e && e.length > 0 ? e : Ge(), n = (() => {
    const i = /* @__PURE__ */ new Map();
    let s = 0;
    return r.forEach((o, a) => {
      o.caller === "+" && (i.set(a, Yt(s, t)), s += 1);
    }), i;
  })();
  return (i, s) => {
    if (i === "+") {
...
var Zt = Object.getOwnPropertyNames, Qt = Object.getOwnPropertySymbols, er = Object.prototype.hasOwnProperty;
function Ne(r, e) {
...
function Ie(r) {
  return Zt(r).concat(Qt(r));
}
var tr = Object.hasOwn || function(r, e) {
  return er.call(r, e);
};
function B(r, e) {
  return r === e || !r && !e && r !== r && e !== e;
}
var rr = "__v", nr = "__o", ir = "_owner", xe = Object.getOwnPropertyDescriptor, Ee = Object.keys;
function sr(r, e, t) {
  var n = r.length;
  if (e.length !== n)
    return !1;
...
function J(r, e, t) {
  ...
  if (Ie(e).length !== i)
    return !1;
  for (var s, o, a; i-- > 0; )
    if (s = n[i], !_e(r, e, t, s) || (o = xe(r, s), a = xe(e, s), (o || a) && (!o || !a || o.configurable !== a.configurable || o.enumerable !== a.enumerable || o.writable !== a.writable)))
      return !1;
  return !0;
}
function fr(r, e) {
...
function _e(r, e, t, n) {
  return (n === ir || n === nr || n === rr) && (r.$$typeof || e.$$typeof) ? !0 : tr(e, n) && t.equals(r[n], e[n], n, n, r, e, t);
}
var mr = "[object Arguments]", gr = "[object Boolean]", yr = "[object Date]", br = "[object Error]", vr = "[object Map]", kr = "[object Number]", wr = "[object Object]", Nr = "[object RegExp]", Ir = "[object Set]", xr = "[object String]", Er = "[object URL]", Sr = Array.isArray, Me = typeof ArrayBuffer == "function" && ArrayBuffer.isView ? ArrayBuffer.isView : null, Te = Object.assign, Ar = Object.prototype.toString.call.bind(Object.prototype.toString);
function Mr(r) {
  ...
  return function(f, m, b) {
    ...
    if (w === Set)
      return u(f, m, b);
    var S = Ar(f);
    return S === yr ? t(f, m, b) : S === Nr ? l(f, m, b) : S === vr ? s(f, m, b) : S === Ir ? u(f, m, b) : S === wr ? typeof f.then != "function" && typeof m.then != "function" && a(f, m, b) : S === Er ? p(f, m, b) : S === br ? n(f, m, b) : S === mr ? a(f, m, b) : S === gr || S === kr || S === xr ? c(f, m, b) : !1;
  };
}
function Tr(r) {
  var e = r.circular, t = r.createCustomConfig, n = r.strict, i = {
    areArraysEqual: n ? J : sr,
    areDatesEqual: or,
    areErrorsEqual: ar,
    areFunctionsEqual: cr,
    areMapsEqual: n ? Ne(Se, J) : Se,
    areNumbersEqual: lr,
    areObjectsEqual: n ? J : ur,
    arePrimitiveWrappersEqual: fr,
    areRegExpsEqual: pr,
    areSetsEqual: n ? Ne(Ae, J) : Ae,
    areTypedArraysEqual: n ? J : hr,
    areUrlsEqual: dr
  };
  if (t && (i = Te({}, i, t(i))), e) {
...
function C(r) {
  r === void 0 && (r = {});
  var e = r.circular, t = e === void 0 ? !1 : e, n = r.createInternalComparator, i = r.createState, s = r.strict, o = s === void 0 ? !1 : s, a = Tr(r), c = Mr(a), l = n ? n(c) : Or(c);
  return Pr({ circular: t, comparator: c, createState: i, equals: l, strict: o });
}
function ee(r, e) {
  return Cr(r, e);
}
function $r(r, e) {
  ...
  return Object.keys(t).forEach((s) => {
    i && (Object.hasOwn(n, s) && $r(n[s], t[s]) || (i = !1));
  }), i;
}
function Oe(r, e, t) {
...
const Yn = (r) => r.replace(/&/g, "&amp;").replace(/</g, "&lt;").replace(/>/g, "&gt;").replace(/"/g, "&quot;").replace(/'/g, "&#x27;").replace(/\//g, "&#x2F;");
function Wn() {
  return typeof navigator < "u" && navigator.languages ? navigator.languages[0].replace(/@posix$/i, "") : new lt().resolvedOptions().locale;
}
function Zn(r, e = 2) {
...
const Ur = 1e3, Xe = 60, He = Xe * 60, Br = He * 24;
function Qn(r, e, t = /* @__PURE__ */ new Date()) {
  const n = Math.floor((e.getTime() - t.getTime()) / Ur), i = Math.round(n / Br);
  if (Math.abs(i) >= 1) return r.format(i, "day");
  const s = Math.round(n / He);
  if (Math.abs(s) >= 1) return r.format(s, "hour");
  const o = Math.round(n / Xe);
...
function ni(r, e, t) {
  ...
  return i.id = `${Fr}${t ? `-${t}` : ""}`, i.dataset.themeId = r.id, i.textContent = zr(r), this.document.head.appendChild(i), i;
}
function Ze(r) {
  return Object.freeze(r), r == null || Object.getOwnPropertyNames(r).forEach(function(t) {
    ...
    // eslint-disable-next-line no-null/no-null
    r[t] !== null && (typeof r[t] == "object" || typeof r[t] == "function") && !Object.isFrozen(r[t]) && Ze(r[t]);
  }), r;
}
const te = Ze({
  version: "3.0.7",
...
USJ: ${JSON.stringify(
  ...
  findAllNotes() {
    var e;
    return Wt((e = this.usj) == null ? void 0 : e.content);
  }
  /**
  ...
  getInfoForMarker(e, t = "usfm") {
    ...
    if (t === "usfm" && c === "cell" && h.colspan) {
      const p = parseInt(h.colspan, 10), d = Gr.exec(n);
      if (d != null && d[1]) {
  ...
  textContentToUsfm(e) {
    return {
      usfm: this.shouldAllowInvisibleCharacters ? e : e.replace(Kr, "~"),
    ...
    return i.push({ fragment: e, indexInUsfm: n.length }), n += a === "optbreak" ? "//" : `\\${h}`, a !== "optbreak" && (i.push({
      ...
      i.push({
        ...
        if ("isClosingMarker" in w.fragment) {
          const { isClosingMarker: S, ...D } = w.fragment, Qe = {
            ...D,
            forMarker: e,
  ...
  static transferFragmentsInfoArrayToMaps(e, t, n, i, s, o) {
    e.map((c) => {
      ...
      if (typeof c.fragment == "object" && "type" in c.fragment) {
        ...
        if (d.type === Ht && d.code)
        ...
        else if (d.type === we && d.number) {
          const f = parseInt(d.number, 10);
          if (Number.isNaN(f))
            console.warn(
              `Found ${we} type marker with number ${d.number}, but could not parse chapter number from it. Continuing using previous chapter number ${n.chapterNum}`
            );
          else {
          ...
          const f = (u = _r.exec(d.number)) == null ? void 0 : u[1];
          if (!f)
            console.warn(
...
export {
  ...
  we as CHAPTER_TYPE,
  en as Collator,
  lt as DateTimeFormat,
  dt as DocumentCombiner,
  un as EventRollingTimeCounter,
  Vt as FIRST_SCR_BOOK_NUM,
  Lt as FIRST_SCR_CHAPTER_NUM,
  Ft as FIRST_SCR_VERSE_NUM,
  qt as LAST_SCR_BOOK_NUM,
  ti as MODIFIER_KEYS,
  gt as Mutex,
  fn as MutexMap,
  pn as NonValidatingDocumentCombiner,
  yt as NumberFormat,
  X as PLATFORM_ERROR_VERSION,
  ut as PlatformEventEmitter,
  hn as PromiseChainingMap,
  Kt as Section,
  le as SortedNumberMap,
  dn as SortedSet,
  Fr as THEME_STYLE_ELEMENT_ID,
  te as USFM_MARKERS_MAP_3_0,
  ii as USFM_MARKERS_MAP_PARATEXT_3_0,
  mn as UnsubscriberAsyncList,
  g as UsjReaderWriter,
  O as VERSE_TYPE,
  Jn as aggregateUnsubscriberAsyncs,
  Fn as aggregateUnsubscribers,
  ni as applyThemeStylesheet,
  Ln as areUsjContentsEqualExceptWhitespace,
  H as at,
  V as charAt,
  vn as codePointAt,
  Dn as compareScrRefs,
  an as createSyncProxyForAsyncObject,
  rn as debounce,
  K as deepClone,
  ee as deepEqual,
  Pn as defaultScrRef,
  ...
  Pt as endsWith,
  Fe as ensureArray,
  Sn as escapeStringRegexp,
  ri as expandThemeContribution,
  Zn as formatBytes,
  ei as formatRelativeDate,
  kn as formatReplacementString,
  $t as formatReplacementStringToArray,
  ge as formatScrRef,
  Vn as formatScrRefRange,
  Qn as formatTimeSpan,
  on as getAllObjectFunctionNames,
  Jt as getChaptersForBook,
  Wn as getCurrentLocale,
  Ge as getDefaultCallerSequence,
  $e as getErrorMessage,
  _n as getFormatCallerFunction,
  zt as getLocalizeKeyForScrollGroupId,
  Rn as getLocalizeKeysForScrollGroupIds,
  Un as getLocalizedIdFromBookNumber,
  Yt as getNthCaller,
  Xn as getPaneSizeLimits,
  qn as getSectionForBook,
  zr as getStylesheetForTheme,
  nn as groupBy,
  zn as hasCustomParatextTags,
  Yn as htmlEncode,
  jt as includes,
  _ as indexOf,
  cn as isErrorMessageAboutParatextBlockingInternetAccess,
  ln as isErrorMessageAboutRegistryAuthFailure,
  En as isLocalizeKey,
  yn as isPlatformError,
  Hn as isSerializable,
  N as isString,
  $r as isSubset,
  R as isWhiteSpace,
  Ut as lastIndexOf,
  Vr as localizedStringsDocumentSchema,
  qr as menuDocumentSchema,
  tn as newGuid,
  gn as newPlatformError,
  wn as normalize,
  be as normalizeScriptureSpaces,
  Cn as offsetBook,
  $n as offsetChapter,
  jn as offsetVerse,
  Nn as ordinalCompare,
  In as padEnd,
  xn as padStart,
  Kn as parseParatextHtml,
  Dr as projectSettingsDocumentSchema,
  Gn as sanitizeHtml,
  Bn as scrRefToBBBCCC,
  me as scrRefToBBBCCCVVV,
  Oe as serialize,
  Rr as settingsDocumentSchema,
  he as slice,
  de as split,
  Je as startsWith,
  x as stringLength,
  j as substring,
  Lr as themeDocumentSchema,
  Bt as toArray,
  Tn as toKebabCase,
  Mn as transformAndEnsureRegExpArray,
  An as transformAndEnsureRegExpRegExpArray,
  On as truncateOmittingMiddleWords,
  ht as wait,
  sn as waitForDuration
};
