...
var y = (r, e, t) => rt(r, typeof e != "symbol" ? e + "" : e, t);
import { Mutex as nt } from "async-mutex";
import { USJ_TYPE as Oe } from "@eten-tech-foundation/scripture-utilities";
import { length as it, indexOf as st, limit as Ce, substring as ot, toArray as at, substr as ct } from "stringz";
...
function an(r, e, t) {
  ...
  return r.forEach((s, i) => {
    const o = e(s, i), a = n.get(o), c = t ? t(s, o, i) : s;
...
function fn(r) {
  ...
  return w(r) ? r.includes(e) : $e(r).includes(e);
}
function pn(r) {
  const e = "401 Unauthorized error while getting shared projects.", t = "User registration is not valid. Cannot retrieve resources from DBL.", n = w(r) ? r : $e(r);
...
class mt {
  ...
  constructor(e, t) {
    ...
    y(this, "latestOutput");
    y(this, "options");
    y(this, "onDidRebuildEmitter", new ft());
  ...
  addOrUpdateContribution(e, t) {
    ...
    let s = this.options.copyDocuments && t ? K(t) : t;
...
class dn {
  ...
  get(e) {
    ...
    return t || (t = new yt(), this.mutexesByID.set(e, t), t);
  }
}
class mn extends mt {
...
class gn {
  ...
  cleanupPromiseChain(e) {
    ...
    if (!t) return;
    const n = { promise: vt }, s = t.catch((i) => this.logger.warn(`Error in promise for ${e}: ${i.message}`)).finally(() => {
...
const H = 1;
function vn(r) {
  if (!r) return { message: "", platformErrorVersion: H };
  if (w(r)) return { message: r, platformErrorVersion: H };
  if (typeof r == "object" && "message" in r && typeof r.message == "string") {
    const e = {
      message: r.message,
      platformErrorVersion: H
    };
    return Object.defineProperties(e, Object.getOwnPropertyDescriptors(r)), Object.defineProperty(e, "message", { enumerable: !0 }), "stack" in r && w(r.stack) && Object.defineProperty(e, "stack", { value: r.stack, enumerable: !0 }), "cause" in e && Object.defineProperty(e, "cause", { enumerable: !0 }), e;
  }
  return { cause: r, message: "", platformErrorVersion: H };
}
function kn(r) {
  return !!r && typeof r == "object" && "platformErrorVersion" in r;
}
var kt = Object.defineProperty, Nt = (r, e, t) => e in r ? kt(r, e, { enumerable: !0, configurable: !0, writable: !0, value: t }) : r[e] = t, v = (r, e, t) => Nt(r, typeof e != "symbol" ? e + "" : e, t);
const U = [
  "GEN",
  "EXO",
  "LEV",
...
function wt(r) {
  const e = typeof r == "string" ? L(r) : r;
  return e >= 40 && e <= 66;
}
function It(r) {
  return (typeof r == "string" ? L(r) : r) <= 39;
}
function Be(r) {
  return r <= 66;
}
...
function Pt(r) {
  return Ue[r - 1].includes("*obsolete*");
}
function Ot() {
  const r = {};
...
const I = {
  ...
  extraBooks: At,
  bookNumberToId: ie,
  bookNumberToEnglishName: Ve,
  bookIdToEnglishName: Mt,
  isCanonical: Re,
  isExtraMaterial: Tt,
  isObsolete: Pt
};
...
var Le = /* @__PURE__ */ ((r) => (r[r.Valid = 0] = "Valid", r[r.UnknownVersification = 1] = "UnknownVersification", r[r.OutOfRange = 2] = "OutOfRange", r[r.VerseOutOfOrder = 3] = "VerseOutOfOrder", r[r.VerseRepeated = 4] = "VerseRepeated", r))(Le || {});
const S = class k {
  constructor(e, t, n, s) {
    if (v(this, "firstChapter"), v(this, "lastChapter"), v(this, "lastVerse"), v(this, "hasSegmentsDefined"), v(this, "text"), v(this, "BBBCCCVVVS"), v(this, "longHashCode"), v(this, "versification"), v(this, "rtlMark", "‏"), v(this, "_bookNum", 0), v(this, "_chapterNum", 0), v(this, "_verseNum", 0), v(this, "_verse"), n == null && s == null)
      if (e != null && typeof e == "string") {
        const i = e, o = t != null && t instanceof $ ? t : void 0;
        this.setEmpty(o), this.parse(i);
      } else if (e != null && typeof e == "number") {
        const i = t != null && t instanceof $ ? t : void 0;
        this.setEmpty(i), this._verseNum = e % k.chapterDigitShifter, this._chapterNum = Math.floor(
        ...
        if (e != null && e instanceof k) {
          ...
          if (e == null) return;
          const i = e instanceof $ ? e : k.defaultVersification;
          this.setEmpty(i);
        }
      else
      ...
      if (typeof e == "string" && typeof t == "string" && typeof n == "string")
        ...
        this._bookNum = e, this._chapterNum = t, this._verseNum = n, this.versification = s ?? k.defaultVersification;
      else
        throw new Error("VerseRef constructor not supported.");
    else
      throw new Error("VerseRef constructor not supported.");
   ...
   */
  static fromJSON(e) {
    const { book: t, chapterNum: n, verseNum: s, verse: i, versificationStr: o } = e, a = i || s.toString();
    let c;
  ...
  parse(e) {
    ...
    if (n.length !== 2 || I.bookIdToNumber(t[0]) === 0 || !Number.isInteger(s) || s < 0 || !k.isVerseParseable(n[1]))
      throw new F("Invalid reference : " + e);
  ...
  allVerses(e = !1, t = k.verseRangeSeparators, n = k.verseSequenceIndicators) {
    if (this._verse == null || this.chapterNum <= 0)
      return [this.clone()];
    const s = [], i = fe(this._verse, n);
    for (const o of i.map((a) => fe(a, t))) {
      const a = this.clone();
      a.verse = o[0];
      const c = a.verseNum;
      if (s.push(a), o.length > 1) {
        const l = this.clone();
        if (l.verse = o[1], !e)
...
v(S, "defaultVersification", $.English), v(S, "verseRangeSeparator", "-"), v(S, "verseSequenceIndicator", ","), v(S, "verseRangeSeparators", [S.verseRangeSeparator]), v(S, "verseSequenceIndicators", [S.verseSequenceIndicator]), v(S, "chapterDigitShifter", 1e3), v(S, "bookDigitShifter", S.chapterDigitShifter * S.chapterDigitShifter), v(S, "bcvMaxValue", S.chapterDigitShifter - 1), /**
* The valid status of the VerseRef.
*/
v(S, "ValidStatusType", Le);
let qe = S;
...
function R(r, e) {
  return e < 0 || e > A(r) - 1 ? "" : X(r, e, 1);
}
function wn(r, e) {
  if (!(e < 0 || e > A(r) - 1))
    return X(r, e, 1).codePointAt(0);
}
function Ct(r, e, t = A(r)) {
  const n = A(e), s = t - n;
  return s < 0 ? !1 : X(r, s, n) === e;
}
function $t(r, e, t) {
  if (e < 0) return -1;
  if (t) {
    if (R(r, e) === "}" && R(r, e - 1) === "\\") return e;
    const i = _(r, "\\}", e);
    return i >= 0 ? i + 1 : i;
  }
  let n = e;
  const s = A(r);
  for (; n < s && (n = _(r, "}", n), !(n === -1 || R(r, n - 1) !== "\\")); )
    n += 1;
  return n >= s ? -1 : n;
}
function jt(r, e) {
  ...
  let n = 0, s = 0;
  function i(a, c, l) {
    const u = j(r, s, c), h = t.length > 0 && w(t[t.length - 1]) ? `${t.pop()}${u}` : u;
    w(a) ? t.push(`${h}${a}`) : (h && t.push(h), t.push(a)), s = c + l;
  }
  const o = A(r);
  for (; n < o; ) {
    switch (R(r, n)) {
  ...
  if (s < o) {
    const a = j(r, s);
    t.push(
      t.length > 0 && w(t[t.length - 1]) ? `${t.pop()}${a}` : a
    );
  }
  return t;
}
function In(r, e) {
  return jt(r, e).map((t) => `${t}`).join("");
}
function Ut(r, e, t = 0) {
  const n = j(r, t);
  return _(n, e) !== -1;
...
function An(r, e, t = " ") {
  return e <= A(r) ? r : Ce(r, e, t, "right");
}
function Mn(r, e, t = " ") {
  return e <= A(r) ? r : Ce(r, e, t, "left");
}
function pe(r, e) {
...
function he(r, e, t) {
  ...
  if (e > n || t && (e > t && !(e >= 0 && e < n && t < 0 && t > -n) || t < -n))
    return "";
  const s = pe(n, e), i = t ? pe(n, t) : void 0;
  return j(r, s, i);
}
function de(r, e, t) {
  const n = [];
  if (t !== void 0 && t <= 0)
    return [r];
  if (e === "") return Bt(r).slice(0, t);
  let s = e;
  (typeof e == "string" || e instanceof RegExp && !Ut(e.flags, "g")) && (s = new RegExp(e, "g"));
  const i = r.match(s);
  let o = 0;
  if (!i) return [r];
  for (let a = 0; a < (t ? t - 1 : i.length); a++) {
    const c = _(r, i[a], o), l = A(i[a]);
...
function X(r, e = 0, t = A(r) - e) {
  return ct(r, e, t);
}
function j(r, e, t = A(r)) {
  return ot(r, e, t);
}
function Bt(r) {
  return at(r);
...
function Cn(r) {
  return r ? Fe(r).map((n) => new RegExp(n)) : [];
}
const Dt = (
...
const Q = ["chapter", "book", "para", "row", "sidebar", Oe], Vt = "​", ze = [
...
], Rt = 1, Lt = ze.length - 1, qt = 1, Ft = 1, Un = {
  book: "GEN",
  chapterNum: 1,
  verseNum: 1
}, Jt = (r) => {
  var e;
  return ((e = ze[r]) == null ? void 0 : e.chapters) ?? -1;
}, Bn = (r, e) => ({
  book: I.bookNumberToId(
    Math.max(
      Rt,
      Math.min(I.bookIdToNumber(r.book) + e, Lt)
    )
  ),
  chapterNum: 1,
  verseNum: 1
  ...
  chapterNum: Math.min(
    ...
    Jt(I.bookIdToNumber(r.book))
  ),
  verseNum: 1
}), Vn = (r, e) => ({
  ...r,
  verseNum: Math.max(Ft, r.verseNum + e)
});
async function Rn(r, e, t) {
  const n = I.bookNumberToId(r);
  if (!Je(Intl.getCanonicalLocales(e)[0], "zh"))
    return t({
...
function Ke(r, e) {
  switch (e) {
    case "English":
      return I.bookIdToEnglishName(r.book);
    case "id":
    case void 0:
      return r.book;
    default:
...
function Gt(r, e) {
  const t = Ke(r, e == null ? void 0 : e.optionOrLocalizedBookName), n = (e == null ? void 0 : e.bookChapterSeparator) ?? " ", s = (e == null ? void 0 : e.chapterVerseSeparator) ?? ":";
...
function ge(r, e) {
  const t = Ke(r, e == null ? void 0 : e.optionOrLocalizedBookName), n = _t(
    r,
...
function Jn(r, e, t) {
  const n = ge(r, t);
  if (zt(r, e) === 0) return n;
  const s = r.book === e.book && !(t != null && t.repeatBookName) ? "" : (t == null ? void 0 : t.endRefOptionOrLocalizedBookName) ?? (t == null ? void 0 : t.optionOrLocalizedBookName), i = ge(e, {
    ...t,
    optionOrLocalizedBookName: s
  });
  return `${n}${(t == null ? void 0 : t.rangeSeparator) ?? " - "}${i}`;
}
var Xt = /* @__PURE__ */ ((r) => (r.OT = "OT", r.NT = "NT", r.DC = "DC", r.Extra = "Extra", r))(Xt || {});
const zn = (r) => {
...
function be(r) {
  ...
  for (let s = 0; s < r.length; s += 1) {
    const i = r[s];
    i.charCodeAt(0) < 32 ? (t || (e += " "), t = !0) : !t && i === Vt && s + 1 < r.length && ye(r[s + 1]) || (ye(i) ? (t || (e += i), t = !0) : Wt(i) && n === i || (e += i, t = !1)), n = i;
  }
  return e;
}
function ve(r) {
...
function Ge(r, e, t, n) {
  ...
  if (s && i) {
    const o = be(r), a = be(t);
    if (o !== a) {
      if (!V(Y(o, -1) ?? "") && !V(Y(a, -1) ?? "") || !ke(r, e) || !ke(t, n)) return !1;
      let c = o;
      for (; V(Y(c, -1) ?? ""); ) c = he(c, 0, -1);
      let l = a;
      for (; V(Y(l, -1) ?? ""); ) l = he(l, 0, -1);
      if (c !== l) return !1;
    }
  } else if (!s && !i) {
    ...
    const l = ve(o.content), u = ve(a.content);
    if (l !== u) return !1;
    if (!l && !u) {
      let h = o.content, p = a.content;
      const d = h[h.length - 1];
      Q.includes(o.type) && w(d) && V(d) && (h = h.slice(0, -1));
      const f = p[p.length - 1];
      if (Q.includes(a.type) && w(f) && V(f) && (p = p.slice(0, -1)), h.length !== p.length) return !1;
...
const Gn = (r) => (...e) => r.map((n) => n(...e)).every((n) => n), _n = (r) => async (...e) => {
  const t = r.map(async (n) => n(...e));
  return (await Promise.all(t)).every((n) => n);
}, Zt = "book", Ne = "chapter", P = "verse", O = "***";
function Xn(r) {
...
function Qt(r, e) {
  const t = e && e.length > 0 ? e : _e();
  return t[r % t.length];
}
function Wn(r, e) {
  const t = e && e.length > 0 ? e : _e(), n = (() => {
    const s = /* @__PURE__ */ new Map();
    let i = 0;
    return r.forEach((o, a) => {
      o.caller === "+" && (s.set(a, Qt(i, t)), i += 1);
    }), s;
  })();
  return (s, i) => {
    if (s === "+") {
      const o = n.get(i);
      return o || (console.warn(`Caller index ${i} out of range for '+' callers`), "?");
    }
    if (s !== "-")
      return s;
  };
...
function Zn(r, e = {}) {
  ...
  let c, l;
  return a < n + s ? (c = i, l = o) : (l = Math.min(
    Math.floor((a - s) / a * 100),
    o
  ), c = Math.min(
    Math.max(Math.ceil(n / a * 100), i),
    l
  )), { minPercent: c, maxPercent: l };
}
var tr = Object.getOwnPropertyNames, rr = Object.getOwnPropertySymbols, nr = Object.prototype.hasOwnProperty;
function we(r, e) {
  return function(n, s, i) {
    return r(n, s, i) && e(n, s, i);
  };
}
function W(r) {
  return function(t, n, s) {
    if (!t || !n || typeof t != "object" || typeof n != "object")
      return r(t, n, s);
    var i = s.cache, o = i.get(t), a = i.get(n);
    if (o && a)
      return o === n && a === t;
    i.set(t, n), i.set(n, t);
    var c = r(t, n, s);
...
function Ie(r) {
  return tr(r).concat(rr(r));
}
var ir = Object.hasOwn || function(r, e) {
  return nr.call(r, e);
};
function B(r, e) {
  return r === e || !r && !e && r !== r && e !== e;
}
var sr = "__v", or = "__o", ar = "_owner", xe = Object.getOwnPropertyDescriptor, Ee = Object.keys;
function cr(r, e, t) {
  var n = r.length;
  if (e.length !== n)
    return !1;
...
function Se(r, e, t) {
  ...
  if (!n)
    return !0;
  for (var s = new Array(n), i = r.entries(), o, a, c = 0; (o = i.next()) && !o.done; ) {
...
function J(r, e, t) {
  var n = Ie(r), s = n.length;
  if (Ie(e).length !== s)
    return !1;
  for (var i, o, a; s-- > 0; )
    if (i = n[s], !Xe(r, e, t, i) || (o = xe(r, i), a = xe(e, i), (o || a) && (!o || !a || o.configurable !== a.configurable || o.enumerable !== a.enumerable || o.writable !== a.writable)))
      return !1;
  return !0;
}
function dr(r, e) {
...
function Ae(r, e, t) {
  ...
  if (!n)
    return !0;
  for (var s = new Array(n), i = r.values(), o, a; (o = i.next()) && !o.done; ) {
    for (var c = e.values(), l = !1, u = 0; (a = c.next()) && !a.done; ) {
      if (!s[u] && t.equals(o.value, a.value, o.value, a.value, r, e, t)) {
        l = s[u] = !0;
        break;
      }
      u++;
...
function Xe(r, e, t, n) {
  return (n === ar || n === or || n === sr) && (r.$$typeof || e.$$typeof) ? !0 : ir(e, n) && t.equals(r[n], e[n], n, n, r, e, t);
}
var br = "[object Arguments]", vr = "[object Boolean]", kr = "[object Date]", Nr = "[object Error]", wr = "[object Map]", Ir = "[object Number]", xr = "[object Object]", Er = "[object RegExp]", Sr = "[object Set]", Ar = "[object String]", Mr = "[object URL]", Tr = Array.isArray, Me = typeof ArrayBuffer == "function" && ArrayBuffer.isView ? ArrayBuffer.isView : null, Te = Object.assign, Pr = Object.prototype.toString.call.bind(Object.prototype.toString);
function Or(r) {
  var e = r.areArraysEqual, t = r.areDatesEqual, n = r.areErrorsEqual, s = r.areFunctionsEqual, i = r.areMapsEqual, o = r.areNumbersEqual, a = r.areObjectsEqual, c = r.arePrimitiveWrappersEqual, l = r.areRegExpsEqual, u = r.areSetsEqual, h = r.areTypedArraysEqual, p = r.areUrlsEqual;
  return function(f, m, b) {
    ...
    if (x !== typeof m)
      return !1;
    if (x !== "object")
      return x === "number" ? o(f, m, b) : x === "function" ? s(f, m, b) : !1;
    var N = f.constructor;
    if (N !== m.constructor)
      return !1;
    if (N === Object)
    ...
    if (N === Set)
      return u(f, m, b);
    var E = Pr(f);
    return E === kr ? t(f, m, b) : E === Er ? l(f, m, b) : E === wr ? i(f, m, b) : E === Sr ? u(f, m, b) : E === xr ? typeof f.then != "function" && typeof m.then != "function" && a(f, m, b) : E === Mr ? p(f, m, b) : E === Nr ? n(f, m, b) : E === br ? a(f, m, b) : E === vr || E === Ir || E === Ar ? c(f, m, b) : !1;
  };
}
function Cr(r) {
  var e = r.circular, t = r.createCustomConfig, n = r.strict, s = {
    areArraysEqual: n ? J : cr,
    areDatesEqual: lr,
    areErrorsEqual: ur,
    areFunctionsEqual: fr,
    areMapsEqual: n ? we(Se, J) : Se,
    areNumbersEqual: pr,
    areObjectsEqual: n ? J : hr,
    arePrimitiveWrappersEqual: dr,
    areRegExpsEqual: mr,
    areSetsEqual: n ? we(Ae, J) : Ae,
    areTypedArraysEqual: n ? J : gr,
    areUrlsEqual: yr
  };
  if (t && (s = Te({}, s, t(s))), e) {
    var i = W(s.areArraysEqual), o = W(s.areMapsEqual), a = W(s.areObjectsEqual), c = W(s.areSetsEqual);
    s = Te({}, s, {
      areArraysEqual: i,
      areMapsEqual: o,
      areObjectsEqual: a,
...
function $r(r) {
  return function(e, t, n, s, i, o, a) {
    return r(e, t, a);
  };
}
function jr(r) {
  var e = r.circular, t = r.comparator, n = r.createState, s = r.equals, i = r.strict;
  if (n)
    return function(c, l) {
...
function C(r) {
  r === void 0 && (r = {});
  var e = r.circular, t = e === void 0 ? !1 : e, n = r.createInternalComparator, s = r.createState, i = r.strict, o = i === void 0 ? !1 : i, a = Cr(r), c = Or(a), l = n ? n(c) : $r(c);
  return jr({ circular: t, comparator: c, createState: s, equals: l, strict: o });
}
function ee(r, e) {
  return Ur(r, e);
}
function Br(r, e) {
  ...
  return Object.keys(t).forEach((i) => {
    s && (Object.hasOwn(n, i) && Br(n[i], t[i]) || (s = !1));
  }), s;
}
function Pe(r, e, t) {
  return JSON.stringify(r, (s, i) => {
    let o = i;
    return e && (o = e(s, o)), o === void 0 && (o = null), o;
  }, t);
}
function Dr(r, e) {
  function t(s) {
...
const ei = (r) => r.replace(/&/g, "&amp;").replace(/</g, "&lt;").replace(/>/g, "&gt;").replace(/"/g, "&quot;").replace(/'/g, "&#x27;").replace(/\//g, "&#x2F;");
function ti() {
  return typeof navigator < "u" && navigator.languages ? navigator.languages[0].replace(/@posix$/i, "") : new ut().resolvedOptions().locale;
}
function ri(r, e = 2) {
...
const Vr = 1e3, He = 60, Ye = He * 60, Rr = Ye * 24;
function ni(r, e, t = /* @__PURE__ */ new Date()) {
  const n = Math.floor((e.getTime() - t.getTime()) / Vr), s = Math.round(n / Rr);
  if (Math.abs(s) >= 1) return r.format(s, "day");
  const i = Math.round(n / Ye);
  if (Math.abs(i) >= 1) return r.format(i, "hour");
  const o = Math.round(n / He);
  return Math.abs(o) >= 1 ? r.format(o, "minute") : r.format(n, "second");
}
function ii(r, e, t, n, s = {
  year: "numeric",
  month: "short",
  day: "numeric"
}) {
  const i = /* @__PURE__ */ new Date(), o = new Date(i);
  o.setDate(o.getDate() - 1);
  const a = r.getDate() === i.getDate() && r.getMonth() === i.getMonth() && r.getFullYear() === i.getFullYear(), c = r.getDate() === o.getDate() && r.getMonth() === o.getMonth() && r.getFullYear() === o.getFullYear();
  return a ? e : c ? t : r.toLocaleString(n, s);
}
          ...
          return [
            ...
            o ? {
              ...
              cssVariables: {
                ...
                ...(a = e == null ? void 0 : e[i]) == null ? void 0 : a.cssVariables,
                ...o.cssVariables
              }
            } : void 0
          ];
...
function ai(r, e, t) {
  ...
  return s.id = `${Kr}${t ? `-${t}` : ""}`, s.dataset.themeId = r.id, s.textContent = _r(r), this.document.head.appendChild(s), s;
}
function Qe(r) {
  return Object.freeze(r), r == null || Object.getOwnPropertyNames(r).forEach(function(t) {
    ...
    // eslint-disable-next-line no-null/no-null
    r[t] !== null && (typeof r[t] == "object" || typeof r[t] == "function") && !Object.isFrozen(r[t]) && Qe(r[t]);
  }), r;
}
const te = Qe({
  version: "3.0.7",
...
USJ: ${JSON.stringify(
  ...
  static createParentMapInternal(e, t, n) {
    ...
    n.set(e, t), e.content && n.set(e.content, e), (s = e.content) == null || s.forEach((i) => {
      typeof i == "object" && g.createParentMapInternal(i, e, n);
    });
  }
    ...
    for (; i !== void 0; ) {
      ...
      if (
        ...
        !i.content.find((o, a) => {
          ...
          return t.unshift({ parent: i, index: a }), !0;
        })
      )
  ...
  convertJsonPathToWorkingStack(e) {
    ...
    return n.forEach((i, o) => {
      ...
      if (t.push({ parent: s, index: c }), o + 1 < n.length) {
  ...
  findAllNotes() {
    var e;
    return er((e = this.usj) == null ? void 0 : e.content);
  }
  /**
  ...
  static findNextMatchingNodeOrClosingFragmentUsingWorkingStack(e, t, n, s) {
    ...
    if (!w(o)) {
      ...
      t.some((l) => {
        ...
        return !w(u) && n.includes(u.type) ? (c = u, !0) : !1;
      }), c && (i = c);
    }
    for (; i !== void 0; ) {
      const c = typeof i == "object" && n.includes(i.type);
      if (!c && s(i, t)) return i;
      if (!c && typeof i == "object" && (((a = i.content) == null ? void 0 : a.length) ?? 0) > 0)
  ...
  static findNextMatchingNodeUsingWorkingStack(e, t, n, s) {
    return this.findNextMatchingNodeOrClosingFragmentUsingWorkingStack(
      ...
      t,
      n,
      (o, a) => typeof o == "object" && "isClosingMarker" in o ? !1 : s(o, a)
    );
  }
  ...
  nodeToUsjNodeAndDocumentLocation(e, t) {
    ...
    if (w(e)) {
      ...
      const a = (i = o.content) == null ? void 0 : i.indexOf(e);
      if (a === void 0 || a < 0)
    ...
    const s = g.convertNodeToUsjDocumentLocation(e, n);
    return {
      node: e,
      documentLocation: s
    };
  ...
  jsonPathToNodeAndParentIfString(e) {
    ...
    const n = w(t) ? this.findParent(e) : void 0;
    if (!n && w(t))
  ...
  usjDocumentLocationToUsfmVerseRefVerseLocation(e, t) {
    ...
    return {
      ...
      offset: n.indexInUsfm - i + g.getOffsetInUsjDocumentLocation(e)
    };
  }
  ...
  getEffectiveBookId(e) {
    const t = Object.keys(this.indicesInUsfmByVerseRef), n = t.length === 0 || t.length === 1 && t[0] === O, s = n ? O : e;
    if (!this.indicesInUsfmByVerseRef[s])
      throw new Error(
        `Book ID ${e} not found in USJ! ${n ? `There seems to be no USJ content because there is no content in ${O} either` : `Book IDs in USJ: ${JSON.stringify(t)}`}`
      );
    return s;
  }
  /**
  ...
  getVerseRefForIndexInUsfm(e, t) {
            ...
            for (; !o && b < m.length; ) {
              ...
              if (N !== void 0) {
                if (e < N) {
                  if (!i)
                    throw new Error(
                      `Could not find verse ref for index in USFM ${e} less than the first known index ${N}`
                    );
                  o = !0;
                  break;
                }
    ...
    const a = this.getIndexInUsfmForVerseRef(i), c = this.fragmentsByIndexInUsfm.get(a);
    return c && g.isFragmentAMarker(c.fragment) && c.fragment.type === P && c.fragment.number && c.fragment.number !== `${i.verseNum}` && (i.verse = c.fragment.number), i;
  }
  ...
  usfmVerseLocationToUsjNodeAndDocumentLocation(e) {
    const { verseRef: t, offset: n } = g.usfmVerseLocationToUsfmVerseRefVerseLocation(e), s = this.usfmVerseLocationToIndexInUsfm(e), { value: i } = this.fragmentsByIndexInUsfm.findClosestLessThanOrEqual(
      s
    ) ?? {
      value: void 0
    };
  ...
  findNextLocationOfMatchingText(e, t, n = 1e3) {
    ...
    if (g.findNextMatchingNodeUsingWorkingStack(
      ...
      (d, f) => {
        ...
        i += m.length, s = `${s}${m}`;
        const x = s.indexOf(t);
        return x < 0 ? (o += s.length, s.length > t.length && (s = s.substring(s.length - t.length)), o -= s.length, i > n) : (a = o + x, !0);
      }
    ), a < 0) return;
    i = 0;
    let u = 0, h = [];
    const p = g.findNextMatchingNodeUsingWorkingStack(
      ...
      z,
      (d, f) => typeof d != "string" || (i += d.length, i < a + 1) ? !1 : (u = a - i + d.length, h = f, !0)
    );
  ...
  search(e) {
    ...
    for (; a !== void 0; )
      a = g.findNextMatchingNodeUsingWorkingStack(
        ...
        // eslint-disable-next-line no-loop-func
        (u, h) => (typeof u != "string" || (s.push(u), i.set(o, {
          node: u,
          documentLocation: {
            offset: 0,
            jsonPath: g.convertWorkingStackToJsonPath(h)
    ...
    for (; l; ) {
      if (l[0].length > 0) {
        ...
        const u = i.findClosestLessThanOrEqual(l.index);
        if (!u)
        ...
        }, p = i.findClosestLessThanOrEqual(
    ...
    return g.findNextMatchingNodeUsingWorkingStack(
      ...
      (o) => {
        ...
        if (s >= o.length)
          return s -= o.length, !1;
        let a = o;
        if (s > 0 && (a = a.substring(s), s = 0), i + a.length < t)
          return i += a.length, n = `${n}${a}`, !1;
        const c = t - i;
  ...
  extractTextBetweenPoints(e, t, n = 100) {
    ...
    return g.findNextMatchingNodeUsingWorkingStack(
      ...
      this.convertJsonPathToWorkingStack(e.documentLocation.jsonPath),
      z,
      (i, o) => i === t.node && (typeof i == "object" || t.documentLocation.jsonPath === g.convertWorkingStackToJsonPath(o)) ? !0 : typeof i != "string" ? !1 : (s = `${s}${i}`, s.length > n && (s = s.substring(0, n)), s.length >= n)
    ), s;
  }
  ...
  getInfoForMarker(e, t = "usfm") {
    ...
    const o = (i == null ? void 0 : i.type) ?? (w(e) ? "" : e.type);
    let a = n;
    if (i != null && i.markerUsfm && (a = i.markerUsfm, i = this.getMarkerInfo(a)), !i) {
      if (w(e))
    ...
    let c = i.type, l = this.markersMap.markerTypes[c];
    if (l != null && l.markerTypeUsfm && (c = l.markerTypeUsfm, l = this.markersMap.markerTypes[c]), !w(e) && e.type !== o && (!l || e.type !== l.markerTypeUsfm && e.type !== l.markerTypeUsx && e.type !== l.markerTypeUsj) && (console.warn(
    ...
    ), c = e.type, l = this.markersMap.markerTypes[c], s = !0), !l)
      throw new Error(
        `Unknown marker type ${c} on marker ${n}! Cannot proceed.`
      );
    s && c === "para" && (l = { ...l, hasNewlineBefore: !1 });
    const u = [];
    i.attributeMarkers && i.attributeMarkers.forEach((p) => {
      const d = this.getMarkerInfo(p);
      d && "attributeMarkerAttributeName" in d && u.push([p, d]);
    });
    const h = e;
    if (t === "usfm" && c === "cell" && h.colspan) {
      const p = parseInt(h.colspan, 10), d = Hr.exec(n);
      if (d != null && d[1]) {
  ...
  textContentToUsfm(e) {
    return {
      usfm: this.shouldAllowInvisibleCharacters ? e : e.replace(Xr, "~"),
  ...
  openingMarkerToUsfm(e, t) {
    let n = "";
    const s = [], { markerName: i, markerInfo: o, markerType: a, markerTypeInfo: c, attributeMarkerInfoEntries: l } = this.getInfoForMarker(e), u = e;
    c.hasNewlineBefore && (n += `
`);
    const h = t ? c.nestedPrefix ?? "" : "";
    return s.push({ fragment: e, indexInUsfm: n.length }), n += a === "optbreak" ? "//" : `\\${h}`, a !== "optbreak" && (s.push({
      fragment: { attributeValueForKey: "marker", forMarker: e },
      indexInUsfm: n.length
    }), n += `${i}${a === "unmatched" ? "" : " "}`), o.leadingAttributes && o.leadingAttributes.forEach((p) => {
      const d = u[p];
      d && (s.push({
        fragment: { attributeValueForKey: p, forMarker: e },
        indexInUsfm: n.length
      }), n += `${d} `);
    }), o.textContentAttribute && u[o.textContentAttribute] && (s.push({
      ...
      const { usfm: x } = this.textContentToUsfm(f);
      s.push({
        fragment: {
        ...
        if (w(N.fragment) || "attributeKey" in N.fragment)
          throw new Error(
            `Attribute marker opening or closing markers generated a text content fragment or an attribute key fragment! This does not make sense. ${JSON.stringify(N)}`
          );
        if (g.isFragmentAMarker(N.fragment)) {
          s.push({
            ...N,
            fragment: {
        ...
        if ("attributeValueForKey" in N.fragment) {
          if (N.fragment.attributeValueForKey !== "marker")
            throw new Error(
              `Attribute marker opening or closing markers generated an attribute value fragment for a key that was not marker! This does not make sense. ${JSON.stringify(N)}`
            );
          s.push({
            ...N,
            fragment: {
        ...
        if ("isClosingMarker" in N.fragment) {
          const { isClosingMarker: E, ...D } = N.fragment, et = {
            ...D,
            forMarker: e,
        ...
        throw new Error(
          `Attribute marker opening or closing markers generated an unrecognized fragment: ${JSON.stringify(N)}`
        );
  ...
  closingMarkerToUsfm(e, t) {
    const {
      ...
      var m, b;
      return !(f === "type" || f === "marker" || f === "content" || f === "closed" || (m = a.skipOutputAttributeToUsfm) != null && m.includes(f) || (b = i.leadingAttributes) != null && b.includes(f) || i.textContentAttribute === f || c.some(
        ([, x]) => x.attributeMarkerAttributeName === f
      ));
    }), u = e;
    if (a.isCloseable && i.independentClosingMarkers && i.independentClosingMarkers.length > 0)
      throw new Error(
    ...
    let h = !0;
    if ((u.closed === "false" || i.isClosingMarkerOptional && !this.markersMap.shouldOptionalClosingMarkersBePresent && u.closed !== "true") && (h = !1), i.independentClosingMarkers && i.independentClosingMarkers.length > 0 && h) {
      const f = {
        type: o,
      ...
      let m = "";
      const b = [], { usfm: x, fragmentsInfo: N } = this.openingMarkerToUsfm(f, t), E = N.find((D) => g.isFragmentAMarker(D.fragment));
      if (!E)
        throw new Error(
          `Could not find opening fragment info for independent closing marker ${JSON.stringify(
            f
          )}. Fragments info generated: ${JSON.stringify(N)}`
        );
      return b.push({
        ...E,
        fragment: { isClosingMarker: !0, forMarker: e }
      }), m += x, n !== f.marker && (m = this.addMarkerUsfmToString(
        m,
        {
          isClosingMarker: !0,
          forMarker: f
    ...
    let p = "";
    const d = [];
    if (l.length > 0 && (p += "|", l.length === 1 && l[0] === i.defaultAttribute ? (d.push({
      fragment: { attributeValueForKey: i.defaultAttribute, forMarker: e },
      indexInUsfm: p.length
    }), p += u[i.defaultAttribute]) : l.forEach((f, m) => {
      ...
      const f = a.isClosingMarkerEmpty ? "" : s, m = t ? a.nestedPrefix ?? "" : "";
      d.push({
        fragment: { isClosingMarker: !0, forMarker: e },
        indexInUsfm: p.length
      }), p += `\\${m}${f}*`;
  ...
  addMarkerUsfmToString(e, t, n, s) {
    ...
    if ("isClosingMarker" in t) {
      ...
      !o.startsWith("|") && (i = g.removeEndSpace(i));
    } else {
    ...
    if (o.startsWith(`
`) && (i.length === 0 ? (a = a.map((p) => ({
      ...p,
      indexInUsfm: p.indexInUsfm - 1
    })), o = o.substring(1)) : i = g.removeEndSpace(i)), this.markersMap.isSpaceAfterAttributeMarkersContent && c === "ca") {
      const p = i.lastIndexOf("\\");
      p >= 0 && e.substring(
        p + 1,
        p + 3
      ) === "c " && (i = g.removeEndSpace(i), i += `
 `);
    }
    return s && g.mergeFragmentsInfoIntoExistingArray(
      a,
      s,
      i.length
    ), i += o, i;
  ...
  static areUsjDocumentLocationsEqual(e, t, n = !1) {
    const { jsonPath: s, ...i } = e, { jsonPath: o, ...a } = t;
    return !n && !ee(q.toPathArray(s), q.toPathArray(o)) ? !1 : ee(i, a);
  }
  ...
  findFragmentInfoAtUsjDocumentLocation(e) {
    ...
    if (s)
      return s.find((i) => g.areUsjDocumentLocationsEqual(
        i.nodeAndDocumentLocation.documentLocation,
        t,
  ...
  static convertNodeToUsjDocumentLocation(e, t, n = 0) {
    const s = g.convertWorkingStackToJsonPath(t);
    return w(e) ? { jsonPath: s, offset: n } : { jsonPath: s };
  }
  /**
  ...
  static convertFragmentToUsjNodeAndDocumentLocation(e, t, n = 0) {
    if (w(e) || g.isFragmentAMarker(e)) {
      const s = g.convertNodeToUsjDocumentLocation(
        e,
        t,
        n
      );
   ...
   *   do.
   */
  static transferFragmentsInfoArrayToMaps(e, t, n, s, i, o) {
    e.map((c) => {
      var u, h, p;
      if (typeof c.fragment == "object" && "type" in c.fragment) {
        const d = c.fragment;
        if (d.type === Zt && d.code)
          n.bookId = d.code, n.chapterNum = 0, n.verseNum = 0, o[O] && (o[n.bookId] = o[O], delete o[O]);
        else if (d.type === Ne && d.number) {
          const f = parseInt(d.number, 10);
          if (Number.isNaN(f))
            console.warn(
              `Found ${Ne} type marker with number ${d.number}, but could not parse chapter number from it. Continuing using previous chapter number ${n.chapterNum}`
            );
          else {
        ...
        } else if (d.type === P && d.number) {
          const f = (u = Yr.exec(d.number)) == null ? void 0 : u[1];
          if (!f)
            console.warn(
              `Found ${P} type marker with number ${d.number}, but could not find starting verse number in it. Continuing using previous verse number ${n.verseNum}`
            );
          else {
            const m = parseInt(f, 10);
            Number.isNaN(m) ? console.warn(
              `Found ${P} type marker with number ${d.number}, but could not parse starting verse number from ${f}. Continuing using previous verse number ${n.verseNum}`
            ) : (p = (h = o[n.bookId]) == null ? void 0 : h[n.chapterNum]) != null && p[m] ? console.warn(`Found ${P} marker with existing number ${m} after
                  current ${P} number ${n.verseNum}! Not updating verse start index. All positions in this duplicate verse will be based on the current ${P} marker, not the new duplicate marker.`) : (m < n.verseNum && console.debug(
              `Found ${P} marker with number ${m} lower than current ${P} number ${n.verseNum}. Verses are out of order. There may be some issues.`
            ), n.verseNum = m);
          }
        }
      }
      ...
      s.set(c.indexInUsfm, c);
      const l = c.nodeAndDocumentLocation.documentLocation.jsonPath, u = i.get(l);
      u ? u.push(c) : i.set(l, [c]), o[n.bookId] || (o[n.bookId] = {}), o[n.bookId][n.chapterNum] || (o[n.bookId][n.chapterNum] = {}), o[n.bookId][n.chapterNum][n.verseNum] === void 0 && (o[n.bookId][n.chapterNum][n.verseNum] = c.indexInUsfm);
    }), e.splice(0);
  }
  ...
  calculateUsfmProperties() {
    let e = "";
    const t = new le(), n = /* @__PURE__ */ new Map(), s = {}, i = [], o = {
      bookId: O,
      chapterNum: 0,
      verseNum: 0
    };
    ...
    return g.findNextMatchingNodeOrClosingFragmentUsingWorkingStack(
      ...
      (u, h) => {
        ...
        return h.length > 0 && (p = h[h.length - 1].parent), "isClosingMarker" in u ? l.length > 0 && l[l.length - 1] === u.forMarker ? (l.pop(), !1) : (e = this.addMarkerUsfmToString(
          ...
          p,
          i
        ), a(h), u.forMarker.type === "book" && c && (e = this.addMarkerUsfmToString(e, c, p, i), a(h), c = void 0), !1) : this.shouldSkipOutputMarkerToUsfm(u) ? (l.push(u), !1) : g.isTopLevelUsjMarker(u, h) && !c ? (u.version !== "3.0" && (c = u), !1) : (e = this.addMarkerUsfmToString(e, u, p, i), a(h), !1);
      }
...
export {
  ...
  Ne as CHAPTER_TYPE,
  nn as Collator,
  ut as DateTimeFormat,
  mt as DocumentCombiner,
  hn as EventRollingTimeCounter,
  Rt as FIRST_SCR_BOOK_NUM,
  qt as FIRST_SCR_CHAPTER_NUM,
  Ft as FIRST_SCR_VERSE_NUM,
  Lt as LAST_SCR_BOOK_NUM,
  si as MODIFIER_KEYS,
  yt as Mutex,
  dn as MutexMap,
  mn as NonValidatingDocumentCombiner,
  bt as NumberFormat,
  H as PLATFORM_ERROR_VERSION,
  ft as PlatformEventEmitter,
  gn as PromiseChainingMap,
  Xt as Section,
  le as SortedNumberMap,
  yn as SortedSet,
  Kr as THEME_STYLE_ELEMENT_ID,
  te as USFM_MARKERS_MAP_3_0,
  ci as USFM_MARKERS_MAP_PARATEXT_3_0,
  bn as UnsubscriberAsyncList,
  g as UsjReaderWriter,
  P as VERSE_TYPE,
  _n as aggregateUnsubscriberAsyncs,
  Gn as aggregateUnsubscribers,
  ai as applyThemeStylesheet,
  Kn as areUsjContentsEqualExceptWhitespace,
  Y as at,
  R as charAt,
  wn as codePointAt,
  jn as collapseMiddleWords,
  zt as compareScrRefs,
  un as createSyncProxyForAsyncObject,
  on as debounce,
  K as deepClone,
  ee as deepEqual,
  Un as defaultScrRef,
  ...
  Ct as endsWith,
  Fe as ensureArray,
  Pn as escapeStringRegexp,
  oi as expandThemeContribution,
  ri as formatBytes,
  ii as formatRelativeDate,
  In as formatReplacementString,
  jt as formatReplacementStringToArray,
  Fn as formatScrRef,
  Jn as formatScrRefRange,
  ni as formatTimeSpan,
  ln as getAllObjectFunctionNames,
  Jt as getChaptersForBook,
  ti as getCurrentLocale,
  _e as getDefaultCallerSequence,
  $e as getErrorMessage,
  Wn as getFormatCallerFunction,
  Kt as getLocalizeKeyForScrollGroupId,
  qn as getLocalizeKeysForScrollGroupIds,
  Rn as getLocalizedIdFromBookNumber,
  Qt as getNthCaller,
  Zn as getPaneSizeLimits,
  zn as getSectionForBook,
  _r as getStylesheetForTheme,
  an as groupBy,
  Xn as hasCustomParatextTags,
  ei as htmlEncode,
  Ut as includes,
  _ as indexOf,
  fn as isErrorMessageAboutParatextBlockingInternetAccess,
  pn as isErrorMessageAboutRegistryAuthFailure,
  Tn as isLocalizeKey,
  kn as isPlatformError,
  Qn as isSerializable,
  w as isString,
  Br as isSubset,
  V as isWhiteSpace,
  xn as lastIndexOf,
  Fr as localizedStringsDocumentSchema,
  Jr as menuDocumentSchema,
  sn as newGuid,
  vn as newPlatformError,
  En as normalize,
  be as normalizeScriptureSpaces,
  Bn as offsetBook,
  Dn as offsetChapter,
  Vn as offsetVerse,
  Sn as ordinalCompare,
  An as padEnd,
  Mn as padStart,
  Hn as parseParatextHtml,
  Lr as projectSettingsDocumentSchema,
  Yn as sanitizeHtml,
  Ln as scrRefToBBBCCC,
  me as scrRefToBBBCCCVVV,
  Pe as serialize,
  qr as settingsDocumentSchema,
  he as slice,
  de as split,
  Je as startsWith,
  A as stringLength,
  j as substring,
  zr as themeDocumentSchema,
  Bt as toArray,
  $n as toKebabCase,
  Cn as transformAndEnsureRegExpArray,
  On as transformAndEnsureRegExpRegExpArray,
  dt as wait,
  cn as waitForDuration
};
