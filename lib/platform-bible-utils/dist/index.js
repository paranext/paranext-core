...
var ae = (i, e, t) => e in i ? se(i, e, { enumerable: !0, configurable: !0, writable: !0, value: t }) : i[e] = t;
var k = (i, e, t) => ae(i, typeof e != "symbol" ? e + "" : e, t);
import { d as C, i as _ } from "./scripture-util-DArajUVn.js";
import { D as Dt, F as Lt, a as Bt, b as Vt, G as zt, L as Ht, M as Jt, S as Kt, c as Gt, e as Yt, f as Xt, g as Wt, h as Zt, j as Qt, k as er, l as tr, m as rr, n as nr, o as ir, p as sr, q as ar, r as or, s as cr, t as dr, u as pr, v as lr, w as ur, x as hr, y as fr, z as mr, A as gr, B as yr, C as kr, E as br, H as vr, I as Mr, J as xr, K as _r, N as Er, O as Ir, P as wr, Q as Sr, R as Pr, T as Tr, U as Cr, V as Ar, W as qr, X as $r, Y as jr, Z as Nr, _ as Or, $ as Ur, a0 as Fr, a1 as Rr, a2 as Dr, a3 as Lr, a4 as Br, a5 as Vr, a6 as zr, a7 as Hr, a8 as Jr, a9 as Kr, aa as Gr, ab as Yr, ac as Xr, ad as Wr } from "./scripture-util-DArajUVn.js";
...
class Ge {
  ...
  cleanupPromiseChain(e) {
    ...
    if (!t) return;
    const r = { promise: ke }, s = t.catch((n) => this.logger.warn(`Error in promise for ${e}: ${n.message}`)).finally(() => {
...
const X = 1e4, O = X / 1e3, W = 3, z = /* @__PURE__ */ new Map(), be = {
  unsubscribed: {
    ...
    suppressed: (i, e) => `UnsubscriberAsyncList ${i}: ${e} more unsubscribers arrived after the list was run in the last ${O}s and were unsubscribed immediately; per-occurrence warnings suppressed.`
  },
  failed: {
    log: (i) => console.error(i),
    first: (i) => `UnsubscriberAsyncList ${i}: Unsubscriber added after the list was run failed!`,
    suppressed: (i, e) => `UnsubscriberAsyncList ${i}: ${e} more unsubscribers added after the list was run failed in the last ${O}s; per-occurrence errors suppressed.`
  },
  threw: {
    log: (i) => console.error(i),
    ...
    suppressed: (i, e, t) => `UnsubscriberAsyncList ${i}: ${e} more unsubscribers added after the list was run threw in the last ${O}s; per-occurrence errors suppressed. Distinct errors sampled (up to ${W}): ${t.join(" | ")}`
  }
};
function H(i, e, t) {
  const { log: r, first: s, suppressed: n } = be[e], c = `${i}\0${e}`, p = Date.now(), d = z.get(c);
  if (!d || p >= d.closesAt) {
    r(s(i, t)), z.set(c, {
      closesAt: p + X,
      suppressedCount: 0,
  ...
  d.suppressedCount += 1, t !== void 0 && d.suppressedErrorSamples.size < W && d.suppressedErrorSamples.add(`${t}`), d.summaryTimeout || (d.summaryTimeout = setTimeout(() => {
...
const We = "ABORTED", Ze = "ALREADY_EXISTS", Qe = "CANCELLED", et = "DATA_LOSS", tt = "DEADLINE_EXCEEDED", rt = "FAILED_PRECONDITION", nt = "INTERNAL", it = "INVALID_ARGUMENT", st = "NOT_FOUND", at = "OUT_OF_RANGE", ot = "PERMISSION_DENIED", ct = "RESOURCE_EXHAUSTED", dt = "UNAUTHENTICATED", pt = "UNAVAILABLE", lt = "UNIMPLEMENTED", ut = "UNKNOWN", q = 1;
function ht(i, e) {
  if (!i)
    return {
      message: "",
  ...
  if (typeof i == "object" && "message" in i && typeof i.message == "string") {
    ...
    return Object.defineProperties(t, Object.getOwnPropertyDescriptors(i)), Object.defineProperty(t, "message", { enumerable: !0 }), "stack" in i && _(i.stack) && Object.defineProperty(t, "stack", { value: i.stack, enumerable: !0 }), "cause" in t && Object.defineProperty(t, "cause", { enumerable: !0 }), e && (t.code = e), t;
  }
  return {
    cause: i,
    message: "",
...
const mt = (i) => (...e) => i.map((r) => r(...e)).every((r) => r), gt = (i) => async (...e) => {
...
function yt(i) {
  var e;
  return ((e = Z[i]) == null ? void 0 : e.type) === a.Paragraph || i === "v";
}
function kt(i) {
  const e = Z[i];
...
function ve(i, e) {
  const t = e && e.length > 0 ? e : Q();
  return t[i % t.length];
}
function vt(i, e) {
  const t = e && e.length > 0 ? e : Q(), r = (() => {
    const s = /* @__PURE__ */ new Map();
    let n = 0;
    return i.forEach((c, p) => {
      c.caller === "+" && (s.set(p, ve(n, t)), n += 1);
    }), s;
  })();
  return (s, n) => {
    if (s === "+") {
...
function xe(i, e) {
  ...
  return Object.keys(t).forEach((n) => {
    s && (Object.hasOwn(r, n) && xe(r[n], t[n]) || (s = !1));
  }), s;
}
function G(i, e, t) {
...
const _t = (i) => i.replace(/&/g, "&amp;").replace(/</g, "&lt;").replace(/>/g, "&gt;").replace(/"/g, "&quot;").replace(/'/g, "&#x27;").replace(/\//g, "&#x2F;");
function Et() {
...
const Ee = 1e3, ee = 60, te = ee * 60, Ie = te * 24;
function St(i, e, t = /* @__PURE__ */ new Date()) {
  const r = Math.floor((e.getTime() - t.getTime()) / Ee), s = Math.round(r / Ie);
  if (Math.abs(s) >= 1) return i.format(s, "day");
  const n = Math.round(r / te);
  if (Math.abs(n) >= 1) return i.format(n, "hour");
  const c = Math.round(r / ee);
  return Math.abs(c) >= 1 ? i.format(c, "minute") : i.format(r, "second");
}
function Pt(i, e, t, r, s = {
  year: "numeric",
  month: "short",
  day: "numeric"
}) {
...
function qt(i) {
  const e = {};
  return typeof i.language == "string" && i.language.length > 0 && (e[$.language] = i.language), typeof i.type == "string" && i.type.length > 0 && (e[$.type] = i.type), typeof i.typeName == "string" && i.typeName.length > 0 && (e[$.typeName] = i.typeName), typeof i.lastUsedAt == "number" && Number.isFinite(i.lastUsedAt) && (e[$.lastUsedAt] = i.lastUsedAt), e;
}
function $t(i) {
...
function Ot(i, e, t) {
  ...
  return s.id = `${Ae}${t ? `-${t}` : ""}`, s.dataset.themeId = i.id, s.textContent = $e(i), this.document.head.appendChild(s), s;
}
function ie(i) {
  return Object.freeze(i), i == null || Object.getOwnPropertyNames(i).forEach(function(t) {
    ...
    i[t] !== null && (typeof i[t] == "object" || typeof i[t] == "function") && !Object.isFrozen(i[t]) && ie(i[t]);
  }), i;
}
const F = ie({
  version: "3.0.7",
...
class g {
  ...
  usfmVerseLocationToUsjNodeAndDocumentLocation(e) {
    const { verseRef: t, offset: r } = g.usfmVerseLocationToUsfmVerseRefVerseLocation(e), s = this.usfmVerseLocationToIndexInUsfm(e), { value: n } = this.fragmentsByIndexInUsfm.findClosestLessThanOrEqual(
      s
    ) ?? {
      value: void 0
    };
  ...
  findNextLocationOfMatchingText(e, t, r = 1e3) {
    ...
    if (g.findNextMatchingNodeUsingWorkingStack(
      ...
      (h, f) => {
        ...
        n += y.length, s = `${s}${y}`;
        const E = s.indexOf(t);
        return E < 0 ? (c += s.length, s.length > t.length && (s = s.substring(s.length - t.length)), c -= s.length, n > r) : (p = c + E, !0);
      }
    ), p < 0) return;
    n = 0;
    let m = 0, b = [];
  ...
  extractTextBetweenPoints(e, t, r = 100) {
    ...
    return g.findNextMatchingNodeUsingWorkingStack(
      ...
      this.convertJsonPathToWorkingStack(e.documentLocation.jsonPath),
      T,
      (n, c) => n === t.node && (typeof n == "object" || t.documentLocation.jsonPath === g.convertWorkingStackToJsonPath(c)) ? !0 : typeof n != "string" ? !1 : (s = `${s}${n}`, s.length > r && (s = s.substring(0, r)), s.length >= r)
    ), s;
  }
  ...
  getInfoForMarker(e, t = "usfm") {
    ...
    if (t === "usfm" && d === "cell" && b.colspan) {
      const u = parseInt(b.colspan, 10), h = Ne.exec(r);
      if (h != null && h[1]) {
...
`);
  ...
  closingMarkerToUsfm(e, t) {
    const {
      ...
      var y, v;
      return !(f === "type" || f === "marker" || f === "content" || f === "closed" || (y = p.skipOutputAttributeToUsfm) != null && y.includes(f) || (v = n.leadingAttributes) != null && v.includes(f) || n.textContentAttribute === f || d.some(
...
`) && (n.length === 0 ? (p = p.map((u) => ({
 ...
 `);
  ...
  static areUsjDocumentLocationsEqual(e, t, r = !1) {
    ...
    return !r && !U(P.toPathArray(s), P.toPathArray(c)) ? !1 : U(n, p);
  }
  ...
  findFragmentInfoAtUsjDocumentLocation(e) {
    ...
    if (s)
      return s.find((n) => g.areUsjDocumentLocationsEqual(
        n.nodeAndDocumentLocation.documentLocation,
        t,
    ...
    e.map((d) => {
      ...
      if (typeof d.fragment == "object" && "type" in d.fragment) {
        ...
        if (h.type === J && h.code)
          ...
          const f = (m = Oe.exec(h.number)) == null ? void 0 : m[1];
          if (!f)
            this.reportProblemOnce(
  ...
  calculateUsfmProperties() {
    let e = "";
    const t = new V(), r = /* @__PURE__ */ new Map(), s = {}, n = [], c = {
      bookId: S,
      chapterNum: 0,
      verseNum: 0
    }, p = (m) => {
...
export {
  ...
  ze as Collator,
  et as DATA_LOSS,
  tt as DEADLINE_EXCEEDED,
  Dt as DEBOUNCE_CANCELED_ERROR_MESSAGE,
  le as DateTimeFormat,
  fe as DocumentCombiner,
  He as EventRollingTimeCounter,
  rt as FAILED_PRECONDITION,
  Lt as FIRST_SCR_BOOK_NUM,
  Bt as FIRST_SCR_CHAPTER_NUM,
  Vt as FIRST_SCR_VERSE_NUM,
  zt as GraphemeString,
  nt as INTERNAL,
  it as INVALID_ARGUMENT,
  Ht as LAST_SCR_BOOK_NUM,
  Jt as MAX_PADDING_LENGTH,
  Tt as MODIFIER_KEYS,
  a as MarkerType,
  ge as Mutex,
  Je as MutexMap,
  st as NOT_FOUND,
  Ke as NonValidatingDocumentCombiner,
  ye as NumberFormat,
  at as OUT_OF_RANGE,
  ot as PERMISSION_DENIED,
  q as PLATFORM_ERROR_VERSION,
  $ as PROJECT_SELECTOR_CUSTOM_DATA_KEYS,
  he as PlatformEventEmitter,
  Ge as PromiseChainingMap,
  ct as RESOURCE_EXHAUSTED,
  Kt as SELECTABLE_INVISIBLE_CHAR_OR_WHITESPACE_CLASS,
  Gt as Section,
  V as SortedNumberMap,
  Ye as SortedSet,
  Ae as THEME_STYLE_ELEMENT_ID,
  dt as UNAUTHENTICATED,
  pt as UNAVAILABLE,
  lt as UNIMPLEMENTED,
  ut as UNKNOWN,
  F as USFM_MARKERS_MAP_3_0,
  Ut as USFM_MARKERS_MAP_PARATEXT_3_0,
  Xe as UnsubscriberAsyncList,
  g as UsjReaderWriter,
  w as VERSE_TYPE,
  gt as aggregateUnsubscriberAsyncs,
  mt as aggregateUnsubscribers,
  Ot as applyThemeStylesheet,
  Yt as areUsjContentsEqualExceptWhitespace,
  Xt as at,
  Wt as charAt,
  Zt as codePointAt,
  Qt as collapseMiddleWords,
  er as collectUsjMarkers,
  tr as compareScrRefs,
  At as computeEffectiveStructureProtection,
  rr as createSyncProxyForAsyncObject,
  nr as debounce,
  C as deepClone,
  U as deepEqual,
  ir as defaultScrRef,
  ...
  Nt as expandThemeContribution,
  It as formatBytes,
  Pt as formatRelativeDate,
  cr as formatReplacementString,
  dr as formatReplacementStringToArray,
  pr as formatScrRef,
  lr as formatScrRefRange,
  St as formatTimeSpan,
  ur as getAllObjectFunctionNames,
  hr as getChaptersForBook,
  Et as getCurrentLocale,
  Q as getDefaultCallerSequence,
  fr as getErrorMessage,
  vt as getFormatCallerFunction,
  Ct as getLocalizeKeyForPhysicalKey,
  mr as getLocalizeKeyForScrollGroupId,
  gr as getLocalizeKeysForScrollGroupIds,
  yr as getLocalizedIdFromBookNumber,
  ve as getNthCaller,
  Mt as getPaneSizeLimits,
  kr as getSectionForBook,
  $e as getStylesheetForTheme,
  br as groupBy,
  _t as htmlEncode,
  vr as includes,
  Mr as indexOf,
  yt as isBlockMarker,
  kt as isCharacterMarker,
  xr as isErrorMessageAboutParatextBlockingInternetAccess,
  _r as isErrorMessageAboutRegistryAuthFailure,
  Er as isLocalizeKey,
  ft as isPlatformError,
  Ir as isSelectableInvisibleCharOrWhiteSpace,
  xt as isSerializable,
  _ as isString,
  xe as isSubset,
  wr as isWhiteSpace,
  Sr as isolateBidi,
  Pr as lastIndexOf,
  Pe as localizedStringsDocumentSchema,
  qt as makeProjectSelectorCustomData,
  Te as menuDocumentSchema,
  Tr as newGuid,
  ht as newPlatformError,
  Cr as normalize,
  wt as normalizeProjectId,
  Ar as normalizeScriptureSpaces,
  qr as offsetBook,
  $r as offsetChapter,
  jr as offsetVerse,
  ...
  Or as padEnd,
  Ur as padStart,
  we as projectSettingsDocumentSchema,
  $t as recencyMapFromOrderedIds,
  Fr as retryUntil,
  bt as sanitizeHtml,
  Rr as scrRefToBBBCCC,
  Dr as scrRefToBBBCCCVVV,
  G as serialize,
  Se as settingsDocumentSchema,
  Lr as slice,
  Br as split,
  Vr as startsWith,
  zr as stringLength,
  Hr as substring,
  Ce as themeDocumentSchema,
  Jr as toArray,
  Kr as toKebabCase,
  Gr as transformAndEnsureRegExpArray,
  Yr as transformAndEnsureRegExpRegExpArray,
  Z as usfmMarkers,
  Xr as wait,
  Wr as waitForDuration
};
