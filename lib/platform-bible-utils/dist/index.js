  ...
  constructor(e, r, s, i) {
    if (l(this, "firstChapter"), l(this, "lastChapter"), l(this, "lastVerse"), l(this, "hasSegmentsDefined"), l(this, "text"), l(this, "BBBCCCVVVS"), l(this, "longHashCode"), l(this, "versification"), l(this, "rtlMark", "‏"), l(this, "_bookNum", 0), l(this, "_chapterNum", 0), l(this, "_verseNum", 0), l(this, "_verse"), s == null && i == null)
      if (e != null && typeof e == "string") {
        const n = e, o = r != null && r instanceof T ? r : void 0;
        this.setEmpty(o), this.parse(n);
      } else if (e != null && typeof e == "number") {
        const n = r != null && r instanceof T ? r : void 0;
        ...
        if (e != null && e instanceof f) {
          ...
          if (e == null)
            return;
          const n = e instanceof T ? e : f.defaultVersification;
          this.setEmpty(n);
        }
      else
...
var Q = typeof globalThis < "u" ? globalThis : typeof window < "u" ? window : typeof global < "u" ? global : typeof self < "u" ? self : {}, S = {}, et = () => {
  const t = "\\ud800-\\udfff", e = "\\u0300-\\u036f", r = "\\ufe20-\\ufe2f", s = "\\u20d0-\\u20ff", i = "\\u1ab0-\\u1aff", n = "\\u1dc0-\\u1dff", o = e + r + s + i + n, a = "\\ufe0e\\ufe0f", h = "\\uD83D\\uDC69\\uD83C\\uDFFB\\u200D\\uD83C\\uDF93", p = `[${t}]`, u = `[${o}]`, c = "\\ud83c[\\udffb-\\udfff]", m = `(?:${u}|${c})`, v = `[^${t}]`, b = "(?:\\uD83C[\\uDDE6-\\uDDFF]){2}", A = "[\\ud800-\\udbff][\\udc00-\\udfff]", x = "\\u200d", Se = "(?:\\ud83c\\udff4\\udb40\\udc67\\udb40\\udc62\\udb40(?:\\udc65|\\udc73|\\udc77)\\udb40(?:\\udc6e|\\udc63|\\udc6c)\\udb40(?:\\udc67|\\udc74|\\udc73)\\udb40\\udc7f)", Te = `[${h}]`, K = `${m}?`, H = `[${a}]?`, Ce = `(?:${x}(?:${[v, b, A].join("|")})${H + K})*`, je = H + K + Ce, Ae = `(?:${[`${v}${u}?`, u, b, A, p, Te].join("|")})`;
  return new RegExp(`${Se}|${c}(?=${c})|${Ae + je}`, "g");
...
function V(t) {
  ...
  return t.match(R.default()) || [];
}
var rt = S.toArray = V;
function G(t) {
  if (typeof t != "string")
    throw new Error("Input must be a string");
  var e = t.match(R.default());
...
function ye(t, e, r) {
  ...
  var s = t.match(R.default());
  return s ? s.slice(e, r).join("") : "";
}
var it = S.substring = ye;
function nt(t, e, r) {
  if (e === void 0 && (e = 0), typeof t != "string")
    throw new Error("Input must be a string");
  var s = G(t);
...
function mr(t, e) {
  return e < 0 || e > g(t) - 1 ? "" : I(t, e, 1);
}
function gr(t, e) {
  if (!(e < 0 || e > g(t) - 1))
    return I(t, e, 1).codePointAt(0);
}
...
function br(t, e) {
  ...
  return s = Y(r, t, (n) => {
    ...
    return t;
  }), s = Y(/[{}\\]*(\\)+\{[^{}\\]*(\\)+\}/g, s, (n) => (s = s.replace(n[1], ""), s = s.replace(n[2], ""), s)), s;
}
function ft(t, e, r = 0) {
  const s = k(t, r);
  return _(s, e) !== -1;
...
function te(t, e, r) {
  ...
  let i = e;
  (typeof e == "string" || e instanceof RegExp && !ft(e.flags, "g")) && (i = new RegExp(e, "g"));
  const n = t.match(i);
  let o = 0;
  if (!n)
    return [t];
...
function Ar(t, e, r, s) {
  ...
  switch (e ?? "id") {
    case "English":
      i = w.bookNumberToEnglishName(t.bookNum);
      break;
    case "id":
      i = w.bookNumberToId(t.bookNum);
      break;
    default:
      i = e ?? "";
      break;
...
const Pr = (t) => (...e) => t.map((s) => s(...e)).every((s) => s), Mr = (t) => async (...e) => {
...
var $e = "_owner", ie = Object.getOwnPropertyDescriptor, ne = Object.keys;
function Et(t, e, r) {
  var s = t.length;
  if (e.length !== s)
    return !1;
...
function Ot(t, e, r) {
  ...
  if (ne(e).length !== i)
    return !1;
  for (var n; i-- > 0; )
    if (n = s[i], n === $e && (t.$$typeof || e.$$typeof) && t.$$typeof !== e.$$typeof || !Ee(e, n) || !r.equals(t[n], e[n], n, n, t, e, r))
      return !1;
  return !0;
}
function M(t, e, r) {
  var s = se(t), i = s.length;
  if (se(e).length !== i)
    return !1;
  for (var n, o, a; i-- > 0; )
    if (n = s[i], n === $e && (t.$$typeof || e.$$typeof) && t.$$typeof !== e.$$typeof || !Ee(e, n) || !r.equals(t[n], e[n], n, n, t, e, r) || (o = ie(t, n), a = ie(e, n), (o || a) && (!o || !a || o.configurable !== a.configurable || o.enumerable !== a.enumerable || o.writable !== a.writable)))
      return !1;
  return !0;
}
function St(t, e) {
...
var jt = "[object Arguments]", At = "[object Boolean]", Pt = "[object Date]", Mt = "[object Map]", Dt = "[object Number]", Bt = "[object Object]", kt = "[object RegExp]", Rt = "[object Set]", It = "[object String]", xt = Array.isArray, ue = typeof ArrayBuffer == "function" && ArrayBuffer.isView ? ArrayBuffer.isView : null, le = Object.assign, Vt = Object.prototype.toString.call.bind(Object.prototype.toString);
function qt(t) {
  ...
  return function(u, c, m) {
    ...
    if (v === Set)
      return a(u, c, m);
    var b = Vt(u);
    return b === Pt ? r(u, c, m) : b === kt ? o(u, c, m) : b === Mt ? s(u, c, m) : b === Rt ? a(u, c, m) : b === Bt ? typeof u.then != "function" && typeof c.then != "function" && i(u, c, m) : b === jt ? i(u, c, m) : b === At || b === Dt || b === It ? n(u, c, m) : !1;
  };
}
function zt(t) {
...
function $(t) {
  t === void 0 && (t = {});
  var e = t.circular, r = e === void 0 ? !1 : e, s = t.createInternalComparator, i = t.createState, n = t.strict, o = n === void 0 ? !1 : n, a = zt(t), h = qt(a), p = s ? s(h) : Jt(h);
  return Gt({ circular: r, comparator: h, createState: i, equals: p, strict: o });
}
function Xt(t, e) {
  return _t(t, e);
}
function Ft(t, e) {
  ...
  return Object.keys(r).forEach((n) => {
    i && (Object.hasOwn(s, n) && Ft(s[n], r[n]) || (i = !1));
  }), i;
}
function ce(t, e, r) {
