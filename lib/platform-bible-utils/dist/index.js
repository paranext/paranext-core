...
function ku(t, e = 300) {
  if (Pe(t)) throw new Error("Tried to debounce a string! Could be XSS");
  let n;
  return (...i) => {
...
function Vu(t) {
  ...
  return Pe(t) ? t.includes(e) : Ir(t).includes(e);
}
function Hu(t) {
  const e = "401 Unauthorized error while getting shared projects.", n = "User registration is not valid. Cannot retrieve resources from DBL.", i = Pe(t) ? t : Ir(t);
...
class tn {
  ...
  constructor(e, n) {
    ...
    W(this, "latestOutput");
    W(this, "options");
    W(this, "onDidRebuildEmitter", new Wr());
...
function kr() {
  ...
  At.prototype.nodeType = Re, R(At, j);
  function ft(r) {
    b(r);
  }
