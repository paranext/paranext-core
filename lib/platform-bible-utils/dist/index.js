...
var Yr = (t, e, n) => e in t ? Jr(t, e, { enumerable: !0, configurable: !0, writable: !0, value: n }) : t[e] = n;
...
var sn = Object.defineProperty, cn = (t, e, n) => e in t ? sn(t, e, { enumerable: !0, configurable: !0, writable: !0, value: n }) : t[e] = n, G = (t, e, n) => cn(t, typeof e != "symbol" ? e + "" : e, n);
const it = [
  "GEN",
  "EXO",
  "LEV",
...
const De = class Y {
  ...
  parse(e) {
    ...
    if (i.length !== 2 || Ne.bookIdToNumber(n[0]) === 0 || !Number.isInteger(o) || o < 0 || !Y.isVerseParseable(i[1]))
      throw new yt("Invalid reference : " + e);
...
function Dt() {
  ...
  tr = 1;
  function t(R, F, j) {
    if (j === void 0 && (j = Array.prototype), R && typeof j.find == "function")
      return j.find.call(R, F);
    for (var ne = 0; ne < R.length; ne++)
      if (n(R, ne)) {
        var le = R[ne];
        if (F.call(void 0, le, ne, R))
          return le;
      }
  }
  function e(R, F) {
...
function kr() {
  ...
  var f = /[\x20\x09\x0D\x0A]/, m = n(f), g = o(f, "+"), l = o(f, "*"), v = /[:_a-zA-Z\xC0-\xD6\xD8-\xF6\xF8-\u02FF\u0370-\u1FFF\u200C-\u200D\u2070-\u218F\u2C00-\u2FEF\u3001-\uD7FF\uF900-\uFDCF\uFDF0-\uFFFD]/;
  e && (v = o("[", n(v), "\\u{10000}-\\u{10FFFF}", "]"));
  var O = n(v), N = o("[", O, n(/[-.0-9\xB7]/), n(/[\u0300-\u036F\u203F-\u2040]/), "]"), y = o(v, N, "*"), U = o(N, "+"), R = o("&", y, ";"), F = a(/&#[0-9]+;|&#x[0-9a-fA-F]+;/), j = a(R, "|", F), ne = o("%", y, ";"), le = a(
    o('"', a(/[^%&"]/, "|", ne, "|", j), "*", '"'),
    "|",
    o("'", a(/[^%&']/, "|", ne, "|", j), "*", "'")
  ), E = a('"', a(/[^<&"]/, "|", j), "*", '"', "|", "'", a(/[^<&']/, "|", j), "*", "'"), x = i(v, ":"), k = i(N, ":"), z = o(x, k, "*"), K = o(z, a(":", z), "?"), ee = o("^", K, "$"), Ie = o("(", K, ")"), te = a(/"[^"]*"|'[^']*'/), Be = o(/^<\?/, "(", y, ")", a(g, "(", p, "*?)"), "?", /\?>/), d = /[\x20\x0D\x0Aa-zA-Z0-9-'()+,./:=?;!*#@$_%]/, b = a('"', d, '*"', "|", "'", i(d, "'"), "*'"), w = "<!--", C = "-->", M = o(w, a(i(p, "-"), "|", o("-", i(p, "-"))), "*", C), A = "#PCDATA", B = a(
    o(/\(/, l, A, a(l, /\|/, l, K), "*", l, /\)\*/),
    "|",
    o(/\(/, l, A, l, /\)/)
  ), X = /[?*+]?/, _ = o(
  ...
  ), T = a("EMPTY", "|", "ANY", "|", B, "|", _), I = "<!ELEMENT", L = o(I, g, a(K, "|", ne), g, a(T, "|", ne), l, ">"), V = o("NOTATION", g, /\(/, l, y, a(l, /\|/, l, y), "*", l, /\)/), fe = o(/\(/, l, U, a(l, /\|/, l, U), "*", l, /\)/), we = a(V, "|", fe), ve = a(/CDATA|ID|IDREF|IDREFS|ENTITY|ENTITIES|NMTOKEN|NMTOKENS/, "|", we), ie = a(/#REQUIRED|#IMPLIED/, "|", a(a("#FIXED", g), "?", E)), P = a(g, y, g, ve, g, ie), je = "<!ATTLIST", Re = o(je, g, y, P, "*", l, ">"), pe = "about:legacy-compat", Ve = a('"' + pe + '"', "|", "'" + pe + "'"), _e = "SYSTEM", Se = "PUBLIC", ke = a(a(_e, g, te), "|", a(Se, g, b, g, te)), He = o(
    "^",
    a(
      a(_e, g, "(?<SystemLiteralOnly>", te, ")"),
      "|",
      a(Se, g, "(?<PubidLiteral>", b, ")", g, "(?<SystemLiteral>", te, ")")
    )
  ), Xe = a(g, "NDATA", g, y), ye = a(le, "|", a(ke, Xe, "?")), Q = "<!ENTITY", ze = o(Q, g, y, g, ye, l, ">"), oe = a(le, "|", ke), Je = o(Q, g, "%", g, y, g, oe, l, ">"), vt = a(ze, "|", Je), Ye = o(Se, g, b), We = o("<!NOTATION", g, y, g, a(ke, "|", Ye), l, ">"), q = o(l, "=", l), Z = /1[.]\d+/, Ae = o(g, "version", q, a("'", Z, "'", "|", '"', Z, '"')), be = /[A-Za-z][-A-Za-z0-9._]*/, Ke = a(g, "encoding", q, a('"', be, '"', "|", "'", be, "'")), st = a(g, "standalone", q, a("'", a("yes", "|", "no"), "'", "|", '"', a("yes", "|", "no"), '"')), ct = o(/^<\?xml/, Ae, Ke, "?", st, "?", l, /\?>/), lt = "<!DOCTYPE", At = "<![CDATA[", bt = "]]>", ft = /<!\[CDATA\[/, Qe = /\]\]>/, pt = o(p, "*?", Qe), Ot = o(ft, pt);
  return $.chars = n, $.chars_without = i, $.detectUnicodeSupport = t, $.reg = o, $.regg = a, $.ABOUT_LEGACY_COMPAT = pe, $.ABOUT_LEGACY_COMPAT_SystemLiteral = Ve, $.AttlistDecl = Re, $.CDATA_START = At, $.CDATA_END = bt, $.CDSect = Ot, $.Char = p, $.Comment = M, $.COMMENT_START = w, $.COMMENT_END = C, $.DOCTYPE_DECL_START = lt, $.elementdecl = L, $.EntityDecl = vt, $.EntityValue = le, $.ExternalID = ke, $.ExternalID_match = He, $.Name = y, $.NotationDecl = We, $.Reference = j, $.PEReference = ne, $.PI = Be, $.PUBLIC = Se, $.PubidLiteral = b, $.QName = K, $.QName_exact = ee, $.QName_group = Ie, $.S = g, $.SChar_s = m, $.S_OPT = l, $.SYSTEM = _e, $.SystemLiteral = te, $.UNICODE_REPLACEMENT_CHARACTER = h, $.UNICODE_SUPPORT = e, $.XMLDecl = ct, $;
}
var ur;
function Fr() {
  if (ur) return re;
  ur = 1;
  var t = Dt(), e = t.find, n = t.hasDefaultHTMLNamespace, i = t.hasOwn, o = t.isHTMLMimeType, a = t.isHTMLRawTextElement, h = t.isHTMLVoidElement, p = t.MIME_TYPE, f = t.NAMESPACE, m = Symbol(), g = _t(), l = g.DOMException, v = g.DOMExceptionName, O = kr();
  function N(r) {
    if (r !== m)
  ...
  var k = {}, z = k.ELEMENT_NODE = 1, K = k.ATTRIBUTE_NODE = 2, ee = k.TEXT_NODE = 3, Ie = k.CDATA_SECTION_NODE = 4, te = k.ENTITY_REFERENCE_NODE = 5, Be = k.ENTITY_NODE = 6, d = k.PROCESSING_INSTRUCTION_NODE = 7, b = k.COMMENT_NODE = 8, w = k.DOCUMENT_NODE = 9, C = k.DOCUMENT_TYPE_NODE = 10, M = k.DOCUMENT_FRAGMENT_NODE = 11, A = k.NOTATION_NODE = 12, B = t.freeze({
  ...
  pt.prototype.nodeType = d, x(pt, be);
  function Ot() {
  }
  ...
  function qe(r, u, s, c) {
    ...
    switch (r.nodeType) {
      case z:
        var J = r.attributes, ae = J.length, me = r.firstChild, de = r.tagName, Ce = de;
        if (!S && !r.prefix && r.namespaceURI) {
          for (var Ee, Ze = 0; Ze < J.length; Ze++)
    ...
    switch (u.childNodes && (c.childNodes = new T()), c.ownerDocument = r, c.nodeType) {
      case z:
        ...
        for (var Ce = 0; Ce < de; Ce++)
          c.setAttributeNode(kt(r, J.item(Ce), !0));
        break;
      case K:
        s = !0;
    }
...
function bn() {
  if (or) return Ct;
  or = 1;
  var t = Dt(), e = kr(), n = _t(), i = t.isHTMLEscapableRawTextElement, o = t.isHTMLMimeType, a = t.isHTMLRawTextElement, h = t.hasOwn, p = t.NAMESPACE, f = n.ParseError, m = n.DOMException, g = 0, l = 1, v = 2, O = 3, N = 4, y = 5, U = 6, R = 7;
  function F() {
  }
  F.prototype = {
    parse: function(d, b, w) {
      var C = this.domBuilder;
      C.startDocument(), z(b, b = /* @__PURE__ */ Object.create(null)), ne(d, b, w, C, this.errorHandler), C.endDocument();
    }
  };
  var j = /&#?\w+;?/g;
  function ne(d, b, w, C, M) {
    var A = o(C.mimeType);
    ...
    function X(q) {
      ...
      var be = Z.slice(1, -1);
      return h(w, be) ? w[be] : be.charAt(0) === "#" ? B(parseInt(be.substring(1).replace("x", "0x"))) : (M.error("entity not found:" + q), q);
    }
    function _(q) {
      if (q > ie) {
        var Z = d.substring(ie, q).replace(j, X);
        V && fe(ie), C.characters(Z, 0, q - ie), ie = q;
      }
    }
    var T = 0, I = 0, L = /\r\n?|\n|$/g, V = C.locator;
    function fe(q, Z) {
      ...
      try {
        ...
        if (P < 0) {
          ...
          if (!d.substring(ie).match(/^\s*$/)) {
            var je = C.doc, Re = je.createTextNode(d.substring(ie));
            if (je.documentElement)
              return M.error("Extra content at the end of the document");
            je.appendChild(Re), C.currentElement = Re;
          }
          return;
        }
        if (P > ie) {
        ...
        switch (d.charAt(P + 1)) {
          case "/":
            ...
            if (C.endElement(He.uri, He.localName, Se), Xe)
              for (var ye in Xe)
                h(Xe, ye) && C.endPrefixMapping(ye);
            oe++;
            break;
          // end element
          case "?":
            V && fe(P), oe = te(d, P, C, M);
            break;
          case "!":
            V && fe(P), oe = Ie(d, P, C, M, A);
            break;
          default:
            V && fe(P);
            var Q = new Be(), ze = we[we.length - 1].currentNSMap, oe = E(d, P, Q, ze, X, M, A), Je = Q.length;
            if (Q.closed || (A && t.isHTMLVoidElement(Q.tagName) ? Q.closed = !0 : ve.push(Q.tagName)), V && Je) {
              ...
              x(Q, C, ze) && we.push(Q);
            A && !Q.closed ? oe = k(d, oe, Q.tagName, X, C) : oe++;
        }
      } catch (q) {
        if (q instanceof f)
          throw q;
  ...
  function le(d, b) {
    return b.lineNumber = d.lineNumber, b.columnNumber = d.columnNumber, b;
  }
  function E(d, b, w, C, M, A, B) {
    function X(fe, we, ve) {
    ...
    for (var _, T, I = ++b, L = g; ; ) {
      ...
      switch (V) {
        ...
        case '"':
          if (L === O || L === l)
            if (L === l && (A.warning('attribute value must after "="'), _ = d.slice(b, I)), b = I + 1, I = d.indexOf(V, b), I > 0)
              T = d.slice(b, I), X(_, T, b - 1), L = y;
            else
              throw new Error("attribute value no end '" + V + "' match");
          else if (L == N)
            T = d.slice(b, I), X(_, T, b), A.warning('attribute "' + _ + '" missed start quot(' + V + ")!!"), b = I + 1, L = y;
          else
        ...
        case "/":
          ...
          break;
        case "":
          return A.error("unexpected end of input"), L == g && w.setTagName(d.slice(b, I)), I;
        case ">":
          switch (L) {
            case g:
              w.setTagName(d.slice(b, I));
            ...
            //Compatible state
            case l:
              T = d.slice(b, I), T.slice(-1) === "/" && (w.closed = !0, T = T.slice(0, -1));
            case v:
              L === v && (T = _), L == N ? (A.warning('attribute "' + T + '" missed quot(")!'), X(_, T, b)) : (B || A.warning('attribute "' + T + '" missed value!! "' + T + '" instead!!'), X(T, T, b));
              break;
            case O:
              if (!B)
        ...
        default:
          if (V <= " ")
            switch (L) {
              ...
              case N:
                var T = d.slice(b, I);
                A.warning('attribute "' + T + '" missed quot(")!!'), X(_, T, b);
              case y:
                L = U;
                break;
            }
            ...
            switch (L) {
              ...
              case v:
                B || A.warning('attribute "' + _ + '" missed value!! "' + _ + '" instead2!!'), X(_, _, b), b = I, L = l;
                break;
              case y:
  ...
  function x(d, b, w) {
    for (var C = d.tagName, M = null, L = d.length; L--; ) {
      var A = d[L], B = A.qName, X = A.value, V = B.indexOf(":");
      if (V > 0)
        var _ = A.prefix = B.slice(0, V), T = B.slice(V + 1), I = _ === "xmlns" && T;
      else
        T = B, _ = null, I = B === "xmlns" && "";
      A.localName = T, I !== !1 && (M == null && (M = /* @__PURE__ */ Object.create(null), z(w, w = /* @__PURE__ */ Object.create(null))), w[I] = M[I] = X, A.uri = p.XMLNS, b.startPrefixMapping(I, X));
    }
    for (var L = d.length; L--; )
      A = d[L], A.prefix && (A.prefix === "xml" && (A.uri = p.XML), A.prefix !== "xmlns" && (A.uri = w[A.prefix]));
    var V = C.indexOf(":");
    V > 0 ? (_ = d.prefix = C.slice(0, V), T = d.localName = C.slice(V + 1)) : (_ = null, T = d.localName = C);
    var fe = d.uri = w[_ || ""];
    if (b.startElement(fe, T, C, d), d.closed) {
      if (b.endElement(fe, T, C), M)
        for (_ in M)
          h(M, _) && b.endPrefixMapping(_);
    } else
      return d.currentNSMap = w, d.localNSMap = M, !0;
  }
  function k(d, b, w, C, M) {
    var A = i(w);
    if (A || a(w)) {
      var B = d.indexOf("</" + w + ">", b), X = d.substring(b + 1, B);
      return A && (X = X.replace(j, C)), M.characters(X, 0, X.length), B;
    }
    return b + 1;
  }
  function z(d, b) {
...
` && L !== "	" && L !== "\r")
  ...
  function ee(d, b) {
    ...
    if (d.char() === "[") {
      d.skip(1);
      for (var M = d.getIndex(); d.getIndex() < C.length; ) {
        if (d.skipBlanks(), d.char() === "]") {
          var A = C.substring(M, d.getIndex());
          return d.skip(1), A;
        }
        var B = null;
        if (d.char() === "<" && d.char(1) === "!")
        ...
        if (!B)
          return b.fatalError("Error in internal subset at position " + d.getIndex());
      }
      return b.fatalError("doctype internal subset is not well-formed, missing ]");
    }
  }
  function Ie(d, b, w, C, M) {
    var A = K(d, b);
    switch (M ? A.char(2).toUpperCase() : A.char(2)) {
      ...
      case "[":
        ...
        return X ? !M && !w.currentElement ? C.fatalError("CDATA outside of element") : (w.startCDATA(), w.characters(X, e.CDATA_START.length, X.length - e.CDATA_START.length - e.CDATA_END.length), w.endCDATA(), A.getIndex()) : C.fatalError("Invalid CDATA starting at position " + b);
      case "D": {
  ...
  function te(d, b, w, C) {
    var M = d.substring(b).match(e.PI);
    if (!M)
    ...
    if (M[1].toLowerCase() === "xml") {
      ...
      if (!e.XMLDecl.test(d.substring(b)))
  ...
  return Be.prototype = {
    ...
    addValue: function(d, b, w) {
      if (!e.QName_exact.test(d))
        throw new Error("invalid attribute:" + d);
      this.attributeNames[d] = this.length, this[this.length++] = { qName: d, value: b, offset: w };
    },
    length: 0,
    ...
    //	getType:function(i){},
  }, Ct.XMLReader = F, Ct.parseUtils = K, Ct.parseDoctypeCommentOrCData = Ie, Ct;
}
var ar;
function Nn() {
  if (ar) return rt;
  ar = 1;
  var t = Dt(), e = Fr(), n = _t(), i = An(), o = bn(), a = e.DOMImplementation, h = t.hasDefaultHTMLNamespace, p = t.isHTMLMimeType, f = t.isValidMimeType, m = t.MIME_TYPE, g = t.NAMESPACE, l = n.ParseError, v = o.XMLReader;
  function O(E) {
    return E.replace(/\r[\n\u0085]/g, `
`).replace(/[\r\u0085\u2028\u2029]/g, `
`);
  ...
  N.prototype.parseFromString = function(E, x) {
    ...
    var k = this.assign(/* @__PURE__ */ Object.create(null), this.xmlns), z = i.XML_ENTITIES, K = k[""] || null;
    h(x) ? (z = i.HTML_ENTITIES, K = g.HTML) : x === m.XML_SVG_IMAGE && (K = g.SVG), k[""] = K, k.xml = k.xml || g.XML;
  ...
  y.prototype = {
    ...
    startDocument: function() {
      var E = new a();
      this.doc = p(this.mimeType) ? E.createHTMLDocument(!1) : E.createDocument(this.defaultNamespace, "");
    },
    startElement: function(E, x, k, z) {
      var K = this.doc, ee = K.createElementNS(E, k || x), Ie = z.length;
      j(this, ee), this.currentElement = ee, this.locator && U(this.locator, ee);
      for (var te = 0; te < Ie; te++) {
        var E = z.getURI(te), Be = z.getValue(te), k = z.getQName(te), d = K.createAttributeNS(E, k);
        this.locator && U(z.getLocator(te), d), d.value = d.nodeValue = Be, ee.setAttributeNode(d);
      }
    },
    ...
    processingInstruction: function(E, x) {
      ...
      this.locator && U(this.locator, k), j(this, k);
    },
    ...
    characters: function(E, x, k) {
      if (E = F.apply(this, arguments), E) {
        ...
        this.currentElement ? this.currentElement.appendChild(z) : /^\s*$/.test(E) && this.doc.appendChild(z), this.locator && U(this.locator, z);
      }
    },
    ...
    comment: function(E, x, k) {
      ...
      this.locator && U(this.locator, z), j(this, z);
    },
    startCDATA: function() {
      this.cdata = !0;
    },
    ...
    startDTD: function(E, x, k, z) {
      ...
      if (K && K.createDocumentType) {
        var ee = K.createDocumentType(E, x, k, z);
        this.locator && U(this.locator, ee), j(this, ee), this.doc.doctype = ee;
      }
    },
...
@#[line:` + E.lineNumber + ",col:" + E.columnNumber + "]";
  ...
  return rt.__DOMHandler = y, rt.DOMParser = N, rt.normalizeLineEndings = O, rt.onErrorStopParsing = ne, rt.onWarningStopParsing = le, rt;
}
var sr;
function yn() {
  if (sr) return H;
...
function Cn() {
  return cr || (cr = 1, $t = () => {
    const t = "\\ud800-\\udfff", h = "\\u0300-\\u036f" + "\\ufe20-\\ufe2f" + "\\u20d0-\\u20ff" + "\\u1ab0-\\u1aff" + "\\u1dc0-\\u1dff", p = "\\ufe0e\\ufe0f", f = "\\uD83D\\uDC69\\uD83C\\uDFFB\\u200D\\uD83C\\uDF93", m = `[${t}]`, g = `[${h}]`, l = "\\ud83c[\\udffb-\\udfff]", v = `(?:${g}|${l})`, O = `[^${t}]`, N = "(?:\\uD83C[\\uDDE6-\\uDDFF]){2}", y = "[\\ud800-\\udbff][\\udc00-\\udfff]", U = "\\u200d", R = "(?:\\ud83c\\udff4\\udb40\\udc67\\udb40\\udc62\\udb40(?:\\udc65|\\udc73|\\udc77)\\udb40(?:\\udc6e|\\udc63|\\udc6c)\\udb40(?:\\udc67|\\udc74|\\udc73)\\udb40\\udc7f)", F = `[${f}]`, j = `${v}?`, ne = `[${p}]?`, le = `(?:${U}(?:${[O, N, y].join("|")})${ne + j})*`, E = ne + j + le, k = `(?:${[`${O}${g}?`, g, N, y, m, F].join("|")})`;
...
function Tn() {
  ...
  function o(f, m, g) {
    if (m === void 0 && (m = 0), typeof f != "string")
      throw new Error("Input must be a string");
    (typeof m != "number" || m < 0) && (m = 0), typeof g == "number" && g < 0 && (g = 0);
    var l = f.match(e.default());
    return l ? l.slice(m, g).join("") : "";
  }
  xe.substring = o;
  function a(f, m, g) {
    if (m === void 0 && (m = 0), typeof f != "string")
    ...
    m < 0 && (m += l);
    var v;
    typeof g > "u" ? v = l : (typeof g != "number" && (g = parseInt(g, 10)), v = g >= 0 ? g + m : m);
    var O = f.match(e.default());
    return O ? O.slice(m, v).join("") : "";
  }
  xe.substr = a;
  function h(f, m, g, l) {
    if (m === void 0 && (m = 16), g === void 0 && (g = "#"), l === void 0 && (l = "right"), typeof f != "string" || typeof m != "number")
  ...
  function p(f, m, g) {
    ...
    if (f === "")
      return m === "" ? 0 : -1;
    g = Number(g), g = isNaN(g) ? 0 : g, m = String(m);
    var l = n(f);
    if (g >= l.length)
      return m === "" ? l.length : -1;
    if (m === "")
...
function On(t, e) {
  ...
  let i = 0, o = 0;
  function a(p, f, m) {
    const g = ut(t, o, f), l = n.length > 0 && Me(n[n.length - 1]) ? `${n.pop()}${g}` : g;
  ...
  if (o < h) {
    const p = ut(t, o);
    n.push(
      n.length > 0 && Me(n[n.length - 1]) ? `${n.pop()}${p}` : p
    );
  }
  return n;
}
...
function hr(t, e, n) {
  ...
  if (n !== void 0 && n <= 0)
    return [t];
  if (e === "") return Mn(t).slice(0, n);
  let o = e;
  (typeof e == "string" || e instanceof RegExp && !In(e.flags, "g")) && (o = new RegExp(e, "g"));
  const a = t.match(o);
  let h = 0;
  if (!a) return [t];
...
const jt = ["chapter", "book", "para", "row", "sidebar", Ut], Rn = "​", Ur = [
...
], _n = 1, Pn = Ur.length - 1, Ln = 1, kn = 1, di = {
  book: "GEN",
  chapterNum: 1,
  verseNum: 1
}, Fn = (t) => {
  ...
  book: Ne.bookNumberToId(
    Math.max(
      _n,
      Math.min(Ne.bookIdToNumber(t.book) + e, Pn)
    )
  ),
  chapterNum: 1,
  verseNum: 1
  ...
  chapterNum: Math.min(
    ...
    Fn(Ne.bookIdToNumber(t.book))
  ),
  verseNum: 1
}), Ei = (t, e) => ({
  ...t,
  verseNum: Math.max(kn, t.verseNum + e)
});
...
function gr(t) {
  ...
  for (let o = 0; o < t.length; o += 1) {
    const a = t[o];
    a.charCodeAt(0) < 32 ? (n || (e += " "), n = !0) : !n && a === Rn && o + 1 < t.length && mr(t[o + 1]) || (mr(a) ? (n || (e += a), n = !0) : jn(a) && i === a || (e += a, n = !1)), i = a;
  }
  return e;
}
function Er(t) {
...
function jr(t, e, n, i) {
  ...
  if (o && a) {
    ...
    const m = Er(h.content), g = Er(p.content);
    if (m !== g) return !1;
    if (!m && !g) {
      ...
      if (jt.includes(p.type) && Me(N) && mt(N) && (v = v.slice(0, -1)), l.length !== v.length) return !1;
...
const Ci = (t) => (...e) => t.map((i) => i(...e)).every((i) => i), Ti = (t) => async (...e) => {
  const n = t.map(async (i) => i(...e));
  return (await Promise.all(n)).every((i) => i);
}, Mt = "chapter", Bt = "verse";
var Vn = Object.getOwnPropertyNames, zn = Object.getOwnPropertySymbols, Gn = Object.prototype.hasOwnProperty;
function vr(t, e) {
...
function Ar(t) {
  return Vn(t).concat(zn(t));
}
var Hn = Object.hasOwn || function(t, e) {
  return Gn.call(t, e);
};
function at(t, e) {
  return t === e || !t && !e && t !== t && e !== e;
}
var Xn = "__v", Jn = "__o", Yn = "_owner", br = Object.getOwnPropertyDescriptor, Nr = Object.keys;
function Wn(t, e, n) {
  var i = t.length;
  if (e.length !== i)
    return !1;
...
function yr(t, e, n) {
  ...
  for (var o = new Array(i), a = t.entries(), h, p, f = 0; (h = a.next()) && !h.done; ) {
    for (var m = e.entries(), g = !1, l = 0; (p = m.next()) && !p.done; ) {
      if (o[l]) {
        l++;
        continue;
      }
...
function Tt(t, e, n) {
  ...
  if (Ar(e).length !== o)
    return !1;
  for (var a, h, p; o-- > 0; )
    if (a = i[o], !Vr(t, e, n, a) || (h = br(t, a), p = br(e, a), (h || p) && (!h || !p || h.configurable !== p.configurable || h.enumerable !== p.enumerable || h.writable !== p.writable)))
      return !1;
  return !0;
}
function ru(t, e) {
...
function Cr(t, e, n) {
  ...
  for (var o = new Array(i), a = t.values(), h, p; (h = a.next()) && !h.done; ) {
    for (var f = e.values(), m = !1, g = 0; (p = f.next()) && !p.done; ) {
      if (!o[g] && n.equals(h.value, p.value, h.value, p.value, t, e, n)) {
        m = o[g] = !0;
        break;
      }
      g++;
...
function Vr(t, e, n, i) {
  return (i === Yn || i === Jn || i === Xn) && (t.$$typeof || e.$$typeof) ? !0 : Hn(e, i) && n.equals(t[i], e[i], i, i, t, e, n);
}
var ou = "[object Arguments]", au = "[object Boolean]", su = "[object Date]", cu = "[object Error]", lu = "[object Map]", fu = "[object Number]", pu = "[object Object]", hu = "[object RegExp]", du = "[object Set]", mu = "[object String]", gu = "[object URL]", Eu = Array.isArray, Tr = typeof ArrayBuffer == "function" && ArrayBuffer.isView ? ArrayBuffer.isView : null, wr = Object.assign, Du = Object.prototype.toString.call.bind(Object.prototype.toString);
function vu(t) {
  var e = t.areArraysEqual, n = t.areDatesEqual, i = t.areErrorsEqual, o = t.areFunctionsEqual, a = t.areMapsEqual, h = t.areNumbersEqual, p = t.areObjectsEqual, f = t.arePrimitiveWrappersEqual, m = t.areRegExpsEqual, g = t.areSetsEqual, l = t.areTypedArraysEqual, v = t.areUrlsEqual;
  return function(N, y, U) {
    if (N === y)
      return !0;
    if (N == null || y == null)
      return !1;
    ...
    if (R !== typeof y)
      return !1;
    if (R !== "object")
      return R === "number" ? h(N, y, U) : R === "function" ? o(N, y, U) : !1;
    var F = N.constructor;
    if (F !== y.constructor)
      return !1;
    if (F === Object)
    ...
    if (F === Set)
      return g(N, y, U);
    var j = Du(N);
    return j === su ? n(N, y, U) : j === hu ? m(N, y, U) : j === lu ? a(N, y, U) : j === du ? g(N, y, U) : j === pu ? typeof N.then != "function" && typeof y.then != "function" && p(N, y, U) : j === gu ? v(N, y, U) : j === cu ? i(N, y, U) : j === ou ? p(N, y, U) : j === au || j === fu || j === mu ? f(N, y, U) : !1;
  };
}
function Au(t) {
...
function Nu(t) {
  ...
  if (i)
    return function(f, m) {
      var g = i(), l = g.cache, v = l === void 0 ? e ? /* @__PURE__ */ new WeakMap() : void 0 : l, O = g.meta;
      return n(f, m, {
        cache: v,
        equals: o,
        meta: O,
...
function Ge(t) {
  t === void 0 && (t = {});
  var e = t.circular, n = e === void 0 ? !1 : e, i = t.createInternalComparator, o = t.createState, a = t.strict, h = a === void 0 ? !1 : a, p = Au(t), f = vu(p), m = i ? i(f) : bu(f);
...
function Tu(t, e) {
  ...
  return Object.keys(n).forEach((a) => {
    o && (Object.hasOwn(i, a) && Tu(i[a], n[a]) || (o = !1));
  }), o;
}
function Sr(t, e, n) {
...
const Si = (t) => t.replace(/&/g, "&amp;").replace(/</g, "&lt;").replace(/>/g, "&gt;").replace(/"/g, "&quot;").replace(/'/g, "&#x27;").replace(/\//g, "&#x2F;");
function Oi() {
  return typeof navigator < "u" && navigator.languages ? navigator.languages[0] : new Kr().resolvedOptions().locale;
}
function Ii(t, e = 2) {
...
const Su = 1e3, zr = 60, Gr = zr * 60, Ou = Gr * 24;
function xi(t, e, n = /* @__PURE__ */ new Date()) {
  const i = Math.floor((e.getTime() - n.getTime()) / Su), o = Math.round(i / Ou);
  if (Math.abs(o) >= 1) return t.format(o, "day");
  const a = Math.round(i / Gr);
  if (Math.abs(a) >= 1) return t.format(a, "hour");
  const h = Math.round(i / zr);
...
const Xr = {
  ...
  themeDefinitionPartial: {
    description: "The data an extension provides for one theme. An extension can provide multiple themes with {@link ThemeContribution}. This is then modified to `ThemeDefinition` for use throughout the application.",
    type: "object",
    properties: {
      id: {
        description: "Programmatic name for the theme. Will be converted to kebab-case as this will be used as the class name in the HTML document.\n\nIf `type` is not specified, it will be determined by whether this ends with `-dark`.",
        type: "string"
      },
      type: {
        description: "What kind of theme this is. Some UI elements use this to determine how to look. Colors not present in the theme will fall back to the built-in colors for this type. This theme may be paired to a theme of the opposite type (light/dark) by `id` for quick theme switching. For example, `id: 'my-theme'` and `id: 'my-theme-dark'` would be paired together.\n\nIf this is not specified, it will be determined by whether `id` ends with `-dark`.",
        type: "string",
        enum: ["light", "dark"]
      },
      label: {
...
Object.freeze(Ru);
const Mi = "-light", Bi = "-dark", _u = "theme-styles";
function Pu(t) {
  return `
.${t.id} {
...
function Ri(t, e, n) {
  ...
  return o.id = `${_u}${n ? `-${n}` : ""}`, o.dataset.themeId = t.id, o.textContent = Pu(t), this.document.head.appendChild(o), o;
}
...
class ge {
  ...
  findVerseRefForNode(e, n, i = {
    ...
    const h = n.content[a], p = ge.findRightMostDescendantMarkerObject(
      h,
      n,
      Ue
    );
  ...
  nodeToVerseRefAndOffset(e, n, i) {
    ...
    return a.startingContentNode !== void 0 && this.findNextMatchingNode(a.startingContentNode, [], (f, m) => {
      var g, l;
      return f === n ? !0 : m.find((v) => Ue.includes(v.parent.type)) ? !1 : typeof f == "string" ? (p += f.length, !1) : f.type === Mt && f.number !== ((g = a.chapterNum) == null ? void 0 : g.toString()) || f.type === Bt && f.number !== ((l = a.verseNum) == null ? void 0 : l.toString()) ? (p = 0, !0) : !1;
    }), { verseRef: h, offset: p };
  }
  // #endregion
  ...
  verseRefToUsjContentLocation(e, n = 0) {
    ...
    const p = e.verse ?? e.verseNum.toString(), f = this.findNextMatchingNode(
      o,
      Ue,
      (v, O) => v === o ? e.verseNum === 0 ? (h = ge.convertWorkingStackToJsonPath(O), !0) : !1 : typeof v != "object" ? !1 : v.type === Mt ? (a = !0, !0) : v.type === Bt && v.number !== void 0 && v.number === p ? (h = ge.convertWorkingStackToJsonPath(O), !0) : !1
    );
    ...
    return this.findNextMatchingNode(
      ...
      (v, O) => {
        ...
        if (typeof v == "string") {
          if (m += v.length, m > n)
            return h = ge.convertWorkingStackToJsonPath(O), g = n - m + v.length, l = v, !0;
        } else if (v.type === Mt || v.type === Bt) return !0;
        return !1;
      }
    ), { node: l ?? f, offset: g, jsonPath: h };
  }
  // #endregion
  ...
  findNextLocationOfMatchingText(e, n, i = 1e3) {
    ...
    return {
      node: g,
      offset: f,
      jsonPath: ge.convertWorkingStackToJsonPath(m)
    };
  }
  // #endregion
  ...
  extractTextBetweenPoints(e, n, i = 100) {
    ...
    return ge.findNextMatchingNodeUsingWorkingStack(
      ...
      this.convertJsonPathToWorkingStack(e.jsonPath),
      Ue,
      (a, h) => a === n.node && (typeof a == "object" || n.jsonPath === ge.convertWorkingStackToJsonPath(h)) ? !0 : typeof a != "string" ? !1 : (o = `${o}${a}`, o.length > i && (o = o.substring(0, i)), o.length >= i)
    ), o;
  }
  // #endregion
...
export {
  ...
  Mt as CHAPTER_TYPE,
  $u as Collator,
  Kr as DateTimeFormat,
  rn as DocumentCombiner,
  Yu as EventRollingTimeCounter,
  _n as FIRST_SCR_BOOK_NUM,
  Ln as FIRST_SCR_CHAPTER_NUM,
  kn as FIRST_SCR_VERSE_NUM,
  Pn as LAST_SCR_BOOK_NUM,
  un as Mutex,
  Wu as MutexMap,
  Ku as NonValidatingDocumentCombiner,
  on as NumberFormat,
  It as PLATFORM_ERROR_VERSION,
  Qr as PlatformEventEmitter,
  Qu as PromiseChainingMap,
  _u as THEME_STYLE_ELEMENT_ID,
  Bi as THEME_SUFFIX_DARK,
  Mi as THEME_SUFFIX_LIGHT,
  Zu as UnsubscriberAsyncList,
  ge as UsjReaderWriter,
  Bt as VERSE_TYPE,
  Ti as aggregateUnsubscriberAsyncs,
  Ci as aggregateUnsubscribers,
  Ri as applyThemeStylesheet,
  yi as areUsjContentsEqualExceptWhitespace,
  xt as at,
  gt as charAt,
  ni as codePointAt,
  Ai as compareScrRefs,
  Hu as createSyncProxyForAsyncObject,
  ju as debounce,
  wt as deepClone,
  Cu as deepEqual,
  di as defaultScrRef,
  ...
  wn as endsWith,
  qr as ensureArray,
  li as escapeStringRegexp,
  Ii as formatBytes,
  ui as formatReplacementString,
  On as formatReplacementStringToArray,
  Ni as formatScrRef,
  xi as formatTimeSpan,
  Gu as getAllObjectFunctionNames,
  Fn as getChaptersForBook,
  Oi as getCurrentLocale,
  ...
  Pu as getStylesheetForTheme,
  Vu as groupBy,
  Si as htmlEncode,
  In as includes,
  St as indexOf,
  Xu as isErrorMessageAboutParatextBlockingInternetAccess,
  Ju as isErrorMessageAboutRegistryAuthFailure,
  ci as isLocalizeKey,
  ti as isPlatformError,
  wi as isSerializable,
  Me as isString,
  Tu as isSubset,
  mt as isWhiteSpace,
  xn as lastIndexOf,
  Mu as localizedStringsDocumentSchema,
  Bu as menuDocumentSchema,
  Uu as newGuid,
  ei as newPlatformError,
  ii as normalize,
  ...
  vi as scrRefToBBBCCC,
  dr as scrRefToBBBCCCVVV,
  Sr as serialize,
  xu as settingsDocumentSchema,
  pr as slice,
  hr as split,
  $r as startsWith,
  ce as stringLength,
  ut as substring,
  Ru as themeDocumentSchema,
  Mn as toArray,
  hi as toKebabCase,
  pi as transformAndEnsureRegExpArray,
  fi as transformAndEnsureRegExpRegExpArray,
  tn as wait,
  zu as waitForDuration
};
