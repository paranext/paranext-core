...
var Wr = (t, e, r) => e in t ? Kr(t, e, { enumerable: !0, configurable: !0, writable: !0, value: r }) : t[e] = r;
var G = (t, e, r) => Wr(t, typeof e != "symbol" ? e + "" : e, r);
import { Mutex as Qr } from "async-mutex";
...
class un {
  ...
  constructor(e, r) {
    ...
    G(this, "latestOutput");
    G(this, "options");
    G(this, "onDidRebuildEmitter", new en());
...
class ti {
  ...
  get(e) {
    ...
    return r || (r = new an(), this.mutexesByID.set(e, r), r);
  }
}
class ri extends un {
...
class ni {
  ...
  cleanupPromiseChain(e) {
    ...
    if (!r) return;
    const u = { promise: cn }, o = r.catch((a) => this.logger.warn(`Error in promise for ${e}: ${a.message}`)).finally(() => {
...
var fn = Object.defineProperty, hn = (t, e, r) => e in t ? fn(t, e, { enumerable: !0, configurable: !0, writable: !0, value: r }) : t[e] = r, z = (t, e, r) => hn(t, typeof e != "symbol" ? e + "" : e, r);
const it = [
  "GEN",
  "EXO",
  "LEV",
...
function Pr(t) {
  const e = typeof t == "number" ? zt(t) : t;
...
const ee = {
  ...
  extraBooks: Dn,
  bookNumberToId: zt,
  bookNumberToEnglishName: Lr,
  bookIdToEnglishName: vn,
  isCanonical: Pr,
  isExtraMaterial: An,
  isObsolete: bn
};
...
z(Te, "Original", new Te(Pe.Original)), z(Te, "Septuagint", new Te(Pe.Septuagint)), z(Te, "Vulgate", new Te(Pe.Vulgate)), z(Te, "English", new Te(Pe.English)), z(Te, "RussianProtestant", new Te(Pe.RussianProtestant)), z(Te, "RussianOrthodox", new Te(Pe.RussianOrthodox));
let nt = Te;
function rr(t, e) {
  const r = e[0];
...
const ve = class K {
  constructor(e, r, u, o) {
    if (z(this, "firstChapter"), z(this, "lastChapter"), z(this, "lastVerse"), z(this, "hasSegmentsDefined"), z(this, "text"), z(this, "BBBCCCVVVS"), z(this, "longHashCode"), z(this, "versification"), z(this, "rtlMark", "‏"), z(this, "_bookNum", 0), z(this, "_chapterNum", 0), z(this, "_verseNum", 0), z(this, "_verse"), u == null && o == null)
...
z(ve, "defaultVersification", nt.English), z(ve, "verseRangeSeparator", "-"), z(ve, "verseSequenceIndicator", ","), z(ve, "verseRangeSeparators", [ve.verseRangeSeparator]), z(ve, "verseSequenceIndicators", [ve.verseSequenceIndicator]), z(ve, "chapterDigitShifter", 1e3), z(ve, "bookDigitShifter", ve.chapterDigitShifter * ve.chapterDigitShifter), z(ve, "bcvMaxValue", ve.chapterDigitShifter - 1), /**
* The valid status of the VerseRef.
*/
z(ve, "ValidStatusType", kr);
let Fr = ve, yt = class extends Error {
};
var J = {}, le = {}, nr;
function Dt() {
  if (nr) return le;
...
function qr() {
  ...
  var C = r(v), b = o("[", C, r(/[-.0-9\xB7]/), r(/[\u0300-\u036F\u203F-\u2040]/), "]"), y = o(v, b, "*"), q = o(b, "+"), B = o("&", y, ";"), F = a(/&#[0-9]+;|&#x[0-9a-fA-F]+;/), U = a(B, "|", F), ue = o("%", y, ";"), he = a(
    o('"', a(/[^%&"]/, "|", ue, "|", U), "*", '"'),
    "|",
    o("'", a(/[^%&']/, "|", ue, "|", U), "*", "'")
  ), E = a('"', a(/[^<&"]/, "|", U), "*", '"', "|", "'", a(/[^<&']/, "|", U), "*", "'"), x = u(v, ":"), k = u(b, ":"), H = o(x, k, "*"), W = o(H, a(":", H), "?"), te = o("^", W, "$"), Ie = o("(", W, ")"), re = a(/"[^"]*"|'[^']*'/), Be = o(/^<\?/, "(", y, ")", a(m, "(", h, "*?)"), "?", /\?>/), g = /[\x20\x0D\x0Aa-zA-Z0-9-'()+,./:=?;!*#@$_%]/, N = a('"', g, '*"', "|", "'", u(g, "'"), "*'"), S = "<!--", T = "-->", M = o(S, a(u(h, "-"), "|", o("-", u(h, "-"))), "*", T), A = "#PCDATA", R = a(
    o(/\(/, l, A, a(l, /\|/, l, W), "*", l, /\)\*/),
    "|",
    o(/\(/, l, A, l, /\)/)
  ), X = /[?*+]?/, _ = o(
  ...
  ), w = a("EMPTY", "|", "ANY", "|", R, "|", _), I = "<!ELEMENT", P = o(I, m, a(W, "|", ue), m, a(w, "|", ue), l, ">"), V = o("NOTATION", m, /\(/, l, y, a(l, /\|/, l, y), "*", l, /\)/), pe = o(/\(/, l, q, a(l, /\|/, l, q), "*", l, /\)/), we = a(V, "|", pe), Ae = a(/CDATA|ID|IDREF|IDREFS|ENTITY|ENTITIES|NMTOKEN|NMTOKENS/, "|", we), ae = a(/#REQUIRED|#IMPLIED/, "|", a(a("#FIXED", m), "?", E)), L = a(m, y, m, Ae, m, ae), Ue = "<!ATTLIST", Re = o(Ue, m, y, L, "*", l, ">"), de = "about:legacy-compat", Ve = a('"' + de + '"', "|", "'" + de + "'"), _e = "SYSTEM", Se = "PUBLIC", ke = a(a(_e, m, re), "|", a(Se, m, N, m, re)), ze = o(
    "^",
    a(
      a(_e, m, "(?<SystemLiteralOnly>", re, ")"),
      "|",
      a(Se, m, "(?<PubidLiteral>", N, ")", m, "(?<SystemLiteral>", re, ")")
    )
  ), Je = a(m, "NDATA", m, y), ye = a(he, "|", a(ke, Je, "?")), Q = "<!ENTITY", Ge = o(Q, m, y, m, ye, l, ">"), se = a(he, "|", ke), Xe = o(Q, m, "%", m, y, m, se, l, ">"), vt = a(Ge, "|", Xe), Ye = o(Se, m, N), Ke = o("<!NOTATION", m, y, m, a(ke, "|", Ye), l, ">"), $ = o(l, "=", l), Z = /1[.]\d+/, be = o(m, "version", $, a("'", Z, "'", "|", '"', Z, '"')), Ne = /[A-Za-z][-A-Za-z0-9._]*/, We = a(m, "encoding", $, a('"', Ne, '"', "|", "'", Ne, "'")), st = a(m, "standalone", $, a("'", a("yes", "|", "no"), "'", "|", '"', a("yes", "|", "no"), '"')), ct = o(/^<\?xml/, be, We, "?", st, "?", l, /\?>/), lt = "<!DOCTYPE", At = "<![CDATA[", bt = "]]>", ft = /<!\[CDATA\[/, Qe = /\]\]>/, ht = o(h, "*?", Qe), It = o(ft, ht);
  return j.chars = r, j.chars_without = u, j.detectUnicodeSupport = t, j.reg = o, j.regg = a, j.ABOUT_LEGACY_COMPAT = de, j.ABOUT_LEGACY_COMPAT_SystemLiteral = Ve, j.AttlistDecl = Re, j.CDATA_START = At, j.CDATA_END = bt, j.CDSect = It, j.Char = h, j.Comment = M, j.COMMENT_START = S, j.COMMENT_END = T, j.DOCTYPE_DECL_START = lt, j.elementdecl = P, j.EntityDecl = vt, j.EntityValue = he, j.ExternalID = ke, j.ExternalID_match = ze, j.Name = y, j.NotationDecl = Ke, j.Reference = U, j.PEReference = ue, j.PI = Be, j.PUBLIC = Se, j.PubidLiteral = N, j.QName = W, j.QName_exact = te, j.QName_group = Ie, j.S = m, j.SChar_s = d, j.S_OPT = l, j.SYSTEM = _e, j.SystemLiteral = re, j.UNICODE_REPLACEMENT_CHARACTER = p, j.UNICODE_SUPPORT = e, j.XMLDecl = ct, j;
}
var or;
function $r() {
  if (or) return ne;
  or = 1;
  var t = Dt(), e = t.find, r = t.hasDefaultHTMLNamespace, u = t.hasOwn, o = t.isHTMLMimeType, a = t.isHTMLRawTextElement, p = t.isHTMLVoidElement, h = t.MIME_TYPE, f = t.NAMESPACE, d = Symbol(), m = Lt(), l = m.DOMException, v = m.DOMExceptionName, C = qr();
  function b(n) {
    if (n !== d)
  ...
  var k = {}, H = k.ELEMENT_NODE = 1, W = k.ATTRIBUTE_NODE = 2, te = k.TEXT_NODE = 3, Ie = k.CDATA_SECTION_NODE = 4, re = k.ENTITY_REFERENCE_NODE = 5, Be = k.ENTITY_NODE = 6, g = k.PROCESSING_INSTRUCTION_NODE = 7, N = k.COMMENT_NODE = 8, S = k.DOCUMENT_NODE = 9, T = k.DOCUMENT_TYPE_NODE = 10, M = k.DOCUMENT_FRAGMENT_NODE = 11, A = k.NOTATION_NODE = 12, R = t.freeze({
  ...
  L.prototype = {
    ...
    compareDocumentPosition: function(n) {
      ...
      for (var ce = [], ge = i.parentNode; ge; ) {
        if (!D && ge === s)
          return R.DOCUMENT_POSITION_CONTAINED_BY + R.DOCUMENT_POSITION_FOLLOWING;
        ce.push(ge), ge = ge.parentNode;
      }
      ce.reverse();
  ...
  E(k, L), E(k, L.prototype), E(R, L), E(R, L.prototype);
  function Re(n, i) {
    if (i(n))
      return !0;
    if (n = n.firstChild)
  ...
  de.prototype = {
    ...
    insertBefore: function(n, i) {
      ...
      return $(this, n, i), n.ownerDocument = this, this.documentElement === null && n.nodeType === H && (this.documentElement = n), n;
    },
    removeChild: function(n) {
      var i = ke(this, n);
    ...
    getElementById: function(n) {
      ...
      return Re(this.documentElement, function(s) {
        if (s.nodeType == H && s.getAttribute("id") == n)
          return i = s, !0;
      }), i;
    },
    /**
    ...
    getElementsByTagNameNS: function(n, i) {
      return new I(this, function(s) {
        ...
        return Re(s, function(D) {
          D !== s && D.nodeType === H && (n === "*" || D.namespaceURI === n) && (i === "*" || D.localName == i) && c.push(D);
        }), c;
      });
    }
  ...
  be.prototype.nodeType = W, x(be, L);
  function Ne(n) {
    b(n);
  }
  Ne.prototype = {
  ...
  bt.prototype.nodeType = Be, x(bt, L);
  function ft(n) {
    b(n);
  }
  ...
  function qe(n, i, s, c) {
    ...
    switch (n.nodeType) {
      case H:
        var Y = n.attributes, ce = Y.length, Ee = n.firstChild, ge = n.tagName, Ce = ge;
        ...
        for (var et = 0; et < ce; et++) {
          var Le = Y.item(et);
          if (me(Le, O, c)) {
            var tt = Le.prefix || "", Nt = Le.namespaceURI;
  ...
  function Ft(n, i, s) {
    ...
    switch (i.childNodes && (c.childNodes = new w()), c.ownerDocument = n, c.nodeType) {
      case H:
        var Y = i.attributes, ce = c.attributes = new V(), ge = Y.length;
        ce._ownerElement = c;
  ...
  return ne._updateLiveList = P, ne.Attr = be, ne.CDATASection = ct, ne.CharacterData = Ne, ne.Comment = st, ne.Document = de, ne.DocumentFragment = Qe, ne.DocumentType = lt, ne.DOMImplementation = ae, ne.Element = Z, ne.Entity = bt, ne.EntityReference = ft, ne.LiveNodeList = I, ne.NamedNodeMap = V, ne.Node = L, ne.NodeList = w, ne.Notation = At, ne.Text = We, ne.ProcessingInstruction = ht, ne.XMLSerializer = It, ne;
}
var rt = {}, $t = {}, ar;
function yn() {
...
function Cn() {
  if (sr) return Ct;
  sr = 1;
  var t = Dt(), e = qr(), r = Lt(), u = t.isHTMLEscapableRawTextElement, o = t.isHTMLMimeType, a = t.isHTMLRawTextElement, p = t.hasOwn, h = t.NAMESPACE, f = r.ParseError, d = r.DOMException, m = 0, l = 1, v = 2, C = 3, b = 4, y = 5, q = 6, B = 7;
  function F() {
  }
  F.prototype = {
    parse: function(g, N, S) {
      var T = this.domBuilder;
      T.startDocument(), H(N, N = /* @__PURE__ */ Object.create(null)), ue(g, N, S, T, this.errorHandler), T.endDocument();
    }
  };
  var U = /&#?\w+;?/g;
  function ue(g, N, S, T, M) {
    var A = o(T.mimeType);
    ...
    function _($) {
      if ($ > ae) {
        var Z = g.substring(ae, $).replace(U, X);
    ...
    for (var we = [{ currentNSMap: N }], Ae = [], ae = 0; ; ) {
      try {
        var L = g.indexOf("<", ae);
        if (L < 0) {
          if (!A && Ae.length > 0)
            return M.fatalError("unclosed xml tag(s): " + Ae.join(", "));
          if (!g.substring(ae).match(/^\s*$/)) {
            var Ue = T.doc, Re = Ue.createTextNode(g.substring(ae));
        ...
        switch (g.charAt(L + 1)) {
          ...
          // end element
          case "?":
            V && pe(L), se = re(g, L, T, M);
            break;
          case "!":
            V && pe(L), se = Ie(g, L, T, M, A);
            break;
          default:
            V && pe(L);
            var Q = new Be(), Ge = we[we.length - 1].currentNSMap, se = E(g, L, Q, Ge, X, M, A), Xe = Q.length;
            if (Q.closed || (A && t.isHTMLVoidElement(Q.tagName) ? Q.closed = !0 : Ae.push(Q.tagName)), V && Xe) {
              ...
              x(Q, T, Ge) && we.push(Q);
            A && !Q.closed ? se = k(g, se, Q.tagName, X, T) : se++;
        }
      } catch ($) {
        if ($ instanceof f)
          throw $;
  ...
  function E(g, N, S, T, M, A, R) {
    ...
    for (var _, w, I = ++N, P = m; ; ) {
      ...
      switch (V) {
        ...
        case '"':
          if (P === C || P === l)
            if (P === l && (A.warning('attribute value must after "="'), _ = g.slice(N, I)), N = I + 1, I = g.indexOf(V, N), I > 0)
              w = g.slice(N, I), X(_, w, N - 1), P = y;
            else
              throw new Error("attribute value no end '" + V + "' match");
          else if (P == b)
            w = g.slice(N, I), X(_, w, N), A.warning('attribute "' + _ + '" missed start quot(' + V + ")!!"), N = I + 1, P = y;
          else
        ...
        case "/":
          ...
          break;
        case "":
          return A.error("unexpected end of input"), P == m && S.setTagName(g.slice(N, I)), I;
        case ">":
          switch (P) {
            case m:
              S.setTagName(g.slice(N, I));
            ...
            case v:
              P === v && (w = _), P == b ? (A.warning('attribute "' + w + '" missed quot(")!'), X(_, w, N)) : (R || A.warning('attribute "' + w + '" missed value!! "' + w + '" instead!!'), X(w, w, N));
              break;
            case C:
              if (!R)
        ...
        default:
          if (V <= " ")
            ...
            switch (P) {
              ...
              case v:
                R || A.warning('attribute "' + _ + '" missed value!! "' + _ + '" instead2!!'), X(_, _, N), N = I, P = l;
                break;
              case y:
  ...
  function x(g, N, S) {
    for (var T = g.tagName, M = null, P = g.length; P--; ) {
      var A = g[P], R = A.qName, X = A.value, V = R.indexOf(":");
      if (V > 0)
        var _ = A.prefix = R.slice(0, V), w = R.slice(V + 1), I = _ === "xmlns" && w;
      else
        w = R, _ = null, I = R === "xmlns" && "";
      A.localName = w, I !== !1 && (M == null && (M = /* @__PURE__ */ Object.create(null), H(S, S = /* @__PURE__ */ Object.create(null))), S[I] = M[I] = X, A.uri = h.XMLNS, N.startPrefixMapping(I, X));
    }
    for (var P = g.length; P--; )
      A = g[P], A.prefix && (A.prefix === "xml" && (A.uri = h.XML), A.prefix !== "xmlns" && (A.uri = S[A.prefix]));
    var V = T.indexOf(":");
...
function Tn() {
  if (cr) return rt;
  cr = 1;
  var t = Dt(), e = $r(), r = Lt(), u = yn(), o = Cn(), a = e.DOMImplementation, p = t.hasDefaultHTMLNamespace, h = t.isHTMLMimeType, f = t.isValidMimeType, d = t.MIME_TYPE, m = t.NAMESPACE, l = r.ParseError, v = o.XMLReader;
  function C(E) {
    return E.replace(/\r[\n\u0085]/g, `
`).replace(/[\r\u0085\u2028\u2029]/g, `
`);
  ...
  b.prototype.parseFromString = function(E, x) {
    ...
    var k = this.assign(/* @__PURE__ */ Object.create(null), this.xmlns), H = u.XML_ENTITIES, W = k[""] || null;
    p(x) ? (H = u.HTML_ENTITIES, W = m.HTML) : x === d.XML_SVG_IMAGE && (W = m.SVG), k[""] = W, k.xml = k.xml || m.XML;
    ...
    return Be && typeof E != "string" && re.errorHandler.fatalError("source is not a string"), re.parse(this.normalizeLineEndings(String(E)), k, H), te.doc.documentElement || re.errorHandler.fatalError("missing root element"), te.doc;
  };
  function y(E) {
    var x = E || {};
  ...
  y.prototype = {
    ...
    startElement: function(E, x, k, H) {
      var W = this.doc, te = W.createElementNS(E, k || x), Ie = H.length;
      U(this, te), this.currentElement = te, this.locator && q(this.locator, te);
      for (var re = 0; re < Ie; re++) {
        var E = H.getURI(re), Be = H.getValue(re), k = H.getQName(re), g = W.createAttributeNS(E, k);
        this.locator && q(H.getLocator(re), g), g.value = g.nodeValue = Be, te.setAttributeNode(g);
      }
    },
    ...
    characters: function(E, x, k) {
      if (E = F.apply(this, arguments), E) {
        if (this.cdata)
          var H = this.doc.createCDATASection(E);
        else
          var H = this.doc.createTextNode(E);
        this.currentElement ? this.currentElement.appendChild(H) : /^\s*$/.test(E) && this.doc.appendChild(H), this.locator && q(this.locator, H);
      }
    },
    ...
    comment: function(E, x, k) {
      ...
      var H = this.doc.createComment(E);
      this.locator && q(this.locator, H), U(this, H);
    },
    startCDATA: function() {
      this.cdata = !0;
    },
    ...
    startDTD: function(E, x, k, H) {
      var W = this.doc.implementation;
      if (W && W.createDocumentType) {
        var te = W.createDocumentType(E, x, k, H);
...
@#[line:` + E.lineNumber + ",col:" + E.columnNumber + "]";
  ...
  return rt.__DOMHandler = y, rt.DOMParser = b, rt.normalizeLineEndings = C, rt.onErrorStopParsing = ue, rt.onWarningStopParsing = he, rt;
}
var lr;
function wn() {
  if (lr) return J;
...
function Sn() {
  return fr || (fr = 1, jt = () => {
    const t = "\\ud800-\\udfff", p = "\\u0300-\\u036f" + "\\ufe20-\\ufe2f" + "\\u20d0-\\u20ff" + "\\u1ab0-\\u1aff" + "\\u1dc0-\\u1dff", h = "\\ufe0e\\ufe0f", f = "\\uD83D\\uDC69\\uD83C\\uDFFB\\u200D\\uD83C\\uDF93", d = `[${t}]`, m = `[${p}]`, l = "\\ud83c[\\udffb-\\udfff]", v = `(?:${m}|${l})`, C = `[^${t}]`, b = "(?:\\uD83C[\\uDDE6-\\uDDFF]){2}", y = "[\\ud800-\\udbff][\\udc00-\\udfff]", q = "\\u200d", B = "(?:\\ud83c\\udff4\\udb40\\udc67\\udb40\\udc62\\udb40(?:\\udc65|\\udc73|\\udc77)\\udb40(?:\\udc6e|\\udc63|\\udc6c)\\udb40(?:\\udc67|\\udc74|\\udc73)\\udb40\\udc7f)", F = `[${f}]`, U = `${v}?`, ue = `[${h}]?`, he = `(?:${q}(?:${[C, b, y].join("|")})${ue + U})*`, E = ue + U + he, k = `(?:${[`${C}${m}?`, m, b, y, d, F].join("|")})`;
...
function gt(t, e) {
  return e < 0 || e > fe(t) - 1 ? "" : Pt(t, e, 1);
}
function li(t, e) {
  if (!(e < 0 || e > fe(t) - 1))
    return Pt(t, e, 1).codePointAt(0);
}
function In(t, e, r = fe(t)) {
  const u = Rn(t, e);
  return !(u === -1 || u + fe(e) !== r);
}
function xn(t, e, r) {
...
function mr(t, e, r) {
  ...
  if (r !== void 0 && r <= 0)
    return [t];
  if (e === "") return _n(t).slice(0, r);
  let o = e;
  (typeof e == "string" || e instanceof RegExp && !Bn(e.flags, "g")) && (o = new RegExp(e, "g"));
  const a = t.match(o);
  let p = 0;
  if (!a) return [t];
...
const Vt = ["chapter", "book", "para", "row", "sidebar", Ut], Pn = "​", Vr = [
...
], kn = 1, Fn = Vr.length - 1, qn = 1, $n = 1, bi = {
  book: "GEN",
  chapterNum: 1,
  verseNum: 1
}, jn = (t) => {
  ...
  book: ee.bookNumberToId(
    Math.max(
      kn,
      Math.min(ee.bookIdToNumber(t.book) + e, Fn)
    )
  ),
  chapterNum: 1,
  verseNum: 1
  ...
  ...t,
  chapterNum: Math.min(
    Math.max(qn, t.chapterNum + e),
    jn(ee.bookIdToNumber(t.book))
  ),
  verseNum: 1
}), Ci = (t, e) => ({
  ...t,
  verseNum: Math.max($n, t.verseNum + e)
});
...
function wi(t) {
  return new Fr(ee.bookIdToNumber(t.book), t.chapterNum, t.verseNum).BBBCCC;
}
function gr(t) {
  return new Fr(ee.bookIdToNumber(t.book), t.chapterNum, t.verseNum).BBBCCCVVV;
}
function Si(t, e) {
  return gr(t) - gr(e);
}
...
var Vn = /* @__PURE__ */ ((t) => (t.OT = "OT", t.NT = "NT", t.DC = "DC", t.Extra = "Extra", t))(Vn || {});
const xi = (t) => {
...
const Gn = ee.allBookIds.filter(
  (t) => !ee.isObsolete(ee.bookIdToNumber(t))
), ki = Object.fromEntries(
  Gn.map((t) => [t, ee.bookIdToEnglishName(t)])
), Hn = (
  // Using unicode control characters to be very explicit about which characters we are using.
  // The first 6 characters are the control characters \f\n\r\t\v.
  // eslint-disable-next-line no-control-regex
...
function Dr(t) {
  ...
  for (let o = 0; o < t.length; o += 1) {
    const a = t[o];
    a.charCodeAt(0) < 32 ? (r || (e += " "), r = !0) : !r && a === Pn && o + 1 < t.length && Er(t[o + 1]) || (Er(a) ? (r || (e += a), r = !0) : Jn(a) && u === a || (e += a, r = !1)), u = a;
  }
  return e;
}
function vr(t) {
...
function Fi(t, e) {
  return Gr(t, void 0, e, void 0);
}
const qi = (t) => (...e) => t.map((u) => u(...e)).every((u) => u), $i = (t) => async (...e) => {
  const r = t.map(async (u) => u(...e));
  return (await Promise.all(r)).every((u) => u);
}, Bt = "chapter", Rt = "verse";
var Xn = Object.getOwnPropertyNames, Yn = Object.getOwnPropertySymbols, Kn = Object.prototype.hasOwnProperty;
function br(t, e) {
...
function Nr(t) {
  return Xn(t).concat(Yn(t));
}
var Wn = Object.hasOwn || function(t, e) {
  return Kn.call(t, e);
};
function at(t, e) {
  return t === e || !t && !e && t !== t && e !== e;
}
var Qn = "__v", Zn = "__o", eu = "_owner", yr = Object.getOwnPropertyDescriptor, Cr = Object.keys;
function tu(t, e, r) {
  var u = t.length;
  if (e.length !== u)
    return !1;
...
function Hr(t, e, r, u) {
  return (u === eu || u === Zn || u === Qn) && (t.$$typeof || e.$$typeof) ? !0 : Wn(e, u) && r.equals(t[u], e[u], u, u, t, e, r);
}
var fu = "[object Arguments]", hu = "[object Boolean]", pu = "[object Date]", du = "[object Error]", mu = "[object Map]", gu = "[object Number]", Eu = "[object Object]", Du = "[object RegExp]", vu = "[object Set]", Au = "[object String]", bu = "[object URL]", Nu = Array.isArray, Sr = typeof ArrayBuffer == "function" && ArrayBuffer.isView ? ArrayBuffer.isView : null, Or = Object.assign, yu = Object.prototype.toString.call.bind(Object.prototype.toString);
function Cu(t) {
  ...
  return function(b, y, q) {
    ...
    if (F === Set)
      return m(b, y, q);
    var U = yu(b);
    return U === pu ? r(b, y, q) : U === Du ? d(b, y, q) : U === mu ? a(b, y, q) : U === vu ? m(b, y, q) : U === Eu ? typeof b.then != "function" && typeof y.then != "function" && h(b, y, q) : U === bu ? v(b, y, q) : U === du ? u(b, y, q) : U === fu ? h(b, y, q) : U === hu || U === gu || U === Au ? f(b, y, q) : !1;
  };
}
function Tu(t) {
  var e = t.circular, r = t.createCustomConfig, u = t.strict, o = {
    areArraysEqual: u ? Tt : tu,
    areDatesEqual: ru,
    areErrorsEqual: nu,
    areFunctionsEqual: uu,
    areMapsEqual: u ? br(Tr, Tt) : Tr,
    areNumbersEqual: iu,
    areObjectsEqual: u ? Tt : ou,
    arePrimitiveWrappersEqual: au,
    areRegExpsEqual: su,
    areSetsEqual: u ? br(wr, Tt) : wr,
    areTypedArraysEqual: u ? Tt : cu,
    areUrlsEqual: lu
  };
  if (r && (o = Or({}, o, r(o))), e) {
...
function He(t) {
  t === void 0 && (t = {});
  var e = t.circular, r = e === void 0 ? !1 : e, u = t.createInternalComparator, o = t.createState, a = t.strict, p = a === void 0 ? !1 : a, h = Tu(t), f = Cu(h), d = u ? u(f) : wu(f);
  return Su({ circular: r, comparator: f, createState: o, equals: d, strict: p });
}
function Iu(t, e) {
  return Ou(t, e);
}
function xu(t, e) {
  ...
  return Object.keys(r).forEach((a) => {
    o && (Object.hasOwn(u, a) && xu(u[a], r[a]) || (o = !1));
  }), o;
}
function Ir(t, e, r) {
...
const Ui = (t) => t.replace(/&/g, "&amp;").replace(/</g, "&lt;").replace(/>/g, "&gt;").replace(/"/g, "&quot;").replace(/'/g, "&#x27;").replace(/\//g, "&#x2F;");
function Vi() {
  return typeof navigator < "u" && navigator.languages ? navigator.languages[0] : new Zr().resolvedOptions().locale;
}
function Gi(t, e = 2) {
...
const Bu = 1e3, zr = 60, Jr = zr * 60, Ru = Jr * 24;
function Hi(t, e, r = /* @__PURE__ */ new Date()) {
  const u = Math.floor((e.getTime() - r.getTime()) / Bu), o = Math.round(u / Ru);
  if (Math.abs(o) >= 1) return t.format(o, "day");
  const a = Math.round(u / Jr);
...
function Xi(t, e, r) {
  ...
  return o.id = `${qu}${r ? `-${r}` : ""}`, o.dataset.themeId = t.id, o.textContent = ju(t), this.document.head.appendChild(o), o;
}
...
class oe {
  ...
  verseRefToUsjContentLocation(e, r = 0) {
    ...
    const h = e.verse ?? e.verseNum.toString(), f = this.findNextMatchingNode(
      o,
      je,
      (v, C) => v === o ? e.verseNum === 0 ? (p = oe.convertWorkingStackToJsonPath(C), !0) : !1 : typeof v != "object" ? !1 : v.type === Bt ? (a = !0, !0) : v.type === Rt && v.number !== void 0 && v.number === h ? (p = oe.convertWorkingStackToJsonPath(C), !0) : !1
    );
...
export {
  Gn as ALL_BOOK_IDS,
  ki as ALL_ENGLISH_BOOK_NAMES,
  Qt as AsyncVariable,
  Bt as CHAPTER_TYPE,
  Hu as Collator,
  Zr as DateTimeFormat,
  un as DocumentCombiner,
  ei as EventRollingTimeCounter,
  kn as FIRST_SCR_BOOK_NUM,
  qn as FIRST_SCR_CHAPTER_NUM,
  $n as FIRST_SCR_VERSE_NUM,
  Fn as LAST_SCR_BOOK_NUM,
  zi as MODIFIER_KEYS,
  an as Mutex,
  ti as MutexMap,
  ri as NonValidatingDocumentCombiner,
  sn as NumberFormat,
  xt as PLATFORM_ERROR_VERSION,
  en as PlatformEventEmitter,
  ni as PromiseChainingMap,
  Vn as Section,
  ln as SortedNumberMap,
  ui as SortedSet,
  qu as THEME_STYLE_ELEMENT_ID,
  ii as UnsubscriberAsyncList,
  oe as UsjReaderWriter,
  Rt as VERSE_TYPE,
  $i as aggregateUnsubscriberAsyncs,
  qi as aggregateUnsubscribers,
  Xi as applyThemeStylesheet,
  Fi as areUsjContentsEqualExceptWhitespace,
  Mt as at,
  gt as charAt,
  li as codePointAt,
  Si as compareScrRefs,
  Wu as createSyncProxyForAsyncObject,
  Ju as debounce,
  wt as deepClone,
  Iu as deepEqual,
  bi as defaultScrRef,
  Mu as deserialize,
  _i as doesBookMatchQuery,
  In as endsWith,
  jr as ensureArray,
  Ei as escapeStringRegexp,
  Ji as expandThemeContribution,
  Gi as formatBytes,
  fi as formatReplacementString,
  Mn as formatReplacementStringToArray,
  Ii as formatScrRef,
  Hi as formatTimeSpan,
  Ku as getAllObjectFunctionNames,
  jn as getChaptersForBook,
  Vi as getCurrentLocale,
  xr as getErrorMessage,
  Un as getLocalizeKeyForScrollGroupId,
  Oi as getLocalizeKeysForScrollGroupIds,
  Pi as getLocalizedBookId,
  Li as getLocalizedBookName,
  Ti as getLocalizedIdFromBookNumber,
  Mi as getLocalizedSectionNames,
  xi as getSectionForBook,
  Bi as getSectionLongName,
  Ri as getSectionShortName,
  ju as getStylesheetForTheme,
  Xu as groupBy,
  Ui as htmlEncode,
  Bn as includes,
  Ot as indexOf,
  Qu as isErrorMessageAboutParatextBlockingInternetAccess,
  Zu as isErrorMessageAboutRegistryAuthFailure,
  gi as isLocalizeKey,
  ai as isPlatformError,
  ji as isSerializable,
  Me as isString,
  xu as isSubset,
  mt as isWhiteSpace,
  Rn as lastIndexOf,
  Pu as localizedStringsDocumentSchema,
  ku as menuDocumentSchema,
  zu as newGuid,
  oi as newPlatformError,
  hi as normalize,
  Dr as normalizeScriptureSpaces,
  Ni as offsetBook,
  yi as offsetChapter,
  Ci as offsetVerse,
  pi as ordinalCompare,
  di as padEnd,
  mi as padStart,
  _u as projectSettingsDocumentSchema,
  wi as scrRefToBBBCCC,
  gr as scrRefToBBBCCCVVV,
  Ir as serialize,
  Lu as settingsDocumentSchema,
  dr as slice,
  mr as split,
  Ur as startsWith,
  fe as stringLength,
  ut as substring,
  Fu as themeDocumentSchema,
  _n as toArray,
  Ai as toKebabCase,
  vi as transformAndEnsureRegExpArray,
  Di as transformAndEnsureRegExpRegExpArray,
  nn as wait,
  Yu as waitForDuration
};
