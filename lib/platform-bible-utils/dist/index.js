...
var _e = (n, e, t) => e in n ? xe(n, e, { enumerable: !0, configurable: !0, writable: !0, value: t }) : n[e] = t;
var k = (n, e, t) => _e(n, typeof e != "symbol" ? e + "" : e, t);
import { d as U, i as w } from "./scripture-util-DArajUVn.js";
import { D as ur, F as hr, a as fr, b as mr, G as gr, L as yr, M as kr, S as br, c as vr, e as Mr, f as xr, g as _r, h as Er, j as Ir, k as wr, l as Sr, m as Pr, n as Tr, o as Cr, p as Ar, q as qr, r as $r, s as Nr, t as jr, u as Or, v as Ur, w as Fr, x as Rr, y as Dr, z as Lr, A as Br, B as Vr, C as zr, E as Hr, H as Jr, I as Kr, J as Gr, K as Yr, N as Xr, O as Wr, P as Zr, Q as Qr, R as en, T as tn, U as rn, V as nn, W as sn, X as an, Y as on, Z as cn, _ as dn, $ as pn, a0 as ln, a1 as un, a2 as hn, a3 as fn, a4 as mn, a5 as gn, a6 as yn, a7 as kn, a8 as bn, a9 as vn, aa as Mn, ab as xn, ac as _n, ad as En } from "./scripture-util-DArajUVn.js";
import { Mutex as Ee } from "async-mutex";
import Ie from "dompurify";
import { deepEqual as we } from "fast-equals";
import { USJ_TYPE as Se } from "@eten-tech-foundation/scripture-utilities";
import { JSONPath as j } from "jsonpath-plus";
const F = class F {
  /**
  ...
  resolveToValue(e, t = !1) {
    if (this.resolver)
      F.verboseLoggingEnabled && console.debug(`${this.variableName} is being resolved now`), this.resolver(e), this.complete();
    else {
  ...
  rejectWithReason(e, t = !1) {
    if (this.rejecter)
      F.verboseLoggingEnabled && console.debug(`${this.variableName} is being rejected now with reason: ${e}`), this.rejecter(e), this.complete();
    else {
      if (t) throw Error(`${this.variableName} was already settled`);
...
function Te(n) {
  return typeof n == "object" && !!n && "then" in n && typeof n.then == "function" && "catch" in n && typeof n.catch == "function";
}
class Ce {
  constructor() {
    /**
...
class Ae {
  ...
  constructor(e, t) {
    ...
    k(this, "latestOutput");
    k(this, "options");
    k(this, "onDidRebuildEmitter", new Ce());
  ...
  updateBaseDocument(e) {
    return this.validateBaseDocument(e), this.baseDocument = this.options.copyDocuments ? U(e) : e, this.baseDocument = this.transformBaseDocumentAfterValidation(this.baseDocument), this.rebuild();
  }
  /**
  ...
  addOrUpdateContribution(e, t) {
    ...
    let s = this.options.copyDocuments && t ? U(t) : t;
    s = this.transformContributionAfterValidation(e, s), this.contributions.set(e, s);
    try {
      return this.rebuild();
    } catch (i) {
      throw r ? this.contributions.set(e, r) : this.contributions.delete(e), new Error(`Error when setting the document named ${e}: ${i}`);
    }
  }
  /**
...
class mt {
  ...
  get(e) {
    ...
    return t || (t = new $e(), this.mutexesByID.set(e, t), t);
  }
  /**
...
class yt {
  ...
  cleanupPromiseChain(e) {
    ...
    if (!t) return;
    const r = { promise: je }, s = t.catch((i) => this.logger.warn(`Error in promise for ${e}: ${i.message}`)).finally(() => {
...
class re {
  ...
  binarySearchLessThanOrEqual(e) {
    ...
    for (; t <= r; ) {
      ...
      this.sortedKeys[i] <= e ? (s = i, t = i + 1) : r = i - 1;
    }
    return s;
  }
...
const de = 1e4, H = de / 1e3, pe = 3, ne = /* @__PURE__ */ new Map(), Oe = {
  unsubscribed: {
    log: (n) => console.warn(n),
    first: (n) => `UnsubscriberAsyncList ${n}: Unsubscriber arrived after the list was run, so it was unsubscribed immediately instead of being stored.`,
    suppressed: (n, e) => `UnsubscriberAsyncList ${n}: ${e} more unsubscribers arrived after the list was run in the last ${H}s and were unsubscribed immediately; per-occurrence warnings suppressed.`
  },
  failed: {
    log: (n) => console.error(n),
    first: (n) => `UnsubscriberAsyncList ${n}: Unsubscriber added after the list was run failed!`,
    suppressed: (n, e) => `UnsubscriberAsyncList ${n}: ${e} more unsubscribers added after the list was run failed in the last ${H}s; per-occurrence errors suppressed.`
  },
  threw: {
    log: (n) => console.error(n),
    first: (n, e) => `UnsubscriberAsyncList ${n}: Unsubscriber added after the list was run threw! ${e}`,
    ...
    suppressed: (n, e, t) => `UnsubscriberAsyncList ${n}: ${e} more unsubscribers added after the list was run threw in the last ${H}s; per-occurrence errors suppressed. Distinct errors sampled (up to ${pe}): ${t.join(" | ")}`
  }
};
function ie(n, e, t) {
  const { log: r, first: s, suppressed: i } = Oe[e], c = `${n}\0${e}`, p = Date.now(), d = ne.get(c);
  if (!d || p >= d.closesAt) {
    r(s(n, t)), ne.set(c, {
      closesAt: p + de,
      suppressedCount: 0,
  ...
  d.suppressedCount += 1, t !== void 0 && d.suppressedErrorSamples.size < pe && d.suppressedErrorSamples.add(`${t}`), d.summaryTimeout || (d.summaryTimeout = setTimeout(() => {
    const { suppressedCount: l } = d, m = [...d.suppressedErrorSamples];
    d.suppressedCount = 0, d.suppressedErrorSamples.clear(), d.summaryTimeout = void 0, l > 0 && r(i(n, l, m));
...
const vt = "ABORTED", Mt = "ALREADY_EXISTS", xt = "CANCELLED", _t = "DATA_LOSS", Et = "DEADLINE_EXCEEDED", It = "FAILED_PRECONDITION", wt = "INTERNAL", St = "INVALID_ARGUMENT", Pt = "NOT_FOUND", Tt = "OUT_OF_RANGE", Ct = "PERMISSION_DENIED", At = "RESOURCE_EXHAUSTED", qt = "UNAUTHENTICATED", $t = "UNAVAILABLE", Nt = "UNIMPLEMENTED", jt = "UNKNOWN", D = 1;
function Ot(n, e) {
  if (!n)
    return {
      message: "",
      ...e && { code: e },
      platformErrorVersion: D
    };
  if (w(n))
    return {
      message: n,
  ...
  if (typeof n == "object" && "message" in n && typeof n.message == "string") {
    ...
    return Object.defineProperties(t, Object.getOwnPropertyDescriptors(n)), Object.defineProperty(t, "message", { enumerable: !0 }), "stack" in n && w(n.stack) && Object.defineProperty(t, "stack", { value: n.stack, enumerable: !0 }), "cause" in t && Object.defineProperty(t, "cause", { enumerable: !0 }), e && (t.code = e), t;
  }
  return {
    cause: n,
    message: "",
...
const Ft = (n) => (...e) => n.map((r) => r(...e)).every((r) => r), Rt = (n) => async (...e) => {
  const t = n.map(async (r) => r(...e));
  return (await Promise.all(t)).every((r) => r);
}, se = "book", ae = "chapter", C = "verse", A = "***";
var o = /* @__PURE__ */ ((n) => (n.FileIdentification = "FileIdentification", n.Headers = "Headers", n.Remarks = "Remarks", n.Introduction = "Introduction", n.DivisionMarks = "DivisionMarks", n.Paragraphs = "Paragraphs", n.Poetry = "Poetry", n.TitlesHeadings = "TitlesHeadings", n.Tables = "Tables", n.CenterTables = "CenterTables", n.RightTables = "RightTables", n.Lists = "Lists", n.Footnotes = "Footnotes", n.CrossReferences = "CrossReferences", n.SpecialText = "SpecialText", n.CharacterStyling = "CharacterStyling", n.Breaks = "Breaks", n.SpecialFeatures = "SpecialFeatures", n.PeripheralReferences = "PeripheralReferences", n.PeripheralMaterials = "PeripheralMaterials", n.Uncategorized = "Uncategorized", n))(o || {}), a = /* @__PURE__ */ ((n) => (n.Paragraph = "Paragraph", n.Character = "Character", n.Note = "Note", n.Unknown = "Unknown", n))(a || {});
const le = {
  id: {
...
function Dt(n) {
  var e;
  return ((e = le[n]) == null ? void 0 : e.type) === a.Paragraph || n === "v";
}
function Lt(n) {
  const e = le[n];
...
function Ue(n, e) {
  const t = e && e.length > 0 ? e : ue();
  return t[n % t.length];
}
function Vt(n, e) {
  const t = e && e.length > 0 ? e : ue(), r = (() => {
    const s = /* @__PURE__ */ new Map();
    let i = 0;
    return n.forEach((c, p) => {
      c.caller === "+" && (s.set(p, Ue(i, t)), i += 1);
    }), s;
  })();
  return (s, i) => {
    if (s === "+") {
...
function zt(n, e = {}) {
  ...
  let d, l;
  return p < r + s ? (d = i, l = c) : (l = Math.min(
    Math.floor((p - s) / p * 100),
    c
  ), d = Math.min(
    Math.max(Math.ceil(r / p * 100), i),
    l
...
function Re(n, e) {
  ...
  if (Array.isArray(n)) {
    const i = e, c = n;
    return i.length === 0 ? !0 : i.every((p) => c.includes(p));
  }
  if (typeof n != "object")
    return J(n, e);
  const t = e, r = n;
  ...
  return Object.keys(t).forEach((i) => {
    s && (Object.hasOwn(r, i) && Re(r[i], t[i]) || (s = !1));
  }), s;
}
function oe(n, e, t) {
...
const Jt = (n) => n.replace(/&/g, "&amp;").replace(/</g, "&lt;").replace(/>/g, "&gt;").replace(/"/g, "&quot;").replace(/'/g, "&#x27;").replace(/\//g, "&#x2F;");
function Kt() {
  return typeof navigator < "u" && navigator.languages ? navigator.languages[0].replace(/@posix$/i, "") : new Pe().resolvedOptions().locale;
}
function Gt(n, e = 2) {
  if (n === 0) return "0 Bytes";
  const t = ["Bytes", "KB", "MB", "GB", "TB", "PB", "EB", "ZB", "YB"], r = Math.floor(Math.log(n) / Math.log(1024)), s = t[r];
  return `${new Ne("en", {
    style: "decimal",
...
function Le(n) {
  return !!ze(n.fullName) && n.fullName !== n.shortName;
}
const Be = " - ";
function Xt(n) {
  return Le(n) ? `${n.shortName}${Be}${n.fullName}` : n.shortName;
}
function Ve(n, e) {
  return n.localeCompare(e, void 0, { sensitivity: "base" });
}
function Wt(n, e) {
  return Ve(n.shortName, e.shortName);
}
function ze(n) {
  return typeof n == "string" && n.trim().length > 0 ? n : void 0;
}
const He = 1e3, he = 60, fe = he * 60, Je = fe * 24;
function Zt(n, e, t = /* @__PURE__ */ new Date()) {
  const r = Math.floor((e.getTime() - t.getTime()) / He), s = Math.round(r / Je);
  if (Math.abs(s) >= 1) return n.format(s, "day");
  const i = Math.round(r / fe);
  if (Math.abs(i) >= 1) return n.format(i, "hour");
  const c = Math.round(r / he);
  return Math.abs(c) >= 1 ? n.format(c, "minute") : n.format(r, "second");
}
function Qt(n, e, t, r, s = {
  ...
  const p = n.getDate() === i.getDate() && n.getMonth() === i.getMonth() && n.getFullYear() === i.getFullYear(), d = n.getDate() === c.getDate() && n.getMonth() === c.getMonth() && n.getFullYear() === c.getFullYear();
  return p ? e : d ? t : n.toLocaleString(r, s);
}
...
function tr(n) {
  return `%physicalKey_${n.charAt(0).toLowerCase()}${n.slice(1)}%`;
}
function rr({
  interfaceMode: n,
  isAdminProtected: e,
...
const Ke = 3 - 0.5, Ge = 0.1;
function nr(n = {}) {
  const e = n.zoomStep ?? Ge, t = n.maxSteps ?? Math.ceil(Ke / e), r = n.window ?? globalThis.window, s = 120, i = 100, c = (v) => {
    const { wheelDeltaY: E } = v;
    return typeof E == "number" && Number.isFinite(E) ? -E / s : v.deltaY / i;
  }, p = (v) => v < 0 ? -Math.round(-v) : Math.round(v);
  let d = 0, l, m = 0;
  const b = 100, u = 0.05, h = 100, f = Math.log(1 + e) * b;
  let g = 0, M, I = 0, x = -1 / 0;
  const _ = ["Control", "Meta"], S = 2e3, T = /* @__PURE__ */ new Set(), $ = /* @__PURE__ */ new Set();
  let Y = -1 / 0;
  const ke = (v) => T.size > 0 || $.size > 0 && v - Y < S, X = (v) => {
    _.includes(v.key) && T.add(v.key);
  }, W = (v) => {
    _.includes(v.key) && (T.delete(v.key), $.delete(v.key));
  }, R = (v) => {
    _.forEach((E) => {
      (E === "Control" ? v.ctrlKey : v.metaKey) ? $.add(E) : ($.delete(E), T.delete(E));
    }), Y = performance.now();
  }, V = () => {
    T.clear(), $.clear();
  }, Z = () => {
    r != null && r.document.hidden && V();
  };
  r && (r.addEventListener("keydown", X, !0), r.addEventListener("keyup", W, !0), r.addEventListener("pointerdown", R, !0), r.addEventListener("pointermove", R, !0), r.addEventListener("blur", V), r.document.addEventListener("visibilitychange", Z));
  const be = (v, E, P) => (
    ...
    v.ctrlKey && !ke(P) && v.deltaMode === 0 && v.deltaX === 0 && (Math.abs(Math.exp(-v.deltaY / b) - 1) < u || // The running gesture belongs to the scope it is running in: a gesture that lands somewhere
    // else is a new one, and starts on its own evidence however close behind it arrives.
    E === M && P - x < h)
  ), z = (v) => v < 0 ? -Math.min(-v, t) : Math.min(v, t), ve = (v, E, P) => {
    const N = v.deltaY < 0 ? -1 : 1;
    (E !== M || N !== I) && (g = 0), M = E, I = N, g += v.deltaY, x = P;
    const q = Math.trunc(g / f);
    return q === 0 ? 0 : (g -= q * f, -z(q));
  }, Me = (v, E) => {
    const P = c(v);
    if (P === 0) return 0;
    const N = P < 0 ? -1 : 1;
    (E !== l || N !== m) && (d = 0), l = E, m = N, d += P;
    const q = p(d);
    return q === 0 ? 0 : (d -= q, -z(q));
  };
  return {
    read(v, E) {
      if (v.deltaY === 0) return 0;
      if (v.deltaMode !== 0) return -z(v.deltaY < 0 ? -1 : 1);
      const P = performance.now();
      return be(v, E, P) ? ve(v, E, P) : Me(v, E);
    },
    dispose() {
      r && (r.removeEventListener("keydown", X, !0), r.removeEventListener("keyup", W, !0), r.removeEventListener("pointerdown", R, !0), r.removeEventListener("pointermove", R, !0), r.removeEventListener("blur", V), r.document.removeEventListener("visibilitychange", Z));
    }
  };
}
const G = {
      ...
      patternProperties: {
        "^[\\w\\-]+\\.[\\w\\-]+$": {
          ...
          properties: {
            ...
            isHeaderHidden: {
              description: "Set to `true` to show this column's items without its header text in a menu that heads each section with its column's header, such as a web view's tab menu. The label still names the section for assistive technology. The application menubar ignores this, because there the header is what opens the column.",
              type: "boolean"
            }
          },
...
function ir(n) {
  const e = {};
  return typeof n.language == "string" && n.language.length > 0 && (e[L.language] = n.language), typeof n.type == "string" && n.type.length > 0 && (e[L.type] = n.type), typeof n.typeName == "string" && n.typeName.length > 0 && (e[L.typeName] = n.typeName), typeof n.lastUsedAt == "number" && Number.isFinite(n.lastUsedAt) && (e[L.lastUsedAt] = n.lastUsedAt), e;
}
function sr(n) {
  const e = /* @__PURE__ */ new Map(), t = n.length;
  return n.forEach((r, s) => {
    e.has(r) || e.set(r, t - s);
  }), e;
}
function ar(n, e) {
  return !n.installed && n.projectId === "" ? !1 : n.projectId !== "" && n.projectId === e ? !0 : n.dblEntryUid !== "" && e.toLowerCase().startsWith(n.dblEntryUid.toLowerCase());
}
const ge = {
  themeCssVariables: {
          ...
          return [
            ...
            c ? {
              ...
              cssVariables: {
                ...
                ...(p = e == null ? void 0 : e[i]) == null ? void 0 : p.cssVariables,
                ...c.cssVariables
              }
            } : void 0
          ];
...
function cr(n, e, t) {
  ...
  return s.id = `${et}${t ? `-${t}` : ""}`, s.dataset.themeId = n.id, s.textContent = rt(n), this.document.head.appendChild(s), s;
}
function ye(n) {
  return Object.freeze(n), n == null || Object.getOwnPropertyNames(n).forEach(function(t) {
    ...
    n[t] !== null && (typeof n[t] == "object" || typeof n[t] == "function") && !Object.isFrozen(n[t]) && ye(n[t]);
  }), n;
}
const K = ye({
  version: "3.0.7",
...
}), O = ["figure", "note", "sidebar", "table"];
Object.freeze(O);
const nt = /\u00A0/g, it = /\w+(\d+)/, st = /(\d+)-?(\d+)?/;
class y {
  constructor(e, t) {
    k(this, "usj");
    k(this, "markersMap");
     ...
     */
    k(this, "reportedProblems", /* @__PURE__ */ new Set());
    this.usj = e;
    ...
    if (r)
      this.markersMap = r, y.areUsjVersionsCompatible(this.usj.version, this.markersMap.version) || console.warn(
        `Warning: USJ for book ${this.getBookIdForLogging()} has version ${this.usj.version}, but provided markers map has version ${this.markersMap.version}. This may cause unexpected issues when transforming between formats.`
      );
    else if (y.areUsjVersionsCompatible(this.usj.version, K.version))
      this.markersMap = K;
    else
      throw new Error(
  ...
  // #region Reporting problems with the document
  /**
  ...
  getBookIdForLogging() {
    var t;
    const e = (t = this.usj.content) == null ? void 0 : t.find(
      (r) => typeof r != "string" && r.type === se && !!r.code
    );
    return (e == null ? void 0 : e.code) ?? A;
  }
  /**
   ...
   */
  reportProblemOnce(e, t = "warn") {
    this.reportedProblems.has(e) || (this.reportedProblems.add(e), t === "debug" ? console.debug(e) : console.warn(e));
  }
  // #endregion Reporting problems with the document
  // #region Directly using the JSONPath package to perform JSONPath query -> USJ node
  findSingleValue(e) {
    const t = j({ path: e, json: this.usj, wrap: !0 });
    if (t === void 0 || t.length === 0) return;
    if (!Array.isArray(t[0])) return t[0];
    const r = j({ path: e, json: this.usj, wrap: !1 });
  ...
  static isTopLevelUsjMarker(e, t) {
    return typeof e == "object" && e.type === Se && t.length === 0;
  }
  /**
  ...
  static isFragmentAMarker(e) {
    return !w(e) && !("forMarker" in e);
  }
  // #endregion marker helper methods
  // #region Parent Maps
  static createParentMapInternal(e, t, r) {
    var s;
    r.set(e, t), e.content && r.set(e.content, e), (s = e.content) == null || s.forEach((i) => {
      typeof i == "object" && y.createParentMapInternal(i, e, r);
    });
  }
    ...
    for (; i !== void 0; ) {
      ...
      if (
        ...
        !i.content.find((c, p) => {
          ...
          return t.unshift({ parent: i, index: p }), !0;
        })
      )
  ...
  convertJsonPathToWorkingStack(e) {
    ...
    return r.forEach((i, c) => {
      ...
      if (t.push({ parent: s, index: d }), c + 1 < r.length) {
  ...
  findAllNotes() {
    var e;
    return Fe((e = this.usj) == null ? void 0 : e.content);
  }
  /**
  ...
  static findNextMatchingNodeOrClosingFragmentUsingWorkingStack(e, t, r, s) {
    ...
    if (!w(c)) {
      ...
      t.some((l) => {
        ...
        return !w(m) && r.includes(m.type) ? (d = m, !0) : !1;
      }), d && (i = d);
    }
    for (; i !== void 0; ) {
      const d = typeof i == "object" && r.includes(i.type);
      if (!d && s(i, t)) return i;
      if (!d && typeof i == "object" && (((p = i.content) == null ? void 0 : p.length) ?? 0) > 0)
        t.push({ parent: i, index: 0 }), [i] = i.content;
      else {
        if (!d) {
          const l = typeof i == "object" ? { isClosingMarker: !0, forMarker: i } : void 0;
          if (l && s(l, t))
            return l;
        }
        for (i = void 0; t.length > 0; ) {
          ...
          if (l)
            if (l.index + 1 < l.parent.content.length) {
              l.index += 1, t.push(l), i = l.parent.content[l.index];
              break;
            } else {
              const m = {
                isClosingMarker: !0,
  ...
  nodeToUsjNodeAndDocumentLocation(e, t) {
    ...
    if (w(e)) {
      ...
      const p = (i = c.content) == null ? void 0 : i.indexOf(e);
      if (p === void 0 || p < 0)
  ...
  jsonPathToNodeAndParentIfString(e) {
    ...
    const r = w(t) ? this.findParent(e) : void 0;
    if (!r && w(t))
  ...
  usjDocumentLocationToUsfmVerseRefVerseLocation(e, t) {
    ...
    const s = this.getVerseRefForIndexInUsfm(r.indexInUsfm, t), i = this.getIndexInUsfmForVerseRef(s);
    return {
      verseRef: s,
      // Final USFM verse offset is the fragment's location relative to the verse plus whatever
      // offset is in the USJ location
      offset: r.indexInUsfm - i + y.getOffsetInUsjDocumentLocation(e)
    };
  }
  ...
  getEffectiveBookId(e) {
    const t = Object.keys(this.indicesInUsfmByVerseRef), r = t.length === 0 || t.length === 1 && t[0] === A, s = r ? A : e;
    if (!this.indicesInUsfmByVerseRef[s])
      throw new Error(
        `Book ID ${e} not found in USJ! ${r ? `There seems to be no USJ content because there is no content in ${A} either` : `Book IDs in USJ: ${JSON.stringify(t)}`}`
      );
    return s;
  }
  /**
  ...
  getVerseRefForIndexInUsfm(e, t) {
    ...
    const p = this.getIndexInUsfmForVerseRef(i), d = this.fragmentsByIndexInUsfm.get(p);
    return d && y.isFragmentAMarker(d.fragment) && d.fragment.type === C && d.fragment.number && d.fragment.number !== `${i.verseNum}` && (i.verse = d.fragment.number), i;
  }
  ...
  usfmVerseLocationToUsjNodeAndDocumentLocation(e) {
    const { verseRef: t, offset: r } = y.usfmVerseLocationToUsfmVerseRefVerseLocation(e), s = this.usfmVerseLocationToIndexInUsfm(e), { value: i } = this.fragmentsByIndexInUsfm.findClosestLessThanOrEqual(
      s
    ) ?? {
      value: void 0
    };
  ...
  findNextLocationOfMatchingText(e, t, r = 1e3) {
    ...
    if (y.findNextMatchingNodeUsingWorkingStack(
      ...
      (h, f) => {
        ...
        if (l && y.areStackItemsShallowEqual(M, l)) {
          ...
          g = h.substring(e.documentLocation.offset), c += e.documentLocation.offset;
        }
        i += g.length, s = `${s}${g}`;
        const I = s.indexOf(t);
        return I < 0 ? (c += s.length, s.length > t.length && (s = s.substring(s.length - t.length)), c -= s.length, i > r) : (p = c + I, !0);
      }
    ), p < 0) return;
    i = 0;
    let m = 0, b = [];
    const u = y.findNextMatchingNodeUsingWorkingStack(
      e.node,
      this.convertJsonPathToWorkingStack(e.documentLocation.jsonPath),
      O,
      (h, f) => typeof h != "string" || (i += h.length, i < p + 1) ? !1 : (m = p - i + h.length, b = f, !0)
    );
    ...
    return {
      node: u,
      documentLocation: {
        jsonPath: y.convertWorkingStackToJsonPath(b),
        offset: m
      }
    };
  }
  ...
  static buildNFDToOriginalPositionMap(e) {
    ...
    return Array.from(e).forEach((c) => {
      ...
      Array.from({ length: p.length }).forEach((d, l) => {
        r[s + l] = i;
      }), s += p.length, i += c.length;
    }), r;
  }
  search(e, t) {
    const r = t instanceof Set ? t : t == null ? void 0 : t.markerStylesToInclude, s = t instanceof Set || t == null ? void 0 : t.normalizationForm, i = [];
    ...
    let l = 0, m = c.node;
    for (; m !== void 0; )
      m = y.findNextMatchingNodeUsingWorkingStack(
        c.node,
        ...
        // eslint-disable-next-line no-loop-func
        (g, M) => (typeof g != "string" || r && M.some((x) => {
          const _ = x.parent;
          if (!_ || !("type" in _) || _.type === "char") return !1;
          let S;
          return "style" in _ && typeof _.style == "string" ? S = _.style : "marker" in _ && typeof _.marker == "string" && (S = _.marker), S !== void 0 && !r.has(S);
        }) || (p.push(g), d.set(l, {
          node: g,
          documentLocation: {
            offset: 0,
    ...
    const b = p.join(""), u = s === "NFD" ? y.buildNFDToOriginalPositionMap(b) : void 0, h = u ? b.normalize("NFD") : b;
    let f = e.exec(h);
    for (; f; ) {
      if (f[0].length > 0) {
        const g = u ? u[f.index] : f.index, M = u ? u[f.index + f[0].length] : f.index + f[0].length;
        if (g < 0 || g >= b.length)
          throw new Error(`Match index out of bounds: ${g}`);
        const I = d.findClosestLessThanOrEqual(g);
        if (!I)
          throw new Error(`Internal error: no starting node found for index ${g}`);
        const x = {
          node: I.value.node,
          documentLocation: {
            jsonPath: I.value.documentLocation.jsonPath,
            offset: g - I.key
          }
        }, _ = d.findClosestLessThanOrEqual(M - 1);
        if (!_)
        ...
        }, T = u ? b.substring(g, M) : f[0];
        i.push({ text: T, start: x, end: S });
      }
      if (!e.global) break;
      f = e.exec(h);
    }
  ...
  extractText(e, t) {
    let r = "", s = "offset" in e.documentLocation ? e.documentLocation.offset : 0, i = 0;
    return y.findNextMatchingNodeUsingWorkingStack(
      ...
      (c) => {
        ...
        if (s >= c.length)
          return s -= c.length, !1;
        let p = c;
        if (s > 0 && (p = p.substring(s), s = 0), i + p.length < t)
          return i += p.length, r = `${r}${p}`, !1;
        const d = t - i;
  ...
  extractTextBetweenPoints(e, t, r = 100) {
    ...
    return y.findNextMatchingNodeUsingWorkingStack(
      ...
      this.convertJsonPathToWorkingStack(e.documentLocation.jsonPath),
      O,
      (i, c) => i === t.node && (typeof i == "object" || t.documentLocation.jsonPath === y.convertWorkingStackToJsonPath(c)) ? !0 : typeof i != "string" ? !1 : (s = `${s}${i}`, s.length > r && (s = s.substring(0, r)), s.length >= r)
    ), s;
  }
  ...
  static removeContentNodesFromArray(e, t) {
    ...
    for (let s = e.length - 1; s >= 0; s--) {
      const i = e[s];
      t(i) ? (e.splice(s, 1), r += 1) : typeof i != "string" && i.content && (r += this.removeContentNodesFromArray(i.content, t));
    }
    return r;
  }
  ...
  getInfoForMarker(e, t = "usfm") {
    ...
    let s = !1, i = this.getMarkerInfo(r);
    const c = (i == null ? void 0 : i.type) ?? (w(e) ? "" : e.type);
    let p = r;
    if (i != null && i.markerUsfm && (p = i.markerUsfm, i = this.getMarkerInfo(p)), !i) {
      if (w(e))
        throw new Error(`Unknown marker ${r} and no marker type provided`);
      i = { type: e.type }, s = !0, this.reportProblemOnce(
        `Unknown marker ${r}. Creating MarkerInfo to use: ${JSON.stringify(i)}`,
        "debug"
      );
    }
    let d = i.type, l = this.markersMap.markerTypes[d];
    if (l != null && l.markerTypeUsfm && (d = l.markerTypeUsfm, l = this.markersMap.markerTypes[d]), !w(e) && e.type !== c && (!l || e.type !== l.markerTypeUsfm && e.type !== l.markerTypeUsx && e.type !== l.markerTypeUsj) && (this.reportProblemOnce(
      `Warning: Mismatching marker type in the USJ content ${e.type} vs marker type in the marker info ${i.type} for marker ${r}. Using the type from the USJ content.`
    ), d = e.type, l = this.markersMap.markerTypes[d], s = !0), !l)
      throw new Error(
        `Unknown marker type ${d} on marker ${r}! Cannot proceed.`
      );
    s && d === "para" && (l = { ...l, hasNewlineBefore: !1 });
    const m = [];
    ...
    if (t === "usfm" && d === "cell" && b.colspan) {
      const u = parseInt(b.colspan, 10), h = it.exec(r);
      if (h != null && h[1]) {
  ...
  textContentToUsfm(e) {
    return {
      usfm: this.shouldAllowInvisibleCharacters ? e : e.replace(nt, "~"),
  ...
  openingMarkerToUsfm(e, t) {
    let r = "";
    const s = [], { markerName: i, markerInfo: c, markerType: p, markerTypeInfo: d, attributeMarkerInfoEntries: l } = this.getInfoForMarker(e), m = e;
    d.hasNewlineBefore && (r += `
`);
    const b = t ? d.nestedPrefix ?? "" : "";
    return s.push({ fragment: e, indexInUsfm: r.length }), r += p === "optbreak" ? "//" : `\\${b}`, p !== "optbreak" && (s.push({
      fragment: { attributeValueForKey: "marker", forMarker: e },
      indexInUsfm: r.length
    }), r += `${i}${p === "unmatched" ? "" : " "}`), c.leadingAttributes && c.leadingAttributes.forEach((u) => {
      const h = m[u];
      h && (s.push({
      ...
      const { usfm: I } = this.textContentToUsfm(f);
      s.push({
        fragment: {
        ...
        indexInUsfm: r.length
      }), r += I, r = this.addMarkerUsfmToString(
        r,
        {
          isClosingMarker: !0,
          forMarker: g
        ...
        if (w(x.fragment) || "attributeKey" in x.fragment)
          throw new Error(
        ...
        if ("isClosingMarker" in x.fragment) {
          const { isClosingMarker: _, ...S } = x.fragment, T = {
            ...S,
            forMarker: e,
  ...
  closingMarkerToUsfm(e, t) {
    const {
      ...
      var g, M;
      return !(f === "type" || f === "marker" || f === "content" || f === "closed" || (g = p.skipOutputAttributeToUsfm) != null && g.includes(f) || (M = i.leadingAttributes) != null && M.includes(f) || i.textContentAttribute === f || d.some(
        ([, I]) => I.attributeMarkerAttributeName === f
      ));
    }), m = e;
    if (p.isCloseable && i.independentClosingMarkers && i.independentClosingMarkers.length > 0)
      throw new Error(
    ...
    let b = !0;
    if ((m.closed === "false" || i.isClosingMarkerOptional && !this.markersMap.shouldOptionalClosingMarkersBePresent && m.closed !== "true") && (b = !1), i.independentClosingMarkers && i.independentClosingMarkers.length > 0 && b) {
      const f = {
        type: c,
      ...
      let g = "";
      const M = [], { usfm: I, fragmentsInfo: x } = this.openingMarkerToUsfm(f, t), _ = x.find((S) => y.isFragmentAMarker(S.fragment));
      if (!_)
        throw new Error(
      ...
      return M.push({
      ...
      }), g += I, r !== f.marker && (g = this.addMarkerUsfmToString(
        g,
        {
          isClosingMarker: !0,
          forMarker: f
        ...
        t
      )), { usfm: g, fragmentsInfo: M };
    }
    let u = "";
    const h = [];
    if (l.length > 0 && (u += "|", l.length === 1 && l[0] === i.defaultAttribute ? (h.push({
      fragment: { attributeValueForKey: i.defaultAttribute, forMarker: e },
      indexInUsfm: u.length
    }), u += m[i.defaultAttribute]) : l.forEach((f, g) => {
      ...
      const f = p.isClosingMarkerEmpty ? "" : s, g = t ? p.nestedPrefix ?? "" : "";
      h.push({
        fragment: { isClosingMarker: !0, forMarker: e },
        indexInUsfm: u.length
      }), u += `\\${g}${f}*`;
  ...
  addMarkerUsfmToString(e, t, r, s) {
    ...
    if (c.startsWith(`
`) && (i.length === 0 ? (p = p.map((u) => ({
      ...u,
      indexInUsfm: u.indexInUsfm - 1
    })), c = c.substring(1)) : i = y.removeEndSpace(i)), this.markersMap.isSpaceAfterAttributeMarkersContent && d === "ca") {
 ...
 `);
  ...
  static areUsjDocumentLocationsEqual(e, t, r = !1) {
    const { jsonPath: s, ...i } = e, { jsonPath: c, ...p } = t;
    return !r && !J(j.toPathArray(s), j.toPathArray(c)) ? !1 : J(i, p);
  }
  ...
  static convertNodeToUsjDocumentLocation(e, t, r = 0) {
    ...
    return w(e) ? { jsonPath: s, offset: r } : { jsonPath: s };
  }
  /**
   ...
   *   do.
   */
  transferFragmentsInfoArrayToMaps(e, t, r, s, i, c) {
    e.map((d) => {
      var m, b, u;
      if (typeof d.fragment == "object" && "type" in d.fragment) {
        const h = d.fragment;
        if (h.type === se && h.code)
          r.bookId = h.code, r.chapterNum = 0, r.verseNum = 0, c[A] && (c[r.bookId] = c[A], delete c[A]);
        else if (h.type === ae && h.number) {
          const f = parseInt(h.number, 10);
          if (Number.isNaN(f))
            this.reportProblemOnce(
              `Found ${ae} type marker with number ${h.number}, but could not parse chapter number from it. Continuing using previous chapter number ${r.chapterNum}`
            );
          else {
        ...
        } else if (h.type === C && h.number) {
          const f = (m = st.exec(h.number)) == null ? void 0 : m[1];
          if (!f)
            this.reportProblemOnce(
              `Found ${C} type marker with number ${h.number}, but could not find starting verse number in it. Continuing using previous verse number ${r.verseNum}`
            );
          else {
            const g = parseInt(f, 10);
            if (Number.isNaN(g))
              this.reportProblemOnce(
                `Found ${C} type marker with number ${h.number}, but could not parse starting verse number from ${f}. Continuing using previous verse number ${r.verseNum}`
              );
            else if ((u = (b = c[r.bookId]) == null ? void 0 : b[r.chapterNum]) != null && u[g]) {
              const M = `Found ${C} marker with existing number ${g} after current ${C} number ${r.verseNum}! Not updating verse start index. All positions in this duplicate verse will be based on the current ${C} marker, not the new duplicate marker.`;
              this.reportProblemOnce(M);
            } else
              g < r.verseNum && console.debug(
                `Found ${C} marker with number ${g} lower than current ${C} number ${r.verseNum}. Verses are out of order. There may be some issues.`
              ), r.verseNum = g;
          }
        }
      }
      ...
      s.set(d.indexInUsfm, d);
      const l = d.nodeAndDocumentLocation.documentLocation.jsonPath, m = i.get(l);
      m ? m.push(d) : i.set(l, [d]), c[r.bookId] || (c[r.bookId] = {}), c[r.bookId][r.chapterNum] || (c[r.bookId][r.chapterNum] = {}), c[r.bookId][r.chapterNum][r.verseNum] === void 0 && (c[r.bookId][r.chapterNum][r.verseNum] = d.indexInUsfm);
    }), e.splice(0);
  }
  ...
  calculateUsfmProperties() {
    let e = "";
    const t = new re(), r = /* @__PURE__ */ new Map(), s = {}, i = [], c = {
      bookId: A,
      chapterNum: 0,
      verseNum: 0
    }, p = (m) => {
    ...
    return y.findNextMatchingNodeOrClosingFragmentUsingWorkingStack(
      ...
      (m, b) => {
        ...
        return b.length > 0 && (u = b[b.length - 1].parent), "isClosingMarker" in m ? l.length > 0 && l[l.length - 1] === m.forMarker ? (l.pop(), !1) : (e = this.addMarkerUsfmToString(
          ...
          u,
          i
        ), p(b), m.forMarker.type === "book" && d && (e = this.addMarkerUsfmToString(e, d, u, i), p(b), d = void 0), !1) : this.shouldSkipOutputMarkerToUsfm(m) ? (l.push(m), !1) : y.isTopLevelUsjMarker(m, b) && !d ? (m.version !== "3.0" && (d = m), !1) : (e = this.addMarkerUsfmToString(e, m, u, i), p(b), !1);
      }
...
export {
  ...
  ur as DEBOUNCE_CANCELED_ERROR_MESSAGE,
  Pe as DateTimeFormat,
  Ae as DocumentCombiner,
  ft as EventRollingTimeCounter,
  It as FAILED_PRECONDITION,
  hr as FIRST_SCR_BOOK_NUM,
  fr as FIRST_SCR_CHAPTER_NUM,
  mr as FIRST_SCR_VERSE_NUM,
  gr as GraphemeString,
  wt as INTERNAL,
  St as INVALID_ARGUMENT,
  yr as LAST_SCR_BOOK_NUM,
  kr as MAX_PADDING_LENGTH,
  er as MODIFIER_KEYS,
  a as MarkerType,
  $e as Mutex,
  mt as MutexMap,
  ...
  Ne as NumberFormat,
  Tt as OUT_OF_RANGE,
  Ct as PERMISSION_DENIED,
  D as PLATFORM_ERROR_VERSION,
  Be as PROJECT_NAME_SEPARATOR,
  L as PROJECT_SELECTOR_CUSTOM_DATA_KEYS,
  Ce as PlatformEventEmitter,
  yt as PromiseChainingMap,
  At as RESOURCE_EXHAUSTED,
  br as SELECTABLE_INVISIBLE_CHAR_OR_WHITESPACE_CLASS,
  vr as Section,
  re as SortedNumberMap,
  kt as SortedSet,
  et as THEME_STYLE_ELEMENT_ID,
  qt as UNAUTHENTICATED,
  $t as UNAVAILABLE,
  Nt as UNIMPLEMENTED,
  jt as UNKNOWN,
  K as USFM_MARKERS_MAP_3_0,
  dr as USFM_MARKERS_MAP_PARATEXT_3_0,
  bt as UnsubscriberAsyncList,
  y as UsjReaderWriter,
  C as VERSE_TYPE,
  Rt as aggregateUnsubscriberAsyncs,
  Ft as aggregateUnsubscribers,
  cr as applyThemeStylesheet,
  Mr as areUsjContentsEqualExceptWhitespace,
  xr as at,
  _r as charAt,
  Er as codePointAt,
  Ir as collapseMiddleWords,
  wr as collectUsjMarkers,
  Ve as compareProjectShortNames,
  Wt as compareProjectsByName,
  Sr as compareScrRefs,
  rr as computeEffectiveStructureProtection,
  nr as createContentZoomWheelReader,
  Pr as createSyncProxyForAsyncObject,
  Tr as debounce,
  U as deepClone,
  J as deepEqual,
  Cr as defaultScrRef,
  De as deserialize,
  ar as doesCatalogRowCoverProject,
  Ar as endsWith,
  qr as ensureArray,
  $r as escapeStringRegexp,
  or as expandThemeContribution,
  Gt as formatBytes,
  Xt as formatProjectName,
  Qt as formatRelativeDate,
  Nr as formatReplacementString,
  jr as formatReplacementStringToArray,
  Or as formatScrRef,
  Ur as formatScrRefRange,
  Zt as formatTimeSpan,
  Fr as getAllObjectFunctionNames,
  Rr as getChaptersForBook,
  Kt as getCurrentLocale,
  ue as getDefaultCallerSequence,
  Dr as getErrorMessage,
  Vt as getFormatCallerFunction,
  tr as getLocalizeKeyForPhysicalKey,
  Lr as getLocalizeKeyForScrollGroupId,
  Br as getLocalizeKeysForScrollGroupIds,
  Vr as getLocalizedIdFromBookNumber,
  Ue as getNthCaller,
  zt as getPaneSizeLimits,
  zr as getSectionForBook,
  rt as getStylesheetForTheme,
  Hr as groupBy,
  Le as hasDistinctFullName,
  Jt as htmlEncode,
  Jr as includes,
  Kr as indexOf,
  Dt as isBlockMarker,
  Lt as isCharacterMarker,
  Gr as isErrorMessageAboutParatextBlockingInternetAccess,
  Yr as isErrorMessageAboutRegistryAuthFailure,
  Xr as isLocalizeKey,
  Ut as isPlatformError,
  Wr as isSelectableInvisibleCharOrWhiteSpace,
  Ht as isSerializable,
  w as isString,
  Re as isSubset,
  Zr as isWhiteSpace,
  Qr as isolateBidi,
  en as lastIndexOf,
  We as localizedStringsDocumentSchema,
  ir as makeProjectSelectorCustomData,
  Ze as menuDocumentSchema,
  tn as newGuid,
  Ot as newPlatformError,
  rn as normalize,
  ze as normalizeFullName,
  Yt as normalizeProjectId,
  nn as normalizeScriptureSpaces,
  sn as offsetBook,
  an as offsetChapter,
  on as offsetVerse,
  cn as ordinalCompare,
  dn as padEnd,
  pn as padStart,
  Ye as projectSettingsDocumentSchema,
  sr as recencyMapFromOrderedIds,
  ln as retryUntil,
  Bt as sanitizeHtml,
  un as scrRefToBBBCCC,
  hn as scrRefToBBBCCCVVV,
  oe as serialize,
  Xe as settingsDocumentSchema,
  fn as slice,
  mn as split,
  gn as startsWith,
  yn as stringLength,
  kn as substring,
  Qe as themeDocumentSchema,
  bn as toArray,
  vn as toKebabCase,
  Mn as transformAndEnsureRegExpArray,
  xn as transformAndEnsureRegExpRegExpArray,
  le as usfmMarkers,
  _n as wait,
  En as waitForDuration
};
