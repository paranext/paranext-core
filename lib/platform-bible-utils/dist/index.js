...
var y = (n, e, t) => we(n, typeof e != "symbol" ? e + "" : e, t);
import { Mutex as Ie } from "async-mutex";
import { Canon as w, VerseRef as ie } from "@sillsdev/scripture";
import { USJ_TYPE as oe } from "@eten-tech-foundation/scripture-utilities";
import { length as Me, indexOf as Ee, limit as ae, substring as Se, toArray as Ae, substr as Te } from "stringz";
...
const U = class U {
  ...
  resolveToValue(e, t = !1) {
    if (this.resolver)
      U.verboseLoggingEnabled && console.debug(`${this.variableName} is being resolved now`), this.resolver(e), this.complete();
    else {
  ...
  rejectWithReason(e, t = !1) {
    if (this.rejecter)
      U.verboseLoggingEnabled && console.debug(`${this.variableName} is being rejected now with reason: ${e}`), this.rejecter(e), this.complete();
    else {
      if (t) throw Error(`${this.variableName} was already settled`);
...
function Ft(n, e = 300) {
  let t, r, i, s;
  return (...o) => (clearTimeout(t), r || (r = new Promise((a, c) => {
    i = a, s = c;
  })), t = setTimeout(async () => {
    try {
      i(await n(...o));
...
function Lt(n, e, t) {
  ...
  return n.forEach((i, s) => {
    const o = e(i, s), a = r.get(o), c = t ? t(i, o, s) : i;
    a ? a.push(c) : r.set(o, [c]);
  }), r;
}
function Ue(n) {
...
function zt(n) {
  ...
  return k(n) ? n.includes(e) : ce(n).includes(e);
}
function qt(n) {
  const e = "401 Unauthorized error while getting shared projects.", t = "User registration is not valid. Cannot retrieve resources from DBL.", r = k(n) ? n : ce(n);
...
class Be {
  ...
  constructor(e, t) {
    ...
    y(this, "latestOutput");
    y(this, "options");
    y(this, "onDidRebuildEmitter", new Oe());
  ...
  updateBaseDocument(e) {
    return this.validateBaseDocument(e), this.baseDocument = this.options.copyDocuments ? O(e) : e, this.baseDocument = this.transformBaseDocumentAfterValidation(this.baseDocument), this.rebuild();
  }
  /**
  ...
  addOrUpdateContribution(e, t) {
    ...
    let i = this.options.copyDocuments && t ? O(t) : t;
...
const D = 1;
function Wt(n) {
  if (!n) return { message: "", platformErrorVersion: D };
  if (k(n)) return { message: n, platformErrorVersion: D };
  if (typeof n == "object" && "message" in n && typeof n.message == "string") {
    const e = {
      message: n.message,
      platformErrorVersion: D
    };
    return Object.defineProperties(e, Object.getOwnPropertyDescriptors(n)), Object.defineProperty(e, "message", { enumerable: !0 }), "stack" in n && k(n.stack) && Object.defineProperty(e, "stack", { value: n.stack, enumerable: !0 }), "cause" in e && Object.defineProperty(e, "cause", { enumerable: !0 }), e;
  }
  return { cause: n, message: "", platformErrorVersion: D };
}
function Zt(n) {
...
function P(n, e) {
  return e < 0 || e > N(n) - 1 ? "" : F(n, e, 1);
}
function Qt(n, e) {
  if (!(e < 0 || e > N(n) - 1))
    return F(n, e, 1).codePointAt(0);
}
function Re(n, e, t = N(n)) {
  const r = Ge(n, e);
  return !(r === -1 || r + N(e) !== t);
}
function ze(n, e, t) {
...
function qe(n, e) {
  ...
  let r = 0, i = 0;
  function s(a, c, l) {
    const f = A(n, i, c), d = t.length > 0 && k(t[t.length - 1]) ? `${t.pop()}${f}` : f;
    k(a) ? t.push(`${d}${a}`) : (d && t.push(d), t.push(a)), i = c + l;
  }
  const o = N(n);
  for (; r < o; ) {
    switch (P(n, r)) {
      case "{":
        if (P(n, r - 1) !== "\\") {
          const a = ze(n, r, !1);
          if (a >= 0) {
            const c = A(n, r + 1, a), l = c in e ? (
              // Just checked that the key is in the object
              // eslint-disable-next-line no-type-assertion/no-type-assertion
              e[c]
            ) : c;
            s(l, r, a + 1 - r), r = a, i = a + 1;
          }
        } else
          s("{", r - 1, 2);
        break;
  ...
  if (i < o) {
    const a = A(n, i);
    t.push(
      t.length > 0 && k(t[t.length - 1]) ? `${t.pop()}${a}` : a
    );
  }
  return t;
}
...
function Ge(n, e, t) {
  let r = t === void 0 ? N(n) : t;
  r < 0 ? r = 0 : r >= N(n) && (r = N(n) - 1);
  for (let i = r; i >= 0; i--)
    if (F(n, i, N(e)) === e)
      return i;
  return -1;
...
function nr(n, e, t = " ") {
  return e <= N(n) ? n : ae(n, e, t, "right");
}
function sr(n, e, t = " ") {
  return e <= N(n) ? n : ae(n, e, t, "left");
}
function X(n, e) {
...
function Y(n, e, t) {
  ...
  for (let a = 0; a < (t ? t - 1 : s.length); a++) {
    const c = j(n, s[a], o), l = N(s[a]);
    if (r.push(A(n, o, c)), o = c + l, t !== void 0 && r.length === t)
      break;
  }
  return r.push(A(n, o)), r;
}
function fe(n, e, t = 0) {
  return j(n, e, t) === t;
}
function F(n, e = 0, t = N(n) - e) {
  return Te(n, e, t);
}
function A(n, e, t = N(n)) {
  return Se(n, e, t);
}
function He(n) {
  return Ae(n);
...
const V = ["chapter", "book", "para", "row", "sidebar", oe], _e = "​", pe = [
...
], Ye = 1, We = pe.length - 1, Ze = 1, Qe = 1, fr = {
  book: "GEN",
  chapterNum: 1,
  verseNum: 1
}, et = (n) => {
  ...
  book: w.bookNumberToId(
    Math.max(
      Ye,
      Math.min(w.bookIdToNumber(n.book) + e, We)
    )
  ),
  chapterNum: 1,
  verseNum: 1
...
async function mr(n, e, t) {
  ...
  return Y(s[0], "ÿ08")[0].trim();
}
function gr(n) {
  return new ie(w.bookIdToNumber(n.book), n.chapterNum, n.verseNum).BBBCCC;
}
function W(n) {
  return new ie(w.bookIdToNumber(n.book), n.chapterNum, n.verseNum).BBBCCCVVV;
}
function tt(n, e) {
  return W(n) - W(e);
}
...
function he(n, e) {
  switch (e) {
    case "English":
      return w.bookIdToEnglishName(n.book);
    case "id":
    case void 0:
      return n.book;
    default:
...
const vr = (n) => {
  if (w.isBookOT(n)) return "OT";
  if (w.isBookNT(n)) return "NT";
  if (w.isBookDC(n)) return "DC";
  if (w.isExtraMaterial(n)) return "Extra";
...
function ee(n) {
  ...
  for (let i = 0; i < n.length; i += 1) {
    const s = n[i];
    s.charCodeAt(0) < 32 ? (t || (e += " "), t = !0) : !t && s === _e && i + 1 < n.length && Q(n[i + 1]) || (Q(s) ? (t || (e += s), t = !0) : lt(s) && r === s || (e += s, t = !1)), r = s;
  }
  return e;
}
function te(n) {
...
function de(n, e, t, r) {
  ...
  if (i && s) {
    const o = ee(n), a = ee(t);
    if (o !== a) {
      if (!T(B(o, -1) ?? "") && !T(B(a, -1) ?? "") || !re(n, e) || !re(t, r)) return !1;
      let c = o;
      for (; T(B(c, -1) ?? ""); ) c = _(c, 0, -1);
      let l = a;
      for (; T(B(l, -1) ?? ""); ) l = _(l, 0, -1);
      if (c !== l) return !1;
    }
  } else if (!i && !s) {
    const o = n, a = t, c = Object.keys(o).filter(
      (d) => d !== "content"
    );
    if (c.length !== Object.keys(a).filter((d) => d !== "content").length || c.some((d) => !(d in a) || o[d] !== a[d])) return !1;
    const l = te(o.content), f = te(a.content);
    if (l !== f) return !1;
    if (!l && !f) {
      let d = o.content, p = a.content;
      const u = d[d.length - 1];
      V.includes(o.type) && k(u) && T(u) && (d = d.slice(0, -1));
      const h = p[p.length - 1];
      if (V.includes(a.type) && k(h) && T(h) && (p = p.slice(0, -1)), d.length !== p.length) return !1;
...
const xr = (n) => (...e) => n.map((r) => r(...e)).every((r) => r), wr = (n) => async (...e) => {
  const t = n.map(async (r) => r(...e));
  return (await Promise.all(t)).every((r) => r);
}, ut = "book", ne = "chapter", M = "verse", S = "***";
function Ir(n) {
...
function Er(n, e = {}) {
  ...
  let c, l;
  return a < r + i ? (c = s, l = o) : (l = Math.min(
...
function ht(n, e) {
  ...
  return Object.keys(t).forEach((s) => {
    i && (Object.hasOwn(r, s) && ht(r[s], t[s]) || (i = !1));
  }), i;
}
function se(n, e, t) {
...
const mt = 1e3, ge = 60, ye = ge * 60, gt = ye * 24;
function $r(n, e, t = /* @__PURE__ */ new Date()) {
  const r = Math.floor((e.getTime() - t.getTime()) / mt), i = Math.round(r / gt);
...
function Cr(n, e, t, r, i = {
  ...
  const a = n.getDate() === s.getDate() && n.getMonth() === s.getMonth() && n.getFullYear() === s.getFullYear(), c = n.getDate() === o.getDate() && n.getMonth() === o.getMonth() && n.getFullYear() === o.getFullYear();
  return a ? e : c ? t : n.toLocaleString(r, i);
}
...
function jr(n, e, t) {
  ...
  return i.id = `${xt}${t ? `-${t}` : ""}`, i.dataset.themeId = n.id, i.textContent = It(n), this.document.head.appendChild(i), i;
}
function ve(n) {
...
}), C = ["figure", "note", "sidebar", "table"];
Object.freeze(C);
const Mt = /\u00A0/g, Et = /\w+(\d+)/, St = /(\d+)-?(\d+)?/;
class m {
  constructor(e, t) {
    y(this, "usj");
    y(this, "markersMap");
...
USJ: ${JSON.stringify(
    ...
    else if (m.areUsjVersionsCompatible(this.usj.version, R.version))
      this.markersMap = R;
    else
      throw new Error(
  ...
  static createParentMapInternal(e, t, r) {
    ...
    r.set(e, t), e.content && r.set(e.content, e), (i = e.content) == null || i.forEach((s) => {
      typeof s == "object" && m.createParentMapInternal(s, e, r);
    });
  }
  ...
  convertJsonPathToWorkingStack(e) {
    ...
    return r.forEach((s, o) => {
      ...
      if (t.push({ parent: i, index: c }), o + 1 < r.length) {
  ...
  findAllNotes() {
    var e;
    return pt((e = this.usj) == null ? void 0 : e.content);
  }
  /**
  ...
  static findNextMatchingNodeOrClosingFragmentUsingWorkingStack(e, t, r, i) {
    ...
    if (!k(o)) {
      ...
      t.some((l) => {
        ...
        return !k(f) && r.includes(f.type) ? (c = f, !0) : !1;
      }), c && (s = c);
    }
    for (; s !== void 0; ) {
      const c = typeof s == "object" && r.includes(s.type);
      if (!c && i(s, t)) return s;
  ...
  findNextMatchingNode(e, t) {
    ...
    let i = r;
    const s = m.findNextMatchingNodeUsingWorkingStack(
      e.node,
      r,
      [],
      (o, a) => (i = a, t({
        node: o,
        documentLocation: m.convertNodeToUsjDocumentLocation(o, a)
      }))
    );
    if (s !== void 0)
      return {
  ...
  jsonPathToNodeAndParentIfString(e) {
    ...
    const r = k(t) ? this.findParent(e) : void 0;
    if (!r && k(t))
  ...
  usjDocumentLocationToUsfmVerseRefVerseLocation(e, t) {
    ...
    return {
      ...
      offset: r.indexInUsfm - s + m.getOffsetInUsjDocumentLocation(e)
    };
  }
  ...
  getVerseRefForIndexInUsfm(e, t) {
            ...
            for (; !o && v < g.length; ) {
              ...
              if (b !== void 0) {
                if (e < b) {
                  if (!s)
                    throw new Error(
                      `Could not find verse ref for index in USFM ${e} less than the first known index ${b}`
                    );
                  o = !0;
                  break;
                }
    ...
    return c && m.isFragmentAMarker(c.fragment) && c.fragment.type === M && c.fragment.number && c.fragment.number !== `${s.verseNum}` && (s.verse = c.fragment.number), s;
  }
  ...
  usfmVerseLocationToUsjNodeAndDocumentLocation(e) {
    const { verseRef: t, offset: r } = m.usfmVerseLocationToUsfmVerseRefVerseLocation(e), i = this.usfmVerseLocationToIndexInUsfm(e), { value: s } = this.fragmentsByIndexInUsfm.findClosestLessThanOrEqual(
      i
    ) ?? {
      value: void 0
    };
  ...
  findNextLocationOfMatchingText(e, t, r = 1e3) {
    ...
    if (m.findNextMatchingNodeUsingWorkingStack(
      ...
      (u, h) => {
        ...
        if (l && m.areStackItemsShallowEqual(v, l)) {
          ...
          g = u.substring(e.documentLocation.offset), o += e.documentLocation.offset;
        }
        s += g.length, i = `${i}${g}`;
        const x = i.indexOf(t);
        return x < 0 ? (o += i.length, i.length > t.length && (i = i.substring(i.length - t.length)), o -= i.length, s > r) : (a = o + x, !0);
      }
    ), a < 0) return;
    s = 0;
    let f = 0, d = [];
    const p = m.findNextMatchingNodeUsingWorkingStack(
      e.node,
      this.convertJsonPathToWorkingStack(e.documentLocation.jsonPath),
      C,
      (u, h) => typeof u != "string" || (s += u.length, s < a + 1) ? !1 : (f = a - s + u.length, d = h, !0)
    );
    ...
    return {
      node: p,
      documentLocation: {
        jsonPath: m.convertWorkingStackToJsonPath(d),
        offset: f
      }
    };
  }
  ...
  static buildNFDToOriginalPositionMap(e) {
    const t = e.normalize("NFD"), r = new Array(t.length + 1).fill(e.length);
    let i = 0, s = 0;
    return Array.from(e).forEach((o) => {
      const a = o.normalize("NFD");
      Array.from({ length: a.length }).forEach((c, l) => {
        r[i + l] = s;
      }), i += a.length, s += o.length;
    }), r;
  }
  /**
  ...
  search(e, t, r) {
    ...
    let c = 0, l = s.node;
    for (; l !== void 0; )
      l = m.findNextMatchingNodeUsingWorkingStack(
        s.node,
        ...
        // eslint-disable-next-line no-loop-func
        (h, g) => (typeof h != "string" || t && g.some((x) => {
          const b = x.parent;
          if (!b || !("type" in b) || b.type === "char") return !1;
          let I;
          return "style" in b && typeof b.style == "string" ? I = b.style : "marker" in b && typeof b.marker == "string" && (I = b.marker), I !== void 0 && !t.has(I);
        }) || (o.push(h), a.set(c, {
          node: h,
          documentLocation: {
            offset: 0,
    ...
    const f = o.join(""), d = (r == null ? void 0 : r.normalizationForm) === "NFD" ? m.buildNFDToOriginalPositionMap(f) : void 0, p = d ? f.normalize("NFD") : f;
    let u = e.exec(p);
    for (; u; ) {
      if (u[0].length > 0) {
        const h = d ? d[u.index] : u.index, g = d ? d[u.index + u[0].length] : u.index + u[0].length;
        if (h < 0 || h >= f.length)
          throw new Error(`Match index out of bounds: ${h}`);
        const v = a.findClosestLessThanOrEqual(h);
        if (!v)
          throw new Error(`Internal error: no starting node found for index ${h}`);
        const x = {
          node: v.value.node,
          documentLocation: {
            jsonPath: v.value.documentLocation.jsonPath,
            offset: h - v.key
          }
        }, b = a.findClosestLessThanOrEqual(g - 1);
        if (!b)
          throw new Error(`Internal error: no ending node found for index ${h}`);
        const I = {
          node: b.value.node,
          documentLocation: {
            jsonPath: b.value.documentLocation.jsonPath,
            offset: g - b.key
          }
        }, E = d ? f.substring(h, g) : u[0];
        i.push({ text: E, start: x, end: I });
      }
      if (!e.global) break;
      u = e.exec(p);
    }
  ...
  extractText(e, t) {
    ...
    return m.findNextMatchingNodeUsingWorkingStack(
      ...
      (o) => {
        ...
        const c = t - s;
        return r = `${r}${a.substring(0, c - 1)}`, !0;
      }
    ), r;
  }
  extractTextBetweenPoints(e, t, r = 100) {
    ...
    return m.findNextMatchingNodeUsingWorkingStack(
      ...
      this.convertJsonPathToWorkingStack(e.documentLocation.jsonPath),
      C,
      (s, o) => s === t.node && (typeof s == "object" || t.documentLocation.jsonPath === m.convertWorkingStackToJsonPath(o)) ? !0 : typeof s != "string" ? !1 : (i = `${i}${s}`, i.length > r && (i = i.substring(0, r)), i.length >= r)
    ), i;
  }
  ...
  getInfoForMarker(e, t = "usfm") {
    ...
    const o = (s == null ? void 0 : s.type) ?? (k(e) ? "" : e.type);
    let a = r;
    ...
    if (l != null && l.markerTypeUsfm && (c = l.markerTypeUsfm, l = this.markersMap.markerTypes[c]), !k(e) && e.type !== o && (!l || e.type !== l.markerTypeUsfm && e.type !== l.markerTypeUsx && e.type !== l.markerTypeUsj) && (console.warn(
      ...
      throw new Error(
        `Unknown marker type ${c} on marker ${r}! Cannot proceed.`
      );
    i && c === "para" && (l = { ...l, hasNewlineBefore: !1 });
    const f = [];
    s.attributeMarkers && s.attributeMarkers.forEach((p) => {
      const u = this.getMarkerInfo(p);
      u && "attributeMarkerAttributeName" in u && f.push([p, u]);
    });
    const d = e;
    if (t === "usfm" && c === "cell" && d.colspan) {
      const p = parseInt(d.colspan, 10), u = Et.exec(r);
      if (u != null && u[1]) {
        const h = parseInt(u[1], 10);
        !Number.isNaN(h) && !Number.isNaN(p) && (a = `${r}-${h + p - 1}`, l = {
          ...l,
  ...
  textContentToUsfm(e) {
    return {
      usfm: this.shouldAllowInvisibleCharacters ? e : e.replace(Mt, "~"),
  ...
  openingMarkerToUsfm(e, t) {
    let r = "";
    const i = [], { markerName: s, markerInfo: o, markerType: a, markerTypeInfo: c, attributeMarkerInfoEntries: l } = this.getInfoForMarker(e), f = e;
    c.hasNewlineBefore && (r += `
`);
    const d = t ? c.nestedPrefix ?? "" : "";
    return i.push({ fragment: e, indexInUsfm: r.length }), r += a === "optbreak" ? "//" : `\\${d}`, a !== "optbreak" && (i.push({
      fragment: { attributeValueForKey: "marker", forMarker: e },
      indexInUsfm: r.length
    }), r += `${s}${a === "unmatched" ? "" : " "}`), o.leadingAttributes && o.leadingAttributes.forEach((p) => {
      const u = f[p];
      u && (i.push({
        fragment: { attributeValueForKey: p, forMarker: e },
        indexInUsfm: r.length
      }), r += `${u} `);
    }), o.textContentAttribute && f[o.textContentAttribute] && (i.push({
      fragment: { attributeValueForKey: o.textContentAttribute, forMarker: e },
      indexInUsfm: r.length
    }), r += `${f[o.textContentAttribute]} `), o.attributeMarkers && l.forEach(([p, u]) => {
      const h = f[u.attributeMarkerAttributeName];
      if (!h) return;
      const g = {
        type: u.type,
        marker: p,
      ...
      const { usfm: x } = this.textContentToUsfm(h);
      i.push({
        fragment: {
        ...
        if (k(b.fragment) || "attributeKey" in b.fragment)
          throw new Error(
            `Attribute marker opening or closing markers generated a text content fragment or an attribute key fragment! This does not make sense. ${JSON.stringify(b)}`
          );
        if (m.isFragmentAMarker(b.fragment)) {
          i.push({
            ...b,
            fragment: {
        ...
        if ("attributeValueForKey" in b.fragment) {
          if (b.fragment.attributeValueForKey !== "marker")
            throw new Error(
              `Attribute marker opening or closing markers generated an attribute value fragment for a key that was not marker! This does not make sense. ${JSON.stringify(b)}`
            );
          i.push({
            ...b,
            fragment: {
        ...
        if ("isClosingMarker" in b.fragment) {
          const { isClosingMarker: I, ...E } = b.fragment, Ne = {
            ...E,
            forMarker: e,
        ...
        throw new Error(
          `Attribute marker opening or closing markers generated an unrecognized fragment: ${JSON.stringify(b)}`
        );
  ...
  closingMarkerToUsfm(e, t) {
    ...
    } = this.getInfoForMarker(e), l = Object.keys(e).filter((h) => {
      var g, v;
      return !(h === "type" || h === "marker" || h === "content" || h === "closed" || (g = a.skipOutputAttributeToUsfm) != null && g.includes(h) || (v = s.leadingAttributes) != null && v.includes(h) || s.textContentAttribute === h || c.some(
        ([, x]) => x.attributeMarkerAttributeName === h
      ));
    }), f = e;
    ...
    let d = !0;
    if ((f.closed === "false" || s.isClosingMarkerOptional && !this.markersMap.shouldOptionalClosingMarkersBePresent && f.closed !== "true") && (d = !1), s.independentClosingMarkers && s.independentClosingMarkers.length > 0 && d) {
      const h = {
        type: o,
      ...
      let g = "";
      const v = [], { usfm: x, fragmentsInfo: b } = this.openingMarkerToUsfm(h, t), I = b.find((E) => m.isFragmentAMarker(E.fragment));
      if (!I)
        throw new Error(
          `Could not find opening fragment info for independent closing marker ${JSON.stringify(
            h
          )}. Fragments info generated: ${JSON.stringify(b)}`
        );
      return v.push({
        ...I,
        fragment: { isClosingMarker: !0, forMarker: e }
      }), g += x, r !== h.marker && (g = this.addMarkerUsfmToString(
        g,
        {
          isClosingMarker: !0,
          forMarker: h
    ...
    let p = "";
    const u = [];
    if (l.length > 0 && (p += "|", l.length === 1 && l[0] === s.defaultAttribute ? (u.push({
      fragment: { attributeValueForKey: s.defaultAttribute, forMarker: e },
      indexInUsfm: p.length
    }), p += f[s.defaultAttribute]) : l.forEach((h, g) => {
      const v = o === "figure" && h === "file" ? "src" : h;
      g > 0 && (p += " "), u.push({
        fragment: { attributeKey: h, forMarker: e },
        indexInUsfm: p.length
      }), p += `${v}="`, u.push({
      ...
      const h = a.isClosingMarkerEmpty ? "" : i, g = t ? a.nestedPrefix ?? "" : "";
      u.push({
        fragment: { isClosingMarker: !0, forMarker: e },
        indexInUsfm: p.length
      }), p += `\\${g}${h}*`;
    }
    return { usfm: p, fragmentsInfo: u };
  }
  /**
  ...
  addMarkerUsfmToString(e, t, r, i) {
    let s = e, o, a;
    const { markerNameOriginal: c, markerType: l, markerTypeInfo: f } = this.getInfoForMarker(
    ...
    if ("isClosingMarker" in t) {
      const { usfm: p, fragmentsInfo: u } = this.closingMarkerToUsfm(
        t.forMarker,
        d
      );
      a = u, o = p, f.isCloseable && f.isClosingMarkerEmpty && // No contents
      (!t.forMarker.content || t.forMarker.content.length === 0) && // No closing marker attributes
      !o.startsWith("|") && (s = m.removeEndSpace(s));
    } else {
      const { usfm: p, fragmentsInfo: u } = this.openingMarkerToUsfm(
        t,
        d
      );
      a = u, o = p;
...
`) && (s.length === 0 ? (a = a.map((p) => ({
    ...
    })), o = o.substring(1)) : s = m.removeEndSpace(s)), this.markersMap.isSpaceAfterAttributeMarkersContent && c === "ca") {
      const p = s.lastIndexOf("\\");
      p >= 0 && e.substring(
        p + 1,
        p + 3
      ) === "c " && (s = m.removeEndSpace(s), s += `
 `);
    }
  ...
  static areUsjDocumentLocationsEqual(e, t, r = !1) {
    ...
    return !r && !J($.toPathArray(i), $.toPathArray(o)) ? !1 : J(s, a);
  }
  ...
  findFragmentInfoAtUsjDocumentLocation(e) {
    ...
    if (i)
      return i.find((s) => m.areUsjDocumentLocationsEqual(
        s.nodeAndDocumentLocation.documentLocation,
        t,
  ...
  static convertNodeToUsjDocumentLocation(e, t, r = 0) {
    ...
    return k(e) ? { jsonPath: i, offset: r } : { jsonPath: i };
  }
  /**
  ...
  static transferFragmentsInfoArrayToMaps(e, t, r, i, s, o) {
    e.map((c) => {
      ...
      if (typeof c.fragment == "object" && "type" in c.fragment) {
        const u = c.fragment;
        if (u.type === ut && u.code)
          r.bookId = u.code, r.chapterNum = 0, r.verseNum = 0, o[S] && (o[r.bookId] = o[S], delete o[S]);
        else if (u.type === ne && u.number) {
          const h = parseInt(u.number, 10);
          if (Number.isNaN(h))
            console.warn(
              `Found ${ne} type marker with number ${u.number}, but could not parse chapter number from it. Continuing using previous chapter number ${r.chapterNum}`
            );
          else {
            r.chapterNum = h, r.verseNum = 0;
            const g = o[r.bookId];
            g != null && g[0] && (g[r.chapterNum] = g[0], delete g[0]);
          }
        } else if (u.type === M && u.number) {
          const h = (f = St.exec(u.number)) == null ? void 0 : f[1];
          if (!h)
            console.warn(
              `Found ${M} type marker with number ${u.number}, but could not find starting verse number in it. Continuing using previous verse number ${r.verseNum}`
            );
          else {
            const g = parseInt(h, 10);
            Number.isNaN(g) ? console.warn(
              `Found ${M} type marker with number ${u.number}, but could not parse starting verse number from ${h}. Continuing using previous verse number ${r.verseNum}`
            ) : (p = (d = o[r.bookId]) == null ? void 0 : d[r.chapterNum]) != null && p[g] ? console.warn(`Found ${M} marker with existing number ${g} after
                  current ${M} number ${r.verseNum}! Not updating verse start index. All positions in this duplicate verse will be based on the current ${M} marker, not the new duplicate marker.`) : (g < r.verseNum && console.debug(
              `Found ${M} marker with number ${g} lower than current ${M} number ${r.verseNum}. Verses are out of order. There may be some issues.`
            ), r.verseNum = g);
          }
        }
      }
      ...
      const l = c.nodeAndDocumentLocation.documentLocation.jsonPath, f = s.get(l);
      f ? f.push(c) : s.set(l, [c]), o[r.bookId] || (o[r.bookId] = {}), o[r.bookId][r.chapterNum] || (o[r.bookId][r.chapterNum] = {}), o[r.bookId][r.chapterNum][r.verseNum] === void 0 && (o[r.bookId][r.chapterNum][r.verseNum] = c.indexInUsfm);
    }), e.splice(0);
  }
  ...
  calculateUsfmProperties() {
    ...
    return m.findNextMatchingNodeOrClosingFragmentUsingWorkingStack(
      ...
      (f, d) => {
        if (typeof f != "object") {
          const { usfm: u, fragmentsInfo: h } = this.textContentToUsfm(f);
        ...
        let p;
        return d.length > 0 && (p = d[d.length - 1].parent), "isClosingMarker" in f ? l.length > 0 && l[l.length - 1] === f.forMarker ? (l.pop(), !1) : (e = this.addMarkerUsfmToString(
          e,
          f,
          p,
          s
        ), a(d), f.forMarker.type === "book" && c && (e = this.addMarkerUsfmToString(e, c, p, s), a(d), c = void 0), !1) : this.shouldSkipOutputMarkerToUsfm(f) ? (l.push(f), !1) : m.isTopLevelUsjMarker(f, d) && !c ? (f.version !== "3.0" && (c = f), !1) : (e = this.addMarkerUsfmToString(e, f, p, s), a(d), !1);
      }
...
export {
  ...
  Le as Mutex,
  Gt as MutexMap,
  Ht as NonValidatingDocumentCombiner,
  Ve as NumberFormat,
  D as PLATFORM_ERROR_VERSION,
  Oe as PlatformEventEmitter,
  Xt as PromiseChainingMap,
  at as SELECTABLE_INVISIBLE_CHAR_OR_WHITESPACE_CLASS,
  it as Section,
  H as SortedNumberMap,
  _t as SortedSet,
  xt as THEME_STYLE_ELEMENT_ID,
  R as USFM_MARKERS_MAP_3_0,
  Dr as USFM_MARKERS_MAP_PARATEXT_3_0,
  Yt as UnsubscriberAsyncList,
  m as UsjReaderWriter,
  M as VERSE_TYPE,
  wr as aggregateUnsubscriberAsyncs,
  xr as aggregateUnsubscribers,
  jr as applyThemeStylesheet,
  Nr as areUsjContentsEqualExceptWhitespace,
  B as at,
  P as charAt,
  Qt as codePointAt,
  ur as collapseMiddleWords,
  tt as compareScrRefs,
  Rt as createSyncProxyForAsyncObject,
  Ft as debounce,
  O as deepClone,
  J as deepEqual,
  fr as defaultScrRef,
  ...
  qt as isErrorMessageAboutRegistryAuthFailure,
  ir as isLocalizeKey,
  Zt as isPlatformError,
  lt as isSelectableInvisibleCharOrWhiteSpace,
  Sr as isSerializable,
  k as isString,
  ht as isSubset,
  T as isWhiteSpace,
  Ge as lastIndexOf,
  kt as localizedStringsDocumentSchema,
  vt as menuDocumentSchema,
  Bt as newGuid,
  Wt as newPlatformError,
  tr as normalize,
  ...
  nr as padEnd,
  sr as padStart,
  yt as projectSettingsDocumentSchema,
  Ir as sanitizeHtml,
  ...
  N as stringLength,
  A as substring,
  Nt as themeDocumentSchema,
  He as toArray,
  lr as toKebabCase,
  cr as transformAndEnsureRegExpArray,
  ar as transformAndEnsureRegExpRegExpArray,
  De as wait,
  Vt as waitForDuration
};
