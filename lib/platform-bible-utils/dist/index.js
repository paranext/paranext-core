...
var _e = (i, e, t) => e in i ? xe(i, e, { enumerable: !0, configurable: !0, writable: !0, value: t }) : i[e] = t;
var k = (i, e, t) => _e(i, typeof e != "symbol" ? e + "" : e, t);
import { d as U, i as w } from "./scripture-util-DArajUVn.js";
import { D as ar, F as or, a as cr, b as dr, G as pr, L as lr, M as ur, S as hr, c as fr, e as mr, f as gr, g as yr, h as kr, j as br, k as vr, l as Mr, m as xr, n as _r, o as Er, p as Ir, q as wr, r as Sr, s as Pr, t as Tr, u as Cr, v as Ar, w as qr, x as $r, y as jr, z as Nr, A as Or, B as Ur, C as Fr, E as Rr, H as Lr, I as Dr, J as Br, K as Vr, N as zr, O as Hr, P as Jr, Q as Kr, R as Gr, T as Yr, U as Xr, V as Wr, W as Zr, X as Qr, Y as en, Z as tn, _ as rn, $ as nn, a0 as sn, a1 as an, a2 as on, a3 as cn, a4 as dn, a5 as pn, a6 as ln, a7 as un, a8 as hn, a9 as fn, aa as mn, ab as gn, ac as yn, ad as kn } from "./scripture-util-DArajUVn.js";
...
import { JSONPath as N } from "jsonpath-plus";
const F = class F {
  /**
...
class ht {
  ...
  cleanupPromiseChain(e) {
    ...
    if (!t) return;
    const r = { promise: Ne }, s = t.catch((n) => this.logger.warn(`Error in promise for ${e}: ${n.message}`)).finally(() => {
...
const de = 1e4, H = de / 1e3, pe = 3, ne = /* @__PURE__ */ new Map(), Oe = {
  unsubscribed: {
    log: (i) => console.warn(i),
    first: (i) => `UnsubscriberAsyncList ${i}: Unsubscriber arrived after the list was run, so it was unsubscribed immediately instead of being stored.`,
    suppressed: (i, e) => `UnsubscriberAsyncList ${i}: ${e} more unsubscribers arrived after the list was run in the last ${H}s and were unsubscribed immediately; per-occurrence warnings suppressed.`
  },
  failed: {
    log: (i) => console.error(i),
    first: (i) => `UnsubscriberAsyncList ${i}: Unsubscriber added after the list was run failed!`,
    suppressed: (i, e) => `UnsubscriberAsyncList ${i}: ${e} more unsubscribers added after the list was run failed in the last ${H}s; per-occurrence errors suppressed.`
  },
  threw: {
    log: (i) => console.error(i),
    first: (i, e) => `UnsubscriberAsyncList ${i}: Unsubscriber added after the list was run threw! ${e}`,
    ...
    suppressed: (i, e, t) => `UnsubscriberAsyncList ${i}: ${e} more unsubscribers added after the list was run threw in the last ${H}s; per-occurrence errors suppressed. Distinct errors sampled (up to ${pe}): ${t.join(" | ")}`
  }
};
function ie(i, e, t) {
  const { log: r, first: s, suppressed: n } = Oe[e], c = `${i}\0${e}`, p = Date.now(), d = ne.get(c);
  if (!d || p >= d.closesAt) {
    r(s(i, t)), ne.set(c, {
      closesAt: p + de,
      suppressedCount: 0,
  ...
  d.suppressedCount += 1, t !== void 0 && d.suppressedErrorSamples.size < pe && d.suppressedErrorSamples.add(`${t}`), d.summaryTimeout || (d.summaryTimeout = setTimeout(() => {
    ...
    d.suppressedCount = 0, d.suppressedErrorSamples.clear(), d.summaryTimeout = void 0, l > 0 && r(n(i, l, m));
...
const gt = "ABORTED", yt = "ALREADY_EXISTS", kt = "CANCELLED", bt = "DATA_LOSS", vt = "DEADLINE_EXCEEDED", Mt = "FAILED_PRECONDITION", xt = "INTERNAL", _t = "INVALID_ARGUMENT", Et = "NOT_FOUND", It = "OUT_OF_RANGE", wt = "PERMISSION_DENIED", St = "RESOURCE_EXHAUSTED", Pt = "UNAUTHENTICATED", Tt = "UNAVAILABLE", Ct = "UNIMPLEMENTED", At = "UNKNOWN", L = 1;
function qt(i, e) {
  if (!i)
    return {
      message: "",
  ...
  if (typeof i == "object" && "message" in i && typeof i.message == "string") {
    ...
    return Object.defineProperties(t, Object.getOwnPropertyDescriptors(i)), Object.defineProperty(t, "message", { enumerable: !0 }), "stack" in i && w(i.stack) && Object.defineProperty(t, "stack", { value: i.stack, enumerable: !0 }), "cause" in t && Object.defineProperty(t, "cause", { enumerable: !0 }), e && (t.code = e), t;
  }
  return {
    cause: i,
    message: "",
...
const jt = (i) => (...e) => i.map((r) => r(...e)).every((r) => r), Nt = (i) => async (...e) => {
...
function Ot(i) {
  var e;
  return ((e = le[i]) == null ? void 0 : e.type) === a.Paragraph || i === "v";
}
function Ut(i) {
  const e = le[i];
...
function Lt(i, e = {}) {
  ...
  let d, l;
  return p < r + s ? (d = n, l = c) : (l = Math.min(
...
function Re(i, e) {
  ...
  return Object.keys(t).forEach((n) => {
    s && (Object.hasOwn(r, n) && Re(r[n], t[n]) || (s = !1));
  }), s;
}
function oe(i, e, t) {
...
const Bt = (i) => i.replace(/&/g, "&amp;").replace(/</g, "&lt;").replace(/>/g, "&gt;").replace(/"/g, "&quot;").replace(/'/g, "&#x27;").replace(/\//g, "&#x2F;");
function Vt() {
...
function Kt(i, e, t, r, s = {
  ...
  const p = i.getDate() === n.getDate() && i.getMonth() === n.getMonth() && i.getFullYear() === n.getFullYear(), d = i.getDate() === c.getDate() && i.getMonth() === c.getMonth() && i.getFullYear() === c.getFullYear();
  return p ? e : d ? t : i.toLocaleString(r, s);
}
...
const Ve = 3 - 0.5, ze = 0.1;
function Wt(i = {}) {
  const e = i.zoomStep ?? ze, t = i.maxSteps ?? Math.ceil(Ve / e), r = i.window ?? globalThis.window, s = 120, n = 100, c = (v) => {
    const { wheelDeltaY: E } = v;
    return typeof E == "number" && Number.isFinite(E) ? -E / s : v.deltaY / n;
  ...
  const be = (v, E, P) => (
    ...
    const j = v.deltaY < 0 ? -1 : 1;
    (E !== M || j !== I) && (g = 0), M = E, I = j, g += v.deltaY, x = P;
...
function Zt(i) {
  const e = {};
  return typeof i.language == "string" && i.language.length > 0 && (e[D.language] = i.language), typeof i.type == "string" && i.type.length > 0 && (e[D.type] = i.type), typeof i.typeName == "string" && i.typeName.length > 0 && (e[D.typeName] = i.typeName), typeof i.lastUsedAt == "number" && Number.isFinite(i.lastUsedAt) && (e[D.lastUsedAt] = i.lastUsedAt), e;
}
function Qt(i) {
  const e = /* @__PURE__ */ new Map(), t = i.length;
...
function rr(i, e, t) {
  ...
  return s.id = `${Xe}${t ? `-${t}` : ""}`, s.dataset.themeId = i.id, s.textContent = Ze(i), this.document.head.appendChild(s), s;
}
function ye(i) {
  return Object.freeze(i), i == null || Object.getOwnPropertyNames(i).forEach(function(t) {
    ...
    i[t] !== null && (typeof i[t] == "object" || typeof i[t] == "function") && !Object.isFrozen(i[t]) && ye(i[t]);
  }), i;
}
const K = ye({
  version: "3.0.7",
...
class y {
  ...
  findSingleValue(e) {
    const t = N({ path: e, json: this.usj, wrap: !0 });
    if (t === void 0 || t.length === 0) return;
    if (!Array.isArray(t[0])) return t[0];
    const r = N({ path: e, json: this.usj, wrap: !1 });
  ...
  getVerseRefForIndexInUsfm(e, t) {
    ...
    return d && y.isFragmentAMarker(d.fragment) && d.fragment.type === C && d.fragment.number && d.fragment.number !== `${n.verseNum}` && (n.verse = d.fragment.number), n;
  }
  ...
  findNextLocationOfMatchingText(e, t, r = 1e3) {
    ...
    if (y.findNextMatchingNodeUsingWorkingStack(
      ...
      (h, f) => {
        ...
        n += g.length, s = `${s}${g}`;
        const I = s.indexOf(t);
        return I < 0 ? (c += s.length, s.length > t.length && (s = s.substring(s.length - t.length)), c -= s.length, n > r) : (p = c + I, !0);
      }
    ), p < 0) return;
    n = 0;
    let m = 0, b = [];
  ...
  getInfoForMarker(e, t = "usfm") {
    ...
    const c = (n == null ? void 0 : n.type) ?? (w(e) ? "" : e.type);
    let p = r;
    if (n != null && n.markerUsfm && (p = n.markerUsfm, n = this.getMarkerInfo(p)), !n) {
      ...
      n = { type: e.type }, s = !0, this.reportProblemOnce(
    ...
    if (t === "usfm" && d === "cell" && b.colspan) {
      const u = parseInt(b.colspan, 10), h = et.exec(r);
      if (h != null && h[1]) {
  ...
  textContentToUsfm(e) {
    return {
      usfm: this.shouldAllowInvisibleCharacters ? e : e.replace(Qe, "~"),
  ...
  openingMarkerToUsfm(e, t) {
    let r = "";
    const s = [], { markerName: n, markerInfo: c, markerType: p, markerTypeInfo: d, attributeMarkerInfoEntries: l } = this.getInfoForMarker(e), m = e;
...
`);
  ...
  closingMarkerToUsfm(e, t) {
    const {
      ...
      var g, M;
      return !(f === "type" || f === "marker" || f === "content" || f === "closed" || (g = p.skipOutputAttributeToUsfm) != null && g.includes(f) || (M = n.leadingAttributes) != null && M.includes(f) || n.textContentAttribute === f || d.some(
    ...
    }), u += m[n.defaultAttribute]) : l.forEach((f, g) => {
...
`) && (n.length === 0 ? (p = p.map((u) => ({
    ...
    })), c = c.substring(1)) : n = y.removeEndSpace(n)), this.markersMap.isSpaceAfterAttributeMarkersContent && d === "ca") {
 ...
 `);
  ...
  static areUsjDocumentLocationsEqual(e, t, r = !1) {
    ...
    return !r && !J(N.toPathArray(s), N.toPathArray(c)) ? !1 : J(n, p);
  }
   ...
   *   do.
   */
  transferFragmentsInfoArrayToMaps(e, t, r, s, n, c) {
    e.map((d) => {
      var m, b, u;
      if (typeof d.fragment == "object" && "type" in d.fragment) {
        ...
        if (h.type === se && h.code)
          ...
          const f = (m = tt.exec(h.number)) == null ? void 0 : m[1];
          if (!f)
            this.reportProblemOnce(
  ...
  calculateUsfmProperties() {
    let e = "";
    const t = new re(), r = /* @__PURE__ */ new Map(), s = {}, n = [], c = {
      bookId: A,
      chapterNum: 0,
      verseNum: 0
    }, p = (m) => {
    ...
    return y.findNextMatchingNodeOrClosingFragmentUsingWorkingStack(
      ...
      (m, b) => {
        ...
        return b.length > 0 && (u = b[b.length - 1].parent), "isClosingMarker" in m ? l.length > 0 && l[l.length - 1] === m.forMarker ? (l.pop(), !1) : (e = this.addMarkerUsfmToString(
          ...
          u,
          n
        ), p(b), m.forMarker.type === "book" && d && (e = this.addMarkerUsfmToString(e, d, u, n), p(b), d = void 0), !1) : this.shouldSkipOutputMarkerToUsfm(m) ? (l.push(m), !1) : y.isTopLevelUsjMarker(m, b) && !d ? (m.version !== "3.0" && (d = m), !1) : (e = this.addMarkerUsfmToString(e, m, u, n), p(b), !1);
      }
...
export {
  ...
  dt as Collator,
  bt as DATA_LOSS,
  vt as DEADLINE_EXCEEDED,
  ar as DEBOUNCE_CANCELED_ERROR_MESSAGE,
  Pe as DateTimeFormat,
  Ae as DocumentCombiner,
  pt as EventRollingTimeCounter,
  Mt as FAILED_PRECONDITION,
  or as FIRST_SCR_BOOK_NUM,
  cr as FIRST_SCR_CHAPTER_NUM,
  dr as FIRST_SCR_VERSE_NUM,
  pr as GraphemeString,
  xt as INTERNAL,
  _t as INVALID_ARGUMENT,
  lr as LAST_SCR_BOOK_NUM,
  ur as MAX_PADDING_LENGTH,
  Gt as MODIFIER_KEYS,
  a as MarkerType,
  $e as Mutex,
  lt as MutexMap,
  Et as NOT_FOUND,
  ut as NonValidatingDocumentCombiner,
  je as NumberFormat,
  It as OUT_OF_RANGE,
  wt as PERMISSION_DENIED,
  L as PLATFORM_ERROR_VERSION,
  D as PROJECT_SELECTOR_CUSTOM_DATA_KEYS,
  Ce as PlatformEventEmitter,
  ht as PromiseChainingMap,
  St as RESOURCE_EXHAUSTED,
  hr as SELECTABLE_INVISIBLE_CHAR_OR_WHITESPACE_CLASS,
  fr as Section,
  re as SortedNumberMap,
  ft as SortedSet,
  Xe as THEME_STYLE_ELEMENT_ID,
  Pt as UNAUTHENTICATED,
  Tt as UNAVAILABLE,
  Ct as UNIMPLEMENTED,
  At as UNKNOWN,
  K as USFM_MARKERS_MAP_3_0,
  nr as USFM_MARKERS_MAP_PARATEXT_3_0,
  mt as UnsubscriberAsyncList,
  y as UsjReaderWriter,
  C as VERSE_TYPE,
  Nt as aggregateUnsubscriberAsyncs,
  jt as aggregateUnsubscribers,
  rr as applyThemeStylesheet,
  mr as areUsjContentsEqualExceptWhitespace,
  gr as at,
  yr as charAt,
  kr as codePointAt,
  br as collapseMiddleWords,
  vr as collectUsjMarkers,
  Mr as compareScrRefs,
  Xt as computeEffectiveStructureProtection,
  Wt as createContentZoomWheelReader,
  xr as createSyncProxyForAsyncObject,
  _r as debounce,
  U as deepClone,
  J as deepEqual,
  Er as defaultScrRef,
  Le as deserialize,
  er as doesCatalogRowCoverProject,
  Ir as endsWith,
  wr as ensureArray,
  Sr as escapeStringRegexp,
  tr as expandThemeContribution,
  zt as formatBytes,
  Kt as formatRelativeDate,
  Pr as formatReplacementString,
  Tr as formatReplacementStringToArray,
  Cr as formatScrRef,
  Ar as formatScrRefRange,
  Jt as formatTimeSpan,
  qr as getAllObjectFunctionNames,
  $r as getChaptersForBook,
  Vt as getCurrentLocale,
  ue as getDefaultCallerSequence,
  jr as getErrorMessage,
  Rt as getFormatCallerFunction,
  Yt as getLocalizeKeyForPhysicalKey,
  Nr as getLocalizeKeyForScrollGroupId,
  Or as getLocalizeKeysForScrollGroupIds,
  Ur as getLocalizedIdFromBookNumber,
  Ue as getNthCaller,
  Lt as getPaneSizeLimits,
  Fr as getSectionForBook,
  Ze as getStylesheetForTheme,
  Rr as groupBy,
  Bt as htmlEncode,
  Lr as includes,
  Dr as indexOf,
  Ot as isBlockMarker,
  Ut as isCharacterMarker,
  Br as isErrorMessageAboutParatextBlockingInternetAccess,
  Vr as isErrorMessageAboutRegistryAuthFailure,
  zr as isLocalizeKey,
  $t as isPlatformError,
  Hr as isSelectableInvisibleCharOrWhiteSpace,
  ...
  Kr as isolateBidi,
  Gr as lastIndexOf,
  Ke as localizedStringsDocumentSchema,
  Zt as makeProjectSelectorCustomData,
  Ge as menuDocumentSchema,
  Yr as newGuid,
  qt as newPlatformError,
  Xr as normalize,
  Ht as normalizeProjectId,
  Wr as normalizeScriptureSpaces,
  Zr as offsetBook,
  Qr as offsetChapter,
  en as offsetVerse,
  tn as ordinalCompare,
  rn as padEnd,
  nn as padStart,
  He as projectSettingsDocumentSchema,
  Qt as recencyMapFromOrderedIds,
  sn as retryUntil,
  Ft as sanitizeHtml,
  an as scrRefToBBBCCC,
  on as scrRefToBBBCCCVVV,
  oe as serialize,
  ...
  ln as stringLength,
  un as substring,
  Ye as themeDocumentSchema,
  hn as toArray,
  fn as toKebabCase,
  mn as transformAndEnsureRegExpArray,
  gn as transformAndEnsureRegExpRegExpArray,
  le as usfmMarkers,
  yn as wait,
