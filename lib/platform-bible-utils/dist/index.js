...
function Tu(t) {
  ...
  return function(b, y, q) {
    ...
    if (F === Set)
      return m(b, y, q);
    var U = Cu(b);
    return U === du ? r(b, y, q) : U === vu ? d(b, y, q) : U === gu ? a(b, y, q) : U === Au ? m(b, y, q) : U === Du ? typeof b.then != "function" && typeof y.then != "function" && h(b, y, q) : U === Nu ? v(b, y, q) : U === mu ? u(b, y, q) : U === hu ? h(b, y, q) : U === pu || U === Eu || U === bu ? f(b, y, q) : !1;
  };
}
function wu(t) {
...
function Ge(t) {
  t === void 0 && (t = {});
  var e = t.circular, r = e === void 0 ? !1 : e, u = t.createInternalComparator, o = t.createState, a = t.strict, p = a === void 0 ? !1 : a, h = wu(t), f = Tu(h), d = u ? u(f) : Su(f);
  return Ou({ circular: r, comparator: f, createState: o, equals: d, strict: p });
}
function xu(t, e) {
  return Iu(t, e);
}
