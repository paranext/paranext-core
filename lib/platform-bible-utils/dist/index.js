...
const Xr = {
  ...
  themeDataPartial: {
    description: "The data an extension provides for one theme. An extension can provide multiple themes with {@link ThemeContribution}. This is then modified to `ThemeData` for use throughout the application.",
    type: "object",
    properties: {
      id: {
