...
var k = (i, e, t) => se(i, typeof e != "symbol" ? e + "" : e, t);
import { d as C, i as _, f as ae } from "./scripture-util-9QtVClbY.js";
import { D as Vt, F as zt, a as Ht, b as Jt, G as Kt, L as Gt, M as Yt, S as Xt, c as Wt, e as Zt, g as Qt, h as er, j as tr, k as rr, l as nr, m as ir, n as sr, o as ar, p as or, q as cr, r as dr, s as pr, t as lr, u as ur, v as hr, w as fr, x as mr, y as gr, z as yr, A as kr, B as br, C as vr, E as Mr, H as xr, I as _r, J as Er, K as Ir, N as wr, O as Sr, P as Pr, Q as Tr, R as Cr, T as Ar, U as qr, V as $r, W as jr, X as Nr, Y as Ur, Z as Or, _ as Fr, $ as Rr, a0 as Dr, a1 as Lr, a2 as Br, a3 as Vr, a4 as zr, a5 as Hr, a6 as Jr, a7 as Kr, a8 as Gr, a9 as Yr, aa as Xr, ab as Wr, ac as Zr, ad as Qr } from "./scripture-util-9QtVClbY.js";
...
function Ct(i, e, t = /* @__PURE__ */ new Date()) {
...
function ne(i) {
  return Object.freeze(i), i == null || Object.getOwnPropertyNames(i).forEach(function(t) {
    ...
    i[t] !== null && (typeof i[t] == "object" || typeof i[t] == "function") && !Object.isFrozen(i[t]) && ne(i[t]);
  }), i;
}
const F = ne({
  version: "3.0.7",
...
export {
  ...
  Vt as DEBOUNCE_CANCELED_ERROR_MESSAGE,
  le as DateTimeFormat,
  fe as DocumentCombiner,
  Ke as EventRollingTimeCounter,
  it as FAILED_PRECONDITION,
  zt as FIRST_SCR_BOOK_NUM,
  Ht as FIRST_SCR_CHAPTER_NUM,
  Jt as FIRST_SCR_VERSE_NUM,
  Kt as GraphemeString,
  st as INTERNAL,
  at as INVALID_ARGUMENT,
  Gt as LAST_SCR_BOOK_NUM,
  Yt as MAX_PADDING_LENGTH,
  qt as MODIFIER_KEYS,
  a as MarkerType,
  ge as Mutex,
  Ge as MutexMap,
  ...
  Xt as SELECTABLE_INVISIBLE_CHAR_OR_WHITESPACE_CLASS,
  Wt as Section,
  ...
  Dt as USFM_MARKERS_MAP_PARATEXT_3_0,
  Ze as UnsubscriberAsyncList,
  g as UsjReaderWriter,
  w as VERSE_TYPE,
  kt as aggregateUnsubscriberAsyncs,
  yt as aggregateUnsubscribers,
  Rt as applyThemeStylesheet,
  Zt as areUsjContentsEqualExceptWhitespace,
  Qt as at,
  er as charAt,
  tr as codePointAt,
  rr as collapseMiddleWords,
  nr as collectUsjMarkers,
  ir as compareScrRefs,
  jt as computeEffectiveStructureProtection,
  sr as createSyncProxyForAsyncObject,
  ar as debounce,
  C as deepClone,
  O as deepEqual,
  or as defaultScrRef,
  ...
  cr as endsWith,
  dr as ensureArray,
  pr as escapeStringRegexp,
  Ft as expandThemeContribution,
  St as formatBytes,
  Tt as formatProjectTitle,
  At as formatRelativeDate,
  ae as formatReplacementString,
  lr as formatReplacementStringToArray,
  ur as formatScrRef,
  hr as formatScrRefRange,
  Ct as formatTimeSpan,
  fr as getAllObjectFunctionNames,
  mr as getChaptersForBook,
  ...
  yr as getLocalizeKeyForScrollGroupId,
  kr as getLocalizeKeysForScrollGroupIds,
  br as getLocalizedIdFromBookNumber,
  Me as getNthCaller,
  _t as getPaneSizeLimits,
  Ie as getProjectDisplayName,
  ...
  Er as isErrorMessageAboutParatextBlockingInternetAccess,
  Ir as isErrorMessageAboutRegistryAuthFailure,
  wr as isLocalizeKey,
  ...
  Dr as retryUntil,
  Mt as sanitizeHtml,
  Lr as scrRefToBBBCCC,
  Br as scrRefToBBBCCCVVV,
  K as serialize,
  ...
  Gr as toArray,
  Yr as toKebabCase,
  Xr as transformAndEnsureRegExpArray,
  Wr as transformAndEnsureRegExpRegExpArray,
  W as usfmMarkers,
  Zr as wait,
