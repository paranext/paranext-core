...
function kr() {
  ...
  var w = n(v), b = a("[", w, n(/[-.0-9\xB7]/), n(/[\u0300-\u036F\u203F-\u2040]/), "]"), C = a(v, b, "*"), k = a(b, "+"), x = a("&", C, ";"), F = o(/&#[0-9]+;|&#x[0-9a-fA-F]+;/), q = o(x, "|", F), ue = a("%", C, ";"), he = o(
    ...
    "|",
    a("'", o(/[^%&']/, "|", ue, "|", q), "*", "'")
  ), D = o('"', o(/[^<&"]/, "|", q), "*", '"', "|", "'", o(/[^<&']/, "|", q), "*", "'"), R = i(v, ":"), L = i(b, ":"), V = a(R, L, "*"), Y = a(V, o(":", V), "?"), ee = a("^", Y, "$"), we = a("(", Y, ")"), te = o(/"[^"]*"|'[^']*'/), xe = a(/^<\?/, "(", C, ")", o(E, "(", l, "*?)"), "?", /\?>/), d = /[\x20\x0D\x0Aa-zA-Z0-9-'()+,./:=?;!*#@$_%]/, A = o('"', d, '*"', "|", "'", i(d, "'"), "*'"), S = "<!--", O = "-->", B = a(S, o(i(l, "-"), "|", a("-", i(l, "-"))), "*", O), N = "#PCDATA", M = o(
    a(/\(/, f, N, o(f, /\|/, f, Y), "*", f, /\)\*/),
    "|",
    a(/\(/, f, N, f, /\)/)
  ), G = /[?*+]?/, _ = a(
...
function Nn() {
  if (sr) return yt;
  sr = 1;
  var t = Dt(), e = kr(), n = Bt(), i = t.isHTMLEscapableRawTextElement, a = t.isHTMLMimeType, o = t.isHTMLRawTextElement, h = t.hasOwn, l = t.NAMESPACE, p = n.ParseError, m = n.DOMException, E = 0, f = 1, v = 2, w = 3, b = 4, C = 5, k = 6, x = 7;
  function F() {
  }
  F.prototype = {
    ...
    for (var I = 0, P = 0, re = /.*(?:\r\n?|\n)|.*$/g, K = O.locator, Ce = [{ currentNSMap: A }], ye = [], se = 0; ; ) {
      try {
        ...
        switch (d.charAt(oe + 1)) {
          ...
          default:
            K && y(oe);
            var Q = new xe(), ge = Ce[Ce.length - 1].currentNSMap, le = D(d, oe, Q, ge, G, B, N), Je = Q.length;
...
function On(t, e) {
  ...
  let i = 0, a = 0;
  function o(l, p, m) {
    const E = tt(t, a, p), f = n.length > 0 && Re(n[n.length - 1]) ? `${n.pop()}${E}` : E;
    Re(l) ? n.push(`${f}${l}`) : (f && n.push(f), n.push(l)), a = p + m;
  }
  const h = pe(t);
  for (; i < h; ) {
    switch (Et(t, i)) {
  ...
  if (a < h) {
    const l = tt(t, a);
    n.push(
      n.length > 0 && Re(n[n.length - 1]) ? `${n.pop()}${l}` : l
    );
  }
  return n;
}
...
function Vr(t, e, n, i) {
  ...
  if (a && o) {
    ...
    if (!m && !E) {
      ...
      $t.includes(h.type) && Re(w) && mt(w) && (f = f.slice(0, -1));
      const b = v[v.length - 1];
      if ($t.includes(l.type) && Re(b) && mt(b) && (v = v.slice(0, -1)), f.length !== v.length) return !1;
