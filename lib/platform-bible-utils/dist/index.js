...
var k = (i, e, t) => oe(i, typeof e != "symbol" ? e + "" : e, t);
...
class Qe {
  ...
  cleanupPromiseChain(e) {
    ...
    if (!t) return;
    const r = { promise: be }, s = t.catch((n) => this.logger.warn(`Error in promise for ${e}: ${n.message}`)).finally(() => {
...
const W = 1e4, O = W / 1e3, Z = 3, z = /* @__PURE__ */ new Map(), ve = {
  unsubscribed: {
  ...
  threw: {
    ...
    suppressed: (i, e, t) => `UnsubscriberAsyncList ${i}: ${e} more unsubscribers added after the list was run threw in the last ${O}s; per-occurrence errors suppressed. Distinct errors sampled (up to ${Z}): ${t.join(" | ")}`
  }
};
function H(i, e, t) {
  const { log: r, first: s, suppressed: n } = ve[e], c = `${i}\0${e}`, p = Date.now(), d = z.get(c);
  if (!d || p >= d.closesAt) {
    r(s(i, t)), z.set(c, {
      closesAt: p + W,
      suppressedCount: 0,
  ...
  d.suppressedCount += 1, t !== void 0 && d.suppressedErrorSamples.size < Z && d.suppressedErrorSamples.add(`${t}`), d.summaryTimeout || (d.summaryTimeout = setTimeout(() => {
...
function xt(i) {
  var e;
  return ((e = Q[i]) == null ? void 0 : e.type) === a.Paragraph || i === "v";
}
function _t(i) {
  const e = Q[i];
  return (e == null ? void 0 : e.type) !== a.Character ? !1 : e.category !== o.DivisionMarks;
}
const K = 0.5, G = 3, xe = 0.1;
function _e(i) {
  return i < K ? K : i > G ? G : i;
}
function Ee(i) {
...
function Ie(i, e) {
  const t = e && e.length > 0 ? e : ee();
  return t[i % t.length];
}
function wt(i, e) {
  const t = e && e.length > 0 ? e : ee(), r = (() => {
...
const Te = 1e3, te = 60, re = te * 60, Ce = re * 24;
function $t(i, e, t = /* @__PURE__ */ new Date()) {
  ...
  const n = Math.round(r / re);
  if (Math.abs(n) >= 1) return i.format(n, "hour");
  const c = Math.round(r / te);
...
function se(i) {
  return Object.freeze(i), i == null || Object.getOwnPropertyNames(i).forEach(function(t) {
    ...
    i[t] !== null && (typeof i[t] == "object" || typeof i[t] == "function") && !Object.isFrozen(i[t]) && se(i[t]);
  }), i;
}
const F = se({
  version: "3.0.7",
...
export {
  ...
  G as MAX_ZOOM_FACTOR,
  K as MIN_ZOOM_FACTOR,
  Nt as MODIFIER_KEYS,
  a as MarkerType,
  ye as Mutex,
  We as MutexMap,
  ...
  ee as getDefaultCallerSequence,
