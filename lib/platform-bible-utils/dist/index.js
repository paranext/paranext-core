...
var y = (s, e, t) => me(s, typeof e != "symbol" ? e + "" : e, t);
import { d as R, i as x } from "./scripture-util-DArajUVn.js";
import { D as Xt, F as Wt, a as Zt, b as Qt, G as er, L as tr, M as rr, S as nr, c as ir, e as sr, f as ar, g as or, h as cr, j as dr, k as pr, l as lr, m as ur, n as hr, o as fr, p as mr, q as gr, r as yr, s as kr, t as br, u as vr, v as Mr, w as xr, x as _r, y as Er, z as Ir, A as wr, B as Pr, C as Sr, E as Tr, H as Cr, I as Ar, J as qr, K as $r, N as jr, O as Nr, P as Fr, Q as Ur, R as Rr, T as Or, U as Dr, V as Lr, W as Br, X as Vr, Y as zr, Z as Hr, _ as Jr, $ as Kr, a0 as Gr, a1 as Yr, a2 as Xr, a3 as Wr, a4 as Zr, a5 as Qr, a6 as en, a7 as tn, a8 as rn, a9 as nn, aa as sn, ab as an, ac as on, ad as cn } from "./scripture-util-DArajUVn.js";
import { Mutex as ge } from "async-mutex";
import ye from "dompurify";
import { deepEqual as ke } from "fast-equals";
import { USJ_TYPE as be } from "@eten-tech-foundation/scripture-utilities";
import { JSONPath as F } from "jsonpath-plus";
const O = class O {
  /**
...
class _e {
  ...
  constructor(e, t) {
    ...
    y(this, "latestOutput");
    y(this, "options");
    y(this, "onDidRebuildEmitter", new xe());
  ...
  updateBaseDocument(e) {
    return this.validateBaseDocument(e), this.baseDocument = this.options.copyDocuments ? R(e) : e, this.baseDocument = this.transformBaseDocumentAfterValidation(this.baseDocument), this.rebuild();
  }
  /**
  ...
  addOrUpdateContribution(e, t) {
    ...
    let i = this.options.copyDocuments && t ? R(t) : t;
...
class it {
  ...
  get(e) {
    ...
    return t || (t = new Ie(), this.mutexesByID.set(e, t), t);
  }
  /**
...
class at {
  ...
  cleanupPromiseChain(e) {
    ...
    if (!t) return;
    const r = { promise: Pe }, i = t.catch((n) => this.logger.warn(`Error in promise for ${e}: ${n.message}`)).finally(() => {
...
const re = 1e4, V = re / 1e3, ne = 3, W = /* @__PURE__ */ new Map(), Se = {
  unsubscribed: {
    ...
    suppressed: (s, e) => `UnsubscriberAsyncList ${s}: ${e} more unsubscribers arrived after the list was run in the last ${V}s and were unsubscribed immediately; per-occurrence warnings suppressed.`
  },
  failed: {
    log: (s) => console.error(s),
    first: (s) => `UnsubscriberAsyncList ${s}: Unsubscriber added after the list was run failed!`,
    suppressed: (s, e) => `UnsubscriberAsyncList ${s}: ${e} more unsubscribers added after the list was run failed in the last ${V}s; per-occurrence errors suppressed.`
  },
  threw: {
    log: (s) => console.error(s),
    ...
    suppressed: (s, e, t) => `UnsubscriberAsyncList ${s}: ${e} more unsubscribers added after the list was run threw in the last ${V}s; per-occurrence errors suppressed. Distinct errors sampled (up to ${ne}): ${t.join(" | ")}`
  }
};
function Z(s, e, t) {
  const { log: r, first: i, suppressed: n } = Se[e], c = `${s}\0${e}`, p = Date.now(), d = W.get(c);
  if (!d || p >= d.closesAt) {
    r(i(s, t)), W.set(c, {
      closesAt: p + re,
      suppressedCount: 0,
  ...
  d.suppressedCount += 1, t !== void 0 && d.suppressedErrorSamples.size < ne && d.suppressedErrorSamples.add(`${t}`), d.summaryTimeout || (d.summaryTimeout = setTimeout(() => {
...
const dt = "ABORTED", pt = "ALREADY_EXISTS", lt = "CANCELLED", ut = "DATA_LOSS", ht = "DEADLINE_EXCEEDED", ft = "FAILED_PRECONDITION", mt = "INTERNAL", gt = "INVALID_ARGUMENT", yt = "NOT_FOUND", kt = "OUT_OF_RANGE", bt = "PERMISSION_DENIED", vt = "RESOURCE_EXHAUSTED", Mt = "UNAUTHENTICATED", xt = "UNAVAILABLE", _t = "UNIMPLEMENTED", Et = "UNKNOWN", D = 1;
function It(s, e) {
  if (!s)
    return {
      message: "",
  ...
  if (typeof s == "object" && "message" in s && typeof s.message == "string") {
    ...
    return Object.defineProperties(t, Object.getOwnPropertyDescriptors(s)), Object.defineProperty(t, "message", { enumerable: !0 }), "stack" in s && x(s.stack) && Object.defineProperty(t, "stack", { value: s.stack, enumerable: !0 }), "cause" in t && Object.defineProperty(t, "cause", { enumerable: !0 }), e && (t.code = e), t;
  }
  return {
    cause: s,
    message: "",
...
const Pt = (s) => (...e) => s.map((r) => r(...e)).every((r) => r), St = (s) => async (...e) => {
  const t = s.map(async (r) => r(...e));
  return (await Promise.all(t)).every((r) => r);
}, Te = "book", Q = "chapter", A = "verse", $ = "***", ie = "ws";
...
function Tt(s) {
  var e;
  return ((e = se[s]) == null ? void 0 : e.type) === a.Paragraph || s === "v";
}
function Ct(s) {
  const e = se[s];
...
function Ce(s, e) {
  const t = e && e.length > 0 ? e : ae();
  return t[s % t.length];
}
function qt(s, e) {
  const t = e && e.length > 0 ? e : ae(), r = (() => {
    const i = /* @__PURE__ */ new Map();
    let n = 0;
    return s.forEach((c, p) => {
      c.caller === "+" && (i.set(p, Ce(n, t)), n += 1);
    }), i;
  })();
  return (i, n) => {
    if (i === "+") {
...
function qe(s, e) {
  ...
  return Object.keys(t).forEach((n) => {
    i && (Object.hasOwn(r, n) && qe(r[n], t[n]) || (i = !1));
  }), i;
}
function ee(s, e, t) {
...
const Nt = (s) => s.replace(/&/g, "&amp;").replace(/</g, "&lt;").replace(/>/g, "&gt;").replace(/"/g, "&quot;").replace(/'/g, "&#x27;").replace(/\//g, "&#x2F;");
function Ft() {
  return typeof navigator < "u" && navigator.languages ? navigator.languages[0].replace(/@posix$/i, "") : new ve().resolvedOptions().locale;
}
function Ut(s, e = 2) {
...
function Jt(s, e, t) {
  ...
  return i.id = `${Le}${t ? `-${t}` : ""}`, i.dataset.themeId = s.id, i.textContent = Ve(s), this.document.head.appendChild(i), i;
}
function le(s) {
  return Object.freeze(s), s == null || Object.getOwnPropertyNames(s).forEach(function(t) {
    ...
    s[t] !== null && (typeof s[t] == "object" || typeof s[t] == "function") && !Object.isFrozen(s[t]) && le(s[t]);
  }), s;
}
const H = le({
  version: "3.0.7",
...
}), U = ["figure", "note", "sidebar", "table"];
Object.freeze(U);
const ue = ["para", "table", "table:row", "table:cell", "sidebar"];
Object.freeze(ue);
const ze = "chapter", He = new RegExp(`^${ie}\\d+$`), Je = /\u00A0/g, Ke = /\w+(\d+)/, Ge = /(\d+)-?(\d+)?/;
class f {
  constructor(e, t) {
    y(this, "usj");
    y(this, "markersMap");
    ...
    if (r)
      this.markersMap = r, f.areUsjVersionsCompatible(this.usj.version, this.markersMap.version) || console.warn(
...
USJ: ${JSON.stringify(
    ...
    else if (f.areUsjVersionsCompatible(this.usj.version, H.version))
      this.markersMap = H;
    else
      throw new Error(
  ...
  findSingleValue(e) {
    const t = F({ path: e, json: this.usj, wrap: !0 });
    if (t === void 0 || t.length === 0) return;
    if (!Array.isArray(t[0])) return t[0];
    const r = F({ path: e, json: this.usj, wrap: !1 });
  ...
  static isTopLevelUsjMarker(e, t) {
    return typeof e == "object" && e.type === be && t.length === 0;
  }
  /**
  ...
  static createParentMapInternal(e, t, r) {
    ...
    r.set(e, t), e.content && r.set(e.content, e), (i = e.content) == null || i.forEach((n) => {
      typeof n == "object" && f.createParentMapInternal(n, e, r);
    });
  }
  ...
  findAllNotes() {
    var e;
    return Ae((e = this.usj) == null ? void 0 : e.content);
  }
  /**
  ...
  static findNextMatchingNodeOrClosingFragmentUsingWorkingStack(e, t, r, i) {
    ...
    if (!x(c)) {
      ...
      t.some((l) => {
        ...
        return !x(h) && r.includes(h.type) ? (d = h, !0) : !1;
      }), d && (n = d);
    }
    for (; n !== void 0; ) {
  ...
  findNextMatchingNode(e, t) {
    ...
    let i = r;
    const n = f.findNextMatchingNodeUsingWorkingStack(
      e.node,
      r,
      [],
      (c, p) => (i = p, t({
        node: c,
        documentLocation: f.convertNodeToUsjDocumentLocation(c, p)
      }))
    );
    if (n !== void 0)
      return {
        node: n,
        documentLocation: f.convertNodeToUsjDocumentLocation(
          n,
          i
        )
      };
  ...
  nodeToUsjNodeAndDocumentLocation(e, t) {
    ...
    const i = f.convertNodeToUsjDocumentLocation(e, r);
    return {
      node: e,
      documentLocation: i
    };
  ...
  jsonPathToNodeAndParentIfString(e) {
    ...
    const r = x(t) ? this.findParent(e) : void 0;
    if (!r && x(t))
  ...
  usjDocumentLocationToUsfmVerseRefVerseLocation(e, t) {
    ...
    return {
      ...
      offset: r.indexInUsfm - n + f.getOffsetInUsjDocumentLocation(e)
    };
  }
  ...
  getEffectiveBookId(e) {
    const t = Object.keys(this.indicesInUsfmByVerseRef), r = t.length === 0 || t.length === 1 && t[0] === $, i = r ? $ : e;
    if (!this.indicesInUsfmByVerseRef[i])
      throw new Error(
        `Book ID ${e} not found in USJ! ${r ? `There seems to be no USJ content because there is no content in ${$} either` : `Book IDs in USJ: ${JSON.stringify(t)}`}`
      );
    return i;
  }
  /**
  ...
  getVerseRefForIndexInUsfm(e, t) {
    ...
    return d && f.isFragmentAMarker(d.fragment) && d.fragment.type === A && d.fragment.number && d.fragment.number !== `${n.verseNum}` && (n.verse = d.fragment.number), n;
  }
  usfmVerseLocationToIndexInUsfm(e) {
    const { verseRef: t, offset: r } = f.usfmVerseLocationToUsfmVerseRefVerseLocation(e);
  ...
  usfmVerseLocationToUsjNodeAndDocumentLocation(e) {
    const { verseRef: t, offset: r } = f.usfmVerseLocationToUsfmVerseRefVerseLocation(e), i = this.usfmVerseLocationToIndexInUsfm(e), { value: n } = this.fragmentsByIndexInUsfm.findClosestLessThanOrEqual(
      i
    ) ?? {
      value: void 0
    };
  ...
  static isUsjDocumentLocationForNode(e) {
    ...
    if ("node" in e) {
      if (x(e.node))
        return f.isUsjDocumentLocationForTextContent(e);
      t = e.documentLocation;
    }
  ...
  findNextLocationOfMatchingText(e, t, r = 1e3) {
    ...
    if (f.findNextMatchingNodeUsingWorkingStack(
      ...
      (u, g) => {
        ...
        if (l && f.areStackItemsShallowEqual(M, l)) {
    ...
    n = 0;
    let h = 0, b = [];
    const m = f.findNextMatchingNodeUsingWorkingStack(
      e.node,
    ...
    if (!x(m))
      throw new Error(
        `Somehow found non-string node while searching for strings: ${JSON.stringify(m)}`
      );
    return {
      node: m,
      documentLocation: {
        jsonPath: f.convertWorkingStackToJsonPath(b),
        offset: h
      }
    };
  }
  ...
  static findNearestBlockAncestor(e) {
    for (let t = e.length - 1; t >= 0; t--) {
      const { parent: r } = e[t];
      if (r && "type" in r && ue.includes(r.type)) return r;
    }
  }
  /**
  ...
  search(e, t) {
    const r = t instanceof Set ? t : t == null ? void 0 : t.markerStylesToInclude, i = t instanceof Set || t == null ? void 0 : t.normalizationForm, n = t instanceof Set ? !1 : !!(t != null && t.flexibleWhitespaceAtBlockBoundaries), c = [];
    if (this.usj.content.length === 0) return c;
    const p = {
      node: this.usj,
      documentLocation: {
        jsonPath: "$"
      }
    }, d = [], l = new X(), h = e.source.includes(`(?<${ie}`), b = n && h, m = /* @__PURE__ */ new Set();
    let u, g = !1, k = !1, M = !1, E = 0, v = p.node;
    for (; v !== void 0; )
      v = f.findNextMatchingNodeUsingWorkingStack(
        p.node,
        this.convertJsonPathToWorkingStack(p.documentLocation.jsonPath),
        [],
        // We need to use variables from outside the function to keep track of our current position
        // eslint-disable-next-line no-loop-func
        (_, j) => {
          if (typeof _ != "string")
            return b && _ && "type" in _ && _.type === ze && (k = !0), !1;
          if (r && j.some((B) => {
            const P = B.parent;
            if (!P || !("type" in P) || P.type === "char") return !1;
            let N;
            return "style" in P && typeof P.style == "string" ? N = P.style : "marker" in P && typeof P.marker == "string" && (N = P.marker), N !== void 0 && !r.has(N);
          }))
            return b && (M = !0), !1;
          if (b) {
            const q = f.findNearestBlockAncestor(j);
            g && q !== u && !k && !M && m.add(E), u = q, g = !0, k = !1, M = !1;
          }
          return d.push(_), l.set(E, {
            node: _,
            documentLocation: {
              offset: 0,
              jsonPath: f.convertWorkingStackToJsonPath(j)
            }
          }), E += _.length, !1;
        }
      );
    const T = d.join(""), I = i === "NFD" ? f.buildNFDToOriginalPositionMap(T) : void 0, C = I ? T.normalize("NFD") : T, S = b && !e.flags.includes("d") ? new RegExp(e.source, `${e.flags}d`) : e;
    let w = S.exec(C);
    for (; w; )
      if (w[0].length === 0) {
        if (!S.global || S.lastIndex >= C.length) {
          S.lastIndex = 0;
          break;
        }
        S.lastIndex = f.advancePastCodePoint(
          C,
          S.lastIndex
        ), w = S.exec(C);
      } else if (
        ...
        b && f.hasWhitespaceGapAwayFromBoundary(
          w,
          m,
          I
        )
        ...
        S.lastIndex = f.advancePastCodePoint(C, w.index), w = S.exec(C);
      } else {
        const _ = I ? I[w.index] : w.index, j = I ? I[w.index + w[0].length] : w.index + w[0].length;
        if (_ < 0 || _ >= T.length)
          throw new Error(`Match index out of bounds: ${_}`);
        const q = l.findClosestLessThanOrEqual(_);
        if (!q)
          throw new Error(`Internal error: no starting node found for index ${_}`);
        const B = {
          node: q.value.node,
          documentLocation: {
            jsonPath: q.value.documentLocation.jsonPath,
            offset: _ - q.key
          }
        }, P = l.findClosestLessThanOrEqual(j - 1);
        if (!P)
          throw new Error(`Internal error: no ending node found for index ${_}`);
        const N = {
          node: P.value.node,
          documentLocation: {
        ...
        }, he = I ? T.substring(_, j) : w[0];
        if (c.push({ text: he, start: B, end: N }), !S.global) break;
        w = S.exec(C);
      }
    return c;
  }
  ...
  extractTextBetweenPoints(e, t, r = 100) {
    ...
    return f.findNextMatchingNodeUsingWorkingStack(
      ...
      this.convertJsonPathToWorkingStack(e.documentLocation.jsonPath),
      U,
      (n, c) => n === t.node && (typeof n == "object" || t.documentLocation.jsonPath === f.convertWorkingStackToJsonPath(c)) ? !0 : typeof n != "string" ? !1 : (i = `${i}${n}`, i.length > r && (i = i.substring(0, r)), i.length >= r)
    ), i;
  }
  ...
  getInfoForMarker(e, t = "usfm") {
    ...
    const c = (n == null ? void 0 : n.type) ?? (x(e) ? "" : e.type);
    let p = r;
    ...
    if (l != null && l.markerTypeUsfm && (d = l.markerTypeUsfm, l = this.markersMap.markerTypes[d]), !x(e) && e.type !== c && (!l || e.type !== l.markerTypeUsfm && e.type !== l.markerTypeUsx && e.type !== l.markerTypeUsj) && (console.warn(
    ...
    const h = [];
    n.attributeMarkers && n.attributeMarkers.forEach((m) => {
      const u = this.getMarkerInfo(m);
      u && "attributeMarkerAttributeName" in u && h.push([m, u]);
    });
    const b = e;
    if (t === "usfm" && d === "cell" && b.colspan) {
      const m = parseInt(b.colspan, 10), u = Ke.exec(r);
      if (u != null && u[1]) {
        const g = parseInt(u[1], 10);
        !Number.isNaN(g) && !Number.isNaN(m) && (p = `${r}-${g + m - 1}`, l = {
          ...l,
...
`);
    ...
    return i.push({ fragment: e, indexInUsfm: r.length }), r += p === "optbreak" ? "//" : `\\${b}`, p !== "optbreak" && (i.push({
    ...
    }), r += `${n}${p === "unmatched" ? "" : " "}`), c.leadingAttributes && c.leadingAttributes.forEach((m) => {
      const u = h[m];
      u && (i.push({
      ...
      indexInUsfm: r.length
    }), r += `${h[c.textContentAttribute]} `), c.attributeMarkers && l.forEach(([m, u]) => {
      ...
      const { usfm: E } = this.textContentToUsfm(g);
      i.push({
        fragment: {
        ...
        if (x(v.fragment) || "attributeKey" in v.fragment)
          throw new Error(
        ...
        if (f.isFragmentAMarker(v.fragment)) {
          i.push({
            ...v,
            fragment: {
        ...
        if ("isClosingMarker" in v.fragment) {
          const { isClosingMarker: T, ...I } = v.fragment, C = {
            ...I,
            forMarker: e,
  ...
  closingMarkerToUsfm(e, t) {
    const {
      ...
      return !(g === "type" || g === "marker" || g === "content" || g === "closed" || (k = p.skipOutputAttributeToUsfm) != null && k.includes(g) || (M = n.leadingAttributes) != null && M.includes(g) || n.textContentAttribute === g || d.some(
        ([, E]) => E.attributeMarkerAttributeName === g
      ));
    }), h = e;
    ...
    if ((h.closed === "false" || n.isClosingMarkerOptional && !this.markersMap.shouldOptionalClosingMarkersBePresent && h.closed !== "true") && (b = !1), n.independentClosingMarkers && n.independentClosingMarkers.length > 0 && b) {
      ...
      let k = "";
      const M = [], { usfm: E, fragmentsInfo: v } = this.openingMarkerToUsfm(g, t), T = v.find((I) => f.isFragmentAMarker(I.fragment));
      if (!T)
        throw new Error(
      ...
      }), k += E, r !== g.marker && (k = this.addMarkerUsfmToString(
        k,
        {
          isClosingMarker: !0,
          forMarker: g
    ...
    let m = "";
    const u = [];
    if (l.length > 0 && (m += "|", l.length === 1 && l[0] === n.defaultAttribute ? (u.push({
      fragment: { attributeValueForKey: n.defaultAttribute, forMarker: e },
      indexInUsfm: m.length
    }), m += h[n.defaultAttribute]) : l.forEach((g, k) => {
  ...
  addMarkerUsfmToString(e, t, r, i) {
    ...
    if (typeof r == "boolean")
      ...
      const { markerType: m } = this.getInfoForMarker(
        r
      );
      m === l && (b = !0);
    }
    if ("isClosingMarker" in t) {
      const { usfm: m, fragmentsInfo: u } = this.closingMarkerToUsfm(
        t.forMarker,
        b
      );
      p = u, c = m, h.isCloseable && h.isClosingMarkerEmpty && // No contents
      (!t.forMarker.content || t.forMarker.content.length === 0) && // No closing marker attributes
      !c.startsWith("|") && (n = f.removeEndSpace(n));
    } else {
      const { usfm: m, fragmentsInfo: u } = this.openingMarkerToUsfm(
        t,
        b
      );
      p = u, c = m;
    ...
    if (c.startsWith(`
`) && (n.length === 0 ? (p = p.map((m) => ({
      ...m,
      indexInUsfm: m.indexInUsfm - 1
    })), c = c.substring(1)) : n = f.removeEndSpace(n)), this.markersMap.isSpaceAfterAttributeMarkersContent && d === "ca") {
      const m = n.lastIndexOf("\\");
      m >= 0 && n.substring(
        m + 1,
        m + 3
      ) === "c " && (n = f.removeEndSpace(n), n += `
 `);
    }
    return i && f.mergeFragmentsInfoIntoExistingArray(
      p,
      i,
      n.length
    ), n += c, n;
  ...
  static areUsjDocumentLocationsEqual(e, t, r = !1) {
    ...
    return !r && !z(F.toPathArray(i), F.toPathArray(c)) ? !1 : z(n, p);
  }
  ...
  findFragmentInfoAtUsjDocumentLocation(e) {
    ...
    if (i)
      return i.find((n) => f.areUsjDocumentLocationsEqual(
        n.nodeAndDocumentLocation.documentLocation,
        t,
  ...
  static convertNodeToUsjDocumentLocation(e, t, r = 0) {
    const i = f.convertWorkingStackToJsonPath(t);
    return x(e) ? { jsonPath: i, offset: r } : { jsonPath: i };
  }
  /**
  ...
  static convertFragmentToUsjNodeAndDocumentLocation(e, t, r = 0) {
    if (x(e) || f.isFragmentAMarker(e)) {
      const i = f.convertNodeToUsjDocumentLocation(
        e,
        t,
        r
      );
  ...
  static transferFragmentsInfoArrayToMaps(e, t, r, i, n, c) {
    e.map((d) => {
      ...
      if (typeof d.fragment == "object" && "type" in d.fragment) {
        const u = d.fragment;
        if (u.type === Te && u.code)
          r.bookId = u.code, r.chapterNum = 0, r.verseNum = 0, c[$] && (c[r.bookId] = c[$], delete c[$]);
        else if (u.type === Q && u.number) {
          const g = parseInt(u.number, 10);
          if (Number.isNaN(g))
            console.warn(
              `Found ${Q} type marker with number ${u.number}, but could not parse chapter number from it. Continuing using previous chapter number ${r.chapterNum}`
            );
          else {
        ...
        } else if (u.type === A && u.number) {
          const g = (h = Ge.exec(u.number)) == null ? void 0 : h[1];
          if (!g)
            console.warn(
              `Found ${A} type marker with number ${u.number}, but could not find starting verse number in it. Continuing using previous verse number ${r.verseNum}`
            );
          else {
            const k = parseInt(g, 10);
            Number.isNaN(k) ? console.warn(
              `Found ${A} type marker with number ${u.number}, but could not parse starting verse number from ${g}. Continuing using previous verse number ${r.verseNum}`
            ) : (m = (b = c[r.bookId]) == null ? void 0 : b[r.chapterNum]) != null && m[k] ? console.warn(`Found ${A} marker with existing number ${k} after
                  current ${A} number ${r.verseNum}! Not updating verse start index. All positions in this duplicate verse will be based on the current ${A} marker, not the new duplicate marker.`) : (k < r.verseNum && console.debug(
              `Found ${A} marker with number ${k} lower than current ${A} number ${r.verseNum}. Verses are out of order. There may be some issues.`
            ), r.verseNum = k);
          }
        }
      }
  ...
  calculateUsfmProperties() {
    let e = "";
    const t = new X(), r = /* @__PURE__ */ new Map(), i = {}, n = [], c = {
      bookId: $,
      chapterNum: 0,
      verseNum: 0
    };
    ...
    return f.findNextMatchingNodeOrClosingFragmentUsingWorkingStack(
      ...
      (h, b) => {
        ...
        let m;
        return b.length > 0 && (m = b[b.length - 1].parent), "isClosingMarker" in h ? l.length > 0 && l[l.length - 1] === h.forMarker ? (l.pop(), !1) : (e = this.addMarkerUsfmToString(
          e,
          h,
          m,
          n
        ), p(b), h.forMarker.type === "book" && d && (e = this.addMarkerUsfmToString(e, d, m, n), p(b), d = void 0), !1) : this.shouldSkipOutputMarkerToUsfm(h) ? (l.push(h), !1) : f.isTopLevelUsjMarker(h, b) && !d ? (h.version !== "3.0" && (d = h), !1) : (e = this.addMarkerUsfmToString(e, h, m, n), p(b), !1);
      }
...
export {
  ...
  ve as DateTimeFormat,
  _e as DocumentCombiner,
  nt as EventRollingTimeCounter,
  ft as FAILED_PRECONDITION,
  Wt as FIRST_SCR_BOOK_NUM,
  Zt as FIRST_SCR_CHAPTER_NUM,
  Qt as FIRST_SCR_VERSE_NUM,
  er as GraphemeString,
  mt as INTERNAL,
  gt as INVALID_ARGUMENT,
  tr as LAST_SCR_BOOK_NUM,
  rr as MAX_PADDING_LENGTH,
  Lt as MODIFIER_KEYS,
  a as MarkerType,
  Ie as Mutex,
  it as MutexMap,
  ...
  Kt as USFM_MARKERS_MAP_PARATEXT_3_0,
  ct as UnsubscriberAsyncList,
  f as UsjReaderWriter,
  A as VERSE_TYPE,
  St as aggregateUnsubscriberAsyncs,
  Pt as aggregateUnsubscribers,
  Jt as applyThemeStylesheet,
  sr as areUsjContentsEqualExceptWhitespace,
  ar as at,
  or as charAt,
  cr as codePointAt,
  dr as collapseMiddleWords,
  pr as collectUsjMarkers,
  lr as compareScrRefs,
  ...
  fr as defaultScrRef,
  $e as deserialize,
  zt as doesCatalogRowCoverProject,
  mr as endsWith,
  gr as ensureArray,
  yr as escapeStringRegexp,
  Ht as expandThemeContribution,
  Ut as formatBytes,
  Dt as formatRelativeDate,
  kr as formatReplacementString,
  br as formatReplacementStringToArray,
  vr as formatScrRef,
  Mr as formatScrRefRange,
  Ot as formatTimeSpan,
  xr as getAllObjectFunctionNames,
  _r as getChaptersForBook,
  Ft as getCurrentLocale,
  ae as getDefaultCallerSequence,
  Er as getErrorMessage,
  qt as getFormatCallerFunction,
  Bt as getLocalizeKeyForPhysicalKey,
  Ir as getLocalizeKeyForScrollGroupId,
  ...
  $r as isErrorMessageAboutRegistryAuthFailure,
  jr as isLocalizeKey,
  wt as isPlatformError,
  Nr as isSelectableInvisibleCharOrWhiteSpace,
  ...
  Lr as normalizeScriptureSpaces,
  Br as offsetBook,
  Vr as offsetChapter,
  zr as offsetVerse,
  Hr as ordinalCompare,
  Jr as padEnd,
  Kr as padStart,
  Fe as projectSettingsDocumentSchema,
  Gr as retryUntil,
  At as sanitizeHtml,
  ...
  rn as toArray,
  nn as toKebabCase,
  sn as transformAndEnsureRegExpArray,
  an as transformAndEnsureRegExpRegExpArray,
  se as usfmMarkers,
  on as wait,
