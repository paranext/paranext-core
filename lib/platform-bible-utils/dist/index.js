...
const We = "ABORTED", Ze = "ALREADY_EXISTS", Qe = "CANCELLED", et = "DATA_LOSS", tt = "DEADLINE_EXCEEDED", rt = "FAILED_PRECONDITION", nt = "INTERNAL", it = "INVALID_ARGUMENT", st = "NOT_FOUND", at = "OUT_OF_RANGE", ot = "PERMISSION_DENIED", ct = "RESOURCE_EXHAUSTED", dt = "UNAUTHENTICATED", pt = "UNAVAILABLE", lt = "UNIMPLEMENTED", ut = "UNKNOWN", A = 1;
function ht(i, e) {
  if (!i)
    return {
      message: "",
...
function Ut(i, e, t) {
  ...
  return s.id = `${qe}${t ? `-${t}` : ""}`, s.dataset.themeId = i.id, s.textContent = $e(i), this.document.head.appendChild(s), s;
}
function ne(i) {
...
export {
  ...
  At as makeProjectSelectorCustomData,
