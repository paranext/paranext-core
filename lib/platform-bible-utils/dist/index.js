...
var Q = typeof globalThis < "u" ? globalThis : typeof window < "u" ? window : typeof global < "u" ? global : typeof self < "u" ? self : {}, C = {}, nt = () => {
  const t = "\\ud800-\\udfff", e = "\\u0300-\\u036f", r = "\\ufe20-\\ufe2f", s = "\\u20d0-\\u20ff", n = "\\u1ab0-\\u1aff", i = "\\u1dc0-\\u1dff", o = e + r + s + n + i, a = "\\ufe0e\\ufe0f", h = "\\uD83D\\uDC69\\uD83C\\uDFFB\\u200D\\uD83C\\uDF93", p = `[${t}]`, u = `[${o}]`, c = "\\ud83c[\\udffb-\\udfff]", m = `(?:${u}|${c})`, v = `[^${t}]`, b = "(?:\\uD83C[\\uDDE6-\\uDDFF]){2}", P = "[\\ud800-\\udbff][\\udc00-\\udfff]", q = "\\u200d", Ce = "(?:\\ud83c\\udff4\\udb40\\udc67\\udb40\\udc62\\udb40(?:\\udc65|\\udc73|\\udc77)\\udb40(?:\\udc6e|\\udc63|\\udc6c)\\udb40(?:\\udc67|\\udc74|\\udc73)\\udb40\\udc7f)", Ie = `[${h}]`, L = `${m}?`, H = `[${a}]?`, Ae = `(?:${q}(?:${[v, b, P].join("|")})${H + L})*`, Te = H + L + Ae, Pe = `(?:${[`${v}${u}?`, u, b, P, p, Ie].join("|")})`;
...
function Kt(t) {
  ...
  return function(u, c, m) {
    ...
    if (v === Set)
      return a(u, c, m);
    var b = Ft(u);
    return b === Mt ? r(u, c, m) : b === zt ? o(u, c, m) : b === kt ? s(u, c, m) : b === Jt ? a(u, c, m) : b === qt ? typeof u.then != "function" && typeof c.then != "function" && n(u, c, m) : b === Dt ? n(u, c, m) : b === Rt || b === Vt || b === Gt ? i(u, c, m) : !1;
  };
}
function Xt(t) {
...
function O(t) {
  t === void 0 && (t = {});
  var e = t.circular, r = e === void 0 ? !1 : e, s = t.createInternalComparator, n = t.createState, i = t.strict, o = i === void 0 ? !1 : i, a = Xt(t), h = Kt(a), p = s ? s(h) : Lt(h);
