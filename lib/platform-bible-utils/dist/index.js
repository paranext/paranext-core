...
var ae = (t, e, r) => e in t ? ne(t, e, { enumerable: !0, configurable: !0, writable: !0, value: r }) : t[e] = r;
...
class he {
  ...
  constructor(e, r) {
    ...
    d(this, "latestOutput");
    d(this, "options");
    d(this, "onDidRebuildEmitter", new le());
...
], be = 1, ye = L.length - 1, ve = 1, $e = 1, Ne = (t) => {
  var e;
  return ((e = L[t]) == null ? void 0 : e.chapters) ?? -1;
}, Ot = (t, e) => ({
  bookNum: Math.max(be, Math.min(t.bookNum + e, ye)),
  chapterNum: 1,
  verseNum: 1
}), St = (t, e) => ({
  ...t,
  chapterNum: Math.min(
    Math.max(ve, t.chapterNum + e),
    Ne(t.bookNum)
  ),
  verseNum: 1
}), Pt = (t, e) => ({
  ...t,
  verseNum: Math.max($e, t.verseNum + e)
}), At = (t) => (...e) => t.map((s) => s(...e)).every((s) => s), Ct = (t) => async (...e) => {
  const r = t.map(async (s) => s(...e));
  return (await Promise.all(r)).every((s) => s);
};
var I = typeof globalThis < "u" ? globalThis : typeof window < "u" ? window : typeof global < "u" ? global : typeof self < "u" ? self : {}, y = {}, we = () => {
  const t = "\\ud800-\\udfff", e = "\\u0300-\\u036f", r = "\\ufe20-\\ufe2f", s = "\\u20d0-\\u20ff", i = "\\u1ab0-\\u1aff", o = "\\u1dc0-\\u1dff", n = e + r + s + i + o, a = "\\ufe0e\\ufe0f", c = "\\uD83D\\uDC69\\uD83C\\uDFFB\\u200D\\uD83C\\uDF93", p = `[${t}]`, u = `[${n}]`, l = "\\ud83c[\\udffb-\\udfff]", f = `(?:${u}|${l})`, g = `[^${t}]`, m = "(?:\\uD83C[\\uDDE6-\\uDDFF]){2}", $ = "[\\ud800-\\udbff][\\udc00-\\udfff]", P = "\\u200d", te = "(?:\\ud83c\\udff4\\udb40\\udc67\\udb40\\udc62\\udb40(?:\\udc65|\\udc73|\\udc77)\\udb40(?:\\udc6e|\\udc63|\\udc6c)\\udb40(?:\\udc67|\\udc74|\\udc73)\\udb40\\udc7f)", re = `[${c}]`, T = `${f}?`, x = `[${a}]?`, se = `(?:${P}(?:${[g, m, $].join("|")})${x + T})*`, ie = x + T + se, oe = `(?:${[`${g}${u}?`, u, m, $, p, re].join("|")})`;
  return new RegExp(`${te}|${l}(?=${l})|${oe + ie}`, "g");
}, Ee = I && I.__importDefault || function(t) {
...
function zt(t, e, r = " ") {
  return e <= h(t) ? t : X(t, e, r, "right");
}
function Rt(t, e, r = " ") {
  return e <= h(t) ? t : X(t, e, r, "left");
}
function B(t, e) {
...
function Bt(t, e, r) {
  ...
  if (r !== void 0 && r <= 0)
    return [t];
  if (e === "")
    return xe(t).slice(0, r);
  let i = e;
  (typeof e == "string" || e instanceof RegExp && !De(e.flags, "g")) && (i = new RegExp(e, "g"));
  const o = t.match(i);
  let n = 0;
  if (!o)
    return [t];
  for (let a = 0; a < (r ? r - 1 : o.length); a++) {
    const c = q(t, o[a], n), p = h(o[a]);
    if (s.push(j(t, n, c)), n = c + p, r !== void 0 && s.length === r)
      break;
  }
  return s.push(j(t, n)), s;
}
function Gt(t, e, r = 0) {
  return q(t, e, r) === r;
}
...
function j(t, e, r = h(t)) {
  return Se(t, e, r);
}
function xe(t) {
  return je(t);
}
var ze = Object.getOwnPropertyNames, Re = Object.getOwnPropertySymbols, Ie = Object.prototype.hasOwnProperty;
function G(t, e) {
...
function V(t) {
  return ze(t).concat(Re(t));
}
var Q = Object.hasOwn || function(t, e) {
  return Ie.call(t, e);
};
function v(t, e) {
  return t || e ? t === e : t === e || t !== t && e !== e;
}
var Y = "_owner", K = Object.getOwnPropertyDescriptor, k = Object.keys;
function Be(t, e, r) {
  var s = t.length;
  if (e.length !== s)
    return !1;
...
function J(t, e, r) {
  ...
  for (var s = {}, i = t.entries(), o = 0, n, a; (n = i.next()) && !n.done; ) {
    for (var c = e.entries(), p = !1, u = 0; (a = c.next()) && !a.done; ) {
      var l = n.value, f = l[0], g = l[1], m = a.value, $ = m[0], P = m[1];
      !p && !s[u] && (p = r.equals(f, $, o, u, t, e, r) && r.equals(g, P, f, $, t, e, r)) && (s[u] = !0), u++;
    }
    if (!p)
      return !1;
    o++;
...
function Ve(t, e, r) {
  var s = k(t), i = s.length;
  if (k(e).length !== i)
    return !1;
  for (var o; i-- > 0; )
    if (o = s[i], o === Y && (t.$$typeof || e.$$typeof) && t.$$typeof !== e.$$typeof || !Q(e, o) || !r.equals(t[o], e[o], o, o, t, e, r))
      return !1;
  return !0;
}
function N(t, e, r) {
  var s = V(t), i = s.length;
  if (V(e).length !== i)
    return !1;
  for (var o, n, a; i-- > 0; )
    if (o = s[i], o === Y && (t.$$typeof || e.$$typeof) && t.$$typeof !== e.$$typeof || !Q(e, o) || !r.equals(t[o], e[o], o, o, t, e, r) || (n = K(t, o), a = K(e, o), (n || a) && (!n || !a || n.configurable !== a.configurable || n.enumerable !== a.enumerable || n.writable !== a.writable)))
      return !1;
  return !0;
}
function Ke(t, e) {
...
function _(t, e, r) {
  ...
  for (var s = {}, i = t.values(), o, n; (o = i.next()) && !o.done; ) {
    for (var a = e.values(), c = !1, p = 0; (n = a.next()) && !n.done; )
      !c && !s[p] && (c = r.equals(o.value, n.value, o.value, n.value, t, e, r)) && (s[p] = !0), p++;
    if (!c)
      return !1;
  }
  return !0;
...
var _e = "[object Arguments]", Ue = "[object Boolean]", Fe = "[object Date]", He = "[object Map]", We = "[object Number]", Le = "[object Object]", Ze = "[object RegExp]", Xe = "[object Set]", Qe = "[object String]", Ye = Array.isArray, U = typeof ArrayBuffer == "function" && ArrayBuffer.isView ? ArrayBuffer.isView : null, F = Object.assign, et = Object.prototype.toString.call.bind(Object.prototype.toString);
function tt(t) {
  var e = t.areArraysEqual, r = t.areDatesEqual, s = t.areMapsEqual, i = t.areObjectsEqual, o = t.arePrimitiveWrappersEqual, n = t.areRegExpsEqual, a = t.areSetsEqual, c = t.areTypedArraysEqual;
  return function(u, l, f) {
    ...
    if (g === Set)
      return a(u, l, f);
    var m = et(u);
    return m === Fe ? r(u, l, f) : m === Ze ? n(u, l, f) : m === He ? s(u, l, f) : m === Xe ? a(u, l, f) : m === Le ? typeof u.then != "function" && typeof l.then != "function" && i(u, l, f) : m === _e ? i(u, l, f) : m === Ue || m === We || m === Qe ? o(u, l, f) : !1;
  };
}
function rt(t) {
  var e = t.circular, r = t.createCustomConfig, s = t.strict, i = {
    areArraysEqual: s ? N : Be,
    areDatesEqual: Ge,
    areMapsEqual: s ? G(J, N) : J,
    areObjectsEqual: s ? N : Ve,
    arePrimitiveWrappersEqual: Ke,
    areRegExpsEqual: ke,
    areSetsEqual: s ? G(_, N) : _,
    areTypedArraysEqual: s ? N : Je
  };
  if (r && (i = F({}, i, r(i))), e) {
    var o = E(i.areArraysEqual), n = E(i.areMapsEqual), a = E(i.areObjectsEqual), c = E(i.areSetsEqual);
    i = F({}, i, {
      areArraysEqual: o,
      areMapsEqual: n,
      areObjectsEqual: a,
...
function b(t) {
  t === void 0 && (t = {});
  var e = t.circular, r = e === void 0 ? !1 : e, s = t.createInternalComparator, i = t.createState, o = t.strict, n = o === void 0 ? !1 : o, a = rt(t), c = tt(a), p = s ? s(c) : st(c);
  return it({ circular: r, comparator: c, createState: i, equals: p, strict: n });
}
function Vt(t, e) {
  return ot(t, e);
}
...
const kt = (t) => t.replace(/&/g, "&amp;").replace(/</g, "&lt;").replace(/>/g, "&gt;").replace(/"/g, "&quot;").replace(/'/g, "&#x27;").replace(/\//g, "&#x2F;"), M = {
...
export {
  ...
  be as FIRST_SCR_BOOK_NUM,
  ve as FIRST_SCR_CHAPTER_NUM,
  $e as FIRST_SCR_VERSE_NUM,
  ye as LAST_SCR_BOOK_NUM,
  ge as Mutex,
  jt as MutexMap,
  ...
  nt as deserialize,
  Tt as endsWith,
  $t as getAllObjectFunctionNames,
