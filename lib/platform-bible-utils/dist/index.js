...
var Q = (o, e, t) => e in o ? Z(o, e, { enumerable: !0, configurable: !0, writable: !0, value: t }) : o[e] = t;
var k = (o, e, t) => Q(o, typeof e != "symbol" ? e + "" : e, t);
...
import { deepEqual as re } from "fast-equals";
import { USJ_TYPE as ne } from "@eten-tech-foundation/scripture-utilities";
...
class Re {
  ...
  get(e) {
    ...
    return t || (t = new de(), this.mutexesByID.set(e, t), t);
  }
  /**
...
class Le {
  ...
  cleanupPromiseChain(e) {
    ...
    if (!t) return;
    const r = { promise: le }, i = t.catch((n) => this.logger.warn(`Error in promise for ${e}: ${n.message}`)).finally(() => {
...
function pt(o) {
  var e;
  return ((e = H[o]) == null ? void 0 : e.type) === s.Paragraph || o === "v";
}
function lt(o) {
  const e = H[o];
...
function he(o, e) {
  const t = e && e.length > 0 ? e : J();
  return t[o % t.length];
}
function ht(o, e) {
  const t = e && e.length > 0 ? e : J(), r = (() => {
...
function yt() {
  return typeof navigator < "u" && navigator.languages ? navigator.languages[0].replace(/@posix$/i, "") : new ie().resolvedOptions().locale;
}
function kt(o, e = 2) {
...
const ye = 1e3, K = 60, G = K * 60, ke = G * 24;
...
function W(o) {
  return Object.freeze(o), o == null || Object.getOwnPropertyNames(o).forEach(function(t) {
    ...
    o[t] !== null && (typeof o[t] == "object" || typeof o[t] == "function") && !Object.isFrozen(o[t]) && W(o[t]);
  }), o;
}
const F = W({
  version: "3.0.7",
...
class g {
  ...
  static isTopLevelUsjMarker(e, t) {
    return typeof e == "object" && e.type === ne && t.length === 0;
  }
  /**
  ...
  findNextLocationOfMatchingText(e, t, r = 1e3) {
    ...
    if (g.findNextMatchingNodeUsingWorkingStack(
      ...
      (h, f) => {
        ...
        if (p && g.areStackItemsShallowEqual(M, p)) {
  ...
  search(e, t) {
    ...
    for (; f; ) {
      if (f[0].length > 0) {
        ...
        }, x = l.findClosestLessThanOrEqual(M - 1);
        if (!x)
  ...
  getInfoForMarker(e, t = "usfm") {
    ...
    if (p != null && p.markerTypeUsfm && (l = p.markerTypeUsfm, p = this.markersMap.markerTypes[l]), !_(e) && e.type !== c && (!p || e.type !== p.markerTypeUsfm && e.type !== p.markerTypeUsx && e.type !== p.markerTypeUsj) && (this.reportProblemOnce(
      `Mismatching marker type in the USJ content ${e.type} vs marker type in the marker info ${n.type} for marker ${r}. Using the type from the USJ content.`
...
`);
    ...
    return i.push({ fragment: e, indexInUsfm: r.length }), r += d === "optbreak" ? "//" : `\\${b}`, d !== "optbreak" && (i.push({
      ...
      i.push({
        ...
        if ("isClosingMarker" in v.fragment) {
          const { isClosingMarker: x, ...E } = v.fragment, j = {
            ...E,
            forMarker: e,
  ...
  closingMarkerToUsfm(e, t) {
    const {
      ...
      var y, M;
      return !(f === "type" || f === "marker" || f === "content" || f === "closed" || (y = d.skipOutputAttributeToUsfm) != null && y.includes(f) || (M = n.leadingAttributes) != null && M.includes(f) || n.textContentAttribute === f || l.some(
    ...
    if ((m.closed === "false" || n.isClosingMarkerOptional && !this.markersMap.shouldOptionalClosingMarkersBePresent && m.closed !== "true") && (b = !1), n.independentClosingMarkers && n.independentClosingMarkers.length > 0 && b) {
      ...
      let y = "";
      const M = [], { usfm: I, fragmentsInfo: v } = this.openingMarkerToUsfm(f, t), x = v.find((E) => g.isFragmentAMarker(E.fragment));
      if (!x)
        throw new Error(
  ...
  transferFragmentsInfoArrayToMaps(e, t, r, i, n, c) {
    e.map((l) => {
      ...
      if (typeof l.fragment == "object" && "type" in l.fragment) {
        ...
        if (h.type === ue && h.code)
        ...
        else if (h.type === B && h.number) {
          const f = parseInt(h.number, 10);
          if (Number.isNaN(f))
            this.reportProblemOnce(
              `Found ${B} type marker with number ${h.number}, but could not parse chapter number from it. Continuing using previous chapter number ${r.chapterNum}`
            );
          else {
          ...
          if (!f)
            ...
            Number.isNaN(y) ? this.reportProblemOnce(
            ...
            ) : (u = (b = c[r.bookId]) == null ? void 0 : b[r.chapterNum]) != null && u[y] ? this.reportProblemOnce(`Found ${w} marker with existing number ${y} after
...
export {
  ...
  ie as DateTimeFormat,
  oe as DocumentCombiner,
