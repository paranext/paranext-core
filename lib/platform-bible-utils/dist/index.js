...
function kr() {
  ...
  var O = n(v), N = o("[", O, n(/[-.0-9\xB7]/), n(/[\u0300-\u036F\u203F-\u2040]/), "]"), y = o(v, N, "*"), j = o(N, "+"), R = o("&", y, ";"), F = a(/&#[0-9]+;|&#x[0-9a-fA-F]+;/), U = a(R, "|", F), ne = o("%", y, ";"), le = a(
    o('"', a(/[^%&"]/, "|", ne, "|", U), "*", '"'),
    "|",
    o("'", a(/[^%&']/, "|", ne, "|", U), "*", "'")
  ), E = a('"', a(/[^<&"]/, "|", U), "*", '"', "|", "'", a(/[^<&']/, "|", U), "*", "'"), x = i(v, ":"), k = i(N, ":"), z = o(x, k, "*"), K = o(z, a(":", z), "?"), ee = o("^", K, "$"), Ie = o("(", K, ")"), te = a(/"[^"]*"|'[^']*'/), Be = o(/^<\?/, "(", y, ")", a(g, "(", p, "*?)"), "?", /\?>/), d = /[\x20\x0D\x0Aa-zA-Z0-9-'()+,./:=?;!*#@$_%]/, b = a('"', d, '*"', "|", "'", i(d, "'"), "*'"), w = "<!--", C = "-->", M = o(w, a(i(p, "-"), "|", o("-", i(p, "-"))), "*", C), A = "#PCDATA", B = a(
    o(/\(/, l, A, a(l, /\|/, l, K), "*", l, /\)\*/),
    "|",
    o(/\(/, l, A, l, /\)/)
  ), J = /[?*+]?/, _ = o(
  ...
  ), T = a("EMPTY", "|", "ANY", "|", B, "|", _), I = "<!ELEMENT", L = o(I, g, a(K, "|", ne), g, a(T, "|", ne), l, ">"), V = o("NOTATION", g, /\(/, l, y, a(l, /\|/, l, y), "*", l, /\)/), fe = o(/\(/, l, j, a(l, /\|/, l, j), "*", l, /\)/), we = a(V, "|", fe), ve = a(/CDATA|ID|IDREF|IDREFS|ENTITY|ENTITIES|NMTOKEN|NMTOKENS/, "|", we), ie = a(/#REQUIRED|#IMPLIED/, "|", a(a("#FIXED", g), "?", E)), P = a(g, y, g, ve, g, ie), Ue = "<!ATTLIST", Re = o(Ue, g, y, P, "*", l, ">"), pe = "about:legacy-compat", Ve = a('"' + pe + '"', "|", "'" + pe + "'"), _e = "SYSTEM", Se = "PUBLIC", ke = a(a(_e, g, te), "|", a(Se, g, b, g, te)), He = o(
    "^",
    a(
...
function Fr() {
  ...
  function qe(r, u, s, c) {
    ...
    switch (r.nodeType) {
      case z:
        var X = r.attributes, ae = X.length, me = r.firstChild, de = r.tagName, Ce = de;
        if (!S && !r.prefix && r.namespaceURI) {
          for (var Ee, Ze = 0; Ze < X.length; Ze++)
    ...
    switch (u.childNodes && (c.childNodes = new T()), c.ownerDocument = r, c.nodeType) {
      case z:
        ...
        for (var Ce = 0; Ce < de; Ce++)
          c.setAttributeNode(kt(r, X.item(Ce), !0));
        break;
      case K:
        s = !0;
    }
...
function bn() {
  if (or) return Ct;
  or = 1;
  var t = Dt(), e = kr(), n = _t(), i = t.isHTMLEscapableRawTextElement, o = t.isHTMLMimeType, a = t.isHTMLRawTextElement, h = t.hasOwn, p = t.NAMESPACE, f = n.ParseError, m = n.DOMException, g = 0, l = 1, v = 2, O = 3, N = 4, y = 5, j = 6, R = 7;
  function F() {
  }
  F.prototype = {
  ...
  function ne(d, b, w, C, M) {
    ...
    function _(q) {
      if (q > ie) {
        var Z = d.substring(ie, q).replace(U, J);
      ...
      try {
        ...
        if (P < 0) {
          ...
          if (!d.substring(ie).match(/^\s*$/)) {
            var Ue = C.doc, Re = Ue.createTextNode(d.substring(ie));
        ...
        switch (d.charAt(P + 1)) {
          ...
          default:
            V && fe(P);
            var Q = new Be(), ze = we[we.length - 1].currentNSMap, oe = E(d, P, Q, ze, J, M, A), Xe = Q.length;
            if (Q.closed || (A && t.isHTMLVoidElement(Q.tagName) ? Q.closed = !0 : ve.push(Q.tagName)), V && Xe) {
              ...
              x(Q, C, ze) && we.push(Q);
            A && !Q.closed ? oe = k(d, oe, Q.tagName, J, C) : oe++;
        }
      } catch (q) {
        if (q instanceof f)
          throw q;
        ...
        case '"':
          if (L === O || L === l)
            if (L === l && (A.warning('attribute value must after "="'), _ = d.slice(b, I)), b = I + 1, I = d.indexOf(V, b), I > 0)
              T = d.slice(b, I), J(_, T, b - 1), L = y;
            else
              throw new Error("attribute value no end '" + V + "' match");
          else if (L == N)
            T = d.slice(b, I), J(_, T, b), A.warning('attribute "' + _ + '" missed start quot(' + V + ")!!"), b = I + 1, L = y;
          else
  ...
  function x(d, b, w) {
    for (var C = d.tagName, M = null, L = d.length; L--; ) {
      ...
      A.localName = T, I !== !1 && (M == null && (M = /* @__PURE__ */ Object.create(null), z(w, w = /* @__PURE__ */ Object.create(null))), w[I] = M[I] = J, A.uri = p.XMLNS, b.startPrefixMapping(I, J));
    }
  ...
  function k(d, b, w, C, M) {
    var A = i(w);
    if (A || a(w)) {
      var B = d.indexOf("</" + w + ">", b), J = d.substring(b + 1, B);
  ...
  y.prototype = {
    ...
    startElement: function(E, x, k, z) {
      ...
      for (var te = 0; te < Ie; te++) {
        ...
        this.locator && j(z.getLocator(te), d), d.value = d.nodeValue = Be, ee.setAttributeNode(d);
      }
    },
...
function Cn() {
  return cr || (cr = 1, $t = () => {
    const t = "\\ud800-\\udfff", h = "\\u0300-\\u036f" + "\\ufe20-\\ufe2f" + "\\u20d0-\\u20ff" + "\\u1ab0-\\u1aff" + "\\u1dc0-\\u1dff", p = "\\ufe0e\\ufe0f", f = "\\uD83D\\uDC69\\uD83C\\uDFFB\\u200D\\uD83C\\uDF93", m = `[${t}]`, g = `[${h}]`, l = "\\ud83c[\\udffb-\\udfff]", v = `(?:${g}|${l})`, O = `[^${t}]`, N = "(?:\\uD83C[\\uDDE6-\\uDDFF]){2}", y = "[\\ud800-\\udbff][\\udc00-\\udfff]", j = "\\u200d", R = "(?:\\ud83c\\udff4\\udb40\\udc67\\udb40\\udc62\\udb40(?:\\udc65|\\udc73|\\udc77)\\udb40(?:\\udc6e|\\udc63|\\udc6c)\\udb40(?:\\udc67|\\udc74|\\udc73)\\udb40\\udc7f)", F = `[${f}]`, U = `${v}?`, ne = `[${p}]?`, le = `(?:${j}(?:${[O, N, y].join("|")})${ne + U})*`, E = ne + U + le, k = `(?:${[`${O}${g}?`, g, N, y, m, F].join("|")})`;
...
const Ut = ["chapter", "book", "para", "row", "sidebar", jt], Rn = "​", jr = [
...
], _n = 1, Pn = jr.length - 1, Ln = 1, kn = 1, gi = {
  book: "GEN",
  chapterNum: 1,
  verseNum: 1
}, Fn = (t) => {
...
function gr(t) {
  ...
  for (let o = 0; o < t.length; o += 1) {
    const a = t[o];
    a.charCodeAt(0) < 32 ? (n || (e += " "), n = !0) : !n && a === Rn && o + 1 < t.length && mr(t[o + 1]) || (mr(a) ? (n || (e += a), n = !0) : Un(a) && i === a || (e += a, n = !1)), i = a;
  }
  return e;
}
function Er(t) {
...
const wi = (t) => (...e) => t.map((i) => i(...e)).every((i) => i), Si = (t) => async (...e) => {
...
var Jn = "__v", Xn = "__o", Yn = "_owner", br = Object.getOwnPropertyDescriptor, Nr = Object.keys;
function Wn(t, e, n) {
  var i = t.length;
  if (e.length !== i)
    return !1;
...
function Vr(t, e, n, i) {
  return (i === Yn || i === Xn || i === Jn) && (t.$$typeof || e.$$typeof) ? !0 : Hn(e, i) && n.equals(t[i], e[i], i, i, t, e, n);
}
...
function vu(t) {
  ...
  return function(N, y, j) {
    ...
    if (R !== typeof y)
      return !1;
    if (R !== "object")
      return R === "number" ? h(N, y, j) : R === "function" ? o(N, y, j) : !1;
    var F = N.constructor;
    if (F !== y.constructor)
      return !1;
    if (F === Object)
    ...
    if (F === Set)
      return g(N, y, j);
    var U = Du(N);
    return U === su ? n(N, y, j) : U === hu ? m(N, y, j) : U === lu ? a(N, y, j) : U === du ? g(N, y, j) : U === pu ? typeof N.then != "function" && typeof y.then != "function" && p(N, y, j) : U === gu ? v(N, y, j) : U === cu ? i(N, y, j) : U === ou ? p(N, y, j) : U === au || U === fu || U === mu ? f(N, y, j) : !1;
  };
}
function Au(t) {
...
const Ii = (t) => t.replace(/&/g, "&amp;").replace(/</g, "&lt;").replace(/>/g, "&gt;").replace(/"/g, "&quot;").replace(/'/g, "&#x27;").replace(/\//g, "&#x2F;");
function xi() {
...
function Bi(t, e, n = /* @__PURE__ */ new Date()) {
...
function _i(t, e, n) {
  ...
  return o.id = `${_u}${n ? `-${n}` : ""}`, o.dataset.themeId = t.id, o.textContent = Lu(t), this.document.head.appendChild(o), o;
}
...
class ge {
  ...
  nodeToVerseRefAndOffset(e, n, i) {
    ...
    return a.startingContentNode !== void 0 && this.findNextMatchingNode(a.startingContentNode, [], (f, m) => {
      var g, l;
      return f === n ? !0 : m.find((v) => je.includes(v.parent.type)) ? !1 : typeof f == "string" ? (p += f.length, !1) : f.type === Mt && f.number !== ((g = a.chapterNum) == null ? void 0 : g.toString()) || f.type === Bt && f.number !== ((l = a.verseNum) == null ? void 0 : l.toString()) ? (p = 0, !0) : !1;
    }), { verseRef: h, offset: p };
  }
  // #endregion
...
export {
  ...
  un as Mutex,
  Ku as MutexMap,
  Qu as NonValidatingDocumentCombiner,
  on as NumberFormat,
  ...
  Bt as VERSE_TYPE,
  Si as aggregateUnsubscriberAsyncs,
  wi as aggregateUnsubscribers,
  _i as applyThemeStylesheet,
  Ti as areUsjContentsEqualExceptWhitespace,
  xt as at,
  gt as charAt,
  ii as codePointAt,
  Ni as compareScrRefs,
  ...
  Ri as expandThemeContribution,
  Mi as formatBytes,
  oi as formatReplacementString,
  On as formatReplacementStringToArray,
  Ci as formatScrRef,
  Bi as formatTimeSpan,
  Hu as getAllObjectFunctionNames,
  Fn as getChaptersForBook,
  xi as getCurrentLocale,
  ...
  Lu as getStylesheetForTheme,
  zu as groupBy,
  Ii as htmlEncode,
  In as includes,
  St as indexOf,
  Xu as isErrorMessageAboutParatextBlockingInternetAccess,
  Yu as isErrorMessageAboutRegistryAuthFailure,
  fi as isLocalizeKey,
  ri as isPlatformError,
  Oi as isSerializable,
  Me as isString,
  Tu as isSubset,
  mt as isWhiteSpace,
  xn as lastIndexOf,
  ...
  Uu as newGuid,
  ti as newPlatformError,
  ai as normalize,
  gr as normalizeScriptureSpaces,
  Ei as offsetBook,
  Di as offsetChapter,
  vi as offsetVerse,
  si as ordinalCompare,
  ci as padEnd,
  li as padStart,
