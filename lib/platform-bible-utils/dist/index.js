...
var $ = /* @__PURE__ */ ((t) => (t[t.Unknown = 0] = "Unknown", t[t.Original = 1] = "Original", t[t.Septuagint = 2] = "Septuagint", t[t.Vulgate = 3] = "Vulgate", t[t.English = 4] = "English", t[t.RussianProtestant = 5] = "RussianProtestant", t[t.RussianOrthodox = 6] = "RussianOrthodox", t))($ || {});
const N = class {
...
const Tr = (t) => (...e) => t.map((s) => s(...e)).every((s) => s), Ar = (t) => async (...e) => {
...
var $e = "_owner", ne = Object.getOwnPropertyDescriptor, ie = Object.keys;
function $t(t, e, r) {
  var s = t.length;
  if (e.length !== s)
    return !1;
...
function St(t, e, r) {
  ...
  if (ie(e).length !== n)
    return !1;
  for (var i; n-- > 0; )
    if (i = s[n], i === $e && (t.$$typeof || e.$$typeof) && t.$$typeof !== e.$$typeof || !Ee(e, i) || !r.equals(t[i], e[i], i, i, t, e, r))
      return !1;
  return !0;
}
function M(t, e, r) {
  ...
  if (se(e).length !== n)
    return !1;
  for (var i, o, a; n-- > 0; )
    if (i = s[n], i === $e && (t.$$typeof || e.$$typeof) && t.$$typeof !== e.$$typeof || !Ee(e, i) || !r.equals(t[i], e[i], i, i, t, e, r) || (o = ne(t, i), a = ne(e, i), (o || a) && (!o || !a || o.configurable !== a.configurable || o.enumerable !== a.enumerable || o.writable !== a.writable)))
      return !1;
  return !0;
}
function jt(t, e) {
