...
var xe = (n, e, t) => e in n ? Ne(n, e, { enumerable: !0, configurable: !0, writable: !0, value: t }) : n[e] = t;
var g = (n, e, t) => xe(n, typeof e != "symbol" ? e + "" : e, t);
...
import { length as Ie, indexOf as Me, limit as ae, substring as Se, toArray as Ae, substr as Ee } from "stringz";
...
class Gt {
  ...
  cleanupPromiseChain(e) {
    ...
    if (!t) return;
    const r = { promise: Re }, i = t.catch((s) => this.logger.warn(`Error in promise for ${e}: ${s.message}`)).finally(() => {
...
function T(n, e) {
  return e < 0 || e > k(n) - 1 ? "" : B(n, e, 1);
}
function Wt(n, e) {
  if (!(e < 0 || e > k(n) - 1))
    return B(n, e, 1).codePointAt(0);
}
function Ve(n, e, t = k(n)) {
  const r = Ke(n, e);
  return !(r === -1 || r + k(e) !== t);
}
function Je(n, e, t) {
...
function ze(n, e) {
  ...
  let r = 0, i = 0;
  function s(a, l, c) {
    const u = S(n, i, l), d = t.length > 0 && b(t[t.length - 1]) ? `${t.pop()}${u}` : u;
    b(a) ? t.push(`${d}${a}`) : (d && t.push(d), t.push(a)), i = l + c;
  }
  const o = k(n);
  for (; r < o; ) {
    switch (T(n, r)) {
...
function Ke(n, e, t) {
  let r = t === void 0 ? k(n) : t;
  r < 0 ? r = 0 : r >= k(n) && (r = k(n) - 1);
  for (let i = r; i >= 0; i--)
    if (B(n, i, k(e)) === e)
      return i;
  return -1;
...
function tr(n, e, t = " ") {
  return e <= k(n) ? n : ae(n, e, t, "right");
}
function rr(n, e, t = " ") {
  return e <= k(n) ? n : ae(n, e, t, "left");
}
function Y(n, e) {
...
function _(n, e, t) {
  ...
  if (e > r || t && (e > t && !(e >= 0 && e < r && t < 0 && t > -r) || t < -r))
    return "";
  const i = Y(r, e), s = t ? Y(r, t) : void 0;
  return S(n, i, s);
}
function W(n, e, t) {
  const r = [];
...
function B(n, e = 0, t = k(n) - e) {
  return Ee(n, e, t);
}
function S(n, e, t = k(n)) {
  return Se(n, e, t);
}
function Ge(n) {
  return Ae(n);
...
const R = ["chapter", "book", "para", "row", "sidebar", oe], Xe = "​", pe = [
...
], Ye = 1, _e = pe.length - 1, We = 1, Ze = 1, lr = {
  book: "GEN",
  chapterNum: 1,
  verseNum: 1
}, Qe = (n) => {
  ...
  book: x.bookNumberToId(
    Math.max(
      Ye,
      Math.min(x.bookIdToNumber(n.book) + e, _e)
    )
  ),
  chapterNum: 1,
  verseNum: 1
  ...
  ...n,
  chapterNum: Math.min(
    Math.max(We, n.chapterNum + e),
    Qe(x.bookIdToNumber(n.book))
  ),
  verseNum: 1
}), pr = (n, e) => ({
  ...n,
  verseNum: Math.max(Ze, n.verseNum + e)
});
...
function V(n, e) {
  const t = rt(n, e == null ? void 0 : e.optionOrLocalizedBookName), r = nt(
    n,
...
function yr(n, e, t) {
  const r = V(n, t);
  if (et(n, e) === 0) return r;
  const i = n.book === e.book && !(t != null && t.repeatBookName) ? "" : (t == null ? void 0 : t.endRefOptionOrLocalizedBookName) ?? (t == null ? void 0 : t.optionOrLocalizedBookName), s = V(e, {
    ...t,
    optionOrLocalizedBookName: i
  });
  return `${r}${(t == null ? void 0 : t.rangeSeparator) ?? " - "}${s}`;
}
var st = /* @__PURE__ */ ((n) => (n.OT = "OT", n.NT = "NT", n.DC = "DC", n.Extra = "Extra", n))(st || {});
const br = (n) => {
...
function ee(n) {
  ...
  for (let i = 0; i < n.length; i += 1) {
    const s = n[i];
    s.charCodeAt(0) < 32 ? (t || (e += " "), t = !0) : !t && s === Xe && i + 1 < n.length && Q(n[i + 1]) || (Q(s) ? (t || (e += s), t = !0) : at(s) && r === s || (e += s, t = !1)), r = s;
  }
  return e;
}
function te(n) {
...
function re(n, e) {
  if (!e || !R.includes(e.type)) return !1;
  if (!e.content)
    throw new Error(
...
function de(n, e, t, r) {
  ...
  if (i && s) {
    ...
    if (o !== a) {
      ...
      let l = o;
      for (; E(D(l, -1) ?? ""); ) l = _(l, 0, -1);
      let c = a;
      for (; E(D(c, -1) ?? ""); ) c = _(c, 0, -1);
      if (l !== c) return !1;
    }
  } else if (!i && !s) {
    ...
    if (l.length !== Object.keys(a).filter((d) => d !== "content").length || l.some((d) => !(d in a) || o[d] !== a[d])) return !1;
    const c = te(o.content), u = te(a.content);
    if (c !== u) return !1;
    if (!c && !u) {
      let d = o.content, f = a.content;
      const p = d[d.length - 1];
      R.includes(o.type) && b(p) && E(p) && (d = d.slice(0, -1));
      const m = f[f.length - 1];
      if (R.includes(a.type) && b(m) && E(m) && (f = f.slice(0, -1)), d.length !== f.length) return !1;
...
const kr = (n) => (...e) => n.map((r) => r(...e)).every((r) => r), Nr = (n) => async (...e) => {
  const t = n.map(async (r) => r(...e));
  return (await Promise.all(t)).every((r) => r);
}, ct = "book", ne = "chapter", I = "verse", M = "***";
function xr(n) {
...
function lt(n, e) {
  const t = e && e.length > 0 ? e : he();
  return t[n % t.length];
}
function wr(n, e) {
  const t = e && e.length > 0 ? e : he(), r = (() => {
    const i = /* @__PURE__ */ new Map();
    let s = 0;
    return n.forEach((o, a) => {
      o.caller === "+" && (i.set(a, lt(s, t)), s += 1);
    }), i;
  })();
  return (i, s) => {
    if (i === "+") {
...
function ft(n, e) {
  ...
  return Object.keys(t).forEach((s) => {
    i && (Object.hasOwn(r, s) && ft(r[s], t[s]) || (i = !1));
  }), i;
}
function se(n, e, t) {
...
const dt = 1e3, me = 60, ge = me * 60, ht = ge * 24;
function Tr(n, e, t = /* @__PURE__ */ new Date()) {
  const r = Math.floor((e.getTime() - t.getTime()) / dt), i = Math.round(r / ht);
  if (Math.abs(i) >= 1) return n.format(i, "day");
  const s = Math.round(r / ge);
  if (Math.abs(s) >= 1) return n.format(s, "hour");
  const o = Math.round(r / me);
...
function Cr(n, e, t) {
  ...
  return i.id = `${kt}${t ? `-${t}` : ""}`, i.dataset.themeId = n.id, i.textContent = xt(n), this.document.head.appendChild(i), i;
}
function ve(n) {
...
class h {
  constructor(e, t) {
    ...
    if (r)
      this.markersMap = r, h.areUsjVersionsCompatible(this.usj.version, this.markersMap.version) || console.warn(
...
USJ: ${JSON.stringify(
    ...
    else if (h.areUsjVersionsCompatible(this.usj.version, z.version))
      this.markersMap = z;
    else
      throw new Error(
  ...
  static createParentMapInternal(e, t, r) {
    ...
    r.set(e, t), e.content && r.set(e.content, e), (i = e.content) == null || i.forEach((s) => {
      typeof s == "object" && h.createParentMapInternal(s, e, r);
    });
  }
  ...
  findAllNotes() {
    var e;
    return ut((e = this.usj) == null ? void 0 : e.content);
  }
  /**
  ...
  findNextMatchingNode(e, t) {
    ...
    let i = r;
    const s = h.findNextMatchingNodeUsingWorkingStack(
      e.node,
      r,
      [],
      (o, a) => (i = a, t({
        node: o,
        documentLocation: h.convertNodeToUsjDocumentLocation(o, a)
      }))
    );
    if (s !== void 0)
      return {
        node: s,
        documentLocation: h.convertNodeToUsjDocumentLocation(
          s,
          i
        )
      };
  ...
  nodeToUsjNodeAndDocumentLocation(e, t) {
    ...
    const i = h.convertNodeToUsjDocumentLocation(e, r);
    return {
      node: e,
      documentLocation: i
    };
  ...
  usjDocumentLocationToUsfmVerseRefVerseLocation(e, t) {
    ...
    return {
      ...
      offset: r.indexInUsfm - s + h.getOffsetInUsjDocumentLocation(e)
    };
  }
  ...
  getVerseRefForIndexInUsfm(e, t) {
    ...
    return l && h.isFragmentAMarker(l.fragment) && l.fragment.type === I && l.fragment.number && l.fragment.number !== `${s.verseNum}` && (s.verse = l.fragment.number), s;
  }
  usfmVerseLocationToIndexInUsfm(e) {
    const { verseRef: t, offset: r } = h.usfmVerseLocationToUsfmVerseRefVerseLocation(e);
  ...
  usfmVerseLocationToUsjNodeAndDocumentLocation(e) {
    const { verseRef: t, offset: r } = h.usfmVerseLocationToUsfmVerseRefVerseLocation(e), i = this.usfmVerseLocationToIndexInUsfm(e), { value: s } = this.fragmentsByIndexInUsfm.findClosestLessThanOrEqual(
      i
    ) ?? {
      value: void 0
    };
  ...
  findNextLocationOfMatchingText(e, t, r = 1e3) {
    ...
    if (h.findNextMatchingNodeUsingWorkingStack(
      ...
      (p, m) => {
        ...
        if (c && h.areStackItemsShallowEqual(N, c)) {
    ...
    s = 0;
    let u = 0, d = [];
    const f = h.findNextMatchingNodeUsingWorkingStack(
      e.node,
      this.convertJsonPathToWorkingStack(e.documentLocation.jsonPath),
      $,
      (p, m) => typeof p != "string" || (s += p.length, s < a + 1) ? !1 : (u = a - s + p.length, d = m, !0)
    );
    ...
    return {
      node: f,
      documentLocation: {
        jsonPath: h.convertWorkingStackToJsonPath(d),
        offset: u
      }
    };
  }
  search(e) {
    ...
    let o = 0, a = r.node;
    for (; a !== void 0; )
      a = h.findNextMatchingNodeUsingWorkingStack(
        r.node,
        ...
        // eslint-disable-next-line no-loop-func
        (u, d) => (typeof u != "string" || (i.push(u), s.set(o, {
          node: u,
          documentLocation: {
            offset: 0,
            jsonPath: h.convertWorkingStackToJsonPath(d)
  ...
  extractTextBetweenPoints(e, t, r = 100) {
    ...
    return h.findNextMatchingNodeUsingWorkingStack(
      ...
      this.convertJsonPathToWorkingStack(e.documentLocation.jsonPath),
      $,
      (s, o) => s === t.node && (typeof s == "object" || t.documentLocation.jsonPath === h.convertWorkingStackToJsonPath(o)) ? !0 : typeof s != "string" ? !1 : (i = `${i}${s}`, i.length > r && (i = i.substring(0, r)), i.length >= r)
    ), i;
  }
  ...
  getInfoForMarker(e, t = "usfm") {
    ...
    const d = e;
    if (t === "usfm" && l === "cell" && d.colspan) {
      const f = parseInt(d.colspan, 10), p = It.exec(r);
      if (p != null && p[1]) {
...
`);
    ...
    return i.push({ fragment: e, indexInUsfm: r.length }), r += a === "optbreak" ? "//" : `\\${d}`, a !== "optbreak" && (i.push({
      ...
      i.push({
        ...
        if (h.isFragmentAMarker(v.fragment)) {
          i.push({
            ...v,
            fragment: {
        ...
        if ("isClosingMarker" in v.fragment) {
          const { isClosingMarker: F, ...A } = v.fragment, ke = {
            ...A,
            forMarker: e,
  ...
  closingMarkerToUsfm(e, t) {
    ...
    if ((u.closed === "false" || s.isClosingMarkerOptional && !this.markersMap.shouldOptionalClosingMarkersBePresent && u.closed !== "true") && (d = !1), s.independentClosingMarkers && s.independentClosingMarkers.length > 0 && d) {
      ...
      let y = "";
      const N = [], { usfm: w, fragmentsInfo: v } = this.openingMarkerToUsfm(m, t), F = v.find((A) => h.isFragmentAMarker(A.fragment));
      if (!F)
        throw new Error(
  ...
  addMarkerUsfmToString(e, t, r, i) {
    ...
    if ("isClosingMarker" in t) {
      ...
      !o.startsWith("|") && (s = h.removeEndSpace(s));
    } else {
...
`) && (s.length === 0 ? (a = a.map((f) => ({
    ...
    })), o = o.substring(1)) : s = h.removeEndSpace(s)), this.markersMap.isSpaceAfterAttributeMarkersContent && l === "ca") {
      const f = s.lastIndexOf("\\");
      f >= 0 && e.substring(
        f + 1,
        f + 3
      ) === "c " && (s = h.removeEndSpace(s), s += `
 `);
    }
    return i && h.mergeFragmentsInfoIntoExistingArray(
      a,
      i,
      s.length
    ), s += o, s;
  ...
  findFragmentInfoAtUsjDocumentLocation(e) {
    ...
    if (i)
      return i.find((s) => h.areUsjDocumentLocationsEqual(
        s.nodeAndDocumentLocation.documentLocation,
        t,
  ...
  static convertNodeToUsjDocumentLocation(e, t, r = 0) {
    const i = h.convertWorkingStackToJsonPath(t);
  ...
  static convertFragmentToUsjNodeAndDocumentLocation(e, t, r = 0) {
    if (b(e) || h.isFragmentAMarker(e)) {
      const i = h.convertNodeToUsjDocumentLocation(
        e,
        t,
        r
      );
    ...
    e.map((l) => {
      ...
      if (typeof l.fragment == "object" && "type" in l.fragment) {
        ...
        if (p.type === ct && p.code)
          ...
          const m = (u = Mt.exec(p.number)) == null ? void 0 : u[1];
          if (!m)
            console.warn(
            ...
            ) : (f = (d = o[r.bookId]) == null ? void 0 : d[r.chapterNum]) != null && f[y] ? console.warn(`Found ${I} marker with existing number ${y} after
  ...
  calculateUsfmProperties() {
    ...
    return h.findNextMatchingNodeOrClosingFragmentUsingWorkingStack(
      ...
      (u, d) => {
        ...
        let f;
        return d.length > 0 && (f = d[d.length - 1].parent), "isClosingMarker" in u ? c.length > 0 && c[c.length - 1] === u.forMarker ? (c.pop(), !1) : (e = this.addMarkerUsfmToString(
          e,
          u,
          f,
          s
        ), a(d), u.forMarker.type === "book" && l && (e = this.addMarkerUsfmToString(e, l, f, s), a(d), l = void 0), !1) : this.shouldSkipOutputMarkerToUsfm(u) ? (c.push(u), !1) : h.isTopLevelUsjMarker(u, d) && !l ? (u.version !== "3.0" && (l = u), !1) : (e = this.addMarkerUsfmToString(e, u, f, s), a(d), !1);
      }
...
export {
  ...
  zt as EventRollingTimeCounter,
  Ye as FIRST_SCR_BOOK_NUM,
  We as FIRST_SCR_CHAPTER_NUM,
  Ze as FIRST_SCR_VERSE_NUM,
  _e as LAST_SCR_BOOK_NUM,
  $r as MODIFIER_KEYS,
  Le as Mutex,
  qt as MutexMap,
  ...
  E as isWhiteSpace,
  Ke as lastIndexOf,
  yt as localizedStringsDocumentSchema,
  bt as menuDocumentSchema,
  jt as newGuid,
  ...
  ir as transformAndEnsureRegExpRegExpArray,
  je as wait,
