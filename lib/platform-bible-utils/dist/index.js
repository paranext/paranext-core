...
function Gu(t) {
  const e = "401 Unauthorized error while getting shared projects.", n = "User registration is not valid. Cannot retrieve resources from DBL.", i = Me(t) ? t : Mr(t);
...
function Ku(t) {
  ...
  if (Me(t)) return { message: t, platformErrorVersion: Ot };
...
function kr() {
  ...
  var w = n(v), b = a("[", w, n(/[-.0-9\xB7]/), n(/[\u0300-\u036F\u203F-\u2040]/), "]"), C = a(v, b, "*"), k = a(b, "+"), R = a("&", C, ";"), F = o(/&#[0-9]+;|&#x[0-9a-fA-F]+;/), q = o(R, "|", F), ue = a("%", C, ";"), he = o(
    ...
    "|",
    a("'", o(/[^%&']/, "|", ue, "|", q), "*", "'")
  ), D = o('"', o(/[^<&"]/, "|", q), "*", '"', "|", "'", o(/[^<&']/, "|", q), "*", "'"), M = i(v, ":"), L = i(b, ":"), V = a(M, L, "*"), Y = a(V, o(":", V), "?"), ee = a("^", Y, "$"), we = a("(", Y, ")"), te = o(/"[^"]*"|'[^']*'/), Re = a(/^<\?/, "(", C, ")", o(E, "(", l, "*?)"), "?", /\?>/), d = /[\x20\x0D\x0Aa-zA-Z0-9-'()+,./:=?;!*#@$_%]/, A = o('"', d, '*"', "|", "'", i(d, "'"), "*'"), S = "<!--", O = "-->", B = a(S, o(i(l, "-"), "|", a("-", i(l, "-"))), "*", O), N = "#PCDATA", x = o(
    a(/\(/, f, N, o(f, /\|/, f, Y), "*", f, /\)\*/),
    "|",
    a(/\(/, f, N, f, /\)/)
  ), G = /[?*+]?/, _ = a(
  ...
  ), y = o("EMPTY", "|", "ANY", "|", x, "|", _), I = "<!ELEMENT", P = a(I, E, o(Y, "|", ue), E, o(y, "|", ue), f, ">"), re = a("NOTATION", E, /\(/, f, C, o(f, /\|/, f, C), "*", f, /\)/), K = a(/\(/, f, k, o(f, /\|/, f, k), "*", f, /\)/), Ce = o(re, "|", K), ye = o(/CDATA|ID|IDREF|IDREFS|ENTITY|ENTITIES|NMTOKEN|NMTOKENS/, "|", Ce), se = o(/#REQUIRED|#IMPLIED/, "|", o(o("#FIXED", E), "?", D)), oe = o(E, C, E, ye, E, se), j = "<!ATTLIST", ze = a(j, E, C, oe, "*", f, ">"), Ae = "SYSTEM", ce = "PUBLIC", xe = o(o(Ae, E, te), "|", o(ce, E, A, E, te)), Le = a(
    "^",
    o(
...
function qr() {
  ...
  j.prototype = {
    ...
    compareDocumentPosition: function(r) {
      ...
      for (var Oe in Se.childNodes) {
        ...
        if (ke === s) return x.DOCUMENT_POSITION_FOLLOWING;
        if (ke === u) return x.DOCUMENT_POSITION_PRECEDING;
        if (be.indexOf(ke) >= 0) return x.DOCUMENT_POSITION_FOLLOWING;
        if (de.indexOf(ke) >= 0) return x.DOCUMENT_POSITION_PRECEDING;
      }
      return 0;
    }
  };
  ...
  D(L, j), D(L, j.prototype), D(x, j), D(x, j.prototype);
  function Ae(r, u) {
    if (u(r))
      return !0;
    if (r = r.firstChild)
  ...
  }, ce.prototype.getElementsByClassName = De.prototype.getElementsByClassName, ce.prototype.getElementsByTagName = De.prototype.getElementsByTagName, ce.prototype.getElementsByTagNameNS = De.prototype.getElementsByTagNameNS, M(De, j);
  function Ne(r) {
    b(r), this.namespaceURI = null, this.prefix = null, this.ownerElement = null;
  }
  Ne.prototype.nodeType = Y, M(Ne, j);
  function Ue(r) {
    b(r);
  }
  Ue.prototype = {
  ...
  lt.prototype.nodeType = O, M(lt, j);
  function vt(r) {
    b(r);
  }
  vt.prototype.nodeType = N, M(vt, j);
  function At(r) {
    b(r);
  }
  At.prototype.nodeType = Re, M(At, j);
  function ft(r) {
    b(r);
  }
  ft.prototype.nodeType = te, M(ft, j);
  function Z(r) {
    b(r);
  }
  Z.prototype.nodeName = "#document-fragment", Z.prototype.nodeType = B, M(Z, j);
  function ae(r) {
    b(r);
  }
  ae.prototype.nodeType = d, M(ae, Ue);
  function Ve() {
  }
        ...
        switch (d.charAt(oe + 1)) {
          ...
          default:
            ...
            if (Q.closed || (N && t.isHTMLVoidElement(Q.tagName) ? Q.closed = !0 : ye.push(Q.tagName)), K && Je) {
              ...
              O.locator = at, M(Q, O, ge) && Ce.push(Q), O.locator = K;
            } else
              M(Q, O, ge) && Ce.push(Q);
        ...
        default:
          if (re <= " ")
            ...
            switch (P) {
              ...
              case v:
                x || N.warning('attribute "' + _ + '" missed value!! "' + _ + '" instead2!!'), G(_, _, A), A = I, P = f;
                break;
              case C:
...
`);
  ...
  b.prototype.parseFromString = function(D, M) {
    if (!p(M))
    ...
    h(M) ? (V = i.HTML_ENTITIES, Y = E.HTML) : M === m.XML_SVG_IMAGE && (Y = E.SVG), L[""] = Y, L.xml = L.xml || E.XML;
  ...
  function C(D) {
    var M = D || {};
    this.mimeType = M.mimeType || m.XML_APPLICATION, this.defaultNamespace = M.defaultNamespace || null, this.cdata = !1, this.currentElement = void 0, this.doc = void 0, this.locator = void 0, this.onError = M.onError;
  }
  function k(D, M) {
  ...
  C.prototype = {
    ...
    startElement: function(D, M, L, V) {
      var Y = this.doc, ee = Y.createElementNS(D, L || M), we = V.length;
    ...
    processingInstruction: function(D, M) {
      var L = this.doc.createProcessingInstruction(D, M);
      this.locator && k(this.locator, L), q(this, L);
    },
    ignorableWhitespace: function(D, M, L) {
    },
    characters: function(D, M, L) {
    ...
    startDTD: function(D, M, L, V) {
      var Y = this.doc.implementation;
      if (Y && Y.createDocumentType) {
        var ee = Y.createDocumentType(D, M, L, V);
    ...
    reportError: function(D, M) {
      if (typeof this.onError == "function")
        try {
          ...
          throw new f("Reporting " + D + ' "' + M + '" caused ' + L, this.locator);
        }
      else
        console.error("[xmldom " + D + "]	" + M, R(this.locator));
    },
    /**
...
@#[line:` + D.lineNumber + ",col:" + D.columnNumber + "]";
  ...
  function F(D, M, L) {
    return typeof D == "string" ? D.substr(M, L) : D.length >= M + L || M ? new java.lang.String(D, M, L) + "" : D;
  }
...
function On(t, e) {
  ...
  let i = 0, a = 0;
  function o(l, p, m) {
    const E = tt(t, a, p), f = n.length > 0 && Me(n[n.length - 1]) ? `${n.pop()}${E}` : E;
    Me(l) ? n.push(`${f}${l}`) : (f && n.push(f), n.push(l)), a = p + m;
  }
  const h = pe(t);
  for (; i < h; ) {
    switch (Et(t, i)) {
  ...
  if (a < h) {
    const l = tt(t, a);
    n.push(
      n.length > 0 && Me(n[n.length - 1]) ? `${n.pop()}${l}` : l
    );
  }
  return n;
}
...
function Vr(t, e, n, i) {
  ...
  if (a && o) {
    ...
    if (!m && !E) {
      ...
      $t.includes(h.type) && Me(w) && mt(w) && (f = f.slice(0, -1));
      const b = v[v.length - 1];
      if ($t.includes(l.type) && Me(b) && mt(b) && (v = v.slice(0, -1)), f.length !== v.length) return !1;
...
const vi = (t) => (...e) => t.map((i) => i(...e)).every((i) => i), Ai = (t) => async (...e) => {
...
function Au(t) {
  ...
  if (n && (a = Or({}, a, n(a))), e) {
    var o = xt(a.areArraysEqual), h = xt(a.areMapsEqual), l = xt(a.areObjectsEqual), p = xt(a.areSetsEqual);
    a = Or({}, a, {
      areArraysEqual: o,
      areMapsEqual: h,
      areObjectsEqual: l,
...
function Ti(t, e, n = /* @__PURE__ */ new Date()) {
...
class Ee {
  ...
  nodeToVerseRefAndOffset(e, n, i) {
    ...
    return o.startingContentNode !== void 0 && this.findNextMatchingNode(o.startingContentNode, [], (p, m) => {
      var E, f;
      return p === n ? !0 : m.find((v) => qe.includes(v.parent.type)) ? !1 : typeof p == "string" ? (l += p.length, !1) : p.type === Mt && p.number !== ((E = o.chapterNum) == null ? void 0 : E.toString()) || p.type === Rt && p.number !== ((f = o.verseNum) == null ? void 0 : f.toString()) ? (l = 0, !0) : !1;
    }), { verseRef: h, offset: l };
  }
  // #endregion
  ...
  verseRefToUsjContentLocation(e, n = 0) {
    ...
    const l = e.verse, p = this.findNextMatchingNode(
      a,
      qe,
      (v, w) => v === a ? e.verseNum === 0 ? (h = Ee.convertWorkingStackToJsonPath(w), !0) : !1 : typeof v != "object" ? !1 : v.type === Mt ? (o = !0, !0) : v.type === Rt && v.number !== void 0 && v.number === l ? (h = Ee.convertWorkingStackToJsonPath(w), !0) : !1
    );
...
export {
  ...
  Rt as VERSE_TYPE,
  Ai as aggregateUnsubscriberAsyncs,
  vi as aggregateUnsubscribers,
  Di as areUsjContentsEqualExceptWhitespace,
  It as at,
  Et as charAt,
  Zu as codePointAt,
  mi as compareScrRefs,
