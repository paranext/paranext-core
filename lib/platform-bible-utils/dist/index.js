...
var w = (e, t, r) => Qn(e, typeof t != "symbol" ? t + "" : t, r);
...
class iu {
  ...
  constructor(t, r) {
    ...
    w(this, "latestOutput");
    w(this, "options");
    w(this, "onDidRebuildEmitter", new tu());
...
class Ta {
  ...
  cleanupPromiseChain(t) {
    ...
    if (!r) return;
    const n = { promise: cu }, u = r.catch((i) => this.logger.warn(`Error in promise for ${t}: ${i.message}`)).finally(() => {
...
var lu = Object.defineProperty, fu = (e, t, r) => t in e ? lu(e, t, { enumerable: !0, configurable: !0, writable: !0, value: r }) : e[t] = r, D = (e, t, r) => fu(e, typeof t != "symbol" ? t + "" : t, r);
const de = [
  "GEN",
  "EXO",
  "LEV",
...
var mr = typeof globalThis < "u" ? globalThis : typeof window < "u" ? window : typeof global < "u" ? global : typeof self < "u" ? self : {}, De = {}, bu = () => {
...
}, yu = mr && mr.__importDefault || function(e) {
...
function gr(e, t, r) {
  ...
  let u = t;
  (typeof t == "string" || t instanceof RegExp && !Fu(t.flags, "g")) && (u = new RegExp(t, "g"));
  const i = e.match(u);
  let a = 0;
  if (!i) return [e];
...
const an = [
...
], ku = 1, qu = an.length - 1, $u = 1, ju = 1, $a = {
  bookNum: 1,
  chapterNum: 1,
  verseNum: 1
}, Uu = (e) => {
  ...
  bookNum: Math.max(ku, Math.min(e.bookNum + t, qu)),
  chapterNum: 1,
  verseNum: 1
}), Ua = (e, t) => ({
  ...e,
  chapterNum: Math.min(
    Math.max($u, e.chapterNum + t),
    Uu(e.bookNum)
  ),
  verseNum: 1
}), Va = (e, t) => ({
  ...e,
  verseNum: Math.max(ju, e.verseNum + t)
});
...
const Xa = (e) => (...t) => e.map((n) => n(...t)).every((n) => n), Ya = (e) => async (...t) => {
  const r = e.map(async (n) => n(...t));
  return (await Promise.all(r)).every((n) => n);
}, pt = "chapter", ht = "verse";
var Hu = Object.getOwnPropertyNames, Gu = Object.getOwnPropertySymbols, zu = Object.prototype.hasOwnProperty;
function vr(e, t) {
...
var Zu = "[object Arguments]", ei = "[object Boolean]", ti = "[object Date]", ri = "[object Map]", ni = "[object Number]", ui = "[object Object]", ii = "[object RegExp]", oi = "[object Set]", ai = "[object String]", si = Array.isArray, Tr = typeof ArrayBuffer == "function" && ArrayBuffer.isView ? ArrayBuffer.isView : null, wr = Object.assign, ci = Object.prototype.toString.call.bind(Object.prototype.toString);
function li(e) {
  ...
  return function(l, f, p) {
    ...
    if (m === Set)
      return o(l, f, p);
    var b = ci(l);
    return b === ti ? r(l, f, p) : b === ii ? a(l, f, p) : b === ri ? n(l, f, p) : b === oi ? o(l, f, p) : b === ui ? typeof l.then != "function" && typeof f.then != "function" && u(l, f, p) : b === Zu ? u(l, f, p) : b === ei || b === ni || b === ai ? i(l, f, p) : !1;
  };
}
function fi(e) {
  var t = e.circular, r = e.createCustomConfig, n = e.strict, u = {
    areArraysEqual: n ? Ue : Ju,
    areDatesEqual: Xu,
    areMapsEqual: n ? vr(yr, Ue) : yr,
    areObjectsEqual: n ? Ue : Yu,
    arePrimitiveWrappersEqual: Ku,
    areRegExpsEqual: Wu,
    areSetsEqual: n ? vr(Cr, Ue) : Cr,
    areTypedArraysEqual: n ? Ue : Qu
  };
  if (r && (u = wr({}, u, r(u))), t) {
...
function fe(e) {
  e === void 0 && (e = {});
  var t = e.circular, r = t === void 0 ? !1 : t, n = e.createInternalComparator, u = e.createState, i = e.strict, a = i === void 0 ? !1 : i, o = fi(e), s = li(o), c = n ? n(s) : pi(s);
  return hi({ circular: r, comparator: s, createState: u, equals: c, strict: a });
}
function mi(e, t) {
  return di(e, t);
}
function Ei(e, t) {
  ...
  return Object.keys(r).forEach((i) => {
    u && (Object.hasOwn(n, i) && Ei(n[i], r[i]) || (u = !1));
  }), u;
}
function Sr(e, t, r) {
...
const Wa = (e) => e.replace(/&/g, "&amp;").replace(/</g, "&lt;").replace(/>/g, "&gt;").replace(/"/g, "&quot;").replace(/'/g, "&#x27;").replace(/\//g, "&#x2F;");
function Qa() {
...
}), Ii = Object.keys(We).map(function(e) {
  return We[e];
});
function Bi(e) {
...
x.hasDefaultHTMLNamespace = Oi;
x.hasOwn = ve;
x.isHTMLBooleanAttribute = Ci;
x.isHTMLRawTextElement = wi;
x.isHTMLEscapableRawTextElement = Si;
x.isHTMLMimeType = hn;
x.isHTMLVoidElement = Ti;
x.isValidMimeType = Bi;
x.MIME_TYPE = We;
x.NAMESPACE = xi;
var Ae = {}, Ri = x;
function dn(e, t) {
...
function it(e, t) {
  En(e) ? (this.name = mn[e], this.message = t || "") : (this.message = e, this.name = Mi(t) ? t : Qe.Error), Error.captureStackTrace && Error.captureStackTrace(this, it);
}
dn(it, !0);
...
var Fi = "�", Ee = /[-\x09\x0A\x0D\x20-\x2C\x2E-\uD7FF\uE000-\uFFFD]/;
ot && (Ee = g("[", me(Ee), "\\u{10000}-\\u{10FFFF}", "]"));
var Qt = /[\x20\x09\x0D\x0A]/, Pi = me(Qt), C = g(Qt, "+"), O = g(Qt, "*"), Ze = /[:_a-zA-Z\xC0-\xD6\xD8-\xF6\xF8-\u02FF\u0370-\u1FFF\u200C-\u200D\u2070-\u218F\u2C00-\u2FEF\u3001-\uD7FF\uF900-\uFDCF\uFDF0-\uFFFD]/;
ot && (Ze = g("[", me(Ze), "\\u{10000}-\\u{10FFFF}", "]"));
var Li = me(Ze), Zt = g("[", Li, me(/[-.0-9\xB7]/), me(/[\u0300-\u036F\u203F-\u2040]/), "]"), X = g(Ze, Zt, "*"), Or = g(Zt, "+"), ki = g("&", X, ";"), qi = d(/&#[0-9]+;|&#x[0-9a-fA-F]+;/), et = d(ki, "|", qi), tt = g("%", X, ";"), er = d(
  g('"', d(/[^%&"]/, "|", tt, "|", et), "*", '"'),
  "|",
  g("'", d(/[^%&']/, "|", tt, "|", et), "*", "'")
), $i = d('"', d(/[^<&"]/, "|", et), "*", '"', "|", "'", d(/[^<&']/, "|", et), "*", "'"), ji = Oe(Ze, ":"), Ui = Oe(Zt, ":"), Ir = g(ji, Ui, "*"), at = g(Ir, d(":", Ir), "?"), Vi = g("^", at, "$"), Hi = g("(", at, ")"), rt = d(/"[^"]*"|'[^']*'/), Gi = g(/^<\?/, "(", X, ")", d(C, "(", Ee, "*?)"), "?", /\?>/), Br = /[\x20\x0D\x0Aa-zA-Z0-9-'()+,./:=?;!*#@$_%]/, yt = d('"', Br, '*"', "|", "'", Oe(Br, "'"), "*'"), vn = "<!--", An = "-->", zi = g(vn, d(Oe(Ee, "-"), "|", g("-", Oe(Ee, "-"))), "*", An), xr = "#PCDATA", Ji = d(
  g(/\(/, O, xr, d(O, /\|/, O, at), "*", O, /\)\*/),
  "|",
  g(/\(/, O, xr, O, /\)/)
), Xi = /[?*+]?/, Yi = g(
...
), Ki = d("EMPTY", "|", "ANY", "|", Ji, "|", Yi), Wi = "<!ELEMENT", Qi = g(Wi, C, d(at, "|", tt), C, d(Ki, "|", tt), O, ">"), Zi = g("NOTATION", C, /\(/, O, X, d(O, /\|/, O, X), "*", O, /\)/), eo = g(/\(/, O, Or, d(O, /\|/, O, Or), "*", O, /\)/), to = d(Zi, "|", eo), ro = d(/CDATA|ID|IDREF|IDREFS|ENTITY|ENTITIES|NMTOKEN|NMTOKENS/, "|", to), no = d(/#REQUIRED|#IMPLIED/, "|", d(d("#FIXED", C), "?", $i)), uo = d(C, X, C, ro, C, no), io = "<!ATTLIST", oo = g(io, C, X, uo, "*", O, ">"), tr = "SYSTEM", Ct = "PUBLIC", Tt = d(d(tr, C, rt), "|", d(Ct, C, yt, C, rt)), ao = g(
  "^",
  d(
...
), so = d(C, "NDATA", C, X), co = d(er, "|", d(Tt, so, "?")), Nn = "<!ENTITY", lo = g(Nn, C, X, C, co, O, ">"), fo = d(er, "|", Tt), po = g(Nn, C, "%", C, X, C, fo, O, ">"), ho = d(lo, "|", po), mo = g(Ct, C, yt), Eo = g("<!NOTATION", C, X, C, d(Tt, "|", mo), O, ">"), rr = g(O, "=", O), Rr = /1[.]\d+/, go = g(C, "version", rr, d("'", Rr, "'", "|", '"', Rr, '"')), Mr = /[A-Za-z][-A-Za-z0-9._]*/, Do = d(C, "encoding", rr, d('"', Mr, '"', "|", "'", Mr, "'")), vo = d(C, "standalone", rr, d("'", d("yes", "|", "no"), "'", "|", '"', d("yes", "|", "no"), '"')), Ao = g(/^<\?xml/, go, Do, "?", vo, "?", O, /\?>/), No = "<!DOCTYPE", bo = "<![CDATA[", yo = "]]>", Co = /<!\[CDATA\[/, To = /\]\]>/, wo = g(Ee, "*?", To), So = g(Co, wo);
E.chars = me;
E.chars_without = Oe;
...
E.COMMENT_START = vn;
E.COMMENT_END = An;
E.DOCTYPE_DECL_START = No;
E.elementdecl = Qi;
E.EntityDecl = ho;
E.EntityValue = er;
E.ExternalID = Tt;
E.ExternalID_match = ao;
E.Name = X;
E.NotationDecl = Eo;
E.Reference = et;
E.PEReference = tt;
...
E.SYSTEM = tr;
E.SystemLiteral = rt;
E.UNICODE_REPLACEMENT_CHARACTER = Fi;
E.UNICODE_SUPPORT = ot;
E.XMLDecl = Ao;
var J = x, ee = J.find, Oo = J.hasDefaultHTMLNamespace, Ie = J.hasOwn, Io = J.isHTMLMimeType, Bo = J.isHTMLRawTextElement, xo = J.isHTMLVoidElement, ze = J.MIME_TYPE, te = J.NAMESPACE, k = Symbol(), bn = Ae, h = bn.DOMException, Ro = bn.DOMExceptionName, Q = E;
function q(e) {
  if (e !== k)
...
function _r(e) {
  if (!e) return [];
  var t = _o(e);
  return Object.keys(t.reduce(Fo, {}));
}
function Po(e) {
  return function(t) {
...
xe.prototype = {
  ...
  setNamedItem: function(e) {
    ...
    return r === e ? e : (qo(this._ownerElement, this, e, r), r);
  },
  /**
...
A.prototype = {
  ...
  replaceChild: function(e, t) {
    At(this, e, t, Ln), t && this.removeChild(t);
  },
  /**
  ...
  compareDocumentPosition: function(e) {
    ...
    if (!t || !r || r.ownerDocument !== t.ownerDocument)
      return _.DOCUMENT_POSITION_DISCONNECTED + _.DOCUMENT_POSITION_IMPLEMENTATION_SPECIFIC + (Pr(r.ownerDocument) > Pr(t.ownerDocument) ? _.DOCUMENT_POSITION_FOLLOWING : _.DOCUMENT_POSITION_PRECEDING);
    var o = Fr(t), s = Fr(r);
...
function se(e, t) {
  q(e);
  var r = t || {};
  this.ownerDocument = this, this.contentType = r.contentType || ze.XML_APPLICATION, this.type = Io(this.contentType) ? "html" : "xml";
}
function $o(e, t, r) {
  e && e._inc++;
...
function Vo(e, t, r) {
  ...
  if (
    ...
    !Uo(t) || // 5. If either `node` is a Text node and `parent` is a document,
...
function At(e, t, r, n) {
  Vo(e, t, r), e.nodeType === A.DOCUMENT_NODE && (n || Ho)(e, t, r);
  var u = t.parentNode;
...
se.prototype = {
  ...
  replaceChild: function(e, t) {
    At(this, e, t, Ln), e.ownerDocument = this, t && this.removeChild(t), ue(e) && (this.documentElement = e);
  },
  ...
  createElement: function(e) {
    var t = new le(k);
    t.ownerDocument = this, this.type === "html" && (e = e.toLowerCase()), Oo(this.contentType) && (t.namespaceURI = te.HTML), t.nodeName = e, t.tagName = e, t.localName = e, t.childNodes = new M();
  ...
  createEntityReference: function(e) {
    ...
    if (this.type === "html")
      throw new h("document is an html document", Ro.NotSupportedError);
    var t = new Bt(k);
...
function we(e, t, r, n) {
  ...
  switch (e.nodeType) {
    case Y:
      ...
      var re = !B;
      if (re && (i || e.namespaceURI === te.HTML) && (re = xo(s)), re)
        t.push("/>");
      else {
        if (t.push(">"), i && Bo(s))
          for (; B; )
...
var Rt = {}, Le = x, v = E, Vn = Ae, Go = Le.isHTMLEscapableRawTextElement, zo = Le.isHTMLMimeType, Jo = Le.isHTMLRawTextElement, ut = Le.hasOwn, jr = Le.NAMESPACE, Ur = Vn.ParseError, Xo = Vn.DOMException, Ve = 0, ie = 1, be = 2, He = 3, ye = 4, Ce = 5, Ge = 6, Et = 7;
function Hn() {
}
Hn.prototype = {
  parse: function(e, t, r) {
    var n = this.domBuilder;
    n.startDocument(), Gn(t, t = /* @__PURE__ */ Object.create(null)), Yo(e, t, r, n, this.errorHandler), n.endDocument();
  }
};
var ir = /&#?\w+;?/g;
function Yo(e, t, r, n, u) {
  var i = zo(n.mimeType);
  ...
  for (var l = 0, f = 0, p = /.*(?:\r\n?|\n)|.*$/g, m = n.locator, b = [{ currentNSMap: t }], T = [], S = 0; ; ) {
    try {
      ...
      switch (e.charAt(I + 1)) {
        ...
        default:
          m && c(I);
          var V = new Xn(), Pt = b[b.length - 1].currentNSMap, H = Ko(e, I, V, Pt, o, u, i), sr = V.length;
          if (V.closed || (i && Le.isHTMLVoidElement(V.tagName) ? V.closed = !0 : T.push(V.tagName)), m && sr) {
            for (var Kn = Vr(m, {}), Lt = 0; Lt < sr; Lt++) {
              var cr = V[Lt];
              c(cr.offset), cr.locator = Vr(m, {});
            }
            n.locator = Kn, Hr(V, n, Pt) && b.push(V), n.locator = m;
          } else
            Hr(V, n, Pt) && b.push(V);
          i && !V.closed ? H = Wo(e, H, V.tagName, o, n) : H++;
      }
    } catch (y) {
      if (y instanceof Ur)
        throw y;
...
function Jn(e, t, r, n, u) {
  ...
  switch (i.char(2)) {
    ...
    case "D": {
      ...
      return i.skipBlanks(), s.internalSubset = Qo(i, n), i.skipBlanks(), i.char() !== ">" ? n.fatalError("doctype not terminated with > at position " + i.getIndex()) : (i.skip(1), r.startDTD(s.name, s.publicId, s.systemId, s.internalSubset), r.endDTD(), i.getIndex());
    }
    default:
...
var Ne = x, ea = R, ta = Ae, Gr = Un, ra = Rt, na = ea.DOMImplementation, ua = Ne.hasDefaultHTMLNamespace, ia = Ne.isHTMLMimeType, oa = Ne.isValidMimeType, Yn = Ne.MIME_TYPE, $t = Ne.NAMESPACE, zr = ta.ParseError, aa = ra.XMLReader;
function sa(e) {
  return e.replace(/\r[\n\u0085]/g, `
`).replace(/[\r\u0085\u2028]/g, `
`);
...
function ca(e) {
  ...
  e.errorHandler && e.errorHandler("warning", "The `errorHandler` option has been deprecated, use `onError` instead!", this), this.normalizeLineEndings = e.normalizeLineEndings || sa, this.locator = !!e.locator, this.xmlns = this.assign(/* @__PURE__ */ Object.create(null), e.xmlns);
}
ca.prototype.parseFromString = function(e, t) {
  if (!oa(t))
  ...
  ua(t) ? (n = Gr.HTML_ENTITIES, u = $t.HTML) : t === Yn.XML_SVG_IMAGE && (u = $t.SVG), r[""] = u, r.xml = r.xml || $t.XML;
...
or.prototype = {
  ...
  startDocument: function() {
    var e = new na();
    this.doc = ia(this.mimeType) ? e.createHTMLDocument(!1) : e.createDocument(this.defaultNamespace, "");
  },
  ...
  reportError: function(e, t) {
    if (typeof this.onError == "function")
      ...
      console.error("[xmldom " + e + "]	" + t, la(this.locator));
  },
  /**
...
class P {
  ...
  static createParentMapInternal(t, r, n) {
    ...
    n.set(t, r), t.content && n.set(t.content, t), (u = t.content) == null || u.forEach((i) => {
      typeof i == "object" && P.createParentMapInternal(i, t, n);
    });
  }
  ...
  createUsjParentMap() {
    ...
    return this.usj.content && t.set(this.usj.content, this.usj), this.usj.content.forEach((r) => {
      typeof r == "object" && P.createParentMapInternal(r, this.usj, t);
    }), t;
  }
  ...
  nodeToJsonPath(t) {
    return P.convertWorkingStackToJsonPath(this.createWorkingStack(t));
  }
  // #endregion
  ...
  verseRefToUsjContentLocation(t, r = 0) {
    ...
    const o = t.verse, s = this.findNextMatchingNode(
      u,
      ne,
      (p, m) => p === u ? t.verseNum === 0 ? (a = P.convertWorkingStackToJsonPath(m), !0) : !1 : typeof p != "object" ? !1 : p.type === pt ? (i = !0, !0) : p.type === ht && p.number !== void 0 && p.number === o ? (a = P.convertWorkingStackToJsonPath(m), !0) : !1
    );
    ...
    return this.findNextMatchingNode(
      ...
      (p, m) => {
        ...
        if (typeof p == "string") {
          if (c += p.length, c > r)
            return a = P.convertWorkingStackToJsonPath(m), l = r - c + p.length, f = p, !0;
  ...
  findNextLocationOfMatchingText(t, r, n = 1e3) {
    ...
    return {
      node: l,
      offset: s,
      jsonPath: P.convertWorkingStackToJsonPath(c)
    };
  }
  // #endregion
  ...
  extractTextBetweenPoints(t, r, n = 100) {
    ...
    return P.findNextMatchingNodeUsingWorkingStack(
      ...
      this.convertJsonPathToWorkingStack(t.jsonPath),
      ne,
      (i, a) => i === r.node && (typeof i == "object" || r.jsonPath === P.convertWorkingStackToJsonPath(a)) ? !0 : typeof i != "string" ? !1 : (u = `${u}${i}`, u.length > n && (u = u.substring(0, n)), u.length >= n)
    ), u;
  }
  // #endregion
  ...
  removeContentNodes(t) {
    const r = P.removeContentNodesFromArray(this.usj.content, t);
...
export {
  ...
  ju as FIRST_SCR_VERSE_NUM,
  qu as LAST_SCR_BOOK_NUM,
  au as Mutex,
  ya as MutexMap,
  Ca as NonValidatingDocumentCombiner,
  su as NumberFormat,
  tu as PlatformEventEmitter,
  Ta as PromiseChainingMap,
  wa as UnsubscriberAsyncList,
  P as UsjReaderWriter,
  ht as VERSE_TYPE,
  Ya as aggregateUnsubscriberAsyncs,
  Xa as aggregateUnsubscribers,
  Oa as at,
  Se as charAt,
  Ia as codePointAt,
  Ga as compareScrRefs,
  ba as createSyncProxyForAsyncObject,
  ga as debounce,
  Je as deepClone,
  mi as deepEqual,
  $a as defaultScrRef,
  ...
  Ru as endsWith,
  un as ensureArray,
  La as escapeStringRegexp,
  Za as formatBytes,
  Ba as formatReplacementString,
  _u as formatReplacementStringToArray,
  Ja as formatScrRef,
  Na as getAllObjectFunctionNames,
  Uu as getChaptersForBook,
  Qa as getCurrentLocale,
  va as getErrorMessage,
  Vu as getLocalizeKeyForScrollGroupId,
  za as getLocalizeKeysForScrollGroupIds,
  ...
  Ye as indexOf,
  Pa as isLocalizeKey,
  Ka as isSerializable,
  Dt as isString,
  Ei as isSubset,
  Pu as lastIndexOf,
  Ai as localizedStringsDocumentSchema,
  Ni as menuDocumentSchema,
  Ea as newGuid,
  xa as normalize,
  ja as offsetBook,
  Ua as offsetChapter,
  ...
  Ma as padEnd,
  _a as padStart,
  Di as projectSettingsDocumentSchema,
  Dr as scrRefToBBBCCCVVV,
  Sr as serialize,
  vi as settingsDocumentSchema,
  Fa as slice,
  gr as split,
  on as startsWith,
  F as stringLength,
  pe as substring,
  Lu as toArray,
  qa as transformAndEnsureRegExpArray,
  ka as transformAndEnsureRegExpRegExpArray,
  uu as wait,
