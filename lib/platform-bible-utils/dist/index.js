...
import { D as nr, F as ir, a as sr, b as ar, G as or, L as cr, M as dr, S as pr, c as lr, e as ur, f as hr, g as fr, h as mr, j as gr, k as yr, l as kr, m as br, n as vr, o as Mr, p as xr, q as _r, r as Er, s as Ir, t as wr, u as Sr, v as Pr, w as Tr, x as Cr, y as Ar, z as qr, A as $r, B as jr, C as Nr, E as Or, H as Ur, I as Fr, J as Rr, K as Dr, N as Lr, O as Br, P as Vr, Q as zr, R as Hr, T as Jr, U as Kr, V as Gr, W as Yr, X as Xr, Y as Wr, Z as Zr, _ as Qr, $ as en, a0 as tn, a1 as rn, a2 as nn, a3 as sn, a4 as an, a5 as on, a6 as cn, a7 as dn, a8 as pn, a9 as ln, aa as un, ab as hn, ac as fn, ad as mn } from "./scripture-util-DArajUVn.js";
import { Mutex as le } from "async-mutex";
import ue from "dompurify";
import { deepEqual as he } from "fast-equals";
import { USJ_TYPE as fe } from "@eten-tech-foundation/scripture-utilities";
...
class ke {
  ...
  constructor(e, t) {
    ...
    k(this, "latestOutput");
    k(this, "options");
    k(this, "onDidRebuildEmitter", new ye());
...
class it {
  ...
  get(e) {
    ...
    return t || (t = new ve(), this.mutexesByID.set(e, t), t);
  }
  /**
...
class at {
  ...
  cleanupPromiseChain(e) {
    ...
    if (!t) return;
    const r = { promise: xe }, s = t.catch((i) => this.logger.warn(`Error in promise for ${e}: ${i.message}`)).finally(() => {
...
const Q = 1e4, O = Q / 1e3, ee = 3, z = /* @__PURE__ */ new Map(), _e = {
  unsubscribed: {
...
function H(n, e, t) {
  const { log: r, first: s, suppressed: i } = _e[e], c = `${n}\0${e}`, p = Date.now(), d = z.get(c);
  if (!d || p >= d.closesAt) {
    r(s(n, t)), z.set(c, {
      closesAt: p + Q,
      suppressedCount: 0,
...
const dt = "ABORTED", pt = "ALREADY_EXISTS", lt = "CANCELLED", ut = "DATA_LOSS", ht = "DEADLINE_EXCEEDED", ft = "FAILED_PRECONDITION", mt = "INTERNAL", gt = "INVALID_ARGUMENT", yt = "NOT_FOUND", kt = "OUT_OF_RANGE", bt = "PERMISSION_DENIED", vt = "RESOURCE_EXHAUSTED", Mt = "UNAUTHENTICATED", xt = "UNAVAILABLE", _t = "UNIMPLEMENTED", Et = "UNKNOWN", q = 1;
function It(n, e) {
  if (!n)
    return {
      message: "",
...
const St = (n) => (...e) => n.map((r) => r(...e)).every((r) => r), Pt = (n) => async (...e) => {
...
function At(n, e) {
  let t = n;
  return e > 0 ? t = Math.floor(n * 10 + X) / 10 : e < 0 && (t = Math.ceil(n * 10 - X) / 10), we(Ie(t + e * Ee));
}
function qt(n) {
  return ue.sanitize(n, {
    ALLOWED_TAGS: [
      "p",
      "br",
      "b",
...
function Te(n, e) {
  ...
  return Object.keys(t).forEach((i) => {
    s && (Object.hasOwn(r, i) && Te(r[i], t[i]) || (s = !1));
  }), s;
}
function W(n, e, t) {
...
const Ot = (n) => n.replace(/&/g, "&amp;").replace(/</g, "&lt;").replace(/>/g, "&gt;").replace(/"/g, "&quot;").replace(/'/g, "&#x27;").replace(/\//g, "&#x2F;");
function Ut() {
  return typeof navigator < "u" && navigator.languages ? navigator.languages[0].replace(/@posix$/i, "") : new me().resolvedOptions().locale;
}
function Ft(n, e = 2) {
...
function Ae(n) {
  return !!je(n.fullName) && n.fullName !== n.shortName;
}
const qe = " - ";
function Dt(n) {
  return Ae(n) ? `${n.shortName}${qe}${n.fullName}` : n.shortName;
}
function $e(n, e) {
  return n.localeCompare(e, void 0, { sensitivity: "base" });
}
function Lt(n, e) {
  return $e(n.shortName, e.shortName);
}
function je(n) {
  return typeof n == "string" && n.trim().length > 0 ? n : void 0;
}
const Ne = 1e3, ne = 60, ie = ne * 60, Oe = ie * 24;
function Bt(n, e, t = /* @__PURE__ */ new Date()) {
  const r = Math.floor((e.getTime() - t.getTime()) / Ne), s = Math.round(r / Oe);
...
const De = /^%[^%]*%$/;
function ae(n) {
  return typeof n != "string" ? !1 : !De.test(n) && n.trim() !== "";
}
function Kt(n, e) {
  const t = n == null ? void 0 : n[e];
  return typeof t == "string" && ae(t) ? t : void 0;
}
function Gt(n, e) {
  return ae(n) ? n : e;
}
...
function Qt(n, e, t) {
  ...
  return s.id = `${Ve}${t ? `-${t}` : ""}`, s.dataset.themeId = n.id, s.textContent = He(n), this.document.head.appendChild(s), s;
}
function ce(n) {
  return Object.freeze(n), n == null || Object.getOwnPropertyNames(n).forEach(function(t) {
    ...
    n[t] !== null && (typeof n[t] == "object" || typeof n[t] == "function") && !Object.isFrozen(n[t]) && ce(n[t]);
  }), n;
}
const F = ce({
  version: "3.0.7",
...
class g {
  ...
  static isTopLevelUsjMarker(e, t) {
    return typeof e == "object" && e.type === fe && t.length === 0;
  }
  /**
  ...
  findAllNotes() {
    var e;
    return Pe((e = this.usj) == null ? void 0 : e.content);
  }
  /**
  ...
  getInfoForMarker(e, t = "usfm") {
    ...
    if (t === "usfm" && d === "cell" && b.colspan) {
      const u = parseInt(b.colspan, 10), h = Ke.exec(r);
      if (h != null && h[1]) {
  ...
  textContentToUsfm(e) {
    return {
      usfm: this.shouldAllowInvisibleCharacters ? e : e.replace(Je, "~"),
    ...
    e.map((d) => {
      ...
      if (typeof d.fragment == "object" && "type" in d.fragment) {
        ...
        if (h.type === J && h.code)
          ...
          const f = (m = Ge.exec(h.number)) == null ? void 0 : m[1];
          if (!f)
            this.reportProblemOnce(
...
export {
  ...
  it as MutexMap,
  yt as NOT_FOUND,
  st as NonValidatingDocumentCombiner,
  Me as NumberFormat,
  kt as OUT_OF_RANGE,
  bt as PERMISSION_DENIED,
  q as PLATFORM_ERROR_VERSION,
  qe as PROJECT_NAME_SEPARATOR,
  $ as PROJECT_SELECTOR_CUSTOM_DATA_KEYS,
  ye as PlatformEventEmitter,
  at as PromiseChainingMap,
  vt as RESOURCE_EXHAUSTED,
  pr as SELECTABLE_INVISIBLE_CHAR_OR_WHITESPACE_CLASS,
  lr as Section,
  V as SortedNumberMap,
  ot as SortedSet,
  Ve as THEME_STYLE_ELEMENT_ID,
  Mt as UNAUTHENTICATED,
  xt as UNAVAILABLE,
  _t as UNIMPLEMENTED,
  Et as UNKNOWN,
  ...
  $e as compareProjectShortNames,
  Lt as compareProjectsByName,
  kr as compareScrRefs,
  Jt as computeEffectiveStructureProtection,
  ...
  zr as isolateBidi,
  Hr as lastIndexOf,
  Kt as localizedStringOrUndefined,
  Re as localizedStringsDocumentSchema,
  Yt as makeProjectSelectorCustomData,
  Le as menuDocumentSchema,
  Jr as newGuid,
  It as newPlatformError,
  Kr as normalize,
  je as normalizeFullName,
  Rt as normalizeProjectId,
  ...
  Qr as padEnd,
  en as padStart,
  Ue as projectSettingsDocumentSchema,
  Xt as recencyMapFromOrderedIds,
  Gt as resolveLocalizedString,
  tn as retryUntil,
  we as roundZoom,
  qt as sanitizeHtml,
