...
var d = (t, e, r) => (Be(t, typeof e != "symbol" ? e + "" : e, r), r);
...
class ze {
  ...
  constructor(e, r) {
    ...
    d(this, "latestOutput");
    d(this, "options");
    d(this, "onDidRebuildEmitter", new xe());
...
var Fe = Object.defineProperty, Ke = (t, e, r) => e in t ? Fe(t, e, { enumerable: !0, configurable: !0, writable: !0, value: r }) : t[e] = r, l = (t, e, r) => Ke(t, typeof e != "symbol" ? e + "" : e, r);
const j = [
  "GEN",
  "EXO",
  "LEV",
...
var Q = typeof globalThis < "u" ? globalThis : typeof window < "u" ? window : typeof global < "u" ? global : typeof self < "u" ? self : {}, C = {}, st = () => {
...
}, nt = Q && Q.__importDefault || function(t) {
...
function te(t, e, r) {
  ...
  if (r !== void 0 && r <= 0)
    return [t];
  if (e === "")
    return bt(t).slice(0, r);
  let n = e;
  (typeof e == "string" || e instanceof RegExp && !mt(e.flags, "g")) && (n = new RegExp(e, "g"));
  const i = t.match(n);
  let o = 0;
  if (!i)
    return [t];
  for (let a = 0; a < (r ? r - 1 : i.length); a++) {
    const h = x(t, i[a], o), p = g(i[a]);
...
], yt = 1, vt = Ee.length - 1, Nt = 1, wt = 1, Et = (t) => {
  var e;
  return ((e = Ee[t]) == null ? void 0 : e.chapters) ?? -1;
}, Cr = (t, e) => ({
  bookNum: Math.max(yt, Math.min(t.bookNum + e, vt)),
  chapterNum: 1,
  verseNum: 1
}), Ir = (t, e) => ({
  ...t,
  chapterNum: Math.min(
    Math.max(Nt, t.chapterNum + e),
    Et(t.bookNum)
  ),
  verseNum: 1
}), Tr = (t, e) => ({
  ...t,
  verseNum: Math.max(wt, t.verseNum + e)
});
...
function re(t) {
  return new rt(t.bookNum, t.chapterNum, t.verseNum).BBBCCCVVV;
}
function Ar(t, e) {
  return re(t) - re(e);
}
...
const Mr = (t) => (...e) => t.map((s) => s(...e)).every((s) => s), Dr = (t) => async (...e) => {
  const r = t.map(async (s) => s(...e));
  return (await Promise.all(r)).every((s) => s);
};
var St = Object.getOwnPropertyNames, Ot = Object.getOwnPropertySymbols, $t = Object.prototype.hasOwnProperty;
function se(t, e) {
...
var Bt = "[object Arguments]", Mt = "[object Boolean]", Dt = "[object Date]", xt = "[object Map]", kt = "[object Number]", Rt = "[object Object]", Vt = "[object RegExp]", qt = "[object Set]", zt = "[object String]", Jt = Array.isArray, le = typeof ArrayBuffer == "function" && ArrayBuffer.isView ? ArrayBuffer.isView : null, ce = Object.assign, Gt = Object.prototype.toString.call.bind(Object.prototype.toString);
function _t(t) {
  ...
  return function(u, c, m) {
    ...
    if (v === Set)
      return a(u, c, m);
    var b = Gt(u);
    return b === Dt ? r(u, c, m) : b === Vt ? o(u, c, m) : b === xt ? s(u, c, m) : b === qt ? a(u, c, m) : b === Rt ? typeof u.then != "function" && typeof c.then != "function" && n(u, c, m) : b === Bt ? n(u, c, m) : b === Mt || b === kt || b === zt ? i(u, c, m) : !1;
  };
}
function Ft(t) {
  var e = t.circular, r = t.createCustomConfig, s = t.strict, n = {
    areArraysEqual: s ? M : jt,
    areDatesEqual: Ct,
    areMapsEqual: s ? se(ae, M) : ae,
    areObjectsEqual: s ? M : It,
    arePrimitiveWrappersEqual: Tt,
    areRegExpsEqual: Pt,
    areSetsEqual: s ? se(ue, M) : ue,
    areTypedArraysEqual: s ? M : At
  };
  if (r && (n = ce({}, n, r(n))), e) {
...
function O(t) {
  t === void 0 && (t = {});
  var e = t.circular, r = e === void 0 ? !1 : e, s = t.createInternalComparator, n = t.createState, i = t.strict, o = i === void 0 ? !1 : i, a = Ft(t), h = _t(a), p = s ? s(h) : Kt(h);
...
function Ut(t, e) {
  ...
  return Object.keys(r).forEach((i) => {
    n && (Object.hasOwn(s, i) && Ut(s[i], r[i]) || (n = !1));
  }), n;
}
function fe(t, e, r) {
...
export {
  ...
  Nt as FIRST_SCR_CHAPTER_NUM,
  wt as FIRST_SCR_VERSE_NUM,
  vt as LAST_SCR_BOOK_NUM,
  Ge as Mutex,
  pr as MutexMap,
  dr as NonValidatingDocumentCombiner,
  _e as NumberFormat,
  ...
  hr as createSyncProxyForAsyncObject,
  ar as debounce,
  D as deepClone,
  Lt as deepEqual,
  Wt as deserialize,
  ...
  x as indexOf,
  $r as isLocalizeKey,
  xr as isSerializable,
  ke as isString,
  Ut as isSubset,
  gt as lastIndexOf,
  Qt as localizedStringsDocumentSchema,
  er as menuDocumentSchema,
  or as newGuid,
  Nr as normalize,
  Cr as offsetBook,
  Ir as offsetChapter,
  ...
  Er as padEnd,
  Sr as padStart,
  Zt as projectSettingsDocumentSchema,
