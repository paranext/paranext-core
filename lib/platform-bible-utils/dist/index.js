...
var z = (t, e, r) => Wr(t, typeof e != "symbol" ? e + "" : e, r);
...
class un {
  ...
  constructor(e, r) {
    ...
    z(this, "latestOutput");
    z(this, "options");
    z(this, "onDidRebuildEmitter", new en());
...
var fn = Object.defineProperty, hn = (t, e, r) => e in t ? fn(t, e, { enumerable: !0, configurable: !0, writable: !0, value: r }) : t[e] = r, H = (t, e, r) => hn(t, typeof e != "symbol" ? e + "" : e, r);
const it = [
  "GEN",
  "EXO",
  "LEV",
...
let Fr = De, yt = class extends Error {
};
var J = {}, ce = {}, nr;
function Dt() {
  if (nr) return ce;
...
function qr() {
  ...
  ), w = a("EMPTY", "|", "ANY", "|", R, "|", _), I = "<!ELEMENT", L = o(I, m, a(W, "|", ne), m, a(w, "|", ne), l, ">"), V = o("NOTATION", m, /\(/, l, y, a(l, /\|/, l, y), "*", l, /\)/), he = o(/\(/, l, q, a(l, /\|/, l, q), "*", l, /\)/), we = a(V, "|", he), ve = a(/CDATA|ID|IDREF|IDREFS|ENTITY|ENTITIES|NMTOKEN|NMTOKENS/, "|", we), oe = a(/#REQUIRED|#IMPLIED/, "|", a(a("#FIXED", m), "?", E)), P = a(m, y, m, ve, m, oe), Ue = "<!ATTLIST", Re = o(Ue, m, y, P, "*", l, ">"), pe = "about:legacy-compat", Ve = a('"' + pe + '"', "|", "'" + pe + "'"), _e = "SYSTEM", Se = "PUBLIC", ke = a(a(_e, m, te), "|", a(Se, m, N, m, te)), He = o(
    "^",
    a(
  ...
  ), Je = a(m, "NDATA", m, y), ye = a(fe, "|", a(ke, Je, "?")), Q = "<!ENTITY", ze = o(Q, m, y, m, ye, l, ">"), ae = a(fe, "|", ke), Xe = o(Q, m, "%", m, y, m, ae, l, ">"), vt = a(ze, "|", Xe), Ye = o(Se, m, N), Ke = o("<!NOTATION", m, y, m, a(ke, "|", Ye), l, ">"), $ = o(l, "=", l), Z = /1[.]\d+/, Ae = o(m, "version", $, a("'", Z, "'", "|", '"', Z, '"')), be = /[A-Za-z][-A-Za-z0-9._]*/, We = a(m, "encoding", $, a('"', be, '"', "|", "'", be, "'")), st = a(m, "standalone", $, a("'", a("yes", "|", "no"), "'", "|", '"', a("yes", "|", "no"), '"')), ct = o(/^<\?xml/, Ae, We, "?", st, "?", l, /\?>/), lt = "<!DOCTYPE", At = "<![CDATA[", bt = "]]>", ft = /<!\[CDATA\[/, Qe = /\]\]>/, ht = o(h, "*?", Qe), It = o(ft, ht);
  return j.chars = r, j.chars_without = u, j.detectUnicodeSupport = t, j.reg = o, j.regg = a, j.ABOUT_LEGACY_COMPAT = pe, j.ABOUT_LEGACY_COMPAT_SystemLiteral = Ve, j.AttlistDecl = Re, j.CDATA_START = At, j.CDATA_END = bt, j.CDSect = It, j.Char = h, j.Comment = M, j.COMMENT_START = S, j.COMMENT_END = T, j.DOCTYPE_DECL_START = lt, j.elementdecl = L, j.EntityDecl = vt, j.EntityValue = fe, j.ExternalID = ke, j.ExternalID_match = He, j.Name = y, j.NotationDecl = Ke, j.Reference = U, j.PEReference = ne, j.PI = Be, j.PUBLIC = Se, j.PubidLiteral = N, j.QName = W, j.QName_exact = ee, j.QName_group = Ie, j.S = m, j.SChar_s = d, j.S_OPT = l, j.SYSTEM = _e, j.SystemLiteral = te, j.UNICODE_REPLACEMENT_CHARACTER = p, j.UNICODE_SUPPORT = e, j.XMLDecl = ct, j;
}
var or;
function $r() {
  if (or) return re;
  ...
  function qe(n, i, s, c) {
    ...
    switch (n.nodeType) {
      case G:
        ...
        var qt = !ge;
        if (qt && (O || n.namespaceURI === f.HTML) && (qt = p(me)), qt)
          i.push("/>");
        else {
          if (i.push(">"), O && a(me))
            for (; ge; )
...
function Cn() {
  ...
  function ne(g, N, S, T, M) {
    ...
    for (var we = [{ currentNSMap: N }], ve = [], oe = 0; ; ) {
      try {
        var P = g.indexOf("<", oe);
        if (P < 0) {
          if (!A && ve.length > 0)
...
function Tn() {
  if (cr) return rt;
  cr = 1;
  var t = Dt(), e = $r(), r = Pt(), u = yn(), o = Cn(), a = e.DOMImplementation, p = t.hasDefaultHTMLNamespace, h = t.isHTMLMimeType, f = t.isValidMimeType, d = t.MIME_TYPE, m = t.NAMESPACE, l = r.ParseError, v = o.XMLReader;
  function C(E) {
    return E.replace(/\r[\n\u0085]/g, `
`).replace(/[\r\u0085\u2028\u2029]/g, `
`);
...
const Vt = ["chapter", "book", "para", "row", "sidebar", Ut], Ln = "​", Vr = [
...
], kn = 1, Fn = Vr.length - 1, qn = 1, $n = 1, vi = {
  book: "GEN",
  chapterNum: 1,
  verseNum: 1
}, jn = (t) => {
  ...
  book: Ne.bookNumberToId(
    Math.max(
      kn,
      Math.min(Ne.bookIdToNumber(t.book) + e, Fn)
    )
  ),
  chapterNum: 1,
  verseNum: 1
...
function Ci(t) {
  return new Fr(Ne.bookIdToNumber(t.book), t.chapterNum, t.verseNum).BBBCCC;
}
function gr(t) {
  return new Fr(Ne.bookIdToNumber(t.book), t.chapterNum, t.verseNum).BBBCCCVVV;
}
function Ti(t, e) {
  return gr(t) - gr(e);
}
...
function Dr(t) {
  ...
  for (let o = 0; o < t.length; o += 1) {
    const a = t[o];
    a.charCodeAt(0) < 32 ? (r || (e += " "), r = !0) : !r && a === Ln && o + 1 < t.length && Er(t[o + 1]) || (Er(a) ? (r || (e += a), r = !0) : Gn(a) && u === a || (e += a, r = !1)), u = a;
  }
  return e;
}
function vr(t) {
...
const Ii = (t) => (...e) => t.map((u) => u(...e)).every((u) => u), xi = (t) => async (...e) => {
  const r = t.map(async (u) => u(...e));
  return (await Promise.all(r)).every((u) => u);
}, Bt = "chapter", Rt = "verse";
var Hn = Object.getOwnPropertyNames, Jn = Object.getOwnPropertySymbols, Xn = Object.prototype.hasOwnProperty;
function br(t, e) {
...
var Kn = "__v", Wn = "__o", Qn = "_owner", yr = Object.getOwnPropertyDescriptor, Cr = Object.keys;
function Zn(t, e, r) {
  var u = t.length;
  if (e.length !== u)
    return !1;
...
function Tt(t, e, r) {
  ...
  if (Nr(e).length !== o)
    return !1;
  for (var a, p, h; o-- > 0; )
    if (a = u[o], !Gr(t, e, r, a) || (p = yr(t, a), h = yr(e, a), (p || h) && (!p || !h || p.configurable !== h.configurable || p.enumerable !== h.enumerable || p.writable !== h.writable)))
      return !1;
  return !0;
}
function iu(t, e) {
...
var cu = "[object Arguments]", lu = "[object Boolean]", fu = "[object Date]", hu = "[object Error]", pu = "[object Map]", du = "[object Number]", mu = "[object Object]", gu = "[object RegExp]", Eu = "[object Set]", Du = "[object String]", vu = "[object URL]", Au = Array.isArray, Sr = typeof ArrayBuffer == "function" && ArrayBuffer.isView ? ArrayBuffer.isView : null, Or = Object.assign, bu = Object.prototype.toString.call.bind(Object.prototype.toString);
function Nu(t) {
  ...
  return function(b, y, q) {
    ...
    if (F === Set)
      return m(b, y, q);
    var U = bu(b);
    return U === fu ? r(b, y, q) : U === gu ? d(b, y, q) : U === pu ? a(b, y, q) : U === Eu ? m(b, y, q) : U === mu ? typeof b.then != "function" && typeof y.then != "function" && h(b, y, q) : U === vu ? v(b, y, q) : U === hu ? u(b, y, q) : U === cu ? h(b, y, q) : U === lu || U === du || U === Du ? f(b, y, q) : !1;
  };
}
function yu(t) {
...
function Ge(t) {
  t === void 0 && (t = {});
  var e = t.circular, r = e === void 0 ? !1 : e, u = t.createInternalComparator, o = t.createState, a = t.strict, p = a === void 0 ? !1 : a, h = yu(t), f = Nu(h), d = u ? u(f) : Cu(f);
...
function Ri() {
  return typeof navigator < "u" && navigator.languages ? navigator.languages[0].replace(/@posix$/i, "") : new Zr().resolvedOptions().locale;
}
function _i(t, e = 2) {
...
const xu = 1e3, Hr = 60, Jr = Hr * 60, Mu = Jr * 24;
function Pi(t, e, r = /* @__PURE__ */ new Date()) {
...
export {
  ...
  Rt as VERSE_TYPE,
  xi as aggregateUnsubscriberAsyncs,
  Ii as aggregateUnsubscribers,
  Fi as applyThemeStylesheet,
  Oi as areUsjContentsEqualExceptWhitespace,
  Mt as at,
  gt as charAt,
  si as codePointAt,
