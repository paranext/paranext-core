...
function de(n, e, t, r) {
  ...
  if (i && s) {
    ...
    if (!l && !u) {
      ...
      if (V.includes(a.type) && b(d) && E(d) && (f = f.slice(0, -1)), h.length !== f.length) return !1;
...
`);
  ...
  closingMarkerToUsfm(e, t) {
    ...
    if ((u.closed === "false" || s.isClosingMarkerOptional && !this.markersMap.shouldOptionalClosingMarkersBePresent && u.closed !== "true") && (h = !1), s.independentClosingMarkers && s.independentClosingMarkers.length > 0 && h) {
      ...
      let g = "";
      const k = [], { usfm: w, fragmentsInfo: v } = this.openingMarkerToUsfm(d, t), F = v.find((A) => m.isFragmentAMarker(A.fragment));
      if (!F)
        throw new Error(
    ...
    e.map((c) => {
      ...
      if (typeof c.fragment == "object" && "type" in c.fragment) {
        ...
        if (p.type === lt && p.code)
          ...
          const d = (u = St.exec(p.number)) == null ? void 0 : u[1];
          if (!d)
            console.warn(
