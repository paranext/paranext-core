...
var Ie = (r, e, t) => e in r ? Ne(r, e, { enumerable: !0, configurable: !0, writable: !0, value: t }) : r[e] = t;
var b = (r, e, t) => Ie(r, typeof e != "symbol" ? e + "" : e, t);
import { Mutex as Se } from "async-mutex";
import { Canon as P, VerseRef as de } from "@sillsdev/scripture";
import { USJ_TYPE as le } from "@eten-tech-foundation/scripture-utilities";
import { indexOf as Pe, limit as pe, length as we, substring as Ce, toArray as Te, substr as qe } from "stringz";
...
function zt(r) {
  ...
  return M(r) ? r.includes(e) : ue(r).includes(e);
}
function Ht(r) {
  const e = "401 Unauthorized error while getting shared projects.", t = "User registration is not valid. Cannot retrieve resources from DBL.", n = M(r) ? r : ue(r);
...
class De {
  ...
  constructor(e, t) {
    ...
    b(this, "latestOutput");
    b(this, "options");
    b(this, "onDidRebuildEmitter", new Oe());
...
class Yt {
  ...
  cleanupPromiseChain(e) {
    ...
    if (!t) return;
    const n = { promise: Je }, s = t.catch((i) => this.logger.warn(`Error in promise for ${e}: ${i.message}`)).finally(() => {
...
const Qt = "ABORTED", er = "ALREADY_EXISTS", tr = "CANCELLED", rr = "DATA_LOSS", nr = "DEADLINE_EXCEEDED", ir = "FAILED_PRECONDITION", sr = "INTERNAL", ar = "INVALID_ARGUMENT", or = "NOT_FOUND", cr = "OUT_OF_RANGE", dr = "PERMISSION_DENIED", lr = "RESOURCE_EXHAUSTED", pr = "UNAUTHENTICATED", ur = "UNAVAILABLE", hr = "UNIMPLEMENTED", fr = "UNKNOWN", R = 1;
function mr(r, e) {
  if (!r)
    return {
      message: "",
      ...e && { code: e },
      platformErrorVersion: R
    };
  if (M(r))
    return {
      message: r,
  ...
  if (typeof r == "object" && "message" in r && typeof r.message == "string") {
    ...
    return Object.defineProperties(t, Object.getOwnPropertyDescriptors(r)), Object.defineProperty(t, "message", { enumerable: !0 }), "stack" in r && M(r.stack) && Object.defineProperty(t, "stack", { value: r.stack, enumerable: !0 }), "cause" in t && Object.defineProperty(t, "cause", { enumerable: !0 }), e && (t.code = e), t;
  }
  return {
    cause: r,
    message: "",
...
function A(r, e) {
  return e < 0 || e > N(r) - 1 ? "" : L(r, e, 1);
}
function yr(r, e) {
  if (!(e < 0 || e > N(r) - 1))
    return L(r, e, 1).codePointAt(0);
}
function ze(r, e, t = N(r)) {
  const n = Xe(r, e);
  return !(n === -1 || n + N(e) !== t);
}
function He(r, e, t) {
  if (e < 0) return -1;
  if (t) {
    if (A(r, e) === "}" && A(r, e - 1) === "\\") return e;
    const i = F(r, "\\}", e);
    return i >= 0 ? i + 1 : i;
  }
  let n = e;
  const s = N(r);
  for (; n < s && (n = F(r, "}", n), !(n === -1 || A(r, n - 1) !== "\\")); )
    n += 1;
  return n >= s ? -1 : n;
}
function Ke(r, e) {
  ...
  let n = 0, s = 0;
  function i(d, l, p) {
    const f = T(r, s, l), g = t.length > 0 && M(t[t.length - 1]) ? `${t.pop()}${f}` : f;
    M(d) ? t.push(`${g}${d}`) : (g && t.push(g), t.push(d)), s = l + p;
  }
  const c = N(r);
  for (; n < c; ) {
    switch (A(r, n)) {
  ...
  if (s < c) {
    const d = T(r, s);
    t.push(
      t.length > 0 && M(t[t.length - 1]) ? `${t.pop()}${d}` : d
    );
  }
  return t;
}
function kr(r, e) {
  return Ke(r, e).map((t) => `${t}`).join("");
}
function Ge(r, e, t = 0) {
  const n = T(r, t);
  return F(n, e) !== -1;
...
function Mr(r, e, t = " ") {
  return e <= N(r) ? r : pe(r, e, t, "right");
}
function xr(r, e, t = " ") {
  return e <= N(r) ? r : pe(r, e, t, "left");
}
function Z(r, e) {
...
function Q(r, e, t) {
  ...
  if (e > n || t && (e > t && !(e >= 0 && e < n && t < 0 && t > -n) || t < -n))
    return "";
  const s = Z(n, e), i = t ? Z(n, t) : void 0;
  return T(r, s, i);
}
function ee(r, e, t) {
  const n = [];
  if (t !== void 0 && t <= 0)
    return [r];
  if (e === "") return Ye(r).slice(0, t);
  let s = e;
  (typeof e == "string" || e instanceof RegExp && !Ge(e.flags, "g")) && (s = new RegExp(e, "g"));
  const i = r.match(s);
  let c = 0;
  if (!i) return [r];
  for (let d = 0; d < (t ? t - 1 : i.length); d++) {
    const l = F(r, i[d], c), p = N(i[d]);
    if (n.push(T(r, c, l)), c = l + p, t !== void 0 && n.length === t)
      break;
  }
  return n.push(T(r, c)), n;
}
function me(r, e, t = 0) {
  return F(r, e, t) === t;
}
function L(r, e = 0, t = N(r) - e) {
  return qe(r, e, t);
}
function T(r, e, t = N(r)) {
  return Ce(r, e, t);
}
function Ye(r) {
  return Te(r);
...
const J = ["chapter", "book", "para", "row", "sidebar", le], Ze = "​", ge = [
...
], Qe = 1, et = ge.length - 1, tt = 1, rt = 1, wr = {
  book: "GEN",
  chapterNum: 1,
  verseNum: 1
}, nt = (r) => {
  var e;
  return ((e = ge[r]) == null ? void 0 : e.chapters) ?? -1;
}, Cr = (r, e) => ({
  book: P.bookNumberToId(
    Math.max(
      Qe,
      Math.min(P.bookIdToNumber(r.book) + e, et)
    )
  ),
  chapterNum: 1,
  verseNum: 1
  ...
  ...r,
  chapterNum: Math.min(
    Math.max(tt, r.chapterNum + e),
    nt(P.bookIdToNumber(r.book))
  ),
  verseNum: 1
}), qr = (r, e) => ({
  ...r,
  verseNum: Math.max(rt, r.verseNum + e)
});
async function Ar(r, e, t) {
  const n = P.bookNumberToId(r);
  if (!me(Intl.getCanonicalLocales(e)[0], "zh"))
    return t({
  ...
  return ee(i[0], "ÿ08")[0].trim();
}
function $r(r) {
  return new de(P.bookIdToNumber(r.book), r.chapterNum, r.verseNum).BBBCCC;
}
function te(r) {
  return new de(P.bookIdToNumber(r.book), r.chapterNum, r.verseNum).BBBCCCVVV;
}
function it(r, e) {
  return te(r) - te(e);
}
...
function ye(r, e) {
  switch (e) {
    case "English":
      return P.bookIdToEnglishName(r.book);
    case "id":
    case void 0:
      return r.book;
    default:
...
function st(r, e) {
  const t = ye(r, e == null ? void 0 : e.optionOrLocalizedBookName), n = (e == null ? void 0 : e.bookChapterSeparator) ?? " ", s = (e == null ? void 0 : e.chapterVerseSeparator) ?? ":";
...
function re(r, e) {
  const t = ye(r, e == null ? void 0 : e.optionOrLocalizedBookName), n = at(
    r,
...
function Fr(r, e, t) {
  const n = re(r, t);
  if (it(r, e) === 0) return n;
  const s = r.book === e.book && !(t != null && t.repeatBookName) ? "" : (t == null ? void 0 : t.endRefOptionOrLocalizedBookName) ?? (t == null ? void 0 : t.optionOrLocalizedBookName), i = re(e, {
    ...t,
...
const Rr = (r) => {
  if (P.isBookOT(r)) return "OT";
  if (P.isBookNT(r)) return "NT";
  if (P.isBookDC(r)) return "DC";
  if (P.isExtraMaterial(r)) return "Extra";
...
function ie(r) {
  ...
  for (let s = 0; s < r.length; s += 1) {
    const i = r[s];
    i.charCodeAt(0) < 32 ? (t || (e += " "), t = !0) : !t && i === Ze && s + 1 < r.length && ne(r[s + 1]) || (ne(i) ? (t || (e += i), t = !0) : pt(i) && n === i || (e += i, t = !1)), n = i;
  }
  return e;
}
function se(r) {
...
function ke(r, e, t, n) {
  ...
  if (s && i) {
    const c = ie(r), d = ie(t);
    if (c !== d) {
      if (!q(D(c, -1) ?? "") && !q(D(d, -1) ?? "") || !ae(r, e) || !ae(t, n)) return !1;
      let l = c;
      for (; q(D(l, -1) ?? ""); ) l = Q(l, 0, -1);
      let p = d;
      for (; q(D(p, -1) ?? ""); ) p = Q(p, 0, -1);
      if (l !== p) return !1;
    }
  } else if (!s && !i) {
    ...
    const p = se(c.content), f = se(d.content);
    if (p !== f) return !1;
    if (!p && !f) {
      let g = c.content, u = d.content;
      const h = g[g.length - 1];
      J.includes(c.type) && M(h) && q(h) && (g = g.slice(0, -1));
      const m = u[u.length - 1];
      if (J.includes(d.type) && M(m) && q(m) && (u = u.slice(0, -1)), g.length !== u.length) return !1;
...
function Dr(r, e) {
  return ke(r, void 0, e, void 0);
}
const Lr = (r) => (...e) => r.map((n) => n(...e)).every((n) => n), Br = (r) => async (...e) => {
  const t = r.map(async (n) => n(...e));
  return (await Promise.all(t)).every((n) => n);
}, ut = "book", oe = "chapter", w = "verse", C = "***";
...
function ht(r, e) {
  const t = e && e.length > 0 ? e : be();
  return t[r % t.length];
}
function zr(r, e) {
  const t = e && e.length > 0 ? e : be(), n = (() => {
...
const Gr = (r) => r.replace(/&/g, "&amp;").replace(/</g, "&lt;").replace(/>/g, "&gt;").replace(/"/g, "&quot;").replace(/'/g, "&#x27;").replace(/\//g, "&#x2F;");
function Xr() {
  return typeof navigator < "u" && navigator.languages ? navigator.languages[0].replace(/@posix$/i, "") : new je().resolvedOptions().locale;
}
function Yr(r, e = 2) {
...
function tn(r, e, t) {
  ...
  return s.id = `${_t}${t ? `-${t}` : ""}`, s.dataset.themeId = r.id, s.textContent = It(r), this.document.head.appendChild(s), s;
}
function _e(r) {
...
USJ: ${JSON.stringify(
    ...
    else if (k.areUsjVersionsCompatible(this.usj.version, H.version))
      this.markersMap = H;
    else
      throw new Error(
  ...
  static findNextMatchingNodeOrClosingFragmentUsingWorkingStack(e, t, n, s) {
    ...
    if (!M(c)) {
      ...
      t.some((p) => {
        ...
        return !M(f) && n.includes(f.type) ? (l = f, !0) : !1;
      }), l && (i = l);
    }
    for (; i !== void 0; ) {
  ...
  jsonPathToNodeAndParentIfString(e) {
    ...
    const n = M(t) ? this.findParent(e) : void 0;
    if (!n && M(t))
  ...
  getVerseRefForIndexInUsfm(e, t) {
    ...
    return l && k.isFragmentAMarker(l.fragment) && l.fragment.type === w && l.fragment.number && l.fragment.number !== `${i.verseNum}` && (i.verse = l.fragment.number), i;
  }
  ...
  findNextLocationOfMatchingText(e, t, n = 1e3) {
    ...
    if (k.findNextMatchingNodeUsingWorkingStack(
      ...
      (h, m) => {
        ...
        if (p && k.areStackItemsShallowEqual(E, p)) {
        ...
        i += y.length, s = `${s}${y}`;
        const I = s.indexOf(t);
        return I < 0 ? (c += s.length, s.length > t.length && (s = s.substring(s.length - t.length)), c -= s.length, i > n) : (d = c + I, !0);
      }
    ), d < 0) return;
    i = 0;
    let f = 0, g = [];
  ...
  search(e, t) {
    ...
    for (; f !== void 0; )
      f = k.findNextMatchingNodeUsingWorkingStack(
        ...
        // eslint-disable-next-line no-loop-func
        (y, E) => (typeof y != "string" || n && E.some((x) => {
          const _ = x.parent;
          if (!_ || !("type" in _) || _.type === "char") return !1;
          let S;
          return "style" in _ && typeof _.style == "string" ? S = _.style : "marker" in _ && typeof _.marker == "string" && (S = _.marker), S !== void 0 && !n.has(S);
        }) || (d.push(y), l.set(p, {
          node: y,
          documentLocation: {
            offset: 0,
            jsonPath: k.convertWorkingStackToJsonPath(E)
          }
        }), p += y.length), !1)
      );
    ...
    for (; m; ) {
      if (m[0].length > 0) {
        const y = u ? u[m.index] : m.index, E = u ? u[m.index + m[0].length] : m.index + m[0].length;
        if (y < 0 || y >= g.length)
        ...
        }, _ = l.findClosestLessThanOrEqual(E - 1);
        if (!_)
        ...
        }, V = u ? g.substring(y, E) : m[0];
        i.push({ text: V, start: x, end: S });
      }
      if (!e.global) break;
      m = e.exec(h);
    }
  ...
  getInfoForMarker(e, t = "usfm") {
    ...
    const c = (i == null ? void 0 : i.type) ?? (M(e) ? "" : e.type);
    let d = n;
    ...
    if (p != null && p.markerTypeUsfm && (l = p.markerTypeUsfm, p = this.markersMap.markerTypes[l]), !M(e) && e.type !== c && (!p || e.type !== p.markerTypeUsfm && e.type !== p.markerTypeUsx && e.type !== p.markerTypeUsj) && (console.warn(
...
`);
    ...
    return s.push({ fragment: e, indexInUsfm: n.length }), n += d === "optbreak" ? "//" : `\\${g}`, d !== "optbreak" && (s.push({
      ...
      const { usfm: I } = this.textContentToUsfm(m);
      s.push({
        fragment: {
        ...
        indexInUsfm: n.length
      }), n += I, n = this.addMarkerUsfmToString(
        n,
        {
          isClosingMarker: !0,
          forMarker: y
        ...
        if (M(x.fragment) || "attributeKey" in x.fragment)
          throw new Error(
        ...
        if (k.isFragmentAMarker(x.fragment)) {
          s.push({
            ...x,
            fragment: {
        ...
        if ("isClosingMarker" in x.fragment) {
          const { isClosingMarker: _, ...S } = x.fragment, V = {
            ...S,
            forMarker: e,
  ...
  closingMarkerToUsfm(e, t) {
    const {
      ...
      var y, E;
      return !(m === "type" || m === "marker" || m === "content" || m === "closed" || (y = d.skipOutputAttributeToUsfm) != null && y.includes(m) || (E = i.leadingAttributes) != null && E.includes(m) || i.textContentAttribute === m || l.some(
        ([, I]) => I.attributeMarkerAttributeName === m
      ));
    }), f = e;
    ...
    if ((f.closed === "false" || i.isClosingMarkerOptional && !this.markersMap.shouldOptionalClosingMarkersBePresent && f.closed !== "true") && (g = !1), i.independentClosingMarkers && i.independentClosingMarkers.length > 0 && g) {
      ...
      let y = "";
      const E = [], { usfm: I, fragmentsInfo: x } = this.openingMarkerToUsfm(m, t), _ = x.find((S) => k.isFragmentAMarker(S.fragment));
      if (!_)
        throw new Error(
      ...
      }), y += I, n !== m.marker && (y = this.addMarkerUsfmToString(
        y,
        {
          isClosingMarker: !0,
          forMarker: m
...
`) && (i.length === 0 ? (d = d.map((u) => ({
 ...
 `);
  ...
  static areUsjDocumentLocationsEqual(e, t, n = !1) {
    ...
    return !n && !z($.toPathArray(s), $.toPathArray(c)) ? !1 : z(i, d);
  }
  ...
  static convertNodeToUsjDocumentLocation(e, t, n = 0) {
    ...
    return M(e) ? { jsonPath: s, offset: n } : { jsonPath: s };
  }
  /**
    ...
    e.map((l) => {
      ...
      if (typeof l.fragment == "object" && "type" in l.fragment) {
        ...
        if (h.type === ut && h.code)
          ...
          if (Number.isNaN(m))
            console.warn(
              `Found ${oe} type marker with number ${h.number}, but could not parse chapter number from it. Continuing using previous chapter number ${n.chapterNum}`
            );
          else {
          ...
          const m = (f = wt.exec(h.number)) == null ? void 0 : f[1];
          if (!m)
            console.warn(
              `Found ${w} type marker with number ${h.number}, but could not find starting verse number in it. Continuing using previous verse number ${n.verseNum}`
            );
          else {
            const y = parseInt(m, 10);
            Number.isNaN(y) ? console.warn(
              `Found ${w} type marker with number ${h.number}, but could not parse starting verse number from ${m}. Continuing using previous verse number ${n.verseNum}`
            ) : (u = (g = c[n.bookId]) == null ? void 0 : g[n.chapterNum]) != null && u[y] ? console.warn(`Found ${w} marker with existing number ${y} after
                  current ${w} number ${n.verseNum}! Not updating verse start index. All positions in this duplicate verse will be based on the current ${w} marker, not the new duplicate marker.`) : (y < n.verseNum && console.debug(
              `Found ${w} marker with number ${y} lower than current ${w} number ${n.verseNum}. Verses are out of order. There may be some issues.`
            ), n.verseNum = y);
          }
        }
      }
  ...
  calculateUsfmProperties() {
    let e = "";
    const t = new W(), n = /* @__PURE__ */ new Map(), s = {}, i = [], c = {
      bookId: C,
      chapterNum: 0,
      verseNum: 0
    };
...
export {
  Qt as ABORTED,
  er as ALREADY_EXISTS,
  G as AsyncVariable,
  tr as CANCELLED,
  oe as CHAPTER_TYPE,
  Ft as Collator,
  rr as DATA_LOSS,
  nr as DEADLINE_EXCEEDED,
  jr as DEFAULT_SCROLL_GROUP_LOCALIZED_STRINGS,
  je as DateTimeFormat,
  De as DocumentCombiner,
  Kt as EventRollingTimeCounter,
  ir as FAILED_PRECONDITION,
  Qe as FIRST_SCR_BOOK_NUM,
  tt as FIRST_SCR_CHAPTER_NUM,
  rt as FIRST_SCR_VERSE_NUM,
  sr as INTERNAL,
  ar as INVALID_ARGUMENT,
  et as LAST_SCR_BOOK_NUM,
  Qr as MODIFIER_KEYS,
  Be as Mutex,
  Gt as MutexMap,
  or as NOT_FOUND,
  ...
  Ve as NumberFormat,
  cr as OUT_OF_RANGE,
  dr as PERMISSION_DENIED,
  R as PLATFORM_ERROR_VERSION,
  ...
  ot as Section,
  W as SortedNumberMap,
  Wt as SortedSet,
  _t as THEME_STYLE_ELEMENT_ID,
  pr as UNAUTHENTICATED,
  ur as UNAVAILABLE,
  hr as UNIMPLEMENTED,
  fr as UNKNOWN,
  ...
  Lr as aggregateUnsubscribers,
  tn as applyThemeStylesheet,
  Dr as areUsjContentsEqualExceptWhitespace,
  D as at,
  A as charAt,
  yr as codePointAt,
  Pr as collapseMiddleWords,
  it as compareScrRefs,
  ...
  en as expandThemeContribution,
  Yr as formatBytes,
  Zr as formatRelativeDate,
  kr as formatReplacementString,
  Ke as formatReplacementStringToArray,
  Ur as formatScrRef,
  Fr as formatScrRefRange,
  Wr as formatTimeSpan,
  Vt as getAllObjectFunctionNames,
  nt as getChaptersForBook,
  Xr as getCurrentLocale,
  be as getDefaultCallerSequence,
  ue as getErrorMessage,
  zr as getFormatCallerFunction,
  v as getLocalizeKeyForScrollGroupId,
  Or as getLocalizeKeysForScrollGroupIds,
  Ar as getLocalizedIdFromBookNumber,
  ht as getNthCaller,
  Hr as getPaneSizeLimits,
  ...
  Ye as toArray,
  Sr as toKebabCase,
  Ir as transformAndEnsureRegExpArray,
