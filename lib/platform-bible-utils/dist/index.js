...
var de = (n, e, t) => e in n ? ce(n, e, { enumerable: !0, configurable: !0, writable: !0, value: t }) : n[e] = t;
var k = (n, e, t) => de(n, typeof e != "symbol" ? e + "" : e, t);
import { d as C, i as _ } from "./scripture-util-DArajUVn.js";
import { D as er, F as tr, a as rr, b as nr, G as ir, L as sr, M as ar, S as or, c as cr, e as dr, f as pr, g as lr, h as ur, j as hr, k as fr, l as mr, m as gr, n as yr, o as kr, p as br, q as vr, r as Mr, s as xr, t as _r, u as Er, v as Ir, w as wr, x as Sr, y as Pr, z as Tr, A as Cr, B as Ar, C as qr, E as $r, H as jr, I as Nr, J as Or, K as Fr, N as Ur, O as Rr, P as Dr, Q as Lr, R as Br, T as Vr, U as zr, V as Hr, W as Jr, X as Kr, Y as Gr, Z as Yr, _ as Xr, $ as Wr, a0 as Zr, a1 as Qr, a2 as en, a3 as tn, a4 as rn, a5 as nn, a6 as sn, a7 as an, a8 as on, a9 as cn, aa as dn, ab as pn, ac as ln, ad as un } from "./scripture-util-DArajUVn.js";
import { Mutex as pe } from "async-mutex";
import le from "dompurify";
import { deepEqual as ue } from "fast-equals";
import { USJ_TYPE as he } from "@eten-tech-foundation/scripture-utilities";
...
const A = class A {
  ...
  resolveToValue(e, t = !1) {
    if (this.resolver)
      A.verboseLoggingEnabled && console.debug(`${this.variableName} is being resolved now`), this.resolver(e), this.complete();
    else {
  ...
  rejectWithReason(e, t = !1) {
    if (this.rejecter)
      A.verboseLoggingEnabled && console.debug(`${this.variableName} is being rejected now with reason: ${e}`), this.rejecter(e), this.complete();
    else {
      if (t) throw Error(`${this.variableName} was already settled`);
...
class ye {
  ...
  constructor(e, t) {
    ...
    k(this, "latestOutput");
    k(this, "options");
    k(this, "onDidRebuildEmitter", new ge());
  ...
  addOrUpdateContribution(e, t) {
    ...
    let s = this.options.copyDocuments && t ? C(t) : t;
...
class rt {
  ...
  get(e) {
    ...
    return t || (t = new be(), this.mutexesByID.set(e, t), t);
  }
  /**
...
class it {
  ...
  cleanupPromiseChain(e) {
    ...
    if (!t) return;
    const r = { promise: Me }, s = t.catch((i) => this.logger.warn(`Error in promise for ${e}: ${i.message}`)).finally(() => {
...
const ee = 1e4, O = ee / 1e3, te = 3, H = /* @__PURE__ */ new Map(), xe = {
  unsubscribed: {
    ...
    suppressed: (n, e) => `UnsubscriberAsyncList ${n}: ${e} more unsubscribers arrived after the list was run in the last ${O}s and were unsubscribed immediately; per-occurrence warnings suppressed.`
  },
  failed: {
    log: (n) => console.error(n),
    first: (n) => `UnsubscriberAsyncList ${n}: Unsubscriber added after the list was run failed!`,
    suppressed: (n, e) => `UnsubscriberAsyncList ${n}: ${e} more unsubscribers added after the list was run failed in the last ${O}s; per-occurrence errors suppressed.`
  },
  threw: {
    log: (n) => console.error(n),
    ...
    suppressed: (n, e, t) => `UnsubscriberAsyncList ${n}: ${e} more unsubscribers added after the list was run threw in the last ${O}s; per-occurrence errors suppressed. Distinct errors sampled (up to ${te}): ${t.join(" | ")}`
  }
};
function J(n, e, t) {
  const { log: r, first: s, suppressed: i } = xe[e], c = `${n}\0${e}`, p = Date.now(), d = H.get(c);
  if (!d || p >= d.closesAt) {
    r(s(n, t)), H.set(c, {
      closesAt: p + ee,
      suppressedCount: 0,
  ...
  d.suppressedCount += 1, t !== void 0 && d.suppressedErrorSamples.size < te && d.suppressedErrorSamples.add(`${t}`), d.summaryTimeout || (d.summaryTimeout = setTimeout(() => {
...
const ot = "ABORTED", ct = "ALREADY_EXISTS", dt = "CANCELLED", pt = "DATA_LOSS", lt = "DEADLINE_EXCEEDED", ut = "FAILED_PRECONDITION", ht = "INTERNAL", ft = "INVALID_ARGUMENT", mt = "NOT_FOUND", gt = "OUT_OF_RANGE", yt = "PERMISSION_DENIED", kt = "RESOURCE_EXHAUSTED", bt = "UNAUTHENTICATED", vt = "UNAVAILABLE", Mt = "UNIMPLEMENTED", xt = "UNKNOWN", q = 1;
function _t(n, e) {
  if (!n)
    return {
      message: "",
      ...e && { code: e },
      platformErrorVersion: q
    };
  if (_(n))
    return {
      message: n,
  ...
  if (typeof n == "object" && "message" in n && typeof n.message == "string") {
    ...
    return Object.defineProperties(t, Object.getOwnPropertyDescriptors(n)), Object.defineProperty(t, "message", { enumerable: !0 }), "stack" in n && _(n.stack) && Object.defineProperty(t, "stack", { value: n.stack, enumerable: !0 }), "cause" in t && Object.defineProperty(t, "cause", { enumerable: !0 }), e && (t.code = e), t;
  }
  return {
    cause: n,
    message: "",
...
const It = (n) => (...e) => n.map((r) => r(...e)).every((r) => r), wt = (n) => async (...e) => {
  const t = n.map(async (r) => r(...e));
  return (await Promise.all(t)).every((r) => r);
}, K = "book", G = "chapter", w = "verse", S = "***";
...
function St(n) {
  var e;
  return ((e = R[n]) == null ? void 0 : e.type) === a.Paragraph || n === "v";
}
function Pt(n) {
  const e = R[n];
...
function Tt(n) {
  var e;
  return ((e = R[n]) == null ? void 0 : e.type) === a.Paragraph;
}
const Y = 0.5, X = 3, _e = 0.1;
function Ee(n) {
  return n < Y ? Y : n > X ? X : n;
}
function Ie(n) {
...
function Ct(n, e) {
  let t = n;
  return e > 0 ? t = Math.floor(n * 10 + W) / 10 : e < 0 && (t = Math.ceil(n * 10 - W) / 10), Ie(Ee(t + e * _e));
}
function At(n) {
  return le.sanitize(n, {
    ALLOWED_TAGS: [
      "p",
      "br",
      "b",
...
function we(n, e) {
  const t = e && e.length > 0 ? e : re();
  return t[n % t.length];
}
function qt(n, e) {
  const t = e && e.length > 0 ? e : re(), r = (() => {
    const s = /* @__PURE__ */ new Map();
    let i = 0;
    return n.forEach((c, p) => {
      c.caller === "+" && (s.set(p, we(i, t)), i += 1);
    }), s;
  })();
  return (s, i) => {
    if (s === "+") {
...
function Pe(n, e) {
  ...
  return Object.keys(t).forEach((i) => {
    s && (Object.hasOwn(r, i) && Pe(r[i], t[i]) || (s = !1));
  }), s;
}
function Z(n, e, t) {
...
const Nt = (n) => n.replace(/&/g, "&amp;").replace(/</g, "&lt;").replace(/>/g, "&gt;").replace(/"/g, "&quot;").replace(/'/g, "&#x27;").replace(/\//g, "&#x2F;");
function Ot() {
  return typeof navigator < "u" && navigator.languages ? navigator.languages[0].replace(/@posix$/i, "") : new fe().resolvedOptions().locale;
}
function Ft(n, e = 2) {
...
function Ce(n) {
  return !!$e(n.fullName) && n.fullName !== n.shortName;
}
const Ae = " - ";
function Rt(n) {
  return Ce(n) ? `${n.shortName}${Ae}${n.fullName}` : n.shortName;
}
function qe(n, e) {
  return n.localeCompare(e, void 0, { sensitivity: "base" });
}
function Dt(n, e) {
  return qe(n.shortName, e.shortName);
}
function $e(n) {
  return typeof n == "string" && n.trim().length > 0 ? n : void 0;
}
const je = 1e3, ne = 60, ie = ne * 60, Ne = ie * 24;
function Lt(n, e, t = /* @__PURE__ */ new Date()) {
  const r = Math.floor((e.getTime() - t.getTime()) / je), s = Math.round(r / Ne);
  if (Math.abs(s) >= 1) return n.format(s, "day");
  const i = Math.round(r / ie);
  if (Math.abs(i) >= 1) return n.format(i, "hour");
  const c = Math.round(r / ne);
...
function Jt(n) {
  const e = {};
  return typeof n.language == "string" && n.language.length > 0 && (e[$.language] = n.language), typeof n.type == "string" && n.type.length > 0 && (e[$.type] = n.type), typeof n.typeName == "string" && n.typeName.length > 0 && (e[$.typeName] = n.typeName), typeof n.lastUsedAt == "number" && Number.isFinite(n.lastUsedAt) && (e[$.lastUsedAt] = n.lastUsedAt), e;
}
function Kt(n) {
...
function Xt(n, e, t) {
  ...
  return s.id = `${Le}${t ? `-${t}` : ""}`, s.dataset.themeId = n.id, s.textContent = Ve(n), this.document.head.appendChild(s), s;
}
function oe(n) {
  return Object.freeze(n), n == null || Object.getOwnPropertyNames(n).forEach(function(t) {
    ...
    n[t] !== null && (typeof n[t] == "object" || typeof n[t] == "function") && !Object.isFrozen(n[t]) && oe(n[t]);
  }), n;
}
const U = oe({
  version: "3.0.7",
...
class g {
  constructor(e, t) {
    ...
    else if (g.areUsjVersionsCompatible(this.usj.version, U.version))
      this.markersMap = U;
    else
      throw new Error(
  ...
  getBookIdForLogging() {
    ...
    const e = (t = this.usj.content) == null ? void 0 : t.find(
      (r) => typeof r != "string" && r.type === K && !!r.code
    );
    return (e == null ? void 0 : e.code) ?? S;
  }
  /**
  ...
  static isTopLevelUsjMarker(e, t) {
    return typeof e == "object" && e.type === he && t.length === 0;
  }
  /**
  ...
  static createParentMapInternal(e, t, r) {
    ...
    r.set(e, t), e.content && r.set(e.content, e), (s = e.content) == null || s.forEach((i) => {
      typeof i == "object" && g.createParentMapInternal(i, e, r);
    });
  }
  ...
  findAllNotes() {
    var e;
    return Se((e = this.usj) == null ? void 0 : e.content);
  }
  /**
  ...
  nodeToUsjNodeAndDocumentLocation(e, t) {
    ...
    const s = g.convertNodeToUsjDocumentLocation(e, r);
    return {
      node: e,
      documentLocation: s
    };
  ...
  usjDocumentLocationToUsfmVerseRefVerseLocation(e, t) {
    ...
    return {
      ...
      offset: r.indexInUsfm - i + g.getOffsetInUsjDocumentLocation(e)
    };
  }
  ...
  getVerseRefForIndexInUsfm(e, t) {
    ...
    return d && g.isFragmentAMarker(d.fragment) && d.fragment.type === w && d.fragment.number && d.fragment.number !== `${i.verseNum}` && (i.verse = d.fragment.number), i;
  }
  ...
  usfmVerseLocationToUsjNodeAndDocumentLocation(e) {
    const { verseRef: t, offset: r } = g.usfmVerseLocationToUsfmVerseRefVerseLocation(e), s = this.usfmVerseLocationToIndexInUsfm(e), { value: i } = this.fragmentsByIndexInUsfm.findClosestLessThanOrEqual(
      s
    ) ?? {
      value: void 0
    };
  ...
  findNextLocationOfMatchingText(e, t, r = 1e3) {
    ...
    if (g.findNextMatchingNodeUsingWorkingStack(
      ...
      (h, f) => {
        ...
        if (l && g.areStackItemsShallowEqual(v, l)) {
        ...
        i += y.length, s = `${s}${y}`;
        const E = s.indexOf(t);
        return E < 0 ? (c += s.length, s.length > t.length && (s = s.substring(s.length - t.length)), c -= s.length, i > r) : (p = c + E, !0);
      }
    ), p < 0) return;
    i = 0;
    let m = 0, b = [];
  ...
  search(e, t) {
    ...
    for (; m !== void 0; )
      m = g.findNextMatchingNodeUsingWorkingStack(
        ...
        // eslint-disable-next-line no-loop-func
        (y, v) => (typeof y != "string" || r && v.some((M) => {
          const x = M.parent;
          ...
          documentLocation: {
            offset: 0,
            jsonPath: g.convertWorkingStackToJsonPath(v)
          }
        }), l += y.length), !1)
      );
    const b = p.join(""), u = s === "NFD" ? g.buildNFDToOriginalPositionMap(b) : void 0, h = u ? b.normalize("NFD") : b;
    let f = e.exec(h);
    for (; f; ) {
      if (f[0].length > 0) {
        const y = u ? u[f.index] : f.index, v = u ? u[f.index + f[0].length] : f.index + f[0].length;
        if (y < 0 || y >= b.length)
        ...
        }, x = d.findClosestLessThanOrEqual(v - 1);
        if (!x)
        ...
        }, N = u ? b.substring(y, v) : f[0];
        i.push({ text: N, start: M, end: I });
      }
      if (!e.global) break;
      f = e.exec(h);
    }
  ...
  extractTextBetweenPoints(e, t, r = 100) {
    ...
    return g.findNextMatchingNodeUsingWorkingStack(
      ...
      this.convertJsonPathToWorkingStack(e.documentLocation.jsonPath),
      T,
      (i, c) => i === t.node && (typeof i == "object" || t.documentLocation.jsonPath === g.convertWorkingStackToJsonPath(c)) ? !0 : typeof i != "string" ? !1 : (s = `${s}${i}`, s.length > r && (s = s.substring(0, r)), s.length >= r)
    ), s;
  }
  ...
  getInfoForMarker(e, t = "usfm") {
    ...
    const c = (i == null ? void 0 : i.type) ?? (_(e) ? "" : e.type);
    let p = r;
    ...
    if (l != null && l.markerTypeUsfm && (d = l.markerTypeUsfm, l = this.markersMap.markerTypes[d]), !_(e) && e.type !== c && (!l || e.type !== l.markerTypeUsfm && e.type !== l.markerTypeUsx && e.type !== l.markerTypeUsj) && (this.reportProblemOnce(
    ...
    if (t === "usfm" && d === "cell" && b.colspan) {
      const u = parseInt(b.colspan, 10), h = He.exec(r);
      if (h != null && h[1]) {
  ...
  textContentToUsfm(e) {
    return {
      usfm: this.shouldAllowInvisibleCharacters ? e : e.replace(ze, "~"),
...
`);
    ...
    return s.push({ fragment: e, indexInUsfm: r.length }), r += p === "optbreak" ? "//" : `\\${b}`, p !== "optbreak" && (s.push({
      ...
      s.push({
        ...
        if (_(M.fragment) || "attributeKey" in M.fragment)
          throw new Error(
        ...
        if (g.isFragmentAMarker(M.fragment)) {
          s.push({
            ...M,
            fragment: {
        ...
        if ("isClosingMarker" in M.fragment) {
          const { isClosingMarker: x, ...I } = M.fragment, N = {
            ...I,
            forMarker: e,
  ...
  closingMarkerToUsfm(e, t) {
    const {
      ...
      var y, v;
      return !(f === "type" || f === "marker" || f === "content" || f === "closed" || (y = p.skipOutputAttributeToUsfm) != null && y.includes(f) || (v = i.leadingAttributes) != null && v.includes(f) || i.textContentAttribute === f || d.some(
    ...
    if ((m.closed === "false" || i.isClosingMarkerOptional && !this.markersMap.shouldOptionalClosingMarkersBePresent && m.closed !== "true") && (b = !1), i.independentClosingMarkers && i.independentClosingMarkers.length > 0 && b) {
      ...
      let y = "";
      const v = [], { usfm: E, fragmentsInfo: M } = this.openingMarkerToUsfm(f, t), x = M.find((I) => g.isFragmentAMarker(I.fragment));
      if (!x)
        throw new Error(
    ...
    if (l.length > 0 && (u += "|", l.length === 1 && l[0] === i.defaultAttribute ? (h.push({
    ...
    }), u += m[i.defaultAttribute]) : l.forEach((f, y) => {
      const v = c === "figure" && f === "file" ? "src" : f;
      y > 0 && (u += " "), h.push({
      ...
      const f = p.isClosingMarkerEmpty ? "" : s, y = t ? p.nestedPrefix ?? "" : "";
      h.push({
        fragment: { isClosingMarker: !0, forMarker: e },
        indexInUsfm: u.length
      }), u += `\\${y}${f}*`;
  ...
  addMarkerUsfmToString(e, t, r, s) {
    ...
    if ("isClosingMarker" in t) {
      ...
      !c.startsWith("|") && (i = g.removeEndSpace(i));
    } else {
...
`) && (i.length === 0 ? (p = p.map((u) => ({
    ...
    })), c = c.substring(1)) : i = g.removeEndSpace(i)), this.markersMap.isSpaceAfterAttributeMarkersContent && d === "ca") {
 ...
 `);
  ...
  static areUsjDocumentLocationsEqual(e, t, r = !1) {
    ...
    return !r && !F(P.toPathArray(s), P.toPathArray(c)) ? !1 : F(i, p);
  }
  ...
  static convertNodeToUsjDocumentLocation(e, t, r = 0) {
    ...
    return _(e) ? { jsonPath: s, offset: r } : { jsonPath: s };
  }
  /**
  ...
  transferFragmentsInfoArrayToMaps(e, t, r, s, i, c) {
    e.map((d) => {
      ...
      if (typeof d.fragment == "object" && "type" in d.fragment) {
        ...
        if (h.type === K && h.code)
        ...
        else if (h.type === G && h.number) {
          const f = parseInt(h.number, 10);
          if (Number.isNaN(f))
            this.reportProblemOnce(
              `Found ${G} type marker with number ${h.number}, but could not parse chapter number from it. Continuing using previous chapter number ${r.chapterNum}`
            );
          else {
          ...
          const f = (m = Je.exec(h.number)) == null ? void 0 : m[1];
          if (!f)
            this.reportProblemOnce(
            ...
            else if ((u = (b = c[r.bookId]) == null ? void 0 : b[r.chapterNum]) != null && u[y]) {
              const v = `Found ${w} marker with existing number ${y} after current ${w} number ${r.verseNum}! Not updating verse start index. All positions in this duplicate verse will be based on the current ${w} marker, not the new duplicate marker.`;
              this.reportProblemOnce(v);
            } else
              y < r.verseNum && console.debug(
  ...
  calculateUsfmProperties() {
    let e = "";
    const t = new z(), r = /* @__PURE__ */ new Map(), s = {}, i = [], c = {
      bookId: S,
      chapterNum: 0,
      verseNum: 0
    }, p = (m) => {
    ...
    return g.findNextMatchingNodeOrClosingFragmentUsingWorkingStack(
      ...
      (m, b) => {
        ...
        return b.length > 0 && (u = b[b.length - 1].parent), "isClosingMarker" in m ? l.length > 0 && l[l.length - 1] === m.forMarker ? (l.pop(), !1) : (e = this.addMarkerUsfmToString(
          ...
          u,
          i
        ), p(b), m.forMarker.type === "book" && d && (e = this.addMarkerUsfmToString(e, d, u, i), p(b), d = void 0), !1) : this.shouldSkipOutputMarkerToUsfm(m) ? (l.push(m), !1) : g.isTopLevelUsjMarker(m, b) && !d ? (m.version !== "3.0" && (d = m), !1) : (e = this.addMarkerUsfmToString(e, m, u, i), p(b), !1);
      }
...
export {
  ...
  et as Collator,
  pt as DATA_LOSS,
  lt as DEADLINE_EXCEEDED,
  er as DEBOUNCE_CANCELED_ERROR_MESSAGE,
  fe as DateTimeFormat,
  ye as DocumentCombiner,
  tt as EventRollingTimeCounter,
  ut as FAILED_PRECONDITION,
  tr as FIRST_SCR_BOOK_NUM,
  rr as FIRST_SCR_CHAPTER_NUM,
  nr as FIRST_SCR_VERSE_NUM,
  ir as GraphemeString,
  ht as INTERNAL,
  ft as INVALID_ARGUMENT,
  sr as LAST_SCR_BOOK_NUM,
  ar as MAX_PADDING_LENGTH,
  X as MAX_ZOOM_FACTOR,
  Y as MIN_ZOOM_FACTOR,
  Vt as MODIFIER_KEYS,
  a as MarkerType,
  be as Mutex,
  rt as MutexMap,
  ...
  ve as NumberFormat,
  gt as OUT_OF_RANGE,
  yt as PERMISSION_DENIED,
  q as PLATFORM_ERROR_VERSION,
  Ae as PROJECT_NAME_SEPARATOR,
  $ as PROJECT_SELECTOR_CUSTOM_DATA_KEYS,
  ge as PlatformEventEmitter,
  it as PromiseChainingMap,
  kt as RESOURCE_EXHAUSTED,
  or as SELECTABLE_INVISIBLE_CHAR_OR_WHITESPACE_CLASS,
  cr as Section,
  z as SortedNumberMap,
  st as SortedSet,
  Le as THEME_STYLE_ELEMENT_ID,
  bt as UNAUTHENTICATED,
  vt as UNAVAILABLE,
  Mt as UNIMPLEMENTED,
  xt as UNKNOWN,
  U as USFM_MARKERS_MAP_3_0,
  Wt as USFM_MARKERS_MAP_PARATEXT_3_0,
  at as UnsubscriberAsyncList,
  g as UsjReaderWriter,
  w as VERSE_TYPE,
  _e as ZOOM_STEP,
  Ct as adjustZoomFactor,
  wt as aggregateUnsubscriberAsyncs,
  It as aggregateUnsubscribers,
  Xt as applyThemeStylesheet,
  dr as areUsjContentsEqualExceptWhitespace,
  pr as at,
  lr as charAt,
  Ee as clampZoom,
  ur as codePointAt,
  hr as collapseMiddleWords,
  fr as collectUsjMarkers,
  qe as compareProjectShortNames,
  Dt as compareProjectsByName,
  mr as compareScrRefs,
  Ht as computeEffectiveStructureProtection,
  gr as createSyncProxyForAsyncObject,
  yr as debounce,
  C as deepClone,
  F as deepEqual,
  kr as defaultScrRef,
  Te as deserialize,
  Gt as doesCatalogRowCoverProject,
  br as endsWith,
  vr as ensureArray,
  Mr as escapeStringRegexp,
  Yt as expandThemeContribution,
  Ft as formatBytes,
  Rt as formatProjectName,
  Bt as formatRelativeDate,
  xr as formatReplacementString,
  _r as formatReplacementStringToArray,
  Er as formatScrRef,
  Ir as formatScrRefRange,
  Lt as formatTimeSpan,
  wr as getAllObjectFunctionNames,
  Sr as getChaptersForBook,
  Ot as getCurrentLocale,
  re as getDefaultCallerSequence,
  Pr as getErrorMessage,
  qt as getFormatCallerFunction,
  zt as getLocalizeKeyForPhysicalKey,
  Tr as getLocalizeKeyForScrollGroupId,
  Cr as getLocalizeKeysForScrollGroupIds,
  Ar as getLocalizedIdFromBookNumber,
  we as getNthCaller,
  $t as getPaneSizeLimits,
  qr as getSectionForBook,
  Ve as getStylesheetForTheme,
  $r as groupBy,
  Ce as hasDistinctFullName,
  Nt as htmlEncode,
  jr as includes,
  Nr as indexOf,
  St as isBlockMarker,
  Pt as isCharacterMarker,
  Or as isErrorMessageAboutParatextBlockingInternetAccess,
  Fr as isErrorMessageAboutRegistryAuthFailure,
  Ur as isLocalizeKey,
  Tt as isParagraphMarker,
  Et as isPlatformError,
  Rr as isSelectableInvisibleCharOrWhiteSpace,
  ...
  Lr as isolateBidi,
  Br as lastIndexOf,
  Ue as localizedStringsDocumentSchema,
  Jt as makeProjectSelectorCustomData,
  Re as menuDocumentSchema,
  Vr as newGuid,
  _t as newPlatformError,
  zr as normalize,
  $e as normalizeFullName,
  Ut as normalizeProjectId,
  Hr as normalizeScriptureSpaces,
  Jr as offsetBook,
  Kr as offsetChapter,
  Gr as offsetVerse,
  Yr as ordinalCompare,
  Xr as padEnd,
  Wr as padStart,
  Oe as projectSettingsDocumentSchema,
  Kt as recencyMapFromOrderedIds,
  Zr as retryUntil,
  Ie as roundZoom,
  At as sanitizeHtml,
  Qr as scrRefToBBBCCC,
  en as scrRefToBBBCCCVVV,
  Z as serialize,
  Fe as settingsDocumentSchema,
  tn as slice,
  rn as split,
  nn as startsWith,
  sn as stringLength,
  an as substring,
  De as themeDocumentSchema,
  on as toArray,
  cn as toKebabCase,
  dn as transformAndEnsureRegExpArray,
  pn as transformAndEnsureRegExpRegExpArray,
  R as usfmMarkers,
  ln as wait,
  un as waitForDuration
};
