...
function ju(t, e, n) {
  ...
  return t.forEach((o) => {
    const a = e(o), h = i.get(a), l = n ? n(o, a) : o;
    h ? h.push(l) : i.set(a, [l]);
  }), i;
}
function Zr(t) {
...
const ve = class X {
   ...
   */
  static fromJSON(e) {
    const { book: n, chapterNum: i, verseNum: o, verse: a, versificationStr: h } = e, l = a || o.toString();
    let p;
  ...
  parse(e) {
    ...
    if (i.length !== 2 || Ce.bookIdToNumber(n[0]) === 0 || !Number.isInteger(o) || o < 0 || !X.isVerseParseable(i[1]))
      throw new Ct("Invalid reference : " + e);
  ...
  allVerses(e = !1, n = X.verseRangeSeparators, i = X.verseSequenceIndicators) {
    ...
    for (const h of a.map((l) => rr(l, n))) {
      const l = this.clone();
      l.verse = h[0];
      const p = l.verseNum;
      if (o.push(l), h.length > 1) {
        const m = this.clone();
        if (m.verse = h[1], !e)
...
function Dt() {
  ...
  return fe.assign = i, fe.find = t, fe.freeze = e, fe.HTML_BOOLEAN_ATTRIBUTES = o, fe.HTML_RAW_TEXT_ELEMENTS = p, fe.HTML_VOID_ELEMENTS = h, fe.hasDefaultHTMLNamespace = v, fe.hasOwn = n, fe.isHTMLBooleanAttribute = a, fe.isHTMLRawTextElement = m, fe.isHTMLEscapableRawTextElement = E, fe.isHTMLMimeType = f, fe.isHTMLVoidElement = l, fe.isValidMimeType = C, fe.MIME_TYPE = w, fe.NAMESPACE = k, fe;
}
var dt = {}, ur;
function Bt() {
  if (ur) return dt;
...
function kr() {
  ...
  e && (l = o("[", n(l), "\\u{10000}-\\u{10FFFF}", "]"));
  var p = /[\x20\x09\x0D\x0A]/, m = n(p), E = o(p, "+"), f = o(p, "*"), v = /[:_a-zA-Z\xC0-\xD6\xD8-\xF6\xF8-\u02FF\u0370-\u1FFF\u200C-\u200D\u2070-\u218F\u2C00-\u2FEF\u3001-\uD7FF\uF900-\uFDCF\uFDF0-\uFFFD]/;
  e && (v = o("[", n(v), "\\u{10000}-\\u{10FFFF}", "]"));
  var w = n(v), b = o("[", w, n(/[-.0-9\xB7]/), n(/[\u0300-\u036F\u203F-\u2040]/), "]"), C = o(v, b, "*"), k = o(b, "+"), x = o("&", C, ";"), F = a(/&#[0-9]+;|&#x[0-9a-fA-F]+;/), q = a(x, "|", F), ue = o("%", C, ";"), he = a(
    o('"', a(/[^%&"]/, "|", ue, "|", q), "*", '"'),
    "|",
    o("'", a(/[^%&']/, "|", ue, "|", q), "*", "'")
  ), D = a('"', a(/[^<&"]/, "|", q), "*", '"', "|", "'", a(/[^<&']/, "|", q), "*", "'"), R = i(v, ":"), L = i(b, ":"), V = o(R, L, "*"), Y = o(V, a(":", V), "?"), ee = o("^", Y, "$"), Se = o("(", Y, ")"), te = a(/"[^"]*"|'[^']*'/), Me = o(/^<\?/, "(", C, ")", a(E, "(", l, "*?)"), "?", /\?>/), d = /[\x20\x0D\x0Aa-zA-Z0-9-'()+,./:=?;!*#@$_%]/, A = a('"', d, '*"', "|", "'", i(d, "'"), "*'"), S = "<!--", O = "-->", B = o(S, a(i(l, "-"), "|", o("-", i(l, "-"))), "*", O), N = "#PCDATA", M = a(
    o(/\(/, f, N, a(f, /\|/, f, Y), "*", f, /\)\*/),
    "|",
    o(/\(/, f, N, f, /\)/)
  ), G = /[?*+]?/, _ = o(
  ...
  ), y = a("EMPTY", "|", "ANY", "|", M, "|", _), I = "<!ELEMENT", P = o(I, E, a(Y, "|", ue), E, a(y, "|", ue), f, ">"), re = o("NOTATION", E, /\(/, f, C, a(f, /\|/, f, C), "*", f, /\)/), K = o(/\(/, f, k, a(f, /\|/, f, k), "*", f, /\)/), ye = a(re, "|", K), Te = a(/CDATA|ID|IDREF|IDREFS|ENTITY|ENTITIES|NMTOKEN|NMTOKENS/, "|", ye), se = a(/#REQUIRED|#IMPLIED/, "|", a(a("#FIXED", E), "?", D)), oe = a(E, C, E, Te, E, se), j = "<!ATTLIST", ze = o(j, E, C, oe, "*", f, ">"), Ae = "SYSTEM", ce = "PUBLIC", Be = a(a(Ae, E, te), "|", a(ce, E, A, E, te)), Le = o(
    "^",
    a(
  ...
  ), it = a(E, "NDATA", E, C), je = a(he, "|", a(Be, it, "?")), $e = "<!ENTITY", ot = o($e, E, C, E, je, f, ">"), Q = a(he, "|", Be), ge = o($e, E, "%", E, C, E, Q, f, ">"), le = a(ot, "|", ge), Je = o(ce, E, A), at = o("<!NOTATION", E, C, E, a(Be, "|", Je), f, ">"), Fe = o(f, "=", f), Xe = /1[.]\d+/, U = o(E, "version", Fe, a("'", Xe, "'", "|", '"', Xe, '"')), ie = /[A-Za-z][-A-Za-z0-9._]*/, De = a(E, "encoding", Fe, a('"', ie, '"', "|", "'", ie, "'")), Ne = a(E, "standalone", Fe, a("'", a("yes", "|", "no"), "'", "|", '"', a("yes", "|", "no"), '"')), Ue = o(/^<\?xml/, U, De, "?", Ne, "?", f, /\?>/), Ye = "<!DOCTYPE", st = "<![CDATA[", ct = "]]>", lt = /<!\[CDATA\[/, vt = /\]\]>/, At = o(l, "*?", vt), ft = o(lt, At);
...
function qr() {
  if (or) return ne;
  or = 1;
  var t = Dt(), e = t.find, n = t.hasDefaultHTMLNamespace, i = t.hasOwn, o = t.isHTMLMimeType, a = t.isHTMLRawTextElement, h = t.isHTMLVoidElement, l = t.MIME_TYPE, p = t.NAMESPACE, m = Symbol(), E = Bt(), f = E.DOMException, v = E.DOMExceptionName, w = kr();
  function b(r) {
    if (r !== m)
  ...
  function ce(r, u) {
    b(r);
    var s = u || {};
    this.ownerDocument = this, this.contentType = s.contentType || l.XML_APPLICATION, this.type = o(this.contentType) ? "html" : "xml";
  }
  function Be(r, u, s) {
    r && r._inc++;
  ...
  function Lt(r, u, s) {
    ...
    switch (u.childNodes && (c.childNodes = new I()), c.ownerDocument = r, c.nodeType) {
      case V:
        ...
        for (var Oe = 0; Oe < be; Oe++)
          c.setAttributeNode(Lt(r, J.item(Oe), !0));
        break;
      case Y:
        s = !0;
    }
    if (s)
      for (var Ie = u.firstChild; Ie; )
        c.appendChild(Lt(r, Ie, s)), Ie = Ie.nextSibling;
    return c;
  }
  function Kt(r, u, s) {
    r[u] = s;
...
function Nn() {
  if (sr) return yt;
  sr = 1;
  var t = Dt(), e = kr(), n = Bt(), i = t.isHTMLEscapableRawTextElement, o = t.isHTMLMimeType, a = t.isHTMLRawTextElement, h = t.hasOwn, l = t.NAMESPACE, p = n.ParseError, m = n.DOMException, E = 0, f = 1, v = 2, w = 3, b = 4, C = 5, k = 6, x = 7;
  function F() {
  }
  F.prototype = {
...
function bn() {
  if (cr) return et;
  cr = 1;
  var t = Dt(), e = qr(), n = Bt(), i = An(), o = Nn(), a = e.DOMImplementation, h = t.hasDefaultHTMLNamespace, l = t.isHTMLMimeType, p = t.isValidMimeType, m = t.MIME_TYPE, E = t.NAMESPACE, f = n.ParseError, v = o.XMLReader;
  function w(D) {
    return D.replace(/\r[\n\u0085]/g, `
`).replace(/[\r\u0085\u2028]/g, `
`);
...
function On(t, e) {
  ...
  let i = 0, o = 0;
  function a(l, p, m) {
    const E = tt(t, o, p), f = n.length > 0 && xe(n[n.length - 1]) ? `${n.pop()}${E}` : E;
    xe(l) ? n.push(`${f}${l}`) : (f && n.push(f), n.push(l)), o = p + m;
  }
  const h = pe(t);
  for (; i < h; ) {
    switch (Et(t, i)) {
...
function mr(t, e, n) {
  ...
  let h = 0;
  if (!a) return [t];
  for (let l = 0; l < (n ? n - 1 : a.length); l++) {
    const p = St(t, a[l], h), m = pe(a[l]);
...
function mi(t) {
  return new Gt(Ce.bookIdToNumber(t.book), t.chapterNum, t.verseNum).BBBCCC;
}
function Er(t) {
  return new Gt(Ce.bookIdToNumber(t.book), t.chapterNum, t.verseNum).BBBCCCVVV;
}
function Ei(t, e) {
  return Er(t) - Er(e);
}
...
function Mt(t) {
  return function(n, i, o) {
    if (!n || !i || typeof n != "object" || typeof i != "object")
      return t(n, i, o);
    var a = o.cache, h = a.get(n), l = a.get(i);
    if (h && l)
      return h === i && l === n;
    a.set(n, i), a.set(i, n);
    var p = t(n, i, o);
...
function Tr(t, e, n) {
  ...
  if (!i)
    return !0;
  for (var o = new Array(i), a = t.entries(), h, l, p = 0; (h = a.next()) && !h.done; ) {
...
function Tt(t, e, n) {
  ...
  if (br(e).length !== o)
    return !1;
  for (var a, h, l; o-- > 0; )
    if (a = i[o], !Hr(t, e, n, a) || (h = Cr(t, a), l = Cr(e, a), (h || l) && (!h || !l || h.configurable !== l.configurable || h.enumerable !== l.enumerable || h.writable !== l.writable)))
      return !1;
  return !0;
}
function ru(t, e) {
...
function wr(t, e, n) {
  ...
  if (!i)
    return !0;
  for (var o = new Array(i), a = t.values(), h, l; (h = a.next()) && !h.done; ) {
    for (var p = e.values(), m = !1, E = 0; (l = p.next()) && !l.done; ) {
      if (!o[E] && n.equals(h.value, l.value, h.value, l.value, t, e, n)) {
        m = o[E] = !0;
        break;
      }
      E++;
...
function vu(t) {
  var e = t.areArraysEqual, n = t.areDatesEqual, i = t.areErrorsEqual, o = t.areFunctionsEqual, a = t.areMapsEqual, h = t.areNumbersEqual, l = t.areObjectsEqual, p = t.arePrimitiveWrappersEqual, m = t.areRegExpsEqual, E = t.areSetsEqual, f = t.areTypedArraysEqual, v = t.areUrlsEqual;
  return function(b, C, k) {
    ...
    if (F === Set)
      return E(b, C, k);
    var q = Du(b);
    return q === su ? n(b, C, k) : q === hu ? m(b, C, k) : q === lu ? a(b, C, k) : q === du ? E(b, C, k) : q === pu ? typeof b.then != "function" && typeof C.then != "function" && l(b, C, k) : q === Eu ? v(b, C, k) : q === cu ? i(b, C, k) : q === ou ? l(b, C, k) : q === au || q === fu || q === mu ? p(b, C, k) : !1;
  };
}
function Au(t) {
  ...
  if (n && (o = Or({}, o, n(o))), e) {
    var a = Mt(o.areArraysEqual), h = Mt(o.areMapsEqual), l = Mt(o.areObjectsEqual), p = Mt(o.areSetsEqual);
    o = Or({}, o, {
      areArraysEqual: a,
      areMapsEqual: h,
      areObjectsEqual: l,
...
function Ge(t) {
  t === void 0 && (t = {});
  var e = t.circular, n = e === void 0 ? !1 : e, i = t.createInternalComparator, o = t.createState, a = t.strict, h = a === void 0 ? !1 : a, l = Au(t), p = vu(l), m = i ? i(p) : Nu(p);
...
function Tu(t, e) {
  ...
  if (Array.isArray(t)) {
    const a = e, h = t;
    return a.length === 0 ? !0 : a.every((l) => h.includes(l));
  }
  if (typeof t != "object")
    return yu(t, e);
  const n = e, i = t;
...
class Ee {
    ...
    for (; a !== void 0; ) {
      ...
      if (
        ...
        !a.content.find((h, l) => {
          ...
          return n.unshift({ parent: a, index: l }), !0;
        })
      )
  ...
  static findNextMatchingNodeUsingWorkingStack(e, n, i, o) {
    ...
    let a = e;
    for (; a !== void 0; ) {
      const l = typeof a == "object" && i.includes(a.type);
      if (!l && o(a, n)) return a;
      if (!l && typeof a == "object" && (((h = a.content) == null ? void 0 : h.length) ?? 0) > 0)
  ...
  findVerseRefForNode(e, n, i = {
    ...
    const h = n.content[a], l = Ee.findRightMostDescendantMarkerObject(
      h,
      n,
      qe
    );
  ...
  nodeToVerseRefAndOffset(e, n, i) {
    ...
    return a.startingContentNode !== void 0 && this.findNextMatchingNode(a.startingContentNode, [], (p, m) => {
      var E, f;
      return p === n ? !0 : m.find((v) => qe.includes(v.parent.type)) ? !1 : typeof p == "string" ? (l += p.length, !1) : p.type === Rt && p.number !== ((E = a.chapterNum) == null ? void 0 : E.toString()) || p.type === xt && p.number !== ((f = a.verseNum) == null ? void 0 : f.toString()) ? (l = 0, !0) : !1;
    }), { verseRef: h, offset: l };
  }
  // #endregion
  ...
  verseRefToUsjContentLocation(e, n = 0) {
    ...
    let a = !1, h = "";
    const l = e.verse ?? e.verseNum.toString(), p = this.findNextMatchingNode(
      o,
      qe,
      (v, w) => v === o ? e.verseNum === 0 ? (h = Ee.convertWorkingStackToJsonPath(w), !0) : !1 : typeof v != "object" ? !1 : v.type === Rt ? (a = !0, !0) : v.type === xt && v.number !== void 0 && v.number === l ? (h = Ee.convertWorkingStackToJsonPath(w), !0) : !1
    );
  ...
  findNextLocationOfMatchingText(e, n, i = 1e3) {
    ...
    if (Ee.findNextMatchingNodeUsingWorkingStack(
      ...
      (f) => {
        ...
        a += f.length, o = `${o}${f}`;
        const v = o.indexOf(n);
        return v < 0 ? (h += o.length, o.length > n.length && (o = o.substring(o.length - n.length)), h -= o.length, a > i) : (l = h + v, !0);
      }
    ), l <= 0) return;
    a = 0;
    let p = 0, m = [];
    const E = Ee.findNextMatchingNodeUsingWorkingStack(
      ...
      this.convertJsonPathToWorkingStack(e.jsonPath),
      qe,
      (f, v) => typeof f != "string" || (a += f.length, a < l + 1) ? !1 : (p = l - a + f.length, m = v, !0)
    );
    ...
    return Ee.findNextMatchingNodeUsingWorkingStack(
      ...
      (h) => {
        ...
        if (o >= h.length)
          return o -= h.length, !1;
        let l = h;
        if (o > 0 && (l = l.substring(o), o = 0), a + l.length < n)
          return a += l.length, i = `${i}${l}`, !1;
        const p = n - a;
