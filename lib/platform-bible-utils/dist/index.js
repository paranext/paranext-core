...
var b = (r, e, t) => Ce(r, typeof e != "symbol" ? e + "" : e, t);
import { Mutex as qe } from "async-mutex";
import { Canon as S, VerseRef as fe } from "@sillsdev/scripture";
import { USJ_TYPE as me } from "@eten-tech-foundation/scripture-utilities";
import { indexOf as Ae, limit as ge, length as Oe, substring as $e, toArray as je, substr as De } from "stringz";
...
function Wt(r) {
  ...
  return v(r) ? r.includes(e) : ye(r).includes(e);
}
function Zt(r) {
  const e = "401 Unauthorized error while getting shared projects.", t = "User registration is not valid. Cannot retrieve resources from DBL.", n = v(r) ? r : ye(r);
...
class ze {
  ...
  constructor(e, t) {
    ...
    b(this, "latestOutput");
    b(this, "options");
    b(this, "onDidRebuildEmitter", new Be());
  ...
  updateBaseDocument(e) {
    return this.validateBaseDocument(e), this.baseDocument = this.options.copyDocuments ? F(e) : e, this.baseDocument = this.transformBaseDocumentAfterValidation(this.baseDocument), this.rebuild();
  }
  /**
  ...
  addOrUpdateContribution(e, t) {
    ...
    let s = this.options.copyDocuments && t ? F(t) : t;
...
class rr {
  ...
  cleanupPromiseChain(e) {
    ...
    if (!t) return;
    const n = { promise: Xe }, s = t.catch((i) => this.logger.warn(`Error in promise for ${e}: ${i.message}`)).finally(() => {
...
const sr = "ABORTED", ar = "ALREADY_EXISTS", or = "CANCELLED", cr = "DATA_LOSS", dr = "DEADLINE_EXCEEDED", lr = "FAILED_PRECONDITION", pr = "INTERNAL", ur = "INVALID_ARGUMENT", hr = "NOT_FOUND", fr = "OUT_OF_RANGE", mr = "PERMISSION_DENIED", gr = "RESOURCE_EXHAUSTED", yr = "UNAUTHENTICATED", kr = "UNAVAILABLE", br = "UNIMPLEMENTED", vr = "UNKNOWN", B = 1;
function Mr(r, e) {
  if (!r)
    return {
      message: "",
      ...e && { code: e },
      platformErrorVersion: B
    };
  if (v(r))
    return {
      message: r,
  ...
  if (typeof r == "object" && "message" in r && typeof r.message == "string") {
    ...
    return Object.defineProperties(t, Object.getOwnPropertyDescriptors(r)), Object.defineProperty(t, "message", { enumerable: !0 }), "stack" in r && v(r.stack) && Object.defineProperty(t, "stack", { value: r.stack, enumerable: !0 }), "cause" in t && Object.defineProperty(t, "cause", { enumerable: !0 }), e && (t.code = e), t;
  }
  return {
    cause: r,
    message: "",
...
function O(r, e) {
  return e < 0 || e > N(r) - 1 ? "" : V(r, e, 1);
}
function Er(r, e) {
  if (!(e < 0 || e > N(r) - 1))
    return V(r, e, 1).codePointAt(0);
}
function Ye(r, e, t = N(r)) {
  const n = et(r, e);
  return !(n === -1 || n + N(e) !== t);
}
function We(r, e, t) {
  if (e < 0) return -1;
  if (t) {
    if (O(r, e) === "}" && O(r, e - 1) === "\\") return e;
    const i = R(r, "\\}", e);
    return i >= 0 ? i + 1 : i;
  }
  let n = e;
  const s = N(r);
  for (; n < s && (n = R(r, "}", n), !(n === -1 || O(r, n - 1) !== "\\")); )
    n += 1;
  return n >= s ? -1 : n;
}
function Ze(r, e) {
  ...
  let n = 0, s = 0;
  function i(d, l, p) {
    const f = q(r, s, l), g = t.length > 0 && v(t[t.length - 1]) ? `${t.pop()}${f}` : f;
...
function et(r, e, t) {
  let n = t === void 0 ? N(r) : t;
  n < 0 ? n = 0 : n >= N(r) && (n = N(r) - 1);
  for (let s = n; s >= 0; s--)
    if (V(r, s, N(e)) === e)
      return s;
  return -1;
...
function Sr(r, e, t = " ") {
  return e <= N(r) ? r : ge(r, e, t, "right");
}
function Pr(r, e, t = " ") {
  return e <= N(r) ? r : ge(r, e, t, "left");
}
function re(r, e) {
...
function ne(r, e, t) {
  ...
  if (e > n || t && (e > t && !(e >= 0 && e < n && t < 0 && t > -n) || t < -n))
    return "";
  const s = re(n, e), i = t ? re(n, t) : void 0;
  return q(r, s, i);
}
function ie(r, e, t) {
  const n = [];
  if (t !== void 0 && t <= 0)
    return [r];
  if (e === "") return tt(r).slice(0, t);
  let s = e;
  (typeof e == "string" || e instanceof RegExp && !Qe(e.flags, "g")) && (s = new RegExp(e, "g"));
  const i = r.match(s);
  let c = 0;
  if (!i) return [r];
  for (let d = 0; d < (t ? t - 1 : i.length); d++) {
    const l = R(r, i[d], c), p = N(i[d]);
    if (n.push(q(r, c, l)), c = l + p, t !== void 0 && n.length === t)
      break;
  }
  return n.push(q(r, c)), n;
}
function ve(r, e, t = 0) {
  return R(r, e, t) === t;
}
function V(r, e = 0, t = N(r) - e) {
  return De(r, e, t);
}
function q(r, e, t = N(r)) {
  return $e(r, e, t);
}
function tt(r) {
  return je(r);
...
function qr(r) {
  return r ? be(r).map((n) => new RegExp(n)) : [];
}
const rt = (
...
const H = ["chapter", "book", "para", "row", "sidebar", me], nt = "​", Me = [
...
], it = 1, st = Me.length - 1, at = 1, ot = 1, $r = {
  book: "GEN",
  chapterNum: 1,
  verseNum: 1
}, ct = (r) => {
  ...
  book: S.bookNumberToId(
    Math.max(
      it,
      Math.min(S.bookIdToNumber(r.book) + e, st)
    )
  ),
  chapterNum: 1,
  verseNum: 1
  ...
  ...r,
  chapterNum: Math.min(
    Math.max(at, r.chapterNum + e),
    ct(S.bookIdToNumber(r.book))
  ),
  verseNum: 1
}), Fr = (r, e) => ({
  ...r,
  verseNum: Math.max(ot, r.verseNum + e)
});
async function Ur(r, e, t) {
  ...
  return ie(i[0], "ÿ08")[0].trim();
}
function Rr(r) {
  return new fe(S.bookIdToNumber(r.book), r.chapterNum, r.verseNum).BBBCCC;
}
function se(r) {
  return new fe(S.bookIdToNumber(r.book), r.chapterNum, r.verseNum).BBBCCCVVV;
}
function dt(r, e) {
  return se(r) - se(e);
}
...
function pt(r, e) {
  const t = xe(r, e == null ? void 0 : e.optionOrLocalizedBookName), n = (e == null ? void 0 : e.bookChapterSeparator) ?? " ", s = (e == null ? void 0 : e.chapterVerseSeparator) ?? ":";
...
function ae(r, e) {
  const t = xe(r, e == null ? void 0 : e.optionOrLocalizedBookName), n = ut(
    r,
...
function Vr(r, e, t) {
  const n = ae(r, t);
  if (dt(r, e) === 0) return n;
  const s = r.book === e.book && !(t != null && t.repeatBookName) ? "" : (t == null ? void 0 : t.endRefOptionOrLocalizedBookName) ?? (t == null ? void 0 : t.optionOrLocalizedBookName), i = ae(e, {
    ...t,
...
function ce(r) {
  ...
  for (let s = 0; s < r.length; s += 1) {
    const i = r[s];
    i.charCodeAt(0) < 32 ? (t || (e += " "), t = !0) : !t && i === nt && s + 1 < r.length && oe(r[s + 1]) || (oe(i) ? (t || (e += i), t = !0) : yt(i) && n === i || (e += i, t = !1)), n = i;
  }
  return e;
}
function de(r) {
...
function le(r, e) {
  if (!e || !H.includes(e.type)) return !1;
  if (!e.content)
    throw new Error(
...
function Ee(r, e, t, n) {
  ...
  if (s && i) {
    const c = ce(r), d = ce(t);
    if (c !== d) {
      if (!A(L(c, -1) ?? "") && !A(L(d, -1) ?? "") || !le(r, e) || !le(t, n)) return !1;
      let l = c;
      for (; A(L(l, -1) ?? ""); ) l = ne(l, 0, -1);
      let p = d;
      for (; A(L(p, -1) ?? ""); ) p = ne(p, 0, -1);
      if (l !== p) return !1;
    }
  } else if (!s && !i) {
    ...
    const p = de(c.content), f = de(d.content);
    if (p !== f) return !1;
    if (!p && !f) {
      let g = c.content, u = d.content;
      const h = g[g.length - 1];
      H.includes(c.type) && v(h) && A(h) && (g = g.slice(0, -1));
      const m = u[u.length - 1];
      if (H.includes(d.type) && v(m) && A(m) && (u = u.slice(0, -1)), g.length !== u.length) return !1;
...
function zr(r, e) {
  return Ee(r, void 0, e, void 0);
}
const Hr = (r) => (...e) => r.map((n) => n(...e)).every((n) => n), Kr = (r) => async (...e) => {
  const t = r.map(async (n) => n(...e));
  return (await Promise.all(t)).every((n) => n);
}, kt = "book", pe = "chapter", T = "verse", C = "***";
...
function Yr(r, e) {
  const t = e && e.length > 0 ? e : Ne(), n = (() => {
    const s = /* @__PURE__ */ new Map();
    let i = 0;
    return r.forEach((c, d) => {
      c.caller === "+" && (s.set(d, bt(i, t)), i += 1);
    }), s;
  })();
  return (s, i) => {
    if (s === "+") {
...
const Qr = (r) => r.replace(/&/g, "&amp;").replace(/</g, "&lt;").replace(/>/g, "&gt;").replace(/"/g, "&quot;").replace(/'/g, "&#x27;").replace(/\//g, "&#x2F;");
function en() {
  return typeof navigator < "u" && navigator.languages ? navigator.languages[0].replace(/@posix$/i, "") : new Re().resolvedOptions().locale;
}
function tn(r, e = 2) {
...
const Et = 1e3, _e = 60, Ie = _e * 60, Nt = Ie * 24;
function rn(r, e, t = /* @__PURE__ */ new Date()) {
  const n = Math.floor((e.getTime() - t.getTime()) / Et), s = Math.round(n / Nt);
  if (Math.abs(s) >= 1) return r.format(s, "day");
  const i = Math.round(n / Ie);
  if (Math.abs(i) >= 1) return r.format(i, "hour");
  const c = Math.round(n / _e);
  return Math.abs(c) >= 1 ? r.format(c, "minute") : r.format(n, "second");
}
function nn(r, e, t, n, s = {
  year: "numeric",
  month: "short",
  day: "numeric"
}) {
...
const sn = /* @__PURE__ */ new Set([
  ...
  const r = [];
  for (let e = 1; e <= 88; e += 1) {
    const t = S.bookNumberToId(e, "");
    t && r.push(t);
  }
  return r;
})(), Y = (r, e, t) => {
  const n = S.bookIdToNumber(r);
  return n >= e && n <= t;
}, P = X.filter((r) => Y(r, 1, 39)), w = X.filter((r) => Y(r, 40, 66)), j = X.filter((r) => Y(r, 67, 88)), he = (r, e) => {
  const t = new Set(r);
  return e.some((n) => t.has(n));
}, an = {
  ...
  portions: {
    ...
    requiredBookIds: [],
    optionalBookIds: [...P, ...w, ...j],
    matchesScope: (r) => r.length >= 1
  },
  selections: {
    id: "selections",
    name: "Selections",
...
function cn(r, e) {
  return r.requiredBookIds.length > 0 ? r.requiredBookIds.length : e.length;
}
function dn(r, e) {
  var t;
  return !!(r.requiredBookIds.includes(e) || (t = r.optionalBookIds) != null && t.includes(e));
}
const W = {
...
function pn(r, e, t) {
  ...
  return s.id = `${wt}${t ? `-${t}` : ""}`, s.dataset.themeId = r.id, s.textContent = qt(r), this.document.head.appendChild(s), s;
}
function Te(r) {
  return Object.freeze(r), r == null || Object.getOwnPropertyNames(r).forEach(function(t) {
    ...
    // eslint-disable-next-line no-null/no-null
    r[t] !== null && (typeof r[t] == "object" || typeof r[t] == "function") && !Object.isFrozen(r[t]) && Te(r[t]);
  }), r;
}
const G = Te({
  version: "3.0.7",
...
}), D = ["figure", "note", "sidebar", "table"];
Object.freeze(D);
const At = /\u00A0/g, Ot = /\w+(\d+)/, $t = /(\d+)-?(\d+)?/;
class k {
  constructor(e, t) {
    b(this, "usj");
    b(this, "markersMap");
...
USJ: ${JSON.stringify(
    ...
    else if (k.areUsjVersionsCompatible(this.usj.version, G.version))
      this.markersMap = G;
    else
      throw new Error(
  ...
  findSingleValue(e) {
    ...
    const n = $({ path: e, json: this.usj, wrap: !1 });
  ...
  static isTopLevelUsjMarker(e, t) {
    return typeof e == "object" && e.type === me && t.length === 0;
  }
  /**
  ...
  findAllNotes() {
    var e;
    return vt((e = this.usj) == null ? void 0 : e.content);
  }
  /**
  ...
  getEffectiveBookId(e) {
    const t = Object.keys(this.indicesInUsfmByVerseRef), n = t.length === 0 || t.length === 1 && t[0] === C, s = n ? C : e;
    if (!this.indicesInUsfmByVerseRef[s])
      throw new Error(
        `Book ID ${e} not found in USJ! ${n ? `There seems to be no USJ content because there is no content in ${C} either` : `Book IDs in USJ: ${JSON.stringify(t)}`}`
      );
    return s;
  }
  /**
  ...
  getVerseRefForIndexInUsfm(e, t) {
    ...
    return l && k.isFragmentAMarker(l.fragment) && l.fragment.type === T && l.fragment.number && l.fragment.number !== `${i.verseNum}` && (i.verse = l.fragment.number), i;
  }
  ...
  findNextLocationOfMatchingText(e, t, n = 1e3) {
    ...
    if (k.findNextMatchingNodeUsingWorkingStack(
      ...
      (h, m) => {
        ...
        i += y.length, s = `${s}${y}`;
        const _ = s.indexOf(t);
        return _ < 0 ? (c += s.length, s.length > t.length && (s = s.substring(s.length - t.length)), c -= s.length, i > n) : (d = c + _, !0);
      }
    ), d < 0) return;
    i = 0;
    let f = 0, g = [];
  ...
  search(e, t) {
    ...
    for (; f !== void 0; )
      f = k.findNextMatchingNodeUsingWorkingStack(
        ...
        (y, x) => (typeof y != "string" || n && x.some((M) => {
          const E = M.parent;
          if (!E || !("type" in E) || E.type === "char") return !1;
          let I;
          return "style" in E && typeof E.style == "string" ? I = E.style : "marker" in E && typeof E.marker == "string" && (I = E.marker), I !== void 0 && !n.has(I);
        }) || (d.push(y), l.set(p, {
          node: y,
          documentLocation: {
            offset: 0,
    ...
    for (; m; ) {
      if (m[0].length > 0) {
        ...
        const _ = l.findClosestLessThanOrEqual(y);
        if (!_)
        ...
        }, E = l.findClosestLessThanOrEqual(x - 1);
        if (!E)
        ...
        }, z = u ? g.substring(y, x) : m[0];
        i.push({ text: z, start: M, end: I });
      }
      if (!e.global) break;
      m = e.exec(h);
    }
  ...
  getInfoForMarker(e, t = "usfm") {
    ...
    if (t === "usfm" && l === "cell" && g.colspan) {
      const u = parseInt(g.colspan, 10), h = Ot.exec(n);
      if (h != null && h[1]) {
  ...
  textContentToUsfm(e) {
    return {
      usfm: this.shouldAllowInvisibleCharacters ? e : e.replace(At, "~"),
...
`);
    ...
    return s.push({ fragment: e, indexInUsfm: n.length }), n += d === "optbreak" ? "//" : `\\${g}`, d !== "optbreak" && (s.push({
      ...
      const { usfm: _ } = this.textContentToUsfm(m);
      s.push({
        fragment: {
        ...
        indexInUsfm: n.length
      }), n += _, n = this.addMarkerUsfmToString(
        n,
        {
          isClosingMarker: !0,
          forMarker: y
        ...
        if ("isClosingMarker" in M.fragment) {
          const { isClosingMarker: E, ...I } = M.fragment, z = {
            ...I,
            forMarker: e,
  ...
  closingMarkerToUsfm(e, t) {
    const {
      ...
      return !(m === "type" || m === "marker" || m === "content" || m === "closed" || (y = d.skipOutputAttributeToUsfm) != null && y.includes(m) || (x = i.leadingAttributes) != null && x.includes(m) || i.textContentAttribute === m || l.some(
        ([, _]) => _.attributeMarkerAttributeName === m
      ));
    }), f = e;
    ...
    if ((f.closed === "false" || i.isClosingMarkerOptional && !this.markersMap.shouldOptionalClosingMarkersBePresent && f.closed !== "true") && (g = !1), i.independentClosingMarkers && i.independentClosingMarkers.length > 0 && g) {
      ...
      let y = "";
      const x = [], { usfm: _, fragmentsInfo: M } = this.openingMarkerToUsfm(m, t), E = M.find((I) => k.isFragmentAMarker(I.fragment));
      if (!E)
        throw new Error(
      ...
      }), y += _, n !== m.marker && (y = this.addMarkerUsfmToString(
        y,
        {
          isClosingMarker: !0,
          forMarker: m
...
`) && (i.length === 0 ? (d = d.map((u) => ({
 ...
 `);
  ...
  static areUsjDocumentLocationsEqual(e, t, n = !1) {
    ...
    return !n && !K($.toPathArray(s), $.toPathArray(c)) ? !1 : K(i, d);
  }
  ...
  static transferFragmentsInfoArrayToMaps(e, t, n, s, i, c) {
    e.map((l) => {
      ...
      if (typeof l.fragment == "object" && "type" in l.fragment) {
        const h = l.fragment;
        if (h.type === kt && h.code)
          n.bookId = h.code, n.chapterNum = 0, n.verseNum = 0, c[C] && (c[n.bookId] = c[C], delete c[C]);
        else if (h.type === pe && h.number) {
          const m = parseInt(h.number, 10);
          if (Number.isNaN(m))
            console.warn(
              `Found ${pe} type marker with number ${h.number}, but could not parse chapter number from it. Continuing using previous chapter number ${n.chapterNum}`
            );
          else {
        ...
        } else if (h.type === T && h.number) {
          const m = (f = $t.exec(h.number)) == null ? void 0 : f[1];
          if (!m)
            console.warn(
              `Found ${T} type marker with number ${h.number}, but could not find starting verse number in it. Continuing using previous verse number ${n.verseNum}`
            );
          else {
            const y = parseInt(m, 10);
            Number.isNaN(y) ? console.warn(
              `Found ${T} type marker with number ${h.number}, but could not parse starting verse number from ${m}. Continuing using previous verse number ${n.verseNum}`
            ) : (u = (g = c[n.bookId]) == null ? void 0 : g[n.chapterNum]) != null && u[y] ? console.warn(`Found ${T} marker with existing number ${y} after
                  current ${T} number ${n.verseNum}! Not updating verse start index. All positions in this duplicate verse will be based on the current ${T} marker, not the new duplicate marker.`) : (y < n.verseNum && console.debug(
              `Found ${T} marker with number ${y} lower than current ${T} number ${n.verseNum}. Verses are out of order. There may be some issues.`
            ), n.verseNum = y);
          }
        }
      }
  ...
  calculateUsfmProperties() {
    let e = "";
    const t = new te(), n = /* @__PURE__ */ new Map(), s = {}, i = [], c = {
      bookId: C,
      chapterNum: 0,
      verseNum: 0
    };
...
export {
  ...
  cr as DATA_LOSS,
  j as DC_BOOK_IDS,
  dr as DEADLINE_EXCEEDED,
  Re as DateTimeFormat,
  ze as DocumentCombiner,
  Qt as EventRollingTimeCounter,
  lr as FAILED_PRECONDITION,
  it as FIRST_SCR_BOOK_NUM,
  at as FIRST_SCR_CHAPTER_NUM,
  ot as FIRST_SCR_VERSE_NUM,
  pr as INTERNAL,
  ur as INVALID_ARGUMENT,
  ...
  hr as NOT_FOUND,
  w as NT_BOOK_IDS,
  tr as NonValidatingDocumentCombiner,
  Ge as NumberFormat,
  P as OT_BOOK_IDS,
  fr as OUT_OF_RANGE,
  mr as PERMISSION_DENIED,
  B as PLATFORM_ERROR_VERSION,
  on as PROJECT_SCOPES,
  an as PROJECT_SCOPE_ABBREVIATIONS,
  Be as PlatformEventEmitter,
  rr as PromiseChainingMap,
  gr as RESOURCE_EXHAUSTED,
  mt as SELECTABLE_INVISIBLE_CHAR_OR_WHITESPACE_CLASS,
  ht as Section,
  te as SortedNumberMap,
  nr as SortedSet,
  wt as THEME_STYLE_ELEMENT_ID,
  yr as UNAUTHENTICATED,
  kr as UNAVAILABLE,
  br as UNIMPLEMENTED,
  vr as UNKNOWN,
  G as USFM_MARKERS_MAP_3_0,
  un as USFM_MARKERS_MAP_PARATEXT_3_0,
  ir as UnsubscriberAsyncList,
  k as UsjReaderWriter,
  T as VERSE_TYPE,
  Kr as aggregateUnsubscriberAsyncs,
  Hr as aggregateUnsubscribers,
  pn as applyThemeStylesheet,
  zr as areUsjContentsEqualExceptWhitespace,
  L as at,
  O as charAt,
  Er as codePointAt,
  Or as collapseMiddleWords,
  ...
  $r as defaultScrRef,
  xt as deserialize,
  dn as doesBookFitScope,
  Ye as endsWith,
  be as ensureArray,
  wr as escapeStringRegexp,
  ln as expandThemeContribution,
  tn as formatBytes,
  nn as formatRelativeDate,
  Nr as formatReplacementString,
  Ze as formatReplacementStringToArray,
  Lr as formatScrRef,
  Vr as formatScrRefRange,
  rn as formatTimeSpan,
  Xt as getAllObjectFunctionNames,
  ct as getChaptersForBook,
  en as getCurrentLocale,
  Ne as getDefaultCallerSequence,
  ye as getErrorMessage,
  cn as getExpectedBookCountForScope,
  Yr as getFormatCallerFunction,
  lt as getLocalizeKeyForScrollGroupId,
  Br as getLocalizeKeysForScrollGroupIds,
  Ur as getLocalizedIdFromBookNumber,
  bt as getNthCaller,
  Wr as getPaneSizeLimits,
  Jr as getSectionForBook,
  qt as getStylesheetForTheme,
  Kt as groupBy,
  Qr as htmlEncode,
  Qe as includes,
  R as indexOf,
  Wt as isErrorMessageAboutParatextBlockingInternetAccess,
  Zt as isErrorMessageAboutRegistryAuthFailure,
  Tr as isLocalizeKey,
  xr as isPlatformError,
  yt as isSelectableInvisibleCharOrWhiteSpace,
  Zr as isSerializable,
  v as isString,
  Mt as isSubset,
  A as isWhiteSpace,
  et as lastIndexOf,
  St as localizedStringsDocumentSchema,
  Pt as menuDocumentSchema,
  zt as newGuid,
  Mr as newPlatformError,
  _r as normalize,
  ce as normalizeScriptureSpaces,
  jr as offsetBook,
  Dr as offsetChapter,
  Fr as offsetVerse,
  ...
  Sr as padEnd,
  Pr as padStart,
  _t as projectSettingsDocumentSchema,
  Xr as sanitizeHtml,
  Rr as scrRefToBBBCCC,
  se as scrRefToBBBCCCVVV,
  ue as serialize,
  It as settingsDocumentSchema,
  ne as slice,
  ie as split,
  ve as startsWith,
  N as stringLength,
