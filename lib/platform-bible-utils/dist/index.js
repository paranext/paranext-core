...
var E = (t, e, r) => (Lr(t, typeof e != "symbol" ? e + "" : e, r), r);
...
d(x, "defaultVersification", Q.English), d(x, "verseRangeSeparator", "-"), d(x, "verseSequenceIndicator", ","), d(x, "verseRangeSeparators", [x.verseRangeSeparator]), d(x, "verseSequenceIndicators", [x.verseSequenceIndicator]), d(x, "chapterDigitShifter", 1e3), d(x, "bookDigitShifter", x.chapterDigitShifter * x.chapterDigitShifter), d(x, "bcvMaxValue", x.chapterDigitShifter - 1), /**
* The valid status of the VerseRef.
*/
d(x, "ValidStatusType", tr);
let rr = x;
class me extends Error {
}
var At = typeof globalThis < "u" ? globalThis : typeof window < "u" ? window : typeof global < "u" ? global : typeof self < "u" ? self : {}, re = {}, fu = () => {
  const t = "\\ud800-\\udfff", e = "\\u0300-\\u036f", r = "\\ufe20-\\ufe2f", u = "\\u20d0-\\u20ff", n = "\\u1ab0-\\u1aff", i = "\\u1dc0-\\u1dff", o = e + r + u + n + i, a = "\\ufe0e\\ufe0f", s = "\\uD83D\\uDC69\\uD83C\\uDFFB\\u200D\\uD83C\\uDF93", c = `[${t}]`, l = `[${o}]`, p = "\\ud83c[\\udffb-\\udfff]", f = `(?:${l}|${p})`, h = `[^${t}]`, g = "(?:\\uD83C[\\uDDE6-\\uDDFF]){2}", v = "[\\ud800-\\udbff][\\udc00-\\udfff]", b = "\\u200d", y = "(?:\\ud83c\\udff4\\udb40\\udc67\\udb40\\udc62\\udb40(?:\\udc65|\\udc73|\\udc77)\\udb40(?:\\udc6e|\\udc63|\\udc6c)\\udb40(?:\\udc67|\\udc74|\\udc73)\\udb40\\udc7f)", Z = `[${s}]`, A = `${f}?`, S = `[${a}]?`, de = `(?:${b}(?:${[h, g, v].join("|")})${S + A})*`, Se = S + A + de, Oe = `(?:${[`${h}${l}?`, l, g, v, c, Z].join("|")})`;
...
var Fu = Object.getOwnPropertyNames, Ru = Object.getOwnPropertySymbols, qu = Object.prototype.hasOwnProperty;
function Ct(t, e) {
...
H.MIME_TYPE = fr;
H.NAMESPACE = pr;
var hr = H, V = hr.find, ye = hr.NAMESPACE;
function hn(t) {
  return t !== "";
}
function dn(t) {
...
var q = {}, j = q.ELEMENT_NODE = 1, le = q.ATTRIBUTE_NODE = 2, ke = q.TEXT_NODE = 3, dr = q.CDATA_SECTION_NODE = 4, mr = q.ENTITY_REFERENCE_NODE = 5, Dn = q.ENTITY_NODE = 6, gr = q.PROCESSING_INSTRUCTION_NODE = 7, Dr = q.COMMENT_NODE = 8, vr = q.DOCUMENT_NODE = 9, br = q.DOCUMENT_TYPE_NODE = 10, G = q.DOCUMENT_FRAGMENT_NODE = 11, vn = q.NOTATION_NODE = 12, T = {}, B = {};
T.INDEX_SIZE_ERR = (B[1] = "Index size error", 1);
T.DOMSTRING_SIZE_ERR = (B[2] = "DOMString size error", 2);
var F = T.HIERARCHY_REQUEST_ERR = (B[3] = "Hierarchy request error", 3);
T.WRONG_DOCUMENT_ERR = (B[4] = "Wrong document", 4);
T.INVALID_CHARACTER_ERR = (B[5] = "Invalid character", 5);
T.NO_DATA_ALLOWED_ERR = (B[6] = "No data allowed", 6);
T.NO_MODIFICATION_ALLOWED_ERR = (B[7] = "No modification allowed", 7);
var Er = T.NOT_FOUND_ERR = (B[8] = "Not found", 8);
T.NOT_SUPPORTED_ERR = (B[9] = "Not supported", 9);
var kt = T.INUSE_ATTRIBUTE_ERR = (B[10] = "Attribute in use", 10);
T.INVALID_STATE_ERR = (B[11] = "Invalid state", 11);
T.SYNTAX_ERR = (B[12] = "Syntax error", 12);
T.INVALID_MODIFICATION_ERR = (B[13] = "Invalid modification", 13);
T.NAMESPACE_ERR = (B[14] = "Invalid namespace", 14);
T.INVALID_ACCESS_ERR = (B[15] = "Invalid access", 15);
function w(t, e) {
...
D.prototype = {
  ...
  normalize: function() {
    for (var t = this.firstChild; t; ) {
      var e = t.nextSibling;
      e && e.nodeType == ke && t.nodeType == ke ? (this.removeChild(e), t.appendData(e.data)) : (t.normalize(), t = e);
    }
  },
...
function An(t) {
  return t && (U(t) || ot(t) || J(t) || t.nodeType === D.DOCUMENT_FRAGMENT_NODE || t.nodeType === D.COMMENT_NODE || t.nodeType === D.PROCESSING_INSTRUCTION_NODE);
}
function J(t) {
...
function Me(t, e, r, u) {
  ...
  return it(t.ownerDocument || t, t), e.nodeType == G && (e.firstChild = e.lastChild = null), e;
}
function wn(t, e) {
...
te.prototype = {
  ...
  appendChild: function(t) {
    return t.nodeType === G ? this.insertBefore(t, null) : wn(this, t);
  },
...
var pt = {}, we = H.NAMESPACE, Ke = /[A-Z_a-z\xC0-\xD6\xD8-\xF6\u00F8-\u02FF\u0370-\u037D\u037F-\u1FFF\u200C-\u200D\u2070-\u218F\u2C00-\u2FEF\u3001-\uD7FF\uF900-\uFDCF\uFDF0-\uFFFD]/, Lt = new RegExp("[\\-\\.0-9" + Ke.source.slice(1, -1) + "\\u00B7\\u0300-\\u036F\\u203F-\\u2040]"), Vt = new RegExp("^" + Ke.source + Lt.source + "*(?::" + Ke.source + Lt.source + "*)?$"), De = 0, X = 1, ue = 2, ve = 3, ne = 4, ie = 5, be = 6, Re = 7;
function fe(t, e) {
  ...
  for (var c = 0, l = 0, p = /.*(?:\r\n?|\n)|.*$/g, f = u.locator, h = [{ currentNSMap: e }], g = {}, v = 0; ; ) {
    try {
      ...
      switch (b > v && a(b), t.charAt(b + 1)) {
        case "/":
          var O = t.indexOf(">", b + 3), A = t.substring(b + 2, O).replace(/[ \t\n\r]+$/g, ""), S = h.pop();
          O < 0 ? (A = t.substring(b + 2).replace(/[\s<].*/, ""), n.error("end tag name: " + A + " is not complete:" + S.tagName), O = b + 1 + A.length) : A.match(/\s</) && (A = A.replace(/[\s<].*/, ""), n.error("end tag name: " + A + " maybe not complete"), O = b + 1 + A.length);
          var de = S.localNSMap, Se = S.tagName == A, ht = Se || S.tagName && S.tagName.toLowerCase() == A.toLowerCase();
          if (ht) {
            if (u.endElement(S.uri, S.localName, A), de)
              for (var Oe in de)
                Object.prototype.hasOwnProperty.call(de, Oe) && u.endPrefixMapping(Oe);
            Se || n.fatalError("end tag name: " + A + " is not match the current start tagName:" + S.tagName);
          } else
            h.push(S);
          O++;
          break;
        ...
        default:
          f && s(b);
          var k = new $r(), ze = h[h.length - 1].currentNSMap, O = Bn(t, b, k, ze, o, n), dt = k.length;
          if (!k.closed && Sn(t, O, k.tagName, g) && (k.closed = !0, r.nbsp || n.warning("unclosed xml attribute")), f && dt) {
            for (var Pr = Ut(f, {}), Ge = 0; Ge < dt; Ge++) {
              var mt = k[Ge];
              s(mt.offset), mt.locator = Ut(f, {});
            }
            u.locator = Pr, zt(k, u, ze) && h.push(k), u.locator = f;
          } else
            zt(k, u, ze) && h.push(k);
          we.isHTML(k.uri) && !k.closed ? O = Tn(t, O, k.tagName, o, u) : O++;
      }
    } catch (N) {
      if (N instanceof fe)
        throw N;
      n.error("element parse error: " + N), O = -1;
    }
    O > v ? v = O : a(Math.max(b, v) + 1);
  }
}
function Ut(t, e) {
...
function Bn(t, e, r, u, n, i) {
  ...
  for (var a, s, c = ++e, l = De; ; ) {
    ...
    switch (p) {
      ...
      case '"':
        if (l === ve || l === X)
          if (l === X && (i.warning('attribute value must after "="'), a = t.slice(e, c)), e = c + 1, c = t.indexOf(p, e), c > 0)
      ...
      default:
        if (p <= " ")
          ...
          switch (l) {
            case ue:
              r.tagName, (!we.isHTML(u[""]) || !a.match(/^(?:disabled|checked|selected)$/i)) && i.warning('attribute "' + a + '" missed value!! "' + a + '" instead2!!'), o(a, a, e), e = c, l = X;
              break;
            case ie:
...
function zt(t, e, r) {
  for (var u = t.tagName, n = null, p = t.length; p--; ) {
    ...
    i.localName = c, l !== !1 && (n == null && (n = {}, kr(r, r = {})), r[l] = n[l] = a, i.uri = we.XMLNS, e.startPrefixMapping(l, a));
  }
...
pt.XMLReader = qr;
pt.ParseError = fe;
var Fn = H, Rn = Y, Gt = Rr, Mr = pt, qn = Rn.DOMImplementation, Jt = Fn.NAMESPACE, kn = Mr.ParseError, $n = Mr.XMLReader;
function Mn(t) {
  return t.replace(/\r[\n\u0085]/g, `
`).replace(/[\r\u0085\u2028]/g, `
`);
...
const Xt = "USJ", K = ["figure", "note", "sidebar", "table"];
class I {
  constructor(e) {
    E(this, "usj");
  ...
  // #endregion
  // #region Parent Maps
  createParentMapInternal(e, r, u) {
    var n;
    u.set(e, r), e.content && u.set(e.content, e), (n = e.content) == null || n.forEach((i) => {
      typeof i == "object" && this.createParentMapInternal(i, e, u);
    });
  }
  /** Viewing a Usj object as a tree, build a map to walk up the tree */
  createUsjParentMap() {
    const e = /* @__PURE__ */ new Map();
    this.usj.content && e.set(this.usj.content, this.usj), this.usj.content.forEach((r) => {
      typeof r == "object" && this.createParentMapInternal(r, this.usj, e);
    }), this.parentMapInternal = e;
  }
  /** Create the parent map if it doesn't already exist and return it */
  get parentMap() {
    return this.parentMapInternal ? this.parentMapInternal : (this.createUsjParentMap(), this.parentMapInternal);
  }
  // #endregion
  ...
  findNextMatchingNode(e, r, u) {
    ...
    return I.findNextMatchingNodeUsingWorkingStack(
      e,
      n,
      r,
      u
  ...
  nodeToJsonPath(e) {
    return I.convertWorkingStackToJsonPath(this.createWorkingStack(e));
  }
  // #endregion
  ...
  findVerseRefForNode(e, r, u = {
    ...
    if (u.verseNum !== void 0 && u.chapterNum !== void 0)
      return u;
    ...
    if (i < 0) {
      ...
      if (!c)
        throw new Error(`No parent found for ${JSON.stringify(r)}`);
      return this.findVerseRefForNode(s, c, u);
    }
    const o = r.content[i], a = I.findRightMostDescendantMarkerObject(
      o,
      r,
      K
    );
  ...
  nodeToVerseRefAndOffset(e, r, u) {
    const n = Array.isArray(u) ? this.parentMap.get(u) : u;
    if (n === void 0)
    ...
    return i.startingContentNode !== void 0 && this.findNextMatchingNode(i.startingContentNode, [], (s, c) => {
      var l, p;
      return s === r ? !0 : c.find((f) => K.includes(f.parent.type)) ? !1 : typeof s == "string" ? (a += s.length, !1) : s.type === xe && s.number !== ((l = i.chapterNum) == null ? void 0 : l.toString()) || s.type === Ie && s.number !== ((p = i.verseNum) == null ? void 0 : p.toString()) ? (a = 0, !0) : !1;
    }), { verseRef: o, offset: a };
  }
  // #endregion
  ...
  jsonPathToVerseRefAndOffset(e, r) {
    ...
    if (!u)
      throw new Error("Invalid USJ - not able to determine the book ID");
  ...
  verseRefToUsjContentLocation(e, r = 0) {
    ...
    if (n === void 0)
      throw new Error(`Could not find ${u} chapter ${e.chapterNum.toString()}`);
    let i = !1, o = "";
    const a = e.verseNum.toString(), s = this.findNextMatchingNode(
      n,
      K,
      (f, h) => f === n ? e.verseNum === 0 ? (o = I.convertWorkingStackToJsonPath(h), !0) : !1 : typeof f != "object" ? !1 : f.type === xe ? (i = !0, !0) : f.type === Ie && f.number !== void 0 && f.number === a ? (o = I.convertWorkingStackToJsonPath(h), !0) : !1
    );
    if (i || s === void 0 || typeof s == "string")
      throw new Error(`Verse ${a} not found in ${u} ${e.chapterNum}`);
    if (r === 0)
      return { node: s, offset: 0, jsonPath: o };
    let c = 0, l = 0, p;
    return this.findNextMatchingNode(
      ...
      (f, h) => {
        ...
        if (typeof f == "string") {
          if (c += f.length, c > r)
            return o = I.convertWorkingStackToJsonPath(h), l = r - c + f.length, p = f, !0;
        } else if (f.type === xe || f.type === Ie)
          return !0;
        return !1;
      }
  ...
  findNextLocationOfMatchingText(e, r, u = 1e3) {
    let n = "", i = 0, o = 0, a = 0;
    if (I.findNextMatchingNodeUsingWorkingStack(
      e.node,
    ...
    i = 0;
    let s = 0, c = [];
    const l = I.findNextMatchingNodeUsingWorkingStack(
      e.node,
      this.convertJsonPathToWorkingStack(e.jsonPath),
      K,
    ...
    return {
      node: l,
      offset: s,
      jsonPath: I.convertWorkingStackToJsonPath(c)
    };
  }
  // #endregion
  ...
  extractTextBetweenPoints(e, r, u = 100) {
    ...
    return I.findNextMatchingNodeUsingWorkingStack(
      ...
      this.convertJsonPathToWorkingStack(e.jsonPath),
      K,
      (i, o) => i === r.node && r.jsonPath === I.convertWorkingStackToJsonPath(o) ? !0 : typeof i != "string" ? !1 : (n = `${n}${i}`, n.length > u && (n = n.substring(0, u)), n.length >= u)
    ), n;
  }
  // #endregion
  ...
  removeContentNodes(e) {
    const r = I.removeContentNodesFromArray(this.usj.content, e);
    return this.parentMapInternal = void 0, r;
  }
  // #endregion
}
export {
