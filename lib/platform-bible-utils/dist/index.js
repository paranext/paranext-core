...
const Hr = {
  ...
  stringMetadata: {
    ...
    properties: {
      ...
      deprecated: {
        description: `If this property is filled, the localized string is deprecated. This string should contain the date of deprecation, the reason for deprecation, and what to use instead in what contexts.
