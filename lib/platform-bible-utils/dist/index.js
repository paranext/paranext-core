...
function Xu(t, e = 300) {
  let r, u, o, a;
  return (...h) => (clearTimeout(r), u || (u = new Promise((p, f) => {
    o = p, a = f;
  })), r = setTimeout(async () => {
    try {
      o(await t(...h));
...
function Yu(t, e, r) {
  ...
  return t.forEach((o) => {
    const a = e(o), h = u.get(a), p = r ? r(o, a) : o;
    h ? h.push(p) : u.set(a, [p]);
  }), u;
}
function rn(t) {
...
const De = class K {
  constructor(e, r, u, o) {
    if (H(this, "firstChapter"), H(this, "lastChapter"), H(this, "lastVerse"), H(this, "hasSegmentsDefined"), H(this, "text"), H(this, "BBBCCCVVVS"), H(this, "longHashCode"), H(this, "versification"), H(this, "rtlMark", "‏"), H(this, "_bookNum", 0), H(this, "_chapterNum", 0), H(this, "_verseNum", 0), H(this, "_verse"), u == null && o == null)
      if (e != null && typeof e == "string") {
        const a = e, h = r != null && r instanceof nt ? r : void 0;
   ...
   */
  static fromJSON(e) {
    const { book: r, chapterNum: u, verseNum: o, verse: a, versificationStr: h } = e, p = a || o.toString();
    let f;
    return h && (f = new nt(h)), r ? new K(r, u.toString(), p, f) : new K();
  }
  /**
...
H(De, "defaultVersification", nt.English), H(De, "verseRangeSeparator", "-"), H(De, "verseSequenceIndicator", ","), H(De, "verseRangeSeparators", [De.verseRangeSeparator]), H(De, "verseSequenceIndicators", [De.verseSequenceIndicator]), H(De, "chapterDigitShifter", 1e3), H(De, "bookDigitShifter", De.chapterDigitShifter * De.chapterDigitShifter), H(De, "bcvMaxValue", De.chapterDigitShifter - 1), /**
* The valid status of the VerseRef.
*/
H(De, "ValidStatusType", kr);
let Fr = De;
...
function Dt() {
  ...
  return ce.assign = u, ce.find = t, ce.freeze = e, ce.HTML_BOOLEAN_ATTRIBUTES = o, ce.HTML_RAW_TEXT_ELEMENTS = f, ce.HTML_VOID_ELEMENTS = h, ce.hasDefaultHTMLNamespace = v, ce.hasOwn = r, ce.isHTMLBooleanAttribute = a, ce.isHTMLRawTextElement = d, ce.isHTMLEscapableRawTextElement = m, ce.isHTMLMimeType = l, ce.isHTMLVoidElement = p, ce.isValidMimeType = y, ce.MIME_TYPE = C, ce.NAMESPACE = q, ce;
}
var dt = {}, ur;
function Lt() {
  if (ur) return dt;
  ...
  function h(v, C) {
    o(v) ? (this.name = u[v], this.message = C || "") : (this.message = v, this.name = a(C) ? C : r.Error), Error.captureStackTrace && Error.captureStackTrace(this, h);
  }
  ...
  for (var p = {
    ...
    DATA_CLONE_ERR: 25
  }, f = Object.entries(p), d = 0; d < f.length; d++) {
    var m = f[d][0];
    h[m] = f[d][1];
  }
  function l(v, C) {
  ...
  return e(l), dt.DOMException = h, dt.DOMExceptionName = r, dt.ExceptionCode = p, dt.ParseError = l, dt;
}
var re = {}, j = {}, ir;
function qr() {
  if (ir) return j;
  ...
  var C = r(v), b = o("[", C, r(/[-.0-9\xB7]/), r(/[\u0300-\u036F\u203F-\u2040]/), "]"), y = o(v, b, "*"), q = o(b, "+"), B = o("&", y, ";"), F = a(/&#[0-9]+;|&#x[0-9a-fA-F]+;/), U = a(B, "|", F), ne = o("%", y, ";"), fe = a(
    ...
    "|",
    o("'", a(/[^%&']/, "|", ne, "|", U), "*", "'")
  ), E = a('"', a(/[^<&"]/, "|", U), "*", '"', "|", "'", a(/[^<&']/, "|", U), "*", "'"), x = u(v, ":"), k = u(b, ":"), G = o(x, k, "*"), W = o(G, a(":", G), "?"), ee = o("^", W, "$"), Ie = o("(", W, ")"), te = a(/"[^"]*"|'[^']*'/), Be = o(/^<\?/, "(", y, ")", a(m, "(", p, "*?)"), "?", /\?>/), g = /[\x20\x0D\x0Aa-zA-Z0-9-'()+,./:=?;!*#@$_%]/, N = a('"', g, '*"', "|", "'", u(g, "'"), "*'"), S = "<!--", T = "-->", M = o(S, a(u(p, "-"), "|", o("-", u(p, "-"))), "*", T), A = "#PCDATA", R = a(
    o(/\(/, l, A, a(l, /\|/, l, W), "*", l, /\)\*/),
    "|",
    o(/\(/, l, A, l, /\)/)
  ), X = /[?*+]?/, _ = o(
  ...
  ), w = a("EMPTY", "|", "ANY", "|", R, "|", _), I = "<!ELEMENT", L = o(I, m, a(W, "|", ne), m, a(w, "|", ne), l, ">"), V = o("NOTATION", m, /\(/, l, y, a(l, /\|/, l, y), "*", l, /\)/), he = o(/\(/, l, q, a(l, /\|/, l, q), "*", l, /\)/), we = a(V, "|", he), Ae = a(/CDATA|ID|IDREF|IDREFS|ENTITY|ENTITIES|NMTOKEN|NMTOKENS/, "|", we), oe = a(/#REQUIRED|#IMPLIED/, "|", a(a("#FIXED", m), "?", E)), P = a(m, y, m, Ae, m, oe), Ue = "<!ATTLIST", Re = o(Ue, m, y, P, "*", l, ">"), pe = "about:legacy-compat", Ve = a('"' + pe + '"', "|", "'" + pe + "'"), _e = "SYSTEM", Se = "PUBLIC", ke = a(a(_e, m, te), "|", a(Se, m, N, m, te)), He = o(
    "^",
    a(
  ...
  ), Je = a(m, "NDATA", m, y), ye = a(fe, "|", a(ke, Je, "?")), Q = "<!ENTITY", ze = o(Q, m, y, m, ye, l, ">"), ae = a(fe, "|", ke), Xe = o(Q, m, "%", m, y, m, ae, l, ">"), vt = a(ze, "|", Xe), Ye = o(Se, m, N), Ke = o("<!NOTATION", m, y, m, a(ke, "|", Ye), l, ">"), $ = o(l, "=", l), Z = /1[.]\d+/, be = o(m, "version", $, a("'", Z, "'", "|", '"', Z, '"')), Ne = /[A-Za-z][-A-Za-z0-9._]*/, We = a(m, "encoding", $, a('"', Ne, '"', "|", "'", Ne, "'")), st = a(m, "standalone", $, a("'", a("yes", "|", "no"), "'", "|", '"', a("yes", "|", "no"), '"')), ct = o(/^<\?xml/, be, We, "?", st, "?", l, /\?>/), lt = "<!DOCTYPE", At = "<![CDATA[", bt = "]]>", ft = /<!\[CDATA\[/, Qe = /\]\]>/, ht = o(p, "*?", Qe), xt = o(ft, ht);
  return j.chars = r, j.chars_without = u, j.detectUnicodeSupport = t, j.reg = o, j.regg = a, j.ABOUT_LEGACY_COMPAT = pe, j.ABOUT_LEGACY_COMPAT_SystemLiteral = Ve, j.AttlistDecl = Re, j.CDATA_START = At, j.CDATA_END = bt, j.CDSect = xt, j.Char = p, j.Comment = M, j.COMMENT_START = S, j.COMMENT_END = T, j.DOCTYPE_DECL_START = lt, j.elementdecl = L, j.EntityDecl = vt, j.EntityValue = fe, j.ExternalID = ke, j.ExternalID_match = He, j.Name = y, j.NotationDecl = Ke, j.Reference = U, j.PEReference = ne, j.PI = Be, j.PUBLIC = Se, j.PubidLiteral = N, j.QName = W, j.QName_exact = ee, j.QName_group = Ie, j.S = m, j.SChar_s = d, j.S_OPT = l, j.SYSTEM = _e, j.SystemLiteral = te, j.UNICODE_REPLACEMENT_CHARACTER = h, j.UNICODE_SUPPORT = e, j.XMLDecl = ct, j;
}
var or;
function $r() {
  if (or) return re;
  or = 1;
  var t = Dt(), e = t.find, r = t.hasDefaultHTMLNamespace, u = t.hasOwn, o = t.isHTMLMimeType, a = t.isHTMLRawTextElement, h = t.isHTMLVoidElement, p = t.MIME_TYPE, f = t.NAMESPACE, d = Symbol(), m = Lt(), l = m.DOMException, v = m.DOMExceptionName, C = qr();
  function b(n) {
    if (n !== d)
  ...
  oe.prototype = {
    ...
    createDocument: function(n, i, s) {
      ...
      n === f.HTML ? c = p.XML_XHTML_APPLICATION : n === f.SVG && (c = p.XML_SVG_IMAGE);
    ...
    createHTMLDocument: function(n) {
      var i = new pe(d, { contentType: p.HTML });
  ...
  function qe(n, i, s, c) {
    ...
    switch (n.nodeType) {
      case G:
        var Y = n.attributes, se = Y.length, ge = n.firstChild, me = n.tagName, Ce = me;
        ...
        var qt = !ge;
        if (qt && (O || n.namespaceURI === f.HTML) && (qt = h(me)), qt)
          i.push("/>");
        else {
          if (i.push(">"), O && a(me))
            for (; ge; )
  ...
  function Ft(n, i, s) {
    ...
    switch (i.childNodes && (c.childNodes = new w()), c.ownerDocument = n, c.nodeType) {
      case G:
        var Y = i.attributes, se = c.attributes = new V(), me = Y.length;
        se._ownerElement = c;
    ...
    if (s)
      for (var Ee = i.firstChild; Ee; )
        c.appendChild(Ft(n, Ee, s)), Ee = Ee.nextSibling;
    return c;
  }
  function Yt(n, i, s) {
    n[i] = s;
...
function Tn() {
  if (sr) return Ct;
  sr = 1;
  var t = Dt(), e = qr(), r = Lt(), u = t.isHTMLEscapableRawTextElement, o = t.isHTMLMimeType, a = t.isHTMLRawTextElement, h = t.hasOwn, p = t.NAMESPACE, f = r.ParseError, d = r.DOMException, m = 0, l = 1, v = 2, C = 3, b = 4, y = 5, q = 6, B = 7;
  function F() {
  }
  F.prototype = {
  ...
  function ne(g, N, S, T, M) {
    ...
    function X($) {
      ...
      var Ne = Z.slice(1, -1);
      return h(S, Ne) ? S[Ne] : Ne.charAt(0) === "#" ? R(parseInt(Ne.substring(1).replace("x", "0x"))) : (M.error("entity not found:" + $), $);
    }
    function _($) {
      if ($ > oe) {
        var Z = g.substring(oe, $).replace(U, X);
        V && he(oe), T.characters(Z, 0, $ - oe), oe = $;
      }
    }
    var w = 0, I = 0, L = /\r\n?|\n|$/g, V = T.locator;
    function he($, Z) {
    ...
    for (var we = [{ currentNSMap: N }], Ae = [], oe = 0; ; ) {
      try {
        ...
        if (P > oe) {
          var pe = g.substring(oe, P);
          !A && Ae.length === 0 && (pe = pe.replace(new RegExp(e.S_OPT.source, "g"), ""), pe && M.error("Unexpected content outside root element: '" + pe + "'")), _(P);
        }
        switch (g.charAt(P + 1)) {
          case "/":
            ...
            if (T.endElement(He.uri, He.localName, Se), Je)
              for (var ye in Je)
                h(Je, ye) && T.endPrefixMapping(ye);
            ae++;
            break;
          // end element
          case "?":
            V && he(P), ae = te(g, P, T, M);
            break;
          case "!":
            V && he(P), ae = Ie(g, P, T, M, A);
            break;
          default:
            V && he(P);
  ...
  function x(g, N, S) {
    for (var T = g.tagName, M = null, L = g.length; L--; ) {
      ...
      A.localName = w, I !== !1 && (M == null && (M = /* @__PURE__ */ Object.create(null), G(S, S = /* @__PURE__ */ Object.create(null))), S[I] = M[I] = X, A.uri = p.XMLNS, N.startPrefixMapping(I, X));
    }
    for (var L = g.length; L--; )
      A = g[L], A.prefix && (A.prefix === "xml" && (A.uri = p.XML), A.prefix !== "xmlns" && (A.uri = S[A.prefix]));
    var V = T.indexOf(":");
...
function wn() {
  if (cr) return rt;
  cr = 1;
  var t = Dt(), e = $r(), r = Lt(), u = Cn(), o = Tn(), a = e.DOMImplementation, h = t.hasDefaultHTMLNamespace, p = t.isHTMLMimeType, f = t.isValidMimeType, d = t.MIME_TYPE, m = t.NAMESPACE, l = r.ParseError, v = o.XMLReader;
  function C(E) {
    return E.replace(/\r[\n\u0085]/g, `
`).replace(/[\r\u0085\u2028\u2029]/g, `
`);
  ...
  b.prototype.parseFromString = function(E, x) {
    ...
    h(x) ? (G = u.HTML_ENTITIES, W = m.HTML) : x === d.XML_SVG_IMAGE && (W = m.SVG), k[""] = W, k.xml = k.xml || m.XML;
...
function On() {
  return fr || (fr = 1, jt = () => {
    const t = "\\ud800-\\udfff", h = "\\u0300-\\u036f" + "\\ufe20-\\ufe2f" + "\\u20d0-\\u20ff" + "\\u1ab0-\\u1aff" + "\\u1dc0-\\u1dff", p = "\\ufe0e\\ufe0f", f = "\\uD83D\\uDC69\\uD83C\\uDFFB\\u200D\\uD83C\\uDF93", d = `[${t}]`, m = `[${h}]`, l = "\\ud83c[\\udffb-\\udfff]", v = `(?:${m}|${l})`, C = `[^${t}]`, b = "(?:\\uD83C[\\uDDE6-\\uDDFF]){2}", y = "[\\ud800-\\udbff][\\udc00-\\udfff]", q = "\\u200d", B = "(?:\\ud83c\\udff4\\udb40\\udc67\\udb40\\udc62\\udb40(?:\\udc65|\\udc73|\\udc77)\\udb40(?:\\udc6e|\\udc63|\\udc6c)\\udb40(?:\\udc67|\\udc74|\\udc73)\\udb40\\udc7f)", F = `[${f}]`, U = `${v}?`, ne = `[${p}]?`, fe = `(?:${q}(?:${[C, b, y].join("|")})${ne + U})*`, E = ne + U + fe, k = `(?:${[`${C}${m}?`, m, b, y, d, F].join("|")})`;
...
function gt(t, e) {
  return e < 0 || e > ve(t) - 1 ? "" : It(t, e, 1);
}
function li(t, e) {
  if (!(e < 0 || e > ve(t) - 1))
    return It(t, e, 1).codePointAt(0);
}
function xn(t, e, r = ve(t)) {
  const u = ve(e), o = r - u;
  return o < 0 ? !1 : It(t, o, u) === e;
}
function Mn(t, e, r) {
  if (e < 0) return -1;
  if (r) {
...
function Bn(t, e) {
  ...
  function a(p, f, d) {
    ...
    Me(p) ? r.push(`${l}${p}`) : (l && r.push(l), r.push(p)), o = f + d;
  }
  const h = ve(t);
  for (; u < h; ) {
    switch (gt(t, u)) {
      case "{":
        if (gt(t, u - 1) !== "\\") {
          const p = Mn(t, u, !1);
          if (p >= 0) {
            const f = ut(t, u + 1, p), d = f in e ? (
              // Just checked that the key is in the object
              // eslint-disable-next-line no-type-assertion/no-type-assertion
              e[f]
            ) : f;
            a(d, u, p + 1 - u), u = p, o = p + 1;
          }
        } else
          a("{", u - 1, 2);
        break;
  ...
  if (o < h) {
    const p = ut(t, o);
    r.push(
      r.length > 0 && Me(r[r.length - 1]) ? `${r.pop()}${p}` : p
    );
  }
  return r;
}
...
function mi(t, e, r = " ") {
  return e <= ve(t) ? t : ot.limit(t, e, r, "right");
}
function gi(t, e, r = " ") {
  return e <= ve(t) ? t : ot.limit(t, e, r, "left");
}
function pr(t, e) {
...
function mr(t, e, r) {
  ...
  let h = 0;
  if (!a) return [t];
  for (let p = 0; p < (r ? r - 1 : a.length); p++) {
    const f = Ot(t, a[p], h), d = ve(a[p]);
    if (u.push(ut(t, h, f)), h = f + d, r !== void 0 && u.length === r)
      break;
  }
  return u.push(ut(t, h)), u;
}
function Ur(t, e, r = 0) {
  return Ot(t, e, r) === r;
}
function It(t, e = 0, r = ve(t) - e) {
  return ot.substr(t, e, r);
}
function ut(t, e, r = ve(t)) {
...
const Vt = ["chapter", "book", "para", "row", "sidebar", Ut], Ln = "​", Vr = [
...
], kn = 1, Fn = Vr.length - 1, qn = 1, $n = 1, Ni = {
  book: "GEN",
  chapterNum: 1,
  verseNum: 1
}, jn = (t) => {
  ...
  book: le.bookNumberToId(
    Math.max(
      kn,
      Math.min(le.bookIdToNumber(t.book) + e, Fn)
    )
  ),
  chapterNum: 1,
  verseNum: 1
...
function Dr(t) {
  ...
  for (let o = 0; o < t.length; o += 1) {
    const a = t[o];
    a.charCodeAt(0) < 32 ? (r || (e += " "), r = !0) : !r && a === Ln && o + 1 < t.length && Er(t[o + 1]) || (Er(a) ? (r || (e += a), r = !0) : Hn(a) && u === a || (e += a, r = !1)), u = a;
  }
  return e;
}
function vr(t) {
...
function zr(t, e, r, u) {
  ...
  if (o && a) {
    const h = Dr(t), p = Dr(r);
    if (h !== p) {
      if (!mt(Bt(h, -1) ?? "") && !mt(Bt(p, -1) ?? "") || !Ar(t, e) || !Ar(r, u)) return !1;
      let f = h;
      for (; mt(Bt(f, -1) ?? ""); ) f = dr(f, 0, -1);
      let d = p;
      for (; mt(Bt(d, -1) ?? ""); ) d = dr(d, 0, -1);
      if (f !== d) return !1;
    }
  } else if (!o && !a) {
    const h = t, p = r, f = Object.keys(h).filter(
      (l) => l !== "content"
    );
    if (f.length !== Object.keys(p).filter((l) => l !== "content").length || f.some((l) => !(l in p) || h[l] !== p[l])) return !1;
    const d = vr(h.content), m = vr(p.content);
    if (d !== m) return !1;
    if (!d && !m) {
      let l = h.content, v = p.content;
      const C = l[l.length - 1];
      Vt.includes(h.type) && Me(C) && mt(C) && (l = l.slice(0, -1));
      const b = v[v.length - 1];
      if (Vt.includes(p.type) && Me(b) && mt(b) && (v = v.slice(0, -1)), l.length !== v.length) return !1;
...
function Pi(t, e) {
  const r = e && e.length > 0 ? e : Gr(), u = (() => {
    ...
    return t.forEach((h, p) => {
      h.caller === "+" && (o.set(p, Jn(a, r)), a += 1);
    }), o;
  })();
  return (o, a) => {
    if (o === "+") {
      const h = u.get(a);
      return h || (console.warn(`Caller index ${a} out of range for '+' callers`), "?");
    }
    if (o !== "-")
      return o;
  };
...
var Yn = Object.getOwnPropertyNames, Kn = Object.getOwnPropertySymbols, Wn = Object.prototype.hasOwnProperty;
function br(t, e) {
...
function Pt(t) {
  return function(r, u, o) {
    if (!r || !u || typeof r != "object" || typeof u != "object")
      return t(r, u, o);
    var a = o.cache, h = a.get(r), p = a.get(u);
    if (h && p)
      return h === u && p === r;
    a.set(r, u), a.set(u, r);
    var f = t(r, u, o);
...
function Nr(t) {
  return Yn(t).concat(Kn(t));
}
var Qn = Object.hasOwn || function(t, e) {
  return Wn.call(t, e);
};
function at(t, e) {
  return t === e || !t && !e && t !== t && e !== e;
}
var Zn = "__v", eu = "__o", tu = "_owner", yr = Object.getOwnPropertyDescriptor, Cr = Object.keys;
function ru(t, e, r) {
  var u = t.length;
  if (e.length !== u)
    return !1;
...
function Tr(t, e, r) {
  ...
  if (!u)
    return !0;
  for (var o = new Array(u), a = t.entries(), h, p, f = 0; (h = a.next()) && !h.done; ) {
    for (var d = e.entries(), m = !1, l = 0; (p = d.next()) && !p.done; ) {
      if (o[l]) {
        l++;
        continue;
      }
      var v = h.value, C = p.value;
...
function Tt(t, e, r) {
  ...
  if (Nr(e).length !== o)
    return !1;
  for (var a, h, p; o-- > 0; )
    if (a = u[o], !Hr(t, e, r, a) || (h = yr(t, a), p = yr(e, a), (h || p) && (!h || !p || h.configurable !== p.configurable || h.enumerable !== p.enumerable || h.writable !== p.writable)))
      return !1;
  return !0;
}
function su(t, e) {
...
function wr(t, e, r) {
  ...
  if (!u)
    return !0;
  for (var o = new Array(u), a = t.values(), h, p; (h = a.next()) && !h.done; ) {
    for (var f = e.values(), d = !1, m = 0; (p = f.next()) && !p.done; ) {
      if (!o[m] && r.equals(h.value, p.value, h.value, p.value, t, e, r)) {
        d = o[m] = !0;
        break;
      }
      m++;
...
function Hr(t, e, r, u) {
  return (u === tu || u === eu || u === Zn) && (t.$$typeof || e.$$typeof) ? !0 : Qn(e, u) && r.equals(t[u], e[u], u, u, t, e, r);
}
var hu = "[object Arguments]", pu = "[object Boolean]", du = "[object Date]", mu = "[object Error]", gu = "[object Map]", Eu = "[object Number]", Du = "[object Object]", vu = "[object RegExp]", Au = "[object Set]", bu = "[object String]", Nu = "[object URL]", yu = Array.isArray, Sr = typeof ArrayBuffer == "function" && ArrayBuffer.isView ? ArrayBuffer.isView : null, Or = Object.assign, Cu = Object.prototype.toString.call.bind(Object.prototype.toString);
function Tu(t) {
  var e = t.areArraysEqual, r = t.areDatesEqual, u = t.areErrorsEqual, o = t.areFunctionsEqual, a = t.areMapsEqual, h = t.areNumbersEqual, p = t.areObjectsEqual, f = t.arePrimitiveWrappersEqual, d = t.areRegExpsEqual, m = t.areSetsEqual, l = t.areTypedArraysEqual, v = t.areUrlsEqual;
  return function(b, y, q) {
    ...
    if (B !== typeof y)
      return !1;
    if (B !== "object")
      return B === "number" ? h(b, y, q) : B === "function" ? o(b, y, q) : !1;
    var F = b.constructor;
    if (F !== y.constructor)
      return !1;
    if (F === Object)
    ...
    if (F === Set)
      return m(b, y, q);
    var U = Cu(b);
    return U === du ? r(b, y, q) : U === vu ? d(b, y, q) : U === gu ? a(b, y, q) : U === Au ? m(b, y, q) : U === Du ? typeof b.then != "function" && typeof y.then != "function" && p(b, y, q) : U === Nu ? v(b, y, q) : U === mu ? u(b, y, q) : U === hu ? p(b, y, q) : U === pu || U === Eu || U === bu ? f(b, y, q) : !1;
  };
}
function wu(t) {
  var e = t.circular, r = t.createCustomConfig, u = t.strict, o = {
    areArraysEqual: u ? Tt : ru,
    areDatesEqual: nu,
    areErrorsEqual: uu,
    areFunctionsEqual: iu,
    areMapsEqual: u ? br(Tr, Tt) : Tr,
    areNumbersEqual: ou,
    areObjectsEqual: u ? Tt : au,
    arePrimitiveWrappersEqual: su,
    areRegExpsEqual: cu,
    areSetsEqual: u ? br(wr, Tt) : wr,
    areTypedArraysEqual: u ? Tt : lu,
    areUrlsEqual: fu
  };
  if (r && (o = Or({}, o, r(o))), e) {
    var a = Pt(o.areArraysEqual), h = Pt(o.areMapsEqual), p = Pt(o.areObjectsEqual), f = Pt(o.areSetsEqual);
    o = Or({}, o, {
      areArraysEqual: a,
      areMapsEqual: h,
      areObjectsEqual: p,
...
function Ge(t) {
  t === void 0 && (t = {});
  var e = t.circular, r = e === void 0 ? !1 : e, u = t.createInternalComparator, o = t.createState, a = t.strict, h = a === void 0 ? !1 : a, p = wu(t), f = Tu(p), d = u ? u(f) : Su(f);
  return Ou({ circular: r, comparator: f, createState: o, equals: d, strict: h });
}
function xu(t, e) {
  return Iu(t, e);
}
function Mu(t, e) {
  ...
  return Object.keys(r).forEach((a) => {
    o && (Object.hasOwn(u, a) && Mu(u[a], r[a]) || (o = !1));
  }), o;
}
function Ir(t, e, r) {
...
const Ru = 1e3, Jr = 60, Xr = Jr * 60, _u = Xr * 24;
function $i(t, e, r = /* @__PURE__ */ new Date()) {
  const u = Math.floor((e.getTime() - r.getTime()) / Ru), o = Math.round(u / _u);
  if (Math.abs(o) >= 1) return t.format(o, "day");
  const a = Math.round(u / Xr);
  if (Math.abs(a) >= 1) return t.format(a, "hour");
  const h = Math.round(u / Jr);
  return Math.abs(h) >= 1 ? t.format(h, "minute") : t.format(u, "second");
}
...
function Vi(t, e, r) {
  ...
  return o.id = `${$u}${r ? `-${r}` : ""}`, o.dataset.themeId = t.id, o.textContent = Uu(t), this.document.head.appendChild(o), o;
}
...
class ie {
    ...
    for (; a !== void 0; ) {
      ...
      if (
        ...
        !a.content.find((h, p) => {
          ...
          return r.unshift({ parent: a, index: p }), !0;
        })
      )
  ...
  findAllNotes() {
    var e;
    return Xn((e = this.usj) == null ? void 0 : e.content);
  }
  /**
  ...
  static findNextMatchingNodeUsingWorkingStack(e, r, u, o) {
    ...
    let a = e;
    for (; a !== void 0; ) {
      const p = typeof a == "object" && u.includes(a.type);
      if (!p && o(a, r)) return a;
  ...
  findVerseRefForNode(e, r, u = {
    ...
    const h = r.content[a], p = ie.findRightMostDescendantMarkerObject(
      h,
      r,
      je
    );
    return this.findVerseRefForNode(p.node, p.parent, u);
  }
  nodeToVerseRefAndOffset(e, r, u) {
    ...
    return a.startingContentNode !== void 0 && this.findNextMatchingNode(a.startingContentNode, [], (f, d) => {
      var m, l;
      return f === r ? !0 : d.find((v) => je.includes(v.parent.type)) ? !1 : typeof f == "string" ? (p += f.length, !1) : f.type === Rt && f.number !== ((m = a.chapterNum) == null ? void 0 : m.toString()) || f.type === _t && f.number !== ((l = a.verseNum) == null ? void 0 : l.toString()) ? (p = 0, !0) : !1;
    }), { verseRef: h, offset: p };
  }
  // #endregion
  ...
  jsonPathToVerseRefAndOffset(e, r) {
    ...
    const h = this.nodeToVerseRefAndOffset(u, o, a);
    if (!h)
      throw new Error(
  ...
  verseRefToUsjContentLocation(e, r = 0) {
    ...
    const p = e.verse ?? e.verseNum.toString(), f = this.findNextMatchingNode(
      o,
      je,
      (v, C) => v === o ? e.verseNum === 0 ? (h = ie.convertWorkingStackToJsonPath(C), !0) : !1 : typeof v != "object" ? !1 : v.type === Rt ? (a = !0, !0) : v.type === _t && v.number !== void 0 && v.number === p ? (h = ie.convertWorkingStackToJsonPath(C), !0) : !1
    );
    if (a || f === void 0 || typeof f == "string")
      throw new Error(`Verse ${p} not found in ${u} ${e.chapterNum}`);
    if (r === 0) return { node: f, offset: 0, jsonPath: h };
    let d = 0, m = 0, l;
    return this.findNextMatchingNode(
      ...
      (v, C) => {
        ...
        if (typeof v == "string") {
          if (d += v.length, d > r)
            return h = ie.convertWorkingStackToJsonPath(C), m = r - d + v.length, l = v, !0;
        } else if (v.type === Rt || v.type === _t) return !0;
        return !1;
      }
    ), { node: l ?? f, offset: m, jsonPath: h };
  }
  ...
  findNextLocationOfMatchingText(e, r, u = 1e3) {
    ...
    if (ie.findNextMatchingNodeUsingWorkingStack(
      ...
      (C, b) => {
        ...
        ie.areStackItemsShallowEqual(q, d) && (y = C.substring(e.offset), h += e.offset), a += y.length, o = `${o}${y}`;
        const B = o.indexOf(r);
        return B < 0 ? (h += o.length, o.length > r.length && (o = o.substring(o.length - r.length)), h -= o.length, a > u) : (p = h + B, !0);
      }
    ), p < 0) return;
    a = 0;
    let m = 0, l = [];
    const v = ie.findNextMatchingNodeUsingWorkingStack(
      ...
      je,
      (C, b) => typeof C != "string" || (a += C.length, a < p + 1) ? !1 : (m = p - a + C.length, l = b, !0)
    );
  ...
  search(e) {
    ...
    let h = 0, p = u.node;
    for (; p !== void 0; )
      p = ie.findNextMatchingNodeUsingWorkingStack(
        u.node,
        ...
        // eslint-disable-next-line no-loop-func
        (m, l) => (typeof m != "string" || (o.push(m), a.set(h, {
          node: m,
          offset: 0,
          jsonPath: ie.convertWorkingStackToJsonPath(l)
        }), h += m.length), !1)
    ...
    return ie.findNextMatchingNodeUsingWorkingStack(
      ...
      (h) => {
        ...
        if (o >= h.length)
          return o -= h.length, !1;
        let p = h;
        if (o > 0 && (p = p.substring(o), o = 0), a + p.length < r)
          return a += p.length, u = `${u}${p}`, !1;
        const f = r - a;
        return u = `${u}${p.substring(0, f - 1)}`, !0;
      }
    ), u;
  }
  extractTextBetweenPoints(e, r, u = 100) {
    ...
    return ie.findNextMatchingNodeUsingWorkingStack(
      ...
      this.convertJsonPathToWorkingStack(e.jsonPath),
      je,
      (a, h) => a === r.node && (typeof a == "object" || r.jsonPath === ie.convertWorkingStackToJsonPath(h)) ? !0 : typeof a != "string" ? !1 : (o = `${o}${a}`, o.length > u && (o = o.substring(0, u)), o.length >= u)
    ), o;
  }
  // #endregion
...
export {
  ...
  sn as Mutex,
  ri as MutexMap,
  ni as NonValidatingDocumentCombiner,
  cn as NumberFormat,
  Mt as PLATFORM_ERROR_VERSION,
  tn as PlatformEventEmitter,
  ui as PromiseChainingMap,
  Vn as Section,
  fn as SortedNumberMap,
  ii as SortedSet,
  $u as THEME_STYLE_ELEMENT_ID,
  oi as UnsubscriberAsyncList,
  ...
  Qu as createSyncProxyForAsyncObject,
  Xu as debounce,
  wt as deepClone,
  xu as deepEqual,
  Ni as defaultScrRef,
  ...
  xi as formatScrRef,
  $i as formatTimeSpan,
  Wu as getAllObjectFunctionNames,
  ...
  Uu as getStylesheetForTheme,
  Yu as groupBy,
  ki as htmlEncode,
  Rn as includes,
  Ot as indexOf,
  Zu as isErrorMessageAboutParatextBlockingInternetAccess,
  ei as isErrorMessageAboutRegistryAuthFailure,
  Ei as isLocalizeKey,
  si as isPlatformError,
  Li as isSerializable,
  Me as isString,
  Mu as isSubset,
  mt as isWhiteSpace,
  hi as lastIndexOf,
  ku as localizedStringsDocumentSchema,
  Fu as menuDocumentSchema,
  Ju as newGuid,
  ai as newPlatformError,
  pi as normalize,
  ...
  mi as padEnd,
  gi as padStart,
  Pu as projectSettingsDocumentSchema,
