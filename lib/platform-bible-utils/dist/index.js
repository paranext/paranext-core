...
var m = (t, e, r) => (Pe(t, typeof e != "symbol" ? e + "" : e, r), r);
...
class Re {
  ...
  constructor(e, r) {
    ...
    m(this, "latestOutput");
    m(this, "options");
    m(this, "onDidRebuildEmitter", new Me());
...
var Ve = Object.defineProperty, ze = (t, e, r) => e in t ? Ve(t, e, { enumerable: !0, configurable: !0, writable: !0, value: r }) : t[e] = r, l = (t, e, r) => (ze(t, typeof e != "symbol" ? e + "" : e, r), r);
const S = [
  "GEN",
  "EXO",
  "LEV",
...
const y = class f {
  constructor(e, r, s, i) {
    if (l(this, "firstChapter"), l(this, "lastChapter"), l(this, "lastVerse"), l(this, "hasSegmentsDefined"), l(this, "text"), l(this, "BBBCCCVVVS"), l(this, "longHashCode"), l(this, "versification"), l(this, "rtlMark", "‏"), l(this, "_bookNum", 0), l(this, "_chapterNum", 0), l(this, "_verseNum", 0), l(this, "_verse"), s == null && i == null)
      if (e != null && typeof e == "string") {
        const o = e, n = r != null && r instanceof j ? r : void 0;
        this.setEmpty(n), this.parse(o);
      } else if (e != null && typeof e == "number") {
        const o = r != null && r instanceof j ? r : void 0;
        ...
        if (e != null && e instanceof f) {
          ...
          if (e == null)
            return;
          const o = e instanceof j ? e : f.defaultVersification;
          this.setEmpty(o);
        }
      else
  ...
  allVerses(e = !1, r = f.verseRangeSeparators, s = f.verseSequenceIndicators) {
    if (this._verse == null || this.chapterNum <= 0)
      return [this.clone()];
    const i = [], o = Z(this._verse, s);
    for (const n of o.map((a) => Z(a, r))) {
      const a = this.clone();
      a.verse = n[0];
      const h = a.verseNum;
...
var Q = typeof globalThis < "u" ? globalThis : typeof window < "u" ? window : typeof global < "u" ? global : typeof self < "u" ? self : {}, O = {}, Ze = () => {
  const t = "\\ud800-\\udfff", e = "\\u0300-\\u036f", r = "\\ufe20-\\ufe2f", s = "\\u20d0-\\u20ff", i = "\\u1ab0-\\u1aff", o = "\\u1dc0-\\u1dff", n = e + r + s + i + o, a = "\\ufe0e\\ufe0f", h = "\\uD83D\\uDC69\\uD83C\\uDFFB\\u200D\\uD83C\\uDF93", p = `[${t}]`, u = `[${n}]`, c = "\\ud83c[\\udffb-\\udfff]", d = `(?:${u}|${c})`, v = `[^${t}]`, b = "(?:\\uD83C[\\uDDE6-\\uDDFF]){2}", P = "[\\ud800-\\udbff][\\udc00-\\udfff]", x = "\\u200d", $e = "(?:\\ud83c\\udff4\\udb40\\udc67\\udb40\\udc62\\udb40(?:\\udc65|\\udc73|\\udc77)\\udb40(?:\\udc6e|\\udc63|\\udc6c)\\udb40(?:\\udc67|\\udc74|\\udc73)\\udb40\\udc7f)", Se = `[${h}]`, H = `${d}?`, L = `[${a}]?`, Oe = `(?:${x}(?:${[v, b, P].join("|")})${L + H})*`, je = L + H + Oe, Ce = `(?:${[`${v}${u}?`, u, b, P, p, Se].join("|")})`;
  return new RegExp(`${$e}|${c}(?=${c})|${Ce + je}`, "g");
...
const vr = (t) => (...e) => t.map((s) => s(...e)).every((s) => s), Nr = (t) => async (...e) => {
...
function oe(t, e, r) {
  ...
  for (var s = {}, i = t.entries(), o = 0, n, a; (n = i.next()) && !n.done; ) {
    for (var h = e.entries(), p = !1, u = 0; (a = h.next()) && !a.done; ) {
      var c = n.value, d = c[0], v = c[1], b = a.value, P = b[0], x = b[1];
      !p && !s[u] && (p = r.equals(d, P, o, u, t, e, r) && r.equals(v, x, d, P, t, e, r)) && (s[u] = !0), u++;
    }
    if (!p)
      return !1;
    o++;
...
function Rt(t) {
  ...
  return function(u, c, d) {
    ...
    if (v === Set)
      return a(u, c, d);
    var b = It(u);
    return b === Ct ? r(u, c, d) : b === Mt ? n(u, c, d) : b === At ? s(u, c, d) : b === Bt ? a(u, c, d) : b === Tt ? typeof u.then != "function" && typeof c.then != "function" && i(u, c, d) : b === Ot ? i(u, c, d) : b === jt || b === Pt || b === Dt ? o(u, c, d) : !1;
  };
}
function xt(t) {
  var e = t.circular, r = t.createCustomConfig, s = t.strict, i = {
    areArraysEqual: s ? M : vt,
    areDatesEqual: Nt,
  ...
  if (r && (i = ue({}, i, r(i))), e) {
    var o = D(i.areArraysEqual), n = D(i.areMapsEqual), a = D(i.areObjectsEqual), h = D(i.areSetsEqual);
    i = ue({}, i, {
      areArraysEqual: o,
      areMapsEqual: n,
      areObjectsEqual: a,
...
function $(t) {
  t === void 0 && (t = {});
  var e = t.circular, r = e === void 0 ? !1 : e, s = t.createInternalComparator, i = t.createState, o = t.strict, n = o === void 0 ? !1 : o, a = xt(t), h = Rt(a), p = s ? s(h) : qt(h);
  return Vt({ circular: r, comparator: h, createState: i, equals: p, strict: n });
}
function Er(t, e) {
  return zt(t, e);
}
...
const $r = (t) => t.replace(/&/g, "&amp;").replace(/</g, "&lt;").replace(/>/g, "&gt;").replace(/"/g, "&quot;").replace(/'/g, "&#x27;").replace(/\//g, "&#x2F;"), X = {
...
export {
  ...
  qe as Mutex,
  or as MutexMap,
  sr as NonValidatingDocumentCombiner,
  ...
  at as includes,
  _ as indexOf,
  wr as isSerializable,
  Be as isString,
  ut as lastIndexOf,
  Xt as localizedStringsDocumentSchema,
