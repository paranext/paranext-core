...
function Ku(t) {
  const e = "401 Unauthorized error while getting shared projects.", n = "User registration is not valid. Cannot retrieve resources from DBL.", i = Ie(t) ? t : Or(t);
...
function kr() {
  ...
  var O = n(v), N = o("[", O, n(/[-.0-9\xB7]/), n(/[\u0300-\u036F\u203F-\u2040]/), "]"), y = o(v, N, "*"), j = o(N, "+"), R = o("&", y, ";"), F = a(/&#[0-9]+;|&#x[0-9a-fA-F]+;/), U = a(R, "|", F), ne = o("%", y, ";"), fe = a(
    ...
    "|",
    o("'", a(/[^%&']/, "|", ne, "|", U), "*", "'")
  ), E = a('"', a(/[^<&"]/, "|", U), "*", '"', "|", "'", a(/[^<&']/, "|", U), "*", "'"), x = i(v, ":"), k = i(N, ":"), z = o(x, k, "*"), W = o(z, a(":", z), "?"), ee = o("^", W, "$"), xe = o("(", W, ")"), te = a(/"[^"]*"|'[^']*'/), Be = o(/^<\?/, "(", y, ")", a(m, "(", h, "*?)"), "?", /\?>/), g = /[\x20\x0D\x0Aa-zA-Z0-9-'()+,./:=?;!*#@$_%]/, b = a('"', g, '*"', "|", "'", i(g, "'"), "*'"), w = "<!--", C = "-->", M = o(w, a(i(h, "-"), "|", o("-", i(h, "-"))), "*", C), A = "#PCDATA", B = a(
    o(/\(/, l, A, a(l, /\|/, l, W), "*", l, /\)\*/),
    "|",
    o(/\(/, l, A, l, /\)/)
  ), J = /[?*+]?/, _ = o(
...
function In(t, e) {
  ...
  let i = 0, o = 0;
  function a(h, f, d) {
    const m = ut(t, o, f), l = n.length > 0 && Ie(n[n.length - 1]) ? `${n.pop()}${m}` : m;
    Ie(h) ? n.push(`${l}${h}`) : (l && n.push(l), n.push(h)), o = f + d;
  }
  const p = le(t);
  for (; i < p; ) {
    switch (gt(t, i)) {
  ...
  if (o < p) {
    const h = ut(t, o);
    n.push(
      n.length > 0 && Ie(n[n.length - 1]) ? `${n.pop()}${h}` : h
    );
  }
  return n;
}
