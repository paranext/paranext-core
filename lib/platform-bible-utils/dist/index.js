...
var At = typeof globalThis < "u" ? globalThis : typeof window < "u" ? window : typeof global < "u" ? global : typeof self < "u" ? self : {}, re = {}, fu = () => {
  const t = "\\ud800-\\udfff", e = "\\u0300-\\u036f", r = "\\ufe20-\\ufe2f", u = "\\u20d0-\\u20ff", n = "\\u1ab0-\\u1aff", i = "\\u1dc0-\\u1dff", o = e + r + u + n + i, a = "\\ufe0e\\ufe0f", s = "\\uD83D\\uDC69\\uD83C\\uDFFB\\u200D\\uD83C\\uDF93", c = `[${t}]`, l = `[${o}]`, p = "\\ud83c[\\udffb-\\udfff]", f = `(?:${l}|${p})`, h = `[^${t}]`, g = "(?:\\uD83C[\\uDDE6-\\uDDFF]){2}", v = "[\\ud800-\\udbff][\\udc00-\\udfff]", b = "\\u200d", y = "(?:\\ud83c\\udff4\\udb40\\udc67\\udb40\\udc62\\udb40(?:\\udc65|\\udc73|\\udc77)\\udb40(?:\\udc6e|\\udc63|\\udc6c)\\udb40(?:\\udc67|\\udc74|\\udc73)\\udb40\\udc7f)", Z = `[${s}]`, A = `${f}?`, O = `[${a}]?`, de = `(?:${b}(?:${[h, g, v].join("|")})${O + A})*`, Se = O + A + de, Oe = `(?:${[`${h}${l}?`, l, g, v, c, Z].join("|")})`;
...
var Fu = Object.getOwnPropertyNames, qu = Object.getOwnPropertySymbols, ku = Object.prototype.hasOwnProperty;
function Ct(t, e) {
...
var k = {}, j = k.ELEMENT_NODE = 1, le = k.ATTRIBUTE_NODE = 2, Re = k.TEXT_NODE = 3, dr = k.CDATA_SECTION_NODE = 4, mr = k.ENTITY_REFERENCE_NODE = 5, Dn = k.ENTITY_NODE = 6, gr = k.PROCESSING_INSTRUCTION_NODE = 7, Dr = k.COMMENT_NODE = 8, vr = k.DOCUMENT_NODE = 9, br = k.DOCUMENT_TYPE_NODE = 10, J = k.DOCUMENT_FRAGMENT_NODE = 11, vn = k.NOTATION_NODE = 12, S = {}, B = {};
...
var pt = {}, we = X.NAMESPACE, Ke = /[A-Z_a-z\xC0-\xD6\xD8-\xF6\u00F8-\u02FF\u0370-\u037D\u037F-\u1FFF\u200C-\u200D\u2070-\u218F\u2C00-\u2FEF\u3001-\uD7FF\uF900-\uFDCF\uFDF0-\uFFFD]/, Lt = new RegExp("[\\-\\.0-9" + Ke.source.slice(1, -1) + "\\u00B7\\u0300-\\u036F\\u203F-\\u2040]"), Vt = new RegExp("^" + Ke.source + Lt.source + "*(?::" + Ke.source + Lt.source + "*)?$"), De = 0, K = 1, ue = 2, ve = 3, ne = 4, ie = 5, be = 6, qe = 7;
function fe(t, e) {
...
pt.XMLReader = kr;
pt.ParseError = fe;
var Fn = X, qn = Y, Gt = qr, Mr = pt, kn = qn.DOMImplementation, Jt = Fn.NAMESPACE, Rn = Mr.ParseError, $n = Mr.XMLReader;
function Mn(t) {
  return t.replace(/\r[\n\u0085]/g, `
`).replace(/[\r\u0085\u2028]/g, `
`);
...
Ue.prototype = {
  startDocument: function() {
    this.doc = new kn().createDocument(null, null, null), this.locator && (this.doc.documentURI = this.locator.systemId);
  },
  startElement: function(t, e, r, u) {
    var n = this.doc, i = n.createElementNS(t, r || e), o = u.length;
    ke(this, i), this.currentElement = i, this.locator && oe(this.locator, i);
    for (var a = 0; a < o; a++) {
  ...
  processingInstruction: function(t, e) {
    ...
    this.locator && oe(this.locator, r), ke(this, r);
  },
  ...
  comment: function(t, e, r) {
    ...
    this.locator && oe(this.locator, u), ke(this, u);
  },
  startCDATA: function() {
    this.cdata = !0;
  },
  ...
  startDTD: function(t, e, r) {
    ...
    if (u && u.createDocumentType) {
      ...
      this.locator && oe(this.locator, n), ke(this, n), this.doc.doctype = n;
    }
  },
  /**
