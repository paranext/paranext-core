...
<<<<<<< HEAD
import { d as C, i as _ } from "./scripture-util-BNsEPlLA.js";
import { F as Tt, a as Ct, b as qt, L as At, S as $t, c as jt, e as Nt, f as Ft, g as Ut, h as Ot, j as Rt, k as Dt, l as Lt, m as Bt, n as Vt, o as zt, p as Ht, q as Jt, r as Kt, s as Gt, t as Yt, u as Xt, v as Wt, w as Zt, x as Qt, y as er, z as tr, A as rr, B as nr, C as ir, D as sr, E as ar, G as or, H as cr, I as dr, J as pr, K as lr, M as ur, N as hr, O as fr, P as mr, Q as gr, R as yr, T as kr, U as br, V as vr, W as Mr, X as xr, Y as _r, Z as Ir, _ as Er, $ as wr, a0 as Sr, a1 as Pr, a2 as Tr, a3 as Cr, a4 as qr, a5 as Ar, a6 as $r, a7 as jr, a8 as Nr, a9 as Fr } from "./scripture-util-BNsEPlLA.js";
=======
import { d as C, i as _ } from "./scripture-util-D7dYF5YF.js";
import { F as Tt, a as Ct, b as qt, L as At, S as $t, c as jt, e as Nt, f as Ft, g as Ut, h as Ot, j as Rt, k as Dt, l as Lt, m as Bt, n as Vt, o as zt, p as Ht, q as Jt, r as Kt, s as Gt, t as Yt, u as Xt, v as Wt, w as Zt, x as Qt, y as er, z as tr, A as rr, B as nr, C as ir, D as sr, E as ar, G as or, H as cr, I as dr, J as pr, K as lr, M as ur, N as hr, O as fr, P as mr, Q as gr, R as yr, T as kr, U as br, V as vr, W as Mr, X as xr, Y as _r, Z as Ir, _ as Er, $ as wr, a0 as Sr, a1 as Pr, a2 as Tr, a3 as Cr, a4 as qr, a5 as Ar, a6 as $r, a7 as jr, a8 as Nr } from "./scripture-util-D7dYF5YF.js";
...
class ae {
  ...
  constructor(e, t) {
    ...
    k(this, "latestOutput");
    k(this, "options");
    k(this, "onDidRebuildEmitter", new se());
...
class Oe {
  ...
  get(e) {
    ...
    return t || (t = new ce(), this.mutexesByID.set(e, t), t);
  }
  /**
...
const Ve = "ABORTED", ze = "ALREADY_EXISTS", He = "CANCELLED", Je = "DATA_LOSS", Ke = "DEADLINE_EXCEEDED", Ge = "FAILED_PRECONDITION", Ye = "INTERNAL", Xe = "INVALID_ARGUMENT", We = "NOT_FOUND", Ze = "OUT_OF_RANGE", Qe = "PERMISSION_DENIED", et = "RESOURCE_EXHAUSTED", tt = "UNAUTHENTICATED", rt = "UNAVAILABLE", nt = "UNIMPLEMENTED", it = "UNKNOWN", A = 1;
function st(o, e) {
  if (!o)
    return {
      message: "",
...
const ot = (o) => (...e) => o.map((r) => r(...e)).every((r) => r), ct = (o) => async (...e) => {
  const t = o.map(async (r) => r(...e));
  return (await Promise.all(t)).every((r) => r);
}, le = "book", B = "chapter", w = "verse", S = "***";
...
function fe(o, e) {
  ...
  return Object.keys(t).forEach((n) => {
    i && (Object.hasOwn(r, n) && fe(r[n], t[n]) || (i = !1));
  }), i;
}
function V(o, e, t) {
...
const mt = (o) => o.replace(/&/g, "&amp;").replace(/</g, "&lt;").replace(/>/g, "&gt;").replace(/"/g, "&quot;").replace(/'/g, "&#x27;").replace(/\//g, "&#x2F;");
function gt() {
...
const ge = 1e3, K = 60, G = K * 60, ye = G * 24;
function bt(o, e, t = /* @__PURE__ */ new Date()) {
  const r = Math.floor((e.getTime() - t.getTime()) / ge), i = Math.round(r / ye);
...
function Et(o, e, t) {
  ...
  return i.id = `${_e}${t ? `-${t}` : ""}`, i.dataset.themeId = o.id, i.textContent = Ee(o), this.document.head.appendChild(i), i;
}
function W(o) {
...
USJ: ${JSON.stringify(
  ...
  findAllNotes() {
    var e;
    return he((e = this.usj) == null ? void 0 : e.content);
  }
  /**
  ...
  getInfoForMarker(e, t = "usfm") {
    ...
    if (p != null && p.markerTypeUsfm && (l = p.markerTypeUsfm, p = this.markersMap.markerTypes[l]), !_(e) && e.type !== c && (!p || e.type !== p.markerTypeUsfm && e.type !== p.markerTypeUsx && e.type !== p.markerTypeUsj) && (console.warn(
    ...
    if (t === "usfm" && l === "cell" && b.colspan) {
      const u = parseInt(b.colspan, 10), h = Se.exec(r);
      if (h != null && h[1]) {
  ...
  textContentToUsfm(e) {
    return {
      usfm: this.shouldAllowInvisibleCharacters ? e : e.replace(we, "~"),
    ...
    e.map((l) => {
      ...
      if (typeof l.fragment == "object" && "type" in l.fragment) {
        ...
        if (h.type === le && h.code)
          ...
          const f = (m = Pe.exec(h.number)) == null ? void 0 : m[1];
          if (!f)
            console.warn(
...
export {
  ...
  Fe as Collator,
  Je as DATA_LOSS,
  Ke as DEADLINE_EXCEEDED,
  ie as DateTimeFormat,
  ae as DocumentCombiner,
  Ue as EventRollingTimeCounter,
  Ge as FAILED_PRECONDITION,
  Tt as FIRST_SCR_BOOK_NUM,
  Ct as FIRST_SCR_CHAPTER_NUM,
  qt as FIRST_SCR_VERSE_NUM,
  Ye as INTERNAL,
  Xe as INVALID_ARGUMENT,
  At as LAST_SCR_BOOK_NUM,
  Mt as MODIFIER_KEYS,
  s as MarkerType,
  ce as Mutex,
  Oe as MutexMap,
  We as NOT_FOUND,
  Re as NonValidatingDocumentCombiner,
  de as NumberFormat,
  Ze as OUT_OF_RANGE,
  Qe as PERMISSION_DENIED,
  A as PLATFORM_ERROR_VERSION,
  se as PlatformEventEmitter,
  De as PromiseChainingMap,
  et as RESOURCE_EXHAUSTED,
  $t as SELECTABLE_INVISIBLE_CHAR_OR_WHITESPACE_CLASS,
  jt as Section,
  L as SortedNumberMap,
  Le as SortedSet,
  _e as THEME_STYLE_ELEMENT_ID,
  tt as UNAUTHENTICATED,
  rt as UNAVAILABLE,
  nt as UNIMPLEMENTED,
  it as UNKNOWN,
  F as USFM_MARKERS_MAP_3_0,
  wt as USFM_MARKERS_MAP_PARATEXT_3_0,
  Be as UnsubscriberAsyncList,
  g as UsjReaderWriter,
  w as VERSE_TYPE,
  ct as aggregateUnsubscriberAsyncs,
  ot as aggregateUnsubscribers,
  Et as applyThemeStylesheet,
  Nt as areUsjContentsEqualExceptWhitespace,
  Ft as at,
  Ut as charAt,
  Ot as codePointAt,
  Rt as collapseMiddleWords,
  Dt as collectUsjMarkers,
  Lt as compareScrRefs,
  _t as computeEffectiveStructureProtection,
  Bt as createSyncProxyForAsyncObject,
  Vt as debounce,
  C as deepClone,
  N as deepEqual,
  zt as defaultScrRef,
  ...
  Ht as endsWith,
  Jt as ensureArray,
  Kt as escapeStringRegexp,
  It as expandThemeContribution,
  yt as formatBytes,
  vt as formatRelativeDate,
  Gt as formatReplacementString,
  Yt as formatReplacementStringToArray,
  Xt as formatScrRef,
  Wt as formatScrRefRange,
  bt as formatTimeSpan,
  Zt as getAllObjectFunctionNames,
  Qt as getChaptersForBook,
  gt as getCurrentLocale,
  J as getDefaultCallerSequence,
  er as getErrorMessage,
  ut as getFormatCallerFunction,
  xt as getLocalizeKeyForPhysicalKey,
  tr as getLocalizeKeyForScrollGroupId,
  rr as getLocalizeKeysForScrollGroupIds,
  nr as getLocalizedIdFromBookNumber,
  ue as getNthCaller,
  ht as getPaneSizeLimits,
  ir as getSectionForBook,
  Ee as getStylesheetForTheme,
  sr as groupBy,
  mt as htmlEncode,
  ar as includes,
  or as indexOf,
  ...
  cr as isErrorMessageAboutParatextBlockingInternetAccess,
  dr as isErrorMessageAboutRegistryAuthFailure,
  pr as isLocalizeKey,
  at as isPlatformError,
  lr as isSelectableInvisibleCharOrWhiteSpace,
  ft as isSerializable,
  _ as isString,
  fe as isSubset,
  ur as isWhiteSpace,
  hr as lastIndexOf,
  ve as localizedStringsDocumentSchema,
  Me as menuDocumentSchema,
  fr as newGuid,
  st as newPlatformError,
  mr as normalize,
  kt as normalizeProjectId,
  ...
  Mr as padEnd,
  xr as padStart,
  ke as projectSettingsDocumentSchema,
  _r as retryUntil,
  lt as sanitizeHtml,
  Ir as scrRefToBBBCCC,
  Er as scrRefToBBBCCCVVV,
  V as serialize,
  be as settingsDocumentSchema,
  wr as slice,
  Sr as split,
  Pr as startsWith,
  Tr as stringLength,
  Cr as substring,
  xe as themeDocumentSchema,
  qr as toArray,
  Ar as toKebabCase,
  $r as transformAndEnsureRegExpArray,
  jr as transformAndEnsureRegExpRegExpArray,
  H as usfmMarkers,
  Nr as wait,
  Fr as waitForDuration
};
