...
], Fn = 1, qn = Vr.length - 1, $n = 1, jn = 1, yi = {
  book: "GEN",
  chapterNum: 1,
  verseNum: 1
}, Un = (t) => {
...
function ki(t) {
  return Yn(t == null ? void 0 : t.content);
}
...
export {
  ...
  xn as endsWith,
  jr as ensureArray,
  vi as escapeStringRegexp,
  zi as expandThemeContribution,
  ki as extractFootnotesFromUsj,
  Yn as extractFootnotesFromUsjContent,
  ji as formatBytes,
  pi as formatReplacementString,
  ...
  xi as getLocalizeKeysForScrollGroupIds,
  Si as getLocalizedIdFromBookNumber,
  Xn as getNthCaller,
  Bi as getSectionForBook,
  ...
  Ti as offsetChapter,
  wi as offsetVerse,
  mi as ordinalCompare,
  gi as padEnd,
  Ei as padStart,
  Lu as projectSettingsDocumentSchema,
  Oi as scrRefToBBBCCC,
  ...
  Pn as toArray,
  Ni as toKebabCase,
  bi as transformAndEnsureRegExpArray,
