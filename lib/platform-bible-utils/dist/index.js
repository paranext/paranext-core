...
const ve = class K {
  ...
  parse(e) {
    ...
    if (u.length !== 2 || oe.bookIdToNumber(r[0]) === 0 || !Number.isInteger(o) || o < 0 || !K.isVerseParseable(u[1]))
      throw new yt("Invalid reference : " + e);
  ...
  updateInternal(e, r, u) {
    this.bookNum = oe.bookIdToNumber(e), this.chapter = r, this.verse = u;
  }
};
...
let Lr = ve, yt = class extends Error {
};
var J = {}, le = {}, tr;
function Dt() {
  if (tr) return le;
...
function kr() {
  ...
  var C = r(v), N = o("[", C, r(/[-.0-9\xB7]/), r(/[\u0300-\u036F\u203F-\u2040]/), "]"), y = o(v, N, "*"), q = o(N, "+"), B = o("&", y, ";"), F = a(/&#[0-9]+;|&#x[0-9a-fA-F]+;/), U = a(B, "|", F), ne = o("%", y, ";"), he = a(
    o('"', a(/[^%&"]/, "|", ne, "|", U), "*", '"'),
    "|",
    o("'", a(/[^%&']/, "|", ne, "|", U), "*", "'")
  ), g = a('"', a(/[^<&"]/, "|", U), "*", '"', "|", "'", a(/[^<&']/, "|", U), "*", "'"), x = u(v, ":"), k = u(N, ":"), G = o(x, k, "*"), W = o(G, a(":", G), "?"), ee = o("^", W, "$"), Ie = o("(", W, ")"), te = a(/"[^"]*"|'[^']*'/), Be = o(/^<\?/, "(", y, ")", a(m, "(", h, "*?)"), "?", /\?>/), E = /[\x20\x0D\x0Aa-zA-Z0-9-'()+,./:=?;!*#@$_%]/, b = a('"', E, '*"', "|", "'", u(E, "'"), "*'"), S = "<!--", T = "-->", M = o(S, a(u(h, "-"), "|", o("-", u(h, "-"))), "*", T), A = "#PCDATA", R = a(
    o(/\(/, l, A, a(l, /\|/, l, W), "*", l, /\)\*/),
    "|",
    o(/\(/, l, A, l, /\)/)
  ), X = /[?*+]?/, _ = o(
  ...
  ), w = a("EMPTY", "|", "ANY", "|", R, "|", _), I = "<!ELEMENT", L = o(I, m, a(W, "|", ne), m, a(w, "|", ne), l, ">"), V = o("NOTATION", m, /\(/, l, y, a(l, /\|/, l, y), "*", l, /\)/), pe = o(/\(/, l, q, a(l, /\|/, l, q), "*", l, /\)/), we = a(V, "|", pe), Ae = a(/CDATA|ID|IDREF|IDREFS|ENTITY|ENTITIES|NMTOKEN|NMTOKENS/, "|", we), ae = a(/#REQUIRED|#IMPLIED/, "|", a(a("#FIXED", m), "?", g)), P = a(m, y, m, Ae, m, ae), Ue = "<!ATTLIST", Re = o(Ue, m, y, P, "*", l, ">"), de = "about:legacy-compat", Ve = a('"' + de + '"', "|", "'" + de + "'"), _e = "SYSTEM", Se = "PUBLIC", ke = a(a(_e, m, te), "|", a(Se, m, b, m, te)), ze = o(
    "^",
    a(
...
function Fr() {
  ...
  var k = {}, G = k.ELEMENT_NODE = 1, W = k.ATTRIBUTE_NODE = 2, ee = k.TEXT_NODE = 3, Ie = k.CDATA_SECTION_NODE = 4, te = k.ENTITY_REFERENCE_NODE = 5, Be = k.ENTITY_NODE = 6, E = k.PROCESSING_INSTRUCTION_NODE = 7, b = k.COMMENT_NODE = 8, S = k.DOCUMENT_NODE = 9, T = k.DOCUMENT_TYPE_NODE = 10, M = k.DOCUMENT_FRAGMENT_NODE = 11, A = k.NOTATION_NODE = 12, R = t.freeze({
  ...
  g(k, P), g(k, P.prototype), g(R, P), g(R, P.prototype);
  function Re(n, i) {
    if (i(n))
      return !0;
    if (n = n.firstChild)
  ...
  Ne.prototype.nodeType = W, x(Ne, P);
  function be(n) {
    N(n);
  }
  be.prototype = {
  ...
  return re._updateLiveList = L, re.Attr = Ne, re.CDATASection = ct, re.CharacterData = be, re.Comment = st, re.Document = de, re.DocumentFragment = Qe, re.DocumentType = lt, re.DOMImplementation = ae, re.Element = Z, re.Entity = Nt, re.EntityReference = ft, re.LiveNodeList = I, re.NamedNodeMap = V, re.Node = P, re.NodeList = w, re.Notation = At, re.Text = We, re.ProcessingInstruction = ht, re.XMLSerializer = Ot, re;
}
var rt = {}, qt = {}, ir;
function Nn() {
...
function bn() {
  ...
  F.prototype = {
    parse: function(E, b, S) {
      ...
      T.startDocument(), G(b, b = /* @__PURE__ */ Object.create(null)), ne(E, b, S, T, this.errorHandler), T.endDocument();
    }
  };
  var U = /&#?\w+;?/g;
  function ne(E, b, S, T, M) {
    var A = o(T.mimeType);
    ...
    for (var we = [{ currentNSMap: b }], Ae = [], ae = 0; ; ) {
      try {
        ...
        switch (E.charAt(P + 1)) {
          ...
          // end element
          case "?":
            V && pe(P), se = te(E, P, T, M);
            break;
          case "!":
            V && pe(P), se = Ie(E, P, T, M, A);
            break;
          default:
            V && pe(P);
            var Q = new Be(), Ge = we[we.length - 1].currentNSMap, se = g(E, P, Q, Ge, X, M, A), Xe = Q.length;
  ...
  function g(E, b, S, T, M, A, R) {
    ...
    for (var _, w, I = ++b, L = m; ; ) {
      ...
      switch (V) {
        ...
        case '"':
          if (L === C || L === l)
            if (L === l && (A.warning('attribute value must after "="'), _ = E.slice(b, I)), b = I + 1, I = E.indexOf(V, b), I > 0)
              w = E.slice(b, I), X(_, w, b - 1), L = y;
            else
              throw new Error("attribute value no end '" + V + "' match");
          else if (L == N)
            w = E.slice(b, I), X(_, w, b), A.warning('attribute "' + _ + '" missed start quot(' + V + ")!!"), b = I + 1, L = y;
          else
        ...
        case "/":
          ...
          break;
        case "":
          return A.error("unexpected end of input"), L == m && S.setTagName(E.slice(b, I)), I;
        case ">":
          switch (L) {
            case m:
              S.setTagName(E.slice(b, I));
            ...
            case v:
              L === v && (w = _), L == N ? (A.warning('attribute "' + w + '" missed quot(")!'), X(_, w, b)) : (R || A.warning('attribute "' + w + '" missed value!! "' + w + '" instead!!'), X(w, w, b));
              break;
            case C:
              if (!R)
        ...
        default:
          if (V <= " ")
            ...
            switch (L) {
              ...
              case v:
                R || A.warning('attribute "' + _ + '" missed value!! "' + _ + '" instead2!!'), X(_, _, b), b = I, L = l;
                break;
              case y:
  ...
  function x(E, b, S) {
    for (var T = E.tagName, M = null, L = E.length; L--; ) {
      var A = E[L], R = A.qName, X = A.value, V = R.indexOf(":");
      if (V > 0)
    ...
    for (var L = E.length; L--; )
      A = E[L], A.prefix && (A.prefix === "xml" && (A.uri = h.XML), A.prefix !== "xmlns" && (A.uri = S[A.prefix]));
    var V = T.indexOf(":");
...
`);
  ...
  N.prototype.parseFromString = function(g, x) {
    ...
    return Be && typeof g != "string" && te.errorHandler.fatalError("source is not a string"), te.parse(this.normalizeLineEndings(String(g)), k, G), ee.doc.documentElement || te.errorHandler.fatalError("missing root element"), ee.doc;
  };
  function y(g) {
    var x = g || {};
  ...
  y.prototype = {
    ...
    startElement: function(g, x, k, G) {
      var W = this.doc, ee = W.createElementNS(g, k || x), Ie = G.length;
      U(this, ee), this.currentElement = ee, this.locator && q(this.locator, ee);
      for (var te = 0; te < Ie; te++) {
        var g = G.getURI(te), Be = G.getValue(te), k = G.getQName(te), E = W.createAttributeNS(g, k);
        this.locator && q(G.getLocator(te), E), E.value = E.nodeValue = Be, ee.setAttributeNode(E);
      }
    },
    ...
    startDTD: function(g, x, k, G) {
      ...
      if (W && W.createDocumentType) {
        var ee = W.createDocumentType(g, x, k, G);
...
@#[line:` + g.lineNumber + ",col:" + g.columnNumber + "]";
  ...
  return rt.__DOMHandler = y, rt.DOMParser = N, rt.normalizeLineEndings = C, rt.onErrorStopParsing = ne, rt.onWarningStopParsing = he, rt;
}
var sr;
function Cn() {
  if (sr) return J;
...
function Tn() {
  return cr || (cr = 1, $t = () => {
    const t = "\\ud800-\\udfff", p = "\\u0300-\\u036f" + "\\ufe20-\\ufe2f" + "\\u20d0-\\u20ff" + "\\u1ab0-\\u1aff" + "\\u1dc0-\\u1dff", h = "\\ufe0e\\ufe0f", f = "\\uD83D\\uDC69\\uD83C\\uDFFB\\u200D\\uD83C\\uDF93", d = `[${t}]`, m = `[${p}]`, l = "\\ud83c[\\udffb-\\udfff]", v = `(?:${m}|${l})`, C = `[^${t}]`, N = "(?:\\uD83C[\\uDDE6-\\uDDFF]){2}", y = "[\\ud800-\\udbff][\\udc00-\\udfff]", q = "\\u200d", B = "(?:\\ud83c\\udff4\\udb40\\udc67\\udb40\\udc62\\udb40(?:\\udc65|\\udc73|\\udc77)\\udb40(?:\\udc6e|\\udc63|\\udc6c)\\udb40(?:\\udc67|\\udc74|\\udc73)\\udb40\\udc7f)", F = `[${f}]`, U = `${v}?`, ne = `[${h}]?`, he = `(?:${q}(?:${[C, N, y].join("|")})${ne + U})*`, g = ne + U + he, k = `(?:${[`${C}${m}?`, m, N, y, d, F].join("|")})`;
...
const Ut = ["chapter", "book", "para", "row", "sidebar", jt], _n = "​", jr = [
...
], Pn = 1, Ln = jr.length - 1, kn = 1, Fn = 1, vi = {
  book: "GEN",
  chapterNum: 1,
  verseNum: 1
}, qn = (t) => {
  ...
  book: oe.bookNumberToId(
    Math.max(
      Pn,
      Math.min(oe.bookIdToNumber(t.book) + e, Ln)
    )
  ),
  chapterNum: 1,
  verseNum: 1
...
function Ci(t) {
  return new Lr(oe.bookIdToNumber(t.book), t.chapterNum, t.verseNum).BBBCCC;
}
function dr(t) {
  return new Lr(oe.bookIdToNumber(t.book), t.chapterNum, t.verseNum).BBBCCCVVV;
}
function Ti(t, e) {
  return dr(t) - dr(e);
}
...
function Si(t, e, r, u) {
  ...
  switch (e ?? "id") {
    case "English":
      o = oe.bookIdToEnglishName(t.book);
      break;
    case "id":
      o = t.book;
      break;
...
const Oi = (t) => {
  if (oe.isBookOT(t)) return "OT";
  if (oe.isBookNT(t)) return "NT";
  if (oe.isBookDC(t)) return "DC";
  if (oe.isExtraMaterial(t)) return "Extra";
...
function Bi(t, e, r) {
  ...
  if (!u) return !1;
  const o = oe.bookIdToEnglishName(t), a = r == null ? void 0 : r.get(t), p = o.toLowerCase().includes(u) || t.toLowerCase().includes(u), h = a ? a.localizedName.toLowerCase().includes(u) || a.localizedId.toLowerCase().includes(u) : !1;
  return p || h;
}
const Un = (
  // Using unicode control characters to be very explicit about which characters we are using.
...
function Er(t) {
  ...
  for (let o = 0; o < t.length; o += 1) {
    const a = t[o];
    a.charCodeAt(0) < 32 ? (r || (e += " "), r = !0) : !r && a === _n && o + 1 < t.length && mr(t[o + 1]) || (mr(a) ? (r || (e += a), r = !0) : Gn(a) && u === a || (e += a, r = !1)), u = a;
  }
  return e;
}
function gr(t) {
...
const _i = (t) => (...e) => t.map((u) => u(...e)).every((u) => u), Pi = (t) => async (...e) => {
  const r = t.map(async (u) => u(...e));
  return (await Promise.all(r)).every((u) => u);
}, Mt = "chapter", Bt = "verse";
var Hn = Object.getOwnPropertyNames, zn = Object.getOwnPropertySymbols, Jn = Object.prototype.hasOwnProperty;
function vr(t, e) {
...
var Yn = "__v", Kn = "__o", Wn = "_owner", Nr = Object.getOwnPropertyDescriptor, br = Object.keys;
function Qn(t, e, r) {
  var u = t.length;
  if (e.length !== u)
    return !1;
...
function Nu(t) {
  ...
  return function(N, y, q) {
    ...
    if (F === Set)
      return m(N, y, q);
    var U = Au(N);
    return U === lu ? r(N, y, q) : U === mu ? d(N, y, q) : U === hu ? a(N, y, q) : U === Eu ? m(N, y, q) : U === du ? typeof N.then != "function" && typeof y.then != "function" && h(N, y, q) : U === Du ? v(N, y, q) : U === fu ? u(N, y, q) : U === su ? h(N, y, q) : U === cu || U === pu || U === gu ? f(N, y, q) : !1;
  };
}
function bu(t) {
  var e = t.circular, r = t.createCustomConfig, u = t.strict, o = {
    areArraysEqual: u ? Tt : Qn,
    areDatesEqual: Zn,
    areErrorsEqual: eu,
    areFunctionsEqual: tu,
    areMapsEqual: u ? vr(yr, Tt) : yr,
    areNumbersEqual: ru,
    areObjectsEqual: u ? Tt : nu,
    arePrimitiveWrappersEqual: uu,
    areRegExpsEqual: iu,
    areSetsEqual: u ? vr(Cr, Tt) : Cr,
    areTypedArraysEqual: u ? Tt : ou,
    areUrlsEqual: au
  };
  if (r && (o = wr({}, o, r(o))), e) {
...
function He(t) {
  t === void 0 && (t = {});
  var e = t.circular, r = e === void 0 ? !1 : e, u = t.createInternalComparator, o = t.createState, a = t.strict, p = a === void 0 ? !1 : a, h = bu(t), f = Nu(h), d = u ? u(f) : yu(f);
  return Cu({ circular: r, comparator: f, createState: o, equals: d, strict: p });
}
function wu(t, e) {
  return Tu(t, e);
}
function Su(t, e) {
  ...
  return Object.keys(r).forEach((a) => {
    o && (Object.hasOwn(u, a) && Su(u[a], r[a]) || (o = !1));
  }), o;
}
function Sr(t, e, r) {
...
const ki = (t) => t.replace(/&/g, "&amp;").replace(/</g, "&lt;").replace(/>/g, "&gt;").replace(/"/g, "&quot;").replace(/'/g, "&#x27;").replace(/\//g, "&#x2F;");
function Fi() {
...
const Iu = 1e3, Gr = 60, Hr = Gr * 60, xu = Hr * 24;
function $i(t, e, r = /* @__PURE__ */ new Date()) {
  const u = Math.floor((e.getTime() - r.getTime()) / Iu), o = Math.round(u / xu);
...
function Vi(t, e, r) {
  ...
  return o.id = `${Lu}${r ? `-${r}` : ""}`, o.dataset.themeId = t.id, o.textContent = Fu(t), this.document.head.appendChild(o), o;
}
...
class ie {
  ...
  verseRefToUsjContentLocation(e, r = 0) {
    ...
    const h = e.verse ?? e.verseNum.toString(), f = this.findNextMatchingNode(
      o,
      je,
      (v, C) => v === o ? e.verseNum === 0 ? (p = ie.convertWorkingStackToJsonPath(C), !0) : !1 : typeof v != "object" ? !1 : v.type === Mt ? (a = !0, !0) : v.type === Bt && v.number !== void 0 && v.number === h ? (p = ie.convertWorkingStackToJsonPath(C), !0) : !1
    );
...
export {
  ...
  ni as UnsubscriberAsyncList,
  ie as UsjReaderWriter,
  Bt as VERSE_TYPE,
  Pi as aggregateUnsubscriberAsyncs,
  _i as aggregateUnsubscribers,
  Vi as applyThemeStylesheet,
  Ri as areUsjContentsEqualExceptWhitespace,
  xt as at,
  Et as charAt,
  si as codePointAt,
  Ti as compareScrRefs,
  ...
  vi as defaultScrRef,
  Ou as deserialize,
  Bi as doesBookMatchQuery,
  Sn as endsWith,
  qr as ensureArray,
  mi as escapeStringRegexp,
  Ui as expandThemeContribution,
  qi as formatBytes,
  ci as formatReplacementString,
  In as formatReplacementStringToArray,
  Si as formatScrRef,
  $i as formatTimeSpan,
  Xu as getAllObjectFunctionNames,
  qn as getChaptersForBook,
  Fi as getCurrentLocale,
  Or as getErrorMessage,
  $n as getLocalizeKeyForScrollGroupId,
  wi as getLocalizeKeysForScrollGroupIds,
  yi as getLocalizedIdFromBookNumber,
  Ii as getLocalizedSectionNames,
  Oi as getSectionForBook,
  xi as getSectionLongName,
  Mi as getSectionShortName,
  ...
  Gu as newGuid,
  ui as newPlatformError,
  li as normalize,
  Er as normalizeScriptureSpaces,
  Ai as offsetBook,
  Ni as offsetChapter,
  bi as offsetVerse,
  fi as ordinalCompare,
  hi as padEnd,
  pi as padStart,
  ...
  Ei as transformAndEnsureRegExpRegExpArray,
  tn as wait,
