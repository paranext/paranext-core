...
import { length as st, indexOf as it, limit as Ce, substring as ot, toArray as at, substr as ct } from "stringz";
...
class yn {
  ...
  cleanupPromiseChain(e) {
    ...
    if (!t) return;
    const n = { promise: vt }, i = t.catch((s) => this.logger.warn(`Error in promise for ${e}: ${s.message}`)).finally(() => {
...
var Nt = Object.defineProperty, kt = (r, e, t) => e in r ? Nt(r, e, { enumerable: !0, configurable: !0, writable: !0, value: t }) : r[e] = t, v = (r, e, t) => kt(r, typeof e != "symbol" ? e + "" : e, t);
const B = [
  "GEN",
  "EXO",
  "LEV",
...
function wt(r) {
  const e = typeof r == "string" ? R(r) : r;
  return e >= 40 && e <= 66;
}
function Et(r) {
  return (typeof r == "string" ? R(r) : r) <= 39;
}
function Ue(r) {
  return r <= 66;
}
...
function* xt() {
  for (let r = 1; r <= B.length; r++) yield r;
}
const St = 1, De = B.length;
function At() {
  return ["XXA", "XXB", "XXC", "XXD", "XXE", "XXF", "XXG"];
}
function se(r, e = "***") {
  const t = r - 1;
  return t < 0 || t >= B.length ? e : B[t];
}
function Ve(r) {
  return r <= 0 || r > De ? "******" : Be[r - 1];
}
function Mt(r) {
  return Ve(R(r));
}
function Le(r) {
  const e = typeof r == "number" ? se(r) : r;
...
function Pt(r) {
  return Be[r - 1].includes("*obsolete*");
}
function Ot() {
  const r = {};
...
var Re = /* @__PURE__ */ ((r) => (r[r.Valid = 0] = "Valid", r[r.UnknownVersification = 1] = "UnknownVersification", r[r.OutOfRange = 2] = "OutOfRange", r[r.VerseOutOfOrder = 3] = "VerseOutOfOrder", r[r.VerseRepeated = 4] = "VerseRepeated", r))(Re || {});
const A = class N {
  constructor(e, t, n, i) {
    if (v(this, "firstChapter"), v(this, "lastChapter"), v(this, "lastVerse"), v(this, "hasSegmentsDefined"), v(this, "text"), v(this, "BBBCCCVVVS"), v(this, "longHashCode"), v(this, "versification"), v(this, "rtlMark", "‏"), v(this, "_bookNum", 0), v(this, "_chapterNum", 0), v(this, "_verseNum", 0), v(this, "_verse"), n == null && i == null)
      if (e != null && typeof e == "string") {
        ...
        this.setEmpty(s), this._verseNum = e % N.chapterDigitShifter, this._chapterNum = Math.floor(
        ...
        if (e != null && e instanceof N) {
          ...
          if (e == null) return;
          const s = e instanceof $ ? e : N.defaultVersification;
          this.setEmpty(s);
        }
      else
      ...
      if (typeof e == "string" && typeof t == "string" && typeof n == "string")
        ...
        this._bookNum = e, this._chapterNum = t, this._verseNum = n, this.versification = i ?? N.defaultVersification;
      else
        throw new Error("VerseRef constructor not supported.");
    else
      throw new Error("VerseRef constructor not supported.");
  ...
  static tryParse(e) {
    let t;
    try {
      return t = new N(e), { success: !0, verseRef: t };
    } catch (n) {
      if (n instanceof F)
  ...
  static getBBBCCCVVV(e, t, n) {
    return e % N.bcvMaxValue * N.bookDigitShifter + (t >= 0 ? t % N.bcvMaxValue * N.chapterDigitShifter : 0) + (n >= 0 ? n % N.bcvMaxValue : 0);
  }
  /**
  ...
  static fromJSON(e) {
    ...
    let c;
    return o && (c = new $(o)), t ? new N(t, n.toString(), a, c) : new N();
  }
  /**
  ...
  set verse(e) {
    const { success: t, vNum: n } = N.tryGetVerseNum(e);
    this._verse = t ? void 0 : e.replace(this.rtlMark, ""), this._verseNum = n, !(this._verseNum >= 0) && ({ vNum: this._verseNum } = N.tryGetVerseNum(this._verse));
  }
  /**
  ...
  parse(e) {
    ...
    if (n.length !== 2 || E.bookIdToNumber(t[0]) === 0 || !Number.isInteger(i) || i < 0 || !N.isVerseParseable(n[1]))
      throw new F("Invalid reference : " + e);
   ...
   */
  equals(e) {
    return e instanceof N ? e._bookNum === this._bookNum && e._chapterNum === this._chapterNum && e._verseNum === this._verseNum && e.verse === this.verse && (e.versification == null && this.versification == null || e.versification != null && this.versification != null && e.versification.equals(this.versification)) : !1;
  }
  /**
   ...
   */
  allVerses(e = !1, t = N.verseRangeSeparators, n = N.verseSequenceIndicators) {
  ...
  updateInternal(e, t, n) {
    this.bookNum = E.bookIdToNumber(e), this.chapter = t, this.verse = n;
  }
};
...
function L(r, e) {
  return e < 0 || e > I(r) - 1 ? "" : Y(r, e, 1);
}
function En(r, e) {
  if (!(e < 0 || e > I(r) - 1))
    return Y(r, e, 1).codePointAt(0);
}
function Ct(r, e, t = I(r)) {
  const n = Ut(r, e);
  return !(n === -1 || n + I(e) !== t);
}
function $t(r, e, t) {
  if (e < 0) return -1;
  if (t) {
    if (L(r, e) === "}" && L(r, e - 1) === "\\") return e;
    const s = X(r, "\\}", e);
    return s >= 0 ? s + 1 : s;
  }
  let n = e;
  const i = I(r);
  for (; n < i && (n = X(r, "}", n), !(n === -1 || L(r, n - 1) !== "\\")); )
    n += 1;
  return n >= i ? -1 : n;
}
function jt(r, e) {
  ...
  let n = 0, i = 0;
  function s(a, c, l) {
    const u = j(r, i, c), h = t.length > 0 && w(t[t.length - 1]) ? `${t.pop()}${u}` : u;
    w(a) ? t.push(`${h}${a}`) : (h && t.push(h), t.push(a)), i = c + l;
  }
  const o = I(r);
  for (; n < o; ) {
    switch (L(r, n)) {
...
function Ut(r, e, t) {
  let n = t === void 0 ? I(r) : t;
  n < 0 ? n = 0 : n >= I(r) && (n = I(r) - 1);
  for (let i = n; i >= 0; i--)
    if (Y(r, i, I(e)) === e)
      return i;
  return -1;
...
function An(r, e, t = " ") {
  return e <= I(r) ? r : Ce(r, e, t, "right");
}
function Mn(r, e, t = " ") {
  return e <= I(r) ? r : Ce(r, e, t, "left");
}
function pe(r, e) {
...
function de(r, e, t) {
  ...
  let i = e;
  (typeof e == "string" || e instanceof RegExp && !Bt(e.flags, "g")) && (i = new RegExp(e, "g"));
  const s = r.match(i);
  let o = 0;
  if (!s) return [r];
  for (let a = 0; a < (t ? t - 1 : s.length); a++) {
    const c = X(r, s[a], o), l = I(s[a]);
...
function Y(r, e = 0, t = I(r) - e) {
  return ct(r, e, t);
}
function j(r, e, t = I(r)) {
  return ot(r, e, t);
}
function Dt(r) {
  return at(r);
...
function jn(r, e) {
  ...
  if (t.length <= e * 2 || e < 1)
    return r;
  const n = t.slice(0, e), i = t.slice(-e);
  return [...n, "[...]", ...i].join(" ");
}
const Q = ["chapter", "book", "para", "row", "sidebar", Oe], Lt = "​", ze = [
...
], Rt = 1, qt = ze.length - 1, Ft = 1, Jt = 1, Bn = {
  book: "GEN",
  chapterNum: 1,
  verseNum: 1
}, zt = (r) => {
  ...
  book: E.bookNumberToId(
    Math.max(
      Rt,
      Math.min(E.bookIdToNumber(r.book) + e, qt)
    )
  ),
  chapterNum: 1,
  verseNum: 1
...
function Rn(r) {
  return new qe(E.bookIdToNumber(r.book), r.chapterNum, r.verseNum).BBBCCC;
}
function me(r) {
  return new qe(E.bookIdToNumber(r.book), r.chapterNum, r.verseNum).BBBCCCVVV;
}
function Kt(r, e) {
  return me(r) - me(e);
}
...
function Ke(r, e) {
  switch (e) {
    case "English":
      return E.bookIdToEnglishName(r.book);
    case "id":
    case void 0:
      return r.book;
    default:
...
function Xt(r, e) {
  const t = Ke(r, e == null ? void 0 : e.optionOrLocalizedBookName), n = (e == null ? void 0 : e.bookChapterSeparator) ?? " ", i = (e == null ? void 0 : e.chapterVerseSeparator) ?? ":";
  return `${t}${n}${r.chapterNum}${i}${r.verseNum}`;
}
function Fn(r, e, t, n) {
  return Xt(r, {
...
function Jn(r, e, t) {
  ...
  const i = r.book === e.book && !(t != null && t.repeatBookName) ? "" : (t == null ? void 0 : t.endRefOptionOrLocalizedBookName) ?? (t == null ? void 0 : t.optionOrLocalizedBookName), s = ge(e, {
    ...t,
    optionOrLocalizedBookName: i
  });
  return `${n}${(t == null ? void 0 : t.rangeSeparator) ?? " - "}${s}`;
}
var Ht = /* @__PURE__ */ ((r) => (r.OT = "OT", r.NT = "NT", r.DC = "DC", r.Extra = "Extra", r))(Ht || {});
const zn = (r) => {
  if (E.isBookOT(r)) return "OT";
  if (E.isBookNT(r)) return "NT";
  if (E.isBookDC(r)) return "DC";
  if (E.isExtraMaterial(r)) return "Extra";
...
function be(r) {
  ...
  for (let i = 0; i < r.length; i += 1) {
    const s = r[i];
    s.charCodeAt(0) < 32 ? (t || (e += " "), t = !0) : !t && s === Lt && i + 1 < r.length && ye(r[i + 1]) || (ye(s) ? (t || (e += s), t = !0) : Zt(s) && n === s || (e += s, t = !1)), n = s;
  }
  return e;
}
function ve(r) {
...
function Ge(r, e, t, n) {
  ...
  if (i && s) {
    const o = be(r), a = be(t);
    if (o !== a) {
      if (!V(H(o, -1) ?? "") && !V(H(a, -1) ?? "") || !Ne(r, e) || !Ne(t, n)) return !1;
      let c = o;
...
var rr = Object.getOwnPropertyNames, nr = Object.getOwnPropertySymbols, sr = Object.prototype.hasOwnProperty;
function we(r, e) {
...
var or = "__v", ar = "__o", cr = "_owner", Ie = Object.getOwnPropertyDescriptor, xe = Object.keys;
function lr(r, e, t) {
  var n = r.length;
  if (e.length !== n)
    return !1;
...
function J(r, e, t) {
  var n = Ee(r), i = n.length;
  if (Ee(e).length !== i)
    return !1;
  for (var s, o, a; i-- > 0; )
    if (s = n[i], !_e(r, e, t, s) || (o = Ie(r, s), a = Ie(e, s), (o || a) && (!o || !a || o.configurable !== a.configurable || o.enumerable !== a.enumerable || o.writable !== a.writable)))
      return !1;
  return !0;
}
function mr(r, e) {
  return U(r.valueOf(), e.valueOf());
}
function gr(r, e) {
...
function _e(r, e, t, n) {
  return (n === cr || n === ar || n === or) && (r.$$typeof || e.$$typeof) ? !0 : ir(e, n) && t.equals(r[n], e[n], n, n, r, e, t);
}
var vr = "[object Arguments]", Nr = "[object Boolean]", kr = "[object Date]", wr = "[object Error]", Er = "[object Map]", Ir = "[object Number]", xr = "[object Object]", Sr = "[object RegExp]", Ar = "[object Set]", Mr = "[object String]", Tr = "[object URL]", Pr = Array.isArray, Me = typeof ArrayBuffer == "function" && ArrayBuffer.isView ? ArrayBuffer.isView : null, Te = Object.assign, Or = Object.prototype.toString.call.bind(Object.prototype.toString);
function Cr(r) {
  ...
  return function(f, m, b) {
    ...
    if (x !== typeof m)
      return !1;
    if (x !== "object")
      return x === "number" ? o(f, m, b) : x === "function" ? i(f, m, b) : !1;
    var k = f.constructor;
    if (k !== m.constructor)
      return !1;
    if (k === Object)
    ...
    if (k === Set)
      return u(f, m, b);
    var S = Or(f);
    return S === kr ? t(f, m, b) : S === Sr ? l(f, m, b) : S === Er ? s(f, m, b) : S === Ar ? u(f, m, b) : S === xr ? typeof f.then != "function" && typeof m.then != "function" && a(f, m, b) : S === Tr ? p(f, m, b) : S === wr ? n(f, m, b) : S === vr ? a(f, m, b) : S === Nr || S === Ir || S === Mr ? c(f, m, b) : !1;
  };
}
function $r(r) {
  ...
  if (t && (i = Te({}, i, t(i))), e) {
    var s = W(i.areArraysEqual), o = W(i.areMapsEqual), a = W(i.areObjectsEqual), c = W(i.areSetsEqual);
    i = Te({}, i, {
      areArraysEqual: s,
      areMapsEqual: o,
      areObjectsEqual: a,
...
function C(r) {
  r === void 0 && (r = {});
  var e = r.circular, t = e === void 0 ? !1 : e, n = r.createInternalComparator, i = r.createState, s = r.strict, o = s === void 0 ? !1 : s, a = $r(r), c = Cr(a), l = n ? n(c) : jr(c);
  return Br({ circular: t, comparator: c, createState: i, equals: l, strict: o });
}
function ee(r, e) {
  return Ur(r, e);
}
function Dr(r, e) {
  ...
  return Object.keys(t).forEach((s) => {
    i && (Object.hasOwn(n, s) && Dr(n[s], t[s]) || (i = !1));
  }), i;
}
function Pe(r, e, t) {
...
const Lr = 1e3, He = 60, We = He * 60, Rr = We * 24;
function ts(r, e, t = /* @__PURE__ */ new Date()) {
  const n = Math.floor((e.getTime() - t.getTime()) / Lr), i = Math.round(n / Rr);
  if (Math.abs(i) >= 1) return r.format(i, "day");
  const s = Math.round(n / We);
...
function is(r, e, t) {
  ...
  return i.id = `${Gr}${t ? `-${t}` : ""}`, i.dataset.themeId = r.id, i.textContent = _r(r), this.document.head.appendChild(i), i;
}
function Qe(r) {
...
USJ: ${JSON.stringify(
  ...
  getEffectiveBookId(e) {
    const t = Object.keys(this.indicesInUsfmByVerseRef), n = t.length === 0 || t.length === 1 && t[0] === O, i = n ? O : e;
  ...
  getVerseRefForIndexInUsfm(e, t) {
    ...
    return c && g.isFragmentAMarker(c.fragment) && c.fragment.type === P && c.fragment.number && c.fragment.number !== `${s.verseNum}` && (s.verse = c.fragment.number), s;
  }
  ...
  findNextLocationOfMatchingText(e, t, n = 1e3) {
    ...
    if (g.findNextMatchingNodeUsingWorkingStack(
      ...
      (d, f) => {
        ...
        s += m.length, i = `${i}${m}`;
        const x = i.indexOf(t);
        return x < 0 ? (o += i.length, i.length > t.length && (i = i.substring(i.length - t.length)), o -= i.length, s > n) : (a = o + x, !0);
      }
    ), a < 0) return;
    s = 0;
    let u = 0, h = [];
  ...
  getInfoForMarker(e, t = "usfm") {
    ...
    const o = (s == null ? void 0 : s.type) ?? (w(e) ? "" : e.type);
    let a = n;
...
`);
    ...
    return i.push({ fragment: e, indexInUsfm: n.length }), n += a === "optbreak" ? "//" : `\\${h}`, a !== "optbreak" && (i.push({
      ...
      i.push({
        ...
        if (w(k.fragment) || "attributeKey" in k.fragment)
          throw new Error(
        ...
        if (g.isFragmentAMarker(k.fragment)) {
          i.push({
            ...k,
            fragment: {
        ...
        if ("isClosingMarker" in k.fragment) {
          const { isClosingMarker: S, ...D } = k.fragment, et = {
            ...D,
            forMarker: e,
  ...
  closingMarkerToUsfm(e, t) {
    ...
    if ((u.closed === "false" || s.isClosingMarkerOptional && !this.markersMap.shouldOptionalClosingMarkersBePresent && u.closed !== "true") && (h = !1), s.independentClosingMarkers && s.independentClosingMarkers.length > 0 && h) {
      ...
      let m = "";
      const b = [], { usfm: x, fragmentsInfo: k } = this.openingMarkerToUsfm(f, t), S = k.find((D) => g.isFragmentAMarker(D.fragment));
      if (!S)
        throw new Error(
...
`) && (s.length === 0 ? (a = a.map((p) => ({
 ...
 `);
  ...
  static areUsjDocumentLocationsEqual(e, t, n = !1) {
    ...
    return !n && !ee(q.toPathArray(i), q.toPathArray(o)) ? !1 : ee(s, a);
  }
  ...
  static convertNodeToUsjDocumentLocation(e, t, n = 0) {
    ...
    return w(e) ? { jsonPath: i, offset: n } : { jsonPath: i };
  }
  /**
...
export {
  ...
  ss as expandThemeContribution,
  es as formatBytes,
  rs as formatRelativeDate,
  ...
  Ln as getLocalizedIdFromBookNumber,
  er as getNthCaller,
