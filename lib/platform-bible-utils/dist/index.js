...
function zu(t, e = 300) {
  let n, u, o, a;
  return (...p) => (clearTimeout(n), u || (u = new Promise((h, f) => {
    o = h, a = f;
  })), n = setTimeout(async () => {
    try {
      o(await t(...p));
...
function Gu(t, e, n) {
  ...
  return t.forEach((o) => {
    const a = e(o), p = u.get(a), h = n ? n(o, a) : o;
...
function Xu(t, e = {}) {
  return new Proxy(e, {
    get(n, u) {
      return u in n ? n[u] : async (...o) => (await t())[u](...o);
    }
  });
}
function Yu(t) {
...
function Ku(t) {
  const e = "401 Unauthorized error while getting shared projects.", n = "User registration is not valid. Cannot retrieve resources from DBL.", u = Me(t) ? t : Or(t);
  return u.includes(e) || u.includes(n);
}
class rn {
  /**
  ...
  deleteContribution(e) {
    ...
    try {
      ...
      throw this.contributions.set(e, n), new Error(`Error when deleting the document named ${e}: ${u}`);
    }
  }
  /**
...
class ei {
  ...
  addPromiseFunction(e, n) {
    ...
    this.map.set(e, u ? u.then(n) : n()), this.cleanupPromiseChain(e);
  }
  /**
  ...
  cleanupPromiseChain(e) {
    ...
    if (!n) return;
    const u = { promise: an }, o = n.catch((a) => this.logger.warn(`Error in promise for ${e}: ${a.message}`)).finally(() => {
...
class sn {
  ...
  findClosestLessThanOrEqual(e) {
    ...
    if (n === -1) return;
    const u = this.sortedKeys[n], o = this.map.get(u);
    if (o !== void 0)
      return { key: u, value: o };
  }
  binarySearchLessThanOrEqual(e) {
    let n = 0, u = this.sortedKeys.length - 1, o = -1;
    for (; n <= u; ) {
      const a = Math.floor((n + u) / 2);
      this.sortedKeys[a] <= e ? (o = a, n = a + 1) : u = a - 1;
    }
    return o;
  }
  binarySearchInsertIndex(e) {
    let n = 0, u = this.sortedKeys.length;
    for (; n < u; ) {
      const o = Math.floor((n + u) / 2);
      this.sortedKeys[o] < e ? n = o + 1 : u = o;
    }
    return n;
  }
}
class ti {
  ...
  async runAllUnsubscribers() {
    const e = [...this.unsubscribers].map((u) => u()), n = await Promise.all(e);
    return this.unsubscribers.clear(), n.every((u, o) => (u || console.error(`UnsubscriberAsyncList ${this.name}: Unsubscriber at index ${o} failed!`), u));
  }
}
const It = 1;
function ri(t) {
...
const De = class K {
  constructor(e, n, u, o) {
    ...
    else if (e != null && n != null && u != null)
      if (typeof e == "string" && typeof n == "string" && typeof u == "string")
        this.setEmpty(o), this.updateInternal(e, n, u);
      else if (typeof e == "number" && typeof n == "number" && typeof u == "number")
        this._bookNum = e, this._chapterNum = n, this._verseNum = u, this.versification = o ?? K.defaultVersification;
      else
        throw new Error("VerseRef constructor not supported.");
    else
      throw new Error("VerseRef constructor not supported.");
   ...
   * digits.
   */
  static getBBBCCCVVV(e, n, u) {
    return e % K.bcvMaxValue * K.bookDigitShifter + (n >= 0 ? n % K.bcvMaxValue * K.chapterDigitShifter : 0) + (u >= 0 ? u % K.bcvMaxValue : 0);
  }
  /**
   ...
   */
  static fromJSON(e) {
    const { book: n, chapterNum: u, verseNum: o, verse: a, versificationStr: p } = e, h = a || o.toString();
    let f;
    return p && (f = new nt(p)), n ? new K(n, u.toString(), h, f) : new K();
  }
  /**
  ...
  set verse(e) {
    const { success: n, vNum: u } = K.tryGetVerseNum(e);
    this._verse = n ? void 0 : e.replace(this.rtlMark, ""), this._verseNum = u, !(this._verseNum >= 0) && ({ vNum: this._verseNum } = K.tryGetVerseNum(this._verse));
  }
  /**
  ...
  parse(e) {
    ...
    if (n.length !== 2)
      throw new yt("Invalid reference : " + e);
    const u = n[1].split(":"), o = +u[0];
    if (u.length !== 2 || Ne.bookIdToNumber(n[0]) === 0 || !Number.isInteger(o) || o < 0 || !K.isVerseParseable(u[1]))
      throw new yt("Invalid reference : " + e);
    this.updateInternal(n[0], u[0], u[1]);
  }
  /**
   ...
   */
  allVerses(e = !1, n = K.verseRangeSeparators, u = K.verseSequenceIndicators) {
  ...
  updateInternal(e, n, u) {
    this.bookNum = Ne.bookIdToNumber(e), this.chapter = n, this.verse = u;
  }
};
...
function Dt() {
  ...
  return se.assign = u, se.find = t, se.freeze = e, se.HTML_BOOLEAN_ATTRIBUTES = o, se.HTML_RAW_TEXT_ELEMENTS = f, se.HTML_VOID_ELEMENTS = p, se.hasDefaultHTMLNamespace = v, se.hasOwn = n, se.isHTMLBooleanAttribute = a, se.isHTMLRawTextElement = d, se.isHTMLEscapableRawTextElement = m, se.isHTMLMimeType = l, se.isHTMLVoidElement = h, se.isValidMimeType = y, se.MIME_TYPE = O, se.NAMESPACE = j, se;
}
var dt = {}, rr;
function _t() {
  if (rr) return dt;
  ...
  function p(v, O) {
    o(v) ? (this.name = u[v], this.message = O || "") : (this.message = v, this.name = a(O) ? O : n.Error), Error.captureStackTrace && Error.captureStackTrace(this, p);
  }
...
function kr() {
  ...
  var O = n(v), N = o("[", O, n(/[-.0-9\xB7]/), n(/[\u0300-\u036F\u203F-\u2040]/), "]"), y = o(v, N, "*"), j = o(N, "+"), R = o("&", y, ";"), F = a(/&#[0-9]+;|&#x[0-9a-fA-F]+;/), U = a(R, "|", F), ne = o("%", y, ";"), fe = a(
    ...
    "|",
    o("'", a(/[^%&']/, "|", ne, "|", U), "*", "'")
  ), E = a('"', a(/[^<&"]/, "|", U), "*", '"', "|", "'", a(/[^<&']/, "|", U), "*", "'"), x = u(v, ":"), k = u(N, ":"), z = o(x, k, "*"), W = o(z, a(":", z), "?"), ee = o("^", W, "$"), Ie = o("(", W, ")"), te = a(/"[^"]*"|'[^']*'/), Be = o(/^<\?/, "(", y, ")", a(m, "(", h, "*?)"), "?", /\?>/), g = /[\x20\x0D\x0Aa-zA-Z0-9-'()+,./:=?;!*#@$_%]/, b = a('"', g, '*"', "|", "'", u(g, "'"), "*'"), w = "<!--", C = "-->", M = o(w, a(u(h, "-"), "|", o("-", u(h, "-"))), "*", C), A = "#PCDATA", B = a(
    o(/\(/, l, A, a(l, /\|/, l, W), "*", l, /\)\*/),
    "|",
    o(/\(/, l, A, l, /\)/)
  ), J = /[?*+]?/, _ = o(
...
function Fr() {
  ...
  function fe(r, i) {
    ...
    if ((s === "xmlns" || i === "xmlns") && r !== t.NAMESPACE.XMLNS)
      throw new l(
        l.NAMESPACE_ERR,
        'either qualifiedName or prefix is "xmlns" and namespace is not the XMLNS namespace'
      );
    if (r === t.NAMESPACE.XMLNS && s !== "xmlns" && i !== "xmlns")
      throw new l(
        l.NAMESPACE_ERR,
  ...
  function x(r, i) {
    ...
    if (!(s instanceof i)) {
      ...
      c.prototype = i.prototype, c = new c(), E(s, c), r.prototype = s = c;
    }
  ...
  function J(r, i) {
    if (i.length < r.length) return J(i, r);
    var s = null;
    for (var c in r) {
      if (r[c] !== i[c]) return s;
      s = r[c];
  ...
  function we(r, i, s, c) {
    if (c ? i[he(i, c)] = s : (i[i.length] = s, i.length++), r) {
      s.ownerElement = r;
  ...
  V.prototype = {
    ...
    removeNamedItemNS: function(r, i) {
      var s = this.getNamedItemNS(r, i);
      if (!s)
        throw new l(l.NOT_FOUND_ERR, r ? r + " : " + i : i);
    ...
    getNamedItemNS: function(r, i) {
      ...
      for (var s = 0; s < this.length; ) {
        var c = this[s];
        if (c.localName === i && c.namespaceURI === r)
          return c;
        s++;
      }
      return null;
  ...
  ie.prototype = {
     ...
     */
    createDocument: function(r, i, s) {
      var c = h.XML_APPLICATION;
      r === f.HTML ? c = h.XML_XHTML_APPLICATION : r === f.SVG && (c = h.XML_SVG_IMAGE);
      var D = new pe(d, { contentType: c });
      if (D.implementation = this, D.childNodes = new T(), D.doctype = s || null, s && D.appendChild(s), i) {
        var S = D.createElementNS(r, i);
        D.appendChild(S);
      }
      return D;
    },
     ...
     * @prettierignore
     */
    createDocumentType: function(r, i, s, c) {
      ne(r);
      var D = new lt(d);
      return D.name = r, D.nodeName = r, D.publicId = i || "", D.systemId = s || "", D.internalSubset = c || "", D.childNodes = new T(), D;
    },
    /**
    ...
    createHTMLDocument: function(r) {
      ...
      if (i.implementation = this, i.childNodes = new T(), r !== !1) {
        ...
        if (s.appendChild(c), typeof r == "string") {
          ...
          D.appendChild(i.createTextNode(r)), c.appendChild(D);
        }
  ...
  P.prototype = {
    ...
    replaceChild: function(r, i) {
      q(this, r, i, Ke), i && this.removeChild(i);
    },
    /**
    ...
    compareDocumentPosition: function(r) {
      ...
      if (!i || !s || s.ownerDocument !== i.ownerDocument)
        return B.DOCUMENT_POSITION_DISCONNECTED + B.DOCUMENT_POSITION_IMPLEMENTATION_SPECIFIC + (_(s.ownerDocument) > _(i.ownerDocument) ? B.DOCUMENT_POSITION_FOLLOWING : B.DOCUMENT_POSITION_PRECEDING);
      if (D && i === s)
      ...
      for (var $e in Ze.childNodes) {
        ...
        if (Oe === i) return B.DOCUMENT_POSITION_PRECEDING;
  ...
  function ke(r, i) {
    ...
    return s ? s.nextSibling = c : r.firstChild = c, c ? c.previousSibling = s : r.lastChild = s, Se(r.ownerDocument, r), i.parentNode = null, i.previousSibling = null, i.nextSibling = null, i;
  }
  function He(r) {
  ...
  function vt(r, i, s) {
    ...
    if (
      ...
      ye(i) && r.nodeType !== P.DOCUMENT_NODE
    )
      throw new l(
  ...
  function Ye(r, i, s) {
    var c = r.childNodes || [], D = i.childNodes || [];
  ...
  function q(r, i, s, c) {
    vt(r, i, s), r.nodeType === P.DOCUMENT_NODE && (c || Ye)(r, i, s);
    var D = i.parentNode;
    ...
    return Se(r.ownerDocument || r, r, i), i.nodeType == M && (i.firstChild = i.lastChild = null), i;
  }
  pe.prototype = {
    /**
    ...
    insertBefore: function(r, i) {
      ...
      return q(this, r, i), r.ownerDocument = this, this.documentElement === null && r.nodeType === z && (this.documentElement = r), r;
    },
    removeChild: function(r) {
      var i = ke(this, r);
    ...
    replaceChild: function(r, i) {
      q(this, r, i, Ke), r.ownerDocument = this, i && this.removeChild(i), Q(r) && (this.documentElement = r);
    },
    ...
    createElement: function(r) {
      var i = new Z(d);
      i.ownerDocument = this, this.type === "html" && (r = r.toLowerCase()), n(this.contentType) && (i.namespaceURI = f.HTML), i.nodeName = r, i.tagName = r, i.localName = r, i.childNodes = new T();
    ...
    createProcessingInstruction: function(r, i) {
      var s = new ht(d);
      return s.ownerDocument = this, s.childNodes = new T(), s.nodeName = s.target = r, s.nodeValue = s.data = i, s;
    },
    /**
    ...
    createElementNS: function(r, i) {
      var s = fe(r, i), c = new Z(d), D = c.attributes = new V();
      return c.childNodes = new T(), c.ownerDocument = this, c.nodeName = i, c.tagName = i, c.namespaceURI = s[0], c.prefix = s[1], c.localName = s[2], D._ownerElement = c, c;
    },
    // Introduced in DOM Level 2:
    /**
     * @param {string} namespaceURI
    ...
    createAttributeNS: function(r, i) {
      var s = fe(r, i), c = new Ae(d);
      return c.ownerDocument = this, c.childNodes = new T(), c.nodeName = i, c.name = i, c.specified = !0, c.namespaceURI = s[0], c.prefix = s[1], c.localName = s[2], c;
    }
  }, x(pe, P);
  function Z(r) {
  ...
  Z.prototype = {
    ...
    setAttribute: function(r, i) {
      ...
      s ? s.value = s.nodeValue = "" + i : (s = this.ownerDocument._createAttribute(r), s.value = s.nodeValue = "" + i, this.setAttributeNode(s));
    },
    ...
    removeAttributeNS: function(r, i) {
      var s = this.getAttributeNodeNS(r, i);
     ...
     */
    setAttributeNS: function(r, i, s) {
      var c = fe(r, i), D = c[2], S = this.getAttributeNodeNS(r, D);
      S ? S.value = S.nodeValue = "" + s : (S = this.ownerDocument.createAttributeNS(r, i), S.value = S.nodeValue = "" + s, this.setAttributeNode(S));
    },
    ...
    getElementsByTagName: function(r) {
      var i = (this.nodeType === w ? this : this.ownerDocument).type === "html", s = r.toLowerCase();
        ...
        return Re(c, function(S) {
          if (!(S === c || S.nodeType !== z))
            if (r === "*")
              ...
              var Y = S.getQualifiedName(), ae = i && S.namespaceURI === f.HTML ? s : r;
              Y === ae && D.push(S);
            }
        }), D;
      });
    ...
    getElementsByTagNameNS: function(r, i) {
      return new I(this, function(s) {
        ...
        return Re(s, function(D) {
          D !== s && D.nodeType === z && (r === "*" || D.namespaceURI === r) && (i === "*" || D.localName == i) && c.push(D);
        }), c;
      });
    }
  ...
  be.prototype = {
    ...
    replaceData: function(r, i, s) {
      var c = this.data.substring(0, r), D = this.data.substring(r + i);
  ...
  We.prototype = {
    ...
    splitText: function(r) {
      var i = this.data, s = i.substring(r);
  ...
  Ot.prototype.serializeToString = function(r, i) {
    return ue.call(r, i);
  }, P.prototype.toString = ue;
  function ue(r) {
    var i = [], s = this.nodeType === w && this.documentElement || this, c = s.prefix, D = s.namespaceURI;
    if (D && c == null) {
  ...
  function qe(r, i, s, c) {
    ...
    switch (r.nodeType) {
      ...
      case M:
        ...
        return;
      case W:
        return Fe(i, r.name, r.value);
      case ee:
        return i.push(r.data.replace(/[<&>]/g, Ue));
      case Ie:
        return i.push(O.CDATA_START, r.data, O.CDATA_END);
      case b:
        return i.push(O.COMMENT_START, r.data, O.COMMENT_END);
      case C:
        var Yt = r.publicId, pt = r.systemId;
        i.push(O.DOCTYPE_DECL_START, " ", r.name), Yt ? (i.push(" ", O.PUBLIC, " ", Yt), pt && pt !== "." && i.push(" ", pt)) : pt && pt !== "." && i.push(" ", O.SYSTEM, " ", pt), r.internalSubset && i.push(" [", r.internalSubset, "]"), i.push(">");
        return;
      case g:
  ...
  function Jt(r, i, s) {
    ...
    switch (i.nodeType) {
      case z:
        c = i.cloneNode(!1), c.ownerDocument = r;
    ...
    if (c || (c = i.cloneNode(!1)), c.ownerDocument = r, c.parentNode = null, s)
  ...
  function kt(r, i, s) {
    ...
    switch (i.childNodes && (c.childNodes = new T()), c.ownerDocument = r, c.nodeType) {
      case z:
        ...
        switch (i.nodeType) {
          ...
          case M:
            ...
            for (i = i.firstChild; i; )
              i.nodeType !== 7 && i.nodeType !== 8 && s.push(r(i)), i = i.nextSibling;
            return s.join("");
          default:
            return i.nodeValue;
        }
...
function Nn() {
  if (or) return Ct;
  or = 1;
  var t = Dt(), e = kr(), n = _t(), u = t.isHTMLEscapableRawTextElement, o = t.isHTMLMimeType, a = t.isHTMLRawTextElement, p = t.hasOwn, h = t.NAMESPACE, f = n.ParseError, d = n.DOMException, m = 0, l = 1, v = 2, O = 3, N = 4, y = 5, j = 6, R = 7;
  function F() {
  }
  F.prototype = {
...
function yn() {
  if (ar) return rt;
  ar = 1;
  var t = Dt(), e = Fr(), n = _t(), u = bn(), o = Nn(), a = e.DOMImplementation, p = t.hasDefaultHTMLNamespace, h = t.isHTMLMimeType, f = t.isValidMimeType, d = t.MIME_TYPE, m = t.NAMESPACE, l = n.ParseError, v = o.XMLReader;
  function O(E) {
    return E.replace(/\r[\n\u0085]/g, `
`).replace(/[\r\u0085\u2028\u2029]/g, `
`);
...
function Cn() {
  ...
  var u = yn();
  return H.DOMParser = u.DOMParser, H.normalizeLineEndings = u.normalizeLineEndings, H.onErrorStopParsing = u.onErrorStopParsing, H.onWarningStopParsing = u.onWarningStopParsing, H;
}
Cn();
const jt = "USJ";
var xe = {}, $t, cr;
...
function hr(t, e, n) {
  const u = le(t);
  if (e > u || n && (e > n && !(e >= 0 && e < u && n < 0 && n > -u) || n < -u))
    return "";
  const o = fr(u, e), a = n ? fr(u, n) : void 0;
  return ut(t, o, a);
}
function pr(t, e, n) {
  const u = [];
  ...
  for (let h = 0; h < (n ? n - 1 : a.length); h++) {
    ...
    if (u.push(ut(t, p, f)), p = f + d, n !== void 0 && u.length === n)
      break;
  }
...
function Ti(t, e, n, u) {
  ...
  return `${o}${u ?? " "}${t.chapterNum}${n ?? ":"}${t.verseNum}`;
}
const jn = (
  // Using unicode control characters to be very explicit about which characters we are using.
  // The first 6 characters are the control characters \f\n\r\t\v.
...
function gr(t) {
  ...
  for (let o = 0; o < t.length; o += 1) {
    const a = t[o];
    a.charCodeAt(0) < 32 ? (n || (e += " "), n = !0) : !n && a === _n && o + 1 < t.length && mr(t[o + 1]) || (mr(a) ? (n || (e += a), n = !0) : Vn(a) && u === a || (e += a, n = !1)), u = a;
  }
  return e;
}
function Er(t) {
...
function Ur(t, e, n, u) {
  ...
  if (o && a) {
    const p = gr(t), h = gr(n);
    if (p !== h) {
      if (!mt(xt(p, -1) ?? "") && !mt(xt(h, -1) ?? "") || !Dr(t, e) || !Dr(n, u)) return !1;
      let f = p;
...
const Si = (t) => (...e) => t.map((u) => u(...e)).every((u) => u), Oi = (t) => async (...e) => {
  const n = t.map(async (u) => u(...e));
...
function Rt(t) {
  return function(n, u, o) {
    if (!n || !u || typeof n != "object" || typeof u != "object")
      return t(n, u, o);
    var a = o.cache, p = a.get(n), h = a.get(u);
    if (p && h)
      return p === u && h === n;
    a.set(n, u), a.set(u, n);
    var f = t(n, u, o);
    return a.delete(n), a.delete(u), f;
  };
}
function Ar(t) {
...
function Tt(t, e, n) {
  ...
  if (Ar(e).length !== o)
    return !1;
  for (var a, p, h; o-- > 0; )
    if (a = u[o], !Vr(t, e, n, a) || (p = br(t, a), h = br(e, a), (p || h) && (!p || !h || p.configurable !== h.configurable || p.enumerable !== h.enumerable || p.writable !== h.writable)))
      return !1;
  return !0;
}
function nu(t, e) {
...
function Vr(t, e, n, u) {
  return (u === Kn || u === Yn || u === Xn) && (t.$$typeof || e.$$typeof) ? !0 : Jn(e, u) && n.equals(t[u], e[u], u, u, t, e, n);
}
...
function Au(t) {
  var e = t.areArraysEqual, n = t.areDatesEqual, u = t.areErrorsEqual, o = t.areFunctionsEqual, a = t.areMapsEqual, p = t.areNumbersEqual, h = t.areObjectsEqual, f = t.arePrimitiveWrappersEqual, d = t.areRegExpsEqual, m = t.areSetsEqual, l = t.areTypedArraysEqual, v = t.areUrlsEqual;
  return function(N, y, j) {
    ...
    if (F === Set)
      return m(N, y, j);
    var U = vu(N);
    return U === cu ? n(N, y, j) : U === du ? d(N, y, j) : U === fu ? a(N, y, j) : U === mu ? m(N, y, j) : U === pu ? typeof N.then != "function" && typeof y.then != "function" && h(N, y, j) : U === Eu ? v(N, y, j) : U === lu ? u(N, y, j) : U === au ? h(N, y, j) : U === su || U === hu || U === gu ? f(N, y, j) : !1;
  };
}
function bu(t) {
  var e = t.circular, n = t.createCustomConfig, u = t.strict, o = {
...
function Nu(t) {
  return function(e, n, u, o, a, p, h) {
    return t(e, n, h);
  };
}
function yu(t) {
  var e = t.circular, n = t.comparator, u = t.createState, o = t.equals, a = t.strict;
  if (u)
    return function(f, d) {
      var m = u(), l = m.cache, v = l === void 0 ? e ? /* @__PURE__ */ new WeakMap() : void 0 : l, O = m.meta;
      return n(f, d, {
        cache: v,
        equals: o,
        meta: O,
...
function Ge(t) {
  t === void 0 && (t = {});
  var e = t.circular, n = e === void 0 ? !1 : e, u = t.createInternalComparator, o = t.createState, a = t.strict, p = a === void 0 ? !1 : a, h = bu(t), f = Au(h), d = u ? u(f) : Nu(f);
...
function wu(t, e) {
  ...
  return Object.keys(n).forEach((a) => {
    o && (Object.hasOwn(u, a) && wu(u[a], n[a]) || (o = !1));
  }), o;
}
function Sr(t, e, n) {
...
function Bi(t, e = 2) {
  ...
  const n = ["Bytes", "KB", "MB", "GB", "TB", "PB", "EB", "ZB", "YB"], u = Math.floor(Math.log(t) / Math.log(1024)), o = n[u];
  return `${new on("en", {
    style: "decimal",
...
function Ri(t, e, n = /* @__PURE__ */ new Date()) {
  const u = Math.floor((e.getTime() - n.getTime()) / Ou), o = Math.round(u / Iu);
...
class ce {
  ...
  // #endregion
  // #region Parent Maps
  static createParentMapInternal(e, n, u) {
    var o;
    u.set(e, n), e.content && u.set(e.content, e), (o = e.content) == null || o.forEach((a) => {
  ...
  convertJsonPathToWorkingStack(e) {
    ...
    return u.forEach((a, p) => {
      ...
      if (n.push({ parent: o, index: f }), p + 1 < u.length) {
   ...
   */
  static findRightMostDescendantMarkerObject(e, n, u = []) {
  ...
  static findNextMatchingNodeUsingWorkingStack(e, n, u, o) {
    var p;
    let a = e;
    for (; a !== void 0; ) {
  ...
  nodeToVerseRefAndOffset(e, n, u) {
    if (typeof n == "string" && u === void 0)
      throw new Error('If "node" is a string, then "nodeParent" cannot be undefined');
    let o;
    if (u === void 0 ? o = this.parentMap.get(n) : o = Array.isArray(u) ? this.parentMap.get(u) : u, o === void 0)
  ...
  findNextLocationOfMatchingText(e, n, u = 1e3) {
    let o = "", a = 0, p = 0, h = 0;
    if (ce.findNextMatchingNodeUsingWorkingStack(
      ...
      (l) => {
        ...
        a += l.length, o = `${o}${l}`;
        const v = o.indexOf(n);
        return v < 0 ? (p += o.length, o.length > n.length && (o = o.substring(o.length - n.length)), p -= o.length, a > u) : (h = p + v, !0);
      }
    ), h <= 0) return;
    a = 0;
    let f = 0, d = [];
  ...
  extractTextBetweenPoints(e, n, u = 100) {
    let o = "";
    return ce.findNextMatchingNodeUsingWorkingStack(
      e.node,
      this.convertJsonPathToWorkingStack(e.jsonPath),
      je,
      (a, p) => a === n.node && (typeof a == "object" || n.jsonPath === ce.convertWorkingStackToJsonPath(p)) ? !0 : typeof a != "string" ? !1 : (o = `${o}${a}`, o.length > u && (o = o.substring(0, u)), o.length >= u)
    ), o;
  }
  // #endregion
  ...
  static removeContentNodesFromArray(e, n) {
    ...
    for (let o = e.length - 1; o >= 0; o--) {
      const a = e[o];
      n(a) ? (e.splice(o, 1), u += 1) : typeof a != "string" && a.content && (u += this.removeContentNodesFromArray(a.content, n));
    }
    return u;
  }
