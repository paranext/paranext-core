...
var se = (s, e, t) => e in s ? ie(s, e, { enumerable: !0, configurable: !0, writable: !0, value: t }) : s[e] = t;
var k = (s, e, t) => se(s, typeof e != "symbol" ? e + "" : e, t);
import { d as C, i as _ } from "./scripture-util-DArajUVn.js";
import { D as Ut, F as Ft, a as Rt, b as Dt, G as Lt, L as Bt, M as Vt, S as zt, c as Ht, e as Jt, f as Kt, g as Gt, h as Yt, j as Xt, k as Wt, l as Zt, m as Qt, n as er, o as tr, p as rr, q as nr, r as ir, s as sr, t as ar, u as or, v as cr, w as dr, x as pr, y as lr, z as ur, A as hr, B as fr, C as mr, E as gr, H as yr, I as kr, J as br, K as vr, N as Mr, O as xr, P as _r, Q as Er, R as Ir, T as wr, U as Sr, V as Pr, W as Tr, X as Cr, Y as qr, Z as Ar, _ as $r, $ as jr, a0 as Nr, a1 as Or, a2 as Ur, a3 as Fr, a4 as Rr, a5 as Dr, a6 as Lr, a7 as Br, a8 as Vr, a9 as zr, aa as Hr, ab as Jr, ac as Kr, ad as Gr } from "./scripture-util-DArajUVn.js";
...
class Ke {
  ...
  cleanupPromiseChain(e) {
    ...
    if (!t) return;
    const r = { promise: ye }, i = t.catch((n) => this.logger.warn(`Error in promise for ${e}: ${n.message}`)).finally(() => {
...
const Y = 1e4, N = Y / 1e3, X = 3, V = /* @__PURE__ */ new Map(), ke = {
  unsubscribed: {
...
function z(s, e, t) {
  const { log: r, first: i, suppressed: n } = ke[e], c = `${s}\0${e}`, p = Date.now(), d = V.get(c);
  if (!d || p >= d.closesAt) {
    r(i(s, t)), V.set(c, {
      closesAt: p + Y,
      suppressedCount: 0,
...
const _e = 1e3, Q = 60, ee = Q * 60, Ee = ee * 24;
...
class g {
  ...
  getBookIdForLogging() {
    ...
    const e = (t = this.usj.content) == null ? void 0 : t.find(
      (r) => typeof r != "string" && r.type === H && !!r.code
    );
...
`) && (n.length === 0 ? (p = p.map((u) => ({
 ...
 `);
  ...
  static areUsjDocumentLocationsEqual(e, t, r = !1) {
    ...
    return !r && !O(P.toPathArray(i), P.toPathArray(c)) ? !1 : O(n, p);
  }
