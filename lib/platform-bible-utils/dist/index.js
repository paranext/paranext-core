...
import { D as Ot, F as Ft, a as Rt, b as Dt, G as Lt, L as Bt, M as Vt, S as zt, c as Ht, e as Jt, f as Kt, g as Gt, h as Yt, j as Xt, k as Wt, l as Zt, m as Qt, n as er, o as tr, p as rr, q as nr, r as ir, s as sr, t as ar, u as or, v as cr, w as dr, x as pr, y as lr, z as ur, A as hr, B as fr, C as mr, E as gr, H as yr, I as kr, J as br, K as vr, N as Mr, O as xr, P as _r, Q as Ir, R as Er, T as wr, U as Sr, V as Pr, W as Tr, X as Cr, Y as qr, Z as Ar, _ as $r, $ as jr, a0 as Nr, a1 as Ur, a2 as Or, a3 as Fr, a4 as Rr, a5 as Dr, a6 as Lr, a7 as Br, a8 as Vr, a9 as zr, aa as Hr, ab as Jr, ac as Kr, ad as Gr } from "./scripture-util-DArajUVn.js";
...
const _e = 1e3, Z = 60, Q = Z * 60, Ie = Q * 24;
function wt(s, e, t = /* @__PURE__ */ new Date()) {
  const r = Math.floor((e.getTime() - t.getTime()) / _e), i = Math.round(r / Ie);
...
USJ: ${JSON.stringify(
    ...
    else if (g.areUsjVersionsCompatible(this.usj.version, O.version))
      this.markersMap = O;
    else
      throw new Error(
  ...
  search(e, t) {
    ...
    for (; f; ) {
      if (f[0].length > 0) {
        ...
        const I = d.findClosestLessThanOrEqual(y);
        if (!I)
...
export {
  ...
  Ot as DEBOUNCE_CANCELED_ERROR_MESSAGE,
