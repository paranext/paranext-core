...
function he(n, e, t, r) {
  ...
  if (i && s) {
    ...
    if (!c && !u) {
      ...
      if (V.includes(a.type) && b(m) && E(m) && (f = f.slice(0, -1)), d.length !== f.length) return !1;
...
USJ: ${JSON.stringify(
  ...
  static isUsjDocumentLocationForNode(e) {
    ...
    if ("node" in e) {
      if (b(e.node))
        return h.isUsjDocumentLocationForTextContent(e);
      t = e.documentLocation;
    }
...
`);
    ...
    return i.push({ fragment: e, indexInUsfm: r.length }), r += a === "optbreak" ? "//" : `\\${d}`, a !== "optbreak" && (i.push({
      ...
      i.push({
        ...
        if (h.isFragmentAMarker(k.fragment)) {
          i.push({
            ...k,
            fragment: {
  ...
  closingMarkerToUsfm(e, t) {
    ...
    if ((u.closed === "false" || s.isClosingMarkerOptional && !this.markersMap.shouldOptionalClosingMarkersBePresent && u.closed !== "true") && (d = !1), s.independentClosingMarkers && s.independentClosingMarkers.length > 0 && d) {
      ...
      let y = "";
      const N = [], { usfm: w, fragmentsInfo: k } = this.openingMarkerToUsfm(m, t), F = k.find((A) => h.isFragmentAMarker(A.fragment));
      if (!F)
        throw new Error(
