...
var p = (t, e, r) => (X(t, typeof e != "symbol" ? e + "" : e, r), r);
class Ke {
  /**
...
function Ze(t, e, r) {
  ...
  return t.forEach((n) => {
    const a = e(n), o = s.get(a), i = r ? r(n, a) : n;
    o ? o.push(i) : s.set(a, [i]);
  }), s;
}
function Y(t) {
...
function Ye(t, e = "obj") {
  ...
  Object.getOwnPropertyNames(t).forEach((n) => {
    try {
      ...
      console.debug(`Skipping ${n} on ${e} due to error: ${a}`);
    }
  });
  ...
  for (; s && Object.getPrototypeOf(s); )
    Object.getOwnPropertyNames(s).forEach((n) => {
      try {
        ...
        console.debug(`Skipping ${n} on ${e}'s prototype due to error: ${a}`);
      }
...
class tt {
  ...
  updateBaseDocument(e) {
    return this.validateStartingDocument(e), this.baseDocument = this.options.copyDocuments ? E(e) : e, this.rebuild();
  }
  /**
  ...
  addOrUpdateContribution(e, r) {
    ...
    const s = this.contributions.get(e), n = this.options.copyDocuments && r ? E(r) : r;
    this.contributions.set(e, n);
    try {
      return this.rebuild();
    } catch (a) {
      throw s ? this.contributions.set(e, s) : this.contributions.delete(e), new Error(`Error when setting the document named ${e}: ${a}`);
    }
  }
  /**
...
const G = [
...
], ne = 1, ae = G.length - 1, oe = 1, ie = 1, ue = (t) => {
  var e;
  return ((e = G[t]) == null ? void 0 : e.chapters) ?? -1;
}, nt = (t, e) => ({
  bookNum: Math.max(ne, Math.min(t.bookNum + e, ae)),
  chapterNum: 1,
  verseNum: 1
}), at = (t, e) => ({
  ...t,
  ...
  ...t,
  verseNum: Math.max(ie, t.verseNum + e)
}), it = (t) => (...e) => t.map((s) => s(...e)).every((s) => s), ut = (t) => async (...e) => {
  const r = t.map(async (s) => s(...e));
  return (await Promise.all(r)).every((s) => s);
};
var M = typeof globalThis < "u" ? globalThis : typeof window < "u" ? window : typeof global < "u" ? global : typeof self < "u" ? self : {}, b = {}, le = () => {
  const t = "\\ud800-\\udfff", e = "\\u0300-\\u036f", r = "\\ufe20-\\ufe2f", s = "\\u20d0-\\u20ff", n = "\\u1ab0-\\u1aff", a = "\\u1dc0-\\u1dff", o = e + r + s + n + a, i = "\\ufe0e\\ufe0f", c = "\\uD83D\\uDC69\\uD83C\\uDFFB\\u200D\\uD83C\\uDF93", h = `[${t}]`, u = `[${o}]`, l = "\\ud83c[\\udffb-\\udfff]", f = `(?:${u}|${l})`, d = `[^${t}]`, m = "(?:\\uD83C[\\uDDE6-\\uDDFF]){2}", v = "[\\ud800-\\udbff][\\udc00-\\udfff]", $ = "\\u200d", F = "(?:\\ud83c\\udff4\\udb40\\udc67\\udb40\\udc62\\udb40(?:\\udc65|\\udc73|\\udc77)\\udb40(?:\\udc6e|\\udc63|\\udc6c)\\udb40(?:\\udc67|\\udc74|\\udc73)\\udb40\\udc7f)", k = `[${c}]`, j = `${f}?`, C = `[${i}]?`, K = `(?:${$}(?:${[d, m, v].join("|")})${C + j})*`, L = C + j + K, W = `(?:${[`${d}${u}?`, u, m, v, h, k].join("|")})`;
  return new RegExp(`${F}|${l}(?=${l})|${W + L}`, "g");
}, ce = M && M.__importDefault || function(t) {
...
function A(t) {
  ...
  return t.match(O.default()) || [];
}
var fe = b.toArray = A;
function q(t) {
  if (typeof t != "string")
    throw new Error("Input must be a string");
  var e = t.match(O.default());
...
function B(t, e, r) {
  ...
  var s = t.match(O.default());
  return s ? s.slice(e, r).join("") : "";
}
var pe = b.substring = B;
function me(t, e, r) {
  if (e === void 0 && (e = 0), typeof t != "string")
    throw new Error("Input must be a string");
  var s = q(t);
  ...
  var a = t.match(O.default());
  return a ? a.slice(e, n).join("") : "";
}
b.substr = me;
function de(t, e, r, s) {
...
function ge(t, e, r) {
  ...
  for (o = r; o < s.length; o += 1) {
    for (var i = 0; i < n.length && n[i] === s[o + i]; )
      i += 1;
    if (i === n.length && n[i - 1] === s[o + i - 1]) {
      a = !0;
      break;
    }
  }
...
var be = b.indexOf = ge;
const lt = be, ct = pe, ft = he, ht = fe, pt = (t, e, r) => {
  V(t, e, r, "left");
}, mt = (t, e, r) => {
  V(t, e, r, "right");
}, dt = (t, e = "NFC") => {
...
var Ne = Object.getOwnPropertyNames, ve = Object.getOwnPropertySymbols, ye = Object.prototype.hasOwnProperty;
function P(t, e) {
  return function(s, n, a) {
    return t(s, n, a) && e(s, n, a);
  };
}
function w(t) {
  return function(r, s, n) {
    if (!r || !s || typeof r != "object" || typeof s != "object")
      return t(r, s, n);
    var a = n.cache, o = a.get(r), i = a.get(s);
    if (o && i)
      return o === s && i === r;
    a.set(r, s), a.set(s, r);
    var c = t(r, s, n);
    return a.delete(r), a.delete(s), c;
  };
}
function S(t) {
  return Ne(t).concat(ve(t));
}
var H = Object.hasOwn || function(t, e) {
  return ye.call(t, e);
};
function N(t, e) {
  return t || e ? t === e : t === e || t !== t && e !== e;
}
var U = "_owner", T = Object.getOwnPropertyDescriptor, D = Object.keys;
function we(t, e, r) {
  var s = t.length;
  if (e.length !== s)
    return !1;
...
function Ee(t, e) {
  return N(t.getTime(), e.getTime());
}
function R(t, e, r) {
  if (t.size !== e.size)
    return !1;
  for (var s = {}, n = t.entries(), a = 0, o, i; (o = n.next()) && !o.done; ) {
    for (var c = e.entries(), h = !1, u = 0; (i = c.next()) && !i.done; ) {
      var l = o.value, f = l[0], d = l[1], m = i.value, v = m[0], $ = m[1];
      !h && !s[u] && (h = r.equals(f, v, a, u, t, e, r) && r.equals(d, $, f, v, t, e, r)) && (s[u] = !0), u++;
    }
    if (!h)
      return !1;
    a++;
...
function Oe(t, e, r) {
  var s = D(t), n = s.length;
  if (D(e).length !== n)
    return !1;
  for (var a; n-- > 0; )
    if (a = s[n], a === U && (t.$$typeof || e.$$typeof) && t.$$typeof !== e.$$typeof || !H(e, a) || !r.equals(t[a], e[a], a, a, t, e, r))
      return !1;
  return !0;
}
function y(t, e, r) {
  var s = S(t), n = s.length;
  if (S(e).length !== n)
    return !1;
  for (var a, o, i; n-- > 0; )
    if (a = s[n], a === U && (t.$$typeof || e.$$typeof) && t.$$typeof !== e.$$typeof || !H(e, a) || !r.equals(t[a], e[a], a, a, t, e, r) || (o = T(t, a), i = T(e, a), (o || i) && (!o || !i || o.configurable !== i.configurable || o.enumerable !== i.enumerable || o.writable !== i.writable)))
      return !1;
  return !0;
}
function $e(t, e) {
  return N(t.valueOf(), e.valueOf());
}
function Ae(t, e) {
...
function x(t, e, r) {
  if (t.size !== e.size)
    return !1;
  for (var s = {}, n = t.values(), a, o; (a = n.next()) && !a.done; ) {
    for (var i = e.values(), c = !1, h = 0; (o = i.next()) && !o.done; )
      !c && !s[h] && (c = r.equals(a.value, o.value, a.value, o.value, t, e, r)) && (s[h] = !0), h++;
    if (!c)
      return !1;
  }
  return !0;
...
function Je(t) {
  var e = t.areArraysEqual, r = t.areDatesEqual, s = t.areMapsEqual, n = t.areObjectsEqual, a = t.arePrimitiveWrappersEqual, o = t.areRegExpsEqual, i = t.areSetsEqual, c = t.areTypedArraysEqual;
  return function(u, l, f) {
    ...
    if (d === Set)
      return i(u, l, f);
    var m = ze(u);
    return m === Me ? r(u, l, f) : m === De ? o(u, l, f) : m === Pe ? s(u, l, f) : m === Re ? i(u, l, f) : m === Te ? typeof u.then != "function" && typeof l.then != "function" && n(u, l, f) : m === je ? n(u, l, f) : m === Ce || m === Se || m === xe ? a(u, l, f) : !1;
  };
}
function _e(t) {
  var e = t.circular, r = t.createCustomConfig, s = t.strict, n = {
    areArraysEqual: s ? y : we,
    areDatesEqual: Ee,
    areMapsEqual: s ? P(R, y) : R,
    areObjectsEqual: s ? y : Oe,
    arePrimitiveWrappersEqual: $e,
    areRegExpsEqual: Ae,
    areSetsEqual: s ? P(x, y) : x,
    areTypedArraysEqual: s ? y : qe
  };
  if (r && (n = z({}, n, r(n))), e) {
    var a = w(n.areArraysEqual), o = w(n.areMapsEqual), i = w(n.areObjectsEqual), c = w(n.areSetsEqual);
    n = z({}, n, {
      areArraysEqual: a,
      areMapsEqual: o,
      areObjectsEqual: i,
...
function Ge(t) {
  return function(e, r, s, n, a, o, i) {
    return t(e, r, i);
  };
}
function Be(t) {
  var e = t.circular, r = t.comparator, s = t.createState, n = t.equals, a = t.strict;
  if (s)
    return function(c, h) {
      var u = s(), l = u.cache, f = l === void 0 ? e ? /* @__PURE__ */ new WeakMap() : void 0 : l, d = u.meta;
      return r(c, h, {
        cache: f,
        equals: n,
        meta: d,
...
function g(t) {
  t === void 0 && (t = {});
  var e = t.circular, r = e === void 0 ? !1 : e, s = t.createInternalComparator, n = t.createState, a = t.strict, o = a === void 0 ? !1 : a, i = _e(t), c = Je(i), h = s ? s(c) : Ge(c);
  return Be({ circular: r, comparator: c, createState: n, equals: h, strict: o });
}
function gt(t, e) {
  return Ve(t, e);
}
...
function He(t, e) {
  function r(n) {
    return Object.keys(n).forEach((a) => {
      n[a] === null ? n[a] = void 0 : typeof n[a] == "object" && (n[a] = r(n[a]));
    }), n;
  }
...
const Nt = (t) => t.replace(/&/g, "&amp;").replace(/</g, "&lt;").replace(/>/g, "&gt;").replace(/"/g, "&quot;").replace(/'/g, "&#x27;").replace(/\//g, "&#x2F;"), Ue = {
...
export {
  Ke as AsyncVariable,
  tt as DocumentCombinerEngine,
  ne as FIRST_SCR_BOOK_NUM,
  oe as FIRST_SCR_CHAPTER_NUM,
  ie as FIRST_SCR_VERSE_NUM,
  ae as LAST_SCR_BOOK_NUM,
  st as PlatformEventEmitter,
  rt as UnsubscriberAsyncList,
  ut as aggregateUnsubscriberAsyncs,
  it as aggregateUnsubscribers,
  et as createSyncProxyForAsyncObject,
  We as debounce,
  E as deepClone,
  gt as deepEqual,
  He as deserialize,
  Ye as getAllObjectFunctionNames,
  ue as getChaptersForBook,
  Xe as getErrorMessage,
  Ze as groupBy,
  Nt as htmlEncode,
  lt as indexOf,
  bt as isSerializable,
  Q as isString,
  ft as length,
  Ue as menuDocumentSchema,
  Le as newGuid,
  dt as normalize,
  nt as offsetBook,
  at as offsetChapter,
