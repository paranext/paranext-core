...
import { length as Me, indexOf as Se, limit as ae, substring as Ee, toArray as Ae, substr as Pe } from "stringz";
...
function P(n, e) {
  return e < 0 || e > N(n) - 1 ? "" : D(n, e, 1);
}
function Qt(n, e) {
  if (!(e < 0 || e > N(n) - 1))
    return D(n, e, 1).codePointAt(0);
}
...
function qe(n, e) {
  ...
  let r = 0, i = 0;
  function s(a, c, l) {
    const u = S(n, i, c), h = t.length > 0 && b(t[t.length - 1]) ? `${t.pop()}${u}` : u;
...
function D(n, e = 0, t = N(n) - e) {
  return Pe(n, e, t);
}
function S(n, e, t = N(n)) {
  return Ee(n, e, t);
}
function He(n) {
  return Ae(n);
...
function de(n, e, t, r) {
  ...
  if (i && s) {
    const o = ee(n), a = ee(t);
    if (o !== a) {
      if (!A(B(o, -1) ?? "") && !A(B(a, -1) ?? "") || !re(n, e) || !re(t, r)) return !1;
      let c = o;
      for (; A(B(c, -1) ?? ""); ) c = _(c, 0, -1);
      let l = a;
      for (; A(B(l, -1) ?? ""); ) l = _(l, 0, -1);
      if (c !== l) return !1;
    }
  } else if (!i && !s) {
    ...
    const l = te(o.content), u = te(a.content);
    if (l !== u) return !1;
    if (!l && !u) {
      let h = o.content, f = a.content;
      const p = h[h.length - 1];
      V.includes(o.type) && b(p) && A(p) && (h = h.slice(0, -1));
      const d = f[f.length - 1];
      if (V.includes(a.type) && b(d) && A(d) && (f = f.slice(0, -1)), h.length !== f.length) return !1;
...
USJ: ${JSON.stringify(
  ...
  static findNextMatchingNodeOrClosingFragmentUsingWorkingStack(e, t, r, i) {
    ...
    if (!b(o)) {
      ...
      t.some((l) => {
        ...
        return !b(u) && r.includes(u.type) ? (c = u, !0) : !1;
      }), c && (s = c);
    }
    for (; s !== void 0; ) {
  ...
  getVerseRefForIndexInUsfm(e, t) {
    ...
    return c && m.isFragmentAMarker(c.fragment) && c.fragment.type === I && c.fragment.number && c.fragment.number !== `${s.verseNum}` && (s.verse = c.fragment.number), s;
  }
  ...
  findNextLocationOfMatchingText(e, t, r = 1e3) {
    ...
    if (m.findNextMatchingNodeUsingWorkingStack(
      ...
      (p, d) => {
        ...
        if (l && m.areStackItemsShallowEqual(k, l)) {
          ...
          g = p.substring(e.documentLocation.offset), o += e.documentLocation.offset;
        }
        s += g.length, i = `${i}${g}`;
        const w = i.indexOf(t);
    ...
    const f = m.findNextMatchingNodeUsingWorkingStack(
      ...
      $,
      (p, d) => typeof p != "string" || (s += p.length, s < a + 1) ? !1 : (u = a - s + p.length, h = d, !0)
    );
  ...
  search(e, t) {
    ...
    let a = 0, c = i.node;
    for (; c !== void 0; )
      c = m.findNextMatchingNodeUsingWorkingStack(
        i.node,
        this.convertJsonPathToWorkingStack(i.documentLocation.jsonPath),
        [],
        // We need to use variables from outside the function to keep track of our current position
        // eslint-disable-next-line no-loop-func
        (h, f) => (typeof h != "string" || t && f.some((d) => {
          const g = d.parent;
          if (!g || !("type" in g) || g.type === "char") return !1;
          let k;
          return "style" in g && typeof g.style == "string" ? k = g.style : "marker" in g && typeof g.marker == "string" && (k = g.marker), k !== void 0 && !t.has(k);
        }) || (s.push(h), o.set(a, {
          node: h,
          documentLocation: {
            offset: 0,
            jsonPath: m.convertWorkingStackToJsonPath(f)
          }
        }), a += h.length), !1)
      );
    const l = s.join("");
    ...
    for (; u; ) {
      if (u[0].length > 0) {
        if (u.index < 0 || u.index >= l.length)
          throw new Error(`Match index out of bounds: ${u.index}`);
        const h = o.findClosestLessThanOrEqual(u.index);
        if (!h)
        ...
        const f = {
          ...
          documentLocation: {
            ...
            offset: u.index - h.key
          }
        }, p = o.findClosestLessThanOrEqual(
        ...
        const d = {
          ...
          documentLocation: {
            ...
            offset: u.index + u[0].length - p.key
          }
        };
        r.push({ text: u[0], start: f, end: d });
      }
      if (!e.global) break;
      u = e.exec(l);
    }
  ...
  getInfoForMarker(e, t = "usfm") {
    ...
    if (t === "usfm" && c === "cell" && h.colspan) {
      const f = parseInt(h.colspan, 10), p = St.exec(r);
      if (p != null && p[1]) {
        const d = parseInt(p[1], 10);
        !Number.isNaN(d) && !Number.isNaN(f) && (a = `${r}-${d + f - 1}`, l = {
          ...l,
...
`);
    ...
    return i.push({ fragment: e, indexInUsfm: r.length }), r += a === "optbreak" ? "//" : `\\${h}`, a !== "optbreak" && (i.push({
      ...
      indexInUsfm: r.length
    }), r += `${u[o.textContentAttribute]} `), o.attributeMarkers && l.forEach(([f, p]) => {
      const d = u[p.attributeMarkerAttributeName];
      if (!d) return;
      const g = {
        type: p.type,
        marker: f,
      ...
      const { usfm: w } = this.textContentToUsfm(d);
      i.push({
        fragment: {
        ...
        if ("isClosingMarker" in v.fragment) {
          const { isClosingMarker: F, ...E } = v.fragment, Ne = {
            ...E,
            forMarker: e,
  ...
  closingMarkerToUsfm(e, t) {
    const {
      ...
      var g, k;
      return !(d === "type" || d === "marker" || d === "content" || d === "closed" || (g = a.skipOutputAttributeToUsfm) != null && g.includes(d) || (k = s.leadingAttributes) != null && k.includes(d) || s.textContentAttribute === d || c.some(
        ([, w]) => w.attributeMarkerAttributeName === d
      ));
    }), u = e;
    ...
    if ((u.closed === "false" || s.isClosingMarkerOptional && !this.markersMap.shouldOptionalClosingMarkersBePresent && u.closed !== "true") && (h = !1), s.independentClosingMarkers && s.independentClosingMarkers.length > 0 && h) {
      ...
      let g = "";
      const k = [], { usfm: w, fragmentsInfo: v } = this.openingMarkerToUsfm(d, t), F = v.find((E) => m.isFragmentAMarker(E.fragment));
      if (!F)
        throw new Error(
      ...
      return k.push({
      ...
      }), g += w, r !== d.marker && (g = this.addMarkerUsfmToString(
        g,
        {
          isClosingMarker: !0,
          forMarker: d
        ...
        t
      )), { usfm: g, fragmentsInfo: k };
    }
    let f = "";
    const p = [];
    if (l.length > 0 && (f += "|", l.length === 1 && l[0] === s.defaultAttribute ? (p.push({
      fragment: { attributeValueForKey: s.defaultAttribute, forMarker: e },
      indexInUsfm: f.length
    }), f += u[s.defaultAttribute]) : l.forEach((d, g) => {
      ...
      const d = a.isClosingMarkerEmpty ? "" : i, g = t ? a.nestedPrefix ?? "" : "";
      p.push({
        fragment: { isClosingMarker: !0, forMarker: e },
        indexInUsfm: f.length
      }), f += `\\${g}${d}*`;
 ...
 `);
    ...
    e.map((c) => {
      ...
      if (typeof c.fragment == "object" && "type" in c.fragment) {
        ...
        if (p.type === ut && p.code)
          ...
          const d = (u = Et.exec(p.number)) == null ? void 0 : u[1];
          if (!d)
            console.warn(
            ...
            Number.isNaN(g) ? console.warn(
              `Found ${I} type marker with number ${p.number}, but could not parse starting verse number from ${d}. Continuing using previous verse number ${r.verseNum}`
            ) : (f = (h = o[r.bookId]) == null ? void 0 : h[r.chapterNum]) != null && f[g] ? console.warn(`Found ${I} marker with existing number ${g} after
      ...
      u ? u.push(c) : s.set(l, [c]), o[r.bookId] || (o[r.bookId] = {}), o[r.bookId][r.chapterNum] || (o[r.bookId][r.chapterNum] = {}), o[r.bookId][r.chapterNum][r.verseNum] === void 0 && (o[r.bookId][r.chapterNum][r.verseNum] = c.indexInUsfm);
    }), e.splice(0);
  }
  ...
  calculateUsfmProperties() {
    ...
    return m.findNextMatchingNodeOrClosingFragmentUsingWorkingStack(
      ...
      (u, h) => {
        if (typeof u != "object") {
          const { usfm: p, fragmentsInfo: d } = this.textContentToUsfm(u);
        ...
        let f;
        return h.length > 0 && (f = h[h.length - 1].parent), "isClosingMarker" in u ? l.length > 0 && l[l.length - 1] === u.forMarker ? (l.pop(), !1) : (e = this.addMarkerUsfmToString(
          e,
          u,
          f,
          s
        ), a(h), u.forMarker.type === "book" && c && (e = this.addMarkerUsfmToString(e, c, f, s), a(h), c = void 0), !1) : this.shouldSkipOutputMarkerToUsfm(u) ? (l.push(u), !1) : m.isTopLevelUsjMarker(u, h) && !c ? (u.version !== "3.0" && (c = u), !1) : (e = this.addMarkerUsfmToString(e, u, f, s), a(h), !1);
      }
...
export {
  ...
  Br as USFM_MARKERS_MAP_PARATEXT_3_0,
