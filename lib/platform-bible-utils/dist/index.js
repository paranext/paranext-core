...
import { d as C, i as _ } from "./scripture-util-CtZM3RsL.js";
import { D as qt, F as At, a as jt, b as $t, L as Nt, S as Ft, c as Ut, e as Ot, f as Rt, g as Dt, h as Lt, j as Bt, k as Vt, l as zt, m as Ht, n as Jt, o as Kt, p as Gt, q as Yt, r as Xt, s as Wt, t as Zt, u as Qt, v as er, w as tr, x as rr, y as nr, z as ir, A as sr, B as ar, C as or, E as cr, G as dr, H as pr, I as lr, J as ur, K as hr, M as fr, N as mr, O as gr, P as yr, Q as kr, R as br, T as vr, U as Mr, V as xr, W as _r, X as Ir, Y as Er, Z as wr, _ as Sr, $ as Pr, a0 as Tr, a1 as Cr, a2 as qr, a3 as Ar, a4 as jr, a5 as $r, a6 as Nr, a7 as Fr, a8 as Ur, a9 as Or, aa as Rr } from "./scripture-util-CtZM3RsL.js";
  ...
  search(e, t) {
    ...
    for (; f; ) {
      if (f[0].length > 0) {
        ...
        }, $ = u ? b.substring(y, M) : f[0];
        n.push({ text: $, start: v, end: E });
      }
      if (!e.global) break;
      f = e.exec(h);
    }
    ...
    return i.push({ fragment: e, indexInUsfm: r.length }), r += d === "optbreak" ? "//" : `\\${b}`, d !== "optbreak" && (i.push({
      ...
      i.push({
        ...
        if ("isClosingMarker" in v.fragment) {
          const { isClosingMarker: x, ...E } = v.fragment, $ = {
            ...E,
            forMarker: e,
...
export {
  ...
  Ft as SELECTABLE_INVISIBLE_CHAR_OR_WHITESPACE_CLASS,
  Ut as Section,
  ...
  Ot as areUsjContentsEqualExceptWhitespace,
  Rt as at,
  Dt as charAt,
  Lt as codePointAt,
  Bt as collapseMiddleWords,
  Vt as collectUsjMarkers,
  zt as compareScrRefs,
  It as computeEffectiveStructureProtection,
  Ht as createSyncProxyForAsyncObject,
  Jt as debounce,
  C as deepClone,
  N as deepEqual,
  Kt as defaultScrRef,
  ...
  Gt as endsWith,
  Yt as ensureArray,
  Xt as escapeStringRegexp,
  wt as expandThemeContribution,
  kt as formatBytes,
  Mt as formatRelativeDate,
  Wt as formatReplacementString,
  Zt as formatReplacementStringToArray,
  Qt as formatScrRef,
  ...
  lr as isErrorMessageAboutParatextBlockingInternetAccess,
  ur as isErrorMessageAboutRegistryAuthFailure,
  hr as isLocalizeKey,
  ot as isPlatformError,
  fr as isSelectableInvisibleCharOrWhiteSpace,
  ...
  Mr as offsetChapter,
  xr as offsetVerse,
  _r as ordinalCompare,
  Ir as padEnd,
  Er as padStart,
  be as projectSettingsDocumentSchema,
  wr as retryUntil,
  ut as sanitizeHtml,
  Sr as scrRefToBBBCCC,
  Pr as scrRefToBBBCCCVVV,
  V as serialize,
  ...
  $r as toArray,
  Nr as toKebabCase,
  Fr as transformAndEnsureRegExpArray,
  Ur as transformAndEnsureRegExpRegExpArray,
  H as usfmMarkers,
  Or as wait,
  Rr as waitForDuration
};
