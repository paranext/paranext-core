...
function zu(t, e = 300) {
  if (Ie(t)) throw new Error("Tried to debounce a string! Could be XSS");
  let r;
  return (...u) => {
...
function Yu(t) {
  ...
  return Ie(t) ? t.includes(e) : Or(t).includes(e);
}
function Ku(t) {
  const e = "401 Unauthorized error while getting shared projects.", r = "User registration is not valid. Cannot retrieve resources from DBL.", u = Ie(t) ? t : Or(t);
...
function ni(t) {
  ...
  if (Ie(t)) return { message: t, platformErrorVersion: It };
  if (typeof t == "object" && "message" in t && typeof t.message == "string") {
    const e = {
      message: t.message,
      platformErrorVersion: It
    };
    return Object.defineProperties(e, Object.getOwnPropertyDescriptors(t)), Object.defineProperty(e, "message", { enumerable: !0 }), "stack" in t && Ie(t.stack) && Object.defineProperty(e, "stack", { value: t.stack, enumerable: !0 }), "cause" in e && Object.defineProperty(e, "cause", { enumerable: !0 }), e;
  }
...
function _t() {
  ...
  function p(v, O) {
    o(v) ? (this.name = u[v], this.message = O || "") : (this.message = v, this.name = a(O) ? O : r.Error), Error.captureStackTrace && Error.captureStackTrace(this, p);
  }
...
function kr() {
  ...
  var O = r(v), N = o("[", O, r(/[-.0-9\xB7]/), r(/[\u0300-\u036F\u203F-\u2040]/), "]"), y = o(v, N, "*"), j = o(N, "+"), R = o("&", y, ";"), F = a(/&#[0-9]+;|&#x[0-9a-fA-F]+;/), U = a(R, "|", F), ne = o("%", y, ";"), fe = a(
    o('"', a(/[^%&"]/, "|", ne, "|", U), "*", '"'),
    "|",
    o("'", a(/[^%&']/, "|", ne, "|", U), "*", "'")
  ), E = a('"', a(/[^<&"]/, "|", U), "*", '"', "|", "'", a(/[^<&']/, "|", U), "*", "'"), x = u(v, ":"), k = u(N, ":"), z = o(x, k, "*"), W = o(z, a(":", z), "?"), ee = o("^", W, "$"), xe = o("(", W, ")"), te = a(/"[^"]*"|'[^']*'/), Be = o(/^<\?/, "(", y, ")", a(m, "(", h, "*?)"), "?", /\?>/), g = /[\x20\x0D\x0Aa-zA-Z0-9-'()+,./:=?;!*#@$_%]/, b = a('"', g, '*"', "|", "'", u(g, "'"), "*'"), w = "<!--", C = "-->", M = o(w, a(u(h, "-"), "|", o("-", u(h, "-"))), "*", C), A = "#PCDATA", B = a(
    o(/\(/, l, A, a(l, /\|/, l, W), "*", l, /\)\*/),
    "|",
    o(/\(/, l, A, l, /\)/)
  ), X = /[?*+]?/, _ = o(
...
function Fr() {
  ...
  var k = {}, z = k.ELEMENT_NODE = 1, W = k.ATTRIBUTE_NODE = 2, ee = k.TEXT_NODE = 3, xe = k.CDATA_SECTION_NODE = 4, te = k.ENTITY_REFERENCE_NODE = 5, Be = k.ENTITY_NODE = 6, g = k.PROCESSING_INSTRUCTION_NODE = 7, b = k.COMMENT_NODE = 8, w = k.DOCUMENT_NODE = 9, C = k.DOCUMENT_TYPE_NODE = 10, M = k.DOCUMENT_FRAGMENT_NODE = 11, A = k.NOTATION_NODE = 12, B = t.freeze({
  ...
  function ve(n, i, s) {
    ...
    if (c >= 0) {
      ...
      if (i.length = D, n) {
        ...
        S && _e(S, n, s), s.ownerElement = null;
      }
    }
  }
  V.prototype = {
  ...
  ie.prototype = {
    ...
    createDocumentType: function(n, i, s, c) {
      ne(n);
      var D = new lt(d);
      return D.name = n, D.nodeName = n, D.publicId = i || "", D.systemId = s || "", D.internalSubset = c || "", D.childNodes = new T(), D;
    },
    /**
    ...
    createHTMLDocument: function(n) {
      ...
      if (i.implementation = this, i.childNodes = new T(), n !== !1) {
  ...
  P.prototype = {
    ...
    replaceChild: function(n, i) {
      q(this, n, i, Ke), i && this.removeChild(i);
    },
    /**
  ...
  function q(n, i, s, c) {
    ...
    S.previousSibling = ae, Y.nextSibling = s, ae ? ae.nextSibling = S : n.firstChild = S, s == null ? n.lastChild = Y : s.previousSibling = Y;
    do
      S.parentNode = n;
  ...
  pe.prototype = {
    ...
    insertBefore: function(n, i) {
      ...
      return q(this, n, i), n.ownerDocument = this, this.documentElement === null && n.nodeType === z && (this.documentElement = n), n;
    },
    removeChild: function(n) {
      var i = ke(this, n);
    ...
    replaceChild: function(n, i) {
      q(this, n, i, Ke), n.ownerDocument = this, i && this.removeChild(i), Q(n) && (this.documentElement = n);
    },
    ...
    createElement: function(n) {
      var i = new Z(d);
      i.ownerDocument = this, this.type === "html" && (n = n.toLowerCase()), r(this.contentType) && (i.namespaceURI = f.HTML), i.nodeName = n, i.tagName = n, i.localName = n, i.childNodes = new T();
    ...
    createTextNode: function(n) {
      var i = new We(d);
      return i.ownerDocument = this, i.childNodes = new T(), i.appendData(n), i;
    },
    /**
     * @param {string} data
     * @returns {Comment}
    ...
    createProcessingInstruction: function(n, i) {
      var s = new ht(d);
      return s.ownerDocument = this, s.childNodes = new T(), s.nodeName = s.target = n, s.nodeValue = s.data = i, s;
    },
    /**
    ...
    _createAttribute: function(n) {
      var i = new Ae(d);
      return i.ownerDocument = this, i.childNodes = new T(), i.name = n, i.nodeName = n, i.localName = n, i.specified = !0, i;
    },
    /**
    ...
    createEntityReference: function(n) {
      ...
      var i = new ft(d);
      return i.ownerDocument = this, i.childNodes = new T(), i.nodeName = n, i;
    },
    // Introduced in DOM Level 2:
    /**
  ...
  Z.prototype = {
    ...
    setAttributeNS: function(n, i, s) {
      var c = fe(n, i), D = c[2], S = this.getAttributeNodeNS(n, D);
      S ? S.value = S.nodeValue = "" + s : (S = this.ownerDocument.createAttributeNS(n, i), S.value = S.nodeValue = "" + s, this.setAttributeNode(S));
    },
    ...
    getElementsByTagName: function(n) {
      var i = (this.nodeType === w ? this : this.ownerDocument).type === "html", s = n.toLowerCase();
        ...
        return Re(c, function(S) {
          if (!(S === c || S.nodeType !== z))
            if (n === "*")
              ...
              var Y = S.getQualifiedName(), ae = i && S.namespaceURI === f.HTML ? s : n;
              Y === ae && D.push(S);
            }
        }), D;
      });
  ...
  function qe(n, i, s, c) {
    c || (c = []);
    var D = n.nodeType === w ? n : n.ownerDocument, S = D.type === "html";
    if (s)
      if (n = s(n), n) {
        if (typeof n == "string") {
          i.push(n);
    ...
    switch (n.nodeType) {
      case z:
        ...
        var Ft = !ge;
        if (Ft && (S || n.namespaceURI === f.HTML) && (Ft = p(me)), Ft)
          i.push("/>");
        else {
          if (i.push(">"), S && a(me))
            for (; ge; )
      ...
      case xe:
        return i.push(O.CDATA_START, n.data, O.CDATA_END);
      case b:
        return i.push(O.COMMENT_START, n.data, O.COMMENT_END);
      case C:
        var Yt = n.publicId, pt = n.systemId;
        i.push(O.DOCTYPE_DECL_START, " ", n.name), Yt ? (i.push(" ", O.PUBLIC, " ", Yt), pt && pt !== "." && i.push(" ", pt)) : pt && pt !== "." && i.push(" ", O.SYSTEM, " ", pt), n.internalSubset && i.push(" [", n.internalSubset, "]"), i.push(">");
        return;
      case g:
  ...
  function kt(n, i, s) {
    ...
    switch (i.childNodes && (c.childNodes = new T()), c.ownerDocument = n, c.nodeType) {
      case z:
...
function Nn() {
  if (or) return Ct;
  or = 1;
  var t = Dt(), e = kr(), r = _t(), u = t.isHTMLEscapableRawTextElement, o = t.isHTMLMimeType, a = t.isHTMLRawTextElement, p = t.hasOwn, h = t.NAMESPACE, f = r.ParseError, d = r.DOMException, m = 0, l = 1, v = 2, O = 3, N = 4, y = 5, j = 6, R = 7;
  function F() {
  }
  F.prototype = {
  ...
  function ne(g, b, w, C, M) {
    ...
    function _(q) {
      if (q > ie) {
        var Z = g.substring(ie, q).replace(U, X);
        ...
        switch (g.charAt(P + 1)) {
          ...
          default:
            ...
            if (Q.closed || (A && t.isHTMLVoidElement(Q.tagName) ? Q.closed = !0 : ve.push(Q.tagName)), V && Xe) {
              ...
              x(Q, C, ze) && we.push(Q);
            A && !Q.closed ? oe = k(g, oe, Q.tagName, X, C) : oe++;
        }
      } catch (q) {
        if (q instanceof f)
          throw q;
        ...
        case '"':
          if (L === O || L === l)
            if (L === l && (A.warning('attribute value must after "="'), _ = g.slice(b, I)), b = I + 1, I = g.indexOf(V, b), I > 0)
              T = g.slice(b, I), X(_, T, b - 1), L = y;
            else
              throw new Error("attribute value no end '" + V + "' match");
          else if (L == N)
            T = g.slice(b, I), X(_, T, b), A.warning('attribute "' + _ + '" missed start quot(' + V + ")!!"), b = I + 1, L = y;
          else
  ...
  function x(g, b, w) {
    for (var C = g.tagName, M = null, L = g.length; L--; ) {
      var A = g[L], B = A.qName, X = A.value, V = B.indexOf(":");
      if (V > 0)
        var _ = A.prefix = B.slice(0, V), T = B.slice(V + 1), I = _ === "xmlns" && T;
      else
        T = B, _ = null, I = B === "xmlns" && "";
      A.localName = T, I !== !1 && (M == null && (M = /* @__PURE__ */ Object.create(null), z(w, w = /* @__PURE__ */ Object.create(null))), w[I] = M[I] = X, A.uri = h.XMLNS, b.startPrefixMapping(I, X));
    }
  ...
  function k(g, b, w, C, M) {
    var A = u(w);
    if (A || a(w)) {
      var B = g.indexOf("</" + w + ">", b), X = g.substring(b + 1, B);
      return A && (X = X.replace(U, C)), M.characters(X, 0, X.length), B;
    }
    return b + 1;
  }
  function z(g, b) {
...
` && L !== "	" && L !== "\r")
  ...
  return Be.prototype = {
    ...
    //	getType:function(i){},
  }, Ct.XMLReader = F, Ct.parseUtils = W, Ct.parseDoctypeCommentOrCData = xe, Ct;
}
var ar;
function yn() {
  if (ar) return rt;
...
`);
  ...
  N.prototype.parseFromString = function(E, x) {
    ...
    this.locator && ee.setDocumentLocator(xe);
    var te = new v();
  ...
  y.prototype = {
    ...
    startElement: function(E, x, k, z) {
      var W = this.doc, ee = W.createElementNS(E, k || x), xe = z.length;
      U(this, ee), this.currentElement = ee, this.locator && j(this.locator, ee);
      for (var te = 0; te < xe; te++) {
...
function In(t, e) {
  ...
  let u = 0, o = 0;
  function a(h, f, d) {
    const m = ut(t, o, f), l = r.length > 0 && Ie(r[r.length - 1]) ? `${r.pop()}${m}` : m;
    Ie(h) ? r.push(`${l}${h}`) : (l && r.push(l), r.push(h)), o = f + d;
  }
  const p = le(t);
  for (; u < p; ) {
    switch (gt(t, u)) {
  ...
  if (o < p) {
    const h = ut(t, o);
    r.push(
      r.length > 0 && Ie(r[r.length - 1]) ? `${r.pop()}${h}` : h
    );
  }
  return r;
}
...
function Ur(t, e, r, u) {
  ...
  if (o && a) {
    ...
    if (!d && !m) {
      ...
      Ut.includes(p.type) && Ie(O) && mt(O) && (l = l.slice(0, -1));
      const N = v[v.length - 1];
      if (Ut.includes(h.type) && Ie(N) && mt(N) && (v = v.slice(0, -1)), l.length !== v.length) return !1;
...
function yr(t, e, r) {
  ...
  for (var o = new Array(u), a = t.entries(), p, h, f = 0; (p = a.next()) && !p.done; ) {
    for (var d = e.entries(), m = !1, l = 0; (h = d.next()) && !h.done; ) {
      ...
      if (r.equals(v[0], O[0], f, l, t, e, r) && r.equals(v[1], O[1], v[0], O[0], t, e, r)) {
        m = o[l] = !0;
        break;
      }
      l++;
...
function Au(t) {
  ...
  return function(N, y, j) {
    ...
    if (F === Set)
      return m(N, y, j);
    var U = vu(N);
    return U === cu ? r(N, y, j) : U === du ? d(N, y, j) : U === fu ? a(N, y, j) : U === mu ? m(N, y, j) : U === pu ? typeof N.then != "function" && typeof y.then != "function" && h(N, y, j) : U === Eu ? v(N, y, j) : U === lu ? u(N, y, j) : U === au ? h(N, y, j) : U === su || U === hu || U === gu ? f(N, y, j) : !1;
  };
}
function bu(t) {
  ...
  verseRefToUsjContentLocation(e, r = 0) {
    ...
    return this.findNextMatchingNode(
      ...
      (v, O) => {
        ...
        if (typeof v == "string") {
          if (d += v.length, d > r)
            return p = ce.convertWorkingStackToJsonPath(O), m = r - d + v.length, l = v, !0;
  ...
  findNextLocationOfMatchingText(e, r, u = 1e3) {
    ...
    if (ce.findNextMatchingNodeUsingWorkingStack(
      ...
      (l) => {
        ...
        a += l.length, o = `${o}${l}`;
        const v = o.indexOf(r);
        return v < 0 ? (p += o.length, o.length > r.length && (o = o.substring(o.length - r.length)), p -= o.length, a > u) : (h = p + v, !0);
      }
    ), h <= 0) return;
    a = 0;
    let f = 0, d = [];
