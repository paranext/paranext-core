...
var ae = (s, e, t) => e in s ? se(s, e, { enumerable: !0, configurable: !0, writable: !0, value: t }) : s[e] = t;
var k = (s, e, t) => ae(s, typeof e != "symbol" ? e + "" : e, t);
import { d as T, i as _ } from "./scripture-util-DArajUVn.js";
import { D as Lt, F as Bt, a as Vt, b as zt, G as Ht, L as Jt, M as Kt, S as Gt, c as Yt, e as Xt, f as Wt, g as Zt, h as Qt, j as er, k as tr, l as rr, m as nr, n as ir, o as sr, p as ar, q as or, r as cr, s as dr, t as pr, u as lr, v as ur, w as hr, x as fr, y as mr, z as gr, A as yr, B as kr, C as br, E as vr, H as xr, I as Mr, J as _r, K as Er, N as Ir, O as Sr, P as wr, Q as Pr, R as Tr, T as Cr, U as Ar, V as qr, W as $r, X as jr, Y as Nr, Z as Or, _ as Fr, $ as Rr, a0 as Ur, a1 as Dr, a2 as Lr, a3 as Br, a4 as Vr, a5 as zr, a6 as Hr, a7 as Jr, a8 as Kr, a9 as Gr, aa as Yr, ab as Xr, ac as Wr, ad as Zr } from "./scripture-util-DArajUVn.js";
import { Mutex as oe } from "async-mutex";
...
class fe {
  ...
  constructor(e, t) {
    ...
    k(this, "latestOutput");
    k(this, "options");
    k(this, "onDidRebuildEmitter", new he());
...
class Ye {
  ...
  get(e) {
    ...
    return t || (t = new ge(), this.mutexesByID.set(e, t), t);
  }
  /**
...
class We {
  ...
  cleanupPromiseChain(e) {
    ...
    if (!t) return;
    const r = { promise: ke }, i = t.catch((n) => this.logger.warn(`Error in promise for ${e}: ${n.message}`)).finally(() => {
...
const G = 1e4, j = G / 1e3, Y = 3, B = /* @__PURE__ */ new Map(), be = {
  unsubscribed: {
    ...
    suppressed: (s, e) => `UnsubscriberAsyncList ${s}: ${e} more unsubscribers arrived after the list was run in the last ${j}s and were unsubscribed immediately; per-occurrence warnings suppressed.`
  },
  failed: {
    log: (s) => console.error(s),
    first: (s) => `UnsubscriberAsyncList ${s}: Unsubscriber added after the list was run failed!`,
    suppressed: (s, e) => `UnsubscriberAsyncList ${s}: ${e} more unsubscribers added after the list was run failed in the last ${j}s; per-occurrence errors suppressed.`
  },
  threw: {
    log: (s) => console.error(s),
    ...
    suppressed: (s, e, t) => `UnsubscriberAsyncList ${s}: ${e} more unsubscribers added after the list was run threw in the last ${j}s; per-occurrence errors suppressed. Distinct errors sampled (up to ${Y}): ${t.join(" | ")}`
  }
};
function V(s, e, t) {
  const { log: r, first: i, suppressed: n } = be[e], c = `${s}\0${e}`, p = Date.now(), d = B.get(c);
  if (!d || p >= d.closesAt) {
    r(i(s, t)), B.set(c, {
      closesAt: p + G,
      suppressedCount: 0,
...
const et = "ABORTED", tt = "ALREADY_EXISTS", rt = "CANCELLED", nt = "DATA_LOSS", it = "DEADLINE_EXCEEDED", st = "FAILED_PRECONDITION", at = "INTERNAL", ot = "INVALID_ARGUMENT", ct = "NOT_FOUND", dt = "OUT_OF_RANGE", pt = "PERMISSION_DENIED", lt = "RESOURCE_EXHAUSTED", ut = "UNAUTHENTICATED", ht = "UNAVAILABLE", ft = "UNIMPLEMENTED", mt = "UNKNOWN", A = 1;
function gt(s, e) {
  if (!s)
    return {
      message: "",
...
const kt = (s) => (...e) => s.map((r) => r(...e)).every((r) => r), bt = (s) => async (...e) => {
  const t = s.map(async (r) => r(...e));
  return (await Promise.all(t)).every((r) => r);
}, ve = "book", z = "chapter", E = "verse", I = "***", xe = "ws";
...
function Ee(s, e) {
  ...
  return Object.keys(t).forEach((n) => {
    i && (Object.hasOwn(r, n) && Ee(r[n], t[n]) || (i = !1));
  }), i;
}
function H(s, e, t) {
...
const St = (s) => s.replace(/&/g, "&amp;").replace(/</g, "&lt;").replace(/>/g, "&gt;").replace(/"/g, "&quot;").replace(/'/g, "&#x27;").replace(/\//g, "&#x2F;");
function wt() {
  return typeof navigator < "u" && navigator.languages ? navigator.languages[0].replace(/@posix$/i, "") : new le().resolvedOptions().locale;
}
function Pt(s, e = 2) {
...
const Se = 1e3, Z = 60, Q = Z * 60, we = Q * 24;
function Ct(s, e, t = /* @__PURE__ */ new Date()) {
  const r = Math.floor((e.getTime() - t.getTime()) / Se), i = Math.round(r / we);
...
function Ft(s, e, t) {
  ...
  return i.id = `${$e}${t ? `-${t}` : ""}`, i.dataset.themeId = s.id, i.textContent = Ne(s), this.document.head.appendChild(i), i;
}
function re(s) {
...
Object.freeze(P);
const ne = ["para", "table", "table:row", "table:cell", "sidebar"];
Object.freeze(ne);
const Oe = "chapter", J = new RegExp(`^${xe}\\d+$`), Fe = /\u00A0/g, Re = /\w+(\d+)/, Ue = /(\d+)-?(\d+)?/;
class m {
  constructor(e, t) {
    k(this, "usj");
    k(this, "markersMap");
...
USJ: ${JSON.stringify(
    ...
    else if (m.areUsjVersionsCompatible(this.usj.version, O.version))
      this.markersMap = O;
    else
      throw new Error(
  ...
  findAllNotes() {
    var e;
    return _e((e = this.usj) == null ? void 0 : e.content);
  }
  /**
  ...
  static findNearestBlockAncestor(e) {
    for (let t = e.length - 1; t >= 0; t--) {
      const { parent: r } = e[t];
      if (r && "type" in r && ne.includes(r.type)) return r;
    }
  }
  /**
  ...
  collectSearchText(e, t) {
    ...
    for (; b !== void 0; )
      b = m.findNextMatchingNodeUsingWorkingStack(
        ...
        (u, h) => {
          if (typeof u != "string")
            return t && u && "type" in u && u.type === Oe && (l = !0), !1;
          if (e && h.some((y) => {
            const v = y.parent;
...
`);
    ...
    return i.push({ fragment: e, indexInUsfm: r.length }), r += p === "optbreak" ? "//" : `\\${b}`, p !== "optbreak" && (i.push({
      ...
      i.push({
        ...
        if ("isClosingMarker" in M.fragment) {
          const { isClosingMarker: $, ...S } = M.fragment, ie = {
            ...S,
            forMarker: e,
  ...
  closingMarkerToUsfm(e, t) {
    ...
    if ((f.closed === "false" || n.isClosingMarkerOptional && !this.markersMap.shouldOptionalClosingMarkersBePresent && f.closed !== "true") && (b = !1), n.independentClosingMarkers && n.independentClosingMarkers.length > 0 && b) {
      ...
      let y = "";
      const v = [], { usfm: x, fragmentsInfo: M } = this.openingMarkerToUsfm(g, t), $ = M.find((S) => m.isFragmentAMarker(S.fragment));
      if (!$)
        throw new Error(
...
`) && (n.length === 0 ? (p = p.map((u) => ({
 ...
 `);
  ...
  static areUsjDocumentLocationsEqual(e, t, r = !1) {
    ...
    return !r && !N(w.toPathArray(i), w.toPathArray(c)) ? !1 : N(n, p);
  }
  ...
  static transferFragmentsInfoArrayToMaps(e, t, r, i, n, c) {
    e.map((d) => {
      ...
      if (typeof d.fragment == "object" && "type" in d.fragment) {
        ...
        if (h.type === ve && h.code)
        ...
        else if (h.type === z && h.number) {
          const g = parseInt(h.number, 10);
          if (Number.isNaN(g))
            console.warn(
              `Found ${z} type marker with number ${h.number}, but could not parse chapter number from it. Continuing using previous chapter number ${r.chapterNum}`
            );
          else {
          ...
          const g = (f = Ue.exec(h.number)) == null ? void 0 : f[1];
          if (!g)
            console.warn(
  ...
  calculateUsfmProperties() {
    let e = "";
    const t = new L(), r = /* @__PURE__ */ new Map(), i = {}, n = [], c = {
      bookId: I,
      chapterNum: 0,
      verseNum: 0
    };
...
export {
  ...
  Ke as Collator,
  nt as DATA_LOSS,
  it as DEADLINE_EXCEEDED,
  Lt as DEBOUNCE_CANCELED_ERROR_MESSAGE,
  le as DateTimeFormat,
  fe as DocumentCombiner,
  Ge as EventRollingTimeCounter,
  st as FAILED_PRECONDITION,
  Bt as FIRST_SCR_BOOK_NUM,
  Vt as FIRST_SCR_CHAPTER_NUM,
  zt as FIRST_SCR_VERSE_NUM,
  Ht as GraphemeString,
  at as INTERNAL,
  ot as INVALID_ARGUMENT,
  Jt as LAST_SCR_BOOK_NUM,
  Kt as MAX_PADDING_LENGTH,
  qt as MODIFIER_KEYS,
  a as MarkerType,
  ge as Mutex,
  Ye as MutexMap,
  ct as NOT_FOUND,
  Xe as NonValidatingDocumentCombiner,
  ye as NumberFormat,
  dt as OUT_OF_RANGE,
  pt as PERMISSION_DENIED,
  A as PLATFORM_ERROR_VERSION,
  he as PlatformEventEmitter,
  We as PromiseChainingMap,
  lt as RESOURCE_EXHAUSTED,
  xe as SEARCH_WHITESPACE_GROUP_PREFIX,
  Gt as SELECTABLE_INVISIBLE_CHAR_OR_WHITESPACE_CLASS,
  Yt as Section,
  L as SortedNumberMap,
  Ze as SortedSet,
  $e as THEME_STYLE_ELEMENT_ID,
  ut as UNAUTHENTICATED,
  ht as UNAVAILABLE,
  ft as UNIMPLEMENTED,
  mt as UNKNOWN,
  O as USFM_MARKERS_MAP_3_0,
  Rt as USFM_MARKERS_MAP_PARATEXT_3_0,
  Qe as UnsubscriberAsyncList,
  m as UsjReaderWriter,
  E as VERSE_TYPE,
  bt as aggregateUnsubscriberAsyncs,
  kt as aggregateUnsubscribers,
  Ft as applyThemeStylesheet,
  Xt as areUsjContentsEqualExceptWhitespace,
  Wt as at,
  Zt as charAt,
  Qt as codePointAt,
  er as collapseMiddleWords,
  tr as collectUsjMarkers,
  rr as compareScrRefs,
  ...
  sr as defaultScrRef,
  Ie as deserialize,
  Nt as doesCatalogRowCoverProject,
  ar as endsWith,
  or as ensureArray,
  cr as escapeStringRegexp,
  Ot as expandThemeContribution,
  Pt as formatBytes,
  At as formatRelativeDate,
  dr as formatReplacementString,
  pr as formatReplacementStringToArray,
  lr as formatScrRef,
  ur as formatScrRefRange,
  Ct as formatTimeSpan,
  hr as getAllObjectFunctionNames,
  fr as getChaptersForBook,
  wt as getCurrentLocale,
  W as getDefaultCallerSequence,
  mr as getErrorMessage,
  _t as getFormatCallerFunction,
  $t as getLocalizeKeyForPhysicalKey,
  gr as getLocalizeKeyForScrollGroupId,
  yr as getLocalizeKeysForScrollGroupIds,
  kr as getLocalizedIdFromBookNumber,
  Me as getNthCaller,
  Et as getPaneSizeLimits,
  br as getSectionForBook,
  Ne as getStylesheetForTheme,
  vr as groupBy,
  St as htmlEncode,
  xr as includes,
  Mr as indexOf,
  vt as isBlockMarker,
  xt as isCharacterMarker,
  _r as isErrorMessageAboutParatextBlockingInternetAccess,
  Er as isErrorMessageAboutRegistryAuthFailure,
  Ir as isLocalizeKey,
  yt as isPlatformError,
  Sr as isSelectableInvisibleCharOrWhiteSpace,
  It as isSerializable,
  _ as isString,
  Ee as isSubset,
  wr as isWhiteSpace,
  Pr as isolateBidi,
  Tr as lastIndexOf,
  Ce as localizedStringsDocumentSchema,
  Ae as menuDocumentSchema,
  Cr as newGuid,
  gt as newPlatformError,
  Ar as normalize,
  Tt as normalizeProjectId,
  qr as normalizeScriptureSpaces,
  $r as offsetBook,
  jr as offsetChapter,
  Nr as offsetVerse,
  ...
  Fr as padEnd,
  Rr as padStart,
  Pe as projectSettingsDocumentSchema,
  Ur as retryUntil,
  Mt as sanitizeHtml,
  Dr as scrRefToBBBCCC,
  Lr as scrRefToBBBCCCVVV,
  H as serialize,
  Te as settingsDocumentSchema,
  Br as slice,
  Vr as split,
  zr as startsWith,
  Hr as stringLength,
  ...
  Kr as toArray,
  Gr as toKebabCase,
  Yr as transformAndEnsureRegExpArray,
  Xr as transformAndEnsureRegExpRegExpArray,
  X as usfmMarkers,
  Wr as wait,
  Zr as waitForDuration
};
