...
var d = (t, e, r) => (xe(t, typeof e != "symbol" ? e + "" : e, r), r);
...
class Je {
  ...
  constructor(e, r) {
    ...
    d(this, "latestOutput");
    d(this, "options");
    d(this, "onDidRebuildEmitter", new Me());
...
var Q = typeof globalThis < "u" ? globalThis : typeof window < "u" ? window : typeof global < "u" ? global : typeof self < "u" ? self : {}, C = {}, nt = () => {
  const t = "\\ud800-\\udfff", e = "\\u0300-\\u036f", r = "\\ufe20-\\ufe2f", s = "\\u20d0-\\u20ff", n = "\\u1ab0-\\u1aff", i = "\\u1dc0-\\u1dff", o = e + r + s + n + i, a = "\\ufe0e\\ufe0f", h = "\\uD83D\\uDC69\\uD83C\\uDFFB\\u200D\\uD83C\\uDF93", p = `[${t}]`, u = `[${o}]`, c = "\\ud83c[\\udffb-\\udfff]", m = `(?:${u}|${c})`, v = `[^${t}]`, b = "(?:\\uD83C[\\uDDE6-\\uDDFF]){2}", P = "[\\ud800-\\udbff][\\udc00-\\udfff]", q = "\\u200d", Ce = "(?:\\ud83c\\udff4\\udb40\\udc67\\udb40\\udc62\\udb40(?:\\udc65|\\udc73|\\udc77)\\udb40(?:\\udc6e|\\udc63|\\udc6c)\\udb40(?:\\udc67|\\udc74|\\udc73)\\udb40\\udc7f)", Ie = `[${h}]`, H = `${m}?`, L = `[${a}]?`, Ae = `(?:${q}(?:${[v, b, P].join("|")})${L + H})*`, Te = L + H + Ae, Pe = `(?:${[`${v}${u}?`, u, b, P, p, Ie].join("|")})`;
...
const Mr = (t) => (...e) => t.map((s) => s(...e)).every((s) => s), kr = (t) => async (...e) => {
  const r = t.map(async (s) => s(...e));
  return (await Promise.all(r)).every((s) => s);
};
var Ot = Object.getOwnPropertyNames, $t = Object.getOwnPropertySymbols, jt = Object.prototype.hasOwnProperty;
function se(t, e) {
...
var xt = "[object Arguments]", Dt = "[object Boolean]", Rt = "[object Date]", Mt = "[object Map]", kt = "[object Number]", Vt = "[object Object]", qt = "[object RegExp]", zt = "[object Set]", Jt = "[object String]", Gt = Array.isArray, le = typeof ArrayBuffer == "function" && ArrayBuffer.isView ? ArrayBuffer.isView : null, ce = Object.assign, _t = Object.prototype.toString.call.bind(Object.prototype.toString);
function Ft(t) {
  ...
  return function(u, c, m) {
    ...
    if (v === Set)
      return a(u, c, m);
    var b = _t(u);
    return b === Rt ? r(u, c, m) : b === qt ? o(u, c, m) : b === Mt ? s(u, c, m) : b === zt ? a(u, c, m) : b === Vt ? typeof u.then != "function" && typeof c.then != "function" && n(u, c, m) : b === xt ? n(u, c, m) : b === Dt || b === kt || b === Jt ? i(u, c, m) : !1;
  };
}
function Kt(t) {
  var e = t.circular, r = t.createCustomConfig, s = t.strict, n = {
    areArraysEqual: s ? x : Ct,
    areDatesEqual: It,
    areMapsEqual: s ? se(ae, x) : ae,
    areObjectsEqual: s ? x : At,
    arePrimitiveWrappersEqual: Tt,
    areRegExpsEqual: Pt,
    areSetsEqual: s ? se(ue, x) : ue,
    areTypedArraysEqual: s ? x : Bt
  };
  if (r && (n = ce({}, n, r(n))), e) {
...
function O(t) {
  t === void 0 && (t = {});
  var e = t.circular, r = e === void 0 ? !1 : e, s = t.createInternalComparator, n = t.createState, i = t.strict, o = i === void 0 ? !1 : i, a = Kt(t), h = Ft(a), p = s ? s(h) : Xt(h);
  return Ht({ circular: r, comparator: h, createState: n, equals: p, strict: o });
}
function Ut(t, e) {
  return Lt(t, e);
}
function Wt(t, e) {
  ...
  return Object.keys(r).forEach((i) => {
    n && (Object.hasOwn(s, i) && Wt(s[i], r[i]) || (n = !1));
  }), n;
}
function fe(t, e, r) {
...
const qr = (t) => t.replace(/&/g, "&amp;").replace(/</g, "&lt;").replace(/>/g, "&gt;").replace(/"/g, "&quot;").replace(/'/g, "&#x27;").replace(/\//g, "&#x2F;");
function zr() {
  return typeof navigator < "u" && navigator.languages ? navigator.languages[0] : new Re().resolvedOptions().locale;
}
function Jr(t, e = 2) {
  if (t === 0)
    return "0 Bytes";
...
export {
  ...
  R as indexOf,
  jr as isLocalizeKey,
  Vr as isSerializable,
  ke as isString,
  Wt as isSubset,
  bt as lastIndexOf,
  er as localizedStringsDocumentSchema,
  tr as menuDocumentSchema,
  ar as newGuid,
  wr as normalize,
  Tr as offsetBook,
  Pr as offsetChapter,
