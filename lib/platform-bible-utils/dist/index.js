...
function kr() {
  ...
  ), w = a("EMPTY", "|", "ANY", "|", R, "|", _), I = "<!ELEMENT", L = o(I, m, a(W, "|", ne), m, a(w, "|", ne), l, ">"), V = o("NOTATION", m, /\(/, l, y, a(l, /\|/, l, y), "*", l, /\)/), pe = o(/\(/, l, q, a(l, /\|/, l, q), "*", l, /\)/), we = a(V, "|", pe), Ae = a(/CDATA|ID|IDREF|IDREFS|ENTITY|ENTITIES|NMTOKEN|NMTOKENS/, "|", we), oe = a(/#REQUIRED|#IMPLIED/, "|", a(a("#FIXED", m), "?", g)), P = a(m, y, m, Ae, m, oe), Ue = "<!ATTLIST", Re = o(Ue, m, y, P, "*", l, ">"), de = "about:legacy-compat", Ve = a('"' + de + '"', "|", "'" + de + "'"), _e = "SYSTEM", Se = "PUBLIC", ke = a(a(_e, m, te), "|", a(Se, m, b, m, te)), ze = o(
    "^",
    a(
  ...
  ), Je = a(m, "NDATA", m, y), ye = a(he, "|", a(ke, Je, "?")), Q = "<!ENTITY", Ge = o(Q, m, y, m, ye, l, ">"), ae = a(he, "|", ke), Xe = o(Q, m, "%", m, y, m, ae, l, ">"), vt = a(Ge, "|", Xe), Ye = o(Se, m, b), Ke = o("<!NOTATION", m, y, m, a(ke, "|", Ye), l, ">"), $ = o(l, "=", l), Z = /1[.]\d+/, Ne = o(m, "version", $, a("'", Z, "'", "|", '"', Z, '"')), be = /[A-Za-z][-A-Za-z0-9._]*/, We = a(m, "encoding", $, a('"', be, '"', "|", "'", be, "'")), st = a(m, "standalone", $, a("'", a("yes", "|", "no"), "'", "|", '"', a("yes", "|", "no"), '"')), ct = o(/^<\?xml/, Ne, We, "?", st, "?", l, /\?>/), lt = "<!DOCTYPE", At = "<![CDATA[", Nt = "]]>", ft = /<!\[CDATA\[/, Qe = /\]\]>/, ht = o(h, "*?", Qe), Ot = o(ft, ht);
...
function Fr() {
  ...
  function qe(n, i, s, c) {
    ...
    switch (n.nodeType) {
      case G:
        var Y = n.attributes, se = Y.length, ge = n.firstChild, Ee = n.tagName, Ce = Ee;
  ...
  function kt(n, i, s) {
    ...
    switch (i.childNodes && (c.childNodes = new w()), c.ownerDocument = n, c.nodeType) {
      case G:
        var Y = i.attributes, se = c.attributes = new V(), Ee = Y.length;
        se._ownerElement = c;
...
function bn() {
  ...
  function ne(E, b, S, T, M) {
    ...
    function _($) {
      if ($ > oe) {
        var Z = E.substring(oe, $).replace(U, X);
    ...
    for (var we = [{ currentNSMap: b }], Ae = [], oe = 0; ; ) {
      try {
        var P = E.indexOf("<", oe);
        if (P < 0) {
          if (!A && Ae.length > 0)
            return M.fatalError("unclosed xml tag(s): " + Ae.join(", "));
          if (!E.substring(oe).match(/^\s*$/)) {
            var Ue = T.doc, Re = Ue.createTextNode(E.substring(oe));
        ...
        switch (E.charAt(P + 1)) {
          ...
          // end element
          case "?":
            V && pe(P), ae = te(E, P, T, M);
            break;
          case "!":
            V && pe(P), ae = Ie(E, P, T, M, A);
            break;
          default:
            V && pe(P);
            var Q = new Be(), Ge = we[we.length - 1].currentNSMap, ae = g(E, P, Q, Ge, X, M, A), Xe = Q.length;
            if (Q.closed || (A && t.isHTMLVoidElement(Q.tagName) ? Q.closed = !0 : Ae.push(Q.tagName)), V && Xe) {
              ...
              x(Q, T, Ge) && we.push(Q);
            A && !Q.closed ? ae = k(E, ae, Q.tagName, X, T) : ae++;
        }
      } catch ($) {
        if ($ instanceof f)
          throw $;
...
const Ut = ["chapter", "book", "para", "row", "sidebar", jt], _n = "​", jr = [
  ...
  book: le.bookNumberToId(
    Math.max(
      Pn,
      Math.min(le.bookIdToNumber(t.book) + e, Ln)
    )
  ),
  chapterNum: 1,
  verseNum: 1
...
function Ci(t) {
  return new Lr(le.bookIdToNumber(t.book), t.chapterNum, t.verseNum).BBBCCC;
}
function dr(t) {
  return new Lr(le.bookIdToNumber(t.book), t.chapterNum, t.verseNum).BBBCCCVVV;
}
function Ti(t, e) {
  return dr(t) - dr(e);
}
...
function qi(t, e, r = /* @__PURE__ */ new Date()) {
