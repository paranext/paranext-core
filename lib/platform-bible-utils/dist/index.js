...
function kr() {
  ...
  ), Je = a(m, "NDATA", m, y), ye = a(fe, "|", a(ke, Je, "?")), Q = "<!ENTITY", ze = o(Q, m, y, m, ye, l, ">"), ae = a(fe, "|", ke), Xe = o(Q, m, "%", m, y, m, ae, l, ">"), vt = a(ze, "|", Xe), Ye = o(Se, m, N), Ke = o("<!NOTATION", m, y, m, a(ke, "|", Ye), l, ">"), $ = o(l, "=", l), Z = /1[.]\d+/, Ae = o(m, "version", $, a("'", Z, "'", "|", '"', Z, '"')), be = /[A-Za-z][-A-Za-z0-9._]*/, We = a(m, "encoding", $, a('"', be, '"', "|", "'", be, "'")), st = a(m, "standalone", $, a("'", a("yes", "|", "no"), "'", "|", '"', a("yes", "|", "no"), '"')), ct = o(/^<\?xml/, Ae, We, "?", st, "?", l, /\?>/), lt = "<!DOCTYPE", At = "<![CDATA[", bt = "]]>", ft = /<!\[CDATA\[/, Qe = /\]\]>/, ht = o(h, "*?", Qe), Ot = o(ft, ht);
