...
function Fr() {
  ...
  var O = n(v), b = o("[", O, n(/[-.0-9\xB7]/), n(/[\u0300-\u036F\u203F-\u2040]/), "]"), C = o(v, b, "*"), $ = o(b, "+"), B = o("&", C, ";"), k = a(/&#[0-9]+;|&#x[0-9a-fA-F]+;/), j = a(B, "|", k), ne = o("%", C, ";"), le = a(
    ...
    "|",
    o("'", a(/[^%&']/, "|", ne, "|", $), "*", "'")
  ), g = a('"', a(/[^<&"]/, "|", $), "*", '"', "|", "'", a(/[^<&']/, "|", $), "*", "'"), x = i(v, ":"), F = i(b, ":"), z = o(x, F, "*"), K = o(z, a(":", z), "?"), ee = o("^", K, "$"), Ie = o("(", K, ")"), te = a(/"[^"]*"|'[^']*'/), Be = o(/^<\?/, "(", C, ")", a(E, "(", p, "*?)"), "?", /\?>/), d = /[\x20\x0D\x0Aa-zA-Z0-9-'()+,./:=?;!*#@$_%]/, N = a('"', d, '*"', "|", "'", i(d, "'"), "*'"), w = "<!--", y = "-->", M = o(w, a(i(p, "-"), "|", o("-", i(p, "-"))), "*", y), A = "#PCDATA", B = a(
    o(/\(/, l, A, a(l, /\|/, l, K), "*", l, /\)\*/),
    "|",
    o(/\(/, l, A, l, /\)/)
  ), X = /[?*+]?/, _ = o(
...
function kr() {
  ...
  var F = {}, z = F.ELEMENT_NODE = 1, K = F.ATTRIBUTE_NODE = 2, ee = F.TEXT_NODE = 3, Ie = F.CDATA_SECTION_NODE = 4, te = F.ENTITY_REFERENCE_NODE = 5, Be = F.ENTITY_NODE = 6, d = F.PROCESSING_INSTRUCTION_NODE = 7, N = F.COMMENT_NODE = 8, w = F.DOCUMENT_NODE = 9, y = F.DOCUMENT_TYPE_NODE = 10, M = F.DOCUMENT_FRAGMENT_NODE = 11, A = F.NOTATION_NODE = 12, B = t.freeze({
  ...
  P.prototype = {
    ...
    compareDocumentPosition: function(r) {
      ...
      for (var Ue in Ze.childNodes) {
        ...
        if (ye.indexOf(Oe) >= 0) return B.DOCUMENT_POSITION_FOLLOWING;
...
function An() {
    ...
    for (var we = [{ currentNSMap: N }], ve = [], ie = 0; ; ) {
      try {
        ...
        switch (d.charAt(P + 1)) {
          ...
          default:
            V && fe(P);
            var Q = new Be(), ze = we[we.length - 1].currentNSMap, oe = g(d, P, Q, ze, J, M, A), Xe = Q.length;
  ...
  function x(d, N, w) {
    for (var y = d.tagName, M = null, L = d.length; L--; ) {
      ...
      A.localName = T, I !== !1 && (M == null && (M = /* @__PURE__ */ Object.create(null), z(w, w = /* @__PURE__ */ Object.create(null))), w[I] = M[I] = J, A.uri = p.XMLNS, N.startPrefixMapping(I, J));
    }
...
`);
  ...
  b.prototype.parseFromString = function(g, x) {
    ...
    h(x) ? (z = i.HTML_ENTITIES, K = E.HTML) : x === m.XML_SVG_IMAGE && (K = E.SVG), F[""] = K, F.xml = F.xml || E.XML;
    ...
    return Be && typeof g != "string" && te.errorHandler.fatalError("source is not a string"), te.parse(this.normalizeLineEndings(String(g)), F, z), ee.doc.documentElement || te.errorHandler.fatalError("missing root element"), ee.doc;
  };
  function C(g) {
    var x = g || {};
  ...
  C.prototype = {
    ...
    startElement: function(g, x, F, z) {
      ...
      for (var te = 0; te < Ie; te++) {
        var g = z.getURI(te), Be = z.getValue(te), F = z.getQName(te), d = K.createAttributeNS(g, F);
    ...
    characters: function(g, x, F) {
      if (g = k.apply(this, arguments), g) {
        ...
        this.currentElement ? this.currentElement.appendChild(z) : /^\s*$/.test(g) && this.doc.appendChild(z), this.locator && j(this.locator, z);
      }
    },
    ...
    comment: function(g, x, F) {
      ...
      this.locator && j(this.locator, z), $(this, z);
    },
    startCDATA: function() {
      this.cdata = !0;
    },
...
function jr(t, e, n, i) {
  ...
  if (o && a) {
    ...
    if (!m && !E) {
      ...
      if (jt.includes(p.type) && Me(b) && mt(b) && (v = v.slice(0, -1)), l.length !== v.length) return !1;
...
var $n = Object.getOwnPropertyNames, Vn = Object.getOwnPropertySymbols, zn = Object.prototype.hasOwnProperty;
function vr(t, e) {
...
function Vr(t, e, n, i) {
  return (i === Xn || i === Jn || i === Hn) && (t.$$typeof || e.$$typeof) ? !0 : Gn(e, i) && n.equals(t[i], e[i], i, i, t, e, n);
}
...
class Ee {
  ...
  verseRefToUsjContentLocation(e, n = 0) {
    ...
    const h = e.verse ?? e.verseNum.toString(), f = this.findNextMatchingNode(
      o,
      je,
      (v, O) => v === o ? e.verseNum === 0 ? (h = Ee.convertWorkingStackToJsonPath(O), !0) : !1 : typeof v != "object" ? !1 : v.type === Mt ? (a = !0, !0) : v.type === Bt && v.number !== void 0 && v.number === p ? (h = Ee.convertWorkingStackToJsonPath(O), !0) : !1
    );
...
export {
  ...
  Gu as createSyncProxyForAsyncObject,
  Uu as debounce,
  wt as deepClone,
  Cu as deepEqual,
  hi as defaultScrRef,
