...
var Te = (t, e, r) => e in t ? Ae(t, e, { enumerable: !0, configurable: !0, writable: !0, value: r }) : t[e] = r;
var m = (t, e, r) => (Te(t, typeof e != "symbol" ? e + "" : e, r), r);
...
class Re {
  ...
  addOrUpdateContribution(e, r) {
    ...
    let i = this.options.copyDocuments && r ? B(r) : r;
...
class ar {
  constructor() {
    m(this, "mutexesByID", /* @__PURE__ */ new Map());
  }
  get(e) {
    let r = this.mutexesByID.get(e);
    return r || (r = new Ve(), this.mutexesByID.set(e, r), r);
  }
}
var qe = Object.defineProperty, ze = (t, e, r) => e in t ? qe(t, e, { enumerable: !0, configurable: !0, writable: !0, value: r }) : t[e] = r, l = (t, e, r) => (ze(t, typeof e != "symbol" ? e + "" : e, r), r);
const S = [
  "GEN",
  "EXO",
  "LEV",
...
function Ge(t) {
  return (typeof t == "string" ? j(t) : t) <= 39;
}
function he(t) {
  return t <= 66;
}
...
const y = class f {
  constructor(e, r, s, i) {
    if (l(this, "firstChapter"), l(this, "lastChapter"), l(this, "lastVerse"), l(this, "hasSegmentsDefined"), l(this, "text"), l(this, "BBBCCCVVVS"), l(this, "longHashCode"), l(this, "versification"), l(this, "rtlMark", "‏"), l(this, "_bookNum", 0), l(this, "_chapterNum", 0), l(this, "_verseNum", 0), l(this, "_verse"), s == null && i == null)
      if (e != null && typeof e == "string") {
        const n = e, o = r != null && r instanceof C ? r : void 0;
        this.setEmpty(o), this.parse(n);
      } else if (e != null && typeof e == "number") {
        const n = r != null && r instanceof C ? r : void 0;
        this.setEmpty(n), this._verseNum = e % f.chapterDigitShifter, this._chapterNum = Math.floor(
          e % f.bookDigitShifter / f.chapterDigitShifter
        ), this._bookNum = Math.floor(e / f.bookDigitShifter);
      } else if (r == null)
        if (e != null && e instanceof f) {
          const n = e;
          this._bookNum = n.bookNum, this._chapterNum = n.chapterNum, this._verseNum = n.verseNum, this._verse = n.verse, this.versification = n.versification;
        } else {
          if (e == null)
            return;
          const n = e instanceof C ? e : f.defaultVersification;
          this.setEmpty(n);
        }
      else
    ...
    if (e = e.replace(this.rtlMark, ""), e.includes("/")) {
      ...
      if (e = n[0], n.length > 1)
        try {
          ...
          throw new M("Invalid reference : " + e);
        }
    }
  ...
  allVerses(e = !1, r = f.verseRangeSeparators, s = f.verseSequenceIndicators) {
    if (this._verse == null || this.chapterNum <= 0)
      return [this.clone()];
    const i = [], n = W(this._verse, s);
    for (const o of n.map((a) => W(a, r))) {
      const a = this.clone();
      a.verse = o[0];
      const h = a.verseNum;
...
var Q = typeof globalThis < "u" ? globalThis : typeof window < "u" ? window : typeof global < "u" ? global : typeof self < "u" ? self : {}, O = {}, We = () => {
  const t = "\\ud800-\\udfff", e = "\\u0300-\\u036f", r = "\\ufe20-\\ufe2f", s = "\\u20d0-\\u20ff", i = "\\u1ab0-\\u1aff", n = "\\u1dc0-\\u1dff", o = e + r + s + i + n, a = "\\ufe0e\\ufe0f", h = "\\uD83D\\uDC69\\uD83C\\uDFFB\\u200D\\uD83C\\uDF93", p = `[${t}]`, u = `[${o}]`, c = "\\ud83c[\\udffb-\\udfff]", d = `(?:${u}|${c})`, v = `[^${t}]`, b = "(?:\\uD83C[\\uDDE6-\\uDDFF]){2}", T = "[\\ud800-\\udbff][\\udc00-\\udfff]", x = "\\u200d", $e = "(?:\\ud83c\\udff4\\udb40\\udc67\\udb40\\udc62\\udb40(?:\\udc65|\\udc73|\\udc77)\\udb40(?:\\udc6e|\\udc63|\\udc6c)\\udb40(?:\\udc67|\\udc74|\\udc73)\\udb40\\udc7f)", Se = `[${h}]`, H = `${d}?`, L = `[${a}]?`, Oe = `(?:${x}(?:${[v, b, T].join("|")})${L + H})*`, Ce = L + H + Oe, je = `(?:${[`${v}${u}?`, u, b, T, p, Se].join("|")})`;
  return new RegExp(`${$e}|${c}(?=${c})|${je + Ce}`, "g");
}, Qe = Q && Q.__importDefault || function(t) {
...
function gr(t, e, r) {
  ...
  if (e > s || r && (e > r && !(e >= 0 && e < s && r < 0 && r > -s) || r < -s))
    return "";
  const i = Y(s, e), n = r ? Y(s, r) : void 0;
  return k(t, i, n);
}
function ee(t, e, r) {
  const s = [];
  if (r !== void 0 && r <= 0)
    return [t];
  if (e === "")
    return ct(t).slice(0, r);
  let i = e;
  (typeof e == "string" || e instanceof RegExp && !at(e.flags, "g")) && (i = new RegExp(e, "g"));
  const n = t.match(i);
  let o = 0;
  if (!n)
    return [t];
  for (let a = 0; a < (r ? r - 1 : n.length); a++) {
    const h = _(t, n[a], o), p = g(n[a]);
    if (s.push(k(t, o, h)), o = h + p, r !== void 0 && s.length === r)
      break;
  }
...
], ft = 1, ht = ve.length - 1, pt = 1, dt = 1, mt = (t) => {
  var e;
  return ((e = ve[t]) == null ? void 0 : e.chapters) ?? -1;
}, br = (t, e) => ({
  bookNum: Math.max(ft, Math.min(t.bookNum + e, ht)),
  chapterNum: 1,
  verseNum: 1
}), yr = (t, e) => ({
  ...t,
  chapterNum: Math.min(
    Math.max(pt, t.chapterNum + e),
    mt(t.bookNum)
  ),
  verseNum: 1
}), vr = (t, e) => ({
  ...t,
  verseNum: Math.max(dt, t.verseNum + e)
});
async function Nr(t, e, r) {
  const s = E.bookNumberToId(t);
  if (!lt(Intl.getCanonicalLocales(e)[0], "zh"))
    return r({
  ...
  return ee(n[0], "ÿ08")[0].trim();
}
const Er = (t) => (...e) => t.map((s) => s(...e)).every((s) => s), wr = (t) => async (...e) => {
  const r = t.map(async (s) => s(...e));
  return (await Promise.all(r)).every((s) => s);
};
var gt = Object.getOwnPropertyNames, bt = Object.getOwnPropertySymbols, yt = Object.prototype.hasOwnProperty;
function te(t, e) {
...
function D(t) {
  return function(r, s, i) {
    ...
    n.set(r, s), n.set(s, r);
    var h = t(r, s, i);
    return n.delete(r), n.delete(s), h;
  };
}
function re(t) {
  return gt(t).concat(bt(t));
}
...
function ne(t, e, r) {
  ...
  for (var s = {}, i = t.entries(), n = 0, o, a; (o = i.next()) && !o.done; ) {
    for (var h = e.entries(), p = !1, u = 0; (a = h.next()) && !a.done; ) {
      var c = o.value, d = c[0], v = c[1], b = a.value, T = b[0], x = b[1];
      !p && !s[u] && (p = r.equals(d, T, n, u, t, e, r) && r.equals(v, x, d, T, t, e, r)) && (s[u] = !0), u++;
    }
    if (!p)
      return !1;
    n++;
...
function Et(t, e, r) {
  ...
  if (ie(e).length !== i)
    return !1;
  for (var n; i-- > 0; )
    if (n = s[i], n === Ee && (t.$$typeof || e.$$typeof) && t.$$typeof !== e.$$typeof || !Ne(e, n) || !r.equals(t[n], e[n], n, n, t, e, r))
      return !1;
  return !0;
}
function P(t, e, r) {
  ...
  if (re(e).length !== i)
    return !1;
  for (var n, o, a; i-- > 0; )
    if (n = s[i], n === Ee && (t.$$typeof || e.$$typeof) && t.$$typeof !== e.$$typeof || !Ne(e, n) || !r.equals(t[n], e[n], n, n, t, e, r) || (o = se(t, n), a = se(e, n), (o || a) && (!o || !a || o.configurable !== a.configurable || o.enumerable !== a.enumerable || o.writable !== a.writable)))
      return !1;
  return !0;
}
function wt(t, e) {
...
function oe(t, e, r) {
  ...
  for (var s = {}, i = t.values(), n, o; (n = i.next()) && !n.done; ) {
    for (var a = e.values(), h = !1, p = 0; (o = a.next()) && !o.done; )
      !h && !s[p] && (h = r.equals(n.value, o.value, n.value, o.value, t, e, r)) && (s[p] = !0), p++;
    if (!h)
      return !1;
  }
  return !0;
...
var Ot = "[object Arguments]", Ct = "[object Boolean]", jt = "[object Date]", At = "[object Map]", Tt = "[object Number]", Mt = "[object Object]", Pt = "[object RegExp]", Bt = "[object Set]", Dt = "[object String]", kt = Array.isArray, ae = typeof ArrayBuffer == "function" && ArrayBuffer.isView ? ArrayBuffer.isView : null, ue = Object.assign, It = Object.prototype.toString.call.bind(Object.prototype.toString);
function Rt(t) {
  var e = t.areArraysEqual, r = t.areDatesEqual, s = t.areMapsEqual, i = t.areObjectsEqual, n = t.arePrimitiveWrappersEqual, o = t.areRegExpsEqual, a = t.areSetsEqual, h = t.areTypedArraysEqual;
  return function(u, c, d) {
    ...
    if (v === Set)
      return a(u, c, d);
    var b = It(u);
    return b === jt ? r(u, c, d) : b === Pt ? o(u, c, d) : b === At ? s(u, c, d) : b === Bt ? a(u, c, d) : b === Mt ? typeof u.then != "function" && typeof c.then != "function" && i(u, c, d) : b === Ot ? i(u, c, d) : b === Ct || b === Tt || b === Dt ? n(u, c, d) : !1;
  };
}
function xt(t) {
  var e = t.circular, r = t.createCustomConfig, s = t.strict, i = {
    areArraysEqual: s ? P : vt,
    areDatesEqual: Nt,
    areMapsEqual: s ? te(ne, P) : ne,
    areObjectsEqual: s ? P : Et,
    arePrimitiveWrappersEqual: wt,
    areRegExpsEqual: $t,
    areSetsEqual: s ? te(oe, P) : oe,
    areTypedArraysEqual: s ? P : St
  };
  if (r && (i = ue({}, i, r(i))), e) {
    var n = D(i.areArraysEqual), o = D(i.areMapsEqual), a = D(i.areObjectsEqual), h = D(i.areSetsEqual);
    i = ue({}, i, {
      areArraysEqual: n,
      areMapsEqual: o,
      areObjectsEqual: a,
...
function qt(t) {
  ...
  if (s)
    return function(h, p) {
      var u = s(), c = u.cache, d = c === void 0 ? e ? /* @__PURE__ */ new WeakMap() : void 0 : c, v = u.meta;
      return r(h, p, {
        cache: d,
        equals: i,
        meta: v,
...
function $(t) {
  t === void 0 && (t = {});
  var e = t.circular, r = e === void 0 ? !1 : e, s = t.createInternalComparator, i = t.createState, n = t.strict, o = n === void 0 ? !1 : n, a = xt(t), h = Rt(a), p = s ? s(h) : Vt(h);
  return qt({ circular: r, comparator: h, createState: i, equals: p, strict: o });
}
function Jt(t, e) {
  return zt(t, e);
}
function Gt(t, e) {
  ...
  if (Array.isArray(t)) {
    const n = e, o = t;
    return n.length === 0 ? !0 : n.every((a) => o.includes(a));
  }
  if (typeof t != "object")
    return Jt(t, e);
  const r = e, s = t;
  ...
  return Object.keys(r).forEach((n) => {
    i && (Object.hasOwn(s, n) && Gt(s[n], r[n]) || (i = !1));
  }), i;
}
function le(t, e, r) {
...
const Sr = (t) => t.replace(/&/g, "&amp;").replace(/</g, "&lt;").replace(/>/g, "&gt;").replace(/"/g, "&quot;").replace(/'/g, "&#x27;").replace(/\//g, "&#x2F;"), X = {
...
export {
  ...
  Ve as Mutex,
  ar as MutexMap,
  nr as NonValidatingDocumentCombiner,
  Pe as PlatformEventEmitter,
  or as UnsubscriberAsyncList,
  ...
  _t as deserialize,
  hr as endsWith,
  sr as getAllObjectFunctionNames,
  mt as getChaptersForBook,
  ...
  dr as padEnd,
  mr as padStart,
  Xt as projectSettingsDocumentSchema,
  le as serialize,
