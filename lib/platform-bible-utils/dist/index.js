...
function qr() {
  ...
  ), Je = a(m, "NDATA", m, y), ye = a(he, "|", a(ke, Je, "?")), Q = "<!ENTITY", ze = o(Q, m, y, m, ye, l, ">"), ae = a(he, "|", ke), Xe = o(Q, m, "%", m, y, m, ae, l, ">"), vt = a(ze, "|", Xe), Ye = o(Se, m, N), Ke = o("<!NOTATION", m, y, m, a(ke, "|", Ye), l, ">"), $ = o(l, "=", l), Z = /1[.]\d+/, be = o(m, "version", $, a("'", Z, "'", "|", '"', Z, '"')), Ne = /[A-Za-z][-A-Za-z0-9._]*/, We = a(m, "encoding", $, a('"', Ne, '"', "|", "'", Ne, "'")), st = a(m, "standalone", $, a("'", a("yes", "|", "no"), "'", "|", '"', a("yes", "|", "no"), '"')), ct = o(/^<\?xml/, be, We, "?", st, "?", l, /\?>/), lt = "<!DOCTYPE", At = "<![CDATA[", bt = "]]>", ft = /<!\[CDATA\[/, Qe = /\]\]>/, ht = o(p, "*?", Qe), It = o(ft, ht);
  return j.chars = r, j.chars_without = u, j.detectUnicodeSupport = t, j.reg = o, j.regg = a, j.ABOUT_LEGACY_COMPAT = de, j.ABOUT_LEGACY_COMPAT_SystemLiteral = Ve, j.AttlistDecl = Re, j.CDATA_START = At, j.CDATA_END = bt, j.CDSect = It, j.Char = p, j.Comment = M, j.COMMENT_START = S, j.COMMENT_END = T, j.DOCTYPE_DECL_START = lt, j.elementdecl = L, j.EntityDecl = vt, j.EntityValue = he, j.ExternalID = ke, j.ExternalID_match = He, j.Name = y, j.NotationDecl = Ke, j.Reference = U, j.PEReference = ne, j.PI = Be, j.PUBLIC = Se, j.PubidLiteral = N, j.QName = W, j.QName_exact = ee, j.QName_group = Ie, j.S = m, j.SChar_s = d, j.S_OPT = l, j.SYSTEM = _e, j.SystemLiteral = te, j.UNICODE_REPLACEMENT_CHARACTER = h, j.UNICODE_SUPPORT = e, j.XMLDecl = ct, j;
}
var or;
function $r() {
  if (or) return re;
  or = 1;
  var t = Dt(), e = t.find, r = t.hasDefaultHTMLNamespace, u = t.hasOwn, o = t.isHTMLMimeType, a = t.isHTMLRawTextElement, h = t.isHTMLVoidElement, p = t.MIME_TYPE, f = t.NAMESPACE, d = Symbol(), m = Pt(), l = m.DOMException, v = m.DOMExceptionName, C = qr();
  function b(n) {
    if (n !== d)
  ...
  oe.prototype = {
    ...
    createHTMLDocument: function(n) {
      var i = new de(d, { contentType: p.HTML });
  ...
  function qe(n, i, s, c) {
    ...
    switch (n.nodeType) {
      case G:
        ...
        var qt = !Ee;
        if (qt && (O || n.namespaceURI === f.HTML) && (qt = h(ge)), qt)
          i.push("/>");
        else {
          if (i.push(">"), O && a(ge))
            for (; Ee; )
...
function Tn() {
  if (sr) return Ct;
  sr = 1;
  var t = Dt(), e = qr(), r = Pt(), u = t.isHTMLEscapableRawTextElement, o = t.isHTMLMimeType, a = t.isHTMLRawTextElement, h = t.hasOwn, p = t.NAMESPACE, f = r.ParseError, d = r.DOMException, m = 0, l = 1, v = 2, C = 3, b = 4, y = 5, q = 6, B = 7;
  function F() {
  }
  F.prototype = {
...
function wn() {
  if (cr) return rt;
  cr = 1;
  var t = Dt(), e = $r(), r = Pt(), u = Cn(), o = Tn(), a = e.DOMImplementation, h = t.hasDefaultHTMLNamespace, p = t.isHTMLMimeType, f = t.isValidMimeType, d = t.MIME_TYPE, m = t.NAMESPACE, l = r.ParseError, v = o.XMLReader;
  function C(E) {
    return E.replace(/\r[\n\u0085]/g, `
`).replace(/[\r\u0085\u2028\u2029]/g, `
`);
...
function On() {
  return fr || (fr = 1, jt = () => {
    const t = "\\ud800-\\udfff", h = "\\u0300-\\u036f" + "\\ufe20-\\ufe2f" + "\\u20d0-\\u20ff" + "\\u1ab0-\\u1aff" + "\\u1dc0-\\u1dff", p = "\\ufe0e\\ufe0f", f = "\\uD83D\\uDC69\\uD83C\\uDFFB\\u200D\\uD83C\\uDF93", d = `[${t}]`, m = `[${h}]`, l = "\\ud83c[\\udffb-\\udfff]", v = `(?:${m}|${l})`, C = `[^${t}]`, b = "(?:\\uD83C[\\uDDE6-\\uDDFF]){2}", y = "[\\ud800-\\udbff][\\udc00-\\udfff]", q = "\\u200d", B = "(?:\\ud83c\\udff4\\udb40\\udc67\\udb40\\udc62\\udb40(?:\\udc65|\\udc73|\\udc77)\\udb40(?:\\udc6e|\\udc63|\\udc6c)\\udb40(?:\\udc67|\\udc74|\\udc73)\\udb40\\udc7f)", F = `[${f}]`, U = `${v}?`, ne = `[${p}]?`, he = `(?:${q}(?:${[C, b, y].join("|")})${ne + U})*`, E = ne + U + he, k = `(?:${[`${C}${m}?`, m, b, y, d, F].join("|")})`;
...
function zr(t, e, r, u) {
  ...
  if (o && a) {
    const h = Dr(t), p = Dr(r);
    if (h !== p) {
      if (!mt(Mt(h, -1) ?? "") && !mt(Mt(p, -1) ?? "") || !Ar(t, e) || !Ar(r, u)) return !1;
      let f = h;
...
function Fi(t, e = {}) {
  const {
    ...
    absoluteMaxPercent: h = 90
  } = e, p = t - r;
  let f, d;
  return p < u + o ? (f = a, d = h) : (d = Math.min(
    Math.floor((p - o) / p * 100),
    h
  ), f = Math.min(
    Math.max(Math.ceil(u / p * 100), a),
    d
...
function wu(t) {
  ...
  return function(b, y, q) {
    ...
    if (F === Set)
      return m(b, y, q);
    var U = Tu(b);
    return U === mu ? r(b, y, q) : U === Au ? d(b, y, q) : U === Eu ? a(b, y, q) : U === bu ? m(b, y, q) : U === vu ? typeof b.then != "function" && typeof y.then != "function" && p(b, y, q) : U === yu ? v(b, y, q) : U === gu ? u(b, y, q) : U === pu ? p(b, y, q) : U === du || U === Du || U === Nu ? f(b, y, q) : !1;
  };
}
function Su(t) {
  ...
  if (r && (o = Or({}, o, r(o))), e) {
    var a = _t(o.areArraysEqual), h = _t(o.areMapsEqual), p = _t(o.areObjectsEqual), f = _t(o.areSetsEqual);
    o = Or({}, o, {
      areArraysEqual: a,
      areMapsEqual: h,
      areObjectsEqual: p,
...
function Ge(t) {
  t === void 0 && (t = {});
  var e = t.circular, r = e === void 0 ? !1 : e, u = t.createInternalComparator, o = t.createState, a = t.strict, h = a === void 0 ? !1 : a, p = Su(t), f = wu(p), d = u ? u(f) : Ou(f);
  return Iu({ circular: r, comparator: f, createState: o, equals: d, strict: h });
}
function Mu(t, e) {
  return xu(t, e);
}
...
const $i = (t) => t.replace(/&/g, "&amp;").replace(/</g, "&lt;").replace(/>/g, "&gt;").replace(/"/g, "&quot;").replace(/'/g, "&#x27;").replace(/\//g, "&#x2F;");
function ji() {
...
function Vi(t, e, r = /* @__PURE__ */ new Date()) {
...
function zi(t, e, r, u, o = {
  year: "numeric",
  month: "short",
  day: "numeric"
}) {
  const a = /* @__PURE__ */ new Date(), h = new Date(a);
  h.setDate(h.getDate() - 1);
  const p = t.getDate() === a.getDate() && t.getMonth() === a.getMonth() && t.getFullYear() === a.getFullYear(), f = t.getDate() === h.getDate() && t.getMonth() === h.getMonth() && t.getFullYear() === h.getFullYear();
  return p ? e : f ? r : t.toLocaleString(u, o);
}
...
class ie {
  ...
  nodeToVerseRefAndOffset(e, r, u) {
    ...
    return a.startingContentNode !== void 0 && this.findNextMatchingNode(a.startingContentNode, [], (f, d) => {
      var m, l;
      return f === r ? !0 : d.find((v) => je.includes(v.parent.type)) ? !1 : typeof f == "string" ? (p += f.length, !1) : f.type === Bt && f.number !== ((m = a.chapterNum) == null ? void 0 : m.toString()) || f.type === Rt && f.number !== ((l = a.verseNum) == null ? void 0 : l.toString()) ? (p = 0, !0) : !1;
    }), { verseRef: h, offset: p };
  }
  // #endregion
  ...
  verseRefToUsjContentLocation(e, r = 0) {
    ...
    const p = e.verse ?? e.verseNum.toString(), f = this.findNextMatchingNode(
      o,
      je,
      (v, C) => v === o ? e.verseNum === 0 ? (h = ie.convertWorkingStackToJsonPath(C), !0) : !1 : typeof v != "object" ? !1 : v.type === Bt ? (a = !0, !0) : v.type === Rt && v.number !== void 0 && v.number === p ? (h = ie.convertWorkingStackToJsonPath(C), !0) : !1
    );
