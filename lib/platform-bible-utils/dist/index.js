...
var p = (t, e, r) => (te(t, typeof e != "symbol" ? e + "" : e, r), r);
class et {
  /**
...
], ue = 1, le = H.length - 1, ce = 1, fe = 1, he = (t) => {
  var e;
  return ((e = H[t]) == null ? void 0 : e.chapters) ?? -1;
}, ft = (t, e) => ({
  bookNum: Math.max(ue, Math.min(t.bookNum + e, le)),
  chapterNum: 1,
  verseNum: 1
}), ht = (t, e) => ({
  ...t,
  chapterNum: Math.min(
    Math.max(ce, t.chapterNum + e),
    he(t.bookNum)
  ),
  verseNum: 1
}), pt = (t, e) => ({
  ...t,
  verseNum: Math.max(fe, t.verseNum + e)
}), mt = (t) => (...e) => t.map((s) => s(...e)).every((s) => s), dt = (t) => async (...e) => {
  const r = t.map(async (s) => s(...e));
  return (await Promise.all(r)).every((s) => s);
};
var S = typeof globalThis < "u" ? globalThis : typeof window < "u" ? window : typeof global < "u" ? global : typeof self < "u" ? self : {}, v = {}, pe = () => {
  const t = "\\ud800-\\udfff", e = "\\u0300-\\u036f", r = "\\ufe20-\\ufe2f", s = "\\u20d0-\\u20ff", n = "\\u1ab0-\\u1aff", o = "\\u1dc0-\\u1dff", a = e + r + s + n + o, i = "\\ufe0e\\ufe0f", c = "\\uD83D\\uDC69\\uD83C\\uDFFB\\u200D\\uD83C\\uDF93", h = `[${t}]`, u = `[${a}]`, l = "\\ud83c[\\udffb-\\udfff]", f = `(?:${u}|${l})`, b = `[^${t}]`, m = "(?:\\uD83C[\\uDDE6-\\uDDFF]){2}", y = "[\\ud800-\\udbff][\\udc00-\\udfff]", q = "\\u200d", L = "(?:\\ud83c\\udff4\\udb40\\udc67\\udb40\\udc62\\udb40(?:\\udc65|\\udc73|\\udc77)\\udb40(?:\\udc6e|\\udc63|\\udc6c)\\udb40(?:\\udc67|\\udc74|\\udc73)\\udb40\\udc7f)", Z = `[${c}]`, M = `${f}?`, P = `[${i}]?`, X = `(?:${q}(?:${[b, m, y].join("|")})${P + M})*`, Q = P + M + X, Y = `(?:${[`${b}${u}?`, u, m, y, h, Z].join("|")})`;
  return new RegExp(`${L}|${l}(?=${l})|${Y + Q}`, "g");
}, me = S && S.__importDefault || function(t) {
...
function j(t) {
  ...
  return t.match($.default()) || [];
}
var de = v.toArray = j;
function C(t) {
  if (typeof t != "string")
    throw new Error("Input must be a string");
  var e = t.match($.default());
...
function U(t, e, r) {
  ...
  var s = t.match($.default());
  return s ? s.slice(e, r).join("") : "";
}
var Ne = v.substring = U;
function ve(t, e, r) {
  if (e === void 0 && (e = 0), typeof t != "string")
    throw new Error("Input must be a string");
  var s = C(t);
...
function Nt(t, e) {
  return e < 0 || e > d(t) - 1 ? "" : A(t, e, 1);
}
function vt(t, e) {
  if (!(e < 0 || e > d(t) - 1))
    return A(t, e, 1).codePointAt(0);
}
function gt(t, e, r = d(t)) {
  const s = $e(t, e);
  return !(s === -1 || s + d(e) !== r);
}
function yt(t, e, r = 0) {
...
function Et(t, e, r = " ") {
  return e <= d(t) ? t : F(t, e, r, "right");
}
function Ot(t, e, r = " ") {
  return e <= d(t) ? t : F(t, e, r, "left");
}
function T(t, e) {
...
function $t(t, e, r) {
  ...
  if (e > s || r && (e > r && !(e > 0 && e < s && r < 0 && r > -s) || r < -s || e < 0 && e > -s && r > 0))
    return "";
  const n = T(s, e), o = r ? T(s, r) : void 0;
  return k(t, n, o);
}
function A(t, e = 0, r = d(t) - e) {
  return ge(t, e, r);
}
function k(t, e, r = d(t)) {
  return Ne(t, e, r);
}
function At(t) {
  return de(t);
}
var Ae = Object.getOwnPropertyNames, qe = Object.getOwnPropertySymbols, je = Object.prototype.hasOwnProperty;
function D(t, e) {
...
var W = "_owner", I = Object.getOwnPropertyDescriptor, z = Object.keys;
function Ce(t, e, r) {
  var s = t.length;
  if (e.length !== s)
    return !1;
...
function _(t, e, r) {
  ...
  for (var s = {}, n = t.entries(), o = 0, a, i; (a = n.next()) && !a.done; ) {
    for (var c = e.entries(), h = !1, u = 0; (i = c.next()) && !i.done; ) {
      var l = a.value, f = l[0], b = l[1], m = i.value, y = m[0], q = m[1];
      !h && !s[u] && (h = r.equals(f, y, o, u, t, e, r) && r.equals(b, q, f, y, t, e, r)) && (s[u] = !0), u++;
    }
    if (!h)
      return !1;
    o++;
...
function Pe(t, e, r) {
  ...
  if (z(e).length !== n)
    return !1;
  for (var o; n-- > 0; )
    if (o = s[n], o === W && (t.$$typeof || e.$$typeof) && t.$$typeof !== e.$$typeof || !K(e, o) || !r.equals(t[o], e[o], o, o, t, e, r))
      return !1;
  return !0;
}
function w(t, e, r) {
  var s = R(t), n = s.length;
  if (R(e).length !== n)
    return !1;
  for (var o, a, i; n-- > 0; )
    if (o = s[n], o === W && (t.$$typeof || e.$$typeof) && t.$$typeof !== e.$$typeof || !K(e, o) || !r.equals(t[o], e[o], o, o, t, e, r) || (a = I(t, o), i = I(e, o), (a || i) && (!a || !i || a.configurable !== i.configurable || a.enumerable !== i.enumerable || a.writable !== i.writable)))
      return !1;
  return !0;
}
function Se(t, e) {
...
function Fe(t) {
  ...
  return function(u, l, f) {
    ...
    if (b === Set)
      return i(u, l, f);
    var m = Ue(u);
    return m === ze ? r(u, l, f) : m === xe ? a(u, l, f) : m === _e ? s(u, l, f) : m === Be ? i(u, l, f) : m === Ge ? typeof u.then != "function" && typeof l.then != "function" && n(u, l, f) : m === Re ? n(u, l, f) : m === Ie || m === Je || m === Ve ? o(u, l, f) : !1;
  };
}
function ke(t) {
  var e = t.circular, r = t.createCustomConfig, s = t.strict, n = {
    ...
    areDatesEqual: Me,
    areMapsEqual: s ? D(_, w) : _,
    areObjectsEqual: s ? w : Pe,
    arePrimitiveWrappersEqual: Se,
    areRegExpsEqual: Te,
    areSetsEqual: s ? D(J, w) : J,
    areTypedArraysEqual: s ? w : De
  };
  if (r && (n = x({}, n, r(n))), e) {
...
function N(t) {
  t === void 0 && (t = {});
  var e = t.circular, r = e === void 0 ? !1 : e, s = t.createInternalComparator, n = t.createState, o = t.strict, a = o === void 0 ? !1 : o, i = ke(t), c = Fe(i), h = s ? s(c) : Ke(c);
  return We({ circular: r, comparator: c, createState: n, equals: h, strict: a });
}
function qt(t, e) {
  return Le(t, e);
}
...
const Ct = (t) => t.replace(/&/g, "&amp;").replace(/</g, "&lt;").replace(/>/g, "&gt;").replace(/"/g, "&quot;").replace(/'/g, "&#x27;").replace(/\//g, "&#x2F;"), Xe = {
...
export {
  et as AsyncVariable,
  ut as DocumentCombinerEngine,
  ue as FIRST_SCR_BOOK_NUM,
  ce as FIRST_SCR_CHAPTER_NUM,
  fe as FIRST_SCR_VERSE_NUM,
  le as LAST_SCR_BOOK_NUM,
  ct as PlatformEventEmitter,
  lt as UnsubscriberAsyncList,
  dt as aggregateUnsubscriberAsyncs,
  mt as aggregateUnsubscribers,
  bt as at,
  Nt as charAt,
  vt as codePointAt,
  it as createSyncProxyForAsyncObject,
  rt as debounce,
  O as deepClone,
  qt as deepEqual,
  Ze as deserialize,
  gt as endsWith,
  at as getAllObjectFunctionNames,
  he as getChaptersForBook,
  nt as getErrorMessage,
  st as groupBy,
  Ct as htmlEncode,
  yt as includes,
  Oe as indexOf,
