...
import { D as Qt, F as er, a as tr, b as rr, G as nr, L as ir, M as sr, S as ar, c as or, e as cr, f as dr, g as pr, h as lr, j as ur, k as hr, l as fr, m as mr, n as gr, o as yr, p as kr, q as br, r as vr, s as Mr, t as xr, u as _r, v as Er, w as Ir, x as wr, y as Sr, z as Pr, A as Tr, B as Cr, C as Ar, E as qr, H as $r, I as jr, J as Nr, K as Or, N as Fr, O as Ur, P as Rr, Q as Dr, R as Lr, T as Br, U as Vr, V as zr, W as Hr, X as Jr, Y as Kr, Z as Gr, _ as Yr, $ as Xr, a0 as Wr, a1 as Zr, a2 as Qr, a3 as en, a4 as tn, a5 as rn, a6 as nn, a7 as sn, a8 as an, a9 as on, aa as cn, ab as dn, ac as pn, ad as ln } from "./scripture-util-DArajUVn.js";
...
function Dt(n, e, t = /* @__PURE__ */ new Date()) {
...
export {
  ...
  Qt as DEBOUNCE_CANCELED_ERROR_MESSAGE,
  fe as DateTimeFormat,
  ye as DocumentCombiner,
  tt as EventRollingTimeCounter,
  ut as FAILED_PRECONDITION,
  er as FIRST_SCR_BOOK_NUM,
  tr as FIRST_SCR_CHAPTER_NUM,
  rr as FIRST_SCR_VERSE_NUM,
  nr as GraphemeString,
  ht as INTERNAL,
  ft as INVALID_ARGUMENT,
  ir as LAST_SCR_BOOK_NUM,
  sr as MAX_PADDING_LENGTH,
  ...
  ar as SELECTABLE_INVISIBLE_CHAR_OR_WHITESPACE_CLASS,
  or as Section,
  ...
  Xt as USFM_MARKERS_MAP_PARATEXT_3_0,
  ...
  Yt as applyThemeStylesheet,
  cr as areUsjContentsEqualExceptWhitespace,
  dr as at,
  pr as charAt,
  Ee as clampZoom,
  lr as codePointAt,
  ur as collapseMiddleWords,
  hr as collectUsjMarkers,
  qe as compareProjectShortNames,
  Rt as compareProjectsByName,
  fr as compareScrRefs,
  zt as computeEffectiveStructureProtection,
  mr as createSyncProxyForAsyncObject,
  gr as debounce,
  C as deepClone,
  F as deepEqual,
  yr as defaultScrRef,
  Te as deserialize,
  Kt as doesCatalogRowCoverProject,
  kr as endsWith,
  br as ensureArray,
  vr as escapeStringRegexp,
  Gt as expandThemeContribution,
  Ot as formatBytes,
  Ut as formatProjectName,
  Lt as formatRelativeDate,
  Mr as formatReplacementString,
  xr as formatReplacementStringToArray,
  _r as formatScrRef,
  Er as formatScrRefRange,
  Dt as formatTimeSpan,
  Ir as getAllObjectFunctionNames,
  wr as getChaptersForBook,
  Nt as getCurrentLocale,
  re as getDefaultCallerSequence,
  Sr as getErrorMessage,
  At as getFormatCallerFunction,
  Vt as getLocalizeKeyForPhysicalKey,
  Pr as getLocalizeKeyForScrollGroupId,
  Tr as getLocalizeKeysForScrollGroupIds,
  Cr as getLocalizedIdFromBookNumber,
  we as getNthCaller,
  qt as getPaneSizeLimits,
  Ar as getSectionForBook,
  ...
  Nr as isErrorMessageAboutParatextBlockingInternetAccess,
  Or as isErrorMessageAboutRegistryAuthFailure,
  Fr as isLocalizeKey,
  Et as isPlatformError,
  Ur as isSelectableInvisibleCharOrWhiteSpace,
  $t as isSerializable,
  _ as isString,
  Pe as isSubset,
  Rr as isWhiteSpace,
  ...
  Ht as makeProjectSelectorCustomData,
  ...
  zr as normalizeScriptureSpaces,
  Hr as offsetBook,
  Jr as offsetChapter,
  Kr as offsetVerse,
  Gr as ordinalCompare,
  Yr as padEnd,
  Xr as padStart,
  Oe as projectSettingsDocumentSchema,
  Jt as recencyMapFromOrderedIds,
  Wr as retryUntil,
  Ie as roundZoom,
  Ct as sanitizeHtml,
  Zr as scrRefToBBBCCC,
  Qr as scrRefToBBBCCCVVV,
  W as serialize,
  ...
  dn as transformAndEnsureRegExpRegExpArray,
  te as usfmMarkers,
  pn as wait,
