...
function kn(r) {
  ...
  if (w(r)) return { message: r, platformErrorVersion: X };
...
function ge(r, e) {
  const t = Ke(r, e == null ? void 0 : e.optionOrLocalizedBookName), n = Xt(
    r,
...
function be(r) {
  ...
  for (let i = 0; i < r.length; i += 1) {
    const s = r[i];
    s.charCodeAt(0) < 32 ? (t || (e += " "), t = !0) : !t && s === Rt && i + 1 < r.length && ye(r[i + 1]) || (ye(s) ? (t || (e += s), t = !0) : Zt(s) && n === s || (e += s, t = !1)), n = s;
  }
  return e;
}
function ve(r) {
...
function J(r, e, t) {
  var n = Ie(r), i = n.length;
  if (Ie(e).length !== i)
    return !1;
  for (var s, o, a; i-- > 0; )
    if (s = n[i], !Xe(r, e, t, s) || (o = xe(r, s), a = xe(e, s), (o || a) && (!o || !a || o.configurable !== a.configurable || o.enumerable !== a.enumerable || o.writable !== a.writable)))
      return !1;
  return !0;
}
function mr(r, e) {
...
function Cr(r) {
  ...
  return function(f, m, b) {
    ...
    if (N === Set)
      return u(f, m, b);
    var S = Or(f);
    return S === Nr ? t(f, m, b) : S === Sr ? l(f, m, b) : S === Ir ? s(f, m, b) : S === Ar ? u(f, m, b) : S === Er ? typeof f.then != "function" && typeof m.then != "function" && a(f, m, b) : S === Tr ? p(f, m, b) : S === wr ? n(f, m, b) : S === vr ? a(f, m, b) : S === kr || S === xr || S === Mr ? c(f, m, b) : !1;
  };
}
function $r(r) {
...
function C(r) {
  ...
  return Ur({ circular: t, comparator: c, createState: i, equals: l, strict: o });
}
function ee(r, e) {
  return Br(r, e);
}
...
const Rr = 1e3, He = 60, Ye = He * 60, Lr = Ye * 24;
function ni(r, e, t = /* @__PURE__ */ new Date()) {
  const n = Math.floor((e.getTime() - t.getTime()) / Rr), i = Math.round(n / Lr);
  if (Math.abs(i) >= 1) return r.format(i, "day");
  const s = Math.round(n / Ye);
...
function ai(r, e, t) {
  ...
  return i.id = `${Gr}${t ? `-${t}` : ""}`, i.dataset.themeId = r.id, i.textContent = Xr(r), this.document.head.appendChild(i), i;
}
function Qe(r) {
...
USJ: ${JSON.stringify(
  ...
  getInfoForMarker(e, t = "usfm") {
    ...
    if (t === "usfm" && c === "cell" && h.colspan) {
      const p = parseInt(h.colspan, 10), d = Yr.exec(n);
      if (d != null && d[1]) {
    ...
    e.map((c) => {
      ...
      if (typeof c.fragment == "object" && "type" in c.fragment) {
        ...
        if (d.type === Qt && d.code)
          ...
          const f = (u = Wr.exec(d.number)) == null ? void 0 : u[1];
          if (!f)
            console.warn(
