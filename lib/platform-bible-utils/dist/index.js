...
var Vr = (t, e, r) => e in t ? Lr(t, e, { enumerable: !0, configurable: !0, writable: !0, value: r }) : t[e] = r;
var E = (t, e, r) => Vr(t, typeof e != "symbol" ? e + "" : e, r);
import { Mutex as Ur } from "async-mutex";
import { JSONPath as Dt } from "jsonpath-plus";
class zn {
  /**
...
class Kr {
  ...
  constructor(e, r) {
    ...
    E(this, "latestOutput");
    E(this, "options");
    E(this, "onDidRebuildEmitter", new Gr());
...
function pe(t, e = !0) {
  return e && (t = t.toUpperCase()), t in Et ? Et[t] : 0;
}
function Qe(t) {
  return pe(t) > 0;
}
...
function er(t) {
  return t <= 0 || t > Qt ? "******" : Yt[t - 1];
}
function au(t) {
  return er(pe(t));
}
function tr(t) {
  const e = typeof t == "number" ? et(t) : t;
...
function cu(t) {
  return Yt[t - 1].includes("*obsolete*");
}
function lu() {
  const t = {};
...
var _ = /* @__PURE__ */ ((t) => (t[t.Unknown = 0] = "Unknown", t[t.Original = 1] = "Original", t[t.Septuagint = 2] = "Septuagint", t[t.Vulgate = 3] = "Vulgate", t[t.English = 4] = "English", t[t.RussianProtestant = 5] = "RussianProtestant", t[t.RussianOrthodox = 6] = "RussianOrthodox", t))(_ || {});
const $ = class {
  ...
  constructor(e) {
    ...
    typeof e == "string" ? (this.name = e, this._type = _[e]) : (this._type = e, this.name = _[e]);
  }
  get type() {
    return this._type;
  }
...
d($, "Original", new $(_.Original)), d($, "Septuagint", new $(_.Septuagint)), d($, "Vulgate", new $(_.Vulgate)), d($, "English", new $(_.English)), d($, "RussianProtestant", new $(_.RussianProtestant)), d($, "RussianOrthodox", new $(_.RussianOrthodox));
let Z = $;
function At(t, e) {
  const r = e[0];
...
const I = class m {
  constructor(e, r, u, n) {
    if (d(this, "firstChapter"), d(this, "lastChapter"), d(this, "lastVerse"), d(this, "hasSegmentsDefined"), d(this, "text"), d(this, "BBBCCCVVVS"), d(this, "longHashCode"), d(this, "versification"), d(this, "rtlMark", "‏"), d(this, "_bookNum", 0), d(this, "_chapterNum", 0), d(this, "_verseNum", 0), d(this, "_verse"), u == null && n == null)
      if (e != null && typeof e == "string") {
        const i = e, o = r != null && r instanceof Z ? r : void 0;
        this.setEmpty(o), this.parse(i);
      } else if (e != null && typeof e == "number") {
        const i = r != null && r instanceof Z ? r : void 0;
        ...
        if (e != null && e instanceof m) {
          ...
          if (e == null) return;
          const i = e instanceof Z ? e : m.defaultVersification;
          this.setEmpty(i);
        }
      else
  ...
  static fromJSON(e) {
    ...
    let s;
    return o && (s = new Z(o)), r ? new m(r, u.toString(), a, s) : new m();
  }
  /**
  ...
  set versificationStr(e) {
    this.versification = this.versification != null ? new Z(e) : void 0;
  }
  /**
  ...
  parse(e) {
    ...
    if (u.length !== 2 || j.bookIdToNumber(r[0]) === 0 || !Number.isInteger(n) || n < 0 || !m.isVerseParseable(u[1]))
      throw new me("Invalid reference : " + e);
  ...
  allVerses(e = !1, r = m.verseRangeSeparators, u = m.verseSequenceIndicators) {
    if (this._verse == null || this.chapterNum <= 0)
      return [this.clone()];
    const n = [], i = At(this._verse, u);
    for (const o of i.map((a) => At(a, r))) {
      const a = this.clone();
      a.verse = o[0];
      const s = a.verseNum;
  ...
  updateInternal(e, r, u) {
    this.bookNum = j.bookIdToNumber(e), this.chapter = r, this.verse = u;
  }
};
d(I, "defaultVersification", Z.English), d(I, "verseRangeSeparator", "-"), d(I, "verseSequenceIndicator", ","), d(I, "verseRangeSeparators", [I.verseRangeSeparator]), d(I, "verseSequenceIndicators", [I.verseSequenceIndicator]), d(I, "chapterDigitShifter", 1e3), d(I, "bookDigitShifter", I.chapterDigitShifter * I.chapterDigitShifter), d(I, "bcvMaxValue", I.chapterDigitShifter - 1), /**
* The valid status of the VerseRef.
*/
d(I, "ValidStatusType", rr);
let ur = I;
class me extends Error {
}
var yt = typeof globalThis < "u" ? globalThis : typeof window < "u" ? window : typeof global < "u" ? global : typeof self < "u" ? self : {}, re = {}, fu = () => {
  const t = "\\ud800-\\udfff", o = "\\u0300-\\u036f" + "\\ufe20-\\ufe2f" + "\\u20d0-\\u20ff" + "\\u1ab0-\\u1aff" + "\\u1dc0-\\u1dff", a = "\\ufe0e\\ufe0f", s = "\\uD83D\\uDC69\\uD83C\\uDFFB\\u200D\\uD83C\\uDF93", l = `[${t}]`, c = `[${o}]`, f = "\\ud83c[\\udffb-\\udfff]", p = `(?:${c}|${f})`, h = `[^${t}]`, g = "(?:\\uD83C[\\uDDE6-\\uDDFF]){2}", v = "[\\ud800-\\udbff][\\udc00-\\udfff]", b = "\\u200d", y = "(?:\\ud83c\\udff4\\udb40\\udc67\\udb40\\udc62\\udb40(?:\\udc65|\\udc73|\\udc77)\\udb40(?:\\udc6e|\\udc63|\\udc6c)\\udb40(?:\\udc67|\\udc74|\\udc73)\\udb40\\udc7f)", Y = `[${s}]`, A = `${p}?`, O = `[${a}]?`, de = `(?:${b}(?:${[h, g, v].join("|")})${O + A})*`, Se = O + A + de, Oe = `(?:${[`${h}${c}?`, c, g, v, l, Y].join("|")})`;
  return new RegExp(`${y}|${f}(?=${f})|${Oe + Se}`, "g");
}, pu = yt && yt.__importDefault || function(t) {
...
function Xe(t) {
  ...
  return t.match(_e.default()) || [];
}
var hu = re.toArray = Xe;
function tt(t) {
  if (typeof t != "string")
    throw new Error("Input must be a string");
  var e = t.match(_e.default());
...
function nr(t, e, r) {
  ...
  var u = t.match(_e.default());
  return u ? u.slice(e, r).join("") : "";
}
var mu = re.substring = nr;
function gu(t, e, r) {
  if (e === void 0 && (e = 0), typeof t != "string")
    throw new Error("Input must be a string");
  var u = tt(t);
...
function se(t, e) {
  return e < 0 || e > C(t) - 1 ? "" : Le(t, e, 1);
}
function ni(t, e) {
  if (!(e < 0 || e > C(t) - 1))
    return Le(t, e, 1).codePointAt(0);
}
...
function Nu(t, e) {
  ...
  let u = 0, n = 0;
  function i(a, s, l) {
    const c = Q(t, n, s), f = r.length > 0 && qe(r[r.length - 1]) ? `${r.pop()}${c}` : c;
    qe(a) ? r.push(`${f}${a}`) : (f && r.push(f), r.push(a)), n = s + l;
  }
  const o = C(t);
  for (; u < o; ) {
    switch (se(t, u)) {
      case "{":
        if (se(t, u - 1) !== "\\") {
          const a = yu(t, u, !1);
          if (a >= 0) {
            const s = Q(t, u + 1, a), l = s in e ? (
              // Just checked that the key is in the object
              // eslint-disable-next-line no-type-assertion/no-type-assertion
              e[s]
            ) : s;
            i(l, u, a + 1 - u), u = a, n = a + 1;
          }
        } else
          i("{", u - 1, 2);
        break;
  ...
  if (n < o) {
    const a = Q(t, n);
    r.push(
      r.length > 0 && qe(r[r.length - 1]) ? `${r.pop()}${a}` : a
    );
  }
  return r;
}
function ii(t, e) {
  return Nu(t, e).map((r) => `${r}`).join("");
}
function wu(t, e, r = 0) {
  const u = Q(t, r);
  return Ae(u, e) !== -1;
...
function si(t, e, r = " ") {
  return e <= C(t) ? t : ir(t, e, r, "right");
}
function ci(t, e, r = " ") {
  return e <= C(t) ? t : ir(t, e, r, "left");
}
function Nt(t, e) {
...
function li(t, e, r) {
  ...
  if (e > u || r && (e > r && !(e >= 0 && e < u && r < 0 && r > -u) || r < -u))
    return "";
  const n = Nt(u, e), i = r ? Nt(u, r) : void 0;
  return Q(t, n, i);
}
function wt(t, e, r) {
  const u = [];
  if (r !== void 0 && r <= 0)
    return [t];
  if (e === "") return Bu(t).slice(0, r);
  let n = e;
  (typeof e == "string" || e instanceof RegExp && !wu(e.flags, "g")) && (n = new RegExp(e, "g"));
  const i = t.match(n);
  let o = 0;
  if (!i) return [t];
  for (let a = 0; a < (r ? r - 1 : i.length); a++) {
    const s = Ae(t, i[a], o), l = C(i[a]);
    if (u.push(Q(t, o, s)), o = s + l, r !== void 0 && u.length === r)
      break;
  }
  return u.push(Q(t, o)), u;
}
function ar(t, e, r = 0) {
  return Ae(t, e, r) === r;
}
function Le(t, e = 0, r = C(t) - e) {
  return Du(t, e, r);
}
function Q(t, e, r = C(t)) {
  return mu(t, e, r);
}
function Bu(t) {
  return hu(t);
...
function di(t) {
  return t ? or(t).map((u) => new RegExp(u)) : [];
}
const sr = [
...
], Tu = 1, Su = sr.length - 1, Ou = 1, xu = 1, mi = {
  bookNum: 1,
  chapterNum: 1,
  verseNum: 1
}, Iu = (t) => {
  var e;
  return ((e = sr[t]) == null ? void 0 : e.chapters) ?? -1;
}, gi = (t, e) => ({
  bookNum: Math.max(Tu, Math.min(t.bookNum + e, Su)),
  chapterNum: 1,
  verseNum: 1
}), Di = (t, e) => ({
  ...t,
  chapterNum: Math.min(
    Math.max(Ou, t.chapterNum + e),
    Iu(t.bookNum)
  ),
  verseNum: 1
}), vi = (t, e) => ({
  ...t,
  verseNum: Math.max(xu, t.verseNum + e)
});
async function bi(t, e, r) {
  const u = j.bookNumberToId(t);
  if (!ar(Intl.getCanonicalLocales(e)[0], "zh"))
    return r({
  ...
  return wt(i[0], "ÿ08")[0].trim();
}
function Ct(t) {
  return new ur(t.bookNum, t.chapterNum, t.verseNum).BBBCCCVVV;
}
function Ei(t, e) {
  return Ct(t) - Ct(e);
}
...
function yi(t, e, r, u) {
  ...
  switch (e ?? "id") {
    case "English":
      n = j.bookNumberToEnglishName(t.bookNum);
      break;
    case "id":
      n = j.bookNumberToId(t.bookNum);
      break;
    default:
      n = e ?? "";
      break;
...
const Ni = (t) => (...e) => t.map((u) => u(...e)).every((u) => u), wi = (t) => async (...e) => {
  const r = t.map(async (u) => u(...e));
  return (await Promise.all(r)).every((u) => u);
}, xe = "chapter", Ie = "verse";
var ku = Object.getOwnPropertyNames, Ru = Object.getOwnPropertySymbols, qu = Object.prototype.hasOwnProperty;
function Bt(t, e) {
...
function Tt(t) {
  return ku(t).concat(Ru(t));
}
var cr = Object.hasOwn || function(t, e) {
  return qu.call(t, e);
};
function he(t, e) {
  return t || e ? t === e : t === e || t !== t && e !== e;
}
var lr = "_owner", St = Object.getOwnPropertyDescriptor, Ot = Object.keys;
function $u(t, e, r) {
  var u = t.length;
  if (e.length !== u)
    return !1;
...
function xt(t, e, r) {
  ...
  for (var u = {}, n = t.entries(), i = 0, o, a; (o = n.next()) && !o.done; ) {
    for (var s = e.entries(), l = !1, c = 0; (a = s.next()) && !a.done; ) {
      var f = o.value, p = f[0], h = f[1], g = a.value, v = g[0], b = g[1];
      !l && !u[c] && (l = r.equals(p, v, i, c, t, e, r) && r.equals(h, b, p, v, t, e, r)) && (u[c] = !0), c++;
    }
    if (!l)
      return !1;
    i++;
...
function Pu(t, e, r) {
  var u = Ot(t), n = u.length;
  if (Ot(e).length !== n)
    return !1;
  for (var i; n-- > 0; )
    if (i = u[n], i === lr && (t.$$typeof || e.$$typeof) && t.$$typeof !== e.$$typeof || !cr(e, i) || !r.equals(t[i], e[i], i, i, t, e, r))
      return !1;
  return !0;
}
function ge(t, e, r) {
  var u = Tt(t), n = u.length;
  if (Tt(e).length !== n)
    return !1;
  for (var i, o, a; n-- > 0; )
    if (i = u[n], i === lr && (t.$$typeof || e.$$typeof) && t.$$typeof !== e.$$typeof || !cr(e, i) || !r.equals(t[i], e[i], i, i, t, e, r) || (o = St(t, i), a = St(e, i), (o || a) && (!o || !a || o.configurable !== a.configurable || o.enumerable !== a.enumerable || o.writable !== a.writable)))
      return !1;
  return !0;
}
function ju(t, e) {
...
var Vu = "[object Arguments]", Uu = "[object Boolean]", zu = "[object Date]", Gu = "[object Map]", Ju = "[object Number]", Hu = "[object Object]", Xu = "[object RegExp]", Ku = "[object Set]", Wu = "[object String]", Yu = Array.isArray, Ft = typeof ArrayBuffer == "function" && ArrayBuffer.isView ? ArrayBuffer.isView : null, kt = Object.assign, Zu = Object.prototype.toString.call.bind(Object.prototype.toString);
function Qu(t) {
  ...
  return function(c, f, p) {
    if (c === f)
      return !0;
    if (c == null || f == null || typeof c != "object" || typeof f != "object")
      return c !== c && f !== f;
    var h = c.constructor;
    if (h !== f.constructor)
      return !1;
    ...
    if (h === Set)
      return a(c, f, p);
    var g = Zu(c);
    return g === zu ? r(c, f, p) : g === Xu ? o(c, f, p) : g === Gu ? u(c, f, p) : g === Ku ? a(c, f, p) : g === Hu ? typeof c.then != "function" && typeof f.then != "function" && n(c, f, p) : g === Vu ? n(c, f, p) : g === Uu || g === Ju || g === Wu ? i(c, f, p) : !1;
  };
}
function en(t) {
  var e = t.circular, r = t.createCustomConfig, u = t.strict, n = {
    areArraysEqual: u ? ge : $u,
    areDatesEqual: Mu,
    areMapsEqual: u ? Bt(xt, ge) : xt,
    areObjectsEqual: u ? ge : Pu,
    arePrimitiveWrappersEqual: ju,
    areRegExpsEqual: _u,
    areSetsEqual: u ? Bt(It, ge) : It,
    areTypedArraysEqual: u ? ge : Lu
  };
  if (r && (n = kt({}, n, r(n))), e) {
...
function rn(t) {
  ...
  if (u)
    return function(s, l) {
      var c = u(), f = c.cache, p = f === void 0 ? e ? /* @__PURE__ */ new WeakMap() : void 0 : f, h = c.meta;
      return r(s, l, {
        cache: p,
        equals: n,
        meta: h,
...
function K(t) {
  t === void 0 && (t = {});
  var e = t.circular, r = e === void 0 ? !1 : e, u = t.createInternalComparator, n = t.createState, i = t.strict, o = i === void 0 ? !1 : i, a = en(t), s = Qu(a), l = u ? u(s) : tn(s);
  return rn({ circular: r, comparator: s, createState: n, equals: l, strict: o });
}
function nn(t, e) {
  return un(t, e);
}
function on(t, e) {
  ...
  return Object.keys(r).forEach((i) => {
    n && (Object.hasOwn(u, i) && on(u[i], r[i]) || (n = !1));
  }), n;
}
function Rt(t, e, r) {
...
const Bi = (t) => t.replace(/&/g, "&amp;").replace(/</g, "&lt;").replace(/>/g, "&gt;").replace(/"/g, "&quot;").replace(/'/g, "&#x27;").replace(/\//g, "&#x2F;");
function Ti() {
...
H.MIME_TYPE = pr;
H.NAMESPACE = hr;
var dr = H, L = dr.find, ye = dr.NAMESPACE;
function dn(t) {
  return t !== "";
}
function mn(t) {
...
function qt(t) {
  if (!t) return [];
  var e = mn(t);
  return Object.keys(e.reduce(gn, {}));
}
function Dn(t) {
  return function(e) {
...
var R = {}, P = R.ELEMENT_NODE = 1, ce = R.ATTRIBUTE_NODE = 2, $e = R.TEXT_NODE = 3, mr = R.CDATA_SECTION_NODE = 4, gr = R.ENTITY_REFERENCE_NODE = 5, vn = R.ENTITY_NODE = 6, Dr = R.PROCESSING_INSTRUCTION_NODE = 7, vr = R.COMMENT_NODE = 8, br = R.DOCUMENT_NODE = 9, Er = R.DOCUMENT_TYPE_NODE = 10, G = R.DOCUMENT_FRAGMENT_NODE = 11, bn = R.NOTATION_NODE = 12, S = {}, B = {};
...
var Ar = S.NOT_FOUND_ERR = (B[8] = "Not found", 8);
S.NOT_SUPPORTED_ERR = (B[9] = "Not supported", 9);
var $t = S.INUSE_ATTRIBUTE_ERR = (B[10] = "Attribute in use", 10);
...
function le(t, e) {
  this._node = t, this._refresh = e, it(this);
}
function it(t) {
  var e = t._node._inc || t._node.ownerDocument._inc;
  if (t._inc !== e) {
    var r = t._refresh(t._node);
    if (kr(t, "length", r.length), !t.$$length || r.length < t.$$length)
...
function Mt(t, e, r, u) {
  if (u ? e[yr(e, u)] = r : e[e.length++] = r, t) {
    r.ownerElement = t;
    var n = t.ownerDocument;
    n && (u && Cr(n, t, u), En(n, t, r));
  }
}
function Pt(t, e, r) {
  var u = yr(e, r);
  if (u >= 0) {
    ...
    if (e.length = n, t) {
      ...
      i && (Cr(i, t, r), r.ownerElement = null);
    }
  } else
    throw new w(Ar, new Error(t.tagName + "@" + r));
}
Me.prototype = {
  length: 0,
  ...
  setNamedItem: function(t) {
    ...
    return Mt(this._ownerElement, this, t, r), r;
  },
  /* returns Node */
  setNamedItemNS: function(t) {
    ...
    if (e && e != this._ownerElement)
      throw new w($t);
    return r = this.getNamedItemNS(t.namespaceURI, t.localName), Mt(this._ownerElement, this, t, r), r;
  },
  /* returns Node */
  removeNamedItem: function(t) {
    var e = this.getNamedItem(t);
    return Pt(this._ownerElement, this, e), e;
  },
  // raises: NOT_FOUND_ERR,NO_MODIFICATION_ALLOWED_ERR
  //for level2
  removeNamedItemNS: function(t, e) {
    var r = this.getNamedItemNS(t, e);
    return Pt(this._ownerElement, this, r), r;
  },
...
Nr.prototype = {
  ...
  createDocument: function(t, e, r) {
    var u = new Be();
    if (u.implementation = this, u.childNodes = new z(), u.doctype = r || null, r && u.appendChild(r), e) {
...
D.prototype = {
  ...
  replaceChild: function(t, e) {
    Pe(this, t, e, Tr), e && this.removeChild(e);
  },
  ...
  cloneNode: function(t) {
    return Ke(this.ownerDocument || this, this, t);
  },
  // Modified in DOM Level 2:
  normalize: function() {
    for (var t = this.firstChild; t; ) {
      var e = t.nextSibling;
      e && e.nodeType == $e && t.nodeType == $e ? (this.removeChild(e), t.appendData(e.data)) : (t.normalize(), t = e);
    }
  },
...
function Br(t, e) {
  ...
  return r ? r.nextSibling = u : t.firstChild = u, u ? u.previousSibling = r : t.lastChild = r, e.parentNode = null, e.previousSibling = null, e.nextSibling = null, ot(t.ownerDocument, t), e;
}
function An(t) {
  return t && (t.nodeType === D.DOCUMENT_NODE || t.nodeType === D.DOCUMENT_FRAGMENT_NODE || t.nodeType === D.ELEMENT_NODE);
}
function yn(t) {
  return t && (V(t) || at(t) || J(t) || t.nodeType === D.DOCUMENT_FRAGMENT_NODE || t.nodeType === D.COMMENT_NODE || t.nodeType === D.PROCESSING_INSTRUCTION_NODE);
}
function J(t) {
...
function Nn(t, e, r) {
  ...
  if (r && r.parentNode !== t)
    throw new w(Ar, "child not in parent");
  if (
    // 4. If `node` is not a DocumentFragment, DocumentType, Element, or CharacterData node, then throw a "HierarchyRequestError" DOMException.
    !yn(e) || // 5. If either `node` is a Text node and `parent` is a document,
    // the sax parser currently adds top level text nodes, this will be fixed in 0.9.0
    // || (node.nodeType === Node.TEXT_NODE && parent.nodeType === Node.DOCUMENT_NODE)
    // or `node` is a doctype and `parent` is not a document, then throw a "HierarchyRequestError" DOMException.
    J(e) && t.nodeType !== D.DOCUMENT_NODE
  )
    throw new w(
      F,
...
function Pe(t, e, r, u) {
  Nn(t, e, r), t.nodeType === D.DOCUMENT_NODE && (u || wn)(t, e, r);
  var n = e.parentNode;
  ...
  return ot(t.ownerDocument || t, t), e.nodeType == G && (e.firstChild = e.lastChild = null), e;
}
function Cn(t, e) {
  return e.parentNode && e.parentNode.removeChild(e), e.parentNode = t, e.previousSibling = t.lastChild, e.nextSibling = null, e.previousSibling ? e.previousSibling.nextSibling = e : t.firstChild = e, t.lastChild = e, ot(t.ownerDocument, t, e), e;
}
Be.prototype = {
  //implementation : null,
  nodeName: "#document",
  ...
  insertBefore: function(t, e) {
    ...
    return Pe(this, t, e), t.ownerDocument = this, this.documentElement === null && t.nodeType === P && (this.documentElement = t), t;
  },
  removeChild: function(t) {
    return this.documentElement == t && (this.documentElement = null), Br(this, t);
  },
  replaceChild: function(t, e) {
    Pe(this, t, e, Tr), t.ownerDocument = this, e && this.removeChild(e), V(t) && (this.documentElement = t);
  },
  // Introduced in DOM Level 2:
  ...
  getElementById: function(t) {
    ...
    return Ne(this.documentElement, function(r) {
      if (r.nodeType == P && r.getAttribute("id") == t)
        return e = r, !0;
    }), e;
  },
  /**
  ...
  createElement: function(t) {
    var e = new te();
    e.ownerDocument = this, e.nodeName = t, e.tagName = t, e.localName = t, e.childNodes = new z();
    var r = e.attributes = new Me();
    return r._ownerElement = e, e;
  },
  createDocumentFragment: function() {
    var t = new Ue();
    return t.ownerDocument = this, t.childNodes = new z(), t;
  },
  ...
  createElementNS: function(t, e) {
    var r = new te(), u = e.split(":"), n = r.attributes = new Me();
    return r.childNodes = new z(), r.ownerDocument = this, r.nodeName = e, r.tagName = e, r.namespaceURI = t, u.length == 2 ? (r.prefix = u[0], r.localName = u[1]) : r.localName = e, n._ownerElement = r, r;
  },
  // Introduced in DOM Level 2:
  createAttributeNS: function(t, e) {
    var r = new je(), u = e.split(":");
...
te.prototype = {
  ...
  appendChild: function(t) {
    return t.nodeType === G ? this.insertBefore(t, null) : Cn(this, t);
  },
  ...
  getElementsByTagName: function(t) {
    return new le(this, function(e) {
      ...
      return Ne(e, function(u) {
        u !== e && u.nodeType == P && (t === "*" || u.tagName == t) && r.push(u);
      }), r;
    });
  },
  getElementsByTagNameNS: function(t, e) {
    return new le(this, function(r) {
      ...
      return Ne(r, function(n) {
        n !== r && n.nodeType === P && (t === "*" || n.namespaceURI === t) && (e === "*" || n.localName == e) && u.push(n);
      }), u;
    });
  }
};
...
Ve.prototype.nodeType = Er;
k(Ve, D);
function Sr() {
}
Sr.prototype.nodeType = bn;
k(Sr, D);
function Or() {
}
Or.prototype.nodeType = vn;
k(Or, D);
function ft() {
}
...
pt.prototype.nodeType = Dr;
k(pt, D);
function xr() {
}
xr.prototype.serializeToString = function(t, e, r) {
  return Ir.call(t, e, r);
};
D.prototype.toString = Ir;
function Ir(t, e) {
...
function ae(t, e, r, u, n) {
  ...
  switch (t.nodeType) {
    case P:
      ...
      for (var h = 0; h < o; h++) {
        ...
        if (Lt(g, r, n)) {
          ...
          He(e, v ? "xmlns:" + v : "xmlns", b), n.push({ prefix: v, namespace: b });
        }
        ae(g, e, r, u, n);
      }
      if (a === s && Lt(t, r, n)) {
    ...
    case Er:
      var Y = t.publicId, A = t.systemId;
      if (e.push("<!DOCTYPE ", t.name), Y)
...
function Fr(t, e, r) {
  ...
  if (u || (u = e.cloneNode(!1)), u.ownerDocument = t, u.parentNode = null, r)
    for (var n = e.firstChild; n; )
      u.appendChild(Fr(t, n, r)), n = n.nextSibling;
  return u;
}
function Ke(t, e, r) {
  ...
  switch (e.childNodes && (u.childNodes = new z()), u.ownerDocument = t, u.nodeType) {
    case P:
      var o = e.attributes, a = u.attributes = new Me(), s = o.length;
      a._ownerElement = u;
      for (var l = 0; l < s; l++)
        u.setAttributeNode(Ke(t, o.item(l), !0));
      break;
    case ce:
      r = !0;
  }
  if (r)
    for (var c = e.firstChild; c; )
      u.appendChild(Ke(t, c, r)), c = c.nextSibling;
  return u;
}
function kr(t, e, r) {
  t[e] = r;
...
var ht = {}, we = H.NAMESPACE, We = /[A-Z_a-z\xC0-\xD6\xD8-\xF6\u00F8-\u02FF\u0370-\u037D\u037F-\u1FFF\u200C-\u200D\u2070-\u218F\u2C00-\u2FEF\u3001-\uD7FF\uF900-\uFDCF\uFDF0-\uFFFD]/, Vt = new RegExp("[\\-\\.0-9" + We.source.slice(1, -1) + "\\u00B7\\u0300-\\u036F\\u203F-\\u2040]"), Ut = new RegExp("^" + We.source + Vt.source + "*(?::" + We.source + Vt.source + "*)?$"), De = 0, X = 1, ue = 2, ve = 3, ne = 4, ie = 5, be = 6, ke = 7;
function fe(t, e) {
...
function Bn(t, e, r, u, n) {
  function i(N) {
    if (N > 65535) {
      N -= 65536;
      var M = 55296 + (N >> 10), _r = 56320 + (N & 1023);
      return String.fromCharCode(M, _r);
    } else
  ...
  function a(N) {
    if (N > v) {
      ...
      p && s(v), u.characters(M, 0, N - v), v = N;
    }
  }
  function s(N, M) {
    for (; N >= c && (M = f.exec(t)); )
      l = M.index, c = l + M[0].length, p.lineNumber++;
    p.columnNumber = N - l + 1;
  }
  for (var l = 0, c = 0, f = /.*(?:\r\n?|\n)|.*$/g, p = u.locator, h = [{ currentNSMap: e }], g = {}, v = 0; ; ) {
    try {
      var b = t.indexOf("<", v);
      if (b < 0) {
        if (!t.substr(v).match(/^\s*$/)) {
          var y = u.doc, Y = y.createTextNode(t.substr(v));
          y.appendChild(Y), u.currentElement = Y;
        }
        return;
      }
      switch (b > v && a(b), t.charAt(b + 1)) {
        case "/":
          ...
          var de = O.localNSMap, Se = O.tagName == A, dt = Se || O.tagName && O.tagName.toLowerCase() == A.toLowerCase();
          if (dt) {
        ...
        default:
          p && s(b);
          var q = new Mr(), Ge = h[h.length - 1].currentNSMap, x = Tn(t, b, q, Ge, o, n), mt = q.length;
          if (!q.closed && On(t, x, q.tagName, g) && (q.closed = !0, r.nbsp || n.warning("unclosed xml attribute")), p && mt) {
            for (var jr = zt(p, {}), Je = 0; Je < mt; Je++) {
              var gt = q[Je];
              s(gt.offset), gt.locator = zt(p, {});
            }
            u.locator = jr, Gt(q, u, Ge) && h.push(q), u.locator = p;
          } else
            Gt(q, u, Ge) && h.push(q);
          we.isHTML(q.uri) && !q.closed ? x = Sn(t, x, q.tagName, o, u) : x++;
      }
    } catch (N) {
      if (N instanceof fe)
        throw N;
...
function Tn(t, e, r, u, n, i) {
  function o(p, h, g) {
    r.attributeNames.hasOwnProperty(p) && i.fatalError("Attribute " + p + " redefined"), r.addValue(
      p,
  ...
  for (var a, s, l = ++e, c = De; ; ) {
    ...
    switch (f) {
      ...
      case '"':
        if (c === ve || c === X)
          if (c === X && (i.warning('attribute value must after "="'), a = t.slice(e, l)), e = l + 1, l = t.indexOf(f, e), l > 0)
            s = t.slice(e, l), o(a, s, e - 1), c = ie;
          else
            throw new Error("attribute value no end '" + f + "' match");
        else if (c == ne)
          s = t.slice(e, l), o(a, s, e), i.warning('attribute "' + a + '" missed start quot(' + f + ")!!"), e = l + 1, c = ie;
        else
      ...
      default:
        if (f <= " ")
          ...
          switch (c) {
            case ue:
              r.tagName, (!we.isHTML(u[""]) || !a.match(/^(?:disabled|checked|selected)$/i)) && i.warning('attribute "' + a + '" missed value!! "' + a + '" instead2!!'), o(a, a, e), e = l, c = X;
              break;
            case ie:
...
function Gt(t, e, r) {
  for (var u = t.tagName, n = null, f = t.length; f--; ) {
    var i = t[f], o = i.qName, a = i.value, p = o.indexOf(":");
    if (p > 0)
      var s = i.prefix = o.slice(0, p), l = o.slice(p + 1), c = s === "xmlns" && l;
    else
      l = o, s = null, c = o === "xmlns" && "";
    i.localName = l, c !== !1 && (n == null && (n = {}, $r(r, r = {})), r[c] = n[c] = a, i.uri = we.XMLNS, e.startPrefixMapping(c, a));
  }
  ...
  var p = u.indexOf(":");
  p > 0 ? (s = t.prefix = u.slice(0, p), l = t.localName = u.slice(p + 1)) : (s = null, l = t.localName = u);
  var h = t.uri = r[s || ""];
  ...
  switch (n) {
    ...
    default:
      ...
      if (a > 1 && /!doctype/i.test(o[0][0])) {
        ...
        var f = o[a - 1];
        return r.startDTD(s, l, c), r.endDTD(), f.index + f[0].length;
      }
  }
  return -1;
}
...
ht.XMLReader = qr;
ht.ParseError = fe;
var kn = H, Rn = W, Jt = Rr, Pr = ht, qn = Rn.DOMImplementation, Ht = kn.NAMESPACE, $n = Pr.ParseError, Mn = Pr.XMLReader;
function Pn(t) {
  return t.replace(/\r[\n\u0085]/g, `
`).replace(/[\r\u0085\u2028]/g, `
`);
...
jn.prototype.parseFromString = function(t, e) {
  var r = this.options, u = new Mn(), n = r.domBuilder || new ze(), i = r.errorHandler, o = r.locator, a = r.xmlns || {}, s = /\/x?html?$/.test(e), l = s ? Jt.HTML_ENTITIES : Jt.XML_ENTITIES;
  o && n.setDocumentLocator(o), u.errorHandler = _n(i, n, o), u.domBuilder = r.domBuilder || n, s && (a[""] = Ht.HTML), a.xml = a.xml || Ht.XML;
  var c = r.normalizeLineEndings || Pn;
...
ze.prototype = {
  ...
  startElement: function(t, e, r, u) {
    ...
    Re(this, i), this.currentElement = i, this.locator && oe(this.locator, i);
    for (var a = 0; a < o; a++) {
  ...
  processingInstruction: function(t, e) {
    ...
    this.locator && oe(this.locator, r), Re(this, r);
  },
  ignorableWhitespace: function(t, e, r) {
  },
  characters: function(t, e, r) {
    if (t = Xt.apply(this, arguments), t) {
      if (this.cdata)
  ...
  comment: function(t, e, r) {
    t = Xt.apply(this, arguments);
    var u = this.doc.createComment(t);
    this.locator && oe(this.locator, u), Re(this, u);
  },
  startCDATA: function() {
    this.cdata = !0;
  },
  ...
  startDTD: function(t, e, r) {
    ...
    if (u && u.createDocumentType) {
      ...
      this.locator && oe(this.locator, n), Re(this, n), this.doc.doctype = n;
    }
  },
  /**
   ...
   */
  warning: function(t) {
    console.warn("[xmldom warning]	" + t, Ye(this.locator));
  },
  error: function(t) {
    console.error("[xmldom error]	" + t, Ye(this.locator));
  },
  fatalError: function(t) {
    throw new $n(t, this.locator);
  }
};
function Ye(t) {
  if (t)
...
const Kt = "USJ", U = ["figure", "note", "sidebar", "table"];
Object.freeze(U);
class T {
  constructor(e) {
    E(this, "usj");
  ...
  findSingleValue(e) {
    const r = Dt({ path: e, json: this.usj, wrap: !0 });
    if (r === void 0 || r.length === 0) return;
    if (!Array.isArray(r[0])) return r[0];
    const u = Dt({ path: e, json: this.usj, wrap: !1 });
  ...
  nodeToVerseRefAndOffset(e, r, u) {
    ...
    return i.startingContentNode !== void 0 && this.findNextMatchingNode(i.startingContentNode, [], (s, l) => {
      var c, f;
      return s === r ? !0 : l.find((p) => U.includes(p.parent.type)) ? !1 : typeof s == "string" ? (a += s.length, !1) : s.type === xe && s.number !== ((c = i.chapterNum) == null ? void 0 : c.toString()) || s.type === Ie && s.number !== ((f = i.verseNum) == null ? void 0 : f.toString()) ? (a = 0, !0) : !1;
    }), { verseRef: o, offset: a };
  }
  // #endregion
  ...
  verseRefToUsjContentLocation(e, r = 0) {
    ...
    const a = e.verse, s = this.findNextMatchingNode(
      n,
      U,
      (p, h) => p === n ? e.verseNum === 0 ? (o = T.convertWorkingStackToJsonPath(h), !0) : !1 : typeof p != "object" ? !1 : p.type === xe ? (i = !0, !0) : p.type === Ie && p.number !== void 0 && p.number === a ? (o = T.convertWorkingStackToJsonPath(h), !0) : !1
    );
    ...
    return this.findNextMatchingNode(
      ...
      (p, h) => {
        ...
        if (typeof p == "string") {
          if (l += p.length, l > r)
            return o = T.convertWorkingStackToJsonPath(h), c = r - l + p.length, f = p, !0;
        } else if (p.type === xe || p.type === Ie) return !0;
        return !1;
      }
    ), { node: f ?? s, offset: c, jsonPath: o };
  }
  // #endregion
  ...
  findNextLocationOfMatchingText(e, r, u = 1e3) {
    ...
    if (T.findNextMatchingNodeUsingWorkingStack(
      ...
      (f) => {
        ...
        i += f.length, n = `${n}${f}`;
        const p = n.indexOf(r);
        return p < 0 ? (o += n.length, n.length > r.length && (n = n.substring(n.length - r.length)), o -= n.length, i > u) : (a = o + p, !0);
      }
    ), a <= 0) return;
    i = 0;
    let s = 0, l = [];
    const c = T.findNextMatchingNodeUsingWorkingStack(
      ...
      this.convertJsonPathToWorkingStack(e.jsonPath),
      U,
      (f, p) => typeof f != "string" || (i += f.length, i < a + 1) ? !1 : (s = a - i + f.length, l = p, !0)
    );
...
export {
  ...
  Tu as FIRST_SCR_BOOK_NUM,
  Ou as FIRST_SCR_CHAPTER_NUM,
  xu as FIRST_SCR_VERSE_NUM,
  Su as LAST_SCR_BOOK_NUM,
  Yr as Mutex,
  Qn as MutexMap,
  ei as NonValidatingDocumentCombiner,
  Zr as NumberFormat,
  Gr as PlatformEventEmitter,
  ti as UnsubscriberAsyncList,
  T as UsjReaderWriter,
  Ie as VERSE_TYPE,
  wi as aggregateUnsubscriberAsyncs,
  Ni as aggregateUnsubscribers,
  ui as at,
  se as charAt,
  ni as codePointAt,
  Ei as compareScrRefs,
  Zn as createSyncProxyForAsyncObject,
  Hn as debounce,
  Ee as deepClone,
  nn as deepEqual,
  mi as defaultScrRef,
  ...
  Si as formatBytes,
  ii as formatReplacementString,
  Nu as formatReplacementStringToArray,
  yi as formatScrRef,
  Yn as getAllObjectFunctionNames,
  Iu as getChaptersForBook,
  Ti as getCurrentLocale,
  Kn as getErrorMessage,
  Fu as getLocalizeKeyForScrollGroupId,
  Ai as getLocalizeKeysForScrollGroupIds,
  ...
  Ci as isSerializable,
  qe as isString,
  on as isSubset,
  Cu as lastIndexOf,
  ln as localizedStringsDocumentSchema,
  fn as menuDocumentSchema,
  Jn as newGuid,
  oi as normalize,
  gi as offsetBook,
  Di as offsetChapter,
  vi as offsetVerse,
  ai as ordinalCompare,
  si as padEnd,
  ci as padStart,
  sn as projectSettingsDocumentSchema,
  Ct as scrRefToBBBCCCVVV,
  Rt as serialize,
  cn as settingsDocumentSchema,
  li as slice,
  wt as split,
  ar as startsWith,
  C as stringLength,
  ...
  hi as transformAndEnsureRegExpRegExpArray,
  Xr as wait,
