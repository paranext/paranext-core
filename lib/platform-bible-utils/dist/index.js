...
var tu = (e, t, r) => t in e ? eu(e, t, { enumerable: !0, configurable: !0, writable: !0, value: r }) : e[t] = r;
var w = (e, t, r) => tu(e, typeof t != "symbol" ? t + "" : t, r);
import { Mutex as ru } from "async-mutex";
...
class su {
  ...
  constructor(t, r) {
    ...
    w(this, "latestOutput");
    w(this, "options");
    w(this, "onDidRebuildEmitter", new uu());
...
class Ma {
  ...
  get(t) {
    ...
    return r || (r = new lu(), this.mutexesByID.set(t, r), r);
  }
}
class _a extends su {
...
class Pa {
  ...
  cleanupPromiseChain(t) {
    ...
    if (!r) return;
    const n = { promise: pu }, u = r.catch((i) => this.logger.warn(`Error in promise for ${t}: ${i.message}`)).finally(() => {
...
var hu = Object.defineProperty, du = (e, t, r) => t in e ? hu(e, t, { enumerable: !0, configurable: !0, writable: !0, value: r }) : e[t] = r, D = (e, t, r) => du(e, typeof t != "symbol" ? t + "" : t, r);
const de = [
  "GEN",
  "EXO",
  "LEV",
...
const W = {
  ...
  extraBooks: Au,
  bookNumberToId: zt,
  bookNumberToEnglishName: en,
  bookIdToEnglishName: Nu,
  isCanonical: tn,
  isExtraMaterial: bu,
  isObsolete: yu
};
...
*/
D(L, "ValidStatusType", rn);
let Jt = L;
class je extends Error {
}
var mr = typeof globalThis < "u" ? globalThis : typeof window < "u" ? window : typeof global < "u" ? global : typeof self < "u" ? self : {}, De = {}, Tu = () => {
...
}, wu = mr && mr.__importDefault || function(e) {
...
function Va(e, t, r = " ") {
  return t <= P(e) ? e : un(e, t, r, "right");
}
function Ha(e, t, r = " ") {
  return t <= P(e) ? e : un(e, t, r, "left");
}
function Er(e, t) {
...
function gr(e, t, r) {
  ...
  if (r !== void 0 && r <= 0)
    return [e];
  if (t === "") return ju(e).slice(0, r);
  let u = t;
  (typeof t == "string" || t instanceof RegExp && !qu(t.flags, "g")) && (u = new RegExp(t, "g"));
  const i = e.match(u);
  let a = 0;
  if (!i) return [e];
...
function Ya(e) {
  return e ? on(e).map((n) => new RegExp(n)) : [];
}
const Uu = /^[\f\n\r\t\v\u0020\u00a0\u1680\u2000-\u200a\u2028\u2029\u202f\u205f\u3000\u0085]+$/;
function Ka(e) {
  return Uu.test(e);
...
function Wa(e) {
  ...
  for (let u = 0; u < e.length; u += 1) {
    const i = e[u];
    i.charCodeAt(0) < 32 ? (r || (t += " "), r = !0) : !r && i === Pu && u + 1 < e.length && Dr(e[u + 1]) || (Dr(i) ? (r || (t += i), r = !0) : Gu(i) && n === i || (t += i, r = !1)), n = i;
  }
  return t;
}
const sn = [
...
], zu = 1, Ju = sn.length - 1, Xu = 1, Yu = 1, Qa = {
  bookNum: 1,
  chapterNum: 1,
  verseNum: 1
}, Ku = (e) => {
  var t;
  return ((t = sn[e]) == null ? void 0 : t.chapters) ?? -1;
}, Za = (e, t) => ({
  bookNum: Math.max(zu, Math.min(e.bookNum + t, Ju)),
  chapterNum: 1,
  verseNum: 1
}), es = (e, t) => ({
  ...e,
  chapterNum: Math.min(
    Math.max(Xu, e.chapterNum + t),
    Ku(e.bookNum)
  ),
  verseNum: 1
}), ts = (e, t) => ({
  ...e,
  verseNum: Math.max(Yu, e.verseNum + t)
});
async function rs(e, t, r) {
  const n = W.bookNumberToId(e);
  if (!an(Intl.getCanonicalLocales(t)[0], "zh"))
    return r({
...
const os = (e) => (...t) => e.map((n) => n(...t)).every((n) => n), as = (e) => async (...t) => {
  const r = e.map(async (n) => n(...t));
  return (await Promise.all(r)).every((n) => n);
}, pt = "chapter", ht = "verse";
var Qu = Object.getOwnPropertyNames, Zu = Object.getOwnPropertySymbols, ei = Object.prototype.hasOwnProperty;
function Ar(e, t) {
...
function Nr(e) {
  return Qu(e).concat(Zu(e));
}
var cn = Object.hasOwn || function(e, t) {
  return ei.call(e, t);
};
function Me(e, t) {
  return e || t ? e === t : e === t || e !== e && t !== t;
}
var ln = "_owner", br = Object.getOwnPropertyDescriptor, yr = Object.keys;
function ti(e, t, r) {
  var n = e.length;
  if (t.length !== n)
    return !1;
...
function ni(e, t, r) {
  ...
  if (yr(t).length !== u)
    return !1;
  for (var i; u-- > 0; )
    if (i = n[u], i === ln && (e.$$typeof || t.$$typeof) && e.$$typeof !== t.$$typeof || !cn(t, i) || !r.equals(e[i], t[i], i, i, e, t, r))
      return !1;
  return !0;
}
function Ue(e, t, r) {
  var n = Nr(e), u = n.length;
  if (Nr(t).length !== u)
    return !1;
  for (var i, a, o; u-- > 0; )
    if (i = n[u], i === ln && (e.$$typeof || t.$$typeof) && e.$$typeof !== t.$$typeof || !cn(t, i) || !r.equals(e[i], t[i], i, i, e, t, r) || (a = br(e, i), o = br(t, i), (a || o) && (!a || !o || a.configurable !== o.configurable || a.enumerable !== o.enumerable || a.writable !== o.writable)))
      return !1;
  return !0;
}
function ui(e, t) {
...
var ai = "[object Arguments]", si = "[object Boolean]", ci = "[object Date]", li = "[object Map]", fi = "[object Number]", pi = "[object Object]", hi = "[object RegExp]", di = "[object Set]", mi = "[object String]", Ei = Array.isArray, wr = typeof ArrayBuffer == "function" && ArrayBuffer.isView ? ArrayBuffer.isView : null, Sr = Object.assign, gi = Object.prototype.toString.call.bind(Object.prototype.toString);
function Di(e) {
  ...
  return function(l, f, p) {
    ...
    if (m === Set)
      return o(l, f, p);
    var b = gi(l);
    return b === ci ? r(l, f, p) : b === hi ? a(l, f, p) : b === li ? n(l, f, p) : b === di ? o(l, f, p) : b === pi ? typeof l.then != "function" && typeof f.then != "function" && u(l, f, p) : b === ai ? u(l, f, p) : b === si || b === fi || b === mi ? i(l, f, p) : !1;
  };
}
function vi(e) {
  var t = e.circular, r = e.createCustomConfig, n = e.strict, u = {
    areArraysEqual: n ? Ue : ti,
    areDatesEqual: ri,
    areMapsEqual: n ? Ar(Cr, Ue) : Cr,
    areObjectsEqual: n ? Ue : ni,
    arePrimitiveWrappersEqual: ui,
    areRegExpsEqual: ii,
    areSetsEqual: n ? Ar(Tr, Ue) : Tr,
    areTypedArraysEqual: n ? Ue : oi
  };
  if (r && (u = Sr({}, u, r(u))), t) {
...
function fe(e) {
  e === void 0 && (e = {});
  var t = e.circular, r = t === void 0 ? !1 : t, n = e.createInternalComparator, u = e.createState, i = e.strict, a = i === void 0 ? !1 : i, o = vi(e), s = Di(o), c = n ? n(s) : Ai(s);
  return Ni({ circular: r, comparator: s, createState: u, equals: c, strict: a });
}
function yi(e, t) {
  return bi(e, t);
}
function Ci(e, t) {
  ...
  return Object.keys(r).forEach((i) => {
    u && (Object.hasOwn(n, i) && Ci(n[i], r[i]) || (u = !1));
  }), u;
}
function Or(e, t, r) {
...
const cs = (e) => e.replace(/&/g, "&amp;").replace(/</g, "&lt;").replace(/>/g, "&gt;").replace(/"/g, "&quot;").replace(/'/g, "&#x27;").replace(/\//g, "&#x2F;");
function ls() {
  return typeof navigator < "u" && navigator.languages ? navigator.languages[0] : new nu().resolvedOptions().locale;
}
function fs(e, t = 2) {
...
const wi = 1e3, fn = 60, pn = fn * 60, Si = pn * 24;
function ps(e, t, r = /* @__PURE__ */ new Date()) {
  const n = Math.floor((t.getTime() - r.getTime()) / wi), u = Math.round(n / Si);
  if (Math.abs(u) >= 1) return e.format(u, "day");
  const i = Math.round(n / pn);
  if (Math.abs(i) >= 1) return e.format(i, "hour");
  const a = Math.round(n / fn);
...
function ki(e) {
  return En(e) || e === We.XML_XHTML_APPLICATION;
}
var We = _e({
  /**
...
}), qi = Object.keys(We).map(function(e) {
  return We[e];
});
function $i(e) {
...
x.find = Ri;
x.freeze = _e;
x.HTML_BOOLEAN_ATTRIBUTES = dn;
x.HTML_RAW_TEXT_ELEMENTS = Ke;
x.HTML_VOID_ELEMENTS = mn;
x.hasDefaultHTMLNamespace = ki;
x.hasOwn = ve;
x.isHTMLBooleanAttribute = _i;
x.isHTMLRawTextElement = Fi;
x.isHTMLEscapableRawTextElement = Li;
x.isHTMLMimeType = En;
x.isHTMLVoidElement = Pi;
x.isValidMimeType = $i;
x.MIME_TYPE = We;
x.NAMESPACE = ji;
var Ae = {}, Ui = x;
...
function it(e, t) {
  vn(e) ? (this.name = Dn[e], this.message = t || "") : (this.message = e, this.name = Vi(t) ? t : Qe.Error), Error.captureStackTrace && Error.captureStackTrace(this, it);
}
gn(it, !0);
...
var Gi = "�", Ee = /[-\x09\x0A\x0D\x20-\x2C\x2E-\uD7FF\uE000-\uFFFD]/;
ot && (Ee = g("[", me(Ee), "\\u{10000}-\\u{10FFFF}", "]"));
var Qt = /[\x20\x09\x0D\x0A]/, zi = me(Qt), C = g(Qt, "+"), O = g(Qt, "*"), Ze = /[:_a-zA-Z\xC0-\xD6\xD8-\xF6\xF8-\u02FF\u0370-\u1FFF\u200C-\u200D\u2070-\u218F\u2C00-\u2FEF\u3001-\uD7FF\uF900-\uFDCF\uFDF0-\uFFFD]/;
ot && (Ze = g("[", me(Ze), "\\u{10000}-\\u{10FFFF}", "]"));
var Ji = me(Ze), Zt = g("[", Ji, me(/[-.0-9\xB7]/), me(/[\u0300-\u036F\u203F-\u2040]/), "]"), X = g(Ze, Zt, "*"), Ir = g(Zt, "+"), Xi = g("&", X, ";"), Yi = d(/&#[0-9]+;|&#x[0-9a-fA-F]+;/), et = d(Xi, "|", Yi), tt = g("%", X, ";"), er = d(
  g('"', d(/[^%&"]/, "|", tt, "|", et), "*", '"'),
  "|",
  g("'", d(/[^%&']/, "|", tt, "|", et), "*", "'")
), Ki = d('"', d(/[^<&"]/, "|", et), "*", '"', "|", "'", d(/[^<&']/, "|", et), "*", "'"), Wi = Oe(Ze, ":"), Qi = Oe(Zt, ":"), Br = g(Wi, Qi, "*"), at = g(Br, d(":", Br), "?"), Zi = g("^", at, "$"), eo = g("(", at, ")"), rt = d(/"[^"]*"|'[^']*'/), to = g(/^<\?/, "(", X, ")", d(C, "(", Ee, "*?)"), "?", /\?>/), xr = /[\x20\x0D\x0Aa-zA-Z0-9-'()+,./:=?;!*#@$_%]/, yt = d('"', xr, '*"', "|", "'", Oe(xr, "'"), "*'"), bn = "<!--", yn = "-->", ro = g(bn, d(Oe(Ee, "-"), "|", g("-", Oe(Ee, "-"))), "*", yn), Rr = "#PCDATA", no = d(
  g(/\(/, O, Rr, d(O, /\|/, O, at), "*", O, /\)\*/),
  "|",
  g(/\(/, O, Rr, O, /\)/)
), uo = /[?*+]?/, io = g(
...
), oo = d("EMPTY", "|", "ANY", "|", no, "|", io), ao = "<!ELEMENT", so = g(ao, C, d(at, "|", tt), C, d(oo, "|", tt), O, ">"), co = g("NOTATION", C, /\(/, O, X, d(O, /\|/, O, X), "*", O, /\)/), lo = g(/\(/, O, Ir, d(O, /\|/, O, Ir), "*", O, /\)/), fo = d(co, "|", lo), po = d(/CDATA|ID|IDREF|IDREFS|ENTITY|ENTITIES|NMTOKEN|NMTOKENS/, "|", fo), ho = d(/#REQUIRED|#IMPLIED/, "|", d(d("#FIXED", C), "?", Ki)), mo = d(C, X, C, po, C, ho), Eo = "<!ATTLIST", go = g(Eo, C, X, mo, "*", O, ">"), tr = "SYSTEM", Ct = "PUBLIC", Tt = d(d(tr, C, rt), "|", d(Ct, C, yt, C, rt)), Do = g(
  "^",
  d(
...
), vo = d(C, "NDATA", C, X), Ao = d(er, "|", d(Tt, vo, "?")), Cn = "<!ENTITY", No = g(Cn, C, X, C, Ao, O, ">"), bo = d(er, "|", Tt), yo = g(Cn, C, "%", C, X, C, bo, O, ">"), Co = d(No, "|", yo), To = g(Ct, C, yt), wo = g("<!NOTATION", C, X, C, d(Tt, "|", To), O, ">"), rr = g(O, "=", O), Mr = /1[.]\d+/, So = g(C, "version", rr, d("'", Mr, "'", "|", '"', Mr, '"')), _r = /[A-Za-z][-A-Za-z0-9._]*/, Oo = d(C, "encoding", rr, d('"', _r, '"', "|", "'", _r, "'")), Io = d(C, "standalone", rr, d("'", d("yes", "|", "no"), "'", "|", '"', d("yes", "|", "no"), '"')), Bo = g(/^<\?xml/, So, Oo, "?", Io, "?", O, /\?>/), xo = "<!DOCTYPE", Ro = "<![CDATA[", Mo = "]]>", _o = /<!\[CDATA\[/, Po = /\]\]>/, Fo = g(Ee, "*?", Po), Lo = g(_o, Fo);
E.chars = me;
E.chars_without = Oe;
E.detectUnicodeSupport = Nn;
E.reg = g;
E.regg = d;
E.AttlistDecl = go;
E.CDATA_START = Ro;
...
E.COMMENT_START = bn;
E.COMMENT_END = yn;
E.DOCTYPE_DECL_START = xo;
E.elementdecl = so;
E.EntityDecl = Co;
E.EntityValue = er;
E.ExternalID = Tt;
E.ExternalID_match = Do;
E.Name = X;
E.NotationDecl = wo;
E.Reference = et;
E.PEReference = tt;
...
E.SYSTEM = tr;
E.SystemLiteral = rt;
E.UNICODE_REPLACEMENT_CHARACTER = Gi;
E.UNICODE_SUPPORT = ot;
E.XMLDecl = Bo;
var J = x, ee = J.find, ko = J.hasDefaultHTMLNamespace, Ie = J.hasOwn, qo = J.isHTMLMimeType, $o = J.isHTMLRawTextElement, jo = J.isHTMLVoidElement, ze = J.MIME_TYPE, te = J.NAMESPACE, k = Symbol(), Tn = Ae, h = Tn.DOMException, Uo = Tn.DOMExceptionName, Q = E;
function q(e) {
  if (e !== k)
...
function Pr(e) {
  if (!e) return [];
  var t = Ho(e);
  return Object.keys(t.reduce(Go, {}));
}
function zo(e) {
  return function(t) {
...
var j = {}, Y = j.ELEMENT_NODE = 1, Be = j.ATTRIBUTE_NODE = 2, vt = j.TEXT_NODE = 3, Sn = j.CDATA_SECTION_NODE = 4, On = j.ENTITY_REFERENCE_NODE = 5, Jo = j.ENTITY_NODE = 6, In = j.PROCESSING_INSTRUCTION_NODE = 7, Bn = j.COMMENT_NODE = 8, nt = j.DOCUMENT_NODE = 9, xn = j.DOCUMENT_TYPE_NODE = 10, ae = j.DOCUMENT_FRAGMENT_NODE = 11, Xo = j.NOTATION_NODE = 12, _ = J.freeze({
...
function Rn(e, t) {
  if (t.length < e.length) return Rn(t, e);
  var r = null;
  for (var n in e) {
    if (e[n] !== t[n]) return r;
    r = e[n];
...
function wt(e) {
  ...
  if (e._inc !== t) {
    ...
    if (Hn(e, "length", r.length), !e.$$length || r.length < e.$$length)
...
function Yo(e, t, r, n) {
  if (n ? t[Mn(t, n)] = r : (t[t.length] = r, t.length++), e) {
    r.ownerElement = e;
    var u = e.ownerDocument;
    u && (n && Fn(u, e, n), Ko(u, e, r));
  }
}
function kr(e, t, r) {
  var n = Mn(t, r);
  if (n >= 0) {
    ...
    if (t.length = u, e) {
      ...
      i && Fn(i, e, r), r.ownerElement = null;
    }
  }
}
xe.prototype = {
  ...
  setNamedItem: function(e) {
    ...
    return r === e ? e : (Yo(this._ownerElement, this, e, r), r);
  },
  /**
...
A.prototype = {
  ...
  replaceChild: function(e, t) {
    At(this, e, t, $n), t && this.removeChild(t);
  },
  /**
...
function se(e, t) {
  q(e);
  var r = t || {};
  this.ownerDocument = this, this.contentType = r.contentType || ze.XML_APPLICATION, this.type = qo(this.contentType) ? "html" : "xml";
}
function Ko(e, t, r) {
  e && e._inc++;
...
function kn(e, t) {
  ...
  return r ? r.nextSibling = n : e.firstChild = n, n ? n.previousSibling = r : e.lastChild = r, Ln(e.ownerDocument, e), t.parentNode = null, t.previousSibling = null, t.nextSibling = null, t;
}
function Wo(e) {
...
function Zo(e, t, r) {
  ...
  if (
    ...
    !Qo(t) || // 5. If either `node` is a Text node and `parent` is a document,
...
function At(e, t, r, n) {
  Zo(e, t, r), e.nodeType === A.DOCUMENT_NODE && (n || ea)(e, t, r);
  var u = t.parentNode;
  ...
  return Ln(e.ownerDocument || e, e, t), t.nodeType == ae && (t.firstChild = t.lastChild = null), t;
}
se.prototype = {
  /**
  ...
  replaceChild: function(e, t) {
    At(this, e, t, $n), e.ownerDocument = this, t && this.removeChild(t), ue(e) && (this.documentElement = e);
  },
  ...
  createElement: function(e) {
    var t = new le(k);
    t.ownerDocument = this, this.type === "html" && (e = e.toLowerCase()), ko(this.contentType) && (t.namespaceURI = te.HTML), t.nodeName = e, t.tagName = e, t.localName = e, t.childNodes = new M();
  ...
  createEntityReference: function(e) {
    ...
    if (this.type === "html")
      throw new h("document is an html document", Uo.NotSupportedError);
    var t = new Bt(k);
...
It.prototype.nodeType = xn;
$(It, A);
function nr(e) {
  q(e);
}
nr.prototype.nodeType = Xo;
$(nr, A);
function ur(e) {
  q(e);
}
...
xt.prototype.nodeType = In;
$(xt, Fe);
function jn() {
}
jn.prototype.serializeToString = function(e, t) {
  return Un.call(e, t);
};
A.prototype.toString = Un;
function Un(e) {
...
function we(e, t, r, n) {
  ...
  switch (e.nodeType) {
    case Y:
      ...
      var re = !B;
      if (re && (i || e.namespaceURI === te.HTML) && (re = jo(s)), re)
        t.push("/>");
      else {
        if (t.push(">"), i && $o(s))
          for (; B; )
    ...
    case vt:
      return t.push(e.data.replace(/[<&>]/g, Pn));
    case Sn:
...
function Vn(e, t, r) {
  ...
  if (n || (n = t.cloneNode(!1)), n.ownerDocument = e, n.parentNode = null, r)
    for (var u = t.firstChild; u; )
      n.appendChild(Vn(e, u, r)), u = u.nextSibling;
  return n;
}
function Vt(e, t, r) {
...
var Rt = {}, Le = x, v = E, zn = Ae, ta = Le.isHTMLEscapableRawTextElement, ra = Le.isHTMLMimeType, na = Le.isHTMLRawTextElement, ut = Le.hasOwn, Ur = Le.NAMESPACE, Vr = zn.ParseError, ua = zn.DOMException, Ve = 0, ie = 1, be = 2, He = 3, ye = 4, Ce = 5, Ge = 6, Et = 7;
function Jn() {
}
Jn.prototype = {
  parse: function(e, t, r) {
    var n = this.domBuilder;
    n.startDocument(), Xn(t, t = /* @__PURE__ */ Object.create(null)), ia(e, t, r, n, this.errorHandler), n.endDocument();
  }
};
var ir = /&#?\w+;?/g;
function ia(e, t, r, n, u) {
  var i = ra(n.mimeType);
  e.indexOf(v.UNICODE_REPLACEMENT_CHARACTER) >= 0 && u.warning("Unicode replacement character detected, source encoding issues?");
  function a(y) {
    if (y > 65535) {
      y -= 65536;
    ...
    try {
      ...
      switch (e.charAt(I + 1)) {
        ...
        case "?":
          ...
          break;
        case "!":
          m && c(I), H = Kn(e, I, n, u, i);
          break;
        default:
          m && c(I);
          var V = new Wn(), Ft = b[b.length - 1].currentNSMap, H = oa(e, I, V, Ft, o, u, i), sr = V.length;
          if (V.closed || (i && Le.isHTMLVoidElement(V.tagName) ? V.closed = !0 : T.push(V.tagName)), m && sr) {
            for (var Zn = Hr(m, {}), Lt = 0; Lt < sr; Lt++) {
              var cr = V[Lt];
              c(cr.offset), cr.locator = Hr(m, {});
            }
            n.locator = Zn, Gr(V, n, Ft) && b.push(V), n.locator = m;
          } else
            Gr(V, n, Ft) && b.push(V);
          i && !V.closed ? H = aa(e, H, V.tagName, o, n) : H++;
      }
    } catch (y) {
      if (y instanceof Vr)
        throw y;
      if (y instanceof ua)
        throw new Vr(y.name + ": " + y.message, n.locator, y);
...
function Gr(e, t, r) {
  for (var n = e.tagName, u = null, f = e.length; f--; ) {
    ...
    i.localName = c, l !== !1 && (u == null && (u = /* @__PURE__ */ Object.create(null), Xn(r, r = /* @__PURE__ */ Object.create(null))), r[l] = u[l] = o, i.uri = Ur.XMLNS, t.startPrefixMapping(l, o));
  }
  for (var f = e.length; f--; )
    i = e[f], i.prefix && (i.prefix === "xml" && (i.uri = Ur.XML), i.prefix !== "xmlns" && (i.uri = r[i.prefix]));
  var p = n.indexOf(":");
...
function Kn(e, t, r, n, u) {
  ...
  switch (i.char(2)) {
    ...
    case "D": {
      ...
      return i.skipBlanks(), s.internalSubset = sa(i, n), i.skipBlanks(), i.char() !== ">" ? n.fatalError("doctype not terminated with > at position " + i.getIndex()) : (i.skip(1), r.startDTD(s.name, s.publicId, s.systemId, s.internalSubset), r.endDTD(), i.getIndex());
    }
    default:
...
Rt.XMLReader = Jn;
Rt.parseUtils = Yn;
Rt.parseDoctypeCommentOrCData = Kn;
var Ne = x, la = R, fa = Ae, zr = Gn, pa = Rt, ha = la.DOMImplementation, da = Ne.hasDefaultHTMLNamespace, ma = Ne.isHTMLMimeType, Ea = Ne.isValidMimeType, Qn = Ne.MIME_TYPE, $t = Ne.NAMESPACE, Jr = fa.ParseError, ga = pa.XMLReader;
function Da(e) {
  return e.replace(/\r[\n\u0085]/g, `
`).replace(/[\r\u0085\u2028]/g, `
`);
...
function va(e) {
  ...
  e.errorHandler && e.errorHandler("warning", "The `errorHandler` option has been deprecated, use `onError` instead!", this), this.normalizeLineEndings = e.normalizeLineEndings || Da, this.locator = !!e.locator, this.xmlns = this.assign(/* @__PURE__ */ Object.create(null), e.xmlns);
}
va.prototype.parseFromString = function(e, t) {
  if (!Ea(t))
    throw new TypeError('DOMParser.parseFromString: the provided mimeType "' + t + '" is not valid.');
  var r = this.assign(/* @__PURE__ */ Object.create(null), this.xmlns), n = zr.XML_ENTITIES, u = r[""] || null;
  da(t) ? (n = zr.HTML_ENTITIES, u = $t.HTML) : t === Qn.XML_SVG_IMAGE && (u = $t.SVG), r[""] = u, r.xml = r.xml || $t.XML;
...
function or(e) {
  var t = e || {};
  this.mimeType = t.mimeType || Qn.XML_APPLICATION, this.defaultNamespace = t.defaultNamespace || null, this.cdata = !1, this.currentElement = void 0, this.doc = void 0, this.locator = void 0, this.onError = t.onError;
}
function Te(e, t) {
...
or.prototype = {
  ...
  startDocument: function() {
    var e = new ha();
    this.doc = ma(this.mimeType) ? e.createHTMLDocument(!1) : e.createDocument(this.defaultNamespace, "");
  },
  ...
  reportError: function(e, t) {
    if (typeof this.onError == "function")
      try {
        ...
        throw new Jr("Reporting " + e + ' "' + t + '" caused ' + r, this.locator);
      }
    else
      console.error("[xmldom " + e + "]	" + t, Aa(this.locator));
  },
  /**
  ...
  fatalError: function(e) {
    throw this.reportError("fatalError", e), new Jr(e, this.locator);
  }
};
function Aa(e) {
  if (e)
...
ke.MIME_TYPE;
ke.NAMESPACE;
const Yr = "USJ", ne = ["figure", "note", "sidebar", "table"];
Object.freeze(ne);
class F {
  constructor(t) {
    w(this, "usj");
...
export {
  ...
  pt as CHAPTER_TYPE,
  Ta as Collator,
  nu as DateTimeFormat,
  su as DocumentCombiner,
  zu as FIRST_SCR_BOOK_NUM,
  Xu as FIRST_SCR_CHAPTER_NUM,
  Yu as FIRST_SCR_VERSE_NUM,
  Ju as LAST_SCR_BOOK_NUM,
  lu as Mutex,
  Ma as MutexMap,
  _a as NonValidatingDocumentCombiner,
  fu as NumberFormat,
  uu as PlatformEventEmitter,
  Pa as PromiseChainingMap,
  Fa as UnsubscriberAsyncList,
  F as UsjReaderWriter,
  ht as VERSE_TYPE,
  as as aggregateUnsubscriberAsyncs,
  os as aggregateUnsubscribers,
  ka as at,
  Se as charAt,
  qa as codePointAt,
  ns as compareScrRefs,
  Ra as createSyncProxyForAsyncObject,
  Sa as debounce,
  Je as deepClone,
  yi as deepEqual,
  Qa as defaultScrRef,
  ...
  fs as formatBytes,
  $a as formatReplacementString,
  ku as formatReplacementStringToArray,
  is as formatScrRef,
  ps as formatTimeSpan,
  xa as getAllObjectFunctionNames,
  Ku as getChaptersForBook,
  ls as getCurrentLocale,
  Ia as getErrorMessage,
  Wu as getLocalizeKeyForScrollGroupId,
  us as getLocalizeKeysForScrollGroupIds,
  rs as getLocalizedIdFromBookNumber,
  Oa as groupBy,
  cs as htmlEncode,
  qu as includes,
  Ye as indexOf,
  za as isLocalizeKey,
  ss as isSerializable,
  Dt as isString,
  Ci as isSubset,
  Ka as isWhiteSpace,
  $u as lastIndexOf,
  Bi as localizedStringsDocumentSchema,
  xi as menuDocumentSchema,
  wa as newGuid,
  ja as normalize,
  Za as offsetBook,
  es as offsetChapter,
  ...
  Va as padEnd,
  Ha as padStart,
  Oi as projectSettingsDocumentSchema,
  Wa as regularizeSpaces,
  vr as scrRefToBBBCCCVVV,
  Or as serialize,
  Ii as settingsDocumentSchema,
  Ga as slice,
  gr as split,
  an as startsWith,
  P as stringLength,
  pe as substring,
  ju as toArray,
  Ya as transformAndEnsureRegExpArray,
  Xa as transformAndEnsureRegExpRegExpArray,
  au as wait,
  Ba as waitForDuration
};
