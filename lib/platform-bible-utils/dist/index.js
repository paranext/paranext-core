...
let qr = ve, Ct = class extends Error {
};
var X = {}, fe = {}, ir;
function bt() {
  if (ir) return fe;
  ...
  return fe.assign = n, fe.find = r, fe.freeze = e, fe.HTML_BOOLEAN_ATTRIBUTES = a, fe.HTML_RAW_TEXT_ELEMENTS = d, fe.HTML_VOID_ELEMENTS = c, fe.hasDefaultHTMLNamespace = g, fe.hasOwn = t, fe.isHTMLBooleanAttribute = s, fe.isHTMLRawTextElement = p, fe.isHTMLEscapableRawTextElement = m, fe.isHTMLMimeType = f, fe.isHTMLVoidElement = l, fe.isValidMimeType = A, fe.MIME_TYPE = b, fe.NAMESPACE = P, fe;
}
var mt = {}, or;
function Pt() {
  if (or) return mt;
...
function $r() {
  ...
  var b = t(g), E = a("[", b, t(/[-.0-9\xB7]/), t(/[\u0300-\u036F\u203F-\u2040]/), "]"), A = a(g, E, "*"), P = a(E, "+"), x = a("&", A, ";"), k = s(/&#[0-9]+;|&#x[0-9a-fA-F]+;/), q = s(x, "|", k), Q = a("%", A, ";"), se = s(
    a('"', s(/[^%&"]/, "|", Q, "|", q), "*", '"'),
    "|",
    a("'", s(/[^%&']/, "|", Q, "|", q), "*", "'")
  ), v = s('"', s(/[^<&"]/, "|", q), "*", '"', "|", "'", s(/[^<&']/, "|", q), "*", "'"), M = n(g, ":"), U = n(E, ":"), H = a(M, U, "*"), Z = a(H, s(":", H), "?"), ne = a("^", Z, "$"), ke = a("(", Z, ")"), ie = s(/"[^"]*"|'[^']*'/), Be = a(/^<\?/, "(", A, ")", s(m, "(", l, "*?)"), "?", /\?>/), y = /[\x20\x0D\x0Aa-zA-Z0-9-'()+,./:=?;!*#@$_%]/, C = s('"', y, '*"', "|", "'", n(y, "'"), "*'"), I = "<!--", T = "-->", B = a(I, s(n(l, "-"), "|", a("-", n(l, "-"))), "*", T), N = "#PCDATA", R = s(
    a(/\(/, f, N, s(f, /\|/, f, Z), "*", f, /\)\*/),
    "|",
    a(/\(/, f, N, f, /\)/)
  ), K = /[?*+]?/, L = a(
  ...
  ), w = s("EMPTY", "|", "ANY", "|", R, "|", L), O = "<!ELEMENT", F = a(O, m, s(Z, "|", Q), m, s(w, "|", Q), f, ">"), G = a("NOTATION", m, /\(/, f, A, s(f, /\|/, f, A), "*", f, /\)/), de = a(/\(/, f, P, s(f, /\|/, f, P), "*", f, /\)/), Ie = s(G, "|", de), De = s(/CDATA|ID|IDREF|IDREFS|ENTITY|ENTITIES|NMTOKEN|NMTOKENS/, "|", Ie), ue = s(/#REQUIRED|#IMPLIED/, "|", s(s("#FIXED", m), "?", v)), _ = s(m, A, m, De, m, ue), je = "<!ATTLIST", Re = a(je, m, A, _, "*", f, ">"), me = "about:legacy-compat", Ve = s('"' + me + '"', "|", "'" + me + "'"), Pe = "SYSTEM", Se = "PUBLIC", Fe = s(s(Pe, m, ie), "|", s(Se, m, C, m, ie)), Je = a(
    "^",
    s(
  ...
  ), Xe = s(m, "NDATA", m, A), Ce = s(se, "|", s(Fe, Xe, "?")), ee = "<!ENTITY", ze = a(ee, m, A, m, Ce, f, ">"), le = s(se, "|", Fe), Ke = a(ee, m, "%", m, A, m, le, f, ">"), vt = s(ze, "|", Ke), Ye = a(Se, m, C), We = a("<!NOTATION", m, A, m, s(Fe, "|", Ye), f, ">"), V = a(f, "=", f), te = /1[.]\d+/, Ae = a(m, "version", V, s("'", te, "'", "|", '"', te, '"')), Ne = /[A-Za-z][-A-Za-z0-9._]*/, Qe = s(m, "encoding", V, s('"', Ne, '"', "|", "'", Ne, "'")), lt = s(m, "standalone", V, s("'", s("yes", "|", "no"), "'", "|", '"', s("yes", "|", "no"), '"')), ct = a(/^<\?xml/, Ae, Qe, "?", lt, "?", f, /\?>/), ft = "<!DOCTYPE", Dt = "<![CDATA[", At = "]]>", pt = /<!\[CDATA\[/, Ze = /\]\]>/, ht = a(l, "*?", Ze), Ot = a(pt, ht);
  return z.chars = t, z.chars_without = n, z.detectUnicodeSupport = r, z.reg = a, z.regg = s, z.ABOUT_LEGACY_COMPAT = me, z.ABOUT_LEGACY_COMPAT_SystemLiteral = Ve, z.AttlistDecl = Re, z.CDATA_START = Dt, z.CDATA_END = At, z.CDSect = Ot, z.Char = l, z.Comment = B, z.COMMENT_START = I, z.COMMENT_END = T, z.DOCTYPE_DECL_START = ft, z.elementdecl = F, z.EntityDecl = vt, z.EntityValue = se, z.ExternalID = Fe, z.ExternalID_match = Je, z.Name = A, z.NotationDecl = We, z.Reference = q, z.PEReference = Q, z.PI = Be, z.PUBLIC = Se, z.PubidLiteral = C, z.QName = Z, z.QName_exact = ne, z.QName_group = ke, z.S = m, z.SChar_s = p, z.S_OPT = f, z.SYSTEM = Pe, z.SystemLiteral = ie, z.UNICODE_REPLACEMENT_CHARACTER = c, z.UNICODE_SUPPORT = e, z.XMLDecl = ct, z;
}
var sr;
function jr() {
  if (sr) return oe;
  ...
  function Ie(i, o, u, h) {
    if (h ? o[de(o, h)] = u : (o[o.length] = u, o.length++), i) {
      ...
      D && (h && Pe(D, i, h), Ve(D, i, u));
    }
  }
  function De(i, o, u) {
    var h = de(o, u);
    if (h >= 0) {
      for (var D = o.length - 1; h <= D; )
        o[h] = o[++h];
      if (o.length = D, i) {
  ...
  ue.prototype = {
    ...
    createDocumentType: function(i, o, u, h) {
      Q(i);
      var D = new ft(p);
      return D.name = i, D.nodeName = i, D.publicId = o || "", D.systemId = u || "", D.internalSubset = h || "", D.childNodes = new w(), D;
    },
    /**
    ...
    createHTMLDocument: function(i) {
      ...
      if (o.implementation = this, o.childNodes = new w(), i !== !1) {
        ...
        if (u.appendChild(h), typeof i == "string") {
          ...
          D.appendChild(o.createTextNode(i)), h.appendChild(D);
        }
  ...
  _.prototype = {
    ...
    compareDocumentPosition: function(i) {
      if (this === i) return 0;
      var o = i, u = this, h = null, D = null;
      if (o instanceof Ae && (h = o, o = h.ownerElement), u instanceof Ae && (D = u, u = D.ownerElement, h && o && u === o))
  ...
  function Pe(i, o, u, h) {
    ...
    D === d.XMLNS && delete o._nsMap[u.prefix ? u.localName : ""];
  }
  function Se(i, o, u) {
    if (i && i._inc) {
      i._inc++;
      ...
      if (u && !u.nextSibling)
        ...
        for (var D = o.firstChild, S = 0; D; )
          h[S++] = D, D = D.nextSibling;
  ...
  function Ye(i, o, u) {
    var h = i.childNodes || [], D = o.childNodes || [];
  ...
  me.prototype = {
    ...
    createElementNS: function(i, o) {
      var u = se(i, o), h = new te(p), D = h.attributes = new G();
      return h.childNodes = new w(), h.ownerDocument = this, h.nodeName = o, h.tagName = o, h.namespaceURI = u[0], h.prefix = u[1], h.localName = u[2], D._ownerElement = h, h;
    },
    // Introduced in DOM Level 2:
    /**
     * @param {string} namespaceURI
  ...
  te.prototype = {
    ...
    setAttributeNS: function(i, o, u) {
      var h = se(i, o), D = h[2], S = this.getAttributeNodeNS(i, D);
    ...
    getElementsByTagNameNS: function(i, o) {
      return new O(this, function(u) {
        ...
        return Re(u, function(D) {
          D !== u && D.nodeType === H && (i === "*" || D.namespaceURI === i) && (o === "*" || D.localName == o) && h.push(D);
        }), h;
      });
    }
  ...
  Ae.prototype.nodeType = Z, M(Ae, _);
  function Ne(i) {
    E(i);
  }
  Ne.prototype = {
    ...
    replaceData: function(i, o, u) {
      var h = this.data.substring(0, i), D = this.data.substring(i + o);
      u = h + u + D, this.nodeValue = this.data = u, this.length = u.length;
    }
  }, M(Ne, _);
  function Qe(i) {
    E(i);
  ...
  Dt.prototype.nodeType = N, M(Dt, _);
  function At(i) {
    E(i);
  }
  At.prototype.nodeType = Be, M(At, _);
  function pt(i) {
    E(i);
  }
  ...
  function ae(i) {
    var o = [], u = this.nodeType === I && this.documentElement || this, h = u.prefix, D = u.namespaceURI;
    if (D && h == null) {
      var h = u.lookupPrefix(D);
      if (h == null)
        var S = [
  ...
  function ge(i, o, u) {
    var h = i.prefix || "", D = i.namespaceURI;
    if (!D || h === "xml" && D === d.XML || D === d.XMLNS)
      return !1;
  ...
  function qe(i, o, u, h) {
    h || (h = []);
    var D = i.nodeType === I ? i : i.ownerDocument, S = D.type === "html";
    if (u)
      if (i = u(i), i) {
        if (typeof i == "string") {
          o.push(i);
  ...
  function Xt(i, o, u) {
    ...
    if (h || (h = o.cloneNode(!1)), h.ownerDocument = i, h.parentNode = null, u)
      for (var D = o.firstChild; D; )
        h.appendChild(Xt(i, D, u)), D = D.nextSibling;
    return h;
  }
  function Ft(i, o, u) {
  ...
  return oe._updateLiveList = F, oe.Attr = Ae, oe.CDATASection = ct, oe.CharacterData = Ne, oe.Comment = lt, oe.Document = me, oe.DocumentFragment = Ze, oe.DocumentType = ft, oe.DOMImplementation = ue, oe.Element = te, oe.Entity = At, oe.EntityReference = pt, oe.LiveNodeList = O, oe.NamedNodeMap = G, oe.Node = _, oe.NodeList = w, oe.Notation = Dt, oe.Text = Qe, oe.ProcessingInstruction = ht, oe.XMLSerializer = Ot, oe;
}
var nt = {}, qt = {}, ur;
function Sn() {
...
function xn() {
  if (lr) return Tt;
  lr = 1;
  var r = bt(), e = $r(), t = Pt(), n = r.isHTMLEscapableRawTextElement, a = r.isHTMLMimeType, s = r.isHTMLRawTextElement, c = r.hasOwn, l = r.NAMESPACE, d = t.ParseError, p = t.DOMException, m = 0, f = 1, g = 2, b = 3, E = 4, A = 5, P = 6, x = 7;
  function k() {
  }
  k.prototype = {
  ...
  function Q(y, C, I, T, B) {
    ...
    function R(V) {
      if (V > 65535) {
        V -= 65536;
        var te = 55296 + (V >> 10), Ae = 56320 + (V & 1023);
        return String.fromCharCode(te, Ae);
      } else
    ...
    function K(V) {
      ...
      var Ae = e.Reference.exec(te);
      if (!Ae || Ae[0].length !== te.length)
        ...
        switch (y.charAt(_ + 1)) {
          case "/":
            ...
            if (!T.currentElement && !T.doc.documentElement)
              return;
            var Se = De[De.length - 1] || T.currentElement.tagName || T.doc.documentElement.tagName || "";
            if (Se !== Pe[1]) {
        ...
        case '"':
          if (F === b || F === f)
            if (F === f && (N.warning('attribute value must after "="'), L = y.slice(C, O)), C = O + 1, O = y.indexOf(G, C), O > 0)
              w = y.slice(C, O), K(L, w, C - 1), F = A;
            else
              throw new Error("attribute value no end '" + G + "' match");
          else if (F == E)
            w = y.slice(C, O), K(L, w, C), N.warning('attribute "' + L + '" missed start quot(' + G + ")!!"), C = O + 1, F = A;
          else
...
`);
  ...
  function E(v) {
    if (v = v || {}, v.locator === void 0 && (v.locator = !0), this.assign = v.assign || r.assign, this.domHandler = v.domHandler || A, this.onError = v.onError || v.errorHandler, v.errorHandler && typeof v.errorHandler != "function")
...
@#[line:` + v.lineNumber + ",col:" + v.columnNumber + "]";
  ...
  return nt.__DOMHandler = A, nt.DOMParser = E, nt.normalizeLineEndings = b, nt.onErrorStopParsing = Q, nt.onWarningStopParsing = se, nt;
}
var fr;
function On() {
  if (fr) return X;
...
function Mn() {
  return pr || (pr = 1, $t = () => {
    const r = "\\ud800-\\udfff", c = "\\u0300-\\u036f" + "\\ufe20-\\ufe2f" + "\\u20d0-\\u20ff" + "\\u1ab0-\\u1aff" + "\\u1dc0-\\u1dff", l = "\\ufe0e\\ufe0f", d = "\\uD83D\\uDC69\\uD83C\\uDFFB\\u200D\\uD83C\\uDF93", p = `[${r}]`, m = `[${c}]`, f = "\\ud83c[\\udffb-\\udfff]", g = `(?:${m}|${f})`, b = `[^${r}]`, E = "(?:\\uD83C[\\uDDE6-\\uDDFF]){2}", A = "[\\ud800-\\udbff][\\udc00-\\udfff]", P = "\\u200d", x = "(?:\\ud83c\\udff4\\udb40\\udc67\\udb40\\udc62\\udb40(?:\\udc65|\\udc73|\\udc77)\\udb40(?:\\udc6e|\\udc63|\\udc6c)\\udb40(?:\\udc67|\\udc74|\\udc73)\\udb40\\udc7f)", k = `[${d}]`, q = `${g}?`, Q = `[${l}]?`, se = `(?:${P}(?:${[b, E, A].join("|")})${Q + q})*`, v = Q + q + se, U = `(?:${[`${b}${m}?`, m, E, A, p, k].join("|")})`;
...
], jn = 1, Vn = Hr.length - 1, zn = 1, Gn = 1, Oo = {
  book: "GEN",
  chapterNum: 1,
  verseNum: 1
}, Hn = (r) => {
...
function Jr(r, e, t, n) {
  ...
  if (a && s) {
    const c = br(r), l = br(t);
    if (c !== l) {
      if (!gt(Bt(c, -1) ?? "") && !gt(Bt(l, -1) ?? "") || !Dr(r, e) || !Dr(t, n)) return !1;
      let d = c;
...
const jo = (r) => (...e) => r.map((n) => n(...e)).every((n) => n), Vo = (r) => async (...e) => {
  const t = r.map(async (n) => n(...e));
  return (await Promise.all(t)).every((n) => n);
}, Qn = "book", Ar = "chapter", Me = "verse", Ge = "***";
function Xr() {
...
var yi = "[object Arguments]", bi = "[object Boolean]", vi = "[object Date]", Di = "[object Error]", Ai = "[object Map]", Ni = "[object Number]", Ci = "[object Object]", Ti = "[object RegExp]", wi = "[object Set]", Ii = "[object String]", Si = "[object URL]", xi = Array.isArray, xr = typeof ArrayBuffer == "function" && ArrayBuffer.isView ? ArrayBuffer.isView : null, kr = Object.assign, ki = Object.prototype.toString.call.bind(Object.prototype.toString);
function Oi(r) {
  ...
  return function(E, A, P) {
    ...
    if (x !== typeof A)
      return !1;
    if (x !== "object")
      return x === "number" ? c(E, A, P) : x === "function" ? a(E, A, P) : !1;
    var k = E.constructor;
    if (k !== A.constructor)
      return !1;
    if (k === Object)
    ...
    if (k === Set)
      return m(E, A, P);
    var q = ki(E);
    return q === vi ? t(E, A, P) : q === Ti ? p(E, A, P) : q === Ai ? s(E, A, P) : q === wi ? m(E, A, P) : q === Ci ? typeof E.then != "function" && typeof A.then != "function" && l(E, A, P) : q === Si ? g(E, A, P) : q === Di ? n(E, A, P) : q === yi ? l(E, A, P) : q === bi || q === Ni || q === Ii ? d(E, A, P) : !1;
  };
}
function Mi(r) {
...
const Ho = (r) => r.replace(/&/g, "&amp;").replace(/</g, "&lt;").replace(/>/g, "&gt;").replace(/"/g, "&quot;").replace(/'/g, "&#x27;").replace(/\//g, "&#x2F;");
function Jo() {
...
function Ko(r, e, t = /* @__PURE__ */ new Date()) {
...
const It = ["figure", "note", "sidebar", "table"];
Object.freeze(It);
...
class j {
  constructor(e, t) {
    ...
    if (this.usj.version !== this.markersMap.version && console.warn(
    ...
    ), !this.markersMap.markersMapVersion.startsWith("1."))
      throw new Error(
    ...
    if (j.findNextMatchingNodeUsingWorkingStack(
      ...
      (b, E) => {
        ...
        if (p && j.areStackItemsShallowEqual(P, p)) {
          ...
          A = b.substring(e.documentLocation.offset), c += e.documentLocation.offset;
        }
        s += A.length, a = `${a}${A}`;
        const x = a.indexOf(t);
...
`);
  ...
  closingMarkerToUsfm(e, t) {
    const {
      ...
      var A, P;
      return !(E === "type" || E === "marker" || E === "content" || E === "closed" || (A = l.skipOutputAttributeToUsfm) != null && A.includes(E) || (P = s.leadingAttributes) != null && P.includes(E) || s.textContentAttribute === E || d.some(
    ...
    if (s.isClosingMarkerOptional ? (!this.markersMap.shouldOptionalClosingMarkersBePresent && m.closed !== "true" || this.markersMap.shouldOptionalClosingMarkersBePresent && m.closed === "false") && (f = !1) : m.closed === "false" && (f = !1), s.independentClosingMarkers && s.independentClosingMarkers.length > 0 && f) {
      ...
      }), A += x, n !== E.marker && (A = this.addMarkerUsfmToString(
        A,
        {
          isClosingMarker: !0,
          forMarker: E
    ...
    if (p.length > 0 && (g += "|", p.length === 1 && p[0] === s.defaultAttribute ? (b.push({
    ...
    }), g += m[s.defaultAttribute]) : p.forEach((E, A) => {
      ...
      const E = l.isClosingMarkerEmpty ? "" : a, A = t ? l.nestedPrefix ?? "" : "";
      b.push({
        fragment: { isClosingMarker: !0, forMarker: e },
        indexInUsfm: g.length
      }), g += `\\${A}${E}*`;
  ...
  static transferFragmentsInfoArrayToMaps(e, t, n, a, s) {
    e.map((l) => {
      ...
      if (typeof l.fragment == "object" && "type" in l.fragment) {
        ...
        else if (g.type === Ar && g.number) {
          const b = parseInt(g.number, 10);
          if (Number.isNaN(b))
            console.warn(
              `Found ${Ar} type marker with number ${g.number}, but could not parse chapter number from it. Continuing using previous chapter number ${n.chapterNum}`
            );
          else {
...
export {
  ...
  tn as USFM_MARKERS_MAP_3_1,
  mo as UnsubscriberAsyncList,
  j as UsjReaderWriter,
  Me as VERSE_TYPE,
  Vo as aggregateUnsubscriberAsyncs,
  jo as aggregateUnsubscribers,
  Qo as applyThemeStylesheet,
  $o as areUsjContentsEqualExceptWhitespace,
  Bt as at,
  Et as charAt,
  vo as codePointAt,
  _o as compareScrRefs,
  ...
  Rn as endsWith,
  zr as ensureArray,
  Io as escapeStringRegexp,
  Wo as expandThemeContribution,
  Xo as formatBytes,
  Do as formatReplacementString,
  Ln as formatReplacementStringToArray,
  Uo as formatScrRef,
  Ko as formatTimeSpan,
  oo as getAllObjectFunctionNames,
  Hn as getChaptersForBook,
  Jo as getCurrentLocale,
  Xr as getDefaultCallerSequence,
  Mr as getErrorMessage,
  zo as getFormatCallerFunction,
  Jn as getLocalizeKeyForScrollGroupId,
  Fo as getLocalizeKeysForScrollGroupIds,
  ...
  Bo as offsetChapter,
  Ro as offsetVerse,
  No as ordinalCompare,
  Co as padEnd,
  To as padStart,
  qi as projectSettingsDocumentSchema,
  Lo as scrRefToBBBCCC,
  ...
  So as transformAndEnsureRegExpRegExpArray,
  cn as wait,
