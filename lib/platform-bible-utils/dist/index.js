...
const Qt = "CANCELLED", er = "UNKNOWN", tr = "INVALID_ARGUMENT", rr = "DEADLINE_EXCEEDED", nr = "NOT_FOUND", ir = "ALREADY_EXISTS", sr = "PERMISSION_DENIED", ar = "RESOURCE_EXHAUSTED", or = "FAILED_PRECONDITION", cr = "ABORTED", dr = "OUT_OF_RANGE", lr = "UNIMPLEMENTED", pr = "INTERNAL", ur = "UNAVAILABLE", hr = "DATA_LOSS", fr = "UNAUTHENTICATED", F = 1;
function mr(r, e) {
  if (!r)
    return {
      message: "",
