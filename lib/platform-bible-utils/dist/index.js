...
var k = (i, e, t) => ce(i, typeof e != "symbol" ? e + "" : e, t);
import { d as C, i as _ } from "./scripture-util-DArajUVn.js";
import { D as Jt, F as Kt, a as Gt, b as Yt, G as Xt, L as Wt, M as Zt, S as Qt, c as er, e as tr, f as rr, g as nr, h as ir, j as sr, k as ar, l as or, m as cr, n as dr, o as pr, p as lr, q as ur, r as hr, s as fr, t as mr, u as gr, v as yr, w as kr, x as br, y as vr, z as Mr, A as xr, B as _r, C as Er, E as Ir, H as wr, I as Sr, J as Pr, K as Tr, N as Cr, O as Ar, P as qr, Q as $r, R as jr, T as Nr, U as Or, V as Ur, W as Fr, X as Rr, Y as Dr, Z as Lr, _ as Br, $ as Vr, a0 as zr, a1 as Hr, a2 as Jr, a3 as Kr, a4 as Gr, a5 as Yr, a6 as Xr, a7 as Wr, a8 as Zr, a9 as Qr, aa as en, ab as tn, ac as rn, ad as nn } from "./scripture-util-DArajUVn.js";
...
class Qe {
  ...
  cleanupPromiseChain(e) {
    ...
    if (!t) return;
    const r = { promise: ve }, s = t.catch((n) => this.logger.warn(`Error in promise for ${e}: ${n.message}`)).finally(() => {
...
const Z = 1e4, O = Z / 1e3, Q = 3, z = /* @__PURE__ */ new Map(), Me = {
  ...
  threw: {
    ...
    suppressed: (i, e, t) => `UnsubscriberAsyncList ${i}: ${e} more unsubscribers added after the list was run threw in the last ${O}s; per-occurrence errors suppressed. Distinct errors sampled (up to ${Q}): ${t.join(" | ")}`
  }
};
function H(i, e, t) {
  const { log: r, first: s, suppressed: n } = Me[e], c = `${i}\0${e}`, p = Date.now(), d = z.get(c);
  if (!d || p >= d.closesAt) {
    r(s(i, t)), z.set(c, {
      closesAt: p + Z,
      suppressedCount: 0,
...
const rt = "ABORTED", nt = "ALREADY_EXISTS", it = "CANCELLED", st = "DATA_LOSS", at = "DEADLINE_EXCEEDED", ot = "FAILED_PRECONDITION", ct = "INTERNAL", dt = "INVALID_ARGUMENT", pt = "NOT_FOUND", lt = "OUT_OF_RANGE", ut = "PERMISSION_DENIED", ht = "RESOURCE_EXHAUSTED", ft = "UNAUTHENTICATED", mt = "UNAVAILABLE", gt = "UNIMPLEMENTED", yt = "UNKNOWN", q = 1;
function kt(i, e) {
  if (!i)
    return {
      message: "",
...
const vt = (i) => (...e) => i.map((r) => r(...e)).every((r) => r), Mt = (i) => async (...e) => {
...
function xt(i) {
  var e;
  return ((e = ee[i]) == null ? void 0 : e.type) === a.Paragraph || i === "v";
}
function _t(i) {
  const e = ee[i];
...
function Se(i, e) {
  ...
  return Object.keys(t).forEach((n) => {
    s && (Object.hasOwn(r, n) && Se(r[n], t[n]) || (s = !1));
  }), s;
}
function X(i, e, t) {
...
const Tt = (i) => i.replace(/&/g, "&amp;").replace(/</g, "&lt;").replace(/>/g, "&gt;").replace(/"/g, "&quot;").replace(/'/g, "&#x27;").replace(/\//g, "&#x2F;");
function Ct() {
...
function Bt(i, e, t) {
  ...
  return s.id = `${Oe}${t ? `-${t}` : ""}`, s.dataset.themeId = i.id, s.textContent = Fe(i), this.document.head.appendChild(s), s;
}
function ae(i) {
  return Object.freeze(i), i == null || Object.getOwnPropertyNames(i).forEach(function(t) {
    ...
    i[t] !== null && (typeof i[t] == "object" || typeof i[t] == "function") && !Object.isFrozen(i[t]) && ae(i[t]);
  }), i;
}
const F = ae({
  version: "3.0.7",
...
class g {
  ...
  getInfoForMarker(e, t = "usfm") {
    ...
    if (t === "usfm" && d === "cell" && b.colspan) {
      const u = parseInt(b.colspan, 10), h = De.exec(r);
      if (h != null && h[1]) {
  ...
  textContentToUsfm(e) {
    return {
      usfm: this.shouldAllowInvisibleCharacters ? e : e.replace(Re, "~"),
    ...
    e.map((d) => {
      ...
      if (typeof d.fragment == "object" && "type" in d.fragment) {
        ...
        if (h.type === J && h.code)
          ...
          const f = (m = Le.exec(h.number)) == null ? void 0 : m[1];
          if (!f)
            this.reportProblemOnce(
...
export {
  ...
  $r as isolateBidi,
  jr as lastIndexOf,
  $e as localizedStringsDocumentSchema,
  Ft as makeProjectSelectorCustomData,
  je as menuDocumentSchema,
  Nr as newGuid,
  kt as newPlatformError,
  Or as normalize,
  ...
  Br as padEnd,
  Vr as padStart,
  Ae as projectSettingsDocumentSchema,
  ...
  X as serialize,
  qe as settingsDocumentSchema,
  Kr as slice,
  Gr as split,
  Yr as startsWith,
  Xr as stringLength,
  Wr as substring,
  Ne as themeDocumentSchema,
  Zr as toArray,
  Qr as toKebabCase,
