...
const Ot = class Ot {
  ...
  resolveToValue(e, r = !1) {
    if (this.resolver)
      Ot.verboseLoggingEnabled && console.debug(`${this.variableName} is being resolved now`), this.resolver(e), this.complete();
    else {
  ...
  rejectWithReason(e, r = !1) {
    if (this.rejecter)
      Ot.verboseLoggingEnabled && console.debug(`${this.variableName} is being rejected now with reason: ${e}`), this.rejecter(e), this.complete();
    else {
      if (r) throw Error(`${this.variableName} was already settled`);
...
function Qu(t) {
  ...
  return Me(t) ? t.includes(e) : Mr(t).includes(e);
}
function Zu(t) {
  const e = "401 Unauthorized error while getting shared projects.", r = "User registration is not valid. Cannot retrieve resources from DBL.", u = Me(t) ? t : Mr(t);
...
class on {
  ...
  addOrUpdateContribution(e, r) {
    ...
    let o = this.options.copyDocuments && r ? St(r) : r;
...
const Mt = 1;
function oi(t) {
  if (!t) return { message: "", platformErrorVersion: Mt };
  if (Me(t)) return { message: t, platformErrorVersion: Mt };
  ...
  return { cause: t, message: "", platformErrorVersion: Mt };
}
function ai(t) {
...
function Et(t, e = !0) {
  return e && (t = t.toUpperCase()), t in rr ? rr[t] : 0;
}
function Ht(t) {
  return Et(t) > 0;
}
...
function Pr(t) {
  return t <= 0 || t > Lr ? "******" : Rr[t - 1];
}
function An(t) {
  return Pr(Et(t));
}
function kr(t) {
  const e = typeof t == "number" ? Jt(t) : t;
...
const ve = class K {
  ...
  allVerses(e = !1, r = K.verseRangeSeparators, u = K.verseSequenceIndicators) {
    if (this._verse == null || this.chapterNum <= 0)
      return [this.clone()];
    const o = [], a = nr(this._verse, u);
    for (const p of a.map((h) => nr(h, r))) {
      const h = this.clone();
      h.verse = p[0];
      const f = h.verseNum;
...
let qr = ve, yt = class extends Error {
};
var J = {}, le = {}, ur;
function Dt() {
  if (ur) return le;
...
function $r() {
  ...
  var C = r(v), b = o("[", C, r(/[-.0-9\xB7]/), r(/[\u0300-\u036F\u203F-\u2040]/), "]"), y = o(v, b, "*"), q = o(b, "+"), B = o("&", y, ";"), F = a(/&#[0-9]+;|&#x[0-9a-fA-F]+;/), U = a(B, "|", F), ue = o("%", y, ";"), he = a(
    ...
    "|",
    o("'", a(/[^%&']/, "|", ue, "|", U), "*", "'")
  ), E = a('"', a(/[^<&"]/, "|", U), "*", '"', "|", "'", a(/[^<&']/, "|", U), "*", "'"), x = u(v, ":"), k = u(b, ":"), G = o(x, k, "*"), W = o(G, a(":", G), "?"), te = o("^", W, "$"), Ie = o("(", W, ")"), re = a(/"[^"]*"|'[^']*'/), Be = o(/^<\?/, "(", y, ")", a(m, "(", h, "*?)"), "?", /\?>/), g = /[\x20\x0D\x0Aa-zA-Z0-9-'()+,./:=?;!*#@$_%]/, N = a('"', g, '*"', "|", "'", u(g, "'"), "*'"), S = "<!--", T = "-->", M = o(S, a(u(h, "-"), "|", o("-", u(h, "-"))), "*", T), A = "#PCDATA", R = a(
    o(/\(/, l, A, a(l, /\|/, l, W), "*", l, /\)\*/),
    "|",
    o(/\(/, l, A, l, /\)/)
  ), X = /[?*+]?/, _ = o(
  ...
  ), w = a("EMPTY", "|", "ANY", "|", R, "|", _), I = "<!ELEMENT", P = o(I, m, a(W, "|", ue), m, a(w, "|", ue), l, ">"), V = o("NOTATION", m, /\(/, l, y, a(l, /\|/, l, y), "*", l, /\)/), pe = o(/\(/, l, q, a(l, /\|/, l, q), "*", l, /\)/), we = a(V, "|", pe), Ae = a(/CDATA|ID|IDREF|IDREFS|ENTITY|ENTITIES|NMTOKEN|NMTOKENS/, "|", we), ae = a(/#REQUIRED|#IMPLIED/, "|", a(a("#FIXED", m), "?", E)), L = a(m, y, m, Ae, m, ae), Ue = "<!ATTLIST", Re = o(Ue, m, y, L, "*", l, ">"), de = "about:legacy-compat", Ve = a('"' + de + '"', "|", "'" + de + "'"), _e = "SYSTEM", Se = "PUBLIC", ke = a(a(_e, m, re), "|", a(Se, m, N, m, re)), He = o(
    "^",
    a(
  ...
  ), Je = a(m, "NDATA", m, y), ye = a(he, "|", a(ke, Je, "?")), Q = "<!ENTITY", ze = o(Q, m, y, m, ye, l, ">"), se = a(he, "|", ke), Xe = o(Q, m, "%", m, y, m, se, l, ">"), vt = a(ze, "|", Xe), Ye = o(Se, m, N), Ke = o("<!NOTATION", m, y, m, a(ke, "|", Ye), l, ">"), $ = o(l, "=", l), Z = /1[.]\d+/, be = o(m, "version", $, a("'", Z, "'", "|", '"', Z, '"')), Ne = /[A-Za-z][-A-Za-z0-9._]*/, We = a(m, "encoding", $, a('"', Ne, '"', "|", "'", Ne, "'")), st = a(m, "standalone", $, a("'", a("yes", "|", "no"), "'", "|", '"', a("yes", "|", "no"), '"')), ct = o(/^<\?xml/, be, We, "?", st, "?", l, /\?>/), lt = "<!DOCTYPE", At = "<![CDATA[", bt = "]]>", ft = /<!\[CDATA\[/, Qe = /\]\]>/, ht = o(h, "*?", Qe), xt = o(ft, ht);
  return j.chars = r, j.chars_without = u, j.detectUnicodeSupport = t, j.reg = o, j.regg = a, j.ABOUT_LEGACY_COMPAT = de, j.ABOUT_LEGACY_COMPAT_SystemLiteral = Ve, j.AttlistDecl = Re, j.CDATA_START = At, j.CDATA_END = bt, j.CDSect = xt, j.Char = h, j.Comment = M, j.COMMENT_START = S, j.COMMENT_END = T, j.DOCTYPE_DECL_START = lt, j.elementdecl = P, j.EntityDecl = vt, j.EntityValue = he, j.ExternalID = ke, j.ExternalID_match = He, j.Name = y, j.NotationDecl = Ke, j.Reference = U, j.PEReference = ue, j.PI = Be, j.PUBLIC = Se, j.PubidLiteral = N, j.QName = W, j.QName_exact = te, j.QName_group = Ie, j.S = m, j.SChar_s = d, j.S_OPT = l, j.SYSTEM = _e, j.SystemLiteral = re, j.UNICODE_REPLACEMENT_CHARACTER = p, j.UNICODE_SUPPORT = e, j.XMLDecl = ct, j;
}
var ar;
function jr() {
  if (ar) return ne;
  ar = 1;
  var t = Dt(), e = t.find, r = t.hasDefaultHTMLNamespace, u = t.hasOwn, o = t.isHTMLMimeType, a = t.isHTMLRawTextElement, p = t.isHTMLVoidElement, h = t.MIME_TYPE, f = t.NAMESPACE, d = Symbol(), m = Pt(), l = m.DOMException, v = m.DOMExceptionName, C = $r();
  function b(n) {
    if (n !== d)
  ...
  var k = {}, G = k.ELEMENT_NODE = 1, W = k.ATTRIBUTE_NODE = 2, te = k.TEXT_NODE = 3, Ie = k.CDATA_SECTION_NODE = 4, re = k.ENTITY_REFERENCE_NODE = 5, Be = k.ENTITY_NODE = 6, g = k.PROCESSING_INSTRUCTION_NODE = 7, N = k.COMMENT_NODE = 8, S = k.DOCUMENT_NODE = 9, T = k.DOCUMENT_TYPE_NODE = 10, M = k.DOCUMENT_FRAGMENT_NODE = 11, A = k.NOTATION_NODE = 12, R = t.freeze({
  ...
  function P(n) {
    ...
    if (n._inc !== i) {
      ...
      if (Kt(n, "length", s.length), !n.$$length || s.length < n.$$length)
  ...
  L.prototype = {
    ...
    cloneNode: function(n) {
      return qt(this.ownerDocument || this, this, n);
    },
    /**
  ...
  xt.prototype.serializeToString = function(n, i) {
    return ie.call(n, i);
  ...
  function qe(n, i, s, c) {
    ...
    switch (n.nodeType) {
      case G:
        ...
        var $t = !Ee;
        if ($t && (O || n.namespaceURI === f.HTML) && ($t = p(ge)), $t)
          i.push("/>");
        else {
          if (i.push(">"), O && a(ge))
            for (; Ee; )
      ...
      case T:
        var Wt = n.publicId, pt = n.systemId;
        i.push(C.DOCTYPE_DECL_START, " ", n.name), Wt ? (i.push(" ", C.PUBLIC, " ", Wt), pt && pt !== "." && i.push(" ", pt)) : pt && pt !== "." && i.push(" ", C.SYSTEM, " ", pt), n.internalSubset && i.push(" [", n.internalSubset, "]"), i.push(">");
        return;
      case g:
  ...
  function Yt(n, i, s) {
    ...
    if (c || (c = i.cloneNode(!1)), c.ownerDocument = n, c.parentNode = null, s)
      for (var D = i.firstChild; D; )
        c.appendChild(Yt(n, D, s)), D = D.nextSibling;
    return c;
  }
  function qt(n, i, s) {
    ...
    switch (i.childNodes && (c.childNodes = new w()), c.ownerDocument = n, c.nodeType) {
      case G:
        ...
        for (var Ce = 0; Ce < ge; Ce++)
          c.setAttributeNode(qt(n, Y.item(Ce), !0));
        break;
      case W:
        s = !0;
    }
    if (s)
      for (var De = i.firstChild; De; )
        c.appendChild(qt(n, De, s)), De = De.nextSibling;
    return c;
  }
  function Kt(n, i, s) {
    n[i] = s;
...
function Tn() {
  if (cr) return Ct;
  cr = 1;
  var t = Dt(), e = $r(), r = Pt(), u = t.isHTMLEscapableRawTextElement, o = t.isHTMLMimeType, a = t.isHTMLRawTextElement, p = t.hasOwn, h = t.NAMESPACE, f = r.ParseError, d = r.DOMException, m = 0, l = 1, v = 2, C = 3, b = 4, y = 5, q = 6, B = 7;
  function F() {
  }
  F.prototype = {
    parse: function(g, N, S) {
      var T = this.domBuilder;
      T.startDocument(), G(N, N = /* @__PURE__ */ Object.create(null)), ue(g, N, S, T, this.errorHandler), T.endDocument();
    }
  };
  var U = /&#?\w+;?/g;
    ...
    for (var we = [{ currentNSMap: N }], Ae = [], ae = 0; ; ) {
      try {
        ...
        switch (g.charAt(L + 1)) {
          ...
          default:
            V && pe(L);
            var Q = new Be(), ze = we[we.length - 1].currentNSMap, se = E(g, L, Q, ze, X, M, A), Xe = Q.length;
...
function wn() {
  if (lr) return rt;
  lr = 1;
  var t = Dt(), e = jr(), r = Pt(), u = Cn(), o = Tn(), a = e.DOMImplementation, p = t.hasDefaultHTMLNamespace, h = t.isHTMLMimeType, f = t.isValidMimeType, d = t.MIME_TYPE, m = t.NAMESPACE, l = r.ParseError, v = o.XMLReader;
  function C(E) {
    return E.replace(/\r[\n\u0085]/g, `
`).replace(/[\r\u0085\u2028\u2029]/g, `
`);
  ...
  b.prototype.parseFromString = function(E, x) {
    ...
    return Be && typeof E != "string" && re.errorHandler.fatalError("source is not a string"), re.parse(this.normalizeLineEndings(String(E)), k, G), te.doc.documentElement || re.errorHandler.fatalError("missing root element"), te.doc;
  };
  function y(E) {
    var x = E || {};
  ...
  y.prototype = {
    ...
    startElement: function(E, x, k, G) {
      var W = this.doc, te = W.createElementNS(E, k || x), Ie = G.length;
      U(this, te), this.currentElement = te, this.locator && q(this.locator, te);
      for (var re = 0; re < Ie; re++) {
        var E = G.getURI(re), Be = G.getValue(re), k = G.getQName(re), g = W.createAttributeNS(E, k);
        this.locator && q(G.getLocator(re), g), g.value = g.nodeValue = Be, te.setAttributeNode(g);
      }
    },
    ...
    startDTD: function(E, x, k, G) {
      ...
      if (W && W.createDocumentType) {
        var te = W.createDocumentType(E, x, k, G);
...
function gt(t, e) {
  return e < 0 || e > fe(t) - 1 ? "" : kt(t, e, 1);
}
function li(t, e) {
  if (!(e < 0 || e > fe(t) - 1))
    return kt(t, e, 1).codePointAt(0);
}
...
function mr(t, e, r) {
  ...
  if (e > u || r && (e > r && !(e >= 0 && e < u && r < 0 && r > -u) || r < -u))
    return "";
  const o = dr(u, e), a = r ? dr(u, r) : void 0;
  return ut(t, o, a);
}
function gr(t, e, r) {
  const u = [];
  ...
  let o = e;
  (typeof e == "string" || e instanceof RegExp && !wt(e.flags, "g")) && (o = new RegExp(e, "g"));
  const a = t.match(o);
  let p = 0;
  if (!a) return [t];
  for (let h = 0; h < (r ? r - 1 : a.length); h++) {
    const f = It(t, a[h], p), d = fe(a[h]);
...
function vi(t) {
  return t ? Ur(t).map((u) => new RegExp(u)) : [];
}
const Ln = (
...
const zt = ["chapter", "book", "para", "row", "sidebar", Vt], Pn = "​", zr = [
...
], kn = 1, Fn = zr.length - 1, qn = 1, $n = 1, bi = {
  book: "GEN",
  chapterNum: 1,
  verseNum: 1
}, jn = (t) => {
  var e;
  return ((e = zr[t]) == null ? void 0 : e.chapters) ?? -1;
}, Ni = (t, e) => ({
...
async function Ti(t, e, r) {
  ...
  if (!Vr(Intl.getCanonicalLocales(e)[0], "zh"))
    return r({
  ...
  return gr(a[0], "ÿ08")[0].trim();
}
function wi(t) {
  return new qr(ee.bookIdToNumber(t.book), t.chapterNum, t.verseNum).BBBCCC;
}
function Er(t) {
  return new qr(ee.bookIdToNumber(t.book), t.chapterNum, t.verseNum).BBBCCCVVV;
}
function Si(t, e) {
  return Er(t) - Er(e);
}
...
function Ri(t, e, r) {
  ...
  if (!u) return !1;
  const o = ee.bookIdToEnglishName(t), a = r == null ? void 0 : r.get(t);
  return !!(wt(o.toLowerCase(), u) || wt(t.toLowerCase(), u) || (a ? wt(a.localizedName.toLowerCase(), u) || wt(a.localizedId.toLowerCase(), u) : !1));
}
function _i(t, e) {
  var u;
...
const zn = ee.allBookIds.filter(
  (t) => !ee.isObsolete(ee.bookIdToNumber(t))
), Pi = Object.fromEntries(
  zn.map((t) => [t, ee.bookIdToEnglishName(t)])
), Gn = (
  // Using unicode control characters to be very explicit about which characters we are using.
  // The first 6 characters are the control characters \f\n\r\t\v.
  // eslint-disable-next-line no-control-regex
...
function vr(t) {
  ...
  for (let o = 0; o < t.length; o += 1) {
    const a = t[o];
    a.charCodeAt(0) < 32 ? (r || (e += " "), r = !0) : !r && a === Pn && o + 1 < t.length && Dr(t[o + 1]) || (Dr(a) ? (r || (e += a), r = !0) : Jn(a) && u === a || (e += a, r = !1)), u = a;
  }
  return e;
}
function Ar(t) {
...
function br(t, e) {
  if (!e || !zt.includes(e.type)) return !1;
  if (!e.content)
    throw new Error(
...
function Gr(t, e, r, u) {
  ...
  if (o && a) {
    const p = vr(t), h = vr(r);
    if (p !== h) {
      if (!mt(Bt(p, -1) ?? "") && !mt(Bt(h, -1) ?? "") || !br(t, e) || !br(r, u)) return !1;
      let f = p;
      for (; mt(Bt(f, -1) ?? ""); ) f = mr(f, 0, -1);
      let d = h;
      for (; mt(Bt(d, -1) ?? ""); ) d = mr(d, 0, -1);
      if (f !== d) return !1;
    }
  } else if (!o && !a) {
    ...
    const d = Ar(p.content), m = Ar(h.content);
    if (d !== m) return !1;
    if (!d && !m) {
      let l = p.content, v = h.content;
      const C = l[l.length - 1];
      zt.includes(p.type) && Me(C) && mt(C) && (l = l.slice(0, -1));
      const b = v[v.length - 1];
      if (zt.includes(h.type) && Me(b) && mt(b) && (v = v.slice(0, -1)), l.length !== v.length) return !1;
...
var Qn = "__v", Zn = "__o", eu = "_owner", Cr = Object.getOwnPropertyDescriptor, Tr = Object.keys;
function tu(t, e, r) {
  var u = t.length;
  if (e.length !== u)
    return !1;
...
function Tt(t, e, r) {
  var u = yr(t), o = u.length;
  if (yr(e).length !== o)
    return !1;
  for (var a, p, h; o-- > 0; )
    if (a = u[o], !Hr(t, e, r, a) || (p = Cr(t, a), h = Cr(e, a), (p || h) && (!p || !h || p.configurable !== h.configurable || p.enumerable !== h.enumerable || p.writable !== h.writable)))
      return !1;
  return !0;
}
function au(t, e) {
...
function Tu(t) {
  var e = t.circular, r = t.createCustomConfig, u = t.strict, o = {
    ...
    areMapsEqual: u ? Nr(wr, Tt) : wr,
    areNumbersEqual: iu,
    areObjectsEqual: u ? Tt : ou,
    arePrimitiveWrappersEqual: au,
    areRegExpsEqual: su,
    areSetsEqual: u ? Nr(Sr, Tt) : Sr,
    areTypedArraysEqual: u ? Tt : cu,
    areUrlsEqual: lu
  };
  if (r && (o = Ir({}, o, r(o))), e) {
    var a = Lt(o.areArraysEqual), p = Lt(o.areMapsEqual), h = Lt(o.areObjectsEqual), f = Lt(o.areSetsEqual);
    o = Ir({}, o, {
      areArraysEqual: a,
      areMapsEqual: p,
      areObjectsEqual: h,
...
function Ui() {
  return typeof navigator < "u" && navigator.languages ? navigator.languages[0] : new en().resolvedOptions().locale;
}
function Vi(t, e = 2) {
...
const Bu = 1e3, Jr = 60, Xr = Jr * 60, Ru = Xr * 24;
function zi(t, e, r = /* @__PURE__ */ new Date()) {
...
class oe {
  ...
  findSingleValue(e) {
    const r = Qt({ path: e, json: this.usj, wrap: !0 });
    if (r === void 0 || r.length === 0) return;
    if (!Array.isArray(r[0])) return r[0];
    const u = Qt({ path: e, json: this.usj, wrap: !1 });
  ...
  findVerseRefForNode(e, r, u = {
    ...
    if (typeof e == "object" && e.number !== void 0) {
      ...
      e.type === _t && !u.verseNum && (u.verseNum = f, u.startingContentNode = e);
    }
    if (!r.content)
  ...
  nodeToVerseRefAndOffset(e, r, u) {
    ...
    return a.startingContentNode !== void 0 && this.findNextMatchingNode(a.startingContentNode, [], (f, d) => {
      var m, l;
      return f === r ? !0 : d.find((v) => je.includes(v.parent.type)) ? !1 : typeof f == "string" ? (h += f.length, !1) : f.type === Rt && f.number !== ((m = a.chapterNum) == null ? void 0 : m.toString()) || f.type === _t && f.number !== ((l = a.verseNum) == null ? void 0 : l.toString()) ? (h = 0, !0) : !1;
    }), { verseRef: p, offset: h };
  }
  // #endregion
  ...
  verseRefToUsjContentLocation(e, r = 0) {
    ...
    const h = e.verse ?? e.verseNum.toString(), f = this.findNextMatchingNode(
      o,
      je,
      (v, C) => v === o ? e.verseNum === 0 ? (p = oe.convertWorkingStackToJsonPath(C), !0) : !1 : typeof v != "object" ? !1 : v.type === Rt ? (a = !0, !0) : v.type === _t && v.number !== void 0 && v.number === h ? (p = oe.convertWorkingStackToJsonPath(C), !0) : !1
    );
    ...
    return this.findNextMatchingNode(
      ...
      (v, C) => {
        ...
        } else if (v.type === Rt || v.type === _t) return !0;
        return !1;
      }
