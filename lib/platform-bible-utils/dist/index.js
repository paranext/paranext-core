...
import { F as It, a as Et, b as wt, L as St, S as Pt, c as Tt, e as Ct, f as qt, g as At, h as jt, j as $t, k as Nt, l as Ft, m as Ot, n as Ut, o as Rt, p as Dt, q as Lt, r as Bt, s as Vt, t as zt, u as Ht, v as Jt, w as Kt, x as Gt, y as Yt, z as Xt, A as Wt, B as Zt, C as Qt, E as er, G as tr, H as rr, I as nr, J as ir, K as sr, M as ar, N as or, O as cr, P as dr, Q as pr, R as lr, T as ur, U as hr, V as fr, W as mr, X as gr, Y as yr, Z as kr, _ as br, $ as vr, a0 as xr, a1 as Mr, a2 as _r, a3 as Ir, a4 as Er, a5 as wr, a6 as Sr, a7 as Pr, a8 as Tr } from "./scripture-util-CIEEBU92.js";
...
const Be = "ABORTED", Ve = "ALREADY_EXISTS", ze = "CANCELLED", He = "DATA_LOSS", Je = "DEADLINE_EXCEEDED", Ke = "FAILED_PRECONDITION", Ge = "INTERNAL", Ye = "INVALID_ARGUMENT", Xe = "NOT_FOUND", We = "OUT_OF_RANGE", Ze = "PERMISSION_DENIED", Qe = "RESOURCE_EXHAUSTED", et = "UNAUTHENTICATED", tt = "UNAVAILABLE", rt = "UNIMPLEMENTED", nt = "UNKNOWN", A = 1;
function it(o, e) {
  if (!o)
    return {
      message: "",
...
function he(o, e) {
  ...
  return Object.keys(t).forEach((n) => {
    i && (Object.hasOwn(r, n) && he(r[n], t[n]) || (i = !1));
  }), i;
}
function V(o, e, t) {
...
const ht = (o) => o.replace(/&/g, "&amp;").replace(/</g, "&lt;").replace(/>/g, "&gt;").replace(/"/g, "&quot;").replace(/'/g, "&#x27;").replace(/\//g, "&#x2F;");
function ft() {
...
const me = 1e3, J = 60, K = J * 60, ge = K * 24;
function gt(o, e, t = /* @__PURE__ */ new Date()) {
  const r = Math.floor((e.getTime() - t.getTime()) / me), i = Math.round(r / ge);
...
function vt(o, e, t) {
  ...
  return i.id = `${Me}${t ? `-${t}` : ""}`, i.dataset.themeId = o.id, i.textContent = Ie(o), this.document.head.appendChild(i), i;
}
function X(o) {
...
USJ: ${JSON.stringify(
  ...
  findAllNotes() {
    var e;
    return ue((e = this.usj) == null ? void 0 : e.content);
  }
  /**
  ...
  getInfoForMarker(e, t = "usfm") {
    ...
    if (t === "usfm" && l === "cell" && b.colspan) {
      const u = parseInt(b.colspan, 10), h = we.exec(r);
      if (h != null && h[1]) {
  ...
  textContentToUsfm(e) {
    return {
      usfm: this.shouldAllowInvisibleCharacters ? e : e.replace(Ee, "~"),
    ...
    e.map((l) => {
      ...
      if (typeof l.fragment == "object" && "type" in l.fragment) {
        ...
        if (h.type === pe && h.code)
          ...
          const f = (m = Se.exec(h.number)) == null ? void 0 : m[1];
          if (!f)
            console.warn(
...
export {
  Be as ABORTED,
  Ve as ALREADY_EXISTS,
  U as AsyncVariable,
  ze as CANCELLED,
  B as CHAPTER_TYPE,
  Ne as Collator,
  He as DATA_LOSS,
  Je as DEADLINE_EXCEEDED,
  ne as DateTimeFormat,
  se as DocumentCombiner,
  Fe as EventRollingTimeCounter,
  Ke as FAILED_PRECONDITION,
  It as FIRST_SCR_BOOK_NUM,
  Et as FIRST_SCR_CHAPTER_NUM,
  wt as FIRST_SCR_VERSE_NUM,
  Ge as INTERNAL,
  Ye as INVALID_ARGUMENT,
  St as LAST_SCR_BOOK_NUM,
  kt as MODIFIER_KEYS,
  oe as Mutex,
  Oe as MutexMap,
  Xe as NOT_FOUND,
  Ue as NonValidatingDocumentCombiner,
  ce as NumberFormat,
  We as OUT_OF_RANGE,
  Ze as PERMISSION_DENIED,
  A as PLATFORM_ERROR_VERSION,
  ie as PlatformEventEmitter,
  Re as PromiseChainingMap,
  Qe as RESOURCE_EXHAUSTED,
  Pt as SELECTABLE_INVISIBLE_CHAR_OR_WHITESPACE_CLASS,
  Tt as Section,
  L as SortedNumberMap,
  De as SortedSet,
  Me as THEME_STYLE_ELEMENT_ID,
  et as UNAUTHENTICATED,
  tt as UNAVAILABLE,
  rt as UNIMPLEMENTED,
  nt as UNKNOWN,
  F as USFM_MARKERS_MAP_3_0,
  xt as USFM_MARKERS_MAP_PARATEXT_3_0,
  Le as UnsubscriberAsyncList,
  g as UsjReaderWriter,
  w as VERSE_TYPE,
  ot as aggregateUnsubscriberAsyncs,
  at as aggregateUnsubscribers,
  vt as applyThemeStylesheet,
  Ct as areUsjContentsEqualExceptWhitespace,
  qt as at,
  At as charAt,
  jt as codePointAt,
  $t as collapseMiddleWords,
  ...
  Rt as endsWith,
  Dt as ensureArray,
  Lt as escapeStringRegexp,
  bt as expandThemeContribution,
  mt as formatBytes,
  yt as formatRelativeDate,
  Bt as formatReplacementString,
  Vt as formatReplacementStringToArray,
  zt as formatScrRef,
  Ht as formatScrRefRange,
  gt as formatTimeSpan,
  Jt as getAllObjectFunctionNames,
  Kt as getChaptersForBook,
  ft as getCurrentLocale,
  H as getDefaultCallerSequence,
  Gt as getErrorMessage,
  pt as getFormatCallerFunction,
  Yt as getLocalizeKeyForScrollGroupId,
  Xt as getLocalizeKeysForScrollGroupIds,
  Wt as getLocalizedIdFromBookNumber,
  le as getNthCaller,
  lt as getPaneSizeLimits,
  Zt as getSectionForBook,
  Ie as getStylesheetForTheme,
  Qt as groupBy,
  ht as htmlEncode,
  er as includes,
  tr as indexOf,
  ...
  ar as isWhiteSpace,
  or as lastIndexOf,
  be as localizedStringsDocumentSchema,
  ve as menuDocumentSchema,
  cr as newGuid,
  ...
  ur as offsetChapter,
  hr as offsetVerse,
  fr as ordinalCompare,
  mr as padEnd,
  gr as padStart,
  ye as projectSettingsDocumentSchema,
  dt as sanitizeHtml,
  yr as scrRefToBBBCCC,
  kr as scrRefToBBBCCCVVV,
  V as serialize,
  ke as settingsDocumentSchema,
  br as slice,
  vr as split,
  xr as startsWith,
  Mr as stringLength,
  ...
  Ir as toArray,
  Er as toKebabCase,
  wr as transformAndEnsureRegExpArray,
  Sr as transformAndEnsureRegExpRegExpArray,
  ct as usfmMarkers,
  Pr as wait,
  Tr as waitForDuration
};
