...
const _ = 1;
function kn(r) {
  if (!r) return { message: "", platformErrorVersion: _ };
  if (w(r)) return { message: r, platformErrorVersion: _ };
  if (typeof r == "object" && "message" in r && typeof r.message == "string") {
    const e = {
      message: r.message,
      platformErrorVersion: _
    };
  ...
  return { cause: r, message: "", platformErrorVersion: _ };
}
function Nn(r) {
...
function R(r, e) {
  return e < 0 || e > x(r) - 1 ? "" : Y(r, e, 1);
}
function In(r, e) {
  if (!(e < 0 || e > x(r) - 1))
    return Y(r, e, 1).codePointAt(0);
}
function Ct(r, e, t = x(r)) {
  const n = Bt(r, e);
  return !(n === -1 || n + x(e) !== t);
}
function $t(r, e, t) {
...
function An(r, e, t = " ") {
  return e <= x(r) ? r : Ce(r, e, t, "right");
}
function Mn(r, e, t = " ") {
  return e <= x(r) ? r : Ce(r, e, t, "left");
}
function pe(r, e) {
...
const Q = ["chapter", "book", "para", "row", "sidebar", Oe], Rt = "​", ze = [
...
], Lt = 1, qt = ze.length - 1, Ft = 1, Jt = 1, Un = {
  book: "GEN",
  chapterNum: 1,
  verseNum: 1
}, zt = (r) => {
  ...
  book: I.bookNumberToId(
    Math.max(
      Lt,
      Math.min(I.bookIdToNumber(r.book) + e, qt)
    )
  ),
  chapterNum: 1,
  verseNum: 1
  ...
  ...r,
  chapterNum: Math.min(
    Math.max(Ft, r.chapterNum + e),
    zt(I.bookIdToNumber(r.book))
  ),
  verseNum: 1
}), Vn = (r, e) => ({
  ...r,
  verseNum: Math.max(Jt, r.verseNum + e)
});
...
var Ht = /* @__PURE__ */ ((r) => (r.OT = "OT", r.NT = "NT", r.DC = "DC", r.Extra = "Extra", r))(Ht || {});
const zn = (r) => {
...
function be(r) {
  ...
  for (let s = 0; s < r.length; s += 1) {
    const i = r[s];
    i.charCodeAt(0) < 32 ? (t || (e += " "), t = !0) : !t && i === Rt && s + 1 < r.length && ye(r[s + 1]) || (ye(i) ? (t || (e += i), t = !0) : Zt(i) && n === i || (e += i, t = !1)), n = i;
  }
  return e;
}
function ve(r) {
...
function Ge(r, e, t, n) {
  ...
  if (s && i) {
    const o = be(r), a = be(t);
    if (o !== a) {
      if (!V(H(o, -1) ?? "") && !V(H(a, -1) ?? "") || !ke(r, e) || !ke(t, n)) return !1;
      let c = o;
      for (; V(H(c, -1) ?? ""); ) c = he(c, 0, -1);
      let l = a;
      for (; V(H(l, -1) ?? ""); ) l = he(l, 0, -1);
      if (c !== l) return !1;
    }
  } else if (!s && !i) {
...
const Gn = (r) => (...e) => r.map((n) => n(...e)).every((n) => n), Xn = (r) => async (...e) => {
  const t = r.map(async (n) => n(...e));
  return (await Promise.all(t)).every((n) => n);
}, Qt = "book", Ne = "chapter", P = "verse", O = "***";
function _n(r) {
...
function er(r, e) {
  const t = e && e.length > 0 ? e : Xe();
  return t[r % t.length];
}
function Yn(r, e) {
  const t = e && e.length > 0 ? e : Xe(), n = (() => {
    const s = /* @__PURE__ */ new Map();
    let i = 0;
    return r.forEach((o, a) => {
      o.caller === "+" && (s.set(a, er(i, t)), i += 1);
    }), s;
  })();
  return (s, i) => {
    if (s === "+") {
...
var rr = Object.getOwnPropertyNames, nr = Object.getOwnPropertySymbols, ir = Object.prototype.hasOwnProperty;
function we(r, e) {
...
function Ie(r) {
  return rr(r).concat(nr(r));
}
var sr = Object.hasOwn || function(r, e) {
  return ir.call(r, e);
};
function B(r, e) {
  return r === e || !r && !e && r !== r && e !== e;
}
var or = "__v", ar = "__o", cr = "_owner", xe = Object.getOwnPropertyDescriptor, Ee = Object.keys;
function lr(r, e, t) {
  var n = r.length;
  if (e.length !== n)
    return !1;
...
function J(r, e, t) {
  ...
  if (Ie(e).length !== s)
    return !1;
  for (var i, o, a; s-- > 0; )
    if (i = n[s], !_e(r, e, t, i) || (o = xe(r, i), a = xe(e, i), (o || a) && (!o || !a || o.configurable !== a.configurable || o.enumerable !== a.enumerable || o.writable !== a.writable)))
      return !1;
  return !0;
}
function mr(r, e) {
...
function _e(r, e, t, n) {
  return (n === cr || n === ar || n === or) && (r.$$typeof || e.$$typeof) ? !0 : sr(e, n) && t.equals(r[n], e[n], n, n, r, e, t);
}
var vr = "[object Arguments]", kr = "[object Boolean]", Nr = "[object Date]", wr = "[object Error]", Ir = "[object Map]", xr = "[object Number]", Er = "[object Object]", Sr = "[object RegExp]", Ar = "[object Set]", Mr = "[object String]", Tr = "[object URL]", Pr = Array.isArray, Me = typeof ArrayBuffer == "function" && ArrayBuffer.isView ? ArrayBuffer.isView : null, Te = Object.assign, Or = Object.prototype.toString.call.bind(Object.prototype.toString);
function Cr(r) {
  ...
  return function(f, m, b) {
    ...
    if (E !== typeof m)
      return !1;
    if (E !== "object")
      return E === "number" ? o(f, m, b) : E === "function" ? s(f, m, b) : !1;
    var N = f.constructor;
    if (N !== m.constructor)
      return !1;
    if (N === Object)
    ...
    if (N === Set)
      return u(f, m, b);
    var S = Or(f);
    return S === Nr ? t(f, m, b) : S === Sr ? l(f, m, b) : S === Ir ? i(f, m, b) : S === Ar ? u(f, m, b) : S === Er ? typeof f.then != "function" && typeof m.then != "function" && a(f, m, b) : S === Tr ? p(f, m, b) : S === wr ? n(f, m, b) : S === vr ? a(f, m, b) : S === kr || S === xr || S === Mr ? c(f, m, b) : !1;
  };
}
function $r(r) {
  var e = r.circular, t = r.createCustomConfig, n = r.strict, s = {
    areArraysEqual: n ? J : lr,
    areDatesEqual: ur,
    areErrorsEqual: fr,
    areFunctionsEqual: pr,
    areMapsEqual: n ? we(Se, J) : Se,
    areNumbersEqual: hr,
    areObjectsEqual: n ? J : dr,
    arePrimitiveWrappersEqual: mr,
    areRegExpsEqual: gr,
    areSetsEqual: n ? we(Ae, J) : Ae,
    areTypedArraysEqual: n ? J : yr,
    areUrlsEqual: br
  };
  if (t && (s = Te({}, s, t(s))), e) {
...
function C(r) {
  r === void 0 && (r = {});
  var e = r.circular, t = e === void 0 ? !1 : e, n = r.createInternalComparator, s = r.createState, i = r.strict, o = i === void 0 ? !1 : i, a = $r(r), c = Cr(a), l = n ? n(c) : jr(c);
  return Ur({ circular: t, comparator: c, createState: s, equals: l, strict: o });
}
function ee(r, e) {
  return Br(r, e);
}
function Dr(r, e) {
  ...
  return Object.keys(t).forEach((i) => {
    s && (Object.hasOwn(n, i) && Dr(n[i], t[i]) || (s = !1));
  }), s;
}
function Pe(r, e, t) {
...
const Rr = 1e3, He = 60, We = He * 60, Lr = We * 24;
function ni(r, e, t = /* @__PURE__ */ new Date()) {
  const n = Math.floor((e.getTime() - t.getTime()) / Rr), s = Math.round(n / Lr);
  if (Math.abs(s) >= 1) return r.format(s, "day");
  const i = Math.round(n / We);
...
function ai(r, e, t) {
  ...
  return s.id = `${Gr}${t ? `-${t}` : ""}`, s.dataset.themeId = r.id, s.textContent = _r(r), this.document.head.appendChild(s), s;
}
function Qe(r) {
...
USJ: ${JSON.stringify(
  ...
  findAllNotes() {
    var e;
    return tr((e = this.usj) == null ? void 0 : e.content);
  }
  /**
  ...
  findNextMatchingNode(e, t) {
    ...
    let s = n;
    const i = g.findNextMatchingNodeUsingWorkingStack(
      e.node,
      n,
      [],
      (o, a) => (s = a, t({
        node: o,
        documentLocation: g.convertNodeToUsjDocumentLocation(o, a)
      }))
    );
    if (i !== void 0)
      return {
  ...
  findNextLocationOfMatchingText(e, t, n = 1e3) {
    ...
    if (g.findNextMatchingNodeUsingWorkingStack(
      ...
      (d, f) => {
        ...
        i += m.length, s = `${s}${m}`;
        const E = s.indexOf(t);
        return E < 0 ? (o += s.length, s.length > t.length && (s = s.substring(s.length - t.length)), o -= s.length, i > n) : (a = o + E, !0);
      }
    ), a < 0) return;
    i = 0;
    let u = 0, h = [];
  ...
  getInfoForMarker(e, t = "usfm") {
    ...
    if (t === "usfm" && c === "cell" && h.colspan) {
      const p = parseInt(h.colspan, 10), d = Wr.exec(n);
      if (d != null && d[1]) {
  ...
  textContentToUsfm(e) {
    return {
      usfm: this.shouldAllowInvisibleCharacters ? e : e.replace(Hr, "~"),
...
`);
    ...
    return s.push({ fragment: e, indexInUsfm: n.length }), n += a === "optbreak" ? "//" : `\\${h}`, a !== "optbreak" && (s.push({
      ...
      s.push({
        ...
        if ("isClosingMarker" in N.fragment) {
          const { isClosingMarker: S, ...D } = N.fragment, et = {
            ...D,
            forMarker: e,
  ...
  closingMarkerToUsfm(e, t) {
    ...
    if ((u.closed === "false" || i.isClosingMarkerOptional && !this.markersMap.shouldOptionalClosingMarkersBePresent && u.closed !== "true") && (h = !1), i.independentClosingMarkers && i.independentClosingMarkers.length > 0 && h) {
      ...
      let m = "";
      const b = [], { usfm: E, fragmentsInfo: N } = this.openingMarkerToUsfm(f, t), S = N.find((D) => g.isFragmentAMarker(D.fragment));
      if (!S)
        throw new Error(
...
export {
  ...
  dn as EventRollingTimeCounter,
  Lt as FIRST_SCR_BOOK_NUM,
  Ft as FIRST_SCR_CHAPTER_NUM,
  Jt as FIRST_SCR_VERSE_NUM,
  qt as LAST_SCR_BOOK_NUM,
  si as MODIFIER_KEYS,
  yt as Mutex,
  mn as MutexMap,
  gn as NonValidatingDocumentCombiner,
  bt as NumberFormat,
  _ as PLATFORM_ERROR_VERSION,
  ft as PlatformEventEmitter,
  yn as PromiseChainingMap,
  Ht as Section,
  le as SortedNumberMap,
  bn as SortedSet,
  Gr as THEME_STYLE_ELEMENT_ID,
  te as USFM_MARKERS_MAP_3_0,
  ci as USFM_MARKERS_MAP_PARATEXT_3_0,
  vn as UnsubscriberAsyncList,
  g as UsjReaderWriter,
  P as VERSE_TYPE,
  Xn as aggregateUnsubscriberAsyncs,
  ...
  Kt as compareScrRefs,
  fn as createSyncProxyForAsyncObject,
  an as debounce,
  K as deepClone,
  ee as deepEqual,
  Un as defaultScrRef,
  ...
  xn as formatReplacementString,
  jt as formatReplacementStringToArray,
  Fn as formatScrRef,
  Jn as formatScrRefRange,
  ni as formatTimeSpan,
  un as getAllObjectFunctionNames,
  zt as getChaptersForBook,
  ti as getCurrentLocale,
  Xe as getDefaultCallerSequence,
  $e as getErrorMessage,
  Yn as getFormatCallerFunction,
  Gt as getLocalizeKeyForScrollGroupId,
  ...
  cn as groupBy,
  _n as hasCustomParatextTags,
  ei as htmlEncode,
  Ut as includes,
  X as indexOf,
  pn as isErrorMessageAboutParatextBlockingInternetAccess,
  hn as isErrorMessageAboutRegistryAuthFailure,
  Tn as isLocalizeKey,
  Nn as isPlatformError,
  Qn as isSerializable,
  w as isString,
  Dr as isSubset,
  V as isWhiteSpace,
  Bt as lastIndexOf,
  Jr as localizedStringsDocumentSchema,
  zr as menuDocumentSchema,
  on as newGuid,
  kn as newPlatformError,
  En as normalize,
