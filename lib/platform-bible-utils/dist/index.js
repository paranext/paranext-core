...
var d = (t, e, r) => xe(t, typeof e != "symbol" ? e + "" : e, r);
import { Mutex as Re } from "async-mutex";
class or {
  /**
...
function lr(t, e = 300) {
  if (ke(t)) throw new Error("Tried to debounce a string! Could be XSS");
  let r;
  return (...s) => {
...
class Je {
  ...
  addOrUpdateContribution(e, r) {
    ...
    let n = this.options.copyDocuments && r ? R(r) : r;
...
class mr {
  ...
  get(e) {
    ...
    return r || (r = new _e(), this.mutexesByID.set(e, r), r);
  }
}
class gr extends Je {
...
var Ke = Object.defineProperty, Xe = (t, e, r) => e in t ? Ke(t, e, { enumerable: !0, configurable: !0, writable: !0, value: r }) : t[e] = r, l = (t, e, r) => Xe(t, typeof e != "symbol" ? e + "" : e, r);
const j = [
  "GEN",
  "EXO",
  "LEV",
...
function He(t) {
  const e = typeof t == "string" ? A(t) : t;
  return e >= 40 && e <= 66;
}
function Le(t) {
  return (typeof t == "string" ? A(t) : t) <= 39;
}
function de(t) {
  return t <= 66;
}
...
function* We() {
  for (let t = 1; t <= j.length; t++) yield t;
}
const Ze = 1, me = j.length;
function Ye() {
...
const y = class f {
  ...
  allVerses(e = !1, r = f.verseRangeSeparators, s = f.verseSequenceIndicators) {
    if (this._verse == null || this.chapterNum <= 0)
      return [this.clone()];
    const n = [], i = Y(this._verse, s);
    for (const o of i.map((a) => Y(a, r))) {
      const a = this.clone();
      a.verse = o[0];
      const h = a.verseNum;
...
var Q = typeof globalThis < "u" ? globalThis : typeof window < "u" ? window : typeof global < "u" ? global : typeof self < "u" ? self : {}, C = {}, nt = () => {
  const t = "\\ud800-\\udfff", o = "\\u0300-\\u036f" + "\\ufe20-\\ufe2f" + "\\u20d0-\\u20ff" + "\\u1ab0-\\u1aff" + "\\u1dc0-\\u1dff", a = "\\ufe0e\\ufe0f", h = "\\uD83D\\uDC69\\uD83C\\uDFFB\\u200D\\uD83C\\uDF93", p = `[${t}]`, u = `[${o}]`, c = "\\ud83c[\\udffb-\\udfff]", m = `(?:${u}|${c})`, v = `[^${t}]`, b = "(?:\\uD83C[\\uDDE6-\\uDDFF]){2}", P = "[\\ud800-\\udbff][\\udc00-\\udfff]", q = "\\u200d", Ce = "(?:\\ud83c\\udff4\\udb40\\udc67\\udb40\\udc62\\udb40(?:\\udc65|\\udc73|\\udc77)\\udb40(?:\\udc6e|\\udc63|\\udc6c)\\udb40(?:\\udc67|\\udc74|\\udc73)\\udb40\\udc7f)", Ie = `[${h}]`, H = `${m}?`, L = `[${a}]?`, Ae = `(?:${q}(?:${[v, b, P].join("|")})${L + H})*`, Te = L + H + Ae, Pe = `(?:${[`${v}${u}?`, u, b, P, p, Ie].join("|")})`;
  return new RegExp(`${Ce}|${c}(?=${c})|${Pe + Te}`, "g");
}, it = Q && Q.__importDefault || function(t) {
...
function z(t) {
  ...
  return t.match(k.default()) || [];
}
var ot = C.toArray = z;
function F(t) {
  if (typeof t != "string")
    throw new Error("Input must be a string");
  var e = t.match(k.default());
...
function ve(t, e, r) {
  ...
  var s = t.match(k.default());
  return s ? s.slice(e, r).join("") : "";
}
var ut = C.substring = ve;
function lt(t, e, r) {
  if (e === void 0 && (e = 0), typeof t != "string")
    throw new Error("Input must be a string");
  var s = F(t);
...
function mt(t, e, r) {
  if (e < 0) return -1;
  if (r) {
    if (I(t, e) === "}" && I(t, e - 1) === "\\") return e;
    const i = M(t, "\\}", e);
    return i >= 0 ? i + 1 : i;
  }
  let s = e;
  const n = g(t);
  for (; s < n && (s = M(t, "}", s), !(s === -1 || I(t, s - 1) !== "\\")); )
    s += 1;
  return s >= n ? -1 : s;
}
function wr(t, e) {
...
function te(t, e, r) {
  ...
  if (r !== void 0 && r <= 0)
    return [t];
  if (e === "") return yt(t).slice(0, r);
  let n = e;
  (typeof e == "string" || e instanceof RegExp && !gt(e.flags, "g")) && (n = new RegExp(e, "g"));
  const i = t.match(n);
  let o = 0;
  if (!i) return [t];
  for (let a = 0; a < (r ? r - 1 : i.length); a++) {
    const h = M(t, i[a], o), p = g(i[a]);
...
function Ar(t) {
  return t ? we(t).map(
    (s) => Array.isArray(s) ? s.map((n) => new RegExp(n)) : new RegExp(s)
  ) : [];
}
function Tr(t) {
  return t ? we(t).map((s) => new RegExp(s)) : [];
}
const Se = [
...
], vt = 1, Nt = Se.length - 1, wt = 1, Et = 1, St = (t) => {
  var e;
  return ((e = Se[t]) == null ? void 0 : e.chapters) ?? -1;
}, Pr = (t, e) => ({
  bookNum: Math.max(vt, Math.min(t.bookNum + e, Nt)),
  chapterNum: 1,
  verseNum: 1
}), Br = (t, e) => ({
  ...t,
  chapterNum: Math.min(
    Math.max(wt, t.chapterNum + e),
    St(t.bookNum)
  ),
  verseNum: 1
}), xr = (t, e) => ({
  ...t,
  verseNum: Math.max(Et, t.verseNum + e)
});
async function Rr(t, e, r) {
  const s = E.bookNumberToId(t);
  if (!Ee(Intl.getCanonicalLocales(e)[0], "zh"))
    return r({
...
function re(t) {
  return new st(t.bookNum, t.chapterNum, t.verseNum).BBBCCCVVV;
}
function Mr(t, e) {
  return re(t) - re(e);
}
...
const Vr = (t) => (...e) => t.map((s) => s(...e)).every((s) => s), qr = (t) => async (...e) => {
  const r = t.map(async (s) => s(...e));
  return (await Promise.all(r)).every((s) => s);
};
var $t = Object.getOwnPropertyNames, jt = Object.getOwnPropertySymbols, Ct = Object.prototype.hasOwnProperty;
function se(t, e) {
...
function ne(t) {
  return $t(t).concat(jt(t));
}
var Oe = Object.hasOwn || function(t, e) {
  return Ct.call(t, e);
};
function T(t, e) {
  return t || e ? t === e : t === e || t !== t && e !== e;
}
var $e = "_owner", ie = Object.getOwnPropertyDescriptor, oe = Object.keys;
function It(t, e, r) {
  var s = t.length;
  if (e.length !== s)
    return !1;
...
function ae(t, e, r) {
  ...
  for (var s = {}, n = t.entries(), i = 0, o, a; (o = n.next()) && !o.done; ) {
    for (var h = e.entries(), p = !1, u = 0; (a = h.next()) && !a.done; ) {
      var c = o.value, m = c[0], v = c[1], b = a.value, P = b[0], q = b[1];
      !p && !s[u] && (p = r.equals(m, P, i, u, t, e, r) && r.equals(v, q, m, P, t, e, r)) && (s[u] = !0), u++;
    }
    if (!p)
      return !1;
    i++;
...
function Tt(t, e, r) {
  ...
  if (oe(e).length !== n)
    return !1;
  for (var i; n-- > 0; )
    if (i = s[n], i === $e && (t.$$typeof || e.$$typeof) && t.$$typeof !== e.$$typeof || !Oe(e, i) || !r.equals(t[i], e[i], i, i, t, e, r))
      return !1;
  return !0;
}
function x(t, e, r) {
  ...
  if (ne(e).length !== n)
    return !1;
  for (var i, o, a; n-- > 0; )
    if (i = s[n], i === $e && (t.$$typeof || e.$$typeof) && t.$$typeof !== e.$$typeof || !Oe(e, i) || !r.equals(t[i], e[i], i, i, t, e, r) || (o = ie(t, i), a = ie(e, i), (o || a) && (!o || !a || o.configurable !== a.configurable || o.enumerable !== a.enumerable || o.writable !== a.writable)))
      return !1;
  return !0;
}
function Pt(t, e) {
...
function Kt(t) {
  ...
  return function(u, c, m) {
    ...
    if (v === Set)
      return a(u, c, m);
    var b = Ft(u);
    return b === Dt ? r(u, c, m) : b === zt ? o(u, c, m) : b === kt ? s(u, c, m) : b === Jt ? a(u, c, m) : b === qt ? typeof u.then != "function" && typeof c.then != "function" && n(u, c, m) : b === Rt ? n(u, c, m) : b === Mt || b === Vt || b === Gt ? i(u, c, m) : !1;
  };
}
function Xt(t) {
  var e = t.circular, r = t.createCustomConfig, s = t.strict, n = {
    areArraysEqual: s ? x : It,
    areDatesEqual: At,
    areMapsEqual: s ? se(ae, x) : ae,
    areObjectsEqual: s ? x : Tt,
    arePrimitiveWrappersEqual: Pt,
    areRegExpsEqual: Bt,
    areSetsEqual: s ? se(ue, x) : ue,
    areTypedArraysEqual: s ? x : xt
  };
  if (r && (n = ce({}, n, r(n))), e) {
    var i = D(n.areArraysEqual), o = D(n.areMapsEqual), a = D(n.areObjectsEqual), h = D(n.areSetsEqual);
    n = ce({}, n, {
      areArraysEqual: i,
      areMapsEqual: o,
      areObjectsEqual: a,
...
function O(t) {
  t === void 0 && (t = {});
  var e = t.circular, r = e === void 0 ? !1 : e, s = t.createInternalComparator, n = t.createState, i = t.strict, o = i === void 0 ? !1 : i, a = Xt(t), h = Kt(a), p = s ? s(h) : Ht(h);
  return Lt({ circular: r, comparator: h, createState: n, equals: p, strict: o });
}
function Wt(t, e) {
  return Ut(t, e);
}
function Zt(t, e) {
  ...
  return Object.keys(r).forEach((i) => {
    n && (Object.hasOwn(s, i) && Zt(s[i], r[i]) || (n = !1));
  }), n;
}
function fe(t, e, r) {
...
function _r(t, e = 2) {
  ...
  const r = ["Bytes", "KB", "MB", "GB", "TB", "PB", "EB", "ZB", "YB"], s = Math.floor(Math.log(t) / Math.log(1024)), n = r[s];
  return `${new Fe("en", {
    style: "decimal",
...
export {
  ...
  Je as DocumentCombiner,
  vt as FIRST_SCR_BOOK_NUM,
  wt as FIRST_SCR_CHAPTER_NUM,
  Et as FIRST_SCR_VERSE_NUM,
  Nt as LAST_SCR_BOOK_NUM,
  _e as Mutex,
  mr as MutexMap,
  gr as NonValidatingDocumentCombiner,
  Fe as NumberFormat,
  De as PlatformEventEmitter,
  br as UnsubscriberAsyncList,
  qr as aggregateUnsubscriberAsyncs,
  Vr as aggregateUnsubscribers,
  vr as at,
  I as charAt,
  Nr as codePointAt,
  Mr as compareScrRefs,
  dr as createSyncProxyForAsyncObject,
  lr as debounce,
  R as deepClone,
  Wt as deepEqual,
  Yt as deserialize,
  ...
  Zt as isSubset,
  bt as lastIndexOf,
  tr as localizedStringsDocumentSchema,
  rr as menuDocumentSchema,
  ur as newGuid,
  Er as normalize,
  Pr as offsetBook,
  Br as offsetChapter,
  xr as offsetVerse,
  Sr as ordinalCompare,
  Or as padEnd,
  $r as padStart,
  Qt as projectSettingsDocumentSchema,
  re as scrRefToBBBCCCVVV,
  fe as serialize,
  er as settingsDocumentSchema,
  jr as slice,
  te as split,
  Ee as startsWith,
  g as stringLength,
