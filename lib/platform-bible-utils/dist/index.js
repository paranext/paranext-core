...
var Q = (t, e, n) => Xr(t, typeof e != "symbol" ? e + "" : e, n);
...
class tn {
  ...
  constructor(e, n) {
    Q(this, "baseDocument");
    Q(this, "contributions", /* @__PURE__ */ new Map());
    Q(this, "latestOutput");
    Q(this, "options");
    Q(this, "onDidRebuildEmitter", new Kr());
    /** Event that emits to announce that the document has been rebuilt and the output has been updated */
    // Need `onDidRebuildEmitter` to be instantiated before this line
    // eslint-disable-next-line @typescript-eslint/member-ordering
    Q(this, "onDidRebuild", this.onDidRebuildEmitter.subscribe);
...
class Hu {
  constructor() {
    Q(this, "mutexesByID", /* @__PURE__ */ new Map());
  }
  get(e) {
...
class Xu {
  constructor(e = "Anonymous") {
    Q(this, "unsubscribers", /* @__PURE__ */ new Set());
    this.name = e;
  }
  /**
...
function Dt() {
  ...
  tr = 1;
  function t(B, k, $) {
    if ($ === void 0 && ($ = Array.prototype), B && typeof $.find == "function")
      return $.find.call(B, k);
...
function Fr() {
  ...
  var O = n(v), b = o("[", O, n(/[-.0-9\xB7]/), n(/[\u0300-\u036F\u203F-\u2040]/), "]"), C = o(v, b, "*"), j = o(b, "+"), B = o("&", C, ";"), k = a(/&#[0-9]+;|&#x[0-9a-fA-F]+;/), $ = a(B, "|", k), ne = o("%", C, ";"), le = a(
    o('"', a(/[^%&"]/, "|", ne, "|", $), "*", '"'),
    "|",
    o("'", a(/[^%&']/, "|", ne, "|", $), "*", "'")
  ), g = a('"', a(/[^<&"]/, "|", $), "*", '"', "|", "'", a(/[^<&']/, "|", $), "*", "'"), x = i(v, ":"), F = i(b, ":"), G = o(x, F, "*"), W = o(G, a(":", G), "?"), ee = o("^", W, "$"), Ie = o("(", W, ")"), te = a(/"[^"]*"|'[^']*'/), Re = o(/^<\?/, "(", C, ")", a(E, "(", p, "*?)"), "?", /\?>/), d = /[\x20\x0D\x0Aa-zA-Z0-9-'()+,./:=?;!*#@$_%]/, N = a('"', d, '*"', "|", "'", i(d, "'"), "*'"), w = "<!--", y = "-->", M = o(w, a(i(p, "-"), "|", o("-", i(p, "-"))), "*", y), A = "#PCDATA", R = a(
    o(/\(/, l, A, a(l, /\|/, l, W), "*", l, /\)\*/),
    "|",
    o(/\(/, l, A, l, /\)/)
  ), J = /[?*+]?/, _ = o(
  ...
  ), T = a("EMPTY", "|", "ANY", "|", R, "|", _), I = "<!ELEMENT", L = o(I, E, a(W, "|", ne), E, a(T, "|", ne), l, ">"), V = o("NOTATION", E, /\(/, l, C, a(l, /\|/, l, C), "*", l, /\)/), fe = o(/\(/, l, j, a(l, /\|/, l, j), "*", l, /\)/), we = a(V, "|", fe), ve = a(/CDATA|ID|IDREF|IDREFS|ENTITY|ENTITIES|NMTOKEN|NMTOKENS/, "|", we), ie = a(/#REQUIRED|#IMPLIED/, "|", a(a("#FIXED", E), "?", g)), P = a(E, C, E, ve, E, ie), $e = "<!ATTLIST", Be = o($e, E, C, P, "*", l, ">"), pe = "about:legacy-compat", Ve = a('"' + pe + '"', "|", "'" + pe + "'"), _e = "SYSTEM", Se = "PUBLIC", Fe = a(a(_e, E, te), "|", a(Se, E, N, E, te)), ze = o(
    "^",
    a(
  ...
  ), Je = a(E, "NDATA", E, C), Ce = a(le, "|", a(Fe, Je, "?")), K = "<!ENTITY", Ge = o(K, E, C, E, Ce, l, ">"), oe = a(le, "|", Fe), Xe = o(K, E, "%", E, C, E, oe, l, ">"), vt = a(Ge, "|", Xe), Ye = o(Se, E, N), We = o("<!NOTATION", E, C, E, a(Fe, "|", Ye), l, ">"), q = o(l, "=", l), Z = /1[.]\d+/, Ae = o(E, "version", q, a("'", Z, "'", "|", '"', Z, '"')), Ne = /[A-Za-z][-A-Za-z0-9._]*/, Ke = a(E, "encoding", q, a('"', Ne, '"', "|", "'", Ne, "'")), st = a(E, "standalone", q, a("'", a("yes", "|", "no"), "'", "|", '"', a("yes", "|", "no"), '"')), ct = o(/^<\?xml/, Ae, Ke, "?", st, "?", l, /\?>/), lt = "<!DOCTYPE", At = "<![CDATA[", Nt = "]]>", ft = /<!\[CDATA\[/, Qe = /\]\]>/, pt = o(p, "*?", Qe), Ot = o(ft, pt);
  return U.chars = n, U.chars_without = i, U.detectUnicodeSupport = t, U.reg = o, U.regg = a, U.ABOUT_LEGACY_COMPAT = pe, U.ABOUT_LEGACY_COMPAT_SystemLiteral = Ve, U.AttlistDecl = Be, U.CDATA_START = At, U.CDATA_END = Nt, U.CDSect = Ot, U.Char = p, U.Comment = M, U.COMMENT_START = w, U.COMMENT_END = y, U.DOCTYPE_DECL_START = lt, U.elementdecl = L, U.EntityDecl = vt, U.EntityValue = le, U.ExternalID = Fe, U.ExternalID_match = ze, U.Name = C, U.NotationDecl = We, U.Reference = $, U.PEReference = ne, U.PI = Re, U.PUBLIC = Se, U.PubidLiteral = N, U.QName = W, U.QName_exact = ee, U.QName_group = Ie, U.S = E, U.SChar_s = m, U.S_OPT = l, U.SYSTEM = _e, U.SystemLiteral = te, U.UNICODE_REPLACEMENT_CHARACTER = h, U.UNICODE_SUPPORT = e, U.XMLDecl = ct, U;
}
var ur;
function kr() {
  if (ur) return re;
  ...
  var F = {}, G = F.ELEMENT_NODE = 1, W = F.ATTRIBUTE_NODE = 2, ee = F.TEXT_NODE = 3, Ie = F.CDATA_SECTION_NODE = 4, te = F.ENTITY_REFERENCE_NODE = 5, Re = F.ENTITY_NODE = 6, d = F.PROCESSING_INSTRUCTION_NODE = 7, N = F.COMMENT_NODE = 8, w = F.DOCUMENT_NODE = 9, y = F.DOCUMENT_TYPE_NODE = 10, M = F.DOCUMENT_FRAGMENT_NODE = 11, A = F.NOTATION_NODE = 12, R = t.freeze({
  ...
  pe.prototype = {
    ...
    replaceChild: function(r, u) {
      q(this, r, u, We), r.ownerDocument = this, u && this.removeChild(u), K(r) && (this.documentElement = r);
    },
...
function An() {
  if (or) return yt;
  or = 1;
  var t = Dt(), e = Fr(), n = _t(), i = t.isHTMLEscapableRawTextElement, o = t.isHTMLMimeType, a = t.isHTMLRawTextElement, h = t.hasOwn, p = t.NAMESPACE, f = n.ParseError, m = n.DOMException, E = 0, l = 1, v = 2, O = 3, b = 4, C = 5, j = 6, B = 7;
  function k() {
  }
  k.prototype = {
  ...
  function ne(d, N, w, y, M) {
    ...
    function J(q) {
      ...
      var Ne = Z.slice(1, -1);
      return h(w, Ne) ? w[Ne] : Ne.charAt(0) === "#" ? R(parseInt(Ne.substring(1).replace("x", "0x"))) : (M.error("entity not found:" + q), q);
    }
    function _(q) {
      if (q > ie) {
      ...
      try {
        ...
        if (P < 0) {
          ...
          if (!d.substring(ie).match(/^\s*$/)) {
            var $e = y.doc, Be = $e.createTextNode(d.substring(ie));
            if ($e.documentElement)
              return M.error("Extra content at the end of the document");
            $e.appendChild(Be), y.currentElement = Be;
          }
          return;
        }
        if (P > ie) {
        ...
        switch (d.charAt(P + 1)) {
          case "/":
            ...
            if (y.endElement(ze.uri, ze.localName, Se), Je)
              for (var Ce in Je)
          ...
          default:
            V && fe(P);
            var K = new Re(), Ge = we[we.length - 1].currentNSMap, oe = g(d, P, K, Ge, J, M, A), Xe = K.length;
            if (K.closed || (A && t.isHTMLVoidElement(K.tagName) ? K.closed = !0 : ve.push(K.tagName)), V && Xe) {
              for (var vt = le(V, {}), Ye = 0; Ye < Xe; Ye++) {
                var We = K[Ye];
                fe(We.offset), We.locator = le(V, {});
              }
              y.locator = vt, x(K, y, Ge) && we.push(K), y.locator = V;
            } else
              x(K, y, Ge) && we.push(K);
            A && !K.closed ? oe = F(d, oe, K.tagName, J, y) : oe++;
        }
      } catch (q) {
        if (q instanceof f)
          throw q;
      ...
      switch (V) {
        ...
        case ">":
          switch (L) {
            ...
            case v:
              L === v && (T = _), L == b ? (A.warning('attribute "' + T + '" missed quot(")!'), J(_, T, N)) : (R || A.warning('attribute "' + T + '" missed value!! "' + T + '" instead!!'), J(T, T, N));
              break;
            case O:
              if (!R)
        ...
        default:
          if (V <= " ")
            ...
            switch (L) {
              ...
              case v:
                R || A.warning('attribute "' + _ + '" missed value!! "' + _ + '" instead2!!'), J(_, _, N), N = I, L = l;
                break;
              case C:
  ...
  function x(d, N, w) {
    for (var y = d.tagName, M = null, L = d.length; L--; ) {
      var A = d[L], R = A.qName, J = A.value, V = R.indexOf(":");
      if (V > 0)
  ...
  function F(d, N, w, y, M) {
    var A = i(w);
    if (A || a(w)) {
      var R = d.indexOf("</" + w + ">", N), J = d.substring(N + 1, R);
      return A && (J = J.replace($, y)), M.characters(J, 0, J.length), R;
    }
    return N + 1;
  }
  function G(d, N) {
...
` && L !== "	" && L !== "\r")
  ...
  return Re.prototype = {
    ...
    //	getType:function(i){},
  }, yt.XMLReader = k, yt.parseUtils = W, yt.parseDoctypeCommentOrCData = Ie, yt;
}
var ar;
function Nn() {
  if (ar) return rt;
...
`);
  ...
  b.prototype.parseFromString = function(g, x) {
    ...
    var F = this.assign(/* @__PURE__ */ Object.create(null), this.xmlns), G = i.XML_ENTITIES, W = F[""] || null;
    h(x) ? (G = i.HTML_ENTITIES, W = E.HTML) : x === m.XML_SVG_IMAGE && (W = E.SVG), F[""] = W, F.xml = F.xml || E.XML;
    ...
    return Re && typeof g != "string" && te.errorHandler.fatalError("source is not a string"), te.parse(this.normalizeLineEndings(String(g)), F, G), ee.doc.documentElement || te.errorHandler.fatalError("missing root element"), ee.doc;
  };
  function C(g) {
    var x = g || {};
  ...
  C.prototype = {
    ...
    startElement: function(g, x, F, G) {
      var W = this.doc, ee = W.createElementNS(g, F || x), Ie = G.length;
      $(this, ee), this.currentElement = ee, this.locator && j(this.locator, ee);
      for (var te = 0; te < Ie; te++) {
        var g = G.getURI(te), Re = G.getValue(te), F = G.getQName(te), d = W.createAttributeNS(g, F);
        this.locator && j(G.getLocator(te), d), d.value = d.nodeValue = Re, ee.setAttributeNode(d);
      }
    },
    ...
    startDTD: function(g, x, F, G) {
      ...
      if (W && W.createDocumentType) {
        var ee = W.createDocumentType(g, x, F, G);
...
function bn() {
  ...
  var i = Nn();
  return z.DOMParser = i.DOMParser, z.normalizeLineEndings = i.normalizeLineEndings, z.onErrorStopParsing = i.onErrorStopParsing, z.onWarningStopParsing = i.onWarningStopParsing, z;
}
bn();
const Ut = "USJ";
var xe = {}, qt, cr;
function Cn() {
  return cr || (cr = 1, qt = () => {
    const t = "\\ud800-\\udfff", h = "\\u0300-\\u036f" + "\\ufe20-\\ufe2f" + "\\u20d0-\\u20ff" + "\\u1ab0-\\u1aff" + "\\u1dc0-\\u1dff", p = "\\ufe0e\\ufe0f", f = "\\uD83D\\uDC69\\uD83C\\uDFFB\\u200D\\uD83C\\uDF93", m = `[${t}]`, E = `[${h}]`, l = "\\ud83c[\\udffb-\\udfff]", v = `(?:${E}|${l})`, O = `[^${t}]`, b = "(?:\\uD83C[\\uDDE6-\\uDDFF]){2}", C = "[\\ud800-\\udbff][\\udc00-\\udfff]", j = "\\u200d", B = "(?:\\ud83c\\udff4\\udb40\\udc67\\udb40\\udc62\\udb40(?:\\udc65|\\udc73|\\udc77)\\udb40(?:\\udc6e|\\udc63|\\udc6c)\\udb40(?:\\udc67|\\udc74|\\udc73)\\udb40\\udc7f)", k = `[${f}]`, $ = `${v}?`, ne = `[${p}]?`, le = `(?:${j}(?:${[O, b, C].join("|")})${ne + $})*`, g = ne + $ + le, F = `(?:${[`${O}${E}?`, E, b, C, m, k].join("|")})`;
...
const jt = ["chapter", "book", "para", "row", "sidebar", Ut], Rn = "​", jr = [
...
], Bn = 1, _n = jr.length - 1, Pn = 1, Ln = 1, ci = {
  book: "GEN",
  chapterNum: 1,
  verseNum: 1
}, Fn = (t) => {
...
var zn = "__v", Jn = "__o", Xn = "_owner", Nr = Object.getOwnPropertyDescriptor, br = Object.keys;
function Yn(t, e, n) {
  var i = t.length;
  if (e.length !== i)
    return !1;
...
function Vr(t, e, n, i) {
  return (i === Xn || i === Jn || i === zn) && (t.$$typeof || e.$$typeof) ? !0 : Hn(e, i) && n.equals(t[i], e[i], i, i, t, e, n);
}
...
function Du(t) {
  ...
  return function(b, C, j) {
    ...
    if (B !== typeof C)
      return !1;
    if (B !== "object")
      return B === "number" ? h(b, C, j) : B === "function" ? o(b, C, j) : !1;
    var k = b.constructor;
    if (k !== C.constructor)
      return !1;
    if (k === Object)
...
function vu(t) {
  ...
  if (n && (o = wr({}, o, n(o))), e) {
    var a = Bt(o.areArraysEqual), h = Bt(o.areMapsEqual), p = Bt(o.areObjectsEqual), f = Bt(o.areSetsEqual);
    o = wr({}, o, {
      areArraysEqual: a,
      areMapsEqual: h,
      areObjectsEqual: p,
...
const wu = 1e3, Gr = 60, Hr = Gr * 60, Su = Hr * 24;
...
class Ee {
  ...
  nodeToVerseRefAndOffset(e, n, i) {
    ...
    return a.startingContentNode !== void 0 && this.findNextMatchingNode(a.startingContentNode, [], (f, m) => {
      var E, l;
      return f === n ? !0 : m.find((v) => je.includes(v.parent.type)) ? !1 : typeof f == "string" ? (p += f.length, !1) : f.type === Mt && f.number !== ((E = a.chapterNum) == null ? void 0 : E.toString()) || f.type === Rt && f.number !== ((l = a.verseNum) == null ? void 0 : l.toString()) ? (p = 0, !0) : !1;
    }), { verseRef: h, offset: p };
  }
  // #endregion
  ...
  verseRefToUsjContentLocation(e, n = 0) {
    ...
    const p = e.verse ?? e.verseNum.toString(), f = this.findNextMatchingNode(
      o,
      je,
      (v, O) => v === o ? e.verseNum === 0 ? (h = Ee.convertWorkingStackToJsonPath(O), !0) : !1 : typeof v != "object" ? !1 : v.type === Mt ? (a = !0, !0) : v.type === Rt && v.number !== void 0 && v.number === p ? (h = Ee.convertWorkingStackToJsonPath(O), !0) : !1
    );
...
export {
  ...
  Ju as PromiseChainingMap,
  Xu as UnsubscriberAsyncList,
  ...
  Tn as endsWith,
  qr as ensureArray,
  ii as escapeStringRegexp,
  yi as formatBytes,
  Zu as formatReplacementString,
  ...
  oi as transformAndEnsureRegExpRegExpArray,
  en as wait,
