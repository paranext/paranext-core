...
class ue {
  ...
  deleteAllContributions() {
    ...
    try {
      ...
      throw e.forEach(([s, n]) => this.contributions.set(s, n)), new Error(`Error when deleting all contributions: ${r}`);
    }
  }
  /**
...
class gt {
  ...
  get(e) {
    ...
    return r || (r = new fe(), this.mutexesByID.set(e, r), r);
  }
}
const F = [
...
], he = 1, pe = F.length - 1, me = 1, de = 1, be = (t) => {
  var e;
  return ((e = F[t]) == null ? void 0 : e.chapters) ?? -1;
}, Nt = (t, e) => ({
  bookNum: Math.max(he, Math.min(t.bookNum + e, pe)),
  chapterNum: 1,
  verseNum: 1
}), vt = (t, e) => ({
  ...t,
  chapterNum: Math.min(
    Math.max(me, t.chapterNum + e),
    be(t.bookNum)
  ),
  verseNum: 1
}), yt = (t, e) => ({
  ...t,
  verseNum: Math.max(de, t.verseNum + e)
}), wt = (t) => (...e) => t.map((s) => s(...e)).every((s) => s), Et = (t) => async (...e) => {
  const r = t.map(async (s) => s(...e));
  return (await Promise.all(r)).every((s) => s);
};
var T = typeof globalThis < "u" ? globalThis : typeof window < "u" ? window : typeof global < "u" ? global : typeof self < "u" ? self : {}, N = {}, ge = () => {
  const t = "\\ud800-\\udfff", e = "\\u0300-\\u036f", r = "\\ufe20-\\ufe2f", s = "\\u20d0-\\u20ff", n = "\\u1ab0-\\u1aff", o = "\\u1dc0-\\u1dff", a = e + r + s + n + o, i = "\\ufe0e\\ufe0f", c = "\\uD83D\\uDC69\\uD83C\\uDFFB\\u200D\\uD83C\\uDF93", h = `[${t}]`, u = `[${a}]`, l = "\\ud83c[\\udffb-\\udfff]", f = `(?:${u}|${l})`, b = `[^${t}]`, d = "(?:\\uD83C[\\uDDE6-\\uDDFF]){2}", y = "[\\ud800-\\udbff][\\udc00-\\udfff]", j = "\\u200d", Z = "(?:\\ud83c\\udff4\\udb40\\udc67\\udb40\\udc62\\udb40(?:\\udc65|\\udc73|\\udc77)\\udb40(?:\\udc6e|\\udc63|\\udc6c)\\udb40(?:\\udc67|\\udc74|\\udc73)\\udb40\\udc7f)", X = `[${c}]`, P = `${f}?`, D = `[${i}]?`, Q = `(?:${j}(?:${[b, d, y].join("|")})${D + P})*`, Y = D + P + Q, ee = `(?:${[`${b}${u}?`, u, d, y, h, X].join("|")})`;
...
function $t(t, e) {
  return e < 0 || e > m(t) - 1 ? "" : q(t, e, 1);
}
function At(t, e) {
  if (!(e < 0 || e > m(t) - 1))
    return q(t, e, 1).codePointAt(0);
}
function qt(t, e, r = m(t)) {
  const s = Me(t, e);
  return !(s === -1 || s + m(e) !== r);
}
function je(t, e, r = 0) {
...
function Me(t, e, r) {
  let s = r === void 0 ? m(t) : r;
  s < 0 ? s = 0 : s >= m(t) && (s = m(t) - 1);
  for (let n = s; n >= 0; n--)
    if (q(t, n, m(e)) === e)
      return n;
  return -1;
...
function Mt(t, e, r = " ") {
  return e <= m(t) ? t : W(t, e, r, "right");
}
function Ct(t, e, r = " ") {
  return e <= m(t) ? t : W(t, e, r, "left");
}
function R(t, e) {
...
function Pt(t, e, r) {
  ...
  if (r !== void 0 && r <= 0)
    return [t];
  if (e === "")
    return Ce(t).slice(0, r);
  let n = e;
  (typeof e == "string" || e instanceof RegExp && !je(e.flags, "g")) && (n = new RegExp(e, "g"));
  const o = t.match(n);
  let a = 0;
  if (!o)
    return [t];
  for (let i = 0; i < (r ? r - 1 : o.length); i++) {
    const c = S(t, o[i], a), h = m(o[i]);
...
var Se = Object.getOwnPropertyNames, Pe = Object.getOwnPropertySymbols, De = Object.prototype.hasOwnProperty;
function I(t, e) {
...
var L = "_owner", _ = Object.getOwnPropertyDescriptor, z = Object.keys;
function Te(t, e, r) {
  var s = t.length;
  if (e.length !== s)
    return !1;
...
function J(t, e, r) {
  ...
  for (var s = {}, n = t.entries(), o = 0, a, i; (a = n.next()) && !a.done; ) {
    for (var c = e.entries(), h = !1, u = 0; (i = c.next()) && !i.done; ) {
      var l = a.value, f = l[0], b = l[1], d = i.value, y = d[0], j = d[1];
...
function w(t, e, r) {
  ...
  if (x(e).length !== n)
    return !1;
  for (var o, a, i; n-- > 0; )
    if (o = s[n], o === L && (t.$$typeof || e.$$typeof) && t.$$typeof !== e.$$typeof || !K(e, o) || !r.equals(t[o], e[o], o, o, t, e, r) || (a = _(t, o), i = _(e, o), (a || i) && (!a || !i || a.configurable !== i.configurable || a.enumerable !== i.enumerable || a.writable !== i.writable)))
      return !1;
  return !0;
}
function xe(t, e) {
...
function Ze(t) {
  ...
  return function(u, l, f) {
    ...
    if (b === Set)
      return i(u, l, f);
    var d = Le(u);
    return d === Ge ? r(u, l, f) : d === Fe ? a(u, l, f) : d === Ve ? s(u, l, f) : d === ke ? i(u, l, f) : d === Ue ? typeof u.then != "function" && typeof l.then != "function" && n(u, l, f) : d === Je ? n(u, l, f) : d === Be || d === He || d === We ? o(u, l, f) : !1;
  };
}
function Xe(t) {
  var e = t.circular, r = t.createCustomConfig, s = t.strict, n = {
    areArraysEqual: s ? w : Te,
    areDatesEqual: Re,
    areMapsEqual: s ? I(J, w) : J,
    areObjectsEqual: s ? w : Ie,
    arePrimitiveWrappersEqual: xe,
    areRegExpsEqual: _e,
    areSetsEqual: s ? I(B, w) : B,
    areTypedArraysEqual: s ? w : ze
  };
  if (r && (n = V({}, n, r(n))), e) {
...
function g(t) {
  t === void 0 && (t = {});
  var e = t.circular, r = e === void 0 ? !1 : e, s = t.createInternalComparator, n = t.createState, o = t.strict, a = o === void 0 ? !1 : o, i = Xe(t), c = Ze(i), h = s ? s(c) : Qe(c);
  return Ye({ circular: r, comparator: c, createState: n, equals: h, strict: a });
}
function Tt(t, e) {
  return et(t, e);
}
...
const It = (t) => t.replace(/&/g, "&amp;").replace(/</g, "&lt;").replace(/>/g, "&gt;").replace(/"/g, "&quot;").replace(/'/g, "&#x27;").replace(/\//g, "&#x2F;"), rt = {
...
export {
  at as AsyncVariable,
  ue as DocumentCombinerEngine,
  he as FIRST_SCR_BOOK_NUM,
  me as FIRST_SCR_CHAPTER_NUM,
  de as FIRST_SCR_VERSE_NUM,
  pe as LAST_SCR_BOOK_NUM,
  fe as Mutex,
  gt as MutexMap,
  mt as NonValidatingDocumentCombiner,
  bt as PlatformEventEmitter,
  dt as UnsubscriberAsyncList,
  Et as aggregateUnsubscriberAsyncs,
  wt as aggregateUnsubscribers,
  Ot as at,
  $t as charAt,
  At as codePointAt,
  pt as createSyncProxyForAsyncObject,
  ut as debounce,
  O as deepClone,
  Tt as deepEqual,
  tt as deserialize,
  qt as endsWith,
  ht as getAllObjectFunctionNames,
  be as getChaptersForBook,
  ct as getErrorMessage,
  lt as groupBy,
  It as htmlEncode,
  je as includes,
  S as indexOf,
  Rt as isSerializable,
  ne as isString,
  Me as lastIndexOf,
  rt as menuDocumentSchema,
  it as newGuid,
  jt as normalize,
  Nt as offsetBook,
  vt as offsetChapter,
