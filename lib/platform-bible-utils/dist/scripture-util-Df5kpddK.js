...
function R(e) {
  ...
  for (let s = 0; s < e.length; s += 1) {
    const o = e[s];
    o.charCodeAt(0) < 32 ? (a || (t += " "), a = !0) : !a && o === ne && s + 1 < e.length && L(e[s + 1]) || (L(o) ? (a || (t += o), a = !0) : Se(o) && r === o || (t += o, a = !1)), r = o;
  }
  return t;
}
function J(e) {
...
function H(e, t, a, r) {
  ...
  if (s && o) {
    ...
    const N = J(l.content), S = J(n.content);
    if (N !== S) return !1;
    if (!N && !S) {
...
//# sourceMappingURL=scripture-util-B187MF1r.js.map
