...
function H(e, t, a, r) {
  ...
  if (s && o) {
    ...
    const f = v(l.content), S = v(n.content);
    if (f !== S) return !1;
    if (!f && !S) {
      let h = l.content, E = n.content;
      const y = h[h.length - 1];
      T.includes(l.type) && i(y) && d(y) && (h = h.slice(0, -1));
      const k = E[E.length - 1];
      if (T.includes(n.type) && i(k) && d(k) && (E = E.slice(0, -1)), h.length !== E.length) return !1;
...
//# sourceMappingURL=scripture-util-Df5kpddK.js.map
