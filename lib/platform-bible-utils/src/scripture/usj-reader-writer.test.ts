 ...
 *
 * Note: all spaces at the end of each line were removed by replacing / +\n/ with /\n/. This is
 * consistent with how Paratext 9 saves its USFM files. We will deal with normalization issues
 * later.
 */
