 ...
 * the per-depth members document the shapes this type is expected to carry rather than enforcing a
 * bound. Eight depths covers every shape the editors render (table cell → char → nested char → text
 * is seven).
 */
