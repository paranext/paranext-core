...
declare module 'shared/models/web-view.model' {
   ...
   *   `undefined` when unknown. Useful for a web view that must follow whichever project is driving the
...
declare module 'renderer/hooks/papi-hooks/use-scroll-group-scr-ref.hook' {
   ...
   *   - `sourceProjectId`: The id of the project that last set this scroll group's reference (the
   *       source frame of `scrRef`); this web view's own `projectId` when not synced to a scroll
   *       group. `undefined` when unknown
   */
