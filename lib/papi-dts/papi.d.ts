...
declare module 'papi-shared-types' {
  ...
  interface ProjectSettingTypes {
     ...
     * undefined = left-to-right (may be changed in the future to detect). Defaults to 'ltr'. This
     * is generally derived from the language definition for the project's language code.
     */
