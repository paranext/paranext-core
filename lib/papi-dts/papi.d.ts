...
declare module "shared/models/web-view.model" {
     ...
     */
    export type SavedWebViewDefinition = (Partial<Omit<WebViewDefinitionReact, 'content' | 'styles' | 'allowScripts'>> | Partial<Omit<WebViewDefinitionHtml, 'content' | 'allowScripts'>> | Partial<Omit<WebViewDefinitionURL, 'content' | 'allowScripts'>>) & Pick<WebViewDefinitionBase, 'id' | 'webViewType'>;
    /** The properties on a WebViewDefinition that may be updated when that webview is already displayed */
    export type WebViewDefinitionUpdatableProperties = Pick<WebViewDefinitionBase, 'iconUrl' | 'title' | 'tooltip'>;
    /**
     ...
     * some reason
     */
    export type GetWebViewDefinitionUpdatableProperties = () => WebViewDefinitionUpdatableProperties | undefined;
    /**
...
declare module "shared/global-this.model" {
    ...
    import { GetWebViewDefinitionUpdatableProperties, UpdateWebViewDefinition, UseWebViewStateHook, WebViewDefinitionUpdatableProperties, WebViewDefinitionUpdateInfo, WebViewProps } from "shared/models/web-view.model";
    /**
    ...
    global {
        ...
        var getWebViewDefinitionUpdatablePropertiesById: (webViewId: string) => WebViewDefinitionUpdatableProperties | undefined;
...
declare module "shared/utils/util" {
     ...
     * for responses
     */
    export type ComplexResponse<TReturn = unknown> = ComplexResponseSuccess<TReturn> | ComplexResponseFailure;
...
declare module "shared/data/internal-connection.model" {
     ...
     * Service
     */
    export type InternalRequestHandler = <TParam, TReturn>(requestType: string, request: InternalRequest<TParam>) => Promise<InternalResponse<TReturn>>;
    /** Handler for requests from the server */
    export type RequestHandler = <TParam, TReturn>(requestType: SerializedRequestType, request: ComplexRequest<TParam>) => Promise<ComplexResponse<TReturn>>;
...
declare module "shared/services/network-connector.interface" {
    import { ConnectionStatus, InternalEvent, InternalNetworkEventHandler, InternalRequestHandler, NetworkConnectorEventHandlers, NetworkConnectorInfo, RequestRouter } from "shared/data/internal-connection.model";
    /**
    ...
    export default interface INetworkConnector {
         ...
         */
        connect: (localRequestHandler: InternalRequestHandler, requestRouter: RequestRouter, localEventHandler: InternalNetworkEventHandler, networkConnectorEventHandlers: NetworkConnectorEventHandlers) => Promise<NetworkConnectorInfo>;
        /**
...
declare module "shared/data/network-connector.model" {
     ...
     */
    import { InternalEvent, InternalRequest, InternalResponse, NetworkConnectorInfo } from "shared/data/internal-connection.model";
    ...
    export type Message = InitClient | ClientConnect | WebSocketRequest | WebSocketResponse | WebSocketEvent<unknown>;
}
...
declare module "client/services/client-network-connector.service" {
    import { ConnectionStatus, InternalEvent, InternalNetworkEventHandler, InternalRequest, InternalRequestHandler, InternalResponse, NetworkConnectorInfo, RequestRouter } from "shared/data/internal-connection.model";
    ...
    export default class ClientNetworkConnector implements INetworkConnector {
        ...
        private clientGuid;
        connect: (localRequestHandler: InternalRequestHandler, requestRouter: RequestRouter, localEventHandler: InternalNetworkEventHandler) => Promise<Readonly<{
            clientId: number;
        }>>;
        notifyClientConnected: () => Promise<void>;
        disconnect: () => void;
        request: <TParam, TReturn>(requestType: string, request: InternalRequest<TParam>) => Promise<InternalResponse<TReturn>>;
        emitEventOnNetwork: <T>(eventType: string, event: InternalEvent<T>) => Promise<void>;
        /**
...
declare module "main/services/server-network-connector.service" {
    import { ConnectionStatus, InternalEvent, InternalNetworkEventHandler, InternalRequest, InternalRequestHandler, InternalResponse, NetworkConnectorEventHandlers, NetworkConnectorInfo, RequestRouter } from "shared/data/internal-connection.model";
    import INetworkConnector from "shared/services/network-connector.interface";
    ...
    export default class ServerNetworkConnector implements INetworkConnector {
        ...
        /** All requests that are waiting for a response */
        private requests;
        connect: (localRequestHandler: InternalRequestHandler, requestRouter: RequestRouter, localEventHandler: InternalNetworkEventHandler, networkConnectorEventHandlers: NetworkConnectorEventHandlers) => Promise<Readonly<{
            clientId: number;
        }>>;
        notifyClientConnected: () => Promise<void>;
        disconnect: () => void;
...
declare module "shared/services/connection.service" {
     ...
     * over this.
     */
    import { NetworkConnectorEventHandlers, NetworkEventHandler, RequestHandler, RequestRouter } from "shared/data/internal-connection.model";
     ...
     * @returns Promise that resolves with the response message
     */
    export const request: <TParam, TReturn>(requestType: string, contents: TParam) => Promise<ComplexResponse<TReturn>>;
    /**
     * Sends an event to other processes. Does NOT run the local event subscriptions as they should be
     * run by NetworkEventEmitter after sending on network.
     *
     ...
     */
    export const connect: (localRequestHandler: RequestHandler, networkRequestRouter: RequestRouter, localEventHandler: NetworkEventHandler, connectorEventHandlers: NetworkConnectorEventHandlers) => Promise<void>;
...
declare module "shared/services/network.service" {
    ...
    import { ComplexRequest, ComplexResponse, RequestHandlerType, SerializedRequestType } from "shared/utils/util";
    /**
     ...
     * function.
     */
    type ArgsRequestHandler<TParam extends Array<unknown> = any[], TReturn = any> = (...args: TParam) => Promise<TReturn> | TReturn;
    /**
     ...
     */
    type ComplexRequestHandler<TParam = any, TReturn = any> = (request: ComplexRequest<TParam>) => Promise<ComplexResponse<TReturn>>;
     ...
     */
    export function registerRequestHandler(requestType: SerializedRequestType, handler: ArgsRequestHandler, handlerType?: RequestHandlerType): Promise<UnsubscriberAsync>;
    export function registerRequestHandler(requestType: SerializedRequestType, handler: ContentsRequestHandler, handlerType?: RequestHandlerType): Promise<UnsubscriberAsync>;
    export function registerRequestHandler(requestType: SerializedRequestType, handler: ComplexRequestHandler, handlerType?: RequestHandlerType): Promise<UnsubscriberAsync>;
    /**
...
declare module "shared/services/network-object.service" {
     ...
     */
    const get: <T extends object>(id: string, createLocalObjectToProxy?: LocalObjectToProxyCreator<T> | undefined) => Promise<NetworkObject<T> | undefined>;
    /**
...
declare module "shared/models/docking-framework.model" {
    ...
    import { SavedWebViewDefinition, WebViewDefinition, WebViewDefinitionUpdateInfo } from "shared/models/web-view.model";
    /**
...
declare module "shared/services/data-provider.service" {
    ...
    import IDataProviderEngine, { DataProviderEngineNotifyUpdate } from "shared/models/data-provider-engine.model";
...
declare module "shared/models/project-data-provider-engine.model" {
    ...
    export interface ProjectDataProviderEngineFactory<ProjectType extends ProjectTypes> {
        createProjectDataProviderEngine(projectId: string, projectStorageInterpreterId: string): ProjectDataProviderEngineTypes[ProjectType];
    }
}
...
declare module "shared/services/project-data-provider.service" {
     ...
     */
    export function registerProjectDataProviderEngineFactory<ProjectType extends ProjectTypes>(projectType: ProjectType, pdpEngineFactory: ProjectDataProviderEngineFactory<ProjectType>): Promise<Dispose>;
    /**
     ...
     */
    export function get<ProjectType extends ProjectTypes>(projectType: ProjectType, projectId: string): Promise<ProjectDataProviders[ProjectType]>;
...
declare module "shared/services/papi-core.service" {
    ...
    export type { ExtensionDataScope, MandatoryProjectDataType, } from "shared/models/project-data-provider.model";
    export type { ProjectMetadata } from "shared/models/project-metadata.model";
    export type { GetWebViewOptions, SavedWebViewDefinition, UseWebViewStateHook, WebViewContentType, WebViewDefinition, WebViewProps, } from "shared/models/web-view.model";
...
declare module "shared/services/menu-data.service-model" {
    import { OnDidDispose, UnsubscriberAsync, MultiColumnMenu, ReferencedItem, WebViewMenu } from 'platform-bible-utils';
    ...
    export type IMenuDataService = {
         ...
         */
        subscribeMainMenu(mainMenuType: undefined, callback: (menuContent: MultiColumnMenu) => void, options?: DataProviderSubscriberOptions): Promise<UnsubscriberAsync>;
        /**
         ...
         * @returns Unsubscriber function (run to unsubscribe from listening for updates)
         */
        subscribeWebViewMenu(webViewType: ReferencedItem, callback: (menuContent: WebViewMenu) => void, options?: DataProviderSubscriberOptions): Promise<UnsubscriberAsync>;
...
declare module "extension-host/services/papi-backend.service" {
    ...
    import { DataProviderService, DataProviderEngine as PapiDataProviderEngine } from "shared/services/data-provider.service";
...
declare module "shared/services/settings.service-model" {
    ...
    import { DataProviderUpdateInstructions, IDataProvider } from "shared/services/papi-core.service";
    ...
    export type SettingEvent<SettingName extends SettingNames> = UpdateSettingEvent<SettingName> | ResetSettingEvent;
    /** All message subscriptions - emitters that emit an event each time a setting is updated */
    export const onDidUpdateSettingEmitters: Map<keyof SettingTypes, PlatformEventEmitter<SettingEvent<keyof SettingTypes>>>;
    ...
    export type ISettingsService = {
         ...
         */
        subscribe<SettingName extends SettingNames>(key: SettingName, callback: (newSetting: SettingEvent<SettingName>) => void): Promise<Unsubscriber>;
...
declare module "renderer/hooks/papi-hooks/use-setting.hook" {
     ...
     *   message type
     */
    const useSetting: <SettingName extends keyof SettingTypes>(key: SettingName, defaultState: SettingTypes[SettingName], subscriberOptions?: DataProviderSubscriberOptions) => [setting: SettingTypes[SettingName], setSetting: (newData: SettingTypes[SettingName]) => Promise<DataProviderUpdateInstructions<SettingDataTypes>>, resetSetting: () => void];
...
declare module "renderer/hooks/papi-hooks/use-project-data-provider.hook" {
     ...
     */
    const useProjectDataProvider: <ProjectType extends keyof ProjectDataProviders>(projectType: ProjectType, projectDataProviderSource: string | ProjectDataProviders[ProjectType] | undefined) => ProjectDataProviders[ProjectType] | undefined;
...
declare module "renderer/hooks/papi-hooks/use-project-data.hook" {
    ...
    type UseProjectDataHook = {
        <ProjectType extends ProjectTypes>(projectType: ProjectType, projectDataProviderSource: string | ProjectDataProviders[ProjectType] | undefined): {
            [TDataType in keyof ProjectDataTypes[ProjectType]]: (selector: ProjectDataTypes[ProjectType][TDataType]['selector'], defaultValue: ProjectDataTypes[ProjectType][TDataType]['getData'], subscriberOptions?: DataProviderSubscriberOptions) => [
                ProjectDataTypes[ProjectType][TDataType]['getData'],
                (((newData: ProjectDataTypes[ProjectType][TDataType]['setData']) => Promise<DataProviderUpdateInstructions<ProjectDataTypes[ProjectType]>>) | undefined),
                boolean
            ];
        };
    };
