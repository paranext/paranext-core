...
declare module "shared/services/settings.service" {
     ...
     */
    const getSetting: <SettingName extends keyof SettingTypes>(key: SettingName, defaultSetting: SettingTypes[SettingName]) => SettingTypes[SettingName];
    /**
     ...
     */
    const setSetting: <SettingName extends keyof SettingTypes>(key: SettingName, newSetting: SettingTypes[SettingName]) => void;
    /**
     ...
     */
    const subscribeToSetting: <SettingName extends keyof SettingTypes>(key: SettingName, callback: (newSetting: SettingEvent<SettingName>) => void) => Unsubscriber;
...
declare module "shared/services/menu-data.service-model" {
    ...
    import { DataProviderDataType, DataProviderSubscriberOptions, DataProviderUpdateInstructions } from "shared/services/papi-core.service";
    export const menuStoreServiceProviderName = "platform.menuStoreServiceDataProvider";
    export const menuStoreServiceObjectToProxy: Readonly<{
        name: "platform.menuStoreServiceDataProvider";
    }>;
    ...
    export type MenuStoreServiceType = {
         ...
         */
        setMenuData: (menuType: string, menuContent: MenuContent) => Promise<DataProviderUpdateInstructions<MenuStoreDataTypes>>;
        /**
         ...
         */
        subscribeMenuData: (menuType: string, callback: (menuContent: MenuContent) => void, options?: DataProviderSubscriberOptions) => Promise<UnsubscriberAsync>;
    } & OnDidDispose & typeof menuStoreServiceObjectToProxy;
...
declare module "shared/services/menu-data.service" {
    import { MenuStoreServiceType } from "shared/services/menu-data.service-model";
    /**
     * JSDOC SOURCE menuStoreService
     *
     * Service that allows to get and store menu data
     */
    const menuDataService: MenuStoreServiceType;
...
declare module "extension-host/services/papi-backend.service" {
    ...
    const papi: {
        ...
        menuData: import("@shared/services/menu-data.service-model").MenuStoreServiceType;
    };
    export default papi;
    /** JSDOC DESTINATION DataProviderEngine */
    ...
    /** JSDOC DESTINATION menuStoreService */
    export const menuData: import("@shared/services/menu-data.service-model").MenuStoreServiceType;
}
...
declare module "renderer/hooks/papi-hooks/use-setting.hook" {
     ...
     *   message type
     */
    const useSetting: <SettingName extends keyof SettingTypes>(key: SettingName, defaultState: SettingTypes[SettingName]) => [setting: SettingTypes[SettingName], setSetting: (newSetting: SettingTypes[SettingName]) => void, resetSetting: () => void];
