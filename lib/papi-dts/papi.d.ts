...
declare module "shared/models/web-view.model" {
    ...
    export type WebViewDefinition = WebViewDefinitionReact | WebViewDefinitionHtml | WebViewDefinitionURL;
    /**
     * The keys of properties on a WebViewDefinition that are omitted when converting to a
     * {@link SavedWebViewDefinition}
     */
    export const SAVED_WEBVIEW_DEFINITION_OMITTED_KEYS: readonly ["content", "styles", "allowScripts", "allowSameOrigin", "allowedFrameSources", "allowPopups"];
    /**
     * The keys of properties on a WebViewDefinition that are omitted when converting to a
     * {@link SavedWebViewDefinition}
     */
    export type SavedWebViewDefinitionOmittedKeys = (typeof SAVED_WEBVIEW_DEFINITION_OMITTED_KEYS)[number];
    /**
     ...
     */
    export type SavedWebViewDefinition = (Partial<Omit<WebViewDefinitionReact, SavedWebViewDefinitionOmittedKeys>> | Partial<Omit<WebViewDefinitionHtml, SavedWebViewDefinitionOmittedKeys>> | Partial<Omit<WebViewDefinitionURL, SavedWebViewDefinitionOmittedKeys>>) & Pick<WebViewDefinitionBase, 'id' | 'webViewType'>;
    /**
     * The keys of properties on a WebViewDefinition that may be updated when that webview is already
     * displayed
     */
    export const WEBVIEW_DEFINITION_UPDATABLE_PROPERTY_KEYS: readonly ["iconUrl", "title", "tooltip", "projectId", "scrollGroupScrRef"];
    /** The properties on a WebViewDefinition that may be updated when that webview is already displayed */
    export type WebViewDefinitionUpdatableProperties = Pick<WebViewDefinitionBase, (typeof WEBVIEW_DEFINITION_UPDATABLE_PROPERTY_KEYS)[number]>;
    /**
     ...
     * ```
     */
    export type UseWebViewStateHook = <T>(stateKey: string, defaultStateValue: T) => [
        webViewStateValue: T,
...
declare module "shared/global-this.model" {
    ...
    import { GetSavedWebViewDefinition, SavedWebViewDefinition, UpdateWebViewDefinition, UseWebViewScrollGroupScrRefHook, UseWebViewStateHook, WebViewDefinitionUpdateInfo, WebViewProps } from "shared/models/web-view.model";
    /**
    ...
    global {
        ...
        var updateWebViewDefinitionById: (webViewId: string, webViewDefinitionUpdateInfo: WebViewDefinitionUpdateInfo) => boolean;
...
declare module "shared/utils/util" {
     ...
     */
    export const createSafeRegisterFn: <TParam extends unknown[]>(unsafeRegisterFn: (...args: TParam) => Promise<UnsubscriberAsync>, isInitialized: boolean, initialize: () => Promise<void>) => ((...args: TParam) => Promise<UnsubscriberAsync>);
    /**
...
declare module "shared/data/internal-connection.model" {
    ...
    import { JSONRPCErrorCode, JSONRPCErrorResponse, JSONRPCParams, JSONRPCRequest, JSONRPCResponse, JSONRPCSuccessResponse, SimpleJSONRPCMethod } from 'json-rpc-2.0';
    ...
    export type RequestHandler = (requestType: SerializedRequestType, requestParams: RequestParams, serverParams?: ServerParams) => Promise<JSONRPCResponse>;
    export type InternalRequestHandler = SimpleJSONRPCMethod<ServerParams> | ((params: JSONRPCParams) => any);
    ...
    export type InternalNetworkEventHandler = <T>(eventType: string, incomingEvent: InternalEvent<T>) => void;
    /** Handler for events from on the network */
    export type NetworkEventHandler = <T>(eventType: string, event: T) => void;
    export function createRequest(requestId: number | string, requestType: SerializedRequestType, requestParams: RequestParams): JSONRPCRequest;
    export function createSuccessResponse<T>(requestId: number | string, contents: T): JSONRPCSuccessResponse;
    export function createErrorResponse(requestId: number | string, errorMessage: string, errorCode?: JSONRPCErrorCode): JSONRPCErrorResponse;
...
declare module "shared/services/network-protocol-handler.interface" {
    import { ConnectionStatus, InternalEvent, InternalNetworkEventHandler, InternalRequestHandler, RequestHandler } from "shared/data/internal-connection.model";
    /**
...
declare module "client/services/client-websocket-protocol-handler" {
    ...
    import { ConnectionStatus, InternalNetworkEventHandler, InternalEvent, RequestParams, InternalRequestHandler } from "shared/data/internal-connection.model";
    import { SerializedRequestType } from "shared/utils/util";
    export default class ClientWebSocketProtocolHandler implements INetworkProtocolHandler {
        ...
        connect(localEventHandler: InternalNetworkEventHandler): Promise<boolean>;
        disconnect(): void;
        request(requestType: SerializedRequestType, requestParams: RequestParams): Promise<JSONRPCResponse>;
        emitEventOnNetwork<T>(eventType: string, event: InternalEvent<T>): void;
        registerMethod(methodName: string, method: InternalRequestHandler): Promise<boolean>;
        unregisterMethod(methodName: string): Promise<boolean>;
...
declare module "main/services/server-websocket-protocol-handler" {
    import { JSONRPCResponse, SimpleJSONRPCMethod } from 'json-rpc-2.0';
    import INetworkProtocolHandler from "shared/services/network-protocol-handler.interface";
    import { ConnectionStatus, InternalNetworkEventHandler, InternalEvent, ServerParams, RequestParams } from "shared/data/internal-connection.model";
    import { SerializedRequestType } from "shared/utils/util";
    ...
    export default class ServerWebSocketProtocolHandler implements INetworkProtocolHandler {
        ...
        private readonly rpcServer;
        private readonly rpcClient;
        private readonly methodsByProtocolHandler;
        constructor(webSocket: WebSocket, methodsByProtocolHandler: Map<string, INetworkProtocolHandler>);
        get nextRequestId(): number;
        private static handleError;
        private static onError;
        ...
        connect(localEventHandler: InternalNetworkEventHandler): Promise<boolean>;
        disconnect(): void;
        request(requestType: SerializedRequestType, requestParams: RequestParams, serverParams?: ServerParams): Promise<JSONRPCResponse>;
        emitEventOnNetwork<T>(eventType: string, event: InternalEvent<T>): void;
        registerRemoteMethod(methodName: string): boolean;
        unregisterRemoteMethod(methodName: string): boolean;
        registerMethod(_methodName: string, _method: SimpleJSONRPCMethod<ServerParams>): Promise<boolean>;
...
declare module "main/services/server-websocket-listener" {
    ...
    export default class ServerWebSocketListener implements INetworkProtocolHandler {
        ...
        disconnect(): void;
        request(requestType: SerializedRequestType, requestParams: RequestParams, serverParams?: ServerParams): Promise<JSONRPCResponse>;
        registerMethod(methodName: string, method: SimpleJSONRPCMethod<ServerParams>): Promise<boolean>;
        unregisterMethod(methodName: string): Promise<boolean>;
        emitEventOnNetwork<T>(eventType: string, event: InternalEvent<T>): void;
...
declare module "shared/services/network.service" {
     ...
     * @returns Promise that resolves with the response message
     */
    export const request: <TParam extends unknown[], TReturn>(requestType: SerializedRequestType, ...args: TParam) => Promise<TReturn>;
    /**
     ...
     */
    export function registerRequestHandler(requestType: SerializedRequestType, requestHandler: InternalRequestHandler): Promise<UnsubscriberAsync>;
    /**
     ...
     */
    export const createRequestFunction: <TParam extends unknown[], TReturn>(requestType: SerializedRequestType) => (...args: TParam) => Promise<TReturn>;
...
declare module "shared/services/network-object.service" {
    ...
    import { NetworkObject, DisposableNetworkObject, NetworkableObject, LocalObjectToProxyCreator, NetworkObjectDetails } from "shared/models/network-object.model";
    ...
    export function overrideDispose(objectToMutate: IDisposableObject, newDispose: UnsubscriberAsync): void;
    /**
     ...
     */
    const get: <T extends object>(id: string, createLocalObjectToProxy?: LocalObjectToProxyCreator<T>) => Promise<NetworkObject<T> | undefined>;
    /**
     ...
     */
    const set: <T extends NetworkableObject>(id: string, objectToShare: T, objectType?: string, objectAttributes?: {
        [property: string]: unknown;
    } | undefined) => Promise<DisposableNetworkObject<T>>;
...
declare module "shared/models/network-object.model" {
    import { Dispose, OnDidDispose, CannotHaveOnDidDispose, CanHaveOnDidDispose } from 'platform-bible-utils';
    /**
     ...
     */
    export type NetworkObject<T extends NetworkableObject> = Omit<CanHaveOnDidDispose<T>, 'dispose'> & OnDidDispose;
    /**
     ...
     * @see {@link networkObjectService}
     */
    export type LocalObjectToProxyCreator<T extends NetworkableObject> = (id: string, networkObjectPromise: Promise<NetworkObject<T>>) => Partial<NetworkableObject>;
...
declare module "shared/models/data-provider.model" {
     ...
     */
    export type DataProviderUpdateInstructions<TDataTypes extends DataProviderDataTypes> = '*' | DataTypeNames<TDataTypes> | DataTypeNames<TDataTypes>[] | boolean;
    /**
     ...
     */
    export type DataProviderSetter<TDataTypes extends DataProviderDataTypes, DataType extends keyof TDataTypes> = (selector: TDataTypes[DataType]['selector'], data: TDataTypes[DataType]['setData']) => Promise<DataProviderUpdateInstructions<TDataTypes>>;
    /**
     ...
     */
    export type DataProviderGetter<TDataType extends DataProviderDataType> = (selector: TDataType['selector']) => Promise<TDataType['getData']>;
    /**
     ...
     */
    export type DataProviderSubscriber<TDataType extends DataProviderDataType> = (selector: TDataType['selector'], callback: PlatformEventHandler<TDataType['getData']>, options?: DataProviderSubscriberOptions) => Promise<UnsubscriberAsync>;
    /**
     ...
     */
    export type DataTypeNames<TDataTypes extends DataProviderDataTypes = DataProviderDataTypes> = keyof TDataTypes & string;
    /**
     ...
     */
    type DataProviderInternal<TDataTypes extends DataProviderDataTypes = DataProviderDataTypes> = NetworkableObject<DataProviderSetters<TDataTypes> & DataProviderGetters<TDataTypes> & DataProviderSubscribers<TDataTypes>>;
    /**
     ...
     */
    export function getDataProviderDataTypeFromFunctionName<TDataTypes extends DataProviderDataTypes = DataProviderDataTypes>(fnName: string): DataTypeNames<TDataTypes>;
    export default DataProviderInternal;
}
declare module "shared/models/project-data-provider.model" {
    import type { DataProviderDataType, DataProviderDataTypes, DataProviderUpdateInstructions } from "shared/models/data-provider.model";
    /**
     ...
     * JSDocs for them.
     */
    export type WithProjectDataProviderEngineExtensionDataMethods<TProjectDataTypes extends DataProviderDataTypes> = {
        /**
         ...
         * @see {@link DataProviderUpdateInstructions} for more info on what to return
         */
        setExtensionData(dataScope: ExtensionDataScope, data: string): Promise<DataProviderUpdateInstructions<TProjectDataTypes>>;
    };
}
declare module "shared/models/data-provider.interface" {
    import { DataProviderDataTypes, DataProviderGetters, DataProviderSetters, DataProviderSubscribers } from "shared/models/data-provider.model";
     ...
     */
    type IDataProvider<TDataTypes extends DataProviderDataTypes = DataProviderDataTypes> = DataProviderSetters<TDataTypes> & DataProviderGetters<TDataTypes> & DataProviderSubscribers<TDataTypes> & OnDidDispose;
     ...
     * @see {@link IDataProvider}
     */
    export type IDisposableDataProvider<TDataProvider extends IDataProvider<any>> = TDataProvider & Dispose;
}
declare module "shared/models/data-provider-engine.model" {
    import { DataProviderDataTypes, DataProviderGetters, DataProviderUpdateInstructions, DataProviderSetters } from "shared/models/data-provider.model";
    import { NetworkableObject } from "shared/models/network-object.model";
    /**
     ...
     */
    export type DataProviderEngineNotifyUpdate<TDataTypes extends DataProviderDataTypes> = (updateInstructions?: DataProviderUpdateInstructions<TDataTypes>) => void;
    /**
     ...
     *   functions.
     */
    type IDataProviderEngine<TDataTypes extends DataProviderDataTypes = DataProviderDataTypes> = NetworkableObject & 
    /**
     ...
     * @see {@link DataProviderGetter} for more information
     */
    DataProviderGetters<TDataTypes> & Partial<WithNotifyUpdate<TDataTypes>>;
     ...
     */
    export abstract class DataProviderEngine<TDataTypes extends DataProviderDataTypes> implements WithNotifyUpdate<TDataTypes> {
...
declare module "shared/models/extract-data-provider-data-types.model" {
     ...
     */
    type ExtractDataProviderDataTypes<TDataProvider> = TDataProvider extends IDataProvider<infer TDataProviderDataTypes> ? TDataProviderDataTypes : TDataProvider extends DataProviderInternal<infer TDataProviderDataTypes> ? TDataProviderDataTypes : TDataProvider extends IDisposableDataProvider<infer TDataProviderDataTypes> ? TDataProviderDataTypes : TDataProvider extends IDataProviderEngine<infer TDataProviderDataTypes> ? TDataProviderDataTypes : never;
...
declare module 'papi-shared-types' {
    ...
    import type { DataProviderDataType, DataProviderDataTypes, DataProviderSubscriberOptions, DataProviderUpdateInstructions } from "shared/models/data-provider.model";
    import type { MandatoryProjectDataTypes, PROJECT_INTERFACE_PLATFORM_BASE, WithProjectDataProviderEngineExtensionDataMethods } from "shared/models/project-data-provider.model";
     ...
     */
    type WithProjectDataProviderEngineSettingMethods<TProjectDataTypes extends DataProviderDataTypes> = {
        /**
         ...
         * @see {@link DataProviderUpdateInstructions} for more info on what to return
         */
        setSetting: <ProjectSettingName extends ProjectSettingNames>(key: ProjectSettingName, newSetting: ProjectSettingTypes[ProjectSettingName]) => Promise<DataProviderUpdateInstructions<TProjectDataTypes & MandatoryProjectDataTypes>>;
        /**
         ...
         */
        getSetting: <ProjectSettingName extends ProjectSettingNames>(key: ProjectSettingName) => Promise<ProjectSettingTypes[ProjectSettingName]>;
        /**
         ...
         */
        resetSetting: <ProjectSettingName extends ProjectSettingNames>(key: ProjectSettingName) => Promise<boolean>;
    };
    /**
     ...
     */
    type IProjectDataProvider<TProjectDataTypes extends DataProviderDataTypes> = IDataProvider<TProjectDataTypes>;
    /**
     * An object on the papi for interacting with that project data. Created by the papi and layers
     ...
     * {@link ProjectDataProviderInterfaces}.
     */
    type IBaseProjectDataProvider<TProjectDataTypes extends DataProviderDataTypes> = IProjectDataProvider<TProjectDataTypes & MandatoryProjectDataTypes> & WithProjectDataProviderEngineSettingMethods<TProjectDataTypes> & WithProjectDataProviderEngineExtensionDataMethods<TProjectDataTypes> & {
        /**
         ...
         * @returns Unsubscriber to stop listening for updates
         */
        subscribeSetting: <ProjectSettingName extends ProjectSettingNames>(key: ProjectSettingName, callback: (value: ProjectSettingTypes[ProjectSettingName]) => void, options: DataProviderSubscriberOptions) => Promise<UnsubscriberAsync>;
    };
    ...
    type ProjectInterfaceDataTypes = {
        [ProjectInterface in ProjectInterfaces]: ExtractDataProviderDataTypes<ProjectDataProviderInterfaces[ProjectInterface]>;
    };
    type StuffDataTypes = {
    ...
    type DataProviderTypes = {
        [DataProviderName in DataProviderNames]: ExtractDataProviderDataTypes<DataProviders[DataProviderName]>;
    };
    /**
...
declare module "shared/services/command.service" {
    ...
    export const sendCommand: <CommandName extends keyof CommandHandlers>(commandName: CommandName, ...args: Parameters<CommandHandlers[CommandName]>) => Promise<Awaited<ReturnType<CommandHandlers[CommandName]>>>;
    /**
     ...
     */
    export const createSendCommandFunction: <CommandName extends keyof CommandHandlers>(commandName: CommandName) => (...args: Parameters<CommandHandlers[CommandName]>) => Promise<Awaited<ReturnType<CommandHandlers[CommandName]>>>;
    /**
     ...
     */
    export const registerCommand: <CommandName extends CommandNames>(commandName: CommandName, handler: CommandHandlers[CommandName]) => Promise<UnsubscriberAsync>;
    /**
...
declare module "shared/models/docking-framework.model" {
    ...
    export type PanelDirection = 'left' | 'right' | 'bottom' | 'top' | 'before-tab' | 'after-tab' | 'maximize' | 'move' | 'active' | 'update';
    ...
    export type OnLayoutChangeRCDock = (newLayout: LayoutBase, currentTabId?: string, direction?: DropDirection) => Promise<void>;
...
declare module "shared/services/web-view.service-model" {
    import { GetWebViewOptions, SavedWebViewDefinition, WebViewId, WebViewType } from "shared/models/web-view.model";
    ...
    export interface WebViewServiceType {
         ...
         */
        getWebView: (webViewType: WebViewType, layout?: Layout, options?: GetWebViewOptions) => Promise<WebViewId | undefined>;
        /**
...
declare module "shared/models/web-view-provider.model" {
    import { GetWebViewOptions, WebViewDefinition, SavedWebViewDefinition } from "shared/models/web-view.model";
    import { DisposableNetworkObject, NetworkObject, NetworkableObject } from "shared/models/network-object.model";
    ...
    export interface IWebViewProvider extends NetworkableObject {
         ...
         */
        getWebView(savedWebView: SavedWebViewDefinition, getWebViewOptions: GetWebViewOptions): Promise<WebViewDefinition | undefined>;
    }
    export interface WebViewProvider extends NetworkObject<NetworkableObject>, CanHaveOnDidDispose<IWebViewProvider> {
    }
    export interface DisposableWebViewProvider extends DisposableNetworkObject<NetworkableObject>, Omit<WebViewProvider, 'dispose'> {
    }
}
declare module "shared/services/web-view-provider.service" {
     ...
     * papi.
     */
    import { DisposableWebViewProvider, IWebViewProvider, WebViewProvider } from "shared/models/web-view-provider.model";
    /** Sets up the service. Only runs once and always returns the same promise after that */
    const initialize: () => Promise<void>;
    /**
     ...
     */
    function register(webViewType: string, webViewProvider: IWebViewProvider): Promise<DisposableWebViewProvider>;
    /**
...
declare module "shared/services/data-provider.service" {
    ...
    import { DataProviderNames, DataProviderTypes, DataProviders, DisposableDataProviders } from 'papi-shared-types';
    import IDataProvider, { IDisposableDataProvider } from "shared/models/data-provider.interface";
    /**
     ...
     */
    function ignore(method: Function & {
        isIgnored?: boolean;
    }): void;
    /**
     * Decorator function that marks a data provider engine `set___` or `get___` method to be ignored.
     ...
     */
    function doNotNotify(method: Function & {
        doNotNotify?: boolean;
    }): void;
    /**
     * Decorator function that marks a data provider engine `set<data_type>` method not to automatically
     ...
     */
    function registerEngine<DataProviderName extends DataProviderNames>(providerName: DataProviderName, dataProviderEngine: IDataProviderEngine<DataProviderTypes[DataProviderName]>, dataProviderType?: string, dataProviderAttributes?: {
        [property: string]: unknown;
    } | undefined): Promise<DisposableDataProviders[DataProviderName]>;
    /**
     * Creates a data provider to be shared on the network layering over the provided data provider
     * engine.
     *
     ...
     *   is a new object distinct from the data provider engine passed in.
     */
    export function registerEngineByType<TDataTypes extends DataProviderDataTypes>(providerName: string, dataProviderEngine: IDataProviderEngine<TDataTypes>, dataProviderType?: string, dataProviderAttributes?: {
        [property: string]: unknown;
    } | undefined): Promise<IDisposableDataProvider<IDataProvider<TDataTypes>>>;
    /**
     ...
     */
    function get<DataProviderName extends DataProviderNames>(providerName: DataProviderName): Promise<DataProviders[DataProviderName] | undefined>;
    /**
     * Get a data provider that has previously been set up
     *
     ...
     * @returns The data provider with the given name if one exists, undefined otherwise
     */
    export function getByType<T extends IDataProvider<any>>(providerName: string): Promise<T | undefined>;
...
declare module "shared/models/project-lookup.service-model" {
    import { ProjectDataProviderFactoryMetadataInfo, ProjectMetadata } from "shared/models/project-metadata.model";
    import { ProjectInterfaces } from 'papi-shared-types';
    ...
    export type ProjectLookupServiceType = {
         ...
         */
        getMetadataForProject(projectId: string, projectInterface?: ProjectInterfaces, pdpFactoryId?: string): Promise<ProjectMetadata>;
        /**
        ...
        filterProjectsMetadata(projectsMetadata: ProjectMetadata[], options: ProjectMetadataFilterOptions): ProjectMetadata[];
        /** Combines two project metadata filters, removing duplicate items */
        mergeMetadataFilters(metadataFilter1: ProjectMetadataFilterOptions | undefined, metadataFilter2: ProjectMetadataFilterOptions | undefined): ProjectMetadataFilterOptions;
        /**
         ...
         *   provided
         */
        getMinimalMatchPdpFactoryId(projectMetadata: ProjectMetadata, projectInterface: ProjectInterfaces): string | undefined;
    };
    ...
    function transformGetMetadataForProjectParametersToFilter(projectId?: string, projectInterface?: ProjectInterfaces, pdpFactoryId?: string): {
     ...
     *   exclusion criteria.
     */
    export function areProjectInterfacesIncluded(projectInterfaces: ProjectInterfaces[], includeProjectInterfaces: (RegExp | RegExp[])[], excludeProjectInterfaces: (RegExp | RegExp[])[]): boolean;
    /**
     ...
     */
    function compareProjectDataProviderFactoryMetadataInfoMinimalMatch(pdpFMetadataInfoA: ProjectDataProviderFactoryMetadataInfo | undefined, pdpFMetadataInfoB: ProjectDataProviderFactoryMetadataInfo | undefined): -1 | 0 | 1;
...
declare module "shared/models/project-data-provider-engine-factory.model" {
     ...
     */
    export interface IProjectDataProviderEngineFactory<SupportedProjectInterfaces extends ProjectInterfaces[]> {
     ...
     * requirements.
     */
    export abstract class LayeringProjectDataProviderEngineFactory<SupportedProjectInterfaces extends ProjectInterfaces[]> {
        pdpfId: string;
...
declare module "shared/models/project-data-provider-engine.model" {
     ...
     * ```
     */
    export type IProjectDataProviderEngine<SupportedProjectInterfaces extends ProjectInterfaces[]> = IDataProviderEngine<UnionToIntersection<ProjectInterfaceDataTypes[SupportedProjectInterfaces[number]]> & {}>;
    /**
     ...
     */
    export abstract class ProjectDataProviderEngine<SupportedProjectInterfaces extends ProjectInterfaces[], AdditionalDataTypes extends DataProviderDataTypes = {}> extends DataProviderEngine<UnionToIntersection<ProjectInterfaceDataTypes[SupportedProjectInterfaces[number]]> & AdditionalDataTypes> {
    }
}
declare module "shared/models/base-project-data-provider-engine.model" {
    import { ProjectInterfaces, ProjectInterfaceDataTypes, WithProjectDataProviderEngineSettingMethods, ProjectSettingNames, ProjectSettingTypes } from 'papi-shared-types';
    import { PROJECT_INTERFACE_PLATFORM_BASE, WithProjectDataProviderEngineExtensionDataMethods } from "shared/models/project-data-provider.model";
    import { DataProviderDataType } from "shared/models/data-provider.model";
    import { UnionToIntersection } from 'platform-bible-utils';
    import { IProjectDataProviderEngine, ProjectDataProviderEngine } from "shared/models/project-data-provider-engine.model";
    /**
     * The object to return from
     * {@link IProjectDataProviderEngineFactory.createProjectDataProviderEngine} that the PAPI registers
     ...
     * ```
     */
    export type IBaseProjectDataProviderEngine<SupportedProjectInterfaces extends ProjectInterfaces[]> = IProjectDataProviderEngine<[
        typeof PROJECT_INTERFACE_PLATFORM_BASE,
        ...SupportedProjectInterfaces
    ]> & WithProjectDataProviderEngineSettingMethods<UnionToIntersection<ProjectInterfaceDataTypes[SupportedProjectInterfaces[number]]> & {}> & WithProjectDataProviderEngineExtensionDataMethods<UnionToIntersection<ProjectInterfaceDataTypes[SupportedProjectInterfaces[number]]> & {}>;
    /**
     ...
     */
    export abstract class BaseProjectDataProviderEngine<SupportedProjectInterfaces extends ProjectInterfaces[]> extends ProjectDataProviderEngine<[
        typeof PROJECT_INTERFACE_PLATFORM_BASE,
        ...SupportedProjectInterfaces
    ], {
        Setting: DataProviderDataType<ProjectSettingNames, ProjectSettingTypes[ProjectSettingNames], ProjectSettingTypes[ProjectSettingNames]>;
    }> {
    }
}
declare module "shared/services/project-data-provider.service" {
     ...
     */
    export function registerProjectDataProviderEngineFactory<SupportedProjectInterfaces extends ProjectInterfaces[]>(pdpFactoryId: string, projectInterfaces: SupportedProjectInterfaces, pdpEngineFactory: IProjectDataProviderEngineFactory<SupportedProjectInterfaces>): Promise<Dispose>;
    /**
     ...
     */
    export function get<ProjectInterface extends ProjectInterfaces>(projectInterface: ProjectInterface, projectId: string, pdpFactoryId?: string): Promise<ProjectDataProviderInterfaces[ProjectInterface]>;
...
declare module "node/services/node-file-system.service" {
     ...
     *   more information
     */
    export function copyFile(sourceUri: Uri, destinationUri: Uri, mode?: Parameters<typeof fs.promises.copyFile>[2]): Promise<void>;
    /**
     ...
     */
    export function readDir(uri: Uri, entryFilter?: (entryName: string) => boolean): Promise<DirectoryEntries>;
    /**
...
declare module "node/utils/crypto-util" {
     ...
     */
    export function generateHashFromBuffer(hashAlgorithm: string, encodingType: 'base64' | 'base64url' | 'hex' | 'binary', buffer: Buffer): string;
}
...
declare module "extension-host/services/extension-storage.service" {
     ...
     */
    function readTextFileFromInstallDirectory(token: ExecutionToken, fileName: string): Promise<string>;
    /**
     ...
     */
    function readBinaryFileFromInstallDirectory(token: ExecutionToken, fileName: string): Promise<Buffer>;
    /**
...
declare module "renderer/components/dialogs/dialog-base.data" {
     ...
     *   dialogs
     */
    export function hookUpDialogService({ resolveDialogRequest: resolve, rejectDialogRequest: reject, }: {
...
declare module "renderer/components/dialogs/dialog-definition.model" {
    ...
    export interface DialogTypes {
        ...
        [SELECT_MULTIPLE_PROJECTS_DIALOG_TYPE]: DialogDataTypes<SelectMultipleProjectsDialogOptions, string[]>;
    ...
    export type DialogDefinition<DialogTabType extends DialogTabTypes> = Readonly<DialogDefinitionBase & {
        /**
...
declare module "shared/services/dialog.service-model" {
    import { DialogTabTypes, DialogTypes, SelectProjectDialogOptions } from "renderer/components/dialogs/dialog-definition.model";
    /**
    ...
    export interface DialogService {
         ...
         */
        showDialog<DialogTabType extends DialogTabTypes>(dialogType: DialogTabType, options?: DialogTypes[DialogTabType]['options']): Promise<DialogTypes[DialogTabType]['responseType'] | undefined>;
        /**
...
declare module "shared/models/create-process-privilege.model" {
    import { ChildProcess, ChildProcessByStdio, ForkOptions, SpawnOptionsWithStdioTuple, StdioPipe } from 'child_process';
     ...
     */
    export type PlatformSpawn = (executionToken: ExtensionBasicData, command: string, args: readonly string[], options: SpawnOptionsWithStdioTuple<StdioPipe, StdioPipe, StdioPipe>) => ChildProcessByStdio<Writable, Readable, Readable>;
    /**
     ...
     */
    export type PlatformFork = (executionToken: ExtensionBasicData, modulePath: string, args?: readonly string[], options?: ForkOptions) => ChildProcess;
...
declare module "shared/models/manage-extensions-privilege.model" {
     ...
     */
    export type InstallExtensionFunction = (extensionUrlToDownload: string, fileSize: number, fileHashes: HashValues) => Promise<void>;
    /**
...
declare module "renderer/hooks/papi-hooks/use-dialog-callback.hook" {
     ...
     */
    function useDialogCallback<DialogTabType extends DialogTabTypes, DialogOptions extends DialogTypes[DialogTabType]['options']>(dialogType: DialogTabType, options: DialogOptions & UseDialogCallbackOptions, resolveCallback: (response: DialogTypes[DialogTabType]['responseType'] | undefined, dialogType: DialogTabType, options: DialogOptions) => void, rejectCallback: (error: unknown, dialogType: DialogTabType, options: DialogOptions) => void): (optionOverrides?: Partial<DialogOptions & UseDialogCallbackOptions>) => Promise<void>;
    /** JSDOC DESTINATION useDialogCallback */
    function useDialogCallback<DialogTabType extends DialogTabTypes, DialogOptions extends DialogTypes[DialogTabType]['options']>(dialogType: DialogTabType, options: DialogOptions & UseDialogCallbackOptions, resolveCallback: (response: DialogTypes[DialogTabType]['responseType'] | undefined, dialogType: DialogTabType, options: DialogOptions) => void): (optionOverrides?: Partial<DialogOptions & UseDialogCallbackOptions>) => Promise<void>;
    export default useDialogCallback;
}
declare module "shared/services/localization.service-model" {
    import IDataProvider from "shared/models/data-provider.interface";
    import { DataProviderDataType, DataProviderUpdateInstructions } from "shared/models/data-provider.model";
...
declare module "shared/utils/settings-document-combiner-base" {
    ...
    import { DocumentCombiner, JsonDocumentLike, Localized, Setting, SettingsGroup } from 'platform-bible-utils';
    /**
...
declare module "shared/services/settings.service-model" {
    ...
    import IDataProvider from "shared/models/data-provider.interface";
    import { DataProviderSubscriberOptions, DataProviderUpdateInstructions } from "shared/models/data-provider.model";
    ...
    export const settingsServiceObjectToProxy: Readonly<{
         ...
         */
        registerValidator: <SettingName extends keyof SettingTypes>(key: SettingName, validator: SettingValidator<SettingName>) => Promise<UnsubscriberAsync>;
    }>;
    /**
    ...
    export type SettingValidator<SettingName extends SettingNames> = (newValue: SettingTypes[SettingName], currentValue: SettingTypes[SettingName], allChanges: Partial<SettingTypes>) => Promise<boolean>;
    ...
    export type ISettingsService = {
         ...
         * @param allChanges
         */
        validateSetting<SettingName extends SettingNames>(key: SettingName, newValue: SettingTypes[SettingName], currentValue: SettingTypes[SettingName], allChanges?: Partial<SettingTypes>): Promise<boolean>;
        /**
         ...
         * @see {@link DataProviderUpdateInstructions} for more info on what to return
         */
        set<SettingName extends SettingNames>(key: SettingName, newSetting: SettingTypes[SettingName]): Promise<DataProviderUpdateInstructions<SettingDataTypes>>;
        /**
         ...
         */
        subscribe<SettingName extends SettingNames>(key: SettingName, callback: (newSetting: SettingTypes[SettingName]) => void, options?: DataProviderSubscriberOptions): Promise<UnsubscriberAsync>;
        /** JSDOC DESTINATION settingsServiceRegisterValidator */
        registerValidator<SettingName extends SettingNames>(key: SettingName, validator: SettingValidator<SettingName>): Promise<UnsubscriberAsync>;
        /**
         * Get the current set of settings contribution info given all the input documents with all
         * localized string keys localized properly.
         *
    ...
    } & OnDidDispose & IDataProvider<SettingDataTypes> & typeof settingsServiceObjectToProxy;
}
declare module "shared/utils/project-settings-document-combiner" {
    ...
    import { JsonDocumentLike, Localized, ProjectSetting, ProjectSettingsGroup } from 'platform-bible-utils';
    ...
    export default class ProjectSettingsDocumentCombiner extends SettingsDocumentCombinerBase {
         ...
         * no need to ever rebuild once all the documents have been contributed to this combiner.
         */
        getLocalizedProjectSettingsContributionInfo(): Promise<LocalizedProjectSettingsContributionInfo | undefined>;
...
declare module "shared/services/project-settings.service-model" {
    ...
    export const projectSettingsServiceObjectToProxy: Readonly<{
        ...
        registerValidator: <ProjectSettingName extends keyof ProjectSettingTypes>(key: ProjectSettingName, validator: ProjectSettingValidator<ProjectSettingName>) => Promise<UnsubscriberAsync>;
    }>;
    /**
    ...
    export interface IProjectSettingsService {
         ...
         */
        isValid<ProjectSettingName extends ProjectSettingNames>(key: ProjectSettingName, newValue: ProjectSettingTypes[ProjectSettingName], currentValue: ProjectSettingTypes[ProjectSettingName], allChanges?: SimultaneousProjectSettingsChanges): Promise<boolean>;
        /**
         ...
         */
        getDefault<ProjectSettingName extends ProjectSettingNames>(key: ProjectSettingName): Promise<ProjectSettingTypes[ProjectSettingName]>;
        /**
         ...
         * @returns Unsubscriber that should be called whenever the providing extension is deactivated
         */
        registerValidator<ProjectSettingName extends ProjectSettingNames>(key: ProjectSettingName, validatorCallback: ProjectSettingValidator<ProjectSettingName>): Promise<UnsubscriberAsync>;
        /**
     ...
     * @param allChanges All project settings changes being set in one batch
     */
    export type ProjectSettingValidator<ProjectSettingName extends ProjectSettingNames> = (newValue: ProjectSettingTypes[ProjectSettingName], currentValue: ProjectSettingTypes[ProjectSettingName], allChanges: SimultaneousProjectSettingsChanges) => Promise<boolean>;
    /**
...
declare module "shared/services/papi-core.service" {
    ...
    export type { default as IDataProvider, IDisposableDataProvider, } from "shared/models/data-provider.interface";
    export type { DataProviderUpdateInstructions, DataProviderDataType, DataProviderSubscriberOptions, } from "shared/models/data-provider.model";
    ...
    export type { ExtensionDataScope, MandatoryProjectDataTypes, } from "shared/models/project-data-provider.model";
    ...
    export type { default as IProjectDataProviderFactory, ProjectMetadataFilterOptions, } from "shared/models/project-data-provider-factory.interface";
    export type { ProjectDataProviderFactoryMetadataInfo, ProjectMetadata, ProjectMetadataWithoutFactoryInfo, } from "shared/models/project-metadata.model";
    export type { LocalizationData, LocalizationSelector, LocalizationSelectors, } from "shared/services/localization.service-model";
    ...
    export type { GetWebViewOptions, SavedWebViewDefinition, UseWebViewStateHook, UseWebViewScrollGroupScrRefHook, WebViewContentType, WebViewDefinition, WebViewProps, } from "shared/models/web-view.model";
    export type { IWebViewProvider } from "shared/models/web-view-provider.model";
    export type { SimultaneousProjectSettingsChanges, ProjectSettingValidator, } from "shared/services/project-settings.service-model";
}
declare module "shared/services/menu-data.service-model" {
    import { OnDidDispose, UnsubscriberAsync, MultiColumnMenu, ReferencedItem, WebViewMenu, Localized } from 'platform-bible-utils';
    import { DataProviderDataType, DataProviderSubscriberOptions, DataProviderUpdateInstructions } from "shared/models/data-provider.model";
    ...
    export type IMenuDataService = {
         ...
         * @returns Unsubscriber function
         */
        setMainMenu(mainMenuType: undefined, value: never): Promise<DataProviderUpdateInstructions<MenuDataDataTypes>>;
        /**
         ...
         */
        subscribeMainMenu(mainMenuType: undefined, callback: (menuContent: Localized<MultiColumnMenu>) => void, options?: DataProviderSubscriberOptions): Promise<UnsubscriberAsync>;
        /**
         ...
         * @returns Unsubscriber function
         */
        setWebViewMenu(webViewType: ReferencedItem, value: never): Promise<DataProviderUpdateInstructions<MenuDataDataTypes>>;
        /**
         ...
         * @returns Unsubscriber function (run to unsubscribe from listening for updates)
         */
        subscribeWebViewMenu(webViewType: ReferencedItem, callback: (menuContent: Localized<WebViewMenu>) => void, options?: DataProviderSubscriberOptions): Promise<UnsubscriberAsync>;
    } & OnDidDispose & typeof menuDataServiceObjectToProxy & IDataProvider<MenuDataDataTypes>;
}
...
declare module "shared/services/project-settings.service" {
     ...
     *   interfaces.
     */
    export function filterProjectSettingsContributionsByProjectInterfaces(contributions: Localized<ProjectSettingsContributionInfo['contributions']> | undefined, projectInterfaces: (keyof ProjectDataProviderInterfaces)[]): Localized<ProjectSettingsContributionInfo['contributions']> | undefined;
...
declare module "renderer/hooks/hook-generators/create-use-network-object-hook.util" {
     ...
     */
    function createUseNetworkObjectHook<THookParams extends unknown[]>(getNetworkObject: (...args: THookParams) => Promise<NetworkObject<object> | undefined>, mapParametersToNetworkObjectSource?: (...args: THookParams) => string | NetworkObject<object> | undefined): (...args: THookParams) => NetworkObject<object> | undefined;
...
declare module "renderer/hooks/papi-hooks/use-data-provider.hook" {
     ...
     */
    const useDataProvider: <DataProviderName extends keyof DataProviders>(dataProviderSource: DataProviderName | DataProviders[DataProviderName] | undefined) => DataProviders[DataProviderName] | undefined;
...
declare module "renderer/hooks/hook-generators/create-use-data-hook.util" {
     ...
     */
    type UseDataFunctionWithProviderType<TDataProvider extends IDataProvider<any>, TDataType extends keyof ExtractDataProviderDataTypes<TDataProvider>> = (selector: ExtractDataProviderDataTypes<TDataProvider>[TDataType]['selector'], defaultValue: ExtractDataProviderDataTypes<TDataProvider>[TDataType]['getData'], subscriberOptions?: DataProviderSubscriberOptions) => [
        ExtractDataProviderDataTypes<TDataProvider>[TDataType]['getData'],
        (((newData: ExtractDataProviderDataTypes<TDataProvider>[TDataType]['setData']) => Promise<DataProviderUpdateInstructions<ExtractDataProviderDataTypes<TDataProvider>>>) | undefined),
        boolean
    ];
    /**
    ...
    type UseDataProxy<TDataProvider extends IDataProvider<any>> = {
        [TDataType in keyof ExtractDataProviderDataTypes<TDataProvider>]: UseDataFunctionWithProviderType<TDataProvider, TDataType>;
    };
    /**
    ...
    type UseDataHookGeneric<TUseDataProviderParams extends unknown[]> = {
        <TDataProvider extends IDataProvider<any>>(...args: TUseDataProviderParams): UseDataProxy<TDataProvider>;
    };
    /**
     ...
     */
    function createUseDataHook<TUseDataProviderParams extends unknown[]>(useDataProviderHook: (...args: TUseDataProviderParams) => IDataProvider | undefined): UseDataHookGeneric<TUseDataProviderParams>;
...
declare module "renderer/hooks/papi-hooks/use-data.hook" {
     ...
     */
    type UseDataHook = {
        <DataProviderName extends DataProviderNames>(dataProviderSource: DataProviderName | DataProviders[DataProviderName] | undefined): {
            [TDataType in keyof DataProviderTypes[DataProviderName]]: (selector: DataProviderTypes[DataProviderName][TDataType]['selector'], defaultValue: DataProviderTypes[DataProviderName][TDataType]['getData'], subscriberOptions?: DataProviderSubscriberOptions) => [
                DataProviderTypes[DataProviderName][TDataType]['getData'],
                (((newData: DataProviderTypes[DataProviderName][TDataType]['setData']) => Promise<DataProviderUpdateInstructions<DataProviderTypes[DataProviderName]>>) | undefined),
                boolean
            ];
        };
    };
...
declare module "renderer/services/scroll-group.service-host" {
     ...
     */
    export function setScrRefSync(scrollGroupId: ScrollGroupId | undefined, scrRef: ScriptureReference, shouldSetVerseRefSetting?: boolean): boolean;
...
declare module "renderer/hooks/papi-hooks/use-scroll-group-scr-ref.hook" {
     ...
     */
    export default function useScrollGroupScrRef(scrollGroupScrRef: ScrollGroupScrRef | undefined, setScrollGroupScrRef: (scrollGroupScrRef: ScrollGroupScrRef) => boolean): [
        scrRef: ScriptureReference,
        setScrRef: (newScrRef: ScriptureReference) => void,
        scrollGroupId: ScrollGroupId | undefined,
        setScrollGroupId: (newScrollGroupId: ScrollGroupId | undefined) => void
...
declare module "renderer/hooks/papi-hooks/use-setting.hook" {
     ...
     *   message type
     */
    const useSetting: <SettingName extends keyof SettingTypes>(key: SettingName, defaultState: SettingTypes[SettingName], subscriberOptions?: DataProviderSubscriberOptions) => [
        setting: SettingTypes[SettingName],
        setSetting: (newData: SettingTypes[SettingName]) => Promise<DataProviderUpdateInstructions<SettingDataTypes>>,
        resetSetting: () => void,
        isLoading: boolean
    ];
...
declare module "renderer/hooks/papi-hooks/use-project-data-provider.hook" {
     ...
     */
    const useProjectDataProvider: <ProjectInterface extends keyof ProjectDataProviderInterfaces>(projectInterface: ProjectInterface, projectDataProviderSource: string | ProjectDataProviderInterfaces[ProjectInterface] | undefined, pdpFactoryId?: string) => ProjectDataProviderInterfaces[ProjectInterface] | undefined;
    export default useProjectDataProvider;
}
declare module "renderer/hooks/papi-hooks/use-project-data.hook" {
    import { DataProviderSubscriberOptions, DataProviderUpdateInstructions } from "shared/models/data-provider.model";
    import { ProjectDataProviderInterfaces, ProjectInterfaceDataTypes, ProjectInterfaces } from 'papi-shared-types';
    /**
    ...
    type UseProjectDataHook = {
        <ProjectInterface extends ProjectInterfaces>(projectInterface: ProjectInterface, projectDataProviderSource: string | ProjectDataProviderInterfaces[ProjectInterface] | undefined): {
            [TDataType in keyof ProjectInterfaceDataTypes[ProjectInterface]]: (selector: ProjectInterfaceDataTypes[ProjectInterface][TDataType]['selector'], defaultValue: ProjectInterfaceDataTypes[ProjectInterface][TDataType]['getData'], subscriberOptions?: DataProviderSubscriberOptions) => [
                ProjectInterfaceDataTypes[ProjectInterface][TDataType]['getData'],
                (((newData: ProjectInterfaceDataTypes[ProjectInterface][TDataType]['setData']) => Promise<DataProviderUpdateInstructions<ProjectInterfaceDataTypes[ProjectInterface]>>) | undefined),
                boolean
            ];
        };
    };
...
declare module "renderer/hooks/papi-hooks/use-project-setting.hook" {
     ...
     *   message type
     */
    const useProjectSetting: <ProjectSettingName extends keyof ProjectSettingTypes>(projectDataProviderSource: string | IBaseProjectDataProvider<any> | undefined, key: ProjectSettingName, defaultValue: ProjectSettingTypes[ProjectSettingName], subscriberOptions?: DataProviderSubscriberOptions) => [
...
declare module "renderer/hooks/papi-hooks/use-data-provider-multi.hook" {
     ...
     *   not disposed.
     */
    function useDataProviderMulti<EachDataProviderName extends DataProviderNames[]>(dataProviderSources: (EachDataProviderName[number] | DataProviders[EachDataProviderName[number]] | undefined)[]): (DataProviders[EachDataProviderName[number]] | undefined)[];
...
declare module "renderer/hooks/papi-hooks/use-localized-strings-hook" {
     ...
     */
    const useLocalizedStrings: (localizationKeys: LocalizeKey[], localizationLocales?: string[], subscriberOptions?: DataProviderSubscriberOptions) => [localizedStrings: LocalizationData, isLoading: boolean];
