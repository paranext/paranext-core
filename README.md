...
`NOTICES_POLICY_OVERLAY=<path>` merges a second policy file over the committed one for every
command above. It exists for a downstream product built from this source, which keeps its own
