...
**Note**: During development on macOS, `electron-log` uses the default app name "Electron" for the log directory. In packaged releases, logs will be in `Platform.Bible`.
...
# View previous log
cat ~/Library/Logs/Electron/main.log.old-1
```
