...
/**
 * @returns {null|{bindState: function(string,WSSharedDoc):void,
 * writeState:function(string,WSSharedDoc):Promise<any>}|null}
...
/**
 * This function is called once every time a Yjs document is created. You can use it to pull data
 * from an external source or initialize content.
 *
...
class WSSharedDoc extends Y.Doc {
  ...
  constructor(name) {
    ...
    this.name = name;
    /**
     * Maps from conn to set of controlled user ids. Delete all user ids from awareness when this
     * conn is closed
     *
