...
/**
 * Determine whether any dialog is open in this window, composed from the two independent places a
 ...
 * key listener) should check this rather than either source alone.
 *
