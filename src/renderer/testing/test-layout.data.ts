...
import { TAB_TYPE_PROJECT_SETTINGS_DIALOG } from '@renderer/components/project-settings-dialog/project-settings-tab.component';
  ...
  ? {
      ...
      floatbox: {
        ...
        children: [
          ...
          {
            tabs: [
              { id: 'Project Settings', tabType: TAB_TYPE_PROJECT_SETTINGS_DIALOG },
            ] as SavedTabInfo[],
            x: 250,
            y: 170,
            w: 600,
