 ...
 * is derivable (from the last sync's per-project results) and is reported. See ADR-0020 in
...
export function SyncStatusButton() {
  ...
  const handleCancel = useCallback(async () => {
    ...
    // click. See ADR-0020 in `.context/standards/Architecture-Decisions.md`.
