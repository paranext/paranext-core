 ...
 */
const windowIdsAwaitingFirstActivation = new Set<string>();

/** Record that a window was created without being activated. See {@link planWindowActivation} */
export function noteWindowWithheldFromActivation(windowId: string): void {
 ...
 */
export function forgetWindowWithholding(windowId: string): void {
 ...
 */
export function isWindowAwaitingFirstActivation(windowId: string): boolean {
 ...
 */
export function shouldContentAvoidDocumentFocus(windowId: string): boolean {
