...
function getReasonEncryptionIsNotAvailable() {
  if (process.platform === 'linux' && safeStorage.getSelectedStorageBackend() === 'basic_text')
    return 'safeStorage did not find a package it could use for encryption. Please install a supported package as mentioned at https://www.electronjs.org/docs/latest/api/safe-storage#safestoragegetselectedstoragebackend-linux';
