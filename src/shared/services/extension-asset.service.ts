...
const initialize = async () => {
  ...
  initializePromise = (async (): Promise<void> => {
    ...
    await networkService.registerRequestHandler(
      ...
      {
        description: 'Get an asset from an extension',
        params: [
          {
            name: 'extensionName',
            required: true,
        ...
        examples: [
          {
            name: requestType,
            params: ['testExtension', 'assets/testAssetData.xyz'],
            result:
              'Base64 encoded contents of the file "testAssetData.xyz" in the "assets" folder in the "testExtension" extension',
          },
        ],
        */
      },
