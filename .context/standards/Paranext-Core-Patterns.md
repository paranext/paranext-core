...
is just a cache. See
[ADR-0020](Architecture-Decisions.md#adr-0020-the-scroll-group-service-is-hosted-in-main-and-each-renderer-keeps-a-predicting-cache)
and [ADR-0021](Architecture-Decisions.md#adr-0021-the-theme-service-is-hosted-in-main-and-each-window-caches-the-current-theme);
