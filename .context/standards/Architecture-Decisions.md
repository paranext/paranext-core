...
- **Consequences:** shortcuts are app-global and cross-platform from one place; couples `main.ts` to
  ...
  Narrowed by ADR-0013: this applies to shortcuts whose command needs nothing from the focused view;
...
## ADR-0013: Per-web-view Ctrl+F for Find, not a main-process `before-input-event` branch
