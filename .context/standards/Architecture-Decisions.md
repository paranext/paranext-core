...
## ADR-0029: App-window input announcements carry the input KIND only, never key identity
...
## ADR-0030: Project stylesheets cross the wire as structured StyleInfo, not generated CSS
