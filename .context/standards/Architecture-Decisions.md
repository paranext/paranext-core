...
## ADR-0024: Panel readiness is derived from whether data sources arrived, never from a filtered result
...
## ADR-0025: Async hook state shape — discriminated union when the payload is state-specific, flat object otherwise
