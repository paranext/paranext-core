...
## ADR-0019: Find follows the editor onto read-only resources, with replace withheld
...
## ADR-0020: Column 3 tab order is expressed as anchor + insert-before in the layout supplement, not as a pinning mechanism
