---
title: "23. Parallel passages"
source_url: "https://manual.paratext.org/23.PP"
...
### 23.1 Open the Parallel passages window[​](#925421753cc849dbb0b0e5c29c6f549c "Direct link to 23.1 Open the Parallel passages window")
...
### 23.2 Display source texts[​](#63b7d3882a4f4eb7845d2ed8e45ca813 "Direct link to 23.2 Display source texts")
...
### 23.4 Filters[​](#bddd1bb153c84ee9bca3bc97ffb62b3b "Direct link to 23.4 Filters")

- Choose the filters as desired: [e.g. All references, Current book, Synoptic gospels]

### 23.5 Compare the passages[​](#15c4aeb5a832426887603cefb4fe4e37 "Direct link to 23.5 Compare the passages")
...
> **Tip:** If the text is **green** in Greek, then **your text** should also be the same (but **darker green**).
> > Normally, if the text is different in the Greek than it should be different in your text, but not always.

### 23.6 To correct the text[​](#7337f71cd3c44034befaf9a302214031 "Direct link to 23.6 To correct the text")

1. Click the blue link **Edit**
2. Make the corrections.
3. Click **OK**.

### 23.7 Copying a text[​](#f792366370e34edaa04a467ba812183e "Direct link to 23.7 Copying a text")

> **Tip:** If two passage need to be the same, you should choose one (normally your later translation) and copy it over the other.
...
> **Warning:** Be careful when there is more than one verse. You don’t want to paste the \v.

### 23.8 Mark the passage as checked[​](#d2196130c2104131b84a2bea4a95ad68 "Direct link to 23.8 Mark the passage as checked")

- Click the check box beside the reference.
  - *The set of references are approved*.

### Three modes for approving[​](#08445ce9fc804dc1afac9e744e6025c0 "Direct link to Three modes for approving")
...
### To change from set to individually[​](#d8817e289b6245e385115906581f599b "Direct link to To change from set to individually")
...
4. *A pencil icon is shown*.
5. Click the **pencil**
   - *The checkboxes move to the other mode but only for this set of passages.*

### 23.9 Passages which have changed[​](#e989e64519384fff9e358789ba19411e "Direct link to 23.9 Passages which have changed")
...
### 23.10 Compare the text as you translate[​](#ff56ce1d6f24468a8b5c84e7eedbf652 "Direct link to 23.10 Compare the text as you translate")
...
### 23.11 To see a third passage[​](#c0a5d24f77314597a326fd75e4fbc55c "Direct link to 23.11 To see a third passage")
