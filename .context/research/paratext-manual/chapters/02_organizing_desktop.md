---
title: "2. Organizing your desktop"
source_url: "https://manual.paratext.org/2.OD"
...
### **Changes in Paratext 9**[​](#ed3427390c2b484f8c1343a8944fe332 "Direct link to ed3427390c2b484f8c1343a8944fe332")
...
> **Tip:** In this manual, when it says **≡ Paratext**, under **Menu** > **Command** (e.g. **≡ Paratext**, under **Paratext** > **Open**). It means click on the Paratext menu icon ≡, then under the menu (e.g. Paratext) choose the command (e.g. Open).
> > 
...
## 2.1 Load the program[​](#c07b16862b1d4f55821e9a5398e26435 "Direct link to 2.1 Load the program")
...
## 2.2 Open a saved layout[​](#d65baaea138b4d72b0dbaaadd85f23d5 "Direct link to 2.2 Open a saved layout")
...
> **Tip:** Remember to save your layout!

### Save the layout[​](#d4ebb0ef8d0f49998351a50a09b5942b "Direct link to Save the layout")
...
## 2.4 Delete a text layout[​](#75e26e8bdc3345529b5b3fc702f4c748 "Direct link to 2.4 Delete a text layout")

If you want to delete a saved layout,

1. **≡ Paratext** under **Layout** > **Manage layouts**
   - *A dialog box is displayed with a list of all the saved layouts*
2. Click the three dots to the right of the name of the saved layout.
   - *A submenu is displayed.*
3. Choose **Delete** from the submenu
   - *A dialog box is displayed warning you that you will delete the layout*
4. Click **Delete** again to confirm.

## 2.5 Open resources in a Text collection[​](#204f93f95d7e4da7aa004d8b2aefaa86 "Direct link to 2.5 Open resources in a Text collection")
...
> >    1. *If a resource has changed, a green dot is shown on the Paratext menu icon.*
> > 
...
> **Tip:** It is suggested that resources be displayed in the order of more literal to less literal (to focus on the texts that are most faithful to the source texts). For English resources: ESV, RSV, NIV, NLT. For French resources, the following order is suggested: TOB, NVSR78Col, NBS, BDS, FC97, PDV11.
...
## 2.6 Open an Enhanced Resource[​](#ddb656b63852444cbe84a309b3bb9923 "Direct link to 2.6 Open an Enhanced Resource")
...
## 2.7 Open a dictionary[​](#7ea1b54db25c492c832d9d92995b4030 "Direct link to 2.7 Open a dictionary")

> **Tip:** If you do not use an enhanced resource, you can open a source language dictionary with glosses in other languages.
...
## 2.8 Working with the Source language text[​](#9fe3171ca9784daf8bc9ff0681bcaa59 "Direct link to 2.8 Working with the Source language text")
