...
| [theme-constants.ts](./theme-constants.ts)       | Toolbar theme family / appearance IDs (internal `colorScheme` identifiers) + legacy composite IDs (shared with manager + theme apply) |
