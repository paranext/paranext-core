// #region shared with https://github.com/paranext/paranext-extension-template/blob/main/tailwind.config.ts and https://github.com/paranext/paranext-core/blob/main/lib/platform-bible-react/tailwind.config.ts
