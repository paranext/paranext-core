 ...
 */
export default class TailwindPrebuildWebpackCodePathsPlugin {
  ...
  apply(resolver: Resolver) {
    ...
    resolver
      ...
      .tapAsync(
        ...
        'TailwindPrebuildWebpackCodePathsPlugin',
        /**
        ...
        (request, resolveContext, callback) => {
          ...
          let redirectPath = tailwindPrebuiltPath;
          // Add the query back onto the request path if it was originally there
          if (!request.query) redirectPath += resourceQuery;
          ...
          resolver.doResolve(
            ...
            `Redirecting ${requestPath} to pre-built version: ${redirectPath}`,
            resolveContext,
            callback,
          );
          return undefined;
