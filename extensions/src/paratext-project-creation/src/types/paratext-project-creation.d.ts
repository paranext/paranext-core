declare module 'paratext-project-creation' {
  ...
  /** Request to update an existing project. Fields that are undefined will not be updated. */
...
declare module 'papi-shared-types' {
  ...
  export interface CommandHandlers {
    ...
    /**
     * Updates an existing project with the specified settings. Only fields that are provided will
     * be updated.
     *
