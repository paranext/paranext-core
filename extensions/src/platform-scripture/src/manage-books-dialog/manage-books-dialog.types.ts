...
export const MANAGE_BOOKS_DIALOG_STRING_KEYS = Object.freeze([
  ...
  // Shared with the model text pickers; lives with the copyright notice strings
  ...
  '%manageBooks_footer_summary_create_empty%',
  '%manageBooks_footer_summary_create_chapterVerse%',
  '%manageBooks_footer_summary_create_fromTemplate_with%',
  '%manageBooks_footer_summary_create_fromTemplate_without%',
  ...
  '%manageBooks_footer_enabledTooltip_copy%',
