...
global.webViewComponent = function FindWebView({
  ...
  const retrieveFindJobUpdate = useCallback(
    // @ts-expect-error 7030: Adding useless return statement to fix ts7030 causes eslint errors
  ...
  const handleStartSearch = useCallback(async () => {
    ...
    // No mutex is needed here because we're fine throwing away concurrent calls
