 ...
 */
import type { EditFilingPatternWebViewOptions, PatternPreviewContext } from 'platform-projects';
import {
  IWebViewProvider,
  OpenWebViewOptions,
...
interface EditFilingPatternOpenWebViewOptions
...
export class EditFilingPatternWebViewProvider implements IWebViewProvider {
  ...
  async getWebView(
    ...
    getWebViewOptions: EditFilingPatternOpenWebViewOptions,
    ...
    return {
      ...
      state: {
        ...savedWebView.state,
        initialPattern: getWebViewOptions.initialPattern ?? '{nn}{BBB}{project}.SFM',
        previewContext: getWebViewOptions.previewContext ?? {
