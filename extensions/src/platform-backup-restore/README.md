...
- `src/` contains the source code for the extension
  ...
  - `src/types/platform-backup-restore.d.ts` is this extension's types file that defines how other extensions can use this extension through the `papi`. It is copied into the build folder
