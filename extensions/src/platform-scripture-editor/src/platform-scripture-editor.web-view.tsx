...
globalThis.webViewComponent = function PlatformScriptureEditor({
  ...
  const menuCommandHandler = useCallback<SelectMenuItemHandler>(
    (projectMenuCommand) => {
      ...
      // definition, which keeps the menu item working (opening an unscoped Find) in a tab that has
      // no project yet, exactly as it did before the selection was added.
