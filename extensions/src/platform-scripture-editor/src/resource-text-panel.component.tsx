...
export function ResourceTextPanel({
  ...
  //
  // The ContentZoomRoot below is only reached once the panel has a project (or is the no-project
  // free-resource entry point), is not mid-pick/install, has a configured readiness, and has not
  // just failed an install. With no project the level is not remembered: zoom memory is keyed by
  // the container project, and there is none. None of the earlier returns for
