...
export const NO_VERSES_TO_SHOW_KEY = '%webView_scriptureTextGrid_cell_noVersesToShow%';
export const CHAPTER_EMPTY_KEY = '%webView_scriptureTextGrid_cell_chapterEmpty%';
