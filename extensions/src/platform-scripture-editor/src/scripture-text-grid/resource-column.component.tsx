...
export function ResourceColumn({
  ...
  return (
    <div
      ...
      // The header band and padding are unscaled, so a click or the wheel there has no marked
      // text to resolve its zoom area from; the scope names this resource's area for them.
