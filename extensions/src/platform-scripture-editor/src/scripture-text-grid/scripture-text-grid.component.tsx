...
export function ScriptureTextGrid({
  ...
  //
  // Accepted a11y cost (`adr-verse-zero-resolves-to-verse-one`): this makes verse 0 unobservable
  // inside the grid. At MAT 5:0 the label announces "MAT 5:1" and the cells show verse 1, so a
