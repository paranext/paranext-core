...
| Comments — especially ones referencing tickets, PRs, or the change's own history                                                                                                                                                                                                  | `.claude/rules/code-quality/forward-facing-comments.md`                                              |
...
| `assets/localization/**` — adding or changing a core string                                                                                                                                                                                                                       | `.claude/rules/localization-locale-files.md`                                                         |
...
| A conclusion that something is absent, drawn from a narrowed search — a path- or glob-scoped `grep`, a `grep -v` exclusion, or looking only where the answer was expected                                                                                                         | `.claude/rules/scoped-sweeps-cannot-prove-absence.md`                                                |
