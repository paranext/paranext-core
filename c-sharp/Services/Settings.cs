...
public sealed class Settings
{
    ...
    /// patch: the patch was adding this const to a public file, which is a standing merge conflict
    /// against every change to it, and the setting itself is core's — defined in
