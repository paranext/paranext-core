...
internal sealed class InventoryWorker
{
    ...
    private Dictionary<InventoryTextType, TextInventory> _summarizedInventoriesByType = [];
    private ScriptureInventoryBase _inventory;
    private ScrText _scrText;
    private ChecksDataSource _dataSource;
    private InputRange[] _inputRanges;
    private InputRangesFilter<TextInventoryItem> _inputRangesFilter;
