...
internal class LocalParatextProjects
{
    ...
    private static readonly List<string> s_paratextProjectInterfaces = [ProjectInterfaces.Base, ProjectInterfaces.USFM_BookChapterVerse, ProjectInterfaces.USX_BookChapterVerse];
