...
public class PlatformCommentConverter : JsonConverter<PlatformCommentWrapper>
{
    ...
    )
    {
        ...
        // common non-conflict note allocates none of the four closures below. Also skipped when the
        // body itself degraded, so a "could not be displayed" note never ships a placeholder body
